...
public abstract class Applet_Sub1 extends Applet implements Runnable, FocusListener, WindowListener {
	...
	private void method1632(@OriginalArg(1) boolean arg0) {
		...
		if (Static446.aClass392_6 != null) {
			try {
				Static446.aClass392_6.method8992();
	...
	private void method1639() {
		@Pc(6) long local6 = Static588.method7722();
		@Pc(17) long local17 = Static475.aLongArray16[Static708.anInt10672];
		Static475.aLongArray16[Static708.anInt10672] = local6;
		if (local17 != 0L && local17 < local6) {
			@Pc(40) int local40 = (int) (local6 - local17);
			Static652.anInt9738 = ((local40 >> 1) + 32000) / local40;
		}
		Static708.anInt10672 = Static708.anInt10672 + 1 & 0x1F;
		if (Static169.anInt2859++ > 50) {
			Static664.aBoolean760 = true;
			Static169.anInt2859 -= 50;
			...
			if (Static353.aFrame10 != null && Static316.aFrame8 == null) {
				...
				Static434.aCanvas7.setLocation(local86.left + Static134.anInt10357, Static241.anInt3973 + local86.top);
			} else {
	...
	public final void run() {
		try {
			...
			Static418.method7866();
			Static148.method2429();
			this.method1641();
			this.method1647();
			Static600.aClass27_1 = Static570.method7557();
			while (Static604.aLong278 == 0L || Static588.method7722() < Static604.aLong278) {
				Static32.anInt779 = Static600.aClass27_1.method5605(Static324.aLong164);
				for (@Pc(213) int local213 = 0; local213 < Static32.anInt779; local213++) {
					this.method1646();
				}
				this.method1639();
				Static61.method1312(Static446.aClass392_6, Static434.aCanvas7);
			}
	...
	public final synchronized void paint(@OriginalArg(0) Graphics arg0) {
		...
		Static664.aBoolean760 = true;
		if (Static463.aBoolean531 && Static588.method7722() - Static149.aLong96 > 1000L) {
	...
	public final void stop() {
		if (Static149.anApplet_Sub1_1 == this && !Static250.aBoolean311) {
			Static604.aLong278 = Static588.method7722() + 4000L;
		}
	}
	...
	public synchronized void method1641() {
		...
		if (local30 == Static353.aFrame10) {
			...
			Static434.aCanvas7.setLocation(Static134.anInt10357 + local74.left, local74.top + Static241.anInt3973);
		} else {
			Static434.aCanvas7.setLocation(Static134.anInt10357, Static241.anInt3973);
		}
		...
		Static206.aBoolean268 = true;
		Static664.aBoolean760 = true;
		Static723.aBoolean828 = false;
		Static149.aLong96 = Static588.method7722();
	}
	...
	private void method1646() {
		@Pc(6) long local6 = Static588.method7722();
		@Pc(10) long local10 = Static221.aLongArray18[Static392.anInt6162];
		Static221.aLongArray18[Static392.anInt6162] = local6;
		...
		Static392.anInt6162 = Static392.anInt6162 + 1 & 0x1F;
		synchronized (this) {
			Static91.aBoolean751 = Static206.aBoolean268;
		}
		this.method1645();
	}
	...
	public final void destroy() {
		if (Static149.anApplet_Sub1_1 == this && !Static250.aBoolean311) {
			Static604.aLong278 = Static588.method7722();
			Static638.method8402(5000L);
			Static284.aClass392_4 = null;
