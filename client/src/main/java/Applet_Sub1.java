...
public abstract class Applet_Sub1 extends Applet implements Runnable, FocusListener, WindowListener {
	...
	private void method1052(@OriginalArg(1) boolean arg0) {
		synchronized (this) {
		...
		Static307.method3115();
		Static501.method4727();
		...
		if (Static446.aClass390_6 != null) {
			try {
				Static446.aClass390_6.method6426();
	...
	protected final void method1055(@OriginalArg(3) int arg0, @OriginalArg(6) String arg1) {
		try {
			...
			@Pc(88) Class270 local88 = Static446.aClass390_6.method6432(this, 1);
			while (local88.anInt6789 == 0) {
				Static638.method5959(10L);
			}
		} catch (@Pc(103) Exception local103) {
			Static240.method2529(local103, (String) null);
		}
	}
	...
	protected final void method1058(@OriginalArg(0) String arg0) {
		if (this.aBoolean156) {
			return;
		}
	...
	private void method1059() {
		@Pc(6) long local6 = Static588.method5469();
	...
	protected final void method1060(@OriginalArg(2) int arg0, @OriginalArg(3) int arg1, @OriginalArg(4) String arg2, @OriginalArg(6) int arg3) {
		try {
			if (Static149.anApplet_Sub1_1 == null) {
				...
				@Pc(80) Class270 local80 = Static446.aClass390_6.method6432(this, 1);
				...
				if (Static426.anInt941 >= 3) {
					this.method1058("alreadyloaded");
				} else {
					this.getAppletContext().showDocument(this.getDocumentBase(), "_self");
				}
			}
		} catch (@Pc(92) Throwable local92) {
			Static240.method2529(local92, (String) null);
			this.method1058("crash");
		}
	}
	...
	public final void run() {
		try {
			...
			Static418.method5568();
			Static148.method1627();
			this.method1061();
			this.method1067();
			Static600.aClass27_1 = Static570.method5319();
			while (Static604.aLong278 == 0L || Static588.method5469() < Static604.aLong278) {
				Static32.anInt776 = Static600.aClass27_1.method3980(Static324.aLong164);
				for (@Pc(213) int local213 = 0; local213 < Static32.anInt776; local213++) {
					this.method1066();
				}
				this.method1059();
				Static61.method812(Static446.aClass390_6, Static434.aCanvas7);
			}
		} catch (@Pc(254) ThreadDeath local254) {
			throw local254;
		} catch (@Pc(257) Throwable local257) {
			Static240.method2529(local257, this.method1068());
			this.method1058("crash");
		} finally {
	...
	public final synchronized void paint(@OriginalArg(0) Graphics arg0) {
		...
		Static664.aBoolean759 = true;
		if (Static463.aBoolean531 && Static588.method5469() - Static149.aLong96 > 1000L) {
	...
	public final void stop() {
		if (Static149.anApplet_Sub1_1 == this && !Static250.aBoolean311) {
			Static604.aLong278 = Static588.method5469() + 4000L;
		}
	}
	...
	public synchronized void method1061() {
		...
		Static149.aLong96 = Static588.method5469();
	}

	@OriginalMember(owner = "client!kh", name = "d", descriptor = "(B)Z")
	protected final boolean method1063() {
	...
	public final boolean method1064() {
		return Static14.method117("jaclib");
	}

	@OriginalMember(owner = "client!kh", name = "k", descriptor = "(I)V")
	protected abstract void method1065();
	...
	protected abstract void method1067();
	...
	public final void destroy() {
		if (Static149.anApplet_Sub1_1 == this && !Static250.aBoolean311) {
			Static604.aLong278 = Static588.method5469();
			Static638.method5959(5000L);
	...
	protected abstract void method1070();
	...
	public final boolean method1071() {
		return Static14.method117("jagtheora");
	}
