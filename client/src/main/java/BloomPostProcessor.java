...
public final class BloomPostProcessor extends PostProcessor {
	...
	public BloomPostProcessor(@OriginalArg(0) Class19_Sub3 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!kca", name = "g", descriptor = "(I)Z")
	public boolean method4630() {
		return super.aClass19_Sub3_22.aBoolean613 && super.aClass19_Sub3_22.aBoolean620 && super.aClass19_Sub3_22.aBoolean603;
	}
	...
	public void method4615() {
		...
		this.aClass408_2 = null;
		this.aClass408_1 = null;
	...
	public boolean method4624() {
		if (!super.aClass19_Sub3_22.aBoolean613 || !super.aClass19_Sub3_22.aBoolean620 || !super.aClass19_Sub3_22.aBoolean603) {
			return false;
		}
		this.aClass408_1 = new Class408(super.aClass19_Sub3_22);
		...
		super.aClass19_Sub3_22.method6974(this.aClass408_1);
		this.aClass408_1.method9376(this.aClass93_Sub2_2, 0);
		this.aClass408_1.method9376(this.aClass93_Sub2_1, 1);
		this.aClass408_1.method9378(0);
		if (!this.aClass408_1.method9375()) {
			super.aClass19_Sub3_22.method7000(this.aClass408_1);
			return false;
		}
		super.aClass19_Sub3_22.method7000(this.aClass408_1);
		this.aClass179_2 = Static173.method2691(super.aClass19_Sub3_22, new Class242[] { Static245.method8636("#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n", super.aClass19_Sub3_22, 35632) });
		this.aClass179_5 = Static173.method2691(super.aClass19_Sub3_22, new Class242[] { Static245.method8636("uniform vec3 params;\nuniform sampler2D sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2D(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n", super.aClass19_Sub3_22, 35632) });
		this.aClass179_3 = Static173.method2691(super.aClass19_Sub3_22, new Class242[] { Static245.method8636("#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform vec3 dimScale;\nuniform sampler2D bloomTex;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n\t vec4 bloomCol = texture2D(bloomTex, gl_TexCoord[1].xy);\n\t vec4 sceneCol = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n\t float preLum = 0.99*dot(lumCoef, sceneCol.rgb)+0.01;\n    float postLum = preLum*(1.0+(preLum/params.y))/(preLum+1.0);\n\t gl_FragColor = sceneCol*(postLum/preLum)+bloomCol*params.x;\n}\n", super.aClass19_Sub3_22, 35632) });
		this.aClass179_4 = Static173.method2691(super.aClass19_Sub3_22, new Class242[] { Static245.method8636("uniform vec3 step;\nuniform sampler2D baseTex;\nvoid main() {\n\tvec4 fragCol = texture2D(baseTex, gl_TexCoord[0].xy)*0.091396265;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-8.0*step.xy))*0.012369139;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 8.0*step.xy))*0.012369139;\n\tgl_FragColor = fragCol;\n}\n", super.aClass19_Sub3_22, 35632) });
	...
	@Override
	public void preProcess(@OriginalArg(0) Class93_Sub2 arg0, @OriginalArg(1) Class93_Sub2 arg1, @OriginalArg(3) int arg2) {
		...
		if (this.aClass93_Sub2Array1 == null) {
			super.aClass19_Sub3_22.method7008(arg1);
			super.aClass19_Sub3_22.method6974(this.aClass408_1);
			this.aClass408_1.method9378(0);
			...
			OpenGL.glTexCoord2f((float) this.anInt5121, 0.0F);
			OpenGL.glVertex2i(1, 0);
			OpenGL.glTexCoord2f((float) this.anInt5121, (float) this.anInt5115);
			OpenGL.glVertex2i(1, 1);
			OpenGL.glTexCoord2f(0.0F, (float) this.anInt5115);
			OpenGL.glVertex2i(0, 1);
			OpenGL.glEnd();
		} else {
			super.aClass19_Sub3_22.method6974(this.aClass408_2);
			@Pc(112) int local112 = Static402.method5594(this.anInt5121);
			@Pc(117) int local117 = Static402.method5594(this.anInt5115);
			@Pc(119) int local119 = 0;
			while (local112 > 256 || local117 > 256) {
				OpenGL.glViewport(0, 0, local112, local117);
				this.aClass408_2.method9376(this.aClass93_Sub2Array1[local119], 0);
				if (local119 == 0) {
					super.aClass19_Sub3_22.method7008(arg1);
					OpenGL.glBegin(7);
					OpenGL.glTexCoord2f(0.0F, 0.0F);
					...
					super.aClass19_Sub3_22.method7008(this.aClass93_Sub2Array1[local119 - 1]);
					OpenGL.glBegin(7);
					OpenGL.glTexCoord2f(0.0F, 0.0F);
					OpenGL.glVertex2i(0, 0);
			...
			super.aClass19_Sub3_22.method7000(this.aClass408_2);
			super.aClass19_Sub3_22.method7008(this.aClass93_Sub2Array1[local119 - 1]);
			super.aClass19_Sub3_22.method6974(this.aClass408_1);
			this.aClass408_1.method9378(0);
			OpenGL.glViewport(0, 0, 256, 256);
		...
		this.aClass408_1.method9378(1);
		super.aClass19_Sub3_22.method7008(this.aClass93_Sub2_2);
		...
		OpenGL.glEnd();
		this.aClass408_1.method9378(0);
		super.aClass19_Sub3_22.method7008(this.aClass93_Sub2_1);
	...
	@Override
	public void postProcess(@OriginalArg(1) int colorAttachment) {
	...
	@Override
	public void setSize(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		this.anInt5121 = arg0;
		this.anInt5115 = arg1;
		@Pc(23) int local23 = Static402.method5594(this.anInt5121);
		@Pc(28) int local28 = Static402.method5594(this.anInt5115);
		if (this.anInt5117 == local23 && this.anInt5123 == local28) {
			return;
		}
		@Pc(49) int local49;
		if (this.aClass93_Sub2Array1 != null) {
			for (local49 = 0; local49 < this.aClass93_Sub2Array1.length; local49++) {
				this.aClass93_Sub2Array1[local49].method9449();
			}
			this.aClass93_Sub2Array1 = null;
		}
		if (local23 <= 256 && local28 <= 256) {
			...
			if (this.aClass408_2 == null) {
				this.aClass408_2 = new Class408(super.aClass19_Sub3_22);
			}
			label54: while (true) {
		...
		this.anInt5117 = local23;
		this.anInt5123 = local28;
	}
}
