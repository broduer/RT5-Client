...
public final class Class10 {
	...
	private void method129(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub21 arg1) {
		if (arg0 == 1) {
			this.anInt123 = arg1.method7389();
		} else if (arg0 == 2) {
			this.aBoolean10 = true;
		} else if (arg0 == 3) {
			this.anInt125 = arg1.method7363();
			this.anInt130 = arg1.method7363();
			this.anInt132 = arg1.method7363();
		} else if (arg0 == 4) {
			this.anInt129 = arg1.method7403();
		} else if (arg0 == 5) {
			this.anInt124 = arg1.method7389();
		} else if (arg0 == 6) {
			this.anInt131 = arg1.method7390();
		} else if (arg0 == 7) {
			this.anInt128 = arg1.method7363();
			this.anInt133 = arg1.method7363();
			this.anInt126 = arg1.method7363();
		}
	}
	...
	public void method131(@OriginalArg(0) Class2_Sub21 arg0) {
		while (true) {
			@Pc(11) int local11 = arg0.method7403();
			if (local11 == 0) {
				return;
			}
