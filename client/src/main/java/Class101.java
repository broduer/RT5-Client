...
public abstract class Class101 {
	...
	public abstract void method9433(@OriginalArg(0) Class93 arg0, @OriginalArg(1) int arg1);

	@OriginalMember(owner = "client!ua", name = "a", descriptor = "(I)V")
	public abstract void method9434();

	@OriginalMember(owner = "client!ua", name = "a", descriptor = "(III)V")
	public abstract void method9435(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1);

	@OriginalMember(owner = "client!ua", name = "a", descriptor = "(IZ)V")
	public abstract void method9436(@OriginalArg(1) boolean arg0);

	@OriginalMember(owner = "client!ua", name = "a", descriptor = "(B)Z")
	public abstract boolean method9438();

	@OriginalMember(owner = "client!ua", name = "b", descriptor = "(ZI)V")
	public abstract void method9439(@OriginalArg(0) boolean arg0);
}
