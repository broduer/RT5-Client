...
public final class Class101_Sub4 extends Class101 {
	...
	public Class101_Sub4(@OriginalArg(0) Class19_Sub3 arg0, @OriginalArg(1) Class331 arg1) {
		super(arg0);
		this.aClass331_3 = arg1;
		if (this.aClass331_3.aClass93_Sub3_3 != null && super.aClass19_Sub3_42.aBoolean616 && super.aClass19_Sub3_42.aBoolean620) {
			...
			this.aClass179_6 = Static173.method2691(super.aClass19_Sub3_42, new Class242[] { local34, local43 });
	...
	public void method9439(@OriginalArg(0) boolean arg0) {
		...
		super.aClass19_Sub3_42.method7021(0);
		super.aClass19_Sub3_42.method7008(this.aClass331_3.aClass93_Sub3_3);
		...
		OpenGL.glUniform3fARB(OpenGL.glGetUniformLocationARB(local47, "sunDir"), -super.aClass19_Sub3_42.aFloatArray52[0], -super.aClass19_Sub3_42.aFloatArray52[1], -super.aClass19_Sub3_42.aFloatArray52[2]);
		...
		OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(local47, "sunExponent"), Math.abs(super.aClass19_Sub3_42.aFloatArray52[1]) * 928.0F + 96.0F);
	...
	public void method9435(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		...
		OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(local49, "time"), (float) (super.aClass19_Sub3_42.anInt8010 * local21 % 40000) / 40000.0F);
