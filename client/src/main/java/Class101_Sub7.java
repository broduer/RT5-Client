...
public final class Class101_Sub7 extends Class101 {
	...
	public Class101_Sub7(@OriginalArg(0) Class19_Sub3 arg0, @OriginalArg(1) Class331 arg1) {
		super(arg0);
		this.aClass331_5 = arg1;
		if (this.aClass331_5.aClass93_Sub3_3 != null && super.aClass19_Sub3_42.aBoolean616 && super.aClass19_Sub3_42.aBoolean620) {
			@Pc(34) Class242 local34 = Static245.method8636("uniform float time;\nuniform float scale;\nvarying vec3 wvVertex;\nvarying float waterDepth;\nvoid main() {\nwaterDepth = gl_MultiTexCoord0.z;\nvec4 ecVertex = gl_ModelViewMatrix*gl_Vertex;\nwvVertex.x = dot(gl_NormalMatrix[0], ecVertex.xyz);\nwvVertex.y = dot(gl_NormalMatrix[1], ecVertex.xyz);\nwvVertex.z = dot(gl_NormalMatrix[2], ecVertex.xyz);\ngl_TexCoord[0].x = dot(gl_TextureMatrix[0][0], gl_MultiTexCoord0)*scale;\ngl_TexCoord[0].y = dot(gl_TextureMatrix[0][1], gl_MultiTexCoord0)*scale;\ngl_TexCoord[0].z = time;\ngl_TexCoord[0].w = 1.0;\ngl_FogFragCoord = 1.0-clamp((gl_Fog.end+ecVertex.z)*gl_Fog.scale, 0.0, 1.0);\ngl_Position = ftransform();\n}\n", super.aClass19_Sub3_42, 35633);
			@Pc(43) Class242 local43 = Static245.method8636("varying vec3 wvVertex;\nvarying float waterDepth;\nuniform vec3 sunDir;\nuniform vec4 sunColour;\nuniform float sunExponent;\nuniform vec2 waveIntensity;\nuniform float waveExponent;\nuniform float breakWaterDepth;\nuniform float breakWaterOffset;\nuniform sampler3D normalSampler;\nuniform samplerCube envMapSampler;\nvoid main() {\nvec4 wnNormal = texture3D(normalSampler, gl_TexCoord[0].xyz).rbga;\nwnNormal.xyz = 2.0*wnNormal.xyz-1.0;\nvec3 wnVector = normalize(wvVertex);\nvec3 wnReflection = reflect(wnVector, wnNormal.xyz);\nvec3 envColour = textureCube(envMapSampler, wnReflection).rgb;\nvec4 specularColour = sunColour*pow(clamp(-dot(sunDir, wnReflection), 0.0, 1.0), sunExponent);\nfloat shoreFactor = clamp(waterDepth/breakWaterDepth-breakWaterOffset*wnNormal.w, 0.0, 1.0);\nfloat waveFactor = pow(1.0-shoreFactor, waveExponent)-0.5;\nwaveFactor = -4.0*waveFactor*waveFactor+1.0;\nfloat ndote = dot(wnVector, wnNormal.xyz);\nfloat fresnel = pow(1.0-abs(ndote), 1.0);\nvec4 surfaceColour = mix(vec4(envColour, fresnel*shoreFactor), (waveIntensity.x*wnNormal.wwww)+waveIntensity.y, waveFactor)+specularColour*shoreFactor;\ngl_FragColor = vec4(mix(surfaceColour.rgb, gl_Fog.color.rgb, gl_FogFragCoord), surfaceColour.a);\n}\n", super.aClass19_Sub3_42, 35632);
			this.aClass179_7 = Static173.method2691(super.aClass19_Sub3_42, new Class242[] { local34, local43 });
			this.aBoolean710 = this.aClass179_7 != null;
		}
	}
	...
	public void method9435(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		...
		OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(local60, "time"), (float) (super.aClass19_Sub3_42.anInt8010 * local8 % 40000) / 40000.0F);
	...
	public void method9439(@OriginalArg(0) boolean arg0) {
		@Pc(12) Class93_Sub1 local12 = super.aClass19_Sub3_42.method6970();
		if (!this.aBoolean710 || local12 == null) {
			return;
		}
		@Pc(32) float local32 = (1.0F - Math.abs(super.aClass19_Sub3_42.aFloatArray52[1])) * 2.0F + 1.0F;
		super.aClass19_Sub3_42.method7021(1);
		super.aClass19_Sub3_42.method7008(local12);
		super.aClass19_Sub3_42.method7021(0);
		super.aClass19_Sub3_42.method7008(this.aClass331_5.aClass93_Sub3_3);
		...
		OpenGL.glUniform3fARB(OpenGL.glGetUniformLocationARB(local58, "sunDir"), -super.aClass19_Sub3_42.aFloatArray52[0], -super.aClass19_Sub3_42.aFloatArray52[1], -super.aClass19_Sub3_42.aFloatArray52[2]);
		...
		OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(local58, "sunExponent"), Math.abs(super.aClass19_Sub3_42.aFloatArray52[1]) * 928.0F + 64.0F);
