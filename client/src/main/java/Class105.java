...
public final class Class105 {
	...
	public void method1621(@OriginalArg(1) Class2_Sub21 arg0) {
		while (true) {
			@Pc(12) int local12 = arg0.method5205();
			if (local12 == 0) {
				return;
			}
			this.method1630(arg0, local12);
		}
	}

	@OriginalMember(owner = "client!el", name = "a", descriptor = "(BLclient!uk;)Z")
	public boolean method1623(@OriginalArg(1) Interface23 arg0) {
		@Pc(31) int local31;
		if (this.anInt2616 == -1) {
			if (this.anInt2599 == -1) {
				return true;
			}
			local31 = arg0.method4827(this.anInt2599);
		} else {
			local31 = arg0.method4828(this.anInt2616);
		}
		...
		if (this.anInt2584 == -1) {
			...
			local78 = arg0.method4827(this.anInt2586);
		} else {
			local78 = arg0.method4828(this.anInt2584);
		}
	...
	public String method1624(@OriginalArg(0) int arg0, @OriginalArg(2) String arg1) {
		if (this.aClass28_14 == null) {
			return arg1;
		} else {
			@Pc(17) Class2_Sub24 local17 = (Class2_Sub24) this.aClass28_14.method373((long) arg0);
			return local17 == null ? arg1 : local17.aString46;
		}
	}

	@OriginalMember(owner = "client!el", name = "a", descriptor = "(III)I")
	public int method1625(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		if (this.aClass28_14 == null) {
			return arg0;
		} else {
			@Pc(27) Class2_Sub38 local27 = (Class2_Sub38) this.aClass28_14.method373((long) arg1);
			return local27 == null ? arg0 : local27.anInt6379;
		}
	}

	@OriginalMember(owner = "client!el", name = "a", descriptor = "(ILclient!ha;)Lclient!st;")
	public Class23 method1626(@OriginalArg(1) Class19 arg0) {
		@Pc(28) Class23 local28 = (Class23) this.aClass246_2.aClass82_135.method1390((long) (this.anInt2618 | 0x20000 | arg0.anInt8962 << 29));
		if (local28 != null) {
			return local28;
		}
		this.aClass246_2.aClass330_83.method5345(this.anInt2618);
		@Pc(49) Class407 local49 = Static735.method6771(this.aClass246_2.aClass330_83, this.anInt2618, 0);
		if (local49 != null) {
			local28 = arg0.a(local49, true);
			this.aClass246_2.aClass82_135.method1384(local28, (long) (this.anInt2618 | 0x20000 | arg0.anInt8962 << 29));
		}
		return local28;
	}
	...
	public Class23 method1629(@OriginalArg(0) boolean arg0, @OriginalArg(2) Class19 arg1) {
		@Pc(22) int local22 = arg0 ? this.anInt2591 : this.anInt2596;
		@Pc(29) int local29 = arg1.anInt8962 << 29 | local22;
		@Pc(38) Class23 local38 = (Class23) this.aClass246_2.aClass82_135.method1390((long) local29);
		if (local38 != null) {
			return local38;
		} else if (this.aClass246_2.aClass330_83.method5345(local22)) {
			@Pc(60) Class407 local60 = Static735.method6771(this.aClass246_2.aClass330_83, local22, 0);
			if (local60 != null) {
				local38 = arg1.a(local60, true);
				this.aClass246_2.aClass82_135.method1384(local38, (long) local29);
			}
			return local38;
		} else {
			return null;
	...
	private void method1630(@OriginalArg(1) Class2_Sub21 arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 1) {
			this.anInt2596 = arg0.method5191();
		} else if (arg1 == 2) {
			this.anInt2591 = arg0.method5191();
		} else if (arg1 == 3) {
			this.aString25 = arg0.method5167();
		} else if (arg1 == 4) {
			this.anInt2592 = arg0.method5192();
		} else if (arg1 == 5) {
			this.anInt2589 = arg0.method5192();
		} else if (arg1 == 6) {
			this.anInt2615 = arg0.method5205();
		} else {
			@Pc(74) int local74;
			if (arg1 == 7) {
				local74 = arg0.method5205();
				if ((local74 & 0x1) == 0) {
				...
				this.aBoolean216 = arg0.method5205() == 1;
			} else if (arg1 == 9) {
				this.anInt2599 = arg0.method5191();
				if (this.anInt2599 == 65535) {
					this.anInt2599 = -1;
				}
				this.anInt2616 = arg0.method5191();
				if (this.anInt2616 == 65535) {
					this.anInt2616 = -1;
				}
				this.anInt2612 = arg0.method5158();
				this.anInt2582 = arg0.method5158();
				return;
				...
				if (arg1 != 15) {
					...
					if (arg1 == 17) {
						this.aString24 = arg0.method5167();
					} else if (arg1 == 18) {
						this.anInt2618 = arg0.method5191();
						return;
					} else if (arg1 == 19) {
						this.anInt2597 = arg0.method5191();
						return;
					} else if (arg1 == 20) {
						this.anInt2586 = arg0.method5191();
						if (this.anInt2586 == 65535) {
							this.anInt2586 = -1;
						}
						this.anInt2584 = arg0.method5191();
						if (this.anInt2584 == 65535) {
							this.anInt2584 = -1;
						}
						this.anInt2606 = arg0.method5158();
						this.anInt2601 = arg0.method5158();
						return;
					} else if (arg1 == 21) {
						this.anInt2608 = arg0.method5158();
						return;
					} else if (arg1 == 22) {
						this.anInt2605 = arg0.method5158();
						return;
					} else if (arg1 == 23) {
						this.anInt2603 = arg0.method5205();
						this.anInt2587 = arg0.method5205();
						this.anInt2607 = arg0.method5205();
						return;
					} else if (arg1 == 24) {
						this.anInt2600 = arg0.method5165();
						this.anInt2617 = arg0.method5165();
						return;
					} else if (arg1 == 249) {
						local74 = arg0.method5205();
						if (this.aClass28_14 == null) {
							local291 = Static440.method4203(local74);
							this.aClass28_14 = new Class28(local291);
						}
						for (local291 = 0; local291 < local74; local291++) {
							@Pc(310) boolean local310 = arg0.method5205() == 1;
							local314 = arg0.method5192();
							@Pc(323) Class2 local323;
							if (local310) {
								local323 = new Class2_Sub24(arg0.method5167());
							} else {
								local323 = new Class2_Sub38(arg0.method5158());
							}
							this.aClass28_14.method370((long) local314, local323);
						}
						return;
					}
					return;
				...
				for (local291 = 0; local291 < local74 * 2; local291++) {
					this.anIntArray228[local291] = arg0.method5165();
				}
				this.anInt2610 = arg0.method5158();
				@Pc(389) int local389 = arg0.method5205();
				this.anIntArray229 = new int[local389];
				for (local314 = 0; local314 < this.anIntArray229.length; local314++) {
					this.anIntArray229[local314] = arg0.method5158();
				}
				this.aByteArray31 = new byte[local74];
				for (@Pc(419) int local419 = 0; local419 < local74; local419++) {
					this.aByteArray31[local419] = arg0.method5186();
				}
				return;
			} else {
				this.aStringArray9[arg1 - 10] = arg0.method5167();
				return;
			}
		}
	}
