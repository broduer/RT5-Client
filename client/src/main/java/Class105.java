...
public final class Class105 {
	...
	private void method2432(@OriginalArg(1) Class2_Sub21 arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 1) {
			this.anInt2605 = arg0.method7389();
		} else if (arg1 == 2) {
			this.anInt2600 = arg0.method7389();
		} else if (arg1 == 3) {
			this.aString25 = arg0.method7365();
		} else if (arg1 == 4) {
			this.anInt2601 = arg0.method7390();
		} else if (arg1 == 5) {
			this.anInt2598 = arg0.method7390();
		} else if (arg1 == 6) {
			this.anInt2624 = arg0.method7403();
		} else {
			@Pc(74) int local74;
			if (arg1 == 7) {
				local74 = arg0.method7403();
				if ((local74 & 0x1) == 0) {
				...
				this.aBoolean216 = arg0.method7403() == 1;
			} else if (arg1 == 9) {
				this.anInt2608 = arg0.method7389();
				if (this.anInt2608 == 65535) {
					this.anInt2608 = -1;
				}
				this.anInt2625 = arg0.method7389();
				if (this.anInt2625 == 65535) {
					this.anInt2625 = -1;
				}
				this.anInt2621 = arg0.method7356();
				this.anInt2591 = arg0.method7356();
				return;
				...
				if (arg1 != 15) {
					...
					if (arg1 == 17) {
						this.aString24 = arg0.method7365();
					} else if (arg1 == 18) {
						this.anInt2627 = arg0.method7389();
						return;
					} else if (arg1 == 19) {
						this.anInt2606 = arg0.method7389();
						return;
					} else if (arg1 == 20) {
						this.anInt2595 = arg0.method7389();
						if (this.anInt2595 == 65535) {
							this.anInt2595 = -1;
						}
						this.anInt2593 = arg0.method7389();
						if (this.anInt2593 == 65535) {
							this.anInt2593 = -1;
						}
						this.anInt2615 = arg0.method7356();
						this.anInt2610 = arg0.method7356();
						return;
					} else if (arg1 == 21) {
						this.anInt2617 = arg0.method7356();
						return;
					} else if (arg1 == 22) {
						this.anInt2614 = arg0.method7356();
						return;
					} else if (arg1 == 23) {
						this.anInt2612 = arg0.method7403();
						this.anInt2596 = arg0.method7403();
						this.anInt2616 = arg0.method7403();
						return;
					} else if (arg1 == 24) {
						...
						for (local291 = 0; local291 < local74; local291++) {
							@Pc(310) boolean local310 = arg0.method7403() == 1;
							local314 = arg0.method7390();
							@Pc(323) Class2 local323;
							if (local310) {
								local323 = new Class2_Sub24(arg0.method7365());
							} else {
				...
				this.anInt2619 = arg0.method7356();
				@Pc(389) int local389 = arg0.method7403();
				this.anIntArray229 = new int[local389];
				for (local314 = 0; local314 < this.anIntArray229.length; local314++) {
					this.anIntArray229[local314] = arg0.method7356();
				}
				this.aByteArray31 = new byte[local74];
				for (@Pc(419) int local419 = 0; local419 < local74; local419++) {
					this.aByteArray31[local419] = arg0.method7384();
				}
				return;
			} else {
				this.aStringArray9[arg1 - 10] = arg0.method7365();
				return;
			}
		}
	}
