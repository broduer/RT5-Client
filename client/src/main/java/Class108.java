...
public final class Class108 {
	...
	private void method1644(@OriginalArg(0) int arg0, @OriginalArg(2) Class2_Sub21 arg1) {
		if (arg0 == 1) {
			this.anInt2629 = arg1.method5191();
		} else if (arg0 == 2) {
			this.anIntArray232 = new int[arg1.method5205()];
			for (@Pc(26) int local26 = 0; local26 < this.anIntArray232.length; local26++) {
				this.anIntArray232[local26] = arg1.method5191();
			}
		} else if (arg0 == 3) {
			this.anInt2624 = arg1.method5205();
		} else if (arg0 == 4) {
			this.anInt2625 = arg1.method5205();
		} else if (arg0 == 5) {
			this.anInt2621 = arg1.method5191();
			return;
		}
	}

	@OriginalMember(owner = "client!ema", name = "a", descriptor = "(BLclient!ge;)V")
	public void method1645(@OriginalArg(1) Class2_Sub21 arg0) {
		while (true) {
			@Pc(3) int local3 = arg0.method5205();
			if (local3 == 0) {
				return;
			}
			this.method1644(local3, arg0);
		}
	}
}
