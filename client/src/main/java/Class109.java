...
public final class Class109 implements Interface13 {
	...
	public void method5493() {
		...
		@Pc(23) int local23 = this.aClass23_9.b();
		@Pc(27) int local27 = this.aClass23_9.a();
		@Pc(29) int local29 = 0;
		...
		this.aClass23_9.b(local29, local44, local31, local37);
	}

	@OriginalMember(owner = "client!en", name = "a", descriptor = "(I)V")
	@Override
	public void method5492() {
		this.aClass23_9 = Static652.method6077(this.aClass200_1.anInt4996, this.aClass330_27);
	}

	@OriginalMember(owner = "client!en", name = "b", descriptor = "(I)Z")
	@Override
	public boolean method5491() {
		return this.aClass330_27.method5345(this.aClass200_1.anInt4996);
	}
}
