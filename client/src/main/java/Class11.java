...
public final class Class11 implements Interface20 {
	...
	public Class11(@OriginalArg(0) Class19_Sub1_Sub1 arg0, @OriginalArg(1) Class399 arg1, @OriginalArg(2) boolean arg2) {
	...
	public Buffer method8554() {
		...
		if (!this.aBoolean12 && Static731.method4161((byte) 86, this.anIDirect3DIndexBuffer1.Lock(0, this.anInt135, local21 ? 8192 : 0, this.aClass19_Sub1_Sub1_1.aGeometryBuffer1))) {
	...
	public void method8550(@OriginalArg(1) int arg0) {
		this.anInt134 = arg0 * this.aClass399_1.anInt10596;
		...
		this.anIDirect3DIndexBuffer1 = this.aClass19_Sub1_Sub1_1.anIDirect3DDevice1.a(this.anInt134, local27, this.aClass399_1 == Static702.aClass399_17 ? 101 : 102, local32, (IDirect3DIndexBuffer) this.anIDirect3DIndexBuffer1);
	...
	public boolean method8553() {
		if (this.aBoolean12 && Static731.method4161((byte) 61, this.anIDirect3DIndexBuffer1.Unlock())) {
