...
public final class Class110 {
	...
	public boolean method2458(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		...
		@Pc(59) int local59 = arg3 - this.anInt2654;
		@Pc(64) int local64 = arg5 - this.anInt2654;
		@Pc(69) int local69 = arg0 - this.anInt2656;
		@Pc(74) int local74 = arg2 - this.anInt2656;
		if (arg6 == 1) {
			if (arg1 == 6 || arg1 == 7) {
				if (arg1 == 7) {
					arg4 = arg4 + 2 & 0x3;
	...
	public boolean method2460(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8) {
		...
		if (arg3 == local23 && (arg5 & 0x2) == 0) {
			...
			while (local75 < local83) {
				if ((this.anIntArrayArray65[local23 - this.anInt2656 - 1][local75 - this.anInt2654] & 0x8) == 0) {
					return true;
				}
				local75++;
			}
			...
			while (local83 > local75) {
				if ((this.anIntArrayArray65[arg4 - this.anInt2656][local75 - this.anInt2654] & 0x80) == 0) {
					return true;
				}
				local75++;
			}
			...
			while (local75 < local83) {
				if ((this.anIntArrayArray65[local75 - this.anInt2656][local27 - this.anInt2654 - 1] & 0x2) == 0) {
					return true;
				}
				local75++;
			}
			...
			local83 = local23 <= local7 ? local23 : local7;
			while (local83 > local75) {
				if ((this.anIntArrayArray65[local75 - this.anInt2656][arg1 - this.anInt2654] & 0x20) == 0) {
					return true;
				}
				local75++;
			}
	...
	public void method2462(@OriginalArg(1) boolean arg0, @OriginalArg(2) boolean arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		@Pc(8) int local8 = arg2 - this.anInt2654;
		@Pc(13) int local13 = arg5 - this.anInt2656;
		if (arg4 == 0) {
			if (arg3 == 0) {
	...
	public void method2463(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) boolean arg3, @OriginalArg(5) int arg4, @OriginalArg(6) boolean arg5) {
		@Pc(4) int local4 = arg4 - this.anInt2656;
		@Pc(17) int local17 = arg0 - this.anInt2654;
		if (arg2 == 0) {
			if (arg1 == 0) {
	...
	public boolean method2464(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7) {
		...
		if (arg2 <= arg3 && local53 >= arg3 && arg0 <= arg7 && arg7 <= local59) {
			return true;
		} else if (arg3 == arg2 - 1 && arg7 >= arg0 && arg7 <= local59 && (this.anIntArrayArray65[arg3 - this.anInt2656][arg7 - this.anInt2654] & 0x8) == 0 && (arg1 & 0x8) == 0) {
			return true;
		} else if (arg3 == local53 + 1 && arg0 <= arg7 && local59 >= arg7 && (this.anIntArrayArray65[arg3 - this.anInt2656][arg7 - this.anInt2654] & 0x80) == 0 && (arg1 & 0x2) == 0) {
			return true;
		} else if (arg0 - 1 == arg7 && arg3 >= arg2 && arg3 <= local53 && (this.anIntArrayArray65[arg3 - this.anInt2656][arg7 - this.anInt2654] & 0x2) == 0 && (arg1 & 0x4) == 0) {
			return true;
		} else {
			return arg7 == local59 + 1 && arg3 >= arg2 && arg3 <= local53 && (this.anIntArrayArray65[arg3 - this.anInt2656][arg7 - this.anInt2654] & 0x20) == 0 && (arg1 & 0x1) == 0;
		}
	}
	...
	public boolean method2465(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		@Pc(68) int local68 = arg4 - this.anInt2656;
		@Pc(73) int local73 = arg2 - this.anInt2654;
		@Pc(78) int local78 = arg5 - this.anInt2656;
		@Pc(83) int local83 = arg3 - this.anInt2654;
		if (arg0 == 1) {
			if (arg1 == 0) {
				if (arg6 == 0) {
	...
	public void method2466(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(15) int local15 = arg1 - this.anInt2656;
		@Pc(20) int local20 = arg0 - this.anInt2654;
	...
	public void method2467() {
		for (@Pc(5) int local5 = 0; local5 < this.anInt2652; local5++) {
			for (@Pc(8) int local8 = 0; local8 < this.anInt2662; local8++) {
				if (local5 == 0 || local8 == 0 || local5 >= this.anInt2652 - 5 || this.anInt2662 - 5 <= local8) {
	...
	public void method2468(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		...
		@Pc(18) int local18 = arg6 - this.anInt2654;
		@Pc(23) int local23 = arg2 - this.anInt2656;
		@Pc(35) int local35;
		if (arg5 == 1 || arg5 == 3) {
			local35 = arg3;
			arg3 = arg4;
		...
		for (local35 = local23; local35 < arg3 + local23; local35++) {
			if (local35 >= 0 && this.anInt2652 > local35) {
				for (@Pc(69) int local69 = local18; local69 < local18 + arg4; local69++) {
					if (local69 >= 0 && local69 < this.anInt2662) {
	...
	public void method2469(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(11) int local11 = arg0 - this.anInt2654;
		@Pc(20) int local20 = arg1 - this.anInt2656;
	...
	public void method2470(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(8) int local8 = arg1 - this.anInt2656;
		@Pc(13) int local13 = arg0 - this.anInt2654;
	...
	public void method2472(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) boolean arg3, @OriginalArg(5) int arg4, @OriginalArg(6) boolean arg5) {
		...
		@Pc(22) int local22 = arg2 - this.anInt2654;
		@Pc(32) int local32 = arg0 - this.anInt2656;
		for (@Pc(34) int local34 = local32; local34 < local32 + arg4; local34++) {
			if (local34 >= 0 && this.anInt2652 > local34) {
				for (@Pc(52) int local52 = local22; local52 < arg1 + local22; local52++) {
					if (local52 >= 0 && this.anInt2662 > local52) {
	...
	public void method2473(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		@Pc(20) int local20 = arg0 - this.anInt2654;
		@Pc(25) int local25 = arg1 - this.anInt2656;
