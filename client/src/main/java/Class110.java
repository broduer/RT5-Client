...
public final class Class110 {
	...
	public boolean method1656(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		if (arg6 == 1) {
	...
	private void method1657(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anIntArrayArray65[arg2][arg0] &= ~arg1;
	}

	@OriginalMember(owner = "client!eq", name = "a", descriptor = "(IIBIIIIIII)Z")
	public boolean method1658(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8) {
	...
	public void method1660(@OriginalArg(1) boolean arg0, @OriginalArg(2) boolean arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		@Pc(8) int local8 = arg2 - this.anInt2645;
		@Pc(13) int local13 = arg5 - this.anInt2647;
		if (arg4 == 0) {
			if (arg3 == 0) {
				this.method1669(local13, local8, 128);
				this.method1669(local13 - 1, local8, 8);
			}
			if (arg3 == 1) {
				this.method1669(local13, local8, 2);
				this.method1669(local13, local8 + 1, 32);
			}
			if (arg3 == 2) {
				this.method1669(local13, local8, 8);
				this.method1669(local13 + 1, local8, 128);
			}
			if (arg3 == 3) {
				this.method1669(local13, local8, 32);
				this.method1669(local13, local8 - 1, 2);
			}
		}
		if (arg4 == 1 || arg4 == 3) {
			if (arg3 == 0) {
				this.method1669(local13, local8, 1);
				this.method1669(local13 - 1, local8 - -1, 16);
			}
			if (arg3 == 1) {
				this.method1669(local13, local8, 4);
				this.method1669(local13 + 1, local8 + 1, 64);
			}
			if (arg3 == 2) {
				this.method1669(local13, local8, 16);
				this.method1669(local13 + 1, local8 + -1, 1);
			}
			if (arg3 == 3) {
				this.method1669(local13, local8, 64);
				this.method1669(local13 - 1, local8 + -1, 4);
			}
		}
		if (arg4 == 2) {
			if (arg3 == 0) {
				this.method1669(local13, local8, 130);
				this.method1669(local13 - 1, local8, 8);
				this.method1669(local13, local8 + 1, 32);
			}
			if (arg3 == 1) {
				this.method1669(local13, local8, 10);
				this.method1669(local13, local8 + 1, 32);
				this.method1669(local13 + 1, local8, 128);
			}
			if (arg3 == 2) {
				this.method1669(local13, local8, 40);
				this.method1669(local13 + 1, local8, 128);
				this.method1669(local13, local8 - 1, 2);
			}
			if (arg3 == 3) {
				this.method1669(local13, local8, 160);
				this.method1669(local13, local8 - 1, 2);
				this.method1669(local13 - 1, local8, 8);
			}
		}
		if (arg0) {
			if (arg4 == 0) {
				if (arg3 == 0) {
					this.method1669(local13, local8, 65536);
					this.method1669(local13 - 1, local8, 4096);
				}
				if (arg3 == 1) {
					this.method1669(local13, local8, 1024);
					this.method1669(local13, local8 + 1, 16384);
				}
				if (arg3 == 2) {
					this.method1669(local13, local8, 4096);
					this.method1669(local13 + 1, local8, 65536);
				}
				if (arg3 == 3) {
					this.method1669(local13, local8, 16384);
					this.method1669(local13, local8 - 1, 1024);
				}
			}
			if (arg4 == 1 || arg4 == 3) {
				if (arg3 == 0) {
					this.method1669(local13, local8, 512);
					this.method1669(local13 - 1, local8 + 1, 8192);
				}
				if (arg3 == 1) {
					this.method1669(local13, local8, 2048);
					this.method1669(local13 + 1, local8 + 1, 32768);
				}
				if (arg3 == 2) {
					this.method1669(local13, local8, 8192);
					this.method1669(local13 + 1, local8 + -1, 512);
				}
				if (arg3 == 3) {
					this.method1669(local13, local8, 32768);
					this.method1669(local13 - 1, local8 + -1, 2048);
				}
			}
			if (arg4 == 2) {
				if (arg3 == 0) {
					this.method1669(local13, local8, 66560);
					this.method1669(local13 - 1, local8, 4096);
					this.method1669(local13, local8 + 1, 16384);
				}
				if (arg3 == 1) {
					this.method1669(local13, local8, 5120);
					this.method1669(local13, local8 + 1, 16384);
					this.method1669(local13 + 1, local8, 65536);
				}
				if (arg3 == 2) {
					this.method1669(local13, local8, 20480);
					this.method1669(local13 + 1, local8, 65536);
					this.method1669(local13, local8 - 1, 1024);
				}
				if (arg3 == 3) {
					this.method1669(local13, local8, 81920);
					this.method1669(local13, local8 - 1, 1024);
					this.method1669(local13 - 1, local8, 4096);
				}
			}
		...
		if (arg4 == 0) {
			if (arg3 == 0) {
				this.method1669(local13, local8, 536870912);
				this.method1669(local13 - 1, local8, 33554432);
			}
			if (arg3 == 1) {
				this.method1669(local13, local8, 8388608);
				this.method1669(local13, local8 + 1, 134217728);
			}
			if (arg3 == 2) {
				this.method1669(local13, local8, 33554432);
				this.method1669(local13 + 1, local8, 536870912);
			}
			if (arg3 == 3) {
				this.method1669(local13, local8, 134217728);
				this.method1669(local13, local8 - 1, 8388608);
			}
		}
		if (arg4 == 1 || arg4 == 3) {
			if (arg3 == 0) {
				this.method1669(local13, local8, 4194304);
				this.method1669(local13 - 1, local8 + 1, 67108864);
			}
			if (arg3 == 1) {
				this.method1669(local13, local8, 16777216);
				this.method1669(local13 + 1, local8 - -1, 268435456);
			}
			if (arg3 == 2) {
				this.method1669(local13, local8, 67108864);
				this.method1669(local13 + 1, local8 + -1, 4194304);
			}
			if (arg3 == 3) {
				this.method1669(local13, local8, 268435456);
				this.method1669(local13 - 1, local8 + -1, 16777216);
			}
		}
		if (arg4 != 2) {
			return;
		...
		if (arg3 == 0) {
			this.method1669(local13, local8, 545259520);
			this.method1669(local13 - 1, local8, 33554432);
			this.method1669(local13, local8 + 1, 134217728);
		}
		if (arg3 == 1) {
			this.method1669(local13, local8, 41943040);
			this.method1669(local13, local8 + 1, 134217728);
			this.method1669(local13 + 1, local8, 536870912);
		}
		if (arg3 == 2) {
			this.method1669(local13, local8, 167772160);
			this.method1669(local13 + 1, local8, 536870912);
			this.method1669(local13, local8 - 1, 8388608);
		}
		if (arg3 == 3) {
			this.method1669(local13, local8, 671088640);
			this.method1669(local13, local8 - 1, 8388608);
			this.method1669(local13 - 1, local8, 33554432);
			return;
		}
	...
	public void method1661(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) boolean arg3, @OriginalArg(5) int arg4, @OriginalArg(6) boolean arg5) {
		@Pc(4) int local4 = arg4 - this.anInt2647;
		@Pc(17) int local17 = arg0 - this.anInt2645;
		if (arg2 == 0) {
			if (arg1 == 0) {
				this.method1657(local17, 128, local4);
				this.method1657(local17, 8, local4 - 1);
			}
			if (arg1 == 1) {
				this.method1657(local17, 2, local4);
				this.method1657(local17 + 1, 32, local4);
			}
			if (arg1 == 2) {
				this.method1657(local17, 8, local4);
				this.method1657(local17, 128, local4 + 1);
			}
			if (arg1 == 3) {
				this.method1657(local17, 32, local4);
				this.method1657(local17 - 1, 2, local4);
			}
		}
		if (arg2 == 1 || arg2 == 3) {
			if (arg1 == 0) {
				this.method1657(local17, 1, local4);
				this.method1657(local17 + 1, 16, local4 - 1);
			}
			if (arg1 == 1) {
				this.method1657(local17, 4, local4);
				this.method1657(local17 + 1, 64, local4 + 1);
			}
			if (arg1 == 2) {
				this.method1657(local17, 16, local4);
				this.method1657(local17 - 1, 1, local4 + 1);
			}
			if (arg1 == 3) {
				this.method1657(local17, 64, local4);
				this.method1657(local17 - 1, 4, local4 - 1);
			}
		}
		if (arg2 == 2) {
			if (arg1 == 0) {
				this.method1657(local17, 130, local4);
				this.method1657(local17, 8, local4 - 1);
				this.method1657(local17 + 1, 32, local4);
			}
			if (arg1 == 1) {
				this.method1657(local17, 10, local4);
				this.method1657(local17 + 1, 32, local4);
				this.method1657(local17, 128, local4 + 1);
			}
			if (arg1 == 2) {
				this.method1657(local17, 40, local4);
				this.method1657(local17, 128, local4 + 1);
				this.method1657(local17 - 1, 2, local4);
			}
			if (arg1 == 3) {
				this.method1657(local17, 160, local4);
				this.method1657(local17 - 1, 2, local4);
				this.method1657(local17, 8, local4 - 1);
			}
		}
		if (arg5) {
			if (arg2 == 0) {
				if (arg1 == 0) {
					this.method1657(local17, 65536, local4);
					this.method1657(local17, 4096, local4 - 1);
				}
				if (arg1 == 1) {
					this.method1657(local17, 1024, local4);
					this.method1657(local17 + 1, 16384, local4);
				}
				if (arg1 == 2) {
					this.method1657(local17, 4096, local4);
					this.method1657(local17, 65536, local4 + 1);
				}
				if (arg1 == 3) {
					this.method1657(local17, 16384, local4);
					this.method1657(local17 - 1, 1024, local4);
				}
			}
			if (arg2 == 1 || arg2 == 3) {
				if (arg1 == 0) {
					this.method1657(local17, 512, local4);
					this.method1657(local17 + 1, 8192, local4 - 1);
				}
				if (arg1 == 1) {
					this.method1657(local17, 2048, local4);
					this.method1657(local17 + 1, 32768, local4 + 1);
				}
				if (arg1 == 2) {
					this.method1657(local17, 8192, local4);
					this.method1657(local17 - 1, 512, local4 + 1);
				}
				if (arg1 == 3) {
					this.method1657(local17, 32768, local4);
					this.method1657(local17 - 1, 2048, local4 - 1);
				}
			}
			if (arg2 == 2) {
				if (arg1 == 0) {
					this.method1657(local17, 66560, local4);
					this.method1657(local17, 4096, local4 - 1);
					this.method1657(local17 + 1, 16384, local4);
				}
				if (arg1 == 1) {
					this.method1657(local17, 5120, local4);
					this.method1657(local17 + 1, 16384, local4);
					this.method1657(local17, 65536, local4 + 1);
				}
				if (arg1 == 2) {
					this.method1657(local17, 20480, local4);
					this.method1657(local17, 65536, local4 + 1);
					this.method1657(local17 - 1, 1024, local4);
				}
				if (arg1 == 3) {
					this.method1657(local17, 81920, local4);
					this.method1657(local17 - 1, 1024, local4);
					this.method1657(local17, 4096, local4 - 1);
				}
			}
		...
		if (arg2 == 0) {
			if (arg1 == 0) {
				this.method1657(local17, 536870912, local4);
				this.method1657(local17, 33554432, local4 - 1);
			}
			if (arg1 == 1) {
				this.method1657(local17, 8388608, local4);
				this.method1657(local17 + 1, 134217728, local4);
			}
			if (arg1 == 2) {
				this.method1657(local17, 33554432, local4);
				this.method1657(local17, 536870912, local4 + 1);
			}
			if (arg1 == 3) {
				this.method1657(local17, 134217728, local4);
				this.method1657(local17 - 1, 8388608, local4);
			}
		}
		if (arg2 == 1 || arg2 == 3) {
			if (arg1 == 0) {
				this.method1657(local17, 4194304, local4);
				this.method1657(local17 + 1, 67108864, local4 - 1);
			}
			if (arg1 == 1) {
				this.method1657(local17, 16777216, local4);
				this.method1657(local17 + 1, 268435456, local4 + 1);
			}
			if (arg1 == 2) {
				this.method1657(local17, 67108864, local4);
				this.method1657(local17 - 1, 4194304, local4 + 1);
			}
			if (arg1 == 3) {
				this.method1657(local17, 268435456, local4);
				this.method1657(local17 - 1, 16777216, local4 - 1);
			}
		}
		if (arg2 != 2) {
			return;
		...
		if (arg1 == 0) {
			this.method1657(local17, 545259520, local4);
			this.method1657(local17, 33554432, local4 - 1);
			this.method1657(local17 + 1, 134217728, local4);
		}
		if (arg1 == 1) {
			this.method1657(local17, 41943040, local4);
			this.method1657(local17 + 1, 134217728, local4);
			this.method1657(local17, 536870912, local4 + 1);
		}
		if (arg1 == 2) {
			this.method1657(local17, 167772160, local4);
			this.method1657(local17, 536870912, local4 + 1);
			this.method1657(local17 - 1, 8388608, local4);
		}
		if (arg1 == 3) {
			this.method1657(local17, 671088640, local4);
			this.method1657(local17 - 1, 8388608, local4);
			this.method1657(local17, 33554432, local4 - 1);
			return;
		}
	...
	public boolean method1662(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7) {
		if (arg4 > 1) {
			return Static275.method2781(arg2, arg4, arg3, arg6, arg5, arg7, arg0, arg4) ? true : this.method1658(arg4, arg0, arg4, arg3, arg2, arg1, arg5, arg7, arg6);
		}
	...
	public boolean method1663(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		if (arg0 == 1) {
	...
	public void method1664(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public void method1666(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		@Pc(7) int local7 = 256;
		if (arg0) {
			local7 = 131328;
		}
			...
			if (local35 >= 0 && this.anInt2643 > local35) {
				for (@Pc(69) int local69 = local18; local69 < local18 + arg4; local69++) {
					if (local69 >= 0 && local69 < this.anInt2653) {
						this.method1657(local69, local7, local35);
					}
				}
			}
		}
	...
	public void method1667(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public void method1668(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	private void method1669(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anIntArrayArray65[arg0][arg1] |= arg2;
	}

	@OriginalMember(owner = "client!eq", name = "a", descriptor = "(IIIIZIZ)V")
	public void method1670(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) boolean arg3, @OriginalArg(5) int arg4, @OriginalArg(6) boolean arg5) {
		@Pc(5) int local5 = 256;
		if (arg5) {
			local5 = 131328;
		}
			...
			if (local34 >= 0 && this.anInt2643 > local34) {
				for (@Pc(52) int local52 = local22; local52 < arg1 + local22; local52++) {
					if (local52 >= 0 && this.anInt2653 > local52) {
						this.method1669(local34, local52, local5);
					}
				}
			}
		}
	...
	public void method1671(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		@Pc(20) int local20 = arg0 - this.anInt2645;
