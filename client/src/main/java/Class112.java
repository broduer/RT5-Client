...
public final class Class112 {
	...
	public Class112(@OriginalArg(0) Class377 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Class49 arg3, @OriginalArg(4) Class330 arg4, @OriginalArg(5) Class330 arg5) {
		...
		if (this.aClass330_29 == null) {
			...
			@Pc(54) int local54 = this.aClass330_29.method5361() - 1;
			this.anInt2670 = this.aClass330_29.method5372(local54) + local54 * 256;
		}
		if (this.aClass377_1 == Static673.aClass377_8) {
			this.aStringArray11 = new String[] { null, null, Static32.aClass32_8.method429(this.anInt2662), null, null, Static32.aClass32_22.method429(this.anInt2662) };
		} else {
			this.aStringArray11 = new String[] { null, null, Static32.aClass32_8.method429(this.anInt2662), null, null, null };
		}
		this.aStringArray10 = new String[] { null, null, null, null, Static32.aClass32_9.method429(this.anInt2662) };
	}
	...
	public Class23 method1676(@OriginalArg(0) int arg0, @OriginalArg(1) Class19 arg1, @OriginalArg(2) Class19 arg2, @OriginalArg(3) Class201 arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean arg7, @OriginalArg(8) int arg8, @OriginalArg(9) Class14 arg9, @OriginalArg(10) int arg10) {
		...
		if (arg6 > 1 && local34.anIntArray799 != null) {
			...
			if (local44 != -1) {
				local34 = this.method1684(local44);
			}
		}
		@Pc(101) int[] local101 = local34.method6285(arg8, arg2, arg6, arg5, arg7, arg3, arg1, arg9, arg0);
		if (local101 == null) {
			return null;
		}
		@Pc(119) Class23 local119;
		if (arg4) {
			local119 = arg1.a(36, 36, 32, local101, 0, 7468);
		} else {
			local119 = arg2.a(36, 36, 32, local101, 0, 7468);
		}
		if (!arg4) {
			...
			this.aClass16_1.method147(local119, local136);
		}
		return local119;
	}
	...
	public void method1677() {
		...
		synchronized (this.aClass82_57) {
			this.aClass82_57.method1381(5);
		}
		local14 = this.aClass82_58;
		synchronized (this.aClass82_58) {
			this.aClass82_58.method1381(5);
		}
	...
	public void method1678() {
		@Pc(6) Class82 local6 = this.aClass82_57;
		synchronized (this.aClass82_57) {
			this.aClass82_57.method1385();
		}
		local6 = this.aClass82_58;
		synchronized (this.aClass82_58) {
			this.aClass82_58.method1385();
		}
		@Pc(44) Class16 local44 = this.aClass16_1;
		synchronized (this.aClass16_1) {
			this.aClass16_1.method139();
		}
	}

	@OriginalMember(owner = "client!es", name = "b", descriptor = "(II)V")
	public void method1679(@OriginalArg(0) int arg0) {
		this.anInt2673 = arg0;
	...
	public Class23 method1681(@OriginalArg(0) Class201 arg0, @OriginalArg(2) Class19 arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		...
		return (Class23) this.aClass16_1.method146(this.aClass324_1);
	}
	...
	public void method1683(@OriginalArg(1) boolean arg0) {
	...
	public Class382 method1684(@OriginalArg(0) int arg0) {
		@Pc(14) Class82 local14 = this.aClass82_57;
		@Pc(26) Class382 local26;
		synchronized (this.aClass82_57) {
			local26 = (Class382) this.aClass82_57.method1390((long) arg0);
		}
		if (local26 != null) {
			return local26;
		}
		...
		synchronized (this.aClass330_29) {
			local53 = this.aClass330_29.method5359(Static223.method6534(arg0), Static593.method5520(arg0));
		}
		...
		if (local53 != null) {
			local26.method6278(new Class2_Sub21(local53));
		}
		local26.method6294();
		if (local26.anInt10087 != -1) {
			local26.method6280(this.method1684(local26.anInt10087), this.method1684(local26.anInt10110));
		}
		if (local26.anInt10083 != -1) {
			local26.method6279(this.method1684(local26.anInt10143), this.method1684(local26.anInt10083));
		}
		if (local26.anInt10144 != -1) {
			local26.method6296(this.method1684(local26.anInt10144), this.method1684(local26.anInt10114));
		}
		if (!this.aBoolean222 && local26.aBoolean770) {
			local26.aString118 = Static32.aClass32_5.method429(this.anInt2662);
			...
			if (local26.aClass28_44 != null) {
				...
				for (@Pc(200) Class2 local200 = local26.aClass28_44.method371(); local200 != null; local200 = local26.aClass28_44.method375()) {
					@Pc(209) Class296 local209 = this.aClass49_1.method681((int) local200.aLong328);
		...
		synchronized (this.aClass82_57) {
			this.aClass82_57.method1384(local26, (long) arg0);
			return local26;
		}
	}
}
