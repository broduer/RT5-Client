...
public abstract class Class114 {
	...
	public abstract void method7480(@OriginalArg(0) Class73 arg0, @OriginalArg(1) Class8_Sub6 arg1, @OriginalArg(2) int arg2);
	...
	private void method7482(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) boolean arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8) {
		@Pc(18) int local18;
		if (arg6 == 1) {
			if (arg1 == 0 || arg1 == 1) {
				local18 = -arg7;
		...
		if (arg2 == 65535) {
			this.method7506(arg1, arg3, arg7, arg8, arg0, arg6, arg5);
		} else {
	...
	public abstract void method7483(@OriginalArg(0) Class73 arg0);
	...
	public final void method7484(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) SecondaryNode_Sub18 arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) SecondaryNode_Sub18 arg5, @OriginalArg(7) SecondaryNode_Sub18 arg6, @OriginalArg(8) int arg7, @OriginalArg(9) boolean arg8, @OriginalArg(10) int arg9, @OriginalArg(11) SecondaryNode_Sub18 arg10, @OriginalArg(12) boolean[] arg11, @OriginalArg(13) int arg12, @OriginalArg(14) int arg13) {
		if (arg1 == -1) {
			return;
		}
		if (arg11 == null || arg13 == -1) {
			this.method7494(arg6, arg7, arg12, arg2, arg1, arg4, 0, arg8);
			return;
		}
		this.method7498();
		if (!this.NA()) {
		...
		@Pc(44) Class255 local44 = arg6.aClass255Array1[arg1];
		@Pc(47) Node_Sub44 local47 = local44.aClass2_Sub44_1;
		@Pc(49) Class255 local49 = null;
		if (arg2 != null) {
			local49 = arg2.aClass255Array1[arg4];
		...
		if (arg5 != null) {
			local83 = arg5.aClass255Array1[arg3];
	...
	public abstract SecondaryNode_Sub9 ba(@OriginalArg(0) SecondaryNode_Sub9 arg0);

	@OriginalMember(owner = "client!ka", name = "e", descriptor = "()V")
	public abstract void method7486();
	...
	public abstract Class251[] method7487();

	@OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lclient!ka;IIIZ)V")
	public abstract void method7488(@OriginalArg(0) Class114 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4);
	...
	public abstract Class330[] method7489();

	@OriginalMember(owner = "client!ka", name = "a", descriptor = "(IILclient!tt;ZII)Z")
	public abstract boolean method7490(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class73 arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5);
	...
	public abstract void method7491(@OriginalArg(0) Class73 arg0, @OriginalArg(1) Class8_Sub6 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3);

	@OriginalMember(owner = "client!ka", name = "a", descriptor = "(IILclient!tt;ZI)Z")
	public abstract boolean method7493(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class73 arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4);

	@OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lclient!rw;IILclient!rw;IIIIZ)V")
	public final void method7494(@OriginalArg(0) SecondaryNode_Sub18 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) SecondaryNode_Sub18 arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) boolean arg7) {
		if (arg4 == -1) {
			return;
		}
		this.method7498();
		...
		@Pc(23) Class255 local23 = arg0.aClass255Array1[arg4];
		@Pc(26) Node_Sub44 local26 = local23.aClass2_Sub44_1;
		@Pc(28) Class255 local28 = null;
		if (arg3 != null) {
			local28 = arg3.aClass255Array1[arg5];
	...
	public abstract void method7495(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3);
	...
	public abstract byte[] method7496();
	...
	protected final void method7497(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) Class178 arg6, @OriginalArg(8) int arg7) {
		@Pc(24) int local24 = -arg3 / 2;
		@Pc(29) int local29 = -arg5 / 2;
		@Pc(40) int local40 = arg6.method7885(local29 + arg4, arg2 - -local24);
		@Pc(44) int local44 = arg3 / 2;
		@Pc(49) int local49 = -arg5 / 2;
		@Pc(61) int local61 = arg6.method7885(local49 + arg4, arg2 + local44);
		@Pc(66) int local66 = -arg3 / 2;
		@Pc(70) int local70 = arg5 / 2;
		@Pc(82) int local82 = arg6.method7885(local70 + arg4, local66 + arg2);
		@Pc(86) int local86 = arg3 / 2;
		@Pc(90) int local90 = arg5 / 2;
		@Pc(101) int local101 = arg6.method7885(local90 + arg4, arg2 - -local86);
	...
	public abstract void method7499(@OriginalArg(0) Class73 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2);

	@OriginalMember(owner = "client!ka", name = "a", descriptor = "(IILclient!rw;)V")
	public final void method7500(@OriginalArg(0) int arg0, @OriginalArg(2) SecondaryNode_Sub18 arg1) {
		if (arg0 == -1) {
			return;
		}
		this.method7498();
		...
		@Pc(33) Class255 local33 = arg1.aClass255Array1[arg0];
		@Pc(36) Node_Sub44 local36 = local33.aClass2_Sub44_1;
		for (@Pc(38) int local38 = 0; local38 < local33.anInt6379; local38++) {
	...
	protected abstract void method7501();

	@OriginalMember(owner = "client!ka", name = "a", descriptor = "(BIZ)Lclient!ka;")
	public abstract Class114 method7502(@OriginalArg(0) byte arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2);
	...
	public final void method7503(@OriginalArg(0) int arg0, @OriginalArg(1) SecondaryNode_Sub18 arg1, @OriginalArg(2) SecondaryNode_Sub18 arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int[] arg4, @OriginalArg(7) int arg5, @OriginalArg(8) boolean arg6, @OriginalArg(9) int arg7, @OriginalArg(10) int arg8) {
		if (arg3 == -1) {
			return;
		}
		this.method7498();
		...
		@Pc(29) Class255 local29 = arg1.aClass255Array1[arg3];
		@Pc(32) Node_Sub44 local32 = local29.aClass2_Sub44_1;
		@Pc(34) Class255 local34 = null;
		if (arg2 != null) {
			local34 = arg2.aClass255Array1[arg7];
	...
	private void method7504(@OriginalArg(0) Class255 arg0, @OriginalArg(1) boolean[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(5) int[] arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class255 arg7, @OriginalArg(9) Node_Sub44 arg8, @OriginalArg(10) int arg9, @OriginalArg(11) boolean arg10) {
		@Pc(11) int local11;
		if (arg0 == null || arg2 == 0) {
			for (local11 = 0; local11 < arg7.anInt6379; local11++) {
				...
				if (arg1 == null || arg3 == arg1[local17] || arg8.anIntArray619[local17] == 0) {
					...
					if (local43 != -1) {
						this.method7482(0, 0, arg9 & arg8.anIntArray618[local43], arg8.anIntArrayArray196[local43], arg4, arg10, arg5, 0, 0);
					}
					this.method7482(arg7.aShortArray89[local11], arg8.anIntArray619[local17], arg9 & arg8.anIntArray618[local17], arg8.anIntArrayArray196[local17], arg4, arg10, arg5, arg7.aShortArray93[local11], arg7.aShortArray94[local11]);
				}
			}
			return;
		}
		...
		for (@Pc(123) int local123 = 0; local123 < arg8.anInt7713; local123++) {
			@Pc(126) boolean local126 = false;
			if (arg7.anInt6379 > local11 && local123 == arg7.aShortArray87[local11]) {
				local126 = true;
			}
			@Pc(146) boolean local146 = false;
			if (arg0.anInt6379 > local116 && local123 == arg0.aShortArray87[local116]) {
				local146 = true;
			}
			if (local126 || local146) {
				if (arg1 == null || arg1[local123] == arg3 || arg8.anIntArray619[local123] == 0) {
					...
					if (local233 != -1) {
						this.method7482(0, 0, arg9 & arg8.anIntArray618[local233], arg8.anIntArrayArray196[local233], arg4, arg10, arg5, 0, 0);
					} else if (local287 != -1) {
						this.method7482(0, 0, arg9 & arg8.anIntArray618[local287], arg8.anIntArrayArray196[local287], arg4, arg10, arg5, 0, 0);
					}
					@Pc(423) int local423;
					@Pc(413) int local413;
					@Pc(439) int local439;
					...
					this.method7482(local439, local211, arg8.anIntArray618[local123] & arg9, arg8.anIntArrayArray196[local123], arg4, arg10, arg5, local423, local413);
				} else {
					if (local146) {
						local116++;
					}
	...
	public abstract void method7505(@OriginalArg(0) byte arg0, @OriginalArg(1) byte[] arg1);
	...
	protected abstract void method7506(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) boolean arg6);
