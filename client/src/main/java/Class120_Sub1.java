...
public final class Class120_Sub1 extends Class120 implements MouseListener, MouseMotionListener, MouseWheelListener {
	...
	public synchronized void mouseReleased(@OriginalArg(0) MouseEvent arg0) {
		@Pc(4) int local4 = this.method2633(arg0);
		if ((this.anInt4135 & local4) == 0) {
			local4 = this.anInt4135;
		}
		if ((local4 & 0x1) != 0) {
			this.method2630(arg0.getY(), arg0.getX(), 3, arg0.getClickCount());
		}
		if ((local4 & 0x4) != 0) {
			this.method2630(arg0.getY(), arg0.getX(), 5, arg0.getClickCount());
		}
		if ((local4 & 0x2) != 0) {
			this.method2630(arg0.getY(), arg0.getX(), 4, arg0.getClickCount());
		}
	...
	private void method2630(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3) {
		@Pc(3) Class2_Sub9_Sub1 local3 = new Class2_Sub9_Sub1();
		local3.anInt1889 = arg1;
		local3.anInt1888 = arg2;
		local3.anInt1887 = arg0;
		local3.aLong68 = Static588.method5469();
		local3.anInt1890 = arg3;
		this.aClass339_21.method5465(local3);
	}

	@OriginalMember(owner = "client!ht", name = "a", descriptor = "(ZII)V")
	private void method2631(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		this.anInt4137 = arg1;
		this.anInt4136 = arg0;
		if (this.aBoolean321) {
			this.method2630(arg0, arg1, -1, 0);
		}
	}
	...
	public Class2_Sub9 method6317() {
		return (Class2_Sub9) this.aClass339_20.method5459();
	}

	@OriginalMember(owner = "client!ht", name = "a", descriptor = "(ILjava/awt/Component;)V")
	private void method2632(@OriginalArg(0) int arg0, @OriginalArg(1) Component arg1) {
		if (arg0 != -30273) {
			return;
		}
		this.method2634();
	...
	private int method2633(@OriginalArg(0) MouseEvent arg0) {
		if (arg0.getButton() == 1) {
	...
	public synchronized void mouseWheelMoved(@OriginalArg(0) MouseWheelEvent arg0) {
		...
		this.method2630(local5, local2, 6, local8);
		arg0.consume();
	}
	...
	public synchronized void mouseExited(@OriginalArg(0) MouseEvent arg0) {
		this.method2631(arg0.getY(), arg0.getX());
	}
	...
	public synchronized void mousePressed(@OriginalArg(0) MouseEvent arg0) {
		@Pc(4) int local4 = this.method2633(arg0);
		if (local4 == 1) {
			this.method2630(arg0.getY(), arg0.getX(), 0, arg0.getClickCount());
		} else if (local4 == 4) {
			this.method2630(arg0.getY(), arg0.getX(), 2, arg0.getClickCount());
		} else if (local4 == 2) {
			this.method2630(arg0.getY(), arg0.getX(), 1, arg0.getClickCount());
		}
		this.anInt4135 |= local4;
		if (arg0.isPopupTrigger()) {
			arg0.consume();
