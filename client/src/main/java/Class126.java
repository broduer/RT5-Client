...
public final class Class126 {
	...
	public int method1810(@OriginalArg(0) int arg0) {
		if (arg0 != 16383) {
			this.method1813(27, -51, 39, -81);
		}
		return this.anInt2889 & 0x3FFF;
	}

	@OriginalMember(owner = "client!ffa", name = "a", descriptor = "(BI)V")
	public void method1812(@OriginalArg(0) byte arg0, @OriginalArg(1) int arg1) {
		this.anInt2889 = arg1;
		if (arg0 >= 46) {
			this.anInt2891 = 0;
		}
	...
	public boolean method1813(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
