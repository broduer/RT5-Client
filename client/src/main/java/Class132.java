...
public abstract class Class132 {
	...
	public final void finalize() throws Throwable {
		this.aClass19_Sub3_25.method4846(this.anInt5571, this.anInt5572);
		super.finalize();
	}

	@OriginalMember(owner = "client!gj", name = "a", descriptor = "(BI[B)V")
	protected final void method3484(@OriginalArg(1) int arg0, @OriginalArg(2) byte[] arg1) {
		this.method3486();
	...
	protected abstract void method3486();
}
