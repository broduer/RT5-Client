...
public final class Class132_Sub2 extends Class132 implements Interface12 {
	...
	@Override
	protected void method3486() {
		super.aClass19_Sub3_25.method4840(this);
	}

	@OriginalMember(owner = "client!kma", name = "a", descriptor = "([BIIB)V")
	@Override
	public void method3489(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.method3484(arg1, arg0);
		this.anInt5581 = arg2;
	}
}
