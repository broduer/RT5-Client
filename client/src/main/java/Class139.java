...
public final class Class139 {
	...
	public Class139(@OriginalArg(0) int arg0, @OriginalArg(1) Class330 arg1, @OriginalArg(2) Class330 arg2, @OriginalArg(3) Interface19 arg3) {
		...
		if (this.aClass330_40 != null) {
			this.anInt3264 = this.aClass330_40.method5372(1);
		}
		if (this.aClass330_41 != null) {
			this.anInt3261 = this.aClass330_41.method5372(1);
		}
	}

	@OriginalMember(owner = "client!gba", name = "a", descriptor = "(Lclient!it;J[II)Ljava/lang/String;")
	public String method2053(@OriginalArg(0) Class184 arg0, @OriginalArg(1) long arg1, @OriginalArg(2) int[] arg2) {
		if (this.anInterface19_1 != null) {
			@Pc(22) String local22 = this.anInterface19_1.method3992(arg1, arg0, arg2);
			if (local22 != null) {
				return local22;
			}
		}
	...
	public Class2_Sub2_Sub12 method2055(@OriginalArg(0) int arg0) {
		@Pc(11) Class2_Sub2_Sub12 local11 = (Class2_Sub2_Sub12) this.aClass82_70.method1390((long) arg0);
		if (local11 != null) {
			return local11;
		}
		@Pc(28) byte[] local28;
		if (arg0 >= 32768) {
			local28 = this.aClass330_41.method5359(arg0 & 0x7FFF, 1);
		} else {
			local28 = this.aClass330_40.method5359(arg0, 1);
		}
		local11 = new Class2_Sub2_Sub12();
		local11.aClass139_1 = this;
		if (local28 != null) {
			local11.method2728(new Class2_Sub21(local28));
		}
		if (arg0 >= 32768) {
			local11.method2731();
		}
		this.aClass82_70.method1384(local11, (long) arg0);
		return local11;
	}
}
