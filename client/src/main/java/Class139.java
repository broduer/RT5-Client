...
public final class Class139 {
	...
	private final Class332 aClass332_40;

	@OriginalMember(owner = "client!gba", name = "b", descriptor = "Lclient!sb;")
	private final Class332 aClass332_41;

	@OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(ILclient!sb;Lclient!sb;Lclient!raa;)V")
	public Class139(@OriginalArg(0) int arg0, @OriginalArg(1) Class332 arg1, @OriginalArg(2) Class332 arg2, @OriginalArg(3) Interface19 arg3) {
		this.anInterface19_1 = arg3;
		this.aClass332_40 = arg1;
		this.aClass332_41 = arg2;
		if (this.aClass332_40 != null) {
			this.anInt3273 = this.aClass332_40.method7615(1);
		}
		if (this.aClass332_41 != null) {
			this.anInt3270 = this.aClass332_41.method7615(1);
		}
	}
	...
	public Class2_Sub2_Sub12 method2950(@OriginalArg(0) int arg0) {
		...
		@Pc(28) byte[] local28;
		if (arg0 >= 32768) {
			local28 = this.aClass332_41.method7602(arg0 & 0x7FFF, 1);
		} else {
			local28 = this.aClass332_40.method7602(arg0, 1);
		}
