...
public abstract class Class14 {
	...
	private final Class383 aClass383_12;

	@OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lclient!ha;Lclient!ve;)V")
	protected Class14(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class383 arg1) {
		this.aClass19_16 = arg0;
		this.aClass383_12 = arg1;
	}

	@OriginalMember(owner = "client!da", name = "a", descriptor = "([Lclient!st;IIIILjava/lang/String;[IILjava/util/Random;I)I")
	public final int method8823(@OriginalArg(0) Class23[] arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(5) String arg3, @OriginalArg(6) int[] arg4, @OriginalArg(8) Random arg5, @OriginalArg(9) int arg6) {
		if (arg3 == null) {
			return 0;
		}
		arg5.setSeed(arg1);
	...
	protected abstract void method8824(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class1 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);

	@OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIILjava/lang/String;II)V")
	public final void method8825(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) String arg5) {
		if (arg5 == null) {
			return;
		}
	...
	private void method8827(@OriginalArg(0) int[] arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class23[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(7) int[] arg6) {
		@Pc(7) int local7 = arg2 - this.aClass383_12.anInt10054;
		@Pc(13) int local13 = -1;
		@Pc(15) int local15 = -1;
		@Pc(17) int local17 = 0;
		...
		for (@Pc(29) int local29 = 0; local29 < local20; local29++) {
			...
			if (local40 == '<') {
						...
						if (!local64.equals("reg")) {
							if (local64.startsWith("img=")) {
								try {
									...
									local17++;
									@Pc(187) int local187 = Static647.method8480(local64.substring(4));
									@Pc(191) Class23 local191 = arg3[local187];
									@Pc(201) int local201 = arg6 == null ? local191.method8199() : arg6[local187];
									local191.method8204(local164 + arg4, local174 + -local201 + local7 + this.aClass383_12.anInt10054, 1, 0, 1);
									local15 = -1;
									arg4 += arg3[local187].method8210();
								} catch (@Pc(230) Exception local230) {
								}
							} else {
								this.method8838(local64);
							}
							continue;
						}
						local40 = '®';
				...
				if (local13 == -1) {
					if (local15 != -1) {
						arg4 += this.aClass383_12.method8744(local40, local15);
					}
					@Pc(268) int local268;
					if (arg0 == null) {
						local268 = 0;
					...
					if (local40 != ' ') {
						if ((Static65.anInt1543 & 0xFF000000) != 0) {
							this.fa(local40, arg4 + local268 + 1, local164 + (local7 - -1), Static65.anInt1543, true);
						}
						this.fa(local40, arg4 + local268, local164 + local7, Static658.anInt9827, false);
					} else if (Static38.anInt926 > 0) {
						Static558.anInt3196 += Static38.anInt926;
						arg4 += Static558.anInt3196 >> 8;
						Static558.anInt3196 &= 0xFF;
					}
					local17++;
					local174 = this.aClass383_12.method8745(local40);
					if (Static633.anInt10926 != -1) {
						this.aClass19_16.method7998((int) ((double) this.aClass383_12.anInt10054 * 0.7D) + local7, Static633.anInt10926, arg4, local174);
					}
					if (Static698.anInt10538 != -1) {
						this.aClass19_16.method7998(this.aClass383_12.anInt10054 + local7, Static698.anInt10538, arg4, local174);
					}
					arg4 += local174;
					local15 = local40;
				}
	...
	private void method8829(@OriginalArg(1) int arg0, @OriginalArg(2) String arg1) {
		@Pc(5) int local5 = 0;
		...
		if (local5 > 0) {
			Static38.anInt926 = (arg0 - this.aClass383_12.method8751(arg1) << 8) / local5;
		}
	}

	@OriginalMember(owner = "client!da", name = "a", descriptor = "([Lclient!st;IILjava/lang/String;IZLclient!aa;I[I)V")
	private void method8831(@OriginalArg(0) Class23[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) String arg3, @OriginalArg(4) int arg4, @OriginalArg(6) Class1 arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int[] arg7) {
		@Pc(5) int local5 = arg6 - this.aClass383_12.anInt10054;
		@Pc(11) int local11 = -1;
		@Pc(18) int local18 = -1;
		...
		for (@Pc(23) int local23 = 0; local23 < local21; local23++) {
			...
			if (local33 == '<') {
						...
						if (!local54.equals("reg")) {
							if (local54.startsWith("img=")) {
								try {
									...
									local18 = -1;
									arg4 += arg0[local136].method8210();
								} catch (@Pc(202) Exception local202) {
								}
							} else {
								this.method8838(local54);
							}
							continue;
						}
						local33 = '®';
				...
				if (local11 == -1) {
					if (local18 != -1) {
						arg4 += this.aClass383_12.method8744(local33, local18);
					}
					if (local33 == ' ') {
						if (Static38.anInt926 > 0) {
							Static558.anInt3196 += Static38.anInt926;
							arg4 += Static558.anInt3196 >> 8;
							Static558.anInt3196 &= 0xFF;
						}
						...
						if ((Static65.anInt1543 & 0xFF000000) != 0) {
							this.fa(local33, arg4 + 1, local5 - -1, Static65.anInt1543, true);
						}
						this.fa(local33, arg4, local5, Static658.anInt9827, false);
					} else {
						if ((Static65.anInt1543 & 0xFF000000) != 0) {
							this.method8824(local33, arg4 + 1, local5 - -1, Static65.anInt1543, true, arg5, arg2, arg1);
						}
						this.method8824(local33, arg4, local5, Static658.anInt9827, false, arg5, arg2, arg1);
					}
					@Pc(328) int local328 = this.aClass383_12.method8745(local33);
					if (Static633.anInt10926 != -1) {
						this.aClass19_16.method7998(local5 + (int) ((double) this.aClass383_12.anInt10054 * 0.7D), Static633.anInt10926, arg4, local328);
					}
					if (Static698.anInt10538 != -1) {
						this.aClass19_16.method7998(this.aClass383_12.anInt10054 + local5 + 1, Static698.anInt10538, arg4, local328);
					}
					local18 = local33;
					arg4 += local328;
				}
	...
	private void method8832(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		Static38.anInt926 = 0;
		Static655.anInt9793 = arg0;
		Static658.anInt9827 = arg0;
		Static558.anInt3196 = 0;
		Static698.anInt10538 = -1;
		Static633.anInt10926 = -1;
		if (arg1 == -1) {
			arg1 = 0;
		}
		Static655.anInt9792 = arg1;
		Static65.anInt1543 = arg1;
	}

	@OriginalMember(owner = "client!da", name = "a", descriptor = "(I[IILjava/lang/String;Lclient!aa;[Lclient!st;IIIIIIIIII)I")
	public final int method8833(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) String arg3, @OriginalArg(4) Class1 arg4, @OriginalArg(5) Class23[] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9, @OriginalArg(11) int arg10, @OriginalArg(12) int arg11, @OriginalArg(13) int arg12, @OriginalArg(14) int arg13, @OriginalArg(15) int arg14) {
		return this.method8837(arg11, arg2, arg7, arg5, 0, arg0, arg6, arg14, arg8, arg4, arg12, arg13, arg10, arg9, arg1, arg3);
	}
	...
	public final int method8837(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) Class23[] arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class1 arg9, @OriginalArg(11) int arg10, @OriginalArg(12) int arg11, @OriginalArg(13) int arg12, @OriginalArg(14) int arg13, @OriginalArg(15) int[] arg14, @OriginalArg(16) String arg15) {
		if (arg15 == null) {
			return 0;
		}
		this.method8832(arg1, arg2);
		if (arg10 == 0) {
			arg10 = this.aClass383_12.anInt10054;
		}
		@Pc(81) int[] local81;
		if (arg10 + this.aClass383_12.anInt10063 + this.aClass383_12.anInt10057 > arg7 && arg7 < arg10 + arg10) {
			local81 = null;
		} else {
			local81 = new int[] { arg11 };
		}
		@Pc(93) int local93 = this.aClass383_12.method8747(Static11.aStringArray2, local81, arg3, arg15);
		if (arg4 == -1) {
			arg4 = arg7 / arg10;
			if (arg4 <= 0) {
				arg4 = 1;
		...
		if (arg4 > 0 && arg4 <= local93) {
			local93 = arg4;
			Static11.aStringArray2[arg4 - 1] = this.aClass383_12.method8750(Static11.aStringArray2[arg4 - 1], arg3, arg11);
		}
		if (arg0 == 3 && local93 == 1) {
			arg0 = 1;
		}
		...
		@Pc(233) int local233;
		if (arg0 == 0) {
			local190 = this.aClass383_12.anInt10057 + arg6;
		} else if (arg0 == 1) {
			local190 = (arg7 - this.aClass383_12.anInt10063 - this.aClass383_12.anInt10057 - arg10 * (local93 + -1)) / 2 + this.aClass383_12.anInt10057 + arg6;
		} else if (arg0 == 2) {
			local190 = arg7 + arg6 - arg10 * (local93 - 1) - this.aClass383_12.anInt10063;
		} else {
			local233 = (arg7 - this.aClass383_12.anInt10057 - this.aClass383_12.anInt10063 - arg10 * (local93 - 1)) / (local93 + 1);
			if (local233 < 0) {
				local233 = 0;
			}
			arg10 += local233;
			local190 = arg6 + this.aClass383_12.anInt10057 + local233;
		}
		for (local233 = 0; local233 < local93; local233++) {
			if (arg13 == 0) {
				this.method8831(arg3, arg5, arg8, Static11.aStringArray2[local233], arg12, arg9, local190, arg14);
			} else if (arg13 == 1) {
				this.method8831(arg3, arg5, arg8, Static11.aStringArray2[local233], arg12 + (arg11 - this.aClass383_12.method8751(Static11.aStringArray2[local233])) / 2, arg9, local190, arg14);
			} else if (arg13 == 2) {
				this.method8831(arg3, arg5, arg8, Static11.aStringArray2[local233], arg12 + arg11 - this.aClass383_12.method8751(Static11.aStringArray2[local233]), arg9, local190, arg14);
			} else if (local93 - 1 == local233) {
				this.method8831(arg3, arg5, arg8, Static11.aStringArray2[local233], arg12, arg9, local190, arg14);
			} else {
				this.method8829(arg11, Static11.aStringArray2[local233]);
				this.method8831(arg3, arg5, arg8, Static11.aStringArray2[local233], arg12, arg9, local190, arg14);
				Static38.anInt926 = 0;
			}
			local190 += arg10;
	...
	private void method8838(@OriginalArg(1) String arg0) {
		try {
			if (arg0.startsWith("col=")) {
				Static658.anInt9827 = Static658.anInt9827 & 0xFF000000 | Static12.method5169(arg0.substring(4)) & 0xFFFFFF;
			} else if (arg0.equals("/col")) {
				Static658.anInt9827 = Static658.anInt9827 & 0xFF000000 | Static655.anInt9793 & 0xFFFFFF;
			}
			if (arg0.startsWith("argb=")) {
				Static658.anInt9827 = Static12.method5169(arg0.substring(5));
			} else if (arg0.equals("/argb")) {
				Static658.anInt9827 = Static655.anInt9793;
			} else if (arg0.startsWith("str=")) {
				Static633.anInt10926 = Static658.anInt9827 & 0xFF000000 | Static12.method5169(arg0.substring(4));
			} else if (arg0.equals("str")) {
				Static633.anInt10926 = Static658.anInt9827 & 0xFF000000 | 0x800000;
			} else if (arg0.equals("/str")) {
				Static633.anInt10926 = -1;
			} else if (arg0.startsWith("u=")) {
				Static698.anInt10538 = Static658.anInt9827 & 0xFF000000 | Static12.method5169(arg0.substring(2));
			} else if (arg0.equals("u")) {
				Static698.anInt10538 = Static658.anInt9827 & 0xFF000000;
			} else if (arg0.equals("/u")) {
				Static698.anInt10538 = -1;
			} else if (arg0.equalsIgnoreCase("shad=-1")) {
				Static65.anInt1543 = 0;
			} else if (arg0.startsWith("shad=")) {
				Static65.anInt1543 = Static658.anInt9827 & 0xFF000000 | Static12.method5169(arg0.substring(5));
			} else if (arg0.equals("shad")) {
				Static65.anInt1543 = Static658.anInt9827 & 0xFF000000;
			} else if (arg0.equals("/shad")) {
				Static65.anInt1543 = Static655.anInt9792;
			} else if (arg0.equals("br")) {
				this.method8832(Static655.anInt9793, Static655.anInt9792);
			}
	...
	public final void method8839(@OriginalArg(1) int arg0, @OriginalArg(2) String arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		if (arg1 == null) {
			return;
		}
	...
	public final void method8840(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) String arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		if (arg2 == null) {
			return;
		}
	...
	public final int method8843(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int[] arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) Random arg6, @OriginalArg(8) String arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9, @OriginalArg(11) Class23[] arg10, @OriginalArg(12) int arg11, @OriginalArg(13) int arg12, @OriginalArg(14) int arg13) {
		...
		@Pc(80) int local80 = this.aClass383_12.anInt10057 + arg12;
		if (arg13 == 1) {
			local80 += (arg5 - this.aClass383_12.anInt10057 - this.aClass383_12.anInt10063) / 2;
		} else if (arg13 == 2) {
			local80 = arg12 + arg5 - this.aClass383_12.anInt10063;
		}
		...
		if (arg0 != null) {
			...
			arg0[3] = this.aClass383_12.anInt10063 + this.aClass383_12.anInt10057;
			arg0[0] = local74;
			arg0[2] = local119;
			arg0[1] = local80 - this.aClass383_12.anInt10057;
		}
		return local46;
	}
}
