...
public final class Class148 {
	...
	public void method2244(@OriginalArg(1) int arg0, @OriginalArg(2) Class19 arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9) {
		@Pc(5) int local5 = 0;
		if (this.aBoolean272) {
			local5 = this.anInt3517;
		}
		if (this.aClass148_2 == null) {
			this.method2246(arg5, arg8, arg6, arg1, true, arg4, arg3, arg7, arg2, local5, arg9, arg0);
			return;
		}
		...
		local16.method2246(arg5, arg8, arg6, arg1, true, arg4, arg3, arg7, arg2, local5, arg9, arg0);
		local19.method2246(arg5, arg8, arg6, arg1, false, arg4, arg3, arg7, arg2, 255 - local5, arg9, arg0);
	}

	@OriginalMember(owner = "client!gm", name = "a", descriptor = "(IIB)V")
	public void method2245(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	private void method2246(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class19 arg3, @OriginalArg(4) boolean arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) int arg10, @OriginalArg(13) int arg11) {
		...
		if (this.aClass114_2 == null) {
			...
			if (this.anInt3507 == -1 || this.anInt3518 == 0) {
				...
				@Pc(74) Class118 local74 = Static708.anInterface4_12.method4805(this.anInt3507);
				if (this.aClass23_10 == null && Static708.anInterface4_12.method4802(this.anInt3507)) {
					@Pc(120) int[] local120 = local74.anInt2796 == 2 ? Static708.anInterface4_12.method4803(0.7F, this.anInt3507, this.anInt3518, this.anInt3518) : Static708.anInterface4_12.method4806(this.anInt3518, false, this.anInt3518, this.anInt3507, 0.7F);
					this.anInt3501 = local120[0];
					this.anInt3511 = local120[local120.length - 1];
					this.aClass23_10 = arg3.a(this.anInt3518, this.anInt3518, this.anInt3518, local120, 0, 7468);
				}
				...
				if (this.aClass23_10 != null) {
					...
					if (this.anInt3515 == 1) {
						for (local233 = local199 - arg2; local233 < arg6; local233 += arg2) {
							this.aClass23_10.a(arg7 + local233, local187 + arg11, arg2, arg2, 0, local10 << 24 | 0xFFFFFF, local161);
						}
						if ((this.anInt3501 & 0xFF000000) != 0) {
							arg3.a(arg6, local187 + arg11 + 1, 0, (byte) 116, (int) 0, this.anInt3501);
						}
						if ((this.anInt3511 & 0xFF000000) != 0) {
							arg3.a(arg6, arg2 - arg2 - local187 - arg11, arg2 + arg11 + local187, (byte) 116, (int) 0, this.anInt3511);
						}
					} else {
						while (arg2 < local187) {
							local187 -= arg2;
						...
						for (local233 = local199 - arg2; local233 < arg6; local233 += arg2) {
							for (@Pc(360) int local360 = local187 - arg2; local360 < arg2; local360 += arg2) {
								this.aClass23_10.a(arg7 + local233, local360 - -arg11, arg2, arg2, 0, local10 << 24 | 0xFFFFFF, local161);
							}
						}
					}
				}
			...
			this.method2249(arg8, arg9, arg10, arg0, arg3);
		}
		for (@Pc(417) int local417 = this.anInt3508 - 1; local417 >= 0; local417--) {
			this.aClass216Array2[local417].method3537(arg3, arg7, arg11, arg6, arg2, arg10, arg8, this.anInt3523, this.anInt3509, this.anInt3505, local10);
		}
		arg3.ya();
	}

	@OriginalMember(owner = "client!gm", name = "a", descriptor = "(IILclient!ha;IIIIIIII)V")
	public void method2247(@OriginalArg(2) Class19 arg0, @OriginalArg(3) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(8) int arg4, @OriginalArg(9) int arg5, @OriginalArg(10) int arg6) {
		this.method2244(arg1, arg0, arg5, arg3, 0, 0, arg6, arg2, 0, arg4);
	}

	@OriginalMember(owner = "client!gm", name = "a", descriptor = "(BLclient!gm;)V")
	public void method2248(@OriginalArg(1) Class148 arg0) {
		if (this.aBoolean272) {
	...
	private void method2249(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) Class19 arg4) {
		@Pc(7) Class73 local7 = arg4.n().b();
		@Pc(10) Class73 local10 = arg4.y();
		local10.a(0, 0, 0);
		local10.f(arg0 & 0x3FFF);
		local10.c(arg2 & 0x3FFF);
		local10.b(arg3 & 0x3FFF);
		arg4.a(local10);
		@Pc(36) Class73 local36 = arg4.y();
		local36.a();
		if (this.anInt3503 != arg1) {
			this.aClass114_2.a((byte) arg1, this.aByteArray35);
			this.anInt3503 = arg1;
		}
		this.aClass114_2.a(local36, (Class8_Sub6) null, 0);
		arg4.a(local7);
	}
	...
	private void method2251(@OriginalArg(1) Class19 arg0) {
		try {
			@Pc(9) Class330 local9 = Static386.aClass330_80;
			@Pc(17) boolean local17 = local9.method5371(this.anInt3514);
			if (local17) {
				arg0.ZA(16777215, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F);
				@Pc(36) Class88 local36 = Static121.method1430(this.anInt3514, Static386.aClass330_80);
				this.aClass114_2 = arg0.a(local36, 1099776, 0, 255, 1);
				@Pc(49) byte[] local49 = this.aClass114_2.b();
				if (local49 == null) {
					this.aByteArray35 = null;
				} else {
					this.aByteArray35 = new byte[local49.length];
					Static734.method5448(local49, 0, this.aByteArray35, 0, local49.length);
				}
			}
	...
	public Class148 method2252() {
		return this.aClass148_2;
	}

	@OriginalMember(owner = "client!gm", name = "a", descriptor = "(IIILclient!ha;)Z")
	public boolean method2253(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) Class19 arg2) {
		if (this.anInt3510 != arg1) {
			this.anInt3510 = arg1;
			@Pc(16) int local16 = Static402.method3969(arg1);
			if (local16 > 512) {
				local16 = 512;
			}
			if (local16 <= 0) {
			...
			if (this.aClass216Array1 != null) {
				...
				for (@Pc(59) int local59 = 0; local59 < this.aClass216Array1.length; local59++) {
					...
					if (local68.method3538(this.anInt3523, this.anInt3509, this.anInt3505, this.anInt3510)) {
						local57[this.anInt3508] = local68.anInt5631;
						this.aClass216Array2[this.anInt3508++] = local68;
					}
				}
				Static441.method4207(this.anInt3508 - 1, 0, local57, this.aClass216Array2);
			}
		...
		if (this.aBoolean273) {
			...
			for (@Pc(142) int local142 = this.anInt3508 - 1; local142 >= 0; local142--) {
				@Pc(155) boolean local155 = this.aClass216Array2[local142].method3532(arg2, this.aClass216_1);
		...
		if (arg0 == 0 || !arg2.a()) {
			...
			this.method2251(arg2);
		}
		if (this.aClass148_2 != null && this.aClass148_2 != this) {
			this.aClass148_2.method2254();
			local131 |= this.aClass148_2.method2253(arg0, arg1, arg2);
		}
		return local131;
	}
