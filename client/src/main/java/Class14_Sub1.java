...
public final class Class14_Sub1 extends Class14 {
	...
	public Class14_Sub1(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) Class381 arg1, @OriginalArg(2) Class407[] arg2, @OriginalArg(3) boolean arg3) {
		...
		if (arg3) {
			...
			if (arg0.method5680(Static679.aClass92_15, Static702.aClass397_16)) {
				this.anInterface18_1 = arg0.method5637(local37, local44, Static679.aClass92_15, local37, false);
			} else {
				...
				this.anInterface18_1 = arg0.method5643(false, local37, local37, local162);
			}
			...
			this.anInterface18_1 = arg0.method5643(false, local37, local37, local207);
			this.aBoolean19 = false;
		}
		this.anInterface18_1.method6475(Static363.aClass259_14);
		this.anInterface16_1 = arg0.method5765(false);
		this.anInterface16_1.method2238(20, 20480);
		for (@Pc(366) int local366 = 0; local366 < 4; local366++) {
			@Pc(373) Buffer local373 = this.anInterface16_1.method2240();
			if (local373 != null) {
				@Pc(381) Stream local381 = this.aClass19_Sub1_2.method5709(local373);
				@Pc(391) float local391 = this.anInterface18_1.method6480((float) local37) / (float) local37;
				@Pc(401) float local401 = this.anInterface18_1.method6484((float) local37) / (float) local37;
				...
				local381.c();
				if (this.anInterface16_1.method2239()) {
					return;
				}
			}
		}
	...
	@Override
	protected void a(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class1 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
	}

	@OriginalMember(owner = "client!aja", name = "fa", descriptor = "(CIIIZ)V")
	@Override
	protected void fa(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
		this.aClass19_Sub1_2.method5673();
		this.aClass19_Sub1_2.method5697(this.anInterface18_1);
		if (this.aBoolean19 || arg4) {
			this.aClass19_Sub1_2.method5703(Static209.aClass121_4, Static185.aClass121_3);
			this.aClass19_Sub1_2.method5689(0, Static454.aClass168_5);
			this.aClass19_Sub1_2.method5721(arg3);
		} else {
			this.aClass19_Sub1_2.method5703(Static185.aClass121_3, Static185.aClass121_3);
		}
		@Pc(43) Class73_Sub1 local43 = this.aClass19_Sub1_2.method5649();
		local43.a(arg1, arg2, 0);
		this.aClass19_Sub1_2.method5651();
		this.aClass19_Sub1_2.method5739(0, this.anInterface16_1);
		this.aClass19_Sub1_2.method5723(this.aClass19_Sub1_2.aClass244_17);
		this.aClass19_Sub1_2.method5688(Static694.aClass131_6, arg0 * 4, 2);
		if (this.aBoolean19 || arg4) {
			this.aClass19_Sub1_2.method5689(0, Static189.aClass168_2);
		}
	}
}
