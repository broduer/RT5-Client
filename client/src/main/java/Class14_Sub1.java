...
public final class Class14_Sub1 extends Class14 {
	...
	public Class14_Sub1(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) Class383 arg1, @OriginalArg(2) Class409[] arg2, @OriginalArg(3) boolean arg3) {
		super(arg0, arg1);
		this.aClass19_Sub1_2 = arg0;
		@Pc(8) int local8 = 0;
		for (@Pc(10) int local10 = 0; local10 < 256; local10++) {
			@Pc(15) Class409 local15 = arg2[local10];
			if (local15.anInt10879 > local8) {
				local8 = local15.anInt10879;
			}
			if (local15.anInt10876 > local8) {
				local8 = local15.anInt10876;
			}
		}
		@Pc(37) int local37 = local8 * 16;
		@Pc(46) int local46;
		@Pc(51) Class409 local51;
		@Pc(63) int local63;
		@Pc(69) int local69;
		@Pc(75) int local75;
		@Pc(77) int local77;
		...
		if (arg3) {
			...
			for (local46 = 0; local46 < 256; local46++) {
				...
				local54 = local51.anInt10879;
				@Pc(57) int local57 = local51.anInt10876;
			...
			if (arg0.method8078(Static679.aClass92_15, Static702.aClass399_16)) {
				this.anInterface18_1 = arg0.method8035(local37, local44, Static679.aClass92_15, local37, false);
			} else {
				...
				this.anInterface18_1 = arg0.method8041(false, local37, local37, local162);
			}
			...
			for (local46 = 0; local46 < 256; local46++) {
				...
				local69 = local51.anInt10879;
				local75 = local51.anInt10876;
			...
			this.anInterface18_1 = arg0.method8041(false, local37, local37, local207);
			this.aBoolean19 = false;
		}
		this.anInterface18_1.method9048(Static363.aClass261_14);
		this.anInterface16_1 = arg0.method8163(false);
		...
		for (@Pc(366) int local366 = 0; local366 < 4; local366++) {
			...
			if (local373 != null) {
				@Pc(381) Stream local381 = this.aClass19_Sub1_2.method8107(local373);
				@Pc(391) float local391 = this.anInterface18_1.method9053((float) local37) / (float) local37;
				@Pc(401) float local401 = this.anInterface18_1.method9057((float) local37) / (float) local37;
				for (local63 = 0; local63 < 256; local63++) {
					@Pc(408) Class409 local408 = arg2[local63];
					local75 = local408.anInt10879;
					local77 = local408.anInt10876;
					local241 = local408.anInt10877;
					local85 = local408.anInt10881;
	...
	protected void fa(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
		this.aClass19_Sub1_2.method8071();
		this.aClass19_Sub1_2.method8095(this.anInterface18_1);
		if (this.aBoolean19 || arg4) {
			this.aClass19_Sub1_2.method8101(Static209.aClass121_4, Static185.aClass121_3);
			this.aClass19_Sub1_2.method8087(0, Static454.aClass168_5);
			this.aClass19_Sub1_2.method8119(arg3);
		} else {
			this.aClass19_Sub1_2.method8101(Static185.aClass121_3, Static185.aClass121_3);
		}
		@Pc(43) Class73_Sub1 local43 = this.aClass19_Sub1_2.method8047();
		local43.method7132(arg1, arg2, 0);
		this.aClass19_Sub1_2.method8049();
		this.aClass19_Sub1_2.method8137(0, this.anInterface16_1);
		this.aClass19_Sub1_2.method8121(this.aClass19_Sub1_2.aClass246_17);
		this.aClass19_Sub1_2.method8086(Static694.aClass131_6, arg0 * 4, 2);
		if (this.aBoolean19 || arg4) {
			this.aClass19_Sub1_2.method8087(0, Static189.aClass168_2);
		}
	}
}
