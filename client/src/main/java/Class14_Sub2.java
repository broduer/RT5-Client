...
public final class Class14_Sub2 extends Class14 {
	...
	public Class14_Sub2(@OriginalArg(0) Class19_Sub3 arg0, @OriginalArg(1) Class383 arg1, @OriginalArg(2) Class409[] arg2, @OriginalArg(3) boolean arg3) {
		super(arg0, arg1);
		...
		if (arg3) {
			...
			for (local46 = 0; local46 < 256; local46++) {
				...
				@Pc(54) int local54 = local51.anInt10879;
				local57 = local51.anInt10876;
			...
			this.aClass93_Sub2_Sub1_1 = Static469.method6366(local37, local44, arg0, local37);
		...
		this.aClass93_Sub2_Sub1_1.method9445(false);
		this.aClass36_4 = new Class36(arg0, 256);
		@Pc(334) float local334 = this.aClass93_Sub2_Sub1_1.aFloat67 / (float) this.aClass93_Sub2_Sub1_1.anInt3268;
		@Pc(343) float local343 = this.aClass93_Sub2_Sub1_1.aFloat68 / (float) this.aClass93_Sub2_Sub1_1.anInt3266;
		for (@Pc(345) int local345 = 0; local345 < 256; local345++) {
			@Pc(350) Class409 local350 = arg2[local345];
			local57 = local350.anInt10879;
			local63 = local350.anInt10876;
			local69 = local350.anInt10877;
			local75 = local350.anInt10881;
	...
	protected void fa(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
		this.aClass19_Sub3_16.method6981();
		this.aClass19_Sub3_16.method7008(this.aClass93_Sub2_Sub1_1);
		if (this.aBoolean275 || arg4) {
			this.aClass19_Sub3_16.method7038(8448, 7681);
			this.aClass19_Sub3_16.method7028(34168, 768, 0);
		} else {
			this.aClass19_Sub3_16.method7038(7681, 7681);
		}
	...
	protected void method8824(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class1 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		this.aClass19_Sub3_16.method7021(1);
		this.aClass19_Sub3_16.method7008(local5);
		this.aClass19_Sub3_16.method7038(8448, 7681);
		this.aClass19_Sub3_16.method7028(34168, 768, 0);
		OpenGL.glTexGeni(8192, 9472, 9216);
		OpenGL.glTexGeni(8193, 9472, 9216);
		@Pc(78) float local78 = local5.aFloat67 / (float) local5.anInt3268;
		@Pc(85) float local85 = local5.aFloat68 / (float) local5.anInt3266;
