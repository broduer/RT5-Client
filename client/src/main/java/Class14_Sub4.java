...
public final class Class14_Sub4 extends Class14 {
	...
	protected void a(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class1 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		if (local28 > 0 && local33 > 0) {
			this.method3986(this.aByteArrayArray18[arg0], this.aClass19_Sub2_6.anIntArray319, arg3, local51, local43, local28, local33, local47, local49, arg1, arg2, this.anIntArray486[arg0], arg5, arg6, arg7);
		}
	}

	@OriginalMember(owner = "client!mq", name = "a", descriptor = "([B[IIIIIIII)V")
	private void method3987(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
	...
	protected void fa(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
		...
		if (local18 > 0 && local23 > 0) {
			this.method3987(this.aByteArrayArray18[arg0], this.aClass19_Sub2_6.anIntArray319, arg3, local41, local33, local18, local23, local37, local39);
		}
	}
}
