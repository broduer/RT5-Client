...
public final class Class14_Sub4 extends Class14 {
	...
	public Class14_Sub4(@OriginalArg(0) Class19_Sub2 arg0, @OriginalArg(1) Class383 arg1, @OriginalArg(2) Class409[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4) {
		super(arg0, arg1);
		...
		for (@Pc(32) int local32 = 0; local32 < arg2.length; local32++) {
			@Pc(37) Class409 local37 = arg2[local32];
	...
	protected void method8824(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class1 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		@Pc(37) int local37 = this.aClass19_Sub2_6.anInt4219;
		@Pc(43) int local43 = arg1 + arg2 * local37;
		@Pc(47) int local47 = local37 - local28;
		@Pc(49) int local49 = 0;
		@Pc(51) int local51 = 0;
		@Pc(62) int local62;
		if (arg2 < this.aClass19_Sub2_6.anInt4197) {
			local62 = this.aClass19_Sub2_6.anInt4197 - arg2;
			local33 -= local62;
			arg2 = this.aClass19_Sub2_6.anInt4197;
			local51 = local62 * local28;
			local43 += local62 * local37;
		}
		if (arg2 + local33 > this.aClass19_Sub2_6.anInt4207) {
			local33 -= arg2 + local33 - this.aClass19_Sub2_6.anInt4207;
		}
		if (arg1 < this.aClass19_Sub2_6.anInt4203) {
			local62 = this.aClass19_Sub2_6.anInt4203 - arg1;
			local28 -= local62;
			arg1 = this.aClass19_Sub2_6.anInt4203;
			local51 += local62;
			local43 += local62;
			local49 = local62;
			local47 += local62;
		}
		if (arg1 + local28 > this.aClass19_Sub2_6.anInt4212) {
			local62 = arg1 + local28 - this.aClass19_Sub2_6.anInt4212;
			local28 -= local62;
			local49 += local62;
			local47 += local62;
		}
		if (local28 > 0 && local33 > 0) {
			this.method5632(this.aByteArrayArray18[arg0], this.aClass19_Sub2_6.anIntArray319, arg3, local51, local43, local28, local33, local47, local49, arg1, arg2, this.anIntArray486[arg0], arg5, arg6, arg7);
		}
	}

	@OriginalMember(owner = "client!mq", name = "a", descriptor = "([B[IIIIIIII)V")
	private void method5633(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
	...
	protected void fa(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
		...
		@Pc(27) int local27 = this.aClass19_Sub2_6.anInt4219;
		...
		@Pc(52) int local52;
		if (arg2 < this.aClass19_Sub2_6.anInt4197) {
			local52 = this.aClass19_Sub2_6.anInt4197 - arg2;
			local23 -= local52;
			arg2 = this.aClass19_Sub2_6.anInt4197;
			local41 += local52 * local18;
			local33 += local52 * local27;
		}
		if (arg2 + local23 > this.aClass19_Sub2_6.anInt4207) {
			local23 -= arg2 + local23 - this.aClass19_Sub2_6.anInt4207;
		}
		if (arg1 < this.aClass19_Sub2_6.anInt4203) {
			local52 = this.aClass19_Sub2_6.anInt4203 - arg1;
			local18 -= local52;
			arg1 = this.aClass19_Sub2_6.anInt4203;
			local41 += local52;
			local33 += local52;
		...
		if (arg1 + local18 > this.aClass19_Sub2_6.anInt4212) {
			local52 = arg1 + local18 - this.aClass19_Sub2_6.anInt4212;
			local18 -= local52;
			local39 += local52;
			local37 += local52;
		}
		if (local18 > 0 && local23 > 0) {
			this.method5633(this.aByteArrayArray18[arg0], this.aClass19_Sub2_6.anIntArray319, arg3, local41, local33, local18, local23, local37, local39);
		}
	}
}
