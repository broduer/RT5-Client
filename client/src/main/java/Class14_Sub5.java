...
public final class Class14_Sub5 extends Class14 {
	...
	public Class14_Sub5(@OriginalArg(0) Class19_Sub2 arg0, @OriginalArg(1) Class383 arg1, @OriginalArg(2) Class409[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4) {
		super(arg0, arg1);
	...
	private void method8844(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) Class1 arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14) {
		...
		if (arg14 > arg10) {
			local10 = arg14;
			arg4 += (arg14 - arg10) * this.aClass19_Sub2_11.anInt4219;
	...
	private void method8845(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) Class1 arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14) {
		@Pc(2) Class1_Sub1 local2 = (Class1_Sub1) arg12;
		@Pc(5) int[] local5 = local2.anIntArray334;
		@Pc(8) int[] local8 = local2.anIntArray335;
		@Pc(14) int local14 = arg9 - this.aClass19_Sub2_11.anInt4203;
	...
	protected void fa(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
		...
		@Pc(27) int local27 = this.aClass19_Sub2_11.anInt4219;
		@Pc(33) int local33 = arg1 + arg2 * local27;
		@Pc(37) int local37 = local27 - local18;
		@Pc(39) int local39 = 0;
		@Pc(41) int local41 = 0;
		@Pc(52) int local52;
		if (arg2 < this.aClass19_Sub2_11.anInt4197) {
			local52 = this.aClass19_Sub2_11.anInt4197 - arg2;
			local23 -= local52;
			arg2 = this.aClass19_Sub2_11.anInt4197;
			local41 += local52 * local18;
			local33 += local52 * local27;
		}
		if (arg2 + local23 > this.aClass19_Sub2_11.anInt4207) {
			local23 -= arg2 + local23 - this.aClass19_Sub2_11.anInt4207;
		}
		if (arg1 < this.aClass19_Sub2_11.anInt4203) {
			local52 = this.aClass19_Sub2_11.anInt4203 - arg1;
			local18 -= local52;
			arg1 = this.aClass19_Sub2_11.anInt4203;
			local41 += local52;
			local33 += local52;
			local39 += local52;
			local37 += local52;
		}
		if (arg1 + local18 > this.aClass19_Sub2_11.anInt4212) {
			local52 = arg1 + local18 - this.aClass19_Sub2_11.anInt4212;
			local18 -= local52;
			local39 += local52;
			local37 += local52;
		}
	...
	@Override
	protected void method8824(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class1 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (arg5 == null) {
		...
		@Pc(37) int local37 = this.aClass19_Sub2_11.anInt4219;
		...
		@Pc(62) int local62;
		if (arg2 < this.aClass19_Sub2_11.anInt4197) {
			local62 = this.aClass19_Sub2_11.anInt4197 - arg2;
			local33 -= local62;
			arg2 = this.aClass19_Sub2_11.anInt4197;
			local51 = local62 * local28;
			local43 += local62 * local37;
		}
		if (arg2 + local33 > this.aClass19_Sub2_11.anInt4207) {
			local33 -= arg2 + local33 - this.aClass19_Sub2_11.anInt4207;
		}
		if (arg1 < this.aClass19_Sub2_11.anInt4203) {
			local62 = this.aClass19_Sub2_11.anInt4203 - arg1;
			local28 -= local62;
			arg1 = this.aClass19_Sub2_11.anInt4203;
			local51 += local62;
			local43 += local62;
		...
		if (arg1 + local28 > this.aClass19_Sub2_11.anInt4212) {
			local62 = arg1 + local28 - this.aClass19_Sub2_11.anInt4212;
			local28 -= local62;
			local49 += local62;
			local47 += local62;
		}
	...
	private void method8846(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
	...
	private void method8847(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
