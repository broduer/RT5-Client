...
public final class Class151 {
	...
	public Class151(@OriginalArg(0) int arg0, @OriginalArg(1) Class330 arg1, @OriginalArg(2) Class330 arg2) {
		...
		if (this.aClass330_50 != null) {
			this.aClass330_50.method5372(0);
		}
		if (this.aClass330_51 != null) {
			this.aClass330_51.method5372(0);
		}
	}

	@OriginalMember(owner = "client!gt", name = "a", descriptor = "(BI)Lclient!bq;")
	public Class2_Sub2_Sub3 method2298(@OriginalArg(1) int arg0) {
		@Pc(11) Class2_Sub2_Sub3 local11 = (Class2_Sub2_Sub3) this.aClass82_79.method1390((long) arg0);
		if (local11 != null) {
			return local11;
		}
		@Pc(28) byte[] local28;
		if (arg0 < 32768) {
			local28 = this.aClass330_50.method5359(arg0, 0);
		} else {
			local28 = this.aClass330_51.method5359(arg0 & 0x7FFF, 0);
		}
		local11 = new Class2_Sub2_Sub3();
		if (local28 != null) {
			local11.method695(new Class2_Sub21(local28));
		}
		if (arg0 >= 32768) {
			local11.method701();
		}
		this.aClass82_79.method1384(local11, (long) arg0);
		return local11;
	}
}
