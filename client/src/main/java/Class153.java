...
public final class Class153 {
	...
	public void method2336() {
		this.aClass339_17.method5454();
		this.anInt3640 = 0;
	}

	@OriginalMember(owner = "client!gw", name = "b", descriptor = "(B)V")
	public void method2337() throws IOException {
		if (this.aClass348_1 == null || this.anInt3640 <= 0) {
			return;
		}
		this.aClass2_Sub21_6.anInt8388 = 0;
		while (true) {
			@Pc(23) Class2_Sub19 local23 = (Class2_Sub19) this.aClass339_17.method5453(65280);
			if (local23 == null || local23.anInt2989 > this.aClass2_Sub21_6.aByteArray93.length - this.aClass2_Sub21_6.anInt8388) {
				this.aClass348_1.method5628(this.aClass2_Sub21_6.aByteArray93, this.aClass2_Sub21_6.anInt8388);
				this.anInt3647 = 0;
				this.anInt3649 += this.aClass2_Sub21_6.anInt8388;
				break;
			}
			this.aClass2_Sub21_6.method5195(local23.anInt2989, local23.aClass2_Sub21_Sub2_1.aByteArray93, 0);
			this.anInt3640 -= local23.anInt2989;
			local23.a((byte) 36);
			local23.aClass2_Sub21_Sub2_1.method5174();
			local23.method1883();
		}
	}
	...
	public void method2338() {
		if (this.aClass348_1 != null) {
			this.aClass348_1.method5623();
			this.aClass348_1 = null;
		}
	}

	@OriginalMember(owner = "client!gw", name = "a", descriptor = "(ILclient!fk;)V")
	public void method2339(@OriginalArg(1) Class2_Sub19 arg0) {
		this.aClass339_17.method5465(arg0);
