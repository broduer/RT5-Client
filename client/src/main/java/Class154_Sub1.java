...
public final class Class154_Sub1 extends Class154 {
	...
	public void method4773(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		...
		Static168.method1779(local36, super.anInt7655, super.anInt7656, local17, local29, local10);
	}

	@OriginalMember(owner = "client!hba", name = "a", descriptor = "(III)V")
	@Override
	public void method4774(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		@Pc(15) int local15 = this.anInt3710 * arg1 >> 12;
		@Pc(22) int local22 = arg1 * this.anInt3712 >> 12;
		@Pc(29) int local29 = arg0 * this.anInt3708 >> 12;
		@Pc(36) int local36 = arg0 * this.anInt3706 >> 12;
		Static264.a(super.anInt7654, local22, super.anInt7655, local29, local36, local15, super.anInt7656);
	}

	@OriginalMember(owner = "client!hba", name = "b", descriptor = "(III)V")
	@Override
	public void method4770(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		Static624.method5899(local22, local10, super.anInt7654, local36, local29);
	}
}
