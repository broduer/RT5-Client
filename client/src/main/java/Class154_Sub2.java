...
public final class Class154_Sub2 extends Class154 {
	...
	public void method6783(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		@Pc(18) int local18 = this.anInt5486 * arg1 >> 12;
		@Pc(25) int local25 = this.anInt5487 * arg1 >> 12;
		@Pc(32) int local32 = this.anInt5482 * arg0 >> 12;
		@Pc(39) int local39 = arg0 * this.anInt5484 >> 12;
		Static136.method2347(local32, super.anInt7679, local39, local18, super.anInt7678, super.anInt7677, local25);
	}
	...
	public void method6779(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(10) int local10 = this.anInt5486 * arg0 >> 12;
		@Pc(17) int local17 = this.anInt5487 * arg0 >> 12;
		@Pc(24) int local24 = arg1 * this.anInt5482 >> 12;
		@Pc(31) int local31 = arg1 * this.anInt5484 >> 12;
		Static180.method2776(local31, super.anInt7677, local24, local17, local10);
	}
}
