...
public final class Class158 {
	...
	public int anInt3815 = 0;

	@OriginalMember(owner = "client!hda", name = "Pc", descriptor = "I")
	public int anInt3772 = 0;

	@OriginalMember(owner = "client!hda", name = "nb", descriptor = "I")
	public int anInt3836 = 0;
	...
	public Class23 method3383(@OriginalArg(1) Class19 arg0) {
		...
		if (this.anInt3783 > 0) {
			local71.method9387(this.anInt3783);
		} else if (this.anInt3809 != 0) {
			local71.method9387(1);
		}
		if (this.anInt3783 >= 1) {
		...
		local60 = arg0.method7955(local71, true);
		Static473.aClass82_157.method2153(local54, local60, local60.method8206() * local60.method8189() * 4);
		return local60;
	}
	...
	public void method3384(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class114 arg1, @OriginalArg(3) Class73 arg2, @OriginalArg(4) int arg3) {
		arg1.method7483(arg2);
		@Pc(9) Class330[] local9 = arg1.method7489();
		@Pc(22) Class251[] local22 = arg1.method7487();
	...
	private Object[] method3386(@OriginalArg(1) Class2_Sub21 arg0) {
		...
		for (@Pc(20) int local20 = 0; local20 < local7; local20++) {
			...
			if (local25 == 0) {
				local18[local20] = Integer.valueOf(arg0.method7356());
			} else if (local25 == 1) {
				local18[local20] = arg0.method7365();
			}
		}
	...
	public void method3390(@OriginalArg(0) Class2_Sub21 arg0) {
		...
		this.anInt3831 = arg0.method7403();
		if ((this.anInt3831 & 0x80) != 0) {
			this.anInt3831 &= 0x7F;
			this.aString40 = arg0.method7365();
		}
		this.anInt3817 = arg0.method7389();
		this.anInt3837 = arg0.method7363();
		this.anInt3819 = arg0.method7363();
		this.anInt3754 = arg0.method7389();
		this.anInt3772 = arg0.method7389();
		this.aByte63 = arg0.method7384();
		this.aByte62 = arg0.method7384();
		this.aByte61 = arg0.method7384();
		this.aByte64 = arg0.method7384();
		this.anInt3753 = arg0.method7389();
		if (this.anInt3753 == 65535) {
			this.anInt3753 = -1;
		} else {
			this.anInt3753 += this.anInt3823 & 0xFFFF0000;
		}
		@Pc(110) int local110 = arg0.method7403();
		this.aBoolean284 = (local110 & 0x1) != 0;
		if (local7 >= 0) {
			this.aBoolean300 = (local110 & 0x2) != 0;
		}
		if (this.anInt3831 == 0) {
			this.anInt3779 = arg0.method7389();
			this.anInt3752 = arg0.method7389();
			if (local7 < 0) {
				this.aBoolean300 = arg0.method7403() == 1;
			}
		}
		@Pc(191) int local191;
		if (this.anInt3831 == 5) {
			this.anInt3821 = arg0.method7356();
			this.anInt3775 = arg0.method7389();
			local191 = arg0.method7403();
			this.aBoolean301 = (local191 & 0x1) != 0;
			this.aBoolean292 = (local191 & 0x2) != 0;
			this.anInt3790 = arg0.method7403();
			this.anInt3783 = arg0.method7403();
			this.anInt3809 = arg0.method7356();
			this.aBoolean291 = arg0.method7403() == 1;
			this.aBoolean293 = arg0.method7403() == 1;
			this.anInt3789 = arg0.method7356();
			if (local7 >= 3) {
				this.aBoolean295 = arg0.method7403() == 1;
			}
		}
		if (this.anInt3831 == 6) {
			this.anInt3834 = 1;
			this.anInt3842 = arg0.method7389();
			...
			if (local326) {
				this.anInt3765 = arg0.method7363();
				this.anInt3810 = arg0.method7363();
				this.anInt3818 = arg0.method7389();
				this.anInt3822 = arg0.method7389();
				this.anInt3747 = arg0.method7389();
				this.anInt3804 = arg0.method7389();
			} else if (this.aBoolean302) {
				this.anInt3765 = arg0.method7363();
				this.anInt3810 = arg0.method7363();
				this.anInt3832 = arg0.method7363();
				this.anInt3818 = arg0.method7389();
				this.anInt3822 = arg0.method7389();
				this.anInt3747 = arg0.method7389();
				this.anInt3804 = arg0.method7363();
			}
			this.anInt3799 = arg0.method7389();
			if (this.anInt3799 == 65535) {
				this.anInt3799 = -1;
			}
			if (this.aByte63 != 0) {
				this.anInt3811 = arg0.method7389();
			}
			if (this.aByte62 != 0) {
				this.anInt3836 = arg0.method7389();
			}
		}
		if (this.anInt3831 == 4) {
			this.anInt3791 = arg0.method7389();
			if (this.anInt3791 == 65535) {
				this.anInt3791 = -1;
			}
			if (local7 >= 2) {
				this.aBoolean299 = arg0.method7403() == 1;
			}
			this.aString44 = arg0.method7365();
			this.anInt3758 = arg0.method7403();
			this.anInt3829 = arg0.method7403();
			this.anInt3825 = arg0.method7403();
			this.aBoolean286 = arg0.method7403() == 1;
			this.anInt3789 = arg0.method7356();
			this.anInt3790 = arg0.method7403();
			if (local7 >= 0) {
				this.anInt3798 = arg0.method7403();
			}
		}
		if (this.anInt3831 == 3) {
			this.anInt3789 = arg0.method7356();
			this.aBoolean294 = arg0.method7403() == 1;
			this.anInt3790 = arg0.method7403();
		}
		if (this.anInt3831 == 9) {
			this.anInt3788 = arg0.method7403();
			this.anInt3789 = arg0.method7356();
			this.aBoolean287 = arg0.method7403() == 1;
		}
		local191 = arg0.method7390();
		@Pc(628) int local628 = arg0.method7403();
		@Pc(653) int local653;
		if (local628 != 0) {
		...
		if (local750 > 0) {
			...
			this.anIntArray301[local730] = arg0.method7389();
		}
		if (local750 > 1) {
			local730 = arg0.method7403();
			this.anIntArray301[local730] = arg0.method7389();
		}
		this.aString42 = arg0.method7365();
		if (this.aString42.equals("")) {
			this.aString42 = null;
		}
		this.anInt3764 = arg0.method7403();
		this.anInt3808 = arg0.method7403();
		this.anInt3841 = arg0.method7403();
		this.aString43 = arg0.method7365();
		local730 = -1;
		if (Static622.method6860(local191) != 0) {
			local730 = arg0.method7389();
			if (local730 == 65535) {
				local730 = -1;
			}
			this.anInt3759 = arg0.method7389();
			if (this.anInt3759 == 65535) {
				this.anInt3759 = -1;
			}
			this.anInt3830 = arg0.method7389();
			if (this.anInt3830 == 65535) {
				this.anInt3830 = -1;
			}
		}
		if (local7 >= 0) {
			this.anInt3793 = arg0.method7389();
			if (this.anInt3793 == 65535) {
				this.anInt3793 = -1;
			}
		}
		this.aClass2_Sub41_2 = new Class2_Sub41(local191, local730);
		if (local7 >= 0) {
			local767 = arg0.method7403();
			@Pc(929) int local929;
			@Pc(933) int local933;
	...
	public Class159 method3393(@OriginalArg(0) Class19 arg0) {
		...
		@Pc(77) int local77 = local53.anInt10881 + local53.anInt10876 + local53.anInt10880;
		@Pc(86) int local86 = local53.anInt10879 + local53.anInt10877 + local53.anInt10878;
		@Pc(89) int[] local89 = new int[local86];
		@Pc(92) int[] local92 = new int[local86];
		for (@Pc(94) int local94 = 0; local94 < local53.anInt10879; local94++) {
			@Pc(97) int local97 = 0;
			for (@Pc(99) int local99 = 0; local99 < local53.anInt10876; local99++) {
				if (local53.aByteArray114[local99 + local53.anInt10876 * local94] != 0) {
					local97 = local99;
					break;
				}
			}
			@Pc(121) int local121 = local53.anInt10876;
			for (@Pc(126) int local126 = local53.anInt10876 - 1; local126 >= local97; local126--) {
				if (local53.aByteArray114[local126 + local53.anInt10876 * local94] != 0) {
					local121 = local126 + 1;
					break;
				}
			}
			local89[local53.anInt10877 + local94] = local53.anInt10881 + local97;
			local92[local53.anInt10877 + local94] = local121 - local97;
		}
		@Pc(180) Class1 local180 = arg0.method8011(local77, local86, local89, local92);
		if (local180 == null) {
			return null;
		} else {
	...
	private int[] method3398(@OriginalArg(1) Class2_Sub21 arg0) {
		@Pc(7) int local7 = arg0.method7403();
		if (local7 == 0) {
			return null;
		}
		...
		for (@Pc(23) int local23 = 0; local23 < local7; local23++) {
			local15[local23] = arg0.method7356();
		}
		return local15;
	}
	...
	public Class114 method3401(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class152 arg1, @OriginalArg(2) Class312 arg2, @OriginalArg(3) Class217 arg3, @OriginalArg(5) Class50 arg4, @OriginalArg(6) Class203 arg5, @OriginalArg(7) Interface23 arg6, @OriginalArg(8) Class310 arg7, @OriginalArg(9) Class112 arg8, @OriginalArg(10) int arg9, @OriginalArg(11) Class388 arg10) {
		...
		if (this.anInt3834 == 0) {
			return null;
		} else if (this.anInt3834 == 1 && this.anInt3842 == -1) {
			return null;
		} else if (this.anInt3834 == 1) {
			if (arg1 != null) {
			...
			if (local277 == null || arg0.method7967(local277.ua(), arg9) != 0) {
				...
				@Pc(307) Class88 local307 = Static121.method2201(this.anInt3842, Static607.aClass332_113);
				if (local307 == null) {
					Static544.aBoolean625 = true;
					return null;
				}
				if (local307.anInt2388 < 13) {
					local307.method2232();
				}
				local277 = arg0.method7959(local307, arg9, Static108.anInt2177, 64, 768);
				@Pc(339) int local339;
				if (this.aShortArray57 != null) {
			...
			if (this.anInt3834 == 2) {
				local438 = arg7.method7099(this.anInt3842).method5999(arg1, arg10, arg0, arg6);
				if (local438 == null) {
					Static544.aBoolean625 = true;
					return null;
				} else {
			...
			} else if (this.anInt3834 == 3) {
				if (arg5 == null) {
					return null;
				}
				local438 = arg5.method4559(arg3, arg4, arg6, arg1, arg8, arg7, arg0);
				if (local438 == null) {
					Static544.aBoolean625 = true;
					return null;
				} else {
			...
			} else if (this.anInt3834 != 7) {
				return null;
			} else if (arg5 == null) {
				return null;
			} else {
				@Pc(558) int local558 = this.anInt3842 >>> 16;
				@Pc(563) int local563 = this.anInt3842 & 0xFFFF;
				@Pc(566) int local566 = this.anInt3748;
				@Pc(578) Class114 local578 = arg5.method4557(arg1, local558, local566, arg4, arg0, arg3, local563);
				if (local578 == null) {
					Static544.aBoolean625 = true;
					return null;
				} else {
	...
	public Class14 method3403(@OriginalArg(1) Class19 arg0) {
		@Pc(18) Class14 local18 = Static324.method4635(this.aBoolean299, false, this.anInt3791, arg0);
		Static544.aBoolean625 = local18 == null;
		return local18;
	}
