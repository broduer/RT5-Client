...
public final class Class158 {
	...
	public Class23 method2421(@OriginalArg(1) Class19 arg0) {
		...
		@Pc(60) Class23 local60 = (Class23) Static473.aClass82_157.method1390(local54);
		if (local60 != null) {
			return local60;
		}
		@Pc(71) Class407 local71 = Static735.method6771(Static262.aClass330_56, this.anInt3810, 0);
		if (local71 == null) {
		...
		if (this.anInt3773 > 0) {
			local71.method6769(this.anInt3773);
		} else if (this.anInt3798 != 0) {
			local71.method6769(1);
		}
		if (this.anInt3773 >= 1) {
			local71.method6774(1);
		}
		if (this.anInt3773 >= 2) {
			local71.method6774(16777215);
		}
		if (this.anInt3798 != 0) {
			local71.method6770(this.anInt3798 | 0xFF000000);
		}
		local60 = arg0.a(local71, true);
		Static473.aClass82_157.method1387(local54, local60, local60.c() * local60.d() * 4);
		return local60;
	}

	@OriginalMember(owner = "client!hda", name = "a", descriptor = "(Lclient!ha;Lclient!ka;ILclient!tt;I)V")
	public void method2422(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class114 arg1, @OriginalArg(3) Class73 arg2, @OriginalArg(4) int arg3) {
		arg1.a(arg2);
		@Pc(9) Class328[] local9 = arg1.f();
		@Pc(22) Class249[] local22 = arg1.c();
		if ((this.aClass8_Sub5_4 == null || this.aClass8_Sub5_4.aBoolean324) && (local9 != null || local22 != null)) {
			this.aClass8_Sub5_4 = Static257.method2650(arg3, false);
		}
		if (this.aClass8_Sub5_4 != null) {
			this.aClass8_Sub5_4.method2639(arg0, (long) arg3, local9, local22);
		}
	}

	@OriginalMember(owner = "client!hda", name = "b", descriptor = "(III)V")
	public void method2423(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		if (this.aClass28_17 == null) {
			this.aClass28_17 = new Class28(16);
			this.aClass28_17.method370((long) arg0, new Class2_Sub38(arg1));
			return;
		}
		@Pc(34) Class2_Sub38 local34 = (Class2_Sub38) this.aClass28_17.method373((long) arg0);
		if (local34 == null) {
			this.aClass28_17.method370((long) arg0, new Class2_Sub38(arg1));
		} else {
	...
	private Object[] method2424(@OriginalArg(1) Class2_Sub21 arg0) {
		...
		for (@Pc(20) int local20 = 0; local20 < local7; local20++) {
			@Pc(25) int local25 = arg0.method5205();
			if (local25 == 0) {
				local18[local20] = Integer.valueOf(arg0.method5158());
			} else if (local25 == 1) {
				local18[local20] = arg0.method5167();
			}
		}
	...
	public void method2426(@OriginalArg(0) short arg0, @OriginalArg(2) int arg1, @OriginalArg(3) short arg2) {
		if (arg1 >= 5) {
			return;
		}
	...
	public String method2427(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		if (this.aClass28_17 == null) {
			return arg0;
		} else {
			@Pc(17) Class2_Sub24 local17 = (Class2_Sub24) this.aClass28_17.method373((long) arg1);
			return local17 == null ? arg0 : local17.aString46;
		}
	}

	@OriginalMember(owner = "client!hda", name = "a", descriptor = "(Lclient!ge;B)V")
	public void method2428(@OriginalArg(0) Class2_Sub21 arg0) {
		@Pc(7) int local7 = arg0.method5205();
		if (local7 == 255) {
			local7 = -1;
		}
		this.anInt3820 = arg0.method5205();
		if ((this.anInt3820 & 0x80) != 0) {
			this.anInt3820 &= 0x7F;
			this.aString40 = arg0.method5167();
		}
		this.anInt3806 = arg0.method5191();
		this.anInt3826 = arg0.method5165();
		this.anInt3808 = arg0.method5165();
		this.anInt3744 = arg0.method5191();
		this.anInt3762 = arg0.method5191();
		this.aByte63 = arg0.method5186();
		this.aByte62 = arg0.method5186();
		this.aByte61 = arg0.method5186();
		this.aByte64 = arg0.method5186();
		this.anInt3743 = arg0.method5191();
		if (this.anInt3743 == 65535) {
			this.anInt3743 = -1;
		} else {
			this.anInt3743 += this.anInt3812 & 0xFFFF0000;
		}
		@Pc(110) int local110 = arg0.method5205();
		this.aBoolean284 = (local110 & 0x1) != 0;
		if (local7 >= 0) {
			this.aBoolean300 = (local110 & 0x2) != 0;
		}
		if (this.anInt3820 == 0) {
			this.anInt3769 = arg0.method5191();
			this.anInt3742 = arg0.method5191();
			if (local7 < 0) {
				this.aBoolean300 = arg0.method5205() == 1;
			}
		}
		@Pc(191) int local191;
		if (this.anInt3820 == 5) {
			this.anInt3810 = arg0.method5158();
			this.anInt3765 = arg0.method5191();
			local191 = arg0.method5205();
			this.aBoolean301 = (local191 & 0x1) != 0;
			this.aBoolean292 = (local191 & 0x2) != 0;
			this.anInt3780 = arg0.method5205();
			this.anInt3773 = arg0.method5205();
			this.anInt3798 = arg0.method5158();
			this.aBoolean291 = arg0.method5205() == 1;
			this.aBoolean293 = arg0.method5205() == 1;
			this.anInt3779 = arg0.method5158();
			if (local7 >= 3) {
				this.aBoolean295 = arg0.method5205() == 1;
			}
		}
		if (this.anInt3820 == 6) {
			this.anInt3823 = 1;
			this.anInt3831 = arg0.method5191();
			...
			if (local326) {
				this.anInt3755 = arg0.method5165();
				this.anInt3799 = arg0.method5165();
				this.anInt3807 = arg0.method5191();
				this.anInt3811 = arg0.method5191();
				this.anInt3737 = arg0.method5191();
				this.anInt3793 = arg0.method5191();
			} else if (this.aBoolean302) {
				this.anInt3755 = arg0.method5165();
				this.anInt3799 = arg0.method5165();
				this.anInt3821 = arg0.method5165();
				this.anInt3807 = arg0.method5191();
				this.anInt3811 = arg0.method5191();
				this.anInt3737 = arg0.method5191();
				this.anInt3793 = arg0.method5165();
			}
			this.anInt3789 = arg0.method5191();
			if (this.anInt3789 == 65535) {
				this.anInt3789 = -1;
			}
			if (this.aByte63 != 0) {
				this.anInt3800 = arg0.method5191();
			}
			if (this.aByte62 != 0) {
				this.anInt3825 = arg0.method5191();
			}
		}
		if (this.anInt3820 == 4) {
			this.anInt3781 = arg0.method5191();
			if (this.anInt3781 == 65535) {
				this.anInt3781 = -1;
			}
			if (local7 >= 2) {
				this.aBoolean299 = arg0.method5205() == 1;
			}
			this.aString44 = arg0.method5167();
			this.anInt3748 = arg0.method5205();
			this.anInt3818 = arg0.method5205();
			this.anInt3814 = arg0.method5205();
			this.aBoolean286 = arg0.method5205() == 1;
			this.anInt3779 = arg0.method5158();
			this.anInt3780 = arg0.method5205();
			if (local7 >= 0) {
				this.anInt3788 = arg0.method5205();
			}
		}
		if (this.anInt3820 == 3) {
			this.anInt3779 = arg0.method5158();
			this.aBoolean294 = arg0.method5205() == 1;
			this.anInt3780 = arg0.method5205();
		}
		if (this.anInt3820 == 9) {
			this.anInt3778 = arg0.method5205();
			this.anInt3779 = arg0.method5158();
			this.aBoolean287 = arg0.method5205() == 1;
		}
		local191 = arg0.method5192();
		@Pc(628) int local628 = arg0.method5205();
		@Pc(653) int local653;
		if (local628 != 0) {
		...
		if (local750 > 0) {
			...
			this.anIntArray301[local730] = arg0.method5191();
		}
		if (local750 > 1) {
			local730 = arg0.method5205();
			this.anIntArray301[local730] = arg0.method5191();
		}
		this.aString42 = arg0.method5167();
		if (this.aString42.equals("")) {
			this.aString42 = null;
		}
		this.anInt3754 = arg0.method5205();
		this.anInt3797 = arg0.method5205();
		this.anInt3830 = arg0.method5205();
		this.aString43 = arg0.method5167();
		local730 = -1;
		if (Static622.method4816(local191) != 0) {
			local730 = arg0.method5191();
			if (local730 == 65535) {
				local730 = -1;
			}
			this.anInt3749 = arg0.method5191();
			if (this.anInt3749 == 65535) {
				this.anInt3749 = -1;
			}
			this.anInt3819 = arg0.method5191();
			if (this.anInt3819 == 65535) {
				this.anInt3819 = -1;
			}
		}
		if (local7 >= 0) {
			this.anInt3783 = arg0.method5191();
		...
		if (local7 >= 0) {
			local767 = arg0.method5205();
			@Pc(929) int local929;
			@Pc(933) int local933;
			for (@Pc(924) int local924 = 0; local924 < local767; local924++) {
				local929 = arg0.method5192();
				local933 = arg0.method5158();
				this.aClass28_17.method370((long) local929, new Class2_Sub38(local933));
			}
			local929 = arg0.method5205();
			for (local933 = 0; local933 < local929; local933++) {
				@Pc(958) int local958 = arg0.method5192();
				@Pc(962) String local962 = arg0.method5152();
				this.aClass28_17.method370((long) local958, new Class2_Sub24(local962));
			}
		}
		this.anObjectArray13 = this.method2424(arg0);
		this.anObjectArray4 = this.method2424(arg0);
		this.anObjectArray26 = this.method2424(arg0);
		this.anObjectArray16 = this.method2424(arg0);
		this.anObjectArray14 = this.method2424(arg0);
		this.anObjectArray25 = this.method2424(arg0);
		this.anObjectArray8 = this.method2424(arg0);
		this.anObjectArray21 = this.method2424(arg0);
		this.anObjectArray3 = this.method2424(arg0);
		this.anObjectArray15 = this.method2424(arg0);
		if (local7 >= 0) {
			this.anObjectArray10 = this.method2424(arg0);
		}
		this.anObjectArray28 = this.method2424(arg0);
		this.anObjectArray17 = this.method2424(arg0);
		this.anObjectArray24 = this.method2424(arg0);
		this.anObjectArray1 = this.method2424(arg0);
		this.anObjectArray32 = this.method2424(arg0);
		this.anObjectArray30 = this.method2424(arg0);
		this.anObjectArray5 = this.method2424(arg0);
		this.anObjectArray11 = this.method2424(arg0);
		this.anObjectArray2 = this.method2424(arg0);
		this.anObjectArray18 = this.method2424(arg0);
		this.anIntArray300 = this.method2436(arg0);
		this.anIntArray299 = this.method2436(arg0);
		this.anIntArray295 = this.method2436(arg0);
		this.anIntArray298 = this.method2436(arg0);
		this.anIntArray296 = this.method2436(arg0);
	}

	@OriginalMember(owner = "client!hda", name = "c", descriptor = "(Ljava/lang/String;II)V")
	public void method2429(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
	...
	public Class159 method2431(@OriginalArg(0) Class19 arg0) {
		@Pc(15) long local15 = (long) this.anInt3741 & 0xFFFFFFFFL | (long) this.anInt3812 << 32;
		@Pc(21) Class159 local21 = (Class159) Static449.aClass82_146.method1390(local15);
		if (local21 != null) {
			if (local21.anInt3836 != this.anInt3810) {
				local21 = null;
				Static449.aClass82_146.method1388(local15);
			}
			if (local21 != null) {
				return local21;
			}
		}
		@Pc(53) Class407 local53 = Static735.method6771(Static262.aClass330_56, this.anInt3810, 0);
		if (local53 == null) {
			return null;
		}
		...
		@Pc(180) Class1 local180 = arg0.a(local77, local86, local89, local92);
		if (local180 == null) {
			return null;
		} else {
			local21 = new Class159(local77, local86, local92, local89, local180, this.anInt3810);
			Static449.aClass82_146.method1384(local21, local15);
			return local21;
		}
	}

	@OriginalMember(owner = "client!hda", name = "b", descriptor = "(Ljava/lang/String;II)V")
	public void method2434(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		if (this.aClass28_17 == null) {
			this.aClass28_17 = new Class28(16);
			this.aClass28_17.method370((long) arg1, new Class2_Sub24(arg0));
			return;
		}
		@Pc(32) Class2_Sub24 local32 = (Class2_Sub24) this.aClass28_17.method373((long) arg1);
		if (local32 == null) {
			this.aClass28_17.method370((long) arg1, new Class2_Sub24(arg0));
		} else {
	...
	public void method2435(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	private int[] method2436(@OriginalArg(1) Class2_Sub21 arg0) {
		@Pc(7) int local7 = arg0.method5205();
		if (local7 == 0) {
			return null;
		}
		...
		for (@Pc(23) int local23 = 0; local23 < local7; local23++) {
			local15[local23] = arg0.method5158();
		}
		return local15;
	}
	...
	public Class114 method2439(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class152 arg1, @OriginalArg(2) Class310 arg2, @OriginalArg(3) Class215 arg3, @OriginalArg(5) Class50 arg4, @OriginalArg(6) Class201 arg5, @OriginalArg(7) Interface23 arg6, @OriginalArg(8) Class308 arg7, @OriginalArg(9) Class112 arg8, @OriginalArg(10) int arg9, @OriginalArg(11) Class386 arg10) {
		...
		if (this.anInt3823 == 0) {
			...
			@Pc(277) Class114 local277 = (Class114) Static312.aClass82_106.method1390(local271);
			if (local277 == null || arg0.b(local277.ua(), arg9) != 0) {
				if (local277 != null) {
					arg9 = arg0.c(arg9, local277.ua());
				}
				@Pc(307) Class88 local307 = Static121.method1430(this.anInt3831, Static607.aClass330_113);
				if (local307 == null) {
					Static544.aBoolean624 = true;
					return null;
				}
				...
				local277 = arg0.a(local307, arg9, Static108.anInt2168, 64, 768);
				@Pc(339) int local339;
				if (this.aShortArray57 != null) {
				...
				Static312.aClass82_106.method1384(local277, local271);
			}
			if (arg1 != null) {
				local277 = local277.a((byte) 1, arg9, true);
				arg1.method6523(local277, 0);
			}
			local277.s(2048);
			return local277;
		} else {
			...
			if (this.anInt3823 == 2) {
				local438 = arg7.method4967(this.anInt3831).method4228(arg1, arg10, arg0, arg6);
				if (local438 == null) {
					Static544.aBoolean624 = true;
					return null;
				} else {
				...
				local438 = arg5.method3182(arg3, arg4, arg6, arg1, arg8, arg7, arg0);
				if (local438 == null) {
					Static544.aBoolean624 = true;
					return null;
				} else {
				...
				@Pc(489) Class382 local489 = arg8.method1684(this.anInt3831);
				@Pc(498) Class114 local498 = local489.method6292(arg1, 2048, arg5, 10, arg0);
				if (local498 == null) {
					Static544.aBoolean624 = true;
					return null;
				} else {
				...
				local438 = arg7.method4967(this.anInt3831).method4229(arg6, arg0, arg2, arg1, 0, (int[]) null, arg10, (Class152) null, 2048, (Class152[]) null);
				if (local438 == null) {
					Static544.aBoolean624 = true;
					return null;
				} else {
				...
				@Pc(578) Class114 local578 = arg5.method3180(arg1, local558, local566, arg4, arg0, arg3, local563);
				if (local578 == null) {
					Static544.aBoolean624 = true;
					return null;
				} else {
	...
	public void method2440(@OriginalArg(0) int arg0) {
		if (this.aClass28_17 != null) {
			@Pc(14) Class2 local14 = this.aClass28_17.method373((long) arg0);
			if (local14 != null) {
				local14.a((byte) 120);
			}
		}
	...
	public Class14 method2441(@OriginalArg(1) Class19 arg0) {
		@Pc(18) Class14 local18 = Static324.method3246(this.aBoolean299, false, this.anInt3781, arg0);
		Static544.aBoolean624 = local18 == null;
		return local18;
	}

	@OriginalMember(owner = "client!hda", name = "a", descriptor = "(III)I")
	public int method2442(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		if (this.aClass28_17 == null) {
			return arg0;
		} else {
			@Pc(17) Class2_Sub38 local17 = (Class2_Sub38) this.aClass28_17.method373((long) arg1);
	...
	public Class148 method2443(@OriginalArg(1) Class78 arg0, @OriginalArg(2) Class307 arg1) {
		if (this.anInt3824 == -1) {
			return null;
		}
		...
		@Pc(54) Class148 local54 = (Class148) Static444.aClass82_145.method1390(local48);
		if (local54 == null) {
			local54 = arg1.method4947(arg0, this.anInt3782, this.anInt3824, this.anInt3796, this.anInt3763);
			Static444.aClass82_145.method1384(local54, local48);
		}
		return local54;
	}

	@OriginalMember(owner = "client!hda", name = "a", descriptor = "(ISIS)V")
	public void method2444(@OriginalArg(1) short arg0, @OriginalArg(2) int arg1, @OriginalArg(3) short arg2) {
		if (arg1 >= 5) {
			return;
		}
		if (this.aShortArray57 == null) {
