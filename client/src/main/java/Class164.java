...
public final class Class164 {
	...
	public int method2508(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	private void method2509(@OriginalArg(1) int arg0) {
		if (this.aBoolean308) {
			if (this.aLongArray8 == null) {
				this.aLongArray8 = new long[arg0];
			} else {
				Static734.method5447(this.aLongArray8, 0, this.aLongArray8 = new long[arg0], 0, this.anInt3939);
			}
		}
		if (this.aBoolean306) {
			if (this.aStringArray18 == null) {
				...
				Static734.method5445(this.aStringArray18, 0, this.aStringArray18 = new String[arg0], 0, this.anInt3939);
			}
		}
		if (this.aByteArray40 == null) {
			this.aByteArray40 = new byte[arg0];
		} else {
			Static734.method5448(this.aByteArray40, 0, this.aByteArray40 = new byte[arg0], 0, this.anInt3939);
		}
		if (this.anIntArray309 == null) {
			this.anIntArray309 = new int[arg0];
		} else {
			Static734.method5449(this.anIntArray309, 0, this.anIntArray309 = new int[arg0], 0, this.anInt3939);
		}
		if (this.anIntArray308 == null) {
			this.anIntArray308 = new int[arg0];
		} else {
			Static734.method5449(this.anIntArray308, 0, this.anIntArray308 = new int[arg0], 0, this.anInt3939);
		}
	}

	@OriginalMember(owner = "client!hi", name = "a", descriptor = "(ILjava/lang/String;JI)V")
	public void method2510(@OriginalArg(1) String arg0, @OriginalArg(2) long arg1, @OriginalArg(3) int arg2) {
		...
		if (this.aBoolean308 != arg1 > 0L) {
			...
			if (arg1 > 0L && (this.aLongArray8 == null || this.anInt3939 >= this.aLongArray8.length) || arg0 != null && (this.aStringArray18 == null || this.aStringArray18.length <= this.anInt3939)) {
				this.method2509(this.anInt3939 + 5);
			}
			if (this.aLongArray8 != null) {
	...
	public Long method2511(@OriginalArg(1) int arg0) {
		if (this.aClass28_19 == null) {
			return null;
		} else {
			@Pc(16) Class2 local16 = this.aClass28_19.method373((long) arg0);
	...
	public int method2512(@OriginalArg(0) String arg0) {
		if (arg0 == null || arg0.length() == 0) {
			return -1;
		}
	...
	public boolean method2514(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		if (arg0 == null) {
			arg0 = "";
		...
		if (this.aClass28_19 == null) {
			...
			@Pc(32) Class2 local32 = this.aClass28_19.method373((long) arg1);
			if (local32 != null) {
		...
		this.aClass28_19.method370((long) arg1, new Class2_Sub24(arg0));
		return true;
	}
	...
	public String method2517(@OriginalArg(1) int arg0) {
		if (this.aClass28_19 == null) {
			return null;
		} else {
			@Pc(24) Class2 local24 = this.aClass28_19.method373((long) arg0);
	...
	public void method2518(@OriginalArg(0) int arg0) {
		...
		Static734.method5448(this.aByteArray40, arg0 + 1, this.aByteArray40, arg0, this.anInt3939 - arg0);
		Static734.method5449(this.anIntArray309, arg0 + 1, this.anIntArray309, arg0, this.anInt3939 - arg0);
		Static734.method5449(this.anIntArray308, arg0 + 1, this.anIntArray308, arg0, this.anInt3939 - arg0);
		if (this.aLongArray8 != null) {
			Static734.method5447(this.aLongArray8, arg0 + 1, this.aLongArray8, arg0, this.anInt3939 - arg0);
		}
		if (this.aStringArray18 != null) {
			Static734.method5445(this.aStringArray18, arg0 + 1, this.aStringArray18, arg0, this.anInt3939 - arg0);
		}
	...
	public void method2519(@OriginalArg(0) String arg0, @OriginalArg(1) long arg1) {
		if (arg0 != null && arg0.length() == 0) {
			arg0 = null;
		}
		if (arg1 > 0L != this.aBoolean308) {
			...
			if (arg1 > 0L && (this.aLongArray7 == null || this.aLongArray7.length <= this.anInt3941) || arg0 != null && (this.aStringArray19 == null || this.anInt3941 >= this.aStringArray19.length)) {
				this.method2525(this.anInt3941 + 5);
			}
	...
	public int[] method2520() {
		if (this.anIntArray310 == null) {
			...
			Static351.method3604(this.anIntArray310, local14);
		}
		return this.anIntArray310;
	}

	@OriginalMember(owner = "client!hi", name = "a", descriptor = "(BIJ)Z")
	public boolean method2521(@OriginalArg(1) int arg0, @OriginalArg(2) long arg1) {
		if (this.aClass28_19 == null) {
			this.aClass28_19 = new Class28(4);
		} else {
			@Pc(29) Class2 local29 = this.aClass28_19.method373((long) arg0);
			if (local29 != null) {
		...
		this.aClass28_19.method370((long) arg0, new Class2_Sub48(arg1));
		return true;
	}

	@OriginalMember(owner = "client!hi", name = "a", descriptor = "(BBI)I")
	public int method2522(@OriginalArg(0) byte arg0, @OriginalArg(2) int arg1) {
	...
	public Integer method2523(@OriginalArg(0) int arg0) {
		if (this.aClass28_19 == null) {
			return null;
		} else {
			@Pc(24) Class2 local24 = this.aClass28_19.method373((long) arg0);
	...
	public void method2524(@OriginalArg(0) int arg0) {
		this.anInt3941--;
		if (this.anInt3941 == 0) {
		...
		if (this.aLongArray7 != null) {
			Static734.method5447(this.aLongArray7, arg0 + 1, this.aLongArray7, arg0, this.anInt3941 - arg0);
		}
		if (this.aStringArray19 != null) {
			Static734.method5445(this.aStringArray19, arg0 + 1, this.aStringArray19, arg0, this.anInt3941 - arg0);
		}
	}

	@OriginalMember(owner = "client!hi", name = "a", descriptor = "(IB)V")
	private void method2525(@OriginalArg(0) int arg0) {
		if (this.aBoolean308) {
			if (this.aLongArray7 == null) {
				this.aLongArray7 = new long[arg0];
			} else {
				Static734.method5447(this.aLongArray7, 0, this.aLongArray7 = new long[arg0], 0, this.anInt3941);
			}
		}
		if (!this.aBoolean306) {
			return;
		...
		if (this.aStringArray19 == null) {
			...
			Static734.method5445(this.aStringArray19, 0, this.aStringArray19 = new String[arg0], 0, this.anInt3941);
		}
	}

	@OriginalMember(owner = "client!hi", name = "a", descriptor = "(IIIII)Z")
	public boolean method2526(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		if (this.aClass28_19 == null) {
			...
			@Pc(63) Class2 local63 = this.aClass28_19.method373((long) arg3);
			if (local63 != null) {
		...
		this.aClass28_19.method370((long) arg3, new Class2_Sub38(local43));
		return true;
	}

	@OriginalMember(owner = "client!hi", name = "a", descriptor = "(ILclient!ge;)V")
	private void method2527(@OriginalArg(1) Class2_Sub21 arg0) {
		@Pc(9) int local9 = arg0.method5205();
		if (local9 < 1 || local9 > 5) {
			throw new RuntimeException("Unsupported ClanSettings version: " + local9);
		}
		@Pc(37) int local37 = arg0.method5205();
		if ((local37 & 0x2) != 0) {
		...
		this.anInt3950 = arg0.method5158();
		this.anInt3944 = arg0.method5158();
		if (local9 <= 3 && this.anInt3944 != 0) {
			this.anInt3944 += 16912800;
		}
		this.anInt3939 = arg0.method5191();
		this.anInt3941 = arg0.method5205();
		this.aString45 = arg0.method5167();
		if (local9 >= 4) {
			arg0.method5158();
		}
		this.aBoolean307 = arg0.method5205() == 1;
		this.aByte68 = arg0.method5186();
		this.aByte67 = arg0.method5186();
		this.aByte66 = arg0.method5186();
		this.aByte65 = arg0.method5186();
		@Pc(282) int local282;
		if (this.anInt3939 > 0) {
			...
			for (local282 = 0; local282 < this.anInt3939; local282++) {
				if (this.aBoolean308) {
					this.aLongArray8[local282] = arg0.method5207();
				}
				if (this.aBoolean306) {
					this.aStringArray18[local282] = arg0.method5212();
				}
				this.aByteArray40[local282] = arg0.method5186();
				if (local9 >= 2) {
					this.anIntArray309[local282] = arg0.method5158();
				}
				if (local9 >= 5) {
					this.anIntArray308[local282] = arg0.method5191();
				} else {
		...
		if (this.anInt3941 > 0) {
			...
			for (local282 = 0; local282 < this.anInt3941; local282++) {
				if (this.aBoolean308) {
					this.aLongArray7[local282] = arg0.method5207();
				}
				if (this.aBoolean306) {
					this.aStringArray19[local282] = arg0.method5212();
				}
			}
		}
		if (local9 < 3) {
		...
		local282 = arg0.method5191();
		if (local282 <= 0) {
			return;
		}
		this.aClass28_19 = new Class28(local282 >= 16 ? 16 : Static440.method4203(local282));
		while (local282-- > 0) {
			@Pc(493) int local493 = arg0.method5158();
			@Pc(497) int local497 = local493 & 0x3FFFFFFF;
			@Pc(501) int local501 = local493 >>> 30;
			if (local501 == 0) {
				@Pc(510) int local510 = arg0.method5158();
				this.aClass28_19.method370((long) local497, new Class2_Sub38(local510));
			} else if (local501 == 1) {
				@Pc(533) long local533 = arg0.method5207();
				this.aClass28_19.method370((long) local497, new Class2_Sub48(local533));
			} else if (local501 == 2) {
				@Pc(556) String local556 = arg0.method5167();
				this.aClass28_19.method370((long) local497, new Class2_Sub24(local556));
			}
		}
		return;
	}
	...
	public Integer method2528(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		if (this.aClass28_19 == null) {
			return null;
		}
		@Pc(16) Class2 local16 = this.aClass28_19.method373((long) arg0);
	...
	public int method2530(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
	...
	public boolean method2531(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.aClass28_19 == null) {
			this.aClass28_19 = new Class28(4);
		} else {
			@Pc(35) Class2 local35 = this.aClass28_19.method373((long) arg1);
			if (local35 != null) {
		...
		this.aClass28_19.method370((long) arg1, new Class2_Sub38(arg0));
		return true;
	}
}
