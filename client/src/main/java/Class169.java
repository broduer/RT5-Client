	...
	public Class93_Sub2 method3529(@OriginalArg(1) int arg0) {
		...
		if (local10 != null) {
			...
			if (local33.aBoolean237 && this.aClass19_Sub3_17.method8021()) {
				@Pc(71) float[] local71 = this.anInterface4_4.method6823(local52, arg0, 0.7F, local52);
				local90 = new Class93_Sub2(this.aClass19_Sub3_17, 3553, 34842, local52, local52, local33.aByte53 != 0, local71, 6408);
			} else {
				@Pc(114) int[] local114;
				if (local33.anInt2805 != 2 && Static501.method6722(local33.aByte56)) {
					local114 = this.anInterface4_4.method6825(local52, true, local52, arg0, 0.7F);
				} else {
					local114 = this.anInterface4_4.method6822(0.7F, arg0, local52, local52);
				}
