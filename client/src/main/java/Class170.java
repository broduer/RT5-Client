...
public final class Class170 {
	...
	public void method2564(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) Class2_Sub2_Sub9 arg2) {
		...
		if (local35 > 0 && local32 > 0) {
			Static607.method5776(this.aByteArray41, local79, local27, local35, local32, local48, local6.aByteArray85, local29);
			this.method2568(arg1, local32, local35, arg0);
		}
	}

	@OriginalMember(owner = "client!hn", name = "a", descriptor = "(IZZI[[ZI)V")
	public void method2565(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(3) int arg2, @OriginalArg(4) boolean[][] arg3, @OriginalArg(5) int arg4) {
		this.aClass19_Sub3_18.method4883(false);
		this.aClass19_Sub3_18.method4847(false);
		this.aClass19_Sub3_18.method4921(-2);
		this.aClass19_Sub3_18.method4866(1);
		this.aClass19_Sub3_18.method4892(1);
									...
									if (local350 != null) {
										...
										if (this.aClass19_Sub3_18.aBoolean618) {
											for (local360 = 0; local360 < local350.length; local360++) {
												local77++;
												local262.method5182(local350[local360] & 0xFFFF);
											}
										} else {
											for (local360 = 0; local360 < local350.length; local360++) {
												local262.method5163(local350[local360] & 0xFFFF);
												local77++;
											}
										}
									}
	...
	public boolean method2566(@OriginalArg(1) int arg0, @OriginalArg(2) Class2_Sub2_Sub9 arg1, @OriginalArg(3) int arg2) {
		...
		if (local33 > 0 && local30 > 0) {
			...
			return Static417.method4051(local27, this.aByteArray41, local33, local30, local39);
		} else {
			return false;
		}
	}
	...
	public void method2567(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub2_Sub9 arg1, @OriginalArg(2) int arg2) {
		@Pc(6) Class2_Sub2_Sub9_Sub2 local6 = (Class2_Sub2_Sub9_Sub2) arg1;
		...
		if (local42 > 0 && local39 > 0) {
			Static672.method6257(local50, local48, local27, this.aByteArray41, local36, local6.aByteArray85, local39, local42);
			this.method2568(arg0, local39, local42, arg2);
		}
	}

	@OriginalMember(owner = "client!hn", name = "a", descriptor = "(IIIII)V")
	private void method2568(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
