...
public abstract class Class178 {
	...
	static {
		...
		for (@Pc(142) int local142 = 0; local142 < local140.length; local142++) {
			aClass167Array5[local140[local142].anInt3984] = local140[local142];
		}
	}
	...
	public abstract void method7875(@OriginalArg(0) Class2_Sub7 arg0, @OriginalArg(1) int[] arg1);
	...
	public abstract boolean method7881(@OriginalArg(0) Class2_Sub2_Sub9 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3);
