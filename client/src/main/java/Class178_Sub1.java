...
public final class Class178_Sub1 extends Class178 {
	...
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		this.method2719(arg3, arg4, arg1, -1, arg2, arg5, arg0);
	}
	...
	public void U(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) boolean arg13) {
		...
		for (@Pc(106) int local106 = 0; local106 < arg6.length; local106++) {
			...
			if ((this.anInt4302 & 0x20) != 0 && local114 != -1 && local41.method4805(local114).aBoolean240) {
				local118 = 128;
				local114 = -1;
			}
			@Pc(167) long local167 = (long) local114 | (long) arg10 << 28 | (long) arg12 << 48 | (long) arg11 << 42 | (long) (local118 << 14);
			@Pc(173) Class2 local173;
			for (local173 = this.aClass28_21.method373(local167); local173 != null; local173 = this.aClass28_21.method379()) {
			...
			if (local173 == null) {
				...
				this.aClass28_21.method370(local167, local104[local106]);
			} else {
	...
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		this.method2719(arg3, arg4, arg1, arg5, arg2, arg6, arg0);
	}
	...
	private void method2719(@OriginalArg(0) boolean[][] arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		...
		if (arg3 == -1) {
			this.aClass19_Sub1_9.method5653();
		} else {
			this.aClass19_Sub1_9.method5655((float) arg3);
			this.aClass19_Sub1_9.method5720();
		}
		this.aClass19_Sub1_9.method5705();
		this.aClass19_Sub1_9.method5681((this.anInt4302 & 0x7) != 0);
		this.aClass19_Sub1_9.method5717(false, -1, false);
		this.aClass19_Sub1_9.method5739(0, this.anInterface16_5);
		for (@Pc(219) int local219 = 0; local219 < this.aClass2_Sub58Array1.length; local219++) {
			this.aClass2_Sub58Array1[local219].method6784(Static80.anIntArray153, Static236.anInt3893);
		}
		@Pc(246) Class73_Sub1 local246 = this.aClass19_Sub1_9.method5649();
		local246.a(0, -1, 0);
		this.aClass19_Sub1_9.method5651();
		if (!this.aClass339_24.method5456()) {
			...
			this.aClass19_Sub1_9.method5681(false);
			this.aClass19_Sub1_9.method5692(false);
			this.aClass19_Sub1_9.method5662(128);
			this.aClass19_Sub1_9.method5717(false, -2, false);
			this.aClass19_Sub1_9.method5697(this.aClass19_Sub1_9.anInterface17_3);
			this.aClass19_Sub1_9.method5703(Static185.aClass121_3, Static209.aClass121_4);
			this.aClass19_Sub1_9.method5689(0, Static454.aClass168_5);
			this.aClass19_Sub1_9.method5751(Static207.aClass168_4, 0);
			for (@Pc(342) Class2 local342 = this.aClass339_24.method5453(65280); local342 != null; local342 = this.aClass339_24.method5460()) {
				@Pc(347) Class2_Sub32 local347 = (Class2_Sub32) local342;
				local347.method3187(arg6, arg2, (byte) 51, arg4, arg0);
			}
			this.aClass19_Sub1_9.method5689(0, Static189.aClass168_2);
			this.aClass19_Sub1_9.method5751(Static189.aClass168_2, 0);
			this.aClass19_Sub1_9.method5697((Interface17) null);
		...
		this.aClass19_Sub1_9.method5739(0, this.anInterface16_5);
		this.aClass19_Sub1_9.method5739(1, this.anInterface16_6);
		this.aClass19_Sub1_9.method5723(this.aClass244_8);
		this.aClass293_1.method4634(arg0, arg4, arg2, arg6, arg1);
		return;
	}
	...
	public void YA() {
		if (this.anInt4322 <= 0) {
			...
			@Pc(122) Class2_Sub58[] local122 = new Class2_Sub58[this.aClass28_21.method374()];
			this.aClass28_21.method378(local122);
			for (@Pc(132) int local132 = 0; local132 < local122.length; local132++) {
				local122[local132].method6783(this.anInt4322);
			}
			...
			@Pc(214) int local214 = Static402.method3969(this.anInt4322 / 4);
			if (local214 < 1) {
				local214 = 1;
			}
					...
					if (this.anIntArrayArrayArray5[local230][local234] != null) {
						...
						for (local472 = 0; local472 < local280.length; local472++) {
							...
							if ((this.anInt4303 - 1 & local535) == 0 && (this.anInt4303 - 1 & local545) == 0) {
								local923 = local224.method373(local590);
							}
							@Pc(964) int local964;
							...
							if (local923 == null) {
								...
								if (Stream.b()) {
									...
									local198.a((float) (local572 + this.a(local545, -120, (int) local535)));
									...
									local198.b((float) (this.a(local545, -109, (int) local535) + local572));
								...
								local224.method370(local590, new Class2_Sub50(local521[local472]));
							} else {
							...
							for (local1004 = 0; local1004 < local460; local1004++) {
								local228[local1004].method6788(local602, local626, local604, local964);
							}
							this.anInt4316++;
						}
					}
				...
				for (local1444 = 0; local1444 < super.anInt8892; local1444++) {
					...
					if (local1456 != null) {
						...
						while (local1456.length > local1462) {
							...
							if (local1489 != null) {
								local1499 = local1489;
								local1489.method6785(local1438, local1460, local1444);
							}
							if (local1493 != null) {
								local1493.method6785(local1438, local1460, local1444);
								if (local1499 == null || local1493.aLong328 < local1499.aLong328) {
									local1499 = local1493;
								}
							}
							if (local1497 != null) {
								local1497.method6785(local1438, local1460, local1444);
							...
							if (local1499 != null) {
								if (local1489 != null) {
									local1499.method6779(local1471);
								}
								if (local1493 != null) {
									local1499.method6779(local1478);
								}
								if (local1497 != null) {
									local1499.method6779(local1485);
								}
								local1499.method6785(local1438, local1460, local1444);
							}
							local1460++;
						}
					}
			...
			local198.c();
			local203.c();
			this.anInterface16_6 = this.aClass19_Sub1_9.method5765(false);
			this.anInterface16_6.method2237(4, this.lb * 4, local183);
			this.anInterface16_5 = this.aClass19_Sub1_9.method5765(false);
			this.anInterface16_5.method2237(local154, this.lb * local154, local193);
			if ((this.anInt4302 & 0x7) == 0) {
				if (this.anIntArrayArrayArray4 == null) {
					this.aClass244_8 = this.aClass19_Sub1_9.method5757(new Class237[] { new Class237(new Class157[] { Static231.aClass157_1, Static231.aClass157_5 }), new Class237(Static231.aClass157_3) });
				} else {
					this.aClass244_8 = this.aClass19_Sub1_9.method5757(new Class237[] { new Class237(new Class157[] { Static231.aClass157_1, Static231.aClass157_5, Static231.aClass157_4 }), new Class237(Static231.aClass157_3) });
				}
			} else if (this.anIntArrayArrayArray4 == null) {
				this.aClass244_8 = this.aClass19_Sub1_9.method5757(new Class237[] { new Class237(new Class157[] { Static231.aClass157_1, Static231.aClass157_5, Static231.aClass157_2 }), new Class237(Static231.aClass157_3) });
			} else {
				this.aClass244_8 = this.aClass19_Sub1_9.method5757(new Class237[] { new Class237(new Class157[] { Static231.aClass157_1, Static231.aClass157_5, Static231.aClass157_4, Static231.aClass157_2 }), new Class237(Static231.aClass157_3) });
			}
			local1444 = 0;
			...
			for (local1462 = 0; local1462 < local1444; local1462++) {
				...
				local1871.method6787(this.lb);
			}
			Static61.method808(local1861, this.aClass2_Sub58Array1);
			if (this.aClass293_1 != null) {
				this.aClass293_1.method4640();
			}
		}
	...
	public void a(@OriginalArg(0) Class2_Sub7 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass339_24.method5465(new Class2_Sub32(this.aClass19_Sub1_9, this, arg0, arg1));
	}
	...
	public void wa(@OriginalArg(0) Class2_Sub2_Sub9 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		if (this.aClass293_1 != null && arg0 != null) {
			...
			this.aClass293_1.method4636(arg0, local27, local42);
		}
	}
	...
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean[][] arg7) {
		...
		@Pc(20) Interface20 local20 = this.aClass19_Sub1_9.method5683(this.anInt4316);
		@Pc(22) int local22 = 0;
		@Pc(24) int local24 = 32767;
		@Pc(26) int local26 = -32768;
		for (@Pc(28) int local28 = 0; local28 < 4; local28++) {
			local22 = 0;
			@Pc(39) Buffer local39 = local20.method6091();
			if (local39 != null) {
				@Pc(47) Stream local47 = this.aClass19_Sub1_9.method5709(local39);
				@Pc(51) int local51;
				@Pc(60) int local60;
				@Pc(62) int local62;
				@Pc(83) short[] local83;
				...
				@Pc(95) int local95;
				if (Stream.b()) {
					for (local51 = arg4; local51 < arg6; local51++) {
						local60 = arg3 + local51 * super.anInt8894;
						for (local62 = arg3; local62 < arg5; local62++) {
							if (arg7[local62 - arg3][local51 - arg4]) {
					...
					for (local51 = arg4; local51 < arg6; local51++) {
						local60 = arg3 + super.anInt8894 * local51;
						for (local62 = arg3; local62 < arg5; local62++) {
							if (arg7[local62 - arg3][local51 - arg4]) {
								local83 = this.aShortArrayArray4[local60];
								if (local83 != null) {
		...
		this.aClass19_Sub1_9.method5761();
		this.aClass19_Sub1_9.method5756(false);
		this.aClass19_Sub1_9.method5681(false);
		this.aClass19_Sub1_9.method5732(false);
		this.aClass19_Sub1_9.method5692(false);
		this.aClass19_Sub1_9.method5662(0);
		this.aClass19_Sub1_9.method5717(false, -2, false);
		this.aClass19_Sub1_9.method5697((Interface17) null);
		@Pc(306) Class73_Sub1 local306 = this.aClass19_Sub1_9.method5649();
		@Pc(311) float[] local311 = this.aClass19_Sub1_9.method5742();
		local311[13] = 1.0F - ((float) (arg1 * 2) + (float) (arg2 * arg6) / 128.0F) / (float) this.aClass19_Sub1_9.anInt9013;
		local311[2] = 0.0F;
		local311[4] = 0.0F;
		local311[9] = 0.0F;
		local311[8] = 0.0F;
		local311[7] = 0.0F;
		local311[11] = 0.0F;
		local311[5] = (float) arg2 / ((float) super.anInt8888 * 128.0F * (float) this.aClass19_Sub1_9.anInt9013);
		local311[0] = (float) arg2 / ((float) super.anInt8888 * 128.0F * (float) this.aClass19_Sub1_9.anInt9122);
		local311[12] = -1.0F - ((float) (arg3 * arg2) / 128.0F - (float) (arg0 * 2)) / (float) this.aClass19_Sub1_9.anInt9122;
		local311[1] = 0.0F;
		...
		local311[3] = 0.0F;
		local311[15] = 1.0F;
		local306.method1203(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 0.0F, 1.0F, 0.0F, 0.0F);
		this.aClass19_Sub1_9.method5724();
		this.aClass19_Sub1_9.method5651();
		if ((this.anInt4302 & 0x7) == 0) {
			this.aClass19_Sub1_9.method5681(false);
		} else {
			this.aClass19_Sub1_9.method5681(true);
			this.aClass19_Sub1_9.method5767();
		}
		this.aClass19_Sub1_9.method5750(false);
		this.aClass19_Sub1_9.method5739(0, this.anInterface16_5);
		this.aClass19_Sub1_9.method5739(1, this.anInterface16_6);
		this.aClass19_Sub1_9.method5723(this.aClass244_8);
		this.aClass19_Sub1_9.method5661(local24, 0, local20, local26 + 1 - local24, Static104.aClass131_2, local22 / 3);
		this.aClass19_Sub1_9.method5750(true);
	}
	...
	public boolean a(@OriginalArg(0) Class2_Sub2_Sub9 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		if (this.aClass293_1 == null || arg0 == null) {
			...
			return this.aClass293_1.method4637(local28, arg0, local43);
		}
	}
	...
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) int[] arg10, @OriginalArg(11) int[] arg11, @OriginalArg(12) int[] arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15, @OriginalArg(16) boolean arg16) {
		...
		this.U(arg0, arg1, local13, local48, local18, local58, local23, local28, local33, local38, arg13, arg14, arg15, arg16);
	}

	@OriginalMember(owner = "client!iga", name = "a", descriptor = "(IILclient!dn;I)V")
	private void method2721(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class2_Sub2_Sub9_Sub1 arg2) {
		...
		while (local22 > local70) {
			...
			if (-((local104 - local95) * (-local91 + local100)) + (local86 - local95) * (local100 + -local109) > 0) {
				arg2.method1426(local104, local95, local86, local100, local91, local109);
			}
		}
	}
	...
	public void CA(@OriginalArg(0) Class2_Sub2_Sub9 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		if (this.aClass293_1 != null && arg0 != null) {
			...
			this.aClass293_1.method4638(arg0, local42, local27);
		}
	}
	...
	public Class2_Sub2_Sub9 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class2_Sub2_Sub9 arg2) {
		...
		if (local25 != null && local25.method1421(local22, local22)) {
			local43 = local25;
			local25.method1425();
		} else {
			local43 = new Class2_Sub2_Sub9_Sub1(this.aClass19_Sub1_9, local22, local22);
		}
		local43.method1423(0, local22, local22, 0);
		this.method2721(arg0, arg1, local43);
		return local43;
	}
}
