...
public final class Class178_Sub2 extends Class178 {
	...
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		this.method4685(arg4, arg3, arg0, -1, arg2, arg1, arg5);
	}
	...
	public void a(@OriginalArg(0) Class2_Sub7 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass339_43.method5465(new Class2_Sub33(this.aClass19_Sub3_33, this, arg0, arg1));
	}

	@OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lclient!ph;IBI)V")
	private void method4684(@OriginalArg(0) Class2_Sub2_Sub9_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2) {
		...
		while (local93 < local27) {
			...
			if ((local115 - local124) * (local101 - local110) - (local115 - local106) * (-local110 + local119) > 0) {
				arg0.method4594(local101, local106, local110, local115, local124, local119);
			}
		}
	}
	...
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean[][] arg7) {
		...
		this.aClass19_Sub3_33.method4856();
		this.aClass19_Sub3_33.method4910(false);
		this.aClass19_Sub3_33.method4883(false);
		this.aClass19_Sub3_33.method4881(false);
		this.aClass19_Sub3_33.method4847(false);
		this.aClass19_Sub3_33.method4892(0);
		this.aClass19_Sub3_33.method4921(-2);
		this.aClass19_Sub3_33.method4876((Class93) null);
		Static699.aFloatArray81[5] = (float) arg2 / ((float) super.anInt8888 * 128.0F * (float) this.aClass19_Sub3_33.anInt7956);
		Static699.aFloatArray81[0] = (float) arg2 / ((float) this.aClass19_Sub3_33.anInt7869 * 128.0F * (float) super.anInt8888);
		...
		Static699.aFloatArray81[13] = 1.0F - ((float) (arg2 * arg6) / 128.0F + (float) (arg1 * 2)) / (float) this.aClass19_Sub3_33.anInt7956;
		...
		Static699.aFloatArray81[12] = -(((float) -(arg0 * 2) + (float) (arg2 * arg3) / 128.0F) / (float) this.aClass19_Sub3_33.anInt7869) - 1.0F;
		...
		if ((this.anInt7486 & 0x7) == 0) {
			...
			this.aClass19_Sub3_33.method4883(true);
			this.aClass19_Sub3_33.method4862();
		}
		this.aClass19_Sub3_33.method4914(this.aClass94_12, this.aClass94_13, this.aClass94_11, this.aClass94_14);
		...
		if (this.aClass19_Sub3_33.aBoolean618) {
			for (local327 = arg4; local327 < arg6; local327++) {
				local337 = local327 * super.anInt8894 + arg3;
				for (local339 = arg3; local339 < arg5; local339++) {
					if (arg7[local339 - arg3][local327 - arg4]) {
						local360 = this.aShortArrayArray6[local337];
						if (local360 != null) {
							for (local364 = 0; local364 < local360.length; local364++) {
								local317++;
								local321.method5182(local360[local364] & 0xFFFF);
							}
						}
					}
					local337++;
			...
			for (local327 = arg4; local327 < arg6; local327++) {
				...
				for (local339 = arg3; local339 < arg5; local339++) {
					if (arg7[local339 - arg3][local327 - arg4]) {
						...
						if (local360 != null) {
							for (local364 = 0; local364 < local360.length; local364++) {
								local321.method5163(local360[local364] & 0xFFFF);
								local317++;
							}
						}
					}
		...
		if (local317 > 0) {
			...
			this.aClass19_Sub3_33.method4909(0, local502, local317);
		}
	}
	...
	public void CA(@OriginalArg(0) Class2_Sub2_Sub9 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		if (this.aClass170_1 != null && arg0 != null) {
			...
			this.aClass170_1.method2564(local27, local42, arg0);
		}
	}
	...
	public void YA() {
		if (this.anInt7508 <= 0) {
			...
			this.aClass2_Sub39Array1 = new Class2_Sub39[this.aClass28_37.method374()];
			this.aClass28_37.method378(this.aClass2_Sub39Array1);
			for (local31 = 0; local31 < this.aClass2_Sub39Array1.length; local31++) {
				this.aClass2_Sub39Array1[local31].method4164(this.anInt7508);
			}
			...
			@Pc(194) int local194 = Static402.method3969(this.anInt7508 / 4);
			if (local194 < 1) {
				local194 = 1;
			}
					...
					if (this.anIntArrayArrayArray15[local212][local216] != null) {
						...
						for (local454 = 0; local454 < local262.length; local454++) {
							...
							if ((this.anInt7499 - 1 & local512) == 0 && (this.anInt7499 - 1 & local522) == 0) {
								local903 = local206.method373(local567);
							}
							...
							if (local903 == null) {
								...
								if (this.aClass19_Sub3_33.aBoolean618) {
									...
									local183.a((float) (local549 + this.a(local522, -110, (int) local512)));
									...
									local183.b((float) (local549 + this.a(local522, -112, (int) local512)));
								...
								local206.method370(local567, new Class2_Sub50(local499[local454]));
							} else {
							...
							for (local972 = 0; local972 < local442; local972++) {
								local210[local972].method4159(local579, local606, local581, local1293);
							}
							this.anInt7491++;
						}
					}
				...
				for (@Pc(1442) int local1442 = 0; local1442 < super.anInt8892; local1442++) {
					...
					if (local1454 != null) {
						...
						while (local1454.length > local1460) {
							...
							if (local1487 != null) {
								local1487.method4163(local1438, local1458, local1442);
								local1497 = local1487;
							}
							if (local1491 != null) {
								local1491.method4163(local1438, local1458, local1442);
								if (local1497 == null || local1497.aLong328 > local1491.aLong328) {
									local1497 = local1491;
								}
							}
							if (local1495 != null) {
								local1495.method4163(local1438, local1458, local1442);
							...
							if (local1497 != null) {
								if (local1487 != null) {
									local1497.method4162(local1469);
								}
								if (local1491 != null) {
									local1497.method4162(local1476);
								}
								if (local1495 != null) {
									local1497.method4162(local1483);
								}
								local1497.method4163(local1438, local1458, local1442);
							}
							local1458++;
						}
					}
			...
			local183.c();
			this.anInterface12_5 = this.aClass19_Sub3_33.method4891(local149, local178, local183.a());
			...
			for (local1458 = 0; local1458 < this.aClass2_Sub39Array1.length; local1458++) {
				...
				local1713.method4160(this.anInt7498);
			}
			Static61.method808(local1702, this.aClass2_Sub39Array1);
			if (this.aClass170_1 != null) {
				this.aClass170_1.method2563();
			}
		}
	...
	public void wa(@OriginalArg(0) Class2_Sub2_Sub9 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		if (this.aClass170_1 != null && arg0 != null) {
			...
			this.aClass170_1.method2567(local42, arg0, local27);
		}
	}
	...
	public boolean a(@OriginalArg(0) Class2_Sub2_Sub9 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		if (this.aClass170_1 == null || arg0 == null) {
			...
			return this.aClass170_1.method2566(local28, arg0, local43);
		}
	}
	...
	public void U(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) boolean arg13) {
		...
		for (@Pc(106) int local106 = 0; local106 < arg6.length; local106++) {
			...
			if ((this.anInt7486 & 0x20) != 0 && local114 != -1 && local41.method4805(local114).aBoolean240) {
				local114 = -1;
				local118 = 128;
			}
			@Pc(164) long local164 = (long) local114 | (long) arg12 << 48 | (long) arg11 << 42 | (long) arg10 << 28 | (long) (local118 << 14);
			@Pc(170) Class2 local170;
			for (local170 = this.aClass28_37.method373(local164); local170 != null; local170 = this.aClass28_37.method379()) {
			...
			if (local170 == null) {
				...
				this.aClass28_37.method370(local164, local104[local106]);
			} else {
	...
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		this.method4685(arg4, arg3, arg0, arg5, arg2, arg1, arg6);
	}

	@OriginalMember(owner = "client!pn", name = "a", descriptor = "(Z[[ZIIIIII)V")
	private void method4685(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean[][] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		...
		if (arg3 == -1) {
			this.aClass19_Sub3_33.method4902();
		} else {
			this.aClass19_Sub3_33.method4839((float) arg3);
			this.aClass19_Sub3_33.method4853();
		}
		this.aClass19_Sub3_33.method4883((this.anInt7486 & 0x7) != 0);
		for (@Pc(213) int local213 = 0; local213 < this.aClass2_Sub39Array1.length; local213++) {
			this.aClass2_Sub39Array1[local213].method4157(local126, local122);
		}
		if (!this.aClass339_43.method5456()) {
			...
			this.aClass19_Sub3_33.method4883(false);
			this.aClass19_Sub3_33.method4847(false);
			this.aClass19_Sub3_33.method4892(128);
			this.aClass19_Sub3_33.method4921(-2);
			this.aClass19_Sub3_33.method4876(this.aClass19_Sub3_33.aClass93_Sub2_5);
			this.aClass19_Sub3_33.method4906(7681, 8448);
			this.aClass19_Sub3_33.method4896(34166, 770, 0);
			this.aClass19_Sub3_33.method4904(0, 34167);
			for (@Pc(312) Class2 local312 = this.aClass339_43.method5453(65280); local312 != null; local312 = this.aClass339_43.method5460()) {
				@Pc(317) Class2_Sub33 local317 = (Class2_Sub33) local312;
				local317.method3448(arg2, arg1, arg4, arg5);
			}
			this.aClass19_Sub3_33.method4896(5890, 768, 0);
			this.aClass19_Sub3_33.method4904(0, 5890);
			this.aClass19_Sub3_33.method4876((Class93) null);
		...
		this.aClass19_Sub3_33.method4914((Class94) null, (Class94) null, this.aClass94_11, this.aClass94_14);
		this.aClass170_1.method2565(arg2, arg0, arg5, arg1, arg4);
		OpenGL.glPopMatrix();
	}
	...
	public Class2_Sub2_Sub9 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class2_Sub2_Sub9 arg2) {
		...
		if (local25 != null && local25.method4597(local22, local22)) {
			local43 = local25;
			local25.method4598();
		} else {
			local43 = new Class2_Sub2_Sub9_Sub2(this.aClass19_Sub3_33, local22, local22);
		}
		local43.method4596(local22, 0, local22, 0);
		this.method4684(local43, arg0, arg1);
		return local43;
	}
