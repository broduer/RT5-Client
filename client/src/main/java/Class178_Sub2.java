...
public final class Class178_Sub2 extends Class178 {
	...
	private final Class341 aClass341_43 = new Class341();
	...
	public void method7875(@OriginalArg(0) Class2_Sub7 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass341_43.method7718(new Class2_Sub33(this.aClass19_Sub3_33, this, arg0, arg1));
	}

	@OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lclient!ph;IBI)V")
	private void method6674(@OriginalArg(0) Class2_Sub2_Sub9_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2) {
	...
	public void method7880(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		...
		if (this.aClass19_Sub3_33.aClass2_Sub21_Sub1_3.aByteArray93.length >= this.anInt7513 * 2) {
			this.aClass19_Sub3_33.aClass2_Sub21_Sub1_3.anInt8412 = 0;
		} else {
			this.aClass19_Sub3_33.aClass2_Sub21_Sub1_3 = new Class2_Sub21_Sub1(this.anInt7513 * 2);
		}
					...
					if (arg4[local339 - arg0][local327 - arg1]) {
						...
						if (local360 != null) {
							for (local364 = 0; local364 < local360.length; local364++) {
								local317++;
								local321.method7380(local360[local364] & 0xFFFF);
							}
						}
					}
					local337++;
		...
		if (local317 > 0) {
			@Pc(502) Class134_Sub2 local502 = new Class134_Sub2(this.aClass19_Sub3_33, 5123, local321.aByteArray93, local321.anInt8412);
	...
	public void YA() {
		if (this.anInt7531 <= 0) {
			...
			@Pc(187) Class2_Sub39[] local187 = new Class2_Sub39[this.anInt7531];
			@Pc(194) int local194 = Static402.method5594(this.anInt7531 / 4);
			if (local194 < 1) {
				local194 = 1;
			}
			@Pc(206) Class28 local206 = new Class28(local194);
			@Pc(210) Class2_Sub39[] local210 = new Class2_Sub39[this.anInt7530];
			@Pc(216) int local216;
	...
	private void method6675(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean[][] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		...
		if (!this.aClass341_43.method7709()) {
			...
			for (@Pc(312) Class2 local312 = this.aClass341_43.method7706(65280); local312 != null; local312 = this.aClass341_43.method7713()) {
