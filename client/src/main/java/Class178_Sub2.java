...
public final class Class178_Sub2 extends Class178 {
	...
	private Node_Sub39[] aClass2_Sub39Array1;
	...
	private final LinkedList aClass341_43 = new LinkedList();

	@OriginalMember(owner = "client!pn", name = "J", descriptor = "I")
	private final int anInt7510 = this.anInt8919 - 2;
	...
	private Node_Sub39[][][] aClass2_Sub39ArrayArrayArray1;
	...
	public Class178_Sub2(@OriginalArg(0) Class19_Sub3 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) int[][] arg6, @OriginalArg(7) int arg7) {
		...
		this.aFloatArrayArray14 = new float[super.anInt8918 + 1][super.anInt8916 + 1];
		this.anIntArrayArrayArray11 = new int[arg3][arg4][];
		this.anIntArrayArrayArray14 = new int[arg3][arg4][];
		this.aFloatArrayArray15 = new float[super.anInt8918 + 1][super.anInt8916 + 1];
		...
		this.aFloatArrayArray16 = new float[super.anInt8918 + 1][super.anInt8916 + 1];
		this.anInt7522 = 0x1 << this.anInt7510;
		for (@Pc(115) int local115 = 1; super.anInt8916 > local115; local115++) {
		...
		this.aClass28_37 = new HashTable(128);
		if ((this.anInt7508 & 0x10) != 0) {
	...
	public void method7877(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		this.method6675(arg4, arg3, arg0, -1, arg2, arg1, arg5);
	}
	...
	public void method7875(@OriginalArg(0) Node_Sub7 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass341_43.insertBefore(new Node_Sub33(this.aClass19_Sub3_33, this, arg0, arg1));
	}

	@OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lclient!ph;IBI)V")
	private void method6674(@OriginalArg(0) SecondaryNode_Sub9_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2) {
		...
		for (@Pc(59) int local59 = 0; local59 < local27; local59++) {
			local53[local59] = local12[local59] >> this.aClass19_Sub3_33.anInt8012;
			local57[local59] = local19[local59] >> this.aClass19_Sub3_33.anInt8012;
		}
		@Pc(93) int local93 = 0;
		while (local93 < local27) {
			...
			if ((local115 - local124) * (local101 - local110) - (local115 - local106) * (-local110 + local119) > 0) {
				arg0.method6549(local101, local106, local110, local115, local124, local119);
			}
		}
	}
	...
	public void method7880(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		...
		this.aClass19_Sub3_33.method6988();
		this.aClass19_Sub3_33.method7042(false);
		this.aClass19_Sub3_33.method7015(false);
		this.aClass19_Sub3_33.method7013(false);
		...
		Static699.aFloatArray82[15] = 1.0F;
		Static699.aFloatArray82[8] = 0.0F;
		Static699.aFloatArray82[9] = 0.0F;
		Static699.aFloatArray82[13] = 1.0F - ((float) (arg3 * 1024) / 128.0F + (float) 0) / (float) this.aClass19_Sub3_33.anInt7979;
		Static699.aFloatArray82[14] = 0.0F;
		Static699.aFloatArray82[6] = 0.0F;
		Static699.aFloatArray82[11] = 0.0F;
		Static699.aFloatArray82[3] = 0.0F;
		Static699.aFloatArray82[12] = -(((float) 0 + (float) (arg0 * 1024) / 128.0F) / (float) this.aClass19_Sub3_33.anInt7892) - 1.0F;
		Static699.aFloatArray82[1] = 0.0F;
		Static699.aFloatArray82[10] = 0.0F;
		Static699.aFloatArray82[4] = 0.0F;
		Static699.aFloatArray82[7] = 0.0F;
		OpenGL.glMatrixMode(5889);
		OpenGL.glLoadMatrixf(Static699.aFloatArray82, 0);
		Static699.aFloatArray82[12] = 0.0F;
		Static699.aFloatArray82[15] = 1.0F;
		Static699.aFloatArray82[10] = 0.0F;
		Static699.aFloatArray82[9] = 1.0F;
		Static699.aFloatArray82[14] = 0.0F;
		Static699.aFloatArray82[8] = 0.0F;
		Static699.aFloatArray82[0] = 1.0F;
		Static699.aFloatArray82[5] = 0.0F;
		Static699.aFloatArray82[7] = 0.0F;
		Static699.aFloatArray82[6] = 1.0F;
		Static699.aFloatArray82[4] = 0.0F;
		Static699.aFloatArray82[11] = 0.0F;
		Static699.aFloatArray82[2] = 0.0F;
		Static699.aFloatArray82[1] = 0.0F;
		Static699.aFloatArray82[3] = 0.0F;
		Static699.aFloatArray82[13] = 0.0F;
		OpenGL.glMatrixMode(5888);
		OpenGL.glLoadMatrixf(Static699.aFloatArray82, 0);
		if ((this.anInt7508 & 0x7) == 0) {
			this.aClass19_Sub3_33.method7015(false);
		} else {
			this.aClass19_Sub3_33.method7015(true);
			this.aClass19_Sub3_33.method6994();
		}
		this.aClass19_Sub3_33.method7046(this.aClass94_12, this.aClass94_13, this.aClass94_11, this.aClass94_14);
		if (this.aClass19_Sub3_33.aClass2_Sub21_Sub1_3.data.length >= this.anInt7513 * 2) {
			this.aClass19_Sub3_33.aClass2_Sub21_Sub1_3.pos = 0;
		} else {
			this.aClass19_Sub3_33.aClass2_Sub21_Sub1_3 = new GlBuffer(this.anInt7513 * 2);
		}
		@Pc(317) int local317 = 0;
		@Pc(321) GlBuffer local321 = this.aClass19_Sub3_33.aClass2_Sub21_Sub1_3;
		@Pc(327) int local327;
		@Pc(337) int local337;
		@Pc(339) int local339;
		@Pc(360) short[] local360;
		@Pc(364) int local364;
		if (this.aClass19_Sub3_33.aBoolean619) {
			for (local327 = arg1; local327 < arg3; local327++) {
				local337 = local327 * super.anInt8918 + arg0;
			...
			for (local327 = arg1; local327 < arg3; local327++) {
				...
				for (local339 = arg0; local339 < arg2; local339++) {
					if (arg4[local339 - arg0][local327 - arg1]) {
						...
						if (local360 != null) {
							for (local364 = 0; local364 < local360.length; local364++) {
								local321.method7361(local360[local364] & 0xFFFF);
								local317++;
							}
						}
					}
		...
		if (local317 > 0) {
			...
			this.aClass19_Sub3_33.method7041(0, local502, local317);
		}
	}
	...
	public void CA(@OriginalArg(0) SecondaryNode_Sub9 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		if (this.aClass170_1 != null && arg0 != null) {
			@Pc(27) int local27 = arg1 - (arg2 * this.aClass19_Sub3_33.anInt8050 >> 8) >> this.aClass19_Sub3_33.anInt8012;
			@Pc(42) int local42 = arg3 - (arg2 * this.aClass19_Sub3_33.anInt8046 >> 8) >> this.aClass19_Sub3_33.anInt8012;
	...
	public void YA() {
		if (this.anInt7531 <= 0) {
			...
			@Pc(25) byte[][] local25 = new byte[super.anInt8918 + 1][super.anInt8916 + 1];
			@Pc(31) int local31;
			for (@Pc(27) int local27 = 1; local27 < super.anInt8918; local27++) {
				for (local31 = 1; local31 < super.anInt8916; local31++) {
			...
			for (local31 = 0; local31 < this.aClass2_Sub39Array1.length; local31++) {
				this.aClass2_Sub39Array1[local31].method5875(this.anInt7531);
			}
			...
			@Pc(178) NativeHeapBuffer local178 = this.aClass19_Sub3_33.aNativeHeap5.a(this.anInt7531 * local149, false);
			@Pc(183) Stream local183 = new Stream(local178);
			@Pc(187) Node_Sub39[] local187 = new Node_Sub39[this.anInt7531];
			@Pc(194) int local194 = Static402.method5594(this.anInt7531 / 4);
			if (local194 < 1) {
				local194 = 1;
			}
			@Pc(206) HashTable local206 = new HashTable(local194);
			@Pc(210) Node_Sub39[] local210 = new Node_Sub39[this.anInt7530];
			@Pc(216) int local216;
			for (@Pc(212) int local212 = 0; super.anInt8918 > local212; local212++) {
				for (local216 = 0; super.anInt8916 > local216; local216++) {
					if (this.anIntArrayArrayArray15[local212][local216] != null) {
						...
						@Pc(499) short[] local499 = this.aShortArrayArray6[local212 + super.anInt8918 * local216] = new short[local262.length];
						for (local454 = 0; local454 < local262.length; local454++) {
							@Pc(512) int local512 = (local212 << super.anInt8919) + local241[local454];
							@Pc(522) int local522 = (local216 << super.anInt8919) + local248[local454];
							@Pc(527) int local527 = local512 >> this.anInt7510;
							@Pc(532) int local532 = local522 >> this.anInt7510;
							...
							if (local571 == 0 && local575 == 0) {
								...
								local602 = local313;
								local610 = local299;
							} else if (local571 == 0 && local575 == super.anInt8912) {
								local602 = local340;
								local606 = local577 - local418;
								local608 = local331;
								local610 = local322;
							} else if (super.anInt8912 == local571 && super.anInt8912 == local575) {
								local606 = local577 - local430;
								local602 = local373;
								local608 = local362;
								local610 = local351;
							} else if (super.anInt8912 == local571 && local575 == 0) {
								local606 = local577 - local440;
								local608 = local391;
								local610 = local382;
								local602 = local400;
							} else {
								@Pc(677) float local677 = (float) local571 / (float) super.anInt8912;
								@Pc(684) float local684 = (float) local575 / (float) super.anInt8912;
								...
								@Pc(776) int local776 = ((local440 - local408) * local571 >> super.anInt8919) + local408;
								@Pc(788) int local788 = local418 + (local571 * (local430 - local418) >> super.anInt8919);
								local606 = local577 - (local575 * (local788 - local776) >> super.anInt8919) - local776;
							}
							if (local536 != -1) {
								...
								if ((this.anInt7508 & 0x7) == 0) {
									local581 = local602 * this.aClass19_Sub3_33.aFloatArray52[2] + local608 * this.aClass19_Sub3_33.aFloatArray52[1] + local610 * this.aClass19_Sub3_33.aFloatArray52[0];
							...
							if ((this.anInt7522 - 1 & local512) == 0 && (this.anInt7522 - 1 & local522) == 0) {
							...
							if (local903 == null) {
								if (local536 == local540) {
									...
									if ((this.anInt7508 & 0x7) == 0) {
										local702 = this.aClass19_Sub3_33.aFloatArray52[1] * local608 + local610 * this.aClass19_Sub3_33.aFloatArray52[0] + local602 * this.aClass19_Sub3_33.aFloatArray52[2];
								...
								if (this.aClass19_Sub3_33.aBoolean619) {
									...
									local183.a((float) (local549 + this.method7885(local522, local512)));
									...
									local183.b((float) (local549 + this.method7885(local522, local512)));
							...
							for (local972 = 0; local972 < local442; local972++) {
								local210[local972].method5870(local579, local606, local581, local1293);
							}
							this.anInt7513++;
						}
					}
			...
			for (local216 = 0; local216 < this.anInt7521; local216++) {
				@Pc(1419) Node_Sub39 local1419 = local187[local216];
				if (local1419 != null) {
					local1419.method5873(local216);
				}
			}
			@Pc(1458) int local1458;
			for (@Pc(1438) int local1438 = 0; local1438 < super.anInt8918; local1438++) {
				for (@Pc(1442) int local1442 = 0; local1442 < super.anInt8916; local1442++) {
					@Pc(1454) short[] local1454 = this.aShortArrayArray6[local1438 + local1442 * super.anInt8918];
					if (local1454 != null) {
						local1458 = 0;
						...
						while (local1454.length > local1460) {
							...
							if (local1487 != null) {
								local1487.method5874(local1438, local1458, local1442);
								local1497 = local1487;
							}
							if (local1491 != null) {
								local1491.method5874(local1438, local1458, local1442);
								if (local1497 == null || local1497.key > local1491.key) {
									local1497 = local1491;
								}
							}
							if (local1495 != null) {
								local1495.method5874(local1438, local1458, local1442);
							...
							if (local1497 != null) {
								if (local1487 != null) {
									local1497.method5873(local1469);
								}
								if (local1491 != null) {
									local1497.method5873(local1476);
								}
								if (local1495 != null) {
									local1497.method5873(local1483);
								}
								local1497.method5874(local1438, local1458, local1442);
							}
							local1458++;
						}
					}
			...
			local183.c();
			this.anInterface12_5 = this.aClass19_Sub3_33.method7023(local149, local178, local183.a());
			...
			for (local1458 = 0; local1458 < this.aClass2_Sub39Array1.length; local1458++) {
				...
				local1713.method5871(this.anInt7521);
			}
	...
	public void wa(@OriginalArg(0) SecondaryNode_Sub9 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		if (this.aClass170_1 != null && arg0 != null) {
			@Pc(27) int local27 = arg1 - (arg2 * this.aClass19_Sub3_33.anInt8050 >> 8) >> this.aClass19_Sub3_33.anInt8012;
			@Pc(42) int local42 = arg3 - (this.aClass19_Sub3_33.anInt8046 * arg2 >> 8) >> this.aClass19_Sub3_33.anInt8012;
	...
	public boolean method7881(@OriginalArg(0) SecondaryNode_Sub9 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (this.aClass170_1 == null || arg0 == null) {
			...
			@Pc(28) int local28 = arg1 - (arg2 * this.aClass19_Sub3_33.anInt8050 >> 8) >> this.aClass19_Sub3_33.anInt8012;
			@Pc(43) int local43 = arg3 - (arg2 * this.aClass19_Sub3_33.anInt8046 >> 8) >> this.aClass19_Sub3_33.anInt8012;
	...
	public void U(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) boolean arg13) {
		if (arg3 != null && this.anIntArrayArrayArray13 == null) {
			this.anIntArrayArrayArray13 = new int[super.anInt8918][super.anInt8916][];
		}
		if (arg5 != null && this.anIntArrayArrayArray10 == null) {
			this.anIntArrayArrayArray10 = new int[super.anInt8918][super.anInt8916][];
		}
		@Pc(41) TextureProvider local41 = this.aClass19_Sub3_33.anInterface4_10;
		...
		for (@Pc(106) int local106 = 0; local106 < arg6.length; local106++) {
			...
			if ((this.anInt7508 & 0x20) != 0 && local114 != -1 && local41.method6824(local114).aBoolean240) {
				local114 = -1;
				local118 = 128;
			}
			@Pc(164) long local164 = (long) local114 | (long) arg12 << 48 | (long) arg11 << 42 | (long) arg10 << 28 | (long) (local118 << 14);
			@Pc(170) Node local170;
			for (local170 = this.aClass28_37.get(local164); local170 != null; local170 = this.aClass28_37.method744()) {
				@Pc(177) Node_Sub39 local177 = (Node_Sub39) local170;
				if (local177.anInt6612 == local114 && (float) local118 == local177.aFloat121 && arg10 == local177.anInt6613 && local177.anInt6615 == arg11 && local177.anInt6605 == arg12) {
					break;
				}
			}
			if (local170 == null) {
				local104[local106] = new Node_Sub39(this, local114, local118, arg10, arg11, arg12);
				this.aClass28_37.put(local164, local104[local106]);
			} else {
		...
		if (this.anInt7530 < arg6.length) {
			this.anInt7530 = arg6.length;
		}
		this.anInt7531 += arg6.length;
	}
	...
	public void method7884(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		this.method6675(arg4, arg3, arg0, arg5, arg2, arg1, arg6);
	}

	@OriginalMember(owner = "client!pn", name = "a", descriptor = "(Z[[ZIIIIII)V")
	private void method6675(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean[][] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		...
		if (super.anInt8918 - 1 < local86) {
			local86 = super.anInt8918 - 1;
		}
		@Pc(105) int local105 = arg4 + arg5;
		if (local105 > super.anInt8916 - 1) {
			local105 = super.anInt8916 - 1;
		}
		...
		for (@Pc(128) int local128 = local61; local128 <= local86; local128++) {
			...
			for (local138 = local75; local138 <= local105; local138++) {
				if (local136[local138 - local77]) {
					local126[local122++] = local128 + local138 * super.anInt8918;
				}
			}
		}
		if (arg3 == -1) {
			this.aClass19_Sub3_33.method7034();
		} else {
			this.aClass19_Sub3_33.method6971((float) arg3);
			this.aClass19_Sub3_33.method6985();
		}
		this.aClass19_Sub3_33.method7015((this.anInt7508 & 0x7) != 0);
		for (@Pc(213) int local213 = 0; local213 < this.aClass2_Sub39Array1.length; local213++) {
			this.aClass2_Sub39Array1[local213].method5868(local126, local122);
		}
		if (!this.aClass341_43.isEmpty()) {
			local138 = this.aClass19_Sub3_33.anInt8025;
			@Pc(252) int local252 = this.aClass19_Sub3_33.anInt8031;
			this.aClass19_Sub3_33.L(0, local252, this.aClass19_Sub3_33.anInt8032);
			this.aClass19_Sub3_33.method7015(false);
			this.aClass19_Sub3_33.method6979(false);
			this.aClass19_Sub3_33.method7024(128);
			this.aClass19_Sub3_33.method7053(-2);
			this.aClass19_Sub3_33.method7008(this.aClass19_Sub3_33.aClass93_Sub2_5);
			this.aClass19_Sub3_33.method7038(7681, 8448);
			this.aClass19_Sub3_33.method7028(34166, 770, 0);
			this.aClass19_Sub3_33.method7036(0, 34167);
			for (@Pc(312) Node local312 = this.aClass341_43.head(); local312 != null; local312 = this.aClass341_43.next()) {
				@Pc(317) Node_Sub33 local317 = (Node_Sub33) local312;
				local317.method4940(arg2, arg1, arg4, arg5);
			}
	...
	public SecondaryNode_Sub9 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) SecondaryNode_Sub9 arg2) {
		...
		@Pc(22) int local22 = super.anInt8912 >> this.aClass19_Sub3_33.anInt8012;
		@Pc(25) SecondaryNode_Sub9_Sub2 local25 = (SecondaryNode_Sub9_Sub2) arg2;
		@Pc(43) SecondaryNode_Sub9_Sub2 local43;
		if (local25 != null && local25.method6552(local22, local22)) {
			local43 = local25;
			local25.method6553();
		} else {
			local43 = new SecondaryNode_Sub9_Sub2(this.aClass19_Sub3_33, local22, local22);
		}
		local43.method6551(local22, 0, local22, 0);
		this.method6674(local43, arg0, arg1);
		return local43;
	}
