...
public final class Class178_Sub3 extends Class178 {
	...
	private Class307[][] aClass307ArrayArray1;
	...
	private Class385[][] aClass385ArrayArray1;
	...
	private Class322[][] aClass322ArrayArray1;
	...
	public Class178_Sub3(@OriginalArg(0) Class19_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) int[][] arg6, @OriginalArg(7) int arg7) {
		...
		@Pc(29) int local29 = this.aClass19_Sub2_8.anInt4214 >> 9;
		for (@Pc(31) int local31 = 1; local31 < arg4; local31++) {
			for (@Pc(34) int local34 = 1; local34 < arg3; local34++) {
				...
				@Pc(124) int local124 = local29 + (this.aClass19_Sub2_8.anInt4200 * local90 + this.aClass19_Sub2_8.anInt4216 * local96 + this.aClass19_Sub2_8.anInt4209 * local102 >> 17);
				local124 >>= 0x1;
				if (local124 < 2) {
					local124 = 2;
	...
	@Override
	public void method7877(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		...
		for (@Pc(56) int local56 = 0; local56 < arg2 + arg2; local56++) {
			for (@Pc(59) int local59 = 0; local59 < arg2 + arg2; local59++) {
				if (arg3[local56][local59]) {
					...
					if (local72 >= 0 && local72 < super.anInt8918 && local78 >= 0 && local78 < super.anInt8916) {
						this.method7175(local72, local78, arg5);
					}
				}
			}
		}
	...
	private void method7168(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Class401 arg3, @OriginalArg(4) Class221 arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int arg9) {
		@Pc(6) Class322 local6 = this.aClass322ArrayArray1[arg0][arg1];
		...
		if (this.anInt8168 == -1) {
			for (local26 = 0; local26 < local6.aShort110; local26++) {
				local37 = local6.aShortArray116[local26] + (arg0 << super.anInt8919);
				local42 = local6.aShortArray117[local26];
				local52 = local6.aShortArray113[local26] + (arg1 << super.anInt8919);
				local73 = this.aFloat173 + this.aFloat164 * (float) local37 + this.aFloat172 * (float) local42 + this.aFloat165 * (float) local52;
				if (local73 <= (float) this.aClass19_Sub2_8.anInt4226) {
					return;
				}
				arg8[local26] = 0;
				if (arg2) {
					local95 = (int) (local73 - (float) arg3.anInt10629);
					if (local95 > 255) {
						local95 = 255;
					}
					if (local95 > 0) {
				...
				arg5[local26] = arg4.anInt5743 + (int) (local172 * (float) this.aClass19_Sub2_8.anInt4217 / local73);
				arg6[local26] = arg4.anInt5741 + (int) (local193 * (float) this.aClass19_Sub2_8.anInt4199 / local73);
			...
			for (local26 = 0; local26 < local6.aShort110; local26++) {
				...
				arg8[local26] = 0;
				if (arg2) {
					local95 = this.anInt8168 - arg3.anInt10629;
					if (local95 > 255) {
						local95 = 255;
					}
					if (local95 > 0) {
				...
				local172 = this.aFloat171 + this.aFloat170 * (float) local37 + this.aFloat167 * (float) local42 + this.aFloat162 * (float) local52;
				local193 = this.aFloat169 + this.aFloat168 * (float) local37 + this.aFloat163 * (float) local42 + this.aFloat166 * (float) local52;
				arg5[local26] = arg4.anInt5743 + (int) (local172 * (float) this.aClass19_Sub2_8.anInt4217 / (float) this.anInt8168);
				arg6[local26] = arg4.anInt5741 + (int) (local193 * (float) this.aClass19_Sub2_8.anInt4199 / (float) this.anInt8168);
				arg7[local26] = (int) local73;
			}
		}
		@Pc(441) float local441 = (float) super.anInt8912;
		for (local95 = 0; local95 < local6.aShort109; local95++) {
			...
			if ((local460 - local464) * (local480 - local476) - (local472 - local476) * (local468 - local464) > 0) {
				arg4.aBoolean434 = local460 < 0 || local464 < 0 || local468 < 0 || local460 > arg4.anInt5745 || local464 > arg4.anInt5745 || local468 > arg4.anInt5745;
				if (arg8[local115] + arg8[local452] + arg8[local456] < 765) {
					@Pc(550) int local550 = arg0 << super.anInt8919;
					@Pc(555) int local555 = arg1 << super.anInt8919;
	...
	@Override
	public void method7882(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.method7175(arg0, arg1, 0);
	}
	...
	public void U(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) boolean arg13) {
		@Pc(9) boolean local9 = (this.anInt8169 & 0x20) == 0;
		if (this.aClass307ArrayArray1 == null && !local9) {
			this.aClass307ArrayArray1 = new Class307[super.anInt8918][super.anInt8916];
			this.aClass385ArrayArray1 = new Class385[super.anInt8918][super.anInt8916];
		} else if (this.aClass322ArrayArray1 == null && local9) {
			this.aClass322ArrayArray1 = new Class322[super.anInt8918][super.anInt8916];
		...
		@Pc(530) int local530;
		if (local9) {
			@Pc(147) Class322 local147 = new Class322();
			...
			for (local205 = 0; local205 < local147.aShort110; local205++) {
				...
				} else if (local210 == 0 && local214 == super.anInt8912) {
					local236 = this.aByteArrayArray31[arg0][arg1 + 1] - this.aByteArrayArray30[arg0][arg1 + 1];
				} else if (local210 == super.anInt8912 && local214 == super.anInt8912) {
					local236 = this.aByteArrayArray31[arg0 + 1][arg1 + 1] - this.aByteArrayArray30[arg0 + 1][arg1 + 1];
				} else if (local210 == super.anInt8912 && local214 == 0) {
					local236 = this.aByteArrayArray31[arg0 + 1][arg1] - this.aByteArrayArray30[arg0 + 1][arg1];
				} else {
					local363 = (this.aByteArrayArray31[arg0][arg1] - this.aByteArrayArray30[arg0][arg1]) * (super.anInt8912 - local210) + (this.aByteArrayArray31[arg0 + 1][arg1] - this.aByteArrayArray30[arg0 + 1][arg1]) * local210;
					local410 = (this.aByteArrayArray31[arg0][arg1 + 1] - this.aByteArrayArray30[arg0][arg1 + 1]) * (super.anInt8912 - local210) + (this.aByteArrayArray31[arg0 + 1][arg1 + 1] - this.aByteArrayArray30[arg0 + 1][arg1 + 1]) * local210;
					local236 = local363 * (super.anInt8912 - local214) + local410 * local214 >> super.anInt8919 * 2;
				}
				local363 = (arg0 << super.anInt8919) + local210;
				local410 = (arg1 << super.anInt8919) + local214;
				local147.aShortArray116[local205] = (short) local210;
				local147.aShortArray113[local205] = (short) local214;
				local147.aShortArray117[local205] = (short) (this.method7885(local410, local363) + (arg3 == null ? 0 : arg3[local205]));
				if (local236 < 0) {
					local236 = 0;
				}
				if (arg6[local205] == 0) {
			...
			this.aClass322ArrayArray1[arg0][arg1] = local147;
			return;
		}
		...
		if (arg2.length == 6) {
			for (local363 = 0; local363 < 6; local363++) {
				if (arg2[local363] == 0 && arg4[local363] == 0) {
					...
					local205 = local363;
				} else if (arg2[local363] == super.anInt8912 && arg4[local363] == 0) {
					if (local210 != -1 && arg6[local210] != arg6[local363]) {
						local654 = false;
						break;
					}
					local210 = local363;
				} else if (arg2[local363] == super.anInt8912 && arg4[local363] == super.anInt8912) {
					if (local214 != -1 && arg6[local214] != arg6[local363]) {
						local654 = false;
						break;
					}
					local214 = local363;
				} else if (arg2[local363] == 0 && arg4[local363] == super.anInt8912) {
			...
			if (local654) {
				...
				if (local654) {
					for (local410 = 1; local410 < 4; local410++) {
						if (arg2[local410] != arg2[0] && arg2[local410] != arg2[0] + super.anInt8912 && arg2[local410] != arg2[0] - super.anInt8912) {
							local654 = false;
							break;
						}
						if (arg4[local410] != arg4[0] && arg4[local410] != arg4[0] + super.anInt8912 && arg4[local410] != arg4[0] - super.anInt8912) {
							local654 = false;
							break;
						}
					}
		...
		if (!local654) {
			@Pc(1760) Class385 local1760 = new Class385();
			...
			local1760.aShortArray144 = new short[local1760.aShort128];
			local1760.aShortArray142 = new short[local1760.aShort128];
			local1760.anIntArray802 = new int[local1760.aShort128];
			if (arg5 != null) {
				local1760.aShortArray139 = new short[local1760.aShort128];
			}
			...
			for (local410 = 0; local410 < local1760.aShort128; local410++) {
				...
				} else if (local498 == 0 && local530 == super.anInt8912) {
					local1834 = this.aByteArrayArray31[arg0][arg1 + 1] - this.aByteArrayArray30[arg0][arg1 + 1];
				} else if (local498 == super.anInt8912 && local530 == super.anInt8912) {
					local1834 = this.aByteArrayArray31[arg0 + 1][arg1 + 1] - this.aByteArrayArray30[arg0 + 1][arg1 + 1];
				} else if (local498 == super.anInt8912 && local530 == 0) {
					local1834 = this.aByteArrayArray31[arg0 + 1][arg1] - this.aByteArrayArray30[arg0 + 1][arg1];
				} else {
					local1961 = (this.aByteArrayArray31[arg0][arg1] - this.aByteArrayArray30[arg0][arg1]) * (super.anInt8912 - local498) + (this.aByteArrayArray31[arg0 + 1][arg1] - this.aByteArrayArray30[arg0 + 1][arg1]) * local498;
					local2008 = (this.aByteArrayArray31[arg0][arg1 + 1] - this.aByteArrayArray30[arg0][arg1 + 1]) * (super.anInt8912 - local498) + (this.aByteArrayArray31[arg0 + 1][arg1 + 1] - this.aByteArrayArray30[arg0 + 1][arg1 + 1]) * local498;
					local1834 = local1961 * (super.anInt8912 - local530) + local2008 * local530 >> super.anInt8919 * 2;
				}
				local1961 = (arg0 << super.anInt8919) + local498;
				local2008 = (arg1 << super.anInt8919) + local530;
				local1760.aShortArray143[local410] = (short) local498;
				local1760.aShortArray142[local410] = (short) local530;
				local1760.aShortArray144[local410] = (short) (this.method7885(local2008, local1961) + (arg3 == null ? 0 : arg3[local410]));
				if (local1834 < 0) {
					local1834 = 0;
				}
				if (arg6[local410] != 0) {
					local2098 = 0;
					if (arg5 != null) {
						@Pc(2110) short local2110 = local1760.aShortArray139[local410] = (short) arg5[local410];
						if (arg11 != 0) {
			...
			for (local530 = 0; local530 < local1760.aShort129; local530++) {
				if (arg8[local530 * 3] != -1 && !this.aClass19_Sub2_8.anInterface4_10.method6824(arg8[local530 * 3]).aBoolean240) {
					local2164 = true;
				}
			}
			if (arg7 != null) {
			...
			if (local2164) {
				...
				local1760.aShortArray141 = new short[local1760.aShort129];
			}
			for (local1834 = 0; local1834 < local1760.aShort129; local1834++) {
				...
				if (local2164) {
					...
					if (local2264 == -1 || this.aClass19_Sub2_8.anInterface4_10.method6824(local2264).aBoolean240) {
						local2260 = false;
					} else {
						local2258 = true;
					}
					...
					if (local2260) {
						local1760.aShortArray140[local1834] = (short) local2264;
						local1760.aShortArray141[local1834] = (short) arg9[local1961];
					} else {
						if (local2258) {
							local2264 = arg8[local1961];
							if (local2264 != -1 && !this.aClass19_Sub2_8.anInterface4_10.method6824(local2264).aBoolean240) {
								local1760.anIntArray802[local1961] = Static323.anIntArray389[Static105.method2043(this.aClass19_Sub2_8.anInterface4_10.method6824(local2264).aShort37 & 0xFFFF) & 0xFFFF];
							}
							local2264 = arg8[local2008];
							if (local2264 != -1 && !this.aClass19_Sub2_8.anInterface4_10.method6824(local2264).aBoolean240) {
								local1760.anIntArray802[local2008] = Static323.anIntArray389[Static105.method2043(this.aClass19_Sub2_8.anInterface4_10.method6824(local2264).aShort37 & 0xFFFF) & 0xFFFF];
							}
							local2264 = arg8[local2098];
							if (local2264 != -1 && !this.aClass19_Sub2_8.anInterface4_10.method6824(local2264).aBoolean240) {
								local1760.anIntArray802[local2098] = Static323.anIntArray389[Static105.method2043(this.aClass19_Sub2_8.anInterface4_10.method6824(local2264).aShort37 & 0xFFFF) & 0xFFFF];
							}
						}
						local1760.aShortArray140[local1834] = -1;
					}
				}
			}
			this.aClass385ArrayArray1[arg0][arg1] = local1760;
			return;
		}
		@Pc(931) Class307 local931 = new Class307();
		local410 = arg6[0];
		local498 = arg8[0];
		if (arg7 != null) {
			local931.anInt7793 = arg7[0] >> 8;
			if (local410 == 0) {
		...
		if (local498 == -1 || (local931.aByte126 & 0x2) != 0 || this.aClass19_Sub2_8.anInterface4_10.method6824(local498).aBoolean240) {
		...
		this.aClass307ArrayArray1[arg0][arg1] = local931;
	}

	@OriginalMember(owner = "client!qs", name = "a", descriptor = "(I)Z")
	private boolean method7169(@OriginalArg(0) int arg0) {
		if ((this.anInt8169 & 0x8) == 0) {
			return false;
		} else if (arg0 == 4) {
			return true;
		} else if (arg0 == 8) {
	...
	private void method7170(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4, @OriginalArg(8) Class401 arg5, @OriginalArg(9) Class221 arg6, @OriginalArg(10) int[] arg7, @OriginalArg(11) int[] arg8) {
		@Pc(7) int local7 = (arg3 - arg1) * 1024 / 256;
		@Pc(14) boolean local14 = arg5.aBoolean805;
			...
			for (@Pc(35) int local35 = arg1; local35 < arg3; local35++) {
				if (arg4[local32 - arg0][local35 - arg1]) {
					...
					if (this.aClass127ArrayArray1[local32][local35] != null) {
						...
						if (local62.aShort38 != -1 && (local62.aByte59 & 0x2) == 0 && local62.anInt2907 == -1) {
							local85 = this.aClass19_Sub2_8.method3793(local62.aShort38);
							arg6.method5163((float) (local30 - 4), (float) (local30 - 4), (float) local30, (float) (local26 + 4), (float) local26, (float) (local26 + 4), 100.0F, 100.0F, 100.0F, (float) Static244.method3513(local62.aShort41 & 0xFFFF, local85), (float) Static244.method3513(local62.aShort40 & 0xFFFF, local85), (float) Static244.method3513(local62.aShort39 & 0xFFFF, local85));
							arg6.method5163((float) local30, (float) local30, (float) (local30 - 4), (float) local26, (float) (local26 + 4), (float) local26, 100.0F, 100.0F, 100.0F, (float) Static244.method3513(local62.aShort42 & 0xFFFF, local85), (float) Static244.method3513(local62.aShort39 & 0xFFFF, local85), (float) Static244.method3513(local62.aShort40 & 0xFFFF, local85));
						} else if (local62.anInt2907 == -1) {
							arg6.method5163((float) (local30 - 4), (float) (local30 - 4), (float) local30, (float) (local26 + 4), (float) local26, (float) (local26 + 4), 100.0F, 100.0F, 100.0F, (float) (local62.aShort41 & 0xFFFF), (float) (local62.aShort40 & 0xFFFF), (float) (local62.aShort39 & 0xFFFF));
							arg6.method5163((float) local30, (float) local30, (float) (local30 - 4), (float) local26, (float) (local26 + 4), (float) local26, 100.0F, 100.0F, 100.0F, (float) (local62.aShort42 & 0xFFFF), (float) (local62.aShort39 & 0xFFFF), (float) (local62.aShort40 & 0xFFFF));
						} else {
							local85 = local62.anInt2907;
							arg6.method5163((float) (local30 - 4), (float) (local30 - 4), (float) local30, (float) (local26 + 4), (float) local26, (float) (local26 + 4), 100.0F, 100.0F, 100.0F, (float) local85, (float) local85, (float) local85);
							arg6.method5163((float) local30, (float) local30, (float) (local30 - 4), (float) local26, (float) (local26 + 4), (float) local26, 100.0F, 100.0F, 100.0F, (float) local85, (float) local85, (float) local85);
						}
						...
						for (local85 = 0; local85 < local338.aShort34; local85++) {
							arg7[local85] = local26 + local338.aShortArray32[local85] * 4 / super.anInt8912;
							arg8[local85] = local30 - local338.aShortArray38[local85] * 4 / super.anInt8912;
						}
	...
	private void method7171(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4, @OriginalArg(8) Class401 arg5, @OriginalArg(9) Class221 arg6, @OriginalArg(10) int[] arg7, @OriginalArg(11) int[] arg8) {
		@Pc(7) int local7 = (arg3 - arg1) * 1024 / 256;
		@Pc(14) boolean local14 = arg5.aBoolean805;
		this.aClass19_Sub2_8.C(false);
		arg6.aBoolean436 = false;
		...
		for (@Pc(32) int local32 = arg0; local32 < arg2; local32++) {
			for (@Pc(35) int local35 = arg1; local35 < arg3; local35++) {
				if (arg4[local32 - arg0][local35 - arg1]) {
					...
					@Pc(416) int local416;
					@Pc(449) int local449;
					if (this.aClass307ArrayArray1 == null) {
						if (this.aClass322ArrayArray1[local32][local35] != null) {
							@Pc(593) Class322 local593 = this.aClass322ArrayArray1[local32][local35];
							for (local89 = 0; local89 < local593.aShort110; local89++) {
								arg7[local89] = local26 + local593.aShortArray116[local89] * 4 / super.anInt8912;
								arg8[local89] = local30 - local593.aShortArray113[local89] * 4 / super.anInt8912;
							}
							for (local379 = 0; local379 < local593.aShort109; local379++) {
								...
								if (local593.anIntArray647 == null || local593.anIntArray647[local379] == 0) {
									arg6.method5148((float) local408, (float) local412, (float) local416, (float) local396, (float) local400, (float) local404, 100.0F, 100.0F, 100.0F, local593.anIntArray646[local384], local593.anIntArray646[local388], local593.anIntArray646[local392]);
								} else {
									local449 = local593.anIntArray647[local379];
									arg6.method5148((float) local408, (float) local412, (float) local416, (float) local396, (float) local400, (float) local404, 100.0F, 100.0F, 100.0F, local449, local449, local449);
								}
							}
						}
					} else if (this.aClass307ArrayArray1[local32][local35] != null) {
						@Pc(67) Class307 local67 = this.aClass307ArrayArray1[local32][local35];
						if (local67.aShort105 != -1 && (local67.aByte126 & 0x2) == 0 && local67.anInt7793 == 0) {
							local89 = this.aClass19_Sub2_8.method3793(local67.aShort105);
							arg6.method5163((float) (local30 - 4), (float) (local30 - 4), (float) local30, (float) (local26 + 4), (float) local26, (float) (local26 + 4), 100.0F, 100.0F, 100.0F, (float) Static244.method3513(local67.anInt7790, local89), (float) Static244.method3513(local67.anInt7792, local89), (float) Static244.method3513(local67.anInt7794, local89));
							arg6.method5163((float) local30, (float) local30, (float) (local30 - 4), (float) local26, (float) (local26 + 4), (float) local26, 100.0F, 100.0F, 100.0F, (float) Static244.method3513(local67.anInt7791, local89), (float) Static244.method3513(local67.anInt7794, local89), (float) Static244.method3513(local67.anInt7792, local89));
						} else if (local67.anInt7793 == 0) {
							arg6.method5148((float) (local30 - 4), (float) (local30 - 4), (float) local30, (float) (local26 + 4), (float) local26, (float) (local26 + 4), 100.0F, 100.0F, 100.0F, local67.anInt7790, local67.anInt7792, local67.anInt7794);
							arg6.method5148((float) local30, (float) local30, (float) (local30 - 4), (float) local26, (float) (local26 + 4), (float) local26, 100.0F, 100.0F, 100.0F, local67.anInt7791, local67.anInt7794, local67.anInt7792);
						} else {
							local89 = local67.anInt7793;
							arg6.method5148((float) (local30 - 4), (float) (local30 - 4), (float) local30, (float) (local26 + 4), (float) local26, (float) (local26 + 4), 100.0F, 100.0F, 100.0F, Static462.method6277(local67.anInt7790 & 0xFF000000, local89), Static462.method6277(local67.anInt7792 & 0xFF000000, local89), Static462.method6277(local67.anInt7794 & 0xFF000000, local89));
							arg6.method5148((float) local30, (float) local30, (float) (local30 - 4), (float) local26, (float) (local26 + 4), (float) local26, 100.0F, 100.0F, 100.0F, Static462.method6277(local67.anInt7791 & 0xFF000000, local89), Static462.method6277(local67.anInt7794 & 0xFF000000, local89), Static462.method6277(local67.anInt7792 & 0xFF000000, local89));
						}
					} else if (this.aClass385ArrayArray1[local32][local35] != null) {
						@Pc(341) Class385 local341 = this.aClass385ArrayArray1[local32][local35];
						for (local89 = 0; local89 < local341.aShort128; local89++) {
							arg7[local89] = local26 + local341.aShortArray143[local89] * 4 / super.anInt8912;
							arg8[local89] = local30 - local341.aShortArray142[local89] * 4 / super.anInt8912;
						}
						for (local379 = 0; local379 < local341.aShort129; local379++) {
							...
							local412 = arg8[local388];
							local416 = arg8[local392];
							if (local341.anIntArray801 != null && local341.anIntArray801[local379] != 0 && (local341.aShortArray140 == null || local341.aShortArray140 != null && local341.aShortArray140[local379] == -1)) {
								local449 = local341.anIntArray801[local379];
								arg6.method5148((float) local408, (float) local412, (float) local416, (float) local396, (float) local400, (float) local404, 100.0F, 100.0F, 100.0F, Static462.method6277(-(local341.anIntArray802[local384] & 0xFF000000) - 16777216, local449), Static462.method6277(-(local341.anIntArray802[local388] & 0xFF000000) - 16777216, local449), Static462.method6277(-(local341.anIntArray802[local392] & 0xFF000000) - 16777216, local449));
							} else if (local341.aShortArray140 == null || local341.aShortArray140[local379] == -1) {
								arg6.method5148((float) local408, (float) local412, (float) local416, (float) local396, (float) local400, (float) local404, 100.0F, 100.0F, 100.0F, local341.anIntArray802[local384], local341.anIntArray802[local388], local341.anIntArray802[local392]);
							} else {
								local449 = this.aClass19_Sub2_8.method3793(local341.aShortArray140[local379]);
								arg6.method5163((float) local408, (float) local412, (float) local416, (float) local396, (float) local400, (float) local404, 100.0F, 100.0F, 100.0F, (float) local449, (float) local449, (float) local449);
							}
						}
					}
				}
	...
	private void method7172(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class221 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int arg7) {
		...
		if (local6 == null) {
			...
			if (local2204 != null) {
				...
				if (this.anInt8168 == -1) {
					for (local480 = 0; local480 < local2204.aShort34; local480++) {
						local50 = local2204.aShortArray32[local480] + (arg0 << super.anInt8919);
						local2253 = local2204.aShortArray33[local480];
						local60 = local2204.aShortArray38[local480] + (arg1 << super.anInt8919);
						local2284 = this.aFloat173 + this.aFloat164 * (float) local50 + this.aFloat172 * (float) local2253 + this.aFloat165 * (float) local60;
						if (local2284 <= (float) this.aClass19_Sub2_8.anInt4226) {
							return;
						}
						...
						arg3[local480] = arg2.anInt5743 + (int) (local2314 * (float) this.aClass19_Sub2_8.anInt4217 / local2284);
						arg4[local480] = arg2.anInt5741 + (int) (local2335 * (float) this.aClass19_Sub2_8.anInt4199 / local2284);
					...
					for (local480 = 0; local480 < local2204.aShort34; local480++) {
						...
						local2314 = this.aFloat171 + this.aFloat170 * (float) local50 + this.aFloat167 * (float) local2253 + this.aFloat162 * (float) local60;
						local2335 = this.aFloat169 + this.aFloat168 * (float) local50 + this.aFloat163 * (float) local2253 + this.aFloat166 * (float) local60;
						arg3[local480] = arg2.anInt5743 + (int) (local2314 * (float) this.aClass19_Sub2_8.anInt4217 / (float) this.anInt8168);
						arg4[local480] = arg2.anInt5741 + (int) (local2335 * (float) this.aClass19_Sub2_8.anInt4199 / (float) this.anInt8168);
						arg5[local480] = (int) local2284;
					}
				}
					...
					if (this.anInt8168 == -1) {
						for (local480 = 0; local480 < local2204.aShort33; local480++) {
							...
							if ((local510 - local2549) * (local2565 - local2561) - (local2557 - local2561) * (local2553 - local2549) > 0) {
								arg2.aBoolean434 = local510 < 0 || local2549 < 0 || local2553 < 0 || local510 > arg2.anInt5745 || local2549 > arg2.anInt5745 || local2553 > arg2.anInt5745;
								local2622 = local2204.aShortArray30[local480];
								if (local2622 == -1) {
									local2753 = local2204.anIntArray230[local480];
									if (local2753 != -1) {
										arg2.method5163((float) local2557, (float) local2561, (float) local2565, (float) local510, (float) local2549, (float) local2553, (float) arg5[local2531], (float) arg5[local2536], (float) arg5[local2541], (float) Static244.method3513(local2204.aShortArray35[local2531], local2753), (float) Static244.method3513(local2204.aShortArray35[local2536], local2753), (float) Static244.method3513(local2204.aShortArray35[local2541], local2753));
									}
								} else {
									arg2.method5157((float) local2557, (float) local2561, (float) local2565, (float) local510, (float) local2549, (float) local2553, (float) arg5[local2531], (float) arg5[local2536], (float) arg5[local2541], (float) local2204.aShortArray32[local2531] / (float) super.anInt8912, (float) local2204.aShortArray32[local2536] / (float) super.anInt8912, (float) local2204.aShortArray32[local2541] / (float) super.anInt8912, (float) local2204.aShortArray38[local2531] / (float) super.anInt8912, (float) local2204.aShortArray38[local2536] / (float) super.anInt8912, (float) local2204.aShortArray38[local2541] / (float) super.anInt8912, Static323.anIntArray389[local2204.aShortArray35[local2531] & 0xFFFF] & 0xFFFFFF | 0xFF000000, Static323.anIntArray389[local2204.aShortArray35[local2536] & 0xFFFF] & 0xFFFFFF | 0xFF000000, Static323.anIntArray389[local2204.aShortArray35[local2541] & 0xFFFF] & 0xFFFFFF | 0xFF000000, 0, 0, 0, 0, local2622);
								}
							}
						}
						return;
			...
			@Pc(45) int local45 = arg0 * super.anInt8912;
			local50 = local45 + super.anInt8912;
			@Pc(55) int local55 = arg1 * super.anInt8912;
			local60 = local55 + super.anInt8912;
			...
			if ((local6.aByte59 & 0x1) == 0) {
				...
				if (this.anInt8168 == -1) {
					...
					local177 = this.aFloat173 + this.aFloat164 * (float) local45 + this.aFloat172 * (float) local804 + this.aFloat165 * (float) local60;
					local287 = this.aFloat171 + this.aFloat170 * (float) local45 + this.aFloat167 * (float) local72 + this.aFloat162 * (float) local55;
					local300 = arg2.anInt5743 + (int) (local287 * (float) this.aClass19_Sub2_8.anInt4217 / (float) this.anInt8168);
					local317 = this.aFloat169 + this.aFloat168 * (float) local45 + this.aFloat163 * (float) local72 + this.aFloat166 * (float) local55;
					local330 = arg2.anInt5741 + (int) (local317 * (float) this.aClass19_Sub2_8.anInt4199 / (float) this.anInt8168);
					local347 = this.aFloat171 + this.aFloat170 * (float) local50 + this.aFloat167 * (float) local784 + this.aFloat162 * (float) local55;
					local360 = arg2.anInt5743 + (int) (local347 * (float) this.aClass19_Sub2_8.anInt4217 / (float) this.anInt8168);
					local377 = this.aFloat169 + this.aFloat168 * (float) local50 + this.aFloat163 * (float) local784 + this.aFloat166 * (float) local55;
					local390 = arg2.anInt5741 + (int) (local377 * (float) this.aClass19_Sub2_8.anInt4199 / (float) this.anInt8168);
					local407 = this.aFloat171 + this.aFloat170 * (float) local50 + this.aFloat167 * (float) local795 + this.aFloat162 * (float) local60;
					local420 = arg2.anInt5743 + (int) (local407 * (float) this.aClass19_Sub2_8.anInt4217 / (float) this.anInt8168);
					local437 = this.aFloat169 + this.aFloat168 * (float) local50 + this.aFloat163 * (float) local795 + this.aFloat166 * (float) local60;
					local450 = arg2.anInt5741 + (int) (local437 * (float) this.aClass19_Sub2_8.anInt4199 / (float) this.anInt8168);
					local467 = this.aFloat171 + this.aFloat170 * (float) local45 + this.aFloat167 * (float) local804 + this.aFloat162 * (float) local60;
					local480 = arg2.anInt5743 + (int) (local467 * (float) this.aClass19_Sub2_8.anInt4217 / (float) this.anInt8168);
					local497 = this.aFloat169 + this.aFloat168 * (float) local45 + this.aFloat163 * (float) local804 + this.aFloat166 * (float) local60;
					local510 = arg2.anInt5741 + (int) (local497 * (float) this.aClass19_Sub2_8.anInt4199 / (float) this.anInt8168);
				}
			} else {
				local72 = super.anIntArrayArray226[arg0][arg1];
			...
			if (this.anInt8168 == -1) {
				if ((local420 - local480) * (local390 - local510) - (local450 - local510) * (local360 - local480) > 0) {
					arg2.aBoolean434 = local420 < 0 || local480 < 0 || local360 < 0 || local420 > arg2.anInt5745 || local480 > arg2.anInt5745 || local360 > arg2.anInt5745;
					if (local6.aShort38 >= 0) {
						arg2.method5157((float) local450, (float) local510, (float) local390, (float) local420, (float) local480, (float) local360, local151, local177, local125, 1.0F, 0.0F, 1.0F, 1.0F, 1.0F, 0.0F, Static323.anIntArray389[local6.aShort41 & 0xFFFF] & 0xFFFFFF | 0xFF000000, Static323.anIntArray389[local6.aShort40 & 0xFFFF] & 0xFFFFFF | 0xFF000000, Static323.anIntArray389[local6.aShort39 & 0xFFFF] & 0xFFFFFF | 0xFF000000, 0, 0, 0, 0, local6.aShort38);
					} else {
						arg2.method5163((float) local450, (float) local510, (float) local390, (float) local420, (float) local480, (float) local360, (float) (int) local151, (float) (int) local177, (float) (int) local125, (float) (local6.aShort41 & 0xFFFF), (float) (local6.aShort40 & 0xFFFF), (float) (local6.aShort39 & 0xFFFF));
					}
				}
				if ((local300 - local360) * (local510 - local390) - (local330 - local390) * (local480 - local360) > 0) {
					arg2.aBoolean434 = local300 < 0 || local360 < 0 || local480 < 0 || local300 > arg2.anInt5745 || local360 > arg2.anInt5745 || local480 > arg2.anInt5745;
					if (local6.aShort38 >= 0) {
						arg2.method5157((float) local330, (float) local390, (float) local510, (float) local300, (float) local360, (float) local480, local99, local125, local177, 0.0F, 1.0F, 1.0F, 0.0F, 0.0F, 1.0F, Static323.anIntArray389[local6.aShort42 & 0xFFFF] & 0xFFFFFF | 0xFF000000, Static323.anIntArray389[local6.aShort39 & 0xFFFF] & 0xFFFFFF | 0xFF000000, Static323.anIntArray389[local6.aShort40 & 0xFFFF] & 0xFFFFFF | 0xFF000000, 0, 0, 0, 0, local6.aShort38);
						return;
					}
					arg2.method5163((float) local330, (float) local390, (float) local510, (float) local300, (float) local360, (float) local480, (float) (int) local99, (float) (int) local125, (float) (int) local177, (float) (local6.aShort42 & 0xFFFF), (float) (local6.aShort39 & 0xFFFF), (float) (local6.aShort40 & 0xFFFF));
					return;
				}
			} else {
				if ((local420 - local480) * (local390 - local510) - (local450 - local510) * (local360 - local480) > 0) {
	...
	@Override
	public void method7884(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(3) Class73_Sub2 local3 = this.aClass19_Sub2_8.aClass73_Sub2_1;
		this.anInt8168 = arg5;
		this.aFloat170 = local3.aFloat59;
		this.aFloat167 = local3.aFloat55;
		...
		for (@Pc(56) int local56 = 0; local56 < arg2 + arg2; local56++) {
			for (@Pc(59) int local59 = 0; local59 < arg2 + arg2; local59++) {
				if (arg3[local56][local59]) {
					...
					@Pc(78) int local78 = arg1 + local59 - arg2;
					if (local72 >= 0 && local72 < super.anInt8918 && local78 >= 0 && local78 < super.anInt8916) {
						this.method7175(local72, local78, arg6);
					}
				}
			}
		}
	...
	@Override
	public void method7880(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		@Pc(4) Class401 local4 = this.aClass19_Sub2_8.method3787(Thread.currentThread());
		@Pc(7) Class221 local7 = local4.aClass221_2;
		local7.anInt5744 = 0;
		local7.aBoolean434 = true;
		this.aClass19_Sub2_8.ya();
		if (this.aClass307ArrayArray1 != null || this.aClass322ArrayArray1 != null) {
			this.method7171(arg0, arg1, arg2, arg3, arg4, local4, local7, local4.anIntArray840, local4.anIntArray843);
		} else if (this.aClass127ArrayArray1 != null) {
			this.method7170(arg0, arg1, arg2, arg3, arg4, local4, local7, local4.anIntArray840, local4.anIntArray843);
		}
	}
	...
	@Override
	public void method7878(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) int[] arg10, @OriginalArg(11) int[] arg11, @OriginalArg(12) int[] arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15) {
		if (this.aClass127ArrayArray1 == null) {
			this.aClass127ArrayArray1 = new Class127[super.anInt8918][super.anInt8916];
			this.aClass107ArrayArray1 = new Class107[super.anInt8918][super.anInt8916];
		} else if (this.aClass307ArrayArray1 != null || this.aClass322ArrayArray1 != null) {
			throw new IllegalStateException();
		}
		...
		if (arg9.length == 2 && arg6.length == 2 && (arg9[0] == arg9[1] || arg11[0] != -1 && arg11[0] == arg11[1])) {
			...
			for (@Pc(72) int local72 = 1; local72 < 2; local72++) {
				...
				if (local79 != 0 && local79 != super.anInt8912 || local85 != 0 && local85 != super.anInt8912) {
					local33 = false;
					break;
				}
			}
		...
		if (!local33) {
			...
			for (@Pc(147) int local147 = 0; local147 < local122; local147++) {
				...
				} else if (local152 == 0 && local156 == super.anInt8912) {
					local118.aShortArray35[local147] = (short) (this.aByteArrayArray31[arg0][arg1 + 1] - this.aByteArrayArray30[arg0][arg1 + 1]);
				} else if (local152 == super.anInt8912 && local156 == super.anInt8912) {
					local118.aShortArray35[local147] = (short) (this.aByteArrayArray31[arg0 + 1][arg1 + 1] - this.aByteArrayArray30[arg0 + 1][arg1 + 1]);
				} else if (local152 == super.anInt8912 && local156 == 0) {
					local118.aShortArray35[local147] = (short) (this.aByteArrayArray31[arg0 + 1][arg1] - this.aByteArrayArray30[arg0 + 1][arg1]);
				} else {
					local323 = (this.aByteArrayArray31[arg0][arg1] - this.aByteArrayArray30[arg0][arg1]) * (super.anInt8912 - local152) + (this.aByteArrayArray31[arg0 + 1][arg1] - this.aByteArrayArray30[arg0 + 1][arg1]) * local152;
					local370 = (this.aByteArrayArray31[arg0][arg1 + 1] - this.aByteArrayArray30[arg0][arg1 + 1]) * (super.anInt8912 - local152) + (this.aByteArrayArray31[arg0 + 1][arg1 + 1] - this.aByteArrayArray30[arg0 + 1][arg1 + 1]) * local152;
					local118.aShortArray35[local147] = (short) (local323 * (super.anInt8912 - local156) + local370 * local156 >> super.anInt8919 * 2);
				}
				local323 = (arg0 << super.anInt8919) + local152;
				local370 = (arg1 << super.anInt8919) + local156;
				local118.aShortArray32[local147] = (short) local152;
				local118.aShortArray38[local147] = (short) local156;
				local118.aShortArray33[local147] = (short) (this.method7885(local370, local323) + (arg3 == null ? 0 : arg3[local147]));
			...
			for (local370 = 0; local370 < local126; local370++) {
				if (arg9[local370] >= 0 || arg10 != null && arg10[local370] >= 0) {
					...
					if (local454) {
						if (arg11[local370] == -1 || this.aClass19_Sub2_8.anInterface4_10.method6824(arg11[local370]).aBoolean240) {
			...
			local85 = arg11[0];
			if (arg10 != null) {
				local741.anInt2907 = Static244.method3513(this.aByteArrayArray31[arg0][arg1] - this.aByteArrayArray30[arg0][arg1], Static105.method2043(arg10[0]));
				if (local79 == -1) {
			...
			if (local849 == null || (local741.aByte59 & 0x2) != 0 || local849.aBoolean240) {
				...
				if (this.method7169(local849.aByte56) || local849.aByte54 != 0 || local849.aByte52 != 0) {
	...
	private void method7173(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Class401 arg3, @OriginalArg(4) Class221 arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int arg9) {
		@Pc(6) Class307 local6 = this.aClass307ArrayArray1[arg0][arg1];
		@Pc(50) int local50;
		@Pc(55) int local55;
		@Pc(60) int local60;
		@Pc(559) int local559;
		...
		@Pc(589) int local589;
		if (local6 == null) {
			@Pc(3142) Class385 local3142 = this.aClass385ArrayArray1[arg0][arg1];
			if (local3142 != null) {
				if (arg9 != 0) {
				...
				if (this.anInt8168 == -1) {
					for (local559 = 0; local559 < local3142.aShort128; local559++) {
						local50 = local3142.aShortArray143[local559] + (arg0 << super.anInt8919);
						local55 = local3142.aShortArray144[local559];
						local60 = local3142.aShortArray142[local559] + (arg1 << super.anInt8919);
						local3222 = this.aFloat173 + this.aFloat164 * (float) local50 + this.aFloat172 * (float) local55 + this.aFloat165 * (float) local60;
						if (local3222 <= (float) this.aClass19_Sub2_8.anInt4226) {
							return;
						}
						arg8[local559] = 0;
						if (arg2) {
							local409 = (int) (local3222 - (float) arg3.anInt10629);
							if (local409 > 255) {
								local409 = 255;
							}
							if (local409 > 0) {
								arg8[local559] = local409;
								local469 = local3142.aShortArray139[local559] * local409 / 255;
								if (local469 > 0) {
									local55 -= local469;
								}
							}
						...
						arg5[local559] = arg4.anInt5743 + (int) (local3321 * (float) this.aClass19_Sub2_8.anInt4217 / local3222);
						arg6[local559] = arg4.anInt5741 + (int) (local3342 * (float) this.aClass19_Sub2_8.anInt4199 / local3222);
					...
					for (local559 = 0; local559 < local3142.aShort128; local559++) {
						...
						arg8[local559] = 0;
						if (arg2) {
							local409 = this.anInt8168 - arg3.anInt10629;
							if (local409 > 255) {
								local409 = 255;
							}
							if (local409 > 0) {
						...
						local3321 = this.aFloat171 + this.aFloat170 * (float) local50 + this.aFloat167 * (float) local55 + this.aFloat162 * (float) local60;
						local3342 = this.aFloat169 + this.aFloat168 * (float) local50 + this.aFloat163 * (float) local55 + this.aFloat166 * (float) local60;
						arg5[local559] = arg4.anInt5743 + (int) (local3321 * (float) this.aClass19_Sub2_8.anInt4217 / (float) this.anInt8168);
						arg6[local559] = arg4.anInt5741 + (int) (local3342 * (float) this.aClass19_Sub2_8.anInt4199 / (float) this.anInt8168);
						arg7[local559] = (int) local3222;
					}
				}
				...
				if (local3142.aShortArray140 != null) {
					...
					if (this.anInt8168 == -1) {
						for (local559 = 0; local559 < local3142.aShort129; local559++) {
							...
							if ((local589 - local3620) * (local3636 - local3632) - (local3628 - local3632) * (local3624 - local3620) > 0) {
								arg4.aBoolean434 = local589 < 0 || local3620 < 0 || local3624 < 0 || local589 > arg4.anInt5745 || local3620 > arg4.anInt5745 || local3624 > arg4.anInt5745;
								local3705 = local3142.aShortArray140[local559];
								if (local3648 >= 765) {
									arg4.method5165((float) local3628, (float) local3632, (float) local3636, (float) local589, (float) local3620, (float) local3624, (float) arg7[local409], (float) arg7[local469], (float) arg7[local529], arg3.anInt10625);
								} else if (local3648 > 0) {
									if (local3705 != -1) {
										local3719 = 0xFF000000;
										if (local3705 != -1 && this.method7169(this.aClass19_Sub2_8.anInterface4_10.method6824(local3705).aByte56)) {
											local3719 = 0x9B000000;
										}
										arg4.method5157((float) local3628, (float) local3632, (float) local3636, (float) local589, (float) local3620, (float) local3624, (float) arg7[local409], (float) arg7[local469], (float) arg7[local529], (float) local3142.aShortArray143[local409] / (float) super.anInt8912, (float) local3142.aShortArray143[local469] / (float) super.anInt8912, (float) local3142.aShortArray143[local529] / (float) super.anInt8912, (float) local3142.aShortArray142[local409] / (float) super.anInt8912, (float) local3142.aShortArray142[local469] / (float) super.anInt8912, (float) local3142.aShortArray142[local529] / (float) super.anInt8912, local3719 | local3142.anIntArray802[local409] & 0xFFFFFF, local3719 | local3142.anIntArray802[local469] & 0xFFFFFF, local3719 | local3142.anIntArray802[local529] & 0xFFFFFF, arg3.anInt10625, arg8[local409], arg8[local469], arg8[local529], local3705);
									} else if ((local3142.anIntArray802[local409] & 0xFFFFFF) != 0) {
										if (local3705 != -1 && this.method7169(this.aClass19_Sub2_8.anInterface4_10.method6824(local3705).aByte56)) {
											arg4.anInt5744 = 0x9B000000;
										}
										arg4.method5148((float) local3628, (float) local3632, (float) local3636, (float) local589, (float) local3620, (float) local3624, (float) arg7[local409], (float) arg7[local469], (float) arg7[local529], Static462.method6277(arg8[local409] << 24 | arg3.anInt10625, local3142.anIntArray802[local409]), Static462.method6277(arg8[local469] << 24 | arg3.anInt10625, local3142.anIntArray802[local469]), Static462.method6277(arg8[local529] << 24 | arg3.anInt10625, local3142.anIntArray802[local529]));
										arg4.anInt5744 = 0;
									}
								} else if (local3705 != -1) {
									local3719 = 0xFF000000;
									...
									arg4.method5148((float) local3628, (float) local3632, (float) local3636, (float) local589, (float) local3620, (float) local3624, (float) arg7[local409], (float) arg7[local469], (float) arg7[local529], local3142.anIntArray802[local409], local3142.anIntArray802[local469], local3142.anIntArray802[local529]);
									arg4.anInt5744 = 0;
								}
							}
						}
					...
					if ((local589 - local3620) * (local3636 - local3632) - (local3628 - local3632) * (local3624 - local3620) > 0) {
						...
						if (local3648 >= 765) {
							...
							if ((local3142.anIntArray802[local409] & 0xFFFFFF) != 0) {
								arg4.method5148((float) local3628, (float) local3632, (float) local3636, (float) local589, (float) local3620, (float) local3624, (float) arg7[local409], (float) arg7[local469], (float) arg7[local529], Static572.method7874(arg3.anInt10625, local3142.anIntArray802[local409], arg8[local409]), Static572.method7874(arg3.anInt10625, local3142.anIntArray802[local469], arg8[local469]), Static572.method7874(arg3.anInt10625, local3142.anIntArray802[local529], arg8[local529]));
							}
						} else if ((local3142.anIntArray802[local409] & 0xFFFFFF) != 0) {
							arg4.method5148((float) local3628, (float) local3632, (float) local3636, (float) local589, (float) local3620, (float) local3624, (float) arg7[local409], (float) arg7[local469], (float) arg7[local529], local3142.anIntArray802[local409], local3142.anIntArray802[local469], local3142.anIntArray802[local529]);
						}
			...
			if ((local6.aByte126 & 0x1) == 0 || arg2) {
				...
				if (arg2) {
					local276 = (int) (local111 - (float) arg3.anInt10629);
					if (local276 > 255) {
						local276 = 255;
					}
					...
					local276 = (int) (local137 - (float) arg3.anInt10629);
					if (local276 > 255) {
						local276 = 255;
					}
					if (local276 > 0) {
					...
					local276 = (int) (local163 - (float) arg3.anInt10629);
					if (local276 > 255) {
						local276 = 255;
					}
					if (local276 > 0) {
					...
					local276 = (int) (local189 - (float) arg3.anInt10629);
					if (local276 > 255) {
						local276 = 255;
					}
					if (local276 > 0) {
				...
				if (this.anInt8168 == -1) {
					...
					local379 = arg4.anInt5743 + (int) (local366 * (float) this.aClass19_Sub2_8.anInt4217 / local111);
					local396 = this.aFloat169 + this.aFloat168 * (float) local45 + this.aFloat163 * (float) local84 + this.aFloat166 * (float) local55;
					local409 = arg4.anInt5741 + (int) (local396 * (float) this.aClass19_Sub2_8.anInt4199 / local111);
					local426 = this.aFloat171 + this.aFloat170 * (float) local50 + this.aFloat167 * (float) local863 + this.aFloat162 * (float) local55;
					local439 = arg4.anInt5743 + (int) (local426 * (float) this.aClass19_Sub2_8.anInt4217 / local137);
					local456 = this.aFloat169 + this.aFloat168 * (float) local50 + this.aFloat163 * (float) local863 + this.aFloat166 * (float) local55;
					local469 = arg4.anInt5741 + (int) (local456 * (float) this.aClass19_Sub2_8.anInt4199 / local137);
					local486 = this.aFloat171 + this.aFloat170 * (float) local50 + this.aFloat167 * (float) local874 + this.aFloat162 * (float) local60;
					local499 = arg4.anInt5743 + (int) (local486 * (float) this.aClass19_Sub2_8.anInt4217 / local163);
					local516 = this.aFloat169 + this.aFloat168 * (float) local50 + this.aFloat163 * (float) local874 + this.aFloat166 * (float) local60;
					local529 = arg4.anInt5741 + (int) (local516 * (float) this.aClass19_Sub2_8.anInt4199 / local163);
					local546 = this.aFloat171 + this.aFloat170 * (float) local45 + this.aFloat167 * (float) local883 + this.aFloat162 * (float) local60;
					local559 = arg4.anInt5743 + (int) (local546 * (float) this.aClass19_Sub2_8.anInt4217 / local189);
					local576 = this.aFloat169 + this.aFloat168 * (float) local45 + this.aFloat163 * (float) local883 + this.aFloat166 * (float) local60;
					local589 = arg4.anInt5741 + (int) (local576 * (float) this.aClass19_Sub2_8.anInt4199 / local189);
				} else {
					local366 = this.aFloat171 + this.aFloat170 * (float) local45 + this.aFloat167 * (float) local84 + this.aFloat162 * (float) local55;
					local379 = arg4.anInt5743 + (int) (local366 * (float) this.aClass19_Sub2_8.anInt4217 / (float) this.anInt8168);
					local396 = this.aFloat169 + this.aFloat168 * (float) local45 + this.aFloat163 * (float) local84 + this.aFloat166 * (float) local55;
					local409 = arg4.anInt5741 + (int) (local396 * (float) this.aClass19_Sub2_8.anInt4199 / (float) this.anInt8168);
					local426 = this.aFloat171 + this.aFloat170 * (float) local50 + this.aFloat167 * (float) local863 + this.aFloat162 * (float) local55;
					local439 = arg4.anInt5743 + (int) (local426 * (float) this.aClass19_Sub2_8.anInt4217 / (float) this.anInt8168);
					local456 = this.aFloat169 + this.aFloat168 * (float) local50 + this.aFloat163 * (float) local863 + this.aFloat166 * (float) local55;
					local469 = arg4.anInt5741 + (int) (local456 * (float) this.aClass19_Sub2_8.anInt4199 / (float) this.anInt8168);
					local486 = this.aFloat171 + this.aFloat170 * (float) local50 + this.aFloat167 * (float) local874 + this.aFloat162 * (float) local60;
					local499 = arg4.anInt5743 + (int) (local486 * (float) this.aClass19_Sub2_8.anInt4217 / (float) this.anInt8168);
					local516 = this.aFloat169 + this.aFloat168 * (float) local50 + this.aFloat163 * (float) local874 + this.aFloat166 * (float) local60;
					local529 = arg4.anInt5741 + (int) (local516 * (float) this.aClass19_Sub2_8.anInt4199 / (float) this.anInt8168);
					local546 = this.aFloat171 + this.aFloat170 * (float) local45 + this.aFloat167 * (float) local883 + this.aFloat162 * (float) local60;
					local559 = arg4.anInt5743 + (int) (local546 * (float) this.aClass19_Sub2_8.anInt4217 / (float) this.anInt8168);
					local576 = this.aFloat169 + this.aFloat168 * (float) local45 + this.aFloat163 * (float) local883 + this.aFloat166 * (float) local60;
					local589 = arg4.anInt5741 + (int) (local576 * (float) this.aClass19_Sub2_8.anInt4199 / (float) this.anInt8168);
				}
			} else {
				local84 = super.anIntArrayArray226[arg0][arg1];
			...
			@Pc(1864) boolean local1864 = local6.aShort105 != -1 && this.method7169(this.aClass19_Sub2_8.anInterface4_10.method6824(local6.aShort105).aByte56);
			if (this.anInt8168 == -1) {
				local863 = local64 + local66 + local68;
				if ((local499 - local559) * (local469 - local589) - (local529 - local589) * (local439 - local559) > 0) {
					arg4.aBoolean434 = local499 < 0 || local559 < 0 || local439 < 0 || local499 > arg4.anInt5745 || local559 > arg4.anInt5745 || local439 > arg4.anInt5745;
					if (local863 >= 765) {
						arg4.method5165((float) local529, (float) local589, (float) local469, (float) local499, (float) local559, (float) local439, (float) (int) local163, (float) (int) local189, (float) (int) local137, arg3.anInt10625);
					} else if (local863 > 0) {
						if (local6.aShort105 >= 0) {
							...
							arg4.method5157((float) local529, (float) local589, (float) local469, (float) local499, (float) local559, (float) local439, local163, local189, local137, 1.0F, 0.0F, 1.0F, 1.0F, 1.0F, 0.0F, local874 | local6.anInt7790 & 0xFFFFFF, local874 | local6.anInt7792 & 0xFFFFFF, local874 | local6.anInt7794 & 0xFFFFFF, arg3.anInt10625, local66, local68, local64, local6.aShort105);
						} else {
							if (local1864) {
								arg4.anInt5744 = 100;
							}
							arg4.method5148((float) local529, (float) local589, (float) local469, (float) local499, (float) local559, (float) local439, (float) (int) local163, (float) (int) local189, (float) (int) local137, Static462.method6277(local66 << 24 | arg3.anInt10625, local6.anInt7790), Static462.method6277(local68 << 24 | arg3.anInt10625, local6.anInt7792), Static462.method6277(local64 << 24 | arg3.anInt10625, local6.anInt7794));
							arg4.anInt5744 = 0;
						}
						...
						arg4.method5157((float) local529, (float) local589, (float) local469, (float) local499, (float) local559, (float) local439, local163, local189, local137, 1.0F, 0.0F, 1.0F, 1.0F, 1.0F, 0.0F, local874 | local6.anInt7790 & 0xFFFFFF, local874 | local6.anInt7792 & 0xFFFFFF, local874 | local6.anInt7794 & 0xFFFFFF, 0, 0, 0, 0, local6.aShort105);
					} else {
						if (local1864) {
							arg4.anInt5744 = 100;
						}
						arg4.method5148((float) local529, (float) local589, (float) local469, (float) local499, (float) local559, (float) local439, (float) (int) local163, (float) (int) local189, (float) (int) local137, local6.anInt7790, local6.anInt7792, local6.anInt7794);
						arg4.anInt5744 = 0;
					}
				}
				local863 = local62 + local64 + local68;
				if ((local379 - local439) * (local589 - local469) - (local409 - local469) * (local559 - local439) > 0) {
					arg4.aBoolean434 = local379 < 0 || local439 < 0 || local559 < 0 || local379 > arg4.anInt5745 || local439 > arg4.anInt5745 || local559 > arg4.anInt5745;
					if (local863 < 765) {
						if (local1864) {
							arg4.anInt5744 = 0x9B000000;
						}
						if (local863 > 0) {
							if (local6.aShort105 >= 0) {
								...
								arg4.method5157((float) local409, (float) local469, (float) local589, (float) local379, (float) local439, (float) local559, local111, local137, local189, 0.0F, 1.0F, 1.0F, 0.0F, 0.0F, 1.0F, local874 | local6.anInt7791 & 0xFFFFFF, local874 | local6.anInt7794 & 0xFFFFFF, local874 | local6.anInt7792 & 0xFFFFFF, arg3.anInt10625, local62, local64, local68, local6.aShort105);
								return;
							}
							if (local1864) {
								arg4.anInt5744 = 100;
							}
							arg4.method5148((float) local409, (float) local469, (float) local589, (float) local379, (float) local439, (float) local559, (float) (int) local111, (float) (int) local137, (float) (int) local189, Static462.method6277(local62 << 24 | arg3.anInt10625, local6.anInt7791), Static462.method6277(local64 << 24 | arg3.anInt10625, local6.anInt7794), Static462.method6277(local68 << 24 | arg3.anInt10625, local6.anInt7792));
							arg4.anInt5744 = 0;
							return;
						}
						if (local6.aShort105 >= 0) {
							...
							arg4.method5157((float) local409, (float) local469, (float) local589, (float) local379, (float) local439, (float) local559, local111, local137, local189, 0.0F, 1.0F, 1.0F, 0.0F, 0.0F, 1.0F, local874 | local6.anInt7791 & 0xFFFFFF, local874 | local6.anInt7794 & 0xFFFFFF, local874 | local6.anInt7792 & 0xFFFFFF, 0, 0, 0, 0, local6.aShort105);
							return;
						}
						if (local1864) {
							arg4.anInt5744 = 100;
						}
						arg4.method5148((float) local409, (float) local469, (float) local589, (float) local379, (float) local439, (float) local559, (float) (int) local111, (float) (int) local137, (float) (int) local189, local6.anInt7791, local6.anInt7794, local6.anInt7792);
						arg4.anInt5744 = 0;
						return;
					}
					arg4.method5165((float) local409, (float) local469, (float) local589, (float) local379, (float) local439, (float) local559, (float) (int) local111, (float) (int) local137, (float) (int) local189, arg3.anInt10625);
					return;
				}
			} else {
				local863 = local64 + local66 + local68;
	...
	private void method7175(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(4) Class401 local4 = this.aClass19_Sub2_8.method3787(Thread.currentThread());
		local4.aClass221_2.anInt5744 = 0;
		if (this.aClass307ArrayArray1 != null) {
			this.method7173(arg0, arg1, local4.aBoolean806, local4, local4.aClass221_2, local4.anIntArray840, local4.anIntArray843, local4.anIntArray852, local4.anIntArray855, arg2);
		} else if (this.aClass127ArrayArray1 != null) {
			this.method7172(arg0, arg1, local4.aClass221_2, local4.anIntArray840, local4.anIntArray843, local4.anIntArray852, local4.anIntArray855, arg2);
		} else if (this.aClass322ArrayArray1 != null) {
			this.method7168(arg0, arg1, local4.aBoolean806, local4, local4.aClass221_2, local4.anIntArray840, local4.anIntArray843, local4.anIntArray852, local4.anIntArray855, arg2);
		}
	}
