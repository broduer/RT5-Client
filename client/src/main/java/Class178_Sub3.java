...
public final class Class178_Sub3 extends Class178 {
	...
	@Override
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
			...
			for (@Pc(59) int local59 = 0; local59 < arg2 + arg2; local59++) {
				if (arg3[local56][local59]) {
					...
					if (local72 >= 0 && local72 < super.anInt8894 && local78 >= 0 && local78 < super.anInt8892) {
						this.method5014(local72, local78, arg5);
					}
				}
			}
		}
	...
	@Override
	public void a(@OriginalArg(0) Class2_Sub7 arg0, @OriginalArg(1) int[] arg1) {
	}

	@OriginalMember(owner = "client!qs", name = "a", descriptor = "(Lclient!r;IIIIZ)Z")
	@Override
	public boolean a(@OriginalArg(0) Class2_Sub2_Sub9 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		return false;
	}
	...
	private void method5007(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Class399 arg3, @OriginalArg(4) Class219 arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int arg9) {
	...
	@Override
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.method5014(arg0, arg1, 0);
	}
	...
	public void U(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) boolean arg13) {
		...
		for (@Pc(67) int local67 = 0; local67 < arg6.length; local67++) {
			if (arg6[local67] == -1) {
				...
				arg6[local67] = Static323.anIntArray389[Static105.method1299(arg6[local67]) & 0xFFFF] << 8 | 0xFF;
			}
		}
		if (arg7 != null) {
			for (@Pc(106) int local106 = 0; local106 < arg7.length; local106++) {
				if (arg7[local106] == -1) {
					...
					arg7[local106] = Static323.anIntArray389[Static105.method1299(arg7[local106]) & 0xFFFF] << 8 | 0xFF;
				}
			}
		}
		@Pc(205) int local205;
		...
		if (local9) {
			...
			for (local205 = 0; local205 < local147.aShort110; local205++) {
				...
				local147.aShortArray117[local205] = (short) (this.a(local410, -113, (int) local363) + (arg3 == null ? 0 : arg3[local205]));
				if (local236 < 0) {
					local236 = 0;
				}
				if (arg6[local205] == 0) {
					...
					local530 = -16777216;
					if (arg8[local205] != -1 && this.method5008(this.aClass19_Sub2_8.anInterface4_10.method4805(arg8[local205]).aByte56)) {
						local530 = -1694498816;
					}
					local147.anIntArray646[local205] = local530 | Static572.a(arg10, Static732.method5013(arg6[local205] >> 8, local236), local498);
					if (arg7 != null) {
						local147.aByteArray92[local205] = (byte) local236;
					}
				}
		...
		if (!local654) {
			...
			for (local410 = 0; local410 < local1760.aShort128; local410++) {
				...
				local1760.aShortArray143[local410] = (short) (this.a(local2008, -117, (int) local1961) + (arg3 == null ? 0 : arg3[local410]));
				if (local1834 < 0) {
					local1834 = 0;
				}
				if (arg6[local410] != 0) {
					...
					local1760.anIntArray802[local410] = Static572.a(arg10, Static732.method5013(arg6[local410] >> 8, local1834), local2098);
					if (arg7 != null) {
			...
			for (local530 = 0; local530 < local1760.aShort129; local530++) {
				if (arg8[local530 * 3] != -1 && !this.aClass19_Sub2_8.anInterface4_10.method4805(arg8[local530 * 3]).aBoolean240) {
					local2164 = true;
				}
			}
			if (arg7 != null) {
			...
			for (local1834 = 0; local1834 < local1760.aShort129; local1834++) {
				...
				if (local2164) {
					...
					if (local2264 == -1 || this.aClass19_Sub2_8.anInterface4_10.method4805(local2264).aBoolean240) {
						local2260 = false;
					} else {
						local2258 = true;
					}
					...
					if (local2260) {
						...
						if (local2258) {
							...
							if (local2264 != -1 && !this.aClass19_Sub2_8.anInterface4_10.method4805(local2264).aBoolean240) {
								local1760.anIntArray802[local1961] = Static323.anIntArray389[Static105.method1299(this.aClass19_Sub2_8.anInterface4_10.method4805(local2264).aShort37 & 0xFFFF) & 0xFFFF];
							}
							local2264 = arg8[local2008];
							if (local2264 != -1 && !this.aClass19_Sub2_8.anInterface4_10.method4805(local2264).aBoolean240) {
								local1760.anIntArray802[local2008] = Static323.anIntArray389[Static105.method1299(this.aClass19_Sub2_8.anInterface4_10.method4805(local2264).aShort37 & 0xFFFF) & 0xFFFF];
							}
							local2264 = arg8[local2098];
							if (local2264 != -1 && !this.aClass19_Sub2_8.anInterface4_10.method4805(local2264).aBoolean240) {
								local1760.anIntArray802[local2098] = Static323.anIntArray389[Static105.method1299(this.aClass19_Sub2_8.anInterface4_10.method4805(local2264).aShort37 & 0xFFFF) & 0xFFFF];
							}
						}
		...
		if (local498 == -1 || (local931.aByte126 & 0x2) != 0 || this.aClass19_Sub2_8.anInterface4_10.method4805(local498).aBoolean240) {
			...
			local931.anInt7768 = Static572.a(arg10, Static732.method5013(arg6[local205] >> 8, this.aByteArrayArray31[arg0][arg1] - this.aByteArrayArray30[arg0][arg1]), local530);
			...
			local931.anInt7771 = Static572.a(arg10, Static732.method5013(arg6[local210] >> 8, this.aByteArrayArray31[arg0 + 1][arg1] - this.aByteArrayArray30[arg0 + 1][arg1]), local530);
			if (local931.anInt7770 != 0) {
			...
			local931.anInt7767 = Static572.a(arg10, Static732.method5013(arg6[local214] >> 8, this.aByteArrayArray31[arg0 + 1][arg1 + 1] - this.aByteArrayArray30[arg0 + 1][arg1 + 1]), local530);
			if (local931.anInt7770 != 0) {
			...
			local931.anInt7769 = Static572.a(arg10, Static732.method5013(arg6[local236] >> 8, this.aByteArrayArray31[arg0][arg1 + 1] - this.aByteArrayArray30[arg0][arg1 + 1]), local530);
			if (local931.anInt7770 != 0) {
	...
	private void method5009(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean[][] arg7, @OriginalArg(8) Class399 arg8, @OriginalArg(9) Class219 arg9, @OriginalArg(10) int[] arg10, @OriginalArg(11) int[] arg11) {
		@Pc(7) int local7 = (arg6 - arg4) * 1024 / 256;
		@Pc(14) boolean local14 = arg8.aBoolean804;
		this.aClass19_Sub2_8.C(false);
		arg9.aBoolean436 = false;
		arg9.aBoolean433 = false;
		@Pc(26) int local26 = 0;
		@Pc(30) int local30 = local7;
		for (@Pc(32) int local32 = arg3; local32 < arg5; local32++) {
			for (@Pc(35) int local35 = arg4; local35 < arg6; local35++) {
				if (arg7[local32 - arg3][local35 - arg4]) {
					@Pc(85) int local85;
					if (this.aClass127ArrayArray1[local32][local35] != null) {
						...
						if (local62.aShort38 != -1 && (local62.aByte59 & 0x2) == 0 && local62.anInt2898 == -1) {
							local85 = this.aClass19_Sub2_8.method2672(local62.aShort38);
							arg9.method3623((float) (local30 - 4), (float) (local30 - 4), (float) local30, (float) (local26 + 4), (float) local26, (float) (local26 + 4), 100.0F, 100.0F, 100.0F, (float) Static244.method2541(local62.aShort41 & 0xFFFF, local85), (float) Static244.method2541(local62.aShort40 & 0xFFFF, local85), (float) Static244.method2541(local62.aShort39 & 0xFFFF, local85));
							arg9.method3623((float) local30, (float) local30, (float) (local30 - 4), (float) local26, (float) (local26 + 4), (float) local26, 100.0F, 100.0F, 100.0F, (float) Static244.method2541(local62.aShort42 & 0xFFFF, local85), (float) Static244.method2541(local62.aShort39 & 0xFFFF, local85), (float) Static244.method2541(local62.aShort40 & 0xFFFF, local85));
						} else if (local62.anInt2898 == -1) {
							arg9.method3623((float) (local30 - 4), (float) (local30 - 4), (float) local30, (float) (local26 + 4), (float) local26, (float) (local26 + 4), 100.0F, 100.0F, 100.0F, (float) (local62.aShort41 & 0xFFFF), (float) (local62.aShort40 & 0xFFFF), (float) (local62.aShort39 & 0xFFFF));
							arg9.method3623((float) local30, (float) local30, (float) (local30 - 4), (float) local26, (float) (local26 + 4), (float) local26, 100.0F, 100.0F, 100.0F, (float) (local62.aShort42 & 0xFFFF), (float) (local62.aShort39 & 0xFFFF), (float) (local62.aShort40 & 0xFFFF));
						} else {
							local85 = local62.anInt2898;
							arg9.method3623((float) (local30 - 4), (float) (local30 - 4), (float) local30, (float) (local26 + 4), (float) local26, (float) (local26 + 4), 100.0F, 100.0F, 100.0F, (float) local85, (float) local85, (float) local85);
							arg9.method3623((float) local30, (float) local30, (float) (local30 - 4), (float) local26, (float) (local26 + 4), (float) local26, 100.0F, 100.0F, 100.0F, (float) local85, (float) local85, (float) local85);
						}
						...
						for (local85 = 0; local85 < local338.aShort34; local85++) {
							arg10[local85] = local26 + local338.aShortArray32[local85] * 4 / super.anInt8888;
							arg11[local85] = local30 - local338.aShortArray38[local85] * 4 / super.anInt8888;
						}
						for (@Pc(376) int local376 = 0; local376 < local338.aShort33; local376++) {
							...
							@Pc(396) int local396 = arg10[local382];
							@Pc(400) int local400 = arg10[local387];
							@Pc(404) int local404 = arg10[local392];
							@Pc(408) int local408 = arg11[local382];
							@Pc(412) int local412 = arg11[local387];
							@Pc(416) int local416 = arg11[local392];
							@Pc(432) int local432;
							if (local338.anIntArray231 != null && local338.anIntArray231[local376] != -1) {
								local432 = local338.anIntArray231[local376];
								arg9.method3623((float) local408, (float) local412, (float) local416, (float) local396, (float) local400, (float) local404, 100.0F, 100.0F, 100.0F, (float) Static244.method2541(local338.aShortArray35[local382], local432), (float) Static244.method2541(local338.aShortArray35[local387], local432), (float) Static244.method2541(local338.aShortArray35[local392], local432));
							} else if (local338.aShortArray30 == null || local338.aShortArray30[local376] == -1) {
								local432 = local338.anIntArray230[local376];
								arg9.method3623((float) local408, (float) local412, (float) local416, (float) local396, (float) local400, (float) local404, 100.0F, 100.0F, 100.0F, (float) Static244.method2541(local338.aShortArray35[local382], local432), (float) Static244.method2541(local338.aShortArray35[local387], local432), (float) Static244.method2541(local338.aShortArray35[local392], local432));
							} else {
								local432 = this.aClass19_Sub2_8.method2672(local338.aShortArray30[local376]);
								arg9.method3623((float) local408, (float) local412, (float) local416, (float) local396, (float) local400, (float) local404, 100.0F, 100.0F, 100.0F, (float) Static244.method2541(local338.aShortArray35[local382], local432), (float) Static244.method2541(local338.aShortArray35[local387], local432), (float) Static244.method2541(local338.aShortArray35[local392], local432));
							}
						}
					}
		...
		arg9.aBoolean436 = true;
		this.aClass19_Sub2_8.C(local14);
	}

	@OriginalMember(owner = "client!qs", name = "b", descriptor = "(IIIIIII[[ZLclient!wf;Lclient!lb;[I[I)V")
	private void method5010(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean[][] arg7, @OriginalArg(8) Class399 arg8, @OriginalArg(9) Class219 arg9, @OriginalArg(10) int[] arg10, @OriginalArg(11) int[] arg11) {
		@Pc(7) int local7 = (arg6 - arg4) * 1024 / 256;
		@Pc(14) boolean local14 = arg8.aBoolean804;
		this.aClass19_Sub2_8.C(false);
		arg9.aBoolean436 = false;
					...
					if (this.aClass305ArrayArray1 == null) {
						if (this.aClass320ArrayArray1[local32][local35] != null) {
							...
							for (local89 = 0; local89 < local593.aShort110; local89++) {
								arg10[local89] = local26 + local593.aShortArray116[local89] * 4 / super.anInt8888;
								arg11[local89] = local30 - local593.aShortArray113[local89] * 4 / super.anInt8888;
							}
							for (local379 = 0; local379 < local593.aShort109; local379++) {
								local384 = local379 * 3;
								local388 = local384 + 1;
								local392 = local388 + 1;
								local396 = arg10[local384];
								local400 = arg10[local388];
								local404 = arg10[local392];
								local408 = arg11[local384];
								local412 = arg11[local388];
								local416 = arg11[local392];
								if (local593.anIntArray647 == null || local593.anIntArray647[local379] == 0) {
									arg9.method3608((float) local408, (float) local412, (float) local416, (float) local396, (float) local400, (float) local404, 100.0F, 100.0F, 100.0F, local593.anIntArray646[local384], local593.anIntArray646[local388], local593.anIntArray646[local392]);
								} else {
									local449 = local593.anIntArray647[local379];
									arg9.method3608((float) local408, (float) local412, (float) local416, (float) local396, (float) local400, (float) local404, 100.0F, 100.0F, 100.0F, local449, local449, local449);
								}
							}
						}
						...
						if (local67.aShort105 != -1 && (local67.aByte126 & 0x2) == 0 && local67.anInt7770 == 0) {
							local89 = this.aClass19_Sub2_8.method2672(local67.aShort105);
							arg9.method3623((float) (local30 - 4), (float) (local30 - 4), (float) local30, (float) (local26 + 4), (float) local26, (float) (local26 + 4), 100.0F, 100.0F, 100.0F, (float) Static244.method2541(local67.anInt7767, local89), (float) Static244.method2541(local67.anInt7769, local89), (float) Static244.method2541(local67.anInt7771, local89));
							arg9.method3623((float) local30, (float) local30, (float) (local30 - 4), (float) local26, (float) (local26 + 4), (float) local26, 100.0F, 100.0F, 100.0F, (float) Static244.method2541(local67.anInt7768, local89), (float) Static244.method2541(local67.anInt7771, local89), (float) Static244.method2541(local67.anInt7769, local89));
						} else if (local67.anInt7770 == 0) {
							arg9.method3608((float) (local30 - 4), (float) (local30 - 4), (float) local30, (float) (local26 + 4), (float) local26, (float) (local26 + 4), 100.0F, 100.0F, 100.0F, local67.anInt7767, local67.anInt7769, local67.anInt7771);
							arg9.method3608((float) local30, (float) local30, (float) (local30 - 4), (float) local26, (float) (local26 + 4), (float) local26, 100.0F, 100.0F, 100.0F, local67.anInt7768, local67.anInt7771, local67.anInt7769);
						} else {
							local89 = local67.anInt7770;
							arg9.method3608((float) (local30 - 4), (float) (local30 - 4), (float) local30, (float) (local26 + 4), (float) local26, (float) (local26 + 4), 100.0F, 100.0F, 100.0F, Static462.method4374(local67.anInt7767 & 0xFF000000, local89), Static462.method4374(local67.anInt7769 & 0xFF000000, local89), Static462.method4374(local67.anInt7771 & 0xFF000000, local89));
							arg9.method3608((float) local30, (float) local30, (float) (local30 - 4), (float) local26, (float) (local26 + 4), (float) local26, 100.0F, 100.0F, 100.0F, Static462.method4374(local67.anInt7768 & 0xFF000000, local89), Static462.method4374(local67.anInt7771 & 0xFF000000, local89), Static462.method4374(local67.anInt7769 & 0xFF000000, local89));
						}
						...
						for (local89 = 0; local89 < local341.aShort128; local89++) {
							arg10[local89] = local26 + local341.aShortArray142[local89] * 4 / super.anInt8888;
							arg11[local89] = local30 - local341.aShortArray141[local89] * 4 / super.anInt8888;
						}
						for (local379 = 0; local379 < local341.aShort129; local379++) {
							...
							if (local341.anIntArray801 != null && local341.anIntArray801[local379] != 0 && (local341.aShortArray139 == null || local341.aShortArray139 != null && local341.aShortArray139[local379] == -1)) {
								...
								arg9.method3608((float) local408, (float) local412, (float) local416, (float) local396, (float) local400, (float) local404, 100.0F, 100.0F, 100.0F, Static462.method4374(-(local341.anIntArray802[local384] & -16777216) - 16777216, local449), Static462.method4374(-(local341.anIntArray802[local388] & -16777216) - 16777216, local449), Static462.method4374(-(local341.anIntArray802[local392] & -16777216) - 16777216, local449));
							} else if (local341.aShortArray139 == null || local341.aShortArray139[local379] == -1) {
								arg9.method3608((float) local408, (float) local412, (float) local416, (float) local396, (float) local400, (float) local404, 100.0F, 100.0F, 100.0F, local341.anIntArray802[local384], local341.anIntArray802[local388], local341.anIntArray802[local392]);
							} else {
								local449 = this.aClass19_Sub2_8.method2672(local341.aShortArray139[local379]);
								arg9.method3623((float) local408, (float) local412, (float) local416, (float) local396, (float) local400, (float) local404, 100.0F, 100.0F, 100.0F, (float) local449, (float) local449, (float) local449);
							}
						}
					}
				}
	...
	private void method5011(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class219 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int arg7) {
			...
			if (local2204 != null) {
				...
				for (local480 = 0; local480 < local2204.aShort33; local480++) {
					...
					if ((local510 - local2549) * (local2565 - local2561) - (local2557 - local2561) * (local2553 - local2549) > 0) {
						...
						if (local3170 != -1) {
							arg2.aBoolean434 = local510 < 0 || local2549 < 0 || local2553 < 0 || local510 > arg2.anInt5725 || local2549 > arg2.anInt5725 || local2553 > arg2.anInt5725;
							arg2.method3623((float) local2557, (float) local2561, (float) local2565, (float) local510, (float) local2549, (float) local2553, (float) arg5[local2531], (float) arg5[local2536], (float) arg5[local2541], (float) Static244.method2541(local2204.aShortArray35[local2531], local3170), (float) Static244.method2541(local2204.aShortArray35[local2536], local3170), (float) Static244.method2541(local2204.aShortArray35[local2541], local3170));
						}
					}
				}
			}
	...
	@Override
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(3) Class73_Sub2 local3 = this.aClass19_Sub2_8.aClass73_Sub2_1;
		this.anInt8145 = arg5;
		this.aFloat170 = local3.aFloat59;
		this.aFloat167 = local3.aFloat55;
		...
		for (@Pc(56) int local56 = 0; local56 < arg2 + arg2; local56++) {
			for (@Pc(59) int local59 = 0; local59 < arg2 + arg2; local59++) {
				if (arg3[local56][local59]) {
					...
					@Pc(78) int local78 = arg1 + local59 - arg2;
					if (local72 >= 0 && local72 < super.anInt8894 && local78 >= 0 && local78 < super.anInt8892) {
						this.method5014(local72, local78, arg6);
					}
				}
			}
		}
	...
	@Override
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean[][] arg7) {
		@Pc(4) Class399 local4 = this.aClass19_Sub2_8.method2666(Thread.currentThread());
		...
		if (this.aClass305ArrayArray1 != null || this.aClass320ArrayArray1 != null) {
			this.method5010(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, local4, local7, local4.anIntArray840, local4.anIntArray843);
		} else if (this.aClass127ArrayArray1 != null) {
			this.method5009(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, local4, local7, local4.anIntArray840, local4.anIntArray843);
		}
	}
	...
	@Override
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) int[] arg10, @OriginalArg(11) int[] arg11, @OriginalArg(12) int[] arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15, @OriginalArg(16) boolean arg16) {
		...
		if (!local33) {
			...
			for (@Pc(147) int local147 = 0; local147 < local122; local147++) {
				...
				local118.aShortArray33[local147] = (short) (this.a(local370, -114, (int) local323) + (arg3 == null ? 0 : arg3[local147]));
			...
			for (local323 = 0; local323 < local126; local323++) {
				...
				if (local370 != -1) {
					@Pc(490) Class118 local490 = this.aClass19_Sub2_8.anInterface4_10.method4805(local370);
					if (!local490.aBoolean240) {
						local454 = true;
						if (this.method5008(local490.aByte56) || local490.aByte54 != 0 || local490.aByte52 != 0) {
			...
			for (local370 = 0; local370 < local126; local370++) {
				if (arg9[local370] >= 0 || arg10 != null && arg10[local370] >= 0) {
					if (arg9[local370] >= 0) {
						local118.anIntArray230[local118.aShort33] = Static105.method1299(arg9[local370]);
					} else {
					...
					if (arg10 != null) {
						if (arg10[local370] == -1) {
							...
							local118.anIntArray231[local118.aShort33] = Static105.method1299(arg10[local370]);
						}
					}
					...
					if (local454) {
						if (arg11[local370] == -1 || this.aClass19_Sub2_8.anInterface4_10.method4805(arg11[local370]).aBoolean240) {
			...
			local85 = arg11[0];
			if (arg10 != null) {
				local741.anInt2898 = Static244.method2541(this.aByteArrayArray31[arg0][arg1] - this.aByteArrayArray30[arg0][arg1], Static105.method1299(arg10[0]));
				if (local79 == -1) {
			...
			if (local85 != -1) {
				local849 = this.aClass19_Sub2_8.anInterface4_10.method4805(local85);
			}
			if (local849 == null || (local741.aByte59 & 0x2) != 0 || local849.aBoolean240) {
				@Pc(987) short local987 = Static105.method1299(local79);
				local741.aShort42 = (short) Static244.method2541(this.aByteArrayArray31[arg0][arg1] - this.aByteArrayArray30[arg0][arg1], local987);
				local741.aShort39 = (short) Static244.method2541(this.aByteArrayArray31[arg0 + 1][arg1] - this.aByteArrayArray30[arg0 + 1][arg1], local987);
				local741.aShort41 = (short) Static244.method2541(this.aByteArrayArray31[arg0 + 1][arg1 + 1] - this.aByteArrayArray30[arg0 + 1][arg1 + 1], local987);
				local741.aShort40 = (short) Static244.method2541(this.aByteArrayArray31[arg0][arg1 + 1] - this.aByteArrayArray30[arg0][arg1 + 1], local987);
				local741.aShort38 = -1;
			} else {
				...
				if (this.method5008(local849.aByte56) || local849.aByte54 != 0 || local849.aByte52 != 0) {
	...
	private void method5012(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Class399 arg3, @OriginalArg(4) Class219 arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int arg9) {
		...
		if (local6 == null) {
					...
					if (this.anInt8145 == -1) {
						for (local559 = 0; local559 < local3142.aShort129; local559++) {
							...
							if ((local589 - local3620) * (local3636 - local3632) - (local3628 - local3632) * (local3624 - local3620) > 0) {
								...
								if (local3648 >= 765) {
									arg4.method3625((float) local3628, (float) local3632, (float) local3636, (float) local589, (float) local3620, (float) local3624, (float) arg7[local409], (float) arg7[local469], (float) arg7[local529], arg3.anInt10597);
								} else if (local3648 > 0) {
									if (local3705 != -1) {
										local3719 = -16777216;
										if (local3705 != -1 && this.method5008(this.aClass19_Sub2_8.anInterface4_10.method4805(local3705).aByte56)) {
											local3719 = -1694498816;
										}
										arg4.method3617((float) local3628, (float) local3632, (float) local3636, (float) local589, (float) local3620, (float) local3624, (float) arg7[local409], (float) arg7[local469], (float) arg7[local529], (float) local3142.aShortArray142[local409] / (float) super.anInt8888, (float) local3142.aShortArray142[local469] / (float) super.anInt8888, (float) local3142.aShortArray142[local529] / (float) super.anInt8888, (float) local3142.aShortArray141[local409] / (float) super.anInt8888, (float) local3142.aShortArray141[local469] / (float) super.anInt8888, (float) local3142.aShortArray141[local529] / (float) super.anInt8888, local3719 | local3142.anIntArray802[local409] & 0xFFFFFF, local3719 | local3142.anIntArray802[local469] & 0xFFFFFF, local3719 | local3142.anIntArray802[local529] & 0xFFFFFF, arg3.anInt10597, arg8[local409], arg8[local469], arg8[local529], local3705);
									} else if ((local3142.anIntArray802[local409] & 0xFFFFFF) != 0) {
										if (local3705 != -1 && this.method5008(this.aClass19_Sub2_8.anInterface4_10.method4805(local3705).aByte56)) {
											arg4.anInt5724 = -1694498816;
										}
										arg4.method3608((float) local3628, (float) local3632, (float) local3636, (float) local589, (float) local3620, (float) local3624, (float) arg7[local409], (float) arg7[local469], (float) arg7[local529], Static462.method4374(arg8[local409] << 24 | arg3.anInt10597, local3142.anIntArray802[local409]), Static462.method4374(arg8[local469] << 24 | arg3.anInt10597, local3142.anIntArray802[local469]), Static462.method4374(arg8[local529] << 24 | arg3.anInt10597, local3142.anIntArray802[local529]));
										arg4.anInt5724 = 0;
									}
								} else if (local3705 != -1) {
									local3719 = -16777216;
									...
									arg4.method3608((float) local3628, (float) local3632, (float) local3636, (float) local589, (float) local3620, (float) local3624, (float) arg7[local409], (float) arg7[local469], (float) arg7[local529], local3142.anIntArray802[local409], local3142.anIntArray802[local469], local3142.anIntArray802[local529]);
									arg4.anInt5724 = 0;
								}
							}
						}
					...
					if ((local589 - local3620) * (local3636 - local3632) - (local3628 - local3632) * (local3624 - local3620) > 0) {
						...
						if (local3648 >= 765) {
							...
							if ((local3142.anIntArray802[local409] & 0xFFFFFF) != 0) {
								arg4.method3608((float) local3628, (float) local3632, (float) local3636, (float) local589, (float) local3620, (float) local3624, (float) arg7[local409], (float) arg7[local469], (float) arg7[local529], Static572.a(arg3.anInt10597, local3142.anIntArray802[local409], arg8[local409]), Static572.a(arg3.anInt10597, local3142.anIntArray802[local469], arg8[local469]), Static572.a(arg3.anInt10597, local3142.anIntArray802[local529], arg8[local529]));
							}
						} else if ((local3142.anIntArray802[local409] & 0xFFFFFF) != 0) {
							arg4.method3608((float) local3628, (float) local3632, (float) local3636, (float) local589, (float) local3620, (float) local3624, (float) arg7[local409], (float) arg7[local469], (float) arg7[local529], local3142.anIntArray802[local409], local3142.anIntArray802[local469], local3142.anIntArray802[local529]);
						}
			...
			@Pc(1864) boolean local1864 = local6.aShort105 != -1 && this.method5008(this.aClass19_Sub2_8.anInterface4_10.method4805(local6.aShort105).aByte56);
			if (this.anInt8145 == -1) {
				...
				if ((local499 - local559) * (local469 - local589) - (local529 - local589) * (local439 - local559) > 0) {
					...
					if (local863 >= 765) {
						arg4.method3625((float) local529, (float) local589, (float) local469, (float) local499, (float) local559, (float) local439, (float) (int) local163, (float) (int) local189, (float) (int) local137, arg3.anInt10597);
					} else if (local863 > 0) {
						if (local6.aShort105 >= 0) {
							...
							arg4.method3617((float) local529, (float) local589, (float) local469, (float) local499, (float) local559, (float) local439, local163, local189, local137, 1.0F, 0.0F, 1.0F, 1.0F, 1.0F, 0.0F, local874 | local6.anInt7767 & 0xFFFFFF, local874 | local6.anInt7769 & 0xFFFFFF, local874 | local6.anInt7771 & 0xFFFFFF, arg3.anInt10597, local66, local68, local64, local6.aShort105);
						} else {
							if (local1864) {
								arg4.anInt5724 = 100;
							}
							arg4.method3608((float) local529, (float) local589, (float) local469, (float) local499, (float) local559, (float) local439, (float) (int) local163, (float) (int) local189, (float) (int) local137, Static462.method4374(local66 << 24 | arg3.anInt10597, local6.anInt7767), Static462.method4374(local68 << 24 | arg3.anInt10597, local6.anInt7769), Static462.method4374(local64 << 24 | arg3.anInt10597, local6.anInt7771));
							arg4.anInt5724 = 0;
						}
						...
						arg4.method3617((float) local529, (float) local589, (float) local469, (float) local499, (float) local559, (float) local439, local163, local189, local137, 1.0F, 0.0F, 1.0F, 1.0F, 1.0F, 0.0F, local874 | local6.anInt7767 & 0xFFFFFF, local874 | local6.anInt7769 & 0xFFFFFF, local874 | local6.anInt7771 & 0xFFFFFF, 0, 0, 0, 0, local6.aShort105);
					} else {
						if (local1864) {
							arg4.anInt5724 = 100;
						}
						arg4.method3608((float) local529, (float) local589, (float) local469, (float) local499, (float) local559, (float) local439, (float) (int) local163, (float) (int) local189, (float) (int) local137, local6.anInt7767, local6.anInt7769, local6.anInt7771);
						arg4.anInt5724 = 0;
					}
				}
					...
					if (local863 < 765) {
						...
						if (local863 > 0) {
							if (local6.aShort105 >= 0) {
								...
								arg4.method3617((float) local409, (float) local469, (float) local589, (float) local379, (float) local439, (float) local559, local111, local137, local189, 0.0F, 1.0F, 1.0F, 0.0F, 0.0F, 1.0F, local874 | local6.anInt7768 & 0xFFFFFF, local874 | local6.anInt7771 & 0xFFFFFF, local874 | local6.anInt7769 & 0xFFFFFF, arg3.anInt10597, local62, local64, local68, local6.aShort105);
								return;
							}
							if (local1864) {
								arg4.anInt5724 = 100;
							}
							arg4.method3608((float) local409, (float) local469, (float) local589, (float) local379, (float) local439, (float) local559, (float) (int) local111, (float) (int) local137, (float) (int) local189, Static462.method4374(local62 << 24 | arg3.anInt10597, local6.anInt7768), Static462.method4374(local64 << 24 | arg3.anInt10597, local6.anInt7771), Static462.method4374(local68 << 24 | arg3.anInt10597, local6.anInt7769));
							arg4.anInt5724 = 0;
							return;
						}
						if (local6.aShort105 >= 0) {
							...
							arg4.method3617((float) local409, (float) local469, (float) local589, (float) local379, (float) local439, (float) local559, local111, local137, local189, 0.0F, 1.0F, 1.0F, 0.0F, 0.0F, 1.0F, local874 | local6.anInt7768 & 0xFFFFFF, local874 | local6.anInt7771 & 0xFFFFFF, local874 | local6.anInt7769 & 0xFFFFFF, 0, 0, 0, 0, local6.aShort105);
							return;
						}
						if (local1864) {
							arg4.anInt5724 = 100;
						}
						arg4.method3608((float) local409, (float) local469, (float) local589, (float) local379, (float) local439, (float) local559, (float) (int) local111, (float) (int) local137, (float) (int) local189, local6.anInt7768, local6.anInt7771, local6.anInt7769);
						arg4.anInt5724 = 0;
						return;
					}
					arg4.method3625((float) local409, (float) local469, (float) local589, (float) local379, (float) local439, (float) local559, (float) (int) local111, (float) (int) local137, (float) (int) local189, arg3.anInt10597);
					return;
				}
			} else {
				local863 = local64 + local66 + local68;
	...
	private void method5014(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(4) Class399 local4 = this.aClass19_Sub2_8.method2666(Thread.currentThread());
		local4.aClass219_2.anInt5724 = 0;
		if (this.aClass305ArrayArray1 != null) {
			this.method5012(arg0, arg1, local4.aBoolean805, local4, local4.aClass219_2, local4.anIntArray840, local4.anIntArray843, local4.anIntArray852, local4.anIntArray855, arg2);
		} else if (this.aClass127ArrayArray1 != null) {
			this.method5011(arg0, arg1, local4.aClass219_2, local4.anIntArray840, local4.anIntArray843, local4.anIntArray852, local4.anIntArray855, arg2);
		} else if (this.aClass320ArrayArray1 != null) {
			this.method5007(arg0, arg1, local4.aBoolean805, local4, local4.aClass219_2, local4.anIntArray840, local4.anIntArray843, local4.anIntArray852, local4.anIntArray855, arg2);
		}
	}
