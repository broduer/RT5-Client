...
public final class Class183 implements Interface7 {
	...
	@Override
	public void method2848(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1) {
	...
	@Override
	public int method2844(@OriginalArg(0) int arg0) {
		if (!this.aBooleanArray12[arg0]) {
			return 0;
		}
		...
		if (this.anIntArray355[arg0] < local35) {
			...
			while (local63 > 0) {
				local63 -= 256;
				this.method2848(arg0, this.anIntArray354);
			}
	...
	@Override
	public void method2846(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) Component arg2) throws Exception {
		if (this.anInt4569 != 0) {
			return;
		}
	...
	@Override
	public void method2849(@OriginalArg(0) int arg0) {
	...
	@Override
	public void method2845(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) throws Exception {
