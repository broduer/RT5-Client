...
public final class Class190 implements Runnable {
	...
	public boolean method2899(@OriginalArg(1) int arg0) throws IOException {
	...
	public int method2904(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) byte[] arg2) throws IOException {
		...
		synchronized (this) {
			...
			if (this.anInt4666 >= this.anInt4665 + arg0) {
				Static734.method5448(this.aByteArray47, this.anInt4665, arg2, arg1, arg0);
			} else {
				@Pc(117) int local117 = this.anInt4666 - this.anInt4665;
				Static734.method5448(this.aByteArray47, this.anInt4665, arg2, arg1, local117);
				Static734.method5448(this.aByteArray47, 0, arg2, local117 + arg1, arg0 + -local117);
			}
