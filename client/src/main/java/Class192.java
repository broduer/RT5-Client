...
public final class Class192 implements Runnable {
	...
	public Class192(@OriginalArg(0) InputStream arg0, @OriginalArg(1) int arg1) {
		this.anInputStream1 = arg0;
		this.anInt4681 = arg1 + 1;
		this.aByteArray47 = new byte[this.anInt4681];
	...
	public boolean method4231(@OriginalArg(1) int arg0) throws IOException {
		if (arg0 <= 0 || arg0 >= this.anInt4681) {
			throw new IOException();
		}
		synchronized (this) {
			@Pc(48) int local48;
			if (this.anInt4680 > this.anInt4684) {
				local48 = this.anInt4681 + this.anInt4684 - this.anInt4680;
			} else {
				local48 = this.anInt4684 - this.anInt4680;
			}
			if (arg0 <= local48) {
				return true;
		...
		while (true) {
			...
			synchronized (this) {
				while (true) {
					...
					if (this.anInt4680 == 0) {
						local33 = this.anInt4681 - this.anInt4684 - 1;
					} else if (this.anInt4684 >= this.anInt4680) {
						local33 = this.anInt4681 - this.anInt4684;
					} else {
						local33 = this.anInt4680 - this.anInt4684 - 1;
					}
					if (local33 > 0) {
						break;
					}
			...
			@Pc(88) int local88;
			try {
				local88 = this.anInputStream1.read(this.aByteArray47, this.anInt4684, local33);
				if (local88 == -1) {
			...
			synchronized (this) {
				this.anInt4684 = (local88 + this.anInt4684) % this.anInt4681;
			}
		}
	}

	@OriginalMember(owner = "client!je", name = "a", descriptor = "(III[B)I")
	public int method4236(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) byte[] arg2) throws IOException {
		if (arg0 < 0 || arg1 < 0 || arg0 + arg1 > arg2.length) {
			throw new IOException();
		}
		synchronized (this) {
			@Pc(49) int local49;
			if (this.anInt4684 >= this.anInt4680) {
				local49 = this.anInt4684 - this.anInt4680;
			} else {
				local49 = this.anInt4684 + this.anInt4681 - this.anInt4680;
			}
			if (local49 < arg0) {
				arg0 = local49;
			}
