...
public final class Class19_Sub1_Sub1 extends Class19_Sub1 {
	...
	private static Class19 createToolkit(@OriginalArg(0) Canvas arg0, @OriginalArg(1) Interface4 arg1, @OriginalArg(2) Class330 arg2, @OriginalArg(3) Integer arg3) {
		...
		try {
			...
			if ((local18.RasterCaps & 0x1000000) == 0) {
				...
				if (!Static325.method3389(local186, local3, local13, local5, arg3)) {
					throw new RuntimeException("");
				}
	...
	public void method3386(@OriginalArg(1) IDirect3DVertexShader arg0) {
	...
	public void method5739(@OriginalArg(0) int arg0, @OriginalArg(2) Interface16 arg1) {
		...
		this.anIDirect3DDevice1.SetStreamSource(arg0, local6.anIDirect3DVertexBuffer1, 0, local6.method1643());
	}

	@OriginalMember(owner = "client!kea", name = "a", descriptor = "(ILclient!jagdx/IDirect3DPixelShader;)V")
	public void method3388(@OriginalArg(1) IDirect3DPixelShader arg0) {
	...
	public boolean method5762(@OriginalArg(0) Class397 arg0, @OriginalArg(1) Class92 arg1) {
		...
		return lh.a((byte) 75, this.anIDirect3D1.a(this.anInt5369, local3)) && lh.a((byte) 89, this.anIDirect3D1.CheckDeviceFormat(this.anInt5369, this.anInt5368, local3.Format, 0, 4, Static325.method3398(arg0, arg1)));
	}
	...
	public boolean method5680(@OriginalArg(0) Class92 arg0, @OriginalArg(1) Class397 arg1) {
		...
		return lh.a((byte) 98, this.anIDirect3D1.a(this.anInt5369, local8)) && lh.a((byte) 58, this.anIDirect3D1.CheckDeviceFormat(this.anInt5369, this.anInt5368, local8.Format, 0, 3, Static325.method3398(arg1, arg0)));
	}
	...
	protected void method5748(@OriginalArg(0) int arg0, @OriginalArg(2) Class168 arg1) {
		...
		this.anIDirect3DDevice1.SetTextureStageState(this.anInt9148, local17, Static325.method3392(arg1) | 0x0);
	}
	...
	private boolean method3391() {
		...
		if (local3 == 0 || local3 == -2005530519) {
			...
			if (Static325.method3389(this.aD3DPRESENT_PARAMETERS1, this.anInt5369, this.anIDirect3D1, this.anInt5368, this.anInt9158)) {
				@Pc(59) int local59 = this.anIDirect3DDevice1.Reset(this.aD3DPRESENT_PARAMETERS1);
				if (lh.a((byte) 95, local59)) {
					local26.method5789(this.anIDirect3DDevice1.c(), this.anIDirect3DDevice1.b(0));
					this.method5710();
					this.method5711();
					return true;
				}
	...
	protected void method5648() {
		@Pc(23) int local23 = this.aBooleanArray16[this.anInt9148] ? Static325.method3387(this.aClass121Array6[this.anInt9148]) : 1;
	...
	protected void method5745() {
		if (this.aBoolean676) {
			...
			this.aClass73_Sub1_15.method1207(Static325.aFloatArray36);
		}
	...
	protected void method5695() {
		...
		if (this.aClass370Array3[this.anInt9148] == Static431.aClass370_5) {
			this.anIDirect3DDevice1.SetTransform(this.anInt9148 + 16, this.aClass73_Sub1Array3[this.anInt9148].method1197(Static325.aFloatArray36));
		} else {
			this.anIDirect3DDevice1.SetTransform(this.anInt9148 + 16, this.aClass73_Sub1Array3[this.anInt9148].method1207(Static325.aFloatArray36));
		}
		@Pc(63) int local63 = Static325.method3393(this.aClass370Array3[this.anInt9148]);
	...
	public void e(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) throws Exception_Sub1 {
		this.anIDirect3DDevice1.EndScene();
		if (this.aClass349_1.method5790()) {
			this.anInt5370 = 0;
			if (lh.a(this.aClass349_1.method5788(), true)) {
				this.method3391();
			}
	...
	public void method3394(@OriginalArg(1) Class61_Sub3 arg0) {
	...
	public void method5688(@OriginalArg(0) Class131 arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		this.anIDirect3DDevice1.DrawPrimitive(Static325.method3395(arg0), arg1, arg2);
	}
	...
	protected void method5658() {
		...
		for (local1 = 0; local1 < this.anInt9177; local1++) {
			...
			@Pc(18) int local18 = local10.method5985();
			@Pc(24) float local24 = local10.method5982() / 255.0F;
			this.aD3DLIGHT2.SetPosition((float) local10.method5980(), (float) local10.method5979(), (float) local10.method5983());
			this.aD3DLIGHT2.SetDiffuse((float) (local18 >> 16 & 0xFF) * local24, local24 * (float) (local18 >> 8 & 0xFF), local24 * (float) (local18 & 0xFF), 0.0F);
			this.aD3DLIGHT2.SetAttenuation(0.0F, 0.0F, 1.0F / (float) (local10.method5986() * local10.method5986()));
			this.aD3DLIGHT2.SetRange((float) local10.method5986());
	...
	protected void method5678() {
		if (this.aClass77_6.method1305()) {
			this.aClass73_Sub1_18.method1207(Static325.aFloatArray36);
		} else {
			Static325.aFloatArray36[3] = 0.0F;
			Static325.aFloatArray36[8] = 0.0F;
			Static325.aFloatArray36[15] = 1.0F;
	...
	public void method3396(@OriginalArg(0) Class61_Sub1 arg0) {
		this.method3397(arg0);
	...
	public void method5661(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) Interface20 arg2, @OriginalArg(4) int arg3, @OriginalArg(5) Class131 arg4, @OriginalArg(6) int arg5) {
		...
		this.anIDirect3DDevice1.DrawIndexedPrimitive(Static325.method3395(arg4), 0, arg0, arg3, arg1, arg5);
	}
	...
	public void method3397(@OriginalArg(0) Class61 arg0) {
		this.anIDirect3DDevice1.SetTexture(this.anInt9148, arg0.method6476());
		if (arg0.aClass259_16 != this.aClass259Array1[this.anInt9148]) {
			@Pc(63) int local63 = Static325.method3390(arg0.aClass259_16);
			...
			if (arg0.aBoolean785 != this.aBooleanArray13[this.anInt9148]) {
				this.anIDirect3DDevice1.SetSamplerState(this.anInt9148, 7, arg0.aBoolean785 ? Static325.method3390(arg0.aClass259_16) : 0);
	...
	public void method5734(@OriginalArg(0) Class168 arg0, @OriginalArg(2) boolean arg1, @OriginalArg(3) boolean arg2, @OriginalArg(4) int arg3) {
		...
		this.anIDirect3DDevice1.SetTextureStageState(this.anInt9148, local26, Static325.method3392(arg0) | local34);
	}
	...
	protected void method5639() {
		@Pc(16) int local16 = this.aBooleanArray16[this.anInt9148] ? Static325.method3387(this.aClass121Array5[this.anInt9148]) : 1;
