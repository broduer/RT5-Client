...
public final class Class19_Sub2 extends Class19 {
	...
	private Class401[] aClass401Array1;
	...
	protected void method7994() {
		if (this.aBoolean330) {
			Static300.method4397(true, false);
			this.aBoolean330 = false;
		}
	...
	public void method7972(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) Class1 arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7) {
		...
		@Pc(18) int local18 = this.anInt4197 > arg7 ? this.anInt4197 : arg7;
		@Pc(34) int local34 = this.anInt4207 < arg7 + local5.length ? this.anInt4207 : arg7 + local5.length;
		arg2 -= arg0;
		arg3 -= arg1;
		if (arg2 + arg3 < 0) {
			arg0 += arg2;
		...
		if (arg2 <= arg3) {
			...
			if (local118 == 255 && true) {
				while (arg1 <= arg3) {
					...
					if (local136 >= this.anInt4203 && local136 < this.anInt4212 && local136 >= local154 && local136 < local154 + local8[local140]) {
						this.anIntArray319[local136 + arg1 * this.anInt4219] = arg4;
					}
					arg0 += local85;
					arg1++;
				}
				...
				while (arg1 <= arg3) {
					...
					if (local140 >= this.anInt4203 && local140 < this.anInt4212 && local140 >= local242 && local140 < local242 + local8[local154]) {
						local261 = local140 + arg1 * this.anInt4219;
						...
						this.anIntArray319[local140 + arg1 * this.anInt4219] = local215 + local629;
					}
					arg0 += local85;
					arg1++;
				}
		...
		arg2 += arg0;
		if (arg0 < this.anInt4203) {
			arg1 += local85 * (this.anInt4203 - arg0);
			arg0 = this.anInt4203;
		}
		if (arg2 >= this.anInt4212) {
			arg2 = this.anInt4212 - 1;
		}
		local118 = arg4 >>> 24;
		if (local118 == 255 && true) {
			while (arg0 <= arg2) {
				...
				if (local136 >= local18 && local136 < local34) {
					...
					if (arg0 >= local154 && arg0 < local154 + local8[local140]) {
						this.anIntArray319[arg0 + local136 * this.anInt4219] = arg4;
					}
				}
				arg1 += local85;
				arg0++;
		...
		while (arg0 <= arg2) {
			...
			if (local140 >= local18 && local140 < local34) {
				...
				if (arg0 >= local242 && arg0 < local242 + local8[local154]) {
					local261 = arg0 + local140 * this.anInt4219;
					local266 = this.anIntArray319[local261];
	...
	public void xa(@OriginalArg(0) float arg0) {
		this.anInt4214 = (int) (arg0 * 65535.0F);
	}

	@OriginalMember(owner = "client!iaa", name = "M", descriptor = "()I")
	@Override
	public int M() {
		@Pc(2) int local2 = this.anInt4225;
		this.anInt4225 = 0;
		return local2;
	}
	...
	public void method7954(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		@Pc(3) Class401 local3 = this.method3787(Thread.currentThread());
		@Pc(6) Class221 local6 = local3.aClass221_2;
		...
		@Pc(108) int local108 = arg0 - local6.method5167();
		@Pc(113) int local113 = arg1 - local6.method5147();
		...
		local6.anInt5744 = 0;
		this.C(false);
		local6.aBoolean434 = local117 < 0 || local117 > local6.anInt5745 || local121 < 0 || local121 > local6.anInt5745 || local127 < 0 || local127 > local6.anInt5745;
		local6.method5165((float) local137, (float) local141, (float) local147, (float) local117, (float) local121, (float) local127, 100.0F, 100.0F, 100.0F, arg4);
		local6.aBoolean434 = local117 < 0 || local117 > local6.anInt5745 || local127 < 0 || local127 > local6.anInt5745 || local133 < 0 || local133 > local6.anInt5745;
		local6.method5165((float) local137, (float) local147, (float) local153, (float) local117, (float) local127, (float) local133, 100.0F, 100.0F, 100.0F, arg4);
		this.C(true);
	}
	...
	public void method8026(@OriginalArg(0) Canvas arg0) {
		if (arg0 == null) {
			...
			if (this.aClass87_1 == null) {
				...
				this.anInt4219 = this.anInt4221 = 1;
				this.anInt4201 = this.anInt4215 = 1;
				this.method3789();
			}
			return;
		}
		...
		this.anInt4194 = local18.width;
		this.anInt4196 = local18.height;
		...
		if (this.anInt4219 != this.anInt4201 || this.anInt4221 != this.anInt4215) {
			...
			this.aFloatArray26 = this.aFloatArray25 = new float[this.anInt4201 * this.anInt4215];
		}
		this.method3789();
		return;
	}
	...
	private void method3783(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		if (arg0 < this.anInt4203 || arg0 >= this.anInt4212) {
			return;
		}
		@Pc(18) int local18 = arg0 + arg1 * this.anInt4219;
		...
		if (local22 == 255 && true) {
			local44 = 0;
			while (local44 < arg2) {
				if (arg1 + local44 >= this.anInt4197 && arg1 + local44 < this.anInt4207 && local30 < arg4) {
					this.anIntArray319[local18 + local44 * this.anInt4219] = arg3;
				}
				local44++;
				local30++;
				local30 %= local26;
		...
		while (local120 < arg2) {
			if (arg1 + local120 >= this.anInt4197 && arg1 + local120 < this.anInt4207 && local30 < arg4) {
				@Pc(147) int local147 = local18 + local120 * this.anInt4219;
	...
	public void ya() {
		...
		@Pc(31) int local31;
		@Pc(33) int local33;
		if (this.anInt4203 == 0 && this.anInt4212 == this.anInt4219 && this.anInt4197 == 0 && this.anInt4207 == this.anInt4221) {
			local25 = this.aFloatArray25.length;
			local31 = local25 - (local25 & 0x7);
			local33 = 0;
			while (local33 < local31) {
				this.aFloatArray25[local33++] = 2.14748365E9F;
				this.aFloatArray25[local33++] = 2.14748365E9F;
				this.aFloatArray25[local33++] = 2.14748365E9F;
				this.aFloatArray25[local33++] = 2.14748365E9F;
				this.aFloatArray25[local33++] = 2.14748365E9F;
		...
		local25 = this.anInt4212 - this.anInt4203;
		local31 = this.anInt4207 - this.anInt4197;
		local33 = this.anInt4219 - local25;
		@Pc(124) int local124 = this.anInt4203 + this.anInt4197 * this.anInt4219;
		...
		for (@Pc(139) int local139 = -local31; local139 < 0; local139++) {
			...
			if (local128 > 0) {
				...
				do {
					local25++;
					this.aFloatArray25[local25] = 2.14748365E9F;
					local25++;
					this.aFloatArray25[local25] = 2.14748365E9F;
					local25++;
					this.aFloatArray25[local25] = 2.14748365E9F;
	...
	public void method7946(@OriginalArg(0) Interface9 arg0) {
		...
		this.anInt4219 = local2.anInt2366;
		this.anInt4221 = local2.anInt2363;
		this.anIntArray319 = local2.anIntArray203;
		this.aClass87_1 = local2;
		this.anInt4201 = local2.anInt2366;
		this.anInt4215 = local2.anInt2363;
		this.aFloatArray25 = local2.aFloatArray16;
		this.method3789();
	}
	...
	public void method7974(@OriginalArg(0) Class232 arg0, @OriginalArg(1) int arg1) {
		...
		for (@Pc(10) Class8_Sub4 local10 = local7.aClass8_Sub4_10; local10 != local7; local10 = local10.aClass8_Sub4_10) {
			...
			@Pc(19) int local19 = local14.anInt7560 >> 12;
			@Pc(24) int local24 = local14.anInt7557 >> 12;
			@Pc(29) int local29 = local14.anInt7559 >> 12;
			...
			if (!(local54 < (float) this.anInt4226) && !(local54 > (float) local3.anInt10629)) {
				@Pc(106) int local106 = this.anInt4218 + (int) ((float) this.anInt4217 * (this.aClass73_Sub2_1.aFloat60 + this.aClass73_Sub2_1.aFloat59 * (float) local19 + this.aClass73_Sub2_1.aFloat55 * (float) local24 + this.aClass73_Sub2_1.aFloat53 * (float) local29) / (float) arg1);
				@Pc(142) int local142 = this.anInt4205 + (int) ((float) this.anInt4199 * (this.aClass73_Sub2_1.aFloat58 + this.aClass73_Sub2_1.aFloat57 * (float) local19 + this.aClass73_Sub2_1.aFloat52 * (float) local24 + this.aClass73_Sub2_1.aFloat51 * (float) local29) / (float) arg1);
				if (local106 >= this.anInt4203 && local106 <= this.anInt4212 && local142 >= this.anInt4197 && local142 <= this.anInt4207) {
					if (local54 == 0.0F) {
						local54 = 1.0F;
					}
					this.method3784(local14, local106, local142, (int) local54, (local14.anInt7558 * this.anInt4217 >> 12) / arg1);
				}
			}
		}
	}
	...
	private void method3784(@OriginalArg(0) Class8_Sub4_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(2) int local2 = arg0.anInt7563;
		@Pc(8) int local8 = arg4 << 1;
		if (local2 == -1) {
			this.method3790(arg1, arg2, arg3, arg4, arg0.anInt7562, 1);
			return;
		}
		...
		local8++;
		((Class23_Sub1) this.aClass23_17).method8215(arg1 - arg4, arg2 - arg4, arg3, local8, local8, 0, arg0.anInt7562, 1);
	}

	@OriginalMember(owner = "client!iaa", name = "F", descriptor = "(II)V")
	@Override
	public void F(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(6) int local6 = arg1 * this.anInt4219 + arg0;
		@Pc(13) int local13 = arg1 * this.anInt4201 + arg0;
		if (local6 == 0 && local13 == 0) {
			return;
		}
		@Pc(24) int[] local24 = this.anIntArray319;
		@Pc(27) float[] local27 = this.aFloatArray25;
		@Pc(34) int local34;
		if (local6 < 0) {
	...
	protected void za(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (local8 < this.anInt4197) {
			local8 = this.anInt4197;
		}
		@Pc(21) int local21 = arg1 + arg2 + 1;
		if (local21 > this.anInt4207) {
			local21 = this.anInt4207;
		}
		...
		if (arg4 == 1 && local57 == 255) {
			while (local30 < arg1) {
				...
				if (local98 < this.anInt4203) {
					local98 = this.anInt4203;
				}
				local109 = arg0 + local36;
				if (local109 > this.anInt4212) {
					local109 = this.anInt4212;
				}
				local123 = local98 + local30 * this.anInt4219;
			...
			while (local30 < local21) {
				...
				local109 = arg0 + local36;
				if (local109 > this.anInt4212 - 1) {
					local109 = this.anInt4212 - 1;
				}
				local123 = local98 + local30 * this.anInt4219;
				for (local125 = local98; local125 <= local109; local125++) {
					this.anIntArray319[local123++] = arg3;
		...
		while (local30 < arg1) {
			...
			if (local109 < this.anInt4203) {
				local109 = this.anInt4203;
			}
			local123 = arg0 + local36;
			if (local123 > this.anInt4212) {
				local123 = this.anInt4212;
			}
			local125 = local109 + local30 * this.anInt4219;
		...
		while (local30 < local21) {
			...
			local123 = arg0 + local36;
			if (local123 > this.anInt4212 - 1) {
				local123 = this.anInt4212 - 1;
			}
			local125 = local109 + local30 * this.anInt4219;
			for (local346 = local109; local346 <= local123; local346++) {
				local352 = this.anIntArray319[local125];
	...
	public void aa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		if (arg0 < this.anInt4203) {
			arg2 -= this.anInt4203 - arg0;
			arg0 = this.anInt4203;
		}
		if (arg1 < this.anInt4197) {
			arg3 -= this.anInt4197 - arg1;
			arg1 = this.anInt4197;
		}
		if (arg0 + arg2 > this.anInt4212) {
			arg2 = this.anInt4212 - arg0;
		}
		if (arg1 + arg3 > this.anInt4207) {
			arg3 = this.anInt4207 - arg1;
		}
		if (arg2 <= 0 || arg3 <= 0 || arg0 > this.anInt4212 || arg1 > this.anInt4207) {
			return;
		}
		@Pc(74) int local74 = this.anInt4219 - arg2;
		@Pc(81) int local81 = arg0 + arg1 * this.anInt4219;
	...
	public void GA(@OriginalArg(0) int arg0) {
		this.aa(0, 0, this.anInt4219, this.anInt4221, arg0, 0);
	}
	...
	public void method8001() {
		...
		@Pc(14) int local14 = 5 - this.anInt4222;
		@Pc(19) int local19 = 75 - this.anInt4222;
		@Pc(24) int local24 = 15 - this.anInt4222;
		@Pc(29) int local29 = 10 - this.anInt4220;
	...
	@Override
	public int[] Y() {
		return new int[] { this.anInt4218, this.anInt4205, this.anInt4217, this.anInt4199 };
	}
	...
	public boolean method3786(@OriginalArg(0) int arg0) {
		return super.anInterface4_10.method6821(arg0);
	}

	@OriginalMember(owner = "client!iaa", name = "a", descriptor = "(Ljava/lang/Runnable;)Lclient!wf;")
	public Class401 method3787(@OriginalArg(0) Runnable arg0) {
		for (@Pc(1) int local1 = 0; local1 < this.anInt4223; local1++) {
			if (this.aClass401Array1[local1].aRunnable2 == arg0) {
				return this.aClass401Array1[local1];
			}
		}
		return null;
	}
	...
	public void f(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		this.anInt4226 = arg0;
		this.anInt4211 = arg1;
		local3.anInt10629 = this.anInt4211 - 255;
	}
	...
	public void P(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (arg1 < this.anInt4197) {
			arg2 -= this.anInt4197 - arg1;
			arg1 = this.anInt4197;
		}
		if (arg1 + arg2 > this.anInt4207) {
			arg2 = this.anInt4207 - arg1;
		}
		@Pc(43) int local43 = arg0 + arg1 * this.anInt4219;
		@Pc(47) int local47 = arg3 >>> 24;
		@Pc(61) int local61;
		if (arg4 == 0 || arg4 == 1 && local47 == 255) {
			for (local61 = 0; local61 < arg2; local61++) {
				this.anIntArray319[local43 + local61 * this.anInt4219] = arg3;
			}
			return;
		}
		@Pc(111) int local111;
		...
		if (arg4 == 1) {
			...
			for (local111 = 0; local111 < arg2; local111++) {
				local119 = local43 + local111 * this.anInt4219;
			...
			for (local61 = 0; local61 < arg2; local61++) {
				local111 = local43 + local61 * this.anInt4219;
	...
	public void U(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg1 < this.anInt4197 || arg1 >= this.anInt4207) {
			return;
		}
		if (arg0 < this.anInt4203) {
			arg2 -= this.anInt4203 - arg0;
	...
	public void ZA(@OriginalArg(0) int arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5) {
		...
		this.anInt4198 = (int) (arg2 * 65535.0F);
		@Pc(26) float local26 = (float) Math.sqrt((double) (arg3 * arg3 + arg4 * arg4 + arg5 * arg5));
		this.anInt4200 = (int) (arg3 * 65535.0F / local26);
		this.anInt4216 = (int) (arg4 * 65535.0F / local26);
		this.anInt4209 = (int) (arg5 * 65535.0F / local26);
	}
	...
	public void A(@OriginalArg(0) int arg0, @OriginalArg(1) Class1 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		@Pc(8) int[] local8 = local2.anIntArray335;
		@Pc(20) int local20;
		if (this.anInt4207 < arg3 + local5.length) {
			local20 = this.anInt4207 - arg3;
		} else {
			local20 = local5.length;
		}
		@Pc(33) int local33;
		if (this.anInt4197 > arg3) {
			local33 = this.anInt4197 - arg3;
			arg3 = this.anInt4197;
		} else {
			local33 = 0;
		}
		...
		@Pc(50) int local50 = arg3 * this.anInt4219;
		for (@Pc(52) int local52 = local33; local52 < local20; local52++) {
			...
			if (this.anInt4203 > local59) {
				local63 -= this.anInt4203 - local59;
				local59 = this.anInt4203;
			}
			if (this.anInt4212 < local59 + local63) {
				local63 = this.anInt4212 - local59;
			}
			local59 += local50;
			for (@Pc(95) int local95 = -local63; local95 < 0; local95++) {
				this.anIntArray319[local59++] = arg0;
			}
			local50 += this.anInt4219;
		}
	}
		...
		if (arg3 == 0) {
			...
			if (arg2 > arg3) {
				...
				if (local182 == 255 && true) {
					while (arg0 <= local243) {
						local278 = arg1 >> 16;
						if (arg0 >= this.anInt4203 && arg0 < this.anInt4212 && local278 >= this.anInt4197 && local278 < this.anInt4207 && arg7 < local149) {
							this.anIntArray319[arg0 + local278 * this.anInt4219] = arg4;
						}
						arg1 += local178;
						arg0++;
					...
					while (arg0 <= local243) {
						local371 = arg1 >> 16;
						if (arg0 >= this.anInt4203 && arg0 < this.anInt4212 && local371 >= this.anInt4197 && local371 < this.anInt4207 && arg7 < local149) {
							local405 = arg0 + local371 * this.anInt4219;
				...
				if (local182 == 255 && true) {
					while (arg1 <= local229) {
						local278 = arg0 >> 16;
						if (arg1 >= this.anInt4197 && arg1 < this.anInt4207 && local278 >= this.anInt4203 && local278 < this.anInt4212 && arg7 < local149) {
							this.anIntArray319[local278 + arg1 * this.anInt4219] = arg4;
						}
						arg0 += local178;
						arg1++;
						local35 = arg7 + local260;
					...
					while (arg1 <= local229) {
						local371 = arg0 >> 16;
						if (arg1 >= this.anInt4197 && arg1 < this.anInt4207 && local371 >= this.anInt4203 && local371 < this.anInt4212 && arg7 < local149) {
							local405 = local371 + arg1 * this.anInt4219;
							local410 = this.anIntArray319[local405];
							@Pc(773) int local773 = ((local410 & 0xFF00FF) * local278 >> 8 & 0xFF00FF) + ((local410 & 0xFF00) * local278 >> 8 & 0xFF00);
							this.anIntArray319[local371 + arg1 * this.anInt4219] = local362 + local773;
						}
						arg0 += local178;
						arg1++;
						local35 = arg7 + local260;
	...
	public void K(@OriginalArg(0) int[] arg0) {
		arg0[0] = this.anInt4203;
		arg0[1] = this.anInt4197;
		arg0[2] = this.anInt4212;
		arg0[3] = this.anInt4207;
	}
	...
	private void method3789() {
		for (@Pc(1) int local1 = 0; local1 < this.anInt4223; local1++) {
			this.aClass401Array1[local1].method9201();
		}
		this.la();
	}
	...
	public void method8027(@OriginalArg(0) int arg0) {
		this.aClass401Array1[arg0].method9203(Thread.currentThread());
	}
	...
	public void method7951(@OriginalArg(0) int[] arg0) {
		arg0[0] = this.anInt4219;
		arg0[1] = this.anInt4221;
	}
	...
	public void H(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3) {
		...
		@Pc(74) int local74 = (int) ((float) this.anInt4217 * (this.aClass73_Sub2_1.aFloat60 + this.aClass73_Sub2_1.aFloat59 * (float) arg0 + this.aClass73_Sub2_1.aFloat55 * (float) arg1 + this.aClass73_Sub2_1.aFloat53 * (float) arg2) / local24);
		@Pc(106) int local106 = (int) ((float) this.anInt4199 * (this.aClass73_Sub2_1.aFloat58 + this.aClass73_Sub2_1.aFloat57 * (float) arg0 + this.aClass73_Sub2_1.aFloat52 * (float) arg1 + this.aClass73_Sub2_1.aFloat51 * (float) arg2) / local24);
		arg3[0] = local74 - this.anInt4222;
		arg3[1] = local106 - this.anInt4220;
		arg3[2] = (int) local24;
	}
	...
	public void ra(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		for (@Pc(1) int local1 = 0; local1 < this.aClass401Array1.length; local1++) {
			this.aClass401Array1[local1].anInt10628 = this.aClass401Array1[local1].anInt10625;
			this.aClass401Array1[local1].anInt10632 = arg0;
			this.aClass401Array1[local1].anInt10625 = arg1;
			this.aClass401Array1[local1].anInt10630 = arg2;
			this.aClass401Array1[local1].aBoolean806 = true;
		}
	}
	...
	private void method3790(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		if (arg5 == 0 || arg5 == 1 && local57 == 255) {
			while (local30 < arg1) {
				...
				local123 = local98 + local30 * this.anInt4219;
				for (local125 = local98; local125 < local109; local125++) {
					if ((float) arg2 < this.aFloatArray25[local123]) {
		...
		if (arg5 == 1) {
			...
			while (local30 < arg1) {
				...
				for (local366 = local109; local366 < local123; local366++) {
					if ((float) arg2 < this.aFloatArray25[local125]) {
	...
	public void KA(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		if (arg2 > this.anInt4219) {
			arg2 = this.anInt4219;
		}
		if (arg3 > this.anInt4221) {
			arg3 = this.anInt4221;
		}
		this.anInt4203 = arg0;
		this.anInt4212 = arg2;
	...
	public void da(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3) {
		@Pc(24) float local24 = this.aClass73_Sub2_1.aFloat62 + this.aClass73_Sub2_1.aFloat56 * (float) arg0 + this.aClass73_Sub2_1.aFloat54 * (float) arg1 + this.aClass73_Sub2_1.aFloat61 * (float) arg2;
		if (local24 < (float) this.anInt4226 || local24 > (float) this.anInt4211) {
			arg3[0] = arg3[1] = arg3[2] = -1;
			return;
		}
		@Pc(84) int local84 = (int) ((float) this.anInt4217 * (this.aClass73_Sub2_1.aFloat60 + this.aClass73_Sub2_1.aFloat59 * (float) arg0 + this.aClass73_Sub2_1.aFloat55 * (float) arg1 + this.aClass73_Sub2_1.aFloat53 * (float) arg2) / local24);
		@Pc(116) int local116 = (int) ((float) this.anInt4199 * (this.aClass73_Sub2_1.aFloat58 + this.aClass73_Sub2_1.aFloat57 * (float) arg0 + this.aClass73_Sub2_1.aFloat52 * (float) arg1 + this.aClass73_Sub2_1.aFloat51 * (float) arg2) / local24);
		if (local84 >= this.anInt4222 && local84 <= this.anInt4204 && local116 >= this.anInt4220 && local116 <= this.anInt4213) {
			arg3[0] = local84 - this.anInt4222;
			arg3[1] = local116 - this.anInt4220;
			arg3[2] = (int) local24;
		} else {
			arg3[0] = arg3[1] = arg3[2] = -1;
		}
	...
	public void HA(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[] arg4) {
		...
		@Pc(85) int local85 = (int) ((float) this.anInt4217 * (this.aClass73_Sub2_1.aFloat60 + this.aClass73_Sub2_1.aFloat59 * (float) arg0 + this.aClass73_Sub2_1.aFloat55 * (float) arg1 + this.aClass73_Sub2_1.aFloat53 * (float) arg2) / (float) arg3);
		@Pc(118) int local118 = (int) ((float) this.anInt4199 * (this.aClass73_Sub2_1.aFloat58 + this.aClass73_Sub2_1.aFloat57 * (float) arg0 + this.aClass73_Sub2_1.aFloat52 * (float) arg1 + this.aClass73_Sub2_1.aFloat51 * (float) arg2) / (float) arg3);
		if (local85 >= this.anInt4222 && local85 <= this.anInt4204 && local118 >= this.anInt4220 && local118 <= this.anInt4213) {
			arg4[0] = local85 - this.anInt4222;
			arg4[1] = local118 - this.anInt4220;
			arg4[2] = (int) local24;
		} else {
			arg4[0] = arg4[1] = arg4[2] = -1;
		}
	...
	public void method8023(@OriginalArg(0) int arg0) {
		this.aClass401Array1[arg0].method9203((Runnable) null);
	}
	...
	public void method7963(@OriginalArg(0) int arg0) {
		this.anInt4223 = arg0;
		this.aClass401Array1 = new Class401[this.anInt4223];
		for (@Pc(9) int local9 = 0; local9 < this.anInt4223; local9++) {
			this.aClass401Array1[local9] = new Class401(this);
		}
	}
	...
	public void method8010() {
		Static567.anInt8508 = 10000;
		Static567.anInt8510 = 10000;
		if (this.anInt4223 > 1) {
			throw new IllegalStateException("No MT");
		}
		this.method7963(this.anInt4223);
		this.method8027(0);
	}
	...
	public void method3791(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
		...
		if (arg6 == 65535 || super.anInterface4_10.method6824(arg6).aBoolean240) {
		...
		((Class23_Sub1) this.aClass23_17).method8215(arg0 - arg3, arg1 - arg4, arg2, arg3 << 1, arg4 << 1, arg8, arg7, arg9);
	}
	...
	public Class23 method7971(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
		...
		@Pc(11) int local11 = arg1 * this.anInt4219 + arg0;
		@Pc(16) int local16 = this.anInt4219 - arg2;
	...
	public void T(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (this.anInt4203 < arg0) {
			this.anInt4203 = arg0;
		}
		if (this.anInt4197 < arg1) {
			this.anInt4197 = arg1;
		}
		if (this.anInt4212 > arg2) {
			this.anInt4212 = arg2;
		}
		if (this.anInt4207 > arg3) {
			this.anInt4207 = arg3;
		}
		this.method3799();
	}
	...
	public Class23 method7955(@OriginalArg(0) Class409 arg0, @OriginalArg(1) boolean arg1) {
		...
		@Pc(8) int local8 = arg0.anInt10876;
		@Pc(11) int local11 = arg0.anInt10879;
		...
		local80.method8191(arg0.anInt10881, arg0.anInt10877, arg0.anInt10880, arg0.anInt10878);
		return local80;
	}
	...
	public int JA(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		if (local26 < (float) this.anInt4226 && local57 < (float) this.anInt4226) {
			local1 |= 0x10;
		} else if (local26 > (float) this.anInt4211 && local57 > (float) this.anInt4211) {
			local1 |= 0x20;
		}
		@Pc(132) int local132 = (int) ((float) this.anInt4217 * (this.aClass73_Sub2_1.aFloat59 * (float) arg0 + this.aClass73_Sub2_1.aFloat55 * (float) arg1 + this.aClass73_Sub2_1.aFloat53 * (float) arg2 + this.aClass73_Sub2_1.aFloat60) / local26);
		@Pc(164) int local164 = (int) ((float) this.anInt4217 * (this.aClass73_Sub2_1.aFloat59 * (float) arg3 + this.aClass73_Sub2_1.aFloat55 * (float) arg4 + this.aClass73_Sub2_1.aFloat53 * (float) arg5 + this.aClass73_Sub2_1.aFloat60) / local57);
		if (local132 < this.anInt4222 && local164 < this.anInt4222) {
			local1 |= 0x1;
		} else if (local132 > this.anInt4204 && local164 > this.anInt4204) {
			local1 |= 0x2;
		}
		@Pc(225) int local225 = (int) ((float) this.anInt4199 * (this.aClass73_Sub2_1.aFloat57 * (float) arg0 + this.aClass73_Sub2_1.aFloat52 * (float) arg1 + this.aClass73_Sub2_1.aFloat51 * (float) arg2 + this.aClass73_Sub2_1.aFloat58) / local26);
		@Pc(257) int local257 = (int) ((float) this.anInt4199 * (this.aClass73_Sub2_1.aFloat57 * (float) arg3 + this.aClass73_Sub2_1.aFloat52 * (float) arg4 + this.aClass73_Sub2_1.aFloat51 * (float) arg5 + this.aClass73_Sub2_1.aFloat58) / local57);
		if (local225 < this.anInt4220 && local257 < this.anInt4220) {
			local1 |= 0x4;
		} else if (local225 > this.anInt4213 && local257 > this.anInt4213) {
			local1 |= 0x8;
		}
		return local1;
	}
	...
	public void method7958(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		if (arg3 == 0) {
			...
			if (arg2 > arg3) {
				...
				arg2 += arg0;
				if (arg0 < this.anInt4203) {
					arg1 += local110 * (this.anInt4203 - arg0);
					arg0 = this.anInt4203;
				}
				if (arg2 >= this.anInt4212) {
					arg2 = this.anInt4212 - 1;
				...
				if (arg5 == 0 || arg5 == 1 && local143 == 255) {
					while (arg0 <= arg2) {
						local161 = arg1 >> 16;
						if (local161 >= this.anInt4197 && local161 < this.anInt4207) {
							this.anIntArray319[arg0 + local161 * this.anInt4219] = arg4;
						}
						arg1 += local110;
						arg0++;
					}
					...
					while (arg0 <= arg2) {
						local229 = arg1 >> 16;
						if (local229 >= this.anInt4197 && local229 < this.anInt4207) {
							local246 = arg0 + local229 * this.anInt4219;
					...
					while (arg0 <= arg2) {
						local161 = arg1 >> 16;
						if (local161 >= this.anInt4197 && local161 < this.anInt4207) {
							local229 = arg0 + local161 * this.anInt4219;
				...
				arg3 += arg1;
				if (arg1 < this.anInt4197) {
					arg0 += local110 * (this.anInt4197 - arg1);
					arg1 = this.anInt4197;
				}
				if (arg3 >= this.anInt4207) {
					arg3 = this.anInt4207 - 1;
				}
				local143 = arg4 >>> 24;
				if (arg5 == 0 || arg5 == 1 && local143 == 255) {
					while (arg1 <= arg3) {
						local161 = arg0 >> 16;
						if (local161 >= this.anInt4203 && local161 < this.anInt4212) {
							this.anIntArray319[local161 + arg1 * this.anInt4219] = arg4;
						}
						arg0 += local110;
						arg1++;
					}
					...
					while (arg1 <= arg3) {
						local229 = arg0 >> 16;
						if (local229 >= this.anInt4203 && local229 < this.anInt4212) {
							local246 = local229 + arg1 * this.anInt4219;
							local251 = this.anIntArray319[local246];
							local251 = ((local251 & 0xFF00FF) * local161 >> 8 & 0xFF00FF) + ((local251 & 0xFF00) * local161 >> 8 & 0xFF00);
							this.anIntArray319[local229 + arg1 * this.anInt4219] = local220 + local251;
						}
						arg0 += local110;
						arg1++;
					}
					...
					while (arg1 <= arg3) {
						local161 = arg0 >> 16;
						if (local161 >= this.anInt4203 && local161 < this.anInt4212) {
							local229 = local161 + arg1 * this.anInt4219;
							local246 = this.anIntArray319[local229];
							local251 = arg4 + local246;
							local331 = (arg4 & 0xFF00FF) + (local246 & 0xFF00FF);
	...
	public int r(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		@Pc(51) int local51 = 0;
		if (local24 < (float) this.anInt4226 && local49 < (float) this.anInt4226) {
			local51 |= 0x10;
		} else if (local24 > (float) this.anInt4211 && local49 > (float) this.anInt4211) {
			local51 |= 0x20;
		}
		@Pc(121) int local121 = (int) ((float) this.anInt4217 * (this.aClass73_Sub2_1.aFloat59 * (float) arg0 + this.aClass73_Sub2_1.aFloat55 * (float) arg1 + this.aClass73_Sub2_1.aFloat53 * (float) arg2 + this.aClass73_Sub2_1.aFloat60) / (float) arg6);
		@Pc(154) int local154 = (int) ((float) this.anInt4217 * (this.aClass73_Sub2_1.aFloat59 * (float) arg3 + this.aClass73_Sub2_1.aFloat55 * (float) arg4 + this.aClass73_Sub2_1.aFloat53 * (float) arg5 + this.aClass73_Sub2_1.aFloat60) / (float) arg6);
		if (local121 < this.anInt4222 && local154 < this.anInt4222) {
			local51 |= 0x1;
		} else if (local121 > this.anInt4204 && local154 > this.anInt4204) {
			local51 |= 0x2;
		}
		@Pc(216) int local216 = (int) ((float) this.anInt4199 * (this.aClass73_Sub2_1.aFloat57 * (float) arg0 + this.aClass73_Sub2_1.aFloat52 * (float) arg1 + this.aClass73_Sub2_1.aFloat51 * (float) arg2 + this.aClass73_Sub2_1.aFloat58) / (float) arg6);
		@Pc(249) int local249 = (int) ((float) this.anInt4199 * (this.aClass73_Sub2_1.aFloat57 * (float) arg3 + this.aClass73_Sub2_1.aFloat52 * (float) arg4 + this.aClass73_Sub2_1.aFloat51 * (float) arg5 + this.aClass73_Sub2_1.aFloat58) / (float) arg6);
		if (local216 < this.anInt4220 && local249 < this.anInt4220) {
			local51 |= 0x4;
		} else if (local216 > this.anInt4213 && local249 > this.anInt4213) {
			local51 |= 0x8;
		}
		return local51;
	}
	...
	public void pa() {
		for (@Pc(1) int local1 = 0; local1 < this.aClass401Array1.length; local1++) {
			this.aClass401Array1[local1].anInt10625 = this.aClass401Array1[local1].anInt10628;
			this.aClass401Array1[local1].aBoolean806 = false;
		}
	}

	@OriginalMember(owner = "client!iaa", name = "m", descriptor = "(I)I")
	public int method3793(@OriginalArg(0) int arg0) {
		return super.anInterface4_10.method6824(arg0).aShort37 & 0xFFFF;
	}
	...
	private void method3794(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		...
		if (local22 == 255 && true) {
			local44 = 0;
			while (local44 < arg2) {
				if (arg0 + local44 >= this.anInt4203 && arg0 + local44 < this.anInt4212 && local30 < arg4) {
		...
		while (local117 < arg2) {
			if (arg0 + local117 >= this.anInt4203 && arg0 + local117 < this.anInt4212 && local30 < arg4) {
	...
	public void b(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) double arg4) {
		@Pc(4) int local4 = this.anInt4201 - arg2;
		@Pc(11) int local11 = arg1 * this.anInt4201 + arg0;
	...
	public void Q(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) byte[] arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		@Pc(33) int local33 = arg0 + arg1 * this.anInt4219;
		@Pc(38) int local38 = this.anInt4219 - arg2;
		if (arg1 + arg3 > this.anInt4207) {
			arg3 -= arg1 + arg3 - this.anInt4207;
		}
		@Pc(62) int local62;
		if (arg1 < this.anInt4197) {
			local62 = this.anInt4197 - arg1;
			arg3 -= local62;
			local33 += local62 * this.anInt4219;
			local11 += local26 * local62;
		}
		if (arg0 + arg2 > this.anInt4212) {
			local62 = arg0 + arg2 - this.anInt4212;
			arg2 -= local62;
			local38 += local62;
		}
		if (arg0 < this.anInt4203) {
			local62 = this.anInt4203 - arg0;
			arg2 -= local62;
			local33 += local62;
	...
	public void method7949(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) Class1 arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9, @OriginalArg(11) int arg10) {
		...
		if (arg2 <= arg3) {
			...
			if (local161 == 255 && true) {
				while (arg1 <= local130) {
					local179 = arg0 >> 16;
					local183 = arg1 - arg7;
					if (arg1 >= local18 && arg1 < local34 && local179 >= this.anInt4203 && local179 < this.anInt4212 && arg10 < local42 && local179 >= arg6 + local5[local183] && local179 < arg6 + local5[local183] + local8[local183]) {
						this.anIntArray319[local179 + arg1 * this.anInt4219] = arg4;
					}
					arg0 += local79;
					arg1++;
				...
				while (arg1 <= local130) {
					local183 = arg0 >> 16;
					local214 = arg1 - arg7;
					if (arg1 >= local18 && arg1 < local34 && local183 >= this.anInt4203 && local183 < this.anInt4212 && arg10 < local42 && local183 >= arg6 + local5[local214] && local183 < arg6 + local5[local214] + local8[local214]) {
						local327 = local183 + arg1 * this.anInt4219;
						...
						this.anIntArray319[local183 + arg1 * this.anInt4219] = local283 + local782;
					}
					arg0 += local79;
					arg1++;
					local38 = arg10 + local83;
		...
		if (local83 == 255 && true) {
			while (arg0 <= local144) {
				...
				if (arg0 >= this.anInt4203 && arg0 < this.anInt4212 && local179 >= local18 && local179 < local34 && arg10 < local42) {
					local214 = arg6 + local5[local183];
					if (arg0 >= local214 && arg0 < local214 + local8[local183]) {
						this.anIntArray319[arg0 + local179 * this.anInt4219] = arg4;
					}
				}
				arg1 += local79;
				arg0++;
		...
		while (arg0 <= local144) {
			...
			if (arg0 >= this.anInt4203 && arg0 < this.anInt4212 && local183 >= local18 && local183 < local34 && arg10 < local42) {
				local327 = arg6 + local5[local214];
				if (arg0 >= local327 && arg0 < local327 + local8[local214]) {
					local346 = arg0 + local183 * this.anInt4219;
	...
	public int method3795(@OriginalArg(0) int arg0) {
		return super.anInterface4_10.method6824(arg0).anInt2805;
	}
	...
	public void L(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		for (@Pc(1) int local1 = 0; local1 < this.aClass401Array1.length; local1++) {
			@Pc(7) Class401 local7 = this.aClass401Array1[local1];
			local7.anInt10625 = arg0 & 0xFFFFFF;
			@Pc(19) int local19 = local7.anInt10625 >>> 16 & 0xFF;
			if (local19 < 2) {
				local19 = 2;
			}
			@Pc(31) int local31 = local7.anInt10625 >> 8 & 0xFF;
			if (local31 < 2) {
				local31 = 2;
			}
			@Pc(41) int local41 = local7.anInt10625 & 0xFF;
			if (local41 < 2) {
				local41 = 2;
			}
			local7.anInt10625 = local19 << 16 | local31 << 8 | local41;
			if (arg1 < 0) {
				local7.aBoolean807 = false;
			} else {
				local7.aBoolean807 = true;
			}
		}
	}
	...
	public boolean method3796(@OriginalArg(0) int arg0) {
		return super.anInterface4_10.method6824(arg0).aBoolean236 || super.anInterface4_10.method6824(arg0).aBoolean235;
	}

	@OriginalMember(owner = "client!iaa", name = "I", descriptor = "()I")
	@Override
	public int I() {
		@Pc(2) int local2 = this.anInt4224;
		this.anInt4224 = 0;
		return local2;
	}
	...
	public void method3797(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
		...
		((Class23_Sub1) this.aClass23_17).method8214(arg0 - arg3, arg1 - arg4, arg2, arg3 << 1, arg4 << 1, arg8, arg7, arg9);
	}
	...
	public void la() {
		this.anInt4203 = 0;
		this.anInt4197 = 0;
		this.anInt4212 = this.anInt4219;
		this.anInt4207 = this.anInt4221;
		this.method3799();
	}

	@OriginalMember(owner = "client!iaa", name = "q", descriptor = "(I)Z")
	public boolean method3798(@OriginalArg(0) int arg0) {
		return this.aBoolean332 || super.anInterface4_10.method6824(arg0).aBoolean233;
	}
	...
	private void method3799() {
		this.anInt4222 = this.anInt4203 - this.anInt4218;
		this.anInt4204 = this.anInt4212 - this.anInt4218;
		this.anInt4220 = this.anInt4197 - this.anInt4205;
		this.anInt4213 = this.anInt4207 - this.anInt4205;
		for (@Pc(29) int local29 = 0; local29 < this.anInt4223; local29++) {
			@Pc(36) Class221 local36 = this.aClass401Array1[local29].aClass221_2;
			local36.anInt5743 = this.anInt4218 - this.anInt4203;
			local36.anInt5741 = this.anInt4205 - this.anInt4197;
			local36.anInt5745 = this.anInt4212 - this.anInt4203;
			local36.anInt5746 = this.anInt4207 - this.anInt4197;
		}
		@Pc(78) int local78 = this.anInt4197 * this.anInt4219 + this.anInt4203;
		for (@Pc(81) int local81 = this.anInt4197; local81 < this.anInt4207; local81++) {
			for (@Pc(84) int local84 = 0; local84 < this.anInt4223; local84++) {
				this.aClass401Array1[local84].aClass221_2.anIntArray439[local81 - this.anInt4197] = local78;
			}
			local78 += this.anInt4219;
		}
	}
	...
	public int[] na(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		for (@Pc(8) int local8 = 0; local8 < arg3; local8++) {
			@Pc(18) int local18 = (arg1 + local8) * this.anInt4219 + arg0;
	...
	public void method8028(@OriginalArg(0) Class232 arg0) {
		...
		for (@Pc(10) Class8_Sub4 local10 = local7.aClass8_Sub4_10; local10 != local7; local10 = local10.aClass8_Sub4_10) {
			...
			@Pc(54) float local54 = this.aClass73_Sub2_1.aFloat62 + this.aClass73_Sub2_1.aFloat56 * (float) local19 + this.aClass73_Sub2_1.aFloat54 * (float) local24 + this.aClass73_Sub2_1.aFloat61 * (float) local29;
			if (!(local54 < (float) this.anInt4226) && !(local54 > (float) local3.anInt10629)) {
				@Pc(105) int local105 = this.anInt4218 + (int) ((float) this.anInt4217 * (this.aClass73_Sub2_1.aFloat60 + this.aClass73_Sub2_1.aFloat59 * (float) local19 + this.aClass73_Sub2_1.aFloat55 * (float) local24 + this.aClass73_Sub2_1.aFloat53 * (float) local29) / local54);
				@Pc(140) int local140 = this.anInt4205 + (int) ((float) this.anInt4199 * (this.aClass73_Sub2_1.aFloat58 + this.aClass73_Sub2_1.aFloat57 * (float) local19 + this.aClass73_Sub2_1.aFloat52 * (float) local24 + this.aClass73_Sub2_1.aFloat51 * (float) local29) / local54);
				if (local105 >= this.anInt4203 && local105 <= this.anInt4212 && local140 >= this.anInt4197 && local140 <= this.anInt4207) {
					if (local54 == 0.0F) {
						local54 = 1.0F;
					}
					this.method3784(local14, local105, local140, (int) local54, (int) ((float) (local14.anInt7558 * this.anInt4217 >> 12) / local54));
				}
			}
		}
	}
	...
	public void EA(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(3) Class401 local3 = this.method3787(Thread.currentThread());
		local3.anInt10632 = arg0;
		local3.anInt10625 = arg1;
		local3.anInt10630 = arg2;
	}
