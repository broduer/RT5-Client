...
public final class Class19_Sub2 extends Class19 {
	...
	private Class19_Sub2(@OriginalArg(0) Interface4 arg0) {
		...
		try {
			...
			this.j(1);
			this.k(0);
			Static198.method2059(true, true);
			this.aBoolean330 = true;
			this.anInt4184 = (int) Static588.method5469();
	...
	protected void u() {
		if (this.aBoolean330) {
			Static300.method3050(true, false);
			this.aBoolean330 = false;
		}
	...
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class1 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		@Pc(2) Class1_Sub1 local2 = (Class1_Sub1) arg6;
		@Pc(5) int[] local5 = local2.anIntArray334;
		@Pc(8) int[] local8 = local2.anIntArray335;
		@Pc(18) int local18 = this.anInt4186 > arg8 ? this.anInt4186 : arg8;
		@Pc(34) int local34 = this.anInt4196 < arg8 + local5.length ? this.anInt4196 : arg8 + local5.length;
		arg2 -= arg0;
		arg3 -= arg1;
		if (arg2 + arg3 < 0) {
			arg0 += arg2;
		...
		if (arg2 <= arg3) {
			...
			local118 = arg4 >>> 24;
			if (arg5 == 1 && local118 == 255) {
				while (arg1 <= arg3) {
					local136 = arg0 >> 16;
					local140 = arg1 - arg8;
					local154 = arg7 + local5[local140];
	...
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(3) Class399 local3 = this.method2666(Thread.currentThread());
		...
		@Pc(108) int local108 = arg0 - local6.method3627();
		@Pc(113) int local113 = arg1 - local6.method3607();
		...
		local6.method3625((float) local137, (float) local141, (float) local147, (float) local117, (float) local121, (float) local127, 100.0F, 100.0F, 100.0F, arg4);
		...
		local6.method3625((float) local137, (float) local147, (float) local153, (float) local117, (float) local127, (float) local133, 100.0F, 100.0F, 100.0F, arg4);
		this.C(true);
	}
	...
	public void a(@OriginalArg(0) Canvas arg0) {
		...
		@Pc(10) Class2_Sub10 local10 = (Class2_Sub10) this.aClass28_20.method373((long) arg0.hashCode());
		if (local10 == null) {
			return;
		}
		this.aCanvas3 = arg0;
	...
	private void method2662(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		@Pc(30) int local30 = arg7 % local26;
		@Pc(44) int local44;
		if (local22 == 255 && true) {
			local44 = 0;
			while (local44 < arg2) {
				if (arg1 + local44 >= this.anInt4186 && arg1 + local44 < this.anInt4196 && local30 < arg5) {
		...
		while (local120 < arg2) {
			if (arg1 + local120 >= this.anInt4186 && arg1 + local120 < this.anInt4196 && local30 < arg5) {
		...
		for (@Pc(10) Class8_Sub4 local10 = local7.aClass8_Sub4_10; local10 != local7; local10 = local10.aClass8_Sub4_10) {
			...
			if (!(local54 < (float) this.anInt4214) && !(local54 > (float) local3.anInt10601)) {
				...
				if (local106 >= this.anInt4192 && local106 <= this.anInt4200 && local142 >= this.anInt4186 && local142 <= this.anInt4196) {
					...
					this.method2663(local14, local106, local142, (int) local54, (local14.anInt7535 * this.anInt4205 >> 12) / arg1);
				}
			}
		}
	}
	...
	private void method2663(@OriginalArg(0) Class8_Sub4_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(2) int local2 = arg0.anInt7540;
		@Pc(8) int local8 = arg4 << 1;
		if (local2 == -1) {
			this.method2669(arg1, arg2, arg3, arg4, arg0.anInt7539, 1);
			return;
		}
		if (this.anInt4215 != local2) {
			@Pc(34) Class23 local34 = (Class23) this.aClass82_88.method1390((long) local2);
			if (local34 == null) {
				@Pc(40) int[] local40 = this.method2667(local2);
				if (local40 == null) {
					return;
				}
				@Pc(54) int local54 = this.method2677(local2) ? 64 : this.lb;
				local34 = this.a(local54, local54, local54, local40, 0, 7468);
				this.aClass82_88.method1384(local34, (long) local2);
			}
			this.anInt4215 = local2;
			this.aClass23_17 = local34;
		}
		local8++;
		((Class23_Sub1) this.aClass23_17).method5792(arg1 - arg4, arg2 - arg4, arg3, local8, local8, 0, arg0.anInt7539, 1);
	}
	...
	public void F(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (local6 < 0) {
			...
			Static734.method5449(local24, -local6, local24, 0, local34);
		} else if (local6 > 0) {
			local34 = local24.length - local6;
			Static734.method5449(local24, 0, local24, local6, local34);
		}
		if (local13 < 0) {
			local34 = local27.length + local13;
			Static734.method5443(local27, -local13, local27, 0, local34);
		} else if (local13 > 0) {
			local34 = local27.length - local13;
			Static734.method5443(local27, 0, local27, local13, local34);
		}
	}
	...
	public void a(@OriginalArg(0) Canvas arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(8) Class2_Sub10 local8 = (Class2_Sub10) this.aClass28_20.method373((long) arg0.hashCode());
		if (local8 == null) {
			return;
		}
		local8.a((byte) 56);
		local8 = Static538.method5033(arg2, arg0, arg1);
		this.aClass28_20.method370((long) arg0.hashCode(), local8);
	...
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12) {
		...
		@Pc(14) int local14 = arg0 - this.anInt4210;
		@Pc(19) int local19 = arg3 - this.anInt4210;
		@Pc(24) int local24 = arg6 - this.anInt4210;
		@Pc(29) int local29 = arg1 - this.anInt4208;
		@Pc(34) int local34 = arg4 - this.anInt4208;
		@Pc(39) int local39 = arg7 - this.anInt4208;
		...
		@Pc(77) int local77 = arg9 >>> 24;
		if (arg12 == 1 && local77 == 255) {
			local6.anInt5724 = 0;
			local6.aBoolean433 = false;
			local6.method3608((float) local29, (float) local34, (float) local39, (float) local14, (float) local19, (float) local24, (float) arg2, (float) arg5, (float) arg8, arg9, arg10, arg11);
		} else {
			local6.anInt5724 = 255 - local77;
			local6.aBoolean433 = false;
			local6.method3608((float) local29, (float) local34, (float) local39, (float) local14, (float) local19, (float) local24, (float) arg2, (float) arg5, (float) arg8, arg9, arg10, arg11);
		}
	...
	public boolean method2665(@OriginalArg(0) int arg0) {
		return super.anInterface4_10.method4802(arg0);
	}

	@OriginalMember(owner = "client!iaa", name = "a", descriptor = "(Ljava/lang/Runnable;)Lclient!wf;")
	public Class399 method2666(@OriginalArg(0) Runnable arg0) {
	...
	public void q() {
		this.aClass82_89.method1391();
		this.aClass82_88.method1391();
	}

	@OriginalMember(owner = "client!iaa", name = "o", descriptor = "(I)[I")
	public int[] method2667(@OriginalArg(0) int arg0) {
		@Pc(2) Class82 local2 = this.aClass82_89;
		@Pc(14) Class2_Sub29 local14;
		synchronized (this.aClass82_89) {
			local14 = (Class2_Sub29) this.aClass82_89.method1390((long) arg0 | Long.MIN_VALUE);
			if (local14 == null) {
				if (!super.anInterface4_10.method4802(arg0)) {
					return null;
				}
				@Pc(36) Class118 local36 = super.anInterface4_10.method4805(arg0);
				@Pc(50) int local50 = local36.aBoolean233 || this.aBoolean332 ? 64 : this.lb;
				local14 = new Class2_Sub29(arg0, local50, super.anInterface4_10.method4803(0.7F, arg0, local50, local50), local36.anInt2796 != 1);
				this.aClass82_89.method1384(local14, (long) arg0 | Long.MIN_VALUE);
			}
		}
		local14.aBoolean341 = true;
		return local14.method2774();
	}
	...
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		if (arg3 == 0) {
			if (arg2 >= 0) {
				this.method2673(arg0, arg1, arg2 + 1, arg4, arg5, arg6, arg7, arg8);
			} else {
				local31 = arg6 + arg7;
				local35 = arg8 % local31;
				local35 = local31 + arg6 - local35 - (-arg2 + 1) % local31;
				arg8 = local35 % local31;
				if (arg8 < 0) {
					arg8 += local31;
				}
				this.method2673(arg0 + arg2, arg1, 1 - arg2, arg4, arg5, arg6, arg7, arg8);
			}
		} else if (arg2 != 0) {
			local35 = arg8 << 8;
			...
			if (arg2 + arg3 < 0) {
				...
				local35 = local31 + local149 - arg8 - local182;
				arg8 = local35 % local31;
				if (arg8 < 0) {
					arg8 += local31;
				}
			...
			if (arg2 > arg3) {
				...
				if (arg5 == 1 && local182 == 255) {
					while (arg0 <= local243) {
						local278 = arg1 >> 16;
						if (arg0 >= this.anInt4192 && arg0 < this.anInt4200 && local278 >= this.anInt4186 && local278 < this.anInt4196 && arg8 < local149) {
							this.anIntArray319[arg0 + local278 * this.anInt4207] = arg4;
						}
						arg1 += local178;
						arg0++;
						local35 = arg8 + local260;
						arg8 = local35 % local31;
					}
				} else {
					...
					while (arg0 <= local243) {
						local371 = arg1 >> 16;
						if (arg0 >= this.anInt4192 && arg0 < this.anInt4200 && local371 >= this.anInt4186 && local371 < this.anInt4196 && arg8 < local149) {
				...
				if (arg5 == 1 && local182 == 255) {
					while (arg1 <= local229) {
						local278 = arg0 >> 16;
						if (arg1 >= this.anInt4186 && arg1 < this.anInt4196 && local278 >= this.anInt4192 && local278 < this.anInt4200 && arg8 < local149) {
					...
					while (arg1 <= local229) {
						local371 = arg0 >> 16;
						if (arg1 >= this.anInt4186 && arg1 < this.anInt4196 && local371 >= this.anInt4192 && local371 < this.anInt4200 && arg8 < local149) {
			...
			this.method2662(arg0, arg1, arg3 + 1, arg4, arg5, arg6, arg7, arg8);
		} else {
			local31 = arg6 + arg7;
			local35 = arg8 % local31;
			local35 = local31 + arg6 - local35 - (-arg3 + 1) % local31;
			arg8 = local35 % local31;
			if (arg8 < 0) {
				arg8 += local31;
			}
			this.method2662(arg0, arg1 + arg3, -arg3 + 1, arg4, arg5, arg6, arg7, arg8);
		}
	}
		...
		try {
			...
			for (@Pc(21) int local21 = 0; local21 < arg1; local21++) {
				...
				if (local26.x + arg2 <= this.anInt4207 && local26.y + arg3 <= this.anInt4209 && local26.x + arg2 + local26.width > 0 && local26.y + arg3 + local26.height > 0) {
					this.aClass2_Sub10_1.method4423(local26.width, local26.x + arg2, local26.x, local19, local26.height, local26.y, local26.y + arg3);
				}
			}
	...
	private void method2668() {
		for (@Pc(1) int local1 = 0; local1 < this.anInt4211; local1++) {
			this.aClass399Array1[local1].method6623();
		}
		this.la();
	}
	...
	@Override
	public void k(@OriginalArg(0) int arg0) {
		this.aClass399Array1[arg0].method6625(Thread.currentThread());
	}
	...
	private void method2669(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		if (arg3 < 0) {
			arg3 = -arg3;
		}
	...
	public void c(@OriginalArg(0) int arg0) {
		this.aClass399Array1[arg0].method6625((Runnable) null);
	}
	...
	public void b(@OriginalArg(0) int arg0) {
		Static567.anInt8484 = arg0;
		Static567.anInt8486 = arg0;
		if (this.anInt4211 > 1) {
			throw new IllegalStateException("No MT");
		}
		this.j(this.anInt4211);
		this.k(0);
	}
		...
		for (@Pc(5) int local5 = 0; local5 < arg4; local5++) {
			for (@Pc(8) int local8 = 0; local8 < arg3; local8++) {
				...
				if (local16 != 0 && local16 != 255) {
					local1 = true;
					return local1 ? new Class23_Sub1_Sub2(this, arg0, arg1, arg2, arg3, arg4, arg5) : new Class23_Sub1_Sub1(this, arg0, arg1, arg2, arg3, arg4, arg5);
				}
			}
		}
		return local1 ? new Class23_Sub1_Sub2(this, arg0, arg1, arg2, arg3, arg4, arg5) : new Class23_Sub1_Sub1(this, arg0, arg1, arg2, arg3, arg4, arg5);
	...
	public void e(@OriginalArg(0) int arg0) {
		...
		for (@Pc(9) Object local9 = this.aClass82_89.method1379(); local9 != null; local9 = this.aClass82_89.method1386()) {
			...
			if (local13.aBoolean341) {
				...
				if (local27 > 0) {
					@Pc(36) Class118 local36 = super.anInterface4_10.method4805(local13.anInt4408);
					local13.method2775(local36.aByte54 * local4 * 50 / 1000, local36.aByte52 * local4 * 50 / 1000);
		...
		this.anInt4184 = arg0;
		this.aClass82_88.method1381(5);
		this.aClass82_89.method1381(5);
	}
	...
	public void method2670(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
		if (arg3 == 0 || arg4 == 0) {
			return;
		}
		if (arg6 == 65535 || super.anInterface4_10.method4805(arg6).aBoolean240) {
			this.method2669(arg0, arg1, arg2, arg3, arg7, arg9);
			return;
		}
		if (this.anInt4215 != arg6) {
			@Pc(33) Class23 local33 = (Class23) this.aClass82_88.method1390((long) arg6);
			if (local33 == null) {
				@Pc(39) int[] local39 = this.method2667(arg6);
				if (local39 == null) {
					return;
				}
				@Pc(53) int local53 = this.method2677(arg6) ? 64 : this.lb;
				local33 = this.a(local53, local53, local53, local39, 0, 7468);
				this.aClass82_88.method1384(local33, (long) arg6);
			}
			this.anInt4215 = arg6;
			this.aClass23_17 = local33;
		}
		((Class23_Sub1) this.aClass23_17).method5792(arg0 - arg3, arg1 - arg4, arg2, arg3 << 1, arg4 << 1, arg8, arg7, arg9);
	}
	...
	public Class23 a(@OriginalArg(0) Class407 arg0, @OriginalArg(1) boolean arg1) {
		...
		local80.c(arg0.anInt10852, arg0.anInt10848, arg0.anInt10851, arg0.anInt10849);
		return local80;
	}
	...
	public Class178 a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[][] arg2, @OriginalArg(3) int[][] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		return new Class178_Sub3(this, arg5, arg6, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public int[] method2671(@OriginalArg(0) int arg0) {
		@Pc(2) Class82 local2 = this.aClass82_89;
		@Pc(12) Class2_Sub29 local12;
		synchronized (this.aClass82_89) {
			local12 = (Class2_Sub29) this.aClass82_89.method1390((long) arg0);
			if (local12 == null) {
				if (!super.anInterface4_10.method4802(arg0)) {
					return null;
				}
				@Pc(34) Class118 local34 = super.anInterface4_10.method4805(arg0);
				@Pc(48) int local48 = local34.aBoolean233 || this.aBoolean332 ? 64 : this.lb;
				local12 = new Class2_Sub29(arg0, local48, super.anInterface4_10.method4806(local48, true, local48, arg0, 0.7F), local34.anInt2796 != 1);
				this.aClass82_89.method1384(local12, (long) arg0);
			}
		}
	...
	public int method2672(@OriginalArg(0) int arg0) {
		return super.anInterface4_10.method4805(arg0).aShort37 & 0xFFFF;
	}
	...
	private void method2673(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (arg1 < this.anInt4186 || arg1 >= this.anInt4196) {
			return;
		}
		@Pc(18) int local18 = arg0 + arg1 * this.anInt4207;
		...
		if (local22 == 255 && true) {
			local44 = 0;
			while (local44 < arg2) {
				if (arg0 + local44 >= this.anInt4192 && arg0 + local44 < this.anInt4200 && local30 < arg5) {
		...
		while (local117 < arg2) {
			if (arg0 + local117 >= this.anInt4192 && arg0 + local117 < this.anInt4200 && local30 < arg5) {
	...
	public void e(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) throws Exception_Sub1 {
		...
		try {
			@Pc(19) Graphics local19 = this.aCanvas3.getGraphics();
			this.aClass2_Sub10_1.method4423(this.anInt4183, arg0, 0, local19, this.anInt4185, 0, arg1);
	...
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class1 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11) {
		...
		@Pc(18) int local18 = this.anInt4186 > arg8 ? this.anInt4186 : arg8;
		@Pc(34) int local34 = this.anInt4196 < arg8 + local5.length ? this.anInt4196 : arg8 + local5.length;
		@Pc(38) int local38 = arg11 << 8;
		@Pc(42) int local42 = arg9 << 8;
		@Pc(46) int local46 = arg10 << 8;
		@Pc(50) int local50 = local42 + local46;
		arg11 = local38 % local50;
		arg2 -= arg0;
		arg3 -= arg1;
		@Pc(79) int local79;
		@Pc(83) int local83;
		if (arg2 + arg3 < 0) {
			...
			local38 = local50 + local42 - arg11 - local83;
			arg11 = local38 % local50;
			if (arg11 < 0) {
				arg11 += local50;
			}
		...
		if (arg2 <= arg3) {
			...
			local130 = arg3 + arg1;
			local161 = arg4 >>> 24;
			if (arg5 == 1 && local161 == 255) {
				while (arg1 <= local130) {
					local179 = arg0 >> 16;
					local183 = arg1 - arg8;
					if (arg1 >= local18 && arg1 < local34 && local179 >= this.anInt4192 && local179 < this.anInt4200 && arg11 < local42 && local179 >= arg7 + local5[local183] && local179 < arg7 + local5[local183] + local8[local183]) {
						this.anIntArray319[local179 + arg1 * this.anInt4207] = arg4;
					}
					arg0 += local79;
					arg1++;
					local38 = arg11 + local83;
					arg11 = local38 % local50;
				}
			} else {
				...
				while (arg1 <= local130) {
					local183 = arg0 >> 16;
					local214 = arg1 - arg8;
					if (arg1 >= local18 && arg1 < local34 && local183 >= this.anInt4192 && local183 < this.anInt4200 && arg11 < local42 && local183 >= arg7 + local5[local214] && local183 < arg7 + local5[local214] + local8[local214]) {
		...
		if (arg5 == 1 && local83 == 255) {
			while (arg0 <= local144) {
				local179 = arg1 >> 16;
				local183 = local179 - arg8;
				if (arg0 >= this.anInt4192 && arg0 < this.anInt4200 && local179 >= local18 && local179 < local34 && arg11 < local42) {
					local214 = arg7 + local5[local183];
		...
		while (arg0 <= local144) {
			local183 = arg1 >> 16;
			local214 = local183 - arg8;
			if (arg0 >= this.anInt4192 && arg0 < this.anInt4200 && local183 >= local18 && local183 < local34 && arg11 < local42) {
				local327 = arg7 + local5[local214];
	...
	public int method2674(@OriginalArg(0) int arg0) {
		return super.anInterface4_10.method4805(arg0).anInt2796;
	}
	...
	public boolean method2675(@OriginalArg(0) int arg0) {
		return super.anInterface4_10.method4805(arg0).aBoolean236 || super.anInterface4_10.method4805(arg0).aBoolean235;
	}
	...
	public void method2676(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
		if (arg3 == 0 || arg4 == 0) {
			return;
		}
		if (arg6 == 65535 || super.anInterface4_10.method4805(arg6).aBoolean240) {
		...
		((Class23_Sub1) this.aClass23_17).method5791(arg0 - arg3, arg1 - arg4, arg2, arg3 << 1, arg4 << 1, arg8, arg7, arg9);
	}
	...
	public boolean method2677(@OriginalArg(0) int arg0) {
		return this.aBoolean332 || super.anInterface4_10.method4805(arg0).aBoolean233;
	}
		...
		for (@Pc(10) Class8_Sub4 local10 = local7.aClass8_Sub4_10; local10 != local7; local10 = local10.aClass8_Sub4_10) {
			...
			if (!(local54 < (float) this.anInt4214) && !(local54 > (float) local3.anInt10601)) {
				...
				if (local105 >= this.anInt4192 && local105 <= this.anInt4200 && local140 >= this.anInt4186 && local140 <= this.anInt4196) {
					...
					this.method2663(local14, local105, local140, (int) local54, (int) ((float) (local14.anInt7535 * this.anInt4205 >> 12) / local54));
				}
			}
		}
	}
	...
	public void b(@OriginalArg(0) Canvas arg0) {
		...
		@Pc(17) Class2_Sub10 local17 = (Class2_Sub10) this.aClass28_20.method373((long) arg0.hashCode());
		if (local17 != null) {
			local17.a((byte) 83);
		}
	}
