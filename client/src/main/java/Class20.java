...
public final class Class20 {
	...
	public Class20(@OriginalArg(0) Class2_Sub21 arg0) {
		this.method295(arg0);
	}

	@OriginalMember(owner = "client!ama", name = "a", descriptor = "(Lclient!ge;B)V")
	private void method295(@OriginalArg(0) Class2_Sub21 arg0) {
		this.aLong15 = arg0.method5207();
		this.anInt519 = arg0.method5158();
		for (@Pc(28) int local28 = arg0.method5205(); local28 != 0; local28 = arg0.method5205()) {
			...
			local61.method6137(arg0);
			this.aClass339_4.method5465(local61);
		}
	}

	@OriginalMember(owner = "client!ama", name = "a", descriptor = "(ILclient!hi;)V")
	public void method297(@OriginalArg(1) Class164 arg0) {
		if (this.aLong15 != arg0.aLong125 || this.anInt519 != arg0.anInt3950) {
			throw new RuntimeException("ClanSettingsDelta.applyToClanSettings(): Credentials do not match! Settings.owner:" + Static287.method2862(arg0.aLong125) + " updateNum:" + arg0.anInt3950 + " delta.owner:" + Static287.method2862(this.aLong15) + " updateNum:" + this.anInt519);
		}
		for (@Pc(82) Class2_Sub14 local82 = (Class2_Sub14) this.aClass339_4.method5453(65280); local82 != null; local82 = (Class2_Sub14) this.aClass339_4.method5460()) {
			local82.method6139(arg0);
		}
		arg0.anInt3950++;
	}
}
