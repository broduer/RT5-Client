...
public final class Class201 {
	...
	public void method3175(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) Class52[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
	...
	public Class114 method3176(@OriginalArg(0) Class112 arg0, @OriginalArg(1) Class152 arg1, @OriginalArg(4) Class310 arg2, @OriginalArg(5) Class50 arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int[] arg5, @OriginalArg(8) Class388 arg6, @OriginalArg(9) Class215 arg7, @OriginalArg(10) Class19 arg8, @OriginalArg(11) Class308 arg9, @OriginalArg(12) Class152[] arg10, @OriginalArg(13) int arg11, @OriginalArg(14) Class152 arg12, @OriginalArg(15) Interface23 arg13) {
		...
		@Pc(116) int local116;
		if (arg1 != null) {
			@Pc(50) Class69 local50 = arg1.method6541();
		...
		for (local116 = 0; local116 < local72; local116++) {
			if (arg10[local116] != null) {
				local28 |= arg10[local116].method6535();
				local257 = true;
			}
		}
		if (arg1 != null) {
			local28 |= arg1.method6535();
			local257 = true;
		}
		if (arg12 != null) {
			local257 = true;
			local28 |= arg12.method6535();
		}
		...
		synchronized (Static580.aClass82_186) {
			local342 = (Class114) Static580.aClass82_186.method1390(local31);
		}
		@Pc(350) Class289 local350 = null;
		if (this.anInt5007 != -1) {
			local350 = arg2.method4993(this.anInt5007);
		}
		@Pc(390) int local390;
		@Pc(395) int local395;
		@Pc(586) int local586;
		@Pc(591) int local591;
		if (local342 == null || arg8.b(local342.ua(), local28) != 0) {
			if (local342 != null) {
				local28 = arg8.c(local28, local342.ua());
			}
			...
			while (true) {
				...
				if (local390 >= local34.length) {
					if (local388) {
						if (this.aLong159 != -1L) {
							...
							synchronized (Static580.aClass82_186) {
								local342 = (Class114) Static580.aClass82_186.method1390(this.aLong159);
							}
						}
						if (local342 == null || arg8.b(local342.ua(), local28) != 0) {
							return null;
						...
						for (local586 = 0; local586 < local34.length; local586++) {
							...
							if ((local591 & 0x40000000) != 0) {
								...
								local633 = arg0.method1684(local591 & 0x3FFFFFFF).method6286(local593, this.aBoolean385);
								if (local633 != null) {
									local584[local586] = local633;
								}
							} else if ((Integer.MIN_VALUE & local591) != 0) {
								local633 = arg7.method3524(local591 & 0x3FFFFFFF).method4647();
								if (local633 != null) {
									local584[local586] = local633;
								}
							}
							...
							for (local591 = 0; local591 < local350.anIntArrayArray181.length; local591++) {
								if (local584[local591] != null) {
									...
									if (local713 != 0 || local715 != 0 || local717 != 0) {
										local584[local591].method1456(local717, local713, local715);
									}
									if (local409 != 0 || local709 != 0 || local711 != 0) {
										local584[local591].method1453(local409, local709, local711);
									}
								}
							}
						}
						...
						local342 = arg8.a(local833, local826, Static294.anInt4766, 64, 850);
						...
						synchronized (Static580.aClass82_186) {
							Static580.aClass82_186.method1384(local342, local31);
						}
				...
				if ((local395 & 0x40000000) != 0) {
					...
					if (!arg0.method1684(local395 & 0x3FFFFFFF).method6289(this.aBoolean385, local397)) {
						local388 = true;
					}
				} else if ((Integer.MIN_VALUE & local395) != 0 && !arg7.method3524(local395 & 0x3FFFFFFF).method4645()) {
					local388 = true;
				}
				local390++;
			}
		}
		@Pc(925) Class114 local925 = local342.a((byte) 4, local28, true);
		if (!local257 && !local310) {
			return local925;
		}
		@Pc(936) Class73[] local936 = null;
		if (local350 != null) {
			local936 = local350.method4544(arg8);
		}
		if (local310 && local936 != null) {
			for (local390 = 0; local390 < arg5.length; local390++) {
				if (local936[local390] != null) {
					local925.a(local936[local390], 0x1 << local390, true);
				}
			}
		}
		local390 = 0;
		...
		while (local390 < local72) {
			if (arg10[local390] != null) {
				arg10[local390].method6544(local395, local925);
			}
			local390++;
			local395 <<= 0x1;
		}
		if (local310) {
			for (local586 = 0; local586 < arg5.length; local586++) {
				if (arg5[local586] != -1) {
					...
					local591 &= 0x3FFF;
					@Pc(1034) Class73 local1034 = arg8.y();
					local1034.g(local591);
					local925.a(local1034, 0x1 << local586, false);
				}
			}
		}
		if (local310 && local936 != null) {
			for (local586 = 0; local586 < arg5.length; local586++) {
				if (local936[local586] != null) {
					local925.a(local936[local586], 0x1 << local586, false);
				}
			}
		}
		if (arg1 != null && arg12 != null) {
			Static468.method5399(arg1, local925, arg12);
		} else if (arg1 != null) {
			arg1.method6523(local925, 0);
		} else if (arg12 != null) {
			arg12.method6523(local925, 0);
		}
		return local925;
	}

	@OriginalMember(owner = "client!ju", name = "a", descriptor = "(IZ)V")
	public void method3177(@OriginalArg(1) boolean arg0) {
		this.aBoolean385 = arg0;
		this.method3173();
	}

	@OriginalMember(owner = "client!ju", name = "a", descriptor = "(IBLclient!kr;I)V")
	public void method3178(@OriginalArg(0) int arg0, @OriginalArg(2) Class215 arg1, @OriginalArg(3) int arg2) {
		@Pc(7) int local7 = Static264.anIntArray891[arg2];
		if (arg1.method3524(arg0) != null) {
	...
	public Class114 method3180(@OriginalArg(0) Class152 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class50 arg3, @OriginalArg(4) Class19 arg4, @OriginalArg(6) Class215 arg5, @OriginalArg(7) int arg6) {
		@Pc(16) int local16 = arg0 == null ? 2048 : arg0.method6535() | 0x800;
		...
		synchronized (Static54.aClass82_25) {
			local39 = (Class114) Static54.aClass82_25.method1390(local29);
		}
		if (local39 == null || arg4.b(local39.ua(), local16) != 0) {
			if (local39 != null) {
				local16 = arg4.c(local16, local39.ua());
			}
			@Pc(70) Class88[] local70 = new Class88[3];
			@Pc(72) int local72 = 0;
			if (!arg5.method3524(arg1).method4644() || !arg5.method3524(arg6).method4644() || !arg5.method3524(arg2).method4644()) {
				return null;
			}
			@Pc(107) Class88 local107 = arg5.method3524(arg1).method4643();
			if (local107 != null) {
				local72++;
				local70[0] = local107;
			}
			local107 = arg5.method3524(arg6).method4643();
			if (local107 != null) {
				local70[local72++] = local107;
			}
			local107 = arg5.method3524(arg2).method4643();
			if (local107 != null) {
				local70[local72++] = local107;
			}
			@Pc(152) int local152 = local16 | 0x4000;
			local107 = new Class88(local70, local72);
			local39 = arg4.a(local107, local152, Static294.anInt4766, 64, 768);
			...
			synchronized (Static54.aClass82_25) {
				Static54.aClass82_25.method1384(local39, local29);
			}
		}
		if (arg0 == null) {
			return local39;
		} else {
			local39 = local39.a((byte) 4, local16, true);
			arg0.method6523(local39, 0);
			return local39;
		}
	}

	@OriginalMember(owner = "client!ju", name = "a", descriptor = "(BIILclient!es;)V")
	public void method3181(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) Class112 arg2) {
		if (arg0 == -1) {
			this.anIntArray381[arg1] = 0;
		} else if (arg2.method1684(arg0) != null) {
	...
	public Class114 method3182(@OriginalArg(0) Class215 arg0, @OriginalArg(2) Class50 arg1, @OriginalArg(3) Interface23 arg2, @OriginalArg(4) Class152 arg3, @OriginalArg(5) Class112 arg4, @OriginalArg(6) Class308 arg5, @OriginalArg(7) Class19 arg6) {
		if (this.anInt5012 != -1) {
			return arg5.method4967(this.anInt5012).method4228(arg3, (Class386) null, arg6, arg2);
		}
		@Pc(35) int local35 = arg3 == null ? 2048 : arg3.method6535() | 0x800;
		@Pc(37) Class82 local37 = Static54.aClass82_25;
		@Pc(48) Class114 local48;
		synchronized (Static54.aClass82_25) {
			local48 = (Class114) Static54.aClass82_25.method1390(this.aLong160);
		}
		if (local48 == null || arg6.b(local48.ua(), local35) != 0) {
			if (local48 != null) {
				local35 = arg6.c(local35, local48.ua());
			}
			...
			for (@Pc(83) int local83 = 0; local83 < this.anIntArray381.length; local83++) {
				...
				if ((local92 & 0x40000000) != 0) {
					...
					if (!arg4.method1684(local92 & 0x3FFFFFFF).method6295(local94, this.aBoolean385)) {
						local81 = true;
					}
				} else if ((Integer.MIN_VALUE & local92) != 0 && !arg0.method3524(local92 & 0x3FFFFFFF).method4644()) {
					local81 = true;
				}
			}
			if (local81) {
			...
			for (@Pc(176) int local176 = 0; local176 < this.anIntArray381.length; local176++) {
				...
				if ((local185 & 0x40000000) != 0) {
					...
					local220 = arg4.method1684(local185 & 0x3FFFFFFF).method6288(this.aBoolean385, local187);
					if (local220 != null) {
						local172[local174++] = local220;
					}
				} else if ((Integer.MIN_VALUE & local185) != 0) {
					local220 = arg0.method3524(local185 & 0x3FFFFFFF).method4643();
					if (local220 != null) {
						local172[local174++] = local220;
					}
				}
			...
			local48 = arg6.a(local266, local270, Static294.anInt4766, 64, 768);
			...
			synchronized (Static54.aClass82_25) {
				Static54.aClass82_25.method1384(local48, this.aLong160);
			}
		}
		if (arg3 == null) {
			return local48;
		} else {
			@Pc(375) Class114 local375 = local48.a((byte) 4, local35, true);
			arg3.method6523(local375, 0);
			return local375;
		}
	}
}
