...
public final class Class202 {
	...
	public boolean method3203(@OriginalArg(1) float arg0, @OriginalArg(2) Class93_Sub3 arg1, @OriginalArg(3) Class93_Sub3 arg2) {
		if (!this.method3205()) {
			return false;
		}
		...
		this.aClass19_Sub3_21.method4842(local14);
		local14.method6755(local25, 0);
		if (local14.method6757()) {
			...
			for (@Pc(115) int local115 = 0; local115 < arg1.anInt10403; local115++) {
				...
				OpenGL.glEnd();
				arg1.method6468(local115, arg1.anInt10410, arg1.anInt10401);
			}
		...
		local14.method6752(0);
		this.aClass19_Sub3_21.method4868(local14);
		return local35;
	}
	...
	public boolean method3205() {
		if (this.aClass19_Sub3_21.aBoolean613 && this.aClass19_Sub3_21.aBoolean619 && this.aClass179_1 == null) {
			@Pc(23) Class240 local23 = Static245.method6146("uniform float rcpRelief;\nuniform vec2 sampleSize;\nuniform sampler3D heightMap;\nvoid main() {\nfloat dx = texture3D(heightMap, vec3(-sampleSize.x, 0.0, 0.0)+gl_TexCoord[0].xyz).r - texture3D(heightMap, vec3(sampleSize.x, 0.0, 0.0)+gl_TexCoord[0].xyz).r;\nfloat dy = texture3D(heightMap, vec3(0.0, -sampleSize.y, 0.0)+gl_TexCoord[0].xyz).r - texture3D(heightMap, vec3(0.0, sampleSize.y, 0.0)+gl_TexCoord[0].xyz).r;\ngl_FragColor = vec4(0.5+normalize(vec3(dx, dy, rcpRelief))*0.5, texture3D(heightMap, gl_TexCoord[0].xyz).r);\n}\n", this.aClass19_Sub3_21, 35632);
			if (local23 != null) {
				this.aClass179_1 = Static173.method1828(this.aClass19_Sub3_21, new Class240[] { local23 });
			}
		}
