...
public final class Class203 {
	...
	public void method4552(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) Class52[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		this.aClass52Array1 = arg2;
		this.anIntArray380 = arg0;
		this.aBoolean385 = arg5;
		if (this.anInt5024 != arg4) {
			this.anInt5024 = arg4;
		}
	...
	public Class114 method4553(@OriginalArg(0) ObjTypeList arg0, @OriginalArg(1) Class152 arg1, @OriginalArg(4) BasTypeList arg2, @OriginalArg(5) SeqTypeList arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int[] arg5, @OriginalArg(8) Class390 arg6, @OriginalArg(9) IdkTypeList arg7, @OriginalArg(10) Class19 arg8, @OriginalArg(11) NpcTypeList arg9, @OriginalArg(12) Class152[] arg10, @OriginalArg(13) int arg11, @OriginalArg(14) Class152 arg12, @OriginalArg(15) Interface23 arg13) {
		...
		if (arg1 != null) {
			...
			if (local50 != null && (local50.anInt1659 >= 0 || local50.anInt1658 >= 0)) {
				...
				if (local50.anInt1659 >= 0 && arg6.anInt10329 != -1) {
					if (local50.anInt1659 == 65535) {
						local34[arg6.anInt10329] = 0;
						...
						local34[arg6.anInt10329] = local50.anInt1659 | 0x40000000;
						for (local116 = 0; local116 < arg6.anIntArray818.length; local116++) {
							local34[arg6.anIntArray818[local116]] = 0;
						}
						local31 ^= (long) local34[arg6.anInt10329] << 32;
					}
					local36 = true;
				}
				if (local50.anInt1658 >= 0 && arg6.anInt10328 != -1) {
					local44 = true;
					if (local50.anInt1658 == 65535) {
						local34[arg6.anInt10328] = 0;
						for (local116 = 0; local116 < arg6.anIntArray820.length; local116++) {
							local34[arg6.anIntArray820[local116]] = 0;
						}
						local31 ^= 0xFFFFFFFFL;
					} else {
						local34[arg6.anInt10328] = local50.anInt1658 | 0x40000000;
						for (local116 = 0; local116 < arg6.anIntArray820.length; local116++) {
							local34[arg6.anIntArray820[local116]] = 0;
						}
		...
		for (local116 = 0; local116 < local72; local116++) {
			if (arg10[local116] != null) {
				local28 |= arg10[local116].method9108();
				local257 = true;
			}
		}
		if (arg1 != null) {
			local28 |= arg1.method9108();
			local257 = true;
		}
		if (arg12 != null) {
			local257 = true;
			local28 |= arg12.method9108();
		}
		...
		if (local342 == null || arg8.method7967(local342.ua(), local28) != 0) {
			if (local342 != null) {
				local28 = arg8.method8020(local28, local342.ua());
			}
					...
					if (local388) {
						...
						for (local586 = 0; local586 < local34.length; local586++) {
							...
							if ((local591 & 0x40000000) != 0) {
								...
								local633 = arg7.method5049(local591 & 0x3FFFFFFF).method6625();
								if (local633 != null) {
									local584[local586] = local633;
								}
							}
						...
						local342 = arg8.method7959(local833, local826, Static294.anInt4782, 64, 850);
		...
		@Pc(925) Class114 local925 = local342.method7502((byte) 4, local28, true);
		if (!local257 && !local310) {
			return local925;
		}
		@Pc(936) Class73[] local936 = null;
		if (local350 != null) {
			local936 = local350.method6487(arg8);
		}
		if (local310 && local936 != null) {
			for (local390 = 0; local390 < arg5.length; local390++) {
				if (local936[local390] != null) {
					local925.method7499(local936[local390], 0x1 << local390, true);
				}
			}
		}
		local390 = 0;
		...
		while (local390 < local72) {
			if (arg10[local390] != null) {
				arg10[local390].method9117(local395, local925);
			}
			local390++;
			local395 <<= 0x1;
		}
		if (local310) {
			for (local586 = 0; local586 < arg5.length; local586++) {
				if (arg5[local586] != -1) {
					...
					local591 &= 0x3FFF;
					@Pc(1034) Class73 local1034 = arg8.method7960();
					local1034.method7138(local591);
					local925.method7499(local1034, 0x1 << local586, false);
				}
			}
		}
		if (local310 && local936 != null) {
			for (local586 = 0; local586 < arg5.length; local586++) {
				if (local936[local586] != null) {
					local925.method7499(local936[local586], 0x1 << local586, false);
				}
			}
		}
		if (arg1 != null && arg12 != null) {
			Static468.method7652(arg1, local925, arg12);
		} else if (arg1 != null) {
			arg1.method9096(local925, 0);
		} else if (arg12 != null) {
			arg12.method9096(local925, 0);
		}
		return local925;
	}

	@OriginalMember(owner = "client!ju", name = "a", descriptor = "(IZ)V")
	public void method4554(@OriginalArg(1) boolean arg0) {
	...
	public Class114 method4557(@OriginalArg(0) Class152 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) SeqTypeList arg3, @OriginalArg(4) Class19 arg4, @OriginalArg(6) IdkTypeList arg5, @OriginalArg(7) int arg6) {
		...
		if (local39 == null || arg4.method7967(local39.ua(), local16) != 0) {
			if (local39 != null) {
				local16 = arg4.method8020(local16, local39.ua());
			}
			@Pc(70) Class88[] local70 = new Class88[3];
			@Pc(72) int local72 = 0;
			if (!arg5.method5049(arg1).method6622() || !arg5.method5049(arg6).method6622() || !arg5.method5049(arg2).method6622()) {
				return null;
			}
			@Pc(107) Class88 local107 = arg5.method5049(arg1).method6621();
			if (local107 != null) {
				local72++;
				local70[0] = local107;
			}
			local107 = arg5.method5049(arg6).method6621();
			if (local107 != null) {
				local70[local72++] = local107;
			}
			local107 = arg5.method5049(arg2).method6621();
			if (local107 != null) {
				local70[local72++] = local107;
			}
			@Pc(152) int local152 = local16 | 0x4000;
			local107 = new Class88(local70, local72);
			local39 = arg4.method7959(local107, local152, Static294.anInt4782, 64, 768);
		...
		if (arg0 == null) {
			...
			local39 = local39.method7502((byte) 4, local16, true);
			arg0.method9096(local39, 0);
			return local39;
		}
	}
	...
	public Class114 method4559(@OriginalArg(0) IdkTypeList arg0, @OriginalArg(2) SeqTypeList arg1, @OriginalArg(3) Interface23 arg2, @OriginalArg(4) Class152 arg3, @OriginalArg(5) ObjTypeList arg4, @OriginalArg(6) NpcTypeList arg5, @OriginalArg(7) Class19 arg6) {
		...
		if (local48 == null || arg6.method7967(local48.ua(), local35) != 0) {
			if (local48 != null) {
				local35 = arg6.method8020(local35, local48.ua());
			}
			...
			for (@Pc(176) int local176 = 0; local176 < this.anIntArray381.length; local176++) {
				...
				if ((local185 & 0x40000000) != 0) {
					...
					local220 = arg0.method5049(local185 & 0x3FFFFFFF).method6621();
					if (local220 != null) {
						local172[local174++] = local220;
					}
				}
			...
			local48 = arg6.method7959(local266, local270, Static294.anInt4782, 64, 768);
		...
		if (arg3 == null) {
			...
			@Pc(375) Class114 local375 = local48.method7502((byte) 4, local35, true);
			arg3.method9096(local375, 0);
			return local375;
		}
	}
}
