...
public final class Class210 {
	...
	public Class284 method3462(@OriginalArg(0) int arg0) {
		...
		synchronized (this.aClass330_67) {
			local45 = this.aClass330_67.method5359(arg0, 19);
		}
		local22 = new Class284();
		if (local45 != null) {
			local22.method4518(new Class2_Sub21(local45));
		}
		@Pc(69) Class82 local69 = this.aClass82_112;
		synchronized (this.aClass82_112) {
			this.aClass82_112.method1384(local22, (long) arg0);
			return local22;
		}
	}
}
