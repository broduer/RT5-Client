...
public final class Class213 {
	...
	public void method3495(@OriginalArg(1) Class8_Sub7 arg0) {
		...
		if (this.aBoolean426) {
			for (local42 = (Class8_Sub7) this.aClass130_8.method1905(); local42 != null; local42 = (Class8_Sub7) this.aClass130_8.method1900()) {
				if (local42.aClass8_Sub2_18 == local6) {
					local42.a();
					Static281.method2842(local42);
				}
			}
		}
		for (local42 = (Class8_Sub7) this.aClass130_8.method1905(); local42 != null; local42 = (Class8_Sub7) this.aClass130_8.method1900()) {
			if (local6.anInt10697 >= local42.aClass8_Sub2_18.anInt10697) {
				Static370.method3739(arg0, local42);
				return;
			}
		}
		this.aClass130_8.method1902(arg0);
	}

	@OriginalMember(owner = "client!kn", name = "a", descriptor = "(B)V")
	public void method3497() {
		while (true) {
			@Pc(5) Class8_Sub7 local5 = (Class8_Sub7) this.aClass130_8.method1898();
			if (local5 == null) {
				return;
			}
			local5.a();
			Static281.method2842(local5);
		}
	}
}
