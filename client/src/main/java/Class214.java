...
public final class Class214 {
	...
	public Class214(@OriginalArg(0) Class377 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class330 arg2) {
		...
		this.aClass330_70.method5372(26);
	}
	...
	public void method3519() {
		...
		synchronized (this.aClass82_114) {
			this.aClass82_114.method1381(5);
		}
	}

	@OriginalMember(owner = "client!kq", name = "a", descriptor = "(II)Lclient!ab;")
	public Class2_Sub2_Sub1 method3520(@OriginalArg(1) int arg0) {
		@Pc(6) Class82 local6 = this.aClass82_114;
		@Pc(16) Class2_Sub2_Sub1 local16;
		synchronized (this.aClass82_114) {
			local16 = (Class2_Sub2_Sub1) this.aClass82_114.method1390((long) arg0);
		}
		if (local16 != null) {
			return local16;
		}
		...
		synchronized (this.aClass330_70) {
			local39 = this.aClass330_70.method5359(arg0, 26);
		}
		local16 = new Class2_Sub2_Sub1();
		if (local39 != null) {
			local16.method47(new Class2_Sub21(local39));
		}
		@Pc(71) Class82 local71 = this.aClass82_114;
		synchronized (this.aClass82_114) {
			this.aClass82_114.method1384(local16, (long) arg0);
			return local16;
		}
	}
