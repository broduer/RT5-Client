...
public final class Class215 {
	...
	public Class215(@OriginalArg(0) Class377 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class330 arg2, @OriginalArg(3) Class330 arg3) {
		...
		this.aClass330_71.method5372(3);
	}
	...
	public void method3523() {
		...
		synchronized (this.aClass82_115) {
			this.aClass82_115.method1385();
		}
	}

	@OriginalMember(owner = "client!kr", name = "a", descriptor = "(IB)Lclient!pka;")
	public Class294 method3524(@OriginalArg(0) int arg0) {
		@Pc(6) Class82 local6 = this.aClass82_115;
		@Pc(24) Class294 local24;
		synchronized (this.aClass82_115) {
			local24 = (Class294) this.aClass82_115.method1390((long) arg0);
		}
		if (local24 != null) {
			return local24;
		}
		...
		synchronized (this.aClass330_71) {
			local47 = this.aClass330_71.method5359(arg0, 3);
		}
		local24 = new Class294();
		local24.aClass215_4 = this;
		if (local47 != null) {
			local24.method4642(new Class2_Sub21(local47));
		}
		@Pc(74) Class82 local74 = this.aClass82_115;
		synchronized (this.aClass82_115) {
			this.aClass82_115.method1384(local24, (long) arg0);
			return local24;
		}
	}
	...
	public void method3527() {
		...
		synchronized (this.aClass82_115) {
			this.aClass82_115.method1381(5);
		}
	}
}
