...
public final class Class215 {
	...
	public Class215(@OriginalArg(0) boolean arg0) {
		this.aBoolean426 = arg0;
	}

	@OriginalMember(owner = "client!kn", name = "a", descriptor = "(ILclient!pea;)V")
	public void method5015(@OriginalArg(1) Class8_Sub7 arg0) {
		...
		for (local42 = (Class8_Sub7) this.aClass130_8.method2790(); local42 != null; local42 = (Class8_Sub7) this.aClass130_8.method2785()) {
			if (local6.anInt10725 >= local42.aClass8_Sub2_18.anInt10725) {
				Static370.method5289(arg0, local42);
				return;
			}
		}
