...
public final class Class216 {
	...
	public boolean method3532(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class216 arg1) {
		return this.aClass23_24 != null || this.method3539(arg0, arg1);
	}

	@OriginalMember(owner = "client!ks", name = "d", descriptor = "(Lclient!ha;Lclient!ks;)V")
	private void method3534(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class216 arg1) {
		Static345.method3533(arg0);
		Static345.method3540(arg0);
		...
		@Pc(147) Class114 local147 = Static345.aClass114_6.a((byte) 0, 51200, true);
		...
		arg0.a(arg0.y());
		@Pc(209) Class73 local209 = arg0.y();
		local209.a(0, 0, arg0.i() - local147.HA());
		local147.a(local209, (Class8_Sub6) null, 1024, 1);
		@Pc(231) int local231 = this.anInt5638 * 13 / 16;
		@Pc(238) int local238 = (this.anInt5638 - local231) / 2;
		Static345.aClass23_23.a(local238, local238, local231, local231, 0, this.anInt5634 | 0xFF000000, 1);
		this.aClass23_24 = arg0.a(0, 0, this.anInt5638, this.anInt5638, true);
		arg0.ya();
		arg0.aa(0, 0, this.anInt5638, this.anInt5638, 0, 0);
		Static345.aClass23_25.a(0, 0, this.anInt5638, this.anInt5638, 1, 0, 0);
		this.aClass23_24.a(0, 0, 3);
	...
	private void method3536(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class216 arg1) {
		@Pc(6) Class88 local6 = Static121.method1430(this.anInt5633, Static386.aClass330_80);
		if (local6 == null) {
			return;
		}
		arg0.K(Static345.anIntArray418);
		...
		local6.method1456(this.anInt5636 & 0x3FFF, this.anInt5632 & 0x3FFF, this.anInt5629 & 0x3FFF);
		@Pc(190) Class114 local190 = arg0.a(local6, 2048, 0, 64, 768);
		...
		arg0.a(arg0.y());
		@Pc(238) Class73 local238 = arg0.A();
		local238.a(0, 0, arg0.i() - local190.HA());
		local190.a(local238, (Class8_Sub6) null, arg0.i(), 1);
		this.aClass23_24 = arg0.a(0, 0, this.anInt5638, this.anInt5638, true);
		this.aClass23_24.a(0, 0, 3);
	...
	public void method3537(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10) {
		...
		@Pc(32) Class73 local32 = arg0.n();
		local32.c(0, 0, 0, local6);
		...
		if (local84 < arg4 && local84 + this.anInt5627 > 0 && local75 < arg3 && local75 + this.anInt5627 > 0) {
			this.aClass23_24.a(local75, local84, this.anInt5627, this.anInt5627, 0, arg10 << 24 | 0xFFFFFF, 1);
		}
	}

	@OriginalMember(owner = "client!ks", name = "a", descriptor = "(IIII)Z")
	public boolean method3538(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(7) int local7;
		@Pc(12) int local12;
		@Pc(17) int local17;
		if (this.aBoolean429) {
		...
		@Pc(143) int local143 = Static440.method4203(this.anInt5627);
		if (local143 > arg3) {
			local143 = Static402.method3969(arg3);
		}
		if (local143 > 512) {
			local143 = 512;
		}
	...
	private boolean method3539(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class216 arg1) {
		if (this.aClass23_24 == null) {
			if (this.anInt5640 == 0) {
				if (Static708.anInterface4_12.method4802(this.anInt5633)) {
					@Pc(23) int[] local23 = Static708.anInterface4_12.method4803(0.7F, this.anInt5633, this.anInt5638, this.anInt5638);
					this.aClass23_24 = arg0.a(this.anInt5638, this.anInt5638, this.anInt5638, local23, 0, 7468);
				}
