...
public final class Class217 {
	...
	private final int anInt5703 = Static650.method6049(16);

	@OriginalMember(owner = "client!l", name = "g", descriptor = "I")
	private final int anInt5698 = Static650.method6049(24);

	@OriginalMember(owner = "client!l", name = "b", descriptor = "I")
	private final int anInt5699 = Static650.method6049(24);

	@OriginalMember(owner = "client!l", name = "a", descriptor = "I")
	private final int anInt5700 = Static650.method6049(24) + 1;

	@OriginalMember(owner = "client!l", name = "e", descriptor = "I")
	private final int anInt5702 = Static650.method6049(6) + 1;

	@OriginalMember(owner = "client!l", name = "c", descriptor = "I")
	private final int anInt5701 = Static650.method6049(8);
	...
	public Class217() {
		...
		for (@Pc(35) int local35 = 0; local35 < this.anInt5702; local35++) {
			local38 = 0;
			@Pc(41) int local41 = Static650.method6049(3);
			@Pc(47) boolean local47 = Static650.method6058() != 0;
			if (local47) {
				local38 = Static650.method6049(5);
			}
			local33[local35] = local38 << 3 | local41;
		}
		this.anIntArray427 = new int[this.anInt5702 * 8];
		for (local38 = 0; local38 < this.anInt5702 * 8; local38++) {
			this.anIntArray427[local38] = (local33[local38 >> 3] & 0x1 << (local38 & 0x7)) == 0 ? -1 : Static650.method6049(8);
		}
	}

	@OriginalMember(owner = "client!l", name = "a", descriptor = "([FIZ)V")
	public void method3589(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		...
		for (@Pc(35) int local35 = 0; local35 < 8; local35++) {
			...
			while (local38 < local30) {
				...
				@Pc(51) int local51;
				if (local35 == 0) {
					local47 = Static650.aClass271Array1[this.anInt5701].method4253();
					...
					if (local90 >= 0) {
						...
						if (this.anInt5703 == 0) {
							...
							for (@Pc(115) int local115 = 0; local115 < local113; local115++) {
								@Pc(119) float[] local119 = local104.method4254();
							...
							while (local113 < this.anInt5700) {
								@Pc(153) float[] local153 = local104.method4254();
