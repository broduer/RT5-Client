...
public final class Class218 {
	...
	private void method5059(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class218 arg1) {
		...
		@Pc(94) int local94;
		if (this.anInt5659 != 0) {
			local79 = Class114_Sub1.anIntArray741[this.anInt5659];
			local84 = Class114_Sub1.anIntArray740[this.anInt5659];
			local94 = local33 * local84 - local35 * local79 >> 14;
			local35 = local33 * local79 + local35 * local84 >> 14;
			local33 = local94;
		}
		if (this.anInt5648 != 0) {
			local79 = Class114_Sub1.anIntArray741[this.anInt5648];
			local84 = Class114_Sub1.anIntArray740[this.anInt5648];
	...
	private void method5061(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class218 arg1) {
		...
		if (this.anInt5659 != 0) {
			...
			local87 = Class114_Sub1.anIntArray741[local83];
			local91 = Class114_Sub1.anIntArray740[local83];
