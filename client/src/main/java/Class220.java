...
public final class Class220 {
	...
	public Class220(@OriginalArg(0) Class377 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class330 arg2, @OriginalArg(3) Class330 arg3) {
		...
		this.aClass330_75.method5372(46);
	}
	...
	public void method3644() {
		...
		synchronized (this.aClass82_122) {
			this.aClass82_122.method1391();
		}
		local2 = this.aClass82_121;
		synchronized (this.aClass82_121) {
			this.aClass82_121.method1391();
		}
	}
	...
	public void method3645() {
		@Pc(2) Class82 local2 = this.aClass82_122;
		synchronized (this.aClass82_122) {
			this.aClass82_122.method1385();
		}
		local2 = this.aClass82_121;
		synchronized (this.aClass82_121) {
			this.aClass82_121.method1385();
		}
	}
	...
	public void method3646() {
		...
		synchronized (this.aClass82_122) {
			this.aClass82_122.method1381(5);
		}
		local6 = this.aClass82_121;
		synchronized (this.aClass82_121) {
			this.aClass82_121.method1381(5);
		}
	}

	@OriginalMember(owner = "client!ld", name = "b", descriptor = "(II)Lclient!pb;")
	public Class285 method3648(@OriginalArg(0) int arg0) {
		@Pc(6) Class82 local6 = this.aClass82_122;
		@Pc(16) Class285 local16;
		synchronized (this.aClass82_122) {
			local16 = (Class285) this.aClass82_122.method1390((long) arg0);
		}
		if (local16 != null) {
			return local16;
		}
		...
		synchronized (this.aClass330_75) {
			local39 = this.aClass330_75.method5359(arg0, 46);
		}
		local16 = new Class285();
		local16.aClass220_1 = this;
		if (local39 != null) {
			local16.method4527(new Class2_Sub21(local39));
		}
		@Pc(66) Class82 local66 = this.aClass82_122;
		synchronized (this.aClass82_122) {
			this.aClass82_122.method1384(local16, (long) arg0);
			return local16;
		}
	}
}
