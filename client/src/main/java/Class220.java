...
public final class Class220 {
	...
	private void method5132(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub21 arg1) {
		if (arg0 == 1) {
			this.aString55 = arg1.method7350();
		} else if (arg0 == 2) {
			this.aString54 = arg1.method7350();
		} else {
			@Pc(29) int local29;
			@Pc(36) int local36;
			if (arg0 == 3) {
				local29 = arg1.method7403();
				this.anIntArrayArray138 = new int[local29][3];
				for (local36 = 0; local36 < local29; local36++) {
					this.anIntArrayArray138[local36][0] = arg1.method7389();
					this.anIntArrayArray138[local36][1] = arg1.method7356();
					this.anIntArrayArray138[local36][2] = arg1.method7356();
				}
			} else if (arg0 == 4) {
				local29 = arg1.method7403();
				this.anIntArrayArray137 = new int[local29][3];
				for (local36 = 0; local36 < local29; local36++) {
					this.anIntArrayArray137[local36][0] = arg1.method7389();
					this.anIntArrayArray137[local36][1] = arg1.method7356();
					this.anIntArrayArray137[local36][2] = arg1.method7356();
				}
			} else if (arg0 == 5) {
				arg1.method7389();
			} else if (arg0 == 6) {
				...
				if (arg0 == 9) {
					...
					for (local36 = 0; local36 < local29; local36++) {
						this.anIntArray436[local36] = arg1.method7356();
					}
				} else if (arg0 == 12) {
					arg1.method7356();
				} else if (arg0 == 13) {
					...
					for (local36 = 0; local36 < local29; local36++) {
						this.anIntArray435[local36] = arg1.method7389();
					}
				} else if (arg0 == 14) {
					local29 = arg1.method7403();
					this.anIntArrayArray139 = new int[local29][2];
					for (local36 = 0; local36 < local29; local36++) {
						this.anIntArrayArray139[local36][0] = arg1.method7403();
						this.anIntArrayArray139[local36][1] = arg1.method7403();
					}
				} else if (arg0 == 15) {
					arg1.method7389();
				} else if (arg0 == 17) {
					this.anInt5724 = arg1.method7389();
				} else if (arg0 == 18) {
					local29 = arg1.method7403();
					...
					for (local36 = 0; local36 < local29; local36++) {
						this.anIntArray432[local36] = arg1.method7356();
						this.anIntArray429[local36] = arg1.method7356();
						this.anIntArray431[local36] = arg1.method7356();
						this.aStringArray28[local36] = arg1.method7365();
					}
				} else if (arg0 == 19) {
					local29 = arg1.method7403();
					...
					for (local36 = 0; local36 < local29; local36++) {
						this.anIntArray434[local36] = arg1.method7356();
						this.anIntArray430[local36] = arg1.method7356();
						this.anIntArray428[local36] = arg1.method7356();
						this.aStringArray27[local36] = arg1.method7365();
					}
				} else if (arg0 == 249) {
					local29 = arg1.method7403();
					if (this.aClass28_30 == null) {
						local36 = Static440.method5969(local29);
						this.aClass28_30 = new Class28(local36);
					}
					for (local36 = 0; local36 < local29; local36++) {
						@Pc(224) boolean local224 = arg1.method7403() == 1;
						@Pc(228) int local228 = arg1.method7390();
						@Pc(237) Class2 local237;
						if (local224) {
							local237 = new Class2_Sub24(arg1.method7365());
						} else {
	...
	public void method5134(@OriginalArg(0) Class2_Sub21 arg0) {
		while (true) {
			@Pc(3) int local3 = arg0.method7403();
			if (local3 == 0) {
				return;
			}
			this.method5132(local3, arg0);
		}
	}
}
