...
public abstract class Class222 {
	...
	protected Class222(@OriginalArg(0) int arg0) {
		if (!Static14.method117("jagtheora")) {
	...
	private Class2_Sub28 method6601() throws IOException {
		if (this.aBoolean800) {
			...
			while (this.anOggSyncState2.pageOut(this.anOggPage2) <= 0) {
				local25 = this.method6615(this.aByteArray110);
				if (local25 == -1) {
			...
			if (!this.anOggPage2.isBOS()) {
				@Pc(81) Class2_Sub28 local81 = (Class2_Sub28) this.aClass28_45.method373((long) local25);
			...
			if (!local99.pageIn(this.anOggPage2)) {
				...
				this.aClass28_45.method370((long) local25, local188);
				return local188;
			} else {
				throw new IllegalStateException();
			}
	...
	public final void method6603(@OriginalArg(0) boolean arg0) {
		if (this.aClass2_Sub28_Sub1_2 != null) {
			@Pc(7) Class2_Sub6_Sub5 local7 = this.aClass2_Sub28_Sub1_2.method2767();
			if (local7 != null) {
				local7.method6575(arg0);
			}
		}
	...
	private void method6604() throws IOException {
		while (this.aClass2_Sub28_Sub3_2.anOggStreamState5.packetOut(this.anOggPacket2) != 1) {
			@Pc(11) Class2_Sub28 local11 = this.method6601();
			if (local11 == null) {
				if (this.aBoolean799) {
					this.method6617();
				}
			...
			if (local11 == this.aClass2_Sub28_Sub4_2) {
				this.method6609((byte) -97);
			}
		}
		this.aClass2_Sub28_Sub3_2.method6095(this.anOggPacket2);
	}

	@OriginalMember(owner = "client!lf", name = "d", descriptor = "(I)Z")
	private boolean method6605() {
		if (this.aClass2_Sub28_Sub1_2 == null) {
			@Pc(42) double local42 = (double) this.aClass2_Sub28_Sub3_2.method3885();
			return local42 == 0.0D || (double) Static588.method5469() >= 1000.0D / local42 + (double) this.aClass2_Sub28_Sub3_2.method3893();
		} else {
			return !this.aClass2_Sub28_Sub3_2.method3895() || this.method6614() > this.aClass2_Sub28_Sub3_2.method3894();
		}
	}

	@OriginalMember(owner = "client!lf", name = "g", descriptor = "(I)Z")
	public final boolean method6606() {
		if (this.aBoolean800 || this.aBoolean799) {
			return this.aClass2_Sub28_Sub1_2 == null || this.aClass2_Sub28_Sub1_2.method2772() <= 0;
		} else {
			return false;
		}
	}
	...
	public final Class2_Sub28_Sub4 method6607() {
		return this.aClass2_Sub28_Sub4_2;
	}

	@OriginalMember(owner = "client!lf", name = "a", descriptor = "(Z)V")
	public final void method6608() throws IOException {
		if (this.aBoolean802) {
			return;
		}
		while (!this.aBoolean800) {
			...
			if (this.aBoolean801) {
				local26 = (Class2_Sub28) this.aClass28_45.method373((long) this.anOggPage2.getSerialNumber());
			} else {
				local26 = this.method6601();
				if (local26 == null) {
					if (this.aBoolean799) {
						this.method6617();
					}
			...
			if (local26 == this.aClass2_Sub28_Sub1_2) {
				if (this.aClass2_Sub28_Sub1_2.method2772() >= 50) {
					return;
				}
				while (this.aClass2_Sub28_Sub1_2.anOggStreamState5.packetOut(this.anOggPacket2) == 1) {
					this.aClass2_Sub28_Sub1_2.method6095(this.anOggPacket2);
					this.method6609((byte) -94);
					if (this.aClass2_Sub28_Sub3_2 != null) {
						@Pc(185) double local185 = this.aClass2_Sub28_Sub3_2.method3894();
						for (@Pc(187) int local187 = 0; local187 < 10 && this.method6605(); local187++) {
							this.method6604();
							if (this.aBoolean800) {
								return;
							}
						}
						if (this.aClass2_Sub28_Sub3_2.method3894() > local185) {
							return;
						}
					}
					if (this.aClass2_Sub28_Sub1_2.method2772() >= 50) {
				...
				while (local26.anOggStreamState5.packetOut(this.anOggPacket2) == 1) {
					if (local26.anInt9753 == 1 && local26 instanceof Class2_Sub28_Sub4) {
						this.method6612(this.aString127);
					}
					local26.method6095(this.anOggPacket2);
				}
			} else if (this.aClass2_Sub28_Sub1_2 == null && !this.aBoolean802) {
				for (@Pc(88) int local88 = 0; local88 < 10 && this.method6605(); local88++) {
					this.method6604();
					if (this.aBoolean800) {
						return;
					}
	...
	private void method6609(@OriginalArg(0) byte arg0) {
		for (@Pc(11) Class2_Sub28 local11 = (Class2_Sub28) this.aClass28_45.method371(); local11 != null; local11 = (Class2_Sub28) this.aClass28_45.method375()) {
			if (local11 instanceof Class2_Sub28_Sub4) {
				@Pc(21) Class2_Sub28_Sub4 local21 = (Class2_Sub28_Sub4) local11;
				while ((local21.anInt9753 <= 8 || this.method6614() > (double) local21.method6105()) && local21.anOggStreamState5.packetOut(this.anOggPacket2) == 1) {
					local21.method6095(this.anOggPacket2);
				}
			}
		}
		this.method6612(this.aString127);
	...
	public final void method6610() {
		if (this.aBoolean800) {
			return;
		}
		for (@Pc(14) Class2_Sub28 local14 = (Class2_Sub28) this.aClass28_45.method371(); local14 != null; local14 = (Class2_Sub28) this.aClass28_45.method375()) {
			local14.method6099();
	...
	public final void method6612(@OriginalArg(1) String arg0) {
		this.aString127 = arg0;
		if (this.aString127 == null) {
			this.aClass2_Sub28_Sub4_2 = null;
			return;
		}
		if (this.aClass2_Sub28_Sub4_2 != null && !this.aString127.equals(this.aClass2_Sub28_Sub4_2.method6102())) {
			this.aClass2_Sub28_Sub4_2 = null;
		}
		if (this.aClass2_Sub28_Sub4_2 != null) {
			return;
		}
		for (@Pc(50) Class2_Sub28 local50 = (Class2_Sub28) this.aClass28_45.method371(); local50 != null; local50 = (Class2_Sub28) this.aClass28_45.method375()) {
			if (local50 instanceof Class2_Sub28_Sub4) {
				@Pc(57) Class2_Sub28_Sub4 local57 = (Class2_Sub28_Sub4) local50;
				if (this.aString127.equals(local57.method6102())) {
	...
	public final double method6614() {
		if (this.aClass2_Sub28_Sub1_2 == null) {
			return this.aClass2_Sub28_Sub3_2 == null ? 0.0D : this.aClass2_Sub28_Sub3_2.method3894();
		} else {
			return this.aClass2_Sub28_Sub1_2.method2770();
		}
	}

	@OriginalMember(owner = "client!lf", name = "a", descriptor = "([BI)I")
	protected abstract int method6615(@OriginalArg(0) byte[] arg0) throws IOException;

	@OriginalMember(owner = "client!lf", name = "f", descriptor = "(B)Lclient!mda;")
	public final Class2_Sub28_Sub3 method6616() {
		return this.aClass2_Sub28_Sub3_2;
	}

	@OriginalMember(owner = "client!lf", name = "a", descriptor = "(B)V")
	private void method6617() {
		for (@Pc(7) Class2_Sub28 local7 = (Class2_Sub28) this.aClass28_45.method371(); local7 != null; local7 = (Class2_Sub28) this.aClass28_45.method375()) {
			if (local7 != this.aClass2_Sub28_Sub3_2) {
				while (local7.anOggStreamState5.packetOut() == 1) {
					local7.method6095(this.anOggPacket2);
				}
			}
		}
		if (this.aClass2_Sub28_Sub3_2 == null) {
	...
	public final Class2_Sub28_Sub1 method6618() {
