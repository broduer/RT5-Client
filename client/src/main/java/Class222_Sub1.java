...
public final class Class222_Sub1 extends Class222 {
	...
	public void method6622(@OriginalArg(0) int arg0) {
		if (this.anIntArray834 == null) {
			return;
		}
		for (@Pc(12) int local12 = 0; local12 < 10 && local12 + this.anInt10596 < this.anIntArray834.length; local12++) {
			if (this.aByteArrayArray37[local12] == null && this.aClass330_126.method5350(0, this.anIntArray834[this.anInt10596 + local12])) {
				this.aByteArrayArray37[local12] = this.aClass330_126.method5359(0, this.anIntArray834[this.anInt10596 + local12]);
			}
		}
		if (arg0 < 93) {
	...
	@Override
	protected int method6615(@OriginalArg(0) byte[] arg0) throws IOException {
		@Pc(50) int local50;
		@Pc(56) int local56;
		if (this.anIntArray834 == null) {
			if (!this.aClass330_126.method5350(0, this.anInt10594)) {
				return 0;
			}
			@Pc(29) byte[] local29 = this.aClass330_126.method5359(0, this.anInt10594);
			if (local29 == null) {
			...
			for (local56 = 0; local56 < local50; local56++) {
				this.anIntArray834[local56] = this.aClass2_Sub21_17.method5191();
			}
		}
		...
		do {
			...
			if (local50 > local143) {
				this.aClass2_Sub21_16.method5153(this.aClass2_Sub21_17.anInt8388, local143, this.aClass2_Sub21_17.aByteArray93);
				this.aClass2_Sub21_17.aByteArray93 = null;
				return arg0.length;
			}
			this.aClass2_Sub21_17.method5195(local50, this.aClass2_Sub21_16.aByteArray93, this.aClass2_Sub21_16.anInt8388);
