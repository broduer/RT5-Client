	...
	public void run() {
		while (true) {
			...
			synchronized (this.aClass339_32) {
				...
				for (local15 = this.aClass339_32.method5459(); local15 == null; local15 = this.aClass339_32.method5459()) {
					try {
