...
public final class Class226 {
	...
	public Class226(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg1 != arg0) {
			@Pc(14) int local14 = Static317.method4586(arg1, arg0);
			@Pc(18) int local18 = arg0 / local14;
			@Pc(22) int local22 = arg1 / local14;
			this.anIntArrayArray143 = new int[local18][14];
			this.anInt5832 = local18;
			this.anInt5839 = local22;
	...
	public int method5238(@OriginalArg(1) int arg0) {
		if (this.anIntArrayArray143 != null) {
			arg0 = (int) ((long) arg0 * (long) this.anInt5839 / (long) this.anInt5832) + 6;
		}
		return arg0;
	}

	@OriginalMember(owner = "client!lg", name = "a", descriptor = "(II)I")
	public int method5241(@OriginalArg(1) int arg0) {
		if (this.anIntArrayArray143 != null) {
			arg0 = (int) ((long) this.anInt5839 * (long) arg0 / (long) this.anInt5832);
		}
		return arg0;
	}

	@OriginalMember(owner = "client!lg", name = "a", descriptor = "(I[B)[B")
	public byte[] method5242(@OriginalArg(1) byte[] arg0) {
		if (this.anIntArrayArray143 != null) {
			@Pc(19) int local19 = (int) ((long) arg0.length * (long) this.anInt5839 / (long) this.anInt5832) + 14;
			...
			for (@Pc(28) int local28 = 0; local28 < arg0.length; local28++) {
				...
				local26 += this.anInt5839;
				@Pc(74) int local74 = local26 / this.anInt5832;
				local26 -= this.anInt5832 * local74;
				local24 += local74;
			}
	...
	public short[] method5244(@OriginalArg(0) short[] arg0) {
		if (this.anIntArrayArray143 != null) {
			@Pc(23) int local23 = (int) ((long) this.anInt5839 * (long) arg0.length / (long) this.anInt5832) + 14;
			...
			for (@Pc(32) int local32 = 0; local32 < arg0.length; local32++) {
				...
				local30 += this.anInt5839;
				@Pc(80) int local80 = local30 / this.anInt5832;
				local28 += local80;
				local30 -= this.anInt5832 * local80;
			}
