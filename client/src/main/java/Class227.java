...
public final class Class227 {
	...
	public void method3703(@OriginalArg(0) Class2_Sub21 arg0) {
		while (true) {
			@Pc(12) int local12 = arg0.method5205();
			if (local12 == 0) {
				return;
			}
			this.method3707(local12, arg0);
		}
	}

	@OriginalMember(owner = "client!lia", name = "a", descriptor = "(BZILclient!gu;Lclient!s;BILclient!s;IILclient!ha;)Lclient!ka;")
	public Class114 method3706(@OriginalArg(0) byte arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class152 arg3, @OriginalArg(4) Class178 arg4, @OriginalArg(6) int arg5, @OriginalArg(7) Class178 arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class19 arg9) {
		@Pc(13) boolean local13 = arg1 & this.aByte96 != 0;
		@Pc(15) int local15 = arg7;
		if (arg3 != null) {
			local15 = arg7 | arg3.method6535();
		}
		if (local13) {
		...
		synchronized (this.aClass128_2.aClass82_62) {
			local85 = (Class114) this.aClass128_2.aClass82_62.method1390((long) (this.anInt5833 |= arg9.anInt8962 << 29));
		}
		if (local85 == null || arg9.b(local85.ua(), local15) != 0) {
			if (local85 != null) {
				local15 = arg9.c(local15, local85.ua());
			}
			...
			@Pc(144) Class88 local144 = Static121.method1430(this.anInt5834, this.aClass128_2.aClass330_34);
			if (local144 == null) {
				return null;
			}
			...
			local85 = arg9.a(local144, local121, this.aClass128_2.anInt2921, this.anInt5835 + 64, this.anInt5839 + 850);
			@Pc(180) int local180;
			if (this.aShortArray81 != null) {
			...
			synchronized (this.aClass128_2.aClass82_62) {
				this.aClass128_2.aClass82_62.method1384(local85, (long) (this.anInt5833 |= arg9.anInt8962 << 29));
			}
		}
		@Pc(263) Class114 local263 = local85.a(arg0, local15, true);
		if (arg3 != null) {
			arg3.method6523(local263, 0);
		}
	...
	private void method3707(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub21 arg1) {
		if (arg0 == 1) {
			this.anInt5834 = arg1.method5191();
		} else if (arg0 == 2) {
			this.anInt5842 = arg1.method5191();
		} else if (arg0 == 4) {
			this.anInt5847 = arg1.method5191();
		} else if (arg0 == 5) {
			this.anInt5843 = arg1.method5191();
		} else if (arg0 == 6) {
			this.anInt5838 = arg1.method5191();
		} else if (arg0 == 7) {
			this.anInt5835 = arg1.method5205();
		} else if (arg0 == 8) {
			this.anInt5839 = arg1.method5205();
		} else if (arg0 == 9) {
			this.aByte96 = 3;
			this.anInt5837 = 8224;
		} else if (arg0 == 10) {
			...
			this.aByte96 = 2;
			this.anInt5837 = arg1.method5205() * 256;
		} else if (arg0 == 15) {
			this.aByte96 = 3;
			this.anInt5837 = arg1.method5191();
		} else if (arg0 == 16) {
			this.aByte96 = 3;
			this.anInt5837 = arg1.method5158();
		} else {
			@Pc(132) int local132;
			@Pc(142) int local142;
			if (arg0 == 40) {
				local132 = arg1.method5205();
				this.aShortArray80 = new short[local132];
				this.aShortArray81 = new short[local132];
				for (local142 = 0; local142 < local132; local142++) {
					this.aShortArray81[local142] = (short) arg1.method5191();
					this.aShortArray80[local142] = (short) arg1.method5191();
				}
			} else if (arg0 == 41) {
				local132 = arg1.method5205();
				...
				for (local142 = 0; local142 < local132; local142++) {
					this.aShortArray82[local142] = (short) arg1.method5191();
					this.aShortArray83[local142] = (short) arg1.method5191();
				}
			}
		}
	}
	...
	public Class114 method3709(@OriginalArg(0) Class152 arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(4) Class19 arg3) {
		return this.method3706(arg1, false, 0, arg0, (Class178) null, 0, (Class178) null, arg2, 0, arg3);
	}
}
