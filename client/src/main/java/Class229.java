...
public final class Class229 {
	...
	public Class270 method3720(@OriginalArg(1) Class390 arg0) {
		return arg0.method6420(this.aString60, this.aBoolean449, this.aBoolean450 ? this.anInt5853 : this.anInt5854);
	}

	@OriginalMember(owner = "client!lja", name = "a", descriptor = "(ILclient!lja;)Z")
	public boolean method3722(@OriginalArg(1) Class229 arg0) {
		if (arg0 == null) {
			return false;
		} else {
