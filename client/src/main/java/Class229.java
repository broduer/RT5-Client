...
public final class Class229 {
	...
	public void method5253(@OriginalArg(0) Class2_Sub21 arg0) {
		while (true) {
	...
	public Class114 method5256(@OriginalArg(0) byte arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class152 arg3, @OriginalArg(4) Class178 arg4, @OriginalArg(6) int arg5, @OriginalArg(7) Class178 arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class19 arg9) {
		...
		synchronized (this.aClass128_2.aClass82_62) {
			local85 = (Class114) this.aClass128_2.aClass82_62.method2156((long) (this.anInt5853 |= arg9.anInt8986 << 29));
		}
		if (local85 == null || arg9.method7967(local85.ua(), local15) != 0) {
			...
			synchronized (this.aClass128_2.aClass82_62) {
				this.aClass128_2.aClass82_62.method2150(local85, (long) (this.anInt5853 |= arg9.anInt8986 << 29));
			}
		}
	...
	private void method5257(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub21 arg1) {
		if (arg0 == 1) {
			this.anInt5854 = arg1.method7389();
		} else if (arg0 == 2) {
			this.anInt5862 = arg1.method7389();
		} else if (arg0 == 4) {
			this.anInt5867 = arg1.method7389();
		} else if (arg0 == 5) {
			this.anInt5863 = arg1.method7389();
		} else if (arg0 == 6) {
			this.anInt5858 = arg1.method7389();
		} else if (arg0 == 7) {
			this.anInt5855 = arg1.method7403();
		} else if (arg0 == 8) {
			this.anInt5859 = arg1.method7403();
		} else if (arg0 == 9) {
			this.aByte96 = 3;
			this.anInt5857 = 8224;
		} else if (arg0 == 10) {
			...
			this.aByte96 = 2;
			this.anInt5857 = arg1.method7403() * 256;
		} else if (arg0 == 15) {
			this.aByte96 = 3;
			this.anInt5857 = arg1.method7389();
		} else if (arg0 == 16) {
			this.aByte96 = 3;
			this.anInt5857 = arg1.method7356();
		} else {
			@Pc(132) int local132;
			@Pc(142) int local142;
			if (arg0 == 40) {
				local132 = arg1.method7403();
				this.aShortArray80 = new short[local132];
				this.aShortArray81 = new short[local132];
				for (local142 = 0; local142 < local132; local142++) {
					this.aShortArray81[local142] = (short) arg1.method7389();
					this.aShortArray80[local142] = (short) arg1.method7389();
				}
			} else if (arg0 == 41) {
				local132 = arg1.method7403();
				...
				for (local142 = 0; local142 < local132; local142++) {
					this.aShortArray82[local142] = (short) arg1.method7389();
					this.aShortArray83[local142] = (short) arg1.method7389();
				}
			}
		}
	}
	...
	public Class114 method5259(@OriginalArg(0) Class152 arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(4) Class19 arg3) {
		return this.method5256(arg1, false, 0, arg0, (Class178) null, 0, (Class178) null, arg2, 0, arg3);
	}
}
