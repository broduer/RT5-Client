...
public final class Class230 {
	...
	private float method5261(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2) {
	...
	public int method5263(@OriginalArg(0) int arg0, @OriginalArg(1) float arg1) {
		@Pc(20) float local20;
		if (arg0 == 0) {
			...
			Static365.anInt5869 = (int) (Static365.aFloat112 * 65536.0F);
		}
		if (this.anIntArray452[arg0] == 0) {
			return 0;
		}
		local20 = this.method5261(arg0, 0, arg1);
		Static365.aFloatArrayArray12[arg0][0] = -2.0F * local20 * (float) Math.cos((double) this.method5265(arg0, 0, arg1));
		Static365.aFloatArrayArray12[arg0][1] = local20 * local20;
		for (@Pc(77) int local77 = 1; local77 < this.anIntArray452[arg0]; local77++) {
			local20 = this.method5261(arg0, local77, arg1);
			@Pc(97) float local97 = -2.0F * local20 * (float) Math.cos((double) this.method5265(arg0, local77, arg1));
	...
	public void method5264(@OriginalArg(0) Class2_Sub21 arg0, @OriginalArg(1) Class213 arg1) {
		...
		this.anIntArray451[0] = arg0.method7389();
		this.anIntArray451[1] = arg0.method7389();
		@Pc(37) int local37 = arg0.method7403();
		@Pc(42) int local42;
		for (@Pc(39) int local39 = 0; local39 < 2; local39++) {
			for (local42 = 0; local42 < this.anIntArray452[local39]; local42++) {
				this.anIntArrayArrayArray8[local39][0][local42] = arg0.method7389();
				this.anIntArrayArrayArray7[local39][0][local42] = arg0.method7389();
			}
		}
		for (local42 = 0; local42 < 2; local42++) {
			for (@Pc(81) int local81 = 0; local81 < this.anIntArray452[local42]; local81++) {
				if ((local37 & 0x1 << local42 * 4 << local81) == 0) {
					...
					this.anIntArrayArrayArray8[local42][1][local81] = arg0.method7389();
					this.anIntArrayArrayArray7[local42][1][local81] = arg0.method7389();
				}
			}
		}
		if (local37 != 0 || this.anIntArray451[1] != this.anIntArray451[0]) {
			arg1.method4956(arg0);
		}
	}

	@OriginalMember(owner = "client!lj", name = "b", descriptor = "(IIF)F")
	private float method5265(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2) {
		...
		return Static365.method5266(local34);
	}
}
