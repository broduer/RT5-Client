...
public final class Class230 {
	...
	public int method5263(@OriginalArg(0) int arg0, @OriginalArg(1) float arg1) {
		...
		Static365.aFloatArrayArray12[arg0][0] = -2.0F * local20 * (float) Math.cos(this.method5265(arg0, 0, arg1));
		...
		for (@Pc(77) int local77 = 1; local77 < this.anIntArray452[arg0]; local77++) {
			...
			@Pc(97) float local97 = -2.0F * local20 * (float) Math.cos(this.method5265(arg0, local77, arg1));
