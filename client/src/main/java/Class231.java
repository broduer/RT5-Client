...
public final class Class231 {
	...
	public Class231(@OriginalArg(0) Class2_Sub21 arg0) {
		...
		for (@Pc(17) int local17 = 0; local17 < local7; local17++) {
			@Pc(23) int local23 = arg0.method5205();
			this.anIntArray454[local17] = local23;
			@Pc(32) int local32 = arg0.method5191();
			@Pc(36) int local36 = arg0.method5191();
			this.anIntArray453[local17] = local36 + (local32 << 16);
		}
	}

	@OriginalMember(owner = "client!lka", name = "a", descriptor = "(Lclient!lw;II)V")
	public void method3728(@OriginalArg(0) Class236 arg0, @OriginalArg(2) int arg1) {
		@Pc(10) int local10 = this.anIntArray453[0];
		arg0.method3802(local10 >>> 16, arg1, local10 & 0xFFFF);
		@Pc(24) Class8_Sub2_Sub1_Sub2 local24 = arg0.method3805();
