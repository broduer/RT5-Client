...
public final class Class233 {
	...
	public void method5278(@OriginalArg(0) Class238 arg0, @OriginalArg(2) int arg1) {
		@Pc(10) int local10 = this.anIntArray453[0];
		arg0.method5367(local10 >>> 16, arg1, local10 & 0xFFFF);
		@Pc(24) Class8_Sub2_Sub1_Sub2 local24 = arg0.method5370();
		local24.anInt10793 = 0;
		for (@Pc(41) int local41 = this.anIntArray454.length - 1; local41 >= 0; local41--) {
			...
			local24.anIntArray879[local24.anInt10793] = local53 >> 16;
			local24.anIntArray878[local24.anInt10793] = local53 & 0xFFFF;
			...
			local24.aByteArray111[local24.anInt10793] = local71;
			local24.anInt10793++;
		}
	}
}
