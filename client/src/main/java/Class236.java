...
public final class Class236 {
	...
	public Class236(@OriginalArg(0) Class2_Sub21 arg0, @OriginalArg(1) int arg1) {
		this.anInt5985 = arg1;
		@Pc(19) int local19 = arg0.method5205();
		if (local19 == 0) {
			this.anInt5980 = arg0.method5155();
		} else if (local19 == 1) {
			this.anInt5980 = -1;
		} else {
			this.anInt5980 = -1;
	...
	public void method3802(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		if (this.aClass8_Sub2_Sub1_Sub2_Sub2_1 == null) {
			...
			this.aClass8_Sub2_Sub1_Sub2_Sub1_1.method873(arg0, arg2);
		} else {
			this.aClass8_Sub2_Sub1_Sub2_Sub2_1.method6717(true, arg2, arg0, arg1, this.aClass8_Sub2_Sub1_Sub2_Sub2_1.method6693((byte) 44));
		}
	}
	...
	public Class8_Sub2_Sub1_Sub2 method3805() {
	...
	public void method3806(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		if (!this.aBoolean455) {
			...
			if (this.anInt5980 >= 0) {
				...
				this.aClass8_Sub2_Sub1_Sub2_Sub2_1.method6719(Static690.aClass308_2.method4967(this.anInt5980));
				this.aClass8_Sub2_Sub1_Sub2_Sub2_1.method6701(this.aClass8_Sub2_Sub1_Sub2_Sub2_1.aClass268_1.anInt6713);
				...
				this.aClass8_Sub2_Sub1_Sub2_Sub1_1.method874(Static518.aClass2_Sub21_18);
		...
		if (this.anInt5980 < 0) {
			this.aClass8_Sub2_Sub1_Sub2_Sub1_1.aByte144 = this.aClass8_Sub2_Sub1_Sub2_Sub1_1.aByte143 = (byte) arg1;
			this.aClass8_Sub2_Sub1_Sub2_Sub1_1.method873(arg2, arg3);
			this.aClass8_Sub2_Sub1_Sub2_Sub1_1.method6689(arg0, true);
		} else {
			this.aClass8_Sub2_Sub1_Sub2_Sub2_1.method6717(true, arg3, arg2, arg1, this.aClass8_Sub2_Sub1_Sub2_Sub2_1.method6693((byte) 71));
			this.aClass8_Sub2_Sub1_Sub2_Sub2_1.method6689(arg0, true);
		}
	}
}
