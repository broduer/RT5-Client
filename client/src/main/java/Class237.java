...
public final class Class237 {
	...
	public Class237(@OriginalArg(0) Class157[] arg0) {
		for (@Pc(3) int local3 = 0; local3 < arg0.length; local3++) {
			this.method3856(arg0[local3]);
		}
	}

	@OriginalMember(owner = "client!mc", name = "a", descriptor = "(II)I")
	private int method3854(@OriginalArg(1) int arg0) {
	...
	private void method3856(@OriginalArg(0) Class157 arg0) {
	...
	public Class157 method3857(@OriginalArg(1) int arg0) {
		return Static231.method2415(this.method3854(arg0));
	}
}
