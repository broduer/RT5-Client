...
public abstract class Class23_Sub1 extends Class23 {
	...
	public abstract void method5791(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);

	@OriginalMember(owner = "client!qc", name = "a", descriptor = "(IIIIIIIII)V")
	public abstract void method5792(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
	...
	@Override
	protected final void a(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) int arg6, @OriginalArg(7) Class1 arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
		if (this.aClass19_Sub2_10.method2664()) {
			throw new IllegalStateException();
		} else if (this.method5795(arg0, arg1, arg2, arg3, arg4, arg5)) {
			@Pc(22) Class1_Sub1 local22 = (Class1_Sub1) arg7;
			this.method5794(local22.anIntArray334, local22.anIntArray335, Static513.anInt9301 - arg8, -arg9 - (Static513.anInt9297 - Static513.anInt9314));
		}
	}

	@OriginalMember(owner = "client!qc", name = "a", descriptor = "(FFFFFFIIII)V")
	@Override
	protected final void a(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
		if (this.aClass19_Sub2_10.method2664()) {
			throw new IllegalStateException();
		} else if (this.method5795(arg0, arg1, arg2, arg3, arg4, arg5)) {
	...
	@Override
	public final void c(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.anInt9298 = arg0;
		this.anInt9308 = arg1;
		this.anInt9295 = arg2;
		this.anInt9294 = arg3;
	...
	@Override
	public final void b(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		if (this.aClass19_Sub2_10.method2664()) {
			throw new IllegalStateException();
		}
		...
		@Pc(40) int local40 = this.b();
		@Pc(43) int local43 = this.a();
		...
		for (@Pc(61) int local61 = 0; local61 < local59; local61++) {
			...
			for (@Pc(68) int local68 = 0; local68 < local51; local68++) {
				this.a(arg0 + local68 * local40, arg1 + local66, arg4, arg5, arg6);
			}
		}
	...
	protected abstract void method5793(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!qc", name = "a", descriptor = "([I[III)V")
	protected abstract void method5794(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3);

	@OriginalMember(owner = "client!qc", name = "a", descriptor = "(FFFFFF)Z")
	private boolean method5795(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5) {
