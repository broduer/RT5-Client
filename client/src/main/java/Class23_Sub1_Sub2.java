...
public final class Class23_Sub1_Sub2 extends Class23_Sub1 {
	...
	protected void method8216(@OriginalArg(0) int arg0) {
		...
		if (Static513.anInt9347 == 0) {
			if (Static513.anInt9335 == 0) {
					...
					if (local16 >= 0 && local18 >= 0 && local16 - (super.anInt9328 << 12) < 0 && local18 - (super.anInt9332 << 12) < 0) {
						while (local20 < 0) {
							...
							if (arg0 == 1) {
								...
								local223 = this.anIntArray528[local57];
								local227 = (local223 >>> 24) * Static513.anInt9330 >> 8;
								local231 = 256 - local227;
								if ((Static513.anInt9339 & 0xFFFFFF) == 16777215) {
									local235 = local3[local60];
									local3[local60] = ((local223 & 0xFF00FF) * local227 + (local235 & 0xFF00FF) * local231 & 0xFF00FF00) + ((local223 & 0xFF00) * local227 + (local235 & 0xFF00) * local231 & 0xFF0000) >> 8;
								} else if (local227 == 255) {
									local235 = (local223 & 0xFF0000) * Static513.anInt9345 & 0xFF000000;
									local348 = (local223 & 0xFF00) * Static513.anInt9325 & 0xFF0000;
									local356 = (local223 & 0xFF) * Static513.anInt9341 & 0xFF00;
								...
								local356 = (local223 >>> 24) * Static513.anInt9330 >> 8;
								...
								local227 = local223 >>> 24;
								local231 = 256 - local227;
								local235 = (local223 & 0xFF00FF) * Static513.anInt9330 & 0xFF00FF00;
								local348 = (local223 & 0xFF00) * Static513.anInt9330 & 0xFF0000;
								local223 = ((local235 | local348) >>> 8) + Static513.anInt9331;
				...
				while (local11 < 0) {
					...
					if (local16 >= 0 && local16 - (super.anInt9328 << 12) < 0) {
						@Pc(949) int local949;
						if ((local949 = local18 - (super.anInt9332 << 12)) >= 0) {
							local956 = (Static513.anInt9335 - local949) / Static513.anInt9335;
							local20 += local956;
							local18 += Static513.anInt9335 * local956;
							local14 += local956;
						}
						@Pc(977) int local977;
						if ((local977 = (local18 - Static513.anInt9335) / Static513.anInt9335) > local20) {
							local20 = local977;
						}
						while (local20 < 0) {
							local57 = (local18 >> 12) * super.anInt9328 + (local16 >> 12);
				...
				while (local11 < 0) {
					...
					if (local16 >= 0 && local16 - (super.anInt9328 << 12) < 0) {
						if (local18 < 0) {
							local956 = (Static513.anInt9335 - local18 - 1) / Static513.anInt9335;
							local20 += local956;
							local18 += Static513.anInt9335 * local956;
							local14 += local956;
						}
						@Pc(1923) int local1923;
						if ((local1923 = (local18 + 1 - (super.anInt9332 << 12) - Static513.anInt9335) / Static513.anInt9335) > local20) {
							local20 = local1923;
						}
						while (local20 < 0) {
							local57 = (local18 >> 12) * super.anInt9328 + (local16 >> 12);
			...
			if (Static513.anInt9335 == 0) {
				...
				while (local11 < 0) {
					...
					if (local18 >= 0 && local18 - (super.anInt9332 << 12) < 0) {
						...
						if ((local2843 = local16 - (super.anInt9328 << 12)) >= 0) {
							local956 = (Static513.anInt9347 - local2843) / Static513.anInt9347;
							local20 += local956;
							local16 += Static513.anInt9347 * local956;
							local14 += local956;
						}
						@Pc(2871) int local2871;
						if ((local2871 = (local16 - Static513.anInt9347) / Static513.anInt9347) > local20) {
							local20 = local2871;
						}
						while (local20 < 0) {
							local57 = (local18 >> 12) * super.anInt9328 + (local16 >> 12);
				...
				while (local11 < 0) {
					...
					if ((local3778 = local16 - (super.anInt9328 << 12)) >= 0) {
						local956 = (Static513.anInt9347 - local3778) / Static513.anInt9347;
						local20 += local956;
						local16 += Static513.anInt9347 * local956;
						local18 += Static513.anInt9335 * local956;
						local14 += local956;
					...
					if ((local3812 = (local16 - Static513.anInt9347) / Static513.anInt9347) > local20) {
						local20 = local3812;
					}
					@Pc(3824) int local3824;
					if ((local3824 = local18 - (super.anInt9332 << 12)) >= 0) {
						local956 = (Static513.anInt9335 - local3824) / Static513.anInt9335;
						local20 += local956;
						local16 += Static513.anInt9347 * local956;
						local18 += Static513.anInt9335 * local956;
						local14 += local956;
					...
					if ((local3858 = (local18 - Static513.anInt9335) / Static513.anInt9335) > local20) {
						local20 = local3858;
					}
					while (local20 < 0) {
						local57 = (local18 >> 12) * super.anInt9328 + (local16 >> 12);
				...
				while (local11 < 0) {
					...
					if ((local4771 = local16 - (super.anInt9328 << 12)) >= 0) {
						local956 = (Static513.anInt9347 - local4771) / Static513.anInt9347;
						local20 += local956;
						local16 += Static513.anInt9347 * local956;
						local18 += Static513.anInt9335 * local956;
						local14 += local956;
					...
					if ((local4805 = (local16 - Static513.anInt9347) / Static513.anInt9347) > local20) {
						local20 = local4805;
					}
					if (local18 < 0) {
						local956 = (Static513.anInt9335 - local18 - 1) / Static513.anInt9335;
					...
					if ((local4853 = (local18 + 1 - (super.anInt9332 << 12) - Static513.anInt9335) / Static513.anInt9335) > local20) {
						local20 = local4853;
					}
					while (local20 < 0) {
						local57 = (local18 >> 12) * super.anInt9328 + (local16 >> 12);
			...
			while (local11 < 0) {
				...
				if (local18 >= 0 && local18 - (super.anInt9332 << 12) < 0) {
					if (local16 < 0) {
						local956 = (Static513.anInt9347 - local16 - 1) / Static513.anInt9347;
						local20 += local956;
						local16 += Static513.anInt9347 * local956;
						local14 += local956;
					}
					@Pc(5809) int local5809;
					if ((local5809 = (local16 + 1 - (super.anInt9328 << 12) - Static513.anInt9347) / Static513.anInt9347) > local20) {
						local20 = local5809;
					}
					while (local20 < 0) {
						local57 = (local18 >> 12) * super.anInt9328 + (local16 >> 12);
			...
			for (local11 = Static513.anInt9323; local11 < 0; local11++) {
				...
				if ((local6756 = (local16 + 1 - (super.anInt9328 << 12) - Static513.anInt9347) / Static513.anInt9347) > local20) {
					local20 = local6756;
				}
				@Pc(6768) int local6768;
				if ((local6768 = local18 - (super.anInt9332 << 12)) >= 0) {
					local956 = (Static513.anInt9335 - local6768) / Static513.anInt9335;
					local20 += local956;
					local16 += Static513.anInt9347 * local956;
					local18 += Static513.anInt9335 * local956;
					local14 += local956;
				...
				if ((local6802 = (local18 - Static513.anInt9335) / Static513.anInt9335) > local20) {
					local20 = local6802;
				}
				while (local20 < 0) {
					local57 = (local18 >> 12) * super.anInt9328 + (local16 >> 12);
			...
			for (local11 = Static513.anInt9323; local11 < 0; local11++) {
				...
				if ((local7751 = (local16 + 1 - (super.anInt9328 << 12) - Static513.anInt9347) / Static513.anInt9347) > local20) {
					local20 = local7751;
				}
				if (local18 < 0) {
					local956 = (Static513.anInt9335 - local18 - 1) / Static513.anInt9335;
				...
				if ((local7799 = (local18 + 1 - (super.anInt9332 << 12) - Static513.anInt9335) / Static513.anInt9335) > local20) {
					local20 = local7799;
				}
				while (local20 < 0) {
					local57 = (local18 >> 12) * super.anInt9328 + (local16 >> 12);
	...
	public void method8203() {
		...
		for (@Pc(205) int local205 = 0; local205 < super.anInt9332; local205++) {
		...
		if (Static513.anInt9347 == 0) {
			if (Static513.anInt9335 == 0) {
				...
				while (local11 < 0) {
					...
					if (local16 >= 0) {
						...
						if (local30 >= 0 && local32 >= 0 && local30 - (super.anInt9328 << 12) < 0 && local32 - (super.anInt9332 << 12) < 0) {
							...
							while (local34 < 0) {
								local122 = this.anIntArray528[(local32 >> 12) * super.anInt9328 + (local30 >> 12)];
				...
				while (local11 < 0) {
					...
					if (local16 >= 0) {
						...
						if (local30 >= 0 && local30 - (super.anInt9328 << 12) < 0) {
							@Pc(229) int local229;
							if ((local229 = local32 - (super.anInt9332 << 12)) >= 0) {
								local236 = (Static513.anInt9335 - local229) / Static513.anInt9335;
								local34 += local236;
								local32 += Static513.anInt9335 * local236;
								local28 += local236;
							}
							@Pc(257) int local257;
							if ((local257 = (local32 - Static513.anInt9335) / Static513.anInt9335) > local34) {
								local34 = local257;
							}
							local64 = arg0[local16] - arg2;
							local69 = -arg1[local16];
				...
				while (local11 < 0) {
					...
					if (local16 >= 0) {
						...
						if (local30 >= 0 && local30 - (super.anInt9328 << 12) < 0) {
							if (local32 < 0) {
								local236 = (Static513.anInt9335 - local32 - 1) / Static513.anInt9335;
								local34 += local236;
								local32 += Static513.anInt9335 * local236;
								local28 += local236;
							}
							@Pc(470) int local470;
							if ((local470 = (local32 + 1 - (super.anInt9332 << 12) - Static513.anInt9335) / Static513.anInt9335) > local34) {
								local34 = local470;
							}
							local64 = arg0[local16] - arg2;
							local69 = -arg1[local16];
			...
			if (Static513.anInt9335 == 0) {
				...
				while (local11 < 0) {
					...
					if (local16 >= 0) {
						...
						if (local32 >= 0 && local32 - (super.anInt9332 << 12) < 0) {
							@Pc(657) int local657;
							if ((local657 = local30 - (super.anInt9328 << 12)) >= 0) {
								local236 = (Static513.anInt9347 - local657) / Static513.anInt9347;
								local34 += local236;
								local30 += Static513.anInt9347 * local236;
								local28 += local236;
							}
							@Pc(685) int local685;
							if ((local685 = (local30 - Static513.anInt9347) / Static513.anInt9347) > local34) {
								local34 = local685;
							}
							local64 = arg0[local16] - arg2;
							local69 = -arg1[local16];
				...
				while (local11 < 0) {
					...
					if (local16 >= 0) {
						...
						local34 = Static513.anInt9329;
						@Pc(859) int local859;
						if ((local859 = local30 - (super.anInt9328 << 12)) >= 0) {
							local236 = (Static513.anInt9347 - local859) / Static513.anInt9347;
							local34 += local236;
							local30 += Static513.anInt9347 * local236;
							local32 += Static513.anInt9335 * local236;
							local28 += local236;
						...
						@Pc(893) int local893;
						if ((local893 = (local30 - Static513.anInt9347) / Static513.anInt9347) > local34) {
							local34 = local893;
						}
						@Pc(905) int local905;
						if ((local905 = local32 - (super.anInt9332 << 12)) >= 0) {
							local236 = (Static513.anInt9335 - local905) / Static513.anInt9335;
							local34 += local236;
							local30 += Static513.anInt9347 * local236;
							local32 += Static513.anInt9335 * local236;
							local28 += local236;
						...
						@Pc(939) int local939;
						if ((local939 = (local32 - Static513.anInt9335) / Static513.anInt9335) > local34) {
							local34 = local939;
						}
						local64 = arg0[local16] - arg2;
						local69 = -arg1[local16];
				...
				while (local11 < 0) {
					...
					if (local16 >= 0) {
						...
						if ((local1119 = local30 - (super.anInt9328 << 12)) >= 0) {
							local236 = (Static513.anInt9347 - local1119) / Static513.anInt9347;
							local34 += local236;
							local30 += Static513.anInt9347 * local236;
							local32 += Static513.anInt9335 * local236;
							local28 += local236;
						...
						if ((local1153 = (local30 - Static513.anInt9347) / Static513.anInt9347) > local34) {
							local34 = local1153;
						}
						if (local32 < 0) {
							local236 = (Static513.anInt9335 - local32 - 1) / Static513.anInt9335;
						...
						if ((local1201 = (local32 + 1 - (super.anInt9332 << 12) - Static513.anInt9335) / Static513.anInt9335) > local34) {
							local34 = local1201;
						}
						local64 = arg0[local16] - arg2;
						local69 = -arg1[local16];
			...
			while (local11 < 0) {
				...
				if (local16 >= 0) {
					...
					if (local32 >= 0 && local32 - (super.anInt9332 << 12) < 0) {
						if (local30 < 0) {
							local236 = (Static513.anInt9347 - local30 - 1) / Static513.anInt9347;
							local34 += local236;
							local30 += Static513.anInt9347 * local236;
							local28 += local236;
						}
						@Pc(1424) int local1424;
						if ((local1424 = (local30 + 1 - (super.anInt9328 << 12) - Static513.anInt9347) / Static513.anInt9347) > local34) {
							local34 = local1424;
						}
						local64 = arg0[local16] - arg2;
						local69 = -arg1[local16];
			...
			while (local11 < 0) {
				...
				if (local16 >= 0) {
					...
					if ((local1638 = (local30 + 1 - (super.anInt9328 << 12) - Static513.anInt9347) / Static513.anInt9347) > local34) {
						local34 = local1638;
					}
					@Pc(1650) int local1650;
					if ((local1650 = local32 - (super.anInt9332 << 12)) >= 0) {
						local236 = (Static513.anInt9335 - local1650) / Static513.anInt9335;
						local34 += local236;
						local30 += Static513.anInt9347 * local236;
						local32 += Static513.anInt9335 * local236;
						local28 += local236;
					...
					if ((local1684 = (local32 - Static513.anInt9335) / Static513.anInt9335) > local34) {
						local34 = local1684;
					}
					local64 = arg0[local16] - arg2;
					local69 = -arg1[local16];
			...
			while (local11 < 0) {
				...
				if (local16 >= 0) {
					...
					if ((local1900 = (local30 + 1 - (super.anInt9328 << 12) - Static513.anInt9347) / Static513.anInt9347) > local34) {
						local34 = local1900;
					}
					if (local32 < 0) {
						local236 = (Static513.anInt9335 - local32 - 1) / Static513.anInt9335;
					...
					if ((local1948 = (local32 + 1 - (super.anInt9332 << 12) - Static513.anInt9335) / Static513.anInt9335) > local34) {
						local34 = local1948;
					}
					local64 = arg0[local16] - arg2;
					local69 = -arg1[local16];
