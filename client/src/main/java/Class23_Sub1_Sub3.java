...
public final class Class23_Sub1_Sub3 extends Class23_Sub1 {
	...
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (super.aClass19_Sub2_10.method2664()) {
					...
					for (local174 = -local33; local174 < 0; local174++) {
						for (local181 = -local36; local181 < 0; local181++) {
							...
							if (local556 == 0) {
								...
								@Pc(569) short local569 = 255;
								@Pc(571) byte local571 = 0;
								local319 = local164[local28];
								local164[local28++] = ((local295 & 0xFF00FF) * local569 + (local319 & 0xFF00FF) * local571 >> 8 & 0xFFFF00FF) + (((local295 & 0xFF00FF00) >>> 8) * local569 + ((local319 & 0xFF00FF00) >>> 8) * local571 & 0xFF00FF00);
							}
						}
						local28 += local40;
						local30 += local42;
	...
	@Override
	protected void method5794(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	@Override
	protected void method5793(@OriginalArg(0) int arg0) {
		@Pc(3) int[] local3 = super.aClass19_Sub2_10.anIntArray319;
		@Pc(963) int local963;
		@Pc(11) int local11;
		@Pc(14) int local14;
	...
	@Override
	public void method5792(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (arg3 <= 0 || arg4 <= 0) {
			return;
		}
		@Pc(9) int local9 = 0;
	...
	@Override
	public void method5791(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (arg3 <= 0 || arg4 <= 0) {
			return;
		}
		@Pc(9) int local9 = 0;
