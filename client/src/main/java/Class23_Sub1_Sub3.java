		...
		if (Static513.anInt9347 == 0) {
			if (Static513.anInt9335 == 0) {
				...
				while (local11 < 0) {
					...
					if (local16 >= 0) {
						...
						if (local30 >= 0 && local32 >= 0 && local30 - (super.anInt9328 << 12) < 0 && local32 - (super.anInt9332 << 12) < 0) {
							...
							while (local34 < 0) {
								local122 = this.aByteArray100[(local32 >> 12) * super.anInt9328 + (local30 >> 12)];
								if (local122 == 0) {
									local28++;
								} else {
				...
				while (local11 < 0) {
					...
					if (local16 >= 0) {
						...
						if (local30 >= 0 && local30 - (super.anInt9328 << 12) < 0) {
							@Pc(199) int local199;
							if ((local199 = local32 - (super.anInt9332 << 12)) >= 0) {
								local206 = (Static513.anInt9335 - local199) / Static513.anInt9335;
								local34 += local206;
								local32 += Static513.anInt9335 * local206;
								local28 += local206;
							}
							@Pc(227) int local227;
							if ((local227 = (local32 - Static513.anInt9335) / Static513.anInt9335) > local34) {
								local34 = local227;
							}
							local64 = arg0[local16] - arg2;
							local69 = -arg1[local16];
				...
				while (local11 < 0) {
					...
					if (local16 >= 0) {
						...
						if (local30 >= 0 && local30 - (super.anInt9328 << 12) < 0) {
							if (local32 < 0) {
								local206 = (Static513.anInt9335 - local32 - 1) / Static513.anInt9335;
								local34 += local206;
								local32 += Static513.anInt9335 * local206;
								local28 += local206;
							}
							@Pc(410) int local410;
							if ((local410 = (local32 + 1 - (super.anInt9332 << 12) - Static513.anInt9335) / Static513.anInt9335) > local34) {
								local34 = local410;
							}
							local64 = arg0[local16] - arg2;
							local69 = -arg1[local16];
			...
			if (Static513.anInt9335 == 0) {
				...
				while (local11 < 0) {
					...
					if (local16 >= 0) {
						...
						if (local32 >= 0 && local32 - (super.anInt9332 << 12) < 0) {
							@Pc(567) int local567;
							if ((local567 = local30 - (super.anInt9328 << 12)) >= 0) {
								local206 = (Static513.anInt9347 - local567) / Static513.anInt9347;
								local34 += local206;
								local30 += Static513.anInt9347 * local206;
								local28 += local206;
							}
							@Pc(595) int local595;
							if ((local595 = (local30 - Static513.anInt9347) / Static513.anInt9347) > local34) {
								local34 = local595;
							}
							local64 = arg0[local16] - arg2;
							local69 = -arg1[local16];
				...
				while (local11 < 0) {
					...
					if (local16 >= 0) {
						...
						local34 = Static513.anInt9329;
						@Pc(739) int local739;
						if ((local739 = local30 - (super.anInt9328 << 12)) >= 0) {
							local206 = (Static513.anInt9347 - local739) / Static513.anInt9347;
							local34 += local206;
							local30 += Static513.anInt9347 * local206;
							local32 += Static513.anInt9335 * local206;
							local28 += local206;
						...
						@Pc(773) int local773;
						if ((local773 = (local30 - Static513.anInt9347) / Static513.anInt9347) > local34) {
							local34 = local773;
						}
						@Pc(785) int local785;
						if ((local785 = local32 - (super.anInt9332 << 12)) >= 0) {
							local206 = (Static513.anInt9335 - local785) / Static513.anInt9335;
							local34 += local206;
							local30 += Static513.anInt9347 * local206;
							local32 += Static513.anInt9335 * local206;
							local28 += local206;
						...
						@Pc(819) int local819;
						if ((local819 = (local32 - Static513.anInt9335) / Static513.anInt9335) > local34) {
							local34 = local819;
						}
						local64 = arg0[local16] - arg2;
						local69 = -arg1[local16];
				...
				while (local11 < 0) {
					...
					if (local16 >= 0) {
						...
						local34 = Static513.anInt9329;
						@Pc(969) int local969;
						if ((local969 = local30 - (super.anInt9328 << 12)) >= 0) {
							local206 = (Static513.anInt9347 - local969) / Static513.anInt9347;
							local34 += local206;
							local30 += Static513.anInt9347 * local206;
							local32 += Static513.anInt9335 * local206;
							local28 += local206;
						...
						if ((local1003 = (local30 - Static513.anInt9347) / Static513.anInt9347) > local34) {
							local34 = local1003;
						}
						if (local32 < 0) {
							local206 = (Static513.anInt9335 - local32 - 1) / Static513.anInt9335;
						...
						if ((local1051 = (local32 + 1 - (super.anInt9332 << 12) - Static513.anInt9335) / Static513.anInt9335) > local34) {
							local34 = local1051;
						}
						local64 = arg0[local16] - arg2;
						local69 = -arg1[local16];
			...
			while (local11 < 0) {
				...
				if (local16 >= 0) {
					...
					if (local32 >= 0 && local32 - (super.anInt9332 << 12) < 0) {
						if (local30 < 0) {
							local206 = (Static513.anInt9347 - local30 - 1) / Static513.anInt9347;
							local34 += local206;
							local30 += Static513.anInt9347 * local206;
							local28 += local206;
						}
						@Pc(1244) int local1244;
						if ((local1244 = (local30 + 1 - (super.anInt9328 << 12) - Static513.anInt9347) / Static513.anInt9347) > local34) {
							local34 = local1244;
						}
						local64 = arg0[local16] - arg2;
						local69 = -arg1[local16];
			...
			while (local11 < 0) {
				...
				if (local16 >= 0) {
					...
					if ((local1428 = (local30 + 1 - (super.anInt9328 << 12) - Static513.anInt9347) / Static513.anInt9347) > local34) {
						local34 = local1428;
					}
					@Pc(1440) int local1440;
					if ((local1440 = local32 - (super.anInt9332 << 12)) >= 0) {
						local206 = (Static513.anInt9335 - local1440) / Static513.anInt9335;
						local34 += local206;
						local30 += Static513.anInt9347 * local206;
						local32 += Static513.anInt9335 * local206;
						local28 += local206;
					...
					if ((local1474 = (local32 - Static513.anInt9335) / Static513.anInt9335) > local34) {
						local34 = local1474;
					}
					local64 = arg0[local16] - arg2;
					local69 = -arg1[local16];
			...
			while (local11 < 0) {
				...
				if (local16 >= 0) {
					...
					if ((local1660 = (local30 + 1 - (super.anInt9328 << 12) - Static513.anInt9347) / Static513.anInt9347) > local34) {
						local34 = local1660;
					}
					if (local32 < 0) {
						local206 = (Static513.anInt9335 - local32 - 1) / Static513.anInt9335;
					...
					if ((local1708 = (local32 + 1 - (super.anInt9332 << 12) - Static513.anInt9335) / Static513.anInt9335) > local34) {
						local34 = local1708;
					}
					local64 = arg0[local16] - arg2;
					local69 = -arg1[local16];
	...
	protected void method8216(@OriginalArg(0) int arg0) {
		...
		if (Static513.anInt9347 == 0) {
			if (Static513.anInt9335 == 0) {
							...
							if (arg0 == 1) {
								...
								if (local241 != 0) {
									...
									if ((Static513.anInt9339 & 0xFFFFFF) == 16777215) {
										local279 = Static513.anInt9339 >>> 24;
										...
										local279 = (local270 & 0xFF0000) * Static513.anInt9345 & 0xFF000000;
										local283 = (local270 & 0xFF00) * Static513.anInt9325 & 0xFF0000;
										local287 = (local270 & 0xFF) * Static513.anInt9341 & 0xFF00;
										...
										local3[local60] = ((local270 & 0xFF00FF) * Static513.anInt9330 + (local359 & 0xFF00FF) * Static513.anInt9338 & 0xFF00FF00) + ((local270 & 0xFF00) * Static513.anInt9330 + (local359 & 0xFF00) * Static513.anInt9338 & 0xFF0000) >> 8;
									}
								}
							} else if (arg0 == 3) {
								local241 = this.aByteArray100[local57];
								local270 = local241 > 0 ? this.anIntArray714[local241] : 0;
								local279 = Static513.anInt9339;
								...
								if (local270 == 0 && Static513.anInt9330 != 255) {
									local270 = local359;
									local359 = local3[local60];
									local359 = ((local270 & 0xFF00FF) * Static513.anInt9330 + (local359 & 0xFF00FF) * Static513.anInt9338 & 0xFF00FF00) + ((local270 & 0xFF00) * Static513.anInt9330 + (local359 & 0xFF00) * Static513.anInt9338 & 0xFF0000) >> 8;
								}
								...
								if (local241 != 0) {
									local270 = this.anIntArray714[local241 & 0xFF];
									local279 = (local270 & 0xFF00FF) * Static513.anInt9330 & 0xFF00FF00;
									local283 = (local270 & 0xFF00) * Static513.anInt9330 & 0xFF0000;
									local3[local60++] = ((local279 | local283) >>> 8) + Static513.anInt9331;
								}
							} else {
								throw new IllegalArgumentException();
							}
				...
				while (local11 < 0) {
					...
					if (local16 >= 0 && local16 - (super.anInt9328 << 12) < 0) {
						@Pc(956) int local956;
						if ((local956 = local18 - (super.anInt9332 << 12)) >= 0) {
							local963 = (Static513.anInt9335 - local956) / Static513.anInt9335;
							local20 += local963;
							local18 += Static513.anInt9335 * local963;
							local14 += local963;
						}
						@Pc(984) int local984;
						if ((local984 = (local18 - Static513.anInt9335) / Static513.anInt9335) > local20) {
							local20 = local984;
						}
						while (local20 < 0) {
							local57 = (local18 >> 12) * super.anInt9328 + (local16 >> 12);
				...
				while (local11 < 0) {
					...
					if (local16 >= 0 && local16 - (super.anInt9328 << 12) < 0) {
						if (local18 < 0) {
							local963 = (Static513.anInt9335 - local18 - 1) / Static513.anInt9335;
							local20 += local963;
							local18 += Static513.anInt9335 * local963;
							local14 += local963;
						}
						@Pc(1937) int local1937;
						if ((local1937 = (local18 + 1 - (super.anInt9332 << 12) - Static513.anInt9335) / Static513.anInt9335) > local20) {
							local20 = local1937;
						}
						while (local20 < 0) {
							local57 = (local18 >> 12) * super.anInt9328 + (local16 >> 12);
			...
			if (Static513.anInt9335 == 0) {
				...
				while (local11 < 0) {
					...
					if (local18 >= 0 && local18 - (super.anInt9332 << 12) < 0) {
						...
						if ((local2864 = local16 - (super.anInt9328 << 12)) >= 0) {
							local963 = (Static513.anInt9347 - local2864) / Static513.anInt9347;
							local20 += local963;
							local16 += Static513.anInt9347 * local963;
							local14 += local963;
						}
						@Pc(2892) int local2892;
						if ((local2892 = (local16 - Static513.anInt9347) / Static513.anInt9347) > local20) {
							local20 = local2892;
						}
						while (local20 < 0) {
							local57 = (local18 >> 12) * super.anInt9328 + (local16 >> 12);
				...
				while (local11 < 0) {
					...
					if ((local3806 = local16 - (super.anInt9328 << 12)) >= 0) {
						local963 = (Static513.anInt9347 - local3806) / Static513.anInt9347;
						local20 += local963;
						local16 += Static513.anInt9347 * local963;
						local18 += Static513.anInt9335 * local963;
						local14 += local963;
					...
					if ((local3840 = (local16 - Static513.anInt9347) / Static513.anInt9347) > local20) {
						local20 = local3840;
					}
					@Pc(3852) int local3852;
					if ((local3852 = local18 - (super.anInt9332 << 12)) >= 0) {
						local963 = (Static513.anInt9335 - local3852) / Static513.anInt9335;
						local20 += local963;
						local16 += Static513.anInt9347 * local963;
						local18 += Static513.anInt9335 * local963;
						local14 += local963;
					...
					if ((local3886 = (local18 - Static513.anInt9335) / Static513.anInt9335) > local20) {
						local20 = local3886;
					}
					while (local20 < 0) {
						local57 = (local18 >> 12) * super.anInt9328 + (local16 >> 12);
				...
				while (local11 < 0) {
					...
					if ((local4806 = local16 - (super.anInt9328 << 12)) >= 0) {
						local963 = (Static513.anInt9347 - local4806) / Static513.anInt9347;
						local20 += local963;
						local16 += Static513.anInt9347 * local963;
						local18 += Static513.anInt9335 * local963;
						local14 += local963;
					...
					if ((local4840 = (local16 - Static513.anInt9347) / Static513.anInt9347) > local20) {
						local20 = local4840;
					}
					if (local18 < 0) {
						local963 = (Static513.anInt9335 - local18 - 1) / Static513.anInt9335;
					...
					if ((local4888 = (local18 + 1 - (super.anInt9332 << 12) - Static513.anInt9335) / Static513.anInt9335) > local20) {
						local20 = local4888;
					}
					while (local20 < 0) {
						local57 = (local18 >> 12) * super.anInt9328 + (local16 >> 12);
			...
			while (local11 < 0) {
				...
				if (local18 >= 0 && local18 - (super.anInt9332 << 12) < 0) {
					if (local16 < 0) {
						local963 = (Static513.anInt9347 - local16 - 1) / Static513.anInt9347;
						local20 += local963;
						local16 += Static513.anInt9347 * local963;
						local14 += local963;
					}
					@Pc(5851) int local5851;
					if ((local5851 = (local16 + 1 - (super.anInt9328 << 12) - Static513.anInt9347) / Static513.anInt9347) > local20) {
						local20 = local5851;
					}
					while (local20 < 0) {
						local57 = (local18 >> 12) * super.anInt9328 + (local16 >> 12);
			...
			for (local11 = Static513.anInt9323; local11 < 0; local11++) {
				...
				if ((local6805 = (local16 + 1 - (super.anInt9328 << 12) - Static513.anInt9347) / Static513.anInt9347) > local20) {
					local20 = local6805;
				}
				@Pc(6817) int local6817;
				if ((local6817 = local18 - (super.anInt9332 << 12)) >= 0) {
					local963 = (Static513.anInt9335 - local6817) / Static513.anInt9335;
					local20 += local963;
					local16 += Static513.anInt9347 * local963;
					local18 += Static513.anInt9335 * local963;
					local14 += local963;
				...
				if ((local6851 = (local18 - Static513.anInt9335) / Static513.anInt9335) > local20) {
					local20 = local6851;
				}
				while (local20 < 0) {
					local57 = (local18 >> 12) * super.anInt9328 + (local16 >> 12);
			...
			for (local11 = Static513.anInt9323; local11 < 0; local11++) {
				...
				if ((local7807 = (local16 + 1 - (super.anInt9328 << 12) - Static513.anInt9347) / Static513.anInt9347) > local20) {
					local20 = local7807;
				}
				if (local18 < 0) {
					local963 = (Static513.anInt9335 - local18 - 1) / Static513.anInt9335;
				...
				if ((local7855 = (local18 + 1 - (super.anInt9332 << 12) - Static513.anInt9335) / Static513.anInt9335) > local20) {
					local20 = local7855;
				}
				while (local20 < 0) {
					local57 = (local18 >> 12) * super.anInt9328 + (local16 >> 12);
		...
		if (arg7 != 0) {
			...
			if (arg7 == 1) {
					...
					if (arg5 == 0) {
						...
						if ((arg6 & 0xFFFFFF) == 16777215) {
							...
							for (local276 = -arg4; local276 < 0; local276++) {
								local353 = (local11 >> 16) * super.anInt9328;
							...
							for (local364 = -arg4; local364 < 0; local364++) {
								local386 = (local11 >> 16) * super.anInt9328;
						...
						for (local361 = -arg4; local361 < 0; local361++) {
							local364 = (local11 >> 16) * super.anInt9328;
				...
				for (local353 = -arg4; local353 < 0; local353++) {
					local361 = (local11 >> 16) * super.anInt9328;
			...
			if (arg6 != 0) {
				...
				if (arg6 == 1) {
						...
						if (arg4 == 0) {
							...
							if ((arg5 & 0xFFFFFF) == 16777215) {
								...
								for (local279 = -arg3; local279 < 0; local279++) {
									local342 = (local20 >> 16) * super.anInt9328;
								...
								for (local353 = -arg3; local353 < 0; local353++) {
									local368 = (local20 >> 16) * super.anInt9328;
							...
							for (local350 = -arg3; local350 < 0; local350++) {
								local353 = (local20 >> 16) * super.anInt9328;
					...
					for (local342 = -arg3; local342 < 0; local342++) {
						local350 = (local20 >> 16) * super.anInt9328;
