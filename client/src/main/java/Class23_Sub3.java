...
public final class Class23_Sub3 extends Class23 {
	...
	public Class23_Sub3(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		...
		this.anInterface18_3 = arg0.method5676(arg3 ? Static172.aClass92_8 : Static685.aClass92_16, Static702.aClass397_16, arg2, arg1);
		this.anInterface18_3.method6486(true, true);
		this.aBoolean494 = this.anInterface18_3.method6479() != arg1;
		this.aBoolean495 = this.anInterface18_3.method6481() != arg2;
		this.aBoolean492 = !this.aBoolean494 && this.anInterface18_3.method6483();
		this.aBoolean496 = !this.aBoolean495 && this.anInterface18_3.method6483();
	}
	...
	public Class23_Sub3(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		this.anInt6606 = arg2;
		this.aClass19_Sub1_12 = arg0;
		this.anInterface18_3 = arg0.method5752(arg1, arg3, arg4, arg5, false, arg2);
		this.anInterface18_3.method6486(true, true);
		this.aBoolean494 = this.anInterface18_3.method6479() != arg1;
		this.aBoolean495 = arg2 != this.anInterface18_3.method6481();
		this.aBoolean492 = !this.aBoolean494 && this.anInterface18_3.method6483();
		this.aBoolean496 = !this.aBoolean495 && this.anInterface18_3.method6483();
	}

	@OriginalMember(owner = "client!np", name = "a", descriptor = "(IIII[III)V")
	private void method4180(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[] arg4, @OriginalArg(6) int arg5) {
		this.anInterface18_3.method6482(arg4, arg0, arg1, arg3, arg2, arg5);
	}
	...
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class1 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		this.anInterface18_3.method6475(Static363.aClass259_14);
		this.aClass19_Sub1_12.method5708();
		this.aClass19_Sub1_12.method5697(this.anInterface18_3);
		this.aClass19_Sub1_12.method5662(1);
		this.aClass19_Sub1_12.method5663(1);
		@Pc(49) Class73_Sub1 local49 = this.aClass19_Sub1_12.method5649();
		local49.method1200(0.0F, (float) this.anInt6606, (float) this.anInt6626);
		local49.b(local14, local19, 0);
		this.aClass19_Sub1_12.method5651();
		@Pc(73) Class73_Sub1 local73 = this.aClass19_Sub1_12.method5691();
		local73.method1200(1.0F, this.anInterface18_3.method6484((float) this.anInt6606), this.anInterface18_3.method6480((float) this.anInt6626));
		this.aClass19_Sub1_12.method5682(Static431.aClass370_5);
		this.aClass19_Sub1_12.method5747(1);
		this.aClass19_Sub1_12.method5697(local9);
		this.aClass19_Sub1_12.method5703(Static209.aClass121_4, Static185.aClass121_3);
		this.aClass19_Sub1_12.method5689(0, Static188.aClass168_1);
		@Pc(123) Class73_Sub1 local123 = this.aClass19_Sub1_12.method5691();
		local123.method1200(1.0F, local9.method6484((float) this.anInt6606), local9.method6480((float) this.anInt6626));
		local123.method1198(0.0F, local9.method6484((float) (local19 - arg4)), local9.method6480((float) (local14 - arg3)));
		this.aClass19_Sub1_12.method5682(Static431.aClass370_5);
		this.aClass19_Sub1_12.method5668();
		this.aClass19_Sub1_12.method5640();
		this.aClass19_Sub1_12.method5689(0, Static189.aClass168_2);
		this.aClass19_Sub1_12.method5703(Static209.aClass121_4, Static209.aClass121_4);
		this.aClass19_Sub1_12.method5697((Interface17) null);
		this.aClass19_Sub1_12.method5747(0);
		this.aClass19_Sub1_12.method5640();
	}
	...
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(8) Class73_Sub1 local8 = this.aClass19_Sub1_12.method5649();
		@Pc(13) Class73_Sub1 local13 = this.aClass19_Sub1_12.method5691();
		@Pc(18) int local18 = arg1 + this.anInt6624;
		@Pc(23) int local23 = arg0 + this.anInt6617;
		this.anInterface18_3.method6475(Static363.aClass259_14);
		this.aClass19_Sub1_12.method5708();
		this.aClass19_Sub1_12.method5697(this.anInterface18_3);
		this.aClass19_Sub1_12.method5662(arg4);
		this.aClass19_Sub1_12.method5663(arg2);
		this.aClass19_Sub1_12.method5689(1, Static454.aClass168_5);
		this.aClass19_Sub1_12.method5751(Static454.aClass168_5, 1);
		this.aClass19_Sub1_12.method5721(arg3);
		local8.method1200(0.0F, (float) this.anInt6606, (float) this.anInt6626);
		local8.b(local23, local18, 0);
		local13.method1200(1.0F, this.anInterface18_3.method6484((float) this.anInt6606), this.anInterface18_3.method6480((float) this.anInt6626));
		this.aClass19_Sub1_12.method5682(Static431.aClass370_5);
		this.aClass19_Sub1_12.method5651();
		this.aClass19_Sub1_12.method5668();
		this.aClass19_Sub1_12.method5640();
		this.aClass19_Sub1_12.method5689(1, Static188.aClass168_1);
		this.aClass19_Sub1_12.method5751(Static188.aClass168_1, 1);
	}
	...
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		if (local13 != null) {
			...
			this.method4180(arg0, arg1, arg2, arg3, local13, arg2);
		}
	}
	...
	public void b(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(10) Class73_Sub1 local10 = this.aClass19_Sub1_12.method5649();
		@Pc(15) Class73_Sub1 local15 = this.aClass19_Sub1_12.method5691();
		this.anInterface18_3.method6475(Static363.aClass259_14);
		this.aClass19_Sub1_12.method5708();
		this.aClass19_Sub1_12.method5697(this.anInterface18_3);
		this.aClass19_Sub1_12.method5662(arg6);
		this.aClass19_Sub1_12.method5663(arg4);
		this.aClass19_Sub1_12.method5689(1, Static454.aClass168_5);
		this.aClass19_Sub1_12.method5751(Static454.aClass168_5, 1);
		this.aClass19_Sub1_12.method5721(arg5);
		...
		if (local96 & local75) {
			local15.method1200(1.0F, this.anInterface18_3.method6484((float) arg3), this.anInterface18_3.method6480((float) arg2));
			local10.method1200(0.0F, (float) arg3, (float) arg2);
			local10.b(arg0, arg1, 0);
			this.aClass19_Sub1_12.method5682(Static431.aClass370_5);
			this.aClass19_Sub1_12.method5651();
			this.aClass19_Sub1_12.method5668();
		} else {
			...
			if (local96) {
				local155 = arg1 + arg3;
				local158 = this.a();
				local15.method1200(1.0F, this.anInterface18_3.method6484((float) this.anInt6606), this.anInterface18_3.method6480((float) arg2));
				this.aClass19_Sub1_12.method5682(Static431.aClass370_5);
				local185 = this.anInt6624 + arg1;
				local191 = local185 + this.anInt6606;
				while (local191 <= local155) {
					local10.method1200(0.0F, (float) this.anInt6606, (float) arg2);
					local10.b(arg0, local185, 0);
					this.aClass19_Sub1_12.method5651();
					local191 += local158;
					local185 += local158;
					this.aClass19_Sub1_12.method5668();
				...
				if (local155 > local185) {
					...
					local15.method1200(1.0F, this.anInterface18_3.method6484((float) local246), this.anInterface18_3.method6480((float) arg2));
					this.aClass19_Sub1_12.method5682(Static431.aClass370_5);
					local10.method1200(0.0F, (float) local246, (float) arg2);
					local10.b(arg0, local185, 0);
					this.aClass19_Sub1_12.method5651();
					this.aClass19_Sub1_12.method5668();
				}
				...
				local155 = arg0 + arg2;
				local158 = this.b();
				local15.method1200(1.0F, this.anInterface18_3.method6484((float) arg3), this.anInterface18_3.method6480((float) this.anInt6626));
				this.aClass19_Sub1_12.method5682(Static431.aClass370_5);
				local185 = arg0 + this.anInt6617;
				local191 = this.anInt6626 + local185;
				while (local191 <= local155) {
					local10.method1200(0.0F, (float) arg3, (float) this.anInt6626);
					local10.b(local185, arg1, 0);
					this.aClass19_Sub1_12.method5651();
					local185 += local158;
					local191 += local158;
					this.aClass19_Sub1_12.method5668();
				...
				if (local185 < local155) {
					local246 = local155 - local185;
					local15.method1200(1.0F, this.anInterface18_3.method6484((float) arg3), this.anInterface18_3.method6480((float) local246));
					this.aClass19_Sub1_12.method5682(Static431.aClass370_5);
					local10.method1200(0.0F, (float) arg3, (float) local246);
					local10.b(local185, arg1, 0);
					this.aClass19_Sub1_12.method5651();
					this.aClass19_Sub1_12.method5668();
				}
				...
				for (@Pc(319) int local319 = local246 + this.anInt6606; local319 <= local155; local319 += local191) {
					local15.method1200(1.0F, this.anInterface18_3.method6484((float) this.anInt6606), this.anInterface18_3.method6480((float) this.anInt6626));
					this.aClass19_Sub1_12.method5682(Static431.aClass370_5);
					local351 = arg0 + this.anInt6617;
					for (local356 = this.anInt6626 + local351; local356 <= local158; local356 += local185) {
						local10.method1200(0.0F, (float) this.anInt6606, (float) this.anInt6626);
						local10.b(local351, local246, 0);
						this.aClass19_Sub1_12.method5651();
						local351 += local185;
						this.aClass19_Sub1_12.method5668();
					}
					if (local158 > local351) {
						...
						local15.method1200(1.0F, this.anInterface18_3.method6484((float) this.anInt6606), this.anInterface18_3.method6480((float) local404));
						this.aClass19_Sub1_12.method5682(Static431.aClass370_5);
						local10.method1200(0.0F, (float) this.anInt6606, (float) local404);
						local10.b(local351, local246, 0);
						this.aClass19_Sub1_12.method5651();
						this.aClass19_Sub1_12.method5668();
					}
				...
				if (local155 > local246) {
					...
					local15.method1200(1.0F, this.anInterface18_3.method6484((float) local351), this.anInterface18_3.method6480((float) this.anInt6626));
					this.aClass19_Sub1_12.method5682(Static431.aClass370_5);
					local356 = this.anInt6617 + arg0;
					local404 = this.anInt6626 + local356;
					while (local158 >= local404) {
						local10.method1200(0.0F, (float) local351, (float) this.anInt6626);
						local10.b(local356, local246, 0);
						this.aClass19_Sub1_12.method5651();
						this.aClass19_Sub1_12.method5668();
						local404 += local185;
						local356 += local185;
					...
					if (local158 > local356) {
						...
						local15.method1200(1.0F, this.anInterface18_3.method6484((float) local351), this.anInterface18_3.method6480((float) local558));
						this.aClass19_Sub1_12.method5682(Static431.aClass370_5);
						local10.method1200(0.0F, (float) local351, (float) local558);
						local10.b(local356, local246, 0);
						this.aClass19_Sub1_12.method5651();
						this.aClass19_Sub1_12.method5668();
					}
	...
	protected void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		@Pc(8) Class73_Sub1 local8 = this.aClass19_Sub1_12.method5649();
		@Pc(13) Class73_Sub1 local13 = this.aClass19_Sub1_12.method5691();
		this.anInterface18_3.method6475(this.aBoolean494 || this.aBoolean495 || (arg7 & 0x1) == 0 ? Static363.aClass259_14 : Static60.aClass259_3);
		this.aClass19_Sub1_12.method5708();
		this.aClass19_Sub1_12.method5697(this.anInterface18_3);
		this.aClass19_Sub1_12.method5662(arg6);
		this.aClass19_Sub1_12.method5663(arg4);
		...
		local13.method1200(1.0F, this.anInterface18_3.method6484((float) this.anInt6606), this.anInterface18_3.method6480((float) this.anInt6626));
		if (this.aBoolean493) {
			arg2 = this.anInt6626 * arg2 / this.b();
			arg3 = this.anInt6606 * arg3 / this.a();
			arg0 += arg2 * this.anInt6617 / this.anInt6626;
			arg1 += this.anInt6624 * arg3 / this.anInt6606;
		}
		local8.method1200(0.0F, (float) arg3, (float) arg2);
		local8.b(arg0, arg1, 0);
		this.aClass19_Sub1_12.method5682(Static431.aClass370_5);
		this.aClass19_Sub1_12.method5651();
		this.aClass19_Sub1_12.method5668();
		this.aClass19_Sub1_12.method5640();
	...
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(15) int[] local15 = this.aClass19_Sub1_12.na(arg0, arg1, this.anInt6626, this.anInt6606);
		@Pc(22) int[] local22 = new int[this.anInt6626 * this.anInt6606];
		this.anInterface18_3.method6478(local22, this.anInt6626, this.anInt6606);
		...
		this.method4180(0, 0, this.anInt6626, this.anInt6606, local22, this.anInt6626);
	}
	...
	protected void a(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) int arg6, @OriginalArg(7) Class1 arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
		@Pc(8) Class73_Sub1 local8 = this.aClass19_Sub1_12.method5649();
		@Pc(13) Class73_Sub1 local13 = this.aClass19_Sub1_12.method5691();
		@Pc(16) Class1_Sub2 local16 = (Class1_Sub2) arg7;
		@Pc(19) Interface18 local19 = local16.anInterface18_2;
		this.anInterface18_3.method6475(this.aBoolean494 || this.aBoolean495 || (arg6 & 0x1) == 0 ? Static363.aClass259_14 : Static60.aClass259_3);
		this.aClass19_Sub1_12.method5708();
		this.aClass19_Sub1_12.method5697(this.anInterface18_3);
		this.aClass19_Sub1_12.method5662(1);
		this.aClass19_Sub1_12.method5663(1);
		if (this.aBoolean493) {
			@Pc(75) float local75 = (float) this.anInt6626 / (float) this.b();
			@Pc(83) float local83 = (float) this.anInt6606 / (float) this.a();
			local8.method1203(local83 * (arg4 - arg0), (arg3 - arg1) * local75, 1.0F, local75 * (arg2 - arg0), 0.0F, 0.0F, 0.0F, 0.0F, local83 * (arg5 - arg1));
			local8.method1198(0.0F, (arg1 + (float) this.anInt6624) * local83, local75 * ((float) this.anInt6617 + arg0));
		} else {
			local8.method1203(arg4 - arg0, -arg1 + arg3, 1.0F, arg2 - arg0, 0.0F, 0.0F, 0.0F, 0.0F, arg5 - arg1);
			local8.method1198(0.0F, arg1, arg0);
		}
		local13.method1200(1.0F, this.anInterface18_3.method6484((float) this.anInt6606), this.anInterface18_3.method6480((float) this.anInt6626));
		this.aClass19_Sub1_12.method5682(Static431.aClass370_5);
		this.aClass19_Sub1_12.method5747(1);
		this.aClass19_Sub1_12.method5697(local19);
		this.aClass19_Sub1_12.method5703(Static209.aClass121_4, Static185.aClass121_3);
		this.aClass19_Sub1_12.method5689(0, Static188.aClass168_1);
		@Pc(213) Class73_Sub1 local213 = this.aClass19_Sub1_12.method5691();
		local213.a((Class73) local8);
		local213.b(-arg8, -arg9, 0);
		local213.method1212(local19.method6484(1.0F), local19.method6480(1.0F), 1.0F);
		this.aClass19_Sub1_12.method5682(Static431.aClass370_5);
		this.aClass19_Sub1_12.method5651();
		this.aClass19_Sub1_12.method5668();
		this.aClass19_Sub1_12.method5640();
	...
	protected void a(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
		@Pc(8) Class73_Sub1 local8 = this.aClass19_Sub1_12.method5649();
		@Pc(13) Class73_Sub1 local13 = this.aClass19_Sub1_12.method5691();
		this.anInterface18_3.method6475(this.aBoolean494 || this.aBoolean495 || (arg9 & 0x1) == 0 ? Static363.aClass259_14 : Static60.aClass259_3);
		this.aClass19_Sub1_12.method5708();
		this.aClass19_Sub1_12.method5697(this.anInterface18_3);
		this.aClass19_Sub1_12.method5662(arg8);
		this.aClass19_Sub1_12.method5663(arg6);
		this.aClass19_Sub1_12.method5689(1, Static454.aClass168_5);
		this.aClass19_Sub1_12.method5751(Static454.aClass168_5, 1);
		this.aClass19_Sub1_12.method5721(arg7);
		if (this.aBoolean493) {
			@Pc(82) float local82 = (float) this.b();
			@Pc(86) float local86 = (float) this.a();
