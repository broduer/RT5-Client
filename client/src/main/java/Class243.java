...
public final class Class243 {
	...
	public Class243(@OriginalArg(0) Class83 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException {
		...
		this.aLong198 = this.aLong196 = arg0.method1395();
		this.aLong195 = 0L;
	...
	private File method3940() {
		return this.aClass83_1.method1398();
	}

	@OriginalMember(owner = "client!mj", name = "a", descriptor = "(II[BI)V")
	public void method3941(@OriginalArg(1) int arg0, @OriginalArg(2) byte[] arg1, @OriginalArg(3) int arg2) throws IOException {
		try {
			if (arg1.length < arg0) {
			...
			if (this.aLong200 != -1L && this.aLong195 >= this.aLong200 && (long) arg0 + this.aLong195 <= (long) this.anInt6208 + this.aLong200) {
				Static734.method5448(this.aByteArray67, (int) (this.aLong195 - this.aLong200), arg1, 0, arg0);
			...
			if (this.aLong195 >= this.aLong199 && this.aLong195 < this.aLong199 + (long) this.anInt6212) {
				...
				Static734.method5448(this.aByteArray66, (int) (this.aLong195 - this.aLong199), arg1, 0, local132);
				this.aLong195 += (long) local132;
				arg2 = local132;
				arg0 -= local132;
			}
			if (this.aByteArray66.length < arg0) {
				this.aClass83_1.method1394(this.aLong195);
				this.aLong197 = this.aLong195;
				while (arg0 > 0) {
					local132 = this.aClass83_1.method1397(arg0, arg1, arg2);
					if (local132 == -1) {
						break;
					}
					this.aLong195 += (long) local132;
				...
				Static734.method5448(this.aByteArray66, 0, arg1, arg2, local132);
				arg2 += local132;
				this.aLong195 += (long) local132;
				arg0 -= local132;
			}
			if (this.aLong200 != -1L) {
				...
				if (local323 > -1L && local373 > local323) {
					...
					Static734.method5448(this.aByteArray67, (int) (local323 - this.aLong200), arg1, (int) (local323 - local92), local462);
	...
	public void method3943(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) byte[] arg2) throws IOException {
		try {
			...
			if (this.aLong200 != -1L && this.aLong200 + (long) this.aByteArray67.length < this.aLong195 + (long) arg1) {
				...
				Static734.method5448(arg2, arg0, this.aByteArray67, (int) (this.aLong195 - this.aLong200), local95);
				arg0 += local95;
				arg1 -= local95;
			...
			if (arg1 > this.aByteArray67.length) {
				...
				this.aClass83_1.method1396(arg2, arg0, arg1);
				...
				if (local188 > -1L && local188 < local239) {
					...
					Static734.method5448(arg2, (int) (local188 + (long) arg0 - this.aLong195), this.aByteArray66, (int) (local188 - this.aLong199), local324);
				}
				...
				Static734.method5448(arg2, arg0, this.aByteArray67, (int) (this.aLong195 - this.aLong200), arg1);
				this.aLong195 += (long) arg1;
	...
	private void method3945() throws IOException {
		this.anInt6212 = 0;
		...
		while (this.anInt6212 < this.aByteArray66.length) {
			...
			@Pc(61) int local61 = this.aClass83_1.method1397(local44, this.aByteArray66, this.anInt6212);
			if (local61 == -1) {
				break;
			}
	...
	public long method3946() {
		return this.aLong198;
	}

	@OriginalMember(owner = "client!mj", name = "a", descriptor = "([BB)V")
	public void method3947(@OriginalArg(0) byte[] arg0) throws IOException {
		this.method3941(arg0.length, arg0, 0);
	}

	@OriginalMember(owner = "client!mj", name = "d", descriptor = "(I)V")
	public void method3948() throws IOException {
		this.method3949();
		this.aClass83_1.method1392();
	}
	...
	private void method3949() throws IOException {
		...
		if (this.aLong200 != this.aLong197) {
			this.aClass83_1.method1394(this.aLong200);
			this.aLong197 = this.aLong200;
		}
		this.aClass83_1.method1396(this.aByteArray67, 0, this.anInt6208);
		...
		if (local71 > -1L && local73 > local71) {
			...
			Static734.method5448(this.aByteArray67, (int) (local71 - this.aLong200), this.aByteArray66, (int) (local71 - this.aLong199), local228);
		}
		this.anInt6208 = 0;
		this.aLong200 = -1L;
	}
	...
	public void method3950(@OriginalArg(0) long arg0) throws IOException {
		if (arg0 < 0L) {
			throw new IOException("Invalid seek to " + arg0 + " in file " + this.method3940());
		}
		this.aLong195 = arg0;
	}
}
