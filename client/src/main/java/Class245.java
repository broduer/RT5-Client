...
public final class Class245 {
	...
	private File method5565() {
		return this.aClass83_1.method2164();
	}

	@OriginalMember(owner = "client!mj", name = "a", descriptor = "(II[BI)V")
	public void method5566(@OriginalArg(1) int arg0, @OriginalArg(2) byte[] arg1, @OriginalArg(3) int arg2) throws IOException {
		try {
			if (arg1.length < arg0) {
			...
			@Pc(132) int local132;
			if (this.aLong195 >= this.aLong199 && this.aLong195 < this.aLong199 + (long) this.anInt6232) {
				local132 = (int) ((long) this.anInt6232 + this.aLong199 - this.aLong195);
				if (arg0 < local132) {
					local132 = arg0;
				}
			...
			if (this.aLong200 != -1L) {
				...
				} else if (this.aLong200 <= local92 && this.aLong200 + (long) this.anInt6228 > local92) {
					local323 = local92;
				}
				@Pc(373) long local373 = -1L;
				if (local92 < this.aLong200 + (long) this.anInt6228 && (long) local96 + local92 >= this.aLong200 + (long) this.anInt6228) {
					local373 = (long) this.anInt6228 + this.aLong200;
				} else if (this.aLong200 < local92 + (long) local96 && (long) this.anInt6228 + this.aLong200 >= local92 - -((long) local96)) {
	...
	public void method5568(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) byte[] arg2) throws IOException {
		try {
			if (this.aLong198 < (long) arg1 + this.aLong195) {
				this.aLong198 = (long) arg1 + this.aLong195;
			}
			if (this.aLong200 != -1L && (this.aLong200 > this.aLong195 || (long) this.anInt6228 + this.aLong200 < this.aLong195)) {
				this.method5574();
			}
			...
			if (arg1 > this.aByteArray67.length) {
				...
				if (this.aLong199 <= this.aLong195 && this.aLong195 < (long) this.anInt6232 + this.aLong199) {
				...
				if (this.aLong199 < (long) arg1 + this.aLong195 && this.aLong199 + (long) this.anInt6232 >= this.aLong195 - -((long) arg1)) {
					local239 = (long) arg1 + this.aLong195;
				} else if (this.aLong195 < (long) this.anInt6232 + this.aLong199 && this.aLong195 + (long) arg1 >= (long) this.anInt6232 + this.aLong199) {
					local239 = this.aLong199 + (long) this.anInt6232;
				}
	...
	private void method5570() throws IOException {
		this.anInt6232 = 0;
		...
		while (this.anInt6232 < this.aByteArray66.length) {
			@Pc(44) int local44 = this.aByteArray66.length - this.anInt6232;
			if (local44 > 200000000) {
				local44 = 200000000;
			}
			@Pc(61) int local61 = this.aClass83_1.method2163(local44, this.aByteArray66, this.anInt6232);
			if (local61 == -1) {
				break;
			}
	...
	public long method5571() {
		return this.aLong198;
	}

	@OriginalMember(owner = "client!mj", name = "a", descriptor = "([BB)V")
	public void method5572(@OriginalArg(0) byte[] arg0) throws IOException {
		this.method5566(arg0.length, arg0, 0);
	}

	@OriginalMember(owner = "client!mj", name = "d", descriptor = "(I)V")
	public void method5573() throws IOException {
		this.method5574();
		this.aClass83_1.method2158();
	}

	@OriginalMember(owner = "client!mj", name = "a", descriptor = "(Z)V")
	private void method5574() throws IOException {
		if (this.aLong200 == -1L) {
			return;
		}
		...
		if (this.aLong199 <= this.aLong200 && this.aLong200 < this.aLong199 + (long) this.anInt6232) {
			local71 = this.aLong200;
		} else if (this.aLong199 >= this.aLong200 && (long) this.anInt6228 + this.aLong200 > this.aLong199) {
			local71 = this.aLong199;
		}
		if (this.aLong199 < this.aLong200 + (long) this.anInt6228 && (long) this.anInt6232 + this.aLong199 >= this.aLong200 - -((long) this.anInt6228)) {
			local73 = this.aLong200 + (long) this.anInt6228;
		} else if (this.aLong200 < this.aLong199 + (long) this.anInt6232 && (long) this.anInt6228 + this.aLong200 >= this.aLong199 - -((long) this.anInt6232)) {
			local73 = (long) this.anInt6232 + this.aLong199;
		}
	...
	public void method5575(@OriginalArg(0) long arg0) throws IOException {
		if (arg0 < 0L) {
			throw new IOException("Invalid seek to " + arg0 + " in file " + this.method5565());
		}
		this.aLong195 = arg0;
	}
}
