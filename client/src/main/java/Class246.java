...
public final class Class246 {
	...
	public Class246(@OriginalArg(0) Class377 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class330 arg2, @OriginalArg(3) Class330 arg3) {
		...
		this.aClass330_82.method5372(36);
	}
	...
	public void method3963() {
		...
		synchronized (this.aClass82_134) {
			this.aClass82_134.method1381(5);
		}
		local12 = this.aClass82_135;
		synchronized (this.aClass82_135) {
			this.aClass82_135.method1381(5);
		}
	}

	@OriginalMember(owner = "client!ml", name = "b", descriptor = "(III)V")
	public void method3965(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
	...
	public Class105 method3966(@OriginalArg(1) int arg0) {
		@Pc(6) Class82 local6 = this.aClass82_134;
		@Pc(16) Class105 local16;
		synchronized (this.aClass82_134) {
			local16 = (Class105) this.aClass82_134.method1390((long) arg0);
		}
		if (local16 != null) {
			return local16;
		}
		...
		synchronized (this.aClass330_82) {
			local39 = this.aClass330_82.method5359(arg0, 36);
		}
		local16 = new Class105();
		local16.aClass246_2 = this;
		local16.anInt2590 = arg0;
		if (local39 != null) {
			local16.method1621(new Class2_Sub21(local39));
		}
		local16.method1628();
		@Pc(72) Class82 local72 = this.aClass82_134;
		synchronized (this.aClass82_134) {
			this.aClass82_134.method1384(local16, (long) arg0);
			return local16;
		}
	}
	...
	public void method3967() {
		@Pc(6) Class82 local6 = this.aClass82_134;
		synchronized (this.aClass82_134) {
			this.aClass82_134.method1385();
		}
		local6 = this.aClass82_135;
		synchronized (this.aClass82_135) {
			this.aClass82_135.method1385();
		}
	}
	...
	public void method3968() {
		@Pc(6) Class82 local6 = this.aClass82_134;
		synchronized (this.aClass82_134) {
			this.aClass82_134.method1391();
		}
		local6 = this.aClass82_135;
		synchronized (this.aClass82_135) {
			this.aClass82_135.method1391();
		}
	}
}
