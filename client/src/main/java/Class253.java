...
public final class Class253 {
	...
	public Class253(@OriginalArg(0) byte[] arg0, @OriginalArg(1) Class2_Sub44 arg1) {
		...
		try {
			...
			local24.method5205();
			local24.anInt8388 += 2;
			@Pc(43) int local43 = local24.method5205();
			@Pc(45) int local45 = 0;
			@Pc(47) int local47 = -1;
			@Pc(49) int local49 = -1;
			...
			for (@Pc(57) int local57 = 0; local57 < local43; local57++) {
				...
				@Pc(72) int local72 = local24.method5205();
				if (local72 > 0) {
					if (local64 == 0) {
						local49 = local57;
					}
					...
					if ((local72 & 0x1) == 0) {
						...
						Static413.aShortArray91[local45] = (short) local29.method5169();
					}
					if ((local72 & 0x2) == 0) {
						Static413.aShortArray88[local45] = local87;
					} else {
						Static413.aShortArray88[local45] = (short) local29.method5169();
					}
					if ((local72 & 0x4) == 0) {
						Static413.aShortArray90[local45] = local87;
					} else {
						Static413.aShortArray90[local45] = (short) local29.method5169();
					}
