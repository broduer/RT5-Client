...
public final class Class255 {
	...
	public Class255(@OriginalArg(0) byte[] arg0, @OriginalArg(1) Node_Sub44 arg1) {
			...
			for (@Pc(57) int local57 = 0; local57 < local43; local57++) {
				...
				if (local72 > 0) {
					...
					if ((local72 & 0x1) == 0) {
						...
						Static413.aShortArray91[local45] = (short) local29.method7367();
					}
					if ((local72 & 0x2) == 0) {
						Static413.aShortArray88[local45] = local87;
					} else {
						Static413.aShortArray88[local45] = (short) local29.method7367();
					}
					if ((local72 & 0x4) == 0) {
						Static413.aShortArray90[local45] = local87;
					} else {
						Static413.aShortArray90[local45] = (short) local29.method7367();
					}
