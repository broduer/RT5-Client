...
public final class Class257 {
	...
	public boolean method4075(@OriginalArg(0) Class50 arg0, @OriginalArg(2) Class69 arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int[] arg4) {
		if (this.aBoolean481) {
			return true;
			...
			this.aClass2_Sub2_Sub18_1 = arg0.method686(this.anInt6448 >> 16);
			...
			if (arg1.aBoolean142 && arg2 != -1 && arg4.length > arg2) {
				...
				this.aClass2_Sub2_Sub18_2 = arg0.method686(this.anInt6450 >> 16);
				this.anInt6450 &= 0xFFFF;
			}
			if (arg1.aBoolean140) {
				this.anInt6452 |= 0x200;
			}
			if (this.aClass2_Sub2_Sub18_1.method5334(this.anInt6448)) {
				this.anInt6452 |= 0x80;
			}
			if (this.aClass2_Sub2_Sub18_1.method5332(this.anInt6448)) {
				this.anInt6452 |= 0x100;
			}
			if (this.aClass2_Sub2_Sub18_1.method5333(this.anInt6448)) {
				this.anInt6452 |= 0x400;
			}
			if (this.aClass2_Sub2_Sub18_2 != null) {
				if (this.aClass2_Sub2_Sub18_2.method5334(this.anInt6450)) {
					this.anInt6452 |= 0x80;
				}
				if (this.aClass2_Sub2_Sub18_2.method5332(this.anInt6450)) {
					this.anInt6452 |= 0x100;
				}
				if (this.aClass2_Sub2_Sub18_2.method5333(this.anInt6450)) {
					this.anInt6452 |= 0x400;
				}
			}
