...
public final class Class258 {
	...
	public void method4081(@OriginalArg(0) Class2_Sub21 arg0) {
		this.aClass211_5 = new Class211();
		this.aClass211_5.method3467(arg0);
		this.aClass211_7 = new Class211();
		this.aClass211_7.method3467(arg0);
		@Pc(21) int local21 = arg0.method5205();
		if (local21 != 0) {
			arg0.anInt8388--;
			this.aClass211_6 = new Class211();
			this.aClass211_6.method3467(arg0);
			this.aClass211_1 = new Class211();
			this.aClass211_1.method3467(arg0);
		}
		local21 = arg0.method5205();
		if (local21 != 0) {
			arg0.anInt8388--;
			this.aClass211_9 = new Class211();
			this.aClass211_9.method3467(arg0);
			this.aClass211_2 = new Class211();
			this.aClass211_2.method3467(arg0);
		}
		local21 = arg0.method5205();
		if (local21 != 0) {
			arg0.anInt8388--;
			this.aClass211_3 = new Class211();
			this.aClass211_3.method3467(arg0);
			this.aClass211_4 = new Class211();
			this.aClass211_4.method3467(arg0);
		}
		for (@Pc(109) int local109 = 0; local109 < 10; local109++) {
			@Pc(114) int local114 = arg0.method5199();
			if (local114 == 0) {
				break;
			}
			this.anIntArray502[local109] = local114;
			this.anIntArray510[local109] = arg0.method5169();
			this.anIntArray504[local109] = arg0.method5199();
		}
		this.anInt6456 = arg0.method5199();
		this.anInt6457 = arg0.method5199();
		this.anInt6454 = arg0.method5191();
		this.anInt6455 = arg0.method5191();
		this.aClass228_1 = new Class228();
		this.aClass211_8 = new Class211();
		this.aClass228_1.method3714(arg0, this.aClass211_8);
	}

	@OriginalMember(owner = "client!ng", name = "a", descriptor = "(II)[I")
	public int[] method4082(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		Static734.method5442(Static423.anIntArray506, 0, arg0);
		if (arg1 < 10) {
			return Static423.anIntArray506;
		}
		@Pc(16) double local16 = (double) arg0 / ((double) arg1 + 0.0D);
		this.aClass211_5.method3465();
		this.aClass211_7.method3465();
		@Pc(24) int local24 = 0;
		@Pc(26) int local26 = 0;
		@Pc(28) int local28 = 0;
		if (this.aClass211_6 != null) {
			this.aClass211_6.method3465();
			this.aClass211_1.method3465();
		...
		if (this.aClass211_9 != null) {
			this.aClass211_9.method3465();
			this.aClass211_2.method3465();
		...
		for (@Pc(176) int local176 = 0; local176 < arg0; local176++) {
			local182 = this.aClass211_5.method3466(arg0);
			local187 = this.aClass211_7.method3466(arg0);
			if (this.aClass211_6 != null) {
				local195 = this.aClass211_6.method3466(arg0);
				local200 = this.aClass211_1.method3466(arg0);
				local182 += this.method4083(local28, local200, this.aClass211_6.anInt5477) >> 1;
				local28 += (local195 * local24 >> 16) + local26;
			}
			if (this.aClass211_9 != null) {
				local195 = this.aClass211_9.method3466(arg0);
				local200 = this.aClass211_2.method3466(arg0);
				local187 = local187 * ((this.method4083(local67, local200, this.aClass211_9.anInt5477) >> 1) + 32768) >> 15;
			...
			for (local195 = 0; local195 < 5; local195++) {
				if (this.anIntArray502[local195] != 0) {
					...
					if (local200 < arg0) {
						Static423.anIntArray506[local200] += this.method4083(Static423.anIntArray508[local195], local187 * Static423.anIntArray512[local195] >> 15, this.aClass211_5.anInt5477);
		...
		if (this.aClass211_3 != null) {
			this.aClass211_3.method3465();
			this.aClass211_4.method3465();
			local182 = 0;
			@Pc(339) boolean local339 = true;
			for (local200 = 0; local200 < arg0; local200++) {
				local347 = this.aClass211_3.method3466(arg0);
				local352 = this.aClass211_4.method3466(arg0);
				if (local339) {
		...
		if (this.aClass228_1.anIntArray452[0] > 0 || this.aClass228_1.anIntArray452[1] > 0) {
			this.aClass211_8.method3465();
			local182 = this.aClass211_8.method3466(arg0 + 1);
			local187 = this.aClass228_1.method3713(0, (float) local182 / 65536.0F);
			local195 = this.aClass228_1.method3713(1, (float) local182 / 65536.0F);
				...
				while (true) {
					...
					if (local200 >= arg0 - local187) {
						while (local200 < arg0) {
							...
							Static423.anIntArray506[local200] = local352;
							this.aClass211_8.method3466(arg0 + 1);
							local200++;
						}
						break;
					}
	...
	private int method4083(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg2 == 1) {
