...
public abstract class Class26 {
	...
	public abstract void method8297(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1);
	...
	public abstract void method8299(@OriginalArg(0) boolean arg0);

	@OriginalMember(owner = "client!rea", name = "a", descriptor = "(Lclient!mw;IB)V")
	public abstract void method8301(@OriginalArg(0) Interface17 arg0, @OriginalArg(1) int arg1);
	...
	public abstract void method8304(@OriginalArg(1) boolean arg0);
}
