...
public final class Class260 {
	...
	public Class260(@OriginalArg(0) Class377 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class330 arg2) {
		...
		if (this.aClass330_86 == null) {
			...
			this.anInt6462 = this.aClass330_86.method5372(16);
		}
	}
	...
	public void method4087() {
		...
		synchronized (this.aClass82_138) {
			this.aClass82_138.method1385();
		}
	}

	@OriginalMember(owner = "client!nh", name = "a", descriptor = "(II)Lclient!rha;")
	public Class321 method4088(@OriginalArg(1) int arg0) {
		@Pc(6) Class82 local6 = this.aClass82_138;
		@Pc(16) Class321 local16;
		synchronized (this.aClass82_138) {
			local16 = (Class321) this.aClass82_138.method1390((long) arg0);
		}
		if (local16 != null) {
			return local16;
		}
		...
		synchronized (this.aClass330_86) {
			local39 = this.aClass330_86.method5359(arg0, 16);
		}
		local16 = new Class321();
		if (local39 != null) {
			local16.method5118(new Class2_Sub21(local39));
		}
		@Pc(63) Class82 local63 = this.aClass82_138;
		synchronized (this.aClass82_138) {
			this.aClass82_138.method1384(local16, (long) arg0);
			return local16;
		}
	}
	...
	public void method4091() {
		...
		synchronized (this.aClass82_138) {
			this.aClass82_138.method1381(5);
		}
	}
}
