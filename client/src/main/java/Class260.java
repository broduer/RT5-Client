...
public final class Class260 {
	...
	public int[] method5783(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		Static734.method7695(Static423.anIntArray506, 0, arg0);
		if (arg1 < 10) {
		...
		for (@Pc(102) int local102 = 0; local102 < 5; local102++) {
			if (this.anIntArray502[local102] != 0) {
				...
				Static423.anIntArray507[local102] = (int) ((double) (this.aClass213_5.anInt5495 - this.aClass213_5.anInt5494) * 32.768D * Math.pow(1.0057929410678534D, this.anIntArray510[local102]) / local16);
