...
public final class Class262 {
	...
	public Class262(@OriginalArg(0) Class295 arg0, @OriginalArg(1) Class174 arg1, @OriginalArg(2) BigInteger arg2, @OriginalArg(3) BigInteger arg3) {
		...
		if (!this.aClass295_1.method4659()) {
			this.aClass2_Sub2_Sub17_Sub1_1 = this.aClass295_1.method4662(255, 255, true, (byte) 0);
		}
	}
	...
	public boolean method4106() {
		...
		@Pc(49) Class2_Sub21 local49 = new Class2_Sub21(this.aClass2_Sub2_Sub17_Sub1_1.method6412());
		local49.anInt8388 = 5;
		@Pc(56) int local56 = local49.method5205();
		local49.anInt8388 += local56 * 72;
		@Pc(72) byte[] local72 = new byte[local49.aByteArray93.length - local49.anInt8388];
		local49.method5153(0, local72.length, local72);
		...
		@Pc(131) byte[] local131 = Static607.method5770(local49.aByteArray93, local49.anInt8388 - local72.length - 5, 5);
	...
	public Class47_Sub1 method4107(@OriginalArg(0) Class9 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class9 arg2) {
		return this.method4108(arg0, arg1, arg2);
	}

	@OriginalMember(owner = "client!nj", name = "a", descriptor = "(ZLclient!af;ILclient!af;I)Lclient!pm;")
	private Class47_Sub1 method4108(@OriginalArg(1) Class9 arg0, @OriginalArg(2) int arg1, @OriginalArg(3) Class9 arg2) {
		if (this.aClass2_Sub21_10 == null) {
			throw new RuntimeException();
			...
			@Pc(52) int local52 = this.aClass2_Sub21_10.method5158();
			@Pc(57) int local57 = this.aClass2_Sub21_10.method5158();
			@Pc(60) byte[] local60 = new byte[64];
			this.aClass2_Sub21_10.method5153(0, 64, local60);
