...
public final class Class263 {
	...
	@OriginalMember(owner = "client!ni", name = "h", descriptor = "I")
	public int anInt6486 = 0;

	@OriginalMember(owner = "client!ni", name = "r", descriptor = "[I")
	public final int[] anIntArray514 = new int[6];

	@OriginalMember(owner = "client!ni", name = "n", descriptor = "[B")
	public final byte[] aByteArray71 = new byte[18002];

	@OriginalMember(owner = "client!ni", name = "c", descriptor = "I")
	public int anInt6490 = 0;

	@OriginalMember(owner = "client!ni", name = "t", descriptor = "[I")
	public final int[] anIntArray515 = new int[16];

	@OriginalMember(owner = "client!ni", name = "g", descriptor = "[[B")
	public final byte[][] aByteArrayArray21 = new byte[6][258];

	@OriginalMember(owner = "client!ni", name = "F", descriptor = "[I")
	public final int[] anIntArray513 = new int[256];

	@OriginalMember(owner = "client!ni", name = "w", descriptor = "[Z")
	public final boolean[] aBooleanArray20 = new boolean[16];

	@OriginalMember(owner = "client!ni", name = "i", descriptor = "[Z")
	public final boolean[] aBooleanArray19 = new boolean[256];

	@OriginalMember(owner = "client!ni", name = "p", descriptor = "[[I")
	public final int[][] anIntArrayArray159 = new int[6][258];

	@OriginalMember(owner = "client!ni", name = "y", descriptor = "[B")
	public final byte[] aByteArray74 = new byte[18002];

	@OriginalMember(owner = "client!ni", name = "B", descriptor = "[[I")
	public final int[][] anIntArrayArray160 = new int[6][258];

	@OriginalMember(owner = "client!ni", name = "o", descriptor = "[B")
	public final byte[] aByteArray75 = new byte[4096];
	...
	public final int[][] anIntArrayArray161 = new int[6][258];
}
