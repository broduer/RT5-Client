...
public final class Class263 implements Runnable {
	...
	public void method4129() throws IOException {
	...
	public int method4130() throws IOException {
	...
	public void run() {
		try {
			...
			Static240.method2529(local122, (String) null);
		}
	}

	@OriginalMember(owner = "client!nk", name = "a", descriptor = "(IBI[B)V")
	public void method4131(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) byte[] arg2) throws IOException {
		if (this.aBoolean488) {
			return;
		}
		while (arg0 > 0) {
	...
	public int method4134() throws IOException {
		return this.aBoolean488 ? 0 : this.anInputStream2.available();
	}

	@OriginalMember(owner = "client!nk", name = "a", descriptor = "(II[BB)V")
	public void method4135(@OriginalArg(1) int arg0, @OriginalArg(2) byte[] arg1) throws IOException {
		if (this.aBoolean488) {
			return;
		}
		if (this.aBoolean489) {
		...
		synchronized (this) {
			...
			if (this.aClass270_3 == null) {
				this.aClass270_3 = this.aClass390_5.method6432(this, 3);
			}
			this.notifyAll();
		}
	}
