...
public final class Class264 {
	...
	private void method4186(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub21 arg1) {
		if (arg0 == 1) {
			this.anInt6634 = arg1.method5192();
			this.method4188(this.anInt6634);
		} else if (arg0 == 2) {
			this.anInt6633 = arg1.method5191();
			if (this.anInt6633 == 65535) {
				this.anInt6633 = -1;
			}
		} else if (arg0 == 3) {
			this.anInt6635 = arg1.method5191() << 2;
		} else if (arg0 == 4) {
	...
	public void method4187(@OriginalArg(0) Class2_Sub21 arg0) {
		while (true) {
			@Pc(3) int local3 = arg0.method5205();
			if (local3 == 0) {
				return;
			}
			this.method4186(local3, arg0);
		}
	}
