...
public final class Class265 implements Runnable {
	...
	private final Class392 aClass392_5;
	...
	public Class265(@OriginalArg(0) Socket arg0, @OriginalArg(1) Class392 arg1, @OriginalArg(2) int arg2) throws IOException {
		this.aClass392_5 = arg1;
		this.aSocket1 = arg0;
	...
	public int method5831() throws IOException {
		...
		try {
			while (true) {
				label80: {
					...
					@Pc(26) int local26;
					synchronized (this) {
						if (this.anInt6560 == this.anInt6561) {
							if (this.aBoolean488) {
								break label80;
							}
							try {
						...
						local26 = this.anInt6560;
						if (this.anInt6561 >= this.anInt6560) {
							local38 = this.anInt6561 - this.anInt6560;
						} else {
							local38 = this.anInt6557 - this.anInt6560;
						}
					}
					if (local38 <= 0) {
						continue;
					...
					this.anInt6560 = (this.anInt6560 + local38) % this.anInt6557;
					try {
						if (this.anInt6561 == this.anInt6560) {
	...
	public void method5832(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) byte[] arg2) throws IOException {
		if (this.aBoolean488) {
			return;
		}
		while (arg0 > 0) {
	...
	public int method5835() throws IOException {
		return this.aBoolean488 ? 0 : this.anInputStream2.available();
	}

	@OriginalMember(owner = "client!nk", name = "a", descriptor = "(II[BB)V")
	public void method5836(@OriginalArg(1) int arg0, @OriginalArg(2) byte[] arg1) throws IOException {
		if (this.aBoolean488) {
			return;
		}
		if (this.aBoolean489) {
		...
		if (this.aByteArray79 == null) {
			this.aByteArray79 = new byte[this.anInt6557];
		}
		synchronized (this) {
			for (@Pc(40) int local40 = 0; local40 < arg0; local40++) {
				this.aByteArray79[this.anInt6561] = arg1[local40];
				this.anInt6561 = (this.anInt6561 + 1) % this.anInt6557;
				if ((this.anInt6557 + this.anInt6560 - 100) % this.anInt6557 == this.anInt6561) {
					throw new IOException();
				}
			}
			if (this.aClass272_3 == null) {
				this.aClass272_3 = this.aClass392_5.method8998(this, 3);
			}
			this.notifyAll();
		}
	}
	...
	public void method5837() {
		...
		if (this.aClass272_3 != null) {
			while (this.aClass272_3.anInt6810 == 0) {
				Static638.method8402(1L);
			}
			if (this.aClass272_3.anInt6810 == 1) {
				try {
					((Thread) this.aClass272_3.anObject13).join();
