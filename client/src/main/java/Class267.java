...
public final class Class267 {
	...
	public Class267(@OriginalArg(0) Class377 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class330 arg2, @OriginalArg(3) Class330 arg3) {
		...
		this.aClass330_89.method5372(33);
	}
	...
	public void method4211() {
		...
		synchronized (this.aClass82_142) {
			this.aClass82_142.method1381(5);
		}
		local11 = this.aClass82_143;
		synchronized (this.aClass82_143) {
			this.aClass82_143.method1381(5);
		}
	}
	...
	public void method4213() {
		...
		synchronized (this.aClass82_142) {
			this.aClass82_142.method1385();
		}
		local9 = this.aClass82_143;
		synchronized (this.aClass82_143) {
			this.aClass82_143.method1385();
		}
	}

	@OriginalMember(owner = "client!nv", name = "a", descriptor = "(II)Lclient!vla;")
	public Class389 method4214(@OriginalArg(1) int arg0) {
		@Pc(6) Class82 local6 = this.aClass82_142;
		@Pc(18) Class389 local18;
		synchronized (this.aClass82_142) {
			local18 = (Class389) this.aClass82_142.method1390((long) arg0);
		}
		if (local18 != null) {
			return local18;
		}
		...
		synchronized (this.aClass330_89) {
			local41 = this.aClass330_89.method5359(arg0, 33);
		}
		local18 = new Class389();
		local18.aClass267_2 = this;
		if (local41 != null) {
			local18.method6386(new Class2_Sub21(local41));
		}
		@Pc(70) Class82 local70 = this.aClass82_142;
		synchronized (this.aClass82_142) {
			this.aClass82_142.method1384(local18, (long) arg0);
			return local18;
		}
	}
	...
	public void method4215() {
		...
		synchronized (this.aClass82_142) {
			this.aClass82_142.method1391();
		}
		local7 = this.aClass82_143;
		synchronized (this.aClass82_143) {
			this.aClass82_143.method1391();
		}
	}
}
