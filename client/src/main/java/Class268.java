...
public final class Class268 {
	...
	public byte aByte110 = 4;

	@OriginalMember(owner = "client!o", name = "S", descriptor = "I")
	private int anInt6750 = -1;

	@OriginalMember(owner = "client!o", name = "T", descriptor = "I")
	public int anInt6716 = -1;
	...
	public boolean method4220() {
		if (this.anIntArray532 == null) {
			return this.anInt6714 != -1 || this.anInt6711 != -1 || this.anInt6712 != -1;
		}
		for (@Pc(35) int local35 = 0; local35 < this.anIntArray532.length; local35++) {
			if (this.anIntArray532[local35] != -1) {
				@Pc(62) Class268 local62 = this.aClass308_1.method4967(this.anIntArray532[local35]);
	...
	public Class268 method4221(@OriginalArg(0) int arg0, @OriginalArg(1) Interface23 arg1) {
		if (arg0 != 65535) {
			return null;
		}
		@Pc(11) int local11 = -1;
		if (this.anInt6749 != -1) {
			local11 = arg1.method4827(this.anInt6749);
		} else if (this.anInt6750 != -1) {
			local11 = arg1.method4828(this.anInt6750);
		}
		if (local11 < 0 || this.anIntArray532.length - 1 <= local11 || this.anIntArray532[local11] == -1) {
			...
			return local66 == -1 ? null : this.aClass308_1.method4967(local66);
		} else {
			return this.aClass308_1.method4967(this.anIntArray532[local11]);
		}
	}

	@OriginalMember(owner = "client!o", name = "a", descriptor = "(BLclient!ge;)V")
	public void method4222(@OriginalArg(1) Class2_Sub21 arg0) {
		while (true) {
			@Pc(15) int local15 = arg0.method5205();
			if (local15 == 0) {
				return;
			}
			this.method4226(local15, arg0);
		}
	}

	@OriginalMember(owner = "client!o", name = "a", descriptor = "(ILclient!ge;B)V")
	private void method4226(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub21 arg1) {
		@Pc(12) int local12;
		@Pc(18) int local18;
		if (arg0 == 1) {
			local12 = arg1.method5205();
			this.anIntArray535 = new int[local12];
			for (local18 = 0; local18 < local12; local18++) {
				this.anIntArray535[local18] = arg1.method5191();
				if (this.anIntArray535[local18] == 65535) {
					this.anIntArray535[local18] = -1;
				}
			}
		} else if (arg0 == 2) {
			this.aString73 = arg1.method5167();
		} else if (arg0 == 12) {
			this.anInt6713 = arg1.method5205();
		} else if (arg0 >= 30 && arg0 < 35) {
			this.aStringArray34[arg0 - 30] = arg1.method5167();
		} else if (arg0 == 40) {
			local12 = arg1.method5205();
			this.aShortArray100 = new short[local12];
			this.aShortArray99 = new short[local12];
			for (local18 = 0; local18 < local12; local18++) {
				this.aShortArray99[local18] = (short) arg1.method5191();
				this.aShortArray100[local18] = (short) arg1.method5191();
			}
		} else if (arg0 == 41) {
			local12 = arg1.method5205();
			this.aShortArray102 = new short[local12];
			this.aShortArray101 = new short[local12];
			for (local18 = 0; local18 < local12; local18++) {
				this.aShortArray101[local18] = (short) arg1.method5191();
				this.aShortArray102[local18] = (short) arg1.method5191();
			}
		} else if (arg0 == 42) {
			local12 = arg1.method5205();
			this.aByteArray80 = new byte[local12];
			for (local18 = 0; local18 < local12; local18++) {
				this.aByteArray80[local18] = arg1.method5186();
			}
		} else if (arg0 == 60) {
			local12 = arg1.method5205();
			this.anIntArray534 = new int[local12];
			for (local18 = 0; local18 < local12; local18++) {
				this.anIntArray534[local18] = arg1.method5191();
			}
		} else if (arg0 == 93) {
			this.aBoolean507 = false;
		} else if (arg0 == 95) {
			this.anInt6727 = arg1.method5191();
		} else if (arg0 == 97) {
			this.anInt6738 = arg1.method5191();
		} else if (arg0 == 98) {
			this.anInt6722 = arg1.method5191();
		} else if (arg0 == 99) {
			this.aBoolean502 = true;
		} else if (arg0 == 100) {
			this.anInt6732 = arg1.method5186();
		} else if (arg0 == 101) {
			this.anInt6747 = arg1.method5186() * 5;
		} else if (arg0 == 102) {
			this.anInt6708 = arg1.method5191();
		} else if (arg0 == 103) {
			this.lb = arg1.method5191();
		} else {
			@Pc(306) int local306;
			if (arg0 == 106 || arg0 == 118) {
				this.anInt6749 = arg1.method5191();
				if (this.anInt6749 == 65535) {
					this.anInt6749 = -1;
				}
				this.anInt6750 = arg1.method5191();
				if (this.anInt6750 == 65535) {
					this.anInt6750 = -1;
				}
				local12 = -1;
				if (arg0 == 118) {
					local12 = arg1.method5191();
					if (local12 == 65535) {
						local12 = -1;
					}
				}
				local18 = arg1.method5205();
				this.anIntArray532 = new int[local18 + 2];
				for (local306 = 0; local306 <= local18; local306++) {
					this.anIntArray532[local306] = arg1.method5191();
					if (this.anIntArray532[local306] == 65535) {
						this.anIntArray532[local306] = -1;
					}
				}
				this.anIntArray532[local18 + 1] = local12;
			} else if (arg0 == 107) {
				...
				this.aShort75 = (short) arg1.method5191();
				this.aShort76 = (short) arg1.method5191();
			} else if (arg0 == 114) {
				this.aByte111 = arg1.method5186();
				this.aByte109 = arg1.method5186();
			} else if (arg0 == 119) {
				this.aByte103 = arg1.method5186();
			} else if (arg0 == 121) {
				this.anIntArrayArray166 = new int[this.anIntArray535.length][];
				local12 = arg1.method5205();
				for (local18 = 0; local18 < local12; local18++) {
					local306 = arg1.method5205();
					@Pc(914) int[] local914 = this.anIntArrayArray166[local306] = new int[3];
					local914[0] = arg1.method5186();
					local914[1] = arg1.method5186();
					local914[2] = arg1.method5186();
				}
			} else if (arg0 == 122) {
				this.anInt6748 = arg1.method5191();
			} else if (arg0 == 123) {
				this.anInt6707 = arg1.method5191();
			} else if (arg0 == 125) {
				this.aByte110 = arg1.method5186();
			} else if (arg0 == 127) {
				this.anInt6726 = arg1.method5191();
			} else if (arg0 == 128) {
				arg1.method5205();
			} else if (arg0 == 134) {
				this.anInt6714 = arg1.method5191();
				if (this.anInt6714 == 65535) {
					this.anInt6714 = -1;
				}
				this.anInt6724 = arg1.method5191();
				if (this.anInt6724 == 65535) {
					this.anInt6724 = -1;
				}
				this.anInt6711 = arg1.method5191();
				if (this.anInt6711 == 65535) {
					this.anInt6711 = -1;
				}
				this.anInt6712 = arg1.method5191();
				if (this.anInt6712 == 65535) {
					this.anInt6712 = -1;
				}
				this.anInt6742 = arg1.method5205();
			} else if (arg0 == 135) {
				this.anInt6716 = arg1.method5205();
				this.anInt6739 = arg1.method5191();
			} else if (arg0 == 136) {
				this.anInt6737 = arg1.method5205();
				this.anInt6752 = arg1.method5191();
			} else if (arg0 == 137) {
				this.anInt6740 = arg1.method5191();
			} else if (arg0 == 138) {
				this.anInt6715 = arg1.method5191();
			} else if (arg0 == 139) {
				this.anInt6720 = arg1.method5191();
			} else if (arg0 == 140) {
				this.anInt6721 = arg1.method5205();
			} else if (arg0 == 141) {
				this.aBoolean504 = true;
			} else if (arg0 == 142) {
				this.anInt6733 = arg1.method5191();
			} else if (arg0 == 143) {
				this.aBoolean503 = true;
			} else if (arg0 >= 150 && arg0 < 155) {
				this.aStringArray34[arg0 - 150] = arg1.method5167();
				if (!this.aClass308_1.aBoolean621) {
					this.aStringArray34[arg0 - 150] = null;
				}
			} else if (arg0 == 155) {
				this.aByte104 = arg1.method5186();
				this.aByte106 = arg1.method5186();
				this.aByte108 = arg1.method5186();
				this.aByte105 = arg1.method5186();
			} else if (arg0 == 158) {
				this.aByte107 = 1;
			} else if (arg0 == 159) {
				this.aByte107 = 0;
				...
				for (local18 = 0; local18 < local12; local18++) {
					this.anIntArray533[local18] = arg1.method5191();
				}
			} else if (arg0 == 162) {
				this.aBoolean508 = true;
			} else if (arg0 == 163) {
				this.anInt6706 = arg1.method5205();
			} else if (arg0 == 164) {
				this.anInt6729 = arg1.method5191();
				this.anInt6736 = arg1.method5191();
			} else if (arg0 == 165) {
				this.anInt6723 = arg1.method5205();
			} else if (arg0 == 168) {
				this.anInt6741 = arg1.method5205();
			} else if (arg0 == 249) {
				local12 = arg1.method5205();
				if (this.aClass28_32 == null) {
					local18 = Static440.method4203(local12);
					this.aClass28_32 = new Class28(local18);
				}
				for (local18 = 0; local18 < local12; local18++) {
					@Pc(761) boolean local761 = arg1.method5205() == 1;
					@Pc(765) int local765 = arg1.method5192();
					@Pc(774) Class2 local774;
					if (local761) {
						local774 = new Class2_Sub24(arg1.method5167());
					} else {
						local774 = new Class2_Sub38(arg1.method5158());
					}
					this.aClass28_32.method370((long) local765, local774);
				}
			}
		}
	}
	...
	public String method4227(@OriginalArg(1) String arg0, @OriginalArg(2) int arg1) {
		if (this.aClass28_32 == null) {
			return arg0;
		} else {
			@Pc(23) Class2_Sub24 local23 = (Class2_Sub24) this.aClass28_32.method373((long) arg1);
	...
	public Class114 method4228(@OriginalArg(1) Class152 arg0, @OriginalArg(2) Class386 arg1, @OriginalArg(4) Class19 arg2, @OriginalArg(5) Interface23 arg3) {
		if (this.anIntArray532 != null) {
			@Pc(15) Class268 local15 = this.method4221(65535, arg3);
			return local15 == null ? null : local15.method4228(arg0, arg1, arg2, arg3);
		} else if (this.anIntArray534 == null && (arg1 == null || arg1.anIntArray816 == null)) {
			return null;
		} else {
			@Pc(54) int local54 = 2048;
			if (arg0 != null) {
				local54 = arg0.method6535() | 0x800;
			}
			...
			synchronized (this.aClass308_1.aClass82_171) {
				local94 = (Class114) this.aClass308_1.aClass82_171.method1390(local71);
			}
			if (local94 == null || (local94.ua() & local54) != local54) {
				if (local94 != null) {
					local54 |= local94.ua();
				}
				@Pc(125) int local125 = local54;
				if (this.aShortArray99 != null) {
					local125 = local54 | 0x4000;
				}
				...
				synchronized (this.aClass308_1.aClass330_102) {
					for (@Pc(173) int local173 = 0; local173 < local163.length; local173++) {
						if (!this.aClass308_1.aClass330_102.method5350(0, local163[local173])) {
							local165 = true;
						}
					}
				}
				...
				synchronized (this.aClass308_1.aClass330_102) {
					...
					while (true) {
						...
						local215[local223] = Static121.method1430(local163[local223], this.aClass308_1.aClass330_102);
						local223++;
					}
				}
				for (@Pc(258) int local258 = 0; local258 < local163.length; local258++) {
					if (local215[local258] != null && local215[local258].anInt2379 < 13) {
						local215[local258].method1452();
					}
				}
				...
				local94 = arg2.a(local304, local125, this.aClass308_1.anInt8088, 64, 768);
				@Pc(340) int local340;
				@Pc(334) short[] local334;
				if (this.aShortArray99 != null) {
					if (arg1 == null || arg1.aShortArray145 == null) {
						local334 = this.aShortArray100;
					} else {
						local334 = arg1.aShortArray145;
					}
					for (local340 = 0; local340 < this.aShortArray99.length; local340++) {
				...
				if (this.aShortArray101 != null) {
					if (arg1 == null || arg1.aShortArray144 == null) {
						local334 = this.aShortArray102;
					} else {
						local334 = arg1.aShortArray144;
					}
					for (local340 = 0; local340 < this.aShortArray101.length; local340++) {
						local94.aa(this.aShortArray101[local340], local334[local340]);
					}
				}
				if (this.aByte105 != 0) {
				...
				synchronized (this.aClass308_1.aClass82_171) {
					this.aClass308_1.aClass82_171.method1384(local94, local71);
				}
			}
			if (arg0 != null) {
				local94 = local94.a((byte) 1, local54, true);
				arg0.method6523(local94, 0);
			}
			local94.s(2048);
			return local94;
		}
	...
	public Class114 method4229(@OriginalArg(0) Interface23 arg0, @OriginalArg(1) Class19 arg1, @OriginalArg(2) Class310 arg2, @OriginalArg(4) Class152 arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int[] arg5, @OriginalArg(7) Class386 arg6, @OriginalArg(8) Class152 arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class152[] arg9) {
		if (this.anIntArray532 != null) {
			@Pc(11) Class268 local11 = this.method4221(65535, arg0);
			return local11 == null ? null : local11.method4229(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9);
		}
		@Pc(32) int local32 = arg8;
		if (this.anInt6722 != 128) {
			local32 = arg8 | 0x2;
		}
		if (this.anInt6738 != 128) {
			local32 |= 0x5;
		}
		...
		for (@Pc(62) int local62 = 0; local62 < local60; local62++) {
			if (arg9[local62] != null) {
				local32 |= arg9[local62].method6535();
				local52 = true;
			}
		}
		if (arg3 != null) {
			local52 = true;
			local32 |= arg3.method6535();
		}
		if (arg7 != null) {
			local32 |= arg7.method6535();
			local52 = true;
		}
		...
		synchronized (this.aClass308_1.aClass82_170) {
			local139 = (Class114) this.aClass308_1.aClass82_170.method1390(local116);
		}
		@Pc(147) Class289 local147 = null;
		if (this.anInt6726 != -1) {
			local147 = arg2.method4993(this.anInt6726);
		}
		@Pc(226) int local226;
		@Pc(396) int local396;
		@Pc(377) int local377;
		if (local139 == null || local32 != (local139.ua() & local32)) {
			if (local139 != null) {
				local32 |= local139.ua();
			}
			@Pc(178) int local178 = local32;
			if (this.aShortArray99 != null) {
				local178 = local32 | 0x4000;
			}
			if (this.aShortArray101 != null) {
				local178 |= 0x8000;
			}
			...
			synchronized (this.aClass308_1.aClass330_102) {
				for (local226 = 0; local226 < local216.length; local226++) {
					if (local216[local226] != -1 && !this.aClass308_1.aClass330_102.method5350(0, local216[local226])) {
						local218 = true;
					}
				}
			}
			...
			for (local226 = 0; local226 < local216.length; local226++) {
				if (local216[local226] != -1) {
					...
					synchronized (this.aClass308_1.aClass330_102) {
						local267[local226] = Static121.method1430(local216[local226], this.aClass308_1.aClass330_102);
					}
					if (local267[local226] != null) {
						if (local267[local226].anInt2379 < 13) {
							local267[local226].method1452();
						}
						if (this.anIntArrayArray166 != null && this.anIntArrayArray166[local226] != null) {
							local267[local226].method1453(this.anIntArrayArray166[local226][0], this.anIntArrayArray166[local226][1], this.anIntArrayArray166[local226][2]);
						}
					}
				}
			}
				...
				for (local377 = 0; local377 < local147.anIntArrayArray181.length; local377++) {
					if (local267.length > local377 && local267[local377] != null) {
						...
						if (local402 != 0 || local404 != 0 || local406 != 0) {
							local267[local377].method1456(local406, local402, local404);
						}
						if (local396 != 0 || local398 != 0 || local400 != 0) {
							local267[local377].method1453(local396, local398, local400);
						}
					}
				}
			}
			...
			local139 = arg1.a(local529, local178, this.aClass308_1.anInt8088, this.anInt6732 + 64, this.anInt6747 + 850);
			@Pc(568) short[] local568;
			if (this.aShortArray99 != null) {
				if (arg6 == null || arg6.aShortArray145 == null) {
					local568 = this.aShortArray100;
				} else {
					local568 = arg6.aShortArray145;
				}
				for (local396 = 0; local396 < this.aShortArray99.length; local396++) {
			...
			if (this.aShortArray101 != null) {
				if (arg6 == null || arg6.aShortArray144 == null) {
					local568 = this.aShortArray102;
				} else {
					local568 = arg6.aShortArray144;
				}
				for (local396 = 0; local396 < this.aShortArray101.length; local396++) {
					local139.aa(this.aShortArray101[local396], local568[local396]);
				}
			}
			if (this.aByte105 != 0) {
			...
			synchronized (this.aClass308_1.aClass82_170) {
				this.aClass308_1.aClass82_170.method1384(local139, local116);
			}
		}
		@Pc(706) Class114 local706 = local139.a((byte) 4, local32, true);
		...
		@Pc(747) Class73[] local747 = null;
		if (local147 != null) {
			local747 = local147.method4544(arg1);
		}
		@Pc(762) int local762;
		if (local716 && local747 != null) {
			for (local762 = 0; local762 < 12; local762++) {
				if (local747[local762] != null) {
					local706.a(local747[local762], 0x1 << local762, true);
				}
			}
		}
		local762 = 0;
		...
		while (local762 < local60) {
			if (arg9[local762] != null) {
				arg9[local762].method6544(local226, local706);
			}
			local762++;
			local226 <<= 0x1;
		}
		if (local716) {
			for (local377 = 0; local377 < 12; local377++) {
				if (arg5[local377] != -1) {
					local396 = arg5[local377] - arg4;
					local396 &= 0x3FFF;
					@Pc(838) Class73 local838 = arg1.y();
					local838.g(local396);
					local706.a(local838, 0x1 << local377, false);
				}
			}
		}
		if (local716 && local747 != null) {
			for (local377 = 0; local377 < 12; local377++) {
				if (local747[local377] != null) {
					local706.a(local747[local377], 0x1 << local377, false);
				}
			}
		}
		if (arg3 != null && arg7 != null) {
			Static468.method5399(arg3, local706, arg7);
		} else if (arg3 != null) {
			arg3.method6523(local706, 0);
		} else if (arg7 != null) {
			arg7.method6523(local706, 0);
		}
	...
	public int method4231(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		if (this.aClass28_32 == null) {
			return arg1;
		} else {
			@Pc(25) Class2_Sub38 local25 = (Class2_Sub38) this.aClass28_32.method373((long) arg0);
			return local25 == null ? arg1 : local25.anInt6379;
		}
	}

	@OriginalMember(owner = "client!o", name = "a", descriptor = "(BLclient!uk;)Z")
	public boolean method4232(@OriginalArg(1) Interface23 arg0) {
		if (this.anIntArray532 == null) {
			return true;
		}
		@Pc(19) int local19 = -1;
		if (this.anInt6749 != -1) {
			local19 = arg0.method4827(this.anInt6749);
		} else if (this.anInt6750 != -1) {
			local19 = arg0.method4828(this.anInt6750);
		}
		if (local19 < 0 || local19 >= this.anIntArray532.length - 1 || this.anIntArray532[local19] == -1) {
			@Pc(71) int local71 = this.anIntArray532[this.anIntArray532.length - 1];
			return local71 != -1;
		} else {
			return true;
		}
