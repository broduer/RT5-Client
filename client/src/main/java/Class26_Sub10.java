...
public final class Class26_Sub10 extends Class26 {
	...
	public Class26_Sub10(@OriginalArg(0) Class19_Sub1_Sub1 arg0, @OriginalArg(1) Class330 arg1, @OriginalArg(2) Class7 arg2) {
		...
		if (arg1 != null && this.aClass19_Sub1_21.aBoolean685 && this.aClass19_Sub1_21.aBoolean696 && (this.aClass19_Sub1_Sub1_8.aD3DCAPS1.VertexShaderVersion & 0xFFFF) >= 257) {
			this.anIDirect3DVertexShader8 = this.aClass19_Sub1_Sub1_8.anIDirect3DDevice1.b(arg1.method5364("dx", "environment_mapped_water_v"));
			this.anIDirect3DPixelShader1 = this.aClass19_Sub1_Sub1_8.anIDirect3DDevice1.a(arg1.method5364("dx", "environment_mapped_water_f"));
			this.aBoolean642 = this.anIDirect3DVertexShader8 != null && this.anIDirect3DPixelShader1 != null && this.aClass7_7.method67();
		} else {
	...
	public void method5871(@OriginalArg(1) boolean arg0) {
		@Pc(4) Interface8 local4 = this.aClass19_Sub1_21.method5754();
		if (!this.aBoolean642 || local4 == null) {
			return;
		}
		@Pc(15) IDirect3DDevice local15 = this.aClass19_Sub1_Sub1_8.anIDirect3DDevice1;
		this.aClass19_Sub1_Sub1_8.method3386(this.anIDirect3DVertexShader8);
		this.aClass19_Sub1_Sub1_8.method3388(this.anIDirect3DPixelShader1);
		this.aClass19_Sub1_21.method5747(1);
		this.aClass19_Sub1_21.method5697(local4);
		this.aClass19_Sub1_21.method5747(0);
		this.aClass19_Sub1_21.method5697(this.aClass7_7.anInterface2_1);
	...
	public void method5862() {
		...
		@Pc(13) Class73_Sub1 local13 = this.aClass19_Sub1_Sub1_8.method5727();
		@Pc(18) Class73_Sub1 local18 = this.aClass19_Sub1_Sub1_8.method5763();
		local8.a(0, local18.method1204(Static562.aFloatArray57));
		local8.a(4, local13.method1208(Static562.aFloatArray57));
	}
	...
	public void method5860() {
		...
		this.aClass19_Sub1_Sub1_8.method3386((IDirect3DVertexShader) null);
		this.aClass19_Sub1_Sub1_8.method3388((IDirect3DPixelShader) null);
		this.aClass19_Sub1_21.method5747(1);
	...
	public void method5859() {
		if (this.aBoolean643) {
			...
			@Pc(11) Class73_Sub1 local11 = this.aClass19_Sub1_Sub1_8.method5763();
			local6.a(0, local11.method1204(Static562.aFloatArray57));
		}
	}
	...
	public void method5861() {
		if (this.aBoolean643) {
			...
			local14.a(8, this.aClass19_Sub1_21.method5746(Static562.aFloatArray57));
		}
	}
	...
	public void method5870() {
		if (this.aBoolean643) {
			@Pc(8) IDirect3DDevice local8 = this.aClass19_Sub1_Sub1_8.anIDirect3DDevice1;
			@Pc(13) Class73_Sub1 local13 = this.aClass19_Sub1_21.method5675();
			local8.SetVertexShaderConstantF(12, local13.method1214(Static562.aFloatArray57), 2);
		}
	}
}
