...
public final class Class26_Sub3 extends Class26 {
	...
	public void method8297(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		...
		@Pc(36) long local36 = this.aClass319_1.aLong253;
		OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(local36, "time"), (float) (local8 * super.aClass19_Sub1_21.anInt9190 % 40000) / 40000.0F);
	...
	public void method8304(@OriginalArg(1) boolean arg0) {
		@Pc(17) Interface8 local17 = super.aClass19_Sub1_21.method8152();
		if (!this.aBoolean243 || local17 == null) {
			return;
		}
		super.aClass19_Sub1_21.method8145(1);
		super.aClass19_Sub1_21.method8095(local17);
		super.aClass19_Sub1_21.method8145(0);
		super.aClass19_Sub1_21.method8095(this.aClass7_4.anInterface2_1);
		@Pc(50) long local50 = this.aClass319_1.aLong253;
		...
		OpenGL.glUniform3fARB(OpenGL.glGetUniformLocationARB(local50, "sunDir"), -super.aClass19_Sub1_21.aFloatArray61[0], -super.aClass19_Sub1_21.aFloatArray61[1], -super.aClass19_Sub1_21.aFloatArray61[2]);
		...
		OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(local50, "sunExponent"), Math.abs(super.aClass19_Sub1_21.aFloatArray61[1]) * 928.0F + 96.0F);
