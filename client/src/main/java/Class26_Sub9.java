...
public final class Class26_Sub9 extends Class26 {
	...
	public Class26_Sub9(@OriginalArg(0) Class19_Sub1_Sub1 arg0, @OriginalArg(1) Class330 arg1, @OriginalArg(2) Class7 arg2) {
		...
		this.aClass7_6 = arg2;
		if (arg1 != null && this.aClass7_6.method68() && (this.aClass19_Sub1_Sub1_7.aD3DCAPS1.VertexShaderVersion & 0xFFFF) >= 257) {
			this.anIDirect3DVertexShader7 = this.aClass19_Sub1_Sub1_7.anIDirect3DDevice1.b(arg1.method5364("dx", "transparent_water"));
		} else {
	...
	public void method5865() {
		...
		this.aClass19_Sub1_21.method5721(this.aClass19_Sub1_21.anInt9146);
	}
	...
	public void method5859() {
		if (this.anIDirect3DVertexShader7 != null) {
			...
			@Pc(13) Class73_Sub1 local13 = this.aClass19_Sub1_Sub1_7.method5763();
			local8.a(0, local13.method1204(Static531.aFloatArray55));
		}
	}
	...
	public void method5871(@OriginalArg(1) boolean arg0) {
		...
		this.aClass19_Sub1_21.method5689(1, Static454.aClass168_5);
		this.aClass19_Sub1_21.method5734(Static207.aClass168_4, false, true, 2);
		this.aClass19_Sub1_21.method5749(false);
		this.aClass19_Sub1_Sub1_7.method3386(this.anIDirect3DVertexShader7);
		this.method5859();
		this.method5870();
		this.method5861();
		this.method5865();
	...
	public void method5866(@OriginalArg(0) boolean arg0) {
		this.aClass19_Sub1_21.method5703(Static438.aClass121_5, Static725.aClass121_6);
	}
	...
	public void method5861() {
		if (this.anIDirect3DVertexShader7 != null) {
			...
			local7.a(4, this.aClass19_Sub1_21.method5746(Static531.aFloatArray55));
		}
	}
	...
	public void method5860() {
		this.aClass19_Sub1_Sub1_7.method3386((IDirect3DVertexShader) null);
		this.aClass19_Sub1_21.method5689(0, Static189.aClass168_2);
		this.aClass19_Sub1_21.method5689(1, Static207.aClass168_4);
		this.aClass19_Sub1_21.method5689(2, Static454.aClass168_5);
		this.aClass19_Sub1_21.method5749(true);
	}
	...
	public void method5864(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		...
		if (this.aClass7_6.aBoolean7) {
			...
			this.aClass19_Sub1_21.method5697(this.aClass7_6.anInterface2_2);
			local3.a(11, local24, 0.0F, 0.0F, 0.0F);
		} else {
			@Pc(50) int local50 = this.aClass19_Sub1_21.anInt9164 % 4000 * 16 / 4000;
			this.aClass19_Sub1_21.method5697(this.aClass7_6.anInterface18Array2[local50]);
	...
	public void method5870() {
		...
		@Pc(16) IDirect3DDevice local16 = this.aClass19_Sub1_Sub1_7.anIDirect3DDevice1;
		@Pc(21) Class73_Sub1 local21 = this.aClass19_Sub1_21.method5675();
		local21.method1214(Static531.aFloatArray55);
	...
	public void method5862() {
		if (this.anIDirect3DVertexShader7 != null) {
			...
			@Pc(11) Class73_Sub1 local11 = this.aClass19_Sub1_Sub1_7.method5763();
			local6.a(0, local11.method1204(Static531.aFloatArray55));
		}
	}
