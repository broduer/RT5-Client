...
public final class Class270 {
	...
	@OriginalMember(owner = "client!o", name = "U", descriptor = "I")
	private int anInt6758 = 128;

	@OriginalMember(owner = "client!o", name = "h", descriptor = "I")
	public int anInt6732 = -1;

	@OriginalMember(owner = "client!o", name = "db", descriptor = "I")
	public int anInt6728 = -1;

	@OriginalMember(owner = "client!o", name = "Db", descriptor = "I")
	public int anInt6756 = 256;

	@OriginalMember(owner = "client!o", name = "v", descriptor = "I")
	public int anInt6760 = -1;

	@OriginalMember(owner = "client!o", name = "z", descriptor = "I")
	public int anInt6759 = -1;

	@OriginalMember(owner = "client!o", name = "f", descriptor = "I")
	public int anInt6743 = 0;
	...
	private int anInt6752 = 0;

	@OriginalMember(owner = "client!o", name = "ab", descriptor = "I")
	public int anInt6753 = -1;
	...
	public boolean method5991() {
		if (this.anIntArray532 == null) {
			return this.anInt6734 != -1 || this.anInt6731 != -1 || this.anInt6732 != -1;
		}
		for (@Pc(35) int local35 = 0; local35 < this.anIntArray532.length; local35++) {
			if (this.anIntArray532[local35] != -1) {
				@Pc(62) Class270 local62 = this.aClass310_1.method7099(this.anIntArray532[local35]);
				if (local62.anInt6734 != -1 || local62.anInt6731 != -1 || local62.anInt6732 != -1) {
					return true;
				}
			}
		}
	...
	public Class270 method5992(@OriginalArg(0) int arg0, @OriginalArg(1) Interface23 arg1) {
		if (arg0 != 65535) {
			return null;
		}
		@Pc(11) int local11 = -1;
		if (this.anInt6770 != -1) {
			local11 = arg1.method6871(this.anInt6770);
		} else if (this.anInt6771 != -1) {
			local11 = arg1.method6872(this.anInt6771);
		}
		if (local11 < 0 || this.anIntArray532.length - 1 <= local11 || this.anIntArray532[local11] == -1) {
			...
			return local66 == -1 ? null : this.aClass310_1.method7099(local66);
		} else {
			return this.aClass310_1.method7099(this.anIntArray532[local11]);
		}
	}

	@OriginalMember(owner = "client!o", name = "a", descriptor = "(BLclient!ge;)V")
	public void method5993(@OriginalArg(1) Class2_Sub21 arg0) {
		while (true) {
			@Pc(15) int local15 = arg0.method7403();
			if (local15 == 0) {
				return;
			}
			this.method5997(local15, arg0);
		}
	}

	@OriginalMember(owner = "client!o", name = "a", descriptor = "(ILclient!ge;B)V")
	private void method5997(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub21 arg1) {
		@Pc(12) int local12;
		@Pc(18) int local18;
		if (arg0 == 1) {
			local12 = arg1.method7403();
			this.anIntArray535 = new int[local12];
			for (local18 = 0; local18 < local12; local18++) {
				this.anIntArray535[local18] = arg1.method7389();
				if (this.anIntArray535[local18] == 65535) {
					this.anIntArray535[local18] = -1;
				}
			}
		} else if (arg0 == 2) {
			this.aString73 = arg1.method7365();
		} else if (arg0 == 12) {
			this.anInt6733 = arg1.method7403();
		} else if (arg0 >= 30 && arg0 < 35) {
			this.aStringArray34[arg0 - 30] = arg1.method7365();
		} else if (arg0 == 40) {
			local12 = arg1.method7403();
			this.aShortArray100 = new short[local12];
			this.aShortArray99 = new short[local12];
			for (local18 = 0; local18 < local12; local18++) {
				this.aShortArray99[local18] = (short) arg1.method7389();
				this.aShortArray100[local18] = (short) arg1.method7389();
			}
		} else if (arg0 == 41) {
			local12 = arg1.method7403();
			...
			for (local18 = 0; local18 < local12; local18++) {
				this.aShortArray101[local18] = (short) arg1.method7389();
				this.aShortArray102[local18] = (short) arg1.method7389();
			}
		} else if (arg0 == 42) {
			local12 = arg1.method7403();
			this.aByteArray80 = new byte[local12];
			for (local18 = 0; local18 < local12; local18++) {
				this.aByteArray80[local18] = arg1.method7384();
			}
		} else if (arg0 == 60) {
			local12 = arg1.method7403();
			this.anIntArray534 = new int[local12];
			for (local18 = 0; local18 < local12; local18++) {
				this.anIntArray534[local18] = arg1.method7389();
			}
		} else if (arg0 == 93) {
			this.aBoolean507 = false;
		} else if (arg0 == 95) {
			this.anInt6747 = arg1.method7389();
		} else if (arg0 == 97) {
			this.anInt6758 = arg1.method7389();
		} else if (arg0 == 98) {
			this.anInt6742 = arg1.method7389();
		} else if (arg0 == 99) {
			this.aBoolean502 = true;
		} else if (arg0 == 100) {
			this.anInt6752 = arg1.method7384();
		} else if (arg0 == 101) {
			this.anInt6767 = arg1.method7384() * 5;
		} else if (arg0 == 102) {
			this.anInt6728 = arg1.method7389();
		} else if (arg0 == 103) {
			this.anInt6768 = arg1.method7389();
		} else {
			@Pc(306) int local306;
			if (arg0 == 106 || arg0 == 118) {
				this.anInt6770 = arg1.method7389();
				if (this.anInt6770 == 65535) {
					this.anInt6770 = -1;
				}
				this.anInt6771 = arg1.method7389();
				if (this.anInt6771 == 65535) {
					this.anInt6771 = -1;
				}
				local12 = -1;
				if (arg0 == 118) {
					local12 = arg1.method7389();
					if (local12 == 65535) {
						local12 = -1;
					}
				}
				local18 = arg1.method7403();
				this.anIntArray532 = new int[local18 + 2];
				for (local306 = 0; local306 <= local18; local306++) {
					this.anIntArray532[local306] = arg1.method7389();
				...
				this.aShort75 = (short) arg1.method7389();
				this.aShort76 = (short) arg1.method7389();
			} else if (arg0 == 114) {
				this.aByte111 = arg1.method7384();
				this.aByte109 = arg1.method7384();
			} else if (arg0 == 119) {
				this.aByte103 = arg1.method7384();
			} else if (arg0 == 121) {
				this.anIntArrayArray166 = new int[this.anIntArray535.length][];
				local12 = arg1.method7403();
				for (local18 = 0; local18 < local12; local18++) {
					local306 = arg1.method7403();
					@Pc(914) int[] local914 = this.anIntArrayArray166[local306] = new int[3];
					local914[0] = arg1.method7384();
					local914[1] = arg1.method7384();
					local914[2] = arg1.method7384();
				}
			} else if (arg0 == 122) {
				this.anInt6769 = arg1.method7389();
			} else if (arg0 == 123) {
				this.anInt6727 = arg1.method7389();
			} else if (arg0 == 125) {
				this.aByte110 = arg1.method7384();
			} else if (arg0 == 127) {
				this.anInt6746 = arg1.method7389();
			} else if (arg0 == 128) {
				arg1.method7403();
			} else if (arg0 == 134) {
				this.anInt6734 = arg1.method7389();
				if (this.anInt6734 == 65535) {
					this.anInt6734 = -1;
				}
				this.anInt6744 = arg1.method7389();
				if (this.anInt6744 == 65535) {
					this.anInt6744 = -1;
				}
				this.anInt6731 = arg1.method7389();
				if (this.anInt6731 == 65535) {
					this.anInt6731 = -1;
				}
				this.anInt6732 = arg1.method7389();
				if (this.anInt6732 == 65535) {
					this.anInt6732 = -1;
				}
				this.anInt6762 = arg1.method7403();
			} else if (arg0 == 135) {
				this.anInt6736 = arg1.method7403();
				this.anInt6759 = arg1.method7389();
			} else if (arg0 == 136) {
				this.anInt6757 = arg1.method7403();
				this.anInt6773 = arg1.method7389();
			} else if (arg0 == 137) {
				this.anInt6760 = arg1.method7389();
			} else if (arg0 == 138) {
				this.anInt6735 = arg1.method7389();
			} else if (arg0 == 139) {
				this.anInt6740 = arg1.method7389();
			} else if (arg0 == 140) {
				this.anInt6741 = arg1.method7403();
			} else if (arg0 == 141) {
				this.aBoolean504 = true;
			} else if (arg0 == 142) {
				this.anInt6753 = arg1.method7389();
			} else if (arg0 == 143) {
				this.aBoolean503 = true;
			} else if (arg0 >= 150 && arg0 < 155) {
				this.aStringArray34[arg0 - 150] = arg1.method7365();
				if (!this.aClass310_1.aBoolean622) {
					this.aStringArray34[arg0 - 150] = null;
				}
			} else if (arg0 == 155) {
				this.aByte104 = arg1.method7384();
				this.aByte106 = arg1.method7384();
				this.aByte108 = arg1.method7384();
				this.aByte105 = arg1.method7384();
			} else if (arg0 == 158) {
				this.aByte107 = 1;
			} else if (arg0 == 159) {
				this.aByte107 = 0;
				...
				for (local18 = 0; local18 < local12; local18++) {
					this.anIntArray533[local18] = arg1.method7389();
				}
			} else if (arg0 == 162) {
				this.aBoolean508 = true;
			} else if (arg0 == 163) {
				this.anInt6726 = arg1.method7403();
			} else if (arg0 == 164) {
				this.anInt6749 = arg1.method7389();
				this.anInt6756 = arg1.method7389();
			} else if (arg0 == 165) {
				this.anInt6743 = arg1.method7403();
			} else if (arg0 == 168) {
				this.anInt6761 = arg1.method7403();
			} else if (arg0 == 249) {
				local12 = arg1.method7403();
				...
				for (local18 = 0; local18 < local12; local18++) {
					@Pc(761) boolean local761 = arg1.method7403() == 1;
					@Pc(765) int local765 = arg1.method7390();
					@Pc(774) Class2 local774;
					if (local761) {
						local774 = new Class2_Sub24(arg1.method7365());
					} else {
	...
	public String method5998(@OriginalArg(1) String arg0, @OriginalArg(2) int arg1) {
		if (this.aClass28_32 == null) {
			return arg0;
		} else {
	...
	public Class114 method5999(@OriginalArg(1) Class152 arg0, @OriginalArg(2) Class388 arg1, @OriginalArg(4) Class19 arg2, @OriginalArg(5) Interface23 arg3) {
		if (this.anIntArray532 != null) {
			@Pc(15) Class270 local15 = this.method5992(65535, arg3);
			return local15 == null ? null : local15.method5999(arg0, arg1, arg2, arg3);
			...
			if (local94 == null || (local94.ua() & local54) != local54) {
				...
				synchronized (this.aClass310_1.aClass332_102) {
					...
					while (true) {
						...
						local215[local223] = Static121.method2201(local163[local223], this.aClass310_1.aClass332_102);
						local223++;
					}
				}
				for (@Pc(258) int local258 = 0; local258 < local163.length; local258++) {
					if (local215[local258] != null && local215[local258].anInt2388 < 13) {
				...
				local94 = arg2.method7959(local304, local125, this.aClass310_1.anInt8111, 64, 768);
				@Pc(340) int local340;
				@Pc(334) short[] local334;
				if (this.aShortArray99 != null) {
					if (arg1 == null || arg1.aShortArray146 == null) {
						local334 = this.aShortArray100;
					} else {
						local334 = arg1.aShortArray146;
					}
			...
			if (arg0 != null) {
				local94 = local94.method7502((byte) 1, local54, true);
				arg0.method9096(local94, 0);
			}
			local94.s(2048);
			return local94;
		}
	...
	public Class114 method6000(@OriginalArg(0) Interface23 arg0, @OriginalArg(1) Class19 arg1, @OriginalArg(2) Class312 arg2, @OriginalArg(4) Class152 arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int[] arg5, @OriginalArg(7) Class388 arg6, @OriginalArg(8) Class152 arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class152[] arg9) {
		...
		if (this.anInt6742 != 128) {
			local32 = arg8 | 0x2;
		}
		if (this.anInt6758 != 128) {
			local32 |= 0x5;
		}
		...
		for (@Pc(62) int local62 = 0; local62 < local60; local62++) {
			if (arg9[local62] != null) {
				local32 |= arg9[local62].method9108();
				local52 = true;
			}
		}
		if (arg3 != null) {
			local52 = true;
			local32 |= arg3.method9108();
		}
		if (arg7 != null) {
		...
		if (local139 == null || local32 != (local139.ua() & local32)) {
			...
			for (local226 = 0; local226 < local216.length; local226++) {
				if (local216[local226] != -1) {
					...
					if (local267[local226] != null) {
						if (local267[local226].anInt2388 < 13) {
							local267[local226].method2232();
						}
			...
			local139 = arg1.method7959(local529, local178, this.aClass310_1.anInt8111, this.anInt6752 + 64, this.anInt6767 + 850);
			@Pc(568) short[] local568;
			if (this.aShortArray99 != null) {
				if (arg6 == null || arg6.aShortArray146 == null) {
					local568 = this.aShortArray100;
				} else {
					local568 = arg6.aShortArray146;
				}
		...
		if (local147 != null) {
			local747 = local147.method6487(arg1);
		}
		@Pc(762) int local762;
		if (local716 && local747 != null) {
			for (local762 = 0; local762 < 12; local762++) {
				if (local747[local762] != null) {
					local706.method7499(local747[local762], 0x1 << local762, true);
				}
			}
		}
		local762 = 0;
		...
		while (local762 < local60) {
			if (arg9[local762] != null) {
				arg9[local762].method9117(local226, local706);
			}
			local762++;
			local226 <<= 0x1;
		}
		if (local716) {
			for (local377 = 0; local377 < 12; local377++) {
				if (arg5[local377] != -1) {
					...
					local396 &= 0x3FFF;
					@Pc(838) Class73 local838 = arg1.method7960();
					local838.method7138(local396);
					local706.method7499(local838, 0x1 << local377, false);
				}
			}
		}
		if (local716 && local747 != null) {
			for (local377 = 0; local377 < 12; local377++) {
				if (local747[local377] != null) {
					local706.method7499(local747[local377], 0x1 << local377, false);
				}
			}
		}
		if (arg3 != null && arg7 != null) {
			Static468.method7652(arg3, local706, arg7);
		} else if (arg3 != null) {
			arg3.method9096(local706, 0);
		} else if (arg7 != null) {
			arg7.method9096(local706, 0);
		}
		if (this.anInt6758 != 128 || this.anInt6742 != 128) {
			local706.O(this.anInt6758, this.anInt6742, this.anInt6758);
		}
		local706.s(arg8);
		return local706;
	}
	...
	public int method6002(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		if (this.aClass28_32 == null) {
			return arg1;
		} else {
	...
	public boolean method6003(@OriginalArg(1) Interface23 arg0) {
		if (this.anIntArray532 == null) {
			return true;
		}
		@Pc(19) int local19 = -1;
		if (this.anInt6770 != -1) {
			local19 = arg0.method6871(this.anInt6770);
		} else if (this.anInt6771 != -1) {
			local19 = arg0.method6872(this.anInt6771);
		}
