...
public final class Class271 {
	...
	public Class271() {
		Static650.method6049(24);
		this.anInt6803 = Static650.method6049(16);
		this.anInt6802 = Static650.method6049(24);
		this.anIntArray543 = new int[this.anInt6802];
		@Pc(23) boolean local23 = Static650.method6058() != 0;
		@Pc(27) int local27;
		@Pc(32) int local32;
		@Pc(43) int local43;
		if (local23) {
			local27 = 0;
			local32 = Static650.method6049(5) + 1;
			while (local27 < this.anInt6802) {
				@Pc(41) int local41 = Static650.method6049(Static434.method4154(this.anInt6802 - local27));
			...
			@Pc(66) boolean local66 = Static650.method6058() != 0;
			for (local32 = 0; local32 < this.anInt6802; local32++) {
				if (local66 && Static650.method6058() == 0) {
					this.anIntArray543[local32] = 0;
				} else {
					this.anIntArray543[local32] = Static650.method6049(5) + 1;
				}
			}
		}
		this.method4252();
		...
		if (local27 > 0) {
			@Pc(103) float local103 = Static650.method6056(Static650.method6049(32));
			@Pc(107) float local107 = Static650.method6056(Static650.method6049(32));
			local43 = Static650.method6049(4) + 1;
			@Pc(118) boolean local118 = Static650.method6058() != 0;
			@Pc(127) int local127;
			if (local27 == 1) {
				local127 = Static731.method4251(this.anInt6802, this.anInt6803);
			} else {
				local127 = this.anInt6802 * this.anInt6803;
			}
			this.anIntArray544 = new int[local127];
			for (@Pc(140) int local140 = 0; local140 < local127; local140++) {
				this.anIntArray544[local140] = Static650.method6049(local43);
			}
	...
	public int method4253() {
		@Pc(1) int local1;
		for (local1 = 0; this.anIntArray545[local1] >= 0; local1 = Static650.method6058() == 0 ? local1 + 1 : this.anIntArray545[local1]) {
		}
		return ~this.anIntArray545[local1];
	}

	@OriginalMember(owner = "client!oca", name = "c", descriptor = "()[F")
	public float[] method4254() {
		return this.aFloatArrayArray13[this.method4253()];
	}
}
