...
public final class Class273 {
	...
	public Class273() {
		Static650.method8507(24);
		this.anInt6824 = Static650.method8507(16);
		this.anInt6823 = Static650.method8507(24);
		this.anIntArray543 = new int[this.anInt6823];
		@Pc(23) boolean local23 = Static650.method8516() != 0;
		@Pc(27) int local27;
		@Pc(32) int local32;
		@Pc(43) int local43;
		if (local23) {
			local27 = 0;
			local32 = Static650.method8507(5) + 1;
			while (local27 < this.anInt6823) {
				@Pc(41) int local41 = Static650.method8507(Static434.method5860(this.anInt6823 - local27));
			...
			@Pc(66) boolean local66 = Static650.method8516() != 0;
			for (local32 = 0; local32 < this.anInt6823; local32++) {
				if (local66 && Static650.method8516() == 0) {
					this.anIntArray543[local32] = 0;
				} else {
					this.anIntArray543[local32] = Static650.method8507(5) + 1;
				}
			}
		}
		this.method6117();
		local27 = Static650.method8507(4);
		if (local27 > 0) {
			@Pc(103) float local103 = Static650.method8514(Static650.method8507(32));
			@Pc(107) float local107 = Static650.method8514(Static650.method8507(32));
			local43 = Static650.method8507(4) + 1;
			...
			for (@Pc(140) int local140 = 0; local140 < local127; local140++) {
				this.anIntArray544[local140] = Static650.method8507(local43);
			}
			this.aFloatArrayArray13 = new float[this.anInt6823][this.anInt6824];
			@Pc(163) int local163;
			@Pc(166) float local166;
			@Pc(168) int local168;
			@Pc(170) int local170;
			if (local27 == 1) {
				for (local163 = 0; local163 < this.anInt6823; local163++) {
					local166 = 0.0F;
					local168 = 1;
					for (local170 = 0; local170 < this.anInt6824; local170++) {
			...
			for (local163 = 0; local163 < this.anInt6823; local163++) {
				local166 = 0.0F;
				local168 = local163 * this.anInt6824;
				for (local170 = 0; local170 < this.anInt6824; local170++) {
	...
	private void method6117() {
		@Pc(3) int[] local3 = new int[this.anInt6823];
		...
		@Pc(54) int local54;
		@Pc(63) int local63;
		for (@Pc(8) int local8 = 0; local8 < this.anInt6823; local8++) {
		...
		local14 = 0;
		for (local22 = 0; local22 < this.anInt6823; local22++) {
	...
	public int method6118() {
		@Pc(1) int local1;
		for (local1 = 0; this.anIntArray545[local1] >= 0; local1 = Static650.method8516() == 0 ? local1 + 1 : this.anIntArray545[local1]) {
		}
		return ~this.anIntArray545[local1];
	}

	@OriginalMember(owner = "client!oca", name = "c", descriptor = "()[F")
	public float[] method6119() {
		return this.aFloatArrayArray13[this.method6118()];
	}
}
