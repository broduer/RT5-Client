...
public final class Class274 {
	...
	public Class274(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) Class293 arg1, @OriginalArg(2) Class178_Sub1 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		if (local27 <= 0) {
			...
			this.anInterface20_4 = this.aClass19_Sub1_13.method5731(false);
			this.anInterface20_4.method6087(local27);
			for (local50 = 0; local50 < 4; local50++) {
				@Pc(120) Buffer local120 = this.anInterface20_4.method6091();
				if (local120 != null) {
					@Pc(128) Stream local128 = this.aClass19_Sub1_13.method5709(local120);
					@Pc(132) int local132;
					@Pc(144) int local144;
					@Pc(146) int local146;
					...
					local128.c();
					if (this.anInterface20_4.method6090()) {
						break;
					}
				}
			}
	...
	public void method4330(@OriginalArg(1) Interface20 arg0, @OriginalArg(2) int arg1) {
		if (arg1 > 0) {
			this.method4331();
			this.aClass19_Sub1_13.method5697(this.anInterface18_4);
			this.aClass19_Sub1_13.method5661(this.anInt6920, 0, arg0, this.anInt6919 + 1 - this.anInt6920, Static104.aClass131_2, arg1);
		}
	}
	...
	private void method4331() {
		...
		@Pc(146) int local146;
		@Pc(168) int local168;
		if (!this.aClass19_Sub1_13.method5680(Static679.aClass92_15, Static702.aClass397_16)) {
			...
			if (this.anInterface18_4 == null) {
				this.anInterface18_4 = this.aClass19_Sub1_13.method5643(false, 128, 128, Static42.anIntArray69);
				this.anInterface18_4.method6486(false, false);
			} else {
				this.anInterface18_4.method6482(Static42.anIntArray69, 0, 0, 128, 128, 128);
			}
			return;
		}
		...
		if (this.anInterface18_4 == null) {
			this.anInterface18_4 = this.aClass19_Sub1_13.method5637(128, Static369.aByteArray43, Static679.aClass92_15, 128, false);
			this.anInterface18_4.method6486(false, false);
		} else {
			this.anInterface18_4.method6485(128, 128, Static369.aByteArray43, Static679.aClass92_15, 128);
		}
	}

	@OriginalMember(owner = "client!oh", name = "b", descriptor = "(I)V")
	public void method4333() {
		this.method4330(this.anInterface20_4, this.anInt6928);
	}
}
