...
public final class Class276 {
	...
	private boolean method4348() {
		if (this.aBoolean527) {
			if (this.aClass2_Sub2_Sub19_1 != null) {
				this.aClass2_Sub2_Sub19_1.method6136();
				this.aClass2_Sub2_Sub19_1 = null;
			}
			if (this.aClass93_Sub2_4 != null) {
				this.aClass93_Sub2_4.method6821();
		...
		if (this.aBoolean524) {
			if (this.aClass406_3 == null) {
				this.aClass19_Sub3_32.method4842(this.aClass406_4);
				this.aClass406_4.method6752(0);
				this.aClass406_4.method6752(1);
				this.aClass406_4.method6752(8);
				this.aClass406_4.method6758(this.aClass93_Sub2Array2[0], 0);
				if (this.anInt6954 > 1) {
					this.aClass406_4.method6758(this.aClass93_Sub2Array2[1], 1);
				}
				if (this.aBoolean528) {
					this.aClass406_4.method6758(this.aClass93_Sub2_4, 8);
				} else {
					this.aClass406_4.method6755(this.aClass2_Sub2_Sub19_1, 8);
				}
				...
				this.aClass19_Sub3_32.method4868(this.aClass406_4);
				this.aClass19_Sub3_32.method4842(this.aClass406_3);
				this.aClass406_3.method6752(0);
				this.aClass406_3.method6752(8);
				this.aClass406_3.method6755(this.aClass2_Sub2_Sub19_2, 0);
				this.aClass406_3.method6755(this.aClass2_Sub2_Sub19_1, 8);
				this.aClass19_Sub3_32.method4868(this.aClass406_3);
			}
			this.aBoolean524 = false;
			this.aBoolean525 = true;
		}
		if (this.aBoolean525) {
			this.aClass19_Sub3_32.method4842(this.aClass406_5);
			this.aBoolean525 = !this.aClass406_5.method6757();
			this.aClass19_Sub3_32.method4868(this.aClass406_5);
		}
	...
	public void method4349() {
		...
		if (this.aClass406_3 != null) {
			this.aClass19_Sub3_32.method4913(this.aClass406_3);
			@Pc(21) short local21 = 16384;
			this.aClass19_Sub3_32.method4911(this.aClass406_4);
			this.aClass406_3.method6763();
			this.aClass406_4.method6760(0);
			if (this.aBoolean528) {
				local21 = 16640;
			}
		...
		this.aClass19_Sub3_32.method4893();
		this.aClass19_Sub3_32.method4892(0);
		this.aClass19_Sub3_32.method4866(1);
		this.aClass19_Sub3_32.la();
		@Pc(90) int local90 = 0;
		@Pc(99) int local99 = 1;
		@Pc(115) Class2_Sub31 local115;
		for (@Pc(105) Class2_Sub31 local105 = (Class2_Sub31) this.aClass339_39.method5453(65280); local105 != null; local105 = local115) {
			local115 = (Class2_Sub31) this.aClass339_39.method5460();
			@Pc(119) int local119 = local105.method3223();
			for (@Pc(121) int local121 = 0; local121 < local119; local121++) {
				local105.method3229(this.aClass93_Sub2_4, this.aClass93_Sub2Array2[local90], local121);
	...
	public boolean method4350(@OriginalArg(0) Class2_Sub31 arg0) {
		if (this.aClass406_5 != null) {
			if (arg0.method3227() || arg0.method3235()) {
				this.aClass339_39.method5465(arg0);
				this.method4351();
				if (this.method4348()) {
					if (this.anInt6944 != -1 && this.anInt6943 != -1) {
						arg0.method3232(this.anInt6944, this.anInt6943);
					}
					arg0.aBoolean387 = true;
					return true;
				}
			}
			this.method4355(arg0);
		}
		return false;
	}
	...
	private void method4351() {
		...
		@Pc(17) int local17 = 0;
		@Pc(32) int local32;
		for (@Pc(25) Class2_Sub31 local25 = (Class2_Sub31) this.aClass339_39.method5453(65280); local25 != null; local25 = (Class2_Sub31) this.aClass339_39.method5460()) {
			local32 = local25.method3230();
			if (local15 < local32) {
				local15 = local32;
			}
			local17 += local25.method3223();
			local13 |= local25.method3231();
		}
		if (local15 == 2) {
			local32 = 34836;
		} else if (local15 == 1) {
	...
	public void method4353() {
		...
		this.aClass93_Sub2_4 = null;
		if (!this.aClass339_39.method5456()) {
			for (@Pc(41) Class2 local41 = this.aClass339_39.method5453(65280); local41 != this.aClass339_39.aClass2_271; local41 = local41.aClass2_346) {
				((Class2_Sub31) local41).method3226();
			}
		}
	...
	public boolean method4354(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		if (this.aClass406_5 == null || this.aClass339_39.method5456()) {
			return false;
		}
		if (arg0 != this.anInt6944 || arg2 != this.anInt6943) {
			this.anInt6944 = arg0;
			this.anInt6943 = arg2;
			for (@Pc(43) Class2 local43 = this.aClass339_39.method5453(65280); local43 != this.aClass339_39.aClass2_271; local43 = local43.aClass2_346) {
				((Class2_Sub31) local43).method3232(this.anInt6944, this.anInt6943);
			}
			this.aBoolean526 = true;
			this.aBoolean527 = true;
			this.aBoolean524 = true;
		...
		this.anInt6942 = arg1;
		this.aClass19_Sub3_32.method4842(this.aClass406_5);
		this.aClass406_5.method6760(0);
		this.aClass19_Sub3_32.method4897(this.anInt6943 + this.anInt6948 - this.aClass19_Sub3_32.anInt7956, -this.anInt6942);
		return true;
	}

	@OriginalMember(owner = "client!oia", name = "a", descriptor = "(ILclient!jea;)V")
	public void method4355(@OriginalArg(1) Class2_Sub31 arg0) {
