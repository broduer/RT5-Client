...
public final class Class278 {
	...
	private void method4375(@OriginalArg(0) Class2_Sub21 arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 1) {
			this.anInt6988 = arg0.method5191();
		} else if (arg1 == 2) {
			arg0.method5205();
		} else if (arg1 == 3) {
			this.anInt6979 = arg0.method5158();
			this.anInt6987 = arg0.method5158();
			this.anInt6975 = arg0.method5158();
		} else if (arg1 == 4) {
			this.anInt6985 = arg0.method5205();
			this.anInt6973 = arg0.method5158();
		} else if (arg1 == 6) {
			this.anInt6982 = arg0.method5205();
		} else if (arg1 == 8) {
			this.anInt6978 = 1;
		} else if (arg1 == 9) {
			this.anInt6984 = 1;
	...
	public void method4378(@OriginalArg(1) Class2_Sub21 arg0) {
		while (true) {
			@Pc(17) int local17 = arg0.method5205();
			if (local17 == 0) {
				return;
			}
			this.method4375(arg0, local17);
		}
	}
}
