...
public final class Class279 {
	...
	public Class279(@OriginalArg(0) Class377 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class330 arg2) {
		...
		this.aClass330_92.method5372(1);
		@Pc(22) Class2_Sub21 local22 = new Class2_Sub21(this.aClass330_92.method5359(0, 0));
		@Pc(26) int local26 = local22.method5205();
		if (local26 > 3) {
			this.aBooleanArray22 = new boolean[0];
			this.anInt6994 = -1;
			this.anIntArrayArray171 = new int[0][];
		} else {
			@Pc(33) int local33 = local22.method5205();
			@Pc(36) Class204[] local36 = Static370.method3738();
			@Pc(38) boolean local38 = true;
			@Pc(44) int local44;
			@Pc(50) int local50;
			if (local33 == local36.length) {
				for (local44 = 0; local44 < local36.length; local44++) {
					local50 = local22.method5205();
			...
			if (local38) {
				local44 = local22.method5205();
				local50 = local22.method5205();
				if (local26 > 2) {
					this.anInt6994 = local22.method5165();
				} else {
					this.anInt6994 = -1;
				}
				...
				for (@Pc(122) int local122 = 0; local122 < local44; local122++) {
					local128 = local22.method5205();
					this.aBooleanArray22[local128] = local22.method5205() == 1;
					@Pc(147) int local147 = local22.method5191();
					@Pc(169) int local169;
					if (this.anInt6994 == -1) {
						this.anIntArrayArray171[local128] = new int[local147];
						for (local169 = 0; local169 < local147; local169++) {
							this.anIntArrayArray171[local128][local169] = local22.method5191();
						}
					} else {
						this.anIntArrayArray171[local128] = new int[local147 + 1];
						this.anIntArrayArray171[local128][0] = this.anInt6994;
						for (local169 = 0; local169 < local147; local169++) {
							this.anIntArrayArray171[local128][local169 + 1] = local22.method5191();
						}
					}
				}
	...
	public int[] method4379(@OriginalArg(0) int arg0) {
		if (arg0 < 0 || this.anIntArrayArray171.length <= arg0) {
			...
			Static734.method5449(this.anIntArrayArray171[arg0], 0, local77, 0, local77.length);
			for (@Pc(99) int local99 = local66; local99 < local77.length; local99++) {
				@Pc(112) int local112 = local66 + Static623.method5895(-5208, local77.length - local66, local70);
	...
	public Class76 method4381(@OriginalArg(0) int arg0) {
		@Pc(10) byte[] local10 = this.aClass330_92.method5359(arg0, 1);
		@Pc(14) Class76 local14 = new Class76();
		local14.method1293(new Class2_Sub21(local10));
		return local14;
	}
}
