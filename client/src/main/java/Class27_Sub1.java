...
public final class Class27_Sub1 extends Class27 {
	...
	@Override
	protected long method3981() {
		this.aLong18 += this.method369();
	...
	@Override
	protected int method3978(@OriginalArg(1) long arg0) {
		if (this.aLong19 > this.aLong18) {
	...
	private long method369() {
		@Pc(10) long local10 = Static588.method5469() * 1000000L;
