...
public final class Class27_Sub3 extends Class27 {
	...
	private long method5610() {
		@Pc(1) long local1 = jagmisc.nanoTime();
		@Pc(14) long local14 = local1 - this.aLong203;
		this.aLong203 = local1;
		if (local14 > -5000000000L && local14 < 5000000000L) {
			this.aLongArray13[this.anInt6283] = local14;
			if (this.anInt6284 < 1) {
				this.anInt6284++;
			}
			this.anInt6283 = (this.anInt6283 + 1) % 10;
		}
		@Pc(59) long local59 = 0L;
		for (@Pc(61) int local61 = 1; local61 <= this.anInt6284; local61++) {
			local59 += this.aLongArray13[(this.anInt6283 + 10 - local61) % 10];
		}
		return local59 / (long) this.anInt6284;
	}
