...
public final class Class289 {
	...
	public int anInt7257 = -1;

	@OriginalMember(owner = "client!pda", name = "f", descriptor = "I")
	public int anInt7229 = -1;
	...
	public int anInt7266 = -1;

	@OriginalMember(owner = "client!pda", name = "z", descriptor = "[I")
	public int[] anIntArray589 = null;
	...
	public int method4541() {
		if (this.anInt7232 != -1) {
			return this.anInt7232;
		} else if (this.anIntArray587 == null) {
			return -1;
		} else {
			@Pc(33) int local33 = (int) ((double) this.anInt7248 * Math.random());
			@Pc(35) int local35;
			for (local35 = 0; local33 >= this.anIntArray589[local35]; local35++) {
				local33 -= this.anIntArray589[local35];
			}
			return this.anIntArray587[local35];
		}
	}

	@OriginalMember(owner = "client!pda", name = "a", descriptor = "(IB)Z")
	public boolean method4543(@OriginalArg(0) int arg0) {
		if (arg0 == -1) {
			return false;
		} else if (arg0 == this.anInt7232) {
			return true;
		} else {
			if (this.anIntArray587 != null) {
				for (@Pc(29) int local29 = 0; local29 < this.anIntArray587.length; local29++) {
					if (this.anIntArray587[local29] == arg0) {
						return true;
					}
				}
			}
	...
	public Class73[] method4544(@OriginalArg(1) Class19 arg0) {
		if (this.aClass73Array1 != null && this.anInt7261 == arg0.anInt8962) {
			...
			for (@Pc(35) int local35 = 0; local35 < this.anIntArrayArray181.length; local35++) {
				...
				if (local38 != 0 || local40 != 0 || local42 != 0 || local44 != 0 || local46 != 0 || local48 != 0) {
					@Pc(137) Class73 local137 = this.aClass73Array1[local35] = arg0.y();
					if (local48 != 0) {
						local137.b(local48);
					}
					if (local44 != 0) {
					...
					local137.b(local38, local40, local42);
				}
			}
			return this.aClass73Array1;
		}
	...
	private void method4546(@OriginalArg(1) Class2_Sub21 arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 1) {
			this.anInt7232 = arg0.method5191();
			this.anInt7245 = arg0.method5191();
			if (this.anInt7232 == 65535) {
				this.anInt7232 = -1;
			}
			if (this.anInt7245 == 65535) {
				this.anInt7245 = -1;
			}
		} else if (arg1 == 2) {
			this.anInt7235 = arg0.method5191();
		} else if (arg1 == 3) {
			this.anInt7262 = arg0.method5191();
		} else if (arg1 == 4) {
			this.anInt7239 = arg0.method5191();
		} else if (arg1 == 5) {
			this.anInt7268 = arg0.method5191();
		} else if (arg1 == 6) {
			this.anInt7226 = arg0.method5191();
		} else if (arg1 == 7) {
			this.anInt7241 = arg0.method5191();
		} else if (arg1 == 8) {
			this.anInt7240 = arg0.method5191();
		} else if (arg1 == 9) {
			this.anInt7260 = arg0.method5191();
		} else if (arg1 == 26) {
			this.anInt7234 = (short) (arg0.method5205() * 4);
			this.anInt7238 = (short) (arg0.method5205() * 4);
		} else {
			@Pc(128) int local128;
			@Pc(136) int local136;
			if (arg1 == 27) {
				...
				local128 = arg0.method5205();
				this.anIntArrayArray181[local128] = new int[6];
				for (local136 = 0; local136 < 6; local136++) {
					this.anIntArrayArray181[local128][local136] = arg0.method5165();
				}
			} else if (arg1 == 28) {
				local128 = arg0.method5205();
				this.anIntArray586 = new int[local128];
				for (local136 = 0; local136 < local128; local136++) {
					this.anIntArray586[local136] = arg0.method5205();
					if (this.anIntArray586[local136] == 255) {
						this.anIntArray586[local136] = -1;
					}
				}
			} else if (arg1 == 29) {
				this.anInt7231 = arg0.method5205();
			} else if (arg1 == 30) {
				this.anInt7250 = arg0.method5191();
			} else if (arg1 == 31) {
				this.anInt7246 = arg0.method5205();
			} else if (arg1 == 32) {
				this.anInt7251 = arg0.method5191();
			} else if (arg1 == 33) {
				this.anInt7224 = arg0.method5165();
			} else if (arg1 == 34) {
				this.anInt7242 = arg0.method5205();
			} else if (arg1 == 35) {
				this.anInt7256 = arg0.method5191();
			} else if (arg1 == 36) {
				this.anInt7252 = arg0.method5165();
			} else if (arg1 == 37) {
				this.anInt7229 = arg0.method5205();
			} else if (arg1 == 38) {
				this.anInt7264 = arg0.method5191();
			} else if (arg1 == 39) {
				this.anInt7243 = arg0.method5191();
			} else if (arg1 == 40) {
				this.anInt7253 = arg0.method5191();
			} else if (arg1 == 41) {
				this.anInt7266 = arg0.method5191();
			} else if (arg1 == 42) {
				this.anInt7254 = arg0.method5191();
			} else if (arg1 == 43) {
				this.anInt7257 = arg0.method5191();
			} else if (arg1 == 44) {
				this.anInt7259 = arg0.method5191();
			} else if (arg1 == 45) {
				this.anInt7267 = arg0.method5191();
			} else if (arg1 == 46) {
				this.anInt7244 = arg0.method5191();
			} else if (arg1 == 47) {
				this.anInt7233 = arg0.method5191();
			} else if (arg1 == 48) {
				this.anInt7249 = arg0.method5191();
			} else if (arg1 == 49) {
				this.anInt7227 = arg0.method5191();
			} else if (arg1 == 50) {
				this.anInt7263 = arg0.method5191();
			} else if (arg1 == 51) {
				this.anInt7269 = arg0.method5191();
			} else if (arg1 == 52) {
				local128 = arg0.method5205();
				this.anIntArray587 = new int[local128];
				this.anIntArray589 = new int[local128];
				for (local136 = 0; local136 < local128; local136++) {
					this.anIntArray587[local136] = arg0.method5191();
					@Pc(395) int local395 = arg0.method5205();
					this.anIntArray589[local136] = local395;
					this.anInt7248 += local395;
				}
			} else if (arg1 == 53) {
				this.aBoolean545 = false;
			} else if (arg1 == 54) {
				this.anInt7236 = arg0.method5205() << 6;
				this.anInt7258 = arg0.method5205() << 6;
			} else if (arg1 == 55) {
				if (this.anIntArray585 == null) {
					this.anIntArray585 = new int[this.aClass310_1.aClass388_2.anIntArray821.length];
				}
				local128 = arg0.method5205();
				this.anIntArray585[local128] = arg0.method5191();
			} else if (arg1 == 56) {
				...
				for (local136 = 0; local136 < 3; local136++) {
					this.anIntArrayArray180[local128][local136] = arg0.method5165();
				}
			}
		}
	}
	...
	public void method4547(@OriginalArg(1) Class2_Sub21 arg0) {
		while (true) {
			@Pc(5) int local5 = arg0.method5205();
			if (local5 == 0) {
				return;
			}
			this.method4546(arg0, local5);
		}
	}
}
