...
public final class Class292 {
	...
	public Class292(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2) {
		this.anInt7365 = Static591.method5502(arg0.length, arg0);
		...
		if (arg2 != null) {
			...
			this.aByteArray86 = Static607.method5770(arg0, arg0.length, 0);
	...
	private void method4620(@OriginalArg(0) byte[] arg0) {
		@Pc(12) Class2_Sub21 local12 = new Class2_Sub21(Static590.method5488(arg0));
		@Pc(16) int local16 = local12.method5205();
		if (local16 < 5 || local16 > 7) {
			throw new RuntimeException();
		}
		if (local16 >= 6) {
			this.anInt7366 = local12.method5158();
		} else {
			this.anInt7366 = 0;
		}
		@Pc(54) int local54 = local12.method5205();
		@Pc(63) boolean local63 = (local54 & 0x1) != 0;
		@Pc(75) boolean local75 = (local54 & 0x2) != 0;
		if (local16 >= 7) {
			this.anInt7367 = local12.method5173();
		} else {
			this.anInt7367 = local12.method5191();
		}
		...
		if (local16 >= 7) {
			for (local115 = 0; local115 < this.anInt7367; local115++) {
				this.anIntArray600[local115] = local101 += local12.method5173();
			...
			for (local115 = 0; local115 < this.anInt7367; local115++) {
				this.anIntArray600[local115] = local101 += local12.method5191();
		...
		if (local63) {
			...
			for (local265 = 0; local265 < this.anInt7367; local265++) {
				this.anIntArray596[this.anIntArray600[local265]] = local12.method5158();
			}
			this.aClass100_1 = new Class100(this.anIntArray596);
		}
		for (local115 = 0; local115 < this.anInt7367; local115++) {
			this.anIntArray599[this.anIntArray600[local115]] = local12.method5158();
		}
		if (local75) {
			for (local265 = 0; local265 < this.anInt7367; local265++) {
				@Pc(339) byte[] local339 = new byte[64];
				local12.method5153(0, 64, local339);
				this.aByteArrayArray24[this.anIntArray600[local265]] = local339;
			}
		}
		for (local265 = 0; local265 < this.anInt7367; local265++) {
			this.anIntArray597[this.anIntArray600[local265]] = local12.method5158();
		}
		@Pc(423) int local423;
		@Pc(432) int local432;
		@Pc(439) int local439;
		...
		if (local16 < 7) {
			for (local398 = 0; local398 < this.anInt7367; local398++) {
				this.anIntArray598[this.anIntArray600[local398]] = local12.method5191();
			}
			for (local423 = 0; local423 < this.anInt7367; local423++) {
				...
				for (local449 = 0; local449 < local439; local449++) {
					local466 = this.anIntArrayArray185[local432][local449] = local101 += local12.method5191();
			...
			for (local398 = 0; local398 < this.anInt7367; local398++) {
				this.anIntArray598[this.anIntArray600[local398]] = local12.method5173();
			}
			for (local423 = 0; local423 < this.anInt7367; local423++) {
				local432 = this.anIntArray600[local423];
				local439 = this.anIntArray598[local432];
				...
				this.anIntArrayArray185[local432] = new int[local439];
				for (local449 = 0; local449 < local439; local449++) {
					local466 = this.anIntArrayArray185[local432][local449] = local101 += local12.method5173();
		...
		for (local398 = 0; local398 < this.anInt7367; local398++) {
			...
			for (local441 = 0; local441 < local432; local441++) {
				...
				this.anIntArrayArray186[local423][local449] = local12.method5158();
			}
