...
public final class Class293 {
	...
	private void method4633(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
	...
	public void method4634(@OriginalArg(0) boolean[][] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
		this.aClass19_Sub1_17.method5681(false);
		this.aClass19_Sub1_17.method5692(false);
		this.aClass19_Sub1_17.method5662(1);
		this.aClass19_Sub1_17.method5663(1);
		this.aClass19_Sub1_17.method5717(false, -2, false);
		...
		if (arg4) {
							...
							if (local99 - arg3 >= -arg1 && arg1 >= local99 - arg3) {
								for (@Pc(127) int local127 = local65; local127 < local72; local127++) {
									if (-arg1 <= local127 - arg2 && local127 - arg2 <= arg1 && arg0[arg1 + local99 - arg3][local127 + arg1 - arg2]) {
										@Pc(169) Class73_Sub1 local169 = this.aClass19_Sub1_17.method5691();
										local169.method1200(1.0F, local54, local54);
										local169.b(-local74, -local58, 0);
										this.aClass19_Sub1_17.method5682(Static431.aClass370_5);
										this.aClass274ArrayArray1[local74][local58].method4333();
										continue label138;
									}
								}
							}
			...
			for (local58 = 0; local58 < this.anInt7426; local58++) {
				...
				for (local74 = 0; local74 < this.anInt7420; local74++) {
					...
					if (local266 != null) {
						@Pc(279) Interface20 local279 = this.aClass19_Sub1_17.method5683(local266.anInt6928 * 3);
						@Pc(284) Buffer local284 = local279.method6091();
						if (local284 != null) {
							@Pc(292) Stream local292 = this.aClass19_Sub1_17.method5709(local284);
							...
							local292.c();
							if (local279.method6090() && local294 > 0) {
								@Pc(490) Class73_Sub1 local490 = this.aClass19_Sub1_17.method5691();
								local490.method1200(1.0F, local54, local54);
								local490.b(-local74, -local58, 0);
								this.aClass19_Sub1_17.method5682(Static431.aClass370_5);
								local266.method4330(local279, local294 / 3);
							}
						}
					}
				}
		...
		this.aClass19_Sub1_17.method5640();
	}

	@OriginalMember(owner = "client!pk", name = "b", descriptor = "(Lclient!r;III)V")
	public void method4636(@OriginalArg(0) Class2_Sub2_Sub9 arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		...
		if (local46 > 0 && local43 > 0) {
			Static714.method6730(local52, local40, this.aByteArray87, local43, local38, local17.aByteArray22, local46, local54);
			this.method4633(local43, arg2, arg1, local46);
		}
	}

	@OriginalMember(owner = "client!pk", name = "a", descriptor = "(ILclient!r;IB)Z")
	public boolean method4637(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub2_Sub9 arg1, @OriginalArg(2) int arg2) {
		...
		if (local40 > 0 && local30 > 0) {
			...
			return Static105.method1298(local30, local27, local45, this.aByteArray87, local40);
		} else {
			return false;
		}
	}
	...
	public void method4638(@OriginalArg(0) Class2_Sub2_Sub9 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		if (local35 > 0 && local32 > 0) {
			Static217.method2270(this.aByteArray87, local6.aByteArray22, local27, local40, local70, local29, local35, local32);
			this.method4633(local32, arg1, arg2, local35);
		}
	}
