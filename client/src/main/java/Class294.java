...
public final class Class294 {
	...
	private void method4641(@OriginalArg(1) int arg0, @OriginalArg(2) Class2_Sub21 arg1) {
		if (arg0 == 1) {
			arg1.method5205();
			return;
		}
		...
		if (arg0 == 2) {
			...
			if (arg0 == 40) {
				...
				for (local69 = 0; local69 < local59; local69++) {
					this.aShortArray105[local69] = (short) arg1.method5191();
					this.aShortArray108[local69] = (short) arg1.method5191();
				}
			} else if (arg0 == 41) {
				local59 = arg1.method5205();
				...
				for (local69 = 0; local69 < local59; local69++) {
					this.aShortArray107[local69] = (short) arg1.method5191();
					this.aShortArray106[local69] = (short) arg1.method5191();
				}
			} else if (arg0 >= 60 && arg0 < 70) {
				this.anIntArray603[arg0 - 60] = arg1.method5191();
			}
		}
	}

	@OriginalMember(owner = "client!pka", name = "a", descriptor = "(Lclient!ge;B)V")
	public void method4642(@OriginalArg(0) Class2_Sub21 arg0) {
		while (true) {
			@Pc(9) int local9 = arg0.method5205();
			if (local9 == 0) {
				return;
			}
			this.method4641(local9, arg0);
		}
	}

	@OriginalMember(owner = "client!pka", name = "a", descriptor = "(B)Lclient!dv;")
	public Class88 method4643() {
		...
		synchronized (this.aClass215_4.aClass330_72) {
			...
			while (true) {
				...
				if (this.anIntArray603[local26] != -1) {
					local8[local10++] = Static121.method1430(this.anIntArray603[local26], this.aClass215_4.aClass330_72);
				}
				local26++;
			}
		}
		...
		if (this.aShortArray105 != null) {
			for (local26 = 0; local26 < this.aShortArray105.length; local26++) {
				local102.method1460(this.aShortArray105[local26], this.aShortArray108[local26]);
			}
		}
		if (this.aShortArray107 != null) {
			for (local26 = 0; local26 < this.aShortArray107.length; local26++) {
				local102.method1458(this.aShortArray107[local26], this.aShortArray106[local26]);
			}
		}
		return local102;
	}
	...
	public boolean method4644() {
		...
		synchronized (this.aClass215_4.aClass330_72) {
			for (@Pc(15) int local15 = 0; local15 < 5; local15++) {
				if (this.anIntArray603[local15] != -1 && !this.aClass215_4.aClass330_72.method5350(0, this.anIntArray603[local15])) {
					local7 = false;
				}
			}
			return local7;
	...
	public boolean method4645() {
		...
		synchronized (this.aClass215_4.aClass330_72) {
			for (@Pc(19) int local19 = 0; local19 < this.anIntArray602.length; local19++) {
				if (!this.aClass215_4.aClass330_72.method5350(0, this.anIntArray602[local19])) {
					local11 = false;
				}
			}
			return local11;
	...
	public Class88 method4647() {
		...
		synchronized (this.aClass215_4.aClass330_72) {
			...
			while (true) {
				...
				local14[local22] = Static121.method1430(this.anIntArray602[local22], this.aClass215_4.aClass330_72);
				local22++;
			}
		}
		for (@Pc(56) int local56 = 0; local56 < this.anIntArray602.length; local56++) {
			if (local14[local56].anInt2379 < 13) {
				local14[local56].method1452();
			}
		}
		...
		if (this.aShortArray105 != null) {
			for (local22 = 0; local22 < this.aShortArray105.length; local22++) {
				local93.method1460(this.aShortArray105[local22], this.aShortArray108[local22]);
			}
		}
		if (this.aShortArray107 != null) {
			for (local22 = 0; local22 < this.aShortArray107.length; local22++) {
				local93.method1458(this.aShortArray107[local22], this.aShortArray106[local22]);
			}
		}
		return local93;
	}
