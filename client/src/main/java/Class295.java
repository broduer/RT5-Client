...
public final class Class295 {
	...
	private void method4649() {
		...
		try {
			...
			this.aClass2_Sub21_13.method5198(6);
			this.aClass2_Sub21_13.method5197(3);
			this.aClass263_1.method4135(4, this.aClass2_Sub21_13.aByteArray93);
	...
	public int method4651() {
		return this.aClass192_10.method3014() + this.aClass192_11.method3014();
	}

	@OriginalMember(owner = "client!pla", name = "d", descriptor = "(B)Z")
	public boolean method4653() {
		@Pc(14) int local14;
		if (this.aClass263_1 != null) {
			@Pc(7) long local7 = Static588.method5469();
		...
		if (this.aClass263_1 == null) {
			return this.method4651() == 0 && this.method4661() == 0;
		}
		try {
			this.aClass263_1.method4129();
			for (@Pc(84) Class2_Sub2_Sub17_Sub1 local84 = (Class2_Sub2_Sub17_Sub1) this.aClass192_10.method3017(); local84 != null; local84 = (Class2_Sub2_Sub17_Sub1) this.aClass192_10.method3015()) {
				this.aClass2_Sub21_13.anInt8388 = 0;
				this.aClass2_Sub21_13.method5198(1);
				this.aClass2_Sub21_13.method5197((int) local84.aLong325);
				this.aClass263_1.method4135(4, this.aClass2_Sub21_13.aByteArray93);
				this.aClass192_11.method3013(local84);
			}
			for (@Pc(142) Class2_Sub2_Sub17_Sub1 local142 = (Class2_Sub2_Sub17_Sub1) this.aClass192_12.method3017(); local142 != null; local142 = (Class2_Sub2_Sub17_Sub1) this.aClass192_12.method3015()) {
				this.aClass2_Sub21_13.anInt8388 = 0;
				this.aClass2_Sub21_13.method5198(0);
				this.aClass2_Sub21_13.method5197((int) local142.aLong325);
				this.aClass263_1.method4135(4, this.aClass2_Sub21_13.aByteArray93);
				this.aClass192_13.method3013(local142);
			}
			for (local14 = 0; local14 < 100; local14++) {
				@Pc(199) int local199 = this.aClass263_1.method4134();
				if (local199 < 0) {
				...
				if (local212 > 0) {
					...
					this.aClass263_1.method4131(local236, this.aClass2_Sub21_14.anInt8388, this.aClass2_Sub21_14.aByteArray93);
					if (this.aByte120 != 0) {
					...
					if (local212 <= this.aClass2_Sub21_14.anInt8388) {
						if (this.aClass2_Sub2_Sub17_Sub1_2 == null) {
							...
							local260 = this.aClass2_Sub21_14.method5205();
							local328 = this.aClass2_Sub21_14.method5191();
							@Pc(333) int local333 = this.aClass2_Sub21_14.method5205();
							@Pc(338) int local338 = this.aClass2_Sub21_14.method5158();
							...
							if (local354) {
								for (local371 = (Class2_Sub2_Sub17_Sub1) this.aClass192_13.method3017(); local371 != null && local371.aLong325 != local361; local371 = (Class2_Sub2_Sub17_Sub1) this.aClass192_13.method3015()) {
								}
							} else {
								for (local371 = (Class2_Sub2_Sub17_Sub1) this.aClass192_11.method3017(); local371 != null && local371.aLong325 != local361; local371 = (Class2_Sub2_Sub17_Sub1) this.aClass192_11.method3015()) {
								}
							}
							if (local371 == null) {
								throw new IOException();
							...
							this.aClass2_Sub2_Sub17_Sub1_2.aClass2_Sub21_15.method5198(local342);
							this.aClass2_Sub2_Sub17_Sub1_2.aClass2_Sub21_15.method5151(local338);
					...
					this.aClass263_1.method4131(local260, this.aClass2_Sub2_Sub17_Sub1_2.aClass2_Sub21_15.anInt8388, this.aClass2_Sub2_Sub17_Sub1_2.aClass2_Sub21_15.aByteArray93);
					if (this.aByte120 != 0) {
					...
					if (local236 == this.aClass2_Sub2_Sub17_Sub1_2.aClass2_Sub21_15.anInt8388) {
						this.aClass2_Sub2_Sub17_Sub1_2.method6674();
	...
	public boolean method4654() {
		return this.method4661() >= 20;
	}

	@OriginalMember(owner = "client!pla", name = "a", descriptor = "(ZI)V")
	public void method4655(@OriginalArg(0) boolean arg0) {
		if (this.aClass263_1 == null) {
			return;
		}
		try {
			this.aClass2_Sub21_13.anInt8388 = 0;
			this.aClass2_Sub21_13.method5198(arg0 ? 2 : 3);
			this.aClass2_Sub21_13.method5197(0);
			this.aClass263_1.method4135(4, this.aClass2_Sub21_13.aByteArray93);
	...
	public void method4656(@OriginalArg(0) boolean arg0, @OriginalArg(2) Class263 arg1) {
		if (this.aClass263_1 != null) {
			try {
				this.aClass263_1.method4136();
		...
		this.method4649();
		this.method4655(arg0);
		this.aClass2_Sub2_Sub17_Sub1_2 = null;
		this.aClass2_Sub21_14.anInt8388 = 0;
		while (true) {
			@Pc(48) Class2_Sub2_Sub17_Sub1 local48 = (Class2_Sub2_Sub17_Sub1) this.aClass192_11.method3011();
			if (local48 == null) {
				while (true) {
					local48 = (Class2_Sub2_Sub17_Sub1) this.aClass192_13.method3011();
					if (local48 == null) {
						if (this.aByte120 != 0) {
							try {
								this.aClass2_Sub21_13.anInt8388 = 0;
								this.aClass2_Sub21_13.method5198(4);
								this.aClass2_Sub21_13.method5198(this.aByte120);
								this.aClass2_Sub21_13.method5182(0);
								this.aClass263_1.method4135(4, this.aClass2_Sub21_13.aByteArray93);
						...
						this.anInt7451 = 0;
						this.aLong238 = Static588.method5469();
						return;
					}
					this.aClass192_12.method3013(local48);
				}
			}
			this.aClass192_10.method3013(local48);
		}
	}
	...
	public void method4657() {
		...
		try {
			this.aClass2_Sub21_13.anInt8388 = 0;
			this.aClass2_Sub21_13.method5198(7);
			this.aClass2_Sub21_13.method5197(0);
			this.aClass263_1.method4135(4, this.aClass2_Sub21_13.aByteArray93);
	...
	public boolean method4659() {
		return this.method4651() >= 20;
	}

	@OriginalMember(owner = "client!pla", name = "d", descriptor = "(I)V")
	public void method4660() {
		if (this.aClass263_1 != null) {
			this.aClass263_1.method4132();
		}
	}

	@OriginalMember(owner = "client!pla", name = "a", descriptor = "(B)I")
	private int method4661() {
		return this.aClass192_12.method3014() + this.aClass192_13.method3014();
	}

	@OriginalMember(owner = "client!pla", name = "a", descriptor = "(IIBZB)Lclient!rja;")
	public Class2_Sub2_Sub17_Sub1 method4662(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) boolean arg2, @OriginalArg(4) byte arg3) {
		...
		if (arg2) {
			if (this.method4651() >= 20) {
				throw new RuntimeException();
			}
			this.aClass192_10.method3013(local23);
		} else if (this.method4661() < 20) {
			this.aClass192_12.method3013(local23);
		} else {
			throw new RuntimeException();
		}
		return local23;
