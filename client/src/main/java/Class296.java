...
public final class Class296 {
	...
	private void method6619(@OriginalArg(1) int arg0, @OriginalArg(2) Class2_Sub21 arg1) {
		if (arg0 == 1) {
			arg1.method7403();
			return;
		}
		...
		if (arg0 == 2) {
			...
			if (arg0 == 40) {
				...
				for (local69 = 0; local69 < local59; local69++) {
					this.aShortArray105[local69] = (short) arg1.method7389();
					this.aShortArray108[local69] = (short) arg1.method7389();
				}
			} else if (arg0 == 41) {
				local59 = arg1.method7403();
				...
				for (local69 = 0; local69 < local59; local69++) {
					this.aShortArray107[local69] = (short) arg1.method7389();
					this.aShortArray106[local69] = (short) arg1.method7389();
				}
			} else if (arg0 >= 60 && arg0 < 70) {
				this.anIntArray603[arg0 - 60] = arg1.method7389();
			}
		}
	}

	@OriginalMember(owner = "client!pka", name = "a", descriptor = "(Lclient!ge;B)V")
	public void method6620(@OriginalArg(0) Class2_Sub21 arg0) {
		while (true) {
			@Pc(9) int local9 = arg0.method7403();
			if (local9 == 0) {
				return;
			}
			this.method6619(local9, arg0);
		}
	}

	@OriginalMember(owner = "client!pka", name = "a", descriptor = "(B)Lclient!dv;")
	public Class88 method6621() {
		@Pc(8) Class88[] local8 = new Class88[5];
		@Pc(10) int local10 = 0;
		@Pc(22) Class332 local22 = this.aClass217_4.aClass332_72;
		@Pc(26) int local26;
		synchronized (this.aClass217_4.aClass332_72) {
			...
			while (true) {
				...
				if (this.anIntArray603[local26] != -1) {
					local8[local10++] = Static121.method2201(this.anIntArray603[local26], this.aClass217_4.aClass332_72);
				}
				local26++;
			}
		}
		for (@Pc(66) int local66 = 0; local66 < 5; local66++) {
			if (local8[local66] != null && local8[local66].anInt2388 < 13) {
	...
	public boolean method6622() {
		...
		@Pc(11) Class332 local11 = this.aClass217_4.aClass332_72;
		synchronized (this.aClass217_4.aClass332_72) {
	...
	public boolean method6623() {
		...
		@Pc(15) Class332 local15 = this.aClass217_4.aClass332_72;
		synchronized (this.aClass217_4.aClass332_72) {
	...
	public Class88 method6625() {
		if (this.anIntArray602 == null) {
			return null;
		}
		@Pc(14) Class88[] local14 = new Class88[this.anIntArray602.length];
		@Pc(18) Class332 local18 = this.aClass217_4.aClass332_72;
		@Pc(22) int local22;
		synchronized (this.aClass217_4.aClass332_72) {
			local22 = 0;
			while (true) {
				...
				local14[local22] = Static121.method2201(this.anIntArray602[local22], this.aClass217_4.aClass332_72);
				local22++;
			}
		}
		for (@Pc(56) int local56 = 0; local56 < this.anIntArray602.length; local56++) {
			if (local14[local56].anInt2388 < 13) {
