...
public final class Class297 {
	...
	public volatile int anInt7475 = 0;

	@OriginalMember(owner = "client!pla", name = "a", descriptor = "I")
	public volatile int anInt7474 = 0;
	...
	private void method6627() {
		...
		try {
			...
			this.aClass265_1.method5836(4, this.aClass2_Sub21_13.aByteArray93);
	...
	public boolean method6631() {
		@Pc(14) int local14;
		if (this.aClass265_1 != null) {
			@Pc(7) long local7 = Static588.method7722();
		...
		try {
			...
			for (local14 = 0; local14 < 100; local14++) {
				@Pc(199) int local199 = this.aClass265_1.method5835();
				if (local199 < 0) {
				...
				if (local212 > 0) {
					...
					this.aClass265_1.method5832(local236, this.aClass2_Sub21_14.anInt8412, this.aClass2_Sub21_14.aByteArray93);
					if (this.aByte120 != 0) {
					...
					this.aClass265_1.method5832(local260, this.aClass2_Sub2_Sub17_Sub1_2.aClass2_Sub21_15.anInt8412, this.aClass2_Sub2_Sub17_Sub1_2.aClass2_Sub21_15.aByteArray93);
					if (this.aByte120 != 0) {
	...
	public void method6634(@OriginalArg(0) boolean arg0, @OriginalArg(2) Class265 arg1) {
		if (this.aClass265_1 != null) {
			try {
				this.aClass265_1.method5837();
			...
			if (local48 == null) {
				while (true) {
					...
					if (local48 == null) {
						...
						this.anInt7473 = 0;
						this.aLong238 = Static588.method7722();
						return;
					}
