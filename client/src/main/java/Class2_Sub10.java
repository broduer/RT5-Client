...
public abstract class Class2_Sub10 extends Class2 {
	...
	public abstract void method4421(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) Canvas arg2);

	@OriginalMember(owner = "client!cda", name = "a", descriptor = "(IIIZLjava/awt/Graphics;III)V")
	public abstract void method4423(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) Graphics arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6);
}
