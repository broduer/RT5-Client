...
public final class Class2_Sub11 extends Class2 {
	...
	public Class2_Sub11(@OriginalArg(0) byte[] arg0) {
		...
		for (@Pc(51) int local51 = 0; local51 < local36; local51++) {
			local49[local51] = local34.method7384();
		}
		local36++;
		local34.anInt8412++;
		@Pc(76) int local76 = local34.anInt8412;
		local34.anInt8412 += local36;
		@Pc(84) int local84;
		for (local84 = 0; local34.aByteArray93[local34.anInt8412 + local84] != 0; local84++) {
		}
		@Pc(97) byte[] local97 = new byte[local84];
		for (@Pc(99) int local99 = 0; local99 < local84; local99++) {
			local97[local99] = local34.method7384();
		}
		local84++;
		local34.anInt8412++;
		@Pc(124) int local124 = local34.anInt8412;
		local34.anInt8412 += local84;
		@Pc(132) int local132;
		for (local132 = 0; local34.aByteArray93[local132 + local34.anInt8412] != 0; local132++) {
		}
		@Pc(148) byte[] local148 = new byte[local132];
		for (@Pc(150) int local150 = 0; local150 < local132; local150++) {
			local148[local150] = local34.method7384();
		}
		local34.anInt8412++;
		local132++;
		...
		@Pc(228) Class271[] local228 = new Class271[local182];
		for (local186 = 0; local186 < local228.length; local186++) {
			@Pc(239) Class271 local239 = local228[local186] = new Class271();
			@Pc(243) int local243 = local34.method7403();
			if (local243 > 0) {
				local239.aByteArray83 = new byte[local243 * 2];
			}
			local243 = local34.method7403();
			if (local243 > 0) {
		...
		for (@Pc(466) int local466 = 0; local466 < 128; local466++) {
			if (this.anIntArray149[local466] != 0) {
				if (local403 == 0) {
					local464 = local34.aByteArray93[local76++] - 1;
		...
		for (@Pc(521) int local521 = 0; local521 < 128; local521++) {
			if (this.anIntArray149[local521] != 0) {
				if (local403 == 0) {
					...
					local519 = local34.aByteArray93[local124++] + 16 << 2;
				}
				local403--;
		...
		for (@Pc(583) int local583 = 0; local583 < 128; local583++) {
			if (this.anIntArray149[local583] != 0) {
				...
				this.aClass271Array1[local583] = local581;
				local403--;
			}
		}
		local405 = 0;
		...
		for (local694 = 0; local694 < local182; local694++) {
			@Pc(833) Class271 local833 = local228[local694];
		...
		for (local795 = 0; local795 < local182; local795++) {
			local228[local795].anInt6792 = local34.method7403();
		}
		for (local840 = 0; local840 < local182; local840++) {
			@Pc(1256) Class271 local1256 = local228[local840];
			if (local1256.aByteArray83 != null) {
				local1256.anInt6799 = local34.method7403();
			}
			if (local1256.aByteArray82 != null) {
				local1256.anInt6800 = local34.method7403();
			}
			if (local1256.anInt6792 > 0) {
				local1256.anInt6793 = local34.method7403();
			}
		}
		for (local1085 = 0; local1085 < local182; local1085++) {
			local228[local1085].anInt6797 = local34.method7403();
		}
		for (local915 = 0; local915 < local182; local915++) {
			@Pc(1311) Class271 local1311 = local228[local915];
			if (local1311.anInt6797 > 0) {
				local1311.anInt6796 = local34.method7403();
			}
		}
		for (local937 = 0; local937 < local182; local937++) {
			@Pc(1336) Class271 local1336 = local228[local937];
			if (local1336.anInt6796 > 0) {
				local1336.anInt6801 = local34.method7403();
			}
		}
	}
