...
public final class Class2_Sub11 extends Class2 {
	...
	public Class2_Sub11(@OriginalArg(0) byte[] arg0) {
		...
		@Pc(36) int local36;
		for (local36 = 0; local34.aByteArray93[local36 + local34.anInt8388] != 0; local36++) {
		}
		@Pc(49) byte[] local49 = new byte[local36];
		for (@Pc(51) int local51 = 0; local51 < local36; local51++) {
			local49[local51] = local34.method5186();
		}
		local36++;
		local34.anInt8388++;
		@Pc(76) int local76 = local34.anInt8388;
		local34.anInt8388 += local36;
		@Pc(84) int local84;
		for (local84 = 0; local34.aByteArray93[local34.anInt8388 + local84] != 0; local84++) {
		}
		@Pc(97) byte[] local97 = new byte[local84];
		for (@Pc(99) int local99 = 0; local99 < local84; local99++) {
			local97[local99] = local34.method5186();
		}
		local84++;
		local34.anInt8388++;
		@Pc(124) int local124 = local34.anInt8388;
		local34.anInt8388 += local84;
		@Pc(132) int local132;
		for (local132 = 0; local34.aByteArray93[local132 + local34.anInt8388] != 0; local132++) {
		}
		@Pc(148) byte[] local148 = new byte[local132];
		for (@Pc(150) int local150 = 0; local150 < local132; local150++) {
			local148[local150] = local34.method5186();
		}
		local34.anInt8388++;
		local132++;
		...
		for (local186 = 0; local186 < local228.length; local186++) {
			...
			@Pc(243) int local243 = local34.method5205();
			if (local243 > 0) {
				local239.aByteArray83 = new byte[local243 * 2];
			}
			local243 = local34.method5205();
			if (local243 > 0) {
		...
		for (@Pc(629) int local629 = 0; local629 < 128; local629++) {
			if (local403 == 0) {
				...
				if (this.anIntArray149[local629] > 0) {
					local627 = local34.method5205() + 1;
				}
			}
			this.aByteArray20[local629] = (byte) local627;
			local403--;
		}
		this.anInt1579 = local34.method5205() + 1;
		@Pc(694) int local694;
		for (@Pc(684) int local684 = 0; local684 < local182; local684++) {
			...
			if (local689.aByteArray83 != null) {
				for (local694 = 1; local694 < local689.aByteArray83.length; local694 += 2) {
					local689.aByteArray83[local694] = local34.method5186();
				}
			}
			if (local689.aByteArray82 != null) {
				for (local694 = 3; local694 < local689.aByteArray82.length - 2; local694 += 2) {
					local689.aByteArray82[local694] = local34.method5186();
				}
			}
		}
		@Pc(747) int local747;
		if (local299 != null) {
			for (local747 = 1; local747 < local299.length; local747 += 2) {
				local299[local747] = local34.method5186();
			}
		}
		if (local316 != null) {
			for (local747 = 1; local747 < local316.length; local747 += 2) {
				local316[local747] = local34.method5186();
			}
		}
		@Pc(795) int local795;
		for (local747 = 0; local747 < local182; local747++) {
			...
			if (local788.aByteArray82 != null) {
				...
				for (local795 = 2; local795 < local788.aByteArray82.length; local795 += 2) {
					local356 = local34.method5205() + local356 + 1;
		...
		if (local299 != null) {
			...
			for (local937 = 2; local937 < local299.length; local937 += 2) {
				...
				for (local964 = local909; local964 < local942; local964++) {
					local972 = Static235.method2465(local942 - local909, local962);
	...
	public boolean method965(@OriginalArg(1) Class123 arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) byte[] arg2) {
			...
			if (arg2 == null || arg2[local11] != 0) {
				...
				if (local33 != 0) {
					if (local33 != local7) {
						local7 = local33--;
						if ((local33 & 0x1) == 0) {
							local9 = arg0.method1756(arg1, local33 >> 2);
						} else {
							local9 = arg0.method1757(arg1, local33 >> 2);
						}
						if (local9 == null) {
							local5 = false;
						}
