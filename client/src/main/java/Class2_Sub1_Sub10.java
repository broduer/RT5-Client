...
public final class Class2_Sub1_Sub10 extends Class2_Sub1 {
	...
	public int[][] method6793(@OriginalArg(0) int arg0) {
		...
		if (super.aClass372_41.aBoolean737) {
			@Pc(29) int[] local29 = this.method6801(arg0, 1);
			@Pc(35) int[] local35 = this.method6801(arg0, 2);
			...
			for (@Pc(49) int local49 = 0; local49 < Static608.anInt9289; local49++) {
				...
				@Pc(109) int[][] local109 = this.method6792(0, local103);
	...
	public void method6795(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2) {
		if (arg2 == 0) {
			this.anInt3297 = arg1.method5191() << 4;
		} else if (arg2 == 1) {
	...
	public int[] method6790(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(19) int[] local19 = super.aClass180_41.method2752(arg1);
		if (super.aClass180_41.aBoolean338) {
			@Pc(29) int[] local29 = this.method6801(arg1, 1);
			@Pc(35) int[] local35 = this.method6801(arg1, 2);
			for (@Pc(37) int local37 = 0; local37 < Static608.anInt9289; local37++) {
				...
				@Pc(94) int[] local94 = this.method6801(local88, 0);
