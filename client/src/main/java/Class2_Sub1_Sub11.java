...
public final class Class2_Sub1_Sub11 extends Class2_Sub1 {
	...
	private void method2824(@OriginalArg(0) int arg0) {
		...
		for (@Pc(77) int local77 = 0; local77 < this.anInt4527; local77++) {
			...
			if (local77 > 0) {
				...
				local98 = (Static623.method5895(-5208, 4096, local12) - 2048) * this.anInt4525 >> 12;
			...
			for (local86 = 0; local86 < this.anInt4540; local86++) {
				if (local86 > 0) {
					...
					@Pc(152) int local152 = (Static623.method5895(-5208, 4096, local12) - 2048) * this.anInt4539 >> 12;
					local98 += local35 * local152 >> 12;
					this.anIntArrayArray109[local77][local86] = local98 + this.anIntArrayArray109[local77][local86 - 1];
				}
				this.anIntArrayArray110[local77][local86] = this.anInt4532 > 0 ? 4096 - Static623.method5895(arg0 ^ 0xFFFF88FC, this.anInt4532, local12) : 4096;
			}
	...
	public void method6795(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2) {
		if (arg2 == 0) {
			this.anInt4540 = arg1.method5205();
		} else if (arg2 == 1) {
			this.anInt4527 = arg1.method5205();
		} else if (arg2 == 2) {
			this.anInt4539 = arg1.method5191();
		} else if (arg2 == 3) {
			this.anInt4525 = arg1.method5191();
		} else if (arg2 == 4) {
			this.anInt4535 = arg1.method5191();
		} else if (arg2 == 5) {
			this.anInt4531 = arg1.method5191();
		} else if (arg2 == 6) {
			this.anInt4528 = arg1.method5191();
		} else if (arg2 == 7) {
			this.anInt4532 = arg1.method5191();
		}
		if (arg0) {
	...
	public void method6800(@OriginalArg(0) int arg0) {
		if (arg0 != 7) {
			this.method6795(true, (Class2_Sub21) null, 83);
		}
		this.method2824(arg0 + 25421);
	}
	...
	public int[] method6790(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(18) int[] local18 = super.aClass180_41.method2752(arg1);
		if (super.aClass180_41.aBoolean338) {
			...
			if (this.anInt4533 + local102 < local31 && local31 < local95 - this.anInt4533) {
				...
				Static734.method5444(local18, 0, Static608.anInt9289, 0);
			}
		}
		return local18;
	}
