...
public final class Class2_Sub1_Sub12 extends Class2_Sub1 {
	...
	public int[][] method9421(@OriginalArg(0) int arg0) {
		...
		if (super.aClass374_41.aBoolean738) {
			@Pc(30) int local30 = this.anInt4871 + this.anInt4871 + 1;
			@Pc(34) int local34 = 65536 / local30;
			@Pc(42) int local42 = this.anInt4866 + this.anInt4866 + 1;
			@Pc(46) int local46 = 65536 / local42;
			@Pc(49) int[][][] local49 = new int[local30][][];
			@Pc(75) int local75;
			@Pc(77) int local77;
			for (@Pc(55) int local55 = arg0 - this.anInt4871; local55 <= arg0 + this.anInt4871; local55++) {
				@Pc(67) int[][] local67 = this.method9420(0, Static489.anInt7364 & local55);
				@Pc(71) int[][] local71 = new int[3][Static608.anInt9315];
				@Pc(73) int local73 = 0;
				local75 = 0;
				local77 = 0;
				...
				for (@Pc(93) int local93 = -this.anInt4866; local93 <= this.anInt4866; local93++) {
					@Pc(101) int local101 = local93 & Static576.anInt8604;
	...
	public int[] method9418(@OriginalArg(1) int arg1) {
		...
		if (super.aClass180_41.aBoolean338) {
			...
			@Pc(35) int local35 = this.anInt4866 + this.anInt4866 + 1;
			@Pc(39) int local39 = 65536 / local35;
			@Pc(42) int[][] local42 = new int[local23][];
			@Pc(63) int local63;
			for (@Pc(48) int local48 = arg1 - this.anInt4871; local48 <= arg1 + this.anInt4871; local48++) {
				@Pc(58) int[] local58 = this.method9429(local48 & Static489.anInt7364, 0);
				@Pc(61) int[] local61 = new int[Static608.anInt9315];
				local63 = 0;
				for (@Pc(67) int local67 = -this.anInt4866; local67 <= this.anInt4866; local67++) {
					local63 += local58[local67 & Static576.anInt8604];
				}
				@Pc(84) int local84 = 0;
				while (local84 < Static608.anInt9315) {
					local61[local84] = local39 * local63 >> 16;
					local63 -= local58[Static576.anInt8604 & local84 - this.anInt4866];
					local84++;
					local63 += local58[local84 + this.anInt4866 & Static576.anInt8604];
				}
				local42[local48 + this.anInt4871 - arg1] = local61;
			}
			for (@Pc(146) int local146 = 0; local146 < Static608.anInt9315; local146++) {
	...
	public void method9423(@OriginalArg(1) Packet arg1, @OriginalArg(2) int arg2) {
		if (arg2 == 0) {
			this.anInt4866 = arg1.g1();
		} else if (arg2 == 1) {
			this.anInt4871 = arg1.g1();
		} else if (arg2 == 2) {
