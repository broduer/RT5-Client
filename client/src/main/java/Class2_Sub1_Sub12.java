...
public final class Class2_Sub1_Sub12 extends Class2_Sub1 {
	...
	public int[][] method6793(@OriginalArg(0) int arg0) {
		...
		if (super.aClass372_41.aBoolean737) {
			...
			for (@Pc(55) int local55 = arg0 - this.anInt4855; local55 <= arg0 + this.anInt4855; local55++) {
				@Pc(67) int[][] local67 = this.method6792(0, Static489.anInt7343 & local55);
	...
	public int[] method6790(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (super.aClass180_41.aBoolean338) {
			...
			for (@Pc(48) int local48 = arg1 - this.anInt4855; local48 <= arg1 + this.anInt4855; local48++) {
				@Pc(58) int[] local58 = this.method6801(local48 & Static489.anInt7343, 0);
	...
	public void method6795(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2) {
		...
		if (arg2 == 0) {
			this.anInt4850 = arg1.method5205();
		} else if (arg2 == 1) {
			this.anInt4855 = arg1.method5205();
		} else if (arg2 == 2) {
