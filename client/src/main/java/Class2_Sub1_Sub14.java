...
public final class Class2_Sub1_Sub14 extends Class2_Sub1 {
	...
	private void method3418(@OriginalArg(0) int arg0) {
		if (arg0 == 0) {
			return;
		}
		if (arg0 == 1) {
	...
	public int[][] method6793(@OriginalArg(0) int arg0) {
		@Pc(19) int[][] local19 = super.aClass372_41.method6004(arg0);
		if (super.aClass372_41.aBoolean737) {
			@Pc(29) int[] local29 = this.method6801(arg0, 0);
	...
	public void method6795(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2) {
		if (arg2 == 0) {
			@Pc(14) int local14 = arg1.method5205();
			if (local14 == 0) {
				this.anIntArrayArray125 = new int[arg1.method5205()][4];
				for (@Pc(28) int local28 = 0; local28 < this.anIntArrayArray125.length; local28++) {
					this.anIntArrayArray125[local28][0] = arg1.method5191();
					this.anIntArrayArray125[local28][1] = arg1.method5205() << 4;
					this.anIntArrayArray125[local28][2] = arg1.method5205() << 4;
					this.anIntArrayArray125[local28][3] = arg1.method5205() << 4;
				}
			} else {
				this.method3418(local14);
			}
		}
		if (arg0) {
