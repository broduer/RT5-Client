...
public final class Class2_Sub1_Sub14 extends Class2_Sub1 {
	...
	private void method4900(@OriginalArg(0) int arg0) {
		if (arg0 == 0) {
			return;
		}
		if (arg0 == 1) {
	...
	public int[][] method9421(@OriginalArg(0) int arg0) {
		...
		if (super.aClass374_41.aBoolean738) {
			@Pc(29) int[] local29 = this.method9429(arg0, 0);
			@Pc(33) int[] local33 = local19[0];
			@Pc(37) int[] local37 = local19[1];
			@Pc(41) int[] local41 = local19[2];
			for (@Pc(43) int local43 = 0; local43 < Static608.anInt9315; local43++) {
	...
	public void method9423(@OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2) {
		if (arg2 == 0) {
			...
			if (local14 == 0) {
				this.anIntArrayArray125 = new int[arg1.method7403()][4];
				for (@Pc(28) int local28 = 0; local28 < this.anIntArrayArray125.length; local28++) {
					this.anIntArrayArray125[local28][0] = arg1.method7389();
					this.anIntArrayArray125[local28][1] = arg1.method7403() << 4;
					this.anIntArrayArray125[local28][2] = arg1.method7403() << 4;
					this.anIntArrayArray125[local28][3] = arg1.method7403() << 4;
				}
			} else {
