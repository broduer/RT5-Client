...
public final class Class2_Sub1_Sub15 extends Class2_Sub1 {
	...
	public void method6795(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2) {
		if (arg2 == 0) {
			this.anInt5419 = arg1.method5205();
		} else if (arg2 == 1) {
			this.anInt5420 = arg1.method5191();
		} else if (arg2 == 2) {
			this.anInt5422 = arg1.method5205();
		} else if (arg2 == 3) {
			this.anInt5418 = arg1.method5191();
		} else if (arg2 == 4) {
			this.anInt5424 = arg1.method5191();
		}
		if (arg0) {
			this.method6790(-52, 90);
		}
	}
	...
	public int[] method6790(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (super.aClass180_41.aBoolean338) {
			...
			@Pc(25) int[][] local25 = super.aClass180_41.method2749();
			@Pc(32) Random local32 = new Random((long) this.anInt5419);
			for (@Pc(34) int local34 = 0; local34 < this.anInt5420; local34++) {
				@Pc(60) int local60 = this.anInt5424 > 0 ? this.anInt5418 + Static623.method5895(-5208, this.anInt5424, local32) - local20 : this.anInt5418;
				@Pc(66) int local66 = local60 >> 4 & 0xFF;
				@Pc(71) int local71 = Static623.method5895(-5208, Static608.anInt9289, local32);
				@Pc(76) int local76 = Static623.method5895(-5208, Static2.anInt53, local32);
				...
				if (local108 != 0 || local103 != 0) {
					...
					@Pc(198) int local198 = 1024 - (Static623.method5895(-5208, 4096, local32) >> 2);
					if (local179 < 0) {
						local179 = -local179;
					}
	...
	public void method6800(@OriginalArg(0) int arg0) {
		if (arg0 != 7) {
			this.method6790(73, -102);
		}
		Static481.method4539();
	}
}
