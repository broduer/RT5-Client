...
public final class Class2_Sub1_Sub18 extends Class2_Sub1 {
	...
	public void method9423(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2) {
		if (arg2 == 0) {
			this.anInt6121 = arg1.method7403();
		} else if (arg2 == 1) {
			super.aBoolean825 = arg1.method7403() == 1;
		}
		if (arg0) {
			Static389.aClass227_157 = null;
		}
	}
	...
	public int[] method9418(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (super.aClass180_41.aBoolean338) {
			@Pc(28) int[] local28 = this.method9429(arg1, 0);
			@Pc(34) int[] local34 = this.method9429(arg1, 1);
			@Pc(37) int local37 = this.anInt6121;
			if (local37 == 1) {
				for (local37 = 0; local37 < Static608.anInt9315; local37++) {
	...
	public int[][] method9421(@OriginalArg(0) int arg0) {
		...
		if (super.aClass374_41.aBoolean738) {
			@Pc(30) int[][] local30 = this.method9420(0, arg0);
			@Pc(36) int[][] local36 = this.method9420(1, arg0);
			...
			@Pc(75) int local75 = this.anInt6121;
			if (local75 == 1) {
