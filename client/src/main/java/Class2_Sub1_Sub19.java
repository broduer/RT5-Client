...
public final class Class2_Sub1_Sub19 extends Class2_Sub1 {
	...
	public void method6795(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2) {
		...
		if (arg2 == 0) {
			this.anInt6314 = arg1.method5191();
		} else if (arg2 == 1) {
			this.aBoolean467 = arg1.method5205() == 1;
		}
	}
	...
	public int[][] method6793(@OriginalArg(0) int arg0) {
		...
		if (super.aClass372_41.aBoolean737) {
			@Pc(25) int[] local25 = this.method6801(arg0 - 1 & Static489.anInt7343, 0);
			@Pc(31) int[] local31 = this.method6801(arg0, 0);
			@Pc(41) int[] local41 = this.method6801(arg0 + 1 & Static489.anInt7343, 0);
