...
public final class Class2_Sub1_Sub2 extends Class2_Sub1 {
	...
	public int[][] method9421(@OriginalArg(0) int arg0) {
		...
		if (super.aClass374_41.aBoolean738) {
			@Pc(27) int[] local27 = this.method9429(arg0, 2);
			@Pc(33) int[][] local33 = this.method9420(0, arg0);
			@Pc(39) int[][] local39 = this.method9420(1, arg0);
			...
			for (@Pc(77) int local77 = 0; local77 < Static608.anInt9315; local77++) {
	...
	public int[] method9418(@OriginalArg(1) int arg1) {
		...
		if (super.aClass180_41.aBoolean338) {
			...
			@Pc(27) int[] local27 = this.method9429(arg1, 1);
			@Pc(33) int[] local33 = this.method9429(arg1, 2);
