...
public final class Class2_Sub1_Sub20 extends Class2_Sub1 {
	...
	public void method6795(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2) {
		...
		if (arg2 == 0) {
			this.anInt6578 = arg1.method5191();
		} else if (arg2 == 1) {
			this.anInt6580 = arg1.method5191();
		} else if (arg2 == 2) {
			this.anInt6574 = arg1.method5191();
		} else if (arg2 == 3) {
			this.anInt6577 = arg1.method5191();
		} else if (arg2 == 4) {
			this.anInt6573 = arg1.method5191();
		} else if (arg2 == 5) {
			this.anInt6570 = arg1.method5191();
		} else if (arg2 == 6) {
			this.anInt6566 = arg1.method5191();
		}
	}
	...
	private boolean method4152(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public int[] method6790(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(17) int[] local17 = super.aClass180_41.method2752(arg1);
		if (super.aClass180_41.aBoolean338) {
			...
			for (@Pc(29) int local29 = 0; local29 < Static608.anInt9289; local29++) {
				...
				local17[local29] = this.method4152(local91, local64) || this.method4153(local120, local146) ? 4096 : 0;
			}
		}
		return local17;
	}
	...
	private boolean method4153(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
