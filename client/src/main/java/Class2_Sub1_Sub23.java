...
public final class Class2_Sub1_Sub23 extends Class2_Sub1 {
	...
	private void method4466() {
		...
		if (this.anInt7099 > 0) {
			for (@Pc(31) int local31 = 0; local31 < 512; local31++) {
				this.aShortArray104[local31] = (short) Static623.method5895(-5208, this.anInt7099, local12);
			}
		}
	}
	...
	public void method6795(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2) {
		...
		if (arg2 == 0) {
			this.anInt7105 = this.anInt7110 = arg1.method5205();
		} else if (arg2 == 1) {
			this.anInt7106 = arg1.method5205();
		} else if (arg2 == 2) {
			this.anInt7099 = arg1.method5191();
		} else if (arg2 == 3) {
			this.anInt7104 = arg1.method5205();
		} else if (arg2 == 4) {
			this.anInt7103 = arg1.method5205();
		} else if (arg2 == 5) {
			this.anInt7105 = arg1.method5205();
		} else if (arg2 == 6) {
			this.anInt7110 = arg1.method5205();
		}
	}
	...
	public void method6800(@OriginalArg(0) int arg0) {
		this.aByteArray84 = Static694.method6463(this.anInt7106);
		if (arg0 != 7) {
			this.anInt7110 = 6;
		}
		this.method4466();
	...
	public int[] method6790(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (arg0 <= 107) {
			Static470.method4467((Class158) null, -42, 121, -79);
		}
