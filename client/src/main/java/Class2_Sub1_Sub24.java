...
public final class Class2_Sub1_Sub24 extends Class2_Sub1 {
	...
	private void method6417(@OriginalArg(1) int[][] arg0) {
		@Pc(7) int local7 = Static608.anInt9315;
	...
	public int[][] method9421(@OriginalArg(0) int arg0) {
		...
		if (super.aClass374_41.aBoolean738) {
			@Pc(23) int local23 = Static608.anInt9315;
			@Pc(25) int local25 = Static2.anInt53;
			@Pc(29) int[][] local29 = new int[local25][local23];
			@Pc(34) int[][][] local34 = super.aClass374_41.method8458();
			...
			for (@Pc(40) int local40 = 0; local40 < Static2.anInt53; local40++) {
				...
				for (@Pc(64) int local64 = 0; local64 < Static608.anInt9315; local64++) {
	...
	public void method9423(@OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2) {
		if (arg2 == 0) {
			...
			for (@Pc(33) int local33 = 0; local33 < this.aClass154Array1.length; local33++) {
				@Pc(39) int local39 = arg1.method7403();
				if (local39 == 0) {
					this.aClass154Array1[local33] = Static305.method4444(arg1);
				} else if (local39 == 1) {
					this.aClass154Array1[local33] = Static396.method5559(arg1);
				} else if (local39 == 2) {
					this.aClass154Array1[local33] = Static150.method2456(arg1);
				} else if (local39 == 3) {
					this.aClass154Array1[local33] = Static75.method6247(arg1);
				}
			}
		} else if (arg2 == 1) {
