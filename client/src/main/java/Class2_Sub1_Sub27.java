...
public final class Class2_Sub1_Sub27 extends Class2_Sub1 {
	...
	public void method5543(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1) {
		...
		if (this.anInt8803 == 1) {
			...
			if (this.aBoolean667) {
				for (local95 = 0; local95 < Static608.anInt9289; local95++) {
					...
					local117 = this.method5546(local51, local77, local31 * local103 >> 12, local37, local81, local90);
		...
		if (local24 > 8 || local24 < -8) {
			...
			for (local95 = 0; local95 < Static608.anInt9289; local95++) {
				local103 = this.anInt8810 * Static54.anIntArray92[local95];
				local117 = this.method5546(local51, local77, local103 * local31 >> 12, local37, local81, local90);
				arg1[local95] = local117 * local24 >> 12;
			}
		}
	...
	public int[] method6790(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(9) int[] local9 = super.aClass180_41.method2752(arg1);
		if (arg0 <= 107) {
			this.aShortArray126 = null;
		}
		if (super.aClass180_41.aBoolean338) {
			this.method5543(arg1, local9);
		}
		return local9;
	}
	...
	public void method6800(@OriginalArg(0) int arg0) {
		this.aByteArray97 = Static694.method6463(this.anInt8809);
		this.method5547(arg0 - 8);
	...
	public void method6795(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2) {
		if (arg0) {
			this.method6790(17, -97);
		}
		if (arg2 == 0) {
			this.aBoolean667 = arg1.method5205() == 1;
		} else if (arg2 == 1) {
			this.anInt8803 = arg1.method5205();
		} else if (arg2 == 2) {
			this.anInt8799 = arg1.method5165();
			if (this.anInt8799 < 0) {
				this.aShortArray127 = new short[this.anInt8803];
				for (@Pc(103) int local103 = 0; local103 < this.anInt8803; local103++) {
					this.aShortArray127[local103] = (short) arg1.method5165();
				}
				return;
			}
		} else if (arg2 == 3) {
			this.anInt8810 = this.anInt8805 = arg1.method5205();
			return;
		} else if (arg2 == 4) {
			this.anInt8809 = arg1.method5205();
			return;
		} else if (arg2 == 5) {
			this.anInt8810 = arg1.method5205();
			return;
		} else if (arg2 == 6) {
			this.anInt8805 = arg1.method5205();
			return;
		}
	}

	@OriginalMember(owner = "client!so", name = "a", descriptor = "(IIIIIII)I")
	private int method5546(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
