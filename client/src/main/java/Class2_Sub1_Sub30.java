...
public final class Class2_Sub1_Sub30 extends Class2_Sub1 {
	...
	public int[][] method6793(@OriginalArg(0) int arg0) {
		...
		if (super.aClass372_41.aBoolean737) {
			...
			if (local33 > 0) {
				...
				local49 = this.method6792(0, local39 * Static2.anInt53 / local33);
			} else {
				local49 = this.method6792(0, 0);
			}
	...
	public void method6795(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2) {
		if (arg2 == 0) {
			this.anInt9793 = arg1.method5205();
		} else if (arg2 == 1) {
			this.anInt9789 = arg1.method5205();
		}
		if (arg0) {
			this.method6795(true, (Class2_Sub21) null, -94);
		}
	}
	...
	public int[] method6790(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (super.aClass180_41.aBoolean338) {
			...
			if (local35 > 0) {
				...
				local51 = this.method6801(Static2.anInt53 * local41 / local35, 0);
			} else {
				local51 = this.method6801(0, 0);
			}
