...
public final class Class2_Sub1_Sub31 extends Class2_Sub1 {
	...
	private void method6198(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public int[][] method6793(@OriginalArg(0) int arg0) {
		@Pc(21) int[][] local21 = super.aClass372_41.method6004(arg0);
		if (super.aClass372_41.aBoolean737) {
			...
			for (@Pc(39) int local39 = 0; local39 < Static608.anInt9289; local39++) {
				this.method6198(local39, arg0);
				@Pc(52) int[][] local52 = this.method6792(0, Static187.anInt3093);
