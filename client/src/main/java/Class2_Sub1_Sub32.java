...
public final class Class2_Sub1_Sub32 extends Class2_Sub1 {
	...
	public void method6795(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2) {
		if (arg0) {
			this.method6795(false, (Class2_Sub21) null, 34);
		}
		if (arg2 == 0) {
			this.anInt10015 = arg1.method5191();
		} else if (arg2 == 1) {
			this.anInt10016 = arg1.method5191();
		} else if (arg2 == 2) {
			this.anInt10017 = arg1.method5191();
		}
	}
	...
	public int[] method6790(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (super.aClass180_41.aBoolean338) {
			...
			@Pc(32) int[] local32 = this.method6801(Static489.anInt7343 & arg1 - 1, 0);
			@Pc(38) int[] local38 = this.method6801(arg1, 0);
			@Pc(48) int[] local48 = this.method6801(arg1 + 1 & Static489.anInt7343, 0);
		...
		if (arg0 < 107) {
			this.method6231((byte) 87);
		}
		return local11;
	}

	@OriginalMember(owner = "client!vda", name = "c", descriptor = "(B)V")
	private void method6231(@OriginalArg(0) byte arg0) {
