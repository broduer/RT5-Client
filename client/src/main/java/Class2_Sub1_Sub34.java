...
public final class Class2_Sub1_Sub34 extends Class2_Sub1 {
	...
	private int method6273(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
	...
	public int[] method6790(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (arg0 <= 107) {
			Static673.method6274((Class390) null, false);
		}
		if (super.aClass180_41.aBoolean338) {
			@Pc(28) int local28 = Static273.anIntArray341[arg1];
			for (@Pc(30) int local30 = 0; local30 < Static608.anInt9289; local30++) {
				local11[local30] = this.method6273(local28, Static54.anIntArray92[local30]) % 4096;
			}
		}
		return local11;
	}
