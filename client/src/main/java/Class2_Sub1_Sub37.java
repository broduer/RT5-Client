...
public final class Class2_Sub1_Sub37 extends Class2_Sub1 {
	...
	private void method6642(@OriginalArg(0) int arg0) {
	...
	public void method6800(@OriginalArg(0) int arg0) {
		...
		if (this.anInt10638 == 2) {
			this.method6642(arg0 ^ 0xFFFFFFF9);
		}
	...
	public int[] method6790(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (super.aClass180_41.aBoolean338) {
			@Pc(21) int[] local21 = this.method6801(arg1, 0);
	...
	public void method6795(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2) {
		...
		this.anInt10638 = arg1.method5205();
		this.anIntArrayArray259 = new int[arg1.method5205()][2];
		for (@Pc(31) int local31 = 0; local31 < this.anIntArrayArray259.length; local31++) {
			this.anIntArrayArray259[local31][0] = arg1.method5191();
			this.anIntArrayArray259[local31][1] = arg1.method5191();
		}
	}
	...
	private void method6646() {
		...
		if (local8 == 2) {
			for (local8 = 0; local8 < 257; local8++) {
				...
				local83 = this.method6647(local30 - 2)[1];
				local87 = local69[1];
				local91 = local74[1];
				local100 = this.method6647(local30 + 1)[1];
	...
	private int[] method6647(@OriginalArg(1) int arg0) {
		if (arg0 < 0) {
