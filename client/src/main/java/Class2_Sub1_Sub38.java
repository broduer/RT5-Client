...
public final class Class2_Sub1_Sub38 extends Class2_Sub1 {
	...
	public void method6795(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2) {
		if (arg2 == 0) {
			this.aBoolean809 = arg1.method5205() == 1;
		} else if (arg2 == 1) {
			this.aBoolean810 = arg1.method5205() == 1;
		} else if (arg2 == 2) {
	...
	public int[][] method6793(@OriginalArg(0) int arg0) {
		@Pc(18) int[][] local18 = super.aClass372_41.method6004(arg0);
		if (super.aClass372_41.aBoolean737) {
			@Pc(39) int[][] local39 = this.method6792(0, this.aBoolean810 ? Static489.anInt7343 - arg0 : arg0);
	...
	public int[] method6790(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (super.aClass180_41.aBoolean338) {
			@Pc(37) int[] local37 = this.method6801(this.aBoolean810 ? Static489.anInt7343 - arg1 : arg1, 0);
			if (this.aBoolean809) {
				for (@Pc(52) int local52 = 0; local52 < Static608.anInt9289; local52++) {
					local11[local52] = local37[Static576.anInt8580 - local52];
				}
			} else {
				Static734.method5449(local37, 0, local11, 0, Static608.anInt9289);
			}
		}
		return local11;
	}
