...
public final class Class2_Sub1_Sub38 extends Class2_Sub1 {
	...
	public void method9423(@OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2) {
		if (arg2 == 0) {
			this.aBoolean810 = arg1.method7403() == 1;
		} else if (arg2 == 1) {
			this.aBoolean811 = arg1.method7403() == 1;
		} else if (arg2 == 2) {
	...
	public int[][] method9421(@OriginalArg(0) int arg0) {
		...
		if (super.aClass374_41.aBoolean738) {
			@Pc(39) int[][] local39 = this.method9420(0, this.aBoolean811 ? Static489.anInt7364 - arg0 : arg0);
			...
			@Pc(68) int local68;
			if (this.aBoolean810) {
				for (local68 = 0; local68 < Static608.anInt9315; local68++) {
	...
	public int[] method9418(@OriginalArg(1) int arg1) {
		...
		if (super.aClass180_41.aBoolean338) {
			@Pc(37) int[] local37 = this.method9429(this.aBoolean811 ? Static489.anInt7364 - arg1 : arg1, 0);
			if (this.aBoolean810) {
