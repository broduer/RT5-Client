...
public final class Class2_Sub1_Sub5 extends Class2_Sub1 {
	...
	public int[][] method6793(@OriginalArg(0) int arg0) {
		...
		if (super.aClass372_41.aBoolean737) {
			@Pc(27) int[][] local27 = this.method6792(0, arg0);
	...
	public void method6795(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2) {
		if (arg2 == 0) {
			this.anInt1209 = arg1.method5191();
		} else if (arg2 == 1) {
			this.anInt1205 = arg1.method5191();
		} else if (arg2 == 2) {
			this.anInt1207 = arg1.method5191();
		} else if (arg2 == 3) {
			this.anInt1204 = arg1.method5191();
		} else if (arg2 == 4) {
			@Pc(72) int local72 = arg1.method5192();
			this.anIntArray110[1] = local72 >> 4 & 0xFF0;
			this.anIntArray110[2] = local72 >> 12 & 0x0;
			this.anIntArray110[0] = (local72 & 0xFF0000) << 4;
		}
		if (arg0) {
			Static60.method793(-43, false, 13, 77, 8);
		}
	}
}
