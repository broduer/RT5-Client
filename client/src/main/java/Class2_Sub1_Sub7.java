		...
		if (local49 <= 0) {
			if (Static608.anInt9315 < arg5 + arg4) {
				...
				for (local84 = 0; local84 < arg1; local84++) {
					...
					Static735.method7697(local92, arg4, local82, local22);
					Static735.method7697(local92, 0, arg5 - local82, local22);
				}
			} else {
				for (local82 = 0; local82 < arg1; local82++) {
					Static735.method7697(arg0[local82 + arg3], arg4, arg5, local22);
				}
			}
			...
			for (@Pc(191) int local191 = 0; local191 < arg1; local191++) {
				...
				if (local191 < local178) {
					...
					if (Static608.anInt9315 < local182 + local189) {
						...
						Static735.method7697(local199, local182, local217, local212);
						Static735.method7697(local199, 0, local189 - local217, local212);
					} else {
						Static735.method7697(local199, local182, local189, local212);
					}
				} else {
					...
					if (local212 < local178) {
						...
						if (Static608.anInt9315 >= local189 + local182) {
							Static735.method7697(local199, local182, local189, local217);
						} else {
							local225 = Static608.anInt9315 - local182;
							Static735.method7697(local199, local182, local225, local217);
							Static735.method7697(local199, 0, local189 - local225, local217);
						}
					} else {
						for (local217 = 0; local217 < local166; local217++) {
						...
						if (Static608.anInt9315 >= local182 + local189) {
							Static735.method7697(local199, local182, local189, local22);
						} else {
							local225 = Static608.anInt9315 - local182;
							Static735.method7697(local199, local182, local225, local22);
							Static735.method7697(local199, 0, local189 - local225, local22);
						}
					}
				}
			}
