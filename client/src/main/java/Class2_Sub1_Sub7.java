...
public final class Class2_Sub1_Sub7 extends Class2_Sub1 {
	...
	public int[] method6790(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(11) int[] local11 = super.aClass180_41.method2752(arg1);
		if (arg0 <= 107) {
			Static102.method1288(true, -62, 43, true);
		}
		if (!super.aClass180_41.aBoolean338) {
			return local11;
		}
		@Pc(31) int[][] local31 = super.aClass180_41.method2749();
		@Pc(33) int local33 = 0;
		@Pc(35) int local35 = 0;
		@Pc(37) int local37 = 0;
		@Pc(39) int local39 = 0;
		...
		while (true) {
			while (true) {
				@Pc(126) int local126 = local56 + Static623.method5895(-5208, local63 - local56, local116);
				@Pc(136) int local136 = local70 + Static623.method5895(-5208, local77 - local70, local116);
							...
							if (local161 != local41) {
								...
								for (@Pc(275) int local275 = 0; local275 <= local167; local275++) {
									...
									if (local289 != local157) {
										...
										this.method1284(local31, local157 - local289, local116, local289, local37 + local311, -local311 + local315, (byte) -58);
									}
								}
							}
							local41 = local161;
				...
				@Pc(406) int[] local406;
				if (local141 == Static608.anInt9289) {
					this.method1284(local31, local136, local116, local157, local35 + local39, local126, (byte) -58);
					if (local43) {
						return local11;
					}
					local43 = true;
					...
					local49 = 0;
					local37 = local35;
					local35 = Static623.method5895(-5208, Static608.anInt9289, local116);
					...
					local406[1] = local141;
					local406[0] = local39;
					this.method1284(local31, local136, local116, local157, local39 + local35, local126, (byte) -58);
					local39 = local141;
				}
			}
		}
	...
	public void method6800(@OriginalArg(0) int arg0) {
		if (arg0 != 7) {
			this.method1284((int[][]) null, 27, (Random) null, 76, -2, -58, (byte) 89);
		}
	}

	@OriginalMember(owner = "client!dd", name = "a", descriptor = "([[IILjava/util/Random;IIIB)V")
	private void method1284(@OriginalArg(0) int[][] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Random arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) byte arg6) {
		@Pc(22) int local22 = this.anInt2133 <= 0 ? 4096 : 4096 - Static623.method5895(arg6 - 5150, this.anInt2133, arg2);
		@Pc(30) int local30 = this.anInt2119 * this.anInt2125 >> 12;
		@Pc(49) int local49 = this.anInt2125 - (local30 <= 0 ? 0 : Static623.method5895(arg6 ^ 0x146E, local30, arg2));
		...
		if (local49 <= 0) {
			if (Static608.anInt9289 < arg5 + arg4) {
				...
				for (local84 = 0; local84 < arg1; local84++) {
					...
					Static734.method5444(local92, arg4, local82, local22);
					Static734.method5444(local92, 0, arg5 - local82, local22);
				}
			} else {
				for (local82 = 0; local82 < arg1; local82++) {
					Static734.method5444(arg0[local82 + arg3], arg4, arg5, local22);
				}
			}
			...
			for (@Pc(191) int local191 = 0; local191 < arg1; local191++) {
				...
				if (local191 < local178) {
					...
					if (Static608.anInt9289 < local182 + local189) {
						...
						Static734.method5444(local199, local182, local217, local212);
						Static734.method5444(local199, 0, local189 - local217, local212);
					} else {
						Static734.method5444(local199, local182, local189, local212);
					}
				} else {
					...
					if (local212 < local178) {
						...
						if (Static608.anInt9289 >= local189 + local182) {
							Static734.method5444(local199, local182, local189, local217);
						} else {
							local225 = Static608.anInt9289 - local182;
							Static734.method5444(local199, local182, local225, local217);
							Static734.method5444(local199, 0, local189 - local225, local217);
						}
					} else {
						for (local217 = 0; local217 < local166; local217++) {
						...
						if (Static608.anInt9289 >= local182 + local189) {
							Static734.method5444(local199, local182, local189, local22);
						} else {
							local225 = Static608.anInt9289 - local182;
							Static734.method5444(local199, local182, local225, local22);
							Static734.method5444(local199, 0, local189 - local225, local22);
						}
					}
				}
			}
	...
	public void method6795(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2) {
		if (arg0) {
			this.method6790(39, 29);
		}
		if (arg2 == 0) {
			this.anInt2124 = arg1.method5205();
		} else if (arg2 == 1) {
			this.anInt2131 = arg1.method5191();
		} else if (arg2 == 2) {
			this.anInt2126 = arg1.method5191();
		} else if (arg2 == 3) {
			this.anInt2132 = arg1.method5191();
		} else if (arg2 == 4) {
			this.anInt2123 = arg1.method5191();
		} else if (arg2 == 5) {
			this.anInt2122 = arg1.method5191();
		} else if (arg2 == 6) {
			this.anInt2118 = arg1.method5205();
		} else if (arg2 == 7) {
			this.anInt2119 = arg1.method5191();
		} else if (arg2 == 8) {
			this.anInt2133 = arg1.method5191();
		}
	}
}
