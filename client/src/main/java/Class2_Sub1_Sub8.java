...
public class Class2_Sub1_Sub8 extends Class2_Sub1 {
	...
	public int[][] method6793(@OriginalArg(0) int arg0) {
		@Pc(11) int[][] local11 = super.aClass372_41.method6004(arg0);
		if (super.aClass372_41.aBoolean737 && this.method5074()) {
	...
	protected final boolean method5074() {
		if (this.anIntArray641 != null) {
			return true;
		} else if (this.anInt8232 >= 0) {
			@Pc(37) Class407 local37 = Static426.anInt940 >= 0 ? Static735.method6771(Static582.aClass330_108, Static426.anInt940, this.anInt8232) : Static735.method6768(Static582.aClass330_108, this.anInt8232);
			local37.method6778();
			this.anIntArray641 = local37.method6772();
	...
	@Override
	public final void method6795(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2) {
		if (!arg0 && arg2 == 0) {
			this.anInt8232 = arg1.method5191();
		}
	}
