...
public final class Class2_Sub1_Sub9 extends Class2_Sub1 {
	...
	public void method6795(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2) {
		if (arg2 == 0) {
			this.anInt3092 = arg1.method5165();
		} else if (arg2 == 1) {
			this.anInt3087 = (arg1.method5186() << 12) / 100;
		} else if (arg2 == 2) {
			this.anInt3079 = (arg1.method5186() << 12) / 100;
		}
		if (arg0) {
			this.anInt3086 = -61;
		}
	...
	private void method1951(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
	...
	private void method1955(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
	...
	public int[][] method6793(@OriginalArg(0) int arg0) {
		@Pc(22) int[][] local22 = super.aClass372_41.method6004(arg0);
		if (super.aClass372_41.aBoolean737) {
			@Pc(32) int[][] local32 = this.method6792(0, arg0);
			...
			for (@Pc(58) int local58 = 0; local58 < Static608.anInt9289; local58++) {
				this.method1955(local36[local58], local44[local58], local40[local58]);
				...
				this.method1951(this.anInt3088, this.anInt3078, this.anInt3080);
