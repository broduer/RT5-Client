...
public final class Class2_Sub1_Sub9 extends Class2_Sub1 {
	...
	public void method9423(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2) {
		if (arg2 == 0) {
			this.anInt3101 = arg1.method7363();
		} else if (arg2 == 1) {
			this.anInt3096 = (arg1.method7384() << 12) / 100;
		} else if (arg2 == 2) {
			this.anInt3088 = (arg1.method7384() << 12) / 100;
		}
		if (arg0) {
			this.anInt3095 = -61;
		}
	...
	public int[][] method9421(@OriginalArg(0) int arg0) {
		@Pc(22) int[][] local22 = super.aClass374_41.method8457(arg0);
		if (super.aClass374_41.aBoolean738) {
			@Pc(32) int[][] local32 = this.method9420(0, arg0);
			...
			for (@Pc(58) int local58 = 0; local58 < Static608.anInt9315; local58++) {
