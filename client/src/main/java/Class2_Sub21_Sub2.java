...
public final class Class2_Sub21_Sub2 extends Class2_Sub21 {
	...
	public int method5221(@OriginalArg(1) int arg0) {
	...
	public boolean method5222() {
		@Pc(22) int local22 = super.aByteArray93[super.anInt8388] - this.aClass186_2.method2858() & 0xFF;
		return local22 >= 128;
	}

	@OriginalMember(owner = "client!rka", name = "a", descriptor = "([IB)V")
	public void method5224(@OriginalArg(0) int[] arg0) {
		this.aClass186_2 = new Class186(arg0);
	}

	@OriginalMember(owner = "client!rka", name = "a", descriptor = "([BIIZ)V")
	public void method5225(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		for (@Pc(7) int local7 = 0; local7 < arg1; local7++) {
			arg0[local7] = (byte) (super.aByteArray93[super.anInt8388++] - this.aClass186_2.method2855());
		}
	}
	...
	public void method5227(@OriginalArg(1) int arg0) {
		super.aByteArray93[super.anInt8388++] = (byte) (arg0 + this.aClass186_2.method2855());
	}

	@OriginalMember(owner = "client!rka", name = "m", descriptor = "(II)I")
	public int method5229(@OriginalArg(0) int arg0) {
		return arg0 * 8 - this.anInt8422;
	}

	@OriginalMember(owner = "client!rka", name = "x", descriptor = "(I)I")
	public int method5230() {
		@Pc(30) int local30 = super.aByteArray93[super.anInt8388++] - this.aClass186_2.method2855() & 0xFF;
		return local30 < 128 ? local30 : (super.aByteArray93[super.anInt8388++] - this.aClass186_2.method2855() & 0xFF) + (local30 - 128 << 8);
	}

	@OriginalMember(owner = "client!rka", name = "a", descriptor = "(Lclient!iv;I)V")
	public void method5231(@OriginalArg(0) Class186 arg0) {
