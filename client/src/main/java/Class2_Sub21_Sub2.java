...
public final class Class2_Sub21_Sub2 extends Class2_Sub21 {
	...
	public void method7418() {
		super.anInt8412 = (this.anInt8446 + 7) / 8;
	}
	...
	public boolean method7420() {
		@Pc(22) int local22 = super.aByteArray93[super.anInt8412] - this.aClass186_2.method4108() & 0xFF;
		return local22 >= 128;
	}
	...
	public void method7423(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		for (@Pc(7) int local7 = 0; local7 < arg1; local7++) {
			arg0[local7] = (byte) (super.aByteArray93[super.anInt8412++] - this.aClass186_2.method4105());
		}
	}

	@OriginalMember(owner = "client!rka", name = "w", descriptor = "(I)V")
	public void method7424() {
		this.anInt8446 = super.anInt8412 * 8;
	}

	@OriginalMember(owner = "client!rka", name = "n", descriptor = "(II)V")
	public void method7425(@OriginalArg(1) int arg0) {
		super.aByteArray93[super.anInt8412++] = (byte) (arg0 + this.aClass186_2.method4105());
	}
	...
	public int method7428() {
		@Pc(30) int local30 = super.aByteArray93[super.anInt8412++] - this.aClass186_2.method4105() & 0xFF;
		return local30 < 128 ? local30 : (super.aByteArray93[super.anInt8412++] - this.aClass186_2.method4105() & 0xFF) + (local30 - 128 << 8);
	}
