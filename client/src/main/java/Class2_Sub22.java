...
public final class Class2_Sub22 extends Class2 {
	...
	public Class114 method3078(@OriginalArg(0) int arg0, @OriginalArg(2) Class19 arg1, @OriginalArg(4) boolean arg2, @OriginalArg(5) Class152 arg3, @OriginalArg(6) Class203 arg4) {
		...
		if (arg0 != -1) {
			local11 = Static574.aClass312_2.method7125(arg0);
		}
		...
		if (local7 == null || arg1.method7967(local7.ua(), local9) != 0) {
			...
			for (@Pc(155) int local155 = 0; local155 < local23.length; local155++) {
				if (local23[local155] != -1 && !Static419.aClass112_1.method2486(local23[local155]).method8809(arg2, (Class52) null)) {
					local153 = true;
				}
			}
			if (local153) {
			...
			for (@Pc(205) int local205 = 0; local205 < local23.length; local205++) {
				if (local23[local205] != -1) {
					local203[local205] = Static419.aClass112_1.method2486(local23[local205]).method8806((Class52) null, arg2);
				}
			}
			@Pc(278) int local278;
			@Pc(285) int local285;
