...
public final class Class2_Sub22 extends Class2 {
	...
	private long method2167(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3) {
	...
	public Class114 method2168(@OriginalArg(0) int arg0, @OriginalArg(2) Class19 arg1, @OriginalArg(4) boolean arg2, @OriginalArg(5) Class152 arg3, @OriginalArg(6) Class201 arg4) {
		@Pc(7) Class114 local7 = null;
		@Pc(9) int local9 = 2048;
		@Pc(11) Class289 local11 = null;
		if (arg0 != -1) {
			local11 = Static574.aClass310_2.method4993(arg0);
		}
		...
		if (arg3 != null) {
			local9 = arg3.method6535() | 0x800;
		}
		@Pc(116) long local116 = this.method2167(arg2, arg0, local23, arg4 == null ? null : arg4.anIntArray380);
		if (Static166.aClass82_59 != null) {
			local7 = (Class114) Static166.aClass82_59.method1390(local116);
		}
		if (local7 == null || arg1.b(local7.ua(), local9) != 0) {
			if (local7 != null) {
				local9 = arg1.c(local9, local7.ua());
			}
			@Pc(151) int local151 = local9;
			@Pc(153) boolean local153 = false;
			for (@Pc(155) int local155 = 0; local155 < local23.length; local155++) {
				if (local23[local155] != -1 && !Static419.aClass112_1.method1684(local23[local155]).method6289(arg2, (Class52) null)) {
					local153 = true;
				}
			}
			if (local153) {
			...
			for (@Pc(205) int local205 = 0; local205 < local23.length; local205++) {
				if (local23[local205] != -1) {
					local203[local205] = Static419.aClass112_1.method1684(local23[local205]).method6286((Class52) null, arg2);
				}
			}
			@Pc(278) int local278;
			@Pc(285) int local285;
				...
				for (@Pc(252) int local252 = 0; local252 < local11.anIntArrayArray181.length; local252++) {
					if (local11.anIntArrayArray181[local252] != null && local203[local252] != null) {
						...
						if (local299 != 0 || local306 != 0 || local313 != 0) {
							local203[local252].method1456(local313, local299, local306);
						}
						if (local278 != 0 || local285 != 0 || local292 != 0) {
							local203[local252].method1453(local278, local285, local292);
						}
					}
				}
			}
			...
			local7 = arg1.a(local382, local151, Static584.anInt8635, 64, 850);
			if (arg4 != null) {
			...
			if (Static166.aClass82_59 != null) {
				local7.s(local9);
				Static166.aClass82_59.method1384(local7, local116);
			}
		}
		if (arg3 == null) {
			return local7;
		} else {
			@Pc(478) Class114 local478 = local7.a((byte) 1, local9, true);
			arg3.method6523(local478, 0);
			return local478;
		}
	}
}
