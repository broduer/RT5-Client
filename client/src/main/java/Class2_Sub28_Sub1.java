...
public final class Class2_Sub28_Sub1 extends Class2_Sub28 {
	...
	protected void method6097(@OriginalArg(1) OggPacket arg0) {
		...
		@Pc(85) Class2_Sub2_Sub8 local85 = this.aClass2_Sub6_Sub5_1.method6571(local35[0].length, this.aDouble14);
		Static373.method3752(local35, local85.aShortArrayArray3);
		for (@Pc(93) int local93 = 0; local93 < this.aVorbisInfo1.channels; local93++) {
			local85.aShortArrayArray3[local93] = this.aClass224_1.method3694(local85.aShortArrayArray3[local93]);
		}
		this.aClass2_Sub6_Sub5_1.method6572(local85);
	}

	@OriginalMember(owner = "client!ik", name = "b", descriptor = "(B)D")
	public double method2770() {
		@Pc(13) double local13 = this.aDouble14;
		if (this.aClass2_Sub6_Sub5_1 != null) {
			local13 = this.aClass2_Sub6_Sub5_1.method6566(false);
			if (local13 < 0.0D) {
	...
	public int method2772() {
		return this.aClass2_Sub6_Sub5_1 == null ? 0 : this.aClass2_Sub6_Sub5_1.method6569();
	}
}
