...
public final class Class2_Sub28_Sub3 extends Class2_Sub28 {
	...
	private void method3887(@OriginalArg(1) int arg0) {
		this.anInt6119 = arg0;
		if (!this.aBoolean463) {
			return;
		}
	...
	public Class23 method3888(@OriginalArg(0) Class19 arg0) {
		if (this.aFrame7 == null) {
			return null;
		} else if (this.aBoolean462 || this.aClass23_29 == null) {
			this.aClass23_29 = arg0.a(this.aFrame7.pixels, 0, this.aFrame7.b, this.aFrame7.b, this.aFrame7.a, false);
	...
	protected void method6097(@OriginalArg(1) OggPacket arg0) {
		...
		if (!this.aBoolean463) {
			...
			if (local19 == 0) {
				...
				this.method3887(this.anInt6119);
			} else if (local19 < 0) {
				throw new IllegalStateException(String.valueOf(local19));
			}
			return;
		}
		this.aLong188 = Static588.method5469();
