...
public final class Class2_Sub28_Sub4 extends Class2_Sub28 {
	...
	protected void method6097(@OriginalArg(1) OggPacket arg0) {
		...
		@Pc(35) int local35 = local31.method5205();
		if (super.anInt9753 > 8) {
			if (local35 == 0) {
				@Pc(47) long local47 = local31.method5168();
				@Pc(51) long local51 = local31.method5168();
				@Pc(55) long local55 = local31.method5168();
				...
				@Pc(121) int local121 = local31.method5160();
				if (local121 < 0 || local31.aByteArray93.length - local31.anInt8388 < local121) {
					throw new IllegalStateException();
				}
				this.aString115 = Static366.method3721(local121, local31.aByteArray93, local31.anInt8388);
			}
			if ((local35 | 0x80) != 0) {
				return;
			}
		...
		this.anInt9764 = local31.method5160();
		this.anInt9757 = local31.method5160();
		if (this.anInt9764 == 0 || this.anInt9757 == 0) {
			throw new IllegalStateException();
		}
		@Pc(211) Class2_Sub21 local211 = new Class2_Sub21(16);
		local31.method5153(0, 16, local211.aByteArray93);
		this.aString116 = local211.method5167();
		local211.anInt8388 = 0;
		local31.method5153(0, 16, local211.aByteArray93);
		this.aString117 = local211.method5167();
	}
