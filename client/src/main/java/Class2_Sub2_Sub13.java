...
public final class Class2_Sub2_Sub13 extends Class2_Sub2 {
	...
	public boolean method2835(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int[] arg2) {
		for (@Pc(23) Class2_Sub56 local23 = (Class2_Sub56) this.aClass339_26.method5453(65280); local23 != null; local23 = (Class2_Sub56) this.aClass339_26.method5460()) {
			if (local23.method6365(arg0, arg1)) {
				local23.method6358(arg2, arg0, arg1);
				return true;
			}
		}
		return false;
	...
	public boolean method2836(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		for (@Pc(17) Class2_Sub56 local17 = (Class2_Sub56) this.aClass339_26.method5453(65280); local17 != null; local17 = (Class2_Sub56) this.aClass339_26.method5460()) {
			if (local17.method6365(arg0, arg1)) {
				return true;
			}
		}
		return false;
	...
	public boolean method2838(@OriginalArg(1) int[] arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		for (@Pc(15) Class2_Sub56 local15 = (Class2_Sub56) this.aClass339_26.method5453(65280); local15 != null; local15 = (Class2_Sub56) this.aClass339_26.method5460()) {
			if (local15.method6363(arg1, arg2, arg3)) {
				local15.method6358(arg0, arg3, arg1);
				return true;
			}
		}
		return false;
	...
	public void method2840() {
		...
		this.anInt4552 = 0;
		for (@Pc(28) Class2_Sub56 local28 = (Class2_Sub56) this.aClass339_26.method5453(65280); local28 != null; local28 = (Class2_Sub56) this.aClass339_26.method5460()) {
	...
	public boolean method2841(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int[] arg2) {
		for (@Pc(9) Class2_Sub56 local9 = (Class2_Sub56) this.aClass339_26.method5453(65280); local9 != null; local9 = (Class2_Sub56) this.aClass339_26.method5460()) {
			if (local9.method6361(arg0, arg1)) {
				local9.method6364(arg1, arg2, arg0);
				return true;
			}
		}
		return false;
