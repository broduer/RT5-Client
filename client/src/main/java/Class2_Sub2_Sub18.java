	...
	public boolean method5329() {
		...
		if (this.aByteArrayArray32 == null) {
			...
			synchronized (Static509.aClass330_96) {
				if (!Static509.aClass330_96.method5371(this.anInt8535)) {
					return false;
				}
				local36 = Static509.aClass330_96.method5367(this.anInt8535);
				this.aByteArrayArray32 = new byte[local36.length][];
				for (local43 = 0; local43 < local36.length; local43++) {
					this.aByteArrayArray32[local43] = Static509.aClass330_96.method5359(local36[local43], this.anInt8535);
				}
			}
		}
		...
		synchronized (Static509.aClass330_96) {
			@Pc(133) int local133 = Static509.aClass330_96.method5372(this.anInt8535);
		...
		for (local43 = 0; local43 < local36.length; local43++) {
			...
			@Pc(179) int local179 = local172.method5191();
			@Pc(181) Class2_Sub44 local181 = null;
			for (@Pc(188) Class2_Sub44 local188 = (Class2_Sub44) local123.method5453(65280); local188 != null; local188 = (Class2_Sub44) local123.method5460()) {
			...
			if (local181 == null) {
				...
				synchronized (Static269.aClass330_58) {
					local181 = new Class2_Sub44(local179, Static269.aClass330_58.method5353(local179));
				}
				local123.method5465(local181);
			}
