...
public final class Class2_Sub2_Sub21 extends Class2_Sub2 {
	...
	public Class2_Sub2_Sub21(@OriginalArg(0) Class2_Sub21 arg0) {
		...
		for (@Pc(20) int local20 = 0; local20 < local7; local20++) {
			@Pc(28) Class2_Sub1 local28 = Static294.method4348(arg0);
			...
			for (local56 = 0; local56 < local49; local56++) {
				local14[local20][local56] = arg0.method7403();
			}
		...
		this.aClass2_Sub1_3 = this.aClass2_Sub1Array39[arg0.method7403()];
		this.aClass2_Sub1_1 = this.aClass2_Sub1Array39[arg0.method7403()];
		this.aClass2_Sub1_2 = this.aClass2_Sub1Array39[arg0.method7403()];
	}

	@OriginalMember(owner = "client!vm", name = "a", descriptor = "(BILclient!d;Lclient!sb;ZI)[F")
	public float[] method8953(@OriginalArg(1) int arg0, @OriginalArg(2) Interface4 arg1, @OriginalArg(3) Class332 arg2, @OriginalArg(4) boolean arg3, @OriginalArg(5) int arg4) {
		...
		for (@Pc(25) int local25 = 0; local25 < this.aClass2_Sub1Array39.length; local25++) {
			this.aClass2_Sub1Array39[local25].method9425(arg0, arg4);
		}
		...
		for (@Pc(58) int local58 = 0; local58 < arg0; local58++) {
			...
			if (this.aClass2_Sub1_3.aBoolean825) {
				...
				@Pc(88) int[][] local88 = this.aClass2_Sub1_3.method9421(local58);
				local78 = local88[0];
				local76 = local88[2];
				local80 = local88[1];
			}
	...
	public boolean method8954(@OriginalArg(0) Class332 arg0, @OriginalArg(1) Interface4 arg1) {
		@Pc(12) int local12;
	...
	public int[] method8955(@OriginalArg(0) int arg0, @OriginalArg(1) double arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) int arg3, @OriginalArg(5) Interface4 arg4, @OriginalArg(6) Class332 arg5) {
		...
		for (@Pc(11) int local11 = 0; local11 < this.aClass2_Sub1Array39.length; local11++) {
			this.aClass2_Sub1Array39[local11].method9425(arg3, arg0);
		}
		...
		for (@Pc(57) int local57 = 0; local57 < arg3; local57++) {
			...
			if (this.aClass2_Sub1_3.aBoolean825) {
				...
				@Pc(73) int[][] local73 = this.aClass2_Sub1_3.method9421(local57);
				local77 = local73[0];
				local81 = local73[2];
				local85 = local73[1];
			}
	...
	public int[] method8958(@OriginalArg(0) Class332 arg0, @OriginalArg(1) double arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Interface4 arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		Static677.anInterface4_11 = arg3;
		Static582.aClass332_108 = arg0;
		for (@Pc(11) int local11 = 0; local11 < this.aClass2_Sub1Array39.length; local11++) {
			this.aClass2_Sub1Array39[local11].method9425(arg5, arg6);
		}
		Static725.method9462(arg1);
		...
		for (@Pc(65) int local65 = 0; local65 < arg5; local65++) {
			...
			if (this.aClass2_Sub1_3.aBoolean825) {
				...
				@Pc(93) int[][] local93 = this.aClass2_Sub1_3.method9421(local65);
				local83 = local93[2];
				local81 = local93[1];
				local85 = local93[0];
			}
