...
public final class Class2_Sub2_Sub21 extends Class2_Sub2 {
	...
	public Class2_Sub2_Sub21(@OriginalArg(0) Class2_Sub21 arg0) {
		...
		for (@Pc(20) int local20 = 0; local20 < local7; local20++) {
			@Pc(28) Class2_Sub1 local28 = Static294.method3006(arg0);
			if (local28.method6791() >= 0) {
				local9++;
			}
			if (local28.method6798() >= 0) {
				local11++;
			}
			@Pc(49) int local49 = local28.aClass2_Sub1Array42.length;
			local14[local20] = new int[local49];
			for (local56 = 0; local56 < local49; local56++) {
				local14[local20][local56] = arg0.method5205();
			}
		...
		for (@Pc(105) int local105 = 0; local105 < local7; local105++) {
			...
			@Pc(148) int local148 = local114.method6791();
			@Pc(152) int local152 = local114.method6798();
			if (local148 > 0) {
		...
		this.aClass2_Sub1_3 = this.aClass2_Sub1Array39[arg0.method5205()];
		this.aClass2_Sub1_1 = this.aClass2_Sub1Array39[arg0.method5205()];
		this.aClass2_Sub1_2 = this.aClass2_Sub1Array39[arg0.method5205()];
	}

	@OriginalMember(owner = "client!vm", name = "a", descriptor = "(BILclient!d;Lclient!sb;ZI)[F")
	public float[] method6392(@OriginalArg(1) int arg0, @OriginalArg(2) Interface4 arg1, @OriginalArg(3) Class330 arg2, @OriginalArg(4) boolean arg3, @OriginalArg(5) int arg4) {
		...
		for (@Pc(25) int local25 = 0; local25 < this.aClass2_Sub1Array39.length; local25++) {
			this.aClass2_Sub1Array39[local25].method6797(arg0, arg4);
		}
		Static132.method1516(arg0, arg4);
		...
		for (@Pc(58) int local58 = 0; local58 < arg0; local58++) {
			...
			if (this.aClass2_Sub1_3.aBoolean824) {
				@Pc(74) int[] local74 = this.aClass2_Sub1_3.method6790(117, local58);
				local76 = local74;
				local78 = local74;
				local80 = local74;
			} else {
				@Pc(88) int[][] local88 = this.aClass2_Sub1_3.method6793(local58);
				local78 = local88[0];
				local76 = local88[2];
				local80 = local88[1];
			}
			...
			if (this.aClass2_Sub1_1.aBoolean824) {
				local110 = this.aClass2_Sub1_1.method6790(114, local58);
			} else {
				local110 = this.aClass2_Sub1_1.method6793(local58)[0];
			}
			if (arg3) {
				local56 = local58 << 2;
			}
			...
			if (this.aClass2_Sub1_2.aBoolean824) {
				local136 = this.aClass2_Sub1_2.method6790(115, local58);
			} else {
				local136 = this.aClass2_Sub1_2.method6793(local58)[0];
			}
		...
		for (@Pc(244) int local244 = 0; local244 < this.aClass2_Sub1Array39.length; local244++) {
			this.aClass2_Sub1Array39[local244].method6802();
		}
		return local54;
	}

	@OriginalMember(owner = "client!vm", name = "a", descriptor = "(Lclient!sb;Lclient!d;B)Z")
	public boolean method6393(@OriginalArg(0) Class330 arg0, @OriginalArg(1) Interface4 arg1) {
		@Pc(12) int local12;
		if (Static426.anInt940 < 0) {
			for (local12 = 0; local12 < this.anIntArray824.length; local12++) {
				if (!arg0.method5345(this.anIntArray824[local12])) {
					return false;
				}
			}
		} else {
			for (local12 = 0; local12 < this.anIntArray824.length; local12++) {
				if (!arg0.method5350(this.anIntArray824[local12], Static426.anInt940)) {
					return false;
				}
			}
		}
		...
		for (local12 = 0; local12 < this.anIntArray823.length; local12++) {
			if (!arg1.method4802(this.anIntArray823[local12])) {
				return false;
			}
		}
		return true;
	...
	public int[] method6394(@OriginalArg(0) int arg0, @OriginalArg(1) double arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) int arg3, @OriginalArg(5) Interface4 arg4, @OriginalArg(6) Class330 arg5) {
		...
		for (@Pc(11) int local11 = 0; local11 < this.aClass2_Sub1Array39.length; local11++) {
			this.aClass2_Sub1Array39[local11].method6797(arg3, arg0);
		}
		Static725.method6834(arg1);
		Static132.method1516(arg3, arg0);
		...
		for (@Pc(57) int local57 = 0; local57 < arg3; local57++) {
			...
			@Pc(93) int[] local93;
			if (this.aClass2_Sub1_3.aBoolean824) {
				local93 = this.aClass2_Sub1_3.method6790(117, local57);
				local81 = local93;
				local85 = local93;
				local77 = local93;
			} else {
				@Pc(73) int[][] local73 = this.aClass2_Sub1_3.method6793(local57);
				local77 = local73[0];
				local81 = local73[2];
				local85 = local73[1];
			}
			if (this.aClass2_Sub1_1.aBoolean824) {
				local93 = this.aClass2_Sub1_1.method6790(111, local57);
			} else {
				local93 = this.aClass2_Sub1_1.method6793(local57)[0];
			}
			if (arg2) {
				local55 = local57;
			}
		...
		for (@Pc(268) int local268 = 0; local268 < this.aClass2_Sub1Array39.length; local268++) {
			this.aClass2_Sub1Array39[local268].method6802();
		}
		return local53;
	}

	@OriginalMember(owner = "client!vm", name = "a", descriptor = "(Lclient!sb;DZLclient!d;ZIII)[I")
	public int[] method6397(@OriginalArg(0) Class330 arg0, @OriginalArg(1) double arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Interface4 arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		Static677.anInterface4_11 = arg3;
		Static582.aClass330_108 = arg0;
		for (@Pc(11) int local11 = 0; local11 < this.aClass2_Sub1Array39.length; local11++) {
			this.aClass2_Sub1Array39[local11].method6797(arg5, arg6);
		}
		Static725.method6834(arg1);
		Static132.method1516(arg5, arg6);
		...
		for (@Pc(65) int local65 = 0; local65 < arg5; local65++) {
			...
			@Pc(83) int[] local83;
			if (this.aClass2_Sub1_3.aBoolean824) {
				@Pc(79) int[] local79 = this.aClass2_Sub1_3.method6790(127, local65);
				local81 = local79;
				local83 = local79;
				local85 = local79;
			} else {
				@Pc(93) int[][] local93 = this.aClass2_Sub1_3.method6793(local65);
				local83 = local93[2];
				local81 = local93[1];
				local85 = local93[0];
			}
		...
		for (@Pc(230) int local230 = 0; local230 < this.aClass2_Sub1Array39.length; local230++) {
			this.aClass2_Sub1Array39[local230].method6802();
		}
		return local41;
	}
}
