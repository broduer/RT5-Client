...
public final class Class2_Sub2_Sub3 extends Class2_Sub2 {
	...
	private void method1181(@OriginalArg(1) Class2_Sub21 arg0, @OriginalArg(2) int arg1) {
		...
		@Pc(44) byte local44;
		if (arg1 == 2) {
			local22 = arg0.method7403();
			this.anIntArray93 = new int[local22];
			this.aCharArray2 = new char[local22];
			for (local32 = 0; local32 < local22; local32++) {
				this.anIntArray93[local32] = arg0.method7389();
				local44 = arg0.method7384();
				this.aCharArray2[local32] = local44 == 0 ? 0 : Static346.method5091(local44);
			}
		} else if (arg1 == 3) {
			local22 = arg0.method7403();
			...
			for (local32 = 0; local32 < local22; local32++) {
				this.anIntArray94[local32] = arg0.method7389();
				local44 = arg0.method7384();
				this.aCharArray3[local32] = local44 == 0 ? 0 : Static346.method5091(local44);
			}
		}
	}
