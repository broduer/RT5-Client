...
public final class Class2_Sub2_Sub3 extends Class2_Sub2 {
	...
	public void method695(@OriginalArg(0) Class2_Sub21 arg0) {
		while (true) {
			@Pc(3) int local3 = arg0.method5205();
			if (local3 == 0) {
				return;
			}
			this.method696(arg0, local3);
		}
	}

	@OriginalMember(owner = "client!bq", name = "a", descriptor = "(ILclient!ge;I)V")
	private void method696(@OriginalArg(1) Class2_Sub21 arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 1) {
			this.aString4 = arg0.method5167();
			return;
		}
		@Pc(22) int local22;
		@Pc(32) int local32;
		@Pc(44) byte local44;
		if (arg1 == 2) {
			local22 = arg0.method5205();
			this.anIntArray93 = new int[local22];
			this.aCharArray2 = new char[local22];
			for (local32 = 0; local32 < local22; local32++) {
				this.anIntArray93[local32] = arg0.method5191();
				local44 = arg0.method5186();
				this.aCharArray2[local32] = local44 == 0 ? 0 : Static346.method3566(local44);
			}
		} else if (arg1 == 3) {
			local22 = arg0.method5205();
			...
			for (local32 = 0; local32 < local22; local32++) {
				this.anIntArray94[local32] = arg0.method5191();
				local44 = arg0.method5186();
				this.aCharArray3[local32] = local44 == 0 ? 0 : Static346.method3566(local44);
			}
		}
	}

	@OriginalMember(owner = "client!bq", name = "a", descriptor = "(CI)I")
	public int method699(@OriginalArg(0) char arg0) {
	...
	public int method700(@OriginalArg(1) char arg0) {
