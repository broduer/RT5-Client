...
public abstract class Class2_Sub31 extends Class2 {
	...
	public abstract void method3225(@OriginalArg(1) int arg0);

	@OriginalMember(owner = "client!jea", name = "c", descriptor = "(B)V")
	public abstract void method3226();

	@OriginalMember(owner = "client!jea", name = "b", descriptor = "(B)Z")
	public abstract boolean method3227();

	@OriginalMember(owner = "client!jea", name = "a", descriptor = "(Lclient!rq;Lclient!rq;II)V")
	public abstract void method3229(@OriginalArg(0) Class93_Sub2 arg0, @OriginalArg(1) Class93_Sub2 arg1, @OriginalArg(3) int arg2);
