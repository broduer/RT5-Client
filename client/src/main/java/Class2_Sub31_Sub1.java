...
public final class Class2_Sub31_Sub1 extends Class2_Sub31 {
	...
	public boolean method3235() {
		...
		this.aClass93_Sub2_2.method2051(false, false);
		this.aClass93_Sub2_1 = new Class93_Sub2(super.aClass19_Sub3_22, 3553, 34842, 256, 256);
		this.aClass93_Sub2_1.method2051(false, false);
		super.aClass19_Sub3_22.method4842(this.aClass406_1);
		this.aClass406_1.method6758(this.aClass93_Sub2_2, 0);
		this.aClass406_1.method6758(this.aClass93_Sub2_1, 1);
		this.aClass406_1.method6760(0);
		if (!this.aClass406_1.method6757()) {
			super.aClass19_Sub3_22.method4868(this.aClass406_1);
			return false;
		}
		super.aClass19_Sub3_22.method4868(this.aClass406_1);
		this.aClass179_2 = Static173.method1828(super.aClass19_Sub3_22, new Class240[] { Static245.method6146("#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n", super.aClass19_Sub3_22, 35632) });
		this.aClass179_5 = Static173.method1828(super.aClass19_Sub3_22, new Class240[] { Static245.method6146("uniform vec3 params;\nuniform sampler2D sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2D(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n", super.aClass19_Sub3_22, 35632) });
		this.aClass179_3 = Static173.method1828(super.aClass19_Sub3_22, new Class240[] { Static245.method6146("#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform vec3 dimScale;\nuniform sampler2D bloomTex;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n\t vec4 bloomCol = texture2D(bloomTex, gl_TexCoord[1].xy);\n\t vec4 sceneCol = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n\t float preLum = 0.99*dot(lumCoef, sceneCol.rgb)+0.01;\n    float postLum = preLum*(1.0+(preLum/params.y))/(preLum+1.0);\n\t gl_FragColor = sceneCol*(postLum/preLum)+bloomCol*params.x;\n}\n", super.aClass19_Sub3_22, 35632) });
		this.aClass179_4 = Static173.method1828(super.aClass19_Sub3_22, new Class240[] { Static245.method6146("uniform vec3 step;\nuniform sampler2D baseTex;\nvoid main() {\n\tvec4 fragCol = texture2D(baseTex, gl_TexCoord[0].xy)*0.091396265;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-8.0*step.xy))*0.012369139;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 8.0*step.xy))*0.012369139;\n\tgl_FragColor = fragCol;\n}\n", super.aClass19_Sub3_22, 35632) });
	...
	public void method3229(@OriginalArg(0) Class93_Sub2 arg0, @OriginalArg(1) Class93_Sub2 arg1, @OriginalArg(3) int arg2) {
		...
		if (this.aClass93_Sub2Array1 == null) {
			...
			super.aClass19_Sub3_22.method4842(this.aClass406_2);
			@Pc(112) int local112 = Static402.method3969(this.anInt5104);
			@Pc(117) int local117 = Static402.method3969(this.anInt5098);
			...
			super.aClass19_Sub3_22.method4868(this.aClass406_2);
			super.aClass19_Sub3_22.method4876(this.aClass93_Sub2Array1[local119 - 1]);
			super.aClass19_Sub3_22.method4842(this.aClass406_1);
			this.aClass406_1.method6760(0);
			OpenGL.glViewport(0, 0, 256, 256);
		...
		this.aClass406_1.method6760(1);
		super.aClass19_Sub3_22.method4876(this.aClass93_Sub2_2);
		...
		super.aClass19_Sub3_22.method4889(1);
		super.aClass19_Sub3_22.method4876(this.aClass93_Sub2_2);
		super.aClass19_Sub3_22.method4889(0);
		super.aClass19_Sub3_22.method4876(arg1);
	}

	@OriginalMember(owner = "client!kca", name = "a", descriptor = "(BI)V")
	@Override
	public void method3225(@OriginalArg(1) int arg0) {
		OpenGL.glUseProgramObjectARB(0L);
		super.aClass19_Sub3_22.method4889(1);
		super.aClass19_Sub3_22.method4876((Class93) null);
		super.aClass19_Sub3_22.method4889(0);
	}
	...
	@Override
	public void method3232(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		this.anInt5104 = arg0;
		this.anInt5098 = arg1;
		@Pc(23) int local23 = Static402.method3969(this.anInt5104);
		@Pc(28) int local28 = Static402.method3969(this.anInt5098);
		...
		if (this.aClass93_Sub2Array1 != null) {
			for (local49 = 0; local49 < this.aClass93_Sub2Array1.length; local49++) {
				this.aClass93_Sub2Array1[local49].method6821();
			}
			this.aClass93_Sub2Array1 = null;
		}
