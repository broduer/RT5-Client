...
public final class Class2_Sub32 extends Class2 {
	...
	public Class2_Sub32(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) Class178_Sub1 arg1, @OriginalArg(2) Class2_Sub7 arg2, @OriginalArg(3) int[] arg3) {
		...
		@Pc(23) int local23 = this.aClass2_Sub7_1.method5986() - (arg1.anInt8888 >> 1);
		this.anInt5022 = this.aClass2_Sub7_1.method5980() - local23 >> arg1.anInt8895;
		this.anInt5025 = local23 + this.aClass2_Sub7_1.method5980() >> arg1.anInt8895;
		this.anInt5024 = this.aClass2_Sub7_1.method5983() - local23 >> arg1.anInt8895;
		this.anInt5027 = local23 + this.aClass2_Sub7_1.method5983() >> arg1.anInt8895;
			...
			if (local123 > 0 && local123 < this.aClass178_Sub1_1.anInt8892 - 1) {
				for (local139 = 0; local139 <= local78; local139++) {
					...
					if (local146 > 0 && local146 < this.aClass178_Sub1_1.anInt8894 - 1) {
						local178 = arg1.a(local123, local146 + 1, (byte) -118) - arg1.a(local123, local146 - 1, (byte) -118);
						local195 = arg1.a(local123 + 1, local146, (byte) -118) - arg1.a(local123 - 1, local146, (byte) -118);
		...
		if (this.anInt5023 <= 0) {
			...
			this.aClass28_25 = new Class28(Static440.method4203(this.anInt5023));
			this.anInterface20_2 = this.aClass19_Sub1_11.method5731(false);
			this.anInterface20_2.method6087(this.anInt5023);
			@Pc(448) NativeHeapBuffer local448 = this.aClass19_Sub1_11.method5715(false, this.anInt5023 * 16);
			this.aStream3 = new Stream(local448);
			while (true) {
				@Pc(460) Buffer local460;
				do {
					local460 = this.anInterface20_2.method6091();
				} while (local460 == null);
							...
							if (local507 >= 0 && arg1.anInt8894 > local507) {
								...
								if (local537 != null && local530 != 0) {
									if (local530 == 1) {
										...
										label119: while (true) {
											while (true) {
												...
												if (local537[local728] == -1 || local537[local728 + 1] == -1 || local537[local728 + 2] == -1) {
													...
													this.method3186(local504, local321, local726[local728], local507, local719[local728], local195);
													local728++;
													this.method3186(local504, local321, local726[local728], local507, local719[local728], local195);
													local728++;
													this.method3186(local504, local321, local726[local728], local507, local719[local728], local195);
										...
										this.method3186(local504, local321, 0, local507, 0, local195);
										this.method3186(local504, local321, 0, local507, arg1.anInt8888, local195);
										this.method3186(local504, local321, arg1.anInt8888, local507, 0, local195);
									} else if (local530 == 2) {
										this.method3186(local504, local321, 0, local507, arg1.anInt8888, local195);
										this.method3186(local504, local321, arg1.anInt8888, local507, arg1.anInt8888, local195);
										this.method3186(local504, local321, 0, local507, 0, local195);
									} else if (local530 == 5) {
										this.method3186(local504, local321, arg1.anInt8888, local507, arg1.anInt8888, local195);
										this.method3186(local504, local321, arg1.anInt8888, local507, 0, local195);
				...
				this.aStream2.c();
				if (this.anInterface20_2.method6090()) {
					this.aStream3.c();
					this.anInterface16_7 = this.aClass19_Sub1_11.method5765(false);
					this.anInterface16_7.method2237(16, this.anInt5028 * 16, local448);
					break;
				}
				this.aStream3.f(0);
				this.aClass28_25.method372();
			}
		}
	...
	private void method3184(@OriginalArg(1) short arg0) {
		if (Stream.b()) {
	...
	private void method3186(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		@Pc(7) long local7 = -1L;
		@Pc(15) int local15 = (arg3 << this.aClass178_Sub1_1.anInt8895) + arg4;
		@Pc(23) int local23 = (arg1 << this.aClass178_Sub1_1.anInt8895) + arg2;
		@Pc(30) int local30 = this.aClass178_Sub1_1.a(local23, -115, (int) local15);
		if ((arg4 & 0x7F) == 0 || (arg2 & 0x7F) == 0) {
			local7 = (long) local15 & 0xFFFFL | 0xFFFFL << 16 & (long) local23 << 16;
			@Pc(63) Class2 local63 = this.aClass28_25.method373(local7);
			if (local63 != null) {
				this.method3184(((Class2_Sub50) local63).aShort119);
				return;
			}
		}
		@Pc(82) short local82 = (short) this.anInt5028++;
		if (local7 != -1L) {
			this.aClass28_25.method370(local7, new Class2_Sub50(local82));
		}
		...
		local214 = (float) (this.aClass2_Sub7_1.method5980() - local15);
		local222 = (float) (this.aClass2_Sub7_1.method5979() - local30);
		local229 = (float) (this.aClass2_Sub7_1.method5983() - local23);
		local236 = (float) Math.sqrt((double) (local222 * local222 + local214 * local214 + local229 * local229));
		local243 = 1.0F / local236;
		local214 *= local243;
		local222 *= local243;
		local229 *= local243;
		local252 = local236 / (float) this.aClass2_Sub7_1.method5986();
		...
		@Pc(583) int local583 = this.aClass2_Sub7_1.method5985();
		...
		this.aStream3.d(255);
		this.method3184(local82);
	}

	@OriginalMember(owner = "client!jw", name = "a", descriptor = "(IIBI[[Z)V")
	public void method3187(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean[][] arg4) {
		...
		for (@Pc(56) int local56 = this.anInt5024; local56 <= this.anInt5027; local56++) {
			for (@Pc(63) int local63 = this.anInt5022; local63 <= this.anInt5025; local63++) {
				...
				if (-arg3 < local70 && local70 < arg3 && -arg3 < local75 && local75 < arg3 && arg4[arg3 + local70][local75 + arg3]) {
					this.aClass19_Sub1_11.method5659((byte) (int) (this.aClass2_Sub7_1.method5982() * 255.0F));
					this.aClass19_Sub1_11.method5739(0, this.anInterface16_7);
					this.aClass19_Sub1_11.method5723(this.aClass19_Sub1_11.aClass244_21);
					this.aClass19_Sub1_11.method5661(0, 0, this.anInterface20_2, this.anInt5028, Static104.aClass131_2, this.anInt5023 / 3);
					return;
				}
			}
		}
		if (arg2 <= 43) {
			this.method3187(119, 109, (byte) 93, 25, (boolean[][]) null);
		}
	}
}
