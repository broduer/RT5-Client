...
public final class Class2_Sub33 extends Class2 {
	...
	public Class2_Sub33(@OriginalArg(0) Class19_Sub3 arg0, @OriginalArg(1) Class178_Sub2 arg1, @OriginalArg(2) Class2_Sub7 arg2, @OriginalArg(3) int[] arg3) {
		...
		@Pc(23) int local23 = this.aClass2_Sub7_2.method5986() - (arg1.anInt8888 >> 1);
		this.anInt5451 = this.aClass2_Sub7_2.method5980() - local23 >> arg1.anInt8895;
		this.anInt5446 = local23 + this.aClass2_Sub7_2.method5980() >> arg1.anInt8895;
		this.anInt5449 = this.aClass2_Sub7_2.method5983() - local23 >> arg1.anInt8895;
		this.anInt5454 = this.aClass2_Sub7_2.method5983() + local23 >> arg1.anInt8895;
			...
			if (local121 > 0 && local121 < this.aClass178_Sub2_2.anInt8892 - 1) {
				for (local141 = 0; local141 <= local76; local141++) {
					...
					if (local148 > 0 && this.aClass178_Sub2_2.anInt8894 - 1 > local148) {
						local178 = arg1.a(local121, local148 + 1, (byte) -118) - arg1.a(local121, local148 - 1, (byte) -118);
						local195 = arg1.a(local121 + 1, local148, (byte) -118) - arg1.a(local121 - 1, local148, (byte) -118);
		...
		if (this.anInt5447 <= 0) {
			...
			this.aClass28_26 = new Class28(Static440.method4203(this.anInt5447));
			local148 = 0;
			local121 = 0;
						...
						if (local345 >= 0 && arg1.anInt8894 > local345) {
							...
							if (local522 != null && local515 != 0) {
								if (local515 == 1) {
									...
									label104: while (true) {
										while (true) {
											...
											if (local522[local716] == -1 || local522[local716 + 1] == -1 || local522[local716 + 2] == -1) {
												...
												this.method3447(local714[local716], local707[local716], local178, local148, local345, local195);
												local716++;
												this.method3447(local714[local716], local707[local716], local178, local148, local345, local195);
												local716++;
												this.method3447(local714[local716], local707[local716], local178, local148, local345, local195);
									...
									this.method3447(0, 0, local178, local148, local345, local195);
									this.method3447(0, arg1.anInt8888, local178, local148, local345, local195);
									this.method3447(arg1.anInt8888, 0, local178, local148, local345, local195);
								} else if (local515 == 2) {
									this.method3447(0, arg1.anInt8888, local178, local148, local345, local195);
									this.method3447(arg1.anInt8888, arg1.anInt8888, local178, local148, local345, local195);
									this.method3447(0, 0, local178, local148, local345, local195);
								} else if (local515 == 5) {
									this.method3447(arg1.anInt8888, arg1.anInt8888, local178, local148, local345, local195);
									this.method3447(arg1.anInt8888, 0, local178, local148, local345, local195);
			...
			this.anInterface1_2 = this.aClass19_Sub3_23.method4885(false, this.aClass2_Sub21_8.anInt8388, this.aClass2_Sub21_8.aByteArray93);
			this.anInterface12_3 = this.aClass19_Sub3_23.method4899(false, this.aClass2_Sub21_Sub1_2.anInt8388, this.aClass2_Sub21_Sub1_2.aByteArray93, 16);
	...
	private void method3447(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		@Pc(7) long local7 = -1L;
		@Pc(15) int local15 = (arg4 << this.aClass178_Sub2_2.anInt8895) + arg1;
		@Pc(23) int local23 = arg0 + (arg2 << this.aClass178_Sub2_2.anInt8895);
		@Pc(30) int local30 = this.aClass178_Sub2_2.a(local23, -127, (int) local15);
		if ((arg1 & 0x7F) == 0 || (arg0 & 0x7F) == 0) {
			local7 = ((long) local23 & 0xFFFFL) << 16 | (long) local15 & 0xFFFFL;
			@Pc(64) Class2 local64 = this.aClass28_26.method373(local7);
			if (local64 != null) {
				this.method3449(((Class2_Sub50) local64).aShort119);
				return;
			}
		}
		@Pc(83) short local83 = (short) this.anInt5452++;
		if (local7 != -1L) {
			this.aClass28_26.method370(local7, new Class2_Sub50(local83));
		}
		...
		local275 = (float) (this.aClass2_Sub7_2.method5980() - local15);
		local283 = (float) (this.aClass2_Sub7_2.method5979() - local30);
		local290 = (float) (this.aClass2_Sub7_2.method5983() - local23);
		local297 = (float) Math.sqrt((double) (local290 * local290 + local275 * local275 + local283 * local283));
		local304 = 1.0F / local297;
		local283 *= local304;
		local290 *= local304;
		local275 *= local304;
		local313 = local297 / (float) this.aClass2_Sub7_2.method5986();
		...
		@Pc(576) int local576 = this.aClass2_Sub7_2.method5985();
		...
		if (this.aClass19_Sub3_23.aBoolean618) {
			this.aClass2_Sub21_Sub1_2.method3001((float) local15);
			this.aClass2_Sub21_Sub1_2.method3001((float) local30);
			this.aClass2_Sub21_Sub1_2.method3001((float) local23);
		} else {
			this.aClass2_Sub21_Sub1_2.method3002((float) local15);
			this.aClass2_Sub21_Sub1_2.method3002((float) local30);
			this.aClass2_Sub21_Sub1_2.method3002((float) local23);
		}
		if (local614 > 255) {
			local614 = 255;
		}
		this.aClass2_Sub21_Sub1_2.method5198(local586);
		this.aClass2_Sub21_Sub1_2.method5198(local601);
		this.aClass2_Sub21_Sub1_2.method5198(local614);
		this.aClass2_Sub21_Sub1_2.method5198(255);
		this.method3449(local83);
	}

	@OriginalMember(owner = "client!kia", name = "a", descriptor = "(I[[ZBII)V")
	public void method3448(@OriginalArg(0) int arg0, @OriginalArg(1) boolean[][] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		...
		for (@Pc(66) int local66 = this.anInt5449; local66 <= this.anInt5454; local66++) {
			for (@Pc(71) int local71 = this.anInt5451; local71 <= this.anInt5446; local71++) {
				...
				if (local77 > -arg2 && arg2 > local77 && -arg2 < local81 && local81 < arg2 && arg1[local77 + arg2][local81 + arg2]) {
					this.aClass19_Sub3_23.method4860((int) (this.aClass2_Sub7_2.method5982() * 255.0F) << 24);
					this.aClass19_Sub3_23.method4914(this.aClass94_5, (Class94) null, this.aClass94_4, (Class94) null);
					this.aClass19_Sub3_23.method4909(0, this.anInterface1_2, this.anInt5447);
					return;
				}
			}
		}
	...
	private void method3449(@OriginalArg(1) short arg0) {
		if (this.aClass19_Sub3_23.aBoolean618) {
			this.aClass2_Sub21_8.method5182(arg0);
		} else {
			this.aClass2_Sub21_8.method5163(arg0);
		}
	}
}
