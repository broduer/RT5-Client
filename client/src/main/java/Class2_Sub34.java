...
public final class Class2_Sub34 extends Node {
	...
	public Class2_Sub34(@OriginalArg(0) Packet arg0, @OriginalArg(1) Class379 arg1, @OriginalArg(2) int arg2) {
	...
	private void method5109(@OriginalArg(0) Packet arg0) {
		if (arg0 == null || arg0.data == null) {
			...
			if (local24 < 23) {
				...
				this.aClass57_Sub25_5 = new Class57_Sub25(arg0.g1(), this);
	...
	public Packet method5117() {
		@Pc(9) Packet local9 = new Packet(Static368.method5276());
		local9.p1(25);
		local9.p1(this.aClass57_Sub13_2.method4380());
		local9.p1(this.aClass57_Sub20_1.method6115());
		local9.p1(this.aClass57_Sub22_1.method6776());
		local9.p1(this.aClass57_Sub5_1.method2172());
		local9.p1(this.aClass57_Sub8_1.method3176());
		local9.p1(this.aClass57_Sub16_1.method5514());
		local9.p1(this.aClass57_Sub23_1.method7061());
		local9.p1(this.aClass57_Sub6_1.method2714());
		local9.p1(this.aClass57_Sub27_1.method7674());
		local9.p1(this.aClass57_Sub24_1.method7089());
		local9.p1(this.aClass57_Sub12_1.method4371());
		local9.p1(this.aClass57_Sub3_1.method2120());
		local9.p1(this.aClass57_Sub28_1.method7845());
		local9.p1(this.aClass57_Sub4_1.method2143());
		local9.p1(this.aClass57_Sub18_1.method5774());
		...
		local9.p1(this.aClass57_Sub30_1.method8363());
		local9.p1(this.aClass57_Sub29_2.method7922());
		local9.p1(this.aClass57_Sub19_1.method5967());
		local9.p1(this.aClass57_Sub26_1.method7470());
		local9.p1(this.aClass57_Sub1_1.method1485());
		local9.p1(this.aClass57_Sub14_1.method5309());
		local9.p1(this.aClass57_Sub15_1.method5327());
		local9.p1(this.aClass57_Sub21_1.method6367());
		local9.p1(this.aClass57_Sub11_1.method3603());
		local9.p1(this.aClass57_Sub10_1.method3519());
		local9.p1(this.aClass57_Sub25_4.method7215());
		local9.p1(this.aClass57_Sub25_1.method7215());
		local9.p1(this.aClass57_Sub25_3.method7215());
		local9.p1(this.aClass57_Sub25_2.method7215());
		local9.p1(this.aClass57_Sub25_5.method7215());
		local9.p1(this.aClass57_Sub17_1.method5674());
		return local9;
	}
	...
	private void method5119(@OriginalArg(1) int arg0, @OriginalArg(2) Packet arg1) {
