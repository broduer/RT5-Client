...
public final class Class2_Sub39 extends Class2 {
	...
	public void method4157(@OriginalArg(1) int[] arg0, @OriginalArg(2) int arg1) {
		@Pc(7) int local7 = 0;
				...
				if (local37 != 0 && local32 != null) {
					...
					while (local32.length > local50) {
						if ((local37 & 0x1 << local48++) == 0) {
							...
							local11.method5182(local32[local50++] & 0xFFFF);
							local7++;
							local7++;
							local11.method5182(local32[local50++] & 0xFFFF);
							local11.method5182(local32[local50++] & 0xFFFF);
				...
				if (local37 != 0 && local32 != null) {
					...
					while (local32.length > local50) {
						if ((local37 & 0x1 << local48++) == 0) {
							...
							local7++;
							local11.method5163(local32[local50++] & 0xFFFF);
							local7++;
							local11.method5163(local32[local50++] & 0xFFFF);
							local11.method5163(local32[local50++] & 0xFFFF);
							local7++;
		...
		this.aClass134_Sub2_1.method6744(local11.anInt8388, local11.aByteArray93);
		...
		this.aClass19_Sub3_31.method4890(this.anInt6592, (this.aClass178_Sub2_3.anInt7486 & 0x7) != 0, (this.aClass178_Sub2_3.anInt7486 & 0x8) != 0);
	...
	public void method4159(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2, @OriginalArg(3) int arg3) {
		@Pc(24) int local24;
		@Pc(49) int local49;
		if (this.anInt6592 != -1) {
			@Pc(19) Class118 local19 = this.aClass19_Sub3_31.anInterface4_10.method4805(this.anInt6592);
	...
	public void method4160(@OriginalArg(1) int arg0) {
		this.aStream5.c();
		@Pc(23) Interface12 local23 = this.aClass19_Sub3_31.method4891(4, this.aNativeHeapBuffer5, arg0 * 4);
	...
	public void method4163(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2) {
