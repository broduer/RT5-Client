...
public final class Class2_Sub47 extends Node {
	...
	private void method7281(@OriginalArg(1) Packet arg0) {
		...
		this.aString101 = arg0.gstr();
		arg0.g1();
		this.aByte127 = arg0.g1b();
		this.aByte128 = arg0.g1b();
		this.anInt8309 = arg0.g2();
		if (this.anInt8309 <= 0) {
			return;
		}
		...
		for (@Pc(82) int local82 = 0; local82 < this.anInt8309; local82++) {
			...
			if (this.aBoolean634) {
				local88.aString2 = arg0.gstr();
			}
			local88.aByte9 = arg0.g1b();
			local88.anInt786 = arg0.g2();
