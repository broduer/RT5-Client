...
public final class Class2_Sub47 extends Class2 {
	...
	private void method5098(@OriginalArg(1) Class2_Sub21 arg0) {
		...
		super.aLong328 = arg0.method5207();
		this.aLong256 = arg0.method5207();
		this.aString101 = arg0.method5167();
		arg0.method5205();
		this.aByte127 = arg0.method5186();
		this.aByte128 = arg0.method5186();
		this.anInt8286 = arg0.method5191();
		if (this.anInt8286 <= 0) {
			return;
		}
		...
		for (@Pc(82) int local82 = 0; local82 < this.anInt8286; local82++) {
			...
			if (this.aBoolean633) {
				local88.aString2 = arg0.method5167();
			}
			local88.aByte9 = arg0.method5186();
			local88.anInt783 = arg0.method5191();
			this.aClass34Array1[local82] = local88;
		}
	}

	@OriginalMember(owner = "client!rfa", name = "a", descriptor = "(BI)V")
	private void method5099(@OriginalArg(1) int arg0) {
		if (this.aClass34Array1 == null) {
			this.aClass34Array1 = new Class34[arg0];
		} else {
			Static734.method5445(this.aClass34Array1, 0, this.aClass34Array1 = new Class34[arg0], 0, this.anInt8286);
		}
	}
	...
	public void method5101(@OriginalArg(0) int arg0) {
		...
		if (this.anInt8286 == 0) {
			...
			Static734.method5445(this.aClass34Array1, arg0 + 1, this.aClass34Array1, arg0, this.anInt8286 - arg0);
		}
		this.anIntArray644 = null;
	}

	@OriginalMember(owner = "client!rfa", name = "a", descriptor = "(Ljava/lang/String;B)I")
	public int method5102(@OriginalArg(0) String arg0) {
