...
public final class Class2_Sub49_Sub1 extends Class2_Sub49 {
	...
	public Class2_Sub49_Sub1 method5550(@OriginalArg(0) Class224 arg0) {
		this.aByteArray98 = arg0.method3692(this.aByteArray98);
		this.anInt8818 = arg0.method3691(this.anInt8818);
		if (this.anInt8819 == this.anInt8820) {
			this.anInt8819 = this.anInt8820 = arg0.method3688(this.anInt8819);
		} else {
			this.anInt8819 = arg0.method3688(this.anInt8819);
			this.anInt8820 = arg0.method3688(this.anInt8820);
			if (this.anInt8819 == this.anInt8820) {
				this.anInt8819--;
			}
		}
