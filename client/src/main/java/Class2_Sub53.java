...
public final class Class2_Sub53 extends Class2 {
	...
	public Class2_Sub53(@OriginalArg(0) byte[] arg0) {
		this.method6048(arg0);
	}

	@OriginalMember(owner = "client!uj", name = "a", descriptor = "([B)V")
	private void method6048(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class2_Sub21 local4 = new Class2_Sub21(arg0);
		this.anInt9680 = local4.method5158();
		this.anInt9684 = local4.method5158();
		this.anInt9685 = local4.method5158();
		this.anInt9679 = local4.method5158();
		if (this.anInt9679 < 0) {
			this.anInt9679 = ~this.anInt9679;
			this.aBoolean745 = true;
		}
		@Pc(40) int local40 = local4.method5158();
		this.aByteArrayArray33 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method5205();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method5153(0, local49, local64);
			this.aByteArrayArray33[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!uj", name = "a", descriptor = "([I)Lclient!sq;")
	public Class2_Sub49_Sub1 method6051(@OriginalArg(0) int[] arg0) {
		...
		while (this.anInt9688 < this.aByteArrayArray33.length) {
			...
			@Pc(42) float[] local42 = this.method6052(this.anInt9688);
			if (local42 != null) {
	...
	private float[] method6052(@OriginalArg(0) int arg0) {
		Static650.method6057(this.aByteArrayArray33[arg0]);
		Static650.method6058();
		@Pc(15) int local15 = Static650.method6049(Static434.method4154(Static650.anIntArray756.length - 1));
		...
		if (local19) {
			local27 = Static650.method6058() != 0;
			local29 = Static650.method6058() != 0;
		}
		...
		@Pc(140) boolean local140 = !Static650.aClass44Array1[local131].method624();
		...
		for (@Pc(144) int local144 = 0; local144 < local123.anInt9477; local144++) {
			...
			local152.method3589(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			...
			Static650.aClass44Array1[local176].method621(Static650.aFloatArray73, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			...
			@Pc(486) int local486 = Static434.method4154(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
