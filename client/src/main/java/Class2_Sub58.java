...
public final class Class2_Sub58 extends Class2 {
	...
	public void method6779(@OriginalArg(0) int arg0) {
	...
	public void method6783(@OriginalArg(1) int arg0) {
		this.aNativeHeapBuffer8 = this.aClass19_Sub1_23.method5715(true, arg0 * 4);
		this.aStream7 = new Stream(this.aNativeHeapBuffer8, 0, arg0 * 4);
	}

	@OriginalMember(owner = "client!wr", name = "a", descriptor = "(B[II)V")
	public void method6784(@OriginalArg(1) int[] arg0, @OriginalArg(2) int arg1) {
		@Pc(14) Interface20 local14 = this.aClass19_Sub1_23.method5683(this.anInt10871 * 3);
		@Pc(19) Buffer local19 = local14.method6091();
		if (local19 == null) {
			return;
		}
		@Pc(29) Stream local29 = this.aClass19_Sub1_23.method5709(local19);
		@Pc(31) int local31 = 0;
		...
		local29.c();
		if (!local14.method6090() || local31 <= 0) {
			return;
		}
		this.aClass19_Sub1_23.method5717((this.aClass178_Sub1_3.anInt4302 & 0x7) != 0, this.anInt10870, (this.aClass178_Sub1_3.anInt4302 & 0x8) != 0);
		...
		@Pc(315) Class73_Sub1 local315 = this.aClass19_Sub1_23.method5691();
		local315.method1200(1.0F, 1.0F / this.aFloat219, 1.0F / this.aFloat219);
		this.aClass19_Sub1_23.method5682(Static431.aClass370_5);
		this.aClass19_Sub1_23.method5739(1, this.anInterface16_18);
		this.aClass19_Sub1_23.method5723(this.aClass178_Sub1_3.aClass244_8);
		this.aClass19_Sub1_23.method5661(local33, 0, local14, local35 + 1 - local33, Static104.aClass131_2, local31);
		this.aClass19_Sub1_23.method5640();
	}

	@OriginalMember(owner = "client!wr", name = "a", descriptor = "(IIII)V")
	public void method6785(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
	...
	public void method6787(@OriginalArg(1) int arg0) {
		this.aStream7.c();
		this.anInterface16_18 = this.aClass19_Sub1_23.method5765(false);
		this.anInterface16_18.method2237(4, arg0 * 4, this.aNativeHeapBuffer8);
		this.aNativeHeapBuffer8 = null;
		this.aStream7 = null;
	}

	@OriginalMember(owner = "client!wr", name = "a", descriptor = "(IIFII)V")
	public void method6788(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2, @OriginalArg(4) int arg3) {
		@Pc(31) int local31;
		@Pc(57) int local57;
		if (this.anInt10870 != -1) {
			@Pc(26) Class118 local26 = this.aClass19_Sub1_23.anInterface4_10.method4805(this.anInt10870);
