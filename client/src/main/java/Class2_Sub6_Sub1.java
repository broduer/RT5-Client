...
public final class Class2_Sub6_Sub1 extends Class2_Sub6 {
	...
	private void method452(@OriginalArg(1) long arg0) {
		while (this.aLong28 <= arg0) {
			...
			while (local17 == this.anInt841) {
				while (this.aClass40_1.anIntArray70[local14] == local17) {
					this.aClass40_1.method598(local14);
					@Pc(33) int local33 = this.aClass40_1.method592(local14);
					if (local33 == 1) {
						this.aClass40_1.method599();
						this.aClass40_1.method593(local14);
						if (this.aClass40_1.method603()) {
							if (!this.aBoolean65 || local17 == 0) {
								this.method484(true);
								this.aClass40_1.method594();
								return;
							}
							this.aClass40_1.method601(local20);
						}
						break;
					}
					if ((local33 & 0x80) != 0 && (local33 & 0xF0) != 144) {
						this.method466(local33);
					}
					this.aClass40_1.method604(local14);
					this.aClass40_1.method593(local14);
				}
				this.aLong29 = local20;
				local14 = this.aClass40_1.method597();
				local17 = this.aClass40_1.anIntArray70[local14];
				local20 = this.aClass40_1.method591(local17);
			}
	...
	private synchronized void method453(@OriginalArg(1) boolean arg0) {
		this.aClass40_1.method594();
	...
	public synchronized void method6560(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (this.aClass40_1.method590()) {
			...
			do {
				...
				this.aClass2_Sub6_Sub4_1.method6560(arg0, arg1, local55);
				arg1 += local55;
				this.method474((byte) -89);
				arg2 -= local55;
			} while (this.aClass40_1.method590());
		}
		this.aClass2_Sub6_Sub4_1.method6560(arg0, arg1, arg2);
	}

	@OriginalMember(owner = "client!bd", name = "c", descriptor = "()Lclient!dea;")
	@Override
	public synchronized Class2_Sub6 method6562() {
		return this.aClass2_Sub6_Sub4_1;
	}

	@OriginalMember(owner = "client!bd", name = "a", descriptor = "(Z)V")
	public synchronized void method454() {
		this.method453(true);
	}

	@OriginalMember(owner = "client!bd", name = "a", descriptor = "(ZZLclient!bn;I)V")
	private synchronized void method455(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) Class2_Sub8 arg2) {
		this.method453(arg1);
		this.aClass40_1.method596(arg2.aByteArray12);
		this.aLong29 = 0L;
		this.aBoolean65 = arg0;
		@Pc(24) int local24 = this.aClass40_1.method605();
		for (@Pc(26) int local26 = 0; local26 < local24; local26++) {
			this.aClass40_1.method598(local26);
			this.aClass40_1.method604(local26);
			this.aClass40_1.method593(local26);
		}
		if (18429 != 18429) {
			this.method459(68, 61);
		}
		this.anInt840 = this.aClass40_1.method597();
		this.anInt841 = this.aClass40_1.anIntArray70[this.anInt840];
		this.aLong28 = this.aClass40_1.method591(this.anInt841);
	}

	@OriginalMember(owner = "client!bd", name = "a", descriptor = "(ILclient!dha;)I")
	private int method456(@OriginalArg(1) Class2_Sub16 arg0) {
	...
	private void method457(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		...
		for (@Pc(47) Class2_Sub16 local47 = (Class2_Sub16) this.aClass2_Sub6_Sub4_1.aClass339_72.method5453(65280); local47 != null; local47 = (Class2_Sub16) this.aClass2_Sub6_Sub4_1.aClass339_72.method5460()) {
	...
	public synchronized void method458(@OriginalArg(1) int arg0) {
		this.anInt812 = arg0;
	}

	@OriginalMember(owner = "client!bd", name = "c", descriptor = "(II)V")
	private void method459(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if ((this.anIntArray56[arg1] & 0x4) != 0) {
			for (@Pc(22) Class2_Sub16 local22 = (Class2_Sub16) this.aClass2_Sub6_Sub4_1.aClass339_72.method5453(arg0 + 65280); local22 != null; local22 = (Class2_Sub16) this.aClass2_Sub6_Sub4_1.aClass339_72.method5460()) {
	...
	@Override
	public synchronized int method6561() {
		return 0;
	}

	@OriginalMember(owner = "client!bd", name = "b", descriptor = "(Lclient!dha;B)Z")
	public boolean method463(@OriginalArg(0) Class2_Sub16 arg0) {
	...
	@Override
	public synchronized Class2_Sub6 method6564() {
		return null;
	}

	@OriginalMember(owner = "client!bd", name = "d", descriptor = "(B)Z")
	public synchronized boolean method464() {
		return this.aClass40_1.method590();
	}

	@OriginalMember(owner = "client!bd", name = "b", descriptor = "(ILclient!dha;)I")
	private int method465(@OriginalArg(1) Class2_Sub16 arg0) {
	...
	private void method466(@OriginalArg(0) int arg0) {
		...
		if (local9 == 128) {
			...
			this.method457(local28, local16, local22);
		} else if (local9 == 144) {
			local16 = arg0 & 0xF;
			local22 = arg0 >> 8 & 0x7F;
			local28 = arg0 >> 16 & 0x7F;
			if (local28 <= 0) {
				this.method457(64, local16, local22);
			} else {
				this.method478(local16, local22, local28);
			}
		} else if (local9 == 160) {
			local16 = arg0 & 0xF;
			local22 = arg0 >> 8 & 0x7F;
			local28 = arg0 >> 16 & 0x7F;
			this.method481(local28, local16, local22);
		} else if (local9 == 176) {
			local16 = arg0 & 0xF;
			local22 = arg0 >> 8 & 0x7F;
			local28 = arg0 >> 16 & 0x7F;
			...
			if (local22 == 120) {
				this.method472(local16);
			}
			if (local22 == 121) {
				this.method461(local16);
			}
			if (local22 == 123) {
				this.method480(local16);
			}
			@Pc(557) int local557;
			if (local22 == 6) {
			...
			if (local22 == 81) {
				if (local28 >= 64) {
					...
					this.method459(0, local16);
					this.anIntArray56[local16] &= 0xFFFFFFFB;
				}
			}
			if (local22 == 17) {
				this.method470((this.anIntArray43[local16] & 0xFFFFC07F) + (local28 << 7), local16);
			}
			if (local22 == 49) {
				this.method470(local28 + (this.anIntArray43[local16] & 0xFFFFFF80), local16);
			}
		} else if (local9 == 192) {
			local16 = arg0 & 0xF;
			local22 = arg0 >> 8 & 0x7F;
			this.method489(local16, local22 + this.anIntArray50[local16]);
		} else if (local9 == 208) {
			local16 = arg0 & 0xF;
			local22 = arg0 >> 8 & 0x7F;
			this.method488(local16, local22);
		} else if (local9 == 224) {
			local16 = arg0 & 0xF;
			local22 = (arg0 >> 8 & 0x7F) + ((arg0 & 0x7F0197) >> 9);
			this.method479(local22, -5807, local16);
		} else {
			local9 = arg0 & 0xFF;
			if (local9 == 255) {
				this.method484(true);
	...
	public synchronized void method467(@OriginalArg(0) Class2_Sub8 arg0, @OriginalArg(1) boolean arg1, @OriginalArg(3) long arg2) {
		this.method455(arg1, true, arg0);
		this.method452(arg2 * (long) this.aClass40_1.anInt988);
	}

	@OriginalMember(owner = "client!bd", name = "b", descriptor = "(IZI)V")
	public synchronized void method468(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		if (arg1 < 0) {
	...
	public synchronized void method469() {
		for (@Pc(5) Class2_Sub11 local5 = (Class2_Sub11) this.aClass28_7.method371(); local5 != null; local5 = (Class2_Sub11) this.aClass28_7.method375()) {
			local5.a((byte) 112);
		}
	}

	@OriginalMember(owner = "client!bd", name = "b", descriptor = "(IIB)V")
	private void method470(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public synchronized void method471() {
		this.method482();
	}

	@OriginalMember(owner = "client!bd", name = "a", descriptor = "(II)V")
	private void method472(@OriginalArg(1) int arg0) {
		for (@Pc(14) Class2_Sub16 local14 = (Class2_Sub16) this.aClass2_Sub6_Sub4_1.aClass339_72.method5453(65280); local14 != null; local14 = (Class2_Sub16) this.aClass2_Sub6_Sub4_1.aClass339_72.method5460()) {
			if (arg0 < 0 || local14.anInt2187 == arg0) {
				if (local14.aClass2_Sub6_Sub2_1 != null) {
					local14.aClass2_Sub6_Sub2_1.method2358(Static686.anInt8944 / 100);
					if (local14.aClass2_Sub6_Sub2_1.method2374()) {
						this.aClass2_Sub6_Sub4_1.aClass2_Sub6_Sub3_2.method4173(local14.aClass2_Sub6_Sub2_1);
					}
					local14.method1329();
				}
	...
	private void method474(@OriginalArg(0) byte arg0) {
		...
		if (this.aClass2_Sub8_1 != null && this.anInt842 == local11) {
			this.method455(this.aBoolean65, this.aBoolean66, this.aClass2_Sub8_1);
			this.method474((byte) -98);
			return;
		}
		while (this.anInt841 == local11) {
			while (this.aClass40_1.anIntArray70[local8] == local11) {
				this.aClass40_1.method598(local8);
				@Pc(50) int local50 = this.aClass40_1.method592(local8);
				if (local50 == 1) {
					this.aClass40_1.method599();
					this.aClass40_1.method593(local8);
					if (this.aClass40_1.method603()) {
						if (this.aClass2_Sub8_1 != null) {
							this.method476(this.aClass2_Sub8_1, this.aBoolean65);
							this.method474((byte) -119);
							return;
						}
						...
						this.aClass40_1.method601(local14);
					}
					break;
				}
				if ((local50 & 0x80) != 0) {
					this.method466(local50);
				}
				this.aClass40_1.method604(local8);
				this.aClass40_1.method593(local8);
			}
			local8 = this.aClass40_1.method597();
			local11 = this.aClass40_1.anIntArray70[local8];
			local14 = this.aClass40_1.method591(local11);
		}
		if (arg0 >= -19) {
			this.anInt841 = -58;
		}
	...
	public synchronized void method475() {
		for (@Pc(7) Class2_Sub11 local7 = (Class2_Sub11) this.aClass28_7.method371(); local7 != null; local7 = (Class2_Sub11) this.aClass28_7.method375()) {
			local7.method960();
		}
	}

	@OriginalMember(owner = "client!bd", name = "a", descriptor = "(ILclient!bn;Z)V")
	public synchronized void method476(@OriginalArg(1) Class2_Sub8 arg0, @OriginalArg(2) boolean arg1) {
		this.method455(arg1, true, arg0);
	}

	@OriginalMember(owner = "client!bd", name = "a", descriptor = "(IIIZ)V")
	private void method478(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.method457(64, arg0, arg1);
		if ((this.anIntArray56[arg0] & 0x2) != 0) {
			for (@Pc(25) Class2_Sub16 local25 = (Class2_Sub16) this.aClass2_Sub6_Sub4_1.aClass339_72.method5462(); local25 != null; local25 = (Class2_Sub16) this.aClass2_Sub6_Sub4_1.aClass339_72.method5463()) {
		...
		@Pc(117) Class2_Sub11 local117 = (Class2_Sub11) this.aClass28_7.method373((long) this.anIntArray54[arg0]);
		if (local117 == null) {
			return;
		}
		...
		if (this.anIntArray49[arg0] == 0) {
			local142.aClass2_Sub6_Sub2_1 = Static730.method2384(local126, this.method456(local142), this.method462(local142), this.method465(local142));
		} else {
			local142.aClass2_Sub6_Sub2_1 = Static730.method2384(local126, this.method456(local142), 0, this.method465(local142));
			this.method485(local117.aShortArray16[arg1] < 0, local142);
		}
		if (local117.aShortArray16[arg1] < 0) {
			local142.aClass2_Sub6_Sub2_1.method2356(-1);
		}
		...
		this.aClass2_Sub6_Sub4_1.aClass339_72.method5465(local142);
		this.aClass2_Sub16ArrayArray1[arg0][arg1] = local142;
	}

	@OriginalMember(owner = "client!bd", name = "b", descriptor = "(III)V")
	private void method479(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg1 != -5807) {
			this.anInt840 = -101;
		}
	...
	private void method480(@OriginalArg(1) int arg0) {
		for (@Pc(6) Class2_Sub16 local6 = (Class2_Sub16) this.aClass2_Sub6_Sub4_1.aClass339_72.method5453(65280); local6 != null; local6 = (Class2_Sub16) this.aClass2_Sub6_Sub4_1.aClass339_72.method5460()) {
	...
	private void method481(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	}
	...
	private void method482() {
		...
		this.method489(9, 128);
	}

	@OriginalMember(owner = "client!bd", name = "a", descriptor = "(BI)V")
	private void method483(@OriginalArg(1) int arg0) {
		if ((this.anIntArray56[arg0] & 0x2) == 0) {
			return;
		}
		for (@Pc(28) Class2_Sub16 local28 = (Class2_Sub16) this.aClass2_Sub6_Sub4_1.aClass339_72.method5453(65280); local28 != null; local28 = (Class2_Sub16) this.aClass2_Sub6_Sub4_1.aClass339_72.method5460()) {
	...
	private void method484(@OriginalArg(1) boolean arg0) {
		if (arg0) {
			this.method472(-1);
		} else {
			this.method480(-1);
	...
	public void method485(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class2_Sub16 arg1) {
		...
		if (arg0 && arg1.aClass2_Sub49_Sub1_1.aBoolean668) {
			...
			if (local13 <= local42) {
				...
				arg1.aClass2_Sub6_Sub2_1.method2361();
			}
		} else {
			local42 = (int) ((long) this.anIntArray49[arg1.anInt2187] * (long) local13 >> 6);
		}
		arg1.aClass2_Sub6_Sub2_1.method2382(local42);
	}

	@OriginalMember(owner = "client!bd", name = "a", descriptor = "(Lclient!fca;Lclient!sb;IILclient!bn;)Z")
	public synchronized boolean method486(@OriginalArg(0) Class123 arg0, @OriginalArg(1) Class330 arg1, @OriginalArg(4) Class2_Sub8 arg2) {
		arg2.method674();
		@Pc(15) boolean local15 = true;
		@Pc(29) int[] local29 = new int[] { 22050 };
		for (@Pc(35) Class2_Sub55 local35 = (Class2_Sub55) arg2.aClass28_8.method371(); local35 != null; local35 = (Class2_Sub55) arg2.aClass28_8.method375()) {
			@Pc(40) int local40 = (int) local35.aLong328;
			@Pc(48) Class2_Sub11 local48 = (Class2_Sub11) this.aClass28_7.method373((long) local40);
			if (local48 == null) {
				local48 = Static680.method6368(arg1, local40);
				if (local48 == null) {
					local15 = false;
					continue;
				}
				this.aClass28_7.method370((long) local40, local48);
			}
			if (!local48.method965(arg0, local29, local35.aByteArray105)) {
				local15 = false;
			}
		}
		if (local15) {
	...
	public synchronized void method6559(@OriginalArg(0) int arg0) {
		if (this.aClass40_1.method590()) {
			...
			do {
				...
				this.aClass2_Sub6_Sub4_1.method6559(local58);
				arg0 -= local58;
				this.method474((byte) -117);
			} while (this.aClass40_1.method590());
		}
		this.aClass2_Sub6_Sub4_1.method6559(arg0);
	}

	@OriginalMember(owner = "client!bd", name = "a", descriptor = "(Lclient!dha;I[III)Z")
	public boolean method487(@OriginalArg(0) Class2_Sub16 arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		arg0.anInt2184 = Static686.anInt8944 / 100;
		if (arg0.anInt2202 >= 0 && (arg0.aClass2_Sub6_Sub2_1 == null || arg0.aClass2_Sub6_Sub2_1.method2349())) {
			arg0.method1329();
			arg0.a((byte) 63);
			if (arg0.anInt2198 > 0 && this.aClass2_Sub16ArrayArray2[arg0.anInt2187][arg0.anInt2198] == arg0) {
				this.aClass2_Sub16ArrayArray2[arg0.anInt2187][arg0.anInt2198] = null;
		...
		arg0.aClass2_Sub6_Sub2_1.method2357(this.method456(arg0));
		...
		if (!local122) {
			arg0.aClass2_Sub6_Sub2_1.method2376(arg0.anInt2184, this.method462(arg0), this.method465(arg0));
			return false;
		}
		arg0.aClass2_Sub6_Sub2_1.method2358(arg0.anInt2184);
		if (arg1 == null) {
			arg0.aClass2_Sub6_Sub2_1.method6559(arg3);
		} else {
			arg0.aClass2_Sub6_Sub2_1.method6560(arg1, arg2, arg3);
		}
		if (arg0.aClass2_Sub6_Sub2_1.method2374()) {
			this.aClass2_Sub6_Sub4_1.aClass2_Sub6_Sub3_2.method4173(arg0.aClass2_Sub6_Sub2_1);
		}
		arg0.method1329();
		if (arg0.anInt2202 >= 0) {
			arg0.a((byte) 117);
	...
	private void method488(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	}

	@OriginalMember(owner = "client!bd", name = "c", descriptor = "(IIB)V")
	private void method489(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
