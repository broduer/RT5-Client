...
public final class Class2_Sub6_Sub1 extends Class2_Sub6 {
	...
	public synchronized void method9138(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (this.aClass40_1.method1055()) {
			@Pc(14) int local14 = this.aClass40_1.anInt992 * this.anInt819 / Static686.anInt8968;
			do {
				...
				this.aClass2_Sub6_Sub4_1.method9138(arg0, arg1, local55);
				arg1 += local55;
				this.method932();
				arg2 -= local55;
			} while (this.aClass40_1.method1055());
		}
		this.aClass2_Sub6_Sub4_1.method9138(arg0, arg1, arg2);
	}

	@OriginalMember(owner = "client!bd", name = "c", descriptor = "()Lclient!dea;")
	@Override
	public synchronized Class2_Sub6 method9140() {
	...
	private int method914(@OriginalArg(1) Class2_Sub16 arg0) {
		...
		local65 = (int) ((double) (arg0.aClass2_Sub49_Sub1_1.anInt8842 * 256) * Math.pow(2.0D, (double) local14 * 3.255208333333333E-4D) / (double) Static686.anInt8968 + 0.5D);
	...
	private void method915(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		...
		for (@Pc(47) Class2_Sub16 local47 = (Class2_Sub16) this.aClass2_Sub6_Sub4_1.aClass341_72.method7706(65280); local47 != null; local47 = (Class2_Sub16) this.aClass2_Sub6_Sub4_1.aClass341_72.method7713()) {
	...
	private void method917(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if ((this.anIntArray56[arg1] & 0x4) != 0) {
			for (@Pc(22) Class2_Sub16 local22 = (Class2_Sub16) this.aClass2_Sub6_Sub4_1.aClass341_72.method7706(arg0 + 65280); local22 != null; local22 = (Class2_Sub16) this.aClass2_Sub6_Sub4_1.aClass341_72.method7713()) {
	...
	@Override
	public synchronized Class2_Sub6 method9142() {
		return null;
	}
	...
	private void method930(@OriginalArg(1) int arg0) {
		for (@Pc(14) Class2_Sub16 local14 = (Class2_Sub16) this.aClass2_Sub6_Sub4_1.aClass341_72.method7706(65280); local14 != null; local14 = (Class2_Sub16) this.aClass2_Sub6_Sub4_1.aClass341_72.method7713()) {
			if (arg0 < 0 || local14.anInt2196 == arg0) {
				if (local14.aClass2_Sub6_Sub2_1 != null) {
					local14.aClass2_Sub6_Sub2_1.method3320(Static686.anInt8968 / 100);
	...
	private void method936(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		if ((this.anIntArray56[arg0] & 0x2) != 0) {
			for (@Pc(25) Class2_Sub16 local25 = (Class2_Sub16) this.aClass2_Sub6_Sub4_1.aClass341_72.method7715(); local25 != null; local25 = (Class2_Sub16) this.aClass2_Sub6_Sub4_1.aClass341_72.method7716()) {
		...
		@Pc(117) Class2_Sub11 local117 = (Class2_Sub11) this.aClass28_7.method738(this.anIntArray54[arg0]);
		if (local117 == null) {
			return;
		}
		...
		if (local142.anInt2207 >= 0) {
			@Pc(297) Class2_Sub16 local297 = this.aClass2_Sub16ArrayArray2[arg0][local142.anInt2207];
		...
		this.aClass2_Sub6_Sub4_1.aClass341_72.method7718(local142);
	...
	private void method938(@OriginalArg(1) int arg0) {
		for (@Pc(6) Class2_Sub16 local6 = (Class2_Sub16) this.aClass2_Sub6_Sub4_1.aClass341_72.method7706(65280); local6 != null; local6 = (Class2_Sub16) this.aClass2_Sub6_Sub4_1.aClass341_72.method7713()) {
	...
	private void method941(@OriginalArg(1) int arg0) {
		...
		for (@Pc(28) Class2_Sub16 local28 = (Class2_Sub16) this.aClass2_Sub6_Sub4_1.aClass341_72.method7706(65280); local28 != null; local28 = (Class2_Sub16) this.aClass2_Sub6_Sub4_1.aClass341_72.method7713()) {
	...
	public synchronized boolean method944(@OriginalArg(0) Class123 arg0, @OriginalArg(1) Class332 arg1, @OriginalArg(4) Class2_Sub8 arg2) {
		arg2.method1154();
		...
		for (@Pc(35) Class2_Sub55 local35 = (Class2_Sub55) arg2.aClass28_8.method736(); local35 != null; local35 = (Class2_Sub55) arg2.aClass28_8.method740()) {
			...
			if (local48 == null) {
				...
				this.aClass28_7.method735(local40, local48);
			}
	...
	public synchronized void method9137(@OriginalArg(0) int arg0) {
		if (this.aClass40_1.method1055()) {
			@Pc(18) int local18 = this.aClass40_1.anInt992 * this.anInt819 / Static686.anInt8968;
			do {
				...
				this.aClass2_Sub6_Sub4_1.method9137(local58);
				arg0 -= local58;
				this.method932();
			} while (this.aClass40_1.method1055());
		}
		this.aClass2_Sub6_Sub4_1.method9137(arg0);
	}
	...
	public boolean method945(@OriginalArg(0) Class2_Sub16 arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		arg0.anInt2193 = Static686.anInt8968 / 100;
		...
		if (arg1 == null) {
			arg0.aClass2_Sub6_Sub2_1.method9137(arg3);
		} else {
			arg0.aClass2_Sub6_Sub2_1.method9138(arg1, arg2, arg3);
		}
