...
public final class Class3 {
	...
	public Class3(@OriginalArg(0) Class330 arg0) {
		@Pc(30) byte[] local30 = arg0.method5353(3);
		this.method50(new Class2_Sub21(local30));
	}

	@OriginalMember(owner = "client!aba", name = "a", descriptor = "(Lclient!ge;I)V")
	private void method50(@OriginalArg(0) Class2_Sub21 arg0) {
		...
		while (true) {
			while (true) {
							...
							while (true) {
								...
								if (local13 == 1) {
									...
									for (local93 = 0; local93 < this.anIntArray16.length; local93++) {
										this.anIntArray16[local93] = arg0.method5165();
										this.anIntArray14[local93] = arg0.method5165();
									}
								} else if (local13 == 2) {
									this.anInt81 = arg0.method5191();
								} else {
									if (local13 != 3) {
										continue label95;
									}
									this.anInt86 = arg0.method5205();
				...
				if (local13 == 5) {
					this.anInt88 = arg0.method5192();
				} else if (local13 == 6) {
					this.anInt82 = arg0.method5192();
				} else if (local13 == 7) {
					...
					this.anInt85 = arg0.method5205();
				} else if (local13 == 10) {
					this.aBoolean6 = false;
				} else if (local13 == 11) {
					this.anInt87 = arg0.method5205();
				}
			}
		}
	}
