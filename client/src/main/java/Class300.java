...
public final class Class300 {
	...
	public void method4759(@OriginalArg(1) Class2_Sub21 arg0, @OriginalArg(2) byte[] arg1) {
	...
	public byte[] method4760(@OriginalArg(0) byte[] arg0) {
		@Pc(8) Class2_Sub21 local8 = new Class2_Sub21(arg0);
		local8.anInt8388 = arg0.length - 4;
		@Pc(24) int local24 = local8.method5160();
		@Pc(27) byte[] local27 = new byte[local24];
		local8.anInt8388 = 0;
		this.method4759(local8, local27);
		return local27;
	}
}
