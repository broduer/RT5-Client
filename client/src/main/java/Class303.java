...
public final class Class303 implements Interface4 {
	...
	public Class303(@OriginalArg(0) Class330 arg0, @OriginalArg(1) Class330 arg1, @OriginalArg(2) Class330 arg2) {
		...
		@Pc(24) Class2_Sub21 local24 = new Class2_Sub21(arg0.method5359(0, 0));
		this.anInt7709 = local24.method5191();
		this.aClass118Array1 = new Class118[this.anInt7709];
		for (@Pc(36) int local36 = 0; local36 < this.anInt7709; local36++) {
			if (local24.method5205() == 1) {
	...
	@Override
	public int[] method4806(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) float arg4) {
		return this.method4807(arg3).method6397(this.aClass330_99, (double) arg4, this.aClass118Array1[arg3].aBoolean238, this, arg1, arg2, arg0);
	}
	...
	@Override
	public boolean method4802(@OriginalArg(1) int arg0) {
		@Pc(8) Class2_Sub2_Sub21 local8 = this.method4807(arg0);
		return local8 != null && local8.method6393(this.aClass330_99, this);
	}

	@OriginalMember(owner = "client!qea", name = "b", descriptor = "(II)Lclient!fa;")
	@Override
	public Class118 method4805(@OriginalArg(0) int arg0) {
		return this.aClass118Array1[arg0];
	}

	@OriginalMember(owner = "client!qea", name = "a", descriptor = "(IIFBIZ)[F")
	@Override
	public float[] method4804(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2, @OriginalArg(4) int arg3) {
		return this.method4807(arg1).method6392(arg0, this, this.aClass330_99, this.aClass118Array1[arg1].aBoolean238, arg3);
	}

	@OriginalMember(owner = "client!qea", name = "a", descriptor = "(FIIZZI)[I")
	@Override
	public int[] method4803(@OriginalArg(0) float arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(5) int arg3) {
		return this.method4807(arg1).method6394(arg2, (double) arg0, this.aClass118Array1[arg1].aBoolean238, arg3, this, this.aClass330_99);
	}
}
