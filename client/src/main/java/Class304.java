...
public final class Class304 implements Interface23 {
	...
	public void method4829(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		this.anIntArray621[arg0] = arg1;
		@Pc(24) Class2_Sub48 local24 = (Class2_Sub48) this.aClass28_39.method373((long) arg0);
		if (local24 == null) {
			local24 = new Class2_Sub48(Static588.method5469() + 500L);
			this.aClass28_39.method370((long) arg0, local24);
		} else {
			local24.aLong264 = Static588.method5469() + 500L;
		}
	}
	...
	public int method4827(@OriginalArg(0) int arg0) {
		@Pc(8) Class95 local8 = Static529.aClass161_1.method2464(arg0);
	...
	public void method4830() {
		for (@Pc(5) int local5 = 0; local5 < Static36.aClass260_1.anInt6462; local5++) {
			@Pc(11) Class321 local11 = Static36.aClass260_1.method4088(local5);
	...
	public void method4831(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		@Pc(13) Class95 local13 = Static529.aClass161_1.method2464(arg1);
		...
		local29 <<= local19;
		this.method4829(local16, ~local29 & this.anIntArray621[local16] | local29 & arg0 << local19);
	}
	...
	public void method4834(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class95 local8 = Static529.aClass161_1.method2464(arg1);
		@Pc(11) int local11 = local8.anInt2501;
		...
		local31 <<= local14;
		this.method4836(local11, arg0 << local14 & local31 | this.anIntArray622[local11] & ~local31);
	}

	@OriginalMember(owner = "client!qga", name = "a", descriptor = "(IZ)I")
	public int method4835(@OriginalArg(1) boolean arg0) {
		@Pc(8) long local8 = Static588.method5469();
		for (@Pc(23) Class2_Sub48 local23 = arg0 ? (Class2_Sub48) this.aClass28_39.method371() : (Class2_Sub48) this.aClass28_39.method375(); local23 != null; local23 = (Class2_Sub48) this.aClass28_39.method375()) {
	...
	public void method4836(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		...
		if (local24 == null) {
			...
			local24.aLong264 = Static588.method5469() + 500L | 0x4000000000000000L;
		}
	}
}
