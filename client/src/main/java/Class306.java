...
public class Class306 {
	...
	public final void method5576(@OriginalArg(0) Class2_Sub21 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class110[] arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		@Pc(4) int local4;
		@Pc(11) int local11;
		@Pc(14) int local14;
		@Pc(19) int local19;
				...
				for (local11 = 0; local11 < 64; local11++) {
					for (local14 = 0; local14 < 64; local14++) {
						...
						if (local19 >= 0 && this.anInt8906 > local19 && local23 >= 0 && local23 < this.anInt8904) {
							local9.method1667(local23, local19);
						}
					}
				}
			}
		...
		for (local11 = 0; local11 < this.anInt8913; local11++) {
			for (local14 = 0; local14 < 64; local14++) {
				for (local19 = 0; local19 < 64; local19++) {
					this.method5584(0, arg1 + local19, 0, local14 + arg5, local4 + local14, arg0, 0, local19 + local84, local11, false);
				}
			}
		}
	}
	...
	public final void method5577(@OriginalArg(2) int arg0, @OriginalArg(4) int arg1) {
		for (@Pc(1) int local1 = 0; local1 < this.anInt8913; local1++) {
			this.method5586(64, arg1, arg0, local1, 64);
		}
	}

	@OriginalMember(owner = "client!qja", name = "a", descriptor = "(I[[[ILclient!ha;[Lclient!eq;)V")
	public final void method5578(@OriginalArg(1) int[][][] arg0, @OriginalArg(2) Class19 arg1, @OriginalArg(3) Class110[] arg2) {
		@Pc(4) int local4;
		@Pc(7) int local7;
		@Pc(10) int local10;
		if (!this.aBoolean673) {
				...
				for (local7 = 0; local7 < this.anInt8906; local7++) {
					for (local10 = 0; local10 < this.anInt8904; local10++) {
						if ((Static280.aByteArrayArrayArray3[local4][local7][local10] & 0x1) != 0) {
							...
							if (local26 >= 0) {
								arg2[local26].method1664(local10, local7);
							}
						}
					}
				}
		...
		for (local4 = 0; local4 < this.anInt8913; local4++) {
			...
			Static429.method4111(local4, arg1.a(this.anInt8906, this.anInt8904, this.anIntArrayArrayArray17[local4], local165, 512, local7, local10));
		}
	}

	@OriginalMember(owner = "client!qja", name = "a", descriptor = "(IBLclient!ha;[[ILclient!s;Lclient!s;Lclient!s;)V")
	private void method5579(@OriginalArg(0) int arg0, @OriginalArg(2) Class19 arg1, @OriginalArg(3) int[][] arg2, @OriginalArg(4) Class178 arg3, @OriginalArg(5) Class178 arg4, @OriginalArg(6) Class178 arg5) {
		for (@Pc(1) int local1 = 0; local1 < this.anInt8906; local1++) {
			for (@Pc(4) int local4 = 0; local4 < this.anInt8904; local4++) {
				if (Static478.anInt7198 == -1 || Static696.method6472(local4, Static478.anInt7198, local1, arg0)) {
					...
					@Pc(72) Class318 local72 = local48 == 0 ? null : this.aClass96_6.method1550(local48 - 1);
					if (local28 == 0 && local72 == null) {
						local28 = 12;
					}
					@Pc(93) Class264 local93 = local59 == 0 ? null : this.aClass79_8.method1317(local59 - 1);
					...
					if (local72 != null || local93 != null) {
						...
						if (local72 == null) {
							...
							if (!this.aBoolean673 && arg0 == 0) {
								Static295.method3019(local1, local4, local72.anInt8260, local72.anInt8252 * 8, local72.anInt8256);
							}
						}
						if (local93 != null) {
						...
						for (@Pc(377) int local377 = 0; local377 < local199; local377++) {
							...
							if (local363 != null && Static499.aBooleanArrayArray7[local28][local377]) {
								...
								local363[local377] = arg3.a(local485, -128, (int) local477) - arg4.a(local485, -127, (int) local477);
							}
							if (local375 != null) {
								if (arg3 != null && !Static499.aBooleanArrayArray7[local28][local377]) {
									local477 = local352[local377] + (local1 << 9);
									local485 = (local4 << 9) + local355[local377];
									local375[local377] = arg4.a(local485, -128, (int) local477) - arg3.a(local485, -115, (int) local477);
									...
									local375[local377] = arg5.a(local485, -126, (int) local477) - arg4.a(local485, -114, (int) local477);
								}
							}
						}
						local383 = arg4.a(local4, local1, (byte) -118);
						local388 = arg4.a(local4, local1 + 1, (byte) -118);
						local477 = arg4.a(local4 + 1, local1 - -1, (byte) -118);
						local485 = arg4.a(local4 + 1, local1, (byte) -118);
						@Pc(633) boolean local633 = Static441.method4209(local4, local1);
						...
						if (this.aBoolean673) {
							local740 = Static100.method1258(local1, local4);
							local742 = Static350.method3591(local1, local4);
							local744 = Static339.method3492(local1, local4);
						}
						arg4.a(local1, local4, local352, local363, local355, local375, local166, local169, local172, local175, local195, local178, local181, local740, local742, local744, false);
						Static527.method4959(arg0, local1, local4);
					}
				}
			}
		}
	...
	private void method5580(@OriginalArg(0) int arg0, @OriginalArg(1) Class318 arg1, @OriginalArg(2) byte[][] arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class19 arg7, @OriginalArg(9) int arg8, @OriginalArg(10) boolean[] arg9, @OriginalArg(11) Class264 arg10, @OriginalArg(12) byte[][] arg11, @OriginalArg(13) byte[][] arg12) {
			...
			if (local37 > 0) {
				...
				if (local50.anInt8249 != -1) {
					...
					if (local50.aBoolean628) {
						...
						local514 = Static718.method6756(local50, arg7);
		...
		local37 = Static718.method6756(arg1, arg7);
		if (!arg1.aBoolean628) {
			return;
		}
	...
	public final void method5582(@OriginalArg(0) int[][] arg0) {
	...
	private void method5584(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) Class2_Sub21 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(10) boolean arg9) {
		if (arg0 == 1) {
			arg2 = 1;
		} else if (arg0 == 2) {
			arg6 = 1;
		...
		while (true) {
			...
			if (local50 == 0) {
				if (this.aBoolean673) {
					...
					this.anIntArrayArrayArray17[0][arg3 + arg6][arg1 + arg2] = -Static144.method1604(arg4 + 932731, arg7 + 556238) * 8 << 2;
				} else {
			...
			if (local50 == 1) {
				@Pc(194) int local194 = arg5.method5205();
				if (this.aBoolean673) {
			...
			if (local50 <= 49) {
				if (arg9) {
					...
					this.aByteArrayArrayArray15[arg8][arg3][arg1] = arg5.method5186();
	...
	public final void method5585(@OriginalArg(1) Class19 arg0, @OriginalArg(2) Class178 arg1, @OriginalArg(3) Class178 arg2) {
			...
			for (@Pc(78) int local78 = -5; local78 < this.anInt8906; local78++) {
				...
				for (@Pc(81) int local81 = 0; local81 < this.anInt8904; local81++) {
					...
					if (local86 < this.anInt8906) {
						...
						if (local101 > 0) {
							@Pc(114) Class264 local114 = this.aClass79_8.method1317(local101 - 1);
					...
					if (local101 >= 0) {
						...
						if (local170 > 0) {
							@Pc(180) Class264 local180 = this.aClass79_8.method1317(local170 - 1);
				...
				if (local78 >= 0) {
					...
					for (@Pc(244) int local244 = -5; local244 < this.anInt8904; local244++) {
						...
						if (local244 >= 0 && local240 > 0 && local242 > 0) {
							local45[local78][local244] = Static318.method6094(local170 / local242, local101 / local242, local86 * 256 / local240);
						}
					}
				}
			}
			if (Static718.aBoolean822) {
				this.method5587(local47 == 0 ? arg2 : null, local45, local47 == 0 ? arg1 : null, Static246.aClass178Array1[local47], arg0, local47);
			} else {
				this.method5579(local47, arg0, local45, local47 == 0 ? arg2 : null, Static246.aClass178Array1[local47], local47 == 0 ? arg1 : null);
			}
		...
		if (!this.aBoolean673) {
			if (Static439.anInt6674 != 0) {
				Static176.method4701();
			}
			if (Static305.aBoolean371) {
				Static358.method6611();
			}
		}
	...
	public final void method5586(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		@Pc(8) int local8;
	...
	private void method5587(@OriginalArg(0) Class178 arg0, @OriginalArg(2) int[][] arg1, @OriginalArg(3) Class178 arg2, @OriginalArg(4) Class178 arg3, @OriginalArg(5) Class19 arg4, @OriginalArg(6) int arg5) {
		...
		for (@Pc(33) int local33 = 0; local33 < this.anInt8906; local33++) {
			...
			for (@Pc(49) int local49 = 0; local49 < this.anInt8904; local49++) {
				...
				if (Static478.anInt7198 == -1 || Static696.method6472(local49, Static478.anInt7198, local33, arg5)) {
					...
					if (local108 != 0 || local116 != 0) {
						@Pc(164) Class318 local164 = local108 == 0 ? null : this.aClass96_6.method1550(local108 - 1);
						@Pc(177) Class264 local177 = local116 == 0 ? null : this.aClass79_8.method1317(local116 - 1);
						...
						if ((local94 == 0 || local94 == 12) && local33 > 0 && local49 > 0 && local33 < this.anInt8906 && this.anInt8904 > local49) {
							...
							if (local391 == local403) {
								local391 = arg3.a(local49, local33, (byte) -118) - arg3.a(local67, local47, (byte) -118);
								if (local391 < 0) {
									local391 = -local391;
								}
								local403 = arg3.a(local49, local47, (byte) -118) - arg3.a(local67, local33, (byte) -118);
								if (local403 < 0) {
									local403 = -local403;
								}
							}
						...
						this.method5580(local94, local164, local13, this.anInt8906, local33, local100, this.anInt8904, arg4, local49, local88, local177, local8, local31);
						...
						if (!local496[local100 + 1 & 0x3]) {
							local88[1] = Static588.method5466(local88[1], (Static248.anIntArray313[2] & Static248.anIntArray313[4]) == 0);
						}
						if (!local496[local100 + 3 & 0x3]) {
							local88[3] = Static588.method5466(local88[3], (Static248.anIntArray313[6] & Static248.anIntArray313[0]) == 0);
						}
						if (!local496[local100 & 0x3]) {
							local88[0] = Static588.method5466(local88[0], (Static248.anIntArray313[0] & Static248.anIntArray313[2]) == 0);
						}
						if (!local496[local100 + 2 & 0x3]) {
							local88[2] = Static588.method5466(local88[2], (Static248.anIntArray313[6] & Static248.anIntArray313[4]) == 0);
						}
						...
						if (local1021 <= 0) {
							Static527.method4959(arg5, local33, local49);
						} else {
							if (local88[0]) {
								local1021++;
							}
							...
							if (local164 != null) {
								...
								local1162 = Static718.method6756(local164, arg4);
								for (local1164 = 0; local1164 < local403; local1164++) {
									...
									for (local1411 = 0; local1411 < local1277; local1411++) {
										...
										if (local1099 != null && Static499.aBooleanArrayArray7[local94][local1416]) {
											...
											local1099[local1064] = arg0.a(local1508, -115, (int) local1501) - arg3.a(local1508, -112, (int) local1501);
										}
										if (local1111 != null) {
											if (arg0 != null && !Static499.aBooleanArrayArray7[local94][local1416]) {
												local1501 = local1452 + (local33 << 9);
												local1508 = (local49 << 9) + local1448;
												local1111[local1064] = arg3.a(local1508, -128, (int) local1501) - arg0.a(local1508, -111, (int) local1501);
											} else if (arg2 != null && !Static355.aBooleanArrayArray4[local94][local1416]) {
												local1501 = local1452 + (local33 << 9);
												local1508 = local1448 + (local49 << 9);
												local1111[local1064] = arg2.a(local1508, -109, (int) local1501) - arg3.a(local1508, -115, (int) local1501);
											}
										}
								...
								if (!this.aBoolean673 && arg5 == 0) {
									Static295.method3019(local33, local49, local164.anInt8260, local164.anInt8252 * 8, local164.anInt8256);
								}
							...
							if (local177 != null) {
								...
								@Pc(1750) Class264 local1750 = this.aClass79_8.method1317(local116 - 1);
								@Pc(1758) Class264 local1758 = this.aClass79_8.method1317(local124 - 1);
								@Pc(1766) Class264 local1766 = this.aClass79_8.method1317(local132 - 1);
								@Pc(1774) Class264 local1774 = this.aClass79_8.method1317(local140 - 1);
								for (local1425 = 0; local1425 < local391; local1425++) {
									...
									for (local1430 = 0; local1430 < local1277; local1430++) {
										...
										if (local1099 != null && Static499.aBooleanArrayArray7[local94][local1452]) {
											...
											local1099[local1064] = arg0.a(local2112, -123, (int) local2106) - arg3.a(local2112, -111, (int) local2106);
										}
										if (local1111 != null) {
											if (arg0 != null && !Static499.aBooleanArrayArray7[local94][local1452]) {
												local2106 = (local33 << 9) + local1501;
												local2112 = local2056 + (local49 << 9);
												local1111[local1064] = arg3.a(local2112, -117, (int) local2106) - arg0.a(local2112, -116, (int) local2106);
											} else if (arg2 != null && !Static355.aBooleanArrayArray4[local94][local1452]) {
												local2106 = local1501 + (local33 << 9);
												local2112 = (local49 << 9) + local2056;
												local1111[local1064] = arg2.a(local2112, -124, (int) local2106) - arg3.a(local2112, -121, (int) local2106);
											}
										}
										if (local1452 < 8 && Static615.anIntArray719[local1435] >= 0) {
											...
											if (local85 && Static499.aBooleanArrayArray7[local94][local1452]) {
												...
												local2106 = Static273.method2773(arg1[local47][local49], local1501 << 7 >> 9, arg1[local33][local49]);
												local2112 = Static273.method2773(arg1[local47][local67], local1501 << 7 >> 9, arg1[local33][local67]);
												local1085[local1064] = Static273.method2773(local2112, local2056 << 7 >> 9, local2106);
											}
											if (local1076 != null) {
							...
							local1162 = arg3.a(local49, local33, (byte) -118);
							local1164 = arg3.a(local49, local47, (byte) -118);
							local1411 = arg3.a(local67, local47, (byte) -118);
							local1416 = arg3.a(local67, local33, (byte) -118);
							@Pc(2560) boolean local2560 = Static441.method4209(local49, local33);
							...
							local1435 = 0;
							if (this.aBoolean673) {
								local1430 = Static100.method1258(local33, local49);
								local1452 = Static350.method3591(local33, local49);
								local1435 = Static339.method3492(local33, local49);
							}
	...
	public final void method5588(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) Class2_Sub21 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) Class110[] arg8) {
		...
		if (!this.aBoolean673) {
			...
			for (local32 = 0; local32 < 8; local32++) {
				for (@Pc(35) int local35 = 0; local35 < 8; local35++) {
					@Pc(49) int local49 = arg2 + Static633.method6809(local32 & 0x7, local35 & 0x7, arg6);
					local61 = arg4 + Static530.method4972(local35 & 0x7, local32 & 0x7, arg6);
					if (local49 > 0 && this.anInt8906 - 1 > local49 && local61 > 0 && local61 < this.anInt8904 - 1) {
						local30.method1667(local61, local49);
					}
				}
			}
		}
				...
				for (@Pc(156) int local156 = 0; local156 < 64; local156++) {
					if (arg1 == local61 && local153 >= local17 && local153 <= local17 + 8 && local23 <= local156 && local156 <= local23 + 8) {
						...
						if (local17 + 8 == local153 || local156 == local23 + 8) {
							...
							this.method5584(0, local252, 0, local243, local153 + local117, arg5, 0, local156 + local32, arg0, true);
						} else {
							local243 = arg2 + Static633.method6809(local153 & 0x7, local156 & 0x7, arg6);
							local252 = Static530.method4972(local156 & 0x7, local153 & 0x7, arg6) + arg4;
							this.method5584(arg6, local252, local127, local243, local153 + local117, arg5, local125, local156 + local32, arg0, false);
						}
						...
						this.method5584(0, -1, 0, -1, 0, arg5, 0, 0, 0, false);
					}
				}
			}
		}
