...
public final class Class306_Sub1 extends Class306 {
	...
	public void method5589(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) Class110[] arg2, @OriginalArg(4) Class19 arg3, @OriginalArg(5) byte[] arg4) {
		@Pc(8) Class2_Sub21 local8 = new Class2_Sub21(arg4);
		@Pc(18) int local18 = -1;
		while (true) {
			@Pc(22) int local22 = local8.method5154();
			if (local22 == 0) {
				return;
			}
			local18 += local22;
			@Pc(30) int local30 = 0;
			while (true) {
				@Pc(34) int local34 = local8.method5199();
				if (local34 == 0) {
					break;
				}
				local30 += local34 - 1;
				...
				@Pc(60) int local60 = local8.method5205();
				...
				if (local73 > 0 && local77 > 0 && local73 < super.anInt8906 - 1 && local77 < super.anInt8904 - 1) {
					...
					this.method5591(local64, local18, local102, local77, arg3, local73, local68, local56, local56, -1);
				}
			}
		}
	}
	...
	public void method5590(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class19 arg3) {
		if (super.aBoolean673) {
			return;
		}
				...
				while (true) {
					while (true) {
						...
						while (arg1.aByteArray93.length > arg1.anInt8388) {
							local28 = arg1.method5205();
							if (local28 != 0) {
								@Pc(149) int local149;
								@Pc(153) int local153;
								@Pc(290) int local290;
								if (local28 == 1) {
									local86 = arg1.method5205();
									if (local86 > 0) {
										for (local504 = 0; local504 < local86; local504++) {
											@Pc(512) Class353 local512 = new Class353(arg3, arg1, 2);
											if (local512.anInt9380 == 31) {
												@Pc(523) Class392 local523 = Static48.aClass384_1.method6301(arg1.method5191());
												local512.method5823(local523.anInt10374, local523.anInt10372, local523.anInt10373, local523.anInt10377);
											}
											if (arg3.e() > 0) {
												@Pc(543) Class2_Sub7 local543 = local512.aClass2_Sub7_3;
												local149 = (arg2 << 9) + local543.method5980();
												local153 = (arg0 << 9) + local543.method5983();
												local290 = local149 >> 9;
												@Pc(567) int local567 = local153 >> 9;
												if (local290 >= 0 && local567 >= 0 && super.anInt8906 > local290 && super.anInt8904 > local567) {
													local543.method5981(local149, local153, super.anIntArrayArrayArray17[local512.anInt9369][local290][local567] - local543.method5979());
													Static698.method6556(local512);
												}
											}
										}
									}
									...
									local12.method5949(arg1);
								} else if (local28 == 128) {
									if (local12 == null) {
										local12 = new Class367();
									}
									local12.method5948(arg1);
								} else if (local28 == 129) {
									...
									for (local86 = 0; local86 < 4; local86++) {
										@Pc(91) byte local91 = arg1.method5186();
										if (local91 == 0 && super.aByteArrayArrayArray12[local86] != null) {
											...
											for (local143 = 0; local143 < 64; local143 += 4) {
												for (local147 = 0; local147 < 64; local147 += 4) {
													@Pc(280) byte local280 = arg1.method5186();
							...
							for (local28 = 0; local28 < 8; local28++) {
								for (local86 = 0; local86 < 8; local86++) {
									...
									if (local504 >= 0 && super.anInt8906 >> 3 > local504 && local143 >= 0 && super.anInt8904 >> 3 > local143) {
										Static108.method1315(local143, local504, local12);
									}
								}
							}
						}
	...
	public void method5591(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class110 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Class19 arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9) {
		if (Static400.aClass2_Sub34_28.aClass57_Sub19_2.method4201() == 0 && !Static696.method6472(arg3, Static164.anInt2808, arg5, arg7)) {
			return;
		}
		if (arg8 < this.anInt8919) {
			this.anInt8919 = arg8;
		}
		@Pc(40) Class54 local40 = Static354.aClass142_4.method2158(arg1, 82);
		if (Static400.aClass2_Sub34_28.aClass57_Sub30_1.method5920() == 0 && local40.aBoolean90) {
			return;
		}
		@Pc(65) int local65;
		@Pc(68) int local68;
		...
		@Pc(170) int local170 = local143.a(local123, local100, (byte) -118) + local143.a(local123, local94, (byte) -118) + local143.a(local121, local100, (byte) -118) + local143.a(local121, local94, (byte) -118) >> 2;
		...
		if (local40.method803()) {
			Static89.method1124(arg8, (Class8_Sub2_Sub1_Sub2_Sub1) null, arg5, arg3, (Class8_Sub2_Sub1_Sub2_Sub2) null, local40, arg6);
		}
		@Pc(248) boolean local248 = arg9 == -1 && !local40.method800() && local40.anIntArray113 == null && !local40.aBoolean93 && !local40.aBoolean91;
		if (Static614.aBoolean718 && (Static540.method4592(arg0) && local40.anInt1223 != 1 || !(!Static389.method3876(arg0) || local40.anInt1223 != 0))) {
			return;
		}
		if (arg0 != 22) {
			...
			if (arg0 == 10 || arg0 == 11) {
				...
				if (Static102.method1287(local420, false)) {
					if (local384 != null && local384.method4823(-19717)) {
						local384.method4824(arg4);
					}
				...
				if (local40.anInt1242 != 0 && arg2 != null) {
					arg2.method1670(arg5, local68, arg3, !local40.aBoolean97, local65, local40.aBoolean99);
				}
				...
				Static102.method1287(local420, false);
				...
				if (arg0 == 0) {
					...
					if (local248) {
						...
						local774 = local772;
						if (local772.method4823(-19717)) {
							local772.method4824(arg4);
						}
					} else {
						local774 = new Class8_Sub2_Sub3_Sub1(arg4, local40, arg8, arg7, local179, local170, local187, super.aBoolean673, arg0, arg6, arg9);
					}
					Static584.method5419(arg8, arg5, arg3, local774, (Class8_Sub2_Sub3) null);
					if (arg6 == 0) {
						...
						if (local744 == 1 && !super.aBoolean673) {
							Static177.method1851(1, local40.anInt1212, arg3, arg5, arg8, local40.anInt1257);
						}
					} else if (arg6 == 1) {
						if (Static404.aBoolean465 && local40.aBoolean98) {
							local143.ka(arg5, arg3 + 1, 50);
						...
						if (local744 == 1 && !super.aBoolean673) {
							Static177.method1851(2, -local40.anInt1212, arg3 + 1, arg5, arg8, local40.anInt1257);
						}
					} else if (arg6 == 2) {
						if (Static404.aBoolean465 && local40.aBoolean98) {
						...
						if (local744 == 1 && !super.aBoolean673) {
							Static177.method1851(1, -local40.anInt1212, arg3, arg5 + 1, arg8, local40.anInt1257);
						}
					} else if (arg6 == 3) {
						if (Static404.aBoolean465 && local40.aBoolean98) {
							local143.ka(arg5, arg3, 50);
						...
						if (local744 == 1 && !super.aBoolean673) {
							Static177.method1851(2, local40.anInt1212, arg3, arg5, arg8, local40.anInt1257);
						}
					}
					if (local40.anInt1242 != 0 && arg2 != null) {
						arg2.method1660(local40.aBoolean99, !local40.aBoolean97, arg3, arg6, arg0, arg5);
					}
					if (local40.anInt1243 != 64) {
						Static411.method4022(arg8, arg5, arg3, local40.anInt1243);
					}
				} else {
					...
					if (arg0 == 1) {
						if (local248) {
							...
							local1079 = local1096;
							if (local1096.method4823(-19717)) {
								local1096.method4824(arg4);
							}
						} else {
							local1079 = new Class8_Sub2_Sub3_Sub1(arg4, local40, arg8, arg7, local179, local170, local187, super.aBoolean673, arg0, arg6, arg9);
						}
						Static584.method5419(arg8, arg5, arg3, local1079, (Class8_Sub2_Sub3) null);
						if (local40.aBoolean98 && Static404.aBoolean465) {
							if (arg6 == 0) {
								local143.ka(arg5, arg3 + 1, 50);
							} else if (arg6 == 1) {
						...
						if (local248) {
							...
							if (local1267.method4823(-19717)) {
								local1267.method4824(arg4);
							}
							local774 = local1283;
							if (local1283.method4823(-19717)) {
								local1283.method4824(arg4);
							}
							local1079 = local1267;
						} else {
						...
						Static584.method5419(arg8, arg5, arg3, local1079, local774);
						...
						if (local40.anInt1223 == 1 && !super.aBoolean673) {
							...
							Static177.method1851(local1723, 0, arg3, arg5, arg8, local40.anInt1257);
						}
						if (local40.anInt1242 != 0 && arg2 != null) {
							arg2.method1670(arg5, local68, arg3, !local40.aBoolean97, local65, local40.aBoolean99);
						}
						...
						if (arg0 == 4) {
							if (local248) {
								...
								if (local1801.method4823(-19717)) {
									local1801.method4824(arg4);
								}
								local1813 = local1801;
							} else {
							...
							Static177.method1853(arg8, arg5, arg3, local1813, (Class8_Sub2_Sub4) null);
						} else {
							...
							if (arg0 == 5) {
								local1844 = 65;
								local1850 = (Interface25) Static302.method3069(arg8, arg5, arg3);
								if (local1850 != null) {
									local1844 = Static354.aClass142_4.method2158(local1850.method4822(-32136), 32).anInt1243 + 1;
								}
								if (local248) {
									...
									if (local1916.method4823(-19717)) {
										local1916.method4824(arg4);
									}
									local1813 = local1916;
								} else {
								...
								local1850 = (Interface25) Static302.method3069(arg8, arg5, arg3);
								if (local1850 != null) {
									local1844 = Static354.aClass142_4.method2158(local1850.method4822(-32136), 115).anInt1243 / 2 + 1;
								}
								if (local248) {
								...
								if (local248) {
									...
									local1813 = local2068;
									if (local2068.method4823(-19717)) {
										local2068.method4824(arg4);
									}
								} else {
								...
								local492 = arg6 + 2 & 0x3;
								local495 = 33;
								@Pc(2134) Interface25 local2134 = (Interface25) Static302.method3069(arg8, arg5, arg3);
								if (local2134 != null) {
									local495 = Static354.aClass142_4.method2158(local2134.method4822(-32136), 92).anInt1243 / 2 + 1;
								}
								...
								if (local248) {
									...
									if (local2178.method4823(-19717)) {
										local2178.method4824(arg4);
									}
									if (local2200.method4823(-19717)) {
										local2200.method4824(arg4);
									}
								} else {
								...
								Static177.method1853(arg8, arg5, arg3, local2178, local2200);
							}
						}
					}
				}
			}
		} else if (Static400.aClass2_Sub34_28.aClass57_Sub6_1.method1849() != 0 || local40.anInt1271 != 0 || local40.anInt1242 == 1 || local40.aBoolean101) {
			...
			if (local248) {
				...
				local325 = local341;
				if (local341.method4823(-19717)) {
					local341.method4824(arg4);
				}
			} else {
				local325 = new Class8_Sub2_Sub2_Sub2(arg4, local40, arg8, arg7, local179, local170, local187, super.aBoolean673, arg6, arg9);
			}
			Static61.method799(arg8, arg5, arg3, local325);
			if (local40.anInt1242 == 1 && arg2 != null) {
				arg2.method1668(arg3, arg5);
			}
		}
	}

	@OriginalMember(owner = "client!taa", name = "a", descriptor = "(IILclient!ha;ILclient!ge;IIIII)V")
	public void method5592(@OriginalArg(0) int arg0, @OriginalArg(2) Class19 arg1, @OriginalArg(3) int arg2, @OriginalArg(4) Class2_Sub21 arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8) {
		if (super.aBoolean673) {
			return;
		}
		@Pc(10) boolean local10 = false;
		...
		while (true) {
			...
			while (arg3.anInt8388 < arg3.aByteArray93.length) {
				...
				if (local35 != 0) {
					...
					@Pc(116) int local116;
					if (local35 == 1) {
						local63 = arg3.method5205();
						if (local63 > 0) {
							for (local70 = 0; local70 < local63; local70++) {
								@Pc(78) Class353 local78 = new Class353(arg1, arg3, 2);
								if (local78.anInt9380 == 31) {
									@Pc(91) Class392 local91 = Static48.aClass384_1.method6301(arg3.method5191());
									local78.method5823(local91.anInt10374, local91.anInt10372, local91.anInt10373, local91.anInt10377);
								}
								if (arg1.e() > 0) {
									@Pc(108) Class2_Sub7 local108 = local78.aClass2_Sub7_3;
									local116 = local108.method5980() >> 9;
									local122 = local108.method5983() >> 9;
									if (arg7 == local78.anInt9369 && local116 >= local18 && local116 < local18 + 8 && local122 >= local24 && local24 + 8 > local122) {
										local176 = Static24.method316(local108.method5980() & 0xFFF, local108.method5983() & 0xFFF, arg6) + (arg0 << 9);
										local116 = local176 >> 9;
										local200 = (arg8 << 9) + Static485.method6796(local108.method5983() & 0xFFF, arg6, local108.method5980() & 0xFFF);
										local122 = local200 >> 9;
										if (local116 >= 0 && local122 >= 0 && local116 < super.anInt8906 && super.anInt8904 > local122) {
											local108.method5981(local176, local200, super.anIntArrayArrayArray17[arg7][local116][local122] - local108.method5979());
											Static698.method6556(local78);
										}
									}
								}
							}
						...
						local12.method5949(arg3);
					} else if (local35 == 128) {
						if (local12 == null) {
							local12 = new Class367();
						}
						local12.method5948(arg3);
					} else if (local35 == 129) {
						if (super.aByteArrayArrayArray12 == null) {
							super.aByteArrayArrayArray12 = new byte[4][][];
						}
						for (local63 = 0; local63 < 4; local63++) {
							@Pc(311) byte local311 = arg3.method5186();
							@Pc(331) int local331;
							if (local311 == 0 && super.aByteArrayArrayArray12[arg4] != null) {
								...
								for (local327 = 0; local327 < 64; local327 += 4) {
									for (local331 = 0; local331 < 64; local331 += 4) {
										@Pc(466) byte local466 = arg3.method5186();
										if (arg7 >= local63) {
											for (local122 = local327; local122 < local327 + 4; local122++) {
												for (local176 = local331; local176 < local331 + 4; local176++) {
													if (local122 >= local18 && local18 + 8 > local122 && local176 >= local24 && local24 + 8 > local176) {
														local200 = arg0 + Static633.method6809(local122 & 0x7, local176 & 0x7, arg6);
														@Pc(534) int local534 = arg8 + Static530.method4972(local176 & 0x7, local122 & 0x7, arg6);
					...
					local12.method5950(arg3);
				}
			}
			if (local12 != null) {
				Static108.method1315(arg8 >> 3, arg0 >> 3, local12);
			}
	...
	public Interface25 method5593(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(5) Interface25 local5 = null;
		if (arg3 == 0) {
			local5 = (Interface25) Static302.method3069(arg2, arg0, arg1);
		}
		if (arg3 == 1) {
			local5 = (Interface25) Static114.method1368(arg2, arg0, arg1);
		}
		if (arg3 == 2) {
			local5 = (Interface25) Static578.method5387(arg2, arg0, arg1, Static603.aClass22 == null ? (Static603.aClass22 = a("uv")) : Static603.aClass22);
		}
		if (arg3 == 3) {
			local5 = (Interface25) Static687.method6405(arg2, arg0, arg1);
		}
		return local5;
	}

	@OriginalMember(owner = "client!taa", name = "a", descriptor = "(I[Lclient!eq;ILclient!ha;BII[BIII)V")
	public void method5594(@OriginalArg(0) int arg0, @OriginalArg(1) Class110[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class19 arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) byte[] arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9) {
		@Pc(26) Class2_Sub21 local26 = new Class2_Sub21(arg6);
		@Pc(28) int local28 = -1;
		while (true) {
			@Pc(32) int local32 = local26.method5154();
			if (local32 == 0) {
				return;
			}
			local28 += local32;
			@Pc(40) int local40 = 0;
			while (true) {
				@Pc(44) int local44 = local26.method5199();
				if (local44 == 0) {
					break;
				}
				local40 += local44 - 1;
				...
				@Pc(73) int local73 = local26.method5205();
				...
				if (arg8 == local69 && arg0 <= local65 && local65 < arg0 + 8 && arg9 <= local59 && local59 < arg9 + 8) {
					@Pc(113) Class54 local113 = Static354.aClass142_4.method2158(local28, 89);
					@Pc(130) int local130 = Static48.method630(local113.anInt1270, local59 & 0x7, local113.anInt1229, local81, local65 & 0x7, arg7) + arg4;
					@Pc(147) int local147 = Static521.method4837(arg7, local59 & 0x7, local113.anInt1229, local81, local113.anInt1270, local65 & 0x7) + arg5;
					if (local130 > 0 && local147 > 0 && local130 < super.anInt8906 - 1 && local147 < super.anInt8904 - 1) {
						...
						this.method5591(local77, local28, local173, local147, arg3, local130, arg7 + local81 & 0x3, arg2, arg2, -1);
					}
				}
			}
		}
	...
	public void method5595(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class19 arg1) {
		Static323.method3242();
		if (!arg0) {
			@Pc(23) int local23;
			@Pc(26) int local26;
				...
				for (local23 = 0; local23 < super.anInt8906; local23++) {
					for (local26 = 0; super.anInt8904 > local26; local26++) {
						if ((Static280.aByteArrayArrayArray3[1][local23][local26] & 0x2) == 2) {
							Static646.method6007(local23, local26);
						}
					}
				}
			}
					...
					for (@Pc(71) int local71 = 0; local71 <= super.anInt8906; local71++) {
						if ((super.aByteArrayArrayArray14[local23][local71][local26] & 0x4) != 0) {
							...
							if ((local90 + 1 - local88) * (local94 + 1 - local92) >= 4) {
								...
								Static269.method2740((local94 << 9) + 512, local88 << 9, local163, local92 << 9, local163, local23, (local90 << 9) + 512);
			...
			Static348.method3579();
		}
		super.aByteArrayArrayArray14 = null;
	}

	@OriginalMember(owner = "client!taa", name = "a", descriptor = "(IBILclient!eq;IILclient!ha;)V")
	public void method5598(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) Class110 arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) Class19 arg5) {
		@Pc(13) Interface25 local13 = this.method5593(arg4, arg1, arg3, arg0);
		if (local13 == null) {
			return;
		}
		@Pc(22) Class54 local22 = Static354.aClass142_4.method2158(local13.method4822(-32136), 98);
		@Pc(26) int local26 = local13.method4821();
		@Pc(30) int local30 = local13.method4818(23796);
		if (local22.method803()) {
			Static506.method5881(arg4, arg1, arg3, local22);
		}
		if (local13.method4823(-19717)) {
			local13.method4820(arg5, -88);
		}
		if (arg0 == 0) {
			Static26.method352(arg3, arg4, arg1);
			if (local22.anInt1242 != 0) {
				arg2.method1661(arg1, local30, local26, !local22.aBoolean97, arg4, local22.aBoolean99);
			}
			if (local22.anInt1223 == 1) {
				if (local30 == 0) {
					Static687.method6404(arg4, arg3, 1, arg1);
				} else if (local30 == 1) {
					Static687.method6404(arg4, arg3, 2, arg1 + 1);
				} else if (local30 == 2) {
					Static687.method6404(arg4 + 1, arg3, 1, arg1);
				} else if (local30 == 3) {
					Static687.method6404(arg4, arg3, 2, arg1);
				}
			}
		} else if (arg0 == 1) {
			Static173.method1829(arg3, arg4, arg1);
		} else if (arg0 == 2) {
			Static10.method78(arg3, arg4, arg1, Static603.aClass22 == null ? (Static603.aClass22 = a("uv")) : Static603.aClass22);
			if (local22.anInt1242 != 0 && super.anInt8906 > local22.anInt1270 + arg4 && super.anInt8904 > local22.anInt1270 + arg1 && arg4 + local22.anInt1229 < super.anInt8906 && local22.anInt1229 + arg1 < super.anInt8904) {
				arg2.method1666(local22.aBoolean99, !local22.aBoolean97, arg4, local22.anInt1270, local22.anInt1229, local30, arg1);
			}
			if (local26 == 9) {
				if ((local30 & 0x1) == 0) {
					Static687.method6404(arg4, arg3, 8, arg1);
				} else {
					Static687.method6404(arg4, arg3, 16, arg1);
				}
			}
		} else if (arg0 == 3) {
			Static609.method5796(arg3, arg4, arg1);
			if (local22.anInt1242 == 1) {
				arg2.method1671(arg1, arg4);
			}
		}
	}
}
