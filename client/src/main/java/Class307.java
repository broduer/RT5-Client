...
public final class Class307 {
	...
	public Class307(@OriginalArg(0) Class377 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class330 arg2) {
		...
		this.aClass330_100.method5372(29);
	}
	...
	public void method4943() {
		...
		synchronized (this.aClass82_168) {
			this.aClass82_168.method1381(5);
		}
	}
	...
	public void method4944() {
		...
		synchronized (this.aClass82_168) {
			this.aClass82_168.method1385();
		}
	}

	@OriginalMember(owner = "client!qk", name = "a", descriptor = "(II)Lclient!ema;")
	private Class108 method4945(@OriginalArg(0) int arg0) {
		@Pc(6) Class82 local6 = this.aClass82_168;
		@Pc(22) Class108 local22;
		synchronized (this.aClass82_168) {
			local22 = (Class108) this.aClass82_168.method1390((long) arg0);
		}
		if (local22 != null) {
			return local22;
		}
		...
		synchronized (this.aClass330_100) {
			local45 = this.aClass330_100.method5359(arg0, 29);
		}
		local22 = new Class108();
		if (local45 != null) {
			local22.method1645(new Class2_Sub21(local45));
		}
		@Pc(69) Class82 local69 = this.aClass82_168;
		synchronized (this.aClass82_168) {
			this.aClass82_168.method1384(local22, (long) arg0);
			return local22;
		}
	}
	...
	public void method4946() {
		...
		synchronized (this.aClass82_168) {
			this.aClass82_168.method1391();
		}
	}

	@OriginalMember(owner = "client!qk", name = "a", descriptor = "(Lclient!dg;IIIIZ)Lclient!gm;")
	public Class148 method4947(@OriginalArg(0) Class78 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(13) Class216[] local13 = null;
		@Pc(18) Class108 local18 = this.method4945(arg2);
		if (local18.anIntArray232 != null) {
			...
			for (@Pc(28) int local28 = 0; local28 < local13.length; local28++) {
				@Pc(37) Class10 local37 = arg0.method1307(local18.anIntArray232[local28]);
