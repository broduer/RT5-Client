...
public final class Class308 {
	...
	public Class308(@OriginalArg(0) Class377 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Class330 arg3, @OriginalArg(4) Class330 arg4) {
		...
		if (this.aClass330_101 != null) {
			@Pc(44) int local44 = this.aClass330_101.method5361() - 1;
			this.aClass330_101.method5372(local44);
		}
		if (Static673.aClass377_8 == this.aClass377_6) {
			this.aStringArray39 = new String[] { null, null, null, null, null, Static32.aClass32_22.method429(this.anInt8086) };
		} else {
	...
	public void method4961() {
		@Pc(2) Class82 local2 = this.aClass82_169;
		synchronized (this.aClass82_169) {
			this.aClass82_169.method1391();
		}
		local2 = this.aClass82_170;
		synchronized (this.aClass82_170) {
			this.aClass82_170.method1391();
		}
		local2 = this.aClass82_171;
		synchronized (this.aClass82_171) {
			this.aClass82_171.method1391();
		}
	}
	...
	public void method4964() {
		@Pc(2) Class82 local2 = this.aClass82_169;
		synchronized (this.aClass82_169) {
			this.aClass82_169.method1385();
		}
		local2 = this.aClass82_170;
		synchronized (this.aClass82_170) {
			this.aClass82_170.method1385();
		}
		local2 = this.aClass82_171;
		synchronized (this.aClass82_171) {
			this.aClass82_171.method1385();
		}
	}

	@OriginalMember(owner = "client!ql", name = "a", descriptor = "(BZ)V")
	public void method4965(@OriginalArg(1) boolean arg0) {
	...
	public Class268 method4967(@OriginalArg(0) int arg0) {
		@Pc(14) Class82 local14 = this.aClass82_169;
		@Pc(24) Class268 local24;
		synchronized (this.aClass82_169) {
			local24 = (Class268) this.aClass82_169.method1390((long) arg0);
		}
		if (local24 != null) {
			return local24;
		}
		...
		synchronized (this.aClass330_101) {
			local51 = this.aClass330_101.method5359(Static612.method5816(arg0), Static713.method6727(arg0));
		}
		...
		if (local51 != null) {
			local24.method4222(new Class2_Sub21(local51));
		}
		local24.method4219();
		@Pc(90) Class82 local90 = this.aClass82_169;
		synchronized (this.aClass82_169) {
			this.aClass82_169.method1384(local24, (long) arg0);
			return local24;
		}
	}
