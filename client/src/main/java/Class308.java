...
public class Class308 {
	...
	protected Class308(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) Class96 arg4, @OriginalArg(5) Class79 arg5) {
		...
		this.aByteArrayArrayArray13 = new byte[this.anInt8937][this.anInt8930][this.anInt8928];
		this.aByteArrayArrayArray17 = new byte[this.anInt8937][this.anInt8930][this.anInt8928];
		this.aByteArrayArrayArray14 = new byte[this.anInt8937][this.anInt8930 + 1][this.anInt8928 + 1];
		this.aByteArrayArrayArray15 = new byte[this.anInt8937][this.anInt8930][this.anInt8928];
		this.aByteArrayArrayArray16 = new byte[this.anInt8937][this.anInt8930][this.anInt8928];
		this.anIntArrayArrayArray17 = new int[this.anInt8937][this.anInt8930 + 1][this.anInt8928 + 1];
	}

	@OriginalMember(owner = "client!qja", name = "a", descriptor = "(Lclient!ge;I[Lclient!eq;IBII)V")
	public final void method7886(@OriginalArg(0) Class2_Sub21 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class110[] arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		@Pc(4) int local4;
		@Pc(11) int local11;
		@Pc(14) int local14;
		@Pc(19) int local19;
			...
			for (local4 = 0; local4 < 4; local4++) {
				...
				for (local11 = 0; local11 < 64; local11++) {
					for (local14 = 0; local14 < 64; local14++) {
						...
						if (local19 >= 0 && this.anInt8930 > local19 && local23 >= 0 && local23 < this.anInt8928) {
		...
		for (local11 = 0; local11 < this.anInt8937; local11++) {
			for (local14 = 0; local14 < 64; local14++) {
				for (local19 = 0; local19 < 64; local19++) {
					this.method7894(0, arg1 + local19, 0, local14 + arg5, local4 + local14, arg0, 0, local19 + local84, local11, false);
				}
			}
		}
	}
	...
	public final void method7887(@OriginalArg(2) int arg0, @OriginalArg(4) int arg1) {
		for (@Pc(1) int local1 = 0; local1 < this.anInt8937; local1++) {
			this.method7896(64, arg1, arg0, local1, 64);
		}
	}

	@OriginalMember(owner = "client!qja", name = "a", descriptor = "(I[[[ILclient!ha;[Lclient!eq;)V")
	public final void method7888(@OriginalArg(1) int[][][] arg0, @OriginalArg(2) Class19 arg1, @OriginalArg(3) Class110[] arg2) {
		@Pc(4) int local4;
		@Pc(7) int local7;
		@Pc(10) int local10;
		if (!this.aBoolean674) {
			for (local4 = 0; local4 < 4; local4++) {
				for (local7 = 0; local7 < this.anInt8930; local7++) {
					for (local10 = 0; local10 < this.anInt8928; local10++) {
		...
		for (local4 = 0; local4 < this.anInt8937; local4++) {
			local7 = 0;
			local10 = 0;
			if (!this.aBoolean674) {
			...
			Static429.method5812(local4, arg1.method8003(this.anInt8930, this.anInt8928, this.anIntArrayArrayArray17[local4], local165, local7, local10));
		}
	}

	@OriginalMember(owner = "client!qja", name = "a", descriptor = "(IBLclient!ha;[[ILclient!s;Lclient!s;Lclient!s;)V")
	private void method7889(@OriginalArg(0) int arg0, @OriginalArg(2) Class19 arg1, @OriginalArg(3) int[][] arg2, @OriginalArg(4) Class178 arg3, @OriginalArg(5) Class178 arg4, @OriginalArg(6) Class178 arg5) {
		for (@Pc(1) int local1 = 0; local1 < this.anInt8930; local1++) {
			for (@Pc(4) int local4 = 0; local4 < this.anInt8928; local4++) {
				if (Static478.anInt7219 == -1 || Static696.method9043(local4, Static478.anInt7219, local1, arg0)) {
					...
					if (local72 != null || local93 != null) {
						...
						@Pc(155) int local155 = local72 == null ? -1 : local72.anInt8278;
						@Pc(163) int local163 = local93 == null ? -1 : local93.anInt6653;
						...
						@Pc(195) int[] local195 = local72 == null || local72.anInt8271 == -1 ? null : new int[local143];
						@Pc(199) int local199;
						if (local72 == null) {
							local147 = local129;
						} else {
							for (local199 = 0; local199 < local129; local199++) {
								...
								local181[local145] = local72.anInt8273;
								local175[local145] = local72.anInt8272;
								if (local195 != null) {
									local195[local145] = local72.anInt8271;
								}
								local145++;
								local147++;
							}
							if (!this.aBoolean674 && arg0 == 0) {
								Static295.method4361(local1, local4, local72.anInt8283, local72.anInt8275 * 8, local72.anInt8279);
							}
						}
						if (local93 != null) {
							for (local199 = 0; local199 < local125; local199++) {
								...
								local181[local145] = local93.anInt6655;
						...
						for (@Pc(377) int local377 = 0; local377 < local199; local377++) {
							...
							if (local363 != null && Static499.aBooleanArrayArray7[local28][local377]) {
								...
								local363[local377] = arg3.method7885(local485, local477) - arg4.method7885(local485, local477);
							}
							if (local375 != null) {
								if (arg3 != null && !Static499.aBooleanArrayArray7[local28][local377]) {
									local477 = local352[local377] + (local1 << 9);
									local485 = (local4 << 9) + local355[local377];
									local375[local377] = arg4.method7885(local485, local477) - arg3.method7885(local485, local477);
									...
									local375[local377] = arg5.method7885(local485, local477) - arg4.method7885(local485, local477);
								}
							}
						}
						local383 = arg4.method7876(local4, local1);
						local388 = arg4.method7876(local4, local1 + 1);
						local477 = arg4.method7876(local4 + 1, local1 - -1);
						local485 = arg4.method7876(local4 + 1, local1);
						@Pc(633) boolean local633 = Static441.method5975(local4, local1);
						if (local633 && arg0 > 1 || !local633 && arg0 > 0) {
							...
							if (local93 != null && !local93.aBoolean497) {
								...
								local652 = false;
							} else if (local48 > 0 && local95 != null && !local95.aBoolean627) {
								local652 = false;
							}
						...
						if (this.aBoolean674) {
							...
							local742 = Static350.method5131(local1, local4);
							local744 = Static339.method5012(local1, local4);
						}
						arg4.method7878(local1, local4, local352, local363, local355, local375, local166, local169, local172, local175, local195, local178, local181, local740, local742, local744);
						Static527.method7091(arg0, local1, local4);
					}
				}
			}
		}
	...
	private void method7890(@OriginalArg(0) int arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) byte[][] arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class19 arg7, @OriginalArg(9) int arg8, @OriginalArg(10) boolean[] arg9, @OriginalArg(11) Class266 arg10, @OriginalArg(12) byte[][] arg11, @OriginalArg(13) byte[][] arg12) {
		...
		if (arg8 > 0) {
			if (arg4 > 0) {
				...
				if (local37 > 0) {
					...
					if (local50.anInt8272 != -1 && local50.aBoolean629) {
						local70 = arg11[arg4 - 1][arg8 - 1];
						local86 = arg2[arg4 - 1][arg8 - 1] * 2 + 4 & 0x7;
						local91 = Static718.method9374(local50, arg7);
						if (Static499.aBooleanArrayArray7[local70][local86]) {
							Static319.anIntArray385[0] = local50.anInt8272;
							Static262.anIntArray326[0] = local91;
							Static153.anIntArray234[0] = local50.anInt8278;
							Static725.anIntArray890[0] = local50.anInt8273;
							Static615.anIntArray719[0] = local50.anInt8274;
			...
			if (arg3 - 1 > arg4) {
				...
				if (local37 > 0) {
					...
					if (local50.anInt8272 != -1 && local50.aBoolean629) {
						...
						local91 = Static718.method9374(local50, arg7);
						if (Static499.aBooleanArrayArray7[local70][local86]) {
							Static319.anIntArray385[2] = local50.anInt8272;
							Static262.anIntArray326[2] = local91;
							Static153.anIntArray234[2] = local50.anInt8278;
							Static725.anIntArray890[2] = local50.anInt8273;
							Static615.anIntArray719[2] = local50.anInt8274;
			...
			if (arg4 > 0) {
				...
				if (local37 > 0) {
					...
					if (local50.anInt8272 != -1 && local50.aBoolean629) {
						...
						local91 = Static718.method9374(local50, arg7);
						if (Static499.aBooleanArrayArray7[local70][local86]) {
							Static319.anIntArray385[6] = local50.anInt8272;
							Static262.anIntArray326[6] = local91;
							Static153.anIntArray234[6] = local50.anInt8278;
							Static725.anIntArray890[6] = local50.anInt8273;
							Static615.anIntArray719[6] = local50.anInt8274;
			...
			if (arg3 - 1 > arg4) {
				...
				if (local37 > 0) {
					...
					if (local50.anInt8272 != -1 && local50.aBoolean629) {
						...
						local91 = Static718.method9374(local50, arg7);
						if (Static499.aBooleanArrayArray7[local70][local86]) {
							Static319.anIntArray385[4] = local50.anInt8272;
							Static262.anIntArray326[4] = local91;
							Static153.anIntArray234[4] = local50.anInt8278;
							Static725.anIntArray890[4] = local50.anInt8273;
							Static615.anIntArray719[4] = local50.anInt8274;
		...
		if (arg8 > 0) {
			...
			if (local37 > 0) {
				local50 = this.aClass96_6.method2352(local37 - 1);
				if (local50.anInt8272 != -1) {
					local70 = arg11[arg4][arg8 - 1];
					local498 = arg2[arg4][arg8 - 1];
					if (local50.aBoolean629) {
						local91 = 2;
						local509 = local498 * 2 + 4;
						local514 = Static718.method9374(local50, arg7);
						for (local516 = 0; local516 < 3; local516++) {
							local91 &= 0x7;
							local509 &= 0x7;
							if (Static499.aBooleanArrayArray7[local70][local509] && local50.anInt8274 >= Static615.anIntArray719[local91]) {
								Static319.anIntArray385[local91] = local50.anInt8272;
								Static262.anIntArray326[local91] = local514;
								Static153.anIntArray234[local91] = local50.anInt8278;
								Static725.anIntArray890[local91] = local50.anInt8273;
								if (Static615.anIntArray719[local91] == local50.anInt8274) {
									Static248.anIntArray313[local91] |= 0x20;
								} else {
									Static248.anIntArray313[local91] = 32;
								}
								Static615.anIntArray719[local91] = local50.anInt8274;
							}
							local91--;
							local509++;
						}
				...
				if (local50.anInt8272 != -1) {
					...
					if (local50.aBoolean629) {
						...
						for (local516 = 0; local516 < 3; local516++) {
							local91 &= 0x7;
							local509 &= 0x7;
							if (Static499.aBooleanArrayArray7[local70][local509] && Static615.anIntArray719[local91] <= local50.anInt8274) {
								Static319.anIntArray385[local91] = local50.anInt8272;
								Static262.anIntArray326[local91] = local514;
								Static153.anIntArray234[local91] = local50.anInt8278;
								Static725.anIntArray890[local91] = local50.anInt8273;
					...
					if (local50.aBoolean629) {
						...
						for (local516 = 0; local516 < 3; local516++) {
							...
							if (Static499.aBooleanArrayArray7[local70][local509] && Static615.anIntArray719[local91] <= local50.anInt8274) {
								...
								Static153.anIntArray234[local91] = local50.anInt8278;
								Static725.anIntArray890[local91] = local50.anInt8273;
								if (local50.anInt8274 == Static615.anIntArray719[local91]) {
		...
		local37 = Static718.method9374(arg1, arg7);
		if (!arg1.aBoolean629) {
			return;
		}
		for (@Pc(1245) int local1245 = 0; local1245 < 8; local1245++) {
			@Pc(1255) int local1255 = local1245 - arg5 * 2 & 0x7;
			if (Static499.aBooleanArrayArray7[arg0][local1245] && arg1.anInt8274 >= Static615.anIntArray719[local1255]) {
				Static319.anIntArray385[local1255] = arg1.anInt8272;
				Static262.anIntArray326[local1255] = local37;
				Static153.anIntArray234[local1255] = arg1.anInt8278;
				Static725.anIntArray890[local1255] = arg1.anInt8273;
				if (arg1.anInt8274 == Static615.anIntArray719[local1255]) {
					Static248.anIntArray313[local1255] |= 0x2;
				} else {
					Static248.anIntArray313[local1255] = 2;
				}
				Static615.anIntArray719[local1255] = arg1.anInt8274;
			}
		}
		return;
	}
	...
	public final void method7892(@OriginalArg(0) int[][] arg0) {
		@Pc(16) int[][] local16 = this.anIntArrayArrayArray17[0];
		for (@Pc(18) int local18 = 0; local18 < this.anInt8930 + 1; local18++) {
			for (@Pc(21) int local21 = 0; local21 < this.anInt8928 + 1; local21++) {
	...
	private void method7894(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) Class2_Sub21 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(10) boolean arg9) {
		if (arg0 == 1) {
			arg2 = 1;
		} else if (arg0 == 2) {
			arg6 = 1;
		...
		@Pc(50) int local50;
		if (arg3 < 0 || this.anInt8930 <= arg3 || arg1 < 0 || arg1 >= this.anInt8928) {
			while (true) {
				local50 = arg5.method7403();
				if (local50 == 0) {
					break;
				}
				if (local50 == 1) {
		...
		while (true) {
			...
			if (local50 == 1) {
				@Pc(194) int local194 = arg5.method7403();
				if (this.aBoolean674) {
			...
			if (local50 <= 49) {
				if (arg9) {
					...
					this.aByteArrayArrayArray15[arg8][arg3][arg1] = arg5.method7384();
	...
	public final void method7895(@OriginalArg(1) Class19 arg0, @OriginalArg(2) Class178 arg1, @OriginalArg(3) Class178 arg2) {
		if (Static397.anIntArray482 == null || this.anInt8928 != Static397.anIntArray482.length) {
			Static501.anIntArray606 = new int[this.anInt8928];
			Static418.anIntArray704 = new int[this.anInt8928];
			Static397.anIntArray482 = new int[this.anInt8928];
			Static359.anIntArray449 = new int[this.anInt8928];
			Static467.anIntArray568 = new int[this.anInt8928];
		}
		@Pc(45) int[][] local45 = new int[this.anInt8930][this.anInt8928];
		@Pc(50) int local50;
		for (@Pc(47) int local47 = 0; local47 < this.anInt8937; local47++) {
			for (local50 = 0; local50 < this.anInt8928; local50++) {
			...
			for (@Pc(78) int local78 = -5; local78 < this.anInt8930; local78++) {
				@Pc(86) int local86;
				@Pc(101) int local101;
				@Pc(170) int local170;
				for (@Pc(81) int local81 = 0; local81 < this.anInt8928; local81++) {
					local86 = local78 + 5;
					@Pc(150) int local150;
					if (local86 < this.anInt8930) {
						...
						if (local101 > 0) {
							...
							Static359.anIntArray449[local81] += local114.anInt6652;
					...
					if (local101 >= 0) {
						...
						if (local170 > 0) {
							...
							Static359.anIntArray449[local81] -= local180.anInt6652;
							local150 = Static418.anIntArray704[local81]--;
						}
					}
				}
				if (local78 >= 0) {
					...
					for (@Pc(244) int local244 = -5; local244 < this.anInt8928; local244++) {
						@Pc(249) int local249 = local244 + 5;
						if (this.anInt8928 > local249) {
						...
						if (local244 >= 0 && local240 > 0 && local242 > 0) {
							local45[local78][local244] = Static318.method8562(local170 / local242, local101 / local242, local86 * 256 / local240);
						}
					}
				}
			}
			if (Static718.aBoolean823) {
				this.method7897(local47 == 0 ? arg2 : null, local45, local47 == 0 ? arg1 : null, Static246.aClass178Array1[local47], arg0, local47);
			} else {
				this.method7889(local47, arg0, local45, local47 == 0 ? arg2 : null, Static246.aClass178Array1[local47], local47 == 0 ? arg1 : null);
			}
	...
	private void method7897(@OriginalArg(0) Class178 arg0, @OriginalArg(2) int[][] arg1, @OriginalArg(3) Class178 arg2, @OriginalArg(4) Class178 arg3, @OriginalArg(5) Class19 arg4, @OriginalArg(6) int arg5) {
		...
		for (@Pc(33) int local33 = 0; local33 < this.anInt8930; local33++) {
			@Pc(47) int local47 = this.anInt8930 - 1 > local33 ? local33 + 1 : local33;
			for (@Pc(49) int local49 = 0; local49 < this.anInt8928; local49++) {
				@Pc(67) int local67 = local49 < this.anInt8928 - 1 ? local49 + 1 : local49;
				if (Static478.anInt7219 == -1 || Static696.method9043(local49, Static478.anInt7219, local33, arg5)) {
					...
					if (local108 != 0 || local116 != 0) {
						...
						@Pc(391) int local391;
						@Pc(403) int local403;
						if ((local94 == 0 || local94 == 12) && local33 > 0 && local49 > 0 && local33 < this.anInt8930 && this.anInt8928 > local49) {
							...
							if (local391 == local403) {
								local391 = arg3.method7876(local49, local33) - arg3.method7876(local67, local47);
								if (local391 < 0) {
									local391 = -local391;
								}
								local403 = arg3.method7876(local49, local47) - arg3.method7876(local67, local33);
								if (local403 < 0) {
									local403 = -local403;
								}
							}
						...
						@Pc(496) boolean[] local496 = local164 != null && local164.aBoolean629 ? Static463.aBooleanArrayArray6[local94] : Static435.aBooleanArrayArray5[local94];
						this.method7890(local94, local164, local13, this.anInt8930, local33, local100, this.anInt8928, arg4, local49, local88, local177, local8, local31);
						@Pc(532) boolean local532 = local164 != null && local164.anInt8272 != local164.anInt8271;
						if (!local532) {
						...
						if (!local496[local100 + 1 & 0x3]) {
							local88[1] = Static588.method7719(local88[1], (Static248.anIntArray313[2] & Static248.anIntArray313[4]) == 0);
						}
						if (!local496[local100 + 3 & 0x3]) {
							local88[3] = Static588.method7719(local88[3], (Static248.anIntArray313[6] & Static248.anIntArray313[0]) == 0);
						}
						if (!local496[local100 & 0x3]) {
							local88[0] = Static588.method7719(local88[0], (Static248.anIntArray313[0] & Static248.anIntArray313[2]) == 0);
						}
						if (!local496[local100 + 2 & 0x3]) {
							local88[2] = Static588.method7719(local88[2], (Static248.anIntArray313[6] & Static248.anIntArray313[4]) == 0);
						}
						...
						if (local1021 <= 0) {
							Static527.method7091(arg5, local33, local49);
						} else {
							if (local88[0]) {
								local1021++;
							}
							...
							if (local164 != null) {
								local1117 = local164.anInt8273;
								local1113 = local164.anInt8272;
								local1115 = local164.anInt8278;
								local1162 = Static718.method9374(local164, arg4);
								for (local1164 = 0; local1164 < local403; local1164++) {
									...
									for (local1411 = 0; local1411 < local1277; local1411++) {
										...
										if (local1099 != null && Static499.aBooleanArrayArray7[local94][local1416]) {
											...
											local1099[local1064] = arg0.method7885(local1508, local1501) - arg3.method7885(local1508, local1501);
										}
										if (local1111 != null) {
											if (arg0 != null && !Static499.aBooleanArrayArray7[local94][local1416]) {
												local1501 = local1452 + (local33 << 9);
												local1508 = (local49 << 9) + local1448;
												local1111[local1064] = arg3.method7885(local1508, local1501) - arg0.method7885(local1508, local1501);
											} else if (arg2 != null && !Static355.aBooleanArrayArray4[local94][local1416]) {
												local1501 = local1452 + (local33 << 9);
												local1508 = local1448 + (local49 << 9);
												local1111[local1064] = arg2.method7885(local1508, local1501) - arg3.method7885(local1508, local1501);
											}
										}
										if (local1416 < 8 && Static615.anIntArray719[local1425] > local164.anInt8274) {
											if (local1076 != null) {
											...
											local1088[local1064] = local164.anInt8278;
											local1091[local1064] = local164.anInt8273;
								...
								if (!this.aBoolean674 && arg5 == 0) {
									Static295.method4361(local33, local49, local164.anInt8283, local164.anInt8275 * 8, local164.anInt8279);
								}
								if (local94 != 12 && local164.anInt8272 != -1 && local164.aBoolean628) {
									local83 = true;
								}
							} else if (local909) {
								...
								for (local1425 = 0; local1425 < local391; local1425++) {
									...
									for (local1430 = 0; local1430 < local1277; local1430++) {
										...
										if (local1099 != null && Static499.aBooleanArrayArray7[local94][local1452]) {
											...
											local1099[local1064] = arg0.method7885(local2112, local2106) - arg3.method7885(local2112, local2106);
										}
										if (local1111 != null) {
											if (arg0 != null && !Static499.aBooleanArrayArray7[local94][local1452]) {
												local2106 = (local33 << 9) + local1501;
												local2112 = local2056 + (local49 << 9);
												local1111[local1064] = arg3.method7885(local2112, local2106) - arg0.method7885(local2112, local2106);
											} else if (arg2 != null && !Static355.aBooleanArrayArray4[local94][local1452]) {
												local2106 = local1501 + (local33 << 9);
												local2112 = (local49 << 9) + local2056;
												local1111[local1064] = arg2.method7885(local2112, local2106) - arg3.method7885(local2112, local2106);
											}
										}
										if (local1452 < 8 && Static615.anIntArray719[local1435] >= 0) {
											...
											if (local85 && Static499.aBooleanArrayArray7[local94][local1452]) {
												...
												local1088[local1064] = local1750.anInt6653;
												local1091[local1064] = local1750.anInt6655;
											} else if (local1501 == 0 && local2056 == 512) {
												local1085[local1064] = arg1[local33][local67];
												local1088[local1064] = local1758.anInt6653;
												local1091[local1064] = local1758.anInt6655;
											} else if (local1501 == 512 && local2056 == 512) {
												local1085[local1064] = arg1[local47][local67];
												local1088[local1064] = local1766.anInt6653;
												local1091[local1064] = local1766.anInt6655;
											} else if (local1501 == 512 && local2056 == 0) {
												local1085[local1064] = arg1[local47][local49];
												local1088[local1064] = local1774.anInt6653;
												local1091[local1064] = local1774.anInt6655;
											} else {
												if (local1501 >= 256) {
													if (local2056 < 256) {
														local1088[local1064] = local1774.anInt6653;
							...
							local1162 = arg3.method7876(local49, local33);
							local1164 = arg3.method7876(local49, local47);
							local1411 = arg3.method7876(local67, local47);
							local1416 = arg3.method7876(local67, local33);
							@Pc(2560) boolean local2560 = Static441.method5975(local49, local33);
							if (local2560 && arg5 > 1 || !local2560 && arg5 > 0) {
								...
								if (local177 != null && !local177.aBoolean497) {
									...
									local2579 = false;
								} else if (local108 > 0 && local187 != null && !local187.aBoolean627) {
									local2579 = false;
								}
							...
							if (this.aBoolean674) {
								...
								local1452 = Static350.method5131(local33, local49);
								local1435 = Static339.method5012(local33, local49);
							}
	...
	public final void method7898(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) Class2_Sub21 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) Class110[] arg8) {
		...
		if (!this.aBoolean674) {
			...
			for (local32 = 0; local32 < 8; local32++) {
				for (@Pc(35) int local35 = 0; local35 < 8; local35++) {
					@Pc(49) int local49 = arg2 + Static633.method9437(local32 & 0x7, local35 & 0x7, arg6);
					local61 = arg4 + Static530.method7104(local35 & 0x7, local32 & 0x7, arg6);
					if (local49 > 0 && this.anInt8930 - 1 > local49 && local61 > 0 && local61 < this.anInt8928 - 1) {
		...
		for (local61 = 0; local61 < this.anInt8937; local61++) {
				...
				for (@Pc(156) int local156 = 0; local156 < 64; local156++) {
					if (arg1 == local61 && local153 >= local17 && local153 <= local17 + 8 && local23 <= local156 && local156 <= local23 + 8) {
						...
						if (local17 + 8 == local153 || local156 == local23 + 8) {
							...
							this.method7894(0, local252, 0, local243, local153 + local117, arg5, 0, local156 + local32, arg0, true);
						} else {
							local243 = arg2 + Static633.method9437(local153 & 0x7, local156 & 0x7, arg6);
							local252 = Static530.method7104(local156 & 0x7, local153 & 0x7, arg6) + arg4;
							this.method7894(arg6, local252, local127, local243, local153 + local117, arg5, local125, local156 + local32, arg0, false);
						}
