...
public final class Class316 {
	...
	public Class316(@OriginalArg(0) Class19_Sub1 arg0) {
		this.aClass244_16 = arg0.method5757(new Class237[] { new Class237(new Class157[] { Static231.aClass157_1, Static231.aClass157_3, Static231.aClass157_5 }), new Class237(Static231.aClass157_2) });
		this.anInterface16_11 = arg0.method5765(true);
		this.anInterface16_12 = arg0.method5765(false);
		this.anInterface16_12.method2238(12, 393168);
		this.anInterface20_5 = arg0.method5731(false);
		this.anInterface20_5.method6087(49146);
		@Pc(96) Buffer local96 = this.anInterface20_5.method6091();
		@Pc(112) int local112;
		if (local96 != null) {
			@Pc(103) Stream local103 = arg0.method5709(local96);
			@Pc(107) int local107;
			if (Stream.b()) {
			...
			local103.c();
			this.anInterface20_5.method6090();
		}
		@Pc(196) Buffer local196 = this.anInterface16_12.method2240();
		if (local196 != null) {
			@Pc(203) Stream local203 = arg0.method5709(local196);
			if (Stream.b()) {
			...
			local203.c();
			this.anInterface16_12.method2239();
		}
	}

	@OriginalMember(owner = "client!rc", name = "a", descriptor = "(B)V")
	public void method5050() {
		this.anInterface16_11.method6082();
	}

	@OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lclient!lk;IILclient!am;)V")
	public void method5051(@OriginalArg(0) Class230 arg0, @OriginalArg(1) int arg1, @OriginalArg(3) Class19_Sub1 arg2) {
		if (arg2.aClass73_Sub1_16 == null) {
			return;
		}
		if (arg1 < 0) {
			this.method5056(arg2);
		} else {
			this.method5054(arg1, arg2);
		}
		...
		try {
			...
			if (local116 + 2 > 1600) {
				local81 = Static434.method4154(local116) + 1 - Static328.anInt5425;
			...
			while (local50 != local47) {
				...
				arg2.method5717(false, local147 < 0 ? -1 : local147, false);
				if (local149 && Static260.aFloat75 != arg2.aFloat186) {
					arg2.xa(Static260.aFloat75);
				} else if (arg2.aFloat186 != 1.0F) {
					arg2.xa(1.0F);
				}
				this.method5057(local116, arg2);
			}
		} catch (@Pc(370) Exception local370) {
		}
		this.method5052(arg2);
	}

	@OriginalMember(owner = "client!rc", name = "a", descriptor = "(ILclient!am;)V")
	private void method5052(@OriginalArg(1) Class19_Sub1 arg0) {
		arg0.method5692(true);
		arg0.method5726(true);
	...
	public void method5053(@OriginalArg(0) Class19_Sub1 arg0) {
		this.anInterface16_11.method2238(24, 786336);
	}

	@OriginalMember(owner = "client!rc", name = "a", descriptor = "(IBLclient!am;)V")
	private void method5054(@OriginalArg(0) int arg0, @OriginalArg(2) Class19_Sub1 arg1) {
		Static260.aFloat75 = arg1.aFloat186;
		arg1.method5655((float) arg0);
		arg1.method5720();
		arg1.method5726(false);
		arg1.method5692(false);
		arg1.method5705();
	}

	@OriginalMember(owner = "client!rc", name = "a", descriptor = "(BLclient!am;)V")
	private void method5056(@OriginalArg(1) Class19_Sub1 arg0) {
		Static260.aFloat75 = arg0.aFloat186;
		arg0.method5653();
		arg0.method5726(false);
		arg0.method5692(false);
		arg0.method5705();
	}

	@OriginalMember(owner = "client!rc", name = "a", descriptor = "(IZLclient!am;)V")
	private void method5057(@OriginalArg(0) int arg0, @OriginalArg(2) Class19_Sub1 arg1) {
		@Pc(5) int local5 = 0;
		@Pc(9) Class73_Sub1 local9 = arg1.method5763();
		...
		@Pc(77) Buffer local77 = this.anInterface16_11.method2240();
		if (local77 == null) {
			return;
		}
		@Pc(91) Stream local91 = arg1.method5709(local77);
		@Pc(97) int local97;
		@Pc(114) int local114;
		@Pc(123) int local123;
		...
		local91.c();
		if (this.anInterface16_11.method2239()) {
			arg1.method5739(0, this.anInterface16_11);
			arg1.method5739(1, this.anInterface16_12);
			arg1.method5723(this.aClass244_16);
			arg1.method5661(0, 0, this.anInterface20_5, local5 * 4, Static104.aClass131_2, local5 * 2);
		}
	}
}
