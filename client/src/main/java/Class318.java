...
public final class Class318 {
	...
	public void method5087(@OriginalArg(1) Class2_Sub21 arg0) {
		while (true) {
			@Pc(7) int local7 = arg0.method5205();
			if (local7 == 0) {
				return;
			}
			this.method5088(arg0, local7);
		}
	}

	@OriginalMember(owner = "client!re", name = "a", descriptor = "(BLclient!ge;I)V")
	private void method5088(@OriginalArg(1) Class2_Sub21 arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 1) {
			this.anInt8249 = Static579.method5392(arg0.method5192());
		} else if (arg1 == 2) {
			this.anInt8255 = arg0.method5205();
		} else if (arg1 == 3) {
			this.anInt8255 = arg0.method5191();
			...
			this.anInt8248 = Static579.method5392(arg0.method5192());
		} else if (arg1 == 8) {
			this.aClass96_5.anInt2509 = this.anInt8253;
		} else if (arg1 == 9) {
			this.anInt8250 = arg0.method5191() << 2;
		} else if (arg1 == 10) {
			this.aBoolean627 = false;
		} else if (arg1 == 11) {
			this.anInt8251 = arg0.method5205();
		} else if (arg1 == 12) {
			this.aBoolean628 = true;
		} else if (arg1 == 13) {
			this.anInt8260 = arg0.method5192();
		} else if (arg1 == 14) {
			this.anInt8252 = arg0.method5205() << 2;
		} else if (arg1 == 16) {
			this.anInt8256 = arg0.method5205();
		}
	}
}
