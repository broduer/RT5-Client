...
public final class Class318 {
	...
	public Class318(@OriginalArg(0) Class19_Sub1 arg0) {
		this.aClass246_16 = arg0.method8155(new Class239[] { new Class239(new Class157[] { Static231.aClass157_1, Static231.aClass157_3, Static231.aClass157_5 }), new Class239(Static231.aClass157_2) });
		this.anInterface16_11 = arg0.method8163(true);
		this.anInterface16_12 = arg0.method8163(false);
		this.anInterface16_12.method3153(12, 393168);
		this.anInterface20_5 = arg0.method8129(false);
		this.anInterface20_5.method8550(49146);
		@Pc(96) Buffer local96 = this.anInterface20_5.method8554();
		@Pc(112) int local112;
		if (local96 != null) {
			@Pc(103) Stream local103 = arg0.method8107(local96);
			@Pc(107) int local107;
			if (Stream.b()) {
			...
			local103.c();
			this.anInterface20_5.method8553();
		}
		@Pc(196) Buffer local196 = this.anInterface16_12.method3155();
		if (local196 != null) {
			@Pc(203) Stream local203 = arg0.method8107(local196);
			if (Stream.b()) {
	...
	public void method7216() {
		this.anInterface16_11.method8545();
	}

	@OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lclient!lk;IILclient!am;)V")
	public void method7217(@OriginalArg(0) Class232 arg0, @OriginalArg(1) int arg1, @OriginalArg(3) Class19_Sub1 arg2) {
		if (arg2.aClass73_Sub1_16 == null) {
			return;
		}
		if (arg1 < 0) {
			this.method7222(arg2);
		} else {
			this.method7220(arg1, arg2);
		}
		...
		try {
			...
			for (local50 = local47.aClass8_Sub4_10; local50 != local47; local50 = local50.aClass8_Sub4_10) {
				...
				local81 = (int) (local29 * (float) (local54.anInt7557 >> 12) + local25 * (float) (local54.anInt7560 >> 12) + local33 * (float) (local54.anInt7559 >> 12) + local37);
				if (local81 < local41) {
					local41 = local81;
				}
				if (local43 < local81) {
			...
			while (local50 != local47) {
				...
				while (local47 != local50) {
					...
					if (local151) {
						...
						local151 = false;
						local147 = local184.anInt7563;
					}
					if (local39 > 0 && (local147 != local184.anInt7563 || local184.aBoolean574 != local149)) {
						local151 = true;
						break;
					}
					...
					if (local227 < 1600) {
						if (this.anIntArray635[local227] >= 64) {
							label102: {
								if (this.anIntArray635[local227] == 64) {
									if (this.anInt8223 == 64) {
										break label102;
									}
									this.anIntArray635[local227] += this.anInt8223++ + 1;
								}
				...
				arg2.method8115(false, local147 < 0 ? -1 : local147, false);
				if (local149 && Static260.aFloat75 != arg2.aFloat186) {
					arg2.xa(Static260.aFloat75);
				} else if (arg2.aFloat186 != 1.0F) {
					arg2.xa(1.0F);
				}
				this.method7223(local116, arg2);
			}
		} catch (@Pc(370) Exception local370) {
		}
		this.method7218(arg2);
	}

	@OriginalMember(owner = "client!rc", name = "a", descriptor = "(ILclient!am;)V")
	private void method7218(@OriginalArg(1) Class19_Sub1 arg0) {
		arg0.method8090(true);
		arg0.method8124(true);
	...
	public void method7219(@OriginalArg(0) Class19_Sub1 arg0) {
		this.anInterface16_11.method3153(24, 786336);
	}

	@OriginalMember(owner = "client!rc", name = "a", descriptor = "(IBLclient!am;)V")
	private void method7220(@OriginalArg(0) int arg0, @OriginalArg(2) Class19_Sub1 arg1) {
		Static260.aFloat75 = arg1.aFloat186;
		arg1.method8053((float) arg0);
		arg1.method8118();
		arg1.method8124(false);
		arg1.method8090(false);
		arg1.method8103();
	}

	@OriginalMember(owner = "client!rc", name = "a", descriptor = "(BLclient!am;)V")
	private void method7222(@OriginalArg(1) Class19_Sub1 arg0) {
		Static260.aFloat75 = arg0.aFloat186;
		arg0.method8051();
		arg0.method8124(false);
		arg0.method8090(false);
		arg0.method8103();
	}

	@OriginalMember(owner = "client!rc", name = "a", descriptor = "(IZLclient!am;)V")
	private void method7223(@OriginalArg(0) int arg0, @OriginalArg(2) Class19_Sub1 arg1) {
		@Pc(5) int local5 = 0;
		@Pc(9) Class73_Sub1 local9 = arg1.method8161();
		...
		@Pc(91) Stream local91 = arg1.method8107(local77);
		@Pc(97) int local97;
		@Pc(114) int local114;
		@Pc(123) int local123;
			...
			for (local97 = arg0 - 1; local97 >= 0; local97--) {
				...
				if (local114 > 0) {
					for (local123 = local114 - 1; local123 >= 0; local123--) {
						...
						local134 = local131.anInt7562;
						local139 = (byte) (local134 >> 16);
						local144 = (byte) (local134 >> 8);
						local147 = (byte) local134;
						local152 = (byte) (local134 >>> 24);
						local158 = (float) (local131.anInt7560 >> 12);
						local164 = (float) (local131.anInt7557 >> 12);
						local170 = (float) (local131.anInt7559 >> 12);
						local175 = local131.anInt7558 >> 12;
					...
					if (this.anIntArray635[local97] > 64) {
						...
						for (local134 = this.anIntArray634[local395] - 1; local134 >= 0; local134--) {
							...
							local413 = local410.anInt7562;
							local147 = (byte) (local413 >> 16);
							local152 = (byte) (local413 >> 8);
							local426 = (byte) local413;
							local431 = (byte) (local413 >>> 24);
							local170 = (float) (local410.anInt7560 >> 12);
							local443 = (float) (local410.anInt7557 >> 12);
							local449 = (float) (local410.anInt7559 >> 12);
							local454 = local410.anInt7558 >> 12;
		...
		if (this.anInterface16_11.method3154()) {
			arg1.method8137(0, this.anInterface16_11);
			arg1.method8137(1, this.anInterface16_12);
			arg1.method8121(this.aClass246_16);
			arg1.method8059(0, 0, this.anInterface20_5, local5 * 4, Static104.aClass131_2, local5 * 2);
		}
	}
}
