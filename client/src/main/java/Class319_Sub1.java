...
public final class Class319_Sub1 extends Class319 implements KeyListener, FocusListener {
	...
	private void method6039(@OriginalArg(0) char arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		@Pc(7) Class2_Sub18 local7 = new Class2_Sub18();
		local7.aChar4 = arg0;
		local7.anInt2881 = arg1;
		local7.anInt2886 = arg2;
		local7.aLong99 = Static588.method5469();
		this.aClass339_71.method5465(local7);
	}
	...
	@Override
	public Interface27 method6032() {
		return (Interface27) this.aClass339_70.method5459();
	}

	@OriginalMember(owner = "client!ui", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V")
	@Override
	public synchronized void keyReleased(@OriginalArg(0) KeyEvent arg0) {
		this.method6041(1, arg0);
	}
	...
	@Override
	public synchronized void method6035() {
		this.aClass339_70.method5454();
		for (@Pc(22) Class2_Sub18 local22 = (Class2_Sub18) this.aClass339_71.method5459(); local22 != null; local22 = (Class2_Sub18) this.aClass339_71.method5459()) {
			local22.anInt2885 = this.method6038();
			if (local22.anInt2886 == 0) {
				if (!this.aBooleanArray31[local22.anInt2881]) {
					...
					this.aClass339_70.method5465(local152);
					this.aBooleanArray31[local22.anInt2881] = true;
				}
				local22.anInt2886 = 2;
				this.aClass339_70.method5465(local22);
				...
				for (@Pc(65) int local65 = 0; local65 < 112; local65++) {
					if (this.aBooleanArray31[local65]) {
						...
						this.aClass339_70.method5465(local78);
	...
	public synchronized void keyPressed(@OriginalArg(0) KeyEvent arg0) {
		this.method6041(0, arg0);
	}

	@OriginalMember(owner = "client!ui", name = "a", descriptor = "(BILjava/awt/event/KeyEvent;)V")
	private void method6041(@OriginalArg(1) int arg0, @OriginalArg(2) KeyEvent arg1) {
		...
		if (local8 != 0) {
			this.method6039('\u0000', local8, arg0);
			arg1.consume();
		}
	}

	@OriginalMember(owner = "client!ui", name = "a", descriptor = "(ILjava/awt/Component;)V")
	private void method6042(@OriginalArg(1) Component arg0) {
		this.method6043();
	...
	public synchronized void keyTyped(@OriginalArg(0) KeyEvent arg0) {
		...
		if (local6 != '\u0000' && Static189.method1972(local6)) {
			this.method6039(local6, -1, 3);
			arg0.consume();
		}
	}
	...
	@Override
	public boolean method6033(@OriginalArg(1) int arg0) {
