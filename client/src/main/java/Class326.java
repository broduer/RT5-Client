...
public final class Class326 {
	...
	public void method5267(@OriginalArg(1) int arg0) {
		this.anInt8468 = arg0;
	}

	@OriginalMember(owner = "client!rr", name = "a", descriptor = "(B)Lclient!jma;")
	public Interface15 method5268() {
		return this.anInterface15_1;
	}

	@OriginalMember(owner = "client!rr", name = "a", descriptor = "(Lclient!jma;I)V")
	public void method5269(@OriginalArg(0) Interface15 arg0) {
		if (arg0.method4533() != this.aClass206_5) {
