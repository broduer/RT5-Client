...
public final class Class327 {
	...
	public Class327(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Component arg3) {
		...
		for (@Pc(38) int local38 = 0; local38 < Static568.anInt8497; local38++) {
			this.method5312(arg0, local32, local36, "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"£$%^&*()-_=+[{]};:'@#~,<.>/?\\| ÄËÏÖÜäëïöüÿßÁÀÉÈÍÌÓÒÚÙáàéèíìóòúùÂÊÎÔÛâêîôûÆæãÃõÕçÇ".charAt(local38), local38, false);
		}
		if (this.aBoolean653) {
			this.aBoolean653 = false;
			...
			for (@Pc(78) int local78 = 0; local78 < Static568.anInt8497; local78++) {
				this.method5312(arg0, local32, local36, "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"£$%^&*()-_=+[{]};:'@#~,<.>/?\\| ÄËÏÖÜäëïöüÿßÁÀÉÈÍÌÓÒÚÙáàéèíìóòúùÂÊÎÔÛâêîôûÆæãÃõÕçÇ".charAt(local78), local78, false);
			}
			if (!this.aBoolean653) {
				this.aBoolean653 = false;
				for (@Pc(103) int local103 = 0; local103 < Static568.anInt8497; local103++) {
					this.method5312(arg0, local32, local36, "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"£$%^&*()-_=+[{]};:'@#~,<.>/?\\| ÄËÏÖÜäëïöüÿßÁÀÉÈÍÌÓÒÚÙáàéèíìóòúùÂÊÎÔÛâêîôûÆæãÃõÕçÇ".charAt(local103), local103, true);
				}
			}
		}
	}
	...
	private void method5308(@OriginalArg(0) Class19 arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) boolean arg6) {
		if (arg5 == 0) {
			arg6 = false;
		}
		...
		for (@Pc(9) int local9 = 0; local9 < arg1.length(); local9++) {
			...
			if (arg6) {
				this.aClass23Array13[local16].a(arg3 + 1, arg4 + 1, 0, -16777216, 1);
			}
			this.aClass23Array13[local16].a(arg3, arg4, 0, local7, 1);
	...
	public int method5310(@OriginalArg(0) String arg0) {
		@Pc(1) int local1 = 0;
	...
	public void method5311(@OriginalArg(0) Class19 arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(5) int local5 = this.method5310(arg1) / 2;
		...
		if (arg2 - local5 <= this.anIntArray680[2] && (arg2 + local5 >= this.anIntArray680[0] && (arg3 - this.anInt8496 <= this.anIntArray680[3] && arg3 + this.anInt8498 >= this.anIntArray680[1]))) {
			this.method5308(arg0, arg1, this.anIntArray680, arg2 - local5, arg3, arg4, true);
		}
	}

	@OriginalMember(owner = "client!rt", name = "a", descriptor = "(Lclient!ha;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
	private void method5312(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Font arg1, @OriginalArg(2) FontMetrics arg2, @OriginalArg(3) char arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		...
		this.aClass23Array13[arg4] = arg0.a(local3, local3, local73, local120, 0, 7468);
	}
}
