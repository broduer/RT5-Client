...
public final class Class328 {
	...
	public Class379 method5316() {
		return Static444.method4230(this.anInt8506);
	}

	@OriginalMember(owner = "client!rv", name = "a", descriptor = "(ZIII)Lclient!rv;")
	public Class328 method5323(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
