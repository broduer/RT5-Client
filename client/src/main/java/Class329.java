...
public final class Class329 {
	...
	public Class329(@OriginalArg(0) Class19_Sub3 arg0) {
		...
		Static491.method6588(arg0);
		if (this.aBoolean655) {
			@Pc(31) byte[] local31 = Static377.method3773(false, Static599.anObject14);
			this.aClass93_Sub3_2 = new Class93_Sub3(arg0, 6410, 128, 128, 16, local31, 6410);
			@Pc(48) byte[] local48 = Static377.method3773(false, Static158.anObject5);
			this.aClass93_Sub3_1 = new Class93_Sub3(arg0, 6410, 128, 128, 16, local48, 6410);
			@Pc(63) Class202 local63 = arg0.aClass202_1;
			if (local63.method3205()) {
				local31 = Static377.method3773(false, Static71.anObject4);
				...
				if (local63.method3203(2.0F, this.aClass93_Sub3_3, local93)) {
					this.aClass93_Sub3_3.method6825();
				} else {
					this.aClass93_Sub3_3.method6821();
			...
			for (@Pc(125) int local125 = 0; local125 < 16; local125++) {
				@Pc(138) byte[] local138 = Static60.method792(Static599.anObject14, local125 * 2 * 128 * 128);
			...
			for (@Pc(164) int local164 = 0; local164 < 16; local164++) {
				@Pc(175) byte[] local175 = Static60.method792(Static158.anObject5, local164 * 128 * 256);
