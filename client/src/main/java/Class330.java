...
public final class Class330 {
	...
	public boolean method5341(@OriginalArg(0) String arg0, @OriginalArg(2) String arg1) {
		if (!this.method5365()) {
			return false;
		}
		@Pc(13) String local13 = arg0.toLowerCase();
		@Pc(16) String local16 = arg1.toLowerCase();
		@Pc(25) int local25 = this.aClass292_2.aClass100_1.method1580(Static95.method1210(local13));
		if (local25 < 0) {
			return false;
		} else {
			@Pc(41) int local41 = this.aClass292_2.aClass100Array1[local25].method1580(Static95.method1210(local16));
			return local41 >= 0;
		}
	}

	@OriginalMember(owner = "client!sb", name = "a", descriptor = "(BLjava/lang/String;)Z")
	public boolean method5342(@OriginalArg(1) String arg0) {
		@Pc(14) int local14 = this.method5354("");
		return local14 == -1 ? this.method5368(arg0, "") : this.method5368("", arg0);
	}

	@OriginalMember(owner = "client!sb", name = "e", descriptor = "(II)V")
	private void method5343(@OriginalArg(0) int arg0) {
		if (this.aBoolean656) {
			this.anObjectArray37[arg0] = this.aClass47_1.method4670(arg0);
		} else {
			this.anObjectArray37[arg0] = Static247.method2552(this.aClass47_1.method4670(arg0));
		}
	}

	@OriginalMember(owner = "client!sb", name = "a", descriptor = "(ZI)I")
	private int method5344(@OriginalArg(1) int arg0) {
		if (this.method5360(arg0)) {
			return this.anObjectArray37[arg0] == null ? this.aClass47_1.method4666(arg0) : 100;
		} else {
			return 0;
		}
	}
	...
	public boolean method5345(@OriginalArg(0) int arg0) {
		if (!this.method5365()) {
			return false;
		} else if (this.aClass292_2.anIntArray595.length == 1) {
			return this.method5350(arg0, 0);
		} else if (!this.method5360(arg0)) {
			return false;
		} else if (this.aClass292_2.anIntArray595[arg0] == 1) {
			return this.method5350(0, arg0);
		} else {
	...
	public int method5346() {
		...
		for (@Pc(22) int local22 = 0; local22 < this.anObjectArray37.length; local22++) {
			if (this.aClass292_2.anIntArray598[local22] > 0) {
				local18 += 100;
				local20 += this.method5344(local22);
			}
		}
		if (local18 == 0) {
			return 100;
	...
	public byte[] method5347(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2) {
		if (!this.method5348(arg1, arg2)) {
			return null;
		}
		if (this.anObjectArrayArray1[arg2] == null || this.anObjectArrayArray1[arg2][arg1] == null) {
			@Pc(33) boolean local33 = this.method5349(arg0, arg1, arg2);
			if (!local33) {
				this.method5343(arg2);
				local33 = this.method5349(arg0, arg1, arg2);
				if (!local33) {
					return null;
				}
			}
		}
		@Pc(61) byte[] local61 = Static377.method3773(false, this.anObjectArrayArray1[arg2][arg1]);
		if (this.anInt8555 == 1) {
	...
	private boolean method5348(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (!this.method5365()) {
			return false;
	...
	private boolean method5349(@OriginalArg(1) int[] arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		if (!this.method5360(arg2)) {
			return false;
			...
			if (arg0 == null || arg0[0] == 0 && arg0[1] == 0 && arg0[2] == 0 && arg0[3] == 0) {
				local138 = Static377.method3773(false, this.anObjectArray37[arg2]);
			} else {
				local138 = Static377.method3773(true, this.anObjectArray37[arg2]);
				@Pc(152) Class2_Sub21 local152 = new Class2_Sub21(local138);
				local152.method5203(arg0, local152.aByteArray93.length);
			}
			@Pc(164) byte[] local164;
			try {
				local164 = Static590.method5488(local138);
			} catch (@Pc(166) RuntimeException local166) {
				throw Static231.method2418(local166, "T3 - " + (arg0 != null) + "," + arg2 + "," + local138.length + "," + Static591.method5502(local138.length, local138) + "," + Static591.method5502(local138.length - 2, local138) + "," + this.aClass292_2.anIntArray599[arg2] + "," + this.aClass292_2.anInt7365);
			}
			if (this.aBoolean656) {
			...
			if (local32 <= 1) {
				...
				if (this.anInt8555 == 0) {
					local60[local243] = Static247.method2552(local164);
				} else {
				...
				if (this.anInt8555 == 2) {
					...
					for (local365 = 0; local365 < local279; local365++) {
						...
						for (local370 = 0; local370 < local32; local370++) {
							...
							if (local566 == arg1) {
								Static734.method5448(local164, local363, local539, local474, local368);
								local474 += local368;
							}
							local363 += local368;
						}
					...
					for (local365 = 0; local365 < local279; local365++) {
						...
						for (local370 = 0; local370 < local32; local370++) {
							local368 += local292.method5158();
							Static734.method5448(local164, local363, local336[local370], local298[local370], local368);
					...
					for (local368 = 0; local368 < local32; local368++) {
						...
						if (this.anInt8555 == 0) {
							local60[local370] = Static247.method2552(local336[local368]);
						} else {
	...
	public boolean method5351(@OriginalArg(0) String arg0) {
		if (this.method5365()) {
			@Pc(21) String local21 = arg0.toLowerCase();
			@Pc(30) int local30 = this.aClass292_2.aClass100_1.method1580(Static95.method1210(local21));
			return local30 >= 0;
		} else {
			return false;
		}
	...
	private void method5352(@OriginalArg(1) int arg0) {
		this.aClass47_1.method4665(arg0);
	}

	@OriginalMember(owner = "client!sb", name = "b", descriptor = "(BI)[B")
	public byte[] method5353(@OriginalArg(1) int arg0) {
		if (!this.method5365()) {
			return null;
		} else if (this.aClass292_2.anIntArray595.length == 1) {
	...
	public int method5354(@OriginalArg(0) String arg0) {
		if (this.method5365()) {
			@Pc(19) String local19 = arg0.toLowerCase();
			@Pc(28) int local28 = this.aClass292_2.aClass100_1.method1580(Static95.method1210(local19));
			return this.method5360(local28) ? local28 : -1;
		} else {
			return -1;
		}
	}
	...
	public int method5357(@OriginalArg(1) String arg0) {
		if (this.method5365()) {
			@Pc(24) String local24 = arg0.toLowerCase();
			@Pc(33) int local33 = this.aClass292_2.aClass100_1.method1580(Static95.method1210(local24));
			return this.method5344(local33);
		} else {
			return 0;
		}
	}
	...
	public byte[] method5359(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		return this.method5347((int[]) null, arg0, arg1);
	}

	@OriginalMember(owner = "client!sb", name = "d", descriptor = "(BI)Z")
	private boolean method5360(@OriginalArg(1) int arg0) {
		if (!this.method5365()) {
			return false;
	...
	public int method5361() {
		return this.method5365() ? this.aClass292_2.anIntArray595.length : -1;
	}

	@OriginalMember(owner = "client!sb", name = "a", descriptor = "(Ljava/lang/String;I)Z")
	public boolean method5362(@OriginalArg(0) String arg0) {
		if (this.method5365()) {
			@Pc(13) String local13 = arg0.toLowerCase();
			@Pc(22) int local22 = this.aClass292_2.aClass100_1.method1580(Static95.method1210(local13));
			return this.method5371(local22);
		} else {
			return false;
		}
	}
	...
	public int method5363(@OriginalArg(1) int arg0) {
		if (this.method5365()) {
			@Pc(17) int local17 = this.aClass292_2.aClass100_1.method1580(arg0);
			return this.method5360(local17) ? local17 : -1;
		} else {
			return -1;
		}
	}
	...
	public byte[] method5364(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1) {
		if (!this.method5365()) {
			return null;
		}
		@Pc(13) String local13 = arg0.toLowerCase();
		@Pc(16) String local16 = arg1.toLowerCase();
		@Pc(25) int local25 = this.aClass292_2.aClass100_1.method1580(Static95.method1210(local13));
		if (this.method5360(local25)) {
			@Pc(53) int local53 = this.aClass292_2.aClass100Array1[local25].method1580(Static95.method1210(local16));
			return this.method5359(local53, local25);
		} else {
			return null;
		}
	}
	...
	private boolean method5365() {
		if (this.aClass292_2 == null) {
			this.aClass292_2 = this.aClass47_1.method4671();
			if (this.aClass292_2 == null) {
				return false;
			}
	...
	public void method5366(@OriginalArg(0) String arg0) {
		if (this.method5365()) {
			@Pc(12) String local12 = arg0.toLowerCase();
			@Pc(29) int local29 = this.aClass292_2.aClass100_1.method1580(Static95.method1210(local12));
	...
	private boolean method5368(@OriginalArg(1) String arg0, @OriginalArg(2) String arg1) {
		if (!this.method5365()) {
			return false;
		}
		@Pc(13) String local13 = arg0.toLowerCase();
		...
		@Pc(25) int local25 = this.aClass292_2.aClass100_1.method1580(Static95.method1210(local13));
		if (this.method5360(local25)) {
			@Pc(44) int local44 = this.aClass292_2.aClass100Array1[local25].method1580(Static95.method1210(local16));
			return this.method5350(local44, local25);
		} else {
			return false;
		}
	}
	...
	public void method5369(@OriginalArg(1) int arg0) {
		if (this.method5360(arg0) && this.anObjectArrayArray1 != null) {
			this.anObjectArrayArray1[arg0] = null;
		}
	}

	@OriginalMember(owner = "client!sb", name = "b", descriptor = "(II)Z")
	public boolean method5371(@OriginalArg(1) int arg0) {
		if (!this.method5360(arg0)) {
			return false;
	...
	public int method5372(@OriginalArg(1) int arg0) {
		return this.method5360(arg0) ? this.aClass292_2.anIntArray595[arg0] : 0;
	}
}
