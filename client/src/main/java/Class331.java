...
public final class Class331 {
	...
	public Class331(@OriginalArg(0) Class19_Sub3 arg0) {
		this.aBoolean656 = arg0.aBoolean606;
		Static491.method9166(arg0);
		if (this.aBoolean656) {
			@Pc(31) byte[] local31 = Static377.method5328(false, Static599.anObject14);
			this.aClass93_Sub3_2 = new Class93_Sub3(arg0, 6410, 128, 128, 16, local31, 6410);
			@Pc(48) byte[] local48 = Static377.method5328(false, Static158.anObject5);
			this.aClass93_Sub3_1 = new Class93_Sub3(arg0, 6410, 128, 128, 16, local48, 6410);
			@Pc(63) Class204 local63 = arg0.aClass204_1;
			if (local63.method4589()) {
				local31 = Static377.method5328(false, Static71.anObject4);
				...
				if (local63.method4587(2.0F, this.aClass93_Sub3_3, local93)) {
					this.aClass93_Sub3_3.method9453();
				} else {
					this.aClass93_Sub3_3.method9449();
