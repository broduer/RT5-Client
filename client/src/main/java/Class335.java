...
public final class Class335 {
	...
	public Class2_Sub2_Sub6 method5411(@OriginalArg(0) int arg0) {
		...
		synchronized (this.aClass330_107) {
			local39 = this.aClass330_107.method5359(arg0, 5);
		}
		local16 = new Class2_Sub2_Sub6();
		if (local39 != null) {
			local16.method1250(new Class2_Sub21(local39));
		}
		@Pc(63) Class82 local63 = this.aClass82_188;
		synchronized (this.aClass82_188) {
			this.aClass82_188.method1384(local16, (long) arg0);
			return local16;
		}
	}
}
