...
public final class Class342 {
	...
	public Class342(@OriginalArg(0) Class377 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class330 arg2) {
		...
		if (this.aClass330_111 == null) {
			...
			this.anInt8769 = this.aClass330_111.method5372(47);
		}
	}
	...
	public void method5523() {
		...
		synchronized (this.aClass82_192) {
			this.aClass82_192.method1381(5);
		}
	}

	@OriginalMember(owner = "client!sn", name = "b", descriptor = "(II)Lclient!fc;")
	public Class122 method5524(@OriginalArg(0) int arg0) {
		@Pc(6) Class82 local6 = this.aClass82_192;
		@Pc(16) Class122 local16;
		synchronized (this.aClass82_192) {
			local16 = (Class122) this.aClass82_192.method1390((long) arg0);
		}
		if (local16 != null) {
			return local16;
		}
		...
		synchronized (this.aClass330_111) {
			local39 = this.aClass330_111.method5359(arg0, 47);
		}
		local16 = new Class122();
		if (local39 != null) {
			local16.method1752(new Class2_Sub21(local39));
		}
		@Pc(63) Class82 local63 = this.aClass82_192;
		synchronized (this.aClass82_192) {
			this.aClass82_192.method1384(local16, (long) arg0);
			return local16;
		}
	}
