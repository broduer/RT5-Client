...
public final class Class348_Sub1 extends Class348 {
	...
	@Override
	public void method5628(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) throws IOException {
		this.aClass385_1.method6367(arg0, arg1);
	}

	@OriginalMember(owner = "client!tc", name = "a", descriptor = "(B[BII)I")
	@Override
	public int method5626(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) throws IOException {
		return this.aClass190_1.method2904(arg1, arg2, arg0);
	}

	@OriginalMember(owner = "client!tc", name = "a", descriptor = "(II)Z")
	@Override
	public boolean method5629(@OriginalArg(0) int arg0) throws IOException {
		return this.aClass190_1.method2899(arg0);
	}
	...
	public void method5623() {
		...
		this.aClass190_1.method2902();
		this.aClass385_1.method6366();
	}
	...
	public void method5624() {
		this.aClass190_1.method2900();
		this.aClass385_1.method6369();
	}
}
