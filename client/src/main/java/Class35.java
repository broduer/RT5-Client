...
public abstract class Class35 {
	...
	protected final void method4112() {
			...
			for (@Pc(77) int local77 = 0; local77 < 128; local77++) {
				for (@Pc(80) int local80 = 0; local80 < 128; local80++) {
					for (@Pc(83) int local83 = 0; local83 < this.anInt6505; local83++) {
						...
						@Pc(307) int local307 = Static487.method4572(local99, this.aShortArray98[local167 + local295], local122, local187);
						@Pc(319) int local319 = Static487.method4572(local99, this.aShortArray98[local295 + local159], local263, local187);
						@Pc(329) int local329 = ((local319 - local307) * local237 >> 12) + local307;
						@Pc(341) int local341 = Static487.method4572(local99, this.aShortArray98[local167 + local274], local122, local259);
						@Pc(353) int local353 = Static487.method4572(local99, this.aShortArray98[local159 + local274], local263, local259);
						@Pc(364) int local364 = local341 + (local237 * (local353 - local341) >> 12);
						@Pc(377) int local377 = Static487.method4572(local267, this.aShortArray98[local167 + local281], local122, local187);
						@Pc(388) int local388 = (local241 * (local364 - local329) >> 12) + local329;
						@Pc(400) int local400 = Static487.method4572(local267, this.aShortArray98[local281 + local159], local263, local187);
						@Pc(411) int local411 = local377 + (local237 * (local400 - local377) >> 12);
						@Pc(424) int local424 = Static487.method4572(local267, this.aShortArray98[local167 + local288], local122, local259);
						@Pc(436) int local436 = Static487.method4572(local267, this.aShortArray98[local159 + local288], local263, local259);
						@Pc(447) int local447 = ((local436 - local424) * local237 >> 12) + local424;
						@Pc(458) int local458 = ((local447 - local411) * local241 >> 12) + local411;
						this.method4115((local245 * (local458 - local388) >> 12) + local388, local83);
					}
					this.method4114();
				}
			}
	...
	protected abstract void method4114();

	@OriginalMember(owner = "client!lea", name = "a", descriptor = "(III)V")
	protected abstract void method4115(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1);
	...
	private void method4116() {
		...
		for (@Pc(25) int local25 = 0; local25 < 255; local25++) {
			...
			@Pc(42) int local42 = Static623.method5895(-5208, local37, local10);
	...
	protected abstract void method4118();
}
