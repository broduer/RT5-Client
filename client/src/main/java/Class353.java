...
public final class Class353 {
	...
	public Class353(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2) {
		...
		this.anInt9369 = arg1.method5205();
		this.aBoolean716 = (this.anInt9369 & 0x10) != 0;
		this.aBoolean717 = (this.anInt9369 & 0x8) != 0;
		this.anInt9369 &= 0x7;
		@Pc(47) int local47 = arg1.method5191() << arg2;
		@Pc(53) int local53 = arg1.method5191() << arg2;
		@Pc(59) int local59 = arg1.method5191() << arg2;
		@Pc(63) int local63 = arg1.method5205();
		...
		for (@Pc(75) int local75 = 0; local75 < this.aShortArray131.length; local75++) {
			@Pc(81) short local81 = (short) arg1.method5191();
			local85 = local81 >>> 8;
			if (local85 >= local69) {
				local85 = local69 - 1;
			}
		...
		@Pc(160) int local160 = Static154.anIntArray237 == null ? Static323.anIntArray389[Static105.method1299(arg1.method5191()) & 0xFFFF] : Static154.anIntArray237[arg1.method5191()];
		local85 = arg1.method5205();
		this.anInt9371 = (local85 & 0xE0) << 3;
		this.anInt9380 = local85 & 0x1F;
		if (this.anInt9380 != 31) {
			this.method5826();
		}
		this.method5825(arg0, local53, local59, local47, local160, local63);
	}

	@OriginalMember(owner = "client!th", name = "a", descriptor = "(ZIB)V")
	public void method5820(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
		@Pc(71) int local71;
		if (arg0) {
			local71 = 2048;
		} else {
		...
		this.aClass2_Sub7_3.method5987((float) ((this.anInt9370 * local71 >> 11) + this.anInt9378) / 2048.0F);
	}

	@OriginalMember(owner = "client!th", name = "a", descriptor = "(IBIII)V")
	public void method5823(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		this.anInt9377 = arg3;
		this.anInt9378 = arg0;
		this.anInt9379 = arg1;
		this.anInt9370 = arg2;
	...
	private void method5825(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		this.aClass2_Sub7_3 = arg0.a(arg3, arg2, arg1, arg5, arg4, (float) 1);
	}
