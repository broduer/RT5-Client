...
public final class Class354 implements Interface22 {
	...
	public Class354(@OriginalArg(0) Class76 arg0, @OriginalArg(1) Class398 arg1) {
		...
		for (@Pc(15) int local15 = 0; local15 < this.anInterface13Array1.length; local15++) {
			this.anInterface13Array1[local15] = arg1.method6597(this.aClass76_1.anInterface10Array1[local15]);
		}
	}
	...
	public boolean method6017(@OriginalArg(1) long arg0) {
		return Static588.method5469() >= (long) this.aClass76_1.anInt2140 + arg0;
	}
	...
	public int method6014() {
		...
		for (@Pc(20) int local20 = 0; local20 < local10.length; local20++) {
			...
			if (local26 == null || local26.method5491()) {
				local7++;
			}
		}
