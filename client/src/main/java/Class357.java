...
public final class Class357 {
	...
	public Class357(@OriginalArg(0) Class2_Sub21 arg0) {
		...
		for (@Pc(37) int local37 = 0; local37 < local7; local37++) {
			this.anIntArray733[local37] = arg0.method5191() - 5120;
			this.anIntArray732[local37] = arg0.method5191() - 5120;
			this.anIntArray735[local37] = arg0.method5165();
			this.anIntArray729[local37] = arg0.method5191() - 5120;
			this.anIntArray734[local37] = arg0.method5191() - 5120;
			this.anIntArray731[local37] = arg0.method5165();
			this.anIntArray730[local37] = arg0.method5165();
		}
	}

	@OriginalMember(owner = "client!tn", name = "b", descriptor = "(II)V")
	public void method5897(@OriginalArg(0) int arg0) {
