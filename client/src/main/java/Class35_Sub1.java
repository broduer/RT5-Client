...
public class Class35_Sub1 extends Class35 {
	...
	@Override
	protected final void method4114() {
		this.anInt6060 = Math.abs(this.anInt6060);
		if (this.anInt6060 >= 4096) {
			this.anInt6060 = 4095;
		}
		this.method3847(this.anInt6056++, (byte) (this.anInt6060 >> 4));
		this.anInt6060 = 0;
	}

	@OriginalMember(owner = "client!uw", name = "a", descriptor = "(I)V")
	@Override
	protected final void method4118() {
		this.anInt6060 = 0;
		this.anInt6056 = 0;
	}
	...
	@Override
	protected final void method4115(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.anInt6060 += this.anIntArray467[arg1] * arg0 >> 12;
	}

	@OriginalMember(owner = "client!uw", name = "a", descriptor = "(BIB)V")
	protected void method3847(@OriginalArg(1) int arg0, @OriginalArg(2) byte arg1) {
