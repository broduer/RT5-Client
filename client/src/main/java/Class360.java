...
public final class Class360 {
	...
	public Class360() {
		Static650.method6049(16);
		this.anInt9477 = Static650.method6058() == 0 ? 1 : Static650.method6049(4) + 1;
		if (Static650.method6058() != 0) {
			Static650.method6049(8);
		}
		Static650.method6049(2);
		if (this.anInt9477 > 1) {
			this.anInt9478 = Static650.method6049(4);
		}
		...
		for (@Pc(42) int local42 = 0; local42 < this.anInt9477; local42++) {
			Static650.method6049(8);
			this.anIntArray738[local42] = Static650.method6049(8);
			this.anIntArray739[local42] = Static650.method6049(8);
		}
	}
}
