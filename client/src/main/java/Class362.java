...
public final class Class362 implements Runnable {
	...
	public Class323 method5910(@OriginalArg(1) int arg0) {
	...
	public void run() {
		try {
			...
			@Pc(22) Class396 local22 = Static640.method5990();
			while (local19 != null) {
				local22.method6578(local19);
				local19 = local16.readLine();
			}
			@Pc(39) String[] local39 = local22.method6580();
	...
	public boolean method5913() {
		...
		if (this.aClass270_7 == null) {
			try {
				...
				this.aClass270_7 = Static446.aClass390_6.method6433(new URL("http://" + Static527.aClass229_3.aString60 + ":" + local23 + "/news.ws?game=" + Static392.aClass377_4.anInt9720));
