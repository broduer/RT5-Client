...
public final class Class363 {
	...
	public Class363(@OriginalArg(0) Class377 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class330 arg2, @OriginalArg(3) Class330 arg3) {
		...
		this.aClass330_115.method5372(34);
	}
	...
	public void method5924() {
		...
		synchronized (this.aClass82_201) {
			this.aClass82_201.method1385();
		}
		local2 = this.aClass82_202;
		synchronized (this.aClass82_202) {
			this.aClass82_202.method1385();
		}
	}
	...
	public void method5925() {
		...
		synchronized (this.aClass82_201) {
			this.aClass82_201.method1391();
		}
		local10 = this.aClass82_202;
		synchronized (this.aClass82_202) {
			this.aClass82_202.method1391();
		}
	}

	@OriginalMember(owner = "client!u", name = "b", descriptor = "(II)Lclient!ia;")
	public Class173 method5926(@OriginalArg(0) int arg0) {
		@Pc(6) Class82 local6 = this.aClass82_201;
		@Pc(16) Class173 local16;
		synchronized (this.aClass82_201) {
			local16 = (Class173) this.aClass82_201.method1390((long) arg0);
		}
		if (local16 != null) {
			return local16;
		}
		...
		synchronized (this.aClass330_115) {
			local39 = this.aClass330_115.method5359(arg0, 34);
		}
		local16 = new Class173();
		local16.aClass363_2 = this;
		if (local39 != null) {
			local16.method2661(new Class2_Sub21(local39));
		}
		@Pc(68) Class82 local68 = this.aClass82_201;
		synchronized (this.aClass82_201) {
			this.aClass82_201.method1384(local16, (long) arg0);
			return local16;
		}
	}

	@OriginalMember(owner = "client!u", name = "a", descriptor = "(III)V")
	public void method5929(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
	...
	public void method5931() {
		@Pc(6) Class82 local6 = this.aClass82_201;
		synchronized (this.aClass82_201) {
			this.aClass82_201.method1381(5);
		}
		local6 = this.aClass82_202;
		synchronized (this.aClass82_202) {
			this.aClass82_202.method1381(5);
		}
	}
}
