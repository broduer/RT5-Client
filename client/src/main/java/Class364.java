...
public final class Class364 implements Runnable {
	...
	public synchronized void method5937(@OriginalArg(1) Interface22 arg0) {
		this.anInterface22_2 = this.anInterface22_1;
		this.anInterface22_1 = arg0;
		this.aLong286 = Static588.method5469();
	}

	@OriginalMember(owner = "client!uaa", name = "a", descriptor = "(ILjava/lang/String;Lclient!gca;IJ)V")
	public synchronized void method5938(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) Class140 arg2, @OriginalArg(4) long arg3) {
		this.anInt9524 = arg0;
	...
	public int method5939() {
		...
		@Pc(22) int local22 = this.aClass140_23.method2057();
	...
	public synchronized boolean method5940() {
		return this.anInterface22_1.method6017(this.aLong286);
	}

	@OriginalMember(owner = "client!uaa", name = "d", descriptor = "(B)Ljava/lang/String;")
	public String method5941() {
	...
	public void run() {
		while (!this.aBoolean732) {
			@Pc(8) long local8 = Static588.method5469();
			synchronized (this) {
				try {
					this.anInt9523++;
					if (this.anInterface22_1 instanceof Class374) {
						this.anInterface22_1.method6019(this.aBoolean731);
					} else {
						@Pc(25) long local25 = Static588.method5469();
						if (Static163.aClass19_17 == null || this.anInterface22_2 == null || this.anInterface22_2.method6016() == 0 || this.aLong286 < local25 - (long) this.anInterface22_2.method6016()) {
							if (this.anInterface22_2 != null) {
								this.aBoolean731 = true;
								this.anInterface22_2.method6015();
							...
							this.anInterface22_1.method6019(this.aBoolean731 || Static163.aClass19_17 != null && Static163.aClass19_17.B());
						} else {
							@Pc(72) int local72 = (int) ((local25 - this.aLong286) * 255L / (long) this.anInterface22_2.method6016());
							@Pc(77) int local77 = 255 - local72;
							Static288.method2880();
							@Pc(85) int local85 = local77 << 24 | 0xFFFFFF;
							@Pc(91) int local91 = local72 << 24 | 0xFFFFFF;
							Static163.aClass19_17.GA(0);
							@Pc(100) Class23 local100 = Static163.aClass19_17.a(Static680.anInt10289, Static380.anInt5979, true);
							Static163.aClass19_17.a((Class23) local100, -1);
							this.anInterface22_2.method6019(true);
							Static163.aClass19_17.v();
							local100.a(0, 0, 0, local85, 1);
							Static163.aClass19_17.a((Class23) local100, -1);
							Static163.aClass19_17.GA(0);
							this.anInterface22_1.method6019(true);
							Static163.aClass19_17.v();
							local100.a(0, 0, 0, local91, 1);
						}
						try {
							...
							Static240.method2529(local205, local205.getMessage() + " (Recovered) " + Static295.aClient1.method1068());
							Static32.method432(0, true);
						}
					}
					...
					if (Static163.aClass19_17 != null && !(this.anInterface22_1 instanceof Class374) && this.aClass140_23.method2057() < Static198.aClass140_19.method2057()) {
			...
			@Pc(304) long local304 = Static588.method5469();
			@Pc(312) int local312 = (int) (local8 + 20L - local304);
			if (local312 > 0) {
				Static638.method5959((long) local312);
			}
		}
	}
