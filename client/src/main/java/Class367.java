...
public final class Class367 {
	...
	public Class367(@OriginalArg(0) Class2_Sub21 arg0) {
		this.method5950(arg0);
	}

	@OriginalMember(owner = "client!uc", name = "a", descriptor = "(Lclient!ge;I)V")
	public void method5948(@OriginalArg(0) Class2_Sub21 arg0) {
		@Pc(17) int local17 = arg0.method5191();
		...
		this.aClass148_5 = Static344.method3529(local25, local17, local21, local29);
	}

	@OriginalMember(owner = "client!uc", name = "a", descriptor = "(Lclient!ge;Z)V")
	public void method5949(@OriginalArg(0) Class2_Sub21 arg0) {
		this.aFloat201 = (float) (arg0.method5205() * 8) / 255.0F;
		this.aFloat200 = (float) (arg0.method5205() * 8) / 255.0F;
		this.aFloat203 = (float) (arg0.method5205() * 8) / 255.0F;
	}

	@OriginalMember(owner = "client!uc", name = "b", descriptor = "(Lclient!ge;I)V")
	public void method5950(@OriginalArg(0) Class2_Sub21 arg0) {
		@Pc(7) int local7 = arg0.method5205();
		if (Static400.aClass2_Sub34_28.aClass57_Sub24_1.method4957() == 1 && Static425.aClass19_13.e() > 0) {
			if ((local7 & 0x1) == 0) {
				this.anInt9537 = Static68.anInt4096;
			} else {
				this.anInt9537 = arg0.method5158();
			}
			if ((local7 & 0x2) == 0) {
				this.aFloat204 = 1.1523438F;
			} else {
				this.aFloat204 = (float) arg0.method5191() / 256.0F;
			}
			if ((local7 & 0x4) == 0) {
				this.aFloat205 = 0.69921875F;
			} else {
				this.aFloat205 = (float) arg0.method5191() / 256.0F;
			}
			if ((local7 & 0x8) == 0) {
				this.aFloat202 = 1.2F;
			} else {
				this.aFloat202 = (float) arg0.method5191() / 256.0F;
			}
		} else {
			if ((local7 & 0x1) != 0) {
				arg0.method5158();
		...
		if ((local7 & 0x10) == 0) {
			...
			this.anInt9535 = arg0.method5165();
			this.anInt9533 = arg0.method5165();
			this.anInt9534 = arg0.method5165();
		}
		if ((local7 & 0x20) == 0) {
			this.anInt9538 = Static563.anInt8460;
		} else {
			this.anInt9538 = arg0.method5158();
		}
		if ((local7 & 0x40) == 0) {
			this.anInt9539 = 0;
		} else {
			this.anInt9539 = arg0.method5191();
		}
		if ((local7 & 0x80) == 0) {
			this.aClass67_10 = Static226.aClass67_9;
			return;
		}
		@Pc(251) int local251 = arg0.method5191();
		@Pc(255) int local255 = arg0.method5191();
		@Pc(261) int local261 = arg0.method5191();
		@Pc(265) int local265 = arg0.method5191();
		@Pc(271) int local271 = arg0.method5191();
		@Pc(275) int local275 = arg0.method5191();
		this.aClass67_10 = Static373.method3753(local271, local255, local261, local265, local275, local251);
	}

	@OriginalMember(owner = "client!uc", name = "a", descriptor = "(BLclient!uc;)Z")
	public boolean method5952(@OriginalArg(1) Class367 arg0) {
