...
public final class Class369 {
	...
	public Class369(@OriginalArg(0) Class2_Sub21 arg0) {
		this.method8393(arg0);
	}

	@OriginalMember(owner = "client!uc", name = "a", descriptor = "(Lclient!ge;I)V")
	public void method8391(@OriginalArg(0) Class2_Sub21 arg0) {
		@Pc(17) int local17 = arg0.method7389();
	...
	public void method8392(@OriginalArg(0) Class2_Sub21 arg0) {
		this.aFloat201 = (float) (arg0.method7403() * 8) / 255.0F;
		this.aFloat200 = (float) (arg0.method7403() * 8) / 255.0F;
		this.aFloat203 = (float) (arg0.method7403() * 8) / 255.0F;
	}

	@OriginalMember(owner = "client!uc", name = "b", descriptor = "(Lclient!ge;I)V")
	public void method8393(@OriginalArg(0) Class2_Sub21 arg0) {
		...
		if (Static400.aClass2_Sub34_28.aClass57_Sub24_1.method7089() == 1 && Static425.aClass19_13.method7962() > 0) {
			if ((local7 & 0x1) == 0) {
				...
				this.anInt9563 = arg0.method7356();
			}
			if ((local7 & 0x2) == 0) {
				this.aFloat204 = 1.1523438F;
			} else {
				this.aFloat204 = (float) arg0.method7389() / 256.0F;
			}
			if ((local7 & 0x4) == 0) {
				this.aFloat205 = 0.69921875F;
			} else {
				this.aFloat205 = (float) arg0.method7389() / 256.0F;
			}
			if ((local7 & 0x8) == 0) {
				this.aFloat202 = 1.2F;
			} else {
				this.aFloat202 = (float) arg0.method7389() / 256.0F;
			}
		} else {
			if ((local7 & 0x1) != 0) {
				arg0.method7356();
		...
		if ((local7 & 0x20) == 0) {
			...
			this.anInt9564 = arg0.method7356();
		}
		if ((local7 & 0x40) == 0) {
			this.anInt9565 = 0;
		} else {
			this.anInt9565 = arg0.method7389();
		}
		if ((local7 & 0x80) == 0) {
			this.aClass67_10 = Static226.aClass67_9;
			return;
		}
		@Pc(251) int local251 = arg0.method7389();
		@Pc(255) int local255 = arg0.method7389();
		@Pc(261) int local261 = arg0.method7389();
		@Pc(265) int local265 = arg0.method7389();
		@Pc(271) int local271 = arg0.method7389();
		@Pc(275) int local275 = arg0.method7389();
