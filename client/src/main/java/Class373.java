...
public final class Class373 {
			...
			if (this.aClass19_Sub3_36.aBoolean618) {
					...
					for (local123 = 0; local123 < local25; local123++) {
						...
						if (local131 != null) {
							for (local135 = 0; local135 < local131.length; local135++) {
								local103.method5182(local131[local135] & 0xFFFF);
							}
						}
					}
				}
				...
				for (local53 = 0; local53 < local25; local53++) {
					...
					for (local123 = 0; local123 < local25; local123++) {
						...
						if (local131 != null) {
							for (local135 = 0; local135 < local131.length; local135++) {
								local103.method5163(local131[local135] & 0xFFFF);
							}
						}
					}
				}
			}
			this.anInterface1_5 = this.aClass19_Sub3_36.method4885(false, local103.anInt8388, local103.aByteArray93);
	...
	private void method6006(@OriginalArg(1) int arg0, @OriginalArg(2) Interface1 arg1) {
		if (arg0 != 0) {
			this.method6009();
			this.aClass19_Sub3_36.method4876(this.aClass93_Sub2_6);
			this.aClass19_Sub3_36.method4909(0, arg1, arg0);
		}
	}
	...
	private void method6009() {
		...
		if (this.aClass93_Sub2_6 == null) {
			...
			this.aClass93_Sub2_6.method2051(false, false);
			this.aClass93_Sub2_6.method6817(true);
		} else {
			this.aClass93_Sub2_6.method2050(6406, 128, 128, this.aClass19_Sub3_36.aByteArray90, false);
		}
	}

	@OriginalMember(owner = "client!uga", name = "a", descriptor = "(I)V")
	public void method6010() {
		this.method6006(this.anInt9627, this.anInterface1_5);
	}

	@OriginalMember(owner = "client!uga", name = "a", descriptor = "(I[BBI)V")
	public void method6013(@OriginalArg(1) byte[] arg0, @OriginalArg(3) int arg1) {
		this.aClass134_Sub2_2.method6744(arg1 * this.aClass19_Sub3_36.method4898(5123), arg0);
		this.method6006(arg1, this.aClass134_Sub2_2);
	}
}
