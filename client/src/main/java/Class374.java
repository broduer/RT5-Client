...
public final class Class374 implements Interface22 {
	...
	private int method6020(@OriginalArg(1) int arg0) {
		return this.aBoolean740 ? (Static380.anInt5979 - arg0) / 2 : 0;
	}

	@OriginalMember(owner = "client!uh", name = "a", descriptor = "(II)I")
	private int method6023(@OriginalArg(1) int arg0) {
		return this.aBoolean739 ? (Static680.anInt10289 - arg0) / 2 : 0;
	}

	@OriginalMember(owner = "client!uh", name = "f", descriptor = "(I)V")
	private void method6024() throws IllegalAccessException, NoSuchFieldException {
		@Pc(6) Class local6 = Static166.anApplet1.getClass();
		this.anImage4 = (Image) this.method6030(local6, "bar");
		this.anImage6 = (Image) this.method6030(local6, "background");
		this.anImage11 = (Image) this.method6030(local6, "left");
		this.anImage5 = (Image) this.method6030(local6, "right");
		this.anImage8 = (Image) this.method6030(local6, "top");
		this.anImage7 = (Image) this.method6030(local6, "bottom");
		this.anImage9 = (Image) this.method6030(local6, "bodyLeft");
		this.anImage12 = (Image) this.method6030(local6, "bodyRight");
		this.anImage10 = (Image) this.method6030(local6, "bodyFill");
		this.aFont2 = (Font) this.method6030(local6, "bf");
		this.aFontMetrics1 = (FontMetrics) this.method6030(local6, "bfm");
		this.aColor1 = (Color) this.method6030(local6, "colourtext");
		@Pc(134) Object local134 = this.method6030(local6, "lb");
		@Pc(137) Class local137 = local134.getClass();
		this.aBoolean739 = this.method6031(local134, local137, "xMiddle");
		this.aBoolean740 = this.method6031(local134, local137, "yMiddle");
		this.anInt9645 = this.method6026(local137, local134, "xOffset");
		this.anInt9646 = this.method6026(local137, local134, "yOffset");
		this.anInt9638 = this.method6026(local137, local134, "width");
		this.anInt9648 = this.method6026(local137, local134, "height");
		this.anInt9634 = this.method6026(local137, local134, "boxXOffset");
		this.anInt9643 = this.method6026(local137, local134, "boxYOffset");
		this.anInt9640 = this.method6026(local137, local134, "boxWidth");
		this.anInt9632 = this.method6026(local137, local134, "textYOffset");
		this.anInt9644 = this.method6026(local137, local134, "offsetPerTenCycles");
	}

	@OriginalMember(owner = "client!uh", name = "a", descriptor = "(I)V")
	@Override
	public void method6015() {
		Static137.method1552();
	}

	@OriginalMember(owner = "client!uh", name = "a", descriptor = "(Z)V")
	private void method6025() {
		Static305.method3094(Static449.aClass364_1.method5942(), Static337.aColorArray1[Static338.anInt5562], Static399.aColorArray2[Static338.anInt5562], Static718.aColorArray3[Static338.anInt5562], Static449.aClass364_1.method5941());
	}

	@OriginalMember(owner = "client!uh", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/Object;ZLjava/lang/String;)I")
	private int method6026(@OriginalArg(0) Class arg0, @OriginalArg(1) Object arg1, @OriginalArg(3) String arg2) throws IllegalAccessException, NoSuchFieldException {
	...
	@Override
	public boolean method6017(@OriginalArg(1) long arg0) {
		return true;
	}

	@OriginalMember(owner = "client!uh", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;B)Ljava/lang/Object;")
	private Object method6030(@OriginalArg(0) Class arg0, @OriginalArg(1) String arg1) throws IllegalAccessException, NoSuchFieldException {
	...
	@Override
	public void method6019(@OriginalArg(0) boolean arg0) {
		if (!this.aBoolean741) {
		...
		try {
			@Pc(63) int local63 = Static449.aClass364_1.method5942();
			@Pc(67) String local67 = Static449.aClass364_1.method5941();
			...
			local79.drawImage(this.anImage9, this.method6023(local90) + this.anInt9634 - this.anInt9640 / 2, this.method6020(local105) - -this.anInt9643, (ImageObserver) null);
			...
			for (@Pc(162) int local162 = local152; local162 <= local160; local162 += local100) {
				local79.drawImage(this.anImage10, this.method6023(local90) + this.anInt9634 + local162, this.method6020(local115) - -this.anInt9643, (ImageObserver) null);
			}
			local79.drawImage(this.anImage12, this.method6023(local95) + this.anInt9634 + this.anInt9640 / 2, this.method6020(local110) + this.anInt9643, (ImageObserver) null);
			...
			@Pc(286) int local286 = this.method6023(this.anInt9638) + this.anInt9645;
			@Pc(296) int local296 = this.method6020(this.anInt9648) + this.anInt9646;
			...
			if (local439 > 0) {
				...
				@Pc(475) int local475 = this.anInt9644 * Static556.method5126() / 10 % local271;
	...
	private boolean method6031(@OriginalArg(0) Object arg0, @OriginalArg(1) Class arg1, @OriginalArg(3) String arg2) throws IllegalAccessException, NoSuchFieldException {
