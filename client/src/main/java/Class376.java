...
public final class Class376 implements Interface22 {
	...
	public void method8472(@OriginalArg(0) boolean arg0) {
		...
		try {
			...
			local79.drawImage(this.anImage9, this.method8476(local90) + this.anInt9660 - this.anInt9666 / 2, this.method8473(local105) - -this.anInt9669, (ImageObserver) null);
			...
			for (@Pc(162) int local162 = local152; local162 <= local160; local162 += local100) {
				local79.drawImage(this.anImage10, this.method8476(local90) + this.anInt9660 + local162, this.method8473(local115) - -this.anInt9669, (ImageObserver) null);
			}
			local79.drawImage(this.anImage12, this.method8476(local95) + this.anInt9660 + this.anInt9666 / 2, this.method8473(local110) + this.anInt9669, (ImageObserver) null);
			...
			local79.drawImage(this.anImage11, local286, local296 + (this.anInt9674 - local236) / 2, (ImageObserver) null);
			local79.drawImage(this.anImage5, local286 + this.anInt9664 - local241, local296 + (this.anInt9674 + -local246) / 2, (ImageObserver) null);
			...
			for (@Pc(392) int local392 = 0; local392 < this.anInt9664 - local241 - local231; local392 += local266) {
				local358.drawImage(this.anImage7, local392, this.anInt9674 - local251, (ImageObserver) null);
			}
