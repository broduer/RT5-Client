...
public final class Class376 {
	...
	private void method6059(@OriginalArg(0) Class2_Sub21 arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2) {
		if (arg2 == 1) {
			this.anInt9693 = arg0.method5191();
			if (this.anInt9693 == 65535) {
				this.anInt9693 = -1;
			}
		} else if (arg2 == 2) {
			this.anInt9696 = arg0.method5191() + 1;
			this.anInt9690 = arg0.method5191() + 1;
		} else if (arg2 == 3) {
			arg0.method5186();
		} else if (arg2 == 4) {
			this.anInt9689 = arg0.method5205();
		} else if (arg2 == 5) {
			this.anInt9697 = arg0.method5205();
		} else if (arg2 == 6) {
	...
	public void method6060(@OriginalArg(0) int arg0, @OriginalArg(2) Class2_Sub21 arg1) {
		while (true) {
			@Pc(13) int local13 = arg1.method5205();
			if (local13 == 0) {
				return;
			}
			this.method6059(arg1, arg0, local13);
		}
	}
}
