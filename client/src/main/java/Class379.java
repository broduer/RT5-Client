...
public final class Class379 {
	...
	private void method6170(@OriginalArg(1) Class2_Sub21 arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 1) {
			this.aShort124 = (short) arg0.method5191();
			this.aShort125 = (short) arg0.method5191();
			this.aShort127 = (short) arg0.method5191();
			this.aShort126 = (short) arg0.method5191();
			...
			this.anInt9894 = arg0.method5158();
			this.anInt9888 = arg0.method5158();
		} else if (arg1 == 4) {
			this.anInt9897 = arg0.method5205();
			this.anInt9915 = arg0.method5186();
		} else if (arg1 == 5) {
			this.anInt9884 = this.anInt9918 = arg0.method5191() << 12 << 2;
		} else if (arg1 == 6) {
			this.anInt9883 = arg0.method5158();
			this.anInt9881 = arg0.method5158();
		} else if (arg1 == 7) {
			this.anInt9912 = arg0.method5191();
			this.anInt9902 = arg0.method5191();
		} else if (arg1 == 8) {
			this.anInt9933 = arg0.method5191();
			this.anInt9898 = arg0.method5191();
		} else {
			@Pc(159) int local159;
			@Pc(165) int local165;
			if (arg1 == 9) {
				local159 = arg0.method5205();
				this.anIntArray775 = new int[local159];
				for (local165 = 0; local165 < local159; local165++) {
					this.anIntArray775[local165] = arg0.method5191();
				}
			} else if (arg1 == 10) {
				local159 = arg0.method5205();
				this.anIntArray777 = new int[local159];
				for (local165 = 0; local165 < local159; local165++) {
					this.anIntArray777[local165] = arg0.method5191();
				}
			} else if (arg1 == 12) {
				this.anInt9917 = arg0.method5186();
			} else if (arg1 == 13) {
				this.anInt9892 = arg0.method5186();
			} else if (arg1 == 14) {
				this.anInt9882 = arg0.method5191();
			} else if (arg1 == 15) {
				this.anInt9905 = arg0.method5191();
			} else if (arg1 == 16) {
				this.aBoolean761 = arg0.method5205() == 1;
				this.anInt9885 = arg0.method5191();
				this.anInt9921 = arg0.method5191();
				this.aBoolean762 = arg0.method5205() == 1;
			} else if (arg1 == 17) {
				this.anInt9880 = arg0.method5191();
			} else if (arg1 == 18) {
				this.anInt9919 = arg0.method5158();
			} else if (arg1 == 19) {
				this.anInt9896 = arg0.method5205();
			} else if (arg1 == 20) {
				this.anInt9932 = arg0.method5205();
			} else if (arg1 == 21) {
				this.anInt9893 = arg0.method5205();
			} else if (arg1 == 22) {
				this.anInt9923 = arg0.method5158();
			} else if (arg1 == 23) {
				this.anInt9907 = arg0.method5205();
			} else if (arg1 == 24) {
				...
				for (local165 = 0; local165 < local159; local165++) {
					this.anIntArray776[local165] = arg0.method5191();
				}
			} else if (arg1 == 26) {
				this.aBoolean760 = false;
			} else if (arg1 == 27) {
				this.anInt9928 = arg0.method5191() << 12 << 2;
			} else if (arg1 == 28) {
				this.anInt9900 = arg0.method5205();
			} else if (arg1 == 29) {
				arg0.method5165();
			} else if (arg1 == 30) {
				this.aBoolean755 = true;
			} else if (arg1 == 31) {
				this.anInt9884 = arg0.method5191() << 12 << 2;
				this.anInt9918 = arg0.method5191() << 12 << 2;
			} else if (arg1 == 32) {
	...
	public void method6171() {
		this.anInt9899 = this.anInt9883 >> 16 & 0xFF;
		if (this.anInt9917 > -2 || this.anInt9892 > -2) {
			this.aBoolean764 = true;
		}
		this.anInt9924 = this.anInt9881 >> 16 & 0xFF;
		this.anInt9929 = this.anInt9924 - this.anInt9899;
		this.anInt9914 = this.anInt9883 >> 8 & 0xFF;
		this.anInt9927 = this.anInt9881 >> 8 & 0xFF;
		this.anInt9879 = this.anInt9881 & 0xFF;
		this.anInt9911 = this.anInt9927 - this.anInt9914;
		this.anInt9903 = this.anInt9883 & 0xFF;
		this.anInt9890 = this.anInt9881 >> 24 & 0xFF;
		this.anInt9906 = this.anInt9883 >> 24 & 0xFF;
		this.anInt9913 = this.anInt9879 - this.anInt9903;
		this.anInt9878 = this.anInt9890 - this.anInt9906;
		if (this.anInt9928 != -1) {
			this.anInt9909 = this.anInt9900 * this.anInt9902 / 100;
			if (this.anInt9909 == 0) {
				this.anInt9909 = 1;
			}
			this.anInt9910 = (this.anInt9928 - (this.anInt9918 - this.anInt9884) / 2 - this.anInt9884) / this.anInt9909;
		}
		if (this.anInt9923 != -1) {
			this.lb = this.anInt9902 * this.anInt9907 / 100;
			if (this.lb == 0) {
				this.lb = 1;
			}
			this.anInt9889 = (this.anInt9923 - (this.anInt9888 - this.anInt9894) / 2 - this.anInt9894) / this.lb;
		}
		if (this.anInt9919 == 0) {
			return;
		}
		this.anInt9925 = this.anInt9893 * this.anInt9902 / 100;
		this.anInt9901 = this.anInt9902 * this.anInt9932 / 100;
		if (this.anInt9901 == 0) {
			this.anInt9901 = 1;
		}
		if (this.anInt9925 == 0) {
		...
		this.anInt9931 = ((this.anInt9919 >> 16 & 0xFF) - this.anInt9929 / 2 - this.anInt9899 << 8) / this.anInt9901;
		this.anInt9920 = ((this.anInt9919 >> 8 & 0xFF) - this.anInt9914 - this.anInt9911 / 2 << 8) / this.anInt9901;
		this.anInt9916 = ((this.anInt9919 & 0xFF) - this.anInt9913 / 2 - this.anInt9903 << 8) / this.anInt9901;
		this.anInt9916 += this.anInt9916 <= 0 ? 4 : -4;
		this.anInt9887 = ((this.anInt9919 >> 24 & 0xFF) - this.anInt9878 / 2 - this.anInt9906 << 8) / this.anInt9925;
	...
	public void method6173(@OriginalArg(1) Class2_Sub21 arg0) {
		while (true) {
			@Pc(3) int local3 = arg0.method5205();
			if (local3 == 0) {
				return;
			}
			this.method6170(arg0, local3);
		}
	}
}
