...
public final class Class381 {
	...
	public boolean aBoolean763 = true;
	...
	public int anInt9918 = -2;

	@OriginalMember(owner = "client!vaa", name = "A", descriptor = "Z")
	public boolean aBoolean764 = true;
	...
	private void method8660(@OriginalArg(1) Class2_Sub21 arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 1) {
			this.aShort124 = (short) arg0.method7389();
			this.aShort125 = (short) arg0.method7389();
			this.aShort127 = (short) arg0.method7389();
			this.aShort126 = (short) arg0.method7389();
			...
			this.anInt9920 = arg0.method7356();
			this.anInt9914 = arg0.method7356();
		} else if (arg1 == 4) {
			this.anInt9923 = arg0.method7403();
			this.anInt9942 = arg0.method7384();
		} else if (arg1 == 5) {
			this.anInt9910 = this.anInt9945 = arg0.method7389() << 12 << 2;
		} else if (arg1 == 6) {
			this.anInt9909 = arg0.method7356();
			this.anInt9907 = arg0.method7356();
		} else if (arg1 == 7) {
			this.anInt9939 = arg0.method7389();
			this.anInt9929 = arg0.method7389();
		} else if (arg1 == 8) {
			this.anInt9960 = arg0.method7389();
			this.anInt9924 = arg0.method7389();
		} else {
			@Pc(159) int local159;
			@Pc(165) int local165;
			if (arg1 == 9) {
				local159 = arg0.method7403();
				this.anIntArray775 = new int[local159];
				for (local165 = 0; local165 < local159; local165++) {
					this.anIntArray775[local165] = arg0.method7389();
				}
			} else if (arg1 == 10) {
				local159 = arg0.method7403();
				this.anIntArray777 = new int[local159];
				for (local165 = 0; local165 < local159; local165++) {
					this.anIntArray777[local165] = arg0.method7389();
				}
			} else if (arg1 == 12) {
				this.anInt9944 = arg0.method7384();
			} else if (arg1 == 13) {
				this.anInt9918 = arg0.method7384();
			} else if (arg1 == 14) {
				this.anInt9908 = arg0.method7389();
			} else if (arg1 == 15) {
				this.anInt9932 = arg0.method7389();
			} else if (arg1 == 16) {
				this.aBoolean762 = arg0.method7403() == 1;
				this.anInt9911 = arg0.method7389();
				this.anInt9948 = arg0.method7389();
				this.aBoolean763 = arg0.method7403() == 1;
			} else if (arg1 == 17) {
				this.anInt9906 = arg0.method7389();
			} else if (arg1 == 18) {
				this.anInt9946 = arg0.method7356();
			} else if (arg1 == 19) {
				this.anInt9922 = arg0.method7403();
			} else if (arg1 == 20) {
				this.anInt9959 = arg0.method7403();
			} else if (arg1 == 21) {
				this.anInt9919 = arg0.method7403();
			} else if (arg1 == 22) {
				this.anInt9950 = arg0.method7356();
			} else if (arg1 == 23) {
				this.anInt9934 = arg0.method7403();
			} else if (arg1 == 24) {
				...
				for (local165 = 0; local165 < local159; local165++) {
					this.anIntArray776[local165] = arg0.method7389();
				}
			} else if (arg1 == 26) {
				this.aBoolean761 = false;
			} else if (arg1 == 27) {
				this.anInt9955 = arg0.method7389() << 12 << 2;
			} else if (arg1 == 28) {
				this.anInt9927 = arg0.method7403();
			} else if (arg1 == 29) {
				arg0.method7363();
			} else if (arg1 == 30) {
				this.aBoolean756 = true;
			} else if (arg1 == 31) {
				this.anInt9910 = arg0.method7389() << 12 << 2;
				this.anInt9945 = arg0.method7389() << 12 << 2;
			} else if (arg1 == 32) {
	...
	public void method8661() {
		this.anInt9925 = this.anInt9909 >> 16 & 0xFF;
		if (this.anInt9944 > -2 || this.anInt9918 > -2) {
			this.aBoolean765 = true;
		}
		this.anInt9951 = this.anInt9907 >> 16 & 0xFF;
		this.anInt9956 = this.anInt9951 - this.anInt9925;
		this.anInt9941 = this.anInt9909 >> 8 & 0xFF;
		this.anInt9954 = this.anInt9907 >> 8 & 0xFF;
		this.anInt9905 = this.anInt9907 & 0xFF;
		this.anInt9938 = this.anInt9954 - this.anInt9941;
		this.anInt9930 = this.anInt9909 & 0xFF;
		this.anInt9916 = this.anInt9907 >> 24 & 0xFF;
		this.anInt9933 = this.anInt9909 >> 24 & 0xFF;
		this.anInt9940 = this.anInt9905 - this.anInt9930;
		this.anInt9904 = this.anInt9916 - this.anInt9933;
		if (this.anInt9955 != -1) {
			this.anInt9936 = this.anInt9927 * this.anInt9929 / 100;
			if (this.anInt9936 == 0) {
				this.anInt9936 = 1;
			}
			this.anInt9937 = (this.anInt9955 - (this.anInt9945 - this.anInt9910) / 2 - this.anInt9910) / this.anInt9936;
		}
		if (this.anInt9950 != -1) {
			this.anInt9926 = this.anInt9929 * this.anInt9934 / 100;
			if (this.anInt9926 == 0) {
				this.anInt9926 = 1;
			}
			this.anInt9915 = (this.anInt9950 - (this.anInt9914 - this.anInt9920) / 2 - this.anInt9920) / this.anInt9926;
		}
		if (this.anInt9946 == 0) {
			return;
		}
		this.anInt9952 = this.anInt9919 * this.anInt9929 / 100;
		this.anInt9928 = this.anInt9929 * this.anInt9959 / 100;
		if (this.anInt9928 == 0) {
			this.anInt9928 = 1;
		}
		if (this.anInt9952 == 0) {
		...
		this.anInt9958 = ((this.anInt9946 >> 16 & 0xFF) - this.anInt9956 / 2 - this.anInt9925 << 8) / this.anInt9928;
		this.anInt9947 = ((this.anInt9946 >> 8 & 0xFF) - this.anInt9941 - this.anInt9938 / 2 << 8) / this.anInt9928;
		this.anInt9943 = ((this.anInt9946 & 0xFF) - this.anInt9940 / 2 - this.anInt9930 << 8) / this.anInt9928;
		this.anInt9943 += this.anInt9943 <= 0 ? 4 : -4;
		this.anInt9913 = ((this.anInt9946 >> 24 & 0xFF) - this.anInt9904 / 2 - this.anInt9933 << 8) / this.anInt9952;
		this.anInt9958 += this.anInt9958 <= 0 ? 4 : -4;
		this.anInt9947 += this.anInt9947 > 0 ? -4 : 4;
		this.anInt9913 += this.anInt9913 <= 0 ? 4 : -4;
	}

	@OriginalMember(owner = "client!vaa", name = "a", descriptor = "(BLclient!ge;)V")
	public void method8663(@OriginalArg(1) Class2_Sub21 arg0) {
		while (true) {
			@Pc(3) int local3 = arg0.method7403();
			if (local3 == 0) {
				return;
			}
			this.method8660(arg0, local3);
		}
	}
}
