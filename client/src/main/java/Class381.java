...
public final class Class381 {
	...
	public Class381(@OriginalArg(0) byte[] arg0) {
		...
		@Pc(10) int local10 = local6.method5205();
		if (local10 != 0) {
			throw new RuntimeException("");
		}
		@Pc(30) boolean local30 = local6.method5205() == 1;
		this.aByteArray106 = new byte[256];
		local6.method5153(0, 256, this.aByteArray106);
		if (local30) {
			@Pc(46) int[] local46 = new int[256];
			for (@Pc(48) int local48 = 0; local48 < 256; local48++) {
				local46[local48] = local6.method5205();
			}
			@Pc(62) int[] local62 = new int[256];
			for (@Pc(64) int local64 = 0; local64 < 256; local64++) {
				local62[local64] = local6.method5205();
			}
				...
				if (local178 != 32 && local178 != 160) {
					for (local142 = 0; local142 < 256; local142++) {
						if (local142 != 32 && local142 != 160) {
							this.aByteArrayArray34[local178][local142] = (byte) Static359.method3682(local62, local142, local46, local178, local78, this.aByteArray106, local128);
						}
					}
				}
			}
			...
			this.anInt10027 = local6.method5205();
		}
		local6.method5205();
		local6.method5205();
		this.anInt10030 = local6.method5205();
		this.anInt10036 = local6.method5205();
	}

	@OriginalMember(owner = "client!ve", name = "a", descriptor = "(CII)I")
	public int method6234(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1) {
	...
	public int method6236(@OriginalArg(0) String arg0, @OriginalArg(1) Class23[] arg1, @OriginalArg(3) int arg2) {
		return this.method6237(Static623.aStringArray43, new int[] { arg2 }, arg1, arg0);
	}

	@OriginalMember(owner = "client!ve", name = "a", descriptor = "([Ljava/lang/String;[II[Lclient!st;Ljava/lang/String;)I")
	public int method6237(@OriginalArg(0) String[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(3) Class23[] arg2, @OriginalArg(4) String arg3) {
		if (arg3 == null) {
			return 0;
		}
		@Pc(10) int local10 = 0;
		...
		for (@Pc(37) int local37 = 0; local37 < local35; local37++) {
			@Pc(46) int local46 = Static41.method563(arg3.charAt(local37)) & 0xFF;
			@Pc(48) int local48 = 0;
			if (local46 == 60) {
				local20 = local37;
			} else {
				@Pc(69) int local69;
				if (local20 == -1) {
					local48 = this.method6235(local46);
					local69 = local37;
					...
					if (local76.equals("lt")) {
						...
						try {
							@Pc(242) int local242 = Static647.method6027(local76.substring(4));
							local48 = arg2[local242].b();
							local22 = -1;
	...
	public int method6238(@OriginalArg(0) Class23[] arg0, @OriginalArg(2) String arg1, @OriginalArg(3) int arg2) {
		@Pc(16) int local16 = this.method6237(Static623.aStringArray43, new int[] { arg2 }, arg0, arg1);
		@Pc(18) int local18 = 0;
		for (@Pc(20) int local20 = 0; local20 < local16; local20++) {
			@Pc(29) int local29 = this.method6239(arg0, Static623.aStringArray43[local20]);
			if (local18 < local29) {
				local18 = local29;
			}
		}
	...
	public int method6239(@OriginalArg(1) Class23[] arg0, @OriginalArg(2) String arg1) {
		if (arg1 == null) {
			return 0;
		}
		@Pc(10) int local10 = -1;
		...
		for (@Pc(26) int local26 = 0; local26 < local24; local26++) {
			...
			if (local31 == '<') {
					...
					if (local53.equals("lt")) {
						...
						if (!local53.equals("reg")) {
							if (local53.startsWith("img=") && arg0 != null) {
								try {
									@Pc(143) int local143 = Static647.method6027(local53.substring(4));
									local19 = -1;
									local21 += arg0[local143].b();
				...
				if (local10 == -1) {
					local21 += this.aByteArray106[Static41.method563(local31) & 0xFF] & 0xFF;
	...
	public String method6240(@OriginalArg(0) String arg0, @OriginalArg(1) Class23[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg2 >= this.method6239(arg1, arg0)) {
			return arg0;
		}
		@Pc(27) int local27 = arg2 - this.method6239((Class23[]) null, "...");
		@Pc(29) int local29 = -1;
		@Pc(31) int local31 = -1;
		@Pc(33) int local33 = 0;
		...
		for (@Pc(40) int local40 = 0; local40 < local36; local40++) {
			...
			if (local45 == '<') {
					...
					if (local69.equals("lt")) {
						...
						if (!local69.equals("reg")) {
							if (local69.startsWith("img=") && arg1 != null) {
								try {
									@Pc(155) int local155 = Static647.method6027(local69.substring(4));
									local33 += arg1[local155].b();
									local31 = -1;
									if (local33 > local27) {
										return local38 + "...";
									}
				...
				if (local29 == -1) {
					local33 += this.aByteArray106[Static41.method563(local45) & 0xFF] & 0xFF;
	...
	public int method6241(@OriginalArg(1) String arg0) {
		return this.method6239((Class23[]) null, arg0);
	}

	@OriginalMember(owner = "client!ve", name = "a", descriptor = "(IILjava/lang/String;[Lclient!st;B)I")
	public int method6242(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2, @OriginalArg(3) Class23[] arg3) {
		if (arg1 == 0) {
			arg1 = this.anInt10027;
		}
		@Pc(24) int local24 = this.method6237(Static623.aStringArray43, new int[] { arg0 }, arg3, arg2);
