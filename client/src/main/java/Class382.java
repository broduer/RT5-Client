...
public final class Class382 {
	...
	public Class382 method6277(@OriginalArg(0) int arg0) {
		if (this.anIntArray799 != null && arg0 > 1) {
			...
			if (local23 != -1) {
				return this.aClass112_2.method1684(local23);
			}
		}
		return this;
	}
	...
	public void method6278(@OriginalArg(0) Class2_Sub21 arg0) {
		while (true) {
			@Pc(15) int local15 = arg0.method5205();
			if (local15 == 0) {
				return;
			}
			this.method6284(arg0, local15);
		}
	}

	@OriginalMember(owner = "client!vfa", name = "a", descriptor = "(BLclient!vfa;Lclient!vfa;)V")
	public void method6279(@OriginalArg(1) Class382 arg0, @OriginalArg(2) Class382 arg1) {
		...
		this.aStringArray45[4] = Static32.aClass32_6.method429(this.aClass112_2.anInt2662);
	}

	@OriginalMember(owner = "client!vfa", name = "a", descriptor = "(Lclient!vfa;ILclient!vfa;)V")
	public void method6280(@OriginalArg(0) Class382 arg0, @OriginalArg(2) Class382 arg1) {
	...
	public int method6281(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.aClass28_44 == null) {
			return arg1;
		} else {
			@Pc(19) Class2_Sub38 local19 = (Class2_Sub38) this.aClass28_44.method373((long) arg0);
			return local19 == null ? arg1 : local19.anInt6379;
		}
	}

	@OriginalMember(owner = "client!vfa", name = "a", descriptor = "(II[I)[I")
	private int[] method6282(@OriginalArg(1) int arg0, @OriginalArg(2) int[] arg1) {
	...
	private void method6284(@OriginalArg(0) Class2_Sub21 arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 1) {
			this.anInt10120 = arg0.method5191();
		} else if (arg1 == 2) {
			this.aString118 = arg0.method5167();
		} else if (arg1 == 4) {
			this.anInt10098 = arg0.method5191();
		} else if (arg1 == 5) {
			this.anInt10107 = arg0.method5191();
		} else if (arg1 == 6) {
			this.anInt10096 = arg0.method5191();
		} else if (arg1 == 7) {
			this.anInt10126 = arg0.method5191();
			if (this.anInt10126 > 32767) {
				this.anInt10126 -= 65536;
			}
		} else if (arg1 == 8) {
			this.anInt10099 = arg0.method5191();
			...
			this.anInt10142 = arg0.method5158();
		} else if (arg1 == 16) {
			this.aBoolean770 = true;
		} else if (arg1 == 18) {
			this.anInt10103 = arg0.method5191();
		} else if (arg1 == 23) {
			this.anInt10084 = arg0.method5191();
		} else if (arg1 == 24) {
			this.anInt10102 = arg0.method5191();
		} else if (arg1 == 25) {
			this.anInt10104 = arg0.method5191();
		} else if (arg1 == 26) {
			this.anInt10106 = arg0.method5191();
		} else if (arg1 >= 30 && arg1 < 35) {
			this.aStringArray46[arg1 - 30] = arg0.method5167();
		} else if (arg1 >= 35 && arg1 < 40) {
			this.aStringArray45[arg1 - 35] = arg0.method5167();
		} else {
			@Pc(202) int local202;
			@Pc(212) int local212;
			if (arg1 == 40) {
				local202 = arg0.method5205();
				this.aShortArray135 = new short[local202];
				this.aShortArray136 = new short[local202];
				for (local212 = 0; local212 < local202; local212++) {
					this.aShortArray135[local212] = (short) arg0.method5191();
					this.aShortArray136[local212] = (short) arg0.method5191();
				}
			} else if (arg1 == 41) {
				local202 = arg0.method5205();
				...
				for (local212 = 0; local212 < local202; local212++) {
					this.aShortArray134[local212] = (short) arg0.method5191();
					this.aShortArray137[local212] = (short) arg0.method5191();
				}
			} else if (arg1 == 42) {
				local202 = arg0.method5205();
				this.aByteArray107 = new byte[local202];
				for (local212 = 0; local212 < local202; local212++) {
					this.aByteArray107[local212] = arg0.method5186();
				}
			} else if (arg1 == 65) {
				this.aBoolean771 = true;
			} else if (arg1 == 78) {
				this.anInt10095 = arg0.method5191();
			} else if (arg1 == 79) {
				this.anInt10135 = arg0.method5191();
			} else if (arg1 == 90) {
				this.anInt10133 = arg0.method5191();
			} else if (arg1 == 91) {
				this.anInt10092 = arg0.method5191();
			} else if (arg1 == 92) {
				this.anInt10111 = arg0.method5191();
			} else if (arg1 == 93) {
				this.anInt10119 = arg0.method5191();
			} else if (arg1 == 95) {
				this.anInt10094 = arg0.method5191();
			} else if (arg1 == 96) {
				this.anInt10101 = arg0.method5205();
			} else if (arg1 == 97) {
				this.anInt10110 = arg0.method5191();
			} else if (arg1 == 98) {
				this.anInt10087 = arg0.method5191();
			} else if (arg1 >= 100 && arg1 < 110) {
				if (this.anIntArray799 == null) {
					this.anIntArray798 = new int[10];
					this.anIntArray799 = new int[10];
				}
				this.anIntArray799[arg1 - 100] = arg0.method5191();
				this.anIntArray798[arg1 - 100] = arg0.method5191();
			} else if (arg1 == 110) {
				this.anInt10125 = arg0.method5191();
			} else if (arg1 == 111) {
				this.anInt10131 = arg0.method5191();
			} else if (arg1 == 112) {
				this.lb = arg0.method5191();
			} else if (arg1 == 113) {
				this.anInt10100 = arg0.method5186();
			} else if (arg1 == 114) {
				this.anInt10109 = arg0.method5186() * 5;
			} else if (arg1 == 115) {
				this.anInt10121 = arg0.method5205();
			} else if (arg1 == 121) {
				this.anInt10143 = arg0.method5191();
			} else if (arg1 == 122) {
				this.anInt10083 = arg0.method5191();
			} else if (arg1 == 125) {
				this.anInt10147 = arg0.method5186() << 2;
				this.anInt10146 = arg0.method5186() << 2;
				this.anInt10118 = arg0.method5186() << 2;
			} else if (arg1 == 126) {
				this.anInt10113 = arg0.method5186() << 2;
				this.anInt10116 = arg0.method5186() << 2;
				this.anInt10136 = arg0.method5186() << 2;
			} else if (arg1 == 127) {
				this.anInt10129 = arg0.method5205();
				this.anInt10112 = arg0.method5191();
			} else if (arg1 == 128) {
				this.anInt10081 = arg0.method5205();
				this.anInt10082 = arg0.method5191();
			} else if (arg1 == 129) {
				this.anInt10122 = arg0.method5205();
				this.anInt10089 = arg0.method5191();
			} else if (arg1 == 130) {
				this.anInt10093 = arg0.method5205();
				this.anInt10091 = arg0.method5191();
			} else if (arg1 == 132) {
				local202 = arg0.method5205();
				this.anIntArray800 = new int[local202];
				for (local212 = 0; local212 < local202; local212++) {
					this.anIntArray800[local212] = arg0.method5191();
				}
			} else if (arg1 == 134) {
				this.anInt10138 = arg0.method5205();
			} else if (arg1 == 139) {
				this.anInt10114 = arg0.method5191();
			} else if (arg1 == 140) {
				this.anInt10144 = arg0.method5191();
			} else if (arg1 == 249) {
				local202 = arg0.method5205();
				if (this.aClass28_44 == null) {
					local212 = Static440.method4203(local202);
					this.aClass28_44 = new Class28(local212);
				}
				for (local212 = 0; local212 < local202; local212++) {
					@Pc(554) boolean local554 = arg0.method5205() == 1;
					@Pc(558) int local558 = arg0.method5192();
					@Pc(567) Class2 local567;
					if (local554) {
						local567 = new Class2_Sub24(arg0.method5167());
					} else {
						local567 = new Class2_Sub38(arg0.method5158());
					}
					this.aClass28_44.method370((long) local558, local567);
				}
			}
		}
	}
	...
	public int[] method6285(@OriginalArg(0) int arg0, @OriginalArg(1) Class19 arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) boolean arg4, @OriginalArg(6) Class201 arg5, @OriginalArg(7) Class19 arg6, @OriginalArg(8) Class14 arg7, @OriginalArg(9) int arg8) {
		@Pc(14) Class88 local14 = Static121.method1430(this.anInt10120, this.aClass112_2.aClass330_28);
		if (local14 == null) {
			return null;
		}
		...
		if (this.aShortArray135 != null) {
			for (local36 = 0; local36 < this.aShortArray135.length; local36++) {
				if (this.aByteArray107 == null || local36 >= this.aByteArray107.length) {
					local14.method1460(this.aShortArray135[local36], this.aShortArray136[local36]);
				} else {
					local14.method1460(this.aShortArray135[local36], Static238.aShortArray62[this.aByteArray107[local36] & 0xFF]);
				}
			}
		}
		if (this.aShortArray134 != null) {
			for (local36 = 0; local36 < this.aShortArray134.length; local36++) {
				local14.method1458(this.aShortArray134[local36], this.aShortArray137[local36]);
			}
		}
		if (arg5 != null) {
			for (local36 = 0; local36 < 10; local36++) {
				for (@Pc(138) int local138 = 0; local138 < Static76.aShortArrayArray2[local36].length; local138++) {
					if (arg5.anIntArray380[local36] < Static339.aShortArrayArrayArray2[local36][local138].length) {
						local14.method1460(Static76.aShortArrayArray2[local36][local138], Static339.aShortArrayArrayArray2[local36][local138][arg5.anIntArray380[local36]]);
					}
				}
			}
		}
		...
		@Pc(244) Class114 local244 = arg6.a(local14, local198, 64, this.anInt10100 + 64, this.anInt10109 + 768);
		if (!local244.a()) {
			return null;
		}
		if (local200) {
			local244.O(this.anInt10125, this.anInt10131, this.lb);
		}
		@Pc(272) Class23 local272 = null;
		if (this.anInt10087 != -1) {
			local272 = this.aClass112_2.method1676(1, arg6, arg1, arg5, true, 0, 10, true, 0, arg7, this.anInt10110);
			if (local272 == null) {
				return null;
			}
		} else if (this.anInt10083 != -1) {
			local272 = this.aClass112_2.method1676(arg8, arg6, arg1, arg5, true, arg3, arg2, false, 0, arg7, this.anInt10143);
			if (local272 == null) {
				return null;
			}
		} else if (this.anInt10144 != -1) {
			local272 = this.aClass112_2.method1676(arg8, arg6, arg1, arg5, true, arg3, arg2, false, 0, arg7, this.anInt10114);
			if (local272 == null) {
				return null;
			}
		}
		...
		@Pc(395) Class73 local395 = arg6.y();
		local395.a();
		arg6.a(local395);
		arg6.xa(1.0F);
		arg6.ZA(16777215, 1.0F, 1.0F, -50.0F, -10.0F, -50.0F);
		@Pc(414) Class73 local414 = arg6.A();
		local414.e(-this.anInt10094 << 3);
		local414.f(this.anInt10096 << 3);
		local414.b(this.anInt10126 << 2, (Class361.anIntArray741[this.anInt10107 << 3] * local363 >> 14) + (this.anInt10099 << 2) - (local244.fa() / 2), (Class361.anIntArray740[this.anInt10107 << 3] * local363 >> 14) - -(this.anInt10099 << 2));
		local414.c(this.anInt10107 << 3);
		...
		local244.a(local414, (Class8_Sub6) null, 1);
		arg6.f(local480, local483);
		@Pc(515) int[] local515 = arg6.na(0, 0, 36, 32);
		if (arg8 >= 1) {
			local515 = this.method6282(-16777214, local515);
			if (arg8 >= 2) {
				local515 = this.method6282(-1, local515);
			}
		}
		if (arg3 != 0) {
			this.method6291(arg3, local515);
		}
		arg6.a(36, 36, 32, local515, 0, 7468).a(0, 0);
		if (this.anInt10087 != -1) {
			local272.a(0, 0);
		} else if (this.anInt10083 != -1) {
			local272.a(0, 0);
		...
		if (arg0 == 1 || arg0 == 2 && (this.anInt10115 == 1 || arg2 != 1) && arg2 != -1) {
			arg7.a((int) 0, 9, this.method6290(arg2), -16777215, 1, -256);
		}
	...
	public Class88 method6286(@OriginalArg(0) Class52 arg0, @OriginalArg(1) boolean arg1) {
		@Pc(19) int local19;
		@Pc(24) int local24;
		@Pc(29) int local29;
		if (arg1) {
			if (arg0 == null || arg0.anIntArray99 == null) {
				local19 = this.anInt10104;
				local24 = this.anInt10106;
				local29 = this.anInt10135;
			} else {
			...
			local29 = this.anInt10095;
			local19 = this.anInt10084;
			local24 = this.anInt10102;
		} else {
		...
		@Pc(86) Class88 local86 = Static121.method1430(local19, this.aClass112_2.aClass330_28);
		if (local86 == null) {
			return null;
		}
		...
		if (local24 != -1) {
			@Pc(113) Class88 local113 = Static121.method1430(local24, this.aClass112_2.aClass330_28);
			...
			if (local29 == -1) {
				...
				@Pc(137) Class88 local137 = Static121.method1430(local29, this.aClass112_2.aClass330_28);
		...
		if (!arg1 && (this.anInt10147 != 0 || this.anInt10146 != 0 || this.anInt10118 != 0)) {
			local86.method1453(this.anInt10147, this.anInt10146, this.anInt10118);
		}
		if (arg1 && (this.anInt10113 != 0 || this.anInt10116 != 0 || this.anInt10136 != 0)) {
			local86.method1453(this.anInt10113, this.anInt10116, this.anInt10136);
		}
		@Pc(269) short[] local269;
		@Pc(275) int local275;
		if (this.aShortArray135 != null) {
			if (arg0 == null || arg0.aShortArray11 == null) {
				local269 = this.aShortArray136;
			} else {
				local269 = arg0.aShortArray11;
			}
			for (local275 = 0; local275 < this.aShortArray135.length; local275++) {
				local86.method1460(this.aShortArray135[local275], local269[local275]);
			}
		}
		if (this.aShortArray134 != null) {
			...
			for (local275 = 0; local275 < this.aShortArray134.length; local275++) {
				local86.method1458(this.aShortArray134[local275], local269[local275]);
			}
		}
		return local86;
	}
	...
	public String method6287(@OriginalArg(0) String arg0, @OriginalArg(2) int arg1) {
		if (this.aClass28_44 == null) {
			return arg0;
		} else {
			@Pc(17) Class2_Sub24 local17 = (Class2_Sub24) this.aClass28_44.method373((long) arg1);
			return local17 == null ? arg0 : local17.aString46;
		}
	}

	@OriginalMember(owner = "client!vfa", name = "a", descriptor = "(ZLclient!bs;I)Lclient!dv;")
	public Class88 method6288(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class52 arg1) {
		@Pc(21) int local21;
		@Pc(26) int local26;
		if (arg0) {
			if (arg1 == null || arg1.anIntArray100 == null) {
				local21 = this.anInt10092;
				local26 = this.anInt10119;
			} else {
				local26 = arg1.anIntArray100[1];
				local21 = arg1.anIntArray100[0];
			}
		} else if (arg1 == null || arg1.anIntArray98 == null) {
			local26 = this.anInt10111;
			local21 = this.anInt10133;
		} else {
		...
		@Pc(84) Class88 local84 = Static121.method1430(local21, this.aClass112_2.aClass330_28);
		if (local84.anInt2379 < 13) {
			local84.method1452();
		}
		if (local26 != -1) {
			@Pc(105) Class88 local105 = Static121.method1430(local26, this.aClass112_2.aClass330_28);
		...
		if (this.aShortArray135 != null) {
			if (arg1 == null || arg1.aShortArray11 == null) {
				local149 = this.aShortArray136;
			} else {
				local149 = arg1.aShortArray11;
			}
			for (local156 = 0; local156 < this.aShortArray135.length; local156++) {
				local84.method1460(this.aShortArray135[local156], local149[local156]);
			}
		}
		if (this.aShortArray134 != null) {
			...
			for (local156 = 0; local156 < this.aShortArray134.length; local156++) {
				local84.method1458(this.aShortArray134[local156], local149[local156]);
			}
		}
		return local84;
	}
	...
	public boolean method6289(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class52 arg1) {
		@Pc(17) int local17;
		@Pc(23) int local23;
		@Pc(20) int local20;
		if (arg0) {
			if (arg1 == null || arg1.anIntArray99 == null) {
				local17 = this.anInt10104;
				local20 = this.anInt10135;
				local23 = this.anInt10106;
			} else {
			...
			local20 = this.anInt10095;
			local17 = this.anInt10084;
			local23 = this.anInt10102;
		} else {
		...
		if (!this.aClass112_2.aClass330_28.method5350(0, local17)) {
			local88 = false;
		}
		if (local23 != -1 && !this.aClass112_2.aClass330_28.method5350(0, local23)) {
			local88 = false;
		}
		if (local20 != -1 && !this.aClass112_2.aClass330_28.method5350(0, local20)) {
			local88 = false;
		}
		return local88;
	}
	...
	private String method6290(@OriginalArg(1) int arg0) {
		if (arg0 < 100000) {
			return "<col=ffff00>" + arg0 + "</col>";
		} else if (arg0 < 10000000) {
			return "<col=ffffff>" + arg0 / 1000 + Static32.aClass32_36.method429(this.aClass112_2.anInt2662) + "</col>";
		} else {
			return "<col=00ff80>" + arg0 / 1000000 + Static32.aClass32_34.method429(this.aClass112_2.anInt2662) + "</col>";
		}
	}

	@OriginalMember(owner = "client!vfa", name = "a", descriptor = "(I[II)V")
	private void method6291(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1) {
	...
	public Class114 method6292(@OriginalArg(0) Class152 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class201 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Class19 arg4) {
		@Pc(17) int local17;
		if (this.anIntArray799 != null && arg3 > 1) {
			...
			if (local17 != -1) {
				return this.aClass112_2.method1684(local17).method6292(arg0, arg1, arg2, 1, arg4);
			}
		}
		local17 = arg1;
		if (arg0 != null) {
			local17 = arg1 | arg0.method6535();
		}
		@Pc(87) Class82 local87 = this.aClass112_2.aClass82_58;
		@Pc(104) Class114 local104;
		synchronized (this.aClass112_2.aClass82_58) {
			local104 = (Class114) this.aClass112_2.aClass82_58.method1390((long) (this.anInt10134 | arg4.anInt8962 << 29));
		}
		if (local104 == null || arg4.b(local104.ua(), local17) != 0) {
			if (local104 != null) {
				local17 = arg4.c(local17, local104.ua());
			}
			@Pc(141) int local141 = local17;
			if (this.aShortArray134 != null) {
				local141 = local17 | 0x8000;
			}
			if (this.aShortArray135 != null || arg2 != null) {
				local141 |= 0x4000;
			}
			...
			@Pc(196) Class88 local196 = Static121.method1430(this.anInt10120, this.aClass112_2.aClass330_28);
			if (local196 == null) {
				return null;
			}
			...
			local104 = arg4.a(local196, local141, this.aClass112_2.anInt2673, this.anInt10100 + 64, 850 - -this.anInt10109);
			if (this.anInt10125 != 128 || this.anInt10131 != 128 || this.lb != 128) {
			...
			if (this.aShortArray135 != null) {
				for (local265 = 0; local265 < this.aShortArray135.length; local265++) {
					if (this.aByteArray107 == null || this.aByteArray107.length <= local265) {
						local104.ia(this.aShortArray135[local265], this.aShortArray136[local265]);
					} else {
						local104.ia(this.aShortArray135[local265], Static238.aShortArray62[this.aByteArray107[local265] & 0xFF]);
					}
				}
			}
			if (this.aShortArray134 != null) {
				for (local265 = 0; local265 < this.aShortArray134.length; local265++) {
					local104.aa(this.aShortArray134[local265], this.aShortArray137[local265]);
				}
			}
			if (arg2 != null) {
			...
			synchronized (this.aClass112_2.aClass82_58) {
				this.aClass112_2.aClass82_58.method1384(local104, (long) (this.anInt10134 | arg4.anInt8962 << 29));
			}
		}
		if (arg0 != null) {
			local104 = local104.a((byte) 1, local17, true);
			arg0.method6523(local104, 0);
		}
		local104.s(arg1);
		return local104;
	}
	...
	public boolean method6295(@OriginalArg(1) Class52 arg0, @OriginalArg(2) boolean arg1) {
		@Pc(19) int local19;
		@Pc(22) int local22;
		if (arg1) {
			if (arg0 == null || arg0.anIntArray100 == null) {
				local19 = this.anInt10092;
				local22 = this.anInt10119;
			} else {
				local19 = arg0.anIntArray100[0];
				local22 = arg0.anIntArray100[1];
			}
		} else if (arg0 == null || arg0.anIntArray98 == null) {
			local22 = this.anInt10111;
			local19 = this.anInt10133;
		} else {
		...
		if (!this.aClass112_2.aClass330_28.method5350(0, local19)) {
			local71 = false;
		}
		if (local22 != -1 && !this.aClass112_2.aClass330_28.method5350(0, local22)) {
			local71 = false;
		}
		return local71;
	}
	...
	public void method6296(@OriginalArg(0) Class382 arg0, @OriginalArg(2) Class382 arg1) {
		this.anInt10142 = 0;
		...
		this.anInt10126 = arg0.anInt10126;
		this.anInt10094 = arg0.anInt10094;
		this.anInt10084 = arg1.anInt10084;
		...
		this.aStringArray45[4] = Static32.aClass32_7.method429(this.aClass112_2.anInt2662);
	}
}
