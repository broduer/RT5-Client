...
public final class Class383 {
	...
	public Class383(@OriginalArg(0) byte[] arg0) {
		...
		@Pc(10) int local10 = local6.method7403();
		if (local10 != 0) {
			throw new RuntimeException("");
		}
		@Pc(30) boolean local30 = local6.method7403() == 1;
		this.aByteArray106 = new byte[256];
		local6.method7351(0, 256, this.aByteArray106);
		if (local30) {
			@Pc(46) int[] local46 = new int[256];
			for (@Pc(48) int local48 = 0; local48 < 256; local48++) {
				local46[local48] = local6.method7403();
			}
			@Pc(62) int[] local62 = new int[256];
			for (@Pc(64) int local64 = 0; local64 < 256; local64++) {
				local62[local64] = local6.method7403();
			}
				...
				if (local178 != 32 && local178 != 160) {
					for (local142 = 0; local142 < 256; local142++) {
						if (local142 != 32 && local142 != 160) {
							this.aByteArrayArray34[local178][local142] = (byte) Static359.method5232(local62, local142, local46, local178, local78, this.aByteArray106, local128);
						}
					}
				}
			}
			this.anInt10054 = local62[32] + local46[32];
		} else {
			this.anInt10054 = local6.method7403();
		}
		local6.method7403();
		local6.method7403();
		this.anInt10057 = local6.method7403();
		this.anInt10063 = local6.method7403();
	}

	@OriginalMember(owner = "client!ve", name = "a", descriptor = "(CII)I")
	public int method8744(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1) {
	...
	public int method8745(@OriginalArg(0) int arg0) {
		return this.aByteArray106[arg0] & 0xFF;
	}

	@OriginalMember(owner = "client!ve", name = "a", descriptor = "(Ljava/lang/String;[Lclient!st;BI)I")
	public int method8746(@OriginalArg(0) String arg0, @OriginalArg(1) Class23[] arg1, @OriginalArg(3) int arg2) {
		return this.method8747(Static623.aStringArray43, new int[] { arg2 }, arg1, arg0);
	}

	@OriginalMember(owner = "client!ve", name = "a", descriptor = "([Ljava/lang/String;[II[Lclient!st;Ljava/lang/String;)I")
	public int method8747(@OriginalArg(0) String[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(3) Class23[] arg2, @OriginalArg(4) String arg3) {
		if (arg3 == null) {
			return 0;
		}
		@Pc(10) int local10 = 0;
		...
		for (@Pc(37) int local37 = 0; local37 < local35; local37++) {
			...
			if (local46 == 60) {
				...
				@Pc(69) int local69;
				if (local20 == -1) {
					local48 = this.method8745(local46);
					local69 = local37;
					...
					if (local76.equals("lt")) {
						...
						try {
							@Pc(242) int local242 = Static647.method8480(local76.substring(4));
							local48 = arg2[local242].method8210();
							local22 = -1;
	...
	public int method8748(@OriginalArg(0) Class23[] arg0, @OriginalArg(2) String arg1, @OriginalArg(3) int arg2) {
		@Pc(16) int local16 = this.method8747(Static623.aStringArray43, new int[] { arg2 }, arg0, arg1);
		@Pc(18) int local18 = 0;
		for (@Pc(20) int local20 = 0; local20 < local16; local20++) {
			@Pc(29) int local29 = this.method8749(arg0, Static623.aStringArray43[local20]);
			if (local18 < local29) {
				local18 = local29;
			}
		}
	...
	public int method8749(@OriginalArg(1) Class23[] arg0, @OriginalArg(2) String arg1) {
		if (arg1 == null) {
			return 0;
		}
		@Pc(10) int local10 = -1;
					...
					if (local53.equals("lt")) {
						...
						if (!local53.equals("reg")) {
							if (local53.startsWith("img=") && arg0 != null) {
								try {
									@Pc(143) int local143 = Static647.method8480(local53.substring(4));
									local19 = -1;
									local21 += arg0[local143].method8210();
	...
	public String method8750(@OriginalArg(0) String arg0, @OriginalArg(1) Class23[] arg1, @OriginalArg(2) int arg2) {
					...
					if (local69.equals("lt")) {
						...
						if (!local69.equals("reg")) {
							if (local69.startsWith("img=") && arg1 != null) {
								try {
									@Pc(155) int local155 = Static647.method8480(local69.substring(4));
									local33 += arg1[local155].method8210();
									local31 = -1;
									if (local33 > local27) {
										return local38 + "...";
									}
	...
	public int method8752(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2, @OriginalArg(3) Class23[] arg3) {
		if (arg1 == 0) {
			arg1 = this.anInt10054;
		}
		@Pc(24) int local24 = this.method8747(Static623.aStringArray43, new int[] { arg0 }, arg3, arg2);
		@Pc(42) int local42 = arg1 * (local24 - 1);
		return local42 + this.anInt10057 + this.anInt10063;
	}
}
