...
public final class Class385 implements Runnable {
	...
	public void method6367(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) throws IOException {
		...
		synchronized (this) {
			...
			if (arg1 + this.anInt10283 > this.anInt10287) {
				...
				Static734.method5448(arg0, 0, this.aByteArray108, this.anInt10283, local101);
				Static734.method5448(arg0, local101, this.aByteArray108, 0, arg1 - local101);
			} else {
				Static734.method5448(arg0, 0, this.aByteArray108, this.anInt10283, arg1);
			}
