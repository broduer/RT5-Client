...
public final class Class387 {
	...
	public Class387(@OriginalArg(0) Class377 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class330 arg2) {
		...
		if (this.aClass330_122 != null) {
			@Pc(20) int local20 = this.aClass330_122.method5361() - 1;
			this.aClass330_122.method5372(local20);
		}
	}

	@OriginalMember(owner = "client!vka", name = "a", descriptor = "(II)Lclient!bt;")
	public Class53 method6376(@OriginalArg(0) int arg0) {
		@Pc(6) Class82 local6 = this.aClass82_223;
		@Pc(16) Class53 local16;
		synchronized (this.aClass82_223) {
			local16 = (Class53) this.aClass82_223.method1390((long) arg0);
		}
		if (local16 != null) {
			return local16;
		}
		@Pc(40) byte[] local40 = this.aClass330_122.method5359(Static61.method813(arg0), Static188.method1967(arg0));
		local16 = new Class53();
		if (local40 != null) {
			local16.method737(new Class2_Sub21(local40));
		}
		@Pc(66) Class82 local66 = this.aClass82_223;
		synchronized (this.aClass82_223) {
			this.aClass82_223.method1384(local16, (long) arg0);
			return local16;
		}
	}
}
