...
public final class Class388 {
	...
	public Class388(@OriginalArg(0) Class330 arg0) {
		@Pc(12) byte[] local12 = arg0.method5353(6);
		this.method6380(new Class2_Sub21(local12));
	...
	private void method6380(@OriginalArg(1) Class2_Sub21 arg0) {
		while (true) {
			...
			@Pc(29) int local29;
			if (local12 == 1) {
				local29 = arg0.method5205();
				this.anIntArray821 = new int[local29];
				for (@Pc(35) int local35 = 0; local35 < this.anIntArray821.length; local35++) {
					this.anIntArray821[local35] = arg0.method5205();
				}
			} else if (local12 == 3) {
				this.anInt10301 = arg0.method5205();
			} else if (local12 == 4) {
				this.anInt10300 = arg0.method5205();
			} else if (local12 == 5) {
				this.anIntArray818 = new int[arg0.method5205()];
				for (local29 = 0; local29 < this.anIntArray818.length; local29++) {
					this.anIntArray818[local29] = arg0.method5205();
				}
			} else if (local12 == 6) {
				this.anIntArray820 = new int[arg0.method5205()];
				for (local29 = 0; local29 < this.anIntArray820.length; local29++) {
					this.anIntArray820[local29] = arg0.method5205();
				}
			}
		}
	}
