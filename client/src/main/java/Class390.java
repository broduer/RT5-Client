...
public final class Class390 implements Runnable {
	...
	public Class390(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) throws Exception {
		...
		Static649.method6046(Static689.anInt10357, Static689.aString122);
		if (this.aBoolean781) {
			this.aClass83_4 = new Class83(Static649.method6045((String) null, Static689.anInt10357, "random.dat"), "rw", 25L);
			this.aClass83_2 = new Class83(Static649.method6044("main_file_cache.dat2"), "rw", 314572800L);
			this.aClass83_3 = new Class83(Static649.method6044("main_file_cache.idx255"), "rw", 1048576L);
			this.aClass83Array1 = new Class83[arg2];
			for (@Pc(226) int local226 = 0; local226 < arg2; local226++) {
				this.aClass83Array1[local226] = new Class83(Static649.method6044("main_file_cache.idx" + local226), "rw", 1048576L);
			}
			if (this.aBoolean779) {
				try {
	...
	public Object method6417() {
		return this.anObject21;
	}

	@OriginalMember(owner = "client!vq", name = "a", descriptor = "(IIIII)Lclient!oba;")
	public Class270 method6418(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2) {
		return this.method6434(arg0 << 16, 6, (Object) null, (arg2 << 16) + arg1);
	}

	@OriginalMember(owner = "client!vq", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;I)Lclient!oba;")
	public Class270 method6419(@OriginalArg(0) Class arg0, @OriginalArg(1) String arg1) {
		return this.method6434(0, 9, new Object[] { arg0, arg1 }, 0);
	}

	@OriginalMember(owner = "client!vq", name = "a", descriptor = "(Ljava/lang/String;ZZI)Lclient!oba;")
	public Class270 method6420(@OriginalArg(0) String arg0, @OriginalArg(2) boolean arg1, @OriginalArg(3) int arg2) {
		return this.method6434(0, arg1 ? 22 : 1, arg0, arg2);
	}

	@OriginalMember(owner = "client!vq", name = "a", descriptor = "(ZLjava/lang/String;B)Lclient!oba;")
	public Class270 method6422(@OriginalArg(1) String arg0) {
		return this.method6434(0, 12, arg0, 0);
	}

	@OriginalMember(owner = "client!vq", name = "a", descriptor = "(BI)Lclient!oba;")
	public Class270 method6423(@OriginalArg(1) int arg0) {
		return this.method6434(0, 3, (Object) null, arg0);
	}

	@OriginalMember(owner = "client!vq", name = "a", descriptor = "(B)Lclient!oba;")
	public Class270 method6425() {
		return this.method6434(0, 5, (Object) null, 0);
	}
		...
		if (this.aClass83Array1 != null) {
			for (@Pc(52) int local52 = 0; local52 < this.aClass83Array1.length; local52++) {
				if (this.aClass83Array1[local52] != null) {
					try {
						this.aClass83Array1[local52].method1392();
	...
	public Class270 method6427(@OriginalArg(0) String arg0) {
		return this.method6434(0, 16, arg0, 0);
	}

	@OriginalMember(owner = "client!vq", name = "a", descriptor = "(Ljava/io/File;I[B)Z")
	public boolean method6428(@OriginalArg(0) File arg0, @OriginalArg(2) byte[] arg1) {
		try {
	...
	public Class270 method6429(@OriginalArg(0) Class arg0, @OriginalArg(1) Class[] arg1, @OriginalArg(2) String arg2) {
		return this.method6434(0, 8, new Object[] { arg0, arg2, arg1 }, 0);
	}

	@OriginalMember(owner = "client!vq", name = "a", descriptor = "(Ljava/awt/Frame;I)Lclient!oba;")
	public Class270 method6430(@OriginalArg(0) Frame arg0) {
		return this.method6434(0, 7, arg0, 0);
	}
	...
	public Class270 method6432(@OriginalArg(1) Runnable arg0, @OriginalArg(2) int arg1) {
		return this.method6434(0, 2, arg0, arg1);
	}

	@OriginalMember(owner = "client!vq", name = "a", descriptor = "(BLjava/net/URL;)Lclient!oba;")
	public Class270 method6433(@OriginalArg(1) URL arg0) {
		return this.method6434(0, 4, arg0, 0);
	}

	@OriginalMember(owner = "client!vq", name = "a", descriptor = "(IILjava/lang/Object;II)Lclient!oba;")
	private Class270 method6434(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Object arg2, @OriginalArg(4) int arg3) {
	...
	public void method6435() {
		Static689.aLong317 = Static588.method5469() + 5000L;
	}

	@OriginalMember(owner = "client!vq", name = "a", descriptor = "(IB[ILjava/awt/Component;Ljava/awt/Point;I)Lclient!oba;")
	public Class270 method6436(@OriginalArg(0) int arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) Component arg2, @OriginalArg(4) Point arg3, @OriginalArg(5) int arg4) {
		return this.method6434(arg0, 17, new Object[] { arg2, arg1, arg3 }, arg4);
	}
	...
	public void run() {
		while (true) {
			...
			try {
				...
				if (local42 == 1) {
					if (Static588.method5469() < Static689.aLong317) {
						throw new IOException();
					}
					local15.anObject13 = new Socket(InetAddress.getByName((String) local15.anObject12), local15.anInt6788);
				} else if (local42 == 22) {
					if (Static689.aLong317 > Static588.method5469()) {
						throw new IOException();
					}
					try {
						local15.anObject13 = Static327.method3419((String) local15.anObject12, local15.anInt6788).method4239();
					...
					if (local42 == 8) {
						...
						if (local42 == 3) {
							...
							if (this.aBoolean779) {
								local15.anObject13 = this.aClass15_1.method136();
							} else {
							...
							if (this.aBoolean779) {
								this.aClass15_1.method134(local268, local15.anInt6787 >> 16, local15.anInt6787 & 0xFFFF, local15.anInt6788 & 0xFFFF, local15.anInt6788 >>> 16);
							} else {
							...
							if (local42 == 12) {
								local438 = Static689.method6421(Static689.aString122, Static689.anInt10357, (String) local15.anObject12);
								local15.anObject13 = local438;
							} else if (local42 == 13) {
								local438 = Static689.method6421("", Static689.anInt10357, (String) local15.anObject12);
								local15.anObject13 = local438;
							} else if (this.aBoolean781 && local42 == 14) {
								@Pc(460) int local460 = local15.anInt6788;
								@Pc(463) int local463 = local15.anInt6787;
								if (this.aBoolean779) {
									this.aCallback_Sub1_1.method4510(local460, local463);
								} else {
								...
								if (this.aBoolean779) {
									this.aCallback_Sub1_1.method4511(local534, local538);
								} else {
							...
							this.aClass15_1.method135((Frame) local15.anObject12);
						} else {
