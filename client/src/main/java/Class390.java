...
public final class Class390 {
	...
	public Class390(@OriginalArg(0) Class332 arg0) {
		...
		this.method8936(new Class2_Sub21(local12));
	...
	private void method8936(@OriginalArg(1) Class2_Sub21 arg0) {
		while (true) {
			...
			@Pc(29) int local29;
			if (local12 == 1) {
				local29 = arg0.method7403();
				this.anIntArray821 = new int[local29];
				for (@Pc(35) int local35 = 0; local35 < this.anIntArray821.length; local35++) {
					this.anIntArray821[local35] = arg0.method7403();
				}
			} else if (local12 == 3) {
				this.anInt10329 = arg0.method7403();
			} else if (local12 == 4) {
				this.anInt10328 = arg0.method7403();
			} else if (local12 == 5) {
				this.anIntArray818 = new int[arg0.method7403()];
				for (local29 = 0; local29 < this.anIntArray818.length; local29++) {
					this.anIntArray818[local29] = arg0.method7403();
				}
			} else if (local12 == 6) {
				this.anIntArray820 = new int[arg0.method7403()];
				for (local29 = 0; local29 < this.anIntArray820.length; local29++) {
					this.anIntArray820[local29] = arg0.method7403();
				}
			}
		}
	}
