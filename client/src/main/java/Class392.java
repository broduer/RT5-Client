...
public final class Class392 {
	...
	public void method6442(@OriginalArg(0) Class2_Sub21 arg0) {
		while (true) {
			@Pc(15) int local15 = arg0.method5205();
			if (local15 == 0) {
				return;
			}
			this.method6443(local15, arg0);
		}
	}

	@OriginalMember(owner = "client!vt", name = "a", descriptor = "(ILclient!ge;B)V")
	private void method6443(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub21 arg1) {
		if (arg0 == 1) {
			this.anInt10372 = arg1.method5205();
		} else if (arg0 == 2) {
			this.anInt10377 = arg1.method5191();
		} else if (arg0 == 3) {
			this.anInt10373 = arg1.method5191();
		} else if (arg0 == 4) {
			this.anInt10374 = arg1.method5165();
		}
	}
}
