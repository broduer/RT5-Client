...
public final class Class394 {
	...
	public Class394(@OriginalArg(0) Class2_Sub21 arg0) {
		this.anInt10421 = arg0.method5155();
		this.anInt10415 = arg0.method5205();
	}

	@OriginalMember(owner = "client!w", name = "b", descriptor = "(B)V")
	public void method6469() {
		Static553.method5113(this.anInt10412, -1, Static461.anIntArray555[this.anInt10415], this.anInt10419, this.anInt10416, this.anInt10415, this.anInt10422);
	}

	@OriginalMember(owner = "client!w", name = "a", descriptor = "(IIBII)V")
	public void method6474(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		Static553.method5113(arg1, this.anInt10421, Static461.anIntArray555[this.anInt10415], arg0, arg3, this.anInt10415, arg2);
