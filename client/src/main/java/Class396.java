...
public final class Class396 {
	...
	public void method6578(@OriginalArg(0) String arg0) {
		this.method6586(this.anInt10544 + 1, arg0);
	}
	...
	public String[] method6580() {
		...
		Static734.method5445(this.aStringArray48, 0, local16, 0, this.anInt10544 + 1);
		return local16;
	}

	@OriginalMember(owner = "client!wca", name = "a", descriptor = "(II)I")
	private int method6583(@OriginalArg(0) int arg0) {
	...
	private void method6585(@OriginalArg(0) int arg0) {
		@Pc(9) String[] local9 = new String[this.method6583(arg0)];
		Static734.method5445(this.aStringArray48, 0, local9, 0, this.aStringArray48.length);
		this.aStringArray48 = local9;
	}

	@OriginalMember(owner = "client!wca", name = "a", descriptor = "(BILjava/lang/String;)V")
	private void method6586(@OriginalArg(1) int arg0, @OriginalArg(2) String arg1) {
		if (this.anInt10544 < arg0) {
			this.anInt10544 = arg0;
		}
		if (arg0 >= this.aStringArray48.length) {
			this.method6585(arg0);
		}
