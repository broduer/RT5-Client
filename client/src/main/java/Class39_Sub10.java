...
public final class Class39_Sub10 extends Class39 {
	...
	public Class39_Sub10(@OriginalArg(0) Class2_Sub21 arg0) {
		super(arg0);
		this.anInt4131 = arg0.method7389();
		@Pc(13) int local13 = arg0.method7403();
		if ((local13 & 0x1) == 0) {
			this.anInt4130 = -1;
			this.anInt4136 = -1;
		} else {
			this.anInt4130 = arg0.method7389();
			this.anInt4136 = arg0.method7389();
		}
		if ((local13 & 0x2) == 0) {
			this.anInt4137 = -1;
			this.anInt4134 = -1;
		} else {
			this.anInt4134 = arg0.method7389();
			this.anInt4137 = arg0.method7389();
		}
		if ((local13 & 0x4) == 0) {
			this.anInt4133 = -1;
		} else {
			@Pc(84) int local84 = arg0.method7389();
			@Pc(88) int local88 = arg0.method7389();
	...
	public void method9168() {
		Static219.aClass238Array1[this.anInt4131].method5370().method9308(this.anInt4137, 0, this.anInt4133, this.anInt4136, Static333.anInt5474, this.anInt4134, this.anInt4130);
	}
}
