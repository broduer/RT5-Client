...
public final class Class39_Sub10 extends Class39 {
	...
	public Class39_Sub10(@OriginalArg(0) Class2_Sub21 arg0) {
		super(arg0);
		this.anInt4120 = arg0.method5191();
		@Pc(13) int local13 = arg0.method5205();
		if ((local13 & 0x1) == 0) {
			this.anInt4119 = -1;
			this.anInt4125 = -1;
		} else {
			this.anInt4119 = arg0.method5191();
			this.anInt4125 = arg0.method5191();
		}
		if ((local13 & 0x2) == 0) {
			this.anInt4126 = -1;
			this.anInt4123 = -1;
		} else {
			this.anInt4123 = arg0.method5191();
			this.anInt4126 = arg0.method5191();
		}
		if ((local13 & 0x4) == 0) {
			this.anInt4122 = -1;
		} else {
			@Pc(84) int local84 = arg0.method5191();
			@Pc(88) int local88 = arg0.method5191();
	...
	public void method6590() {
		Static219.aClass236Array1[this.anInt4120].method3805().method6692(this.anInt4126, 0, this.anInt4122, this.anInt4125, Static333.anInt5455, this.anInt4123, this.anInt4119);
	}
}
