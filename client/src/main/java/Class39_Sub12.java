...
public final class Class39_Sub12 extends Class39 {
	...
	public Class39_Sub12(@OriginalArg(0) Class2_Sub21 arg0) {
		super(arg0);
		this.anInt5045 = arg0.method5191();
		this.anInt5040 = arg0.method5191();
	}

	@OriginalMember(owner = "client!k", name = "b", descriptor = "(I)V")
	@Override
	public void method6590() {
		Static219.aClass236Array1[this.anInt5045].method3805().method6689(this.anInt5040, true);
	}
}
