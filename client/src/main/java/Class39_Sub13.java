...
public final class Class39_Sub13 extends Class39 {
	...
	private Node_Sub8 aClass2_Sub8_4;
	...
	public Class39_Sub13(@OriginalArg(0) Buffer arg0) {
		super(arg0);
	...
	public boolean method9165() {
		if (this.aClass2_Sub8_4 == null) {
			this.aClass2_Sub8_4 = Static728.method1153(client.js5Archive6, this.anInt5450, 0);
		}
		if (this.aClass2_Sub8_4 == null) {
			return false;
		} else {
