...
public final class Class39_Sub16 extends Class39 {
	...
	public Class39_Sub16(@OriginalArg(0) Class2_Sub21 arg0) {
		super(arg0);
		this.anInt7273 = arg0.method5191();
		@Pc(11) int local11 = arg0.method5158();
		this.anInt7275 = local11 & 0xFFFF;
		this.anInt7278 = local11 >>> 16;
		this.anInt7280 = arg0.method5205();
		this.anInt7279 = arg0.method5205();
	}

	@OriginalMember(owner = "client!pe", name = "b", descriptor = "(I)V")
	@Override
	public void method6590() {
		Static507.aClass394Array1[this.anInt7273].method6474(this.anInt7278, this.anInt7279, this.anInt7275, this.anInt7280);
	}
}
