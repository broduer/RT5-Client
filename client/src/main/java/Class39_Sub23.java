...
public final class Class39_Sub23 extends Class39 {
	...
	public Class39_Sub23(@OriginalArg(0) Class2_Sub21 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		if (arg1 == 0) {
			...
			this.anInt9980 = -1;
			this.anInt9972 = -1;
			this.anInt9982 = arg0.method5191();
		}
		if (arg2 == 0) {
			local10 = arg0.method5158();
			...
			this.anInt9973 = -1;
			this.anInt9985 = -1;
			this.anInt9989 = arg0.method5191();
		}
		if (arg1 == 0 && arg2 == 0) {
			this.anInt9983 = arg0.method5205();
		} else {
			this.anInt9983 = -1;
		}
		this.anInt9976 = arg0.method5191();
		this.anInt9974 = arg0.method5205();
		this.anInt9988 = arg0.method5205();
		this.anInt9978 = arg0.method5192();
		this.anInt9977 = arg0.method5191();
		this.anInt9979 = arg0.method5205();
	}
	...
	public void method6590() {
		...
		if (this.anInt9980 < 0) {
			local15 = Static219.aClass236Array1[this.anInt9982].method3805();
		...
		if (this.anInt9972 >= 0) {
			...
			local15 = Static219.aClass236Array1[this.anInt9989].method3805();
		...
		local128.a(this.anInt9988 << 2, this.anInt9978 + Static333.anInt5455, local56, local63);
		Static505.aClass339_77.method5465(new Class2_Sub2_Sub15(local128));
	}
}
