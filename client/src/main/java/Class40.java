...
public final class Class40 {
	...
	public long method591(@OriginalArg(0) int arg0) {
		return this.aLong31 + (long) arg0 * (long) this.anInt989;
	}

	@OriginalMember(owner = "client!bha", name = "b", descriptor = "(I)I")
	public int method592(@OriginalArg(0) int arg0) {
		return this.method602(arg0);
	}
	...
	private int method595(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12;
		if (arg1 != 255) {
			@Pc(78) byte local78 = Static43.aByteArray11[arg1 - 128];
			local12 = arg1;
			if (local78 >= 1) {
				local12 = arg1 | this.aClass2_Sub21_3.method5205() << 8;
			}
			if (local78 >= 2) {
				local12 |= this.aClass2_Sub21_3.method5205() << 16;
			}
			return local12;
		}
		@Pc(7) int local7 = this.aClass2_Sub21_3.method5205();
		local12 = this.aClass2_Sub21_3.method5211();
		if (local7 == 47) {
			this.aClass2_Sub21_3.anInt8388 += local12;
			return 1;
		} else if (local7 == 81) {
			@Pc(32) int local32 = this.aClass2_Sub21_3.method5192();
			local12 -= 3;
	...
	public void method596(@OriginalArg(0) byte[] arg0) {
		this.aClass2_Sub21_3.aByteArray93 = arg0;
		this.aClass2_Sub21_3.anInt8388 = 10;
		@Pc(12) int local12 = this.aClass2_Sub21_3.method5191();
		this.anInt988 = this.aClass2_Sub21_3.method5191();
		this.anInt989 = 500000;
		this.anIntArray71 = new int[local12];
		@Pc(27) int local27 = 0;
		@Pc(33) int local33;
		while (local27 < local12) {
			local33 = this.aClass2_Sub21_3.method5158();
			@Pc(38) int local38 = this.aClass2_Sub21_3.method5158();
	...
	public void method601(@OriginalArg(0) long arg0) {
		this.aLong31 = arg0;
	...
	private int method602(@OriginalArg(0) int arg0) {
		...
		if (local13 != 240 && local13 != 247) {
			return this.method595(arg0, local13);
		}
		@Pc(42) int local42 = this.aClass2_Sub21_3.method5211();
		if (local13 == 247 && local42 > 0) {
			...
			if (local57 >= 241 && local57 <= 243 || local57 == 246 || local57 == 248 || local57 >= 250 && local57 <= 252 || local57 == 254) {
				...
				return this.method595(arg0, local57);
			}
		}
	...
	public void method604(@OriginalArg(0) int arg0) {
		@Pc(4) int local4 = this.aClass2_Sub21_3.method5211();
