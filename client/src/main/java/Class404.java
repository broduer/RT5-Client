...
public final class Class404 {
	...
	public void method6731() {
		...
		if (60 < 29) {
			Static715.method6736((String) null, 79, (String) null, -124, false);
		}
	...
	public void method6732(@OriginalArg(0) long arg0, @OriginalArg(1) byte[] arg1) {
		@Pc(7) int local7 = 0;
	...
	public void method6733(@OriginalArg(0) byte[] arg0) {
		...
		Static734.method5448(this.aByteArray113, 0, this.aByteArray112, 32, 32);
		this.method6734();
	...
	private void method6734() {
		...
		@Pc(9) int local9 = 0;
		while (local7 < 8) {
			this.aLongArray25[local7] = Static315.method3199(Static570.method5317(255L, (long) this.aByteArray112[local9 + 7]), Static315.method3199(Static570.method5317(0xFFL << 8, (long) this.aByteArray112[local9 + 6] << 8), Static315.method3199(Static315.method3199(Static315.method3199(Static315.method3199(Static570.method5317(0xFFL << 40, (long) this.aByteArray112[local9 + 2] << 40), Static315.method3199(Static570.method5317(255L, (long) this.aByteArray112[local9 + 1]) << 48, (long) this.aByteArray112[local9] << 56)), Static570.method5317(0xFFL << 32, (long) this.aByteArray112[local9 + 3] << 32)), Static570.method5317(255L, (long) this.aByteArray112[local9 + 4]) << 24), Static570.method5317((long) this.aByteArray112[local9 + 5], 255L) << 16)));
			local9 += 8;
			local7++;
		}
		for (@Pc(121) int local121 = 0; local121 < 8; local121++) {
			this.aLongArray23[local121] = Static315.method3199(this.aLongArray25[local121], this.aLongArray24[local121] = this.aLongArray22[local121]);
		}
		@Pc(159) int local159;
		for (@Pc(153) int local153 = 1; local153 <= 10; local153++) {
			...
			for (local159 = 0; local159 < 8; local159++) {
				...
				local170 = 56;
				while (local168 < 8) {
					this.aLongArray26[local159] = Static315.method3199(this.aLongArray26[local159], Class90_Sub2_Sub1.aLongArrayArray1[local168][(int) (this.aLongArray24[local159 - local168 & 0x7] >>> local170) & 0xFF]);
					local170 -= 8;
					local168++;
				}
			}
			...
			this.aLongArray24[0] = Static315.method3199(this.aLongArray24[0], Class90_Sub2_Sub1.aLongArray19[local153]);
			@Pc(262) int local262;
			for (local170 = 0; local170 < 8; local170++) {
				...
				while (local262 < 8) {
					this.aLongArray26[local170] = Static315.method3199(this.aLongArray26[local170], Class90_Sub2_Sub1.aLongArrayArray1[local262][(int) (this.aLongArray23[local170 - local262 & 0x7] >>> local264) & 0xFF]);
					local262++;
					local264 -= 8;
				}
			}
		...
		for (local159 = 0; local159 < 8; local159++) {
			this.aLongArray22[local159] = Static315.method3199(this.aLongArray22[local159], Static315.method3199(this.aLongArray23[local159], this.aLongArray25[local159]));
		}
	}
}
