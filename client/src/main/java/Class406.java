...
public final class Class406 {
	...
	public void method9350(@OriginalArg(0) long arg0, @OriginalArg(1) byte[] arg1) {
		@Pc(7) int local7 = 0;
		@Pc(24) int local24 = 8 - ((int) arg0 & 0x7) & 0x7;
		@Pc(29) int local29 = this.anInt10841 & 0x7;
		...
		while (arg0 > 8L) {
			...
			this.aByteArray112[this.anInt10836] = (byte) (this.aByteArray112[this.anInt10836] | local96 >>> local29);
			...
			this.aByteArray112[this.anInt10836] = (byte) (local96 << 8 - local29 & 0xFF);
			this.anInt10841 += local29;
			local7++;
			arg0 -= 8L;
		}
		if (arg0 <= 0L) {
		...
		if (arg0 + (long) local29 < 8L) {
			this.anInt10841 = (int) ((long) this.anInt10841 + arg0);
			return;
		}
		this.anInt10841 += 8 - local29;
		this.anInt10836++;
		...
		this.aByteArray112[this.anInt10836] = (byte) (local96 << 8 - local29 & 0xFF);
		this.anInt10841 += (int) arg0;
	}

	@OriginalMember(owner = "client!wla", name = "a", descriptor = "([BII)V")
	public void method9351(@OriginalArg(0) byte[] arg0) {
		this.aByteArray112[this.anInt10836] = (byte) (this.aByteArray112[this.anInt10836] | 0x80 >>> (this.anInt10841 & 0x7));
		this.anInt10836++;
		if (this.anInt10836 > 32) {
			while (true) {
				if (this.anInt10836 >= 64) {
					this.method9352();
					this.anInt10836 = 0;
					break;
				}
	...
	private void method9352() {
		...
		for (@Pc(121) int local121 = 0; local121 < 8; local121++) {
			this.aLongArray23[local121] = Static315.method4583(this.aLongArray25[local121], this.aLongArray24[local121] = this.aLongArray22[local121]);
		}
		@Pc(159) int local159;
		for (@Pc(153) int local153 = 1; local153 <= 10; local153++) {
			...
			for (local159 = 0; local159 < 8; local159++) {
				...
				local170 = 56;
				while (local168 < 8) {
					this.aLongArray26[local159] = Static315.method4583(this.aLongArray26[local159], Class90_Sub2_Sub1.aLongArrayArray1[local168][(int) (this.aLongArray24[local159 - local168 & 0x7] >>> local170) & 0xFF]);
					local170 -= 8;
					local168++;
				}
			}
			...
			this.aLongArray24[0] = Static315.method4583(this.aLongArray24[0], Class90_Sub2_Sub1.aLongArray19[local153]);
			@Pc(262) int local262;
			for (local170 = 0; local170 < 8; local170++) {
				...
				while (local262 < 8) {
					this.aLongArray26[local170] = Static315.method4583(this.aLongArray26[local170], Class90_Sub2_Sub1.aLongArrayArray1[local262][(int) (this.aLongArray23[local170 - local262 & 0x7] >>> local264) & 0xFF]);
					local262++;
					local264 -= 8;
				}
			}
		...
		for (local159 = 0; local159 < 8; local159++) {
			this.aLongArray22[local159] = Static315.method4583(this.aLongArray22[local159], Static315.method4583(this.aLongArray23[local159], this.aLongArray25[local159]));
		}
	}
}
