...
public final class Class407 {
	...
	@OriginalMember(owner = "client!wp", name = "f", descriptor = "()I")
	public int method6767() {
		return this.anInt10847 + this.anInt10852 + this.anInt10851;
	}

	@OriginalMember(owner = "client!wp", name = "a", descriptor = "(I)V")
	public void method6769(@OriginalArg(0) int arg0) {
		@Pc(2) int local2 = this.method6767();
		@Pc(5) int local5 = this.method6773();
	...
	public void method6770(@OriginalArg(0) int arg0) {
		@Pc(1) int local1 = -1;
		@Pc(8) int local8;
		@Pc(69) int local69;
		@Pc(63) int local63;
		if (this.anIntArray882.length < 255) {
			...
			if (local1 == -1) {
				...
				Static734.method5449(this.anIntArray882, 0, local38, 0, this.anIntArray882.length);
	...
	@OriginalMember(owner = "client!wp", name = "b", descriptor = "()[I")
	public int[] method6772() {
		@Pc(2) int local2 = this.method6767();
		@Pc(8) int[] local8 = new int[local2 * this.method6773()];
		@Pc(13) int local13;
		@Pc(19) int local19;
		@Pc(29) int local29;
		@Pc(31) int local31;
