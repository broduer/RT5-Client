...
public final class Class42 {
	...
	private void method1077(@OriginalArg(1) Class19_Sub3 arg0, @OriginalArg(2) int arg1) {
		...
		this.aClass2_Sub21_Sub1_1.anInt8412 = 0;
		@Pc(99) int local99;
		@Pc(117) int local117;
		@Pc(123) int local123;
			...
			for (local99 = arg1 - 1; local99 >= 0; local99--) {
				...
				if (local117 > 0) {
					for (local123 = local117 - 1; local123 >= 0; local123--) {
						...
						local137 = local134.anInt7562;
						local142 = (byte) (local137 >> 16);
						local147 = (byte) (local137 >> 8);
						local150 = (byte) local137;
						local155 = (byte) (local137 >>> 24);
						local161 = (float) (local134.anInt7560 >> 12);
						local167 = (float) (local134.anInt7557 >> 12);
						local173 = (float) (local134.anInt7559 >> 12);
						local178 = local134.anInt7558 >> 12;
						this.aClass2_Sub21_Sub1_1.method4343(0.0F);
						this.aClass2_Sub21_Sub1_1.method4343(0.0F);
						this.aClass2_Sub21_Sub1_1.method4343(local161 + (float) -local178 * local54);
						this.aClass2_Sub21_Sub1_1.method4343((float) -local178 * local58 + local167);
						this.aClass2_Sub21_Sub1_1.method4343((float) -local178 * local62 + local173);
						this.aClass2_Sub21_Sub1_1.method7396(local142);
						this.aClass2_Sub21_Sub1_1.method7396(local147);
						this.aClass2_Sub21_Sub1_1.method7396(local150);
						this.aClass2_Sub21_Sub1_1.method7396(local155);
						this.aClass2_Sub21_Sub1_1.method4343(1.0F);
						this.aClass2_Sub21_Sub1_1.method4343(0.0F);
						this.aClass2_Sub21_Sub1_1.method4343(local161 + (float) local178 * local66);
						this.aClass2_Sub21_Sub1_1.method4343((float) local178 * local71 + local167);
						this.aClass2_Sub21_Sub1_1.method4343(local173 + (float) local178 * local75);
						this.aClass2_Sub21_Sub1_1.method7396(local142);
						this.aClass2_Sub21_Sub1_1.method7396(local147);
						this.aClass2_Sub21_Sub1_1.method7396(local150);
						this.aClass2_Sub21_Sub1_1.method7396(local155);
						this.aClass2_Sub21_Sub1_1.method4343(1.0F);
						this.aClass2_Sub21_Sub1_1.method4343(1.0F);
						this.aClass2_Sub21_Sub1_1.method4343(local54 * (float) local178 + local161);
						this.aClass2_Sub21_Sub1_1.method4343(local167 + (float) local178 * local58);
						this.aClass2_Sub21_Sub1_1.method4343(local173 + local62 * (float) local178);
						this.aClass2_Sub21_Sub1_1.method7396(local142);
						this.aClass2_Sub21_Sub1_1.method7396(local147);
						this.aClass2_Sub21_Sub1_1.method7396(local150);
						this.aClass2_Sub21_Sub1_1.method7396(local155);
						this.aClass2_Sub21_Sub1_1.method4343(0.0F);
						this.aClass2_Sub21_Sub1_1.method4343(1.0F);
						this.aClass2_Sub21_Sub1_1.method4343(local80 * (float) local178 + local161);
						this.aClass2_Sub21_Sub1_1.method4343(local167 + (float) local178 * local84);
						this.aClass2_Sub21_Sub1_1.method4343(local173 + local88 * (float) local178);
						this.aClass2_Sub21_Sub1_1.method7396(local142);
						this.aClass2_Sub21_Sub1_1.method7396(local147);
						this.aClass2_Sub21_Sub1_1.method7396(local150);
						this.aClass2_Sub21_Sub1_1.method7396(local155);
					...
					if (this.anIntArray74[local99] > 64) {
						...
						for (local137 = this.anIntArray76[local448] - 1; local137 >= 0; local137--) {
							...
							local467 = local464.anInt7562;
							local150 = (byte) (local467 >> 16);
							local155 = (byte) (local467 >> 8);
							local480 = (byte) local467;
							local485 = (byte) (local467 >>> 24);
							local173 = (float) (local464.anInt7560 >> 12);
							local497 = (float) (local464.anInt7557 >> 12);
							local503 = (float) (local464.anInt7559 >> 12);
							local508 = local464.anInt7558 >> 12;
							this.aClass2_Sub21_Sub1_1.method4343(0.0F);
							this.aClass2_Sub21_Sub1_1.method4343(0.0F);
							this.aClass2_Sub21_Sub1_1.method4343((float) -local508 * local54 + local173);
							this.aClass2_Sub21_Sub1_1.method4343(local58 * (float) -local508 + local497);
							this.aClass2_Sub21_Sub1_1.method4343((float) -local508 * local62 + local503);
							this.aClass2_Sub21_Sub1_1.method7396(local150);
							this.aClass2_Sub21_Sub1_1.method7396(local155);
							this.aClass2_Sub21_Sub1_1.method7396(local480);
							this.aClass2_Sub21_Sub1_1.method7396(local485);
							this.aClass2_Sub21_Sub1_1.method4343(1.0F);
							this.aClass2_Sub21_Sub1_1.method4343(0.0F);
							this.aClass2_Sub21_Sub1_1.method4343((float) local508 * local66 + local173);
							this.aClass2_Sub21_Sub1_1.method4343(local497 + local71 * (float) local508);
							this.aClass2_Sub21_Sub1_1.method4343((float) local508 * local75 + local503);
							this.aClass2_Sub21_Sub1_1.method7396(local150);
							this.aClass2_Sub21_Sub1_1.method7396(local155);
							this.aClass2_Sub21_Sub1_1.method7396(local480);
							this.aClass2_Sub21_Sub1_1.method7396(local485);
							this.aClass2_Sub21_Sub1_1.method4343(1.0F);
							this.aClass2_Sub21_Sub1_1.method4343(1.0F);
							this.aClass2_Sub21_Sub1_1.method4343(local173 + local54 * (float) local508);
							this.aClass2_Sub21_Sub1_1.method4343(local497 + local58 * (float) local508);
							this.aClass2_Sub21_Sub1_1.method4343(local62 * (float) local508 + local503);
							this.aClass2_Sub21_Sub1_1.method7396(local150);
							this.aClass2_Sub21_Sub1_1.method7396(local155);
							this.aClass2_Sub21_Sub1_1.method7396(local480);
							this.aClass2_Sub21_Sub1_1.method7396(local485);
							this.aClass2_Sub21_Sub1_1.method4343(0.0F);
							this.aClass2_Sub21_Sub1_1.method4343(1.0F);
							this.aClass2_Sub21_Sub1_1.method4343(local173 + local80 * (float) local508);
							this.aClass2_Sub21_Sub1_1.method4343(local497 + (float) local508 * local84);
							this.aClass2_Sub21_Sub1_1.method4343(local88 * (float) local508 + local503);
							this.aClass2_Sub21_Sub1_1.method7396(local150);
							this.aClass2_Sub21_Sub1_1.method7396(local155);
							this.aClass2_Sub21_Sub1_1.method7396(local480);
							this.aClass2_Sub21_Sub1_1.method7396(local485);
			...
			for (local99 = arg1 - 1; local99 >= 0; local99--) {
				...
				if (local117 > 0) {
					for (local123 = local117 - 1; local123 >= 0; local123--) {
						...
						local173 = (float) (local134.anInt7559 >> 12);
						local178 = local134.anInt7558 >> 12;
						this.aClass2_Sub21_Sub1_1.method4344(0.0F);
						this.aClass2_Sub21_Sub1_1.method4344(0.0F);
						this.aClass2_Sub21_Sub1_1.method4344(local54 * (float) -local178 + local161);
						this.aClass2_Sub21_Sub1_1.method4344((float) -local178 * local58 + local167);
						this.aClass2_Sub21_Sub1_1.method4344(local62 * (float) -local178 + local173);
						this.aClass2_Sub21_Sub1_1.method7396(local142);
						this.aClass2_Sub21_Sub1_1.method7396(local147);
						this.aClass2_Sub21_Sub1_1.method7396(local150);
						this.aClass2_Sub21_Sub1_1.method7396(local155);
						this.aClass2_Sub21_Sub1_1.method4344(1.0F);
						this.aClass2_Sub21_Sub1_1.method4344(0.0F);
						this.aClass2_Sub21_Sub1_1.method4344(local66 * (float) local178 + local161);
						this.aClass2_Sub21_Sub1_1.method4344(local167 + (float) local178 * local71);
						this.aClass2_Sub21_Sub1_1.method4344(local173 + local75 * (float) local178);
						this.aClass2_Sub21_Sub1_1.method7396(local142);
						this.aClass2_Sub21_Sub1_1.method7396(local147);
						this.aClass2_Sub21_Sub1_1.method7396(local150);
						this.aClass2_Sub21_Sub1_1.method7396(local155);
						...
						this.aClass2_Sub21_Sub1_1.method4344(local54 * (float) local178 + local161);
						this.aClass2_Sub21_Sub1_1.method4344((float) local178 * local58 + local167);
						this.aClass2_Sub21_Sub1_1.method4344(local173 + (float) local178 * local62);
						this.aClass2_Sub21_Sub1_1.method7396(local142);
						this.aClass2_Sub21_Sub1_1.method7396(local147);
						this.aClass2_Sub21_Sub1_1.method7396(local150);
						this.aClass2_Sub21_Sub1_1.method7396(local155);
						this.aClass2_Sub21_Sub1_1.method4344(0.0F);
						this.aClass2_Sub21_Sub1_1.method4344(1.0F);
						this.aClass2_Sub21_Sub1_1.method4344((float) local178 * local80 + local161);
						this.aClass2_Sub21_Sub1_1.method4344(local167 + (float) local178 * local84);
						this.aClass2_Sub21_Sub1_1.method4344((float) local178 * local88 + local173);
						this.aClass2_Sub21_Sub1_1.method7396(local142);
						this.aClass2_Sub21_Sub1_1.method7396(local147);
						this.aClass2_Sub21_Sub1_1.method7396(local150);
						this.aClass2_Sub21_Sub1_1.method7396(local155);
					...
					if (this.anIntArray74[local99] > 64) {
						...
						for (local137 = this.anIntArray76[local448] - 1; local137 >= 0; local137--) {
							...
							this.aClass2_Sub21_Sub1_1.method4344(0.0F);
							this.aClass2_Sub21_Sub1_1.method4344(0.0F);
							this.aClass2_Sub21_Sub1_1.method4344(local173 + local54 * (float) -local508);
							this.aClass2_Sub21_Sub1_1.method4344(local58 * (float) -local508 + local497);
							this.aClass2_Sub21_Sub1_1.method4344((float) -local508 * local62 + local503);
							this.aClass2_Sub21_Sub1_1.method7396(local150);
							this.aClass2_Sub21_Sub1_1.method7396(local155);
							this.aClass2_Sub21_Sub1_1.method7396(local480);
							this.aClass2_Sub21_Sub1_1.method7396(local485);
							this.aClass2_Sub21_Sub1_1.method4344(1.0F);
							this.aClass2_Sub21_Sub1_1.method4344(0.0F);
							this.aClass2_Sub21_Sub1_1.method4344(local66 * (float) local508 + local173);
							this.aClass2_Sub21_Sub1_1.method4344((float) local508 * local71 + local497);
							this.aClass2_Sub21_Sub1_1.method4344(local75 * (float) local508 + local503);
							this.aClass2_Sub21_Sub1_1.method7396(local150);
							this.aClass2_Sub21_Sub1_1.method7396(local155);
							this.aClass2_Sub21_Sub1_1.method7396(local480);
							this.aClass2_Sub21_Sub1_1.method7396(local485);
							...
							this.aClass2_Sub21_Sub1_1.method4344(1.0F);
							this.aClass2_Sub21_Sub1_1.method4344(local173 + local54 * (float) local508);
							this.aClass2_Sub21_Sub1_1.method4344((float) local508 * local58 + local497);
							this.aClass2_Sub21_Sub1_1.method4344((float) local508 * local62 + local503);
							this.aClass2_Sub21_Sub1_1.method7396(local150);
							this.aClass2_Sub21_Sub1_1.method7396(local155);
							this.aClass2_Sub21_Sub1_1.method7396(local480);
							...
							this.aClass2_Sub21_Sub1_1.method4344(0.0F);
							this.aClass2_Sub21_Sub1_1.method4344(1.0F);
							this.aClass2_Sub21_Sub1_1.method4344(local173 + local80 * (float) local508);
							this.aClass2_Sub21_Sub1_1.method4344(local84 * (float) local508 + local497);
							this.aClass2_Sub21_Sub1_1.method4344(local503 + (float) local508 * local88);
							this.aClass2_Sub21_Sub1_1.method7396(local150);
							this.aClass2_Sub21_Sub1_1.method7396(local155);
							this.aClass2_Sub21_Sub1_1.method7396(local480);
							this.aClass2_Sub21_Sub1_1.method7396(local485);
		...
		if (this.aClass2_Sub21_Sub1_1.anInt8412 != 0) {
			this.anInterface12_1.method5009(this.aClass2_Sub21_Sub1_1.aByteArray93, this.aClass2_Sub21_Sub1_1.anInt8412, 24);
			arg0.method7046(this.aClass94_2, (Class94) null, this.aClass94_1, this.aClass94_3);
			arg0.method7005(this.aClass2_Sub21_Sub1_1.anInt8412 / 24);
		}
	}

	@OriginalMember(owner = "client!bj", name = "a", descriptor = "(ILclient!qha;)V")
	private void method1078(@OriginalArg(1) Class19_Sub3 arg0) {
		arg0.method6979(true);
	...
	private void method1079(@OriginalArg(0) int arg0, @OriginalArg(1) Class19_Sub3 arg1) {
		...
		arg1.method6971((float) arg0);
		arg1.method6985();
		OpenGL.glDisable(16384);
		OpenGL.glDisable(16385);
		arg1.method6979(false);
		OpenGL.glNormal3f(0.0F, -1.0F, 0.0F);
	}

	@OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lclient!qha;Lclient!lk;IZ)V")
	public void method1080(@OriginalArg(0) Class19_Sub3 arg0, @OriginalArg(1) Class232 arg1, @OriginalArg(2) int arg2) {
		...
		try {
			...
			for (local59 = local56.aClass8_Sub4_10; local59 != local56; local59 = local59.aClass8_Sub4_10) {
				...
				local91 = (int) (local46 + local42 * (float) (local64.anInt7559 >> 12) + (float) (local64.anInt7560 >> 12) * local34 + (float) (local64.anInt7557 >> 12) * local38);
				if (local91 > local52) {
					local52 = local91;
				}
			...
			while (local59 != local56) {
				...
				while (local59 != local56) {
					...
					if (local156) {
						...
						local152 = local210.anInt7563;
						local156 = false;
					}
					if (local48 > 0 && (local210.anInt7563 != local152 || local210.aBoolean574 != local154)) {
						local156 = true;
						break;
					}
					...
					if (local257 < 1600) {
						if (this.anIntArray74[local257] >= 64) {
							label102: {
								if (this.anIntArray74[local257] == 64) {
									if (this.anInt1004 == 64) {
										break label102;
									}
									this.anIntArray74[local257] += this.anInt1004++ + 1;
								}
	...
	public void method1081(@OriginalArg(1) Class19_Sub3 arg0) {
		this.anInterface12_1 = arg0.method7031(true, 196584, (byte[]) null, 24);
