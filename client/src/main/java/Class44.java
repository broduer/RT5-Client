...
public final class Class44 {
	...
	public Class44() {
		@Pc(4) int local4 = Static650.method6049(16);
		if (local4 != 1) {
			throw new RuntimeException();
		}
		@Pc(15) int local15 = Static650.method6049(5);
		@Pc(17) int local17 = 0;
		this.anIntArray78 = new int[local15];
		@Pc(27) int local27;
		for (@Pc(23) int local23 = 0; local23 < local15; local23++) {
			local27 = Static650.method6049(4);
		...
		for (local27 = 0; local27 < local17; local27++) {
			this.anIntArray84[local27] = Static650.method6049(3) + 1;
			local78 = this.anIntArray79[local27] = Static650.method6049(2);
			if (local78 != 0) {
				this.anIntArray83[local27] = Static650.method6049(8);
			}
			local78 = 0x1 << local78;
			@Pc(95) int[] local95 = new int[local78];
			this.anIntArrayArray22[local27] = local95;
			for (local102 = 0; local102 < local78; local102++) {
				local95[local102] = Static650.method6049(8) - 1;
			}
		}
		this.anInt1004 = Static650.method6049(2) + 1;
		local78 = Static650.method6049(4);
		...
		for (@Pc(168) int local168 = 0; local168 < local15; local168++) {
			...
			for (@Pc(176) int local176 = 0; local176 < this.anIntArray84[local174]; local176++) {
				this.anIntArray81[local131++] = Static650.method6049(local78);
			}
		}
	...
	public void method621(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1) {
		...
		for (@Pc(20) int local20 = 2; local20 < local3; local20++) {
			local25 = Static47.method620(Static47.anIntArray80, local20);
			local29 = Static47.method622(Static47.anIntArray80, local20);
			local47 = this.method623(Static47.anIntArray80[local25], Static47.anIntArray82[local25], Static47.anIntArray80[local29], Static47.anIntArray82[local29], Static47.anIntArray80[local20]);
		...
		for (local47 = 1; local47 < local3; local47++) {
			if (Static47.aBooleanArray1[local47]) {
				...
				this.method626(local25, local29, local51, local55, arg0, arg1);
				if (local51 >= arg1) {
					return;
				}
				local25 = local51;
	...
	private int method623(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
	...
	public boolean method624() {
		@Pc(6) boolean local6 = Static650.method6058() != 0;
		if (!local6) {
			return false;
		}
		...
		@Pc(42) int local42 = Static434.method4154(local36 - 1);
		Static47.anIntArray82[0] = Static650.method6049(local42);
		Static47.anIntArray82[1] = Static650.method6049(local42);
		@Pc(54) int local54 = 2;
		for (@Pc(56) int local56 = 0; local56 < this.anIntArray78.length; local56++) {
			...
			@Pc(80) int local80 = 0;
			if (local72 > 0) {
				local80 = Static650.aClass271Array1[this.anIntArray83[local62]].method4253();
			}
			for (@Pc(92) int local92 = 0; local92 < local67; local92++) {
				@Pc(102) int local102 = this.anIntArrayArray22[local62][local80 & local78];
				local80 >>>= local72;
				Static47.anIntArray82[local54++] = local102 >= 0 ? Static650.aClass271Array1[local102].method4253() : 0;
			}
		}
		return true;
	}
	...
	private void method626(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) float[] arg4, @OriginalArg(5) int arg5) {
		@Pc(3) int local3 = arg3 - arg1;
		@Pc(7) int local7 = arg2 - arg0;
		@Pc(15) int local15 = local3 < 0 ? -local3 : local3;
	...
	private void method627(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 >= arg1) {
			return;
		}
		...
		this.method627(arg0, local6 - 1);
		this.method627(local6 + 1, arg1);
	}
}
