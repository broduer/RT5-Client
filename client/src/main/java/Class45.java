...
public final class Class45 {
	...
	public Class45(@OriginalArg(0) Class377 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class330 arg2) {
		...
		if (this.aClass330_9 != null) {
			this.aClass330_9.method5372(35);
		}
	}
	...
	public void method628() {
		...
		synchronized (this.aClass82_17) {
			this.aClass82_17.method1385();
		}
	}

	@OriginalMember(owner = "client!bka", name = "a", descriptor = "(IB)Lclient!la;")
	public Class218 method629(@OriginalArg(0) int arg0) {
		@Pc(6) Class82 local6 = this.aClass82_17;
		@Pc(16) Class218 local16;
		synchronized (this.aClass82_17) {
			local16 = (Class218) this.aClass82_17.method1390((long) arg0);
		}
		if (local16 != null) {
			return local16;
		}
		...
		synchronized (this.aClass330_9) {
			local39 = this.aClass330_9.method5359(arg0, 35);
		}
		local16 = new Class218();
		if (local39 != null) {
			local16.method3594(new Class2_Sub21(local39));
		}
		local16.method3590();
		@Pc(66) Class82 local66 = this.aClass82_17;
		synchronized (this.aClass82_17) {
			this.aClass82_17.method1384(local16, (long) arg0);
			return local16;
		}
	}
