...
public final class Class50 {
	...
	public Class50(@OriginalArg(0) Class377 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class330 arg2, @OriginalArg(3) Class330 arg3, @OriginalArg(4) Class330 arg4) {
		...
		if (this.aClass330_11 != null) {
			@Pc(26) int local26 = this.aClass330_11.method5361() - 1;
			this.aClass330_11.method5372(local26);
		}
		Static642.method5994(arg4, arg3);
	}

	@OriginalMember(owner = "client!bp", name = "a", descriptor = "(IB)Lclient!cka;")
	public Class69 method682(@OriginalArg(0) int arg0) {
		@Pc(6) Class82 local6 = this.aClass82_22;
		@Pc(16) Class69 local16;
		synchronized (this.aClass82_22) {
			local16 = (Class69) this.aClass82_22.method1390((long) arg0);
		}
		if (local16 != null) {
			return local16;
		}
		...
		synchronized (this.aClass330_11) {
			local43 = this.aClass330_11.method5359(Static668.method6209(arg0), Static291.method2901(arg0));
		}
		local16 = new Class69();
		local16.anInt1650 = arg0;
		if (local43 != null) {
			local16.method1019(new Class2_Sub21(local43));
		}
		local16.method1018();
		@Pc(73) Class82 local73 = this.aClass82_22;
		synchronized (this.aClass82_22) {
			this.aClass82_22.method1384(local16, (long) arg0);
			return local16;
		}
	}
	...
	public void method683() {
		@Pc(6) Class82 local6 = this.aClass82_22;
		synchronized (this.aClass82_22) {
			this.aClass82_22.method1381(5);
		}
		local6 = this.aClass82_23;
		synchronized (this.aClass82_23) {
			this.aClass82_23.method1381(5);
		}
	}
	...
	public void method684() {
		...
		synchronized (this.aClass82_22) {
			this.aClass82_22.method1385();
		}
		local2 = this.aClass82_23;
		synchronized (this.aClass82_23) {
			this.aClass82_23.method1385();
		}
	}
	...
	public void method685() {
		...
		synchronized (this.aClass82_22) {
			this.aClass82_22.method1391();
		}
		local7 = this.aClass82_23;
		synchronized (this.aClass82_23) {
			this.aClass82_23.method1391();
		}
	}

	@OriginalMember(owner = "client!bp", name = "b", descriptor = "(II)Lclient!rw;")
	public Class2_Sub2_Sub18 method686(@OriginalArg(0) int arg0) {
		@Pc(12) Class82 local12 = this.aClass82_23;
		synchronized (this.aClass82_23) {
			@Pc(22) Class2_Sub2_Sub18 local22 = (Class2_Sub2_Sub18) this.aClass82_23.method1390((long) arg0);
			if (local22 == null) {
				local22 = new Class2_Sub2_Sub18(arg0);
				this.aClass82_23.method1384(local22, (long) arg0);
			}
			return local22.method5329() ? local22 : null;
		}
	}
}
