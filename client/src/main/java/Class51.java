...
public abstract class Class51 implements Interface17 {
	...
	private Class261 aClass261_15 = Static60.aClass261_3;
	...
	protected final int anInt9874;

	@OriginalMember(owner = "client!hka", name = "u", descriptor = "Lclient!wda;")
	protected final Class399 aClass399_11;
	...
	protected Class51(@OriginalArg(0) Class19_Sub1_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class92 arg2, @OriginalArg(3) Class399 arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		this.aClass92_14 = arg2;
		this.anInt9874 = arg1;
		this.aClass399_11 = arg3;
		this.aClass19_Sub1_Sub2_12 = arg0;
		this.anInt9883 = arg4;
		this.aBoolean755 = arg5;
		OpenGL.glGenTextures(1, Static374.anIntArray457, 0);
		this.anInt9881 = Static374.anIntArray457[0];
		this.method8641();
		this.method8644();
	}
	...
	@Override
	public final void method9050() {
		@Pc(8) int local8 = this.aClass19_Sub1_Sub2_12.method8033();
		@Pc(21) int local21 = this.aClass19_Sub1_Sub2_12.anIntArray712[local8];
		if (this.anInt9874 != local21) {
			if (local21 != 0) {
				OpenGL.glBindTexture(local21, 0);
				OpenGL.glDisable(local21);
			}
			OpenGL.glEnable(this.anInt9874);
			this.aClass19_Sub1_Sub2_12.anIntArray712[local8] = this.anInt9874;
		}
		OpenGL.glBindTexture(this.anInt9874, this.anInt9881);
	}

	@OriginalMember(owner = "client!hka", name = "g", descriptor = "(I)I")
	protected final int method8638() {
		if (Static702.aClass399_16 == this.aClass399_11) {
		...
		} else if (Static702.aClass399_19 == this.aClass399_11) {
		...
		} else if (Static702.aClass399_20 == this.aClass399_11) {
			if (this.aClass92_14 == Static685.aClass92_16) {
				return 34837;
			}
			if (this.aClass92_14 == Static172.aClass92_8) {
	...
	private int method8640() {
		@Pc(20) int local20 = this.anInt9883 * this.aClass399_11.anInt10596 * this.aClass92_14.anInt2425;
		return this.aBoolean755 ? local20 * 4 / 3 : local20;
	}

	@OriginalMember(owner = "client!hka", name = "c", descriptor = "(I)V")
	private void method8641() {
		this.aClass19_Sub1_Sub2_12.method8095(this);
		if (Static60.aClass261_3 == this.aClass261_15) {
			OpenGL.glTexParameteri(this.anInt9874, 10241, this.aBoolean755 ? 9987 : 9729);
			OpenGL.glTexParameteri(this.anInt9874, 10240, 9729);
		} else {
			OpenGL.glTexParameteri(this.anInt9874, 10241, this.aBoolean755 ? 9984 : 9728);
			OpenGL.glTexParameteri(this.anInt9874, 10240, 9728);
		}
	}

	@OriginalMember(owner = "client!hka", name = "a", descriptor = "(BLclient!nga;)V")
	@Override
	public final void method9048(@OriginalArg(1) Class261 arg0) {
		if (this.aClass261_15 != arg0) {
			this.aClass261_15 = arg0;
			this.method8641();
		}
	}

	@OriginalMember(owner = "client!hka", name = "a", descriptor = "(I[IIII)V")
	protected final void method8643(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		if (arg3 > 0 && !Static700.method9157(arg3)) {
			throw new IllegalArgumentException("");
		} else if (arg2 > 0 && !Static700.method9157(arg2)) {
			throw new IllegalArgumentException("");
			...
			while (true) {
				OpenGL.glTexImage2Di(arg0, local45, this.method8638(), arg3, arg2, 0, 32993, this.aClass19_Sub1_Sub2_12.anInt9303, local71, 0);
				if (local53 <= 1) {
					return;
				}
				@Pc(96) int local96 = 0;
	...
	private void method8644() {
		this.aClass19_Sub1_Sub2_12.anInt9171 += this.method8640();
	}

	@OriginalMember(owner = "client!hka", name = "a", descriptor = "(III[BI)V")
	protected final void method8645(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) byte[] arg2, @OriginalArg(4) int arg3) {
		if (arg3 > 0 && !Static700.method9157(arg3)) {
			throw new IllegalArgumentException("");
		} else if (arg0 <= 0 || Static700.method9157(arg0)) {
			@Pc(40) int local40 = this.aClass92_14.anInt2425;
			@Pc(49) int local49 = 0;
			...
			while (true) {
				OpenGL.glTexImage2Dub(arg1, local49, this.method8638(), arg3, arg0, 0, Static468.method7651(this.aClass92_14), 5121, local71, 0);
				if (local61 <= 1) {
					return;
				}
	...
	protected final void method8646(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3) {
		if (arg1 > 0 && !Static700.method9157(arg1)) {
			throw new IllegalArgumentException("");
		} else if (arg2 <= 0 || Static700.method9157(arg2)) {
			@Pc(40) int local40 = this.aClass92_14.anInt2425;
			@Pc(42) int local42 = 0;
			...
			while (true) {
				OpenGL.glTexImage2Df(arg3, local42, this.method8638(), arg1, arg2, 0, Static468.method7651(this.aClass92_14), 5126, local60, 0);
				if (local50 <= 1) {
					return;
				}
	...
	private void method8647() {
		if (this.anInt9881 > 0) {
			this.aClass19_Sub1_Sub2_12.method8167(this.method8640(), this.anInt9881);
			this.anInt9881 = 0;
		}
	}
}
