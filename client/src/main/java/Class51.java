...
public abstract class Class51 implements Interface17 {
	...
	@Override
	public final void method6477() {
		@Pc(8) int local8 = this.aClass19_Sub1_Sub2_12.method5635();
	...
	protected final int method6148() {
	...
	@Override
	public final void method6475(@OriginalArg(1) Class259 arg0) {
	...
	protected final void method6153(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		if (arg3 > 0 && !Static700.method6579(arg3)) {
			throw new IllegalArgumentException("");
		} else if (arg2 > 0 && !Static700.method6579(arg2)) {
			throw new IllegalArgumentException("");
	...
	private void method6154() {
		this.aClass19_Sub1_Sub2_12.anInt9145 += this.method6150();
	}

	@OriginalMember(owner = "client!hka", name = "a", descriptor = "(III[BI)V")
	protected final void method6155(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) byte[] arg2, @OriginalArg(4) int arg3) {
		if (arg3 > 0 && !Static700.method6579(arg3)) {
			throw new IllegalArgumentException("");
		} else if (arg0 <= 0 || Static700.method6579(arg0)) {
	...
	protected final void method6156(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3) {
		if (arg1 > 0 && !Static700.method6579(arg1)) {
			throw new IllegalArgumentException("");
		} else if (arg2 <= 0 || Static700.method6579(arg2)) {
			@Pc(40) int local40 = this.aClass92_14.anInt2416;
			@Pc(42) int local42 = 0;
	...
	private void method6157() {
		if (this.anInt9855 > 0) {
			this.aClass19_Sub1_Sub2_12.method5769(this.method6150(), this.anInt9855);
			this.anInt9855 = 0;
		}
	}
}
