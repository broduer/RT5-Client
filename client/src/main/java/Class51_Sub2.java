...
public final class Class51_Sub2 extends Class51 implements Interface8 {
	...
	public Class51_Sub2(@OriginalArg(0) Class19_Sub1_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) int[][] arg3) {
		super(arg0, 34067, Static172.aClass92_8, Static702.aClass399_16, arg1 * 6 * arg1, arg2);
		super.aClass19_Sub1_Sub2_12.method8095(this);
		@Pc(22) int local22;
		if (arg2) {
			for (local22 = 0; local22 < 6; local22++) {
				this.method8643(local22 + 34069, arg3[local22], arg1, arg1);
			}
		} else {
			for (local22 = 0; local22 < 6; local22++) {
				OpenGL.glTexImage2Di(local22 + 34069, 0, this.method8638(), arg1, arg1, 0, Static468.method7651(super.aClass92_14), super.aClass19_Sub1_Sub2_12.anInt9303, arg3[local22], 0);
			}
		}
	}
}
