...
public class Class56 {
	...
	private long aLong128 = Static588.method7722();
	...
	private void method3584() {
		...
		if (this.aClass2_Sub6_6 != null) {
			this.aClass2_Sub6_6.method9137(256);
		}
	}
	...
	public final synchronized void method3592() {
		...
		try {
			...
			this.method3596();
			this.aLong129 = Static588.method7722() + 2000L;
		}
	}
	...
	public final synchronized void method3594() {
		...
		@Pc(11) long local11 = Static588.method7722();
		try {
		...
		try {
			if (this.aLong129 != 0L) {
				...
				this.method3588(this.anInt4108);
				this.aLong129 = 0L;
				this.aBoolean320 = true;
			}
			@Pc(95) int local95 = this.method3587();
			if (this.anInt4111 - local95 > this.anInt4112) {
				this.anInt4112 = this.anInt4111 - local95;
			}
			@Pc(118) int local118 = this.anInt4109 + this.anInt4114;
			if (local118 + 256 > 16384) {
				local118 = 16128;
			}
			if (this.anInt4108 < local118 + 256) {
				this.anInt4108 += 1024;
				if (this.anInt4108 > 16384) {
					this.anInt4108 = 16384;
				}
				this.method3596();
				this.method3588(this.anInt4108);
				local95 = 0;
				if (this.anInt4108 < local118 + 256) {
					local118 = this.anInt4108 - 256;
					this.anInt4114 = local118 - this.anInt4109;
				}
				this.aBoolean320 = true;
			}
			...
			if (local11 > this.aLong130) {
				...
				} else if (this.anInt4112 == 0 && this.anInt4113 == 0) {
					this.method3596();
					this.aLong129 = local11 + 2000L;
					return;
				} else {
					this.anInt4114 = Math.min(this.anInt4113, this.anInt4112);
					this.anInt4113 = this.anInt4112;
				}
				this.aLong130 = local11 + 2000L;
				this.anInt4112 = 0;
			}
			this.anInt4111 = local95;
	...
	private void method3595(@OriginalArg(0) int[] arg0) {
		...
		if (this.aClass2_Sub6_6 != null && this.anInt4110 <= 0) {
			...
			Static440.method5971(this.aClass2_Sub6_6);
			this.method3591(this.aClass2_Sub6_6.method9143(), this.aClass2_Sub6_6);
			@Pc(47) int local47 = 0;
					...
					if ((local74 & 0x1) != 0) {
						...
						label97: while (true) {
							while (true) {
								...
								if (local101 == null || local101.anInt8841 <= local63) {
									local97.aBoolean794 = true;
									@Pc(127) int local127 = local97.method9139();
									local47 += local127;
									if (local101 != null) {
										local101.anInt8841 += local127;
									}
									if (local47 >= this.anInt4098) {
										break label103;
									}
									@Pc(148) Class2_Sub6 local148 = local97.method9140();
									if (local148 != null) {
		...
		if (this.aClass2_Sub6_6 != null) {
			this.aClass2_Sub6_6.method9138(arg0, 0, 256);
		}
		this.aLong128 = Static588.method7722();
	}
