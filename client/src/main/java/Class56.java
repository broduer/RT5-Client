...
public class Class56 {
	...
	private long aLong128 = Static588.method5469();
	...
	public final synchronized void method2585(@OriginalArg(1) Class2_Sub6 arg0) {
		this.aClass2_Sub6_6 = arg0;
	}

	@OriginalMember(owner = "client!cd", name = "a", descriptor = "()V")
	protected void method2586() throws Exception {
	}
	...
	private void method2587() {
		...
		if (this.aClass2_Sub6_6 != null) {
			this.aClass2_Sub6_6.method6559(256);
		}
	}
	...
	protected int method2590() throws Exception {
	...
	protected void method2593() throws Exception {
	}

	@OriginalMember(owner = "client!cd", name = "a", descriptor = "(ZILclient!dea;)V")
	private void method2594(@OriginalArg(1) int arg0, @OriginalArg(2) Class2_Sub6 arg1) {
	...
	public final synchronized void method2595() {
		this.aBoolean320 = true;
		try {
			this.method2586();
		} catch (@Pc(19) Exception local19) {
			this.method2599();
			this.aLong129 = Static588.method5469() + 2000L;
		}
	}
	...
	public final synchronized void method2597() {
		...
		@Pc(11) long local11 = Static588.method5469();
		try {
		...
		try {
			if (this.aLong129 != 0L) {
				...
				this.method2591(this.anInt4097);
				this.aLong129 = 0L;
				this.aBoolean320 = true;
			}
			@Pc(95) int local95 = this.method2590();
			...
			while (local118 > local95) {
				this.method2598(this.anIntArray315);
				local95 += 256;
				this.method2593();
			}
	...
	private void method2598(@OriginalArg(0) int[] arg0) {
		...
		Static734.method5442(arg0, 0, local1);
		this.anInt4099 -= 256;
		if (this.aClass2_Sub6_6 != null && this.anInt4099 <= 0) {
			this.anInt4099 += Static686.anInt8944 >> 4;
			Static440.method4205(this.aClass2_Sub6_6);
			this.method2594(this.aClass2_Sub6_6.method6565(), this.aClass2_Sub6_6);
			@Pc(47) int local47 = 0;
						...
						label97: while (true) {
							while (true) {
								...
								if (local101 == null || local101.anInt8817 <= local63) {
									...
									@Pc(127) int local127 = local97.method6561();
									local47 += local127;
									if (local101 != null) {
									...
									@Pc(148) Class2_Sub6 local148 = local97.method6562();
									if (local148 != null) {
										@Pc(153) int local153 = local97.anInt10517;
										while (local148 != null) {
											this.method2594(local153 * local148.method6565() >> 8, local148);
											local148 = local97.method6564();
										}
									}
		...
		if (this.aClass2_Sub6_6 != null) {
			this.aClass2_Sub6_6.method6560(arg0, 0, 256);
		}
		this.aLong128 = Static588.method5469();
	}
