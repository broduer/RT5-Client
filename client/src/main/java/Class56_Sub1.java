...
public final class Class56_Sub1 extends Class56 {
	...
	@Override
	protected void method2586() throws LineUnavailableException {
	...
	@Override
	public void method2591(@OriginalArg(0) int arg0) throws LineUnavailableException {
		try {
			...
			if (Static171.method1807(arg0) == 1) {
				this.aSourceDataLine1 = null;
				throw local39;
			} else {
				this.method2591(Static440.method4203(arg0));
			}
		}
	}
	...
	@Override
	public void method2596(@OriginalArg(0) Component arg0) {
