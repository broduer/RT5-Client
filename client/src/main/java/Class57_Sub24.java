...
public final class Class57_Sub24 extends Class57 {

	@OriginalMember(owner = "client!qka", name = "<init>", descriptor = "(Lclient!kv;)V")
	public Class57_Sub24(@OriginalArg(0) Class2_Sub34 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!qka", name = "<init>", descriptor = "(ILclient!kv;)V")
	public Class57_Sub24(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub34 arg1) {
		super(arg0, arg1);
	}
