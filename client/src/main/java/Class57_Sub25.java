...
public final class Class57_Sub25 extends Class57 {

	@OriginalMember(owner = "client!rba", name = "<init>", descriptor = "(ILclient!kv;)V")
	public Class57_Sub25(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub34 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!rba", name = "<init>", descriptor = "(Lclient!kv;)V")
	public Class57_Sub25(@OriginalArg(0) Class2_Sub34 arg0) {
		super(arg0);
	}
	...
	public void method5914() {
		if (super.anInt9489 < 0 && super.anInt9489 > 127) {
