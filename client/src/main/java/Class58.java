...
public abstract class Class58 {
	...
	protected final Socket method6103() throws IOException {
		return new Socket(this.aString74, this.anInt6804);
	}

	@OriginalMember(owner = "client!cca", name = "b", descriptor = "(I)Ljava/net/Socket;")
	public abstract Socket method6104() throws IOException;
}
