...
public final class Class58_Sub2 extends Class58 {
	...
	private Socket method4242(@OriginalArg(1) Proxy arg0) throws IOException {
		if (arg0.type() == Type.DIRECT) {
			return this.method4238();
		}
	...
	@Override
	public Socket method4239() throws IOException {
		...
		for (@Pc(112) int local112 = 0; local112 < local106.length; local112++) {
			...
			try {
				@Pc(132) Socket local132 = this.method4242(local127);
				if (local132 != null) {
					return local132;
				}
