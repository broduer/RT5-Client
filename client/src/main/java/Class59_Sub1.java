...
public final class Class59_Sub1 extends Class59 {
	...
	@Override
	public void method953(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(3) float[] arg2, @OriginalArg(4) int arg3, @OriginalArg(5) float arg4, @OriginalArg(6) int arg5, @OriginalArg(7) float arg6) {
		...
		@Pc(79) float local79 = Static272.method2753(local66);
		...
		for (@Pc(95) int local95 = 0; local95 < 128; local95++) {
			...
			@Pc(122) float local122 = Static272.method2753(local114);
			...
			for (@Pc(162) int local162 = 0; local162 < 128; local162++) {
				...
				@Pc(198) float local198 = Static272.method2753(local182);
				arg2[arg3++] = arg1 * Static226.a(Static226.a(Static226.a(Static282.method2780(local66, local182, local114, this.anIntArray146[local190 + local160] & 0x7), Static282.method2780(local66, local186, local114, this.anIntArray146[local194 + local160] & 0x7), local198), Static226.a(Static282.method2780(local66, local182, local118, this.anIntArray146[local152 + local190] & 0x7), Static282.method2780(local66, local186, local118, this.anIntArray146[local194 + local152] & 0x7), local198), local122), Static226.a(Static226.a(Static282.method2780(local71, local182, local114, this.anIntArray146[local144 + local190] & 0x7), Static282.method2780(local71, local186, local114, this.anIntArray146[local144 + local194] & 0x7), local198), Static226.a(Static282.method2780(local71, local182, local118, this.anIntArray146[local137 + local190] & 0x7), Static282.method2780(local71, local186, local118, this.anIntArray146[local194 + local137] & 0x7), local198), local122), local79);
			}
		}
	}
}
