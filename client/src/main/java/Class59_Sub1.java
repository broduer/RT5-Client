...
public final class Class59_Sub1 extends Class59 {
	...
	@Override
	public void method1509(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2, @OriginalArg(3) float[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) float arg5, @OriginalArg(6) int arg6, @OriginalArg(7) float arg7, @OriginalArg(8) int arg8, @OriginalArg(10) int arg9) {
		@Pc(13) int local13 = (int) (arg7 * (float) arg2 - 1.0F);
		@Pc(17) int local17 = local13 & 0xFF;
		@Pc(33) int local33 = (int) ((float) arg9 * arg0 - 1.0F);
		@Pc(37) int local37 = local33 & 0xFF;
		@Pc(45) int local45 = (int) ((float) arg8 * arg5 - 1.0F);
		@Pc(49) int local49 = local45 & 0xFF;
		@Pc(54) float local54 = (float) arg6 * arg5;
		...
		for (@Pc(95) int local95 = 0; local95 < arg9; local95++) {
			...
			for (@Pc(162) int local162 = 0; local162 < arg2; local162++) {
				@Pc(169) float local169 = (float) local162 * arg7;
				...
				arg3[arg4++] = arg1 * Static226.method8006(
					Static226.method8006(
						Static226.method8006(
							Static282.method3978(
								local66, local182, local114, this.anIntArray146[local190 + local160] & 0x7
							),
							Static282.method3978(
								local66, local186, local114, this.anIntArray146[local194 + local160] & 0x7
							),
							local198
						), Static226.method8006(
							Static282.method3978(
								local66, local182, local118, this.anIntArray146[local152 + local190] & 0x7
							),
							Static282.method3978(
								local66, local186, local118, this.anIntArray146[local194 + local152] & 0x7
							),
							local198
						), local122
					),
					Static226.method8006(
						Static226.method8006(
							Static282.method3978(
								local71, local182, local114, this.anIntArray146[local144 + local190] & 0x7
							),
							Static282.method3978(
								local71, local186, local114, this.anIntArray146[local144 + local194] & 0x7
							),
							local198
						), Static226.method8006(
							Static282.method3978(
								local71, local182, local118, this.anIntArray146[local137 + local190] & 0x7
							),
							Static282.method3978(
								local71, local186, local118, this.anIntArray146[local194 + local137] & 0x7
							),
							local198
						),
						local122
