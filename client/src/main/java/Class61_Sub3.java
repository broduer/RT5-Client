...
public final class Class61_Sub3 extends Class61 implements Interface18 {
	...
	public Class61_Sub3(@OriginalArg(0) Class19_Sub1_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		super(arg0, Static172.aClass92_8, Static702.aClass399_16, arg3 && arg0.aBoolean414, arg2 * arg1);
		if (this.aClass19_Sub1_Sub1_9.aBoolean413) {
			this.anInt10453 = arg1;
			this.anInt10454 = arg2;
		} else {
			this.anInt10453 = Static440.method5969(arg1);
			this.anInt10454 = Static440.method5969(arg2);
		}
		if (arg3) {
			this.anIDirect3DTexture1 = this.aClass19_Sub1_Sub1_9.anIDirect3DDevice1.a(this.anInt10453, this.anInt10454, 0, 1024, 21, 1);
		} else {
			this.anIDirect3DTexture1 = this.aClass19_Sub1_Sub1_9.anIDirect3DDevice1.a(this.anInt10453, this.anInt10454, 1, 0, 21, 1);
		}
		...
		if (Static731.method4161((byte) 84, local83)) {
			if (arg6 == 0) {
				arg6 = arg1;
			}
	...
	public Class61_Sub3(@OriginalArg(0) Class19_Sub1_Sub1 arg0, @OriginalArg(1) Class92 arg1, @OriginalArg(2) Class399 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		super(arg0, arg1, arg2, false, arg4 * arg3);
		if (this.aClass19_Sub1_Sub1_9.aBoolean413) {
			this.anInt10454 = arg4;
			this.anInt10453 = arg3;
		} else {
			this.anInt10453 = Static440.method5969(arg3);
			this.anInt10454 = Static440.method5969(arg4);
		}
		this.anIDirect3DTexture1 = this.aClass19_Sub1_Sub1_9.anIDirect3DDevice1.a(arg3, arg4, 1, 0, Static325.method4875(this.aClass399_12, this.aClass92_17), 1);
	}
	...
	public Class61_Sub3(@OriginalArg(0) Class19_Sub1_Sub1 arg0, @OriginalArg(1) Class92 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) byte[] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		super(arg0, arg1, Static702.aClass399_16, arg4 && arg0.aBoolean414, arg3 * arg2);
		if (this.aClass19_Sub1_Sub1_9.aBoolean413) {
			this.anInt10454 = arg3;
			this.anInt10453 = arg2;
		} else {
			this.anInt10453 = Static440.method5969(arg2);
			this.anInt10454 = Static440.method5969(arg3);
		}
		if (arg4) {
			this.anIDirect3DTexture1 = this.aClass19_Sub1_Sub1_9.anIDirect3DDevice1.a(this.anInt10453, this.anInt10454, 0, 1024, Static325.method4875(Static702.aClass399_16, this.aClass92_17), 1);
		} else {
			this.anIDirect3DTexture1 = this.aClass19_Sub1_Sub1_9.anIDirect3DDevice1.a(this.anInt10453, this.anInt10454, 1, 0, Static325.method4875(Static702.aClass399_16, this.aClass92_17), 1);
		}
		...
		if (Static731.method4161((byte) 104, local91)) {
	...
	public void method9058(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(4) byte[] arg2, @OriginalArg(6) Class92 arg3, @OriginalArg(8) int arg4) {
		if (arg3 != this.aClass92_17 || Static702.aClass399_16 != this.aClass399_12) {
		...
		if (!Static731.method4161((byte) 106, local30)) {
			return;
		}
		@Pc(40) int local40 = arg0 * this.aClass92_17.anInt2425;
		@Pc(46) int local46 = arg4 * this.aClass92_17.anInt2425;
	...
	public void method9051(@OriginalArg(3) int[] arg0, @OriginalArg(5) int arg1, @OriginalArg(6) int arg2) {
		if (Static172.aClass92_8 != this.aClass92_17 || Static702.aClass399_16 != this.aClass399_12) {
			throw new RuntimeException();
		}
		...
		if (!Static731.method4161((byte) 63, local39)) {
			return;
		}
	...
	public void method9055(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(7) int arg5) {
		...
		if (!Static731.method4161((byte) 123, local29)) {
			return;
		}
