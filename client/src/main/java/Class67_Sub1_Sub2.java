	...
	public Class93_Sub1 method6121() {
		if (this.aClass93_Sub1_2 == null) {
			...
			for (@Pc(48) int local48 = 0; local48 < 6; local48++) {
				if (!local37.method4802(Static319.anIntArray384[local48])) {
					return null;
				}
				@Pc(69) Class118 local69 = local37.method4805(Static319.anIntArray384[local48]);
			...
			for (@Pc(99) int local99 = 0; local99 < 6; local99++) {
				Static304.anIntArrayArray119[local99] = local37.method4806(local46, false, local46, Static319.anIntArray384[local99], 1.0F);
			}
