	...
	public Interface8 method6400() {
		if (this.anInterface8_1 == null) {
			...
			for (@Pc(48) int local48 = 0; local48 < 6; local48++) {
				if (!local42.method4802(Static601.anIntArray705[local48])) {
					return null;
				}
				@Pc(71) Class118 local71 = local42.method4805(Static601.anIntArray705[local48]);
			...
			for (@Pc(102) int local102 = 0; local102 < 6; local102++) {
				Static518.anIntArrayArray262[local102] = local42.method4806(local46, false, local46, Static601.anIntArray705[local102], 1.0F);
			}
			this.anInterface8_1 = this.aClass19_Sub1_22.method5672(local46, Static518.anIntArrayArray262, local44);
		}
