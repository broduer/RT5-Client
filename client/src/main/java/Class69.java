...
public final class Class69 {
	...
	private void method1588(@OriginalArg(0) int arg0, @OriginalArg(2) Class2_Sub21 arg1) {
		...
		@Pc(58) int local58;
		if (arg0 == 1) {
			local20 = arg1.method7389();
			this.anIntArray157 = new int[local20];
			for (local26 = 0; local26 < local20; local26++) {
				this.anIntArray157[local26] = arg1.method7389();
			}
			this.anIntArray159 = new int[local20];
			for (local44 = 0; local44 < local20; local44++) {
				this.anIntArray159[local44] = arg1.method7389();
			}
			for (local58 = 0; local58 < local20; local58++) {
				this.anIntArray159[local58] = (arg1.method7389() << 16) + this.anIntArray159[local58];
			}
		} else if (arg0 == 2) {
			this.anInt1647 = arg1.method7389();
		} else if (arg0 == 3) {
			this.aBooleanArray3 = new boolean[256];
			local20 = arg1.method7403();
			for (local26 = 0; local26 < local20; local26++) {
				this.aBooleanArray3[arg1.method7403()] = true;
			}
		} else if (arg0 == 5) {
			this.anInt1656 = arg1.method7403();
		} else if (arg0 == 6) {
			this.anInt1659 = arg1.method7389();
		} else if (arg0 == 7) {
			this.anInt1658 = arg1.method7389();
		} else if (arg0 == 8) {
			this.anInt1654 = arg1.method7403();
		} else if (arg0 == 9) {
			this.anInt1649 = arg1.method7403();
		} else if (arg0 == 10) {
			this.anInt1661 = arg1.method7403();
		} else if (arg0 == 11) {
			this.anInt1653 = arg1.method7403();
		} else if (arg0 == 12) {
			local20 = arg1.method7403();
			this.anIntArray158 = new int[local20];
			for (local26 = 0; local26 < local20; local26++) {
				this.anIntArray158[local26] = arg1.method7389();
			}
			for (local44 = 0; local44 < local20; local44++) {
				this.anIntArray158[local44] += arg1.method7389() << 16;
			}
		} else if (arg0 == 13) {
			local20 = arg1.method7389();
			this.anIntArrayArray38 = new int[local20][];
			for (local26 = 0; local26 < local20; local26++) {
				local44 = arg1.method7403();
				if (local44 > 0) {
					this.anIntArrayArray38[local26] = new int[local44];
					this.anIntArrayArray38[local26][0] = arg1.method7390();
					for (local58 = 1; local58 < local44; local58++) {
						this.anIntArrayArray38[local26][local58] = arg1.method7389();
					}
				}
			}
		} else if (arg0 == 14) {
			...
			if (arg0 == 18) {
				...
				this.anIntArray156[arg1.method7403()] = arg1.method7403();
				return;
			} else if (arg0 == 20) {
				...
				local20 = arg1.method7403();
				this.anIntArray154[local20] = arg1.method7389();
				this.anIntArray155[local20] = arg1.method7389();
				return;
			}
			return;
		}
