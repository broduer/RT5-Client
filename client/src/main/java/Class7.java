...
public final class Class7 {
	...
	public Class7(@OriginalArg(0) Class19_Sub1 arg0) {
		...
		this.aBoolean7 = this.aClass19_Sub1_1.aBoolean697;
		if (this.aBoolean7 && !this.aClass19_Sub1_1.method8160(Static702.aClass399_16, Static482.aClass92_13)) {
			this.aBoolean7 = false;
		}
		if (this.aBoolean7 || this.aClass19_Sub1_1.method8078(Static482.aClass92_13, Static702.aClass399_16)) {
			Static132.method2312();
			if (this.aBoolean7) {
				@Pc(60) byte[] local60 = Static377.method5328(false, Static177.anObject6);
				this.anInterface2_2 = this.aClass19_Sub1_1.method8045(Static482.aClass92_13, local60);
				@Pc(76) byte[] local76 = Static377.method5328(false, Static644.anObject18);
				this.aClass19_Sub1_1.method8045(Static482.aClass92_13, local76);
			} else {
				...
				for (@Pc(93) int local93 = 0; local93 < 16; local93++) {
					...
					this.anInterface18Array2[local93] = this.aClass19_Sub1_1.method8035(128, local104, Static482.aClass92_13, 128, true);
				}
				...
				for (@Pc(129) int local129 = 0; local129 < 16; local129++) {
					...
					this.anInterface18Array1[local129] = this.aClass19_Sub1_1.method8035(128, local140, Static482.aClass92_13, 128, true);
				}
			}
		}
	}
	...
	public boolean method115() {
		if (this.anInterface2_1 == null) {
			...
			this.anInterface2_1 = this.aClass19_Sub1_1.method8045(Static172.aClass92_8, local42);
		}
