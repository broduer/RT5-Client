...
public final class Class7 {
	...
	public Class7(@OriginalArg(0) Class19_Sub1 arg0) {
		...
		if (this.aBoolean7 && !this.aClass19_Sub1_1.method5762(Static702.aClass397_16, Static482.aClass92_13)) {
			this.aBoolean7 = false;
		}
		if (this.aBoolean7 || this.aClass19_Sub1_1.method5680(Static482.aClass92_13, Static702.aClass397_16)) {
			Static132.method1515();
			if (this.aBoolean7) {
				@Pc(60) byte[] local60 = Static377.method3773(false, Static177.anObject6);
				this.anInterface2_2 = this.aClass19_Sub1_1.method5647(Static482.aClass92_13, local60);
				@Pc(76) byte[] local76 = Static377.method3773(false, Static644.anObject18);
				this.aClass19_Sub1_1.method5647(Static482.aClass92_13, local76);
			} else {
				this.anInterface18Array2 = new Interface18[16];
				for (@Pc(93) int local93 = 0; local93 < 16; local93++) {
					@Pc(104) byte[] local104 = Static60.method792(Static177.anObject6, local93 * 16384 * 2);
					this.anInterface18Array2[local93] = this.aClass19_Sub1_1.method5637(128, local104, Static482.aClass92_13, 128, true);
				}
				this.anInterface18Array1 = new Interface18[16];
				for (@Pc(129) int local129 = 0; local129 < 16; local129++) {
					@Pc(140) byte[] local140 = Static60.method792(Static644.anObject18, local129 * 128 * 256);
					this.anInterface18Array1[local129] = this.aClass19_Sub1_1.method5637(128, local140, Static482.aClass92_13, 128, true);
				}
			}
		}
	}
	...
	public boolean method67() {
		if (this.anInterface2_1 == null) {
			...
			if (Static186.anObject7 == null) {
				local26 = Static448.method4248(4.0F, 4.0F, 0.5F, 16.0F, 0.6F, new Class59_Sub1(419684));
				Static186.anObject7 = Static247.method2552(local26);
			}
			local26 = Static377.method3773(false, Static186.anObject7);
			...
			this.anInterface2_1 = this.aClass19_Sub1_1.method5647(Static172.aClass92_8, local42);
		}
