...
public abstract class Class72 implements Interface21 {
	...
	public void method6082() {
		if (this.anInt9721 > 0) {
			this.aClass19_Sub1_Sub2_11.method5773(this.anInt9721, this.anInt9726);
			this.anInt9721 = -1;
		}
	}
	...
	protected final boolean method6084(@OriginalArg(0) int arg0, @OriginalArg(1) Source arg1) {
	...
	protected final boolean method6085(@OriginalArg(1) MapBuffer arg0) {
	...
	public void method6087(@OriginalArg(1) int arg0) {
		if (arg0 > this.anInt9733) {
			...
			if (this.anInt9721 > 0) {
				...
				this.aNativeHeapBuffer7 = this.aClass19_Sub1_Sub2_11.method5715(false, arg0);
			}
			this.anInt9733 = arg0;
		}
		this.anInt9726 = arg0;
	...
	protected final Buffer method6088(@OriginalArg(1) MapBuffer arg0) {
		if (this.anInt9732 == 0) {
			this.method6089();
			if (this.anInt9721 <= 0) {
				this.anInt9732 = 2;
