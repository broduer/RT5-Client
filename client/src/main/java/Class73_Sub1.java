...
public final class Class73_Sub1 extends Class73 {
	...
	public void method1193(@OriginalArg(0) float arg0, @OriginalArg(2) float arg1, @OriginalArg(3) float arg2) {
		this.aFloat46 = arg2;
		this.aFloat43 = arg0;
	...
	public void method1194(@OriginalArg(1) Class73 arg0) {
	...
	public void method1195(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(3) float arg2, @OriginalArg(4) float[] arg3, @OriginalArg(5) float arg4) {
	...
	public void method1196(@OriginalArg(0) Class73 arg0) {
		@Pc(6) Class73_Sub1 local6 = (Class73_Sub1) arg0;
	...
	public float[] method1197(@OriginalArg(1) float[] arg0) {
	...
	public void method1198(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(3) float arg2) {
		this.aFloat37 += arg1;
		this.aFloat46 += arg2;
		this.aFloat43 += arg0;
	}
	...
	public float method1199(@OriginalArg(1) float arg0, @OriginalArg(2) float arg1, @OriginalArg(3) float arg2) {
	...
	public void method1200(@OriginalArg(0) float arg0, @OriginalArg(2) float arg1, @OriginalArg(3) float arg2) {
		this.aFloat39 = arg2;
		this.aFloat47 = arg0;
		this.aFloat43 = 0.0F;
		this.aFloat41 = 0.0F;
	...
	public float method1201(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2) {
	...
	@Override
	public void b(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	public void method1202(@OriginalArg(0) Class73 arg0) {
	...
	public void method1203(@OriginalArg(0) float arg0, @OriginalArg(2) float arg1, @OriginalArg(3) float arg2, @OriginalArg(4) float arg3, @OriginalArg(5) float arg4, @OriginalArg(6) float arg5, @OriginalArg(7) float arg6, @OriginalArg(8) float arg7, @OriginalArg(9) float arg8) {
		this.aFloat37 = 0.0F;
		this.aFloat44 = arg1;
		this.aFloat42 = arg8;
		this.aFloat45 = arg7;
	...
	public float[] method1204(@OriginalArg(1) float[] arg0) {
	...
	public float method1205(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2) {
	...
	public void method1206(@OriginalArg(0) Class73 arg0, @OriginalArg(1) Class73 arg1) {
		@Pc(6) Class73_Sub1 local6 = (Class73_Sub1) arg0;
	...
	public float[] method1207(@OriginalArg(1) float[] arg0) {
		arg0[10] = this.aFloat47;
		arg0[5] = this.aFloat42;
		arg0[1] = this.aFloat44;
	...
	public float[] method1208(@OriginalArg(1) float[] arg0) {
		arg0[15] = 0.0F;
		arg0[2] = this.aFloat38;
		arg0[4] = this.aFloat44;
		arg0[13] = 0.0F;
	...
	public void method1209(@OriginalArg(0) float arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) float arg3, @OriginalArg(5) float arg4, @OriginalArg(6) int arg5) {
		if (arg5 == 0) {
	...
	public void method1212(@OriginalArg(0) float arg0, @OriginalArg(2) float arg1, @OriginalArg(3) float arg2) {
		this.aFloat38 *= arg1;
		this.aFloat45 *= arg2;
		this.aFloat36 *= arg2;
		this.aFloat41 *= arg0;
	...
	public void method1213(@OriginalArg(0) float arg0, @OriginalArg(1) float[] arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3) {
	...
	public float[] method1214(@OriginalArg(0) float[] arg0) {
		arg0[4] = this.aFloat44;
		arg0[3] = this.aFloat46;
		arg0[6] = this.aFloat41;
		arg0[2] = this.aFloat38;
