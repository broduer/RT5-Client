...
public final class Class73_Sub3 extends Class73 {
	...
	@Override
	public void method7134(@OriginalArg(0) int arg0) {
	...
	@Override
	public void method7131(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3) {
	...
	public void method7149(@OriginalArg(1) Class73 arg0) {
	...
	@Override
	public void method7147(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3) {
	...
	@Override
	public void method7133(@OriginalArg(0) int[] arg0) {
	...
	@Override
	public void method7146(@OriginalArg(0) int arg0) {
		@Pc(9) float local9 = Applet_Sub1.aFloatArray14[arg0 & 0x3FFF];
		@Pc(15) float local15 = Applet_Sub1.aFloatArray15[arg0 & 0x3FFF];
		@Pc(18) float local18 = this.aFloat153;
		@Pc(21) float local21 = this.aFloat157;
	...
	public void method7150(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float[] arg4) {
	...
	@Override
	public void method7142(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
	...
	public void method7151(@OriginalArg(1) int arg0, @OriginalArg(2) float arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) float arg4, @OriginalArg(6) float arg5) {
		if (arg2 == 0) {
			this.aFloat154 = 1.0F;
	...
	@Override
	public void method7141(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	public float[] method7152() {
		Static614.aFloatArray68[0] = this.aFloat153;
		Static614.aFloatArray68[2] = this.aFloat155;
		Static614.aFloatArray68[13] = 0.0F;
		Static614.aFloatArray68[1] = this.aFloat161;
		Static614.aFloatArray68[14] = 0.0F;
		Static614.aFloatArray68[6] = this.aFloat151;
		Static614.aFloatArray68[4] = this.aFloat157;
		Static614.aFloatArray68[10] = this.aFloat154;
		Static614.aFloatArray68[12] = 0.0F;
		Static614.aFloatArray68[9] = this.aFloat150;
		Static614.aFloatArray68[8] = this.aFloat160;
		Static614.aFloatArray68[5] = this.aFloat156;
		return Static614.aFloatArray68;
	}
	...
	@Override
	public void method7137(@OriginalArg(0) int arg0) {
		@Pc(9) float local9 = Applet_Sub1.aFloatArray14[arg0 & 0x3FFF];
		@Pc(15) float local15 = Applet_Sub1.aFloatArray15[arg0 & 0x3FFF];
	...
	public float[] method7153() {
		Static614.aFloatArray68[12] = this.aFloat152;
		Static614.aFloatArray68[0] = this.aFloat153;
		Static614.aFloatArray68[5] = this.aFloat156;
		Static614.aFloatArray68[1] = this.aFloat161;
		Static614.aFloatArray68[2] = this.aFloat155;
		...
		Static614.aFloatArray68[4] = this.aFloat157;
		Static614.aFloatArray68[9] = this.aFloat150;
		Static614.aFloatArray68[14] = this.aFloat159;
		Static614.aFloatArray68[13] = this.aFloat158;
		Static614.aFloatArray68[6] = this.aFloat151;
		return Static614.aFloatArray68;
	}
	...
	@Override
	public void method7145(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3) {
	...
	@Override
	public void method7138(@OriginalArg(0) int arg0) {
		this.aFloat156 = 1.0F;
	...
	@Override
	public void method7132(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.aFloat159 = (float) arg2;
		this.aFloat161 = this.aFloat155 = this.aFloat157 = this.aFloat151 = this.aFloat160 = this.aFloat150 = 0.0F;
		this.aFloat158 = (float) arg1;
		this.aFloat153 = this.aFloat156 = this.aFloat154 = 1.0F;
	...
	@Override
	public void method7135(@OriginalArg(0) Class73 arg0) {
		@Pc(6) Class73_Sub3 local6 = (Class73_Sub3) arg0;
