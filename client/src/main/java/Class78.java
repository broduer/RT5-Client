...
public final class Class78 {
	...
	private final Class332 aClass332_17;

	@OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Lclient!ul;ILclient!sb;)V")
	public Class78(@OriginalArg(0) Class379 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class332 arg2) {
		this.aClass332_17 = arg2;
		this.aClass332_17.method7615(30);
	}
	...
	public Class10 method2051(@OriginalArg(1) int arg0) {
		...
		synchronized (this.aClass82_45) {
			local16 = (Class10) this.aClass82_45.method2156(arg0);
		}
		if (local16 != null) {
			return local16;
		}
		@Pc(30) Class332 local30 = this.aClass332_17;
		@Pc(39) byte[] local39;
		synchronized (this.aClass332_17) {
			local39 = this.aClass332_17.method7602(arg0, 30);
		}
		local16 = new Class10();
		if (local39 != null) {
			local16.method131(new Class2_Sub21(local39));
		}
		@Pc(63) Class82 local63 = this.aClass82_45;
		synchronized (this.aClass82_45) {
			this.aClass82_45.method2150(local16, arg0);
			return local16;
		}
	}
