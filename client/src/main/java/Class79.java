...
public final class Class79 {
	...
	public Class264 method1317(@OriginalArg(1) int arg0) {
		...
		synchronized (this.aClass330_18) {
			local41 = this.aClass330_18.method5359(arg0, 1);
		}
		local18 = new Class264();
		if (local41 != null) {
			local18.method4187(new Class2_Sub21(local41));
		}
		@Pc(67) Class82 local67 = this.aClass82_47;
		synchronized (this.aClass82_47) {
			this.aClass82_47.method1384(local18, (long) arg0);
			return local18;
		}
	}
