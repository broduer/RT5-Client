...
public final class Class87 implements Interface9 {
	...
	@Override
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) boolean arg6, @OriginalArg(7) boolean arg7) {
		Static22.method298(arg5, arg2, this.aClass19_Sub2_3.aFloatArray25, arg6 ? this.aClass19_Sub2_3.aClass2_Sub10_1.anIntArray567 : null, this.aClass19_Sub2_3.aClass2_Sub10_1.anInt7053, this.aFloatArray16, this.anInt2357, arg4, this.anIntArray203, arg3, arg0, arg1);
	}

	@OriginalMember(owner = "client!du", name = "b", descriptor = "(IIIIIIZZ)V")
	@Override
	public void b(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) boolean arg6, @OriginalArg(7) boolean arg7) {
		Static22.method298(arg5, arg2, this.aFloatArray16, this.anIntArray203, this.anInt2357, this.aClass19_Sub2_3.aFloatArray25, this.aClass19_Sub2_3.aClass2_Sub10_1.anInt7053, arg4, this.aClass19_Sub2_3.aClass2_Sub10_1.anIntArray567, arg3, arg0, arg1);
	}
}
