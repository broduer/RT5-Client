...
public final class Class89 {
	...
	public Class89(@OriginalArg(0) Class2_Sub21 arg0) {
		for (@Pc(7) int local7 = 0; local7 < 10; local7++) {
			...
			if (local12 != 0) {
				...
				this.aClass258Array1[local7].method4081(arg0);
			}
		}
		this.anInt2381 = arg0.method5191();
		this.anInt2382 = arg0.method5191();
	}
	...
	private byte[] method1466() {
		...
		for (@Pc(54) int local54 = 0; local54 < 10; local54++) {
			if (this.aClass258Array1[local54] != null) {
				...
				@Pc(92) int[] local92 = this.aClass258Array1[local54].method4082(local70, this.aClass258Array1[local54].anInt6454);
	...
	public Class2_Sub49_Sub1 method1467() {
		@Pc(2) byte[] local2 = this.method1466();
