...
public abstract class Class8_Sub2 extends Class8 {
	...
	public abstract Class8_Sub7 a(@OriginalArg(1) Class19 arg0);

	@OriginalMember(owner = "client!eo", name = "a", descriptor = "(I[Lclient!lca;II)I")
	protected final int a(@OriginalArg(1) Class2_Sub7[] arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
	...
	public abstract Class205 c(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1);

	@OriginalMember(owner = "client!eo", name = "a", descriptor = "(IIZLclient!ha;)Z")
	public abstract boolean a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Class19 arg3);
	...
	public abstract boolean h(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!eo", name = "b", descriptor = "(B)Z")
	public abstract boolean b();

	@OriginalMember(owner = "client!eo", name = "a", descriptor = "(BLclient!ha;)Z")
	public abstract boolean a(@OriginalArg(0) byte arg0, @OriginalArg(1) Class19 arg1);

	@OriginalMember(owner = "client!eo", name = "a", descriptor = "(IZLclient!ha;IBILclient!eo;)V")
	public abstract void a(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) Class19 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class8_Sub2 arg6);

	@OriginalMember(owner = "client!eo", name = "k", descriptor = "(I)I")
	public abstract int k(@OriginalArg(0) int arg0);
	...
	public abstract int a(@OriginalArg(0) Class2_Sub7[] arg0);

	@OriginalMember(owner = "client!eo", name = "d", descriptor = "(Lclient!ha;I)V")
	public abstract void d(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1);

	@OriginalMember(owner = "client!eo", name = "i", descriptor = "(I)Z")
	public abstract boolean i(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!eo", name = "c", descriptor = "(B)I")
	public abstract int c(@OriginalArg(0) byte arg0);
}
