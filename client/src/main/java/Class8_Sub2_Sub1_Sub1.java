...
public final class Class8_Sub2_Sub1_Sub1 extends Class8_Sub2_Sub1 {
	...
	public Class8_Sub2_Sub1_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) boolean arg13, @OriginalArg(14) int arg14) {
		super(arg1, arg2, arg3, Static102.method1286(arg1, -29754, arg4, arg3) - arg5, arg4, arg3 >> 9, arg3 >> 9, arg4 >> 9, arg4 >> 9, false, (byte) 0);
		this.anInt721 = arg5;
		this.anInt715 = arg0;
		this.anInt722 = arg6;
		this.anInt695 = arg14;
		...
		this.anInt705 = arg8;
		this.anInt709 = arg9;
		@Pc(82) int local82 = Static23.aClass128_1.method1831(this.anInt715).anInt5842;
		this.aClass152_1 = new Class152_Sub2(this, false);
		this.aClass152_1.method6547(true, local82);
	}
	...
	public void a(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		@Pc(9) double local9;
		if (!this.aBoolean59) {
			...
			if (this.aBoolean57) {
				this.aDouble5 = (double) (Static102.method1286(super.aByte144, -29754, (int) this.aDouble4, (int) this.aDouble8) - this.anInt721);
			} else {
	...
	private Class114 a(@OriginalArg(0) int arg0, @OriginalArg(1) Class19 arg1, @OriginalArg(2) int arg2) {
		@Pc(17) Class227 local17 = Static23.aClass128_1.method1831(this.anInt715);
		return local17.method3709(this.aClass152_1, (byte) 2, arg0, arg1);
	}
	...
	public void a() {
		if (this.aClass8_Sub5_1 != null) {
			this.aClass8_Sub5_1.method2640();
		}
	}
	...
	public void c() {
		...
		if (Static1.anInt10798 == 3) {
			local21 = Static219.aClass236Array1[this.anInt706 - 1].method3805();
		} else {
			@Pc(35) int local35;
			if (this.anInt706 < 0) {
				...
				local35 = this.anInt706 - 1;
				@Pc(58) Class2_Sub45 local58 = (Class2_Sub45) Static18.aClass28_2.method373((long) local35);
				if (local58 != null) {
		...
		super.anInt10691 = Static102.method1286(super.aByte144, -29754, local21.anInt10694, local21.anInt10690) - this.anInt721;
		if (this.anInt695 < 0) {
			return;
		}
		@Pc(105) Class289 local105 = local21.method6708();
		...
		if (local107 != 0 || local109 != 0) {
			@Pc(185) int local185 = local21.aClass126_7.method1810(16383);
	...
	private void a(@OriginalArg(1) Class19 arg0, @OriginalArg(2) Class73 arg1, @OriginalArg(3) Class114 arg2) {
		arg2.a(arg1);
		@Pc(9) Class328[] local9 = arg2.f();
		@Pc(12) Class249[] local12 = arg2.c();
		if ((this.aClass8_Sub5_1 == null || this.aClass8_Sub5_1.aBoolean324) && (local9 != null || local12 != null)) {
			this.aClass8_Sub5_1 = Static257.method2650(Static333.anInt5455, true);
		}
		if (this.aClass8_Sub5_1 != null) {
			this.aClass8_Sub5_1.method2639(arg0, (long) Static333.anInt5455, local9, local12);
			this.aClass8_Sub5_1.method2654(super.aByte144, super.aShort131, super.aShort134, super.aShort132, super.aShort133);
		}
	}
	...
	public void d(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(18) Class114 local18 = this.a(0, arg0, arg1 + 75);
		if (local18 == null) {
			return;
		}
		@Pc(25) Class73 local25 = arg0.A();
		local25.a(this.anInt703);
		local25.f(this.anInt694);
		local25.b((int) this.aDouble8, (int) this.aDouble5, (int) this.aDouble4);
		this.anInt717 = local18.fa();
		this.anInt692 = local18.ma();
		this.a(arg0, local25, local18);
	}

	@OriginalMember(owner = "client!b", name = "a", descriptor = "(ILclient!ha;)Lclient!pea;")
	@Override
	public Class8_Sub7 a(@OriginalArg(1) Class19 arg0) {
		@Pc(19) Class114 local19 = this.a(2048, arg0, 46);
		if (local19 == null) {
			return null;
		}
		@Pc(27) Class73 local27 = arg0.A();
		local27.a(this.anInt703);
		local27.f(this.anInt694);
		local27.b((int) this.aDouble8, (int) this.aDouble5, (int) this.aDouble4);
		this.a(arg0, local27, local19);
		@Pc(57) Class8_Sub7 local57 = Static642.method5995(false, 1);
		if (Static504.aBoolean579) {
			local19.a(local27, local57.aClass8_Sub6Array1[0], Static582.anInt8627, 0);
		} else {
			local19.a(local27, local57.aClass8_Sub6Array1[0], 0);
		}
		if (this.aClass8_Sub5_1 != null) {
			@Pc(89) Class230 local89 = this.aClass8_Sub5_1.method2641();
			if (Static504.aBoolean579) {
				arg0.a(local89, Static582.anInt8627);
			} else {
				arg0.a(local89);
			}
		}
	...
	public void a(@OriginalArg(1) int arg0) {
		...
		if (this.aClass152_1.method6546(1) && this.aClass152_1.method6536()) {
			this.aClass152_1.method6533();
		}
	}
}
