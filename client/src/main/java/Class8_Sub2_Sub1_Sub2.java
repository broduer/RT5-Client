...
public abstract class Class8_Sub2_Sub1_Sub2 extends Class8_Sub2_Sub1 {
	...
	protected final void method6688(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class19 arg2, @OriginalArg(3) Class289 arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		for (@Pc(13) int local13 = 0; local13 < this.aClass199Array3.length; local13++) {
			...
			if (local50.anInt4930 == -1 || local50.aClass152_7.method6540()) {
				this.aClass114Array3[local13 + 1] = null;
			} else {
				@Pc(76) Class227 local76 = Static23.aClass128_1.method1831(local50.anInt4930);
				...
				@Pc(146) Class114 local146 = this.aClass114Array3[local13 + 1] = local76.method3709(local50.aClass152_7, local16, local97, arg2);
				if (local146 != null) {
					if (local50.anInt4928 >= 0 && arg3.anIntArrayArray181 != null && arg3.anIntArrayArray181[local50.anInt4928] != null) {
						...
						if (arg3.anIntArrayArray181 != null && arg3.anIntArrayArray181[local50.anInt4928] != null) {
							local173 = arg3.anIntArrayArray181[local50.anInt4928][1];
							local175 = arg3.anIntArrayArray181[local50.anInt4928][2];
							local171 = arg3.anIntArrayArray181[local50.anInt4928][0];
						}
	...
	public final void method6692(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		...
		@Pc(52) int local52 = 0;
		if (arg6 >= 0) {
			@Pc(59) Class285 local59 = Static561.aClass220_2.method3648(arg6);
	...
	public int method6693(@OriginalArg(0) byte arg0) {
		if (arg0 <= 43) {
			this.method6705(49, 56, -61, -114, 70, -70);
		}
		return this.anInt10733;
	}

	@OriginalMember(owner = "client!cg", name = "e", descriptor = "(I)I")
	public final int method6694() {
		@Pc(9) Class289 local9 = this.method6708();
		@Pc(13) int local13 = this.aClass126_7.anInt2889;
		@Pc(30) boolean local30;
		if (local9.anInt7231 == 0) {
			local30 = this.aClass126_7.method1813(this.anInt10756, this.anInt10757, -21712, this.anInt10757);
		} else {
			local30 = this.aClass126_7.method1813(this.anInt10756, local9.anInt7250, -21712, local9.anInt7231);
		}
		@Pc(55) int local55 = this.aClass126_7.anInt2889 - local13;
		if (local55 == 0) {
			this.anInt10749 = 0;
			this.aClass126_7.method1812((byte) 61, this.anInt10756);
		} else {
			this.anInt10749++;
		}
		if (local30) {
			if (local9.anInt7246 != 0) {
				if (local55 > 0) {
					this.aClass126_8.method1813(local9.anInt7224, local9.anInt7251, -21712, local9.anInt7246);
				} else {
					this.aClass126_8.method1813(-local9.anInt7224, local9.anInt7251, -21712, local9.anInt7246);
				}
			}
			if (local9.anInt7242 != 0) {
				this.aClass126_9.method1813(local9.anInt7252, local9.anInt7256, -21712, local9.anInt7242);
			}
		} else {
			if (local9.anInt7246 == 0) {
				this.aClass126_8.method1812((byte) 73, 0);
			} else {
				this.aClass126_8.method1813(0, local9.anInt7251, -21712, local9.anInt7246);
			}
			if (local9.anInt7242 == 0) {
				this.aClass126_9.method1812((byte) 122, 0);
			} else {
				this.aClass126_9.method1813(0, local9.anInt7256, -21712, local9.anInt7242);
			}
		}
		return local55;
	}
	...
	public abstract int method6695(@OriginalArg(0) byte arg0);

	@OriginalMember(owner = "client!cg", name = "a", descriptor = "(BI)V")
	public final void method6696(@OriginalArg(1) int arg0) {
		@Pc(15) Class289 local15 = this.method6708();
		if (local15.anInt7231 == 0 && this.anInt10757 == 0) {
			return;
		}
		this.aClass126_7.method1808();
	...
	protected final void method6697(@OriginalArg(0) Class114 arg0) {
	...
	@Override
	public final boolean h(@OriginalArg(0) int arg0) {
		if (arg0 != 0) {
			this.anInt10749 = -63;
		}
	...
	public final boolean method6698(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		if (this.anIntArray877 == null) {
			if (arg1 == -1) {
				return true;
			}
			this.anIntArray877 = new int[Static125.aClass388_1.anIntArray821.length];
			for (@Pc(24) int local24 = 0; local24 < Static125.aClass388_1.anIntArray821.length; local24++) {
				this.anIntArray877[local24] = -1;
			}
		}
		@Pc(43) Class289 local43 = this.method6708();
		...
		if (arg1 != -1) {
			if (this.anIntArray877[arg0] == -1) {
				this.anIntArray877[arg0] = this.aClass126_7.method1810(16383);
			}
			...
			local82 = this.aClass126_7.method1810(16383);
			...
			for (@Pc(112) int local112 = 0; local112 < Static125.aClass388_1.anIntArray821.length; local112++) {
	...
	public final void method6700(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		@Pc(16) Class199 local16 = this.aClass199Array3[arg0];
		@Pc(19) int local19 = local16.anInt4930;
		if (arg5 != -1 && local19 != -1) {
			@Pc(38) Class227 local38;
			if (local19 == arg5) {
				local38 = Static23.aClass128_1.method1831(arg5);
				if (local38.aBoolean448 && local38.anInt5842 != -1) {
					@Pc(54) Class69 local54 = Static25.aClass50_1.method682(local38.anInt5842);
					@Pc(57) int local57 = local54.anInt1646;
					if (local57 == 0) {
						return;
					}
					if (local57 == 2) {
						local16.aClass152_7.method6549();
						return;
					}
				}
			} else {
				local38 = Static23.aClass128_1.method1831(arg5);
				@Pc(86) Class227 local86 = Static23.aClass128_1.method1831(local19);
				if (local38.anInt5842 != -1 && local86.anInt5842 != -1) {
					@Pc(103) Class69 local103 = Static25.aClass50_1.method682(local38.anInt5842);
					@Pc(109) Class69 local109 = Static25.aClass50_1.method682(local86.anInt5842);
		...
		if (arg5 != -1 && !Static23.aClass128_1.method1831(arg5).aBoolean448) {
			local118 = 2;
		}
		...
		local16.aClass152_7.method6526(arg5 == -1 ? -1 : Static23.aClass128_1.method1831(arg5).anInt5842, arg3 & 0xFFFF, local118, false);
	}

	@OriginalMember(owner = "client!cg", name = "a", descriptor = "(II)V")
	public final void method6701(@OriginalArg(1) int arg0) {
		this.anInt10733 = arg0;
	}

	@OriginalMember(owner = "client!cg", name = "e", descriptor = "(B)Z")
	public abstract boolean method6702();

	@OriginalMember(owner = "client!cg", name = "a", descriptor = "(ILjava/lang/String;ZII)V")
	public final void method6704(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
	...
	protected final void method6705(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		@Pc(74) int local74 = Static323.method3244(local59 + super.anInt10694, super.aByte144, local11, local20, local48 + super.anInt10690);
		...
		@Pc(119) int local119 = Static323.method3244(local104 + super.anInt10694, super.aByte144, local11, local20, local93 + super.anInt10690);
		...
		@Pc(165) int local165 = Static323.method3244(local149 + super.anInt10694, super.aByte144, local11, local20, super.anInt10690 + local138);
		...
		@Pc(210) int local210 = Static323.method3244(local194 + super.anInt10694, super.aByte144, local11, local20, super.anInt10690 + local183);
	...
	public final void method6706(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1) {
		if (this.anIntArray872 == null && arg1 != null) {
			this.anIntArray872 = new int[Static125.aClass388_1.anIntArray821.length];
		} else if (arg1 == null) {
	...
	public final void finalize() {
		if (this.aClass8_Sub5_8 != null) {
			this.aClass8_Sub5_8.method2640();
		}
	}

	@OriginalMember(owner = "client!cg", name = "i", descriptor = "(B)Lclient!pda;")
	public final Class289 method6708() {
		@Pc(13) int local13 = this.method6711(0);
		return local13 == -1 ? Static636.aClass289_1 : Static574.aClass310_2.method4993(local13);
	}
	...
	public abstract Class80 method6709(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!cg", name = "a", descriptor = "(Lclient!ha;BZ[Lclient!ka;Lclient!tt;)V")
	protected final void method6710(@OriginalArg(0) Class19 arg0, @OriginalArg(2) boolean arg1, @OriginalArg(3) Class114[] arg2, @OriginalArg(4) Class73 arg3) {
		if (!arg1) {
			@Pc(15) int local15 = 0;
			@Pc(17) int local17 = 0;
			@Pc(19) int local19 = 0;
			...
			for (@Pc(35) int local35 = 0; local35 < arg2.length; local35++) {
				if (arg2[local35] != null) {
					arg2[local35].a(arg3);
					local29[local35] = arg2[local35].f();
					local33[local35] = arg2[local35].c();
			...
			if ((this.aClass8_Sub5_8 == null || this.aClass8_Sub5_8.aBoolean324) && (local17 > 0 || local21 > 0)) {
				this.aClass8_Sub5_8 = Static257.method2650(Static333.anInt5455, true);
			}
			if (this.aClass8_Sub5_8 != null) {
				...
				if (local17 == 1) {
					...
					for (local142 = 0; local142 < arg2.length; local142++) {
						if (local29[local142] != null) {
							Static734.method5445(local29[local142], 0, local138, local140, local29[local142].length);
				...
				if (local21 == 1) {
					...
					for (@Pc(199) int local199 = 0; local199 < arg2.length; local199++) {
						if (local33[local199] != null) {
							Static734.method5445(local33[local199], 0, local191, local142, local33[local199].length);
							local142 += local33[local199].length;
						}
					}
				}
				this.aClass8_Sub5_8.method2639(arg0, (long) Static333.anInt5455, local138, local191);
				this.aBoolean820 = true;
			}
		} else if (this.aClass8_Sub5_8 != null) {
			this.aClass8_Sub5_8.method2645((long) Static333.anInt5455);
		}
		if (this.aClass8_Sub5_8 != null) {
			this.aClass8_Sub5_8.method2654(super.aByte144, super.aShort131, super.aShort134, super.aShort132, super.aShort133);
		}
	}

	@OriginalMember(owner = "client!cg", name = "m", descriptor = "(I)I")
	protected abstract int method6711(@OriginalArg(0) int arg0);
}
