...
public final class Class8_Sub2_Sub1_Sub2_Sub1 extends Class8_Sub2_Sub1_Sub2 {
	...
	public void d(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1) {
		if (this.aClass201_1 == null || !super.aBoolean820 && !this.method875(0, arg0)) {
			return;
		}
		@Pc(24) Class73 local24 = arg0.A();
		local24.g(super.aClass126_7.method1810(arg1 ^ 0xFFFFC004));
		local24.b(super.anInt10690, arg1 + super.anInt10691, super.anInt10694);
		this.method6710(arg0, super.aBoolean820, super.aClass114Array3, local24);
	...
	public void method867(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2) {
		this.method6704(Static504.method4741() * Static65.aClass3_1.anInt87, arg2, arg1, arg0);
	}

	@OriginalMember(owner = "client!ca", name = "a", descriptor = "(BIIILclient!ka;Lclient!tt;Lclient!ha;I)V")
	private void method868(@OriginalArg(0) byte arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Class114 arg4, @OriginalArg(5) Class73 arg5, @OriginalArg(6) Class19 arg6, @OriginalArg(7) int arg7) {
		if (arg0 != -74) {
			this.d((Class19) null, 41);
		}
		@Pc(20) int local20 = arg7 * arg7 + arg1 * arg1;
		if (local20 < 262144 || local20 > arg2) {
			return;
		}
		@Pc(53) int local53 = (int) (Math.atan2((double) arg1, (double) arg7) * 2607.5945876176133D - (double) super.aClass126_7.method1810(16383)) & 0x3FFF;
		@Pc(65) Class114 local65 = Static691.method6440(super.anInt10746, super.anInt10742, arg3, super.anInt10716, local53, arg6);
		if (local65 != null) {
			arg6.C(false);
			local65.a(arg5, (Class8_Sub6) null, 0);
			arg6.C(true);
		}
	}
	...
	public boolean a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Class19 arg3) {
		if (this.aClass201_1 == null || !this.method875(131072, arg3)) {
			return false;
		}
		@Pc(22) Class73 local22 = arg3.A();
		@Pc(27) int local27 = super.aClass126_7.method1810(16383);
		local22.g(local27);
		local22.b(super.anInt10690, super.anInt10691, super.anInt10694);
		@Pc(40) boolean local40 = arg2;
		for (@Pc(42) int local42 = 0; local42 < super.aClass114Array3.length; local42++) {
			if (super.aClass114Array3[local42] != null && (Static504.aBoolean579 ? super.aClass114Array3[local42].a(arg1, arg0, local22, true, 0, Static582.anInt8627) : super.aClass114Array3[local42].a(arg1, arg0, local22, true, 0))) {
				local40 = true;
				break;
			}
		}
	...
	public boolean i(@OriginalArg(0) int arg0) {
		if (arg0 != 0) {
			this.method868((byte) 124, 20, -110, 30, (Class114) null, (Class73) null, (Class19) null, 15);
		}
		return false;
	}
	...
	@Override
	public int method6695(@OriginalArg(0) byte arg0) {
		if (arg0 > -48) {
			this.method6709(-126);
		}
		return -1;
	...
	@Override
	protected int method6711(@OriginalArg(0) int arg0) {
		if (arg0 != 0) {
			this.anInt1444 = -112;
		}
	...
	private void method870(@OriginalArg(0) Class114 arg0, @OriginalArg(1) int arg1, @OriginalArg(3) Class19 arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) Class73 arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7) {
		@Pc(12) int local12 = arg4 * arg4 + arg7 * arg7;
		if (local12 < 262144 || local12 > arg1) {
			return;
		}
		@Pc(53) int local53 = (int) (Math.atan2((double) arg4, (double) arg7) * 2607.5945876176133D - (double) super.aClass126_7.method1810(16383)) & 0x3FFF;
		@Pc(65) Class114 local65 = Static691.method6440(super.anInt10746, super.anInt10742, arg3, super.anInt10716, local53, arg2);
		if (local65 != null) {
			arg2.C(false);
			local65.a(arg5, (Class8_Sub6) null, arg6, 0);
			arg2.C(true);
		}
	}
	...
	public void method872(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) byte arg2) {
	...
	@Override
	public int method6693(@OriginalArg(0) byte arg0) {
		if (this.aClass201_1 == null || this.aClass201_1.anInt5012 == -1) {
			if (arg0 < 43) {
				this.anInt1460 = 1;
			}
			return super.method6693((byte) 76);
		} else {
			return Static690.aClass308_2.method4967(this.aClass201_1.anInt5012).anInt6713;
		}
	}

	@OriginalMember(owner = "client!ca", name = "c", descriptor = "(III)V")
	public void method873(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		super.anInt10764 = 0;
		super.anIntArray879[0] = arg0;
		super.anInt10763 = 0;
		super.anInt10762 = 0;
		super.anIntArray878[0] = arg1;
		@Pc(26) int local26 = this.method6693((byte) 84);
		...
		if (super.aClass8_Sub5_8 != null) {
			super.aClass8_Sub5_8.method2652();
		}
	}
	...
	public Class8_Sub7 a(@OriginalArg(1) Class19 arg0) {
		if (this.aClass201_1 == null || !this.method875(2048, arg0)) {
			return null;
		}
		...
		local22.b(super.anInt10690, -super.anInt10732 + super.anInt10691 - 20, super.anInt10694);
		super.aBoolean819 = false;
		@Pc(114) Class8_Sub7 local114 = null;
		if (Static400.aClass2_Sub34_28.aClass57_Sub7_1.method2010() == 1) {
			@Pc(126) Class289 local126 = this.method6708();
			if (local126.aBoolean545 && (this.aClass201_1.anInt5012 == -1 || Static690.aClass308_2.method4967(this.aClass201_1.anInt5012).aBoolean506)) {
				@Pc(166) Class152 local166 = super.aClass152_11.method6543() && super.aClass152_11.method6540() ? super.aClass152_11 : null;
				@Pc(186) Class152 local186 = super.aClass152_10.method6543() && (!super.aBoolean817 || local166 == null) ? super.aClass152_10 : null;
				@Pc(212) Class114 local212 = Static618.method5889(240, super.aClass114Array3[0], super.anInt10742, 0, super.anInt10716, 1, arg0, 160, local186 == null ? local166 : local186, super.anInt10746, local27, 0);
				if (local212 != null) {
					local114 = Static642.method5995(true, super.aClass114Array3.length + 1);
					super.aBoolean819 = true;
					arg0.C(false);
					if (Static504.aBoolean579) {
						local212.a(local22, local114.aClass8_Sub6Array1[super.aClass114Array3.length], Static582.anInt8627, 0);
					} else {
						local212.a(local22, local114.aClass8_Sub6Array1[super.aClass114Array3.length], 0);
					}
					arg0.C(true);
				}
			}
			...
			for (local269 = Static527.aClass254Array1.length - 1; local269 >= 0; local269--) {
				...
				if (local275 != null && local275.anInt6371 != -1) {
					...
					if (local275.anInt6363 == 1) {
						@Pc(298) Class2_Sub45 local298 = (Class2_Sub45) Static18.aClass28_2.method373((long) local275.anInt6366);
						if (local298 != null) {
							...
							if (Static504.aBoolean579) {
								this.method870(super.aClass114Array3[0], 92160000, arg0, local275.anInt6371, local310, local22, Static582.anInt8627, local316);
							} else {
								this.method868((byte) -74, local310, 92160000, local275.anInt6371, super.aClass114Array3[0], local22, arg0, local316);
							}
						}
					}
					@Pc(371) int local371;
					if (local275.anInt6363 == 2) {
						...
						local310 *= local310;
						if (Static504.aBoolean579) {
							this.method870(super.aClass114Array3[0], local310, arg0, local275.anInt6371, local364, local22, Static582.anInt8627, local371);
						} else {
							this.method868((byte) -74, local364, local310, local275.anInt6371, super.aClass114Array3[0], local22, arg0, local371);
						}
					}
					if (local275.anInt6363 == 10 && local275.anInt6366 >= 0 && local275.anInt6366 < Static621.aClass8_Sub2_Sub1_Sub2_Sub1Array3.length) {
						...
						if (local438 != null) {
							...
							if (Static504.aBoolean579) {
								this.method870(super.aClass114Array3[0], 92160000, arg0, local275.anInt6371, local371, local22, Static582.anInt8627, local310);
							} else {
								this.method868((byte) -74, local371, 92160000, local275.anInt6371, super.aClass114Array3[0], local22, arg0, local310);
							}
						}
					}
				}
		...
		local22.g(local27);
		local22.b(super.anInt10690, -super.anInt10732 + super.anInt10691 - 5, super.anInt10694);
		if (local114 == null) {
			local114 = Static642.method5995(true, super.aClass114Array3.length);
		}
		this.method6710(arg0, false, super.aClass114Array3, local22);
		if (Static504.aBoolean579) {
			for (local269 = 0; local269 < super.aClass114Array3.length; local269++) {
				if (super.aClass114Array3[local269] != null) {
					super.aClass114Array3[local269].a(local22, local114.aClass8_Sub6Array1[local269], Static582.anInt8627, Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2 == this ? 1 : 0);
				}
			}
		} else {
			for (local269 = 0; local269 < super.aClass114Array3.length; local269++) {
				if (super.aClass114Array3[local269] != null) {
					super.aClass114Array3[local269].a(local22, local114.aClass8_Sub6Array1[local269], Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2 == this ? 1 : 0);
				}
			}
		}
		if (super.aClass8_Sub5_8 != null) {
			@Pc(635) Class230 local635 = super.aClass8_Sub5_8.method2641();
			if (Static504.aBoolean579) {
				arg0.a(local635, Static582.anInt8627);
			} else {
				arg0.a(local635);
			}
		}
	...
	public void method874(@OriginalArg(0) Class2_Sub21 arg0) {
		arg0.anInt8388 = 0;
		@Pc(12) int local12 = arg0.method5205();
		...
		@Pc(44) int local44 = super.method6693((byte) 85);
		this.method6701((local12 >> 3 & 0x7) + 1);
		this.aByte31 = (byte) (local12 >> 6 & 0x3);
		super.anInt10690 += this.method6693((byte) 44) - local44 << 8;
		super.anInt10694 += this.method6693((byte) 111) - local44 << 8;
		this.aByte33 = arg0.method5186();
		this.anInt1430 = arg0.method5186();
		this.anInt1431 = arg0.method5186();
		this.aBoolean124 = arg0.method5186() == 1;
		...
		for (@Pc(151) int local151 = 0; local151 < Static125.aClass388_1.anIntArray821.length; local151++) {
			if (Static125.aClass388_1.anIntArray821[local151] != 1) {
				local165 = arg0.method5205();
				if (local165 == 0) {
					local139[local151] = 0;
				} else {
					local184 = arg0.method5205();
					local191 = (local165 << 8) + local184;
					if (local151 == 0 && local191 == 65535) {
						local134 = arg0.method5191();
						this.anInt1433 = arg0.method5205();
						break;
					}
					if (local191 >= 32768) {
						local191 = Static349.anIntArray426[local191 - 32768];
						local139[local151] = local191 | 0x40000000;
						local149[local151] = Static419.aClass112_1.method1684(local191);
			...
			for (local191 = 0; local191 < Static125.aClass388_1.anIntArray821.length; local191++) {
				if (Static125.aClass388_1.anIntArray821[local191] == 0) {
					if ((local165 & 0x1 << local184) != 0) {
						local144[local191] = Static595.method5545(arg0, local149[local191]);
					}
					local184++;
				}
			}
		...
		this.anInt1443 = arg0.method5191();
		this.aString8 = arg0.method5167();
		if (Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2 == this) {
			Static515.aString96 = this.aString8;
		}
		this.aString9 = this.aString8;
		this.anInt1444 = arg0.method5205();
		if (local40) {
			this.anInt1436 = arg0.method5191();
			...
			this.anInt1436 = 0;
			this.anInt1437 = arg0.method5205();
			this.anInt1471 = arg0.method5205();
			if (this.anInt1471 == 255) {
				this.anInt1471 = -1;
			}
		}
		local191 = this.anInt1452;
		this.anInt1452 = arg0.method5205();
		@Pc(490) int local490;
		if (this.anInt1452 == 0) {
			Static76.method991(this);
		} else {
			...
			this.anInt1455 = arg0.method5191();
			this.anInt1459 = arg0.method5191();
			this.anInt1445 = arg0.method5191();
			this.anInt1469 = arg0.method5191();
			this.anInt1460 = arg0.method5205();
		...
		this.aClass201_1.method3175(local332, local139, local144, local134, this.method6711(0), this.aByte32 == 1);
		if (local134 != local240) {
			super.anInt10690 = (super.anIntArray879[0] << 9) + (this.method6693((byte) 83) << 8);
			super.anInt10694 = (super.anIntArray878[0] << 9) + (this.method6693((byte) 45) << 8);
		}
		...
		if (!super.aClass152_10.method6543() || !super.aBoolean817) {
			return;
		}
		@Pc(717) Class289 local717 = this.method6708();
		if (!local717.method4543(super.aClass152_10.method6548())) {
			super.aClass152_10.method6547(true, -1);
	...
	private boolean method875(@OriginalArg(0) int arg0, @OriginalArg(2) Class19 arg1) {
		@Pc(5) int local5 = arg0;
		@Pc(15) Class289 local15 = this.method6708();
		@Pc(33) Class152 local33 = super.aClass152_11.method6543() && !super.aClass152_11.method6540() ? super.aClass152_11 : null;
		@Pc(58) Class152 local58 = !super.aClass152_10.method6543() || this.aBoolean129 || super.aBoolean817 && local33 != null ? null : super.aClass152_10;
		...
		this.method6697(local152);
		if (local61 == 0 && local64 == 0) {
			this.method6705(local95, 0, 0, this.method6693((byte) 59) << 9, this.method6693((byte) 126) << 9, -81);
		} else {
			this.method6705(local95, local15.anInt7236, local15.anInt7258, local61, local64, -104);
		...
		if (!this.aBoolean129) {
			this.method6688(local5, local64, arg1, local15, local95, local61);
		}
		return true;
	}
	...
	public String method878(@OriginalArg(0) boolean arg0) {
		@Pc(5) String local5 = "";
		...
		if (local40 != null && local40[this.aByte31] != -1) {
			@Pc(62) Class53 local62 = Static619.aClass387_2.method6376(local40[this.aByte31]);
			if (local62.aChar1 == 's') {
				local5 = local5 + local62.method744(this.aByte33 & 0xFF);
			} else {
				Static240.method2529(new Throwable(), "gdn1");
	...
	@Override
	public Class80 method6709(@OriginalArg(0) int arg0) {
		if (arg0 != -3109) {
		...
		if (super.aClass80_3 != null) {
			...
			if (Static133.anInt2458 == 0 || Static133.anInt2458 == 3 || Static133.anInt2458 == 1 && Static362.method3698(arg0 + 3109, this.aString9)) {
	...
	public void method879(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) byte arg2) {
		if (super.aClass152_11.method6543() && super.aClass152_11.method6541().anInt1654 == 1) {
			super.anIntArray869 = null;
			super.aClass152_11.method6547(true, -1);
		}
		for (@Pc(33) int local33 = 0; local33 < super.aClass199Array3.length; local33++) {
			if (super.aClass199Array3[local33].anInt4930 != -1) {
				@Pc(56) Class227 local56 = Static23.aClass128_1.method1831(super.aClass199Array3[local33].anInt4930);
				if (local56.aBoolean448 && local56.anInt5842 != -1 && Static25.aClass50_1.method682(local56.anInt5842).anInt1654 == 1) {
					super.aClass199Array3[local33].aClass152_7.method6547(true, -1);
					super.aClass199Array3[local33].anInt4930 = -1;
				}
			}
		}
		if (-9380 != -9380) {
			this.method6693((byte) -74);
		}
		this.anInt1467 = -1;
		if (arg1 < 0 || Static720.anInt10859 <= arg1 || arg0 < 0 || Static501.anInt7568 <= arg0) {
			this.method873(arg1, arg0);
			...
			if (arg2 == 2) {
				Static360.method3689(this, arg1, arg0);
			}
			this.method872(arg0, arg1, arg2);
		} else {
			this.method873(arg1, arg0);
		}
	}
