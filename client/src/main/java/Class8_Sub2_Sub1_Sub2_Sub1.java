...
public final class Class8_Sub2_Sub1_Sub2_Sub1 extends Class8_Sub2_Sub1_Sub2 {
	...
	public void method9296(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1) {
		if (this.aClass203_1 == null || !super.aBoolean821 && !this.method1421(0, arg0)) {
			return;
		}
		@Pc(24) Class73 local24 = arg0.method7992();
		local24.method7138(super.aClass126_7.method2673(arg1 ^ 0xFFFFC004));
		local24.method7141(super.anInt10718, arg1 + super.anInt10719, super.anInt10722);
		this.method9326(arg0, super.aBoolean821, super.aClass114Array3, local24);
	...
	public void method1413(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2) {
		this.method9320(Static504.method6740() * Static65.aClass3_1.anInt87, arg2, arg1, arg0);
	}
	...
	private void method1414(@OriginalArg(0) byte arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Class114 arg4, @OriginalArg(5) Class73 arg5, @OriginalArg(6) Class19 arg6, @OriginalArg(7) int arg7) {
		if (arg0 != -74) {
			this.method9296((Class19) null, 41);
		}
		...
		@Pc(65) Class114 local65 = Static691.method9011(super.anInt10775, super.anInt10770, arg3, super.anInt10744, local53, arg6);
		if (local65 != null) {
			arg6.C(false);
			local65.method7480(arg5, (Class8_Sub6) null, 0);
			arg6.C(true);
		}
	}
	...
	public boolean method9286(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Class19 arg3) {
		if (this.aClass203_1 == null || !this.method1421(131072, arg3)) {
			return false;
		}
		@Pc(22) Class73 local22 = arg3.method7992();
		@Pc(27) int local27 = super.aClass126_7.method2673(16383);
		local22.method7138(local27);
		local22.method7141(super.anInt10718, super.anInt10719, super.anInt10722);
		@Pc(40) boolean local40 = arg2;
		for (@Pc(42) int local42 = 0; local42 < super.aClass114Array3.length; local42++) {
			if (super.aClass114Array3[local42] != null && (Static504.aBoolean579 ? super.aClass114Array3[local42].method7490(arg1, arg0, local22, true, 0, Static582.anInt8651) : super.aClass114Array3[local42].method7493(arg1, arg0, local22, true, 0))) {
				local40 = true;
				break;
			}
		}
	...
	private void method1416(@OriginalArg(0) Class114 arg0, @OriginalArg(1) int arg1, @OriginalArg(3) Class19 arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) Class73 arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7) {
		...
		@Pc(65) Class114 local65 = Static691.method9011(super.anInt10775, super.anInt10770, arg3, super.anInt10744, local53, arg2);
		if (local65 != null) {
			arg2.C(false);
			local65.method7491(arg5, (Class8_Sub6) null, arg6, 0);
			arg2.C(true);
		}
	}
	...
	public void method1418(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) byte arg2) {
		...
		for (@Pc(24) int local24 = super.anInt10793; local24 > 0; local24--) {
	...
	public int method9309(@OriginalArg(0) byte arg0) {
		if (this.aClass203_1 == null || this.aClass203_1.anInt5029 == -1) {
			if (arg0 < 43) {
				this.anInt1467 = 1;
			}
	...
	public void method1419(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		...
		@Pc(26) int local26 = this.method9309((byte) 84);
		super.anInt10718 = local26 * 256 + super.anIntArray879[0] * 512;
		super.anInt10722 = super.anIntArray878[0] * 512 + local26 * 256;
	...
	public Class8_Sub7 method9283(@OriginalArg(1) Class19 arg0) {
		if (this.aClass203_1 == null || !this.method1421(2048, arg0)) {
			return null;
		}
		@Pc(22) Class73 local22 = arg0.method7992();
		@Pc(27) int local27 = super.aClass126_7.method2673(16383);
		local22.method7138(local27);
		@Pc(53) Class293 local53 = Static334.aClass293ArrayArrayArray1[super.aByte144][super.anInt10718 >> Static52.anInt1070][super.anInt10722 >> Static52.anInt1070];
		if (local53 == null || local53.aClass8_Sub2_Sub2_1 == null) {
			super.anInt10760 = (int) ((float) super.anInt10760 - (float) super.anInt10760 / 10.0F);
		} else {
			@Pc(68) int local68 = super.anInt10760 - local53.aClass8_Sub2_Sub2_1.aShort46;
			super.anInt10760 = (int) ((float) super.anInt10760 - (float) local68 / 10.0F);
		}
		...
		if (Static400.aClass2_Sub34_28.aClass57_Sub7_1.method2905() == 1) {
			...
			if (local126.aBoolean545 && (this.aClass203_1.anInt5029 == -1 || Static690.aClass310_2.method7099(this.aClass203_1.anInt5029).aBoolean506)) {
				...
				if (local212 != null) {
					local114 = Static642.method8448(true, super.aClass114Array3.length + 1);
					super.aBoolean820 = true;
					arg0.C(false);
					if (Static504.aBoolean579) {
						local212.method7491(local22, local114.aClass8_Sub6Array1[super.aClass114Array3.length], Static582.anInt8651, 0);
					} else {
						local212.method7480(local22, local114.aClass8_Sub6Array1[super.aClass114Array3.length], 0);
					}
					arg0.C(true);
				}
			}
		...
		@Pc(269) int local269;
		if (Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2 == this) {
			for (local269 = Static527.aClass256Array1.length - 1; local269 >= 0; local269--) {
				@Pc(275) Class256 local275 = Static527.aClass256Array1[local269];
				if (local275 != null && local275.anInt6391 != -1) {
					@Pc(310) int local310;
					if (local275.anInt6383 == 1) {
						@Pc(298) Class2_Sub45 local298 = (Class2_Sub45) Static18.aClass28_2.method738((long) local275.anInt6386);
						if (local298 != null) {
							...
							@Pc(316) int local316 = local303.anInt10722 - Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.anInt10722;
							if (Static504.aBoolean579) {
								this.method1416(super.aClass114Array3[0], 92160000, arg0, local275.anInt6391, local310, local22, Static582.anInt8651, local316);
							} else {
								this.method1414((byte) -74, local310, 92160000, local275.anInt6391, super.aClass114Array3[0], local22, arg0, local316);
							}
						}
					}
					@Pc(371) int local371;
					if (local275.anInt6383 == 2) {
						@Pc(364) int local364 = local275.anInt6389 - Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.anInt10718;
						local371 = local275.anInt6382 - Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.anInt10722;
						local310 = local275.anInt6384 << 9;
						local310 *= local310;
						if (Static504.aBoolean579) {
							this.method1416(super.aClass114Array3[0], local310, arg0, local275.anInt6391, local364, local22, Static582.anInt8651, local371);
						} else {
							this.method1414((byte) -74, local364, local310, local275.anInt6391, super.aClass114Array3[0], local22, arg0, local371);
						}
					}
					if (local275.anInt6383 == 10 && local275.anInt6386 >= 0 && local275.anInt6386 < Static621.aClass8_Sub2_Sub1_Sub2_Sub1Array3.length) {
						@Pc(438) Class8_Sub2_Sub1_Sub2_Sub1 local438 = Static621.aClass8_Sub2_Sub1_Sub2_Sub1Array3[local275.anInt6386];
						if (local438 != null) {
							local371 = local438.anInt10718 - Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.anInt10718;
							local310 = local438.anInt10722 - Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.anInt10722;
							if (Static504.aBoolean579) {
								this.method1416(super.aClass114Array3[0], 92160000, arg0, local275.anInt6391, local371, local22, Static582.anInt8651, local310);
							} else {
								this.method1414((byte) -74, local371, 92160000, local275.anInt6391, super.aClass114Array3[0], local22, arg0, local310);
							}
						}
					}
				}
		...
		if (local114 == null) {
			local114 = Static642.method8448(true, super.aClass114Array3.length);
		}
		...
		if (Static504.aBoolean579) {
			for (local269 = 0; local269 < super.aClass114Array3.length; local269++) {
				if (super.aClass114Array3[local269] != null) {
					super.aClass114Array3[local269].method7491(local22, local114.aClass8_Sub6Array1[local269], Static582.anInt8651, Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2 == this ? 1 : 0);
				}
			}
		} else {
			for (local269 = 0; local269 < super.aClass114Array3.length; local269++) {
				if (super.aClass114Array3[local269] != null) {
					super.aClass114Array3[local269].method7480(local22, local114.aClass8_Sub6Array1[local269], Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2 == this ? 1 : 0);
				}
			}
		}
		if (super.aClass8_Sub5_8 != null) {
			@Pc(635) Class232 local635 = super.aClass8_Sub5_8.method3645();
			if (Static504.aBoolean579) {
				arg0.method7974(local635, Static582.anInt8651);
			} else {
				arg0.method8028(local635);
			}
		}
		for (local269 = 0; local269 < super.aClass114Array3.length; local269++) {
			if (super.aClass114Array3[local269] != null) {
				super.aBoolean820 |= super.aClass114Array3[local269].F();
			}
	...
	public void method1420(@OriginalArg(0) Class2_Sub21 arg0) {
		...
		@Pc(44) int local44 = super.method9309((byte) 85);
		this.method9317((local12 >> 3 & 0x7) + 1);
		this.aByte31 = (byte) (local12 >> 6 & 0x3);
		super.anInt10718 += this.method9309((byte) 44) - local44 << 8;
		super.anInt10722 += this.method9309((byte) 111) - local44 << 8;
		this.aByte33 = arg0.method7384();
		...
		@Pc(191) int local191;
		@Pc(240) int local240;
		for (@Pc(151) int local151 = 0; local151 < Static125.aClass390_1.anIntArray821.length; local151++) {
			if (Static125.aClass390_1.anIntArray821[local151] != 1) {
				local165 = arg0.method7403();
				if (local165 == 0) {
					local139[local151] = 0;
				} else {
					local184 = arg0.method7403();
					local191 = (local165 << 8) + local184;
					if (local151 == 0 && local191 == 65535) {
						local134 = arg0.method7389();
						this.anInt1440 = arg0.method7403();
						break;
					}
					if (local191 >= 32768) {
		...
		if (local134 == -1) {
			local165 = arg0.method7389();
			local184 = 0;
			for (local191 = 0; local191 < Static125.aClass390_1.anIntArray821.length; local191++) {
				if (Static125.aClass390_1.anIntArray821[local191] == 0) {
					if ((local165 & 0x1 << local184) != 0) {
						local144[local191] = Static595.method7818(arg0, local149[local191]);
					}
					local184++;
				}
			}
		...
		this.anInt1450 = arg0.method7389();
		this.aString8 = arg0.method7365();
		if (Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2 == this) {
			Static515.aString96 = this.aString8;
		}
		this.aString9 = this.aString8;
		this.anInt1451 = arg0.method7403();
		if (local40) {
			this.anInt1443 = arg0.method7389();
			this.anInt1444 = this.anInt1451;
			...
			this.anInt1443 = 0;
			this.anInt1444 = arg0.method7403();
			this.anInt1478 = arg0.method7403();
			if (this.anInt1478 == 255) {
				this.anInt1478 = -1;
			}
		}
		local191 = this.anInt1459;
		this.anInt1459 = arg0.method7403();
		@Pc(490) int local490;
		if (this.anInt1459 == 0) {
			Static76.method1552(this);
		} else {
			local240 = this.anInt1462;
			@Pc(487) int local487 = this.anInt1466;
			local490 = this.anInt1452;
			@Pc(493) int local493 = this.anInt1476;
			@Pc(496) int local496 = this.anInt1467;
			this.anInt1462 = arg0.method7389();
			this.anInt1466 = arg0.method7389();
			this.anInt1452 = arg0.method7389();
			this.anInt1476 = arg0.method7389();
			this.anInt1467 = arg0.method7403();
			if (this.aBoolean126 != local21 || this.anInt1459 != local191 || local240 != this.anInt1462 || local487 != this.anInt1466 || this.anInt1452 != local490 || this.anInt1476 != local493 || local496 != this.anInt1467) {
		...
		local240 = this.aClass203_1.anInt5029;
		@Pc(603) int[] local603 = this.aClass203_1.anIntArray380;
		this.aClass203_1.method4552(local332, local139, local144, local134, this.method9327(0), this.aByte32 == 1);
		if (local134 != local240) {
			super.anInt10718 = (super.anIntArray879[0] << 9) + (this.method9309((byte) 83) << 8);
			super.anInt10722 = (super.anIntArray878[0] << 9) + (this.method9309((byte) 45) << 8);
		}
	...
	private boolean method1421(@OriginalArg(0) int arg0, @OriginalArg(2) Class19 arg1) {
		...
		@Pc(64) int local64 = local15.anInt7259;
		if (local61 != 0 || local64 != 0 || local15.anInt7245 != 0 || local15.anInt7273 != 0) {
			arg0 |= 0x7;
		}
		...
		super.anInt10777 = local152.fa();
		super.anInt10756 = local152.ma();
		this.method9313(local152);
		if (local61 == 0 && local64 == 0) {
			this.method9321(local95, 0, 0, this.method9309((byte) 59) << 9, this.method9309((byte) 126) << 9, -81);
		} else {
			this.method9321(local95, local15.anInt7257, local15.anInt7279, local61, local64, -104);
			if (super.anInt10775 != 0) {
				local152.FA(super.anInt10775);
			}
			if (super.anInt10770 != 0) {
				local152.VA(super.anInt10770);
			}
			if (super.anInt10744 != 0) {
				local152.H(0, super.anInt10744, 0);
			}
		}
		if (local119) {
			local152.method7495(super.aByte150, super.aByte147, super.aByte148, super.aByte149 & 0xFF);
		}
		if (!this.aBoolean129) {
			this.method9304(local5, local64, arg1, local15, local95, local61);
		}
		return true;
	}
	...
	public Class80 method9325(@OriginalArg(0) int arg0) {
		...
		if (super.aClass80_3 != null) {
			...
			if (Static133.anInt2467 == 0 || Static133.anInt2467 == 3 || Static133.anInt2467 == 1 && Static362.method5248(arg0 + 3109, this.aString9)) {
	...
	public void method1425(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) byte arg2) {
		...
		if (-9380 != -9380) {
			this.method9309((byte) -74);
		}
		this.anInt1474 = -1;
		if (arg1 < 0 || Static720.anInt10888 <= arg1 || arg0 < 0 || Static501.anInt7591 <= arg0) {
			this.method1419(arg1, arg0);
		} else if (super.anIntArray879[0] >= 0 && super.anIntArray879[0] < Static720.anInt10888 && super.anIntArray878[0] >= 0 && Static501.anInt7591 > super.anIntArray878[0]) {
			if (arg2 == 2) {
				Static360.method5239(this, arg1, arg0);
			}
