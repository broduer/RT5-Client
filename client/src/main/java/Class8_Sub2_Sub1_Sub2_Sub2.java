...
public final class Class8_Sub2_Sub1_Sub2_Sub2 extends Class8_Sub2_Sub1_Sub2 {
	...
	public boolean a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Class19 arg3) {
		if (this.aClass268_1 == null || !this.method6715(131072, arg3)) {
			return false;
		}
		@Pc(20) Class73 local20 = arg3.A();
		@Pc(25) int local25 = super.aClass126_7.method1810(16383);
		local20.g(local25);
		local20.b(super.anInt10690, super.anInt10691, super.anInt10694);
		...
		for (@Pc(40) int local40 = 0; local40 < super.aClass114Array3.length; local40++) {
			if (super.aClass114Array3[local40] != null) {
				...
				if (Static504.aBoolean579) {
					local105 = super.aClass114Array3[local40].a(arg1, arg0, local20, local89, this.aClass268_1.anInt6723, Static582.anInt8627);
				} else {
					local105 = super.aClass114Array3[local40].a(arg1, arg0, local20, local89, this.aClass268_1.anInt6723);
				}
				if (local105) {
					local38 = true;
					break;
	...
	public Class8_Sub7 a(@OriginalArg(1) Class19 arg0) {
		if (this.aClass268_1 == null || !this.method6715(2048, arg0)) {
			return null;
		}
		...
		@Pc(104) Class289 local104 = this.method6708();
		@Pc(118) Class268 local118 = this.aClass268_1.anIntArray532 == null ? this.aClass268_1 : this.aClass268_1.method4221(65535, Static34.aClass304_1);
		super.aBoolean819 = false;
		@Pc(123) Class8_Sub7 local123 = null;
		if (Static400.aClass2_Sub34_28.aClass57_Sub7_1.method2010() == 1 && local118.aBoolean506 && local104.aBoolean545) {
			@Pc(159) Class152 local159 = super.aClass152_11.method6543() && super.aClass152_11.method6540() ? super.aClass152_11 : null;
			@Pc(179) Class152 local179 = super.aClass152_10.method6543() && (!super.aBoolean817 || local159 == null) ? super.aClass152_10 : null;
			@Pc(223) Class114 local223 = Static618.method5889(this.aClass268_1.aByte109 & 0xFF, super.aClass114Array3[0], super.anInt10742, this.aClass268_1.aShort76 & 0xFFFF, super.anInt10716, this.aClass268_1.anInt6713, arg0, this.aClass268_1.aByte111 & 0xFF, local179 == null ? local159 : local179, super.anInt10746, local27, this.aClass268_1.aShort75 & 0xFFFF);
			if (local223 != null) {
				local123 = Static642.method5995(this.method6721(), super.aClass114Array3.length + 1);
				super.aBoolean819 = true;
				arg0.C(false);
				if (Static504.aBoolean579) {
					local223.a(local22, local123.aClass8_Sub6Array1[super.aClass114Array3.length], Static582.anInt8627, 0);
				} else {
					local223.a(local22, local123.aClass8_Sub6Array1[super.aClass114Array3.length], 0);
				}
				arg0.C(true);
			}
		}
		...
		if (local123 == null) {
			local123 = Static642.method5995(this.method6721(), super.aClass114Array3.length);
		}
		...
		if (Static504.aBoolean579) {
			for (local314 = 0; local314 < super.aClass114Array3.length; local314++) {
				if (super.aClass114Array3[local314] != null) {
					super.aClass114Array3[local314].a(local22, local123.aClass8_Sub6Array1[local314], Static582.anInt8627, 0);
				}
			}
		} else {
			for (local314 = 0; local314 < super.aClass114Array3.length; local314++) {
				if (super.aClass114Array3[local314] != null) {
					super.aClass114Array3[local314].a(local22, local123.aClass8_Sub6Array1[local314], 0);
				}
			}
		}
		if (super.aClass8_Sub5_8 != null) {
			@Pc(394) Class230 local394 = super.aClass8_Sub5_8.method2641();
			if (Static504.aBoolean579) {
				arg0.a(local394, Static582.anInt8627);
			} else {
				arg0.a(local394);
			}
		}
	...
	private boolean method6715(@OriginalArg(0) int arg0, @OriginalArg(2) Class19 arg1) {
		@Pc(5) int local5 = arg0;
		@Pc(9) Class289 local9 = this.method6708();
		@Pc(27) Class152 local27 = super.aClass152_11.method6543() && !super.aClass152_11.method6540() ? super.aClass152_11 : null;
		@Pc(47) Class152 local47 = super.aClass152_10.method6543() && (!super.aBoolean817 || local27 == null) ? super.aClass152_10 : null;
		...
		@Pc(111) int local111 = super.aClass126_7.method1810(16383);
		@Pc(134) Class114 local134 = super.aClass114Array3[0] = this.aClass268_1.method4229(Static34.aClass304_1, arg1, Static574.aClass310_2, local27, local111, super.anIntArray877, this.aClass386_1, local47, arg0, super.aClass152_Sub2_Sub1Array3);
		if (local134 == null) {
			return false;
		}
		super.anInt10748 = local134.fa();
		super.anInt10728 = local134.ma();
		this.method6697(local134);
		if (local50 == 0 && local53 == 0) {
			this.method6705(local111, 0, 0, this.method6693((byte) 116) << 9, this.method6693((byte) 79) << 9, -86);
		} else {
			this.method6705(local111, local9.anInt7236, local9.anInt7258, local50, local53, -119);
		...
		this.method6688(local5, local53, arg1, local9, local111, local50);
		return true;
	}
	...
	public int method6690() {
		if (this.aClass268_1.anIntArray532 != null) {
			@Pc(19) Class268 local19 = this.aClass268_1.method4221(65535, Static34.aClass304_1);
			if (local19 != null && local19.anInt6707 != -1) {
				return local19.anInt6707;
			}
		}
		return this.aClass268_1.anInt6707 == -1 ? super.method6690() : this.aClass268_1.anInt6707;
	}
	...
	public int method6695(@OriginalArg(0) byte arg0) {
		...
		if (this.aClass268_1.anIntArray532 != null) {
			@Pc(22) Class268 local22 = this.aClass268_1.method4221(65535, Static34.aClass304_1);
	...
	public void method6716(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		for (@Pc(110) int local110 = 0; local110 < super.aClass199Array3.length; local110++) {
			if (super.aClass199Array3[local110].anInt4930 != -1) {
				@Pc(131) Class227 local131 = Static23.aClass128_1.method1831(super.aClass199Array3[local110].anInt4930);
				if (local131.aBoolean448 && local131.anInt5842 != -1 && Static25.aClass50_1.method682(local131.anInt5842).anInt1654 == 1) {
					super.aClass199Array3[local110].aClass152_7.method6547(true, -1);
	...
	public void method6717(@OriginalArg(1) boolean arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		super.aByte144 = super.aByte143 = (byte) arg3;
		if (Static441.method4209(arg1, arg2)) {
			super.aByte143++;
		}
		if (super.aClass152_11.method6543() && super.aClass152_11.method6541().anInt1654 == 1) {
			super.anIntArray869 = null;
		...
		for (@Pc(61) int local61 = 0; local61 < super.aClass199Array3.length; local61++) {
			if (super.aClass199Array3[local61].anInt4930 != -1) {
				@Pc(81) Class227 local81 = Static23.aClass128_1.method1831(super.aClass199Array3[local61].anInt4930);
				if (local81.aBoolean448 && local81.anInt5842 != -1 && Static25.aClass50_1.method682(local81.anInt5842).anInt1654 == 1) {
					super.aClass199Array3[local61].aClass152_7.method6547(true, -1);
	...
	public void method6718(@OriginalArg(2) String arg0) {
		@Pc(17) int local17 = Static504.method4741() * Static65.aClass3_1.anInt85;
		this.method6704(local17, arg0, 0, 0);
	}
	...
	public void d(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1) {
		if (this.aClass268_1 == null || !super.aBoolean820 && !this.method6715(0, arg0)) {
			return;
		}
		@Pc(26) Class73 local26 = arg0.A();
		local26.g(super.aClass126_7.method1810(16383));
		local26.b(super.anInt10690, super.anInt10691 - 20, super.anInt10694);
		this.method6710(arg0, super.aBoolean820, super.aClass114Array3, local26);
		for (@Pc(53) int local53 = 0; local53 < super.aClass114Array3.length; local53++) {
			super.aClass114Array3[local53] = null;
		}
		if (arg1 != -5) {
			this.c((Class19) null, -21);
		}
	}
	...
	public void method6719(@OriginalArg(0) Class268 arg0) {
		if (arg0 != this.aClass268_1 && Static400.aBoolean622 && Static321.method3240(super.anInt10740)) {
			Static488.method4579();
		}
	...
	protected int method6711(@OriginalArg(0) int arg0) {
		if (this.aClass268_1.anIntArray532 != null) {
			@Pc(15) Class268 local15 = this.aClass268_1.method4221(arg0 + 65535, Static34.aClass304_1);
