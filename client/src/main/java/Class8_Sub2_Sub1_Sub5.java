...
public final class Class8_Sub2_Sub1_Sub5 extends Class8_Sub2_Sub1 {
	...
	public Class8_Sub2_Sub1_Sub5(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) boolean arg12) {
		...
		@Pc(36) Class227 local36 = Static23.aClass128_1.method1831(this.anInt7402);
		...
		if (local39 != -1) {
			...
			this.aClass152_8.method6526(local39, arg1, local59, false);
		}
	}

	@OriginalMember(owner = "client!pja", name = "a", descriptor = "(Lclient!tt;Lclient!ka;ILclient!ha;)V")
	private void method4622(@OriginalArg(0) Class73 arg0, @OriginalArg(1) Class114 arg1, @OriginalArg(3) Class19 arg2) {
		arg1.a(arg0);
		@Pc(9) Class328[] local9 = arg1.f();
		@Pc(19) Class249[] local19 = arg1.c();
		if ((this.aClass8_Sub5_5 == null || this.aClass8_Sub5_5.aBoolean324) && (local9 != null || local19 != null)) {
			this.aClass8_Sub5_5 = Static257.method2650(Static333.anInt5455, true);
		}
		if (this.aClass8_Sub5_5 != null) {
			this.aClass8_Sub5_5.method2639(arg2, (long) Static333.anInt5455, local9, local19);
			this.aClass8_Sub5_5.method2654(super.aByte144, super.aShort131, super.aShort134, super.aShort132, super.aShort133);
		}
	}

	@OriginalMember(owner = "client!pja", name = "a", descriptor = "(IILclient!ha;I)Lclient!ka;")
	private Class114 method4623(@OriginalArg(1) int arg0, @OriginalArg(2) Class19 arg1, @OriginalArg(3) int arg2) {
		@Pc(8) Class227 local8 = Static23.aClass128_1.method1831(arg0);
		...
		return this.aClass152_8 == null || this.aClass152_8.method6536() ? local8.method3706((byte) 2, true, super.anInt10694, (Class152) null, local36, super.anInt10690, local22, arg2, super.anInt10691, arg1) : local8.method3706((byte) 2, true, super.anInt10694, this.aClass152_8, local36, super.anInt10690, local22, arg2, super.anInt10691, arg1);
	}
	...
	public void finalize() {
		if (this.aClass8_Sub5_5 != null) {
			this.aClass8_Sub5_5.method2640();
		}
	}
	...
	public void d(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1) {
		if (arg1 != -5) {
			this.d((Class19) null, 72);
		}
		@Pc(20) Class114 local20 = this.method4623(this.anInt7402, arg0, 0);
		if (local20 != null) {
			@Pc(25) Class73 local25 = arg0.A();
			local25.a(super.anInt10690, super.anInt10691, super.anInt10694);
			this.method4622(local25, local20, arg0);
		}
	}
	...
	public boolean method4624() {
		return this.aClass152_8 != null && !this.aClass152_8.method6540();
	}
	...
	public void method4627() {
		if (this.aClass152_8 != null && !this.aClass152_8.method6536()) {
			this.aClass152_8.method6546(1);
		}
	}
	...
	public Class205 c(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1) {
		if (arg1 >= -93) {
			this.a(-78, 64, true, (Class19) null);
		}
		return null;
	}
	...
	public Class8_Sub7 a(@OriginalArg(1) Class19 arg0) {
		@Pc(24) Class114 local24 = this.method4623(this.anInt7402, arg0, (this.anInt7400 == 0 ? 0 : 5) | 0x800);
		if (local24 == null) {
			return null;
		}
		if (this.anInt7400 != 0) {
		...
		@Pc(43) Class73 local43 = arg0.A();
		local43.a(super.anInt10690, super.anInt10691, super.anInt10694);
		this.method4622(local43, local24, arg0);
		@Pc(62) Class8_Sub7 local62 = Static642.method5995(false, 1);
		if (Static504.aBoolean579) {
			local24.a(local43, local62.aClass8_Sub6Array1[0], Static582.anInt8627, 0);
		} else {
			local24.a(local43, local62.aClass8_Sub6Array1[0], 0);
		}
		if (this.aClass8_Sub5_5 != null) {
			@Pc(102) Class230 local102 = this.aClass8_Sub5_5.method2641();
			if (Static504.aBoolean579) {
				arg0.a(local102, Static582.anInt8627);
			} else {
				arg0.a(local102);
			}
		}
	...
	public boolean method4632() {
		return this.aClass152_8 == null || this.aClass152_8.method6536();
	}
}
