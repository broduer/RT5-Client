...
public final class Class8_Sub2_Sub2_Sub1 extends Class8_Sub2_Sub2 implements Interface25 {
	...
	public Class8_Sub2_Sub2_Sub1(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class54 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean arg7, @OriginalArg(8) int arg8, @OriginalArg(9) boolean arg9) {
		...
		this.aBoolean181 = arg0.r() && arg1.aBoolean89 && !this.aBoolean183 && Static400.aClass2_Sub34_28.aClass57_Sub12_1.method3029() != 0;
		@Pc(68) int local68 = 2048;
		if (this.aBoolean180) {
			local68 |= 0x10000;
		}
		@Pc(83) Class272 local83 = this.method1186(local68, 20, arg0, this.aBoolean181);
		if (local83 != null) {
			this.aClass2_Sub2_Sub9_1 = local83.aClass2_Sub2_Sub9_5;
			this.aClass114_1 = local83.aClass114_7;
			if (this.aBoolean180) {
				this.aClass114_1 = this.aClass114_1.a((byte) 0, local68, false);
				return;
			}
		}
	}
	...
	public Class8_Sub7 a(@OriginalArg(1) Class19 arg0) {
		...
		@Pc(34) Class8_Sub7 local34 = Static642.method5995(this.aBoolean182, 1);
		if (Static504.aBoolean579) {
			this.aClass114_1.a(local20, local34.aClass8_Sub6Array1[0], Static582.anInt8627, 0);
		} else {
			this.aClass114_1.a(local20, local34.aClass8_Sub6Array1[0], 0);
		}
		return local34;
	}
	...
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) Class19 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class8_Sub2 arg6) {
		if (arg4 <= 101) {
			this.method1186(-126, -84, (Class19) null, false);
		}
		...
		if (this.aClass114_1 != null && local21.aClass114_1 != null) {
			this.aClass114_1.a(local21.aClass114_1, arg5, arg0, arg3, arg1);
			return;
		}
	}
	...
	public boolean a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Class19 arg3) {
		...
		@Pc(16) Class114 local16 = this.method1189(arg3, 131072);
		if (local16 == null) {
			return false;
		} else {
			@Pc(21) Class73 local21 = arg3.A();
			local21.a(super.anInt10690, super.anInt10691, super.anInt10694);
			return Static504.aBoolean579 ? local16.a(arg1, arg0, local21, false, 0, Static582.anInt8627) : local16.a(arg1, arg0, local21, false, 0);
		}
	}
	...
	public void method4824(@OriginalArg(0) Class19 arg0) {
		...
		if (this.aClass2_Sub2_Sub9_1 == null && this.aBoolean181) {
			@Pc(25) Class272 local25 = this.method1186(262144, 20, arg0, true);
		...
		if (local33 != null) {
			Static630.method5921(local33, super.aByte143, super.anInt10690, super.anInt10694, (boolean[]) null);
		}
	}

	@OriginalMember(owner = "client!cu", name = "a", descriptor = "(IILclient!ha;Z)Lclient!od;")
	private Class272 method1186(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class19 arg2, @OriginalArg(3) boolean arg3) {
		@Pc(13) Class54 local13 = Static354.aClass142_4.method2158(this.aShort20 & 0xFFFF, arg1 + 35);
		if (arg1 != 20) {
			this.aShort20 = -113;
		}
		...
		return local13.method809(this.aByte38, super.anInt10694, super.anInt10690, local29, arg3, super.anInt10691, 22, arg2, (Class150) null, arg0, local35);
	}
	...
	public Class205 c(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1) {
		if (this.aClass205_1 == null) {
			this.aClass205_1 = Static317.method3206(super.anInt10691, super.anInt10690, this.method1189(arg0, 0), super.anInt10694);
		}
		if (arg1 >= -93) {
	...
	public int method4818(@OriginalArg(0) int arg0) {
		if (arg0 != 23796) {
			this.a(90, false, (Class19) null, -97, (byte) -34, 87, (Class8_Sub2) null);
		}
		return this.aByte38;
	}
	...
	public void method4820(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1) {
		...
		if (this.aClass2_Sub2_Sub9_1 == null && this.aBoolean181) {
			@Pc(36) Class272 local36 = this.method1186(262144, 20, arg0, true);
		...
		if (local25 != null) {
			Static292.method3236(local25, super.aByte143, super.anInt10690, super.anInt10694, (boolean[]) null);
		}
	}
	...
	private Class114 method1189(@OriginalArg(1) Class19 arg0, @OriginalArg(2) int arg1) {
		if (this.aClass114_1 != null && arg0.b(this.aClass114_1.ua(), arg1) == 0) {
			return this.aClass114_1;
		} else {
			@Pc(26) Class272 local26 = this.method1186(arg1, 20, arg0, false);
