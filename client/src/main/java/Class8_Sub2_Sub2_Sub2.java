...
public final class Class8_Sub2_Sub2_Sub2 extends Class8_Sub2_Sub2 implements Interface25 {
	...
	public boolean a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Class19 arg3) {
		@Pc(12) Class114 local12 = this.aClass337_2.method5432(arg3, false, true, arg2, 131072);
		if (local12 == null) {
			return false;
		} else {
	...
	public void d(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1) {
		if (arg1 != -5) {
			this.method2584((Class150) null);
		}
		@Pc(21) Class114 local21 = this.aClass337_2.method5432(arg0, true, true, true, 262144);
		if (local21 == null) {
			return;
		}
		...
		this.aClass337_2.method5435(local33, local21, false, -9827, arg0, local28, local28, local33, local36);
	}

	@OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lclient!gp;I)V")
	public void method2584(@OriginalArg(0) Class150 arg0) {
		this.aClass337_2.method5433(arg0);
	}
	...
	public void method4820(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1) {
		this.aClass337_2.method5423(arg0);
		if (arg1 > -42) {
			this.h(-38);
		}
	}
	...
	public void method4824(@OriginalArg(0) Class19 arg0) {
		this.aClass337_2.method5422(arg0);
	}
	...
	public int k(@OriginalArg(0) int arg0) {
		if (arg0 != 2) {
			this.method4820((Class19) null, 33);
		}
		return this.aClass337_2.method5425();
	}
	...
	public boolean method4823(@OriginalArg(0) int arg0) {
		...
		return this.aClass337_2.method5429(arg0 + 19727);
	}
	...
	public Class8_Sub7 a(@OriginalArg(1) Class19 arg0) {
		@Pc(22) Class114 local22 = this.aClass337_2.method5432(arg0, false, true, true, 2048);
		if (local22 == null) {
			return null;
		}
		@Pc(30) Class73 local30 = arg0.A();
		local30.a(super.anInt10690, super.anInt10691, super.anInt10694);
		@Pc(44) Class8_Sub7 local44 = Static642.method5995(this.aBoolean318, 1);
		@Pc(49) int local49 = super.anInt10690 >> 9;
		@Pc(54) int local54 = super.anInt10694 >> 9;
		this.aClass337_2.method5435(local54, local22, true, -9827, arg0, local49, local49, local54, local30);
		if (Static504.aBoolean579) {
			local22.a(local30, local44.aClass8_Sub6Array1[0], Static582.anInt8627, 0);
		} else {
			local22.a(local30, local44.aClass8_Sub6Array1[0], 0);
		}
		if (this.aClass337_2.aClass8_Sub5_7 != null) {
			@Pc(100) Class230 local100 = this.aClass337_2.aClass8_Sub5_7.method2641();
			if (Static504.aBoolean579) {
		...
		if (this.aClass205_3 == null) {
			this.aClass205_3 = Static317.method3206(super.anInt10691, super.anInt10690, local22, super.anInt10694);
		} else {
			Static223.method6537(local22, super.anInt10694, super.anInt10691, super.anInt10690, this.aClass205_3);
		}
		return local44;
	}
	...
	public int c(@OriginalArg(0) byte arg0) {
		...
		return this.aClass337_2.method5427(true);
	}
