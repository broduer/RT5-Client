...
public final class Class8_Sub2_Sub2_Sub2 extends Class8_Sub2_Sub2 implements Interface25 {
	...
	public Class8_Sub2_Sub2_Sub2(@OriginalArg(0) Class19 arg0, @OriginalArg(1) LocType arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
		super(arg4, arg5, arg6, arg2, arg3, arg1.anInt1232);
		this.aClass339_2 = new Class339(arg0, arg1, 22, arg8, arg2, arg3, this, arg7, arg9);
		this.aBoolean318 = arg1.anInt1276 != 0 && !arg7;
	}
	...
	public boolean method9286(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Class19 arg3) {
		@Pc(12) Class114 local12 = this.aClass339_2.method7685(arg3, false, true, arg2, 131072);
		if (local12 == null) {
			return false;
		} else {
	...
	public void method9296(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1) {
		...
		this.aClass339_2.method7688(local33, local21, false, -9827, arg0, local28, local28, local33, local36);
	}

	@OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lclient!gp;I)V")
	public void method3581(@OriginalArg(0) Class150 arg0) {
		this.aClass339_2.method7686(arg0);
	}
	...
	public void method6864(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1) {
		this.aClass339_2.method7676(arg0);
		if (arg1 > -42) {
			this.method9289(-38);
		}
	}
	...
	public void method6868(@OriginalArg(0) Class19 arg0) {
		this.aClass339_2.method7675(arg0);
	}
	...
	public int method6866(@OriginalArg(0) int arg0) {
		...
		return this.aClass339_2.anInt8673;
	}
	...
	public boolean method6867(@OriginalArg(0) int arg0) {
		...
		return this.aClass339_2.method7682(arg0 + 19727);
	}
	...
	public Class8_Sub7 method9283(@OriginalArg(1) Class19 arg0) {
		@Pc(22) Class114 local22 = this.aClass339_2.method7685(arg0, false, true, true, 2048);
		if (local22 == null) {
			return null;
		}
		@Pc(30) Class73 local30 = arg0.method7992();
		local30.method7132(super.anInt10718, super.anInt10719, super.anInt10722);
		@Pc(44) Class8_Sub7 local44 = Static642.method8448(this.aBoolean318, 1);
		@Pc(49) int local49 = super.anInt10718 >> 9;
		@Pc(54) int local54 = super.anInt10722 >> 9;
		this.aClass339_2.method7688(local54, local22, true, -9827, arg0, local49, local49, local54, local30);
		if (Static504.aBoolean579) {
			local22.method7491(local30, local44.aClass8_Sub6Array1[0], Static582.anInt8651, 0);
		} else {
			local22.method7480(local30, local44.aClass8_Sub6Array1[0], 0);
		}
		if (this.aClass339_2.aClass8_Sub5_7 != null) {
			@Pc(100) Class232 local100 = this.aClass339_2.aClass8_Sub5_7.method3645();
			if (Static504.aBoolean579) {
		...
		this.aBoolean317 = local22.F() || this.aClass339_2.aClass8_Sub5_7 != null;
		if (this.aClass207_3 == null) {
			this.aClass207_3 = Static317.method4590(super.anInt10719, super.anInt10718, local22, super.anInt10722);
		} else {
			Static223.method9110(local22, super.anInt10722, super.anInt10719, super.anInt10718, this.aClass207_3);
		}
		return local44;
	}
	...
	public int method6865() {
		return this.aClass339_2.anInt8669;
	}
