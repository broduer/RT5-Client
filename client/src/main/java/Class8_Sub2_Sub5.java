...
public abstract class Class8_Sub2_Sub5 extends Class8_Sub2 {
	...
	@Override
	public final boolean a(@OriginalArg(0) byte arg0, @OriginalArg(1) Class19 arg1) {
		@Pc(15) Class286 local15 = Static467.method4440(super.aByte144, super.anInt10690 >> Static52.anInt1066, super.anInt10694 >> Static52.anInt1066);
		if (arg0 == 59) {
			return local15 != null && local15.aClass8_Sub2_Sub1_1.aBoolean815 ? Static282.method2778(local15.aClass8_Sub2_Sub1_1.k(2) + this.k(2), super.aByte144, super.anInt10690 >> Static52.anInt1066, super.anInt10694 >> Static52.anInt1066) : Static588.method5468(super.anInt10694 >> Static52.anInt1066, super.aByte144, super.anInt10690 >> Static52.anInt1066);
		} else {
			return true;
		}
	}
	...
	@Override
	public final void a(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) Class19 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class8_Sub2 arg6) {
		if (arg4 >= 101) {
	...
	@Override
	public final int a(@OriginalArg(0) Class2_Sub7[] arg0) {
		return this.a(arg0, super.anInt10694 >> Static52.anInt1066, super.anInt10690 >> Static52.anInt1066);
	}
	...
	@Override
	public final boolean i(@OriginalArg(0) int arg0) {
		if (arg0 != 0) {
			this.a((byte) -87, (Class19) null);
		}
		return false;
	}
}
