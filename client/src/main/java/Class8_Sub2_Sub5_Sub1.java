...
public final class Class8_Sub2_Sub5_Sub1 extends Class8_Sub2_Sub5 {
	...
	@Override
	public int d() {
		@Pc(9) Class382 local9 = Static419.aClass112_1.method1684(this.anInt8867);
		@Pc(12) int local12 = local9.anInt10138;
		if (this.anInt8878 != -1) {
			@Pc(22) Class382 local22 = Static419.aClass112_1.method1684(this.anInt8878);
			if (local22.anInt10138 > local12) {
				local12 = local22.anInt10138;
			}
		}
		if (this.anInt8876 != -1) {
			@Pc(48) Class382 local48 = Static419.aClass112_1.method1684(this.anInt8876);
	...
	public boolean a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Class19 arg3) {
		if (arg2) {
			this.c((Class19) null, 104);
		}
		@Pc(16) Class73 local16 = arg3.A();
		local16.a(super.anInt10690, super.anInt10691 - 10, super.anInt10694);
		@Pc(32) Class382 local32 = Static419.aClass112_1.method1684(this.anInt8867);
		@Pc(42) Class114 local42 = local32.method6292((Class152) null, 131072, (Class201) null, this.anInt8873, arg3);
		if (local42 != null && (Static504.aBoolean579 ? local42.a(arg1, arg0, local16, true, local32.anInt10138, Static582.anInt8627) : local42.a(arg1, arg0, local16, true, local32.anInt10138))) {
			return true;
		}
		@Pc(82) Class382 local82;
		if (this.anInt8878 != -1) {
			local82 = Static419.aClass112_1.method1684(this.anInt8878);
			local42 = local82.method6292((Class152) null, 131072, (Class201) null, this.anInt8874, arg3);
			if (local42 != null && (Static504.aBoolean579 ? local42.a(arg1, arg0, local16, true, local82.anInt10138, Static582.anInt8627) : local42.a(arg1, arg0, local16, true, local82.anInt10138))) {
				return true;
			}
		}
		if (this.anInt8876 != -1) {
			local82 = Static419.aClass112_1.method1684(this.anInt8876);
			local42 = local82.method6292((Class152) null, 131072, (Class201) null, this.anInt8872, arg3);
			if (local42 != null && (Static504.aBoolean579 ? local42.a(arg1, arg0, local16, true, local82.anInt10138, Static582.anInt8627) : local42.a(arg1, arg0, local16, true, local82.anInt10138))) {
				return true;
			}
		}
	...
	public Class8_Sub7 a(@OriginalArg(1) Class19 arg0) {
		@Pc(17) Class286 local17 = Static467.method4440(super.aByte144, super.anInt10690 >> Static52.anInt1066, super.anInt10694 >> Static52.anInt1066);
		@Pc(29) Class8_Sub2_Sub2 local29 = Static687.method6405(super.aByte144, super.anInt10690 >> Static52.anInt1066, super.anInt10694 >> Static52.anInt1066);
		@Pc(31) int local31 = 0;
		if (local17 != null && local17.aClass8_Sub2_Sub1_1.aBoolean815) {
			local31 = local17.aClass8_Sub2_Sub1_1.k(2);
		}
		...
		if (this.anInt8885 == 0) {
			...
			@Pc(139) int local139 = local110.a(super.anInt10694 + local127, -122, (int) (local122 + super.anInt10690));
			@Pc(143) int local143 = local115 / 2;
			@Pc(148) int local148 = -local115 / 2;
			@Pc(161) int local161 = local110.a(super.anInt10694 + local148, -125, (int) (local143 + super.anInt10690));
			@Pc(166) int local166 = -local115 / 2;
			@Pc(170) int local170 = local115 / 2;
			@Pc(182) int local182 = local110.a(local170 + super.anInt10694, -117, (int) (super.anInt10690 + local166));
			@Pc(186) int local186 = local115 / 2;
			@Pc(190) int local190 = local115 / 2;
			@Pc(203) int local203 = local110.a(super.anInt10694 + local190, -123, (int) (local186 + super.anInt10690));
			...
			if (local297 != 0) {
				local94.b(0, local297, 0);
			}
		}
		local94.b(super.anInt10690, super.anInt10691 - 10, super.anInt10694);
		@Pc(345) Class8_Sub7 local345 = Static642.method5995(true, 3);
		this.anInt8879 = 0;
		this.aBoolean672 = false;
		@Pc(369) Class114 local369;
		if (this.anInt8876 != -1) {
			local369 = Static419.aClass112_1.method1684(this.anInt8876).method6292((Class152) null, 2048, (Class201) null, this.anInt8872, arg0);
			if (local369 != null) {
				if (Static504.aBoolean579) {
					local369.a(local94, local345.aClass8_Sub6Array1[2], Static582.anInt8627, 0);
				} else {
					local369.a(local94, local345.aClass8_Sub6Array1[2], 0);
				}
		...
		if (this.anInt8878 != -1) {
			local369 = Static419.aClass112_1.method1684(this.anInt8878).method6292((Class152) null, 2048, (Class201) null, this.anInt8874, arg0);
			if (local369 != null) {
				if (Static504.aBoolean579) {
					local369.a(local94, local345.aClass8_Sub6Array1[1], Static582.anInt8627, 0);
				} else {
					local369.a(local94, local345.aClass8_Sub6Array1[1], 0);
				}
				this.aBoolean672 |= local369.F();
		...
		local369 = Static419.aClass112_1.method1684(this.anInt8867).method6292((Class152) null, 2048, (Class201) null, this.anInt8873, arg0);
		if (local369 != null) {
			if (Static504.aBoolean579) {
				local369.a(local94, local345.aClass8_Sub6Array1[0], Static582.anInt8627, 0);
			} else {
				local369.a(local94, local345.aClass8_Sub6Array1[0], 0);
			}
			this.aBoolean672 |= local369.F();
			if (local369.ma() > this.anInt8879) {
				this.anInt8879 = local369.ma();
