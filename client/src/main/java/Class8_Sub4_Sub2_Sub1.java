...
public final class Class8_Sub4_Sub2_Sub1 extends Class8_Sub4_Sub2 {
	...
	private void method4706() {
		...
		if (this.aClass8_Sub8_1.aClass8_Sub5_6.aClass8_Sub4_Sub2_Sub1Array1[local4] != null) {
			this.aClass8_Sub8_1.aClass8_Sub5_6.aClass8_Sub4_Sub2_Sub1Array1[local4].method4710();
		}
		...
		this.aClass8_Sub8_1.aClass130_11.method1902(this);
	}

	@OriginalMember(owner = "client!pp", name = "a", descriptor = "(JI)V")
	public void method4707(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1) {
		...
		if (local35.anIntArray776 != null) {
			for (local317 = 0; local317 < local35.anIntArray776.length; local317++) {
				@Pc(776) Class2_Sub2_Sub5 local776 = (Class2_Sub2_Sub5) Static519.aClass144_1.method2185((long) local35.anIntArray776[local317]);
				while (local776 != null) {
					...
					if (local810 > (double) local780.aLong221) {
						local776 = (Class2_Sub2_Sub5) Static519.aClass144_1.method2186();
					} else {
		...
		if (local35.anIntArray777 != null) {
			if (local35.anIntArray774 == null) {
				...
				for (local317 = 0; local317 < local35.anIntArray777.length; local317++) {
					Static66.method936(local35.anIntArray777[local317]);
					local35.anIntArray774[local317] = ((Class2_Sub38) Static503.aClass28_38.method373((long) local35.anIntArray777[local317])).anInt6379;
				}
			}
	...
	public void method4708(@OriginalArg(0) Class19 arg0, @OriginalArg(1) long arg1) {
		...
		@Pc(71) int local71 = local46[local49].a(local13, local6, (byte) -118);
		@Pc(86) int local86;
		if (local49 < Static299.anInt4824 - 1) {
			local86 = local46[local49 + 1].a(local13, local6, (byte) -118);
		} else {
		...
		if (local44.aBoolean764) {
			...
			if (local44.anInt9917 >= 0 && local18 > local46[local44.anInt9917].a(local13, local6, (byte) -118)) {
				this.method4710();
				return;
			}
			...
			if (local44.anInt9892 >= 0 && local18 < local46[local44.anInt9892 + 1].a(local13, local6, (byte) -118)) {
				this.method4710();
				return;
			}
		}
		@Pc(154) int local154;
		for (local154 = Static299.anInt4824 - 1; local154 > 0 && local18 > local46[local154].a(local13, local6, (byte) -118); local154--) {
		}
		if (local44.aBoolean756 && local154 == 0 && local18 > local46[0].a(local13, local6, (byte) -118)) {
			this.method4710();
		} else if (local154 == Static299.anInt4824 - 1 && local46[local154].a(local13, local6, (byte) -118) - local18 > 0x8 << Static52.anInt1066) {
			this.method4710();
		} else {
			...
			if (local44.aBoolean757) {
				...
				if (local58.aClass8_Sub2_Sub3_2 != null) {
					local318 = local58.aClass8_Sub2_Sub3_2.c(arg0, -105);
					if (local318 != null && local318.method3249(local18, local261, local304)) {
						this.method4710();
						return;
					}
				}
				if (local58.aClass8_Sub2_Sub3_1 != null) {
					local318 = local58.aClass8_Sub2_Sub3_1.c(arg0, -120);
					if (local318 != null && local318.method3249(local18, local261, local304)) {
						this.method4710();
						return;
					}
				...
				if (local58.aClass8_Sub2_Sub2_1 != null) {
					local318 = local58.aClass8_Sub2_Sub2_1.c(arg0, -109);
					if (local318 != null && local318.method3249(local18, local261, local304)) {
						this.method4710();
						return;
					}
				...
				for (@Pc(375) Class286 local375 = local58.aClass286_2; local375 != null; local375 = local375.aClass286_1) {
					@Pc(382) Class205 local382 = local375.aClass8_Sub2_Sub1_1.c(arg0, -117);
					if (local382 != null && local382.method3249(local18, local261, local304)) {
						this.method4710();
						return;
					}
				}
			}
			local40.aClass230_1.aClass113_1.method1686(this);
		}
	}

	@OriginalMember(owner = "client!pp", name = "a", descriptor = "(Lclient!rf;IIIIIIIIIIIZZ)V")
	public void method4709(@OriginalArg(0) Class8_Sub8 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) boolean arg12, @OriginalArg(13) boolean arg13) {
		this.aClass8_Sub8_1 = arg0;
		super.anInt7537 = arg1 << 12;
		super.anInt7534 = arg2 << 12;
		super.anInt7536 = arg3 << 12;
