...
public final class Class8_Sub5 extends Class8 {
	...
	public Class8_Sub5(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
		this.method2653(arg0, arg1);
	}

	@OriginalMember(owner = "client!hv", name = "a", descriptor = "(Lclient!ha;J[Lclient!rv;[Lclient!mn;Z)V")
	public void method2639(@OriginalArg(0) Class19 arg0, @OriginalArg(1) long arg1, @OriginalArg(2) Class328[] arg2, @OriginalArg(3) Class249[] arg3) {
		if (!this.aBoolean324) {
			this.method2647(arg0, arg2);
			this.method2644(arg3);
			this.aLong133 = arg1;
		}
	}
	...
	public Class230 method2641() {
		return this.aClass230_1;
	}

	@OriginalMember(owner = "client!hv", name = "a", descriptor = "(Lclient!ha;)V")
	public void method2642(@OriginalArg(0) Class19 arg0) {
		this.aClass230_1.aClass113_1.method1685();
		for (@Pc(10) Class8_Sub8 local10 = (Class8_Sub8) this.aClass130_6.method1905(); local10 != null; local10 = (Class8_Sub8) this.aClass130_6.method1900()) {
			local10.method5092(this.aLong132, arg0);
		}
	}

	@OriginalMember(owner = "client!hv", name = "a", descriptor = "([Lclient!mn;Z)V")
	private void method2644(@OriginalArg(0) Class249[] arg0) {
		for (@Pc(1) int local1 = 0; local1 < 8; local1++) {
			Static257.aBooleanArray6[local1] = false;
		}
		@Pc(21) int local21;
		label71: for (@Pc(16) Class2_Sub2_Sub5 local16 = (Class2_Sub2_Sub5) this.aClass339_22.method5453(65280); local16 != null; local16 = (Class2_Sub2_Sub5) this.aClass339_22.method5460()) {
			if (arg0 != null) {
		...
		for (local21 = 0; local21 < arg0.length && local21 != 8 && this.anInt4150 != 8; local21++) {
			if (!Static257.aBooleanArray6[local21]) {
				...
				if (arg0[local21].method3972().anInt6982 == 1 && Static654.anInt9740 < 32) {
					local96 = new Class2_Sub2_Sub5(arg0[local21], this);
					Static519.aClass144_1.method2184(local96, (long) arg0[local21].anInt6248);
					Static654.anInt9740++;
				}
				if (local96 == null) {
					local96 = new Class2_Sub2_Sub5(arg0[local21], this);
				}
				this.aClass339_22.method5465(local96);
				this.anInt4150++;
				Static257.aBooleanArray6[local21] = true;
			}
		}
	...
	public void method2645(@OriginalArg(0) long arg0) {
		this.aLong133 = arg0;
	}

	@OriginalMember(owner = "client!hv", name = "b", descriptor = "()Lclient!lk;")
	public Class230 method2646() {
		this.aClass230_1.aClass113_1.method1685();
		for (@Pc(6) int local6 = 0; local6 < this.aClass8_Sub4_Sub2_Sub1Array1.length; local6++) {
			if (this.aClass8_Sub4_Sub2_Sub1Array1[local6] != null && this.aClass8_Sub4_Sub2_Sub1Array1[local6].aClass8_Sub8_1 != null) {
				this.aClass230_1.aClass113_1.method1686(this.aClass8_Sub4_Sub2_Sub1Array1[local6]);
			}
		}
		return this.aClass230_1;
	}
	...
	private void method2647(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class328[] arg1) {
		for (@Pc(1) int local1 = 0; local1 < 32; local1++) {
			Static257.aBooleanArray7[local1] = false;
		}
		@Pc(21) int local21;
		label62: for (@Pc(16) Class8_Sub8 local16 = (Class8_Sub8) this.aClass130_6.method1905(); local16 != null; local16 = (Class8_Sub8) this.aClass130_6.method1900()) {
			if (arg1 != null) {
		...
		for (local21 = 0; local21 < arg1.length && local21 != 32 && this.anInt4148 != 32; local21++) {
			if (!Static257.aBooleanArray7[local21]) {
				...
				this.aClass130_6.method1902(local104);
				this.anInt4148++;
				Static257.aBooleanArray7[local21] = true;
			}
		}
	...
	public void method2648() {
		...
		for (@Pc(8) Class2_Sub2_Sub5 local8 = (Class2_Sub2_Sub5) this.aClass339_22.method5453(65280); local8 != null; local8 = (Class2_Sub2_Sub5) this.aClass339_22.method5460()) {
		...
		for (@Pc(27) int local27 = 0; local27 < this.aClass8_Sub4_Sub2_Sub1Array1.length; local27++) {
			if (this.aClass8_Sub4_Sub2_Sub1Array1[local27] != null) {
				this.aClass8_Sub4_Sub2_Sub1Array1[local27].method4710();
	...
	public boolean method2649(@OriginalArg(0) Class19 arg0, @OriginalArg(1) long arg1) {
		...
		if (this.aBoolean326) {
			for (local36 = (Class8_Sub8) this.aClass130_6.method1905(); local36 != null; local36 = (Class8_Sub8) this.aClass130_6.method1900()) {
				for (@Pc(39) int local39 = 0; local39 < local36.aClass379_1.anInt9882; local39++) {
					local36.method5090(1, !this.aBoolean323, arg1, arg0);
				}
			}
			this.aBoolean326 = false;
		}
		for (local36 = (Class8_Sub8) this.aClass130_6.method1905(); local36 != null; local36 = (Class8_Sub8) this.aClass130_6.method1900()) {
			local36.method5090(local27, !this.aBoolean323, arg1, arg0);
		}
		this.aLong132 = arg1;
		return true;
	}
	...
	public void method2653(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
		Static342.aClass130_7.method1902(this);
	...
	public void method2654(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		this.anInt4149 = arg0;
	}
}
