...
public final class Class8_Sub7 extends Class8 {
	...
	public boolean method6503(@OriginalArg(0) Class19 arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		@Pc(10) int local10 = this.aClass8_Sub2_18.method9294();
		if (this.aClass8_Sub6Array1 != null) {
			for (@Pc(15) int local15 = 0; local15 < this.aClass8_Sub6Array1.length; local15++) {
				this.aClass8_Sub6Array1[local15].anInt4516 <<= local10;
				if (this.aClass8_Sub6Array1[local15].method4048(arg2, arg1) && this.aClass8_Sub2_18.method9286(arg1, arg2, false, arg0)) {
					this.aClass8_Sub6Array1[local15].anInt4516 >>= local10;
					return true;
				}
				this.aClass8_Sub6Array1[local15].anInt4516 >>= local10;
