...
public final class Class8_Sub7 extends Class8 {
	...
	public boolean method4558(@OriginalArg(0) Class19 arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		@Pc(10) int local10 = this.aClass8_Sub2_18.d();
		if (this.aClass8_Sub6Array1 != null) {
			for (@Pc(15) int local15 = 0; local15 < this.aClass8_Sub6Array1.length; local15++) {
				...
				if (this.aClass8_Sub6Array1[local15].method2808(arg2, arg1) && this.aClass8_Sub2_18.a(arg1, arg2, false, arg0)) {
					this.aClass8_Sub6Array1[local15].anInt4502 >>= local10;
					return true;
				}
				this.aClass8_Sub6Array1[local15].anInt4502 >>= local10;
