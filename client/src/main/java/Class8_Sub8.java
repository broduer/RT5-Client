...
public final class Class8_Sub8 extends Class8 {
	...
	public Class8_Sub8(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class328 arg1, @OriginalArg(2) Class8_Sub5 arg2, @OriginalArg(3) long arg3) {
		...
		this.aClass379_1 = this.aClass328_1.method5316();
		if (!arg0.x() && this.aClass379_1.anInt9880 != -1) {
			this.aClass379_1 = Static444.method4230(this.aClass379_1.anInt9880);
		}
	...
	public void method5090(@OriginalArg(0) int arg0, @OriginalArg(2) boolean arg1, @OriginalArg(3) long arg2, @OriginalArg(4) Class19 arg3) {
		@Pc(46) int local46;
		if (this.aBoolean630) {
			arg1 = false;
		...
		if (arg1) {
			...
			if (this.anInt8264 > 63) {
				...
				for (local244 = 0; local244 < local210; local244++) {
					...
					if (!arg3.x() && !this.aClass379_1.aBoolean755) {
						local990 = -1;
					}
					if (Static600.anInt8880 == Static559.anInt8410) {
						...
						local1032.method4709(this, local794, local803, local812, local218, local226, local235, local828, local845, local926, local862, local990, this.aClass379_1.aBoolean760, this.aClass379_1.aBoolean758);
					}
				}
			}
		}
		if (!this.aClass177_1.method2718(this.aClass177_2)) {
		...
		this.anInt8268 = 0;
		for (@Pc(1171) Class8_Sub4_Sub2_Sub1 local1171 = (Class8_Sub4_Sub2_Sub1) this.aClass130_11.method1905(); local1171 != null; local1171 = (Class8_Sub4_Sub2_Sub1) this.aClass130_11.method1900()) {
			local1171.method4707(arg2, arg0);
			this.anInt8268++;
		}
	...
	public void method5092(@OriginalArg(0) long arg0, @OriginalArg(1) Class19 arg1) {
		for (@Pc(11) Class8_Sub4_Sub2_Sub1 local11 = (Class8_Sub4_Sub2_Sub1) this.aClass130_11.method1905(); local11 != null; local11 = (Class8_Sub4_Sub2_Sub1) this.aClass130_11.method1900()) {
			local11.method4708(arg1, arg0);
		}
	}
