...
public final class Class9 {
	...
	public boolean method73(@OriginalArg(0) int arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2) {
		@Pc(6) Class243 local6 = this.aClass243_2;
		synchronized (this.aClass243_2) {
			if (arg0 < 0 || arg0 > this.anInt114) {
				throw new IllegalArgumentException();
			}
			@Pc(30) boolean local30 = this.method76(arg1, arg2, arg0, true);
			if (!local30) {
				local30 = this.method76(arg1, arg2, arg0, false);
			}
			return local30;
		}
	}
	...
	public byte[] method74(@OriginalArg(0) int arg0) {
		@Pc(6) Class243 local6 = this.aClass243_2;
		synchronized (this.aClass243_2) {
			try {
				if (this.aClass243_3.method3946() < (long) (arg0 * 6 + 6)) {
					return null;
				}
				this.aClass243_3.method3950((long) (arg0 * 6));
				this.aClass243_3.method3941(6, Static294.aByteArray49, 0);
				...
				if (local67 < 0 || local67 > this.anInt114) {
					return null;
				} else if (local89 > 0 && this.aClass243_2.method3946() / 520L >= (long) local89) {
					...
					while (local67 > local131) {
						...
						this.aClass243_2.method3950((long) (local89 * 520));
						@Pc(161) int local161 = local67 - local131;
						if (local161 > 512) {
							local161 = 512;
						}
						this.aClass243_2.method3941(local161 + 8, Static294.aByteArray49, 0);
						...
						if (arg0 == local191 && local140 == local205 && local233 == this.anInt118) {
							if (local227 >= 0 && (long) local227 <= this.aClass243_2.method3946() / 520L) {
								local140++;
	...
	private boolean method76(@OriginalArg(0) byte[] arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) boolean arg3) {
		@Pc(8) Class243 local8 = this.aClass243_2;
		synchronized (this.aClass243_2) {
			try {
				@Pc(84) int local84;
				if (arg3) {
					if (this.aClass243_3.method3946() < (long) (arg1 * 6 + 6)) {
						return false;
					}
					this.aClass243_3.method3950((long) (arg1 * 6));
					this.aClass243_3.method3941(6, Static294.aByteArray49, 0);
					local84 = (Static294.aByteArray49[5] & 0xFF) + (((Static294.aByteArray49[3] & 0xFF) << 16) + ((Static294.aByteArray49[4] & 0xFF) << 8));
					if (local84 <= 0 || this.aClass243_2.method3946() / 520L < (long) local84) {
						return false;
					}
				} else {
					local84 = (int) ((this.aClass243_2.method3946() + 519L) / 520L);
					if (local84 == 0) {
						local84 = 1;
					}
				}
				...
				this.aClass243_3.method3950((long) (arg1 * 6));
				this.aClass243_3.method3943(0, 6, Static294.aByteArray49);
				...
				while (true) {
					if (local173 < arg2) {
						label102: {
							...
							@Pc(217) int local217;
							if (arg3) {
								this.aClass243_2.method3950((long) (local84 * 520));
								try {
									this.aClass243_2.method3941(8, Static294.aByteArray49, 0);
								...
								if (local181 < 0 || this.aClass243_2.method3946() / 520L < (long) local181) {
									return false;
								}
							}
							if (local181 == 0) {
								arg3 = false;
								local181 = (int) ((this.aClass243_2.method3946() + 519L) / 520L);
								if (local181 == 0) {
									local181++;
								}
								if (local181 == local84) {
							...
							this.aClass243_2.method3950((long) (local84 * 520));
							this.aClass243_2.method3943(0, 8, Static294.aByteArray49);
							local217 = arg2 - local173;
							if (local217 > 512) {
								local217 = 512;
							}
							this.aClass243_2.method3943(local173, local217, arg0);
							local84 = local181;
							local173 += local217;
							local175++;
							continue;
