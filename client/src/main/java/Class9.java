...
public final class Class9 {
	...
	private Class245 aClass245_2 = null;

	@OriginalMember(owner = "client!af", name = "i", descriptor = "Lclient!mj;")
	private Class245 aClass245_3 = null;
	...
	public Class9(@OriginalArg(0) int arg0, @OriginalArg(1) Class245 arg1, @OriginalArg(2) Class245 arg2, @OriginalArg(3) int arg3) {
		this.aClass245_3 = arg2;
		this.anInt118 = arg0;
		this.anInt114 = arg3;
		this.aClass245_2 = arg1;
	}
		...
		synchronized (this.aClass245_2) {
			try {
				...
				if (local67 < 0 || local67 > this.anInt114) {
					return null;
				} else if (local89 > 0 && this.aClass245_2.method5571() / 520L >= (long) local89) {
					...
					while (local67 > local131) {
						...
						this.aClass245_2.method5566(local161 + 8, Static294.aByteArray49, 0);
						...
						if (arg0 == local191 && local140 == local205 && local233 == this.anInt118) {
							if (local227 >= 0 && (long) local227 <= this.aClass245_2.method5571() / 520L) {
								local140++;
		...
		synchronized (this.aClass245_2) {
			try {
				...
				if (arg3) {
					...
					local84 = (int) ((this.aClass245_2.method5571() + 519L) / 520L);
					if (local84 == 0) {
						local84 = 1;
					}
				}
					...
					if (local173 < arg2) {
						label102: {
							...
							if (arg3) {
								...
								if (local181 < 0 || this.aClass245_2.method5571() / 520L < (long) local181) {
									return false;
								}
							}
							if (local181 == 0) {
								arg3 = false;
								local181 = (int) ((this.aClass245_2.method5571() + 519L) / 520L);
								if (local181 == 0) {
									local181++;
								}
								if (local181 == local84) {
							...
							this.aClass245_2.method5568(local173, local217, arg0);
							local84 = local181;
							local173 += local217;
							local175++;
							continue;
