...
public final class Class90_Sub2_Sub1 extends Class90_Sub2 {
	...
	static {
		for (@Pc(58) int local58 = 0; local58 < 256; local58++) {
			...
			aLongArrayArray1[0][local58] = Static713.method9341(Static713.method9341(local88 << 8, Static713.method9341(Static713.method9341(Static713.method9341(local84 << 32, Static713.method9341(Static713.method9341(local84 << 48, local84 << 56), local100 << 40)), local118 << 24), local114 << 16)), local130);
			for (@Pc(166) int local166 = 1; local166 < 8; local166++) {
				aLongArrayArray1[local166][local58] = Static713.method9341(aLongArrayArray1[local166 - 1][local58] >>> 8, aLongArrayArray1[local166 - 1][local58] << 56);
			}
		}
		aLongArray19[0] = 0L;
	...
	protected void method7763(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		@Pc(14) int local14 = super.aClass23_40.method8210();
		@Pc(26) int local26 = ((Class138_Sub1_Sub1) super.aClass138_5).anInt3201 * Static556.method7309() / 10 % local14;
		super.aClass23_40.method8205(arg1 + local26 - local14, arg0, arg2 + local14 - local26, arg3);
	}
}
