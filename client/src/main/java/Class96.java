...
public final class Class96 {
	...
	public Class96(@OriginalArg(0) Class377 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class330 arg2) {
		...
		this.anInt2506 = this.aClass330_23.method5372(4);
	}
	...
	public void method1549() {
		...
		synchronized (this.aClass82_55) {
			this.aClass82_55.method1385();
		}
	}

	@OriginalMember(owner = "client!ef", name = "a", descriptor = "(IB)Lclient!re;")
	public Class318 method1550(@OriginalArg(0) int arg0) {
		@Pc(15) Class82 local15 = this.aClass82_55;
		@Pc(25) Class318 local25;
		synchronized (this.aClass82_55) {
			local25 = (Class318) this.aClass82_55.method1390((long) arg0);
		}
		if (local25 != null) {
			return local25;
		}
		...
		synchronized (this.aClass330_23) {
			local48 = this.aClass330_23.method5359(arg0, 4);
		}
		local25 = new Class318();
		local25.aClass96_5 = this;
		local25.anInt8253 = arg0;
		if (local48 != null) {
			local25.method5087(new Class2_Sub21(local48));
		}
		local25.method5085();
		@Pc(81) Class82 local81 = this.aClass82_55;
		synchronized (this.aClass82_55) {
			this.aClass82_55.method1384(local25, (long) arg0);
			return local25;
		}
	}
