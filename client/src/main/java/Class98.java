...
public final class Class98 {
	...
	public Class98(@OriginalArg(0) Class19_Sub3 arg0) {
		...
		if (!this.aClass101Array1[8].method6810()) {
			this.aClass101Array1[8] = this.aClass101Array1[4];
		}
		if (!this.aClass101Array1[9].method6810()) {
	...
	public boolean method1555() {
		return this.aClass101Array1[3].method6810();
	}

	@OriginalMember(owner = "client!eg", name = "a", descriptor = "(BILclient!kd;)Z")
	public boolean method1557(@OriginalArg(1) int arg0, @OriginalArg(2) Class93 arg1) {
		if (this.anInt2519 == 0) {
			return false;
		} else {
			this.aClass101Array1[Integer.MAX_VALUE & this.anInt2519].method6805(arg1, arg0);
			return true;
		}
	}

	@OriginalMember(owner = "client!eg", name = "a", descriptor = "(IIZZII)V")
	public void method1558(@OriginalArg(1) int arg0, @OriginalArg(2) boolean arg1, @OriginalArg(3) boolean arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		@Pc(9) boolean local9 = arg1 & this.aClass19_Sub3_5.z();
		...
		if (arg4 != this.anInt2519) {
			if (this.anInt2519 != 0) {
				this.aClass101Array1[this.anInt2519 & Integer.MAX_VALUE].method6806();
			}
			if (arg4 != 0) {
				this.aClass101Array1[Integer.MAX_VALUE & arg4].method6811(arg2);
				this.aClass101Array1[arg4 & Integer.MAX_VALUE].method6808(arg2);
				this.aClass101Array1[arg4 & Integer.MAX_VALUE].method6807(arg0, arg3);
			}
			this.anInt2520 = arg0;
			this.anInt2522 = arg3;
			this.anInt2519 = arg4;
		} else if (this.anInt2519 != 0) {
			this.aClass101Array1[this.anInt2519 & Integer.MAX_VALUE].method6808(arg2);
			if (this.anInt2522 != arg3 || this.anInt2520 != arg0) {
				this.aClass101Array1[this.anInt2519 & Integer.MAX_VALUE].method6807(arg0, arg3);
				this.anInt2520 = arg0;
				this.anInt2522 = arg3;
			}
			return;
