...
public final class CursorType {
	...
	public CursorTypeList aClass269_2;
	...
	private void method8940(@OriginalArg(0) Buffer arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 1) {
	...
	public synchronized Class409 method8941() {
		@Pc(13) Class409 local13 = (Class409) this.aClass269_2.aClass82_143.get(this.anInt10333);
		if (local13 != null) {
			return local13;
		}
		local13 = Static735.method9389(this.aClass269_2.aClass332_88, this.anInt10333, 0);
		if (local13 != null) {
			this.aClass269_2.aClass82_143.put(local13, this.anInt10333);
		}
		return local13;
	}

	@OriginalMember(owner = "client!vla", name = "a", descriptor = "(Lclient!ge;I)V")
	public void method8942(@OriginalArg(0) Buffer arg0) {
		while (true) {
