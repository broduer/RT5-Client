...
public final class FloType {
	...
	public void method7263(@OriginalArg(1) Buffer arg0) {
		while (true) {
	...
	private void method7264(@OriginalArg(1) Buffer arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 1) {
			this.anInt8272 = Static579.method7640(arg0.g3());
		} else if (arg1 == 2) {
			...
			this.anInt8271 = Static579.method7640(arg0.g3());
		} else if (arg1 == 8) {
