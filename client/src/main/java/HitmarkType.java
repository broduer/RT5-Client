...
public final class HitmarkType {
	...
	public HitmarkTypeList aClass222_1;
	...
	public Class23 method6458(@OriginalArg(0) Class19 arg0) {
		...
		@Pc(22) Class23 local22 = (Class23) this.aClass222_1.aClass82_121.get(this.anInt7202);
		if (local22 == null) {
			this.method6462(arg0);
			local22 = (Class23) this.aClass222_1.aClass82_121.get(this.anInt7202);
		}
		return local22;
	}
	...
	public Class23 method6459(@OriginalArg(1) Class19 arg0) {
		...
		@Pc(29) Class23 local29 = (Class23) this.aClass222_1.aClass82_121.get(this.anInt7201);
		if (local29 == null) {
			this.method6462(arg0);
			local29 = (Class23) this.aClass222_1.aClass82_121.get(this.anInt7201);
		}
		return local29;
	}
	...
	public Class23 method6460(@OriginalArg(0) Class19 arg0) {
		...
		@Pc(27) Class23 local27 = (Class23) this.aClass222_1.aClass82_121.get(this.anInt7208);
		if (local27 == null) {
			this.method6462(arg0);
			local27 = (Class23) this.aClass222_1.aClass82_121.get(this.anInt7208);
		}
		return local27;
	}
	...
	public Class23 method6461(@OriginalArg(1) Class19 arg0) {
		...
		@Pc(20) Class23 local20 = (Class23) this.aClass222_1.aClass82_121.get(this.anInt7204);
		if (local20 == null) {
			this.method6462(arg0);
			local20 = (Class23) this.aClass222_1.aClass82_121.get(this.anInt7204);
		}
		return local20;
	}
	...
	private void method6462(@OriginalArg(1) Class19 arg0) {
		@Pc(7) Js5 local7 = this.aClass222_1.aClass332_76;
		@Pc(34) Class409 local34;
		if (this.anInt7204 >= 0 && this.aClass222_1.aClass82_121.get(this.anInt7204) == null && local7.method7588(this.anInt7204)) {
			local34 = Static735.method9386(local7, this.anInt7204);
			this.aClass222_1.aClass82_121.put(arg0.method7955(local34, true), this.anInt7204);
		}
		if (this.anInt7202 >= 0 && this.aClass222_1.aClass82_121.get(this.anInt7202) == null && local7.method7588(this.anInt7202)) {
			local34 = Static735.method9386(local7, this.anInt7202);
			this.aClass222_1.aClass82_121.put(arg0.method7955(local34, true), this.anInt7202);
		}
		if (this.anInt7201 >= 0 && this.aClass222_1.aClass82_121.get(this.anInt7201) == null && local7.method7588(this.anInt7201)) {
			local34 = Static735.method9386(local7, this.anInt7201);
			this.aClass222_1.aClass82_121.put(arg0.method7955(local34, true), this.anInt7201);
		}
		if (this.anInt7208 >= 0 && this.aClass222_1.aClass82_121.get(this.anInt7208) == null && local7.method7588(this.anInt7208)) {
			local34 = Static735.method9386(local7, this.anInt7208);
			this.aClass222_1.aClass82_121.put(arg0.method7955(local34, true), this.anInt7208);
		}
	}

	@OriginalMember(owner = "client!pb", name = "a", descriptor = "(Lclient!ge;BI)V")
	private void method6463(@OriginalArg(0) Buffer arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 1) {
			this.anInt7217 = arg0.g2();
		} else if (arg1 == 2) {
			this.anInt7211 = arg0.g3();
		} else if (arg1 == 3) {
	...
	public void method6465(@OriginalArg(1) Buffer arg0) {
		while (true) {
