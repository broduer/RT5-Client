...
public final class IdkType {
	...
	public IdkTypeList aClass217_4;
	...
	private void method6619(@OriginalArg(1) int arg0, @OriginalArg(2) Buffer arg1) {
		if (arg0 == 1) {
			arg1.g1();
			return;
		}
	...
	public void method6620(@OriginalArg(0) Buffer arg0) {
		while (true) {
	...
	public Class88 method6621() {
		...
		@Pc(10) int local10 = 0;
		@Pc(22) Js5 local22 = this.aClass217_4.aClass332_72;
		@Pc(26) int local26;
	...
	public Class88 method6625() {
		...
		@Pc(18) Js5 local18 = this.aClass217_4.aClass332_72;
		@Pc(22) int local22;
		synchronized (this.aClass217_4.aClass332_72) {
			local22 = 0;
			while (true) {
