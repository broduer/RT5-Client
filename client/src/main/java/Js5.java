...
public final class Js5 {
	...
	public void method7582(@OriginalArg(0) boolean arg0) {
		...
		if (arg0) {
			this.index.aClass100_1 = null;
			this.index.anIntArray596 = null;
		}
		this.index.anIntArrayArray186 = null;
		this.index.aClass100Array1 = null;
	}
	...
	public boolean method7584(@OriginalArg(0) String arg0, @OriginalArg(2) String arg1) {
		...
		if (local25 < 0) {
			...
			@Pc(41) int local41 = this.index.aClass100Array1[local25].method2382(Static95.method1894(local16));
			return local41 >= 0;
		}
	}
	...
	private void method7586(@OriginalArg(0) int arg0) {
		if (this.discardPacked) {
			...
			this.packed[arg0] = Static247.method3524(this.provider.fetchGroup(arg0));
		}
	}
	...
	public byte[] method7590(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2) {
		...
		@Pc(61) byte[] local61 = Static377.method5328(false, this.unpacked[arg2][arg1]);
		if (this.discardUnpacked == 1) {
			this.unpacked[arg2][arg1] = null;
			if (this.index.anIntArray595[arg2] == 1) {
	...
	private boolean method7591(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (!this.method7608()) {
			return false;
		} else if (arg1 >= 0 && arg0 >= 0 && arg1 < this.index.anIntArray595.length && this.index.anIntArray595[arg1] > arg0) {
			return true;
	...
	private boolean method7592(@OriginalArg(1) int[] arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		if (!this.method7603(arg2)) {
			return false;
		} else if (this.packed[arg2] == null) {
			return false;
		} else {
			@Pc(32) int local32 = this.index.groupSizes[arg2];
			@Pc(38) int[] local38 = this.index.anIntArrayArray185[arg2];
			if (this.unpacked[arg2] == null) {
				this.unpacked[arg2] = new Object[this.index.anIntArray595[arg2]];
			}
			@Pc(60) Object[] local60 = this.unpacked[arg2];
			...
			if (arg0 == null || arg0[0] == 0 && arg0[1] == 0 && arg0[2] == 0 && arg0[3] == 0) {
				local138 = Static377.method5328(false, this.packed[arg2]);
			} else {
				local138 = Static377.method5328(true, this.packed[arg2]);
				@Pc(152) Buffer local152 = new Buffer(local138);
			...
			try {
				...
				throw TracingException.wrap(local166, "T3 - " + (arg0 != null) + "," + arg2 + "," + local138.length + "," + Buffer.getcrc(local138.length, local138) + "," + Buffer.getcrc(local138.length - 2, local138) + "," + this.index.groupChecksums[arg2] + "," + this.index.anInt7386);
			}
			if (this.discardPacked) {
				this.packed[arg2] = null;
			}
			@Pc(243) int local243;
			if (local32 <= 1) {
				if (local38 == null) {
	...
	public boolean method7594(@OriginalArg(0) String arg0) {
		if (this.method7608()) {
			...
			@Pc(30) int local30 = this.index.aClass100_1.method2382(Static95.method1894(local21));
			return local30 >= 0;
		} else {
			return false;
		}
	...
	public int getGroupId(@OriginalArg(0) String arg0) {
		if (this.method7608()) {
			...
			@Pc(28) int local28 = this.index.aClass100_1.method2382(Static95.method1894(local19));
	...
	public boolean method7598() {
		...
		for (@Pc(26) int local26 = 0; local26 < this.index.anIntArray600.length; local26++) {
			@Pc(36) int local36 = this.index.anIntArray600[local26];
			if (this.packed[local36] == null) {
	...
	public void method7599() {
		if (this.unpacked != null) {
			for (@Pc(4) int local4 = 0; local4 < this.unpacked.length; local4++) {
				this.unpacked[local4] = null;
			}
		}
	}
	...
	public int method7600(@OriginalArg(1) String arg0) {
		if (this.method7608()) {
			...
			@Pc(33) int local33 = this.index.aClass100_1.method2382(Static95.method1894(local24));
	...
	public void method7601() {
		if (this.packed != null) {
			for (@Pc(18) int local18 = 0; local18 < this.packed.length; local18++) {
				this.packed[local18] = null;
			}
		}
	}
	...
	private boolean method7603(@OriginalArg(1) int arg0) {
		if (!this.method7608()) {
			return false;
		} else if (arg0 >= 0 && arg0 < this.index.anIntArray595.length && this.index.anIntArray595[arg0] != 0) {
			return true;
		} else if (Static486.aBoolean550) {
	...
	public int method7604() {
		return this.method7608() ? this.index.anIntArray595.length : -1;
	}
	...
	public boolean method7605(@OriginalArg(0) String arg0) {
		if (this.method7608()) {
			@Pc(13) String local13 = arg0.toLowerCase();
			@Pc(22) int local22 = this.index.aClass100_1.method2382(Static95.method1894(local13));
	...
	public int method7606(@OriginalArg(1) int arg0) {
		if (this.method7608()) {
			@Pc(17) int local17 = this.index.aClass100_1.method2382(arg0);
	...
	public byte[] fetchFile(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1) {
		...
		if (this.method7603(local25)) {
			@Pc(53) int local53 = this.index.aClass100Array1[local25].method2382(Static95.method1894(local16));
			return this.fetchFile(local53, local25);
		} else {
			return null;
		}
	}
	...
	private boolean method7608() {
		if (this.index == null) {
			...
			this.unpacked = new Object[this.index.capaity][];
			this.packed = new Object[this.index.capaity];
		}
		return true;
	}
	...
	public void method7609(@OriginalArg(0) String arg0) {
		if (this.method7608()) {
			...
			@Pc(29) int local29 = this.index.aClass100_1.method2382(Static95.method1894(local12));
	...
	public int[] method7610(@OriginalArg(0) int arg0) {
		...
		@Pc(17) int[] local17 = this.index.anIntArrayArray185[arg0];
		if (local17 == null) {
			local17 = new int[this.index.groupSizes[arg0]];
			@Pc(28) int local28 = 0;
	...
	public void method7612(@OriginalArg(1) int arg0) {
		if (this.method7603(arg0) && this.unpacked != null) {
	...
	public int getGroupCapacity(@OriginalArg(1) int arg0) {
		return this.method7603(arg0) ? this.index.anIntArray595[arg0] : 0;
	}
}
