...
public final class Js5NetQueue {
	...
	private final SecondaryLinkedList aClass194_10 = new SecondaryLinkedList();

	@OriginalMember(owner = "client!pla", name = "b", descriptor = "Lclient!jga;")
	private final SecondaryLinkedList aClass194_11 = new SecondaryLinkedList();

	@OriginalMember(owner = "client!pla", name = "r", descriptor = "Lclient!jga;")
	private final SecondaryLinkedList aClass194_12 = new SecondaryLinkedList();

	@OriginalMember(owner = "client!pla", name = "j", descriptor = "Lclient!jga;")
	private final SecondaryLinkedList aClass194_13 = new SecondaryLinkedList();

	@OriginalMember(owner = "client!pla", name = "v", descriptor = "Lclient!ge;")
	private final Buffer aClass2_Sub21_13 = new Buffer(4);
	...
	private final Buffer aClass2_Sub21_14 = new Buffer(8);
	...
	public int method6629() {
		return this.aClass194_10.size() + this.aClass194_11.size();
	}
	...
	public boolean cycle() {
		...
		try {
			...
			for (@Pc(84) Js5NetRequest local84 = (Js5NetRequest) this.aClass194_10.head(); local84 != null; local84 = (Js5NetRequest) this.aClass194_10.next()) {
				this.aClass2_Sub21_13.pos = 0;
				this.aClass2_Sub21_13.p1(1);
				this.aClass2_Sub21_13.p3((int) local84.secondaryKey);
				this.aClass265_1.method5836(0, 4, this.aClass2_Sub21_13.data);
				this.aClass194_11.addTail(local84);
			}
			for (@Pc(142) Js5NetRequest local142 = (Js5NetRequest) this.aClass194_12.head(); local142 != null; local142 = (Js5NetRequest) this.aClass194_12.next()) {
				this.aClass2_Sub21_13.pos = 0;
				this.aClass2_Sub21_13.p1(0);
				this.aClass2_Sub21_13.p3((int) local142.secondaryKey);
				this.aClass265_1.method5836(0, 4, this.aClass2_Sub21_13.data);
				this.aClass194_13.addTail(local142);
			}
				...
				if (local212 > 0) {
					...
					if (local212 <= this.aClass2_Sub21_14.pos) {
						if (this.aClass2_Sub2_Sub17_Sub1_2 == null) {
							...
							if (local354) {
								for (local371 = (Js5NetRequest) this.aClass194_13.head(); local371 != null && local371.secondaryKey != local361; local371 = (Js5NetRequest) this.aClass194_13.next()) {
								}
							} else {
								for (local371 = (Js5NetRequest) this.aClass194_11.head(); local371 != null && local371.secondaryKey != local361; local371 = (Js5NetRequest) this.aClass194_11.next()) {
								}
							}
							if (local371 == null) {
								throw new IOException();
							...
							this.aClass2_Sub2_Sub17_Sub1_2.aClass2_Sub21_15 = new Buffer(local454 + local338 + this.aClass2_Sub2_Sub17_Sub1_2.aByte129);
	...
	public void start(@OriginalArg(0) boolean arg0, @OriginalArg(2) ClientStream arg1) {
		...
		this.aClass2_Sub21_14.pos = 0;
		while (true) {
			@Pc(48) Js5NetRequest local48 = (Js5NetRequest) this.aClass194_11.removeHead();
			if (local48 == null) {
				while (true) {
					local48 = (Js5NetRequest) this.aClass194_13.removeHead();
					if (local48 == null) {
						if (this.aByte120 != 0) {
							try {
								this.aClass2_Sub21_13.pos = 0;
					...
					this.aClass194_12.addTail(local48);
				}
			}
			this.aClass194_10.addTail(local48);
		}
	}
	...
	private int method6639() {
		return this.aClass194_12.size() + this.aClass194_13.size();
	}
	...
	public Js5NetRequest read(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) boolean arg2, @OriginalArg(4) byte arg3) {
		...
		if (arg2) {
			...
			this.aClass194_10.addTail(local23);
		} else if (this.method6639() < 20) {
			this.aClass194_12.addTail(local23);
		} else {
			throw new RuntimeException();
		}
		return local23;
