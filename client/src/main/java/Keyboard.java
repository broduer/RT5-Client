...
public final class Keyboard extends Class321 implements KeyListener, FocusListener {
	...
	private final LinkedList aClass341_70 = new LinkedList();

	@OriginalMember(owner = "client!ui", name = "q", descriptor = "Lclient!sia;")
	private final LinkedList aClass341_71 = new LinkedList();
	...
	private void method8492(@OriginalArg(0) char arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		...
		this.aClass341_71.insertBefore(local7);
	}
	...
	public Interface27 method8485() {
		return (Interface27) this.aClass341_70.removeHead();
	}
	...
	public synchronized void method8488() {
		this.aClass341_70.clear();
		for (@Pc(22) Node_Sub18 local22 = (Node_Sub18) this.aClass341_71.removeHead(); local22 != null; local22 = (Node_Sub18) this.aClass341_71.removeHead()) {
			...
			if (local22.anInt2895 == 0) {
				if (!this.aBooleanArray31[local22.anInt2890]) {
					...
					this.aClass341_70.insertBefore(local152);
					this.aBooleanArray31[local22.anInt2890] = true;
				}
				local22.anInt2895 = 2;
				this.aClass341_70.insertBefore(local22);
				...
				for (@Pc(65) int local65 = 0; local65 < 112; local65++) {
					if (this.aBooleanArray31[local65]) {
						...
						this.aClass341_70.insertBefore(local78);
