...
public final class LinkedList {
	...
	public int method7708() {
		@Pc(13) int local13 = 0;
		@Pc(17) Node local17 = this.sentinel.next;
	...
	private void method7710(@OriginalArg(0) Node arg0, @OriginalArg(1) LinkedList arg1) {
		@Pc(7) Node local7 = this.sentinel.prev;
	...
	public void method7714(@OriginalArg(1) LinkedList arg0) {
		this.method7710(this.sentinel.next, arg0);
	}
	...
	public void insertBefore(@OriginalArg(1) Node node) {
		if (node.prev != null) {
			node.unlink();
		}
