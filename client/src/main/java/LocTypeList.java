...
public final class LocTypeList {
	...
	private SoftLruHashTable aClass82_73 = new SoftLruHashTable(64);

	@OriginalMember(owner = "client!gea", name = "f", descriptor = "Lclient!dla;")
	public final SoftLruHashTable aClass82_74 = new SoftLruHashTable(500);

	@OriginalMember(owner = "client!gea", name = "k", descriptor = "Lclient!dla;")
	public final SoftLruHashTable aClass82_75 = new SoftLruHashTable(30);

	@OriginalMember(owner = "client!gea", name = "q", descriptor = "Lclient!dla;")
	public final SoftLruHashTable aClass82_76 = new SoftLruHashTable(50);

	@OriginalMember(owner = "client!gea", name = "b", descriptor = "Lclient!sb;")
	public final Js5 aClass332_44;

	@OriginalMember(owner = "client!gea", name = "j", descriptor = "Lclient!ul;")
	private final ModeGame aClass379_2;
	...
	private final Js5 aClass332_43;
	...
	public LocTypeList(@OriginalArg(0) ModeGame arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Js5 arg3, @OriginalArg(4) Js5 arg4) {
		...
		if (this.aClass332_43 != null) {
			...
			this.aClass332_43.getGroupCapacity(local53);
		}
		if (Static673.runescapeGame == this.aClass379_2) {
			this.aStringArray15 = new String[] { null, null, null, null, null, Static32.aClass32_22.getLocalization(this.anInt3393) };
		} else {
	...
	public void method3062(@OriginalArg(1) int arg0) {
		this.aClass82_73 = new SoftLruHashTable(arg0);
	}
	...
	public LocType method3063(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		synchronized (this.aClass82_73) {
			local22 = (LocType) this.aClass82_73.get(arg0);
		}
		if (local22 != null) {
			return local22;
		}
		...
		synchronized (this.aClass332_43) {
			local49 = this.aClass332_43.fetchFile(Static570.method7558(arg0), Static705.method9204(arg0));
		}
		local22 = new LocType();
		...
		if (local49 != null) {
			local22.method1305(new Buffer(local49));
		}
		local22.method1306();
		...
		synchronized (this.aClass82_73) {
			this.aClass82_73.put(local22, arg0);
			return local22;
		}
	}
	...
	public void method3065(@OriginalArg(0) int arg0) {
		this.anInt3400 = arg0;
		@Pc(9) SoftLruHashTable local9 = this.aClass82_74;
		synchronized (this.aClass82_74) {
			this.aClass82_74.method2157();
		}
