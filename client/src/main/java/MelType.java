...
public final class MelType {
	...
	public MelTypeList aClass248_2;
	...
	private int anInt2593 = -1;

	@OriginalMember(owner = "client!el", name = "d", descriptor = "I")
	public int anInt2596 = -1;

	@OriginalMember(owner = "client!el", name = "H", descriptor = "I")
	private int anInt2595 = -1;

	@OriginalMember(owner = "client!el", name = "m", descriptor = "I")
	public int anInt2605 = -1;

	@OriginalMember(owner = "client!el", name = "A", descriptor = "I")
	public int anInt2603 = Integer.MIN_VALUE;

	@OriginalMember(owner = "client!el", name = "r", descriptor = "I")
	public int anInt2600 = -1;
	...
	@OriginalMember(owner = "client!el", name = "X", descriptor = "I")
	public int anInt2597 = Integer.MAX_VALUE;

	@OriginalMember(owner = "client!el", name = "L", descriptor = "I")
	public int anInt2606 = -1;
	...
	@OriginalMember(owner = "client!el", name = "b", descriptor = "I")
	public int anInt2607 = Integer.MAX_VALUE;

	@OriginalMember(owner = "client!el", name = "C", descriptor = "I")
	public int anInt2623 = Integer.MIN_VALUE;

	@OriginalMember(owner = "client!el", name = "a", descriptor = "I")
	private int anInt2625 = -1;
	...
	public void method2423(@OriginalArg(1) Buffer arg0) {
		while (true) {
	...
	public boolean method2425(@OriginalArg(1) Interface23 arg0) {
		...
		if (this.anInt2625 == -1) {
			...
			local31 = arg0.method6871(this.anInt2608);
		} else {
			local31 = arg0.method6872(this.anInt2625);
		}
		if (local31 < this.anInt2621 || local31 > this.anInt2591) {
			return false;
		}
		@Pc(78) int local78;
		if (this.anInt2593 == -1) {
			...
			local78 = arg0.method6871(this.anInt2595);
		} else {
			local78 = arg0.method6872(this.anInt2593);
		}
		return this.anInt2615 <= local78 && this.anInt2610 >= local78;
	}
	...
	public String method2426(@OriginalArg(0) int arg0, @OriginalArg(2) String arg1) {
		if (this.aClass28_14 == null) {
			...
			@Pc(17) Node_Sub24 local17 = (Node_Sub24) this.aClass28_14.get(arg0);
	...
	public int method2427(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		if (this.aClass28_14 == null) {
			...
			@Pc(27) Node_Sub38 local27 = (Node_Sub38) this.aClass28_14.get(arg1);
	...
	public Class23 method2428(@OriginalArg(1) Class19 arg0) {
		@Pc(28) Class23 local28 = (Class23) this.aClass248_2.aClass82_135.get(this.anInt2627 | 0x20000 | arg0.anInt8986 << 29);
		if (local28 != null) {
			return local28;
		}
		...
		if (local49 != null) {
			...
			this.aClass248_2.aClass82_135.put(local28, this.anInt2627 | 0x20000 | arg0.anInt8986 << 29);
		}
		return local28;
	}
	...
	public void method2430() {
		...
		for (@Pc(16) int local16 = 0; local16 < this.anIntArray228.length; local16 += 2) {
			if (this.anIntArray228[local16] < this.anInt2607) {
				this.anInt2607 = this.anIntArray228[local16];
			} else if (this.anInt2623 < this.anIntArray228[local16]) {
				this.anInt2623 = this.anIntArray228[local16];
			}
			if (this.anInt2597 > this.anIntArray228[local16 + 1]) {
				this.anInt2597 = this.anIntArray228[local16 + 1];
			} else if (this.anInt2603 < this.anIntArray228[local16 + 1]) {
				this.anInt2603 = this.anIntArray228[local16 + 1];
			}
		}
	}
	...
	public Class23 method2431(@OriginalArg(0) boolean arg0, @OriginalArg(2) Class19 arg1) {
		...
		@Pc(38) Class23 local38 = (Class23) this.aClass248_2.aClass82_135.get(local29);
		if (local38 != null) {
			return local38;
			...
			if (local60 != null) {
				...
				this.aClass248_2.aClass82_135.put(local38, local29);
			}
			return local38;
		} else {
			return null;
	...
	private void method2432(@OriginalArg(1) Buffer arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 1) {
			this.anInt2605 = arg0.g2();
		} else if (arg1 == 2) {
			this.anInt2600 = arg0.g2();
		} else if (arg1 == 3) {
			this.aString25 = arg0.gstr();
		} else if (arg1 == 4) {
			this.anInt2601 = arg0.g3();
		} else if (arg1 == 5) {
			this.anInt2598 = arg0.g3();
		} else if (arg1 == 6) {
			this.anInt2624 = arg0.g1();
		} else {
			@Pc(74) int local74;
			if (arg1 == 7) {
				local74 = arg0.g1();
				...
				this.anInt2608 = arg0.g2();
				if (this.anInt2608 == 65535) {
					this.anInt2608 = -1;
				}
				this.anInt2625 = arg0.g2();
				if (this.anInt2625 == 65535) {
					this.anInt2625 = -1;
				}
				this.anInt2621 = arg0.g4();
				this.anInt2591 = arg0.g4();
				return;
				...
				if (arg1 != 15) {
					...
					if (arg1 == 17) {
						this.aString24 = arg0.gstr();
					} else if (arg1 == 18) {
						this.anInt2627 = arg0.g2();
						return;
					} else if (arg1 == 19) {
						this.anInt2606 = arg0.g2();
						return;
					} else if (arg1 == 20) {
						this.anInt2595 = arg0.g2();
						if (this.anInt2595 == 65535) {
							this.anInt2595 = -1;
						}
						this.anInt2593 = arg0.g2();
						if (this.anInt2593 == 65535) {
							this.anInt2593 = -1;
						}
						this.anInt2615 = arg0.g4();
						this.anInt2610 = arg0.g4();
						return;
					} else if (arg1 == 21) {
						this.anInt2617 = arg0.g4();
						return;
					} else if (arg1 == 22) {
						this.anInt2614 = arg0.g4();
						return;
					} else if (arg1 == 23) {
						this.anInt2612 = arg0.g1();
						this.anInt2596 = arg0.g1();
						this.anInt2616 = arg0.g1();
						return;
					} else if (arg1 == 24) {
						this.anInt2609 = arg0.method7363();
						this.anInt2626 = arg0.method7363();
						return;
					} else if (arg1 == 249) {
						local74 = arg0.g1();
						if (this.aClass28_14 == null) {
							local291 = Static440.method5969(local74);
							this.aClass28_14 = new HashTable(local291);
						}
						for (local291 = 0; local291 < local74; local291++) {
							...
							if (local310) {
								local323 = new Node_Sub24(arg0.gstr());
							} else {
								local323 = new Node_Sub38(arg0.g4());
							}
							this.aClass28_14.put(local314, local323);
						}
						return;
					}
					return;
				...
				for (local291 = 0; local291 < local74 * 2; local291++) {
					this.anIntArray228[local291] = arg0.method7363();
				}
				this.anInt2619 = arg0.g4();
				...
				this.aStringArray9[arg1 - 10] = arg0.gstr();
				return;
			}
		}
	}
