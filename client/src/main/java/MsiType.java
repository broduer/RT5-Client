...
public final class MsiType {
	...
	public MsiTypeList aClass365_2;
	...
	public Class23 method3689(@OriginalArg(0) int arg0, @OriginalArg(1) Class19 arg1, @OriginalArg(2) boolean arg2) {
		...
		@Pc(31) Class23 local31 = (Class23) this.aClass365_2.aClass82_202.get(local23);
		if (local31 != null) {
			return local31;
			...
			if (local31 != null) {
				this.aClass365_2.aClass82_202.put(local31, local23);
			}
			return local31;
		} else {
			return null;
	...
	private void method3691(@OriginalArg(1) int arg0, @OriginalArg(2) Buffer arg1) {
		if (arg0 == 1) {
			this.anInt4178 = arg1.g2();
		} else if (arg0 == 2) {
			this.anInt4176 = arg1.g3();
		} else if (arg0 == 3) {
	...
	public void method3694(@OriginalArg(0) Buffer arg0) {
		while (true) {
