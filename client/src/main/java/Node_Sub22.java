...
public final class Node_Sub22 extends Node {
	...
	private long method3077(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3) {
		@Pc(7) long[] local7 = Buffer.aLongArray21;
		@Pc(9) long local9 = -1L;
	...
	public Class114 method3078(@OriginalArg(0) int arg0, @OriginalArg(2) Class19 arg1, @OriginalArg(4) boolean arg2, @OriginalArg(5) Class152 arg3, @OriginalArg(6) Class203 arg4) {
		@Pc(7) Class114 local7 = null;
		@Pc(9) int local9 = 2048;
		@Pc(11) BasType local11 = null;
		if (arg0 != -1) {
			local11 = client.basTypeList.method7125(arg0);
		}
		...
		if (arg3 != null) {
			local9 = arg3.method9108() | 0x800;
		}
		@Pc(116) long local116 = this.method3077(arg2, arg0, local23, arg4 == null ? null : arg4.anIntArray380);
		if (Static166.aClass82_59 != null) {
			local7 = (Class114) Static166.aClass82_59.get(local116);
		}
		if (local7 == null || arg1.method7967(local7.ua(), local9) != 0) {
			if (local7 != null) {
				local9 = arg1.method8020(local9, local7.ua());
			}
			@Pc(151) int local151 = local9;
			@Pc(153) boolean local153 = false;
			for (@Pc(155) int local155 = 0; local155 < local23.length; local155++) {
				if (local23[local155] != -1 && !client.objTypeList.get(local23[local155]).method8809(arg2, null)) {
					local153 = true;
				}
			}
			if (local153) {
			...
			for (@Pc(205) int local205 = 0; local205 < local23.length; local205++) {
				if (local23[local205] != -1) {
					local203[local205] = client.objTypeList.get(local23[local205]).method8806(null, arg2);
				}
			}
			@Pc(278) int local278;
			@Pc(285) int local285;
			...
			local7 = arg1.method7959(local382, local151, Static584.anInt8659, 64, 850);
			if (arg4 != null) {
			...
			if (Static166.aClass82_59 != null) {
				local7.s(local9);
				Static166.aClass82_59.put(local7, local116);
			}
		}
		if (arg3 == null) {
			return local7;
		} else {
			@Pc(478) Class114 local478 = local7.method7502((byte) 1, local9, true);
			arg3.method9096(local478, 0);
			return local478;
		}
	}
}
