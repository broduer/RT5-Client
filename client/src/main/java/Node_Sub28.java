...
public abstract class Node_Sub28 extends Node {
	...
	public Node_Sub28(@OriginalArg(0) OggStreamState arg0) {
		this.anOggStreamState5 = arg0;
	}

	@OriginalMember(owner = "client!kb", name = "a", descriptor = "(ILclient!jagtheora/ogg/OggPacket;)V")
	public final void method8563(@OriginalArg(1) OggPacket arg0) {
		this.method8565(arg0);
		this.anInt9779++;
	}

	@OriginalMember(owner = "client!kb", name = "b", descriptor = "(ILclient!jagtheora/ogg/OggPacket;)V")
	protected abstract void method8565(@OriginalArg(1) OggPacket arg0);

	@OriginalMember(owner = "client!kb", name = "b", descriptor = "(I)V")
	public abstract void method8567();
}
