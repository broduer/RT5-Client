...
public final class Node_Sub28_Sub3 extends Node_Sub28 {
	...
	public Node_Sub28_Sub3(@OriginalArg(0) OggStreamState arg0) {
		super(arg0);
	}
	...
	private void method5497(@OriginalArg(1) int arg0) {
		this.anInt6139 = arg0;
		if (!this.aBoolean463) {
			return;
		}
		if (this.anInt6139 > this.anInt6135) {
			this.anInt6139 = this.anInt6135;
		}
		if (this.anInt6139 < 0) {
			this.anInt6139 = 0;
		}
		this.aDecoderContext1.setPostProcessingLevel(this.anInt6139);
	}

	@OriginalMember(owner = "client!mda", name = "a", descriptor = "(Lclient!ha;I)Lclient!st;")
	public Class23 method5498(@OriginalArg(0) Class19 arg0) {
		if (this.aFrame7 == null) {
			return null;
		} else if (this.aBoolean462 || this.aClass23_29 == null) {
			this.aClass23_29 = arg0.method7965(this.aFrame7.pixels, this.aFrame7.b, this.aFrame7.b, this.aFrame7.a, false);
	...
	protected void method8565(@OriginalArg(1) OggPacket arg0) {
		...
		if (!this.aBoolean463) {
			...
			if (local19 == 0) {
				...
				this.anInt6135 = this.aDecoderContext1.getMaxPostProcessingLevel();
				this.method5497(this.anInt6139);
			} else if (local19 < 0) {
				throw new IllegalStateException(String.valueOf(local19));
			}
			return;
		}
		this.aLong188 = Static588.currentTimeMillis();
