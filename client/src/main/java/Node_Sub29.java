...
public final class Node_Sub29 extends Node {
	...
	public Node_Sub29(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) boolean arg3) {
		...
		if (arg3) {
			@Pc(16) int[] local16 = new int[this.anInt4423];
			@Pc(20) int[] local20 = new int[this.anInt4423];
			@Pc(24) int[] local24 = new int[this.anInt4423];
			@Pc(28) int[] local28 = new int[this.anInt4423];
			...
			@Pc(44) int local44 = this.anInt4423;
			@Pc(47) int local47 = this.anInt4423;
	...
	public void method3973(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(28) int local28 = this.anInt4423 - 1;
		@Pc(33) int local33 = this.anInt4423 * arg1;
		@Pc(37) int local37 = local21 - 1;
		for (@Pc(39) int local39 = 0; local39 < local21; local39 += this.anInt4423) {
