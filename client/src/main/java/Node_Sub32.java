...
public final class Node_Sub32 extends Node {
	...
	private final Node_Sub7 aClass2_Sub7_1;
	...
	public Node_Sub32(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) Class178_Sub1 arg1, @OriginalArg(2) Node_Sub7 arg2, @OriginalArg(3) int[] arg3) {
		this.aClass19_Sub1_11 = arg0;
		this.aClass178_Sub1_1 = arg1;
		this.aClass2_Sub7_1 = arg2;
		@Pc(23) int local23 = this.aClass2_Sub7_1.method8439() - (arg1.anInt8912 >> 1);
		this.anInt5039 = this.aClass2_Sub7_1.method8433() - local23 >> arg1.anInt8919;
		this.anInt5042 = local23 + this.aClass2_Sub7_1.method8433() >> arg1.anInt8919;
		this.anInt5041 = this.aClass2_Sub7_1.method8436() - local23 >> arg1.anInt8919;
		this.anInt5044 = local23 + this.aClass2_Sub7_1.method8436() >> arg1.anInt8919;
		@Pc(78) int local78 = this.anInt5042 + 1 - this.anInt5039;
		@Pc(87) int local87 = this.anInt5044 + 1 - this.anInt5041;
		...
		for (@Pc(116) int local116 = 0; local116 <= local87; local116++) {
			local123 = local116 + this.anInt5041;
			if (local123 > 0 && local123 < this.aClass178_Sub1_1.anInt8916 - 1) {
				for (local139 = 0; local139 <= local78; local139++) {
					local146 = this.anInt5039 + local139;
		...
		local123 = 0;
		@Pc(321) int local321;
		for (local139 = this.anInt5041; local139 <= this.anInt5044; local139++) {
			if (local139 >= 0 && local139 < arg1.anInt8916) {
				for (local146 = this.anInt5039; local146 <= this.anInt5042; local146++) {
					if (local146 >= 0 && arg1.anInt8918 > local146) {
				...
				local123 += this.anInt5042 - this.anInt5039;
			}
		}
		if (this.anInt5040 <= 0) {
			...
			this.aClass28_25 = new HashTable(Static440.method5969(this.anInt5040));
			this.anInterface20_2 = this.aClass19_Sub1_11.method8129(false);
			this.anInterface20_2.method8550(this.anInt5040);
			@Pc(448) NativeHeapBuffer local448 = this.aClass19_Sub1_11.method8113(false, this.anInt5040 * 16);
			this.aStream3 = new Stream(local448);
			while (true) {
				@Pc(460) Buffer local460;
				do {
					local460 = this.anInterface20_2.method8554();
				} while (local460 == null);
				this.aStream2 = new Stream(local460);
				local195 = 0;
				local123 = 0;
				for (local321 = this.anInt5041; local321 <= this.anInt5044; local321++) {
					if (local321 >= 0 && local321 < arg1.anInt8916) {
						@Pc(504) int local504 = 0;
						for (@Pc(507) int local507 = this.anInt5039; local507 <= this.anInt5042; local507++) {
							if (local507 >= 0 && arg1.anInt8918 > local507) {
								...
								if (local537 != null && local530 != 0) {
									if (local530 == 1) {
										...
										label119: while (true) {
											while (true) {
												...
												if (local537[local728] == -1 || local537[local728 + 1] == -1 || local537[local728 + 2] == -1) {
													...
													this.method4570(local504, local321, local726[local728], local507, local719[local728], local195);
													local728++;
													this.method4570(local504, local321, local726[local728], local507, local719[local728], local195);
													local728++;
													this.method4570(local504, local321, local726[local728], local507, local719[local728], local195);
										...
										this.method4570(local504, local321, 0, local507, 0, local195);
										this.method4570(local504, local321, 0, local507, arg1.anInt8912, local195);
										this.method4570(local504, local321, arg1.anInt8912, local507, 0, local195);
									} else if (local530 == 2) {
										this.method4570(local504, local321, 0, local507, arg1.anInt8912, local195);
										this.method4570(local504, local321, arg1.anInt8912, local507, arg1.anInt8912, local195);
										this.method4570(local504, local321, 0, local507, 0, local195);
									} else if (local530 == 5) {
										this.method4570(local504, local321, arg1.anInt8912, local507, arg1.anInt8912, local195);
										this.method4570(local504, local321, arg1.anInt8912, local507, 0, local195);
				...
				this.aStream2.c();
				if (this.anInterface20_2.method8553()) {
					this.aStream3.c();
					this.anInterface16_7 = this.aClass19_Sub1_11.method8163(false);
					this.anInterface16_7.method3152(16, this.anInt5045 * 16, local448);
					break;
				}
				this.aStream3.f(0);
				this.aClass28_25.clear();
			}
		}
	...
	private void method4568(@OriginalArg(1) short arg0) {
		if (Stream.b()) {
	...
	private void method4570(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		@Pc(7) long local7 = -1L;
		@Pc(15) int local15 = (arg3 << this.aClass178_Sub1_1.anInt8919) + arg4;
		@Pc(23) int local23 = (arg1 << this.aClass178_Sub1_1.anInt8919) + arg2;
		...
		if ((arg4 & 0x7F) == 0 || (arg2 & 0x7F) == 0) {
			...
			@Pc(63) Node local63 = this.aClass28_25.get(local7);
			if (local63 != null) {
				this.method4568(((Node_Sub50) local63).aShort119);
				return;
			}
		}
		@Pc(82) short local82 = (short) this.anInt5045++;
		if (local7 != -1L) {
			this.aClass28_25.put(local7, new Node_Sub50(local82));
		}
		...
		if (arg4 == 0 && arg2 == 0) {
		...
		} else if (this.aClass178_Sub1_1.anInt8912 == arg4 && arg2 == 0) {
		...
		} else if (this.aClass178_Sub1_1.anInt8912 == arg4 && arg2 == this.aClass178_Sub1_1.anInt8912) {
		...
		} else if (arg4 == 0 && arg2 == this.aClass178_Sub1_1.anInt8912) {
			...
			local214 = (float) arg4 / (float) this.aClass178_Sub1_1.anInt8912;
			local222 = (float) arg2 / (float) this.aClass178_Sub1_1.anInt8912;
		...
		local222 *= local243;
		local229 *= local243;
		local252 = local236 / (float) this.aClass2_Sub7_1.method8439();
		...
		@Pc(583) int local583 = this.aClass2_Sub7_1.method8438();
		...
		if (this.aClass19_Sub1_11.anInt9204 == 0) {
		...
		this.aStream3.d(255);
		this.method4568(local82);
	}

	@OriginalMember(owner = "client!jw", name = "a", descriptor = "(IIBI[[Z)V")
	public void method4571(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean[][] arg4) {
		if (this.anInterface20_2 == null || (arg3 + arg0 < this.anInt5039 || (arg0 - arg3 > this.anInt5042 || (arg1 + arg3 < this.anInt5041 || arg1 - arg3 > this.anInt5044)))) {
			return;
		}
		for (@Pc(56) int local56 = this.anInt5041; local56 <= this.anInt5044; local56++) {
			for (@Pc(63) int local63 = this.anInt5039; local63 <= this.anInt5042; local63++) {
				...
				if (-arg3 < local70 && local70 < arg3 && -arg3 < local75 && local75 < arg3 && arg4[arg3 + local70][local75 + arg3]) {
					this.aClass19_Sub1_11.method8057((byte) (int) (this.aClass2_Sub7_1.method8435() * 255.0F));
					this.aClass19_Sub1_11.method8137(0, this.anInterface16_7);
					this.aClass19_Sub1_11.method8121(this.aClass19_Sub1_11.aClass246_21);
					this.aClass19_Sub1_11.method8059(0, 0, this.anInterface20_2, this.anInt5045, Static104.aClass131_2, this.anInt5040 / 3);
					return;
				}
			}
		}
