...
public final class Node_Sub33 extends Node {
	...
	private final Node_Sub7 aClass2_Sub7_2;
	...
	public Node_Sub33(@OriginalArg(0) Class19_Sub3 arg0, @OriginalArg(1) Class178_Sub2 arg1, @OriginalArg(2) Node_Sub7 arg2, @OriginalArg(3) int[] arg3) {
		...
		@Pc(23) int local23 = this.aClass2_Sub7_2.method8439() - (arg1.anInt8912 >> 1);
		this.anInt5470 = this.aClass2_Sub7_2.method8433() - local23 >> arg1.anInt8919;
		this.anInt5465 = local23 + this.aClass2_Sub7_2.method8433() >> arg1.anInt8919;
		this.anInt5468 = this.aClass2_Sub7_2.method8436() - local23 >> arg1.anInt8919;
		this.anInt5473 = this.aClass2_Sub7_2.method8436() + local23 >> arg1.anInt8919;
		@Pc(76) int local76 = this.anInt5465 + 1 - this.anInt5470;
		@Pc(84) int local84 = this.anInt5473 + 1 - this.anInt5468;
		...
		for (@Pc(113) int local113 = 0; local113 <= local84; local113++) {
			local121 = local113 + this.anInt5468;
			if (local121 > 0 && local121 < this.aClass178_Sub2_2.anInt8916 - 1) {
				for (local141 = 0; local141 <= local76; local141++) {
					local148 = this.anInt5470 + local141;
		...
		local121 = 0;
		@Pc(345) int local345;
		for (local141 = this.anInt5468; local141 <= this.anInt5473; local141++) {
			if (local141 >= 0 && local141 < arg1.anInt8916) {
				for (local148 = this.anInt5470; local148 <= this.anInt5465; local148++) {
					if (local148 >= 0 && local148 < arg1.anInt8918) {
				...
				local121 += this.anInt5465 - this.anInt5470;
			}
		}
		if (this.anInt5466 <= 0) {
			...
			this.aClass2_Sub21_8 = new Buffer(this.anInt5466 * 2);
			this.aClass2_Sub21_Sub1_2 = new GlBuffer(this.anInt5466 * 16);
			this.aClass28_26 = new HashTable(Static440.method5969(this.anInt5466));
			local148 = 0;
			local121 = 0;
			for (local178 = this.anInt5468; local178 <= this.anInt5473; local178++) {
				if (local178 >= 0 && local178 < arg1.anInt8916) {
					local195 = 0;
					for (local345 = this.anInt5470; local345 <= this.anInt5465; local345++) {
						if (local345 >= 0 && arg1.anInt8918 > local345) {
							...
							if (local522 != null && local515 != 0) {
								if (local515 == 1) {
									...
									label104: while (true) {
										while (true) {
											...
											if (local522[local716] == -1 || local522[local716 + 1] == -1 || local522[local716 + 2] == -1) {
												...
												this.method4939(local714[local716], local707[local716], local178, local148, local345, local195);
												local716++;
												this.method4939(local714[local716], local707[local716], local178, local148, local345, local195);
												local716++;
												this.method4939(local714[local716], local707[local716], local178, local148, local345, local195);
									...
									this.method4939(0, 0, local178, local148, local345, local195);
									this.method4939(0, arg1.anInt8912, local178, local148, local345, local195);
									this.method4939(arg1.anInt8912, 0, local178, local148, local345, local195);
								} else if (local515 == 2) {
									this.method4939(0, arg1.anInt8912, local178, local148, local345, local195);
									this.method4939(arg1.anInt8912, arg1.anInt8912, local178, local148, local345, local195);
									this.method4939(0, 0, local178, local148, local345, local195);
								} else if (local515 == 5) {
									this.method4939(arg1.anInt8912, arg1.anInt8912, local178, local148, local345, local195);
									this.method4939(arg1.anInt8912, 0, local178, local148, local345, local195);
	...
	private void method4939(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		@Pc(7) long local7 = -1L;
		@Pc(15) int local15 = (arg4 << this.aClass178_Sub2_2.anInt8919) + arg1;
		@Pc(23) int local23 = arg0 + (arg2 << this.aClass178_Sub2_2.anInt8919);
		...
		if ((arg1 & 0x7F) == 0 || (arg0 & 0x7F) == 0) {
			...
			@Pc(64) Node local64 = this.aClass28_26.get(local7);
			if (local64 != null) {
				this.method4941(((Node_Sub50) local64).aShort119);
				return;
			}
		}
		@Pc(83) short local83 = (short) this.anInt5471++;
		if (local7 != -1L) {
			this.aClass28_26.put(local7, new Node_Sub50(local83));
		}
		...
		if (arg1 == 0 && arg0 == 0) {
		...
		} else if (this.aClass178_Sub2_2.anInt8912 == arg1 && arg0 == 0) {
		...
		} else if (this.aClass178_Sub2_2.anInt8912 == arg1 && arg0 == this.aClass178_Sub2_2.anInt8912) {
		...
		} else if (arg1 == 0 && arg0 == this.aClass178_Sub2_2.anInt8912) {
			...
			local275 = (float) arg1 / (float) this.aClass178_Sub2_2.anInt8912;
			local283 = (float) arg0 / (float) this.aClass178_Sub2_2.anInt8912;
		...
		local290 *= local304;
		local275 *= local304;
		local313 = local297 / (float) this.aClass2_Sub7_2.method8439();
		...
		@Pc(576) int local576 = this.aClass2_Sub7_2.method8438();
		...
		if (this.aClass19_Sub3_23.aBoolean619) {
			this.aClass2_Sub21_Sub1_2.method4343((float) local15);
			this.aClass2_Sub21_Sub1_2.method4343((float) local30);
			this.aClass2_Sub21_Sub1_2.method4343((float) local23);
		} else {
			this.aClass2_Sub21_Sub1_2.method4344((float) local15);
			this.aClass2_Sub21_Sub1_2.method4344((float) local30);
			this.aClass2_Sub21_Sub1_2.method4344((float) local23);
		}
		if (local614 > 255) {
			local614 = 255;
		}
	...
	public void method4940(@OriginalArg(0) int arg0, @OriginalArg(1) boolean[][] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		if (this.anInterface1_2 == null || (arg2 + arg0 < this.anInt5470 || (this.anInt5465 < arg0 - arg2 || (this.anInt5468 > arg2 + arg3 || arg3 - arg2 > this.anInt5473)))) {
			return;
		}
		for (@Pc(66) int local66 = this.anInt5468; local66 <= this.anInt5473; local66++) {
			for (@Pc(71) int local71 = this.anInt5470; local71 <= this.anInt5465; local71++) {
