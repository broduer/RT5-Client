...
public final class Node_Sub39 extends Node {
	...
	public Node_Sub39(@OriginalArg(0) Class178_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
	...
	public void method5868(@OriginalArg(1) int[] arg0, @OriginalArg(2) int arg1) {
		@Pc(7) int local7 = 0;
		@Pc(11) GlBuffer local11 = this.aClass19_Sub3_31.aClass2_Sub21_Sub1_3;
		local11.pos = 0;
		@Pc(32) short[] local32;
		@Pc(26) int local26;
		@Pc(37) int local37;
		...
		this.aClass134_Sub2_1.method9362(local11.pos, local11.data);
	...
	public void method5870(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2, @OriginalArg(3) int arg3) {
		...
		@Pc(49) int local49;
		if (this.anInt6612 != -1) {
			@Pc(19) Material local19 = this.aClass19_Sub3_31.anInterface4_10.method6824(this.anInt6612);
