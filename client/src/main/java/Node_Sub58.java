...
public final class Node_Sub58 extends Node {
	...
	public final int anInt10889;

	@OriginalMember(owner = "client!wr", name = "w", descriptor = "I")
	public final int anInt10897;

	@OriginalMember(owner = "client!wr", name = "B", descriptor = "I")
	public final int anInt10899;
	...
	public Node_Sub58(@OriginalArg(0) Class178_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		this.anInt10892 = arg3;
		this.aClass19_Sub1_23 = this.aClass178_Sub1_3.aClass19_Sub1_9;
		this.aFloat219 = (float) arg2;
		this.anInt10889 = arg4;
		this.anInt10897 = arg5;
		this.anInt10899 = arg1;
		this.anIntArray884 = new int[this.aClass178_Sub1_3.anInt8916 * this.aClass178_Sub1_3.anInt8918];
	}
	...
	public void method9406(@OriginalArg(1) int arg0) {
		this.aNativeHeapBuffer8 = this.aClass19_Sub1_23.method8113(true, arg0 * 4);
		this.aStream7 = new Stream(this.aNativeHeapBuffer8, 0, arg0 * 4);
	}

	@OriginalMember(owner = "client!wr", name = "a", descriptor = "(B[II)V")
	public void method9407(@OriginalArg(1) int[] arg0, @OriginalArg(2) int arg1) {
		@Pc(14) Interface20 local14 = this.aClass19_Sub1_23.method8081(this.anInt10900 * 3);
		@Pc(19) Buffer local19 = local14.method8554();
		if (local19 == null) {
			return;
		}
		@Pc(29) Stream local29 = this.aClass19_Sub1_23.method8107(local19);
		@Pc(31) int local31 = 0;
		...
		local29.c();
		if (!local14.method8553() || local31 <= 0) {
			return;
		}
		this.aClass19_Sub1_23.method8115((this.aClass178_Sub1_3.anInt4314 & 0x7) != 0, this.anInt10899, (this.aClass178_Sub1_3.anInt4314 & 0x8) != 0);
		if (this.aClass19_Sub1_23.aBoolean682) {
			this.aClass19_Sub1_23.EA(Integer.MAX_VALUE, this.anInt10892, this.anInt10889, this.anInt10897);
		}
		@Pc(315) Class73_Sub1 local315 = this.aClass19_Sub1_23.method8089();
		local315.method1884(1.0F, 1.0F / this.aFloat219, 1.0F / this.aFloat219);
		this.aClass19_Sub1_23.method8080(Static431.aClass372_5);
		this.aClass19_Sub1_23.method8137(1, this.anInterface16_18);
		this.aClass19_Sub1_23.method8121(this.aClass178_Sub1_3.aClass246_8);
		this.aClass19_Sub1_23.method8059(local33, 0, local14, local35 + 1 - local33, Static104.aClass131_2, local31);
		this.aClass19_Sub1_23.method8038();
	}

	@OriginalMember(owner = "client!wr", name = "a", descriptor = "(IIII)V")
	public void method9408(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		this.anIntArray884[this.aClass178_Sub1_3.anInt8918 * arg2 + arg0] |= 0x1 << arg1;
		this.anInt10900++;
	}
	...
	public void method9410(@OriginalArg(1) int arg0) {
		this.aStream7.c();
		this.anInterface16_18 = this.aClass19_Sub1_23.method8163(false);
	...
	public void method9411(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2, @OriginalArg(4) int arg3) {
		@Pc(31) int local31;
		@Pc(57) int local57;
		if (this.anInt10899 != -1) {
			@Pc(26) Material local26 = this.aClass19_Sub1_23.anInterface4_10.method6824(this.anInt10899);
		...
		if (this.aClass19_Sub1_23.anInt9204 == 0) {
