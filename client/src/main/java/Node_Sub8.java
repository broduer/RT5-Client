...
public final class Node_Sub8 extends Node {
	...
	public Node_Sub8(@OriginalArg(0) Buffer arg0) {
		...
		@Pc(533) Buffer local533 = new Buffer(this.aByteArray12);
	...
	public void method1154() {
		...
		this.aClass28_8 = new HashTable(16);
				...
				while (local30.anIntArray70[local52] == local57) {
					...
					if (local84 == 144) {
						...
						if (local103 > 0) {
							...
							@Pc(190) Node_Sub55 local190 = (Node_Sub55) this.aClass28_8.get(local182);
							if (local190 == null) {
								local190 = new Node_Sub55(new byte[128]);
								this.aClass28_8.put(local182, local190);
							}
