...
public final class ObjType {
	...
	public ObjTypeList aClass112_2;
	...
	public ObjType method8797(@OriginalArg(0) int arg0) {
		if (this.anIntArray799 != null && arg0 > 1) {
			...
			if (local23 != -1) {
				return this.aClass112_2.get(local23);
			}
		}
		return this;
	}
	...
	public void method8798(@OriginalArg(0) Buffer arg0) {
		while (true) {
	...
	public void method8799(@OriginalArg(1) ObjType arg0, @OriginalArg(2) ObjType arg1) {
		...
		this.aStringArray45[4] = Static32.aClass32_6.getLocalization(this.aClass112_2.anInt2671);
	}

	@OriginalMember(owner = "client!vfa", name = "a", descriptor = "(Lclient!vfa;ILclient!vfa;)V")
	public void method8800(@OriginalArg(0) ObjType arg0, @OriginalArg(2) ObjType arg1) {
	...
	public int method8801(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.aClass28_44 == null) {
			...
			@Pc(19) Node_Sub38 local19 = (Node_Sub38) this.aClass28_44.get(arg0);
	...
	private void method8804(@OriginalArg(0) Buffer arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 1) {
			this.anInt10148 = arg0.g2();
		} else if (arg1 == 2) {
			this.aString118 = arg0.gstr();
		} else if (arg1 == 4) {
			this.anInt10125 = arg0.g2();
		} else if (arg1 == 5) {
			this.anInt10134 = arg0.g2();
		} else if (arg1 == 6) {
			this.anInt10123 = arg0.g2();
		} else if (arg1 == 7) {
			this.anInt10154 = arg0.g2();
			...
			this.anInt10170 = arg0.g4();
		} else if (arg1 == 16) {
			this.aBoolean771 = true;
		} else if (arg1 == 18) {
			this.anInt10130 = arg0.g2();
		} else if (arg1 == 23) {
			this.anInt10111 = arg0.g2();
		} else if (arg1 == 24) {
			this.anInt10129 = arg0.g2();
		} else if (arg1 == 25) {
			this.anInt10131 = arg0.g2();
		} else if (arg1 == 26) {
			this.anInt10133 = arg0.g2();
		} else if (arg1 >= 30 && arg1 < 35) {
			this.aStringArray46[arg1 - 30] = arg0.gstr();
		} else if (arg1 >= 35 && arg1 < 40) {
			this.aStringArray45[arg1 - 35] = arg0.gstr();
		} else {
			@Pc(202) int local202;
			@Pc(212) int local212;
			if (arg1 == 40) {
				...
				for (local212 = 0; local212 < local202; local212++) {
					...
					this.aShortArray138[local212] = (short) arg0.g2();
				}
			} else if (arg1 == 42) {
				local202 = arg0.g1();
				...
				this.anInt10122 = arg0.g2();
			} else if (arg1 == 79) {
				this.anInt10163 = arg0.g2();
			} else if (arg1 == 90) {
				this.anInt10161 = arg0.g2();
			} else if (arg1 == 91) {
				this.anInt10119 = arg0.g2();
			} else if (arg1 == 92) {
				this.anInt10138 = arg0.g2();
			} else if (arg1 == 93) {
				this.anInt10147 = arg0.g2();
			} else if (arg1 == 95) {
				this.anInt10121 = arg0.g2();
			} else if (arg1 == 96) {
				this.anInt10128 = arg0.g1();
			} else if (arg1 == 97) {
				this.anInt10137 = arg0.g2();
			} else if (arg1 == 98) {
				...
				this.anInt10153 = arg0.g2();
			} else if (arg1 == 111) {
				this.anInt10159 = arg0.g2();
			} else if (arg1 == 112) {
				this.anInt10146 = arg0.g2();
			} else if (arg1 == 113) {
				this.anInt10127 = arg0.g1b();
			} else if (arg1 == 114) {
				this.anInt10136 = arg0.g1b() * 5;
			} else if (arg1 == 115) {
				this.anInt10149 = arg0.g1();
			} else if (arg1 == 121) {
				this.anInt10171 = arg0.g2();
			} else if (arg1 == 122) {
				this.anInt10110 = arg0.g2();
			} else if (arg1 == 125) {
				this.anInt10175 = arg0.g1b() << 2;
				this.anInt10174 = arg0.g1b() << 2;
				this.anInt10145 = arg0.g1b() << 2;
			} else if (arg1 == 126) {
				this.anInt10140 = arg0.g1b() << 2;
				this.anInt10143 = arg0.g1b() << 2;
				this.anInt10164 = arg0.g1b() << 2;
			} else if (arg1 == 127) {
				this.anInt10157 = arg0.g1();
				this.anInt10139 = arg0.g2();
			} else if (arg1 == 128) {
				this.anInt10108 = arg0.g1();
				this.anInt10109 = arg0.g2();
			} else if (arg1 == 129) {
				this.anInt10150 = arg0.g1();
				this.anInt10116 = arg0.g2();
			} else if (arg1 == 130) {
				this.anInt10120 = arg0.g1();
				this.anInt10118 = arg0.g2();
			} else if (arg1 == 132) {
				local202 = arg0.g1();
				...
				this.anInt10166 = arg0.g1();
			} else if (arg1 == 139) {
				this.anInt10141 = arg0.g2();
			} else if (arg1 == 140) {
				this.anInt10172 = arg0.g2();
			} else if (arg1 == 249) {
				local202 = arg0.g1();
				if (this.aClass28_44 == null) {
					local212 = Static440.method5969(local202);
					this.aClass28_44 = new HashTable(local212);
				}
				for (local212 = 0; local212 < local202; local212++) {
					...
					if (local554) {
						local567 = new Node_Sub24(arg0.gstr());
					} else {
						local567 = new Node_Sub38(arg0.g4());
					}
					this.aClass28_44.put(local558, local567);
				}
			}
		}
	}
	...
	public int[] method8805(@OriginalArg(0) int arg0, @OriginalArg(1) Class19 arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) boolean arg4, @OriginalArg(6) Class203 arg5, @OriginalArg(7) Class19 arg6, @OriginalArg(8) Class14 arg7, @OriginalArg(9) int arg8) {
		...
		if (this.anInt10114 != -1) {
			local272 = this.aClass112_2.createSprite(1, arg6, arg1, arg5, true, 0, 10, true, 0, arg7, this.anInt10137);
			if (local272 == null) {
				return null;
			}
		} else if (this.anInt10110 != -1) {
			local272 = this.aClass112_2.createSprite(arg8, arg6, arg1, arg5, true, arg3, arg2, false, 0, arg7, this.anInt10171);
			if (local272 == null) {
				return null;
			}
		} else if (this.anInt10172 != -1) {
			local272 = this.aClass112_2.createSprite(arg8, arg6, arg1, arg5, true, arg3, arg2, false, 0, arg7, this.anInt10141);
			if (local272 == null) {
				return null;
			}
		}
		...
		local414.method7141(this.anInt10154 << 2, (Class114_Sub1.anIntArray741[this.anInt10134 << 3] * local363 >> 14) + (this.anInt10126 << 2) - (local244.fa() / 2), (Class114_Sub1.anIntArray740[this.anInt10134 << 3] * local363 >> 14) - -(this.anInt10126 << 2));
	...
	public String method8807(@OriginalArg(0) String arg0, @OriginalArg(2) int arg1) {
		if (this.aClass28_44 == null) {
			...
			@Pc(17) Node_Sub24 local17 = (Node_Sub24) this.aClass28_44.get(arg1);
	...
	private String method8810(@OriginalArg(1) int arg0) {
		if (arg0 < 100000) {
			...
			return "<col=ffffff>" + arg0 / 1000 + Static32.aClass32_36.getLocalization(this.aClass112_2.anInt2671) + "</col>";
		} else {
			return "<col=00ff80>" + arg0 / 1000000 + Static32.aClass32_34.getLocalization(this.aClass112_2.anInt2671) + "</col>";
		}
	}
	...
	public Class114 method8812(@OriginalArg(0) Class152 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class203 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Class19 arg4) {
		...
		if (this.anIntArray799 != null && arg3 > 1) {
			...
			if (local17 != -1) {
				return this.aClass112_2.get(local17).method8812(arg0, arg1, arg2, 1, arg4);
			}
		}
		local17 = arg1;
		if (arg0 != null) {
		...
		@Pc(87) SoftLruHashTable local87 = this.aClass112_2.aClass82_58;
		@Pc(104) Class114 local104;
		synchronized (this.aClass112_2.aClass82_58) {
			local104 = (Class114) this.aClass112_2.aClass82_58.get(this.anInt10162 | arg4.anInt8986 << 29);
		}
		if (local104 == null || arg4.method7967(local104.ua(), local17) != 0) {
			...
			local104.s(local17);
			@Pc(426) SoftLruHashTable local426 = this.aClass112_2.aClass82_58;
			synchronized (this.aClass112_2.aClass82_58) {
				this.aClass112_2.aClass82_58.put(local104, this.anInt10162 | arg4.anInt8986 << 29);
			}
		}
		if (arg0 != null) {
	...
	public void method8816(@OriginalArg(0) ObjType arg0, @OriginalArg(2) ObjType arg1) {
		this.anInt10170 = 0;
		...
		this.aStringArray45[4] = Static32.aClass32_7.getLocalization(this.aClass112_2.anInt2671);
	}
}
