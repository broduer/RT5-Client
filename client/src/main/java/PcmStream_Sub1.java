...
public final class PcmStream_Sub1 extends PcmStream {
	...
	private final LinkedList aClass341_80 = new LinkedList();
	...
	public PcmStream_Sub1(@OriginalArg(0) int arg0) {
	...
	public synchronized double method9144(@OriginalArg(0) boolean arg0) {
		...
		@Pc(16) SecondaryNode_Sub8 local16 = (SecondaryNode_Sub8) this.aClass341_80.head();
		if (local16 == null) {
			return -1.0D;
		} else {
			if (arg0) {
	...
	public synchronized void skip(@OriginalArg(0) int arg0) {
		...
		while (true) {
			@Pc(14) SecondaryNode_Sub8 local14 = this.method9152();
			if (local14 == null) {
				if (this.aBoolean796) {
					this.unlink();
					Static341.aClass363_1.clear();
				}
				return;
			}
	...
	public SecondaryNode_Sub8 method9149(@OriginalArg(0) int arg0, @OriginalArg(1) double arg1) {
		@Pc(11) long local11 = arg0 | this.anInt10549 << 0;
		@Pc(17) SecondaryNode_Sub8 local17 = (SecondaryNode_Sub8) Static341.aClass363_1.get(local11);
		if (local17 == null) {
			local17 = new SecondaryNode_Sub8(new short[this.anInt10549][arg0], arg1);
		} else {
	...
	public synchronized void method9150(@OriginalArg(0) SecondaryNode_Sub8 arg0) {
		while (this.anInt10563 >= 100) {
			this.aClass341_80.removeHead();
			this.anInt10563--;
		}
		this.aClass341_80.insertBefore(arg0);
		if (-73 != -73) {
	...
	private synchronized void method9151() {
		@Pc(7) SecondaryNode_Sub8 local7 = this.method9152();
		if (local7 != null) {
			local7.unlink();
			this.anInt10563--;
			this.anInt10564 = 0;
			Static341.aClass363_1.put(local7, local7.method2133());
		}
	}
	...
	private synchronized SecondaryNode_Sub8 method9152() {
		return (SecondaryNode_Sub8) this.aClass341_80.head();
	}
	...
	public synchronized void read(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		if (this.method9152() != null) {
			...
			while (arg1 < local32) {
				@Pc(56) SecondaryNode_Sub8 local56 = this.method9152();
				if (local56 == null) {
					return;
				}
