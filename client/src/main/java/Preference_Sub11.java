...
public final class Preference_Sub11 extends Preference {

	@OriginalMember(owner = "client!hr", name = "<init>", descriptor = "(Lclient!kv;)V")
	public Preference_Sub11(@OriginalArg(0) Preferences arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!hr", name = "<init>", descriptor = "(ILclient!kv;)V")
	public Preference_Sub11(@OriginalArg(0) int arg0, @OriginalArg(1) Preferences arg1) {
		super(arg0, arg1);
	}
