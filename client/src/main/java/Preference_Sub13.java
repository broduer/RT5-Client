...
public final class Preference_Sub13 extends Preference {

	@OriginalMember(owner = "client!jha", name = "<init>", descriptor = "(Lclient!kv;)V")
	public Preference_Sub13(@OriginalArg(0) Preferences arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!jha", name = "<init>", descriptor = "(ILclient!kv;)V")
	public Preference_Sub13(@OriginalArg(0) int arg0, @OriginalArg(1) Preferences arg1) {
		super(arg0, arg1);
	}
