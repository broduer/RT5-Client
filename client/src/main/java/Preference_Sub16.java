...
public final class Preference_Sub16 extends Preference {

	@OriginalMember(owner = "client!mea", name = "<init>", descriptor = "(Lclient!kv;)V")
	public Preference_Sub16(@OriginalArg(0) Preferences arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!mea", name = "<init>", descriptor = "(ILclient!kv;)V")
	public Preference_Sub16(@OriginalArg(0) int arg0, @OriginalArg(1) Preferences arg1) {
		super(arg0, arg1);
	}
