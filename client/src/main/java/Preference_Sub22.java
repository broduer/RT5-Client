...
public final class Preference_Sub22 extends Preference {

	@OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(ILclient!kv;)V")
	public Preference_Sub22(@OriginalArg(0) int arg0, @OriginalArg(1) Preferences arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Lclient!kv;)V")
	public Preference_Sub22(@OriginalArg(0) Preferences arg0) {
		super(arg0);
	}
