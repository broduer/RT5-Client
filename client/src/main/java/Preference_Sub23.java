...
public final class Preference_Sub23 extends Preference {

	@OriginalMember(owner = "client!qia", name = "<init>", descriptor = "(ILclient!kv;)V")
	public Preference_Sub23(@OriginalArg(0) int arg0, @OriginalArg(1) Preferences arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!qia", name = "<init>", descriptor = "(Lclient!kv;)V")
	public Preference_Sub23(@OriginalArg(0) Preferences arg0) {
		super(arg0);
	}
