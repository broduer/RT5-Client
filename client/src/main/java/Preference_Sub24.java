...
public final class Preference_Sub24 extends Preference {

	@OriginalMember(owner = "client!qka", name = "<init>", descriptor = "(Lclient!kv;)V")
	public Preference_Sub24(@OriginalArg(0) Preferences arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!qka", name = "<init>", descriptor = "(ILclient!kv;)V")
	public Preference_Sub24(@OriginalArg(0) int arg0, @OriginalArg(1) Preferences arg1) {
		super(arg0, arg1);
	}
