...
public final class Preference_Sub6 extends Preference {

	@OriginalMember(owner = "client!fia", name = "<init>", descriptor = "(Lclient!kv;)V")
	public Preference_Sub6(@OriginalArg(0) Preferences arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!fia", name = "<init>", descriptor = "(ILclient!kv;)V")
	public Preference_Sub6(@OriginalArg(0) int arg0, @OriginalArg(1) Preferences arg1) {
		super(arg0, arg1);
	}
