...
public final class Preferences extends Node {
	...
	private final ModeGame aClass379_3;
	...
	public Preferences(@OriginalArg(0) Buffer arg0, @OriginalArg(1) ModeGame arg1, @OriginalArg(2) int arg2) {
	...
	private void method5109(@OriginalArg(0) Buffer buf) {
		if (buf == null || buf.data == null) {
			this.method5110(true);
		} else {
			@Pc(24) int local24 = buf.g1();
			if (local24 < 23) {
				try {
					this.method5119(local24, buf);
				} catch (@Pc(34) Exception local34) {
					this.method5110(true);
				}
				this.method5110(false);
			} else if (local24 <= 25) {
				this.aClass57_Sub13_2 = new Class57_Sub13(buf.g1(), this);
				this.aClass57_Sub13_1 = new Class57_Sub13(this.aClass57_Sub13_2.method4380(), this);
				this.aClass57_Sub20_1 = new Class57_Sub20(buf.g1(), this);
				this.aClass57_Sub22_1 = new Class57_Sub22(buf.g1(), this);
				this.aClass57_Sub5_1 = new Class57_Sub5(buf.g1(), this);
				this.aClass57_Sub8_1 = new Class57_Sub8(buf.g1(), this);
				this.aClass57_Sub16_1 = new Class57_Sub16(buf.g1(), this);
				this.aClass57_Sub23_1 = new Class57_Sub23(buf.g1(), this);
				this.aClass57_Sub6_1 = new Class57_Sub6(buf.g1(), this);
				this.aClass57_Sub27_1 = new Class57_Sub27(buf.g1(), this);
				this.aClass57_Sub24_1 = new Class57_Sub24(buf.g1(), this);
				this.aClass57_Sub12_1 = new Class57_Sub12(buf.g1(), this);
				if (local24 >= 24) {
					this.aClass57_Sub3_1 = new Class57_Sub3(buf.g1(), this);
				}
				this.aClass57_Sub28_1 = new Class57_Sub28(buf.g1(), this);
				this.aClass57_Sub4_1 = new Class57_Sub4(buf.g1(), this);
				this.aClass57_Sub4_2 = new Class57_Sub4(this.aClass57_Sub4_1.method2143(), this);
				this.aClass57_Sub18_1 = new Class57_Sub18(buf.g1(), this);
				if (local24 >= 25) {
					this.aClass57_Sub2_1 = new Class57_Sub2(buf.g1(), this);
				}
				this.aClass57_Sub7_1 = new Class57_Sub7(buf.g1(), this);
				this.aClass57_Sub9_1 = new Class57_Sub9(buf.g1(), this);
				this.aClass57_Sub30_1 = new Class57_Sub30(buf.g1(), this);
				this.aClass57_Sub29_2 = new Class57_Sub29(buf.g1(), this);
				this.aClass57_Sub29_1 = new Class57_Sub29(this.aClass57_Sub29_2.method7922(), this);
				this.aClass57_Sub19_1 = new Class57_Sub19(buf.g1(), this);
				this.aClass57_Sub19_2 = new Class57_Sub19(this.aClass57_Sub19_1.method5967(), this);
				this.aClass57_Sub26_1 = new Class57_Sub26(buf.g1(), this);
				this.aClass57_Sub1_1 = new Class57_Sub1(buf.g1(), this);
				this.aClass57_Sub1_2 = new Class57_Sub1(this.aClass57_Sub1_1.method1485(), this);
				this.aClass57_Sub14_1 = new Class57_Sub14(buf.g1(), this);
				this.aClass57_Sub15_1 = new Class57_Sub15(buf.g1(), this);
				this.aClass57_Sub21_1 = new Class57_Sub21(buf.g1(), this);
				this.aClass57_Sub11_1 = new Class57_Sub11(buf.g1(), this);
				this.aClass57_Sub10_1 = new Class57_Sub10(buf.g1(), this);
				this.aClass57_Sub25_4 = new Class57_Sub25(buf.g1(), this);
				this.aClass57_Sub25_1 = new Class57_Sub25(buf.g1(), this);
				this.aClass57_Sub25_3 = new Class57_Sub25(buf.g1(), this);
				this.aClass57_Sub25_2 = new Class57_Sub25(buf.g1(), this);
				this.aClass57_Sub25_5 = new Class57_Sub25(buf.g1(), this);
				this.aClass57_Sub17_1 = new Class57_Sub17(buf.g1(), this);
				this.method5110(false);
			} else {
				this.method5110(true);
			}
	...
	public Buffer encode() {
		@Pc(9) Buffer buf = new Buffer(Static368.method5276());
		buf.p1(25);
		buf.p1(this.aClass57_Sub13_2.method4380());
		buf.p1(this.aClass57_Sub20_1.method6115());
		buf.p1(this.aClass57_Sub22_1.method6776());
		buf.p1(this.aClass57_Sub5_1.method2172());
		buf.p1(this.aClass57_Sub8_1.method3176());
		buf.p1(this.aClass57_Sub16_1.method5514());
		buf.p1(this.aClass57_Sub23_1.method7061());
		buf.p1(this.aClass57_Sub6_1.method2714());
		buf.p1(this.aClass57_Sub27_1.method7674());
		buf.p1(this.aClass57_Sub24_1.method7089());
		buf.p1(this.aClass57_Sub12_1.method4371());
		buf.p1(this.aClass57_Sub3_1.method2120());
		buf.p1(this.aClass57_Sub28_1.method7845());
		buf.p1(this.aClass57_Sub4_1.method2143());
		buf.p1(this.aClass57_Sub18_1.method5774());
		buf.p1(this.aClass57_Sub2_1.method1989());
		buf.p1(this.aClass57_Sub7_1.method2905());
		buf.p1(this.aClass57_Sub9_1.method3199());
		buf.p1(this.aClass57_Sub30_1.method8363());
		buf.p1(this.aClass57_Sub29_2.method7922());
		buf.p1(this.aClass57_Sub19_1.method5967());
		buf.p1(this.aClass57_Sub26_1.method7470());
		buf.p1(this.aClass57_Sub1_1.method1485());
		buf.p1(this.aClass57_Sub14_1.method5309());
		buf.p1(this.aClass57_Sub15_1.method5327());
		buf.p1(this.aClass57_Sub21_1.method6367());
		buf.p1(this.aClass57_Sub11_1.method3603());
		buf.p1(this.aClass57_Sub10_1.method3519());
		buf.p1(this.aClass57_Sub25_4.method7215());
		buf.p1(this.aClass57_Sub25_1.method7215());
		buf.p1(this.aClass57_Sub25_3.method7215());
		buf.p1(this.aClass57_Sub25_2.method7215());
		buf.p1(this.aClass57_Sub25_5.method7215());
		buf.p1(this.aClass57_Sub17_1.method5674());
		return buf;
	}
	...
	private void method5119(@OriginalArg(1) int arg0, @OriginalArg(2) Buffer arg1) {
		...
		if (arg0 >= 21) {
			this.aClass57_Sub25_5 = new Class57_Sub25(arg1.g1(), this);
		} else {
