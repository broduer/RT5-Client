...
public final class QuestType {
	...
	private void method5132(@OriginalArg(0) int arg0, @OriginalArg(1) Buffer arg1) {
		if (arg0 == 1) {
			...
			if (arg0 == 3) {
				...
				if (arg0 == 9) {
					...
					for (local36 = 0; local36 < local29; local36++) {
						...
						this.aStringArray28[local36] = arg1.gstr();
					}
				} else if (arg0 == 19) {
					local29 = arg1.g1();
					...
					for (local36 = 0; local36 < local29; local36++) {
						...
						this.aStringArray27[local36] = arg1.gstr();
					}
				} else if (arg0 == 249) {
					local29 = arg1.g1();
					if (this.aClass28_30 == null) {
						local36 = Static440.method5969(local29);
						this.aClass28_30 = new HashTable(local36);
					}
					for (local36 = 0; local36 < local29; local36++) {
						...
						if (local224) {
							local237 = new Node_Sub24(arg1.gstr());
						} else {
							local237 = new Node_Sub38(arg1.g4());
						}
						this.aClass28_30.put(local228, local237);
					}
				}
			}
		}
	...
	public void method5134(@OriginalArg(0) Buffer arg0) {
		while (true) {
