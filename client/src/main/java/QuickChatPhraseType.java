...
public final class QuickChatPhraseType extends SecondaryNode {
	...
	public void method3899(@OriginalArg(0) Buffer arg0) {
		while (true) {
	...
	public String method3903(@OriginalArg(1) Buffer arg0) {
	...
	public void method3904(@OriginalArg(0) Buffer arg0, @OriginalArg(1) int[] arg1) {
		if (this.anIntArray331 == null) {
			return;
		}
		for (@Pc(15) int local15 = 0; local15 < this.anIntArray331.length; local15++) {
	...
	@OriginalMember(owner = "client!ih", name = "a", descriptor = "(Lclient!ge;II)V")
	private void method3907(@OriginalArg(0) Buffer arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 1) {
			this.aStringArray23 = Static189.method2861(arg0.gstr(), '<');
			return;
		}
		@Pc(21) int local21;
		@Pc(27) int local27;
