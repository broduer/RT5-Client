...
public final class QuickChatPhraseTypeList {
	...
	private final Js5 aClass332_40;

	@OriginalMember(owner = "client!gba", name = "b", descriptor = "Lclient!sb;")
	private final Js5 aClass332_41;

	@OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(ILclient!sb;Lclient!sb;Lclient!raa;)V")
	public QuickChatPhraseTypeList(@OriginalArg(0) int arg0, @OriginalArg(1) Js5 arg1, @OriginalArg(2) Js5 arg2, @OriginalArg(3) Interface19 arg3) {
		this.anInterface19_1 = arg3;
		this.aClass332_40 = arg1;
		this.aClass332_41 = arg2;
		if (this.aClass332_40 != null) {
			this.anInt3273 = this.aClass332_40.getGroupCapacity(1);
		}
		if (this.aClass332_41 != null) {
			this.anInt3270 = this.aClass332_41.getGroupCapacity(1);
		}
	}
	...
	public String method2948(@OriginalArg(0) Class184 arg0, @OriginalArg(1) long arg1, @OriginalArg(2) int[] arg2) {
		if (this.anInterface19_1 != null) {
			@Pc(22) String local22 = this.anInterface19_1.method5638(arg1, arg0, arg2);
			if (local22 != null) {
				return local22;
			}
		}
	...
	public QuickChatPhraseType method2950(@OriginalArg(0) int arg0) {
		@Pc(11) QuickChatPhraseType local11 = (QuickChatPhraseType) this.aClass82_70.get(arg0);
		if (local11 != null) {
			return local11;
		}
		@Pc(28) byte[] local28;
		if (arg0 >= 32768) {
			local28 = this.aClass332_41.fetchFile(arg0 & 0x7FFF, 1);
		} else {
			local28 = this.aClass332_40.fetchFile(arg0, 1);
		}
		local11 = new QuickChatPhraseType();
		local11.aClass139_1 = this;
		if (local28 != null) {
			local11.method3899(new Buffer(local28));
		}
		if (arg0 >= 32768) {
			local11.method3902();
		}
		this.aClass82_70.put(local11, arg0);
		return local11;
	}
}
