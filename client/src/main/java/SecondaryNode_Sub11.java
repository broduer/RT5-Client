...
public abstract class SecondaryNode_Sub11 extends SecondaryNode {

	@OriginalMember(owner = "client!pv", name = "u", descriptor = "I")
	public final int anInt9471;
	...
	protected SecondaryNode_Sub11(@OriginalArg(0) Interface24 arg0, @OriginalArg(1) int arg1) {
		this.anInt9471 = arg1;
		this.anInterface24_3 = arg0;
	}

	@OriginalMember(owner = "client!pv", name = "a", descriptor = "(I)Ljava/lang/Object;")
	public abstract Object method8318();

	@OriginalMember(owner = "client!pv", name = "c", descriptor = "(B)Z")
	public abstract boolean method8321();
}
