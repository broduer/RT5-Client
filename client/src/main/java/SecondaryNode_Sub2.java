...
public final class SecondaryNode_Sub2 extends SecondaryNode {
	...
	public SecondaryNode_Sub2(@OriginalArg(0) int arg0, @OriginalArg(1) long arg1) {
	...
	public void method202() {
		...
		if (this.method201() == (long) 0) {
			Static138.aClass194_6.addTail(this);
		}
	}
	...
	public void method205() {
		super.secondaryKey = Static588.currentTimeMillis() + 500L | super.secondaryKey & Long.MIN_VALUE;
		Static59.aClass194_9.addTail(this);
	}
}
