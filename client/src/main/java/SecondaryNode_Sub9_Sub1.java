...
public final class SecondaryNode_Sub9_Sub1 extends SecondaryNode_Sub9 {
	...
	public SecondaryNode_Sub9_Sub1(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	public void method2194(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.anInt2335 = arg3;
		this.anInt2334 = arg1 - arg0;
		this.anInt2329 = arg2 - arg3;
		this.anInt2337 = arg0;
	}
		...
		if (arg4 <= arg3 && arg4 <= arg5) {
			if (arg3 < arg5) {
					...
					while (true) {
						...
						if (arg3 < 0) {
							while (true) {
								...
								Static368.method5277(arg0 >> 16, this.aByteArray22, arg4, arg1 >> 16);
								arg0 += local44;
								arg1 += local23;
								arg4 += this.anInt2329;
							}
						}
						Static368.method5277(arg0 >> 16, this.aByteArray22, arg4, arg2 >> 16);
						arg4 += this.anInt2329;
						arg0 += local44;
						arg2 += local7;
					}
					...
					while (true) {
						...
						if (arg3 < 0) {
							while (true) {
								...
								Static368.method5277(arg1 >> 16, this.aByteArray22, arg4, arg0 >> 16);
								arg4 += this.anInt2329;
								arg0 += local44;
								arg1 += local23;
							}
						}
						Static368.method5277(arg2 >> 16, this.aByteArray22, arg4, arg0 >> 16);
						arg2 += local7;
						arg4 += this.anInt2329;
						arg0 += local44;
					}
				...
				if ((arg4 == arg5 || local7 <= local44) && (arg4 != arg5 || local23 <= local7)) {
					...
					while (true) {
						...
						Static368.method5277(arg2 >> 16, this.aByteArray22, arg4, arg1 >> 16);
						arg4 += this.anInt2329;
						arg2 += local7;
						arg1 += local44;
					}
					...
					while (true) {
						...
						Static368.method5277(arg1 >> 16, this.aByteArray22, arg4, arg2 >> 16);
						arg1 += local44;
						arg2 += local7;
						arg4 += this.anInt2329;
					}
			...
			if (arg4 > arg5) {
					...
					while (true) {
						...
						if (arg5 < 0) {
							while (true) {
								...
								Static368.method5277(arg2 >> 16, this.aByteArray22, arg3, arg0 >> 16);
								arg2 += local7;
								arg0 += local44;
								arg3 += this.anInt2329;
							}
						}
						Static368.method5277(arg2 >> 16, this.aByteArray22, arg3, arg1 >> 16);
						arg2 += local7;
						arg1 += local23;
						arg3 += this.anInt2329;
					}
					...
					while (true) {
						...
						if (arg5 < 0) {
							while (true) {
								...
								Static368.method5277(arg0 >> 16, this.aByteArray22, arg3, arg2 >> 16);
								arg0 += local44;
								arg2 += local7;
								arg3 += this.anInt2329;
							}
						}
						Static368.method5277(arg1 >> 16, this.aByteArray22, arg3, arg2 >> 16);
						arg1 += local23;
						arg3 += this.anInt2329;
						arg2 += local7;
					}
				...
				if (local7 < local23) {
					...
					while (true) {
						...
						Static368.method5277(arg0 >> 16, this.aByteArray22, arg3, arg1 >> 16);
						arg3 += this.anInt2329;
						arg0 += local7;
						arg1 += local23;
					}
					...
					while (true) {
						...
						Static368.method5277(arg1 >> 16, this.aByteArray22, arg3, arg0 >> 16);
						arg0 += local7;
						arg1 += local23;
						arg3 += this.anInt2329;
					}
				...
				while (true) {
					...
					if (arg4 < 0) {
						while (true) {
							...
							Static368.method5277(arg1 >> 16, this.aByteArray22, arg5, arg2 >> 16);
							arg5 += this.anInt2329;
							arg2 += local7;
							arg1 += local23;
						}
					}
					Static368.method5277(arg1 >> 16, this.aByteArray22, arg5, arg0 >> 16);
					arg1 += local23;
					arg0 += local44;
					arg5 += this.anInt2329;
				}
				...
				while (true) {
					...
					if (arg4 < 0) {
						while (true) {
							...
							Static368.method5277(arg2 >> 16, this.aByteArray22, arg5, arg1 >> 16);
							arg2 += local7;
							arg1 += local23;
							arg5 += this.anInt2329;
						}
					}
					Static368.method5277(arg0 >> 16, this.aByteArray22, arg5, arg1 >> 16);
					arg5 += this.anInt2329;
					arg1 += local23;
					arg0 += local44;
				}
			...
			if (local44 <= local23) {
				...
				while (true) {
					...
					Static368.method5277(arg0 >> 16, this.aByteArray22, arg5, arg2 >> 16);
					arg0 += local44;
					arg2 += local23;
					arg5 += this.anInt2329;
				}
				...
				while (true) {
					...
					Static368.method5277(arg2 >> 16, this.aByteArray22, arg5, arg0 >> 16);
					arg5 += this.anInt2329;
					arg2 += local23;
					arg0 += local44;
				}
