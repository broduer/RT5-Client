...
public final class SkyBoxTypeList {
	...
	private final SoftLruHashTable aClass82_168 = new SoftLruHashTable(16);

	@OriginalMember(owner = "client!qk", name = "j", descriptor = "Lclient!sb;")
	private final Js5 aClass332_100;
	...
	public SkyBoxTypeList(@OriginalArg(0) ModeGame arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Js5 arg2) {
		...
		this.aClass332_100.getGroupCapacity(29);
	}
	...
	private SkyBoxType method7077(@OriginalArg(0) int arg0) {
		@Pc(22) SkyBoxType local22;
		synchronized (this.aClass82_168) {
			local22 = (SkyBoxType) this.aClass82_168.get(arg0);
		}
		if (local22 != null) {
			return local22;
		}
		...
		synchronized (this.aClass332_100) {
			local45 = this.aClass332_100.fetchFile(arg0, 29);
		}
		local22 = new SkyBoxType();
		if (local45 != null) {
			local22.method2447(new Buffer(local45));
		}
		synchronized (this.aClass82_168) {
			this.aClass82_168.put(local22, arg0);
			return local22;
		}
	}
	...
	public Class148 method7079(@OriginalArg(0) SkyBoxSphereTypeList arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(13) Class218[] local13 = null;
		@Pc(18) SkyBoxType local18 = this.method7077(arg2);
