...
public final class SoundPcmStream extends PcmStream {
	...
	private int method3309(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		do {
			if (this.anInt3694 <= 0) {
				if (this.anInt3689 == -256 && (this.anInt3696 & 0xFF) == 0) {
					if (AudioChannel.stereo) {
						return Static730.method3334(((PcmSound) super.aSound_6).aByteArray98, arg0, this.anInt3696, arg1, this.anInt3690, this.anInt3687, arg3, arg2, this);
					}
					return Static730.method3343(((PcmSound) super.aSound_6).aByteArray98, arg0, this.anInt3696, arg1, this.anInt3686, arg3, arg2, this);
				}
				if (AudioChannel.stereo) {
					return Static730.method3324(((PcmSound) super.aSound_6).aByteArray98, arg0, this.anInt3696, arg1, this.anInt3690, this.anInt3687, arg3, arg2, this, this.anInt3689, arg4);
				}
				return Static730.method3339(((PcmSound) super.aSound_6).aByteArray98, arg0, this.anInt3696, arg1, this.anInt3686, arg3, arg2, this, this.anInt3689, arg4);
			}
			...
			if (this.anInt3689 == -256 && (this.anInt3696 & 0xFF) == 0) {
				if (AudioChannel.stereo) {
					arg1 = Static730.method3342(((PcmSound) super.aSound_6).aByteArray98, arg0, this.anInt3696, arg1, this.anInt3690, this.anInt3687, this.anInt3693, this.anInt3697, local5, arg2, this);
				} else {
					arg1 = Static730.method3332(((PcmSound) super.aSound_6).aByteArray98, arg0, this.anInt3696, arg1, this.anInt3686, this.anInt3688, local5, arg2, this);
				}
			} else if (AudioChannel.stereo) {
				arg1 = Static730.method3326(((PcmSound) super.aSound_6).aByteArray98, arg0, this.anInt3696, arg1, this.anInt3690, this.anInt3687, this.anInt3693, this.anInt3697, local5, arg2, this, this.anInt3689, arg4);
			} else {
				arg1 = Static730.method3347(((PcmSound) super.aSound_6).aByteArray98, arg0, this.anInt3696, arg1, this.anInt3686, this.anInt3688, local5, arg2, this, this.anInt3689, arg4);
			}
			this.anInt3694 -= arg1;
			if (this.anInt3694 != 0) {
				return arg1;
	...
	public synchronized void read(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		@Pc(13) PcmSound local13 = (PcmSound) super.aSound_6;
	...
	public boolean method3311() {
		return this.anInt3696 < 0 || this.anInt3696 >= ((PcmSound) super.aSound_6).aByteArray98.length << 8;
	}
	...
	private int method3317(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		do {
			if (this.anInt3694 <= 0) {
				if (this.anInt3689 == 256 && (this.anInt3696 & 0xFF) == 0) {
					if (AudioChannel.stereo) {
						return Static730.method3329(((PcmSound) super.aSound_6).aByteArray98, arg0, this.anInt3696, arg1, this.anInt3690, this.anInt3687, arg3, arg2, this);
					}
					return Static730.method3310(((PcmSound) super.aSound_6).aByteArray98, arg0, this.anInt3696, arg1, this.anInt3686, arg3, arg2, this);
				}
				if (AudioChannel.stereo) {
					return Static730.method3312(((PcmSound) super.aSound_6).aByteArray98, arg0, this.anInt3696, arg1, this.anInt3690, this.anInt3687, arg3, arg2, this, this.anInt3689, arg4);
				}
				return Static730.method3316(((PcmSound) super.aSound_6).aByteArray98, arg0, this.anInt3696, arg1, this.anInt3686, arg3, arg2, this, this.anInt3689, arg4);
			}
			@Pc(5) int local5 = arg1 + this.anInt3694;
			if (local5 > arg3) {
				local5 = arg3;
			...
			if (this.anInt3689 == 256 && (this.anInt3696 & 0xFF) == 0) {
				if (AudioChannel.stereo) {
					arg1 = Static730.method3325(((PcmSound) super.aSound_6).aByteArray98, arg0, this.anInt3696, arg1, this.anInt3690, this.anInt3687, this.anInt3693, this.anInt3697, local5, arg2, this);
				} else {
					arg1 = Static730.method3321(((PcmSound) super.aSound_6).aByteArray98, arg0, this.anInt3696, arg1, this.anInt3686, this.anInt3688, local5, arg2, this);
				}
			} else if (AudioChannel.stereo) {
				arg1 = Static730.method3313(((PcmSound) super.aSound_6).aByteArray98, arg0, this.anInt3696, arg1, this.anInt3690, this.anInt3687, this.anInt3693, this.anInt3697, local5, arg2, this, this.anInt3689, arg4);
			} else {
				arg1 = Static730.method3331(((PcmSound) super.aSound_6).aByteArray98, arg0, this.anInt3696, arg1, this.anInt3686, this.anInt3688, local5, arg2, this, this.anInt3689, arg4);
			}
			this.anInt3694 -= arg1;
			if (this.anInt3694 != 0) {
				return arg1;
	...
	public synchronized void skip(@OriginalArg(0) int arg0) {
		...
		@Pc(71) PcmSound local71 = (PcmSound) super.aSound_6;
	...
	public synchronized void method3344(@OriginalArg(0) int arg0) {
		@Pc(7) int local7 = ((PcmSound) super.aSound_6).aByteArray98.length << 8;
		if (arg0 < -1) {
			arg0 = -1;
		}
		if (arg0 > local7) {
	...
	public int method9143() {
		...
		if (this.anInt3698 == 0) {
			local6 -= local6 * this.anInt3696 / (((PcmSound) super.aSound_6).aByteArray98.length << 8);
		} else if (this.anInt3698 >= 0) {
			local6 -= local6 * this.anInt3691 / ((PcmSound) super.aSound_6).aByteArray98.length;
		}
