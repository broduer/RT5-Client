...
public final class Static101 {
	...
	public static void method1266() {
		...
		for (@Pc(31) Class2_Sub51 local31 = (Class2_Sub51) Static717.aClass339_81.method5453(65280); local31 != null; local31 = (Class2_Sub51) Static717.aClass339_81.method5460()) {
	...
	public static void method1267(@OriginalArg(0) byte[][] arg0, @OriginalArg(2) Class306_Sub1 arg1) {
						...
						if (!arg1.aBoolean673 || local27 == 0) {
							...
							for (@Pc(67) int local67 = 0; local67 < Static89.anIntArray169.length; local67++) {
								if (Static89.anIntArray169[local67] == local65 && arg0[local67] != null) {
									arg1.method5594((local49 & 0x7) * 8, Static577.aClass110Array1, local1, Static163.aClass19_17, local6 * 8, local9 * 8, arg0[local67], local43, local27, (local55 & 0x7) * 8);
									break;
								}
							}
						}
