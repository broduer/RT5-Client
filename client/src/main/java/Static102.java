...
public final class Static102 {
	...
	public static int method1286(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg1 != -29754) {
			method1287((Class8_Sub2_Sub1) null, false);
		}
		...
		return Static246.aClass178Array1[local56].a(arg2, -121, (int) arg3);
	}

	@OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lclient!qf;Z)Z")
	public static boolean method1287(@OriginalArg(0) Class8_Sub2_Sub1 arg0, @OriginalArg(1) boolean arg1) {
		...
		for (@Pc(44) int local44 = arg0.aShort131; local44 <= arg0.aShort134; local44++) {
			for (local48 = arg0.aShort132; local48 <= arg0.aShort133; local48++) {
				@Pc(55) Class291 local55 = Static347.method3572(arg0.aByte144, local44, local48);
				if (local55 != null) {
					@Pc(61) Class286 local61 = Static223.method6529(arg0);
	...
	public static String method1288(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		if (arg2 > 36) {
			throw new IllegalArgumentException("Invalid radix:" + arg2);
		} else if (arg3 && arg1 >= 0) {
			if (arg0) {
				method1286(21, 69, -79, 83);
			}
			@Pc(51) int local51 = 2;
