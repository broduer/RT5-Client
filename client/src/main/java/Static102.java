...
public final class Static102 {
	...
	public static void method2022() {
		for (@Pc(15) int local15 = 0; local15 < 100; local15++) {
			Static489.aClass285Array1[local15] = null;
		}
	...
	public static int method2025(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		if (local21 < 0 || local25 < 0 || Static720.anInt10888 - 1 < local21 || Static501.anInt7591 - 1 < local25) {
			return 0;
		}
		...
		return Static246.aClass178Array1[local56].method7885(arg2, arg3);
	}
	...
	public static boolean method2026(@OriginalArg(0) Class8_Sub2_Sub1 arg0, @OriginalArg(1) boolean arg1) {
		...
		arg0.method9301();
		if (arg0.aShort131 < 0 || arg0.aShort132 < 0 || arg0.aShort134 >= Static619.anInt1573 || arg0.aShort133 >= Static662.anInt9869) {
			return false;
		}
		...
		for (@Pc(44) int local44 = arg0.aShort131; local44 <= arg0.aShort134; local44++) {
			for (local48 = arg0.aShort132; local48 <= arg0.aShort133; local48++) {
				@Pc(55) Class293 local55 = Static347.method5102(arg0.aByte144, local44, local48);
				if (local55 != null) {
					@Pc(61) Class288 local61 = Static223.method9102(arg0);
					@Pc(64) Class288 local64 = local55.aClass288_2;
					if (local64 == null) {
						local55.aClass288_2 = local61;
					} else {
						while (local64.aClass288_1 != null) {
							local64 = local64.aClass288_1;
						}
						local64.aClass288_1 = local61;
					}
		...
		if (arg1) {
			Static679.aClass8_Sub2_Sub1Array1[Static125.anInt2361++] = arg0;
		} else {
