...
public final class Static107 {
	...
	public static byte[] method1310(@OriginalArg(0) String arg0) {
		...
		if (local27 - 2 >= local6 || Static204.method2171(arg0.charAt(local27 - 2)) == -1) {
			local33 -= 2;
		} else if (local6 <= local27 - 1 || Static204.method2171(arg0.charAt(local27 - 1)) == -1) {
			local33--;
		}
		@Pc(84) byte[] local84 = new byte[local33];
		Static200.method2080(arg0, local84, 0);
		return local84;
	}
}
