...
public final class Static108 {
	...
	public static void method1315(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) Class367 arg2) {
		Static665.aClass367ArrayArray1[arg1][arg0] = arg2;
	}

	@OriginalMember(owner = "client!dga", name = "a", descriptor = "(Ljava/lang/String;ZC)I")
	public static int method1316(@OriginalArg(0) String arg0, @OriginalArg(2) char arg1) {
		@Pc(5) int local5 = 0;
