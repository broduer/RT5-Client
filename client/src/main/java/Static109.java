...
public final class Static109 {
	...
	public static void method1319(@OriginalArg(0) Class8_Sub2 arg0) {
		if (arg0 == null) {
			return;
		}
	...
	public static Class330 method1320(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		Static226.aClass47_Sub1Array8[arg1] = Static228.aClass262_1.method4107(local5, arg1, Static276.aClass9_1);
		Static226.aClass47_Sub1Array8[arg1].method4683();
		return new Class330(Static226.aClass47_Sub1Array8[arg1], arg0, arg2);
	}

	@OriginalMember(owner = "client!dh", name = "b", descriptor = "(II)Z")
	public static boolean method1321(@OriginalArg(0) int arg0) {
