...
public final class Static112 {
	...
	public static int method1343(@OriginalArg(1) Class8_Sub2_Sub1_Sub2 arg0) {
		...
		if (arg0.anInt10722 != -1) {
			...
			if (arg0.anInt10722 < 32768) {
				@Pc(54) Class2_Sub45 local54 = (Class2_Sub45) Static18.aClass28_2.method373((long) arg0.anInt10722);
				if (local54 != null) {
			...
			if (local24 != null) {
				...
				if (local67 != 0 || local74 != 0) {
					arg0.method6696((int) (Math.atan2((double) local67, (double) local74) * 2607.5945876176133D) & 0x3FFF);
				}
			}
		}
		if (arg0 instanceof Class8_Sub2_Sub1_Sub2_Sub1) {
			...
			if (local104.anInt1467 != -1 && (local104.anInt10764 == 0 || local104.anInt10763 > 0)) {
				local104.method6696(local104.anInt1467);
			...
			if (local138.anInt10774 != -1 && (local138.anInt10764 == 0 || local138.anInt10763 > 0)) {
				...
				if (local67 != 0 || local74 != 0) {
					local138.method6696((int) (Math.atan2((double) local67, (double) local74) * 2607.5945876176133D) & 0x3FFF);
				}
	...
	public static Class200 method1345(@OriginalArg(1) Class2_Sub21 arg0) {
		@Pc(7) int local7 = arg0.method5191();
