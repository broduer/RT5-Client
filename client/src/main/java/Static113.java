...
public final class Static113 {
	...
	public static void method1358(@OriginalArg(1) int arg0) {
	...
	public static void method1360(@OriginalArg(0) byte[] arg0, @OriginalArg(2) boolean arg1) {
		if (Static339.aClass2_Sub21_9 == null) {
			Static339.aClass2_Sub21_9 = new Class2_Sub21(20000);
		}
		Static339.aClass2_Sub21_9.method5195(arg0.length, arg0, 0);
		if (!arg1) {
			return;
		}
		Static681.method6370(Static339.aClass2_Sub21_9.aByteArray93);
		...
		for (@Pc(33) int local33 = Static494.anInt7396; local33 <= Static699.anInt10532; local33++) {
			@Pc(38) Class297_Sub1 local38 = Static615.method5839(local33);
			if (local38 != null) {
				Static343.aClass297_Sub1Array2[local31++] = local38;
			}
		}
		Static149.aBoolean221 = false;
		Static363.aLong219 = Static588.method5469();
