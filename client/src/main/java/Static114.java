...
public final class Static114 {
	...
	public static void method1366(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) long arg2, @OriginalArg(4) Class1 arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class158 arg7) {
		...
		if (local16 <= local37 * local37) {
			Static6.method64(arg5, arg3, Static174.aClass23Array4[arg4], arg6, arg0, arg7, arg1);
			return;
		}
		local37 -= 10;
		@Pc(64) int local64;
		...
		Static558.aClass23Array7[arg4].a((float) local136 + (float) arg7.anInt3802 / 2.0F + (float) arg1, (float) -local143 + (float) arg7.anInt3746 / 2.0F + (float) arg5, 4096, (int) (-local129 / 6.283185307179586D * 65535.0D));
	}

	@OriginalMember(owner = "client!dk", name = "a", descriptor = "(III)Lclient!tla;")
	public static Class8_Sub2_Sub4 method1368(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
