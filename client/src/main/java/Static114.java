...
public final class Static114 {
	...
	public static void method2132(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) long arg2, @OriginalArg(4) Class1 arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class158 arg7) {
		...
		@Pc(37) int local37 = Math.min(arg7.anInt3813 / 2, arg7.anInt3756 / 2);
		...
		Static558.aClass23Array7[arg4].method8193((float) local136 + (float) arg7.anInt3813 / 2.0F + (float) arg1, (float) -local143 + (float) arg7.anInt3756 / 2.0F + (float) arg5, 4096, (int) (-local129 / 6.283185307179586D * 65535.0D));
	}
