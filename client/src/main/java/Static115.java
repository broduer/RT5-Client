...
public final class Static115 {
	...
	public static void method1370(@OriginalArg(1) int arg0) {
		if (Static400.aClass2_Sub34_28.aClass57_Sub14_1.method3754() == 0) {
			arg0 = -1;
		}
		...
		if (arg0 != -1) {
			@Pc(28) Class389 local28 = Static354.aClass267_1.method4214(arg0);
			@Pc(32) Class407 local32 = local28.method6385();
			if (local32 == null) {
				arg0 = -1;
			} else {
				Static446.aClass390_6.method6436(local32.method6773(), local32.method6772(), Static434.aCanvas7, new Point(local28.anInt10303, local28.anInt10308), local32.method6767());
				Static470.anInt7112 = arg0;
			}
		}
		if (arg0 == -1 && Static470.anInt7112 != -1) {
			Static446.aClass390_6.method6436(-1, (int[]) null, Static434.aCanvas7, new Point(), -1);
