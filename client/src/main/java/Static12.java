...
public final class Static12 {
	...
	public static int method3629(@OriginalArg(0) String arg0) {
		return Static269.method2737(arg0, 16);
	}

	@OriginalMember(owner = "client!ah", name = "a", descriptor = "(BII[B)I")
	public static int method3630(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) byte[] arg2) {
		@Pc(11) int local11 = -1;
	...
	public static void method3631(@OriginalArg(0) Class2_Sub21 arg0) {
		while (true) {
			@Pc(20) int local20 = arg0.method5205();
			if (local20 == 0) {
				Static482.anInt7228 = arg0.method5191();
				Static134.anInt10330 = arg0.method5191();
			} else if (local20 == 255) {
				return;
			}
		}
