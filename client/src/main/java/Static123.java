...
public final class Static123 {
	...
	public static final SoftLruHashTable aClass82_53 = new SoftLruHashTable(8);
	...
	public static void method2210(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		...
		Static696.method9044(local49, arg0, arg4 - arg3, local44);
		@Pc(62) int local62 = arg4 + local15;
		Static696.method9044(local62, arg1, local49, local44);
		Static696.method9044(arg4 + arg3, arg0, local62, local44);
		while (local10 < local21) {
			...
			if (local24 >= 0) {
				...
				if (local21 < local15) {
					...
					Static696.method9044(local161, arg0, local152, local132);
					Static696.method9044(local156, arg1, local161, local132);
					Static696.method9044(local147, arg0, local156, local132);
					Static696.method9044(local161, arg0, local152, local139);
					Static696.method9044(local156, arg1, local161, local139);
					Static696.method9044(local147, arg0, local156, local139);
				} else {
					local132 = Static723.anIntArrayArray266[arg2 + local21];
					local139 = Static723.anIntArrayArray266[arg2 - local21];
					local143 = arg4 + local10;
					local147 = arg4 - local10;
					Static696.method9044(local143, arg0, local147, local132);
					Static696.method9044(local143, arg0, local147, local139);
				}
				local24 -= local21 << 1;
			}
			...
			if (local15 > local10) {
				...
				Static696.method9044(local161, arg0, local147, local132);
				Static696.method9044(local156, arg1, local161, local132);
				Static696.method9044(local143, arg0, local156, local132);
				Static696.method9044(local161, arg0, local147, local139);
				Static696.method9044(local156, arg1, local161, local139);
				Static696.method9044(local143, arg0, local156, local139);
			} else {
				Static696.method9044(local143, arg0, local147, local132);
				Static696.method9044(local143, arg0, local147, local139);
			}
