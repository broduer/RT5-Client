...
public final class Static124 {
	...
	public static Class330 aClass330_20;

	@OriginalMember(owner = "client!ds", name = "a", descriptor = "(B)V")
	public static void method1439() {
		Static627.aClass82_200.method1391();
	}

	@OriginalMember(owner = "client!ds", name = "a", descriptor = "(IIIILclient!ek;IIIIILclient!wk;I)V")
	public static void method1440(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Class103 arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(10) Class403 arg9, @OriginalArg(11) int arg10) {
	...
	public static boolean method1442(@OriginalArg(0) int arg0) {
