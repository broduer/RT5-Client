...
public final class Static13 {
	...
	public static void method158() {
		for (@Pc(7) int local7 = 0; local7 < Static390.anInt6146; local7++) {
			@Pc(13) int local13 = Static103.anIntArray187[local7];
			@Pc(20) Class2_Sub45 local20 = (Class2_Sub45) Static18.aClass28_2.method738(local13);
			if (local20 != null) {
				@Pc(25) Class8_Sub2_Sub1_Sub2_Sub2 local25 = local20.aClass8_Sub2_Sub1_Sub2_Sub2_2;
				Static489.method6554(false, local25);
			}
		}
	}
}
