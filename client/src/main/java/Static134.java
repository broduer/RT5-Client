...
public final class Static134 {
	...
	public static byte[] method6401(@OriginalArg(0) byte[] arg0) {
		if (arg0 == null) {
			return null;
		} else {
			@Pc(12) byte[] local12 = new byte[arg0.length];
			Static734.method5448(arg0, 0, local12, 0, arg0.length);
			return local12;
		}
	}

	@OriginalMember(owner = "client!eda", name = "a", descriptor = "(Lclient!hda;BZ)V")
	public static void method6402(@OriginalArg(0) Class158 arg0, @OriginalArg(2) boolean arg1) {
		...
		Static220.method2285(local16, arg1, local37, Static453.aClass158ArrayArray2[arg0.anInt3812 >> 16], arg0.anInt3812);
		if (arg0.aClass158Array1 != null) {
			Static220.method2285(local16, arg1, local37, arg0.aClass158Array1, arg0.anInt3812);
		}
		@Pc(72) Class2_Sub4 local72 = (Class2_Sub4) Static548.aClass28_40.method373((long) arg0.anInt3812);
		if (local72 != null) {
			Static19.method151(arg1, local72.anInt147, local37, local16);
		}
	}
}
