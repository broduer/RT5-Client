...
public final class Static141 {
	...
	private static int anInt2544;

	@OriginalMember(owner = "client!eh", name = "e", descriptor = "I")
	private static int anInt2545;

	@OriginalMember(owner = "client!eh", name = "g", descriptor = "I")
	private static int anInt2546;

	@OriginalMember(owner = "client!eh", name = "h", descriptor = "I")
	private static int anInt2547;

	@OriginalMember(owner = "client!eh", name = "d", descriptor = "[I")
	private static int[] anIntArray223;

	@OriginalMember(owner = "client!eh", name = "b", descriptor = "I")
	private static int anInt2548;

	@OriginalMember(owner = "client!eh", name = "a", descriptor = "I")
	private static int anInt2549;
	...
	public static boolean method2370(@OriginalArg(0) int arg0) {
		...
		while (local3 >= local1) {
			...
			@Pc(17) int local17 = anInt2548;
			@Pc(24) int local24;
			@Pc(31) int local31;
			while (local1 < anInt2546) {
		...
		anInt2547 = anIntArray223[local3] >> 16;
		anInt2549 = anIntArray223[local3 + 4] >> 16;
	...
	public static void method2374(@OriginalArg(0) int[] arg0, @OriginalArg(2) int arg1) {
		...
		if (anIntArray223 == null || anIntArray223.length < local5) {
			...
			for (local18 = 0; local18 < anInt2546; local18++) {
		...
		for (local18 = 0; local18 < local37; local18 += 2) {
			...
			if (local50 < local56) {
				anIntArray223[anInt2546++] = arg0[local41];
				anIntArray223[anInt2546++] = local50;
				anIntArray223[anInt2546++] = arg0[local18];
				anIntArray223[anInt2546++] = local56;
	...
	public static void method2378(@OriginalArg(0) int arg0) {
		if (anInt2546 < 0) {
			...
			anInt2545 = 0;
			anInt2548 = 0;
			anInt2550 = 2147483646;
			return;
		}
		method2372(0, anInt2546);
		@Pc(18) int local18 = anIntArray223[1];
		if (local18 < arg0) {
			local18 = arg0;
		}
		@Pc(27) int local27;
		for (local27 = 0; local27 < anInt2546; local27 += 4) {
