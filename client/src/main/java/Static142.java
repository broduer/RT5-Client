...
public final class Static142 {
	...
	public static void method1577(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3) {
		if (arg2 - arg3 >= Static180.anInt2995 && Static111.anInt2219 >= arg2 + arg3 && arg0 - arg3 >= Static724.anInt10930 && arg0 + arg3 <= Static273.anInt4395) {
			Static265.method2716(arg2, arg1, arg3, arg0);
		} else {
			Static158.method1713(arg0, arg3, arg1, arg2);
		}
	}

	@OriginalMember(owner = "client!eha", name = "a", descriptor = "(IBI[Ljava/lang/String;)Ljava/lang/String;")
	public static String method1579(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) String[] arg2) {
		if (arg0 == 0) {
			return "";
		} else if (arg0 == 1) {
