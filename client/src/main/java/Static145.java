...
public final class Static145 {
	...
	public static void method1606(@OriginalArg(1) Class2_Sub2 arg0, @OriginalArg(2) Class2_Sub2 arg1) {
	...
	public static void method1608(@OriginalArg(0) Class8_Sub2_Sub1_Sub2 arg0) {
		...
		for (@Pc(19) int local19 = 0; local19 < arg0.anIntArray872.length; local19++) {
			...
			if (local25 != -1) {
				...
				if ((local25 & -1073741824) == -1073741824) {
					...
					@Pc(111) Class2_Sub45 local111 = (Class2_Sub45) Static18.aClass28_2.method373((long) local25);
					if (local111 == null) {
						arg0.method6698(local19, -1);
						continue;
					}
				...
				if (local102 != 0 || local95 != 0) {
					arg0.method6698(local19, (int) (Math.atan2((double) local102, (double) local95) * 2607.5945876176133D) & 0x3FFF);
				}
			} else if (!arg0.method6698(local19, -1)) {
				local17 = false;
			}
		}
		if (local17) {
	...
	public static void method1609(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		if (Static571.method5330(arg1)) {
			Static84.method1083(Static453.aClass158ArrayArray2[arg1], arg0);
		}
	}

	@OriginalMember(owner = "client!eja", name = "a", descriptor = "(BI)Lclient!hda;")
	public static Class158 method1610(@OriginalArg(1) int arg0) {
		...
		if (Static453.aClass158ArrayArray2[local16] == null || Static453.aClass158ArrayArray2[local16][local20] == null) {
			@Pc(38) boolean local38 = Static571.method5330(local16);
			if (!local38) {
				return null;
			}
		}
