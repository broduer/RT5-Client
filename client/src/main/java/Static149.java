...
public final class Static149 {
	...
	public static void method2449(@OriginalArg(0) Class19 arg0) {
		...
		Static87.method1693(Static682.anInt10323, Static407.anInt6308, Static32.aClass32_24.method877(Static51.anInt1056), arg0, local7 + Static84.anInt1783, Static71.anInt1583 - -local5);
		...
		if (Static236.aBoolean304) {
			...
			if (Static139.aClass2_Sub2_Sub4_1 != null) {
				Static87.method1693(Static85.anInt10703, Static25.anInt600, Static139.aClass2_Sub2_Sub4_1.aString10, arg0, Static493.anInt7385, Static692.anInt10403);
				local70 = 0;
				for (local190 = (Class2_Sub2_Sub16) Static139.aClass2_Sub2_Sub4_1.aClass194_3.method4359(); local190 != null; local190 = (Class2_Sub2_Sub16) Static139.aClass2_Sub2_Sub4_1.aClass194_3.method4357()) {
					local202 = Static493.anInt7385 + local70 * 16 + 13 + 20;
				...
				Static292.method4611(Static493.anInt7385, arg0, Static692.anInt10403, Static85.anInt10703, Static25.anInt600);
			}
		} else {
			local70 = 0;
			for (local281 = (Class2_Sub2_Sub16) Static693.aClass341_79.method7706(65280); local281 != null; local281 = (Class2_Sub2_Sub16) Static693.aClass341_79.method7713()) {
				local89 = (Static594.anInt8801 - local70 - 1) * 16 + local23 + 33;
				local70++;
		...
		Static292.method4611(local7 + Static84.anInt1783, arg0, Static71.anInt1583 + local5, Static682.anInt10323, Static407.anInt6308);
		if (Static236.aBoolean304) {
			local70 = 0;
			for (local77 = (Class2_Sub2_Sub4) Static350.aClass194_8.method4359(); local77 != null; local77 = (Class2_Sub2_Sub4) Static350.aClass194_8.method4357()) {
				local89 = local70 * 16 + local7 + Static84.anInt1783 + 33;
			...
			if (Static139.aClass2_Sub2_Sub4_1 != null) {
				local70 = 0;
				for (local190 = (Class2_Sub2_Sub16) Static139.aClass2_Sub2_Sub4_1.aClass194_3.method4359(); local190 != null; local190 = (Class2_Sub2_Sub16) Static139.aClass2_Sub2_Sub4_1.aClass194_3.method4357()) {
					local202 = Static493.anInt7385 + local70 * 16 + 20 + 13;
			...
			local70 = 0;
			for (local281 = (Class2_Sub2_Sub16) Static693.aClass341_79.method7706(65280); local281 != null; local281 = (Class2_Sub2_Sub16) Static693.aClass341_79.method7713()) {
				local89 = local23 + (-local70 + -1 + Static594.anInt8801) * 16 + 13 + 20;
				local70++;
