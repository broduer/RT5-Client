...
public final class Static149 {
	...
	public static void method2449(@OriginalArg(0) Class19 arg0) {
		...
		Static87.method1693(Static682.anInt10323, Static407.anInt6308, Static32.aClass32_24.getLocalization(client.lang), arg0, local7 + Static84.anInt1783, Static71.anInt1583 - -local5, local31);
		@Pc(55) int local55 = Static189.aClass120_1.method8860() + local5;
		@Pc(66) int local66 = local7 + Static189.aClass120_1.method8861();
		@Pc(70) int local70;
		@Pc(77) SecondaryNode_Sub4 local77;
		@Pc(89) int local89;
		@Pc(202) int local202;
		@Pc(281) SecondaryNode_Sub16 local281;
		@Pc(190) SecondaryNode_Sub16 local190;
		if (Static236.aBoolean304) {
			local70 = 0;
			for (local77 = (SecondaryNode_Sub4) Static350.aClass194_8.head(); local77 != null; local77 = (SecondaryNode_Sub4) Static350.aClass194_8.next()) {
				local89 = local31 + local23 + local70 * 16 + 13;
				if (local55 > local5 + Static71.anInt1583 && local55 < local5 + Static71.anInt1583 + Static682.anInt10323 && local66 > local89 - 13 && local66 < local89 + 4 && (local77.anInt1541 > 1 || ((SecondaryNode_Sub16) local77.aClass194_3.sentinel.secondaryNext).aBoolean552)) {
			...
			if (Static139.aClass2_Sub2_Sub4_1 != null) {
				...
				local70 = 0;
				for (local190 = (SecondaryNode_Sub16) Static139.aClass2_Sub2_Sub4_1.aClass194_3.head(); local190 != null; local190 = (SecondaryNode_Sub16) Static139.aClass2_Sub2_Sub4_1.aClass194_3.next()) {
			...
			local70 = 0;
			for (local281 = (SecondaryNode_Sub16) Static693.aClass341_79.head(); local281 != null; local281 = (SecondaryNode_Sub16) Static693.aClass341_79.next()) {
		...
		if (Static236.aBoolean304) {
			...
			for (local77 = (SecondaryNode_Sub4) Static350.aClass194_8.head(); local77 != null; local77 = (SecondaryNode_Sub4) Static350.aClass194_8.next()) {
				...
				if (local77.anInt1541 == 1) {
					Static232.method3387(arg0, Static682.anInt10323, Static407.anInt6308, Static84.anInt1783 + local7, local89, Static634.anInt9536 | 0xFF000000, (SecondaryNode_Sub16) local77.aClass194_3.sentinel.secondaryNext, Static563.anInt8479 | 0xFF000000, local66, Static71.anInt1583 + local5, local55);
				} else {
