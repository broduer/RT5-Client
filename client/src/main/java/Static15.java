...
public final class Static15 {
	...
	public static boolean method188(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) Class207 arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		if (!Static18.aBoolean20 || !Static29.aBoolean60) {
			...
			for (@Pc(72) int local72 = arg4; local72 <= arg1; local72++) {
				for (@Pc(75) int local75 = arg0; local75 <= arg3; local75++) {
					if (Static446.anIntArrayArrayArray9[arg5][local72][local75] == -Static675.anInt10183) {
						return false;
					}
				}
			}
			if (Static342.method4470(arg2)) {
				Static356.anInt5793++;
				return true;
			} else {
				return false;
			}
		} else if (!Static588.method7721(arg0, arg5, arg4)) {
			return false;
		} else if (Static342.method4470(arg2)) {
			Static356.anInt5793++;
			return true;
		} else {
			return false;
	...
	public static String method189(@OriginalArg(1) Buffer arg0) {
		return Static387.method5448(arg0);
	}
}
