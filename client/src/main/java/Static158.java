...
public final class Static158 {
	...
	public static void method1713(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		@Pc(21) int local21 = -1;
		@Pc(29) int local29 = Static670.method6229(Static180.anInt2995, Static111.anInt2219, arg1 + arg3);
		@Pc(38) int local38 = Static670.method6229(Static180.anInt2995, Static111.anInt2219, arg3 - arg1);
		Static696.method6473(local29, arg2, local38, Static723.anIntArrayArray266[arg0]);
		while (local14 < local16) {
			...
			if (local19 > 0) {
				...
				if (local73 >= Static724.anInt10930 && local69 <= Static273.anInt4395) {
					local94 = Static670.method6229(Static180.anInt2995, Static111.anInt2219, arg3 + local14);
					local103 = Static670.method6229(Static180.anInt2995, Static111.anInt2219, arg3 - local14);
					if (local73 <= Static273.anInt4395) {
						Static696.method6473(local94, arg2, local103, Static723.anIntArrayArray266[local73]);
					}
					if (Static724.anInt10930 <= local69) {
						Static696.method6473(local94, arg2, local103, Static723.anIntArrayArray266[local69]);
					}
				}
			}
			local14++;
			...
			if (Static724.anInt10930 <= local73 && local69 <= Static273.anInt4395) {
				local94 = Static670.method6229(Static180.anInt2995, Static111.anInt2219, arg3 + local16);
				local103 = Static670.method6229(Static180.anInt2995, Static111.anInt2219, arg3 - local16);
