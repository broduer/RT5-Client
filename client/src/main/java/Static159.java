...
public final class Static159 {
	...
	public static Class341 aClass341_15 = new Class341();
	...
	public static void method2574(@OriginalArg(0) Class19 arg0) {
		...
		if (Static236.aBoolean304) {
			local80 = 0;
			for (@Pc(137) Class2_Sub2_Sub4 local137 = (Class2_Sub2_Sub4) Static350.aClass194_8.method4359(); local137 != null; local137 = (Class2_Sub2_Sub4) Static350.aClass194_8.method4357()) {
				local101 = local9 + Static84.anInt1783 + local80 * 16 + 31;
				if (local137.anInt1541 == 1) {
					Static232.method3387(arg0, Static682.anInt10323, Static407.anInt6308, Static84.anInt1783 + local9, local101, -256, (Class2_Sub2_Sub16) local137.aClass194_3.aClass2_Sub2_36.aClass2_Sub2_66, -1, local76, local7 + Static71.anInt1583, local69);
				} else {
			...
			if (Static139.aClass2_Sub2_Sub4_1 != null) {
				...
				for (@Pc(239) Class2_Sub2_Sub16 local239 = (Class2_Sub2_Sub16) Static139.aClass2_Sub2_Sub4_1.aClass194_3.method4359(); local239 != null; local239 = (Class2_Sub2_Sub16) Static139.aClass2_Sub2_Sub4_1.aClass194_3.method4357()) {
			...
			local80 = 0;
			for (@Pc(85) Class2_Sub2_Sub16 local85 = (Class2_Sub2_Sub16) Static693.aClass341_79.method7706(65280); local85 != null; local85 = (Class2_Sub2_Sub16) Static693.aClass341_79.method7713()) {
