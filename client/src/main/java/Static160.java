...
public final class Static160 {
	...
	private static final Class263 aClass263_1 = new Class263();
	...
	public static int method2576(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2, @OriginalArg(3) int arg3) {
		@Pc(1) Class263 local1 = aClass263_1;
		synchronized (aClass263_1) {
			aClass263_1.aByteArray72 = arg2;
			aClass263_1.anInt6490 = 9;
			aClass263_1.aByteArray73 = arg0;
			aClass263_1.anInt6486 = 0;
			aClass263_1.anInt6498 = arg1;
			aClass263_1.anInt6502 = 0;
			aClass263_1.anInt6488 = 0;
			aClass263_1.anInt6492 = 0;
			aClass263_1.anInt6494 = 0;
			method2577(aClass263_1);
			@Pc(37) int local37 = arg1 - aClass263_1.anInt6498;
			aClass263_1.aByteArray72 = null;
			aClass263_1.aByteArray73 = null;
			return local37;
		}
	}
	...
	public static void method2577(@OriginalArg(0) Class263 arg0) {
		...
		while (true) {
			while (local56) {
				...
				arg0.anInt6487 = 0;
				local60 = method2584(arg0);
				arg0.anInt6487 = arg0.anInt6487 << 8 | local60 & 0xFF;
				local60 = method2584(arg0);
				arg0.anInt6487 = arg0.anInt6487 << 8 | local60 & 0xFF;
				local60 = method2584(arg0);
				arg0.anInt6487 = arg0.anInt6487 << 8 | local60 & 0xFF;
				...
				method2582(arg0);
				@Pc(213) int local213 = arg0.anInt6495 + 2;
				...
				@Pc(420) int local420 = arg0.anInt6495 + 1;
				...
				while (true) {
					...
					arg0.anInt6496 = Static104.anIntArray189[arg0.anInt6487] >> 8;
					arg0.anInt6497 = 0;
					arg0.anInt6496 = Static104.anIntArray189[arg0.anInt6496];
					arg0.anInt6493 = (byte) (arg0.anInt6496 & 0xFF);
					arg0.anInt6496 >>= 0x8;
					arg0.anInt6497++;
					arg0.anInt6491 = local470;
					method2579(arg0);
					if (arg0.anInt6497 == arg0.anInt6491 + 1 && arg0.anInt6489 == 0) {
						local56 = true;
						break;
					}
					local56 = false;
	...
	public static void method2579(@OriginalArg(0) Class263 arg0) {
		...
		@Pc(11) int local11 = arg0.anInt6493;
		@Pc(13) int[] local13 = Static104.anIntArray189;
		@Pc(16) int local16 = arg0.anInt6496;
		@Pc(19) byte[] local19 = arg0.aByteArray73;
		@Pc(22) int local22 = arg0.anInt6486;
		@Pc(25) int local25 = arg0.anInt6498;
		@Pc(27) int local27 = local25;
		@Pc(32) int local32 = arg0.anInt6491 + 1;
		label57: while (true) {
			if (local5 > 0) {
				while (true) {
					if (local25 == 0) {
		...
		@Pc(191) int local191 = arg0.anInt6494;
		arg0.anInt6494 += local27 - local25;
		arg0.aByte102 = local2;
		arg0.anInt6489 = local5;
		arg0.anInt6497 = local8;
		arg0.anInt6493 = local11;
		Static104.anIntArray189 = local13;
		arg0.anInt6496 = local16;
		arg0.aByteArray73 = local19;
		arg0.anInt6486 = local22;
		arg0.anInt6498 = local25;
	}
	...
	public static int method2581(@OriginalArg(0) int arg0, @OriginalArg(1) Class263 arg1) {
		...
		@Pc(17) int local17 = arg1.anInt6488 >> arg1.anInt6502 - arg0 & (0x1 << arg0) - 1;
		arg1.anInt6502 -= arg0;
		return local17;
	}
	...
	public static void method2582(@OriginalArg(0) Class263 arg0) {
		...
		for (@Pc(4) int local4 = 0; local4 < 256; local4++) {
			if (arg0.aBooleanArray19[local4]) {
				arg0.aByteArray76[arg0.anInt6495] = (byte) local4;
				arg0.anInt6495++;
			}
		}
	}
