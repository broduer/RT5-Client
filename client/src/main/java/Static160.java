...
public final class Static160 {
	...
	public static int method1718(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2, @OriginalArg(3) int arg3) {
	...
	private static void method1719(@OriginalArg(0) Class261 arg0) {
		arg0.anInt6481 = 1;
		...
		while (true) {
			while (local56) {
				@Pc(60) byte local60 = method1726(arg0);
				if (local60 == 23) {
					return;
				}
				local60 = method1726(arg0);
				local60 = method1726(arg0);
				local60 = method1726(arg0);
				local60 = method1726(arg0);
				local60 = method1726(arg0);
				...
				@Pc(217) int local217 = method1723(3, arg0);
				@Pc(221) int local221 = method1723(15, arg0);
				...
				for (local304 = 0; local304 < local217; local304++) {
					@Pc(309) int local309 = method1723(5, arg0);
				...
				for (local304 = 0; local304 < local217; local304++) {
					...
					method1720(arg0.anIntArrayArray159[local304], arg0.anIntArrayArray160[local304], arg0.anIntArrayArray161[local304], arg0.aByteArrayArray21[local304], local347, local349, local213);
				...
				for (local507 = method1723(local485, arg0); local507 > local490[local503]; local507 = local507 << 1 | local516) {
					local503++;
					local516 = method1725(arg0);
				}
	...
	private static void method1720(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) byte[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(1) int local1 = 0;
		@Pc(3) int local3;
	...
	private static void method1721(@OriginalArg(0) Class261 arg0) {
	...
	private static int method1723(@OriginalArg(0) int arg0, @OriginalArg(1) Class261 arg1) {
	...
	private static void method1724(@OriginalArg(0) Class261 arg0) {
		arg0.anInt6475 = 0;
	...
	private static byte method1725(@OriginalArg(0) Class261 arg0) {
		return (byte) method1723(1, arg0);
	}

	@OriginalMember(owner = "client!f", name = "a", descriptor = "(Lclient!ni;)B")
	private static byte method1726(@OriginalArg(0) Class261 arg0) {
		return (byte) method1723(8, arg0);
	}
}
