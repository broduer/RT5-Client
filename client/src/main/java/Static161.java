...
public final class Static161 {
	...
	public static void method2585(@OriginalArg(1) Class8_Sub2_Sub1_Sub2_Sub1 arg0, @OriginalArg(2) int arg1, @OriginalArg(3) Packet arg2, @OriginalArg(4) int arg3) {
		@Pc(7) byte local7 = -1;
		@Pc(15) int local15;
		@Pc(18) int[] local18;
		@Pc(21) int[] local21;
		...
		if ((arg3 & 0x8) != 0) {
			...
			@Pc(545) Buffer local545 = new Buffer(local540);
	...
	public static void method2586(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (Static400.aClass2_Sub34_28.aClass57_Sub25_4.method7215() != 0 && arg3 != 0 && Static33.anInt782 < 50 && arg2 != -1) {
			Static409.aClass104Array1[Static33.anInt782++] = new Class104((byte) 1, arg2, arg3, arg1, arg4, 0, arg0, null);
		}
	}
	...
	public static void method2588() {
		...
		while (local8.method7427(Static405.aClass153_2.length) >= 15) {
			...
			@Pc(36) Node_Sub45 local36 = (Node_Sub45) Static18.aClass28_2.get(local22);
			...
			if (local36 == null) {
				...
				Static18.aClass28_2.put(local22, local36);
			...
			local42.method9335(client.npcTypeList.method7099(local8.method7419(15)));
			...
			if (local42.aClass270_1.method5991()) {
				Static89.method1714(local42.aByte144, null, local42.anIntArray879[0], local42.anIntArray878[0], local42, null, 0);
			}
		}
		local8.method7418();
	}
