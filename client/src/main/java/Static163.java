...
public final class Static163 {
	...
	public static Node_Sub4 method8857(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) boolean arg3) {
		@Pc(7) Node_Sub4 local7 = new Node_Sub4();
		local7.anInt147 = arg1;
		local7.anInt146 = arg0;
		Static548.aClass28_40.put(arg2, local7);
		...
		Static94.method1840();
		if (local26 != null) {
			Static134.method8963(local26, !arg3);
		}
		if (!arg3) {
			Static472.method6421(arg1);
		}
		if (!arg3 && Static377.anInt5950 != -1) {
	...
	public static void method8859(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3) {
		if (arg3 >= arg1) {
			return;
		}
		...
		method8859(arg0, local17 - 1, arg2, arg3);
		method8859(arg0, arg1, arg2, local17 + 1);
	}
}
