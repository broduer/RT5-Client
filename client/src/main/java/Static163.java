...
public final class Static163 {
	...
	public static String method6312(@OriginalArg(0) long arg0) {
	...
	public static byte[] method6315(@OriginalArg(0) byte[] arg0) {
		@Pc(13) int local13 = arg0.length;
		@Pc(16) byte[] local16 = new byte[local13];
		Static734.method5448(arg0, 0, local16, 0, local13);
		return local16;
	}

	@OriginalMember(owner = "client!fb", name = "a", descriptor = "(IIIIZ)Lclient!aha;")
	public static Class2_Sub4 method6316(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) boolean arg3) {
		@Pc(7) Class2_Sub4 local7 = new Class2_Sub4();
		local7.anInt147 = arg1;
		local7.anInt146 = arg0;
		Static548.aClass28_40.method370((long) arg2, local7);
		Static122.method1432(arg1);
		@Pc(26) Class158 local26 = Static145.method1610(arg2);
		if (local26 != null) {
			Static178.method1859(local26);
		}
		...
		Static94.method1190();
		if (local26 != null) {
			Static134.method6402(local26, !arg3);
		}
		if (!arg3) {
			Static472.method4493(arg1);
		}
	...
	public static void method6318(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3) {
		if (arg3 >= arg1) {
			return;
		}
		...
		method6318(arg0, local17 - 1, arg2, arg3);
		method6318(arg0, arg1, arg2, local17 + 1);
	}
}
