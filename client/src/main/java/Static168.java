...
public final class Static168 {
	...
	public static void method1775(@OriginalArg(0) Class2_Sub21_Sub2 arg0) {
		arg0.method5226();
		...
		@Pc(28) int local28 = arg0.method5221(30);
		...
		local20.anInt10690 = (local20.anIntArray879[0] << 9) + (local20.method6693((byte) 53) << 8);
		local20.anIntArray878[0] = local51 - Static116.anInt2270;
		local20.anInt10694 = (local20.anIntArray878[0] << 9) + (local20.method6693((byte) 65) << 8);
		Static394.anInt6176 = local20.aByte144 = local20.aByte143 = local33;
		if (Static441.method4209(local20.anIntArray878[0], local20.anIntArray879[0])) {
			local20.aByte143++;
		}
		if (Static462.aClass2_Sub21Array1[local10] != null) {
			local20.method874(Static462.aClass2_Sub21Array1[local10]);
		}
		...
		for (@Pc(151) int local151 = 1; local151 < 2048; local151++) {
			if (local10 != local151) {
				@Pc(163) int local163 = arg0.method5221(18);
	...
	public static Class23 method1776(@OriginalArg(1) byte[] arg0) {
		if (arg0 == null) {
		...
		while (true) {
			try {
				...
				if (!local27.isErrorAny() && local37 >= 0 && local41 >= 0) {
					...
					local78.grabPixels();
					return Static163.aClass19_17.a(local37, local37, local41, local66, 0, 7468);
				}
				throw new RuntimeException("");
	...
	public static void method1778(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) boolean arg2, @OriginalArg(4) int arg3, @OriginalArg(5) boolean arg4, @OriginalArg(6) int arg5) {
		if (arg0 <= arg1) {
			return;
		}
		...
		for (@Pc(31) int local31 = arg1; local31 < arg0; local31++) {
			if (Static639.method5977(local19, arg3, arg5, arg4, 70, Static343.aClass297_Sub1Array2[local31], arg2) <= 0) {
		...
		method1778(local15 - 1, arg1, arg2, arg3, arg4, arg5);
		method1778(arg0, local15 + 1, arg2, arg3, arg4, arg5);
	}

	@OriginalMember(owner = "client!fda", name = "a", descriptor = "(IBIIIII)V")
	public static void method1779(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		if (Static180.anInt2995 <= arg5 && Static111.anInt2219 >= arg3 && Static724.anInt10930 <= arg4 && Static273.anInt4395 >= arg0) {
			if (arg2 == 1) {
				Static175.method1838(arg0, arg4, arg1, arg3, arg5);
			} else {
				Static548.method5084(arg1, arg5, arg3, arg0, arg2, arg4);
			}
		} else if (arg2 == 1) {
			Static385.method3832(arg0, arg5, arg1, arg3, arg4);
		} else {
			Static249.method2558(arg2, arg4, arg3, arg0, arg5, arg1);
		}
	}
}
