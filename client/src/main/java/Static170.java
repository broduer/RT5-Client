...
public final class Static170 {
	...
	public static void method2652(@OriginalArg(0) byte arg0) {
		...
		for (@Pc(14) int local14 = 0; local14 < 4; local14++) {
			for (@Pc(17) int local17 = 0; local17 < Static720.anInt10888; local17++) {
				for (@Pc(20) int local20 = 0; local20 < Static501.anInt7591; local20++) {
	...
	public static void method2653(@OriginalArg(0) int arg0) {
		...
		Static409.anInt6338 = arg0;
		Static320.anInt5101 = 3;
