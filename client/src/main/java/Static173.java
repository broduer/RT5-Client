...
public final class Static173 {
	...
	public static void method1827() {
		if (Static719.aClass56_5 != null) {
			Static719.aClass56_5.method2589();
		}
		if (Static559.aClass56_3 != null) {
			Static559.aClass56_3.method2589();
		}
	}

	@OriginalMember(owner = "client!fga", name = "a", descriptor = "(Lclient!qha;I[Lclient!mfa;)Lclient!iha;")
	public static Class179 method1828(@OriginalArg(0) Class19_Sub3 arg0, @OriginalArg(2) Class240[] arg1) {
	...
	public static void method1829(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(7) Class291 local7 = Static334.aClass291ArrayArrayArray1[arg0][arg1][arg2];
		if (local7 == null) {
			return;
		}
		Static109.method1319(local7.aClass8_Sub2_Sub4_1);
		Static109.method1319(local7.aClass8_Sub2_Sub4_2);
