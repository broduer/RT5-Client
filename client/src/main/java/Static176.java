...
public final class Static176 {
	...
	public static void method4701() {
		Static374.method3755(Static299.anInt4824);
	}

	@OriginalMember(owner = "client!fi", name = "a", descriptor = "(III)Z")
	public static boolean method4702(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		return (arg2 & 0x180) != 0;
	}

	@OriginalMember(owner = "client!fi", name = "a", descriptor = "(ILclient!ge;)V")
	public static void method4703(@OriginalArg(1) Class2_Sub21 arg0) {
		@Pc(6) byte[] local6 = new byte[24];
		if (Static690.aClass243_5 != null) {
			@Pc(18) int local18;
			try {
				Static690.aClass243_5.method3950(0L);
				Static690.aClass243_5.method3947(local6);
