...
public final class Static177 {
	...
	public static void method1851(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		if (arg0 != 8 && arg0 != 16) {
		...
		if (arg0 != 8) {
			...
			local42 = Static706.aClass178Array3[arg4].a(arg2, arg3 + 1, (byte) -118);
			local54 = Static706.aClass178Array3[arg4].a(arg2 + 1, arg3, (byte) -118);
		...
		local30 = arg2 << Static52.anInt1066;
		local34 = local30 + Static340.anInt5586;
		local42 = Static706.aClass178Array3[arg4].a(arg2, arg3, (byte) -118);
		local54 = Static706.aClass178Array3[arg4].a(arg2 + 1, arg3 - -1, (byte) -118);
	...
	public static void method1853(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class8_Sub2_Sub4 arg3, @OriginalArg(4) Class8_Sub2_Sub4 arg4) {
		@Pc(4) Class291 local4 = Static347.method3572(arg0, arg1, arg2);
		if (local4 == null) {
			return;
		}
