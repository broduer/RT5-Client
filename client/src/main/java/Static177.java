...
public final class Static177 {
	...
	public static Class332 aClass332_35;
	...
	public static void method2716(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		if (arg0 != 8 && arg0 != 16) {
			@Pc(163) Class293 local163 = Static334.aClass293ArrayArrayArray1[arg4][arg3][arg2];
			if (local163 == null) {
				local163 = new Class293(arg4);
			}
			if (arg0 == 1) {
		...
		@Pc(54) int local54;
		if (arg0 != 8) {
			local22 = Static340.anInt5606 + (arg3 << Static52.anInt1070);
			local26 = local22 - Static340.anInt5606;
			local30 = arg2 << Static52.anInt1070;
			local34 = local30 + Static340.anInt5606;
			local42 = Static706.aClass178Array3[arg4].method7876(arg2, arg3 + 1);
			local54 = Static706.aClass178Array3[arg4].method7876(arg2 + 1, arg3);
			Static285.aClass75Array1[Static150.anInt2643++] = new Class75(arg0, arg4, local22, local26, local26, local22, local42, local54, local54 - arg5, local42 - arg5, local30, local34, local34, local30);
			return;
		}
		local22 = arg3 << Static52.anInt1070;
		local26 = Static340.anInt5606 + local22;
		local30 = arg2 << Static52.anInt1070;
		local34 = local30 + Static340.anInt5606;
		local42 = Static706.aClass178Array3[arg4].method7876(arg2, arg3);
		local54 = Static706.aClass178Array3[arg4].method7876(arg2 + 1, arg3 - -1);
		Static285.aClass75Array1[Static150.anInt2643++] = new Class75(arg0, arg4, local22, local26, local26, local22, local42, local54, local54 - arg5, -arg5 + local42, local30, local34, local34, local30);
	}
