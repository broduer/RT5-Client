...
public final class Static180 {
	...
	public static void method1890(@OriginalArg(1) int arg0) {
		...
		@Pc(45) Class153 local45 = Static668.method6208();
		@Pc(53) Class2_Sub19 local53 = Static293.method3000(Static507.aClass345_95, local45.aClass186_1);
		local53.aClass2_Sub21_Sub2_1.method5198(Static231.method2417(local29.aString2) + 2);
		local53.aClass2_Sub21_Sub2_1.method5182(arg0);
		local53.aClass2_Sub21_Sub2_1.method5200(local29.aString2);
		local45.method2339(local53);
	}

	@OriginalMember(owner = "client!fka", name = "a", descriptor = "(IIBIII)V")
	public static void method1891(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		if (arg0 == arg3) {
			Static142.method1577(arg2, arg1, arg4, arg3);
		} else if (arg4 - arg3 >= anInt2995 && arg3 + arg4 <= Static111.anInt2219 && Static724.anInt10930 <= arg2 - arg0 && Static273.anInt4395 >= arg2 + arg0) {
			Static211.method3487(arg2, arg0, arg3, arg1, arg4);
		} else {
			Static619.method952(arg2, arg3, arg0, arg4, arg1);
		}
	}
}
