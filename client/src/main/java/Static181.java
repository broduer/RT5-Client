...
public final class Static181 {
	...
	public static void method1895(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8) {
		if (arg7 == arg4 && arg1 == arg0 && arg3 == arg8 && arg6 == arg5) {
			Static409.method4014(arg4, arg8, arg2, arg6, arg0);
			return;
		}
		...
		for (@Pc(128) int local128 = 128; local128 <= 4096; local128 += 128) {
			...
			Static409.method4014(local51, local176, arg2, local188, local53);
			local53 = local188;
			local51 = local176;
		}
	}
	...
	public static void method1896() {
		...
		for (@Pc(27) int local27 = 0; local27 < Static617.anInt9434; local27++) {
			...
			for (@Pc(35) int local35 = 0; local35 < Static211.anInt5574; local35++) {
				...
				Static651.anInterface9Array1[local41].a(local35 * Static437.anInt6628, Static714.anInt10802 * local27, Static437.anInt6628, Static714.anInt10802, 0, 0, true, true);
			}
		}
	}
}
