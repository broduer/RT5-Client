...
public final class Static181 {
	...
	public static final ClientProt aClass347_34 = new ClientProt(39, 12);
	...
	public static void method2780(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8) {
		if (arg7 == arg4 && arg1 == arg0 && arg3 == arg8 && arg6 == arg5) {
			Static409.method5665(arg4, arg8, arg2, arg6, arg0);
			return;
		}
		...
		for (@Pc(128) int local128 = 128; local128 <= 4096; local128 += 128) {
			...
			Static409.method5665(local51, local176, arg2, local188, local53);
			local53 = local188;
			local51 = local176;
		}
	}
	...
	public static void method2781() {
		...
		for (@Pc(27) int local27 = 0; local27 < Static617.anInt9460; local27++) {
			@Pc(33) int local33 = Static211.anInt5594 * local27;
			for (@Pc(35) int local35 = 0; local35 < Static211.anInt5594; local35++) {
				@Pc(41) int local41 = local35 + local33;
				Static651.anInterface9Array1[local41].method9046(local35 * Static437.anInt6648, Static714.anInt10831 * local27, Static437.anInt6648, Static714.anInt10831, true);
			}
		}
	}
}
