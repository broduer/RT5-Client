...
public final class Static184 {
	...
	public static void method1912(@OriginalArg(0) long arg0, @OriginalArg(3) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) Class330 arg3) {
		Static349.method3586(arg3, arg2, arg1, arg0);
	}

	@OriginalMember(owner = "client!fma", name = "a", descriptor = "(IIII)Lclient!cg;")
	public static Class8_Sub2_Sub1_Sub2 method1913(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		for (@Pc(31) Class286 local31 = local13.aClass286_2; local31 != null; local31 = local31.aClass286_1) {
			...
			if (local35 instanceof Class8_Sub2_Sub1_Sub2) {
				...
				@Pc(51) int local51 = local41.method6693((byte) 76) * 256 + 252 - 256;
