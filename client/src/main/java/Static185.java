...
public final class Static185 {
	...
	public static final Class347 aClass347_35 = new Class347(0, 7);
	...
	public static void method2814(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7) {
		...
		if (local9 != null) {
			...
			if (local20.anInt1244 == -1) {
				local45 = arg1;
				if (local20.anInt1276 > 0) {
					local45 = arg7;
				}
				if (local30 == 0 || local30 == 2) {
					if (local26 == 0) {
						arg0.method8005(4, arg5, local45, arg4);
					} else if (local26 == 1) {
						arg0.method7998(arg5, local45, arg4, 4);
					} else if (local26 == 2) {
						arg0.method8005(4, arg5, local45, arg4 + 3);
					} else if (local26 == 3) {
						arg0.method7998(arg5 + 3, local45, arg4, 4);
					}
				}
				if (local30 == 3) {
					if (local26 == 0) {
						arg0.method7978(1, 1, arg5, arg4, local45);
					} else if (local26 == 1) {
						arg0.method7978(1, 1, arg5, arg4 + 3, local45);
					} else if (local26 == 2) {
						arg0.method7978(1, 1, arg5 + 3, arg4 + 3, local45);
					} else if (local26 == 3) {
						arg0.method7978(1, 1, arg5 + 3, arg4, local45);
					}
				}
				if (local30 == 2) {
					if (local26 == 0) {
		...
		local9 = (Interface25) Static578.method7630(arg6, arg2, arg3, aClass8 == null ? (aClass8 = Class132_Sub1.a("uv")) : aClass8);
		if (local9 != null) {
			...
			if (local20.anInt1244 != -1) {
				...
				if (local26 == 0 || local26 == 2) {
					arg0.method7961(arg5, arg5 + 3, arg4 + 3, local45, arg4);
				} else {
					arg0.method7961(arg5 + 3, arg5, arg4 + 3, local45, arg4);
				}
			}
		}
		local9 = (Interface25) Static687.method8966(arg6, arg2, arg3);
		if (local9 == null) {
			return;
		}
