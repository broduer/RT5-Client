...
public final class Static186 {
	...
	public static void method1933(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) boolean arg5) {
		if ((arg5 ? Static400.aClass2_Sub34_28.lb.method5049() : Static400.aClass2_Sub34_28.aClass57_Sub25_3.method5049()) != 0 && arg1 != 0 && Static33.anInt779 < 50 && arg0 != -1) {
	...
	public static Class2_Sub2_Sub13 method1934() {
		return Static30.aClass2_Sub2_Sub13_3;
	}

	@OriginalMember(owner = "client!fo", name = "a", descriptor = "(III)V")
	public static void method1936(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
