...
public final class Static188 {
	...
	public static void method1966(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8) {
		if (arg7 == arg6 && arg0 == arg5 && arg4 == arg8 && arg2 == arg3) {
			Static418.method5571(arg8, arg2, arg7, arg1, arg0);
			return;
		}
		...
		for (@Pc(109) int local109 = 128; local109 <= 4096; local109 += 128) {
			...
			Static418.method5571(local157, local168, local32, arg1, local34);
			local32 = local157;
			local34 = local168;
		}
	}
	...
	public static int method1967(@OriginalArg(1) int arg0) {
		return arg0 >>> 8;
	}

	@OriginalMember(owner = "client!fq", name = "a", descriptor = "(IIILclient!eq;IIIIIII)Z")
	public static boolean method1968(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class110 arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9) {
		...
		while (local43 != local50) {
			...
			if (arg2 == -4) {
				...
				if (Static275.method2781(arg6, 1, local5, arg0, arg1, local7, arg7, 1)) {
					Static594.anInt8775 = local5;
					Static407.anInt6285 = local7;
					return true;
				}
			} else if (arg2 == -2) {
				if (arg3.method1658(1, arg7, 1, local5, arg6, arg9, arg1, local7, arg0)) {
					Static407.anInt6285 = local7;
					Static594.anInt8775 = local5;
					return true;
				}
			} else if (arg2 == -1) {
				if (arg3.method1662(arg7, arg9, arg6, local5, 1, arg1, arg0, local7)) {
					Static407.anInt6285 = local7;
					Static594.anInt8775 = local5;
					return true;
				}
			} else if (arg2 == 0 || arg2 == 1 || arg2 == 2 || arg2 == 3 || arg2 == 9) {
				if (arg3.method1663(1, arg2, arg7, local7, local5, arg6, arg8)) {
					Static594.anInt8775 = local5;
					Static407.anInt6285 = local7;
					return true;
				}
			} else if (arg3.method1656(local5, arg2, arg6, arg7, arg8, local7, 1)) {
				Static407.anInt6285 = local7;
				Static594.anInt8775 = local5;
				return true;
			}
	...
	public static int method1970(@OriginalArg(1) Class330 arg0) {
		@Pc(5) int local5 = 0;
		if (arg0.method5345(Static159.anInt2787)) {
			local5++;
		}
		if (arg0.method5345(Static434.anInt6579)) {
			local5++;
		}
		if (arg0.method5345(Static67.anInt6784)) {
			local5++;
		}
		if (arg0.method5345(Static304.anInt4876)) {
			local5++;
		}
		if (arg0.method5345(Static644.anInt9607)) {
			local5++;
		}
		if (arg0.method5345(Static699.anInt10540)) {
			local5++;
		}
		if (arg0.method5345(Static132.anInt2451)) {
			local5++;
		}
		if (arg0.method5345(Static270.anInt4355)) {
			local5++;
		}
		if (arg0.method5345(Static598.anInt8828)) {
			local5++;
		}
		if (arg0.method5345(Static305.anInt4883)) {
			local5++;
		}
		if (arg0.method5345(Static548.anInt8259)) {
			local5++;
		}
		if (arg0.method5345(Static113.anInt2238)) {
			local5++;
		}
		if (arg0.method5345(Static670.anInt10024)) {
			local5++;
		}
		if (arg0.method5345(Static286.anInt4592)) {
			local5++;
		}
		if (arg0.method5345(Static665.anInt9943)) {
			local5++;
		}
		return local5;
	}
