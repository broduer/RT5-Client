...
public final class Static188 {
	...
	public static final int anInt3113 = 1337;
	...
	public static void method2856(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8) {
		if (arg7 == arg6 && arg0 == arg5 && arg4 == arg8 && arg2 == arg3) {
			Static418.method7869(arg8, arg2, arg7, arg1, arg0);
			return;
		}
		...
		for (@Pc(109) int local109 = 128; local109 <= 4096; local109 += 128) {
			...
			Static418.method7869(local157, local168, local32, arg1, local34);
			local32 = local157;
			local34 = local168;
		}
	}
	...
	public static boolean method2858(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class110 arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9) {
		...
		while (local43 != local50) {
			...
			@Pc(70) int local70 = local7 - arg3.anInt2654;
			@Pc(76) int local76 = local5 - arg3.anInt2656;
	...
	public static int method2860(@OriginalArg(1) Class332 arg0) {
		@Pc(5) int local5 = 0;
		if (arg0.method7588(Static159.anInt2796)) {
			local5++;
		}
		if (arg0.method7588(Static434.anInt6599)) {
			local5++;
		}
		if (arg0.method7588(Static67.anInt6805)) {
			local5++;
		}
		if (arg0.method7588(Static304.anInt4892)) {
			local5++;
		}
		if (arg0.method7588(Static644.anInt9633)) {
			local5++;
		}
		if (arg0.method7588(Static699.anInt10568)) {
			local5++;
		}
		if (arg0.method7588(Static132.anInt2460)) {
			local5++;
		}
		if (arg0.method7588(Static270.anInt4368)) {
			local5++;
		}
		if (arg0.method7588(Static598.anInt8852)) {
			local5++;
		}
		if (arg0.method7588(Static305.anInt4899)) {
			local5++;
		}
		if (arg0.method7588(Static548.anInt8282)) {
			local5++;
		}
		if (arg0.method7588(Static113.anInt2247)) {
			local5++;
		}
		if (arg0.method7588(Static670.anInt10051)) {
			local5++;
		}
		if (arg0.method7588(Static286.anInt4606)) {
			local5++;
		}
		if (arg0.method7588(Static665.anInt9970)) {
			local5++;
		}
		return local5;
	}
