...
public final class Static189 {
	...
	public static final Class206 aClass206_7 = new Class206(7, 2);
	...
	public static Class282 method2864(@OriginalArg(0) int arg0) {
		@Pc(6) Class282[] local6 = Static400.method7119();
		for (@Pc(8) int local8 = 0; local8 < local6.length; local8++) {
			@Pc(19) Class282 local19 = local6[local8];
			if (arg0 == local19.anInt7060) {
				return local19;
			}
		}
		return null;
