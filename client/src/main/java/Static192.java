...
public final class Static192 {
	...
	public static String method1979(@OriginalArg(0) Class2_Sub2_Sub4 arg0) {
		return arg0.aString10 + " <col=ffffff>>";
	}

	@OriginalMember(owner = "client!fu", name = "a", descriptor = "(Lclient!cba;I)I")
	public static int method1980(@OriginalArg(0) Class2_Sub2_Sub4 arg0) {
		@Pc(14) String local14 = method1979(arg0);
		return Static42.aClass381_4.method6239(Static186.aClass23Array5, local14);
	}

	@OriginalMember(owner = "client!fu", name = "a", descriptor = "(I)Lclient!aea;")
	public static Class8_Sub1 method1981() {
		@Pc(14) Class8_Sub1 local14 = (Class8_Sub1) Static129.aClass130_3.method1898();
		if (local14 == null) {
	...
	public static void method1982(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2) {
		Static524.aClass153_3 = Static405.aClass153_2;
		Static299.anInt4825 = 2;
		Static470.anInt7113 = arg1;
		Static238.method2504(false, arg2, false, arg0);
	}
}
