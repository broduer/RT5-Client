...
public final class Static194 {
	...
	public static byte method2009(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		if (arg0 == 9) {
	...
	public static void method2012() {
		...
		synchronized (Static354.aClass82_120) {
			Static354.aClass82_120.method1381(5);
		}
	}

	@OriginalMember(owner = "client!g", name = "a", descriptor = "(BII)Z")
	public static boolean method2013(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
