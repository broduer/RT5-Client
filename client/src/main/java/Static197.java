...
public final class Static197 {
	...
	public static void method2054() {
		...
		for (local8 = (Class2_Sub25) Static159.aClass339_15.method5453(65280); local8 != null; local8 = (Class2_Sub25) Static159.aClass339_15.method5460()) {
			if (local8.aBoolean309) {
				...
				if (local8.anInt4016 >= 0 && local8.anInt4006 >= 0 && Static720.anInt10859 > local8.anInt4016 && Static501.anInt7568 > local8.anInt4006) {
					Static293.method2997(local8);
				}
			}
		}
		for (local8 = (Class2_Sub25) Static227.aClass339_18.method5453(65280); local8 != null; local8 = (Class2_Sub25) Static227.aClass339_18.method5460()) {
			if (local8.aBoolean309) {
				local8.a((byte) 30);
			} else {
				local8.aBoolean310 = true;
