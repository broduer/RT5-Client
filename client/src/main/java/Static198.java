...
public final class Static198 {
	...
	public static void method2056() {
		Static186.aClass82_67.method1381(5);
	}

	@OriginalMember(owner = "client!gca", name = "a", descriptor = "(IIIIIIII)V")
	public static void method2058(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6) {
		...
		if (arg6 == 0) {
			local52 = (Interface25) Static302.method3069(arg0, arg4, arg1);
			@Pc(58) Interface25 local58 = (Interface25) Static619.method954(arg0, arg4, arg1);
			if (local52 != null && arg2 != 2) {
				if (local52 instanceof Class8_Sub2_Sub3_Sub1) {
					((Class8_Sub2_Sub3_Sub1) local52).aClass337_1.method5426(arg3);
				} else {
					Static235.method2459(arg1, arg2, arg5, arg4, arg3, arg6, arg0, local52.method4822(-32136));
				}
			}
			if (local58 != null) {
				if (local58 instanceof Class8_Sub2_Sub3_Sub1) {
					((Class8_Sub2_Sub3_Sub1) local58).aClass337_1.method5426(arg3);
				} else {
					Static235.method2459(arg1, arg2, arg5, arg4, arg3, arg6, arg0, local58.method4822(-32136));
				}
			}
		} else if (arg6 == 1) {
			local52 = (Interface25) Static114.method1368(arg0, arg4, arg1);
			if (local52 != null) {
				if (local52 instanceof Class8_Sub2_Sub4_Sub2) {
					((Class8_Sub2_Sub4_Sub2) local52).aClass337_4.method5426(arg3);
				} else {
					@Pc(279) int local279 = local52.method4822(-32136);
					if (arg2 == 4 || arg2 == 5) {
						Static235.method2459(arg1, 4, arg5, arg4, arg3, arg6, arg0, local279);
					} else if (arg2 == 6) {
						Static235.method2459(arg1, 4, arg5 + 4, arg4, arg3, arg6, arg0, local279);
					} else if (arg2 == 7) {
						Static235.method2459(arg1, 4, (arg5 + 2 & 0x3) + 4, arg4, arg3, arg6, arg0, local279);
					} else if (arg2 == 8) {
						Static235.method2459(arg1, 4, arg5 + 4, arg4, arg3, arg6, arg0, local279);
						Static235.method2459(arg1, 4, (arg5 + 2 & 0x3) + 4, arg4, arg3, arg6, arg0, local279);
					}
			...
			local52 = (Interface25) Static578.method5387(arg0, arg4, arg1, aClass9 == null ? (aClass9 = Class140.a("uv")) : aClass9);
			if (local52 != null) {
				if (arg2 == 11) {
					arg2 = 10;
				}
				if (local52 instanceof Class8_Sub2_Sub1_Sub4) {
					((Class8_Sub2_Sub1_Sub4) local52).aClass337_3.method5426(arg3);
				} else {
					Static235.method2459(arg1, arg2, arg5, arg4, arg3, arg6, arg0, local52.method4822(-32136));
				}
			}
		} else if (arg6 == 3) {
			local52 = (Interface25) Static687.method6405(arg0, arg4, arg1);
			if (local52 != null) {
				if (local52 instanceof Class8_Sub2_Sub2_Sub2) {
					((Class8_Sub2_Sub2_Sub2) local52).aClass337_2.method5426(arg3);
				} else {
					Static235.method2459(arg1, arg2, arg5, arg4, arg3, arg6, arg0, local52.method4822(-32136));
				}
			}
	...
	public static void method2059(@OriginalArg(1) boolean arg0, @OriginalArg(2) boolean arg1) {
		if (arg1) {
			Static432.anInt524++;
			Static315.method3198();
		}
		if (arg0) {
			Static191.anInt3115++;
			Static457.method4336();
		}
	}

	@OriginalMember(owner = "client!gca", name = "a", descriptor = "(B)[Lclient!gca;")
	public static Class140[] method2060() {
	...
	public static boolean method2062(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (Static116.method1376(arg0, arg1)) {
			return (arg0 & 0xB000) != 0 | Static54.method698(arg1, arg0) | Static194.method2013(arg0, arg1) ? true : (Static139.method1556(arg0, arg1) | Static401.method3957(arg0, arg1)) & (arg1 & 0x37) == 0;
		} else {
			return false;
		}
	}
