...
public final class Static198 {
	...
	public static void method2953(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6) {
		if (arg4 < 0 || arg1 < 0 || Static720.anInt10888 - 1 <= arg4 || Static501.anInt7591 - 1 <= arg1) {
			return;
		}
		...
		if (arg6 == 0) {
			local52 = (Interface25) Static302.method4421(arg0, arg4, arg1);
			...
			if (local52 != null && arg2 != 2) {
				if (local52 instanceof Class8_Sub2_Sub3_Sub1) {
					((Class8_Sub2_Sub3_Sub1) local52).aClass339_1.method7679(arg3);
				} else {
					Static235.method3421(arg1, arg2, arg5, arg4, arg3, arg6, arg0, local52.method6866(-32136));
				}
			}
			if (local58 != null) {
				if (local58 instanceof Class8_Sub2_Sub3_Sub1) {
					((Class8_Sub2_Sub3_Sub1) local58).aClass339_1.method7679(arg3);
				} else {
					Static235.method3421(arg1, arg2, arg5, arg4, arg3, arg6, arg0, local58.method6866(-32136));
				}
			}
		} else if (arg6 == 1) {
			...
			if (local52 != null) {
				if (local52 instanceof Class8_Sub2_Sub4_Sub2) {
					...
					@Pc(279) int local279 = local52.method6866(-32136);
					if (arg2 == 4 || arg2 == 5) {
			...
			local52 = (Interface25) Static578.method7630(arg0, arg4, arg1, aClass9 == null ? (aClass9 = getClass("Interface25")) : aClass9);
			if (local52 != null) {
				if (arg2 == 11) {
					arg2 = 10;
				}
				if (local52 instanceof Class8_Sub2_Sub1_Sub4) {
					((Class8_Sub2_Sub1_Sub4) local52).aClass339_3.method7679(arg3);
				} else {
					Static235.method3421(arg1, arg2, arg5, arg4, arg3, arg6, arg0, local52.method6866(-32136));
				}
			}
		} else if (arg6 == 3) {
			local52 = (Interface25) Static687.method8966(arg0, arg4, arg1);
			if (local52 != null) {
				if (local52 instanceof Class8_Sub2_Sub2_Sub2) {
					((Class8_Sub2_Sub2_Sub2) local52).aClass339_2.method7679(arg3);
				} else {
					Static235.method3421(arg1, arg2, arg5, arg4, arg3, arg6, arg0, local52.method6866(-32136));
				}
			}
	...
	public static void method2954(@OriginalArg(1) boolean arg0, @OriginalArg(2) boolean arg1) {
		if (arg1) {
			Static432.anInt526++;
			Static315.method4582();
		}
		if (arg0) {
			Static191.anInt3124++;
			Static457.method6239();
		}
	}
	...
	public static boolean method2957(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (Static116.method2142(arg0, arg1)) {
			return (arg0 & 0xB000) != 0 | Static54.method1183(arg1, arg0) | Static194.method2908(arg0, arg1) ? true : (Static139.method2358(arg0, arg1) | Static401.method5582(arg0, arg1)) & (arg1 & 0x37) == 0;
		} else {
			return false;
		}
	}
