...
public final class Static2 {
	...
	public static void method29(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		@Pc(9) Class2_Sub2_Sub2 local9 = Static440.method4204(6, (long) arg1);
		local9.method130();
		local9.anInt197 = arg0;
	}

	@OriginalMember(owner = "client!aaa", name = "a", descriptor = "(IBIILclient!cv;)V")
	public static void method30(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) Class2_Sub15 arg3) {
		@Pc(16) long local16 = (long) (arg1 << 14 | arg0 << 28 | arg2);
		@Pc(22) Class2_Sub17 local22 = (Class2_Sub17) Static497.aClass28_35.method373(local16);
		if (local22 == null) {
			local22 = new Class2_Sub17();
			Static497.aClass28_35.method370(local16, local22);
			local22.aClass339_12.method5465(arg3);
			return;
		}
		@Pc(45) Class382 local45 = Static419.aClass112_1.method1684(arg3.anInt1958);
		@Pc(48) int local48 = local45.anInt10142;
		if (local45.anInt10115 == 1) {
			local48 *= arg3.anInt1959 + 1;
		}
		for (@Pc(65) Class2_Sub15 local65 = (Class2_Sub15) local22.aClass339_12.method5453(65280); local65 != null; local65 = (Class2_Sub15) local22.aClass339_12.method5460()) {
			local45 = Static419.aClass112_1.method1684(local65.anInt1958);
			@Pc(78) int local78 = local45.anInt10142;
			if (local45.anInt10115 == 1) {
				local78 *= local65.anInt1959 + 1;
			}
			if (local48 > local78) {
				Static201.method5177(local65, arg3);
				return;
			}
		}
		if (-108 == -108) {
	...
	public static void method32(@OriginalArg(1) int arg0) {
		if (arg0 == 37) {
	...
	public static boolean method33(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return (arg1 & 0x37) != 0;
	}
}
