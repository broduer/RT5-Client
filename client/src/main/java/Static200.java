...
public final class Static200 {
	...
	public static synchronized void method2079(@OriginalArg(0) byte[] arg0) {
	...
	public static int method2080(@OriginalArg(0) String arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(3) int arg2) {
		@Pc(17) int local17 = arg0.length();
		for (@Pc(19) int local19 = 0; local19 < local17; local19 += 4) {
			@Pc(29) int local29 = Static204.method2171(arg0.charAt(local19));
			@Pc(48) int local48 = local19 + 1 >= local17 ? -1 : Static204.method2171(arg0.charAt(local19 + 1));
			@Pc(68) int local68 = local17 > local19 + 2 ? Static204.method2171(arg0.charAt(local19 + 2)) : -1;
			@Pc(84) int local84 = local19 + 3 >= local17 ? -1 : Static204.method2171(arg0.charAt(local19 + 3));
	...
	public static synchronized byte[] method2081(@OriginalArg(1) int arg0) {
		@Pc(18) byte[] local18;
