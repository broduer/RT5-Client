...
public final class Static204 {
	...
	public static void method2169(@OriginalArg(0) Class330 arg0) {
		Static159.anInt2787 = arg0.method5354("hitbar_default");
		Static434.anInt6579 = arg0.method5354("timerbar_default");
		Static67.anInt6784 = arg0.method5354("headicons_pk");
		Static304.anInt4876 = arg0.method5354("headicons_prayer");
		Static644.anInt9607 = arg0.method5354("hint_headicons");
		Static699.anInt10540 = arg0.method5354("hint_mapmarkers");
		Static132.anInt2451 = arg0.method5354("mapflag");
		Static270.anInt4355 = arg0.method5354("cross");
		Static598.anInt8828 = arg0.method5354("mapdots");
		Static305.anInt4883 = arg0.method5354("scrollbar");
		Static548.anInt8259 = arg0.method5354("name_icons");
		Static113.anInt2238 = arg0.method5354("floorshadows");
		Static670.anInt10024 = arg0.method5354("compass");
		Static286.anInt4592 = arg0.method5354("otherlevel");
		Static665.anInt9943 = arg0.method5354("hint_mapedge");
	}

	@OriginalMember(owner = "client!gfa", name = "a", descriptor = "(BC)I")
	public static int method2171(@OriginalArg(1) char arg0) {
	...
	public static boolean method2173(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class110 arg9) {
		...
		while (local52 != local41) {
			...
			if (arg5 == -4) {
				...
				if (Static275.method2781(arg3, 2, local5, arg6, arg2, local7, arg7, 2)) {
					Static407.anInt6285 = local7;
					Static594.anInt8775 = local5;
					return true;
				}
			} else if (arg5 == -2) {
				if (arg9.method1658(2, arg7, 2, local5, arg3, arg0, arg2, local7, arg6)) {
					Static407.anInt6285 = local7;
					Static594.anInt8775 = local5;
					return true;
				}
			} else if (arg5 == -1) {
				if (arg9.method1662(arg7, arg0, arg3, local5, 2, arg2, arg6, local7)) {
					Static407.anInt6285 = local7;
					Static594.anInt8775 = local5;
					return true;
				}
			} else if (arg5 == 0 || arg5 == 1 || arg5 == 2 || arg5 == 3 || arg5 == 9) {
				if (arg9.method1663(2, arg5, arg7, local7, local5, arg3, arg4)) {
					Static594.anInt8775 = local5;
					Static407.anInt6285 = local7;
					return true;
				}
			} else if (arg9.method1656(local5, arg5, arg3, arg7, arg4, local7, 2)) {
				Static407.anInt6285 = local7;
				Static594.anInt8775 = local5;
				return true;
			}
