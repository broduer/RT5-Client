...
public final class Static206 {
	...
	public static final int anInt3431 = 1339;

	@OriginalMember(owner = "client!gga", name = "a", descriptor = "(Lclient!d;Ljava/awt/Canvas;II)Lclient!ha;")
	public static Class19 method3093(@OriginalArg(0) TextureProvider arg0, @OriginalArg(1) Canvas arg1, @OriginalArg(2) int arg2) {
