...
public final class Static208 {
	...
	public static void method2195(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		...
		if (Static616.anInt9417 == 1) {
			...
			local30.a(local5 - 8, local7 + -8);
			Static682.method6378(local7 - 8, local7 - 8 - -local30.a(), local5 - 8, local30.b() + -8 + local5);
		}
		if (Static616.anInt9417 == 2) {
			local30 = Static355.aClass23Array9[Static481.anInt7215 / 100 + 4];
			local30.a(local5 - 8, local7 + -8);
			Static682.method6378(local7 - 8, local30.a() + -8 + local7, local5 - 8, local30.b() + local5 + -8);
		}
		Static494.method4626();
	}

	@OriginalMember(owner = "client!gha", name = "a", descriptor = "(Z)V")
	public static void method2196() {
		Static334.aClass319_1.method6036();
		Static189.aClass120_1.method6314();
		Static295.aClient1.method1061();
	...
	public static boolean method2197(@OriginalArg(0) Class8_Sub2 arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) byte[][][] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte arg4) {
		...
		for (@Pc(39) int local39 = local9; local39 <= local11; local39++) {
			for (@Pc(42) int local42 = local16; local42 <= local18; local42++) {
				if (arg0.aByte143 < Static299.anInt4824 && local39 >= Static441.anInt6691 && local39 < Static77.anInt1613 && local42 >= Static220.anInt3562 && local42 < Static692.anInt10370) {
					if ((arg2 == null || arg0.aByte144 < arg3 || arg2[arg0.aByte144][local39][local42] != arg4) && arg0.g() && !arg0.a((byte) 59, Static665.aClass19_15)) {
						return false;
					}
					if (!arg1 && local39 >= Static403.anInt6246 - 16 && local39 <= Static403.anInt6246 + 16 && local42 >= Static550.anInt8271 - 16 && local42 <= Static550.anInt8271 + 16) {
						if (Static661.aBoolean457) {
							Static684.aClass302Array1[Static29.anInt702++].method4797(arg0);
							Static29.anInt702 %= Static549.anInt9424;
						} else {
							arg0.d(Static665.aClass19_15, -5);
						}
					}
				}
			}
