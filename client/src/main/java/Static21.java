...
public final class Static21 {
	...
	public static void method8050(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) boolean arg5, @OriginalArg(8) boolean arg6) {
		Static665.aClass19_15 = arg0;
		Static32.anInt775 = arg1;
		Static661.aBoolean457 = Static32.anInt775 > 1 && Static665.aClass19_15.method7986();
		...
		Static35.anInt816 = arg4;
		Static272.aClass13_1 = Static167.method2632();
		Static276.method3986();
		Static478.aClass293ArrayArrayArray3 = new Class293[4][Static619.anInt1573][Static662.anInt9869];
		Static706.aClass178Array3 = new Class178[4];
		if (arg5) {
			Static62.anIntArrayArray33 = new int[Static619.anInt1573][Static662.anInt9869];
			Static421.aByteArrayArray20 = new byte[Static619.anInt1573][Static662.anInt9869];
			Static272.aShortArrayArray5 = new short[Static619.anInt1573][Static662.anInt9869];
			Static420.aClass293ArrayArrayArray2 = new Class293[1][Static619.anInt1573][Static662.anInt9869];
		...
		Static258.aBooleanArrayArray3 = new boolean[Static35.anInt816 + Static35.anInt816 + 1][Static35.anInt816 + Static35.anInt816 + 1];
		Static142.aBooleanArrayArray1 = new boolean[Static35.anInt816 + Static35.anInt816 + 2][Static35.anInt816 + Static35.anInt816 + 2];
		Static102.anIntArray184 = new int[Static35.anInt816 + Static35.anInt816 + 2];
		Static514.aClass215_2 = Static514.aClass215_3;
		if (Static661.aBoolean457) {
			Static433.aBooleanArrayArrayArray5 = new boolean[4][Static35.anInt816 + Static35.anInt816 + 1][Static35.anInt816 + Static35.anInt816 + 1];
			Static275.aBooleanArrayArrayArray4 = new boolean[4][][];
			if (Static226.aClass46Array7 != null) {
				Static227.method3354();
			}
			Static226.aClass46Array7 = new Class46[Static32.anInt775];
			Static665.aClass19_15.method7963(Static226.aClass46Array7.length + 1);
			Static665.aClass19_15.method8027(0);
			...
			if (Static32.anInt775 == 2) {
				local253 = 4;
				Static549.anInt9450 = 2;
			} else if (Static32.anInt775 == 3) {
				local253 = 6;
				Static549.anInt9450 = 3;
			} else {
				local253 = 8;
				Static549.anInt9450 = 4;
			}
			Static684.aClass304Array1 = new Class304[local253];
			for (@Pc(273) int local273 = 0; local273 < local253; local273++) {
				Static684.aClass304Array1[local273] = new Class304(Static515.aStringArrayArray2[Static32.anInt775 - 2][local273]);
			}
		} else {
			Static549.anInt9450 = 1;
		}
		Static537.anIntArray633 = new int[Static549.anInt9450 - 1];
		Static621.anIntArray766 = new int[Static549.anInt9450 - 1];
	}

	@OriginalMember(owner = "client!am", name = "a", descriptor = "(ILjava/io/File;Z)V")
	public static void method8055(@OriginalArg(1) File arg0) {
		if (Static210.anObject8 == null) {
			Static716.method9356();
		}
		try {
