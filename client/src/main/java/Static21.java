...
public final class Static21 {
	...
	public static void method5652(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) boolean arg5, @OriginalArg(8) boolean arg6) {
		Static665.aClass19_15 = arg0;
		Static32.anInt772 = arg1;
		Static661.aBoolean457 = Static32.anInt772 > 1 && Static665.aClass19_15.s();
		...
		Static272.aClass13_1 = Static167.method1774();
		Static276.method2788();
		...
		if (Static661.aBoolean457) {
			...
			if (Static226.aClass46Array7 != null) {
				Static227.method2392();
			}
			Static226.aClass46Array7 = new Class46[Static32.anInt772];
			Static665.aClass19_15.j(Static226.aClass46Array7.length + 1);
			Static665.aClass19_15.k(0);
	...
	public static void method5657(@OriginalArg(1) File arg0) {
		if (Static210.anObject8 == null) {
			Static716.method6738();
		}
		try {
			@Pc(28) Class local28 = Class.forName("com.sun.management.HotSpotDiagnosticMXBean");
			@Pc(54) Method local54 = local28.getDeclaredMethod("dumpHeap", aClass23 == null ? (aClass23 = Class19_Sub1.a((String) "java.lang.String")) : aClass23, Boolean.TYPE);
	...
	public static boolean method5728() {
		if (Static98.aBoolean191) {
			try {
				Static727.method54("showVideoAd", Static166.anApplet1);
				return true;
