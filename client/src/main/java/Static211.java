...
public final class Static211 {
	...
	public static void method3485(@OriginalArg(0) int arg0, @OriginalArg(2) String arg1) {
		@Pc(16) Class2_Sub2_Sub2 local16 = Static440.method4204(3, (long) arg0);
		local16.method130();
		local16.aString1 = arg1;
	}

	@OriginalMember(owner = "client!gj", name = "a", descriptor = "(IIIIII)V")
	public static void method3487(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		@Pc(7) int local7 = 0;
		...
		Static696.method6473(arg2 + arg4, arg3, arg4 - arg2, Static723.anIntArrayArray266[arg0]);
		...
		while (local9 > 0) {
			...
			Static696.method6473(local180, arg3, local185, Static723.anIntArrayArray266[local172]);
			Static696.method6473(local180, arg3, local185, Static723.anIntArrayArray266[local176]);
		}
	}
}
