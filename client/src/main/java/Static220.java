...
public final class Static220 {
	...
	public static boolean method2282(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		return (arg0 & 0x10000) != 0;
	}

	@OriginalMember(owner = "client!gq", name = "a", descriptor = "(IBIII)V")
	public static void method2283(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		for (@Pc(6) Class2_Sub51 local6 = (Class2_Sub51) Static460.aClass339_40.method5453(65280); local6 != null; local6 = (Class2_Sub51) Static460.aClass339_40.method5460()) {
			Static632.method5930(arg0, local6, arg3, arg2, arg1);
		}
		if (-123 <= -127) {
			return;
		}
		...
		for (@Pc(42) Class2_Sub51 local42 = (Class2_Sub51) Static717.aClass339_81.method5453(65280); local42 != null; local42 = (Class2_Sub51) Static717.aClass339_81.method5460()) {
			@Pc(46) byte local46 = 1;
			@Pc(51) Class289 local51 = local42.aClass8_Sub2_Sub1_Sub2_Sub2_3.method6708();
			@Pc(57) int local57 = local42.aClass8_Sub2_Sub1_Sub2_Sub2_3.aClass152_10.method6548();
			...
			if (local42.anInt9364 != local46) {
				local154 = Static497.method4658(local42.aClass8_Sub2_Sub1_Sub2_Sub2_3);
				@Pc(158) Class268 local158 = local42.aClass8_Sub2_Sub1_Sub2_Sub2_3.aClass268_1;
				if (local158.anIntArray532 != null) {
					local158 = local158.method4221(65535, Static34.aClass304_1);
				}
				if (local158 == null || local154 == -1) {
					...
					if (local42.aClass2_Sub6_Sub2_4 == null) {
						...
						if (local42.anInt9358 <= 0) {
							Static336.aClass2_Sub6_Sub3_1.method4174(local42.aClass2_Sub6_Sub2_4);
							local198 = true;
			...
			local42.anInt9362 = local42.aClass8_Sub2_Sub1_Sub2_Sub2_3.anInt10690 + (local42.aClass8_Sub2_Sub1_Sub2_Sub2_3.method6693((byte) 53) << 8);
			local42.anInt9352 = local42.aClass8_Sub2_Sub1_Sub2_Sub2_3.anInt10694;
			local42.anInt9349 = local42.aClass8_Sub2_Sub1_Sub2_Sub2_3.anInt10694 + (local42.aClass8_Sub2_Sub1_Sub2_Sub2_3.method6693((byte) 68) << 8);
			Static632.method5930(arg0, local42, arg3, arg2, arg1);
		}
		for (@Pc(329) Class2_Sub51 local329 = (Class2_Sub51) Static113.aClass28_12.method371(); local329 != null; local329 = (Class2_Sub51) Static113.aClass28_12.method375()) {
			@Pc(333) byte local333 = 1;
			@Pc(338) Class289 local338 = local329.aClass8_Sub2_Sub1_Sub2_Sub1_3.method6708();
			local154 = local329.aClass8_Sub2_Sub1_Sub2_Sub1_3.aClass152_10.method6548();
			...
			if (local333 != local329.anInt9364) {
				@Pc(448) int local448 = Static326.method3400(local329.aClass8_Sub2_Sub1_Sub2_Sub1_3);
				if (local329.anInt9353 == local448 && local329.aClass8_Sub2_Sub1_Sub2_Sub1_3.aBoolean126 == local329.aBoolean714) {
					...
					if (local329.aClass2_Sub6_Sub2_4 == null) {
						...
						if (local329.anInt9358 <= 0) {
							Static336.aClass2_Sub6_Sub3_1.method4174(local329.aClass2_Sub6_Sub2_4);
			...
			local329.anInt9362 = local329.aClass8_Sub2_Sub1_Sub2_Sub1_3.anInt10690 + (local329.aClass8_Sub2_Sub1_Sub2_Sub1_3.method6693((byte) 127) << 8);
			local329.anInt9352 = local329.aClass8_Sub2_Sub1_Sub2_Sub1_3.anInt10694;
			local329.anInt9349 = local329.aClass8_Sub2_Sub1_Sub2_Sub1_3.anInt10694 + (local329.aClass8_Sub2_Sub1_Sub2_Sub1_3.method6693((byte) 62) << 8);
			Static632.method5930(arg0, local329, arg3, arg2, arg1);
		}
	}

	@OriginalMember(owner = "client!gq", name = "a", descriptor = "(ZIZI[Lclient!hda;I)V")
	public static void method2285(@OriginalArg(1) int arg0, @OriginalArg(2) boolean arg1, @OriginalArg(3) int arg2, @OriginalArg(4) Class158[] arg3, @OriginalArg(5) int arg4) {
		for (@Pc(5) int local5 = 0; local5 < arg3.length; local5++) {
			@Pc(14) Class158 local14 = arg3[local5];
			if (local14 != null && local14.anInt3743 == arg4) {
				Static507.method4746(arg1, arg2, arg0, local14);
				Static470.method4467(local14, arg0, arg2, -8525);
				...
				if (local14.anInt3820 == 0) {
					Static134.method6402(local14, arg1);
				}
			}
		}
	}
	...
	public static boolean method2286(@OriginalArg(0) Class56 arg0, @OriginalArg(1) Class330 arg1, @OriginalArg(2) Class330 arg2, @OriginalArg(3) Class330 arg3, @OriginalArg(5) Class2_Sub6_Sub1 arg4) {
