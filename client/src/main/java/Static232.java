...
public final class Static232 {
	...
	public static void method2425(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class2_Sub2_Sub16 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10) {
		if (arg9 < arg10 && arg1 + arg9 > arg10 && arg8 > arg4 - 13 && arg4 + 3 > arg8 && arg6.aBoolean552) {
			arg7 = arg5;
		}
		@Pc(49) int[] local49 = null;
		if (Static245.method6152(arg6.anInt7314)) {
			local49 = Static419.aClass112_1.method1684((int) arg6.aLong233).anIntArray800;
		} else if (arg6.anInt7317 != -1) {
			local49 = Static419.aClass112_1.method1684(arg6.anInt7317).anIntArray800;
		} else if (Static598.method5554(arg6.anInt7314)) {
			@Pc(110) Class2_Sub45 local110 = (Class2_Sub45) Static18.aClass28_2.method373((long) (int) arg6.aLong233);
			if (local110 != null) {
				...
				if (local118.anIntArray532 != null) {
					local118 = local118.method4221(65535, Static34.aClass304_1);
				}
				if (local118 != null) {
					local49 = local118.anIntArray533;
				}
			}
		} else if (Static523.method2482(arg6.anInt7314)) {
			@Pc(87) Class54 local87 = Static354.aClass142_4.method2158((int) (arg6.aLong233 >>> 32 & 0x7FFFFFFFL), 99);
			if (local87.anIntArray113 != null) {
				local87 = local87.method801(13, Static34.aClass304_1);
			}
			if (local87 != null) {
				local49 = local87.anIntArray112;
			}
		}
		@Pc(154) String local154 = Static518.a(arg6);
		if (local49 != null) {
			local154 = local154 + Static72.method966(local49);
		}
		Static180.aClass14_3.a(arg7, 0, arg4, local154, -238946248, arg9 + 3, Static186.aClass23Array5, Static460.anIntArray554);
		if (arg6.aBoolean553) {
			Static517.aClass23_32.a(arg9 + Static42.aClass381_4.method6241(local154) + 5, arg4 + -12);
		}
	}
	...
	public static void method2430() {
		try {
			...
			if (Static96.anInt10171 == 1) {
				local14 = Static581.aClass2_Sub6_Sub1_3.method490();
				if (local14 > 0 && Static581.aClass2_Sub6_Sub1_3.method464()) {
					local14 -= Static190.anInt3112;
					if (local14 < 0) {
						local14 = 0;
					}
					Static581.aClass2_Sub6_Sub1_3.method458(local14);
					return;
				}
				Static581.aClass2_Sub6_Sub1_3.method454();
				Static581.aClass2_Sub6_Sub1_3.method469();
			...
			if (Static96.anInt10171 == 3) {
				local14 = Static581.aClass2_Sub6_Sub1_3.method490();
				if (local14 < Static24.anInt595 && Static581.aClass2_Sub6_Sub1_3.method464()) {
	...
	public static String method2433(@OriginalArg(0) String arg0, @OriginalArg(2) String arg1, @OriginalArg(3) String arg2) {
	...
	public static boolean method2438() {
		@Pc(10) Class2_Sub57 local10 = (Class2_Sub57) Static631.aClass339_78.method5453(65280);
		if (local10 == null) {
			return false;
		}
