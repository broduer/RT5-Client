...
public final class Static235 {
	...
	public static void method2459(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7) {
		if (arg3 < 1 || arg0 < 1 || Static720.anInt10859 - 2 < arg3 || Static501.anInt7568 - 2 < arg0) {
			return;
		}
		@Pc(39) int local39 = arg6;
		if (arg6 < 3 && Static441.method4209(arg0, arg3)) {
			local39 = arg6 + 1;
		}
		if (Static400.aClass2_Sub34_28.aClass57_Sub19_2.method4201() == 0 && !Static696.method6472(arg0, Static164.anInt2808, arg3, local39)) {
			return;
		}
		if (Static334.aClass291ArrayArrayArray1 == null) {
			return;
		}
		Static2.aClass306_Sub1_1.method5598(arg5, arg0, Static577.aClass110Array1[arg6], arg6, arg3, Static163.aClass19_17);
		if (arg7 >= 0) {
			@Pc(93) int local93 = Static400.aClass2_Sub34_28.aClass57_Sub6_1.method1849();
			Static400.aClass2_Sub34_28.method3576(1, Static400.aClass2_Sub34_28.aClass57_Sub6_1);
			Static2.aClass306_Sub1_1.method5591(arg1, arg7, Static577.aClass110Array1[arg6], arg0, Static163.aClass19_17, arg3, arg2, local39, arg6, arg4);
			Static400.aClass2_Sub34_28.method3576(local93, Static400.aClass2_Sub34_28.aClass57_Sub6_1);
		}
	}

	@OriginalMember(owner = "client!hf", name = "b", descriptor = "(III)Z")
	public static boolean method2462(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 11) {
			arg1 = 10;
		}
		@Pc(19) Class54 local19 = Static354.aClass142_4.method2158(arg0, 61);
		if (arg1 >= 5 && arg1 <= 8) {
			arg1 = 4;
		}
		return local19.method804(arg1);
	}

	@OriginalMember(owner = "client!hf", name = "a", descriptor = "(Lclient!ge;B)Lclient!pi;")
	public static Class39 method2463(@OriginalArg(0) Class2_Sub21 arg0) {
		@Pc(7) int local7 = arg0.method5205();
		@Pc(19) Class155 local19 = Static471.method4488(local7);
	...
	public static int method2465(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
