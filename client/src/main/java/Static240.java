...
public final class Static240 {
	...
	public static void method3496(@OriginalArg(0) Throwable arg0, @OriginalArg(1) String arg1) {
		try {
			...
			if (arg0 != null) {
				local12 = Static446.method6100(arg0);
			}
			if (arg1 != null) {
				if (arg0 != null) {
					local12 = local12 + " | ";
			...
			if (Static631.anApplet4 != null) {
				@Pc(131) Class272 local131 = Static284.aClass392_4.method8999(new URL(Static631.anApplet4.getCodeBase(), "clienterror.ws?c=" + Static373.anInt5925 + "&u=" + (Static515.aString96 == null ? String.valueOf(Static292.aLong163) : Static515.aString96) + "&v1=" + Static689.aString123 + "&v2=" + Static689.aString124 + "&e=" + local12));
				while (local131.anInt6810 == 0) {
					Static638.method8402(1L);
				}
				if (local131.anInt6810 == 1) {
