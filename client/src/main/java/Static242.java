...
public final class Static242 {
	...
	public static int method2532(@OriginalArg(1) Class172 arg0) {
	...
	public static void method2535() {
		Static525.aClass2_Sub2_Sub16_12 = new Class2_Sub2_Sub16(Static32.aClass32_4.method429(Static51.anInt1052), "", Static442.anInt6699, 1012, -1, 0L, 0, 0, true, false, 0L, true);
	}

	@OriginalMember(owner = "client!hj", name = "a", descriptor = "(IZ)I")
	public static int method2536(@OriginalArg(1) boolean arg0) {
	...
	public static void method2537(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		...
		for (@Pc(19) int local19 = 0; local19 < local5; local19++) {
			...
			if (local26 != null && Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2 != local26 && local26.aString9 != null && local26.aString9.equalsIgnoreCase(arg0)) {
				...
				if (local47 != null) {
					@Pc(108) Class2_Sub19 local108 = Static293.method3000(local47, Static405.aClass153_2.aClass186_1);
					local108.aClass2_Sub21_Sub2_1.method5198(0);
					local108.aClass2_Sub21_Sub2_1.method5182(local7[local19]);
					Static405.aClass153_2.method2339(local108);
				}
				local9 = true;
				break;
			}
