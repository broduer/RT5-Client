...
public final class Static256 {
	...
	public static Class19 method2635(@OriginalArg(0) int arg0, @OriginalArg(2) Class330 arg1, @OriginalArg(3) Interface4 arg2, @OriginalArg(4) Canvas arg3) {
		if (!Static651.method6065()) {
	...
	public static void method2636(@OriginalArg(1) Class8_Sub2_Sub1_Sub2 arg0, @OriginalArg(2) boolean arg1) {
		@Pc(9) Class289 local9 = arg0.method6708();
		...
		if (arg0.aClass152_11.method6543() && !arg0.aClass152_11.method6540()) {
			@Pc(41) Class69 local41 = arg0.aClass152_11.method6541();
		...
		for (@Pc(86) int local86 = 0; local86 < arg0.aClass199Array3.length; local86++) {
			if (arg0.aClass199Array3[local86].anInt4930 != -1 && arg0.aClass199Array3[local86].aClass152_7.method6540()) {
				@Pc(117) Class227 local117 = Static23.aClass128_1.method1831(arg0.aClass199Array3[local86].anInt4930);
				if (local117.aBoolean448 && local117.anInt5842 != -1) {
					@Pc(133) Class69 local133 = Static25.aClass50_1.method682(local117.anInt5842);
		...
		@Pc(206) int local206 = arg0.anIntArray879[arg0.anInt10764 - 1] * 512 + arg0.method6693((byte) 76) * 256;
		@Pc(222) int local222 = arg0.anIntArray878[arg0.anInt10764 - 1] * 512 + arg0.method6693((byte) 105) * 256;
		if (local186 < local206) {
			if (local189 < local222) {
				arg0.method6696(10240);
			} else if (local222 < local189) {
				arg0.method6696(14336);
			} else {
				arg0.method6696(12288);
			}
		} else if (local206 >= local186) {
			if (local189 < local222) {
				arg0.method6696(8192);
			} else if (local222 < local189) {
				arg0.method6696(0);
			}
		} else if (local222 > local189) {
			arg0.method6696(6144);
		} else if (local222 < local189) {
			arg0.method6696(2048);
		} else {
			arg0.method6696(4096);
		}
		...
		if (!arg1 && (local206 - local186 > 1024 || local206 - local186 < -1024 || local222 - local189 > 1024 || local222 - local189 < -1024)) {
			...
			arg0.method6689(arg0.anInt10756, false);
			Static524.anInt8042 = 0;
	...
	public static void method2637(@OriginalArg(0) Class14 arg0, @OriginalArg(1) String arg1, @OriginalArg(2) Class381 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) Class158 arg6, @OriginalArg(8) Class1 arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9, @OriginalArg(11) int arg10) {
		...
		@Pc(125) int local125 = arg2.method6238((Class23[]) null, arg1, 100);
		@Pc(131) int local131 = local107 - local125 / 2;
		@Pc(139) int local139 = arg2.method6242(100, 0, arg1, (Class23[]) null);
		if (local131 >= -arg6.anInt3802 && arg6.anInt3802 >= local131 && local118 >= -arg6.anInt3746 && arg6.anInt3746 >= local118) {
			arg0.a(arg9, (int[]) null, arg4, arg1, arg7, (Class23[]) null, arg6.anInt3746 / 2 + arg9 - local118 - arg5 - local139, 0, 101, arg3, 1, arg6.anInt3802 / 2 + local131 + arg3, 0, 0, local125, 50);
		}
	}
}
