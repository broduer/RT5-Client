...
public final class Static259 {
	...
	public static void method3693(@OriginalArg(1) String arg0, @OriginalArg(2) String arg1, @OriginalArg(3) Class392 arg2, @OriginalArg(4) boolean arg3, @OriginalArg(5) boolean arg4) {
		if (!arg4) {
			Static637.method8389(arg0, 3, arg2);
			return;
		}
		@Pc(31) String local31;
		if (Static689.aString119.startsWith("win") && arg2.aBoolean782) {
			local31 = null;
			if (Static166.anApplet1 != null) {
				local31 = Static166.anApplet1.getParameter("haveie6");
			}
			if (local31 == null || !local31.equals("1")) {
				@Pc(53) Class272 local53 = Static637.method8389(arg0, 0, arg2);
				Static272.aClass392_3 = arg2;
				Static340.aString53 = arg0;
				Static236.aClass272_2 = local53;
				return;
			}
		}
