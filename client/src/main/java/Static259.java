...
public final class Static259 {
	...
	public static void method2660(@OriginalArg(1) String arg0, @OriginalArg(2) String arg1, @OriginalArg(3) Class390 arg2, @OriginalArg(4) boolean arg3, @OriginalArg(5) boolean arg4) {
		if (!arg4) {
			Static637.method5946(arg0, 3, arg2);
			return;
		}
		...
		if (Static689.aString119.startsWith("win") && arg2.aBoolean781) {
			...
			if (local31 == null || !local31.equals("1")) {
				@Pc(53) Class270 local53 = Static637.method5946(arg0, 0, arg2);
		...
		if (Static689.aString119.startsWith("mac")) {
			...
			if (local31 != null && local31.equals("1") && arg3) {
				Static36.method522(arg2, arg0, arg1, 1);
				return;
			}
		}
		Static637.method5946(arg0, 2, arg2);
	}
}
