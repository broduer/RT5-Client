...
public final class Static262 {
	...
	public static void method2697() {
		...
		local8.method5226();
		@Pc(16) int local16 = local8.method5221(8);
		@Pc(21) int local21;
		...
		for (local21 = 0; local21 < local16; local21++) {
			...
			@Pc(81) Class8_Sub2_Sub1_Sub2_Sub2 local81 = ((Class2_Sub45) Static18.aClass28_2.method373((long) local73)).aClass8_Sub2_Sub1_Sub2_Sub2_2;
			@Pc(86) int local86 = local8.method5221(1);
			if (local86 == 0) {
				Static103.anIntArray187[Static390.anInt6126++] = local73;
				local81.anInt10751 = Static572.anInt8896;
			} else {
				@Pc(108) int local108 = local8.method5221(2);
				if (local108 == 0) {
					Static103.anIntArray187[Static390.anInt6126++] = local73;
					local81.anInt10751 = Static572.anInt8896;
					...
					if (local108 == 1) {
						Static103.anIntArray187[Static390.anInt6126++] = local73;
						local81.anInt10751 = Static572.anInt8896;
						local156 = local8.method5221(3);
						local81.method6716(1, local156);
						local166 = local8.method5221(1);
						if (local166 == 1) {
							Static458.anIntArray553[Static86.anInt1798++] = local73;
						}
					} else if (local108 == 2) {
						Static103.anIntArray187[Static390.anInt6126++] = local73;
						local81.anInt10751 = Static572.anInt8896;
						if (local8.method5221(1) == 1) {
							local156 = local8.method5221(3);
							local81.method6716(2, local156);
							local166 = local8.method5221(3);
							local81.method6716(2, local166);
						} else {
							local156 = local8.method5221(3);
							local81.method6716(0, local156);
						}
						local156 = local8.method5221(1);
						if (local156 == 1) {
							Static458.anIntArray553[Static86.anInt1798++] = local73;
						}
					} else if (local108 == 3) {
