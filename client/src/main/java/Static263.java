...
public final class Static263 {
	...
	public static void method2713(@OriginalArg(0) boolean arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) String arg3) {
		Static311.method3168(false, arg0, arg1, arg2, arg3, (String) null);
	}

	@OriginalMember(owner = "client!ida", name = "a", descriptor = "(Lclient!rka;I)V")
	public static void method2714(@OriginalArg(0) Class2_Sub21_Sub2 arg0) {
		arg0.method5226();
		@Pc(10) int local10 = 0;
		@Pc(20) int local20;
		@Pc(52) int local52;
		for (@Pc(12) int local12 = 0; local12 < Static338.anInt5564; local12++) {
			...
			if ((Static402.aByteArray68[local20] & 0x1) == 0) {
				if (local10 > 0) {
					...
					local52 = arg0.method5221(1);
					if (local52 == 0) {
						local10 = Static59.method3776(arg0);
						Static402.aByteArray68[local20] = (byte) (Static402.aByteArray68[local20] | 0x2);
					} else {
						Static610.method5801(local20, arg0);
					}
				}
			}
		}
		...
		for (local20 = 0; local20 < Static338.anInt5564; local20++) {
			...
			if ((Static402.aByteArray68[local52] & 0x1) != 0) {
				if (local10 > 0) {
					...
					local144 = arg0.method5221(1);
					if (local144 == 0) {
						local10 = Static59.method3776(arg0);
						Static402.aByteArray68[local52] = (byte) (Static402.aByteArray68[local52] | 0x2);
					} else {
						Static610.method5801(local52, arg0);
					}
				}
			}
		}
		...
		for (local52 = 0; local52 < Static51.anInt1053; local52++) {
			...
			if ((Static402.aByteArray68[local144] & 0x1) != 0) {
				if (local10 > 0) {
					...
					local243 = arg0.method5221(1);
					if (local243 == 0) {
						local10 = Static59.method3776(arg0);
						Static402.aByteArray68[local144] = (byte) (Static402.aByteArray68[local144] | 0x2);
					} else if (Static383.method3821(local144, arg0)) {
						Static402.aByteArray68[local144] = (byte) (Static402.aByteArray68[local144] | 0x2);
					}
				}
			}
		...
		for (local144 = 0; local144 < Static51.anInt1053; local144++) {
			...
			if ((Static402.aByteArray68[local243] & 0x1) == 0) {
				if (local10 > 0) {
					...
					@Pc(351) int local351 = arg0.method5221(1);
					if (local351 == 0) {
						local10 = Static59.method3776(arg0);
						Static402.aByteArray68[local243] = (byte) (Static402.aByteArray68[local243] | 0x2);
					} else if (Static383.method3821(local243, arg0)) {
						Static402.aByteArray68[local243] = (byte) (Static402.aByteArray68[local243] | 0x2);
					}
				}
			}
