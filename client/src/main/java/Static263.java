...
public final class Static263 {
	...
	public static void method3855(@OriginalArg(0) boolean arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) String arg3) {
		Static311.method4545(false, arg0, arg1, arg2, arg3, null);
	}

	@OriginalMember(owner = "client!ida", name = "a", descriptor = "(Lclient!rka;I)V")
	public static void method3856(@OriginalArg(0) Packet arg0) {
		arg0.method7424();
		@Pc(10) int local10 = 0;
		@Pc(20) int local20;
		@Pc(52) int local52;
		for (@Pc(12) int local12 = 0; local12 < Static338.anInt5584; local12++) {
			...
			if ((Static402.aByteArray68[local20] & 0x1) == 0) {
				if (local10 > 0) {
					...
					local52 = arg0.method7419(1);
					if (local52 == 0) {
						local10 = Static59.method5336(arg0);
						Static402.aByteArray68[local20] = (byte) (Static402.aByteArray68[local20] | 0x2);
					} else {
						Static610.method8224(local20, arg0);
					}
				}
			}
		}
		...
		arg0.method7424();
		@Pc(144) int local144;
		for (local20 = 0; local20 < Static338.anInt5584; local20++) {
			...
			if ((Static402.aByteArray68[local52] & 0x1) != 0) {
				if (local10 > 0) {
					...
					local144 = arg0.method7419(1);
					if (local144 == 0) {
						local10 = Static59.method5336(arg0);
						Static402.aByteArray68[local52] = (byte) (Static402.aByteArray68[local52] | 0x2);
					} else {
						Static610.method8224(local52, arg0);
					}
				}
			}
		}
		...
		arg0.method7424();
		@Pc(243) int local243;
		for (local52 = 0; local52 < Static51.anInt1057; local52++) {
			...
			if ((Static402.aByteArray68[local144] & 0x1) != 0) {
				if (local10 > 0) {
					...
					local243 = arg0.method7419(1);
					if (local243 == 0) {
						local10 = Static59.method5336(arg0);
						Static402.aByteArray68[local144] = (byte) (Static402.aByteArray68[local144] | 0x2);
					} else if (Static383.method5386(local144, arg0)) {
						Static402.aByteArray68[local144] = (byte) (Static402.aByteArray68[local144] | 0x2);
					}
				}
			}
		...
		arg0.method7424();
		for (local144 = 0; local144 < Static51.anInt1057; local144++) {
			...
			if ((Static402.aByteArray68[local243] & 0x1) == 0) {
				if (local10 > 0) {
					...
					@Pc(351) int local351 = arg0.method7419(1);
					if (local351 == 0) {
						local10 = Static59.method5336(arg0);
						Static402.aByteArray68[local243] = (byte) (Static402.aByteArray68[local243] | 0x2);
					} else if (Static383.method5386(local243, arg0)) {
						Static402.aByteArray68[local243] = (byte) (Static402.aByteArray68[local243] | 0x2);
					}
				}
			}
		...
		for (local243 = 1; local243 < 2048; local243++) {
			...
			if (local433 == null) {
				Static409.anIntArray494[Static51.anInt1057++] = local243;
			} else {
				Static210.anIntArray280[Static338.anInt5584++] = local243;
			}
		}
	}
}
