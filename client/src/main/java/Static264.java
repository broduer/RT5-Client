...
public final class Static264 {
	...
	public static void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		if (Static180.anInt2995 <= arg5 && arg1 <= Static111.anInt2219 && Static724.anInt10930 <= arg3 && arg4 <= Static273.anInt4395) {
			Static446.method4236(arg4, arg1, arg2, arg0, arg5, arg6, arg3);
		} else {
			Static547.method5083(arg4, arg5, arg2, arg3, arg1, arg6, arg0);
		}
	}

	@OriginalMember(owner = "client!ie", name = "a", descriptor = "(IIIBIIIIII)Z")
	public static boolean a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8) {
				...
				if (arg4 > arg6) {
						...
						while (true) {
							...
							if (arg6 < 0) {
								while (true) {
									...
									if (!Static34.method437((arg8 >> 12) - 1, (arg5 >> 12) + 1, arg7, Static485.anIntArray886, local369, arg1)) {
										return false;
									}
									arg5 += local312;
									arg7 += local381;
							...
							if (!Static34.method437((arg0 >> 12) - 1, (arg5 >> 12) + 1, arg7, Static485.anIntArray886, local369, arg1)) {
								return false;
							}
							arg7 += local381;
							arg1 += Static228.anInt3709;
						...
						while (true) {
							...
							if (arg6 < 0) {
								while (true) {
									...
									if (!Static34.method437((arg5 >> 12) - 1, (arg8 >> 12) + 1, arg7, Static485.anIntArray886, local369, arg1)) {
										return false;
									}
									arg5 += local312;
									arg8 += local291;
							...
							if (!Static34.method437((arg5 >> 12) - 1, (arg0 >> 12) + 1, arg7, Static485.anIntArray886, local369, arg1)) {
								return false;
							}
							arg0 += local274;
							arg7 += local381;
					...
					if (arg1 != arg4 && local312 < local274 || arg1 == arg4 && local291 > local274) {
						...
						while (true) {
							...
							if (!Static34.method437((arg8 >> 12) - 1, (arg0 >> 12) + 1, arg7, Static485.anIntArray886, local369, arg1)) {
								return false;
							}
							arg0 += local274;
							arg7 += local381;
						...
						while (true) {
							...
							if (!Static34.method437((arg0 >> 12) - 1, (arg8 >> 12) - -1, arg7, Static485.anIntArray886, local369, arg1)) {
								return false;
							}
							arg0 += local274;
							arg1 += Static228.anInt3709;
				...
				if (arg6 > arg1) {
						...
						while (true) {
							...
							if (arg1 < 0) {
								while (true) {
									...
									if (!Static34.method437((arg0 >> 12) - 1, (arg8 >> 12) + 1, arg2, Static485.anIntArray886, local369, arg4)) {
										return false;
									}
									arg2 += local381;
									arg8 += local291;
							...
							if (!Static34.method437((arg5 >> 12) - 1, (arg8 >> 12) + 1, arg2, Static485.anIntArray886, local369, arg4)) {
								return false;
							}
							arg4 += Static228.anInt3709;
							arg5 += local312;
						...
						while (true) {
							...
							if (arg1 < 0) {
								while (true) {
									...
									if (!Static34.method437((arg8 >> 12) - 1, (arg0 >> 12) + 1, arg2, Static485.anIntArray886, local369, arg4)) {
										return false;
									}
									arg2 += local381;
									arg8 += local291;
							...
							if (!Static34.method437((arg8 >> 12) - 1, (arg5 >> 12) + 1, arg2, Static485.anIntArray886, local369, arg4)) {
								return false;
							}
							arg5 += local312;
							arg4 += Static228.anInt3709;
					...
					if (local312 <= local291) {
						...
						while (true) {
							...
							if (!Static34.method437((arg5 >> 12) - 1, (arg0 >> 12) + 1, arg2, Static485.anIntArray886, local369, arg4)) {
								return false;
							}
							arg0 += local291;
							arg4 += Static228.anInt3709;
						...
						while (true) {
							...
							if (!Static34.method437((arg0 >> 12) - 1, (arg5 >> 12) + 1, arg2, Static485.anIntArray886, local369, arg4)) {
								return false;
							}
							arg2 += local381;
							arg0 += local291;
						...
						while (true) {
							...
							if (arg1 < 0) {
								while (true) {
									...
									if (!Static34.method437((arg0 >> 12) - 1, (arg8 >> 12) + 1, arg3, Static485.anIntArray886, local369, arg6)) {
										return false;
									}
									arg8 += local291;
									arg0 += local312;
							...
							if (!Static34.method437((arg5 >> 12) - 1, (arg8 >> 12) + 1, arg3, Static485.anIntArray886, local369, arg6)) {
								return false;
							}
							arg8 += local291;
							arg6 += Static228.anInt3709;
						...
						while (true) {
							...
							if (arg1 < 0) {
								while (true) {
									...
									if (!Static34.method437((arg8 >> 12) - 1, (arg0 >> 12) + 1, arg3, Static485.anIntArray886, local369, arg6)) {
										return false;
									}
									arg8 += local291;
									arg0 += local312;
							...
							if (!Static34.method437((arg8 >> 12) - 1, (arg5 >> 12) + 1, arg3, Static485.anIntArray886, local369, arg6)) {
								return false;
							}
							arg6 += Static228.anInt3709;
							arg5 += local274;
						...
						while (true) {
							...
							if (arg4 < 0) {
								while (true) {
									...
									if (!Static34.method437((arg0 >> 12) - 1, (arg5 >> 12) + 1, arg3, Static485.anIntArray886, local369, arg6)) {
										return false;
									}
									arg0 += local274;
									arg3 += local381;
						...
						while (true) {
							...
							if (arg4 < 0) {
								while (true) {
									...
									if (!Static34.method437((arg5 >> 12) - 1, (arg0 >> 12) + 1, arg3, Static485.anIntArray886, local369, arg6)) {
										return false;
									}
									arg3 += local381;
									arg6 += Static228.anInt3709;
