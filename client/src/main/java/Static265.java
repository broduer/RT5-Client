...
public final class Static265 {
	...
	public static int[] method2715(@OriginalArg(6) float arg0) {
		...
		local10.anInt8810 = 8;
		local10.anInt8803 = 4;
		local10.method6800(7);
		Static132.method1516(1, 2048);
		local10.method5543(0, local6);
		return local6;
	}

	@OriginalMember(owner = "client!iea", name = "a", descriptor = "(IIIII)V")
	public static void method2716(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		@Pc(7) int local7 = 0;
		@Pc(14) int local14 = arg2;
		@Pc(17) int local17 = -arg2;
		Static696.method6473(arg2 + arg0, arg1, arg0 - arg2, Static723.anIntArrayArray266[arg3]);
		@Pc(31) int local31 = -1;
		while (local7 < local14) {
			...
			if (local17 >= 0) {
				...
				Static696.method6473(local68, arg1, local73, local57);
				Static696.method6473(local68, arg1, local73, local64);
			}
			...
			Static696.method6473(local91, arg1, local96, local102);
			Static696.method6473(local91, arg1, local96, local109);
		}
	}
}
