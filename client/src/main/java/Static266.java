...
public final class Static266 {
	...
	public static void method4772() {
		...
		@Pc(113) int local113;
		@Pc(116) int local116;
		for (@Pc(71) Class2_Sub35 local71 = (Class2_Sub35) Static391.aClass339_34.method5453(65280); local71 != null; local71 = (Class2_Sub35) Static391.aClass339_34.method5460()) {
		...
		local22 = 0;
		for (@Pc(312) Class2_Sub35 local312 = (Class2_Sub35) Static391.aClass339_34.method5453(65280); local312 != null; local312 = (Class2_Sub35) Static391.aClass339_34.method5460()) {
			...
			for (local107 = local93 >>> 3; local107 <= local101; local107++) {
				label82: for (local110 = local98 >>> 3; local110 <= local104; local110++) {
					...
					Static267.anIntArray329[local22] = Static93.aClass330_16.method5354("m" + local107 + "_" + local110);
					anIntArray615[local22] = Static93.aClass330_16.method5354("l" + local107 + "_" + local110);
					Static68.anIntArray316[local22] = Static93.aClass330_16.method5354("um" + local107 + "_" + local110);
					Static298.anIntArray367[local22] = Static93.aClass330_16.method5354("ul" + local107 + "_" + local110);
					local22++;
				}
			}
		}
		...
		Static684.method6382(false, Static720.anInt10859 >> 4, 12, Static501.anInt7568 >> 4);
	}
	...
	public static void method4775() {
		...
		try {
			local5 = Static689.method6424("2");
			@Pc(25) Class2_Sub21 local25 = new Class2_Sub21(Static319.anInt5078 * 6 + 3);
			local25.method5198(1);
			local25.method5182(Static319.anInt5078);
			for (@Pc(35) int local35 = 0; local35 < Static511.anIntArray614.length; local35++) {
				if (Static118.aBooleanArray4[local35]) {
					local25.method5182(local35);
					local25.method5151(Static511.anIntArray614[local35]);
				}
			}
			local5.method1396(local25.aByteArray93, 0, local25.anInt8388);
		...
		Static98.aLong71 = Static588.method5469();
