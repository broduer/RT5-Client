...
public final class Static269 {
	...
	public static int method2737(@OriginalArg(1) String arg0, @OriginalArg(2) int arg1) {
		if (arg1 > 36) {
	...
	public static void method2738() {
		Static480.aClass361_2.method5909();
	}

	@OriginalMember(owner = "client!iha", name = "a", descriptor = "(IIIIIIBII)V")
	public static void method2740(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6) {
