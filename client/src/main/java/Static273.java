...
public final class Static273 {
	...
	public static void method2766(@OriginalArg(0) int arg0) {
		@Pc(17) Class2_Sub2_Sub2 local17 = Static440.method4204(16, (long) arg0);
		local17.method133();
	}

	@OriginalMember(owner = "client!ik", name = "a", descriptor = "(Lclient!bd;ZIILclient!sb;II)V")
	public static void method2768(@OriginalArg(0) Class2_Sub6_Sub1 arg0, @OriginalArg(3) int arg1, @OriginalArg(4) Class330 arg2, @OriginalArg(5) int arg3) {
		Static611.method5813(arg1, arg3, arg2);
		Static117.aClass2_Sub6_Sub1_2 = arg0;
	}

	@OriginalMember(owner = "client!ik", name = "g", descriptor = "(I)Lclient!fk;")
	public static Class2_Sub19 method2769() {
	...
	public static int method2773(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		if (arg2 == arg0) {
			return arg2;
		}
