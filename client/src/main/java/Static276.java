...
public final class Static276 {
	...
	public static void method2790() {
		if (Static400.aClass2_Sub34_28.aClass57_Sub4_2.method1377() != 2) {
			return;
		}
		...
		if (Static511.anInt7645 != 1 && Static692.anInt10376 == -1) {
			local149 = Static102.method1286(Static394.anInt6176, -29754, Static110.anInt2186, Static170.anInt2864);
			if (local149 - Static359.anInt5801 < 3200 && (Static280.aByteArrayArrayArray3[Static394.anInt6176][Static170.anInt2864 >> 9][Static110.anInt2186 >> 9] & 0x4) != 0) {
				Static409.method4012(Static110.anInt2186 >> 9, Static334.aClass291ArrayArrayArray1, 1, Static170.anInt2864 >> 9, false);
				return;
			}
			return;
		}
		...
		if ((Static280.aByteArrayArrayArray3[Static394.anInt6176][local92 >> 9][local95 >> 9] & 0x4) != 0) {
			Static409.method4012(local95 >> 9, Static334.aClass291ArrayArrayArray1, 0, local92 >> 9, false);
		}
			...
			if (local169 <= local186) {
				...
				while (local161 != local153) {
					...
					if ((Static280.aByteArrayArrayArray3[Static394.anInt6176][local149][local153] & 0x4) != 0) {
						Static409.method4012(local153, Static334.aClass291ArrayArrayArray1, 1, local149, false);
						return;
					}
					local280 += local278;
					if (local280 >= 65536) {
		...
		Static240.method2529((Throwable) null, "RC: " + local149 + "," + local153 + " " + local157 + "," + local161 + " " + Static691.anInt10367 + "," + Static116.anInt2270);
		return;
	}
}
