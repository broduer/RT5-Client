...
public final class Static278 {
	...
	public static void method2823(@OriginalArg(1) double arg0) {
		Static203.aClass73_4.a(Static420.aClass73_7);
		Static203.aClass73_4.b(0, 0, (int) arg0);
		Static74.aClass19_4.a(Static203.aClass73_4);
	}

	@OriginalMember(owner = "client!in", name = "b", descriptor = "(II)Z")
	public static boolean method2825(@OriginalArg(0) int arg0) {
