...
public final class Static282 {
	...
	public static boolean method2778(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3) {
		if (!Static18.aBoolean20 || !Static29.aBoolean60) {
			return false;
		} else if (Static432.anInt525 < 100) {
			return false;
		} else if (Static588.method5468(arg3, arg1, arg2)) {
			@Pc(38) int local38 = arg2 << Static52.anInt1066;
			@Pc(42) int local42 = arg3 << Static52.anInt1066;
			if (Static318.method6096(Static340.anInt5586, arg0, local38, local42, Static246.aClass178Array1[arg1].a(arg3, arg2, (byte) -118), Static340.anInt5586)) {
				Static356.anInt5773++;
				return true;
			} else {
				return false;
	...
	public static void method2779(@OriginalArg(0) File arg0, @OriginalArg(2) byte[] arg1, @OriginalArg(3) int arg2) throws IOException {
	...
	public static float method2780(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) int arg3) {
