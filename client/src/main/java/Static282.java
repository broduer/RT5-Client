...
public final class Static282 {
	...
	public static boolean method3976(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3) {
		if (!Static18.aBoolean20 || !Static29.aBoolean60) {
			...
			return false;
		} else if (Static588.method7721(arg3, arg1, arg2)) {
			@Pc(38) int local38 = arg2 << Static52.anInt1070;
			@Pc(42) int local42 = arg3 << Static52.anInt1070;
			if (Static318.method8564(Static340.anInt5606, arg0, local38, local42, Static246.aClass178Array1[arg1].method7876(arg3, arg2), Static340.anInt5606)) {
				Static356.anInt5793++;
				return true;
			} else {
				return false;
