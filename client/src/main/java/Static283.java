	...
	public static void method2850(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte[][][] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) byte arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) boolean arg14, @OriginalArg(16) int arg15, @OriginalArg(17) int arg16, @OriginalArg(18) boolean arg17) {
		...
		if (Static581.aBoolean657) {
			for (local85 = 0; local85 < Static35.anInt813 + Static35.anInt813 + 2; local85++) {
				...
				for (@Pc(92) int local92 = 0; local92 < Static35.anInt813 + Static35.anInt813 + 2; local92++) {
					...
					if (local112 >= 0 && local118 >= 0 && local112 < Static619.anInt1566 && local118 < Static662.anInt9843) {
						...
						@Pc(159) int local159 = Static706.aClass178Array3[Static706.aClass178Array3.length - 1].a(local118, local112, (byte) -118) - (0x3E8 << Static52.anInt1066 - 7);
						@Pc(188) int local188 = (Static693.aClass178Array2 == null ? Static706.aClass178Array3[0].a(local118, local112, (byte) -118) + Static340.anInt5586 : Static693.aClass178Array2[0].a(local118, local112, (byte) -118) + Static340.anInt5586) + (0x3E8 << Static52.anInt1066 - 7);
			...
			if (arg15 >= 0) {
				...
				Static725.method6833(Static665.aClass19_15, arg10);
			}
		} else {
		...
		Static497.method4652(Static665.aClass19_15);
		if (!Static514.aClass213_2.aBoolean426) {
			@Pc(387) Class130 local387 = Static514.aClass213_2.aClass130_8;
			for (@Pc(392) Class8_Sub7 local392 = (Class8_Sub7) local387.method1905(); local392 != null; local392 = (Class8_Sub7) local387.method1900()) {
				local392.a();
				Static281.method2842(local392);
			}
		}
		if (Static442.aBoolean500) {
			for (local85 = 0; local85 < Static319.anInt5080; local85++) {
				Static265.aClass353Array1[local85].method5820(arg14, arg0);
			}
		}
		if (Static661.aBoolean457) {
			...
			for (local90 = 0; local90 < Static226.aClass46Array7.length; local90++) {
				Static226.aClass46Array7[local90].method642();
			}
		}
		if (Static420.aClass291ArrayArrayArray2 != null) {
			if (Static661.aBoolean457) {
				Static341.method3515(0);
			}
			Static379.method3797(true);
			Static665.aClass19_15.ra(-1, 1583160, 40, 127);
			Static517.method4811(true, arg4, arg10, arg11, arg15, arg16, arg17);
			if (Static661.aBoolean457) {
				Static245.method6147();
			}
			Static665.aClass19_15.pa();
			Static379.method3797(false);
		}
		Static517.method4811(false, arg4, arg10, arg11, arg15, arg16, arg17);
		if (Static661.aBoolean457) {
			...
			for (local88 = 0; local88 < Static226.aClass46Array7.length; local88++) {
				Static226.aClass46Array7[local88].method642();
			}
		}
		if (Static661.aBoolean457) {
			Static245.method6147();
