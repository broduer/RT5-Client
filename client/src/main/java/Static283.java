...
public final class Static283 {
	...
	public static final Class227 aClass227_115 = new Class227(86, 0);
	...
	public static void method4100(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte[][][] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) byte arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) boolean arg14, @OriginalArg(16) int arg15, @OriginalArg(17) int arg16, @OriginalArg(18) boolean arg17) {
		...
		Static442.aBoolean500 = Static665.aClass19_15.method7962() > 0;
		Static581.aBoolean658 = true;
		Static403.anInt6266 = arg1 >> Static52.anInt1070;
		Static550.anInt8294 = arg3 >> Static52.anInt1070;
		Static499.anInt7514 = arg1;
		Static715.anInt10839 = arg3;
		Static523.anInt3893 = arg2;
		Static441.anInt6711 = Static403.anInt6266 - Static35.anInt816;
		if (Static441.anInt6711 < 0) {
			Static231.anInt3744 = -Static441.anInt6711;
			Static441.anInt6711 = 0;
		} else {
			Static231.anInt3744 = 0;
		}
		Static220.anInt3572 = Static550.anInt8294 - Static35.anInt816;
		if (Static220.anInt3572 < 0) {
			Static13.anInt148 = -Static220.anInt3572;
			Static220.anInt3572 = 0;
		} else {
			Static13.anInt148 = 0;
		}
		Static77.anInt1620 = Static403.anInt6266 + Static35.anInt816;
		if (Static77.anInt1620 > Static619.anInt1573) {
			Static77.anInt1620 = Static619.anInt1573;
		}
		Static692.anInt10398 = Static550.anInt8294 + Static35.anInt816;
		if (Static692.anInt10398 > Static662.anInt9869) {
			Static692.anInt10398 = Static662.anInt9869;
		}
		...
		if (Static581.aBoolean658) {
			for (local85 = 0; local85 < Static35.anInt816 + Static35.anInt816 + 2; local85++) {
				local88 = 0;
				local90 = 0;
				for (@Pc(92) int local92 = 0; local92 < Static35.anInt816 + Static35.anInt816 + 2; local92++) {
					if (local92 > 1) {
						Static102.anIntArray184[local92 - 2] = local88;
					}
					local88 = local90;
					@Pc(112) int local112 = Static403.anInt6266 + local85 - Static35.anInt816;
					@Pc(118) int local118 = Static550.anInt8294 + local92 - Static35.anInt816;
					@Pc(138) int local138;
					if (local112 >= 0 && local118 >= 0 && local112 < Static619.anInt1573 && local118 < Static662.anInt9869) {
						local138 = local112 << Static52.anInt1070;
						@Pc(142) int local142 = local118 << Static52.anInt1070;
						@Pc(159) int local159 = Static706.aClass178Array3[Static706.aClass178Array3.length - 1].method7876(local118, local112) - (0x3E8 << Static52.anInt1070 - 7);
						@Pc(188) int local188 = (Static693.aClass178Array2 == null ? Static706.aClass178Array3[0].method7876(local118, local112) + Static340.anInt5606 : Static693.aClass178Array2[0].method7876(local118, local112) + Static340.anInt5606) + (0x3E8 << Static52.anInt1070 - 7);
				...
				Static102.anIntArray184[Static35.anInt816 + Static35.anInt816] = local88;
				Static102.anIntArray184[Static35.anInt816 + Static35.anInt816 + 1] = local90;
			}
			if (arg15 >= 0) {
				...
				Static725.method9461(Static665.aClass19_15, arg10);
			}
		} else {
			if (Static222.aBooleanArrayArray2 == null) {
				Static222.aBooleanArrayArray2 = new boolean[Static619.anInt1573 + Static619.anInt1573 + 1][Static662.anInt9869 + Static619.anInt1573 + 1];
			}
		...
		Static497.method6630(Static665.aClass19_15);
		if (!Static514.aClass215_2.aBoolean426) {
			@Pc(387) Class130 local387 = Static514.aClass215_2.aClass130_8;
		...
		if (Static442.aBoolean500) {
			for (local85 = 0; local85 < Static319.anInt5097; local85++) {
				Static265.aClass355Array1[local85].method8248(arg14, arg0);
			}
		}
		if (Static661.aBoolean457) {
			Static346.anIntArray420 = Static665.aClass19_15.Y();
			Static665.aClass19_15.K(Static238.anIntArray307);
			local85 = (Static238.anIntArray307[2] - Static238.anIntArray307[0]) / Static549.anInt9450;
			for (local88 = 0; local88 < Static549.anInt9450 - 1; local88++) {
		...
		if (Static420.aClass293ArrayArrayArray2 != null) {
			if (Static661.aBoolean457) {
				Static341.method5040(0);
			}
			Static379.method5362(true);
			Static665.aClass19_15.ra(-1, 1583160, 40, 127);
			Static517.method6830(true, arg4, arg10, arg11, arg15, arg16, arg17);
			if (Static661.aBoolean457) {
				Static245.method8637();
			}
			Static665.aClass19_15.pa();
			Static379.method5362(false);
		}
		Static517.method6830(false, arg4, arg10, arg11, arg15, arg16, arg17);
		if (Static661.aBoolean457) {
			for (local85 = 0; local85 < Static299.anInt4840; local85++) {
