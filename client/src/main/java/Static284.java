...
public final class Static284 {
	...
	public static Class255 method2853(@OriginalArg(0) boolean arg0, @OriginalArg(2) Class330 arg1, @OriginalArg(3) String arg2) {
		@Pc(8) int local8 = arg1.method5354(arg2);
		if (local8 == -1) {
			return new Class255(0);
		}
		@Pc(24) int[] local24 = arg1.method5367(local8);
		@Pc(30) Class255 local30 = new Class255(local24.length);
		@Pc(32) int local32 = 0;
		@Pc(34) int local34 = 0;
		while (true) {
			while (local30.anInt6373 > local32) {
				@Pc(47) Class2_Sub21 local47 = new Class2_Sub21(arg1.method5359(local24[local34++], local8));
				@Pc(51) int local51 = local47.method5158();
				@Pc(57) int local57 = local47.method5191();
				@Pc(61) int local61 = local47.method5205();
				if (!arg0 && local61 == 1) {
					local30.anInt6373--;
				} else {
