	...
	public static Class257 method4103(@OriginalArg(0) boolean arg0, @OriginalArg(2) Class332 arg1, @OriginalArg(3) String arg2) {
		...
		while (true) {
			while (local30.anInt6393 > local32) {
				@Pc(47) Class2_Sub21 local47 = new Class2_Sub21(arg1.method7602(local24[local34++], local8));
				@Pc(51) int local51 = local47.method7356();
				@Pc(57) int local57 = local47.method7389();
				@Pc(61) int local61 = local47.method7403();
				if (!arg0 && local61 == 1) {
					local30.anInt6393--;
				} else {
