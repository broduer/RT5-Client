...
public final class Static284 {
	...
	public static Class257 method4103(@OriginalArg(0) boolean arg0, @OriginalArg(2) Js5 arg1, @OriginalArg(3) String arg2) {
		...
		while (true) {
			while (local30.anInt6393 > local32) {
				@Pc(47) Buffer local47 = new Buffer(arg1.fetchFile(local24[local34++], local8));
