...
public final class Static292 {
	...
	public static Node_Sub43 instance;
	...
	public static void method4611(@OriginalArg(0) int arg0, @OriginalArg(1) Class19 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg6) {
		if ((Static26.aClass23_5 == null || Static63.aClass23_8 == null || Static261.aClass23_18 == null) && client.js5Archive8.method7588(Static337.anInt5581) && client.js5Archive8.method7588(Static176.anInt7555) && client.js5Archive8.method7588(Static282.anInt4432)) {
			@Pc(46) Class409 local46 = Static735.method9389(client.js5Archive8, Static176.anInt7555, 0);
			Static63.aClass23_8 = arg1.method7955(local46, true);
			local46.method9395();
			Static542.aClass23_33 = arg1.method7955(local46, true);
			Static26.aClass23_5 = arg1.method7955(Static735.method9389(client.js5Archive8, Static337.anInt5581, 0), true);
			@Pc(71) Class409 local71 = Static735.method9389(client.js5Archive8, Static282.anInt4432, 0);
	...
	public static void method4613(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		...
		if (local52 != 0) {
			local69 = Class114_Sub1.anIntArray741[local52] * -local45 >> 14;
			local71 = local45 * Class114_Sub1.anIntArray740[local52] >> 14;
		}
		if (local65 != 0) {
			local67 = local71 * Class114_Sub1.anIntArray741[local65] >> 14;
			local71 = Class114_Sub1.anIntArray740[local65] * local71 >> 14;
		}
	...
	public static void method4622() {
		...
		if (Static265.sskey != null) {
			@Pc(23) Buffer local23 = new Buffer(Static265.sskey);
	...
	public static void method4625(@OriginalArg(0) SecondaryNode_Sub9 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean[] arg4) {
