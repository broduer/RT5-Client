...
public final class Static295 {
	...
	public static void method3012(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		@Pc(14) Class2_Sub2_Sub2 local14 = Static440.method4204(13, (long) arg0);
		local14.method130();
		local14.anInt197 = arg1;
	}

	@OriginalMember(owner = "client!jga", name = "a", descriptor = "(IIIBILclient!qha;)Lclient!gb;")
	public static Class93_Sub2_Sub1 method3018(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) Class19_Sub3 arg4) {
		if (arg4.aBoolean597 || Static700.method6579(arg2) && Static700.method6579(arg1)) {
			...
			return new Class93_Sub2_Sub1(arg4, arg0, arg3, arg2, arg1, Static440.method4203(arg2), Static440.method4203(arg1), true);
		}
	}
