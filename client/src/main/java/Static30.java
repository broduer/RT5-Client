...
public final class Static30 {
	...
	@OriginalMember(owner = "client!baa", name = "g", descriptor = "I")
	public static int anInt5662 = (int) (Math.random() * 17.0D) - 8;
	...
	public static Class2_Sub2_Sub13 method5066(@OriginalArg(0) int arg0) {
		return (Class2_Sub2_Sub13) aClass28_27.method738((long) arg0);
	}

	@OriginalMember(owner = "client!baa", name = "a", descriptor = "(Lclient!ha;)V")
	public static void method5067(@OriginalArg(0) Class19 arg0) {
		@Pc(3) int local3 = anInt5667 - anInt5672;
		@Pc(7) int local7 = anInt5665 - anInt5674;
		@Pc(15) int local15 = (anInt5671 - anInt5669 << 16) / local3;
		@Pc(23) int local23 = (anInt5666 - anInt5673 << 16) / local7;
		method5073(arg0, local15, local23);
	}
		...
		if (arg10 || arg5 != 0 || arg6 > 0) {
			if (arg6 == 0) {
				...
				if (local20 == 0 || arg3 <= 1 || arg4 <= 1) {
					...
					local32 = arg10 ? 0 : 1;
					Static339.method5014(arg4, aByteArrayArrayArray5, anIntArray419[arg6], arg3, anInt5663, arg1, arg0, local32, arg7 >> 6 & 0x3, arg2, arg5, local20);
				}
			}
		}
		if (arg8 == null) {
	...
	public static void method5069(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		anInt5672 = arg0 - anInt5675;
		anInt5665 = arg1 - anInt5668;
		anInt5667 = arg2 - anInt5675;
		anInt5674 = arg3 - anInt5668;
		anInt5669 = arg4;
		anInt5673 = arg5;
		anInt5671 = arg6;
		anInt5666 = arg7;
		...
		for (@Pc(4) int local4 = 0; local4 < arg5.length; local4++) {
			...
			if (local17 != -1) {
				...
				if (local49 != null) {
					...
					@Pc(65) int local65 = arg4 * local49.method8199() >> 2;
					if (local25.aBoolean329) {
						@Pc(71) int local71 = local14.anInt1275;
						@Pc(74) int local74 = local14.anInt1234;
					...
					if (local58 != 0 && local65 != 0) {
						if (local25.anInt4176 == 0) {
							local49.method8213(arg1, arg2 + arg4 - local65, local58, local65);
						} else {
							local49.method8212(arg1, arg2 + arg4 - local65, local58, local65, 0, local25.anInt4176 | 0xFF000000, 1);
						}
					}
				}
			}
	...
	private static void method5071(@OriginalArg(0) byte[] arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) short[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		@Pc(11) int[] local11 = new int[anInt5664];
		@Pc(14) int[] local14 = new int[anInt5664];
		for (@Pc(16) int local16 = -5; local16 < anInt5670; local16++) {
			...
			for (@Pc(27) int local27 = 0; local27 < anInt5664; local27++) {
				...
				if (local21 < anInt5670) {
					...
					if (local41 > 0) {
						local50 = aClass79_5.method2066(local41 - 1);
						local2[local27] += local50.anInt6650;
						local5[local27] += local50.anInt6657;
						local8[local27] += local50.anInt6659;
						local11[local27] += local50.anInt6652;
						local86 = local14[local27]++;
					}
				}
				if (local25 >= 0) {
					local41 = arg0[local25 + local27 * anInt5670] & 0xFF;
					if (local41 > 0) {
						local50 = aClass79_5.method2066(local41 - 1);
						local2[local27] -= local50.anInt6650;
						local5[local27] -= local50.anInt6657;
			...
			if (local16 >= 0) {
				...
				for (@Pc(167) int local167 = -5; local167 < anInt5664; local167++) {
					@Pc(172) int local172 = local167 + 5;
					if (local172 < anInt5664) {
					...
					if (local167 >= 0 && local165 > 0) {
						@Pc(261) int local261;
						if ((arg0[local16 + local167 * anInt5670] & 0xFF) == 0) {
							local261 = local16 + local167 * anInt5670;
							arg1[local261] = 0;
							arg2[local261] = 0;
						} else {
							local261 = local163 == 0 ? 0 : Static318.method8562(local161 / local165, local159 / local165, local41 * 256 / local163);
							...
							@Pc(322) int local322 = local16 + local167 * anInt5670;
							@Pc(333) int local333 = Static323.anIntArray389[Static105.method2043(Static75.method6245(local316)) & 0xFFFF];
	...
	public static void method5072(@OriginalArg(0) Class332 arg0, @OriginalArg(1) Class96 arg1, @OriginalArg(2) Class79 arg2, @OriginalArg(3) Class142 arg3, @OriginalArg(4) Class248 arg4, @OriginalArg(5) Class365 arg5, @OriginalArg(6) Interface23 arg6) {
		...
		if (local28 != null) {
			for (@Pc(32) int local32 = 0; local32 < local28.length; local32++) {
				...
				aClass28_27.method735((long) local41.anInt4577, local41);
			}
		}
	...
	private static void method5073(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		for (@Pc(17) int local17 = 0; local17 < local3; local17++) {
			local28 = (arg1 * local17 >> 16) + anInt5669;
			local40 = (arg1 * (local17 + 1) >> 16) + anInt5669;
			local44 = local40 - local28;
			if (local44 > 0) {
				local50 = anInt5672 + local17;
				if (local50 >= 0 && local50 < anInt5670) {
					for (local57 = 0; local57 < local7; local57++) {
						local70 = anInt5666 - (arg2 * (local57 + 1) >> 16);
						local80 = anInt5666 - (arg2 * local57 >> 16);
						local84 = local80 - local70;
						if (local84 > 0) {
							local93 = local57 + anInt5674;
							local173 = local50 + local93 * anInt5670;
							local175 = 0;
							local177 = 0;
							local179 = 0;
							if (local93 >= 0 && local93 < anInt5664) {
							...
							if (local175 == 0 && local177 == 0 && local179 == 0) {
								if (aClass2_Sub2_Sub13_3.anInt4575 != -1) {
									local175 = aClass2_Sub2_Sub13_3.anInt4575 | 0xFF000000;
								} else if ((local17 + anInt5672 & 0x4) == (local57 + anInt5665 & 0x4)) {
									local175 = anIntArray419[aClass96_2.anInt2518 + 1];
								} else {
									local175 = -11840664;
								}
								if (local175 == 0) {
								...
								method5068(arg0, local28, local70, local44, local84, local175, local177, aByteArray59[local173], (short[]) null, (byte[]) null, true);
							} else if (local179 == 65535) {
								@Pc(282) Class2_Sub23 local282 = (Class2_Sub23) aClass28_28.method738((long) (local50 << 16 | local93));
								if (local282 != null) {
								...
								method5068(arg0, local28, local70, local44, local84, local175, local177, aByteArray59[local173], aShortArray77, aByteArray55, true);
							}
						}
					}
				} else {
					for (local57 = 0; local57 < local7; local57++) {
						...
						local84 = local80 - local70;
						if (aClass2_Sub2_Sub13_3.anInt4575 != -1) {
							local93 = aClass2_Sub2_Sub13_3.anInt4575 | 0xFF000000;
						} else if ((local17 + anInt5672 & 0x4) == (local57 + anInt5665 & 0x4)) {
							local93 = anIntArray419[aClass96_2.anInt2518 + 1];
						} else {
							local93 = -11840664;
						}
						if (local93 == 0) {
		...
		for (local28 = -16; local28 < local3 + 16; local28++) {
			local40 = (arg1 * local28 >> 16) + anInt5669;
			local44 = (arg1 * (local28 + 1) >> 16) + anInt5669;
			local50 = local44 - local40;
			if (local50 > 0) {
				local57 = local28 + anInt5672;
				if (local57 >= 0 && local57 < anInt5670) {
					for (local70 = -16; local70 < local7 + 16; local70++) {
						local80 = anInt5666 - (arg2 * (local70 + 1) >> 16);
						local84 = anInt5666 - (arg2 * local70 >> 16);
						local93 = local84 - local80;
						if (local93 > 0) {
							local173 = local70 + anInt5674;
							if (local173 >= 0 && local173 < anInt5664) {
								local175 = aShortArray78[local57 + local173 * anInt5670] & 0xFFFF;
								if (local175 <= 0) {
									method5070(arg0, local40, local80, local50, local93, (short[]) null, (byte[]) null);
								} else if (local175 == 65535) {
									@Pc(459) Class2_Sub23 local459 = (Class2_Sub23) aClass28_28.method738((long) (local57 << 16 | local173));
									if (local459 != null) {
									...
									aByteArray55[0] = aByteArray58[local57 + local173 * anInt5670];
									method5070(arg0, local40, local80, local50, local93, aShortArray77, aByteArray55);
								}
							}
						}
					}
		...
		for (local70 = 0; local70 < 3; local70++) {
			...
			for (local80 = local40; local80 <= local50; local80++) {
				for (local84 = local44; local84 <= local57; local84++) {
					...
					if (local589 != null) {
						local173 = (local80 + (anInt5675 >> 6)) * 64;
						local175 = (local84 + (anInt5668 >> 6)) * 64;
						for (@Pc(612) Class8_Sub10 local612 = (Class8_Sub10) local589.method2790(); local612 != null; local612 = (Class8_Sub10) local589.method2785()) {
							local179 = local173 + local612.aByte138 - anInt5675 - anInt5672;
							local631 = local175 + local612.aByte139 - anInt5668 - anInt5674;
							local641 = (arg1 * local179 >> 16) + anInt5669;
							local653 = (arg1 * (local179 + 1) >> 16) + anInt5669;
							local665 = anInt5666 - (arg2 * (local631 + 1) >> 16);
							local675 = anInt5666 - (arg2 * local631 >> 16);
							method5068(arg0, local641, local665, local653 - local641, local675 - local665, local612.anInt9796, local612.aByte137 & 0xFF, local612.aByte136, local612.aShortArray134, local612.aByteArray104, false);
						}
					}
				}
			}
			for (local84 = local40; local84 <= local50; local84++) {
				for (local93 = local44; local93 <= local57; local93++) {
					...
					if (local727 != null) {
						local175 = (local84 + (anInt5675 >> 6)) * 64;
						local177 = (local93 + (anInt5668 >> 6)) * 64;
						for (@Pc(750) Class8_Sub10 local750 = (Class8_Sub10) local727.method2790(); local750 != null; local750 = (Class8_Sub10) local727.method2785()) {
							local631 = local175 + local750.aByte138 - anInt5675 - anInt5672;
							local641 = local177 + local750.aByte139 - anInt5668 - anInt5674;
							local653 = (arg1 * local631 >> 16) + anInt5669;
							local665 = (arg1 * (local631 + 1) >> 16) + anInt5669;
							local675 = anInt5666 - (arg2 * (local641 + 1) >> 16);
							@Pc(813) int local813 = anInt5666 - (arg2 * local641 >> 16);
							method5070(arg0, local653, local675, local665 - local653, local813 - local675, local750.aShortArray134, local750.aByteArray104);
						}
					}
				}
			}
	...
	private static int method5075(@OriginalArg(0) Interface4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		@Pc(11) int local11 = local4.anInt8278;
		if (local11 >= 0 && arg0.method6824(local11).aBoolean240) {
			local11 = -1;
		}
		@Pc(68) int local68;
		@Pc(27) int local27;
		@Pc(33) int local33;
		@Pc(55) int local55;
		if (local4.anInt8271 >= 0) {
			local27 = local4.anInt8271;
			...
			local68 = Static323.anIntArray389[Static105.method2043(Static203.method3066(arg0.method6824(local11).aShort37)) & 0xFFFF] | 0xFF000000;
		} else if (local4.anInt8272 == -1) {
			local68 = 0;
		} else {
			local27 = local4.anInt8272;
			local33 = (local27 & 0x7F) + arg3;
			if (local33 < 0) {
				local33 = 0;
			} else if (local33 > 127) {
	...
	public static void method5076() {
		aByteArray57 = new byte[anInt5670 * anInt5664];
		aByteArray60 = new byte[anInt5670 * anInt5664];
	...
	public static void method5078(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class2_Sub20 arg1, @OriginalArg(2) Class105 arg2) {
		...
		for (@Pc(9) int local9 = 0; local9 < local7.length / 2; local9++) {
			local20 = arg2.anIntArray228[local9 * 2] + arg1.anInt3138;
			local32 = arg2.anIntArray228[local9 * 2 + 1] + arg1.anInt3133;
			local7[local9 * 2] = anInt5669 + (anInt5671 - anInt5669) * (local20 - anInt5672) / (anInt5667 - anInt5672);
			local7[local9 * 2 + 1] = anInt5666 - (anInt5666 - anInt5673) * (local32 - anInt5674) / (anInt5665 - anInt5674);
		}
		Static141.method2371(arg0, local7, arg2.anInt2619);
		if (arg2.anInt2612 > 0) {
			@Pc(102) int local102;
			@Pc(110) int local110;
			@Pc(120) int local120;
			...
			for (local20 = 0; local20 < local7.length / 2 - 1; local20++) {
				...
				arg0.method8002(local32, local102, local110, local120, arg2.anIntArray229[arg2.aByteArray31[local20] & 0xFF], arg2.anInt2612, arg2.anInt2596, arg2.anInt2616);
			}
			...
			arg0.method8002(local32, local102, local110, local120, arg2.anIntArray229[arg2.aByteArray31[arg2.aByteArray31.length - 1] & 0xFF], arg2.anInt2612, arg2.anInt2596, arg2.anInt2616);
			return;
		}
		for (local20 = 0; local20 < local7.length / 2 - 1; local20++) {
			arg0.method7961(local7[(local20 + 1) * 2 + 1], local7[local20 * 2 + 1], local7[(local20 + 1) * 2], arg2.anIntArray229[arg2.aByteArray31[local20] & 0xFF], local7[local20 * 2]);
		}
		arg0.method7961(local7[1], local7[local7.length - 1], local7[0], arg2.anIntArray229[arg2.aByteArray31[arg2.aByteArray31.length - 1] & 0xFF], local7[local7.length - 2]);
	}

	@OriginalMember(owner = "client!baa", name = "a", descriptor = "(I)V")
	public static void method5079(@OriginalArg(0) int arg0) {
		aClass2_Sub2_Sub13_3 = (Class2_Sub2_Sub13) aClass28_27.method738((long) arg0);
	}
	...
	private static void method5081(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7) {
		...
		if ((local3 & 0x1) == 0) {
			...
			if (local21 != 62) {
				...
				if (local15) {
					aByteArray57[arg4 + arg5 * anInt5670] = (byte) local21;
					aByteArray60[arg4 + arg5 * anInt5670] = 0;
				} else {
					aByteArray60[arg4 + arg5 * anInt5670] = (byte) local21;
					aByteArray59[arg4 + arg5 * anInt5670] = 0;
					aByteArray57[arg4 + arg5 * anInt5670] = arg1.method7384();
				}
			}
			return;
		}
		...
		for (@Pc(118) int local118 = 0; local118 < local100; local118++) {
			@Pc(123) int local123 = arg1.method7403();
			@Pc(125) int local125 = 0;
			@Pc(127) int local127 = 0;
			if (local108) {
				local125 = arg1.method7403();
				local127 = arg1.method7403();
			}
			@Pc(139) int local139 = 0;
			if (local116) {
				local139 = arg1.method7403();
			}
			@Pc(215) short[] local215;
			@Pc(218) byte[] local218;
			@Pc(220) int local220;
			if (local118 == 0) {
				aByteArray57[arg4 + arg5 * anInt5670] = (byte) local123;
				aByteArray60[arg4 + arg5 * anInt5670] = (byte) local125;
				aByteArray59[arg4 + arg5 * anInt5670] = (byte) local127;
				if (local139 == 1) {
					aShortArray78[arg4 + arg5 * anInt5670] = (short) (arg1.method7389() + 1);
					aByteArray58[arg4 + arg5 * anInt5670] = arg1.method7384();
				} else if (local139 > 1) {
					aShortArray78[arg4 + arg5 * anInt5670] = -1;
					local215 = new short[local139];
					local218 = new byte[local139];
					for (local220 = 0; local220 < local139; local220++) {
						local215[local220] = (short) arg1.method7389();
						local218[local220] = arg1.method7384();
					}
					aClass28_28.method735((long) (arg4 << 16 | arg5), new Class2_Sub23(local215, local218));
				}
			} else {
				local215 = null;
				local218 = null;
				...
				if (aClass130ArrayArrayArray2[local118 - 1][arg2 - (anInt5675 >> 6)][arg3 - (anInt5668 >> 6)] == null) {
					aClass130ArrayArrayArray2[local118 - 1][arg2 - (anInt5675 >> 6)][arg3 - (anInt5668 >> 6)] = new Class130();
				}
				@Pc(338) Class8_Sub10 local338 = new Class8_Sub10(arg4 & 0x3F, arg5 & 0x3F, local123, local125, local127, local215, local218);
				aClass130ArrayArrayArray2[local118 - 1][arg2 - (anInt5675 >> 6)][arg3 - (anInt5668 >> 6)].method2787(local338);
			}
		}
	}
	...
	private static void method5082() {
		...
		@Pc(15) int local15;
		@Pc(49) int local49;
		for (@Pc(1) int local1 = 0; local1 < anInt5670; local1++) {
			for (local4 = 0; local4 < anInt5664; local4++) {
				local15 = aShortArray78[local1 + local4 * anInt5670] & 0xFFFF;
				if (local15 != 0) {
					@Pc(35) int local35;
					if (local15 == 65535) {
						@Pc(31) Class2_Sub23 local31 = (Class2_Sub23) aClass28_28.method738((long) (local1 << 16 | local4));
						if (local31 != null) {
	...
	public static void method5087(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(11) Class2_Sub21 local11 = new Class2_Sub21(aClass332_74.method7607(aClass2_Sub2_Sub13_3.aString48, "area"));
		@Pc(15) int local15 = local11.method7403();
		@Pc(18) int[] local18 = new int[local15];
		for (@Pc(20) int local20 = 0; local20 < local15; local20++) {
			local18[local20] = local11.method7403();
		}
		@Pc(35) int local35 = local11.method7403();
		@Pc(38) int[] local38 = new int[local35];
		for (@Pc(40) int local40 = 0; local40 < local35; local40++) {
			local38[local40] = local11.method7403();
		}
		while (true) {
			@Pc(60) int local60;
			@Pc(66) int local66;
			...
			@Pc(78) int local78;
			@Pc(150) int local150;
			while (local11.anInt8412 < local11.aByteArray93.length) {
				@Pc(64) int local64;
				@Pc(86) int local86;
				if (local11.method7403() == 0) {
					local60 = local11.method7403();
					local64 = local11.method7403();
					for (local66 = 0; local66 < 64; local66++) {
						for (local69 = 0; local69 < 64; local69++) {
							local78 = local60 * 64 + local66 - anInt5675;
							local86 = local64 * 64 + local69 - anInt5668;
							method5081(arg0, local11, local60, local64, local78, local86, local18, local38);
						}
					}
				} else {
					local60 = local11.method7403();
					local64 = local11.method7403();
					local66 = local11.method7403();
					local69 = local11.method7403();
					for (local78 = 0; local78 < 8; local78++) {
						for (local86 = 0; local86 < 8; local86++) {
							@Pc(138) int local138 = local60 * 64 + local66 * 8 + local78 - anInt5675;
							local150 = local64 * 64 + local69 * 8 + local86 - anInt5668;
							method5081(arg0, local11, local60, local64, local138, local150, local18, local38);
						}
					}
				}
			}
			aByteArray56 = new byte[anInt5670 * anInt5664];
			aShortArray79 = new short[anInt5670 * anInt5664];
			for (local60 = 0; local60 < 3; local60++) {
				@Pc(193) byte[] local193 = new byte[anInt5670 * anInt5664];
					...
					for (local69 = 0; local69 < aClass130ArrayArrayArray2[local60][0].length; local69++) {
						...
						if (local207 != null) {
							for (@Pc(214) Class8_Sub10 local214 = (Class8_Sub10) local207.method2790(); local214 != null; local214 = (Class8_Sub10) local207.method2785()) {
								local193[local66 * 64 + local214.aByte138 + (local69 * 64 + local214.aByte139) * anInt5670] = (byte) local214.anInt9796;
							}
						}
					}
				}
				method5071(local193, aByteArray56, aShortArray79, arg1, arg2);
					...
					for (local78 = 0; local78 < aClass130ArrayArrayArray2[local60][0].length; local78++) {
						...
						if (local278 != null) {
							for (@Pc(285) Class8_Sub10 local285 = (Class8_Sub10) local278.method2790(); local285 != null; local285 = (Class8_Sub10) local278.method2785()) {
								local150 = local69 * 64 + local285.aByte138 + (local78 * 64 + local285.aByte139) * anInt5670;
								local285.anInt9796 = (aByteArray56[local150] & 0xFF) << 16 | aShortArray79[local150] & 0xFFFF;
								if (local285.anInt9796 != 0) {
									local285.anInt9796 |= 0xFF000000;
								}
							}
						}
					}
			...
			method5071(aByteArray57, aByteArray56, aShortArray79, arg1, arg2);
			aByteArray57 = null;
			method5082();
			return;
		}
	...
	public static Class341 method5088(@OriginalArg(0) Class19 arg0) {
		...
		@Pc(15) int local15 = (anInt5671 - anInt5669 << 16) / local3;
		@Pc(23) int local23 = (anInt5666 - anInt5673 << 16) / local7;
		return method5089(arg0, local15, local23);
	}
