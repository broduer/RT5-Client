...
public final class Static30 {
	...
	private static short[] aShortArray78;
	...
	private static Class130[][][] aClass130ArrayArrayArray2;
	...
	@OriginalMember(owner = "client!baa", name = "g", descriptor = "I")
	public static int anInt5642 = (int) (Math.random() * 17.0D) - 8;
	...
	public static final Class339 aClass339_31 = new Class339();

	@OriginalMember(owner = "client!baa", name = "b", descriptor = "(I)Lclient!ip;")
	public static Class2_Sub2_Sub13 method3541(@OriginalArg(0) int arg0) {
		return (Class2_Sub2_Sub13) aClass28_27.method373((long) arg0);
	}

	@OriginalMember(owner = "client!baa", name = "a", descriptor = "(Lclient!ha;)V")
	public static void method3542(@OriginalArg(0) Class19 arg0) {
		...
		method3548(arg0, local15, local23);
	}

	@OriginalMember(owner = "client!baa", name = "a", descriptor = "(Lclient!ha;IIIIIII[S[BZ)V")
	private static void method3543(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) boolean arg10) {
		@Pc(20) int local20;
		@Pc(32) int local32;
		if (arg10 || arg5 != 0 || arg6 > 0) {
			if (arg6 == 0) {
				...
				if (local20 == 0 || arg3 <= 1 || arg4 <= 1) {
					local32 = anIntArray419[arg6];
					if (arg10 || local32 != 0) {
						arg0.aa(arg1, arg2, arg3, arg4, local32, 0);
					}
				} else {
					local32 = arg10 ? 0 : 1;
					Static339.method3494(arg4, aByteArrayArrayArray5, anIntArray419[arg6], arg3, anInt5643, arg1, arg0, local32, arg7 >> 6 & 0x3, arg2, arg5, local20);
				}
			}
		}
		if (arg8 == null) {
		...
		for (@Pc(100) int local100 = 0; local100 < arg8.length; local100++) {
			...
			if (local107 == 0 || local107 == 2 || local107 == 3 || local107 == 9) {
				@Pc(127) Class54 local127 = aClass142_3.method2158(arg8[local100] & 0xFFFF, 55);
	...
	public static void method3544(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		anInt5652 = arg0 - anInt5655;
		anInt5645 = arg1 - anInt5648;
		anInt5647 = arg2 - anInt5655;
		anInt5654 = arg3 - anInt5648;
		anInt5649 = arg4;
		anInt5653 = arg5;
		anInt5651 = arg6;
		anInt5646 = arg7;
	...
	private static void method3545(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) short[] arg5, @OriginalArg(6) byte[] arg6) {
		if (arg5 == null) {
			return;
		}
		for (@Pc(4) int local4 = 0; local4 < arg5.length; local4++) {
			@Pc(14) Class54 local14 = aClass142_3.method2158(arg5[local4] & 0xFFFF, 116);
			@Pc(17) int local17 = local14.anInt1239;
			if (local17 != -1) {
				@Pc(25) Class173 local25 = aClass363_3.method5926(local17);
				@Pc(49) Class23 local49 = local25.method2656(local14.aBoolean103 ? arg6[local4] >> 6 & 0x3 : 0, arg0, local14.aBoolean96 ? local14.aBoolean100 : false);
				if (local49 != null) {
					@Pc(58) int local58 = arg3 * local49.b() >> 2;
					...
					if (local58 != 0 && local65 != 0) {
						if (local25.anInt4165 == 0) {
							local49.b(arg1, arg2 + arg4 - local65, local58, local65);
						} else {
							local49.a(arg1, arg2 + arg4 - local65, local58, local65, 0, local25.anInt4165 | 0xFF000000, 1);
						}
					}
				}
			}
	...
	private static void method3546(@OriginalArg(0) byte[] arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) short[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(2) int[] local2 = new int[anInt5644];
		@Pc(5) int[] local5 = new int[anInt5644];
		@Pc(8) int[] local8 = new int[anInt5644];
		@Pc(11) int[] local11 = new int[anInt5644];
		@Pc(14) int[] local14 = new int[anInt5644];
		for (@Pc(16) int local16 = -5; local16 < anInt5650; local16++) {
			@Pc(21) int local21 = local16 + 5;
			@Pc(25) int local25 = local16 - 5;
			@Pc(41) int local41;
			for (@Pc(27) int local27 = 0; local27 < anInt5644; local27++) {
				@Pc(50) Class264 local50;
				@Pc(86) int local86;
				if (local21 < anInt5650) {
					local41 = arg0[local21 + local27 * anInt5650] & 0xFF;
					if (local41 > 0) {
						local50 = aClass79_5.method1317(local41 - 1);
				...
				if (local25 >= 0) {
					local41 = arg0[local25 + local27 * anInt5650] & 0xFF;
					if (local41 > 0) {
						local50 = aClass79_5.method1317(local41 - 1);
						local2[local27] -= local50.anInt6630;
						local5[local27] -= local50.anInt6637;
			...
			if (local16 >= 0) {
				...
				for (@Pc(167) int local167 = -5; local167 < anInt5644; local167++) {
					@Pc(172) int local172 = local167 + 5;
					if (local172 < anInt5644) {
					...
					if (local167 >= 0 && local165 > 0) {
						@Pc(261) int local261;
						if ((arg0[local16 + local167 * anInt5650] & 0xFF) == 0) {
							local261 = local16 + local167 * anInt5650;
							arg1[local261] = 0;
							arg2[local261] = 0;
						} else {
							local261 = local163 == 0 ? 0 : Static318.method6094(local161 / local165, local159 / local165, local41 * 256 / local163);
							...
							@Pc(333) int local333 = Static323.anIntArray389[Static105.method1299(Static75.method4342(local316)) & 0xFFFF];
	...
	public static void method3547(@OriginalArg(0) Class330 arg0, @OriginalArg(1) Class96 arg1, @OriginalArg(2) Class79 arg2, @OriginalArg(3) Class142 arg3, @OriginalArg(4) Class246 arg4, @OriginalArg(5) Class363 arg5, @OriginalArg(6) Interface23 arg6) {
		aClass330_74 = arg0;
		aClass96_2 = arg1;
		aClass79_5 = arg2;
		aClass142_3 = arg3;
		...
		aClass28_27.method372();
		@Pc(23) int local23 = aClass330_74.method5354("details");
		@Pc(28) int[] local28 = aClass330_74.method5367(local23);
		if (local28 != null) {
			for (@Pc(32) int local32 = 0; local32 < local28.length; local32++) {
				@Pc(41) Class2_Sub2_Sub13 local41 = Static517.method4808(aClass330_74, local23, local28[local32]);
				aClass28_27.method370((long) local41.anInt4563, local41);
			}
		}
		Static198.method2059(false, true);
	}

	@OriginalMember(owner = "client!baa", name = "a", descriptor = "(Lclient!ha;IIII)V")
	private static void method3548(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(3) int local3 = anInt5647 - anInt5652;
		@Pc(7) int local7 = anInt5645 - anInt5654;
		if (anInt5647 < anInt5650) {
			local3++;
		}
		if (anInt5645 < anInt5644) {
			local7++;
		}
		@Pc(28) int local28;
		@Pc(40) int local40;
		...
		for (@Pc(17) int local17 = 0; local17 < local3; local17++) {
			...
			if (local44 > 0) {
				...
				if (local50 >= 0 && local50 < anInt5650) {
					for (local57 = 0; local57 < local7; local57++) {
						...
						if (local84 > 0) {
							...
							local173 = local50 + local93 * anInt5650;
							local175 = 0;
							local177 = 0;
							local179 = 0;
							if (local93 >= 0 && local93 < anInt5644) {
							...
							if (local175 == 0 && local177 == 0 && local179 == 0) {
								if (aClass2_Sub2_Sub13_3.anInt4561 != -1) {
									local175 = aClass2_Sub2_Sub13_3.anInt4561 | 0xFF000000;
								} else if ((local17 + anInt5652 & 0x4) == (local57 + anInt5645 & 0x4)) {
									local175 = anIntArray419[aClass96_2.anInt2509 + 1];
								} else {
									local175 = -11840664;
								}
								if (local175 == 0) {
								...
								method3543(arg0, local28, local70, local44, local84, local175, local177, aByteArray59[local173], (short[]) null, (byte[]) null, true);
							} else if (local179 == 65535) {
								@Pc(282) Class2_Sub23 local282 = (Class2_Sub23) aClass28_28.method373((long) (local50 << 16 | local93));
								if (local282 != null) {
									method3543(arg0, local28, local70, local44, local84, local175, local177, aByteArray59[local173], local282.aShortArray59, local282.aByteArray38, true);
								}
							} else {
								aShortArray77[0] = (short) (local179 - 1);
								aByteArray55[0] = aByteArray58[local173];
								method3543(arg0, local28, local70, local44, local84, local175, local177, aByteArray59[local173], aShortArray77, aByteArray55, true);
							}
						}
					}
				} else {
					for (local57 = 0; local57 < local7; local57++) {
						...
						local84 = local80 - local70;
						if (aClass2_Sub2_Sub13_3.anInt4561 != -1) {
							local93 = aClass2_Sub2_Sub13_3.anInt4561 | 0xFF000000;
						} else if ((local17 + anInt5652 & 0x4) == (local57 + anInt5645 & 0x4)) {
							local93 = anIntArray419[aClass96_2.anInt2509 + 1];
						} else {
							local93 = -11840664;
						}
						if (local93 == 0) {
		...
		for (local28 = -16; local28 < local3 + 16; local28++) {
			...
			if (local50 > 0) {
				...
				if (local57 >= 0 && local57 < anInt5650) {
					for (local70 = -16; local70 < local7 + 16; local70++) {
						...
						if (local93 > 0) {
							...
							if (local173 >= 0 && local173 < anInt5644) {
								local175 = aShortArray78[local57 + local173 * anInt5650] & 0xFFFF;
								if (local175 <= 0) {
									method3545(arg0, local40, local80, local50, local93, (short[]) null, (byte[]) null);
								} else if (local175 == 65535) {
									@Pc(459) Class2_Sub23 local459 = (Class2_Sub23) aClass28_28.method373((long) (local57 << 16 | local173));
									if (local459 != null) {
										method3545(arg0, local40, local80, local50, local93, local459.aShortArray59, local459.aByteArray38);
									}
								} else {
									aShortArray77[0] = (short) (local175 - 1);
									aByteArray55[0] = aByteArray58[local57 + local173 * anInt5650];
									method3545(arg0, local40, local80, local50, local93, aShortArray77, aByteArray55);
								}
							}
						}
					}
			...
			for (local80 = local40; local80 <= local50; local80++) {
				for (local84 = local44; local84 <= local57; local84++) {
					...
					if (local589 != null) {
						...
						for (@Pc(612) Class8_Sub10 local612 = (Class8_Sub10) local589.method1905(); local612 != null; local612 = (Class8_Sub10) local589.method1900()) {
							...
							method3543(arg0, local641, local665, local653 - local641, local675 - local665, local612.anInt9770, local612.aByte137 & 0xFF, local612.aByte136, local612.aShortArray133, local612.aByteArray104, false);
						}
					}
				}
			}
			for (local84 = local40; local84 <= local50; local84++) {
				for (local93 = local44; local93 <= local57; local93++) {
					...
					if (local727 != null) {
						...
						for (@Pc(750) Class8_Sub10 local750 = (Class8_Sub10) local727.method1905(); local750 != null; local750 = (Class8_Sub10) local727.method1900()) {
							...
							method3545(arg0, local653, local675, local665 - local653, local813 - local675, local750.aShortArray133, local750.aByteArray104);
						}
					}
				}
			}
	...
	public static void method3549(@OriginalArg(0) Interface4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		for (@Pc(1) int local1 = 0; local1 < aClass96_2.anInt2506; local1++) {
			anIntArray419[local1 + 1] = method3550(arg0, local1, arg1, arg2);
		}
	}

	@OriginalMember(owner = "client!baa", name = "a", descriptor = "(Lclient!d;III)I")
	private static int method3550(@OriginalArg(0) Interface4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(4) Class318 local4 = aClass96_2.method1550(arg1);
		if (local4 == null) {
			return 0;
		}
		@Pc(11) int local11 = local4.anInt8255;
		if (local11 >= 0 && arg0.method4805(local11).aBoolean240) {
			local11 = -1;
		}
		@Pc(68) int local68;
		@Pc(27) int local27;
		@Pc(33) int local33;
		@Pc(55) int local55;
		if (local4.anInt8248 >= 0) {
			local27 = local4.anInt8248;
			...
			local68 = Static323.anIntArray389[Static105.method1299(Static203.method2161(local55)) & 0xFFFF] | 0xFF000000;
		} else if (local11 >= 0) {
			local68 = Static323.anIntArray389[Static105.method1299(Static203.method2161(arg0.method4805(local11).aShort37)) & 0xFFFF] | 0xFF000000;
		} else if (local4.anInt8249 == -1) {
			local68 = 0;
		} else {
			local27 = local4.anInt8249;
			local33 = (local27 & 0x7F) + arg3;
			if (local33 < 0) {
				local33 = 0;
			} else if (local33 > 127) {
	...
	public static void method3551() {
		aByteArray57 = new byte[anInt5650 * anInt5644];
		aByteArray60 = new byte[anInt5650 * anInt5644];
	...
	public static void method3553(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class2_Sub20 arg1, @OriginalArg(2) Class105 arg2) {
		...
		for (@Pc(9) int local9 = 0; local9 < local7.length / 2; local9++) {
			local20 = arg2.anIntArray228[local9 * 2] + arg1.anInt3129;
			local32 = arg2.anIntArray228[local9 * 2 + 1] + arg1.anInt3124;
		...
		Static141.method1569(arg0, local7, arg2.anInt2610);
		if (arg2.anInt2603 > 0) {
			@Pc(102) int local102;
			@Pc(110) int local110;
			@Pc(120) int local120;
			...
			for (local20 = 0; local20 < local7.length / 2 - 1; local20++) {
				...
				arg0.a(local32, local102, local110, local120, arg2.anIntArray229[arg2.aByteArray31[local20] & 0xFF], 1, arg2.anInt2603, arg2.anInt2587, arg2.anInt2607);
			}
			...
			arg0.a(local32, local102, local110, local120, arg2.anIntArray229[arg2.aByteArray31[arg2.aByteArray31.length - 1] & 0xFF], 1, arg2.anInt2603, arg2.anInt2587, arg2.anInt2607);
			return;
		}
		for (local20 = 0; local20 < local7.length / 2 - 1; local20++) {
			arg0.b(local7[(local20 + 1) * 2 + 1], local7[local20 * 2 + 1], local7[(local20 + 1) * 2], arg2.anIntArray229[arg2.aByteArray31[local20] & 0xFF], 1, local7[local20 * 2]);
		}
		arg0.b(local7[1], local7[local7.length - 1], local7[0], arg2.anIntArray229[arg2.aByteArray31[arg2.aByteArray31.length - 1] & 0xFF], 1, local7[local7.length - 2]);
	}

	@OriginalMember(owner = "client!baa", name = "a", descriptor = "(I)V")
	public static void method3554(@OriginalArg(0) int arg0) {
		aClass2_Sub2_Sub13_3 = (Class2_Sub2_Sub13) aClass28_27.method373((long) arg0);
	}

	@OriginalMember(owner = "client!baa", name = "a", descriptor = "(Lclient!ha;Lclient!fu;IIII)V")
	private static void method3555(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class2_Sub20 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	private static void method3556(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class2_Sub21 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7) {
		@Pc(3) int local3 = arg1.method5205();
		if ((local3 & 0x1) == 0) {
			@Pc(15) boolean local15 = (local3 & 0x2) == 0;
			@Pc(21) int local21 = local3 >> 2 & 0x3F;
			if (local21 != 62) {
				if (local21 == 63) {
					local21 = arg1.method5205();
				} else if (local15) {
				...
				if (local15) {
					aByteArray57[arg4 + arg5 * anInt5650] = (byte) local21;
					aByteArray60[arg4 + arg5 * anInt5650] = 0;
				} else {
					aByteArray60[arg4 + arg5 * anInt5650] = (byte) local21;
					aByteArray59[arg4 + arg5 * anInt5650] = 0;
					aByteArray57[arg4 + arg5 * anInt5650] = arg1.method5186();
				}
			}
			return;
		}
		...
		for (@Pc(118) int local118 = 0; local118 < local100; local118++) {
			@Pc(123) int local123 = arg1.method5205();
			@Pc(125) int local125 = 0;
			@Pc(127) int local127 = 0;
			if (local108) {
				local125 = arg1.method5205();
				local127 = arg1.method5205();
			}
			@Pc(139) int local139 = 0;
			if (local116) {
				local139 = arg1.method5205();
			}
			@Pc(215) short[] local215;
			@Pc(218) byte[] local218;
			@Pc(220) int local220;
			if (local118 == 0) {
				aByteArray57[arg4 + arg5 * anInt5650] = (byte) local123;
				aByteArray60[arg4 + arg5 * anInt5650] = (byte) local125;
				aByteArray59[arg4 + arg5 * anInt5650] = (byte) local127;
				if (local139 == 1) {
					aShortArray78[arg4 + arg5 * anInt5650] = (short) (arg1.method5191() + 1);
					aByteArray58[arg4 + arg5 * anInt5650] = arg1.method5186();
				} else if (local139 > 1) {
					aShortArray78[arg4 + arg5 * anInt5650] = -1;
					local215 = new short[local139];
					local218 = new byte[local139];
					for (local220 = 0; local220 < local139; local220++) {
						local215[local220] = (short) arg1.method5191();
						local218[local220] = arg1.method5186();
					}
					aClass28_28.method370((long) (arg4 << 16 | arg5), new Class2_Sub23(local215, local218));
				}
			} else {
				local215 = null;
				local218 = null;
				...
				aClass130ArrayArrayArray2[local118 - 1][arg2 - (anInt5655 >> 6)][arg3 - (anInt5648 >> 6)].method1902(local338);
			}
		}
	}
	...
	private static void method3557() {
		...
		@Pc(15) int local15;
		@Pc(49) int local49;
		for (@Pc(1) int local1 = 0; local1 < anInt5650; local1++) {
			for (local4 = 0; local4 < anInt5644; local4++) {
				local15 = aShortArray78[local1 + local4 * anInt5650] & 0xFFFF;
				if (local15 != 0) {
					@Pc(35) int local35;
					if (local15 == 65535) {
						@Pc(31) Class2_Sub23 local31 = (Class2_Sub23) aClass28_28.method373((long) (local1 << 16 | local4));
						if (local31 != null) {
							for (local35 = 0; local35 < local31.aShortArray59.length; local35++) {
								@Pc(46) Class54 local46 = aClass142_3.method2158(local31.aShortArray59[local35] & 0xFFFF, 115);
								local49 = local46.anInt1233;
								if (local46.anIntArray113 != null) {
									local46 = local46.method801(13, anInterface23_3);
									if (local46 != null) {
										local49 = local46.anInt1233;
									}
								}
								if (local49 != -1) {
									...
									local70.anInt3129 = local1;
									local70.anInt3124 = local4;
									aClass339_31.method5465(local70);
								}
							}
						}
					} else {
						@Pc(94) Class54 local94 = aClass142_3.method2158(local15 - 1, 115);
						local35 = local94.anInt1233;
						if (local94.anIntArray113 != null) {
							local94 = local94.method801(13, anInterface23_3);
							if (local94 != null) {
								local35 = local94.anInt1233;
							}
						}
						if (local35 != -1) {
							...
							local118.anInt3129 = local1;
							local118.anInt3124 = local4;
							aClass339_31.method5465(local118);
						}
					}
				}
			}
		...
		for (local4 = 0; local4 < 3; local4++) {
			for (local15 = 0; local15 < aClass130ArrayArrayArray2[0].length; local15++) {
				for (@Pc(144) int local144 = 0; local144 < aClass130ArrayArrayArray2[0][0].length; local144++) {
					...
					if (local153 != null) {
						for (@Pc(160) Class8_Sub10 local160 = (Class8_Sub10) local153.method1905(); local160 != null; local160 = (Class8_Sub10) local153.method1900()) {
							if (local160.aShortArray133 != null) {
								for (local49 = 0; local49 < local160.aShortArray133.length; local49++) {
									@Pc(177) Class54 local177 = aClass142_3.method2158(local160.aShortArray133[local49] & 0xFFFF, 126);
									@Pc(180) int local180 = local177.anInt1233;
									if (local177.anIntArray113 != null) {
										local177 = local177.method801(13, anInterface23_3);
										if (local177 != null) {
									...
									if (local180 != -1) {
										...
										local201.anInt3129 = (local15 + (anInt5655 >> 6)) * 64 + local160.aByte138 - anInt5655;
										local201.anInt3124 = (local144 + (anInt5648 >> 6)) * 64 + local160.aByte139 - anInt5648;
										aClass339_31.method5465(local201);
									}
								}
							}
						}
	...
	public static Class192 method3558(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(3) Class192 local3 = new Class192();
		for (@Pc(8) Class2_Sub2_Sub13 local8 = (Class2_Sub2_Sub13) aClass28_27.method371(); local8 != null; local8 = (Class2_Sub2_Sub13) aClass28_27.method375()) {
			if (local8.aBoolean354 && local8.method2836(arg0, arg1)) {
				local3.method3013(local8);
			}
		}
		return local3;
	}
	...
	public static Class2_Sub2_Sub13 method3560(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		for (@Pc(4) Class2_Sub2_Sub13 local4 = (Class2_Sub2_Sub13) aClass28_27.method371(); local4 != null; local4 = (Class2_Sub2_Sub13) aClass28_27.method375()) {
			if (local4.aBoolean354 && local4.method2836(arg0, arg1)) {
				return local4;
			}
		}
		return null;
	...
	public static void method3561() {
		...
		for (@Pc(4) int local4 = 0; local4 < aClass255_3.anInt6373; local4++) {
			@Pc(32) boolean local32 = aClass2_Sub2_Sub13_3.method2838(local2, aClass255_3.anIntArray495[local4] & 0x3FFF, aClass255_3.anIntArray495[local4] >> 28 & 0x3, aClass255_3.anIntArray495[local4] >> 14 & 0x3FFF);
			if (local32) {
				@Pc(42) Class2_Sub20 local42 = new Class2_Sub20(aClass255_3.anIntArray496[local4]);
				local42.anInt3129 = local2[1] - anInt5655;
				local42.anInt3124 = local2[2] - anInt5648;
				aClass339_31.method5465(local42);
			}
		}
	}

	@OriginalMember(owner = "client!baa", name = "a", descriptor = "(Lclient!ha;II)V")
	public static void method3562(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(11) Class2_Sub21 local11 = new Class2_Sub21(aClass330_74.method5364(aClass2_Sub2_Sub13_3.aString48, "area"));
		@Pc(15) int local15 = local11.method5205();
		@Pc(18) int[] local18 = new int[local15];
		for (@Pc(20) int local20 = 0; local20 < local15; local20++) {
			local18[local20] = local11.method5205();
		}
		@Pc(35) int local35 = local11.method5205();
		@Pc(38) int[] local38 = new int[local35];
		for (@Pc(40) int local40 = 0; local40 < local35; local40++) {
			local38[local40] = local11.method5205();
		}
		while (true) {
			@Pc(60) int local60;
			@Pc(66) int local66;
			...
			@Pc(78) int local78;
			@Pc(150) int local150;
			while (local11.anInt8388 < local11.aByteArray93.length) {
				@Pc(64) int local64;
				@Pc(86) int local86;
				if (local11.method5205() == 0) {
					local60 = local11.method5205();
					local64 = local11.method5205();
					for (local66 = 0; local66 < 64; local66++) {
						for (local69 = 0; local69 < 64; local69++) {
							local78 = local60 * 64 + local66 - anInt5655;
							local86 = local64 * 64 + local69 - anInt5648;
							method3556(arg0, local11, local60, local64, local78, local86, local18, local38);
						}
					}
				} else {
					local60 = local11.method5205();
					local64 = local11.method5205();
					local66 = local11.method5205();
					local69 = local11.method5205();
					for (local78 = 0; local78 < 8; local78++) {
						for (local86 = 0; local86 < 8; local86++) {
							@Pc(138) int local138 = local60 * 64 + local66 * 8 + local78 - anInt5655;
							local150 = local64 * 64 + local69 * 8 + local86 - anInt5648;
							method3556(arg0, local11, local60, local64, local138, local150, local18, local38);
						}
					}
				}
			}
			aByteArray56 = new byte[anInt5650 * anInt5644];
			...
			for (local60 = 0; local60 < 3; local60++) {
				...
				for (local66 = 0; local66 < aClass130ArrayArrayArray2[local60].length; local66++) {
					for (local69 = 0; local69 < aClass130ArrayArrayArray2[local60][0].length; local69++) {
						...
						if (local207 != null) {
							for (@Pc(214) Class8_Sub10 local214 = (Class8_Sub10) local207.method1905(); local214 != null; local214 = (Class8_Sub10) local207.method1900()) {
								local193[local66 * 64 + local214.aByte138 + (local69 * 64 + local214.aByte139) * anInt5650] = (byte) local214.anInt9770;
							}
						}
					}
				}
				method3546(local193, aByteArray56, aShortArray79, arg1, arg2);
				for (local69 = 0; local69 < aClass130ArrayArrayArray2[local60].length; local69++) {
					for (local78 = 0; local78 < aClass130ArrayArrayArray2[local60][0].length; local78++) {
						...
						if (local278 != null) {
							for (@Pc(285) Class8_Sub10 local285 = (Class8_Sub10) local278.method1905(); local285 != null; local285 = (Class8_Sub10) local278.method1900()) {
			...
			method3546(aByteArray57, aByteArray56, aShortArray79, arg1, arg2);
			aByteArray57 = null;
			method3557();
			return;
		}
	...
	public static Class339 method3563(@OriginalArg(0) Class19 arg0) {
		@Pc(3) int local3 = anInt5647 - anInt5652;
		@Pc(7) int local7 = anInt5645 - anInt5654;
		@Pc(15) int local15 = (anInt5651 - anInt5649 << 16) / local3;
		@Pc(23) int local23 = (anInt5646 - anInt5653 << 16) / local7;
		return method3564(arg0, local15, local23);
	}

	@OriginalMember(owner = "client!baa", name = "b", descriptor = "(Lclient!ha;IIII)Lclient!sia;")
	private static Class339 method3564(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		for (@Pc(4) Class2_Sub20 local4 = (Class2_Sub20) aClass339_31.method5453(65280); local4 != null; local4 = (Class2_Sub20) aClass339_31.method5460()) {
			method3555(arg0, local4, arg1, arg2);
		}
		return aClass339_31;
	}
}
