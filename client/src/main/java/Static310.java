...
public final class Static310 {
	...
	public static void method3135(@OriginalArg(0) int[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int[] arg2, @OriginalArg(4) Class8_Sub2_Sub1_Sub2 arg3) {
			...
			while (local24 != 0 && arg3.aClass152_Sub2_Sub1Array3.length > local30) {
				if ((local24 & 0x1) != 0) {
					if (local20 == -1) {
						...
						@Pc(60) Class69 local60 = Static25.aClass50_1.method682(local20);
						@Pc(63) int local63 = local60.anInt1646;
						@Pc(68) Class152_Sub2_Sub1 local68 = arg3.aClass152_Sub2_Sub1Array3[local30];
						if (local68 != null && local68.method6543()) {
							if (local20 == local68.method6548()) {
								if (local63 == 0) {
							...
							} else if (local60.anInt1649 >= local68.method6541().anInt1649) {
								local68 = arg3.aClass152_Sub2_Sub1Array3[local30] = null;
							}
						}
						if (local68 == null || !local68.method6543()) {
							local68 = arg3.aClass152_Sub2_Sub1Array3[local30] = new Class152_Sub2_Sub1(arg3);
							local68.method6547(true, local20);
							local68.anInt10508 = local28;
						}
					}
				}
