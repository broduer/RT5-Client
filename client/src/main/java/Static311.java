...
public final class Static311 {
	...
	public static boolean method3167(@OriginalArg(0) Class2_Sub8 arg0) {
		if (arg0 == null) {
			return true;
		}
		...
		if (Static159.anInt2788 == 1) {
			if (!Static581.aClass2_Sub6_Sub1_3.method486(Static270.aClass123_2, Static86.aClass330_13, arg0)) {
				return false;
			}
	...
	public static void method3168(@OriginalArg(0) boolean arg0, @OriginalArg(2) boolean arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) String arg4, @OriginalArg(6) String arg5) {
		...
		if (arg3 != -1) {
			@Pc(25) Class296 local25 = Static386.aClass49_2.method681(arg3);
			if (local25 == null || local25.method4689() != arg0) {
				return;
			}
			if (local25.method4689()) {
		...
		for (@Pc(56) int local56 = 0; local56 < Static419.aClass112_1.anInt2670; local56++) {
			@Pc(62) Class382 local62 = Static419.aClass112_1.method1684(local56);
			if ((!arg1 || local62.aBoolean771) && local62.anInt10087 == -1 && local62.anInt10083 == -1 && local62.anInt10144 == -1 && local62.anInt10101 == 0 && local62.aString118.toLowerCase().indexOf(local9) != -1) {
				if (arg3 != -1) {
					if (arg0) {
						if (!arg5.equals(local62.method6287(local16, arg3))) {
							continue;
						}
					} else if (arg2 != local62.method6281(arg3, local14)) {
						continue;
					}
				}
				if (local54 >= 250) {
		...
		for (@Pc(205) int local205 = 0; local205 < Static606.anInt8947; local205++) {
			local203[local205] = Static419.aClass112_1.method1684(local12[local205]).aString118;
		}
		Static554.method5116(local203, Static256.aShortArray63);
		Static380.aClass330_79.method5356();
