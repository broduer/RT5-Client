...
public final class Static315 {
	...
	public static void method3197(@OriginalArg(0) int arg0) {
	...
	public static long method3199(@OriginalArg(0) long arg0, @OriginalArg(1) long arg1) {
		return arg0 ^ arg1;
	}

	@OriginalMember(owner = "client!k", name = "a", descriptor = "(IILclient!cka;)V")
	public static void method3200(@OriginalArg(0) int arg0, @OriginalArg(2) Class69 arg1) {
		...
		if (arg1.anIntArray154 != null && arg1.anIntArray155 != null) {
			local63 = Static159.method1714(arg1.anIntArray154[arg0], arg1.anIntArray155[arg0]);
		}
		if (arg1.aBoolean141) {
			Static186.method1933(local46, local81, local63, 0, 255, false);
		} else {
			Static161.method1728(local63, 0, local46, local81, 255);
		}
	}

	@OriginalMember(owner = "client!k", name = "a", descriptor = "(JB)V")
	public static void method3201(@OriginalArg(0) long arg0) {
		try {
			Thread.sleep(arg0);
