...
public final class Static319 {
	...
	public static boolean method3217(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		return Static483.method4552(arg1, arg0) & Static340.method3499(arg1, arg0);
	}

	@OriginalMember(owner = "client!kba", name = "a", descriptor = "(IZIBIII)V")
	public static void method3218(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		...
		if (arg1 && Static674.anInt10088 >= 100) {
			...
			Static359.anInt5801 = Static102.method1286(Static394.anInt6176, -29754, Static110.anInt2186, Static170.anInt2864) - Static363.anInt6934;
		}
