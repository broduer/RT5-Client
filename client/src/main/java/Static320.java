...
public final class Static320 {
	...
	public static void method3221() {
		...
		Static204.aClass339_16.method5454();
		Static239.aClass339_19.method5454();
		@Pc(64) int local64;
		for (@Pc(57) Class2_Sub2_Sub16 local57 = (Class2_Sub2_Sub16) Static693.aClass339_79.method5453(65280); local57 != null; local57 = (Class2_Sub2_Sub16) Static693.aClass339_79.method5460()) {
			local64 = local57.anInt7314;
			if (local64 < 1000) {
				local57.a((byte) 78);
				if (local64 == 21 || local64 == 60 || local64 == 23 || local64 == 17 || local64 == 44 || local64 == 4 || local64 == 18) {
					Static239.aClass339_19.method5465(local57);
				} else {
					Static204.aClass339_16.method5465(local57);
				}
			}
		}
		Static204.aClass339_16.method5461(Static693.aClass339_79);
		Static239.aClass339_19.method5461(Static693.aClass339_79);
		if (Static594.anInt8777 <= 1) {
			Static470.aClass2_Sub2_Sub16_10 = null;
			Static96.aClass2_Sub2_Sub16_13 = null;
		} else {
			if (Static209.aBoolean269 && Static334.aClass319_1.method6033(81) && Static594.anInt8777 > 2) {
		...
		local64 = -1;
		@Pc(204) Class2_Sub9 local204 = (Class2_Sub9) Static226.aClass339_58.method5453(65280);
		if (local204 != null) {
			local64 = local204.method3775();
		}
		if (!Static400.aBoolean622) {
			if (local64 == 0 && (Static219.anInt3549 == 1 && Static594.anInt8777 > 2 || Static204.method2174())) {
				local64 = 2;
			}
			if (local64 == 2 && Static594.anInt8777 > 0 && local204 != null) {
				if (Static109.aClass158_3 == null && Static460.anInt6964 == 0) {
					Static572.b(local204.method3780(), local204.method3778());
				} else {
		...
		@Pc(428) int local428;
		if (local64 == -1) {
			local317 = Static189.aClass120_1.method6319();
			local321 = Static189.aClass120_1.method6320();
			...
			if (!local323) {
				if (Static71.anInt1576 - 10 > local317 || Static71.anInt1576 + Static682.anInt10295 + 10 < local317 || Static84.anInt1775 - 10 > local321 || local321 > Static407.anInt6288 + Static84.anInt1775 + 10) {
					...
					if (local426 != -1) {
						...
						for (@Pc(530) Class2_Sub2_Sub4 local530 = (Class2_Sub2_Sub4) local525.method4737(); local530 != null; local530 = (Class2_Sub2_Sub4) local525.method4736()) {
							if (local444 == local426) {
								if (local530.anInt1534 > 1) {
									Static609.method5798(local428, local321, local530);
								}
								break;
							}
							local444++;
		...
		local317 = local204.method3778();
		local321 = local204.method3780();
		@Pc(661) int local661;
		...
		if (Static139.aClass2_Sub2_Sub4_1 != null && Static692.anInt10375 <= local317 && Static85.anInt10675 + Static692.anInt10375 >= local317 && local321 >= Static493.anInt7364 && Static493.anInt7364 + Static25.anInt598 >= local321) {
			...
			if (local661 != -1) {
				...
				for (local762 = (Class2_Sub2_Sub16) local886.method4737(); local762 != null; local762 = (Class2_Sub2_Sub16) local886.method4736()) {
					if (local661 == local428) {
						Static55.method732(local321, local762, local317);
						break;
					}
					local428++;
				}
		...
		if (!Static236.aBoolean304) {
			...
			if (local661 != -1) {
				...
				for (local762 = (Class2_Sub2_Sub16) local757.method3008(); local762 != null; local762 = (Class2_Sub2_Sub16) local757.method3007()) {
					if (local661 == local428) {
						Static55.method732(local321, local762, local317);
						break;
					}
		...
		for (@Pc(891) Class2_Sub2_Sub4 local891 = (Class2_Sub2_Sub4) local886.method4737(); local891 != null; local891 = (Class2_Sub2_Sub4) local886.method4736()) {
			if (local428 == local661) {
				Static55.method732(local321, (Class2_Sub2_Sub16) local891.aClass192_3.aClass2_Sub2_36.aClass2_Sub2_66, local317);
				Static488.method4579();
				return;
			}
			local428++;
