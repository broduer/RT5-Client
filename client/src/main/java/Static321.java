...
public final class Static321 {
	...
	public static void method3237(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(23) Class2_Sub2_Sub2 local23 = Static440.method4204(18, (long) arg1 << 32 | (long) arg0);
		local23.method133();
	}

	@OriginalMember(owner = "client!kca", name = "a", descriptor = "(IB)Lclient!wca;")
	public static Class396 method3238() {
		return new Class396(1, false);
	}

	@OriginalMember(owner = "client!kca", name = "a", descriptor = "(II)Z")
	public static boolean method3240(@OriginalArg(0) int arg0) {
		for (@Pc(8) Class2_Sub2_Sub16 local8 = (Class2_Sub2_Sub16) Static693.aClass339_79.method5453(65280); local8 != null; local8 = (Class2_Sub2_Sub16) Static693.aClass339_79.method5460()) {
			if (Static598.method5554(local8.anInt7314) && local8.aLong233 == (long) arg0) {
				return true;
			}
		}
		return false;
