...
public final class Static323 {
			...
			for (@Pc(4) int local4 = 0; local4 < Static619.anInt1566; local4++) {
				for (@Pc(7) int local7 = 0; local7 < Static662.anInt9843; local7++) {
					...
					if (local16 != null) {
						...
						if (local21 != null && local21.i(0)) {
							Static535.method5006(local21, local1, local4, local7, 1, 1);
							if (local24 != null && local24.i(0)) {
								Static535.method5006(local24, local1, local4, local7, 1, 1);
								local24.a(0, false, Static665.aClass19_15, 0, (byte) 126, 0, local21);
								local24.j(27811);
							}
							local21.j(27811);
						}
						for (@Pc(76) Class286 local76 = local16.aClass286_2; local76 != null; local76 = local76.aClass286_1) {
							...
							if (local80 != null && local80.i(0)) {
								Static535.method5006(local80, local1, local4, local7, local80.aShort134 + 1 - local80.aShort131, local80.aShort133 - local80.aShort132 + 1);
								local80.j(27811);
							}
						}
						@Pc(120) Class8_Sub2_Sub2 local120 = local16.aClass8_Sub2_Sub2_1;
						if (local120 != null && local120.i(0)) {
							Static453.method4318(local120, local1, local4, local7);
							local120.j(27811);
						}
					}
				}
	...
	public static void method3243() {
		...
		if (Static400.aClass2_Sub34_28 != null) {
			local5 = Static400.aClass2_Sub34_28.aClass57_Sub18_1.method4073();
		}
		@Pc(34) int local34;
		@Pc(51) int local51;
		if (local5 == 2) {
	...
	public static int method3244(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		if (Static246.aClass178Array1 == null) {
			...
			if (arg2 < 0 || arg3 < 0 || Static720.anInt10859 - 1 < arg2 || Static501.anInt7568 - 1 < arg3) {
				...
				return Static246.aClass178Array1[arg1].a(arg0, -119, (int) arg4);
			} else {
				return 0;
			}
		} else {
