...
public final class Static323 {
	...
	public static void method4631() {
		for (@Pc(1) int local1 = Static296.anInt4808; local1 < Static299.anInt4840; local1++) {
			for (@Pc(4) int local4 = 0; local4 < Static619.anInt1573; local4++) {
				for (@Pc(7) int local7 = 0; local7 < Static662.anInt9869; local7++) {
					@Pc(16) Class293 local16 = Static334.aClass293ArrayArrayArray1[local1][local4][local7];
					if (local16 != null) {
	...
	public static void method4632() {
		...
		if (Static400.aClass2_Sub34_28 != null) {
			local5 = Static400.aClass2_Sub34_28.aClass57_Sub18_1.method5774();
		}
		@Pc(34) int local34;
		@Pc(51) int local51;
		if (local5 == 2) {
	...
	public static int method4633(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		if (Static246.aClass178Array1 == null) {
			return 0;
		} else if (arg1 < 3) {
			@Pc(24) int local24 = arg4 >> 9;
			@Pc(28) int local28 = arg0 >> 9;
			if (arg2 < 0 || arg3 < 0 || Static720.anInt10888 - 1 < arg2 || Static501.anInt7591 - 1 < arg3) {
				return 0;
			} else if (local24 >= 1 && local28 >= 1 && local24 <= Static720.anInt10888 - 1 && local28 <= Static501.anInt7591 - 1) {
				...
				return Static246.aClass178Array1[arg1].method7885(arg0, arg4);
			} else {
				return 0;
			}
		} else {
