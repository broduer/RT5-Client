...
public final class Static325 {
	...
	public static int method4864(@OriginalArg(0) Class121 arg0) {
	...
	public static boolean method4866(@OriginalArg(0) D3DPRESENT_PARAMETERS arg0, @OriginalArg(1) int arg1, @OriginalArg(2) IDirect3D arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(1) int local1 = 0;
		@Pc(3) int local3 = 0;
		@Pc(10) int local10 = 0;
		try {
			@Pc(14) D3DDISPLAYMODE local14 = new D3DDISPLAYMODE();
			if (Static731.method4162(arg2.a(arg1, local14), true)) {
				return false;
			}
	...
	public static int method4867(@OriginalArg(1) Class261 arg0) {
		if (arg0 == Static60.aClass261_3) {
			return 2;
		} else if (arg0 == Static363.aClass261_14) {
			return 1;
		} else {
			throw new IllegalArgumentException();
		}
	...
	public static int method4869(@OriginalArg(0) Class168 arg0) {
	...
	public static int method4870(@OriginalArg(1) Class372 arg0) {
		if (arg0 == Static223.aClass372_9) {
			return 1;
		} else if (Static431.aClass372_5 == arg0) {
			return 2;
		} else if (Static104.aClass372_1 == arg0) {
			return 3;
		} else if (Static483.aClass372_7 == arg0) {
			return 4;
		} else if (arg0 == Static450.aClass372_6) {
			return 256;
		} else {
			return 0;
		}
	...
	public static int method4872(@OriginalArg(1) Class131 arg0) {
	...
	public static int method4875(@OriginalArg(0) Class399 arg0, @OriginalArg(1) Class92 arg1) {
		if (Static702.aClass399_16 == arg0) {
