...
public final class Static331 {
	...
	public static void method3444(@OriginalArg(0) boolean arg0, @OriginalArg(1) String arg1) {
		Static263.method2713(arg0, -1, -1, arg1);
	}

	@OriginalMember(owner = "client!ki", name = "a", descriptor = "(B[Lclient!st;)V")
	public static void method3445(@OriginalArg(1) Class23[] arg0) {
		anInt5440 = arg0.length;
		Static186.aClass23Array5 = new Class23[anInt5440 + 10];
		Static460.anIntArray554 = new int[anInt5440 + 10];
		Static734.method5445(arg0, 0, Static186.aClass23Array5, 0, anInt5440);
		for (@Pc(32) int local32 = 0; local32 < anInt5440; local32++) {
			Static460.anIntArray554[local32] = Static186.aClass23Array5[local32].a();
		}
	...
	public static int method3446(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2, @OriginalArg(4) int arg3) {
