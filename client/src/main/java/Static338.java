...
public final class Static338 {
	...
	public static void method3481(@OriginalArg(1) byte[][] arg0, @OriginalArg(2) Class306_Sub1 arg1) {
		...
		for (@Pc(8) int local8 = 0; local8 < local6; local8++) {
			...
			if (local13 != null) {
				...
				arg1.method5589(local26, local36, Static577.aClass110Array1, Static163.aClass19_17, local13);
			}
		}
	}
	...
	public static int method3482() {
		if (Static400.aBoolean622) {
			...
			if (Static466.method4420(local23)) {
				return 1;
			} else if (Static245.method6152(local23)) {
				return 2;
			} else if (Static523.method2482(local23)) {
				return 3;
			} else if (Static598.method5554(local23)) {
				return 4;
			} else if (Static124.method1442(local23)) {
				return 7;
			} else if (local23 == 4) {
				return 8;
			} else {
