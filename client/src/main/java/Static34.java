...
public final class Static34 {
	...
	public static Class267 method884(@OriginalArg(0) int arg0, @OriginalArg(2) byte[] arg1, @OriginalArg(3) Class19_Sub1_Sub2 arg2) {
		...
		return new Class267(arg2, local22, arg0);
	}
	...
	public static boolean method885(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int[] arg3, @OriginalArg(5) int arg4, @OriginalArg(7) int arg5) {
		...
		@Pc(74) int local74;
		@Pc(61) int local61;
		if (Static254.anInt4126 == 1) {
			Static432.anInt527 += local41;
			while (true) {
				local41--;
				if (local41 < 0) {
