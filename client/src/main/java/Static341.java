	...
	public static void method5040(@OriginalArg(0) int arg0) {
		if (arg0 == 0) {
			if (Static32.anInt775 == 2) {
				Static226.aClass46Array7[0].method1105(Static684.aClass304Array1[0]);
				Static226.aClass46Array7[1].method1105(Static684.aClass304Array1[1]);
			} else if (Static32.anInt775 == 3) {
				Static226.aClass46Array7[0].method1105(Static684.aClass304Array1[0]);
				Static226.aClass46Array7[1].method1105(Static684.aClass304Array1[1]);
				Static226.aClass46Array7[2].method1105(Static684.aClass304Array1[2]);
			} else {
				Static226.aClass46Array7[0].method1105(Static684.aClass304Array1[0]);
				Static226.aClass46Array7[1].method1105(Static684.aClass304Array1[1]);
				Static226.aClass46Array7[2].method1105(Static684.aClass304Array1[2]);
				Static226.aClass46Array7[3].method1105(Static684.aClass304Array1[3]);
			}
		} else if (arg0 == 1) {
			if (Static32.anInt775 == 2) {
				Static226.aClass46Array7[0].method1105(Static684.aClass304Array1[2]);
			} else if (Static32.anInt775 == 3) {
				Static226.aClass46Array7[0].method1105(Static684.aClass304Array1[3]);
				Static226.aClass46Array7[1].method1105(Static684.aClass304Array1[4]);
			} else {
				Static226.aClass46Array7[0].method1105(Static684.aClass304Array1[4]);
				Static226.aClass46Array7[1].method1105(Static684.aClass304Array1[5]);
				Static226.aClass46Array7[2].method1105(Static684.aClass304Array1[6]);
			}
		} else if (arg0 == 2) {
			if (Static32.anInt775 == 2) {
				Static226.aClass46Array7[0].method1105(Static684.aClass304Array1[3]);
			...
			if (Static32.anInt775 == 3) {
				Static226.aClass46Array7[0].method1105(Static684.aClass304Array1[5]);
				return;
			}
			Static226.aClass46Array7[0].method1105(Static684.aClass304Array1[7]);
		}
	}
