...
public final class Static344 {
	...
	public static void method3525() {
		Static695.anIntArray868 = Static265.method2715(0.4F);
	}
	...
	public static Class148 method3529(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		@Pc(31) long local31 = (long) arg1 & 0xFFFFL | ((long) arg3 & 0xFFFFL) << 16 | (long) arg2 << 48 & 0xFFFFL << 48 | ((long) arg0 & 0xFFFFL) << 32;
		@Pc(43) Class148 local43 = (Class148) Static123.aClass82_53.method1390(local31);
		if (local43 == null) {
			local43 = Static324.aClass307_1.method4947(Static99.aClass78_1, arg3, arg1, arg0, arg2);
			Static123.aClass82_53.method1384(local43, local31);
		}
		return local43;
	}
}
