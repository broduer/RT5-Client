...
public final class Static345 {
	...
	public static void method3533(@OriginalArg(0) Class19 arg0) {
		if (aClass114_6 != null) {
			return;
		}
		@Pc(8) Class88 local8 = new Class88(580, 1104, 1);
		local8.method1457();
		local8.method1450(0, 128, 0);
		local8.method1450(0, -128, 0);
		for (@Pc(37) int local37 = 0; local37 <= 24; local37++) {
			...
			for (@Pc(54) int local54 = 1; local54 < 24; local54++) {
				...
				local8.method1450(-local75, local67, local83);
			}
			if (local37 > 0) {
				local61 = local37 * 23 + 2;
				local67 = local61 - 23;
				local8.method1451(0, local61, local67, (short) 127, (short) 0, (byte) 0, (byte) 0, (byte) 0);
				for (local75 = 1; local75 < 23; local75++) {
					local83 = local67 + 1;
					@Pc(130) int local130 = local61 + 1;
					local8.method1451(local67, local61, local83, (short) 127, (short) 0, (byte) 0, (byte) 0, (byte) 0);
					local8.method1451(local83, local61, local130, (short) 127, (short) 0, (byte) 0, (byte) 0, (byte) 0);
					local67 = local83;
					local61 = local130;
				}
				local8.method1451(local61, 1, local67, (short) 127, (short) 0, (byte) 0, (byte) 0, (byte) 0);
			}
		}
		...
		aClass114_6 = arg0.a(local8, 51200, 33, 64, 768);
	}

	@OriginalMember(owner = "client!ks", name = "b", descriptor = "(Lclient!ha;)V")
	public static void method3540(@OriginalArg(0) Class19 arg0) {
		if (aClass23_25 != null) {
			return;
		}
		...
		aClass23_25 = arg0.a(128, 128, 128, local7, 0, 7468);
		aClass23_23 = arg0.a(128, 128, 128, local4, 0, 7468);
	}
}
