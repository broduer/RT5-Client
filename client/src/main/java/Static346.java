...
public final class Static346 {
	...
	public static char method3566(@OriginalArg(0) byte arg0) {
	...
	public static void method3567() {
		...
		Static572.anInt8896++;
		Static262.method2697();
		Static161.method1730();
		Static538.method5034();
		@Pc(23) boolean local23 = false;
		@Pc(33) int local33;
		for (@Pc(25) int local25 = 0; local25 < Static78.anInt1622; local25++) {
			local33 = Static118.anIntArray197[local25];
			@Pc(40) Class2_Sub45 local40 = (Class2_Sub45) Static18.aClass28_2.method373((long) local33);
			@Pc(43) Class8_Sub2_Sub1_Sub2_Sub2 local43 = local40.aClass8_Sub2_Sub1_Sub2_Sub2_2;
			if (local43.anInt10751 != Static572.anInt8896) {
				if (Static400.aBoolean622 && Static321.method3240(local33)) {
					Static488.method4579();
				}
				if (local43.aClass268_1.method4220()) {
					Static58.method769(local43);
				}
				local43.method6719((Class268) null);
				local40.a((byte) 86);
				local23 = true;
			}
		}
		...
		for (local33 = 0; local33 < Static390.anInt6126; local33++) {
			if (Static18.aClass28_2.method373((long) Static103.anIntArray187[local33]) == null) {
