	...
	public static void method460() {
		for (@Pc(7) int local7 = 0; local7 < Static33.anInt779; local7++) {
			...
			if (local13.aClass2_Sub6_Sub2_2 == null) {
				local13.anInt2571--;
				if (local13.anInt2571 < (local13.method1616() ? -1500 : -10)) {
					local15 = true;
				} else {
					if (local13.aByte49 == 1 && local13.aClass89_1 == null) {
						local13.aClass89_1 = Static729.method1465(Static281.aClass330_60, local13.anInt2580, 0);
						if (local13.aClass89_1 == null) {
							continue;
						}
						local13.anInt2571 += local13.aClass89_1.method1468();
					} else if (local13.method1616() && (local13.aClass2_Sub53_1 == null || local13.aClass2_Sub49_Sub1_2 == null)) {
						if (local13.aClass2_Sub53_1 == null) {
							local13.aClass2_Sub53_1 = Static650.method6047(Static147.aClass330_26, local13.anInt2580);
						}
						if (local13.aClass2_Sub53_1 == null) {
							continue;
						}
						if (local13.aClass2_Sub49_Sub1_2 == null) {
							local13.aClass2_Sub49_Sub1_2 = local13.aClass2_Sub53_1.method6051(new int[] { 22050 });
							if (local13.aClass2_Sub49_Sub1_2 == null) {
								continue;
							}
						}
					...
					if (local13.anInt2571 < 0) {
						...
						if (local13.anInt2578 == 0) {
							local179 = local13.anInt2577 * (local13.aByte49 == 3 ? Static400.aClass2_Sub34_28.lb.method5049() : Static400.aClass2_Sub34_28.aClass57_Sub25_3.method5049()) >> 2;
						} else {
							...
							if (local188 == Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.aByte144) {
								...
								@Pc(205) int local205 = Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.method6693((byte) 126) << 8;
								...
								local179 = Static400.aClass2_Sub34_28.aClass57_Sub25_1.method5049() * (local199 - local251) * local13.anInt2577 / local199 >> 2;
						...
						if (local179 > 0) {
							...
							if (local13.aByte49 == 1) {
								local392 = local13.aClass89_1.method1467().method5550(Static681.aClass224_2);
							} else if (local13.method1616()) {
								local392 = local13.aClass2_Sub49_Sub1_2;
							}
							@Pc(422) Class2_Sub6_Sub2 local422 = local13.aClass2_Sub6_Sub2_2 = Static730.method2384(local392, local13.anInt2573, local179, local154);
							local422.method2356(local13.anInt2574 - 1);
							Static336.aClass2_Sub6_Sub3_1.method4173(local422);
						}
					}
				}
			} else if (!local13.aClass2_Sub6_Sub2_2.e(-121)) {
				local15 = true;
			}
			if (local15) {
				Static33.anInt779--;
		...
		if (Static501.aBoolean575 && !Static52.method677(126)) {
			if (Static400.aClass2_Sub34_28.aClass57_Sub25_2.method5049() != 0 && Static588.anInt8692 != -1) {
				if (Static8.aClass2_Sub6_Sub1_1 == null) {
					Static611.method5813(Static588.anInt8692, Static400.aClass2_Sub34_28.aClass57_Sub25_2.method5049(), Static398.aClass330_81);
				} else {
					Static273.method2768(Static8.aClass2_Sub6_Sub1_1, Static588.anInt8692, Static398.aClass330_81, Static400.aClass2_Sub34_28.aClass57_Sub25_2.method5049());
				}
			}
			Static8.aClass2_Sub6_Sub1_1 = null;
			Static501.aBoolean575 = false;
		} else if (Static400.aClass2_Sub34_28.aClass57_Sub25_2.method5049() != 0 && Static588.anInt8692 != -1 && !Static52.method677(125)) {
			@Pc(551) Class2_Sub19 local551 = Static293.method3000(Static235.aClass345_49, Static405.aClass153_2.aClass186_1);
			local551.aClass2_Sub21_Sub2_1.method5151(Static588.anInt8692);
			Static405.aClass153_2.method2339(local551);
			Static588.anInt8692 = -1;
		}
	}

	@OriginalMember(owner = "client!bd", name = "a", descriptor = "(Lclient!ge;I)Lclient!lv;")
	public static Class235 method477(@OriginalArg(0) Class2_Sub21 arg0) {
		@Pc(7) int local7 = arg0.method5205();
		@Pc(16) Class403 local16 = Static33.method434()[arg0.method5205()];
		@Pc(25) Class103 local25 = Static313.method3174()[arg0.method5205()];
		@Pc(29) int local29 = arg0.method5165();
		@Pc(33) int local33 = arg0.method5165();
		@Pc(39) int local39 = arg0.method5191();
		@Pc(43) int local43 = arg0.method5191();
		@Pc(49) int local49 = arg0.method5158();
		@Pc(53) int local53 = arg0.method5158();
		@Pc(59) int local59 = arg0.method5158();
		@Pc(69) boolean local69 = arg0.method5205() == 1;
