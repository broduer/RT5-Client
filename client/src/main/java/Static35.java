...
public final class Static35 {
			...
			if (local13.aClass2_Sub6_Sub2_2 == null) {
				...
				if (local13.anInt2580 < (local13.method2418() ? -1500 : -10)) {
					...
					if (local13.aByte49 == 1 && local13.aClass89_1 == null) {
						local13.aClass89_1 = Static729.method2245(Static281.aClass332_60, local13.anInt2589, 0);
						...
						if (local13.aClass2_Sub53_1 == null) {
							local13.aClass2_Sub53_1 = Static650.method8505(Static147.aClass332_26, local13.anInt2589);
						}
						if (local13.aClass2_Sub53_1 == null) {
							continue;
						}
					...
					if (local13.anInt2580 < 0) {
						...
						if (local13.anInt2587 == 0) {
							...
							if (local188 == Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.aByte144) {
								...
								if (local224 != 0 || local243 != 0) {
									@Pc(336) int local336 = -Static323.anInt5136 - (int) (Math.atan2((double) local224, (double) local243) * 2607.5945876176133D) - 4096 & 0x3FFF;
									if (local336 > 8192) {
						...
						if (local179 > 0) {
							...
							@Pc(422) Class2_Sub6_Sub2 local422 = local13.aClass2_Sub6_Sub2_2 = Static730.method3346(local392, local13.anInt2582, local179, local154);
							local422.method3318(local13.anInt2583 - 1);
							Static336.aClass2_Sub6_Sub3_1.method5889(local422);
						}
					}
				}
			} else if (!local13.aClass2_Sub6_Sub2_2.method9465()) {
				local15 = true;
			}
			if (local15) {
				Static33.anInt782--;
		...
		if (Static501.aBoolean575 && !Static52.method1157(126)) {
			if (Static400.aClass2_Sub34_28.aClass57_Sub25_2.method7215() != 0 && Static588.anInt8716 != -1) {
				if (Static8.aClass2_Sub6_Sub1_1 == null) {
					Static611.method8236(Static588.anInt8716, Static400.aClass2_Sub34_28.aClass57_Sub25_2.method7215(), Static398.aClass332_81);
				} else {
					Static273.method3961(Static8.aClass2_Sub6_Sub1_1, Static588.anInt8716, Static398.aClass332_81, Static400.aClass2_Sub34_28.aClass57_Sub25_2.method7215());
				}
			}
			...
			@Pc(551) Class2_Sub19 local551 = Static293.method4342(Static235.aClass347_49, Static405.aClass153_2.aClass186_1);
			local551.aClass2_Sub21_Sub2_1.method7349(Static588.anInt8716);
	...
	public static Class237 method935(@OriginalArg(0) Class2_Sub21 arg0) {
		@Pc(7) int local7 = arg0.method7403();
		@Pc(16) Class405 local16 = Static33.method882()[arg0.method7403()];
		@Pc(25) Class103 local25 = Static313.method4551()[arg0.method7403()];
		@Pc(29) int local29 = arg0.method7363();
		@Pc(33) int local33 = arg0.method7363();
		@Pc(39) int local39 = arg0.method7389();
		@Pc(43) int local43 = arg0.method7389();
		@Pc(49) int local49 = arg0.method7356();
		@Pc(53) int local53 = arg0.method7356();
		@Pc(59) int local59 = arg0.method7356();
		@Pc(69) boolean local69 = arg0.method7403() == 1;
