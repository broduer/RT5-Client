...
public final class Static351 {
	...
	public static void method3604(@OriginalArg(1) int[] arg0, @OriginalArg(2) String[] arg1) {
		Static316.a(arg1, arg0, arg1.length - 1, 0);
	}

	@OriginalMember(owner = "client!laa", name = "a", descriptor = "(Lclient!ha;ILclient!el;ILclient!fu;I)Z")
	public static boolean method3605(@OriginalArg(0) Class19 arg0, @OriginalArg(2) Class105 arg1, @OriginalArg(4) Class2_Sub20 arg2) {
		...
		if (arg1.anInt2596 != -1) {
			if (arg2.aBoolean256 && arg1.anInt2591 != -1) {
				local102 = arg1.method1629(true, arg0);
			} else {
				local102 = arg1.method1629(false, arg0);
			}
			if (local102 != null) {
				local104 = arg2.anInt3130 - (local102.b() + 1 >> 1);
				local106 = arg2.anInt3130 + (local102.b() + 1 >> 1);
				if (local7 > local104) {
					local7 = local104;
				}
				if (local106 > local9) {
				...
				local108 = arg2.anInt3122 - (local102.a() + 1 >> 1);
				if (local11 > local108) {
					local11 = local108;
				}
				local110 = arg2.anInt3122 + (local102.a() + 1 >> 1);
				if (local110 > local13) {
					local13 = local110;
				}
			}
		...
		if (arg1.aString25 != null) {
			local209 = Static390.method3890(arg1.anInt2615);
			if (local209 != null) {
				local211 = Static154.aClass381_6.method6237(Static37.aStringArray5, (int[]) null, (Class23[]) null, arg1.aString25);
				...
				if (local102 == null) {
					local215 -= local211 * local209.method5309() / 2;
				} else {
					local215 -= (local102.a() >> 1) + (local209.method5307() * local211);
				}
				for (local312 = 0; local312 < local211; local312++) {
					...
					@Pc(335) int local335 = local209.method5310(local318);
				...
				local231 = local215;
				local233 = local215 + local211 * local209.method5307();
				if (local11 > local231) {
					local11 = local231;
				}
				if (local233 > local13) {
		...
		Static30.method3553(arg0, arg2, arg1);
		if (local102 != null) {
			if (Static320.anInt5084 > 0 && (Static475.anInt7168 != -1 && arg2.anInt3131 == Static475.anInt7168 || Static409.anInt6318 != -1 && arg1.anInt2597 == Static409.anInt6318)) {
				...
				arg0.a(arg2.anInt3122, local495, arg2.anInt3130, (byte) 86, local102.c() / 2 + 7);
				arg0.a(arg2.anInt3122, local495, arg2.anInt3130, (byte) 86, local102.c() / 2 + 5);
				arg0.a(arg2.anInt3122, local495, arg2.anInt3130, (byte) 86, local102.c() / 2 + 3);
				arg0.a(arg2.anInt3122, local495, arg2.anInt3130, (byte) 86, local102.c() / 2 + 1);
				arg0.a(arg2.anInt3122, local495, arg2.anInt3130, (byte) 86, local102.c() / 2);
			}
			local102.a(arg2.anInt3130 - (local102.b() >> 1), arg2.anInt3122 - (local102.a() >> 1));
		}
		if (arg1.aString25 != null && local209 != null) {
			Static720.method6780(local211, arg2, local213, arg1, local209, local217, arg0, local215);
		}
		if (arg1.anInt2596 != -1 || arg1.aString25 != null) {
			...
			Static551.aClass339_54.method5465(local612);
		}
		return false;
	}
}
