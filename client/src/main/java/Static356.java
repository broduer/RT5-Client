...
public final class Static356 {
	...
	public static final ClientProt aClass347_67 = new ClientProt(23, 1);

	@OriginalMember(owner = "client!le", name = "a", descriptor = "(IJ)V")
	public static void method5203(@OriginalArg(1) long arg0) {
	...
	public static int method5206(@OriginalArg(0) int arg0) {
		@Pc(1) int local1 = -1;
		for (@Pc(3) int local3 = 0; local3 < Static549.anInt9450 - 1; local3++) {
		...
		if (local1 == -1) {
			local1 = Static549.anInt9450 - 1;
		}
		return local1;
	}

	@OriginalMember(owner = "client!le", name = "a", descriptor = "(II)Z")
	public static boolean method5209(@OriginalArg(1) int arg0) {
