...
public final class Static356 {
	...
	public static void method3653(@OriginalArg(1) long arg0) {
		Static260.aCalendar1.setTime(new Date(arg0));
	}

	@OriginalMember(owner = "client!le", name = "b", descriptor = "(I)I")
	public static int method3656(@OriginalArg(0) int arg0) {
		@Pc(1) int local1 = -1;
	...
	public static boolean method3659(@OriginalArg(1) int arg0) {
