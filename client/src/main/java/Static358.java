...
public final class Static358 {
	...
	public static short[] method6602(@OriginalArg(1) int arg0, @OriginalArg(2) short[] arg1) {
		@Pc(14) short[] local14 = new short[arg0];
		Static734.method5446(arg1, 0, local14, 0, arg0);
		return local14;
	}
	...
	public static void method6611() {
		for (@Pc(1) int local1 = 0; local1 < Static319.anInt5080; local1++) {
			if (!Static279.aBooleanArray11[local1]) {
				...
				@Pc(22) int local22 = local13.method5986() - Static247.anInt3993;
				@Pc(30) int local30 = (local22 * 2 >> Static52.anInt1066) + 1;
				@Pc(32) int local32 = 0;
				@Pc(37) int[] local37 = new int[local30 * local30];
				@Pc(45) int local45 = local13.method5980() - local22 >> Static52.anInt1066;
				@Pc(53) int local53 = local13.method5983() - local22 >> Static52.anInt1066;
				@Pc(61) int local61 = local13.method5983() + local22 >> Static52.anInt1066;
				if (local53 < 0) {
					local32 = -local53;
					local53 = 0;
				}
				...
				for (@Pc(78) int local78 = local53; local78 <= local61; local78++) {
					...
					for (@Pc(125) int local125 = local100; local125 <= local108; local125++) {
						...
						@Pc(144) Class8_Sub2_Sub1 local144 = Static578.method5387(local16, local125, local78, aClass28 == null ? (aClass28 = Class222.a("qf")) : aClass28);
				...
				Static246.aClass178Array1[local16].a(local13, local37);
			}
		}
	}
	...
	public static void method6619() {
		...
		try {
			...
			@Pc(31) int local31 = (int) (Static588.method5469() / 86400000L) - 11745;
			@Pc(47) String local47 = "usrdob=" + local31 + "; version=1; path=/; domain=" + local23;
			Static727.method55("document.cookie=\"" + local47 + "\"", Static166.anApplet1);
	...
	public static void method6620() {
		...
		Static458.method4347(Static478.aClass291ArrayArrayArray3);
		if (Static420.aClass291ArrayArrayArray2 != null) {
			Static458.method4347(Static420.aClass291ArrayArrayArray2);
		}
