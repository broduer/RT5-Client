...
public final class Static359 {
	...
	public static int method3681(@OriginalArg(0) int arg0) {
		return arg0 >>> 8;
	}

	@OriginalMember(owner = "client!lfa", name = "a", descriptor = "([III[II[[B[B[[B)I")
	public static int method3682(@OriginalArg(0) int[] arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int[] arg2, @OriginalArg(4) int arg3, @OriginalArg(5) byte[][] arg4, @OriginalArg(6) byte[] arg5, @OriginalArg(7) byte[][] arg6) {
	...
	public static int method3683() {
		return Static372.method3743(false);
	}
}
