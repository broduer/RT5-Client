...
public final class Static36 {
	...
	public static void method519(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		Static101.method1266();
		if (arg1 < 92) {
			return;
		}
		@Pc(16) int local16 = aClass260_1.method4088(arg0).anInt8301;
		if (local16 == 0) {
			return;
		}
	...
	public static int method520(@OriginalArg(0) int arg0) {
		if (arg0 != 3) {
			method519(127, (byte) 11);
		}
	...
	public static Class270 method522(@OriginalArg(1) Class390 arg0, @OriginalArg(2) String arg1, @OriginalArg(3) String arg2, @OriginalArg(4) int arg3) {
		if (arg3 == 0) {
			return arg0.method6427(arg1);
		}
		@Pc(57) Class270 local57;
		if (arg3 == 1) {
			try {
				@Pc(36) Object local36 = Static727.method53(Static166.anApplet1, arg2, new Object[] { (new URL(Static166.anApplet1.getCodeBase(), arg1)).toString() });
				if (local36 == null) {
