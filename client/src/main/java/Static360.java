...
public final class Static360 {
	...
	public static boolean method5237(@OriginalArg(0) int arg0) {
		if (Static5.anInt92 != arg0 || Static178.aClass249_1 == null) {
			Static298.method4392();
			Static5.anInt92 = arg0;
			Static178.aClass249_1 = Static403.aClass249_2;
		}
		@Pc(53) int local53;
		if (Static403.aClass249_2 == Static178.aClass249_1) {
			...
			Static178.aClass249_1 = Static403.aClass249_3;
		}
		if (Static178.aClass249_1 == Static403.aClass249_3) {
			...
			Static178.aClass249_1 = Static403.aClass249_4;
		}
		return true;
	}

	@OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lclient!ca;IZBI)V")
	public static void method5239(@OriginalArg(0) Class8_Sub2_Sub1_Sub2_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(4) int arg2) {
		@Pc(10) int local10 = arg0.anIntArray879[0];
		@Pc(15) int local15 = arg0.anIntArray878[0];
		if (local10 < 0 || local10 >= Static720.anInt10888 || local15 < 0 || Static501.anInt7591 <= local15 || (arg1 < 0 || arg1 >= Static720.anInt10888 || arg2 < 0 || Static501.anInt7591 <= arg2)) {
			return;
		}
		@Pc(76) int local76 = Static521.method6877(arg2, arg0.method9309((byte) 65), true, 0, local10, 0, Static480.anIntArray583, 0, local15, -4, Static577.aClass110Array1[arg0.aByte144], Static70.anIntArray147, arg1, 0);
	...
	public static String method5240(@OriginalArg(1) int arg0) {
		...
		if (local8.length() > 9) {
			return " <col=00ff80>" + local8.substring(0, local8.length() - 8) + Static32.aClass32_33.method877(Static51.anInt1056) + " (" + local8 + ")</col>";
		} else if (local8.length() > 6) {
			return " <col=ffffff>" + local8.substring(0, local8.length() - 4) + Static32.aClass32_35.method877(Static51.anInt1056) + " (" + local8 + ")</col>";
		} else {
