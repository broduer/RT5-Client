...
public final class Static360 {
	...
	public static boolean method3687(@OriginalArg(0) int arg0) {
		if (Static5.anInt92 != arg0 || Static178.aClass247_1 == null) {
			Static298.method3045();
			Static5.anInt92 = arg0;
			Static178.aClass247_1 = Static403.aClass247_2;
		}
		@Pc(53) int local53;
		if (Static403.aClass247_2 == Static178.aClass247_1) {
			@Pc(36) byte[] local36 = Static504.aClass330_95.method5353(arg0);
			if (local36 == null) {
				return false;
			}
			@Pc(46) Class2_Sub21 local46 = new Class2_Sub21(local36);
			Static12.method3631(local46);
			local53 = local46.method5205();
			for (@Pc(55) int local55 = 0; local55 < local53; local55++) {
				Static391.aClass339_34.method5465(new Class2_Sub35(local46));
			}
			@Pc(78) int local78 = local46.method5199();
			...
			@Pc(108) int local108 = local46.method5199();
			...
			@Pc(139) int local139 = local46.method5199();
			...
			@Pc(169) int local169 = local46.method5199();
			...
			@Pc(195) int local195 = local46.method5199();
			Static401.aClass39Array1 = new Class39[local195];
			for (@Pc(200) int local200 = 0; local200 < local195; local200++) {
				Static401.aClass39Array1[local200] = Static235.method2463(local46);
			}
	...
	public static void method3689(@OriginalArg(0) Class8_Sub2_Sub1_Sub2_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(4) int arg2) {
		...
		@Pc(76) int local76 = Static521.method4833(arg2, arg0.method6693((byte) 65), true, 0, local10, 0, Static480.anIntArray583, 0, local15, -4, Static577.aClass110Array1[arg0.aByte144], Static70.anIntArray147, arg1, 0);
		if (local76 >= 1 && local76 <= 3) {
			for (@Pc(92) int local92 = 0; local92 < local76 - 1; local92++) {
				arg0.method872(Static480.anIntArray583[local92], Static70.anIntArray147[local92], (byte) 2);
			}
		}
	}

	@OriginalMember(owner = "client!lg", name = "b", descriptor = "(II)Ljava/lang/String;")
	public static String method3690(@OriginalArg(1) int arg0) {
		...
		if (local8.length() > 9) {
			return " <col=00ff80>" + local8.substring(0, local8.length() - 8) + Static32.aClass32_33.method429(Static51.anInt1052) + " (" + local8 + ")</col>";
		} else if (local8.length() > 6) {
			return " <col=ffffff>" + local8.substring(0, local8.length() - 4) + Static32.aClass32_35.method429(Static51.anInt1052) + " (" + local8 + ")</col>";
		} else {
