...
public final class Static361 {
	...
	public static void method5247() {
		@Pc(5) int local5 = 0;
		for (@Pc(15) int local15 = 0; local15 < Static720.anInt10888; local15++) {
			for (@Pc(18) int local18 = 0; local18 < Static501.anInt7591; local18++) {
				if (Static409.method5663(local18, Static334.aClass293ArrayArrayArray1, local5, local15, true)) {
					local5++;
				}
				if (local5 >= 512) {
					return;
