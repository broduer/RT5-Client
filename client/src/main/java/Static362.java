...
public final class Static362 {
	...
	public static final Class244 aClass244_10 = new Class244("", 19);

	@OriginalMember(owner = "client!lha", name = "j", descriptor = "I")
	public static final int anInt5851 = 1407;

	@OriginalMember(owner = "client!lha", name = "a", descriptor = "(ILjava/lang/String;)Z")
	public static boolean method5248(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1) {
		if (arg1 == null) {
			return false;
		}
		for (@Pc(10) int local10 = arg0; local10 < Static327.anInt5411; local10++) {
