...
public final class Static363 {
	...
	public static void method4338(@OriginalArg(1) String[] arg0) {
		if (arg0.length <= 1) {
		...
		for (@Pc(41) int local41 = 0; local41 < arg0.length; local41++) {
			if (arg0[local41].startsWith("pause")) {
				...
				Static79.method1013("Pausing for " + local61 + " seconds...");
				Static144.aStringArray7 = arg0;
				Static523.anInt3885 = local41 + 1;
				Static305.aLong157 = (long) (local61 * 1000) + Static588.method5469();
				return;
			}
			Static110.aString19 = arg0[local41];
			Static270.method2742(false);
		}
	}

	@OriginalMember(owner = "client!li", name = "a", descriptor = "(III)I")
	public static int method4339(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (Static65.aClass3_1.anInt81 == -1) {
			return 1;
		}
		if (arg1 != Static400.aClass2_Sub34_28.aClass57_Sub29_1.method5612()) {
			Static667.method6202(true, Static32.aClass32_13.method429(Static51.anInt1052), arg1);
			if (arg1 != Static400.aClass2_Sub34_28.aClass57_Sub29_1.method5612()) {
				return -1;
			}
		}
		try {
			...
			Static694.method6464(Static163.aClass19_17, Static32.aClass32_13.method429(Static51.anInt1052), true, Static694.aClass381_13, Static437.aClass14_9);
			@Pc(67) Class88 local67 = Static121.method1430(Static65.aClass3_1.anInt81, Static190.aClass330_38);
			@Pc(70) long local70 = Static588.method5469();
			Static163.aClass19_17.la();
			Static460.aClass73_10.a(0, Static247.anInt3993, 0);
			...
			@Pc(111) Class114 local111 = Static163.aClass19_17.a(local67, 2048, 64, 64, 768);
			...
			label41: for (@Pc(115) int local115 = 0; local115 < 500; local115++) {
				...
				for (@Pc(123) int local123 = 15; local123 >= 0; local123--) {
					for (@Pc(126) int local126 = 0; local126 <= local123; local126++) {
						Static59.aClass73_5.a((int) ((float) Static340.anInt5586 * (-((float) local123 / 2.0F) + (float) local126)), 0, (local123 + 1) * Static340.anInt5586);
						local111.a(Static59.aClass73_5, (Class8_Sub6) null, 0);
						local113++;
						if ((long) arg0 <= Static588.method5469() - local70) {
							break label41;
						}
					}
				}
			}
			Static163.aClass19_17.j();
			@Pc(195) long local195 = (long) (local113 * 1000) / (Static588.method5469() - local70);
			Static163.aClass19_17.GA(0);
			Static163.aClass19_17.ya();
			return (int) local195;
	...
	public static void method4340(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) boolean arg4) {
		...
		if (arg2 == 3 && Static316.aFrame8 == null) {
			Static316.aFrame8 = Static489.method4595(0, Static446.aClass390_6, arg1, arg3);
		...
		if (arg2 == 3 && Static316.aFrame8 == null) {
			method4340(arg0, -1, Static400.aClass2_Sub34_28.aClass57_Sub1_1.method934(), -1, true);
			return;
		}
		...
		if (arg4) {
			...
			if (Static137.aBoolean210) {
				Static575.method5370(Static434.aCanvas7);
			} else {
				Static163.aClass19_17.a(Static434.aCanvas7, Static680.anInt10289, Static380.anInt5979);
			}
		...
		if (Static377.anInt5930 != -1) {
			Static640.method5989(true);
		}
		if (Static405.aClass153_2.aClass348_1 != null && Static109.method1321(Static283.anInt4574)) {
			Static371.method3741();
		}
