...
public final class Static366 {
	...
	public static String method3718(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1) {
	...
	public static boolean method3719(@OriginalArg(0) int arg0) {
		return arg0 == 3 || arg0 == 5 || arg0 == 6;
	}

	@OriginalMember(owner = "client!lja", name = "a", descriptor = "(BI[BI)Ljava/lang/String;")
	public static String method3721(@OriginalArg(1) int arg0, @OriginalArg(2) byte[] arg1, @OriginalArg(3) int arg2) {
