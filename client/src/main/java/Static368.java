...
public final class Static368 {
	...
	public static void method3727(@OriginalArg(0) int arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3) {
		if (arg0 >= arg3) {
			return;
		}
		arg2 += arg0;
	...
	public static void method3729(@OriginalArg(1) Class339 arg0, @OriginalArg(3) Class19 arg1) {
		Static551.aClass339_54.method5454();
		if (Static178.aBoolean251) {
			return;
		}
		for (@Pc(27) Class2_Sub20 local27 = (Class2_Sub20) arg0.method5453(65280); local27 != null; local27 = (Class2_Sub20) arg0.method5460()) {
			@Pc(35) Class105 local35 = Static30.aClass246_3.method3966(local27.anInt3131);
			if (Static408.method3995(local35)) {
				@Pc(47) boolean local47 = Static351.method3605(arg1, local35, local27);
				if (local47) {
					Static603.method5599(local27, arg1, local35);
				}
			}
		}
	}
