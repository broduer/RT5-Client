...
public final class Static369 {
		...
		for (@Pc(13) int local13 = 0; local13 < local11; local13++) {
			if (Static363.aByteArrayArray22[local13] != null) {
				...
				while (Static363.aByteArrayArray22[local13].length > local66.anInt8388 && local68 < 511 && Static390.anInt6126 < 1023) {
					...
					@Pc(94) int local94 = local66.method5191();
					...
					@Pc(142) Class268 local142 = Static690.aClass308_2.method4967(local66.method5191());
					@Pc(149) Class2_Sub45 local149 = (Class2_Sub45) Static18.aClass28_2.method373((long) local88);
					if (local149 == null && (local142.aByte103 & 0x1) > 0 && local98 == Static164.anInt2808 && local121 >= 0 && local142.anInt6713 + local121 < Static720.anInt10859 && local135 >= 0 && local135 + local142.anInt6713 < Static501.anInt7568) {
						...
						Static18.aClass28_2.method370((long) local88, local205);
						...
						local197.method6719(local142);
						local197.method6701(local197.aClass268_1.anInt6713);
						local197.anInt10757 = local197.aClass268_1.lb << 3;
						local197.method6689((local197.aClass268_1.aByte110 + 4 & 0x80600007) << 11, true);
						local197.method6717(true, local135, local121, local98, local197.method6693((byte) 119));
					}
				}
			}
		}
	...
	public static void method2709(@OriginalArg(0) Class19 arg0) {
		if (Static133.aClass339_13.method5455() == 0) {
			return;
		}
		@Pc(31) Class2_Sub36 local31;
		if (Static400.aClass2_Sub34_28.aClass57_Sub29_1.method5612() == 0) {
			for (local31 = (Class2_Sub36) Static133.aClass339_13.method5453(65280); local31 != null; local31 = (Class2_Sub36) Static133.aClass339_13.method5460()) {
				Static419.aClass112_1.method1676(local31.anInt5893, arg0, arg0, local31.aBoolean451 ? Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.aClass201_1 : null, false, local31.anInt5891, local31.anInt5888, false, local31.anInt5890, Static665.aClass14_12, local31.anInt5895);
				local31.a((byte) 52);
			}
		...
		if (Static158.aClass19_5 == null) {
			...
			Static158.aClass19_5 = Static255.method2615(Static124.aClass330_20, Static56.anInterface4_3, 0, local85, 0);
			Static629.aClass14_11 = Static158.aClass19_5.a(Static74.method974(Static662.anInt9845, Static697.aClass330_123), Static735.method6764(Static721.aClass330_128, Static662.anInt9845), true);
		}
		for (local31 = (Class2_Sub36) Static133.aClass339_13.method5453(65280); local31 != null; local31 = (Class2_Sub36) Static133.aClass339_13.method5460()) {
			Static419.aClass112_1.method1676(local31.anInt5893, Static158.aClass19_5, arg0, local31.aBoolean451 ? Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.aClass201_1 : null, false, local31.anInt5891, local31.anInt5888, false, local31.anInt5890, Static629.aClass14_11, local31.anInt5895);
			local31.a((byte) 93);
		}
	}
	...
	public static void method2710() {
		if (Static265.aByteArray44 != null) {
			Static292.method3233();
		} else if (Static129.anInt2409 == -1) {
			Static616.method5857(Static59.aString63, Static449.aString75);
		} else {
			Static695.method6680();
		}
	}
}
