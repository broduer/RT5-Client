...
public final class Static372 {
	...
	public static final ClientProt aClass347_69 = new ClientProt(20, 8);

	@OriginalMember(owner = "client!ln", name = "l", descriptor = "[Lclient!fk;")
	public static final Node_Sub19[] aClass2_Sub19Array1 = new Node_Sub19[300];

	@OriginalMember(owner = "client!ln", name = "a", descriptor = "(III)I")
	public static int method5297(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public static int method5298(@OriginalArg(0) boolean arg0) {
		if (Static552.anIntArray753 == null) {
			...
			for (@Pc(31) int local31 = 0; local31 < Static552.anIntArray753.length; local31++) {
				...
				if (Static555.aClass332_106.method7588(local36)) {
					local29++;
				}
				if (Static237.aClass332_87.method7588(local36)) {
					local29++;
				}
			}
			return local29;
	...
	public static int method5299(@OriginalArg(0) int arg0, @OriginalArg(1) Class158 arg1) {
		if (!Static84.method1661(arg1).isButtonEnabled(arg0) && arg1.anObjectArray15 == null) {
			return -1;
