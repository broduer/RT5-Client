...
public final class Static372 {
	...
	public static int method3742(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public static int method3743(@OriginalArg(0) boolean arg0) {
		if (Static552.anIntArray753 == null) {
			...
			for (@Pc(31) int local31 = 0; local31 < Static552.anIntArray753.length; local31++) {
				...
				if (Static555.aClass330_106.method5345(local36)) {
					local29++;
				}
				if (Static237.aClass330_87.method5345(local36)) {
					local29++;
				}
			}
			return local29;
	...
	public static int method3744(@OriginalArg(0) int arg0, @OriginalArg(1) Class158 arg1) {
		if (!Static84.method1081(arg1).method4325(arg0) && arg1.anObjectArray15 == null) {
			return -1;
