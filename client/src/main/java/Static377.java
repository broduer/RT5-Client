...
public final class Static377 {
	...
	public static byte[] method3773(@OriginalArg(1) boolean arg0, @OriginalArg(2) Object arg1) {
		if (arg1 == null) {
			return null;
		} else if (arg1 instanceof byte[]) {
			@Pc(14) byte[] local14 = (byte[]) arg1;
			return arg0 ? Static163.method6315(local14) : local14;
		} else if (arg1 instanceof Class175) {
			@Pc(29) Class175 local29 = (Class175) arg1;
			return local29.method2708();
		} else {
