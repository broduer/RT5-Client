...
public final class Static38 {
	...
	public static void method538(@OriginalArg(1) int arg0, @OriginalArg(2) long arg1, @OriginalArg(3) int arg2) {
		...
		if (local10 != 10 && local10 != 11 && local10 != 22) {
			Static147.method1617(local17, arg2, 0, true, arg0, 0, local10, 0);
			return;
		}
		@Pc(62) Class54 local62 = Static354.aClass142_4.method2158(local29, 63);
		@Pc(75) int local75;
		@Pc(78) int local78;
		...
		Static147.method1617(0, arg2, local78, true, arg0, local88, 0, local75);
	}

	@OriginalMember(owner = "client!bea", name = "a", descriptor = "(IZ)J")
	public static long method540(@OriginalArg(0) int arg0) {
