...
public final class Static383 {
	...
	public static boolean method3821(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub21_Sub2 arg1) {
		@Pc(18) int local18 = arg1.method5221(2);
		@Pc(45) int local45;
		@Pc(50) int local50;
		@Pc(127) int local127;
		@Pc(131) int local131;
		@Pc(137) int local137;
		if (local18 == 0) {
			if (arg1.method5221(1) != 0) {
				method3821(arg0, arg1);
			}
			local45 = arg1.method5221(6);
			local50 = arg1.method5221(6);
			@Pc(63) boolean local63 = arg1.method5221(1) == 1;
			if (local63) {
			...
			if (Static462.aClass2_Sub21Array1[arg0] != null) {
				local99.method874(Static462.aClass2_Sub21Array1[arg0]);
			}
			local99.method6689(local91.anInt9326, true);
			...
			if (Static441.method4209(local161, local149)) {
				local99.aByte143++;
			}
			local99.method873(local149, local161);
			local99.aBoolean127 = false;
			Static246.aClass350Array1[arg0] = null;
			return true;
		} else if (local18 == 1) {
			local45 = arg1.method5221(2);
	...
	public static boolean method3823(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		return (arg1 & 0x800) != 0 | Static555.method5121(arg1, arg0) || Static519.method4815(0xFFFFFF9F ^ 0x5, arg1, arg0);
	}
}
