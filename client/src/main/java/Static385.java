...
public final class Static385 {
	...
	public static void method3832(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		...
		if (arg4 < Static724.anInt10930) {
			...
			Static696.method6473(arg3, arg2, arg1, Static723.anIntArrayArray266[arg4++]);
		}
		if (Static273.anInt4395 < arg0) {
			arg0 = Static273.anInt4395;
		} else {
			Static696.method6473(arg3, arg2, arg1, Static723.anIntArrayArray266[arg0--]);
		}
		@Pc(140) int local140;
		if (local31 && local70) {
	...
	public static boolean method3833() {
		if (Static98.aBoolean191) {
			try {
				if ((Boolean) Static727.method54("showingVideoAd", Static166.anApplet1)) {
					return false;
				}
				return true;
	...
	public static void method3836(@OriginalArg(0) Class2_Sub2_Sub4 arg0) {
		@Pc(5) boolean local5 = false;
		arg0.method6674();
		for (@Pc(21) Class2_Sub2_Sub4 local21 = (Class2_Sub2_Sub4) Static350.aClass192_8.method3017(); local21 != null; local21 = (Class2_Sub2_Sub4) Static350.aClass192_8.method3015()) {
			if (Static546.method5081(arg0.method917(), local21.method917())) {
				local5 = true;
				Static409.method4010(local21, arg0);
				break;
			}
		}
		if (!local5) {
			Static350.aClass192_8.method3013(arg0);
		}
	}
}
