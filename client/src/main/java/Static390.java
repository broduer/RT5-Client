...
public final class Static390 {
	...
	public static String method3889(@OriginalArg(1) String arg0) {
		if (arg0 == null) {
			return null;
		}
		@Pc(10) int local10 = 0;
		@Pc(13) int local13 = arg0.length();
		while (local10 < local13 && Static19.method148(arg0.charAt(local10))) {
			local10++;
		}
		while (local10 < local13 && Static19.method148(arg0.charAt(local13 - 1))) {
			local13--;
		}
		...
		for (@Pc(77) int local77 = local10; local77 < local13; local77++) {
			...
			if (Static540.method4588(local82)) {
				@Pc(90) char local90 = Static146.method1611(local82);
				if (local90 != '\u0000') {
	...
	public static Class327 method3890(@OriginalArg(1) int arg0) {
		if (arg0 == 0) {
	...
	public static int method3891(@OriginalArg(1) boolean arg0, @OriginalArg(2) int arg1, @OriginalArg(4) int arg2) {
		@Pc(18) Class2_Sub22 local18 = Static556.method5127(arg2, false);
		if (local18 == null) {
			return 0;
		}
		@Pc(25) int local25 = 0;
		for (@Pc(27) int local27 = 0; local27 < local18.anIntArray278.length; local27++) {
			if (local18.anIntArray278[local27] >= 0 && local18.anIntArray278[local27] < Static419.aClass112_1.anInt2670) {
				@Pc(54) Class382 local54 = Static419.aClass112_1.method1684(local18.anIntArray278[local27]);
				@Pc(64) int local64 = local54.method6281(arg1, Static386.aClass49_2.method681(arg1).anInt7509);
				if (arg0) {
	...
	public static boolean method3892(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		return Static483.method4552(arg1, arg0) | (arg0 & 0x60000) != 0 || Static198.method2062(arg0, arg1) || Static319.method3217(arg0, arg1);
	}
}
