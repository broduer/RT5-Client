...
public final class Static393 {
	...
	public static void method5516(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(3) Class158 arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		for (@Pc(10) int local10 = 7; local10 >= 0; local10--) {
			for (@Pc(16) int local16 = 127; local16 >= 0; local16--) {
				...
				arg0.aa(arg3 + (arg2.anInt3813 * local16 >> 7), arg4 + ((-local10 + 7) * arg2.anInt3756 >> 3), (arg2.anInt3813 >> 7) + 1, (arg2.anInt3756 >> 3) - -1, local44, 0);
			}
		}
		anInt6167++;
	}
