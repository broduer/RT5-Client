...
public final class Static394 {
	...
	public static float method3930(@OriginalArg(1) float arg0, @OriginalArg(2) float arg1, @OriginalArg(3) int arg2, @OriginalArg(4) float arg3, @OriginalArg(5) float arg4, @OriginalArg(6) float arg5, @OriginalArg(7) float arg6) {
		...
		while (local7 < 1.1F) {
			...
			if (local70 > 0 && local75 > 0 && Static720.anInt10859 > local70 && local75 < Static501.anInt7568) {
				...
				@Pc(135) int local135 = Static706.aClass178Array3[local104].a((int) local65, -113, (int) (int) local53);
				if (local59 > (float) local135) {
					if (arg2 < 2) {
						return local7;
					}
					return method3930(local39, local65, arg2 - 1, local43, local59, local41, local53) * 0.1F + local7 - 0.1F;
				}
			}
			local43 = local65;
			local41 = local59;
	...
	public static void method3931(@OriginalArg(1) int arg0, @OriginalArg(2) String arg1) {
		@Pc(9) Class2_Sub2_Sub2 local9 = Static440.method4204(2, (long) arg0);
		local9.method130();
