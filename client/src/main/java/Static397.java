...
public final class Static397 {
	...
	public static void method3936(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) byte[] arg5) {
		if (arg3 > 0 && !Static700.method6579(arg3)) {
			throw new IllegalArgumentException("");
		} else if (arg4 <= 0 || Static700.method6579(arg4)) {
			@Pc(35) int local35 = Static646.method6012(arg2);
			@Pc(37) int local37 = 0;
	...
	public static void method3938(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) float[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(10) int arg9) {
	...
	public static void method3939(@OriginalArg(1) int arg0, @OriginalArg(2) Class8_Sub2_Sub1_Sub2 arg1, @OriginalArg(4) Class8_Sub2_Sub1_Sub2 arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6) {
		@Pc(7) int local7 = arg2.method6695((byte) -71);
		if (local7 == -1) {
			return;
		}
		@Pc(27) Class23 local27 = (Class23) Static541.aClass82_174.method1390((long) local7);
		if (local27 == null) {
			@Pc(34) Class407[] local34 = Static735.method6764(Static721.aClass330_128, local7);
			if (local34 == null) {
				return;
			}
			local27 = Static163.aClass19_17.a(local34[0], true);
			Static541.aClass82_174.method1384(local27, (long) local7);
		}
		Static418.method5569(arg1.aByte144, arg1.anInt10694, 0, arg1.anInt10690, arg1.method6693((byte) 55) * 256);
		...
		local27.a(local83, local102);
		if (arg2 == arg1) {
			Static163.aClass19_17.a(local102 - 1, -256, 18, (int) 18, (byte) 93, local83 - 1);
		}
		Static682.method6378(local102 - 1, local102 - -18, local83 - 1, local83 - -18);
		@Pc(140) Class8_Sub1 local140 = Static192.method1981();
		...
		Static149.aClass130_4.method1902(local140);
	}
}
