...
public final class Static397 {
	...
	public static void method5561(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) byte[] arg5) {
		if (arg3 > 0 && !Static700.method9157(arg3)) {
			throw new IllegalArgumentException("");
		} else if (arg4 <= 0 || Static700.method9157(arg4)) {
			@Pc(35) int local35 = Static646.method8465(arg2);
			@Pc(37) int local37 = 0;
	...
	public static void method5563(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) float[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(10) int arg9) {
	...
	public static void method5564(@OriginalArg(1) int arg0, @OriginalArg(2) Class8_Sub2_Sub1_Sub2 arg1, @OriginalArg(4) Class8_Sub2_Sub1_Sub2 arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6) {
		@Pc(7) int local7 = arg2.method9311((byte) -71);
		if (local7 == -1) {
			return;
		}
		...
		local27.method8209(local83, local102);
		if (arg2 == arg1) {
			Static163.aClass19_17.method7952(local102 - 1, -256, 18, 18, local83 - 1);
		}
		Static682.method8934(local102 - 1, local102 - -18, local83 - 1, local83 - -18);
