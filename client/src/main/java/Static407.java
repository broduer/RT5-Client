...
public final class Static407 {
	...
	public static boolean method3988(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return false;
	}

	@OriginalMember(owner = "client!mr", name = "a", descriptor = "(B)V")
	public static void method3989() {
		@Pc(16) Class2_Sub9 local16 = (Class2_Sub9) Static226.aClass339_58.method5453(65280);
		@Pc(30) boolean local30 = Static109.aClass158_3 != null || Static460.anInt6964 > 0;
		@Pc(34) int local34 = local16.method3778();
		@Pc(38) int local38 = local16.method3780();
		if (local30) {
		...
		if (local30) {
			...
			Static55.method732(local38, Static470.aClass2_Sub2_Sub16_10, local34);
		}
	}
}
