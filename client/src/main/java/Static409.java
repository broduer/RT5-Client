...
public final class Static409 {
	...
	public static boolean method5663(@OriginalArg(1) int arg0, @OriginalArg(2) Class293[][][] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) boolean arg4) {
		@Pc(21) byte local21 = arg4 ? 1 : (byte) (Static198.anInt3285 & 0xFF);
		if (Static328.aByteArrayArrayArray4[Static394.anInt6196][arg3][arg0] == local21) {
			return false;
		} else if ((Static280.aByteArrayArrayArray3[Static394.anInt6196][arg3][arg0] & 0x4) == 0) {
			return false;
		} else {
			...
			Static328.aByteArrayArrayArray4[Static394.anInt6196][arg3][arg0] = local21;
			while (local58 != local61) {
				...
				if ((Static280.aByteArrayArrayArray3[Static394.anInt6196][local78][local100] & 0x4) == 0) {
					local116 = true;
				}
					...
					label237: for (local139 = Static394.anInt6196 + 1; local139 <= 3; local139++) {
						if (arg1[local139] != null && (Static280.aByteArrayArrayArray3[local139][local78][local100] & 0x8) == 0) {
							...
							if (local116 && arg1[local139][local78][local100] != null) {
								...
								if (local331.aClass288_2 != null) {
									for (local337 = local331.aClass288_2; local337 != null; local337 = local337.aClass288_1) {
										local341 = local337.aClass8_Sub2_Sub1_1;
										if (local341 instanceof Interface25) {
											@Pc(347) Interface25 local347 = (Interface25) local341;
											local351 = local347.method6865();
											@Pc(355) int local355 = local347.method6862(23796);
											if (local351 == 21) {
												local351 = 19;
											}
							...
							local331 = arg1[local139][local78][local100];
							if (local331 != null && local331.aClass288_2 != null) {
								for (local337 = local331.aClass288_2; local337 != null; local337 = local337.aClass288_1) {
									local341 = local337.aClass8_Sub2_Sub1_1;
				...
				if (local133) {
					local139 = Static246.aClass178Array1[Static394.anInt6196 + 1].method7876(local100, local78);
				...
				if (!local116) {
					if (local78 >= 1 && local21 != Static328.aByteArrayArrayArray4[Static394.anInt6196][local78 - 1][local100]) {
						Static278.anIntArray351[local61] = 0xD3000000 | 0x120000 | local78 - 1;
						Static98.anIntArray176[local61] = local100 | 0x130000;
						Static328.aByteArrayArrayArray4[Static394.anInt6196][local78 - 1][local100] = local21;
						local61 = local61 + 1 & 0xFFF;
					}
					local100++;
					if (local100 < Static501.anInt7591) {
						if (local78 - 1 >= 0 && local21 != Static328.aByteArrayArrayArray4[Static394.anInt6196][local78 - 1][local100] && (Static280.aByteArrayArrayArray3[Static394.anInt6196][local78][local100] & 0x4) == 0 && (Static280.aByteArrayArrayArray3[Static394.anInt6196][local78 - 1][local100 - 1] & 0x4) == 0) {
							Static278.anIntArray351[local61] = local78 - 1 | 0x120000 | 0x52000000;
							Static98.anIntArray176[local61] = local100 | 0x130000;
							local61 = local61 + 1 & 0xFFF;
							Static328.aByteArrayArrayArray4[Static394.anInt6196][local78 - 1][local100] = local21;
						}
						if (local21 != Static328.aByteArrayArrayArray4[Static394.anInt6196][local78][local100]) {
							Static278.anIntArray351[local61] = 0x13000000 | 0x520000 | local78;
							Static98.anIntArray176[local61] = local100 | 0x530000;
							Static328.aByteArrayArrayArray4[Static394.anInt6196][local78][local100] = local21;
							local61 = local61 + 1 & 0xFFF;
						}
						if (Static720.anInt10888 > local78 + 1 && local21 != Static328.aByteArrayArrayArray4[Static394.anInt6196][local78 + 1][local100] && (Static280.aByteArrayArrayArray3[Static394.anInt6196][local78][local100] & 0x4) == 0 && (Static280.aByteArrayArrayArray3[Static394.anInt6196][local78 + 1][local100 - 1] & 0x4) == 0) {
					...
					local100--;
					if (local78 + 1 < Static720.anInt10888 && Static328.aByteArrayArrayArray4[Static394.anInt6196][local78 + 1][local100] != local21) {
					...
					local100--;
					if (local100 >= 0) {
						if (local78 - 1 >= 0 && Static328.aByteArrayArrayArray4[Static394.anInt6196][local78 - 1][local100] != local21 && (Static280.aByteArrayArrayArray3[Static394.anInt6196][local78][local100] & 0x4) == 0 && (Static280.aByteArrayArrayArray3[Static394.anInt6196][local78 - 1][local100 + 1] & 0x4) == 0) {
							Static278.anIntArray351[local61] = local78 - 1 | 0xD20000 | 0x12000000;
							Static98.anIntArray176[local61] = local100 | 0xD30000;
							local61 = local61 + 1 & 0xFFF;
							Static328.aByteArrayArrayArray4[Static394.anInt6196][local78 - 1][local100] = local21;
						}
						if (Static328.aByteArrayArrayArray4[Static394.anInt6196][local78][local100] != local21) {
							Static278.anIntArray351[local61] = 0x93000000 | 0xD20000 | local78;
							Static98.anIntArray176[local61] = local100 | 0xD30000;
							Static328.aByteArrayArrayArray4[Static394.anInt6196][local78][local100] = local21;
							local61 = local61 + 1 & 0xFFF;
						}
						if (local78 + 1 < Static720.anInt10888 && Static328.aByteArrayArrayArray4[Static394.anInt6196][local78 + 1][local100] != local21 && (Static280.aByteArrayArrayArray3[Static394.anInt6196][local78][local100] & 0x4) == 0 && (Static280.aByteArrayArrayArray3[Static394.anInt6196][local78 + 1][local100 + 1] & 0x4) == 0) {
	...
	public static void setWindowMode(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) boolean arg2, @OriginalArg(4) int arg3) {
		...
		if (!Static163.aClass19_17.method7990()) {
			arg2 = true;
		}
		Static363.method6243(local10, arg3, arg0, arg1, arg2);
	}

	@OriginalMember(owner = "client!mt", name = "a", descriptor = "(IIIBII)V")
	public static void method5665(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		...
		if (local13 == 0) {
			...
			Static297.method4378(arg4, arg1, arg2, arg0);
		} else {
			if (local13 < 0) {
				local13 = -local13;
			}
