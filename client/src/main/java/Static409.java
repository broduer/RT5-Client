...
public final class Static409 {
	...
	public static void method4010(@OriginalArg(1) Class2_Sub2 arg0, @OriginalArg(2) Class2_Sub2 arg1) {
	...
	public static boolean method4012(@OriginalArg(1) int arg0, @OriginalArg(2) Class291[][][] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) boolean arg4) {
		...
		if (Static328.aByteArrayArrayArray4[Static394.anInt6176][arg3][arg0] == local21) {
			...
			while (local58 != local61) {
						...
						if (arg1[local139] != null && (Static280.aByteArrayArrayArray3[local139][local78][local100] & 0x8) == 0) {
							...
							if (local116 && arg1[local139][local78][local100] != null) {
								if (arg1[local139][local78][local100].aClass8_Sub2_Sub3_2 != null) {
									local185 = Static239.method2507(local86);
									...
									if (local94 != 0) {
										local235 = Static239.method2507(local94);
									...
									if (local108 != 0) {
										local235 = Static239.method2507(local108);
								...
								if (local331.aClass286_2 != null) {
									for (local337 = local331.aClass286_2; local337 != null; local337 = local337.aClass286_1) {
										...
										if (local341 instanceof Interface25) {
											...
											local351 = local347.method4821();
											@Pc(355) int local355 = local347.method4818(23796);
											if (local351 == 21) {
												local351 = 19;
											}
				...
				if (local133) {
					local139 = Static246.aClass178Array1[Static394.anInt6176 + 1].a(local100, local78, (byte) -118);
	...
	public static void method4013(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) boolean arg2, @OriginalArg(4) int arg3) {
		Static498.method4675();
		Static297.aLong153 = 0L;
		@Pc(10) int local10 = Static36.method520(3);
		if (arg0 == 3 || local10 == 3) {
			arg2 = true;
		}
		if (!Static163.aClass19_17.b()) {
			arg2 = true;
		}
		Static363.method4340(local10, arg3, arg0, arg1, arg2);
	}

	@OriginalMember(owner = "client!mt", name = "a", descriptor = "(IIIBII)V")
	public static void method4014(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		@Pc(8) int local8 = arg3 - arg4;
		@Pc(13) int local13 = arg1 - arg0;
		if (local13 == 0) {
			if (local8 != 0) {
				Static87.method1107(arg3, arg4, arg2, arg0);
			}
		} else if (local8 == 0) {
			Static297.method3036(arg4, arg1, arg2, arg0);
		} else {
			if (local13 < 0) {
				local13 = -local13;
			}
