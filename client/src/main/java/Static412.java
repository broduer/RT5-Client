...
public final class Static412 {
	...
	public static void method4025(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		if (arg4 - arg1 >= Static180.anInt2995 && arg1 + arg4 <= Static111.anInt2219 && Static724.anInt10930 <= arg3 - arg1 && arg1 + arg3 <= Static273.anInt4395) {
			Static123.method1434(arg2, arg5, arg3, arg1, arg4, arg0);
		} else {
			Static51.method671(arg0, arg5, arg2, arg4, arg1, arg3);
		}
	}
	...
	public static void method4026() {
		...
		for (@Pc(13) int local13 = 0; local13 < Static419.aClass112_1.anInt2670; local13++) {
			@Pc(20) Class382 local20 = Static419.aClass112_1.method1684(local13);
