...
public final class Static417 {
	...
	public static int anInt6420 = -60;

	@OriginalMember(owner = "client!nd", name = "a", descriptor = "(II[BIBII)Z")
	public static boolean method5730(@OriginalArg(1) int arg0, @OriginalArg(2) byte[] arg1, @OriginalArg(3) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4) {
