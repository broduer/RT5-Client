...
public final class Static418 {
	...
	public static void method5569(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(6) int arg4) {
		...
		@Pc(58) int local58 = Static102.method1286(arg0, -29754, arg1, arg3) - arg2;
		if (Static137.aBoolean210) {
			Static713.method6722(true);
		} else {
			Static460.aClass73_10.b(arg4, 0, 0);
	...
	public static void method5571(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		@Pc(10) int local10 = arg0 - arg2;
		@Pc(15) int local15 = arg1 - arg4;
		if (local10 == 0) {
			if (local15 != 0) {
				Static591.method5501(arg2, arg3, arg4, arg1);
			}
		} else if (local15 == 0) {
			Static289.method2882(arg0, arg4, arg3, arg2);
		} else {
			...
			Static409.method4014(local113, local81, arg3, local79, local115);
		}
	}
}
