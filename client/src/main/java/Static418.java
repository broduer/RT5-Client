...
public final class Static418 {
	...
	public static void method7867(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(6) int arg4) {
		if (arg3 < 512 || arg1 < 512 || Static720.anInt10888 * 512 - 1024 < arg3 || Static501.anInt7591 * 512 - 1024 < arg1) {
		...
		if (Static137.aBoolean210) {
			Static713.method9338(true);
		} else {
			Static460.aClass73_10.method7141(arg4, 0, 0);
			Static163.aClass19_17.method8007(Static460.aClass73_10);
		}
		if (Static504.aBoolean579) {
			Static163.aClass19_17.HA(arg3, local58, arg1, Static582.anInt8651, Static215.anIntArray284);
		} else {
	...
	public static void method7869(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		@Pc(10) int local10 = arg0 - arg2;
		@Pc(15) int local15 = arg1 - arg4;
		if (local10 == 0) {
			if (local15 != 0) {
				Static591.method7764(arg2, arg3, arg4, arg1);
			}
		} else if (local15 == 0) {
			Static289.method4191(arg0, arg4, arg3, arg2);
		} else {
			@Pc(53) int local53 = (local15 << 12) / local10;
			@Pc(62) int local62 = arg4 - (arg2 * local53 >> 12);
			@Pc(81) int local81;
			@Pc(79) int local79;
			if (arg0 < Static180.anInt3004) {
				local79 = (local53 * Static180.anInt3004 >> 12) + local62;
				local81 = Static180.anInt3004;
			} else if (arg0 > Static111.anInt2228) {
				local79 = local62 + (Static111.anInt2228 * local53 >> 12);
				local81 = Static111.anInt2228;
			} else {
				local79 = arg1;
				local81 = arg0;
			}
			@Pc(113) int local113;
			@Pc(115) int local115;
			if (arg2 < Static180.anInt3004) {
				local113 = Static180.anInt3004;
				local115 = local62 + (Static180.anInt3004 * local53 >> 12);
			} else if (Static111.anInt2228 >= arg2) {
				local113 = arg2;
				local115 = arg4;
			} else {
				local115 = local62 + (local53 * Static111.anInt2228 >> 12);
				local113 = Static111.anInt2228;
			}
			if (Static724.anInt10959 > local79) {
				local79 = Static724.anInt10959;
				local81 = (Static724.anInt10959 - local62 << 12) / local53;
			} else if (Static273.anInt4408 < local79) {
				local81 = (Static273.anInt4408 - local62 << 12) / local53;
				local79 = Static273.anInt4408;
			}
			if (local115 < Static724.anInt10959) {
				local113 = (Static724.anInt10959 - local62 << 12) / local53;
				local115 = Static724.anInt10959;
			} else if (Static273.anInt4408 < local115) {
				local113 = (Static273.anInt4408 - local62 << 12) / local53;
				local115 = Static273.anInt4408;
			}
			Static409.method5665(local113, local81, arg3, local79, local115);
		}
	}
}
