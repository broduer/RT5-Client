...
public final class Static426 {
	...
	public static void method553(@OriginalArg(1) String arg0) {
		System.exit(1);
	}

	@OriginalMember(owner = "client!nha", name = "a", descriptor = "(IIBIII)Z")
	public static boolean method554(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
	...
	public static Class2_Sub6_Sub1 method555() {
