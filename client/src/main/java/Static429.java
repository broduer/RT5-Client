...
public final class Static429 {
	...
	public static final ClientProt aClass347_81 = new ClientProt(90, -1);
	...
	public static int method5810() {
		return Static37.anInt922++;
	}

	@OriginalMember(owner = "client!nj", name = "a", descriptor = "(ILclient!s;)V")
	public static void method5812(@OriginalArg(0) int arg0, @OriginalArg(1) Class178 arg1) {
