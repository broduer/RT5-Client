...
public final class Static430 {
	...
	public static void method4121(@OriginalArg(1) int[][] arg0) {
		Static723.anIntArrayArray266 = arg0;
	}

	@OriginalMember(owner = "client!nja", name = "a", descriptor = "(IBLjava/lang/String;)Z")
	public static boolean method4123(@OriginalArg(0) int arg0, @OriginalArg(2) String arg1) {
	...
	public static void method4124() throws Exception_Sub1 {
		if (Static448.anInt6796 == 1) {
			Static74.aClass19_4.e(Static2.anInt45, Static312.anInt5001);
		} else {
			Static74.aClass19_4.e(0, 0);
		}
	}

	@OriginalMember(owner = "client!nja", name = "a", descriptor = "(Ljava/lang/String;II)V")
	public static void method4125(@OriginalArg(0) String arg0, @OriginalArg(2) int arg1) {
		@Pc(10) Class153 local10 = Static668.method6208();
		@Pc(16) Class2_Sub19 local16 = Static293.method3000(Static425.aClass345_80, local10.aClass186_1);
		local16.aClass2_Sub21_Sub2_1.method5198(Static231.method2417(arg0) + 1);
		local16.aClass2_Sub21_Sub2_1.method5200(arg0);
		local16.aClass2_Sub21_Sub2_1.method5150(arg1);
		local10.method2339(local16);
	}
}
