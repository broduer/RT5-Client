...
public final class Static431 {
	...
	public static void method5829(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9, @OriginalArg(11) int arg10) {
		if (!Static571.method7573(arg7)) {
			return;
		}
	...
	public static void method5834(@OriginalArg(0) Class69 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class8_Sub2 arg2) {
		if (Static33.anInt782 >= 50 || (arg0 == null || arg0.anIntArrayArray38 == null || arg0.anIntArrayArray38.length <= arg1 || arg0.anIntArrayArray38[arg1] == null)) {
			return;
		}
		...
		} else if (Static400.aClass2_Sub34_28.aClass57_Sub25_1.method7215() != 0) {
			@Pc(184) int local184 = arg2.anInt10718 - 256 >> 9;
			@Pc(191) int local191 = arg2.anInt10722 - 256 >> 9;
			@Pc(212) int local212 = arg2 == Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2 ? 0 : local93 + (local191 << 8) + (local184 << 16) + (arg2.aByte144 << 24);
			Static409.aClass104Array1[Static33.anInt782++] = new Class104((byte) (arg0.aBoolean141 ? 2 : 1), local55, local61, 0, local134, local212, local80, arg2);
		}
	}
}
