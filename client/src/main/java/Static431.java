...
public final class Static431 {
	...
	public static void method4128(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9, @OriginalArg(11) int arg10) {
		if (!Static571.method5330(arg7)) {
			return;
		}
		if (Static148.aClass158ArrayArray1[arg7] == null) {
			Static84.method1089(Static453.aClass158ArrayArray2[arg7], -1, arg10, arg2, arg5, arg0, arg6, arg1, arg8, arg3, arg9, arg4);
		} else {
			Static84.method1089(Static148.aClass158ArrayArray1[arg7], -1, arg10, arg2, arg5, arg0, arg6, arg1, arg8, arg3, arg9, arg4);
		}
	}

	@OriginalMember(owner = "client!nk", name = "a", descriptor = "(Lclient!cka;ILclient!eo;B)V")
	public static void method4133(@OriginalArg(0) Class69 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class8_Sub2 arg2) {
		...
		if (local93 == 0) {
			if (arg2 == Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2) {
				if (!arg0.aBoolean141) {
					Static161.method1728(local80, 0, local55, local61, local134);
					return;
				}
				Static186.method1933(local55, local61, local80, 0, local134, false);
			}
		} else if (Static400.aClass2_Sub34_28.aClass57_Sub25_1.method5049() != 0) {
