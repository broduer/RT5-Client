	...
	public static void method5862() {
		...
		for (local55 = (local28 - (Static720.anInt10888 >> 4)) / 8; local55 <= ((Static720.anInt10888 >> 4) + local28) / 8; local55++) {
			for (@Pc(137) int local137 = (local32 - (Static501.anInt7591 >> 4)) / 8; local137 <= (local32 + (Static501.anInt7591 >> 4)) / 8; local137++) {
				...
				Static267.anIntArray329[local46] = Static93.aClass332_16.method7597("m" + local55 + "_" + local137);
				Static266.anIntArray615[local46] = Static93.aClass332_16.method7597("l" + local55 + "_" + local137);
				Static68.anIntArray316[local46] = Static93.aClass332_16.method7597("um" + local55 + "_" + local137);
				Static298.anIntArray367[local46] = Static93.aClass332_16.method7597("ul" + local55 + "_" + local137);
				local46++;
			}
		}
