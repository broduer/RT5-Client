...
public final class Static434 {
	...
	public static int method4154(@OriginalArg(0) int arg0) {
		@Pc(5) int local5 = 0;
	...
	public static boolean method4155(@OriginalArg(0) int arg0, @OriginalArg(1) Class110 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(11) int arg10) {
						...
						do {
							label259: do {
								...
								if (arg4 == -4) {
									...
									if (Static275.method2781(arg7, arg9, local5, arg3, arg10, local7, arg8, arg9)) {
										Static407.anInt6285 = local7;
										Static594.anInt8775 = local5;
										return true;
									}
								} else if (arg4 == -2) {
									if (arg1.method1658(arg9, arg8, arg9, local5, arg7, arg6, arg10, local7, arg3)) {
										Static407.anInt6285 = local7;
										Static594.anInt8775 = local5;
										return true;
									}
								} else if (arg4 == -1) {
									if (arg1.method1662(arg8, arg6, arg7, local5, arg9, arg10, arg3, local7)) {
										Static407.anInt6285 = local7;
										Static594.anInt8775 = local5;
										return true;
									}
								} else if (arg4 == 0 || arg4 == 1 || arg4 == 2 || arg4 == 3 || arg4 == 9) {
									if (arg1.method1663(arg9, arg4, arg8, local7, local5, arg7, arg0)) {
										Static407.anInt6285 = local7;
										Static594.anInt8775 = local5;
										return true;
									}
								} else if (arg1.method1656(local5, arg4, arg7, arg8, arg0, local7, arg9)) {
									Static407.anInt6285 = local7;
									Static594.anInt8775 = local5;
									return true;
								}
	...
	public static void method4156() {
		...
		@Pc(12) int local12 = local8.method5210();
		@Pc(24) boolean local24 = local8.method5205() == 1;
		@Pc(28) int local28 = local8.method5181();
		@Pc(32) int local32 = local8.method5191();
		Static165.method1749();
		Static342.method3100(local12);
		...
		for (@Pc(52) int local52 = 0; local52 < local46; local52++) {
			for (local55 = 0; local55 < 4; local55++) {
				Static22.anIntArrayArray11[local52][local55] = local8.method5158();
			}
		}
		...
		for (local55 = (local28 - (Static720.anInt10859 >> 4)) / 8; local55 <= ((Static720.anInt10859 >> 4) + local28) / 8; local55++) {
			for (@Pc(137) int local137 = (local32 - (Static501.anInt7568 >> 4)) / 8; local137 <= (local32 + (Static501.anInt7568 >> 4)) / 8; local137++) {
				...
				Static267.anIntArray329[local46] = Static93.aClass330_16.method5354("m" + local55 + "_" + local137);
				Static266.anIntArray615[local46] = Static93.aClass330_16.method5354("l" + local55 + "_" + local137);
				Static68.anIntArray316[local46] = Static93.aClass330_16.method5354("um" + local55 + "_" + local137);
				Static298.anIntArray367[local46] = Static93.aClass330_16.method5354("ul" + local55 + "_" + local137);
				local46++;
			}
		}
		Static684.method6382(local24, local28, 12, local32);
	}
}
