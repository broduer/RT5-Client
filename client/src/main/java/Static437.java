...
public final class Static437 {
	...
	public static void method4181(@OriginalArg(1) Class2_Sub21_Sub2 arg0) {
		...
		arg0.method5151(local10.anInt10366);
		for (@Pc(105) int local105 = 0; local105 < local10.anInt10364; local105++) {
			if (local10.anIntArray829[local105] == 0) {
				try {
					...
					if (local130 == 3) {
						...
						if (local283 == null) {
							...
							arg0.method5198(1);
							arg0.method5172(((Number) local283).longValue());
						} else if (local283 instanceof String) {
							arg0.method5198(2);
							arg0.method5200((String) local283);
						} else {
							arg0.method5198(4);
						}
					} else if (local130 == 4) {
				...
				arg0.method5198(local10.anIntArray829[local105]);
			}
		}
		arg0.method5162(local98);
		if (-2 == -2) {
			local10.a((byte) 66);
		}
	}
	...
	public static boolean method4183(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		return (arg2 & 0x70000) != 0 | Static646.method6011(arg1, arg2) || Static598.method5557(arg2, arg1);
	}
}
