...
public final class Static440 {
	...
	public static int method4203(@OriginalArg(0) int arg0) {
	...
	public static Class2_Sub2_Sub2 method4204(@OriginalArg(1) int arg0, @OriginalArg(2) long arg1) {
		@Pc(21) Class2_Sub2_Sub2 local21 = (Class2_Sub2_Sub2) Static658.aClass28_43.method373(arg1 | (long) arg0 << 56);
		if (local21 == null) {
			local21 = new Class2_Sub2_Sub2(arg0, arg1);
			Static658.aClass28_43.method370(local21.aLong328, local21);
		}
		return local21;
	}

	@OriginalMember(owner = "client!nt", name = "a", descriptor = "(ILclient!dea;)V")
	public static void method4205(@OriginalArg(1) Class2_Sub6 arg0) {
		if (arg0.aClass2_Sub49_6 != null) {
			arg0.aClass2_Sub49_6.anInt8817 = 0;
		}
		arg0.aBoolean793 = false;
		for (@Pc(25) Class2_Sub6 local25 = arg0.method6562(); local25 != null; local25 = arg0.method6564()) {
			method4205(local25);
		}
	}
}
