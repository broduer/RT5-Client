...
public final class Static441 {
	...
	public static void method4207(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) Object[] arg3) {
		if (arg1 >= arg0) {
			return;
		}
		...
		method4207(local18 - 1, arg1, arg2, arg3);
		method4207(arg0, local18 + 1, arg2, arg3);
	}

	@OriginalMember(owner = "client!nu", name = "a", descriptor = "(ILclient!cg;)V")
	public static void method4208(@OriginalArg(1) Class8_Sub2_Sub1_Sub2 arg0) {
		@Pc(9) int local9 = arg0.anInt10759 - Static333.anInt5455;
		@Pc(20) int local20 = arg0.anInt10750 * 512 + arg0.method6693((byte) 99) * 256;
		@Pc(32) int local32 = arg0.anInt10753 * 512 + arg0.method6693((byte) 58) * 256;
	...
	public static boolean method4209(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
