...
public final class Static46 {
	...
	public static int method617(@OriginalArg(2) int arg0) {
		@Pc(13) Class2_Sub22 local13 = Static556.method5127(arg0, false);
		if (local13 == null) {
			return Static503.aClass335_1.method5411(arg0).anInt2072;
		}
		@Pc(24) int local24 = 0;
		...
		return local24 + Static503.aClass335_1.method5411(arg0).anInt2072 - local13.anIntArray278.length;
	}

	@OriginalMember(owner = "client!bja", name = "a", descriptor = "(I)V")
	public static void method619() {
		for (@Pc(8) Class2_Sub5 local8 = (Class2_Sub5) Static106.aClass28_11.method371(); local8 != null; local8 = (Class2_Sub5) Static106.aClass28_11.method375()) {
			Static121.method1428(local8.anInt182);
		}
	}
}
