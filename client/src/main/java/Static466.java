...
public final class Static466 {
	...
	public static void method4416(@OriginalArg(0) Class8_Sub2_Sub1_Sub2 arg0) {
		if (arg0 instanceof Class8_Sub2_Sub1_Sub2_Sub2) {
			...
			if (local5.aClass268_1 != null) {
				Static651.method6066(Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.aByte144 != local5.aByte144, local5);
			}
			...
			Static414.method4029(local33.aByte144 != Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.aByte144, local33);
		}
	}

	@OriginalMember(owner = "client!om", name = "a", descriptor = "(Z)I")
	public static int method4417() {
	...
	public static void method4418(@OriginalArg(0) byte arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) boolean arg10, @OriginalArg(12) int arg11, @OriginalArg(13) int[] arg12, @OriginalArg(14) byte[][][] arg13, @OriginalArg(15) int[] arg14, @OriginalArg(16) int arg15) {
		...
		if (!Static75.aBoolean521) {
			...
			if (local152 >= 0 && local159 >= 0 && Static571.anInt8534 >= local163 && local167 <= Static576.anInt8585 || Static448.anInt6796 == 2) {
				...
				@Pc(465) int local465;
				for (@Pc(456) Class8_Sub7 local456 = (Class8_Sub7) local451.method1905(); local456 != null; local456 = (Class8_Sub7) local451.method1900()) {
					...
					if (local463) {
						local456.a();
						Static281.method2842(local456);
					}
				}
				if (Static448.anInt6796 == 0) {
					Static74.aClass19_4.a(Static450.anInterface9_1);
				}
				Static74.aClass19_4.F(-local250, -local252);
				Static74.aClass19_4.b(local340, local386, local338, local393, local258);
				Static278.method2823(Static643.aDouble23 + local258);
				...
				Static119.method1404(Static10.aClass213_1);
				if (local395 > 0) {
					...
					Static283.method2850(arg7, arg1, arg3, arg2, arg13, arg9, arg12, arg5, arg14, arg6, arg8, arg0, arg15, arg4, arg10, arg11, 1, false);
				}
				if (local342 > 0) {
				...
				Static102.method1282();
				if (Static448.anInt6796 == 0) {
					Static74.aClass19_4.v();
				}
				...
				if (Static448.anInt6796 == 1) {
					...
					for (@Pc(855) int local855 = 0; local855 < Static617.anInt9434; local855++) {
						@Pc(868) int local868 = Static719.method6552(Static482.anInt7265 + local855, 16939, Static617.anInt9434) * Static211.anInt5574;
						for (local465 = 0; local465 < Static211.anInt5574; local465++) {
							@Pc(881) int local881 = Static719.method6552(local465 + Static632.anInt9503, 16939, Static211.anInt5574) + local868;
							...
							Static651.anInterface9Array1[local881].a(local465 * Static437.anInt6628, Static714.anInt10802 * local855, Static437.anInt6628, Static714.anInt10802, 0, 0, local936, true);
						}
					}
				}
			} else {
		...
		if (Static75.aBoolean521) {
			...
			Static74.aClass19_4.ya();
			Static74.aClass19_4.GA(Static551.anInt8289);
			Static420.aClass73_7.a(Static354.anInt5763, Static149.anInt2623, Static9.anInt121, Static693.anInt10382, Static138.anInt2512, Static49.anInt1045);
			Static74.aClass19_4.a(Static420.aClass73_7);
			if (Static448.anInt6796 == 1) {
			...
			Static10.aClass213_1.method3497();
			Static119.method1404(Static10.aClass213_1);
			Static283.method2850(arg7, arg1, arg3, arg2, arg13, arg9, arg12, arg5, arg14, arg6, arg8, arg0, arg15, arg4, arg10, arg11, 1, false);
			Static102.method1282();
			...
			if (Static448.anInt6796 == 1) {
				Static181.method1896();
			}
		}
		if (Static448.anInt6796 == 0) {
			Static450.anInterface9_1.b(Static2.anInt45, Static312.anInt5001, Static252.anInt4078, Static281.anInt4566, 0, 0, true, true);
		}
		Static420.anInt6436++;
		Static278.method2823(Static643.aDouble23);
		...
		Static283.method2850(arg7, arg1, arg3, arg2, arg13, arg9, arg12, arg5, arg14, arg6, arg8, arg0, arg15, arg4, arg10, arg11, Static448.anInt6796 == 2 ? 0 : 2, Static448.anInt6796 == 1);
		Static74.aClass19_4.la();
	...
	public static void method4419() {
		...
		@Pc(12) int local12 = local8.method5191();
		@Pc(16) int local16 = local8.method5205();
		@Pc(28) boolean local28 = local8.method5185() == 1;
		Static117.anInt2282 = local8.method5185();
		@Pc(36) int local36 = local8.method5181();
		Static165.method1749();
		Static342.method3100(local16);
		local8.method5226();
		@Pc(50) int local50;
		@Pc(54) int local54;
		@Pc(61) int local61;
		for (@Pc(46) int local46 = 0; local46 < 4; local46++) {
			for (local50 = 0; local50 < Static720.anInt10859 >> 3; local50++) {
				for (local54 = 0; local54 < Static501.anInt7568 >> 3; local54++) {
					local61 = local8.method5221(1);
					if (local61 == 1) {
						Static623.anIntArrayArrayArray19[local46][local50][local54] = local8.method5221(26);
					} else {
		...
		for (local54 = 0; local54 < local50; local54++) {
			for (local61 = 0; local61 < 4; local61++) {
				Static22.anIntArrayArray11[local54][local61] = local8.method5158();
			}
		}
				...
				for (@Pc(225) int local225 = 0; local225 < Static501.anInt7568 >> 3; local225++) {
					...
					if (local235 != -1) {
						...
						if (local261 != -1) {
							...
							Static267.anIntArray329[local50] = Static93.aClass330_16.method5354("m" + local299 + "_" + local303);
							Static266.anIntArray615[local50] = Static93.aClass330_16.method5354("l" + local299 + "_" + local303);
							Static68.anIntArray316[local50] = Static93.aClass330_16.method5354("um" + local299 + "_" + local303);
							Static298.anIntArray367[local50] = Static93.aClass330_16.method5354("ul" + local299 + "_" + local303);
							local50++;
						}
					}
				}
		...
		Static684.method6382(local28, local36, 12, local12);
	}

	@OriginalMember(owner = "client!om", name = "a", descriptor = "(IB)Z")
	public static boolean method4420(@OriginalArg(0) int arg0) {
