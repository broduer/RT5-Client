...
public final class Static467 {
	...
	public static boolean method4439(@OriginalArg(1) String arg0) {
		return Static702.method6596(arg0);
	}

	@OriginalMember(owner = "client!oo", name = "a", descriptor = "(III)Lclient!pba;")
	public static Class286 method4440(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
