...
public final class Static475 {
	...
	public static boolean method4512(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		return Static407.method3988(arg0, arg1) & Static230.method2410(arg1, arg0);
	}

	@OriginalMember(owner = "client!pa", name = "a", descriptor = "(IB)Z")
	public static boolean method4514(@OriginalArg(0) int arg0) {
