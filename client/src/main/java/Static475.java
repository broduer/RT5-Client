...
public final class Static475 {
	...
	public static int anInt7189 = -1;

	@OriginalMember(owner = "client!pa", name = "a", descriptor = "(III)Z")
	public static boolean method6450(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		return Static407.method5634(arg0, arg1) & Static230.method3372(arg1, arg0);
	}

	@OriginalMember(owner = "client!pa", name = "a", descriptor = "(IB)Z")
	public static boolean method6452(@OriginalArg(0) int arg0) {
