...
public final class Static48 {
	...
	public static int method630(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
	...
	public static Class2_Sub2_Sub10 method632(@OriginalArg(0) byte[] arg0) {
		...
		@Pc(23) int local23 = local12.method5191();
		@Pc(34) int local34 = local12.aByteArray93.length - local23 - 2 - 16;
		local12.anInt8388 = local34;
		@Pc(50) int local50 = local12.method5158();
		local7.anInt2948 = local12.method5191();
		local7.anInt2950 = local12.method5191();
		local7.anInt2949 = local12.method5191();
		local7.anInt2951 = local12.method5191();
		local7.anInt2953 = local12.method5191();
		local7.anInt2954 = local12.method5191();
		@Pc(84) int local84 = local12.method5205();
		@Pc(95) int local95;
		@Pc(100) int local100;
		if (local84 > 0) {
			local7.aClass28Array1 = new Class28[local84];
			for (local95 = 0; local95 < local84; local95++) {
				local100 = local12.method5191();
				@Pc(107) Class28 local107 = new Class28(Static440.method4203(local100));
				local7.aClass28Array1[local95] = local107;
				while (local100-- > 0) {
					@Pc(117) int local117 = local12.method5158();
					@Pc(121) int local121 = local12.method5158();
					local107.method370((long) local117, new Class2_Sub38(local121));
				}
			}
		}
		local12.anInt8388 = 0;
		local7.aString31 = local12.method5212();
		...
		while (local12.anInt8388 < local34) {
			...
			if (local100 == 3) {
				...
				local7.aStringArray14[local95] = local12.method5167().intern();
			} else if (local100 == 54) {
				if (local7.aLongArray4 == null) {
					local7.aLongArray4 = new long[local50];
				}
				local7.aLongArray4[local95] = local12.method5207();
			} else {
				if (local7.anIntArray255 == null) {
					local7.anIntArray255 = new int[local50];
				}
				if (local100 >= 150 || local100 == 21 || local100 == 38 || local100 == 39) {
					local7.anIntArray255[local95] = local12.method5205();
				} else {
					local7.anIntArray255[local95] = local12.method5158();
				}
			}
	...
	public static Class2_Sub6_Sub1 method635(@OriginalArg(0) Class2_Sub6_Sub1 arg0) {
