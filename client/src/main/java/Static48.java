...
public final class Static48 {
	...
	public static SecondaryNode_Sub10 method1097(@OriginalArg(0) byte[] arg0) {
		@Pc(7) SecondaryNode_Sub10 local7 = new SecondaryNode_Sub10();
		...
		local7.anInt2957 = local12.g2();
		local7.anInt2959 = local12.g2();
		local7.anInt2958 = local12.g2();
		local7.anInt2960 = local12.g2();
		local7.anInt2962 = local12.g2();
		local7.anInt2963 = local12.g2();
		@Pc(84) int local84 = local12.g1();
		@Pc(95) int local95;
		@Pc(100) int local100;
		if (local84 > 0) {
			local7.aClass28Array1 = new HashTable[local84];
			for (local95 = 0; local95 < local84; local95++) {
				local100 = local12.g2();
				@Pc(107) HashTable local107 = new HashTable(Static440.method5969(local100));
				local7.aClass28Array1[local95] = local107;
				while (local100-- > 0) {
					@Pc(117) int local117 = local12.g4();
					@Pc(121) int local121 = local12.g4();
					local107.put(local117, new Node_Sub38(local121));
				}
			}
		}
		local12.pos = 0;
		...
		while (local12.pos < local34) {
			...
			if (local100 == 3) {
				...
				local7.aStringArray14[local95] = local12.gstr().intern();
			} else if (local100 == 54) {
