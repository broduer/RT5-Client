...
public final class Static480 {
	...
	public static void method4535(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(7) int arg5) {
		if (arg0 > 0 && !Static700.method6579(arg0)) {
	...
	public static void method4537(@OriginalArg(1) Class2_Sub21 arg0, @OriginalArg(2) Class390 arg1, @OriginalArg(3) int arg2) {
		@Pc(23) Class2_Sub57 local23 = new Class2_Sub57();
		local23.anInt10364 = arg0.method5205();
		local23.anInt10366 = arg0.method5158();
		...
		Static631.aClass339_78.method5465(local23);
	}

	@OriginalMember(owner = "client!pca", name = "c", descriptor = "(B)V")
	public static void method4538() {
		Static74.aClass19_4.a(Static712.aClass73_11);
