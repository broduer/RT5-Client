...
public final class Static482 {
	...
	public static void method6488(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(12) int local12 = Static400.aClass2_Sub34_28.aClass57_Sub25_2.method7215() * arg0 >> 8;
		if (local12 == 0 || arg1 == -1) {
			return;
		}
		...
		Static611.method8236(arg1, local12, client.js5Archive11);
