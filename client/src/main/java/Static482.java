...
public final class Static482 {
	...
	public static void method4545(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(12) int local12 = Static400.aClass2_Sub34_28.aClass57_Sub25_2.method5049() * arg0 >> 8;
		if (local12 == 0 || arg1 == -1) {
			return;
		}
		if (!Static501.aBoolean575 && Static588.anInt8692 != -1 && Static52.method677(0x6E ^ 0x11) && !Static203.method2165()) {
			Static8.aClass2_Sub6_Sub1_1 = Static426.method555();
			@Pc(52) Class2_Sub6_Sub1 local52 = Static48.method635(Static8.aClass2_Sub6_Sub1_1);
			Static697.method6554(local52);
		}
		Static611.method5813(arg1, local12, Static340.aClass330_69);
