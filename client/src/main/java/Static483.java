...
public final class Static483 {
	...
	public static final Class372 aClass372_7 = new Class372();

	@OriginalMember(owner = "client!pe", name = "a", descriptor = "(IIB)Z")
	public static boolean method6495(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return (arg1 & 0x10) != 0;
	}

	@OriginalMember(owner = "client!pe", name = "c", descriptor = "(I)V")
	public static void method6497(@OriginalArg(0) int arg0) {
		Static684.anInt10332 = arg0;
	}

	@OriginalMember(owner = "client!pe", name = "a", descriptor = "(I[BIBII)V")
	public static void method6498(@OriginalArg(0) int arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(5) int arg3) {
		if (arg3 >= arg0) {
			return;
		}
		arg2 += arg3;
