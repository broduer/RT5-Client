...
public final class Static484 {
	...
	public static boolean method4556(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1) {
		...
		for (@Pc(19) int local19 = local9; local19 < local9 + 104; local19++) {
			for (@Pc(22) int local22 = local15; local22 < local15 + 104; local22++) {
				for (local25 = arg1; local25 <= 3; local25++) {
					if (Static696.method6472(local22, arg1, local19, local25)) {
						local37 = local25;
						if (Static441.method4209(local22, local19)) {
							local37 = local25 - 1;
						}
						if (local37 >= 0) {
							local17 &= Static561.method5238(local19, local22, local37);
						}
					}
				}
			}
		...
		Static12.aClass23_26 = arg0.a(512, 512, 512, local95, 0, 7468);
				...
				for (local278 = arg1; local278 <= 3; local278++) {
					for (local281 = 0; local281 <= Static200.anInt3302; local281++) {
						for (local284 = 0; local284 <= Static200.anInt3302; local284++) {
							local206[local281][local284] = Static696.method6472(local284 + local229, arg1, local218 + local281, local278);
						}
					}
					Static706.aClass178Array3[local278].a(0, 0, 1024, local218, local229, local238, local249, local206);
					if (!Static113.aBoolean198) {
						for (local284 = -4; local284 < Static200.anInt3302; local284++) {
							for (local331 = -4; local331 < Static200.anInt3302; local331++) {
								...
								if (local9 <= local336 && local340 >= local15 && Static696.method6472(local340, arg1, local336, local278)) {
									local365 = local278;
									if (Static441.method4209(local340, local336)) {
										local365 = local278 - 1;
									}
									if (local365 >= 0) {
										Static185.method1929(arg0, local37, local336, local340, local214 + local284 * 4, (-local331 + Static200.anInt3302) * 4 + local216 + -4, local365, local177);
									}
								}
							}
						}
					...
					for (local284 = 0; local284 < Static200.anInt3302; local284++) {
						for (local331 = 0; local331 < Static200.anInt3302; local331++) {
							...
							if ((local365 & 0x40240000) != 0) {
								arg0.a(4, 4, (Static200.anInt3302 - local331) * 4 + local216 - 4, (byte) 116, (int) (local214 + local284 * 4), -1713569622);
							} else if ((local365 & 0x800000) != 0) {
								arg0.a((Static200.anInt3302 - local331) * 4 + local216 - 4, -1713569622, local214 + local284 * 4, false, 4);
							} else if ((local365 & 0x2000000) != 0) {
								arg0.a(4, local216 + (Static200.anInt3302 - local331) * 4 - 4, -1713569622, (int) (local284 * 4 + local214 + 3), 2);
							} else if ((local365 & 0x8000000) != 0) {
								arg0.a((Static200.anInt3302 - local331) * 4 + local216 + 3 - 4, -1713569622, local284 * 4 + local214, false, 4);
							} else if ((local365 & 0x20000000) != 0) {
								arg0.a(4, (Static200.anInt3302 - local331) * 4 + local216 - 4, -1713569622, (int) (local284 * 4 + local214), 2);
							}
						}
					}
				}
				arg0.aa(local214, local216, Static200.anInt3302 * 4, Static200.anInt3302 * 4, local196, 2);
				Static12.aClass23_26.a((local208 - local9) * 4 + 48, -(Static200.anInt3302 * 4) + -((local211 + -local15) * 4) + 464, Static200.anInt3302 * 4, Static200.anInt3302 * 4, local214, local216);
			}
		}
		arg0.la();
		arg0.GA(-16777215);
		...
		Static612.aClass339_67.method5454();
		if (!Static113.aBoolean198) {
			for (local211 = local9; local211 < local9 + 104; local211++) {
				for (local214 = local15; local214 < local15 + 104; local214++) {
					for (local216 = arg1; local216 <= arg1 + 1 && local216 <= 3; local216++) {
						if (Static696.method6472(local214, arg1, local211, local216)) {
							@Pc(730) Interface25 local730 = (Interface25) Static687.method6405(local216, local211, local214);
							if (local730 == null) {
								local730 = (Interface25) Static578.method5387(local216, local211, local214, aClass19 == null ? (aClass19 = Class8_Sub7.a("uv")) : aClass19);
							}
							if (local730 == null) {
								local730 = (Interface25) Static302.method3069(local216, local211, local214);
							}
							if (local730 == null) {
								local730 = (Interface25) Static114.method1368(local216, local211, local214);
							}
							if (local730 != null) {
								@Pc(776) Class54 local776 = Static354.aClass142_4.method2158(local730.method4822(-32136), 100);
								if (!local776.aBoolean95 || Static174.aBoolean249) {
									...
									if (local776.anIntArray113 != null) {
										for (local249 = 0; local249 < local776.anIntArray113.length; local249++) {
											if (local776.anIntArray113[local249] != -1) {
												@Pc(808) Class54 local808 = Static354.aClass142_4.method2158(local776.anIntArray113[local249], 87);
									...
									if (local238 >= 0) {
										...
										if (local238 >= 0) {
											@Pc(842) Class105 local842 = Static577.aClass246_4.method3966(local238);
			...
			if (Static42.aClass255_2 != null) {
				...
				Static577.aClass246_4.method3965(1024, 64);
				for (local214 = 0; local214 < Static42.aClass255_2.anInt6373; local214++) {
					...
					if (Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.aByte144 == local216 >> 28) {
						...
						if (local218 >= 0 && local218 < Static720.anInt10859 && local229 >= 0 && local229 < Static501.anInt7568) {
							Static612.aClass339_67.method5465(new Class2_Sub38(local214));
						} else {
							@Pc(1199) Class105 local1199 = Static577.aClass246_4.method3966(Static42.aClass255_2.anIntArray496[local214]);
				...
				Static577.aClass246_4.method3965(128, 64);
				Static6.aClass330_1.anInt8555 = 2;
				Static6.aClass330_1.method5356();
			}
		}
		return true;
	}
