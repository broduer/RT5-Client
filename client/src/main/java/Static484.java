					...
					for (local284 = 0; local284 < Static200.anInt3311; local284++) {
						for (local331 = 0; local331 < Static200.anInt3311; local331++) {
							...
							if ((local365 & 0x40240000) != 0) {
								arg0.method7978(4, 4, (Static200.anInt3311 - local331) * 4 + local216 - 4, local214 + local284 * 4, 0x99DD00AA);
							} else if ((local365 & 0x800000) != 0) {
								arg0.method7998((Static200.anInt3311 - local331) * 4 + local216 - 4, 0x99DD00AA, local214 + local284 * 4, 4);
							} else if ((local365 & 0x2000000) != 0) {
								arg0.method8005(4, local216 + (-local331 + Static200.anInt3311) * 4 - 4, 0x99DD00AA, local284 * 4 + local214 + 3);
							} else if ((local365 & 0x8000000) != 0) {
								arg0.method7998((Static200.anInt3311 - local331) * 4 + local216 + 3 - 4, 0x99DD00AA, local284 * 4 + local214, 4);
							} else if ((local365 & 0x20000000) != 0) {
								arg0.method8005(4, (Static200.anInt3311 - local331) * 4 + local216 - 4, 0x99DD00AA, local284 * 4 + local214);
							}
						}
					}
				}
