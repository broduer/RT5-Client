...
public final class Static488 {
	...
	public static int method4578(@OriginalArg(0) Class121 arg0) {
	...
	public static void method4579() {
		...
		Static585.method5424(Static682.anInt10295, Static71.anInt1576, Static407.anInt6288, Static84.anInt1775);
	}

	@OriginalMember(owner = "client!pga", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/Class;")
	public static Class method4581(@OriginalArg(0) String arg0) throws ClassNotFoundException {
		if (arg0.equals("B")) {
			return Byte.TYPE;
	...
	public static Class2_Sub2_Sub10 method4582(@OriginalArg(0) int arg0) {
		@Pc(10) Class2_Sub2_Sub10 local10 = (Class2_Sub2_Sub10) Static480.aClass361_2.method5906((long) arg0);
		if (local10 != null) {
			return local10;
		}
		@Pc(21) byte[] local21 = Static31.aClass330_6.method5359(0, arg0);
		if (local21 == null || local21.length <= 1) {
			return null;
		}
		try {
			local10 = Static48.method632(local21);
		} catch (@Pc(38) Exception local38) {
			throw new RuntimeException(local38.getMessage() + " S: " + arg0);
		}
		Static480.aClass361_2.method5905(local10, (long) arg0);
		return local10;
	}
}
