...
public final class Static488 {
	...
	public static int method6528(@OriginalArg(0) Class121 arg0) {
	...
	public static void method6529() {
		...
		Static585.method7677(Static682.anInt10323, Static71.anInt1583, Static407.anInt6308, Static84.anInt1783);
	}

	@OriginalMember(owner = "client!pga", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/Class;")
	public static Class method6531(@OriginalArg(0) String arg0) throws ClassNotFoundException {
		if (arg0.equals("B")) {
			return Byte.TYPE;
	...
	public static Class2_Sub2_Sub10 method6532(@OriginalArg(0) int arg0) {
		@Pc(10) Class2_Sub2_Sub10 local10 = (Class2_Sub2_Sub10) Static480.aClass363_2.method8349((long) arg0);
		if (local10 != null) {
			return local10;
		}
		...
		Static480.aClass363_2.method8348(local10, (long) arg0);
		return local10;
	}
}
