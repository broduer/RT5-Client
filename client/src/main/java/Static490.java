...
public final class Static490 {
	...
	public static int[][] method4603(@OriginalArg(8) float arg0) {
		...
		local11.anInt8810 = 4;
		local11.anInt8803 = 3;
		local11.method6800(7);
		Static132.method1516(256, 64);
		for (@Pc(48) int local48 = 0; local48 < 256; local48++) {
			local11.method5543(local48, local7[local48]);
		}
		return local7;
	}

	@OriginalMember(owner = "client!pha", name = "a", descriptor = "(ZII)I")
	public static int method4605(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
