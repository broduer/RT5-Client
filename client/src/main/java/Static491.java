...
public final class Static491 {
	...
	public static final Class227 aClass227_253 = new Class227(142, 0);

	@OriginalMember(owner = "client!pi", name = "e", descriptor = "Lclient!lga;")
	public static final Class227 aClass227_254 = new Class227(103, 2);
	...
	public static void method9166(@OriginalArg(0) Class19_Sub3 arg0) {
		@Pc(12) byte[] local12;
		if (Static599.anObject14 == null) {
			@Pc(5) Class35_Sub2_Sub2 local5 = new Class35_Sub2_Sub2();
			local12 = local5.method5823();
