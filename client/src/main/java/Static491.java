...
public final class Static491 {
	...
	public static void method6588(@OriginalArg(0) Class19_Sub3 arg0) {
		@Pc(12) byte[] local12;
		if (Static599.anObject14 == null) {
			@Pc(5) Class35_Sub2_Sub2 local5 = new Class35_Sub2_Sub2();
			local12 = local5.method4122();
			Static599.anObject14 = Static247.method2552(local12);
		}
		if (Static158.anObject5 == null) {
			@Pc(34) Class35_Sub1_Sub1 local34 = new Class35_Sub1_Sub1();
			local12 = local34.method521();
			Static158.anObject5 = Static247.method2552(local12);
		}
		@Pc(49) Class202 local49 = arg0.aClass202_1;
		if (local49.method3205() && Static71.anObject4 == null) {
			local12 = Static448.method4248(4.0F, 4.0F, 0.5F, 16.0F, 0.6F, new Class59_Sub1(419684));
			Static71.anObject4 = Static247.method2552(local12);
		}
	}
}
