...
public final class Static494 {
	...
	public static void method4628(@OriginalArg(1) String arg0, @OriginalArg(2) boolean arg1) {
		...
		for (@Pc(31) int local31 = local18; local31 < local29; local31++) {
			@Pc(37) Class2_Sub2_Sub12 local37 = Static288.aClass139_2.method2055(local31);
			if (local37.aBoolean334 && local37.method2735().toLowerCase().indexOf(local6) != -1) {
				if (local11 >= 50) {
		...
		for (local80 = 0; local80 < Static606.anInt8947; local80++) {
			local120[local80] = Static288.aClass139_2.method2055(local9[local80]).method2735();
		}
		Static554.method5116(local120, Static256.aShortArray63);
	}

	@OriginalMember(owner = "client!pja", name = "a", descriptor = "(ILclient!dda;ILclient!ha;)V")
	public static void method4630(@OriginalArg(0) int arg0, @OriginalArg(1) Class75 arg1, @OriginalArg(3) Class19 arg2) {
		@Pc(15) int local15;
		...
		if (arg1.aByte43 == 1) {
			...
			if (local15 >= 0 && local15 <= Static35.anInt813 + Static35.anInt813) {
				...
				if (local375) {
					...
					if (!(float) Static86.anInt1803 > local410 && (Static219.method2275(0, arg1) && (Static219.method2275(1, arg1) && (Static219.method2275(2, arg1) && Static219.method2275(3, arg1))))) {
			...
			if (local15 >= 0 && local15 <= Static35.anInt813 + Static35.anInt813) {
				...
				if (local375) {
					...
					if (!(local410 < (float) Static86.anInt1803) && (Static219.method2275(0, arg1) && (Static219.method2275(1, arg1) && (Static219.method2275(2, arg1) && Static219.method2275(3, arg1))))) {
						Static560.aClass75Array3[Static469.anInt7072++] = arg1;
					}
				}
			}
			...
			if (local15 >= 0 && Static35.anInt813 + Static35.anInt813 >= local15) {
				...
				if (local323 >= 0 && Static35.anInt813 + Static35.anInt813 >= local323 && Static258.aBooleanArrayArray3[local15][local323]) {
					...
					if ((!((float) Static86.anInt1803 > local697) || !((float) Static86.anInt1803 > local714)) && (Static219.method2275(0, arg1) && (Static219.method2275(1, arg1) && (Static219.method2275(2, arg1) && Static219.method2275(3, arg1))))) {
						Static560.aClass75Array3[Static469.anInt7072++] = arg1;
					}
				}
			}
			...
			if (!(local787 <= (float) Static663.anInt9874)) {
				...
				if (local900 && (Static219.method2275(0, arg1) && (Static219.method2275(1, arg1) && (Static219.method2275(2, arg1) && Static219.method2275(3, arg1))))) {
					Static560.aClass75Array3[Static469.anInt7072++] = arg1;
				}
			}
		}
