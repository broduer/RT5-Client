...
public final class Static495 {
	...
	public static void method4639(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		@Pc(7) int local7 = 0;
		...
		if (Static724.anInt10930 <= arg4 && arg4 <= Static273.anInt4395) {
			...
			local179 = Static670.method6229(Static180.anInt2995, Static111.anInt2219, arg0 - arg1);
			local190 = Static670.method6229(Static180.anInt2995, Static111.anInt2219, arg0 + arg1);
			local198 = Static670.method6229(Static180.anInt2995, Static111.anInt2219, arg0 - local16);
			local206 = Static670.method6229(Static180.anInt2995, Static111.anInt2219, arg0 + local16);
			Static696.method6473(local198, arg3, local179, local170);
			Static696.method6473(local206, arg5, local198, local170);
			Static696.method6473(local190, arg3, local206, local170);
		}
		while (local9 > 0) {
			...
			if (local190 >= Static724.anInt10930 && local179 <= Static273.anInt4395) {
				local198 = Static670.method6229(Static180.anInt2995, Static111.anInt2219, arg0 + local7);
				local206 = Static670.method6229(Static180.anInt2995, Static111.anInt2219, arg0 - local7);
				if (local239) {
					@Pc(442) int local442 = Static670.method6229(Static180.anInt2995, Static111.anInt2219, arg0 + local11);
					@Pc(452) int local452 = Static670.method6229(Static180.anInt2995, Static111.anInt2219, arg0 - local11);
					@Pc(459) int[] local459;
					if (Static724.anInt10930 <= local179) {
						local459 = Static723.anIntArrayArray266[local179];
						Static696.method6473(local452, arg3, local206, local459);
						Static696.method6473(local442, arg5, local452, local459);
						Static696.method6473(local198, arg3, local442, local459);
					}
					...
					if (local179 >= Static724.anInt10930) {
						Static696.method6473(local198, arg3, local206, Static723.anIntArrayArray266[local179]);
					}
					if (local190 <= Static273.anInt4395) {
						Static696.method6473(local198, arg3, local206, Static723.anIntArrayArray266[local190]);
					}
				}
			}
		}
