...
public final class Static497 {
	...
	public static void method4652(@OriginalArg(1) Class19 arg0) {
		for (@Pc(6) Class8_Sub5 local6 = (Class8_Sub5) Static342.aClass130_7.method1905(); local6 != null; local6 = (Class8_Sub5) Static342.aClass130_7.method1900()) {
			if (local6.aBoolean325) {
				local6.method2642(arg0);
			}
		}
		if (false) {
			aClass28_35 = null;
	...
	public static int method4658(@OriginalArg(1) Class8_Sub2_Sub1_Sub2_Sub2 arg0) {
		@Pc(6) Class268 local6 = arg0.aClass268_1;
		if (local6.anIntArray532 != null) {
			local6 = local6.method4221(65535, Static34.aClass304_1);
			if (local6 == null) {
				return -1;
			}
		}
		@Pc(22) int local22 = local6.anInt6711;
		@Pc(32) Class289 local32 = arg0.method6708();
		@Pc(37) int local37 = arg0.aClass152_10.method6548();
