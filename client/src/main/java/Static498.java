...
public final class Static498 {
	...
	public static void method4672(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4) {
		if (arg4 < 1) {
			arg4 = 1;
		}
		if (arg3 < 1) {
		...
		if (local72 < Static552.aShort123) {
			...
			if (Static598.aShort120 < local49) {
				...
				if (arg1) {
					...
					Static163.aClass19_17.a(local122, arg3, arg2, (byte) 116, (int) arg0, -16777216);
					Static163.aClass19_17.a(local122, arg3, arg2, (byte) 116, (int) (arg4 + arg0 - local122), -16777216);
				}
				arg0 += local122;
				arg4 -= local122 * 2;
			}
			...
			if (Static25.aShort1 > local49) {
				...
				if (arg1) {
					Static163.aClass19_17.la();
					Static163.aClass19_17.a(arg4, local122, arg2, (byte) 116, (int) arg0, -16777216);
					Static163.aClass19_17.a(arg4, local122, arg2 + arg3 - local122, (byte) 116, (int) arg0, -16777216);
				}
				arg3 -= local122 * 2;
				arg2 += local122;
			}
	...
	public static void method4675() {
		Static135.method5073();
		@Pc(19) int local19 = Static400.aClass2_Sub34_28.aClass57_Sub3_1.method1359();
		if (local19 == 2) {
			Static85.method6678(Static380.anInt5979, Static680.anInt10289, Static163.aClass19_17);
		} else if (local19 == 3) {
			Static126.method1447(Static163.aClass19_17, Static680.anInt10289, Static32.anInt777, Static288.anInt4620, Static380.anInt5979);
		}
		if (Static400.aClass2_Sub34_28.aClass57_Sub3_1.method1357()) {
			Static575.method5370(Static434.aCanvas7);
		}
		if (Static163.aClass19_17 != null) {
			Static209.method2200();
		}
		Static504.aBoolean579 = Static400.aClass2_Sub34_28.aClass57_Sub3_1.method1359() != 0;
		Static137.aBoolean210 = Static400.aClass2_Sub34_28.aClass57_Sub3_1.method1357();
	}

	@OriginalMember(owner = "client!pm", name = "a", descriptor = "([Lclient!eo;II)V")
	public static void method4679(@OriginalArg(0) Class8_Sub2[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg1 >= arg2) {
			return;
		}
		...
		method4679(arg0, arg1, local10 - 1);
		method4679(arg0, local10 + 1, arg2);
	}
}
