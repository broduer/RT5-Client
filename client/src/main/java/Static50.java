...
public final class Static50 {
	...
	public static Class369 method4664(@OriginalArg(1) Class88 arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int[] arg2) {
		...
		if (arg0.aByteArray28 != null) {
			...
			for (local97 = 0; local97 < local25; local97++) {
				...
				if (local268 > 0) {
					...
					local13[local97] = Static395.method6592(local340, local326, local334, arg0.aShortArray29[local97], arg0.aShortArray28[local97], arg0.aByteArray27[local97] & 0xFF, arg0.aShortArray21[local97]);
				}
			}
		}
	...
	public static void method4667(@OriginalArg(0) Class8_Sub2_Sub1_Sub2 arg0) {
		@Pc(8) Class152 local8 = arg0.aClass152_10;
		if (local8.method6543() && local8.method6546(1) && local8.method6536()) {
			if (arg0.aBoolean817) {
				local8.method6547(true, arg0.method6708().method4541());
				arg0.aBoolean817 = local8.method6543();
			}
			local8.method6533();
		}
		...
		for (@Pc(50) int local50 = 0; local50 < arg0.aClass199Array3.length; local50++) {
			if (arg0.aClass199Array3[local50].anInt4930 != -1) {
				...
				if (local75.method6540()) {
					@Pc(88) Class227 local88 = Static23.aClass128_1.method1831(arg0.aClass199Array3[local50].anInt4930);
					@Pc(92) Class69 local92 = local75.method6541();
				...
				if (local75.method6546(1) && local75.method6536()) {
					local75.method6547(true, -1);
					arg0.aClass199Array3[local50].anInt4930 = -1;
				}
			}
		...
		if (local75.method6543()) {
			label83: {
				@Pc(214) Class69 local214 = local75.method6541();
				if (local214.anInt1642 == 3) {
					...
					if (arg0.anInt10762 > 0 && Static333.anInt5455 >= arg0.anInt10759 && arg0.anInt10755 < Static333.anInt5455) {
						local75.method6525(1);
						break label83;
					}
					local75.method6525(0);
				}
				if (local75.method6546(1) && local75.method6536()) {
					arg0.anIntArray869 = null;
					local75.method6547(true, -1);
		...
		for (@Pc(313) int local313 = 0; local313 < arg0.aClass152_Sub2_Sub1Array3.length; local313++) {
			...
			if (local320 != null) {
				if (local320.anInt10508 > 0) {
					local320.anInt10508--;
				} else if (local320.method6546(1) && local320.method6536()) {
	...
	public static void method4668(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class2_Sub2_Sub2 local8 = Static440.method4204(15, 0L);
		local8.method130();
