...
public final class Static50 {
	...
	public static final Class347 aClass347_90 = new Class347(85, 2);
	...
	public static Class371 method6642(@OriginalArg(1) Class88 arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int[] arg2) {
		@Pc(7) int[] local7 = null;
		@Pc(9) int[] local9 = null;
		@Pc(11) int[] local11 = null;
		@Pc(13) float[][] local13 = null;
		if (arg0.aByteArray28 != null) {
			@Pc(25) int local25 = arg0.anInt2386;
			...
			for (local97 = 0; local97 < local25; local97++) {
				...
				if (local268 > 0) {
					...
					local13[local97] = Static395.method9170(local340, local326, local334, arg0.aShortArray29[local97], arg0.aShortArray28[local97], arg0.aByteArray27[local97] & 0xFF, arg0.aShortArray21[local97]);
				}
			}
		}
		return new Class371(local7, local9, local11, local13);
	}

	@OriginalMember(owner = "client!bm", name = "a", descriptor = "(Lclient!cg;B)V")
	public static void method6645(@OriginalArg(0) Class8_Sub2_Sub1_Sub2 arg0) {
		@Pc(8) Class152 local8 = arg0.aClass152_10;
		if (local8.method9116() && local8.method9119(1) && local8.method9109()) {
			if (arg0.aBoolean818) {
				local8.method9120(true, arg0.method9324().method6484());
				arg0.aBoolean818 = local8.method9116();
			}
			local8.method9106();
		}
		@Pc(75) Class152 local75;
		for (@Pc(50) int local50 = 0; local50 < arg0.aClass201Array3.length; local50++) {
				...
				if (local75.method9113()) {
					...
					if (local88.aBoolean448) {
						if (local92.anInt1649 == 3) {
							if (arg0.anInt10791 > 0 && Static333.anInt5474 >= arg0.anInt10788 && arg0.anInt10784 < Static333.anInt5474) {
								local75.method9120(true, -1);
								arg0.aClass201Array3[local50].anInt4947 = -1;
								continue;
							}
						} else if (local92.anInt1649 == 1 && arg0.anInt10791 > 0 && arg0.anInt10788 <= Static333.anInt5474 && Static333.anInt5474 > arg0.anInt10784) {
							continue;
						}
					}
				}
				if (local75.method9119(1) && local75.method9109()) {
					local75.method9120(true, -1);
					arg0.aClass201Array3[local50].anInt4947 = -1;
				}
			}
		...
		if (local75.method9116()) {
			label83: {
				...
				if (local214.anInt1649 == 3) {
					if (arg0.anInt10791 > 0 && arg0.anInt10788 <= Static333.anInt5474 && Static333.anInt5474 > arg0.anInt10784) {
						arg0.anIntArray869 = null;
						local75.method9120(true, -1);
						break label83;
					}
				} else if (local214.anInt1649 == 1) {
					if (arg0.anInt10791 > 0 && Static333.anInt5474 >= arg0.anInt10788 && arg0.anInt10784 < Static333.anInt5474) {
						local75.method9098(1);
						break label83;
					}
					local75.method9098(0);
				}
				if (local75.method9119(1) && local75.method9109()) {
					arg0.anIntArray869 = null;
					local75.method9120(true, -1);
		...
		for (@Pc(313) int local313 = 0; local313 < arg0.aClass152_Sub2_Sub1Array3.length; local313++) {
			...
			if (local320 != null) {
				if (local320.anInt10536 > 0) {
					local320.anInt10536--;
				} else if (local320.method9119(1) && local320.method9109()) {
