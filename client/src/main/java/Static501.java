...
public final class Static501 {
	...
	public static boolean method6722(@OriginalArg(1) int arg0) {
		return arg0 != 1 && arg0 != 7;
	}

	@OriginalMember(owner = "client!pq", name = "a", descriptor = "(ZI)V")
	public static void method6723(@OriginalArg(0) boolean arg0) {
		@Pc(5) int local5 = Static329.anInt1759;
		@Pc(7) int local7 = Static32.anInt778;
