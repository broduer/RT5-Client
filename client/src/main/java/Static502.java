...
public final class Static502 {
	...
	public static Class70 method4732(@OriginalArg(0) boolean arg0, @OriginalArg(2) Class19 arg1, @OriginalArg(3) boolean arg2, @OriginalArg(4) int arg3) {
		if (arg3 == -1) {
			return null;
		}
		...
		@Pc(54) Class70 local54 = (Class70) Static627.aClass82_200.method1390((long) ((arg0 ? 1 : 0) | arg3 << 1));
		if (local54 != null) {
			if (arg2 && local54.aClass381_5 == null) {
				@Pc(70) Class381 local70 = Static238.method2501(arg3, Static237.aClass330_87);
				if (local70 == null) {
					return null;
				}
		...
		@Pc(84) Class407[] local84 = Static735.method6776(Static555.aClass330_106, arg3);
		if (local84 == null) {
			return null;
		}
		@Pc(94) Class381 local94 = Static238.method2501(arg3, Static237.aClass330_87);
		if (local94 == null) {
			return null;
		}
		if (arg2) {
			local54 = new Class70(arg1.a(local94, local84, arg0), local94);
		} else {
			local54 = new Class70(arg1.a(local94, local84, arg0));
		}
		Static627.aClass82_200.method1384(local54, (long) (arg3 << 1 | (arg0 ? 1 : 0)));
		return local54;
	}

	@OriginalMember(owner = "client!pr", name = "a", descriptor = "(BLclient!ge;)Lclient!il;")
	public static Class138_Sub3 method4733(@OriginalArg(1) Class2_Sub21 arg0) {
		@Pc(7) Class138 local7 = Static632.method5923(arg0);
		@Pc(23) int local23 = arg0.method5158();
		@Pc(27) int local27 = arg0.method5158();
	...
	public static void method4734(@OriginalArg(1) byte[] arg0) {
		...
		while (true) {
			...
			label46: do {
				while (true) {
					while (true) {
						local14 = local10.method5205();
						if (local14 == 0) {
							return;
						}
						if (local14 == 1) {
							@Pc(137) int[] local137 = Static449.anIntArray546 = new int[6];
							local137[0] = local10.method5191();
							local137[1] = local10.method5191();
							local137[2] = local10.method5191();
							local137[3] = local10.method5191();
							local137[4] = local10.method5191();
							local137[5] = local10.method5191();
						} else {
							if (local14 != 4) {
								continue label46;
							}
							local50 = local10.method5205();
							Static406.anIntArray484 = new int[local50];
							for (local55 = 0; local55 < local50; local55++) {
								Static406.anIntArray484[local55] = local10.method5191();
			...
			for (local55 = 0; local55 < local50; local55++) {
				Static150.anIntArray233[local55] = local10.method5191();
