...
public final class Static502 {
	...
	public static Class70 method6726(@OriginalArg(0) boolean arg0, @OriginalArg(2) Class19 arg1, @OriginalArg(3) boolean arg2, @OriginalArg(4) int arg3) {
		if (arg3 == -1) {
			return null;
		}
		...
		@Pc(94) Class383 local94 = Static238.method3468(arg3, Static237.aClass332_87);
		if (local94 == null) {
			return null;
		}
		if (arg2) {
			local54 = new Class70(arg1.method8017(local94, local84, arg0), local94);
		} else {
	...
	public static Class138_Sub3 method6727(@OriginalArg(1) Class2_Sub21 arg0) {
		@Pc(7) Class138 local7 = Static632.method8366(arg0);
		@Pc(23) int local23 = arg0.method7356();
		@Pc(27) int local27 = arg0.method7356();
		return new Class138_Sub3(local7.aClass405_10, local7.aClass103_10, local7.anInt4436, local7.anInt4425, local7.anInt4431, local7.anInt4426, local7.anInt4429, local7.anInt4428, local7.anInt4434, local23, local27);
	}
	...
	public static void method6728(@OriginalArg(1) byte[] arg0) {
		...
		while (true) {
			...
			label46: do {
				while (true) {
					while (true) {
						local14 = local10.method7403();
						if (local14 == 0) {
							return;
						}
						if (local14 == 1) {
							@Pc(137) int[] local137 = Static449.anIntArray546 = new int[6];
							local137[0] = local10.method7389();
							local137[1] = local10.method7389();
							local137[2] = local10.method7389();
							local137[3] = local10.method7389();
							local137[4] = local10.method7389();
							local137[5] = local10.method7389();
						} else {
							if (local14 != 4) {
								continue label46;
							}
							local50 = local10.method7403();
							Static406.anIntArray484 = new int[local50];
							for (local55 = 0; local55 < local50; local55++) {
								Static406.anIntArray484[local55] = local10.method7389();
			...
			for (local55 = 0; local55 < local50; local55++) {
				Static150.anIntArray233[local55] = local10.method7389();
