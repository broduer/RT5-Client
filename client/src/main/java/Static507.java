...
public final class Static507 {
	...
	public static void method4746(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) Class158 arg3) {
		...
		if (Static103.aBoolean195 && (Static84.method1081(arg3).anInt6909 != 0 || arg3.anInt3820 == 0)) {
		...
		if (arg0 && arg3.anObjectArray19 != null && (local6 != arg3.anInt3802 || local16 != arg3.anInt3746)) {
			...
			Static521.aClass339_44.method5465(local225);
		}
	}

	@OriginalMember(owner = "client!pw", name = "c", descriptor = "(Z)V")
	public static void method4747() {
		for (@Pc(15) Class2_Sub5 local15 = (Class2_Sub5) Static106.aClass28_11.method371(); local15 != null; local15 = (Class2_Sub5) Static106.aClass28_11.method375()) {
			if (local15.aBoolean18) {
				local15.aBoolean18 = false;
			} else {
				Static121.method1428(local15.anInt182);
			}
		}
	}
}
