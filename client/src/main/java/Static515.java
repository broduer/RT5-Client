...
public final class Static515 {
	...
	public static final Class22 aClass22_1 = Static433.method3977();

	@OriginalMember(owner = "client!qda", name = "a", descriptor = "(IIIIILclient!ha;IIIIILclient!cba;)V")
	public static void method4787(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) Class19 arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9, @OriginalArg(11) Class2_Sub2_Sub4 arg10) {
		if (arg8 < arg5 && arg5 < arg1 + arg8 && arg2 - 13 < arg0 && arg0 < arg2 + 3) {
			arg6 = arg3;
		}
		@Pc(41) String local41 = Static192.method1979(arg10);
		Static180.aClass14_3.a(arg6, 0, arg2, local41, -238946248, arg8 + 3, Static186.aClass23Array5, Static460.anIntArray554);
	}

	@OriginalMember(owner = "client!qda", name = "a", descriptor = "(BILclient!ha;III)V")
	public static void method4789(@OriginalArg(1) int arg0, @OriginalArg(2) Class19 arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		arg1.KA(arg3, arg4, arg3 + arg0, arg2 + arg4);
		arg1.a(arg0, arg2, arg4, (byte) 116, (int) arg3, -16777216);
		...
		if (Static13.aClass23_4 == null || Static13.aClass23_4.c() != arg0 || Static13.aClass23_4.d() != arg2) {
			Static30.method3544(Static30.anInt5655, Static30.anInt5648 + Static30.anInt5644, Static30.anInt5650 + Static30.anInt5655, Static30.anInt5648, local75, local84, local75 + local46, local84 - -local48);
			Static30.method3542(arg1);
			Static13.aClass23_4 = arg1.a(local75, local84, local46, local48, false);
		}
		Static13.aClass23_4.a(local75, local84);
		...
		arg1.d(local152, local166, local138, local144, local168, 0);
		...
		for (@Pc(213) Class2_Sub20 local213 = (Class2_Sub20) Static30.aClass339_31.method5453(65280); local213 != null; local213 = (Class2_Sub20) Static30.aClass339_31.method5460()) {
			@Pc(221) Class105 local221 = Static30.aClass246_3.method3966(local213.anInt3131);
			if (Static408.method3995(local221)) {
				@Pc(256) int local256;
				@Pc(269) int local269;
				if (Static475.anInt7168 == local213.anInt3131) {
					...
					arg1.a(4, 4, local269 - 2, (byte) 116, (int) (local256 - 2), local202 << 24 | 0xFFFF00);
	...
	public static void method4790(@OriginalArg(0) boolean arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		if (Static106.aClass28_11.method373((long) arg1) != null) {
			return;
		}
		if (Static234.aBoolean303) {
			...
			local34.aClass222_Sub1_1.method6612(Static384.aStringArray31[Static51.anInt1052]);
			Static106.aClass28_11.method370((long) arg1, local34);
		} else {
			Static635.method5944(arg1, arg0);
		}
	}

	@OriginalMember(owner = "client!qda", name = "a", descriptor = "(Lclient!ge;B)Lclient!no;")
	public static Class160 method4791(@OriginalArg(0) Class2_Sub21 arg0) {
		@Pc(15) int local15 = arg0.method5191();
		@Pc(22) Class403 local22 = Static33.method434()[arg0.method5205()];
		@Pc(29) Class103 local29 = Static313.method3174()[arg0.method5205()];
		@Pc(35) int local35 = arg0.method5165();
		@Pc(39) int local39 = arg0.method5165();
		return new Class160(local15, local22, local29, local35, local39);
	}

	@OriginalMember(owner = "client!qda", name = "a", descriptor = "(III)Z")
	public static boolean method4792(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		return Static77.method999(arg0, arg1) || Static519.method4815(-97, arg1, arg0);
	}
}
