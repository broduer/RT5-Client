...
public final class Static517 {
	...
	public static Class2_Sub2_Sub13 method4808(@OriginalArg(0) Class330 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(14) Class2_Sub21 local14 = new Class2_Sub21(arg0.method5359(arg2, arg1));
		@Pc(50) Class2_Sub2_Sub13 local50 = new Class2_Sub2_Sub13(arg2, local14.method5167(), local14.method5167(), local14.method5158(), local14.method5158(), local14.method5205() == 1, local14.method5205(), local14.method5205());
		@Pc(54) int local54 = local14.method5205();
		for (@Pc(56) int local56 = 0; local56 < local54; local56++) {
			local50.aClass339_26.method5465(new Class2_Sub56(local14.method5205(), local14.method5191(), local14.method5191(), local14.method5191(), local14.method5191(), local14.method5191(), local14.method5191(), local14.method5191(), local14.method5191()));
		}
		local50.method2840();
		return local50;
	}
	...
	public static void method4810(@OriginalArg(0) boolean arg0) {
		if (22050 > 48000) {
	...
	public static void method4811(@OriginalArg(0) boolean arg0, @OriginalArg(1) byte[][][] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) boolean arg6) {
		...
		if ((arg5 & 0x2) == 0) {
			for (local22 = Static576.aClass8_Sub2Array9[local6]; local22 != null; local22 = local22.aClass8_Sub2_25) {
				if (!Static208.method2197(local22, arg0, arg1, arg2, arg3)) {
					method4812(local22);
		...
		if ((arg5 & 0x1) == 0) {
			...
			for (@Pc(98) Class8_Sub2 local98 = Static468.aClass8_Sub2Array10[local6]; local98 != null; local98 = local98.aClass8_Sub2_25) {
				if (!Static208.method2197(local98, arg0, arg1, arg2, arg3)) {
					if (local98.h(0)) {
						method4812(local98);
			...
			if (!arg0) {
				for (local157 = 0; local157 < Static125.anInt2352; local157++) {
					if (!Static208.method2197(Static679.aClass8_Sub2_Sub1Array1[local157], arg0, arg1, arg2, arg3)) {
						method4812(Static679.aClass8_Sub2_Sub1Array1[local157]);
						if (Static679.aClass8_Sub2_Sub1Array1[local157].anInt10697 != -1) {
							if (Static679.aClass8_Sub2_Sub1Array1[local157].h(0)) {
		...
		if (Static546.anInt8244 > 0) {
			Static590.method5489(Static48.aClass8_Sub2Array3, 0, Static546.anInt8244 - 1);
			for (local225 = 0; local225 < Static546.anInt8244; local225++) {
				Static632.method5932(Static48.aClass8_Sub2Array3[local225], arg6);
			}
		}
		if (Static442.aBoolean500) {
			Static665.aClass19_15.a(0, (Class2_Sub7[]) null);
		}
		if ((arg5 & 0x2) == 0) {
			for (local225 = Static296.anInt4792; local225 < Static299.anInt4824; local225++) {
				...
				if (local225 < arg2 || arg1 == null) {
					...
					if (Static581.aBoolean657) {
						...
						for (local316 = Static231.anInt3734; local316 < local263; local316++) {
							...
							for (local325 = Static13.anInt148; local325 < local157; local325++) {
								if (Static258.aBooleanArrayArray3[local316][local325] && !Static588.method5468(local325 + Static220.anInt3562 - Static13.anInt148, local225, local323)) {
					...
					if (Static661.aBoolean457) {
						if (arg4 >= 0) {
							Static246.aClass178Array1[local225].a(0, 0, 0, (boolean[][]) null, false, arg4, arg5);
						} else {
							Static246.aClass178Array1[local225].a(0, 0, 0, (boolean[][]) null, false, arg5);
						}
						for (local316 = 0; local316 < Static32.anInt772; local316++) {
							Static684.aClass302Array1[local316].method4793(new Class8_Sub9(local225 + 1));
						}
					} else if (arg4 >= 0) {
						Static246.aClass178Array1[local225].a(Static403.anInt6246, Static550.anInt8271, Static35.anInt813, Static142.aBooleanArrayArray1, true, arg4, arg5);
					} else {
						Static246.aClass178Array1[local225].a(Static403.anInt6246, Static550.anInt8271, Static35.anInt813, Static142.aBooleanArrayArray1, true, arg5);
					}
				} else {
					local263 = Static258.aBooleanArrayArray3.length;
					if (Static441.anInt6691 + Static258.aBooleanArrayArray3.length > Static619.anInt1566) {
								...
								if (Static258.aBooleanArrayArray3[local316][local325]) {
									...
									for (@Pc(346) int local346 = local225; local346 >= 0; local346--) {
										if (Static334.aClass291ArrayArrayArray1[local346][local323][local344] != null && Static334.aClass291ArrayArrayArray1[local346][local323][local344].aByte116 == local225) {
											if ((local346 < arg2 || arg1[local346][local323][local344] != arg3) && !Static588.method5468(local344, local225, local323)) {
												local304[local316][local325] = true;
												break;
											}
											local304[local316][local325] = false;
					...
					if (Static661.aBoolean457) {
						...
						Static246.aClass178Array1[local225].a(Static403.anInt6246, Static550.anInt8271, Static35.anInt813, Static142.aBooleanArrayArray1, false, arg4, arg5);
					} else {
						Static246.aClass178Array1[local225].a(Static403.anInt6246, Static550.anInt8271, Static35.anInt813, Static142.aBooleanArrayArray1, false, arg5);
					}
				}
			}
		}
		if (Static645.anInt9611 > 0) {
			Static498.method4679(Static395.aClass8_Sub2Array11, 0, Static645.anInt9611 - 1);
			for (local225 = 0; local225 < Static645.anInt9611; local225++) {
				Static632.method5932(Static395.aClass8_Sub2Array11[local225], arg6);
			}
		}
	}

	@OriginalMember(owner = "client!qea", name = "a", descriptor = "(Lclient!eo;)V")
	private static void method4812(@OriginalArg(0) Class8_Sub2 arg0) {
		Static665.aClass19_15.H(arg0.anInt10690, arg0.anInt10691 + (arg0.k(2) >> 1), arg0.anInt10694, Static486.anIntArray591);
