...
public final class Static519 {
	...
	public static int method4814() {
		...
		if (local5) {
			try {
				local82 = Static363.method4339(1000, 2);
			} catch (@Pc(95) Exception local95) {
			}
		}
		if (local9) {
			try {
				local86 = Static363.method4339(1000, 3);
				if (Static400.aClass2_Sub34_28.aClass57_Sub29_1.method5612() == 3) {
					@Pc(114) Class84 local114 = Static163.aClass19_17.c();
		...
		if (local7) {
			try {
				local84 = Static363.method4339(1000, 1);
		...
		if (local82 > local86 && local82 > local84) {
			return Static611.method5812(local82);
		} else if (local86 > local84) {
			return Static399.method3953(3, local86);
		} else {
			return Static399.method3953(1, local84);
		}
	}

	@OriginalMember(owner = "client!qfa", name = "a", descriptor = "(III)Z")
	public static boolean method4815(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (Static280.method2837(arg2, arg1)) {
			return Static77.method999(arg2, arg1) | (arg1 & 0x9000) != 0 | Static433.method3983(arg2, arg1) ? true : (arg2 & 0x37) == 0 & (Static526.method4948(arg2, arg1) | (arg1 & 0x2000) != 0 | Static220.method2282(arg1, arg2));
		} else {
			return false;
		}
	}
