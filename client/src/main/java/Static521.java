...
public final class Static521 {
	...
	public static int method6877(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int[] arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9, @OriginalArg(11) Class110 arg10, @OriginalArg(12) int[] arg11, @OriginalArg(13) int arg12, @OriginalArg(14) int arg13) {
		...
		if (arg1 == 1) {
			...
			local51 = Static434.method5861(arg13, arg10, arg4, arg7, arg9, arg8, arg3, arg12, arg0, arg1, arg5);
		}
		@Pc(87) int local87 = arg4 - 64;
		@Pc(91) int local91 = arg8 - 64;
		@Pc(93) int local93 = Static594.anInt8799;
		@Pc(95) int local95 = Static407.anInt6305;
		@Pc(106) int local106;
		@Pc(108) int local108;
		@Pc(114) int local114;
		if (!local51) {
	...
	public static int method6881(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		if ((arg3 & 0x1) == 1) {
