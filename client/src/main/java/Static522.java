...
public final class Static522 {
	...
	public static String method4869(@OriginalArg(1) int arg0, @OriginalArg(2) long arg1) {
		Static551.method5100(arg1);
		...
		return arg0 == 3 ? Static614.method5822(arg1, arg0) : Integer.toString(local19 / 10) + local19 % 10 + "-" + Static19.aStringArrayArray1[arg0][local23] + "-" + local27;
	}

	@OriginalMember(owner = "client!qha", name = "a", descriptor = "(ILclient!bn;)V")
	public static void method4916(@OriginalArg(1) Class2_Sub8 arg0) {
		Static581.aClass2_Sub6_Sub1_3.method476(arg0, false);
