...
public final class Static523 {
	...
	public static boolean method2482(@OriginalArg(0) int arg0) {
	...
	public static int method2484(@OriginalArg(1) Class2_Sub21 arg0, @OriginalArg(2) String arg1) {
		@Pc(12) int local12 = arg0.anInt8388;
		@Pc(16) byte[] local16 = Static469.method4450(arg1);
		arg0.method5161(local16.length);
		arg0.anInt8388 += Static636.aClass197_1.method3095(arg0.anInt8388, 0, local16.length, arg0.aByteArray93, local16);
		return arg0.anInt8388 - local12;
	}

	@OriginalMember(owner = "client!qi", name = "a", descriptor = "(ZI)V")
	public static void method2485(@OriginalArg(0) boolean arg0) {
		if (Static449.aClass364_1 == null) {
			Static229.method2406();
		}
		if (arg0) {
			Static449.aClass364_1.method5935();
		}
	}
	...
	public static int method2486() {
		@Pc(12) int local12;
		if (Static400.aClass2_Sub34_28.aClass57_Sub10_1.method2547() == 0) {
			for (local12 = 0; local12 < Static671.anInt10026; local12++) {
				if (Static194.anInterface27Array1[local12].method1803() == 's' || Static194.anInterface27Array1[local12].method1803() == 'S') {
					Static400.aClass2_Sub34_28.method3576(1, Static400.aClass2_Sub34_28.aClass57_Sub10_1);
		...
		if (Static198.aClass140_1 == Static473.aClass140_22) {
			...
			@Pc(77) long local77 = Static588.method5469();
		...
		if (Static198.aClass140_2 == Static473.aClass140_22) {
			...
			if (!Static228.aClass262_1.method4106()) {
				return 0;
			}
			Static595.method5541((String) null, true, 0);
			Static297.aBoolean368 = !Static589.method5470();
			Static177.aClass330_35 = Static109.method1320(false, Static297.aBoolean368 ? 34 : 32, 1);
			Static516.aClass330_97 = Static109.method1320(false, 33, 1);
			Static697.aClass330_123 = Static109.method1320(false, 13, 1);
		}
		@Pc(184) boolean local184;
		if (Static198.aClass140_3 == Static473.aClass140_22) {
			local184 = Static516.aClass330_97.method5355();
			local74 = Static226.aClass47_Sub1Array8[33].method4673();
			local74 += Static226.aClass47_Sub1Array8[Static297.aBoolean368 ? 34 : 32].method4673();
			local74 += Static226.aClass47_Sub1Array8[13].method4673();
			local74 += local184 ? 100 : Static516.aClass330_97.method5346();
			if (local74 != 400) {
				return local74 / 4;
			}
			Static324.anInt5129 = Static177.aClass330_35.method5340();
			Static466.anInt7042 = Static516.aClass330_97.method5340();
			Static616.method5858(Static177.aClass330_35);
			@Pc(250) int local250 = Static400.aClass2_Sub34_28.aClass57_Sub11_1.method2606();
			Static333.aClass279_1 = new Class279(Static392.aClass377_4, Static51.anInt1052, Static516.aClass330_97);
			@Pc(262) int[] local262 = Static333.aClass279_1.method4379(local250);
			if (local262.length == 0) {
				local262 = Static333.aClass279_1.method4379(0);
			}
			...
			if (local262.length > 0) {
				...
				for (@Pc(285) int local285 = 0; local285 < Static234.anInterface22Array1.length; local285++) {
					Static234.anInterface22Array1[local285] = new Class354(Static333.aClass279_1.method4381(local262[local285]), local276);
				}
			}
		}
		if (Static198.aClass140_4 == Static473.aClass140_22) {
			Static82.method1026(Static697.aClass330_123, Static177.aClass330_35, Static52.method679());
		}
		if (Static198.aClass140_5 == Static473.aClass140_22) {
			local12 = Static359.method3683();
			local74 = Static714.method6728();
			if (local74 > local12) {
		...
		if (Static198.aClass140_6 == Static473.aClass140_22) {
			if (Static234.anInterface22Array1 != null && Static234.anInterface22Array1.length > 0) {
				if (Static234.anInterface22Array1[0].method6014() < 100) {
					return 0;
				}
				if (Static234.anInterface22Array1.length > 1 && Static333.aClass279_1.method4380() && Static234.anInterface22Array1[1].method6014() < 100) {
					return 0;
				}
			}
			Static570.method5318(Static163.aClass19_17);
			Static469.method4447(Static163.aClass19_17);
			Static81.method1020(1);
		}
		if (Static198.aClass140_7 == Static473.aClass140_22) {
			for (local12 = 0; local12 < 4; local12++) {
				Static577.aClass110Array1[local12] = Static125.method1443(Static720.anInt10859, Static501.anInt7568);
			}
		}
		if (Static473.aClass140_22 == Static198.aClass140_8) {
			Static721.aClass330_128 = Static109.method1320(false, 8, 1);
			Static344.aClass330_73 = Static109.method1320(false, 0, 1);
			Static142.aClass330_25 = Static109.method1320(false, 1, 1);
			Static6.aClass330_1 = Static109.method1320(false, 2, 1);
			Static554.aClass330_105 = Static109.method1320(false, 3, 1);
			Static281.aClass330_60 = Static109.method1320(false, 4, 1);
			Static93.aClass330_16 = Static109.method1320(true, 5, 1);
			Static398.aClass330_81 = Static109.method1320(true, 6, 1);
			Static190.aClass330_38 = Static109.method1320(false, 7, 1);
			Static534.aClass330_104 = Static109.method1320(false, 9, 1);
			Static463.aClass330_93 = Static109.method1320(false, 10, 1);
			Static340.aClass330_69 = Static109.method1320(false, 11, 1);
			Static31.aClass330_6 = Static109.method1320(false, 12, 1);
			Static147.aClass330_26 = Static109.method1320(false, 14, 1);
			Static405.aClass330_84 = Static109.method1320(false, 15, 1);
			Static459.aClass330_91 = Static109.method1320(false, 16, 1);
			Static20.aClass330_3 = Static109.method1320(false, 17, 1);
			Static333.aClass330_66 = Static109.method1320(false, 18, 1);
			Static380.aClass330_79 = Static109.method1320(false, 19, 1);
			Static668.aClass330_119 = Static109.method1320(false, 20, 1);
			Static271.aClass330_59 = Static109.method1320(false, 21, 1);
			Static233.aClass330_52 = Static109.method1320(false, 22, 1);
			Static120.aClass330_19 = Static109.method1320(true, 23, 1);
			Static58.aClass330_12 = Static109.method1320(false, 24, 1);
			Static244.aClass330_55 = Static109.method1320(false, 25, 1);
			Static199.aClass330_42 = Static109.method1320(true, 26, 1);
			Static88.aClass330_14 = Static109.method1320(false, 27, 1);
			Static336.aClass330_68 = Static109.method1320(true, 28, 1);
			Static140.aClass330_24 = Static109.method1320(false, 29, 1);
			Static504.aClass330_95 = Static109.method1320(true, 35, 1);
			Static614.aClass330_114 = Static109.method1320(true, 30, 1);
			Static124.aClass330_20 = Static109.method1320(true, 31, 1);
			Static709.aClass330_127 = Static109.method1320(true, 36, 2);
		}
		if (Static473.aClass140_22 == Static198.aClass140_9) {
			...
			for (local74 = 0; local74 < 37; local74++) {
				if (Static226.aClass47_Sub1Array8[local74] != null) {
					local12 += Static226.aClass47_Sub1Array8[local74].method4673() * Static462.anIntArray556[local74] / 100;
				}
			}
			if (local12 != 100) {
			...
			Static204.method2169(Static721.aClass330_128);
			Static82.method1026(Static697.aClass330_123, Static721.aClass330_128, Static52.method679());
		}
		if (Static473.aClass140_22 == Static198.aClass140_10) {
			@Pc(746) byte[] local746 = Static336.aClass330_68.method5353(4);
			if (local746 == null) {
				return 0;
			}
			Static9.method72(local746);
			Static674.method6293();
			Static81.method1020(2);
		}
		if (Static198.aClass140_11 == Static473.aClass140_22) {
			Static529.method4971(Static614.aClass330_114, Static446.aClass390_6);
		}
		if (Static198.aClass140_12 == Static473.aClass140_22) {
			local12 = Static460.method4370();
			if (local12 < 100) {
				return local12;
			}
			Static502.method4734(Static336.aClass330_68.method5353(1));
		...
		if (Static198.aClass140_13 == Static473.aClass140_22) {
			if (Static65.aClass3_1.anInt81 != -1 && !Static190.aClass330_38.method5350(0, Static65.aClass3_1.anInt81)) {
				return 99;
			}
			...
			Static444.method4223(Static554.aClass330_105, Static697.aClass330_123, Static721.aClass330_128, Static190.aClass330_38);
			Static110.method1327(Static140.aClass330_24);
			...
			Static412.method4026();
			Static354.aClass142_4.method2156(Static400.aClass2_Sub34_28.aClass57_Sub19_2.method4201() == 0);
			Static34.aClass304_1 = new Class304();
			Static296.method3027();
			Static44.method609(Static25.aClass50_1);
			Static187.method1954(Static88.aClass330_14);
			Static405.method3974(Static56.anInterface4_3, Static190.aClass330_38);
			@Pc(1119) Class197 local1119 = new Class197(Static463.aClass330_93.method5364("huffman", ""));
			Static342.method3097(local1119);
			try {
				jagmisc.init();
			} catch (@Pc(1126) Throwable local1126) {
			}
			Static600.aClass27_1 = Static570.method5319();
			Static292.aClass2_Sub43_2 = new Class2_Sub43(true, Static446.aClass390_6);
		}
		if (Static198.aClass140_15 == Static473.aClass140_22) {
			local12 = Static188.method1970(Static721.aClass330_128) + Static372.method3743(true);
			local74 = Static688.method6415() + Static714.method6728();
			if (local12 < local74) {
				return local12 * 100 / local74;
			}
		}
		if (Static198.aClass140_16 == Static473.aClass140_22) {
			Static30.method3547(Static120.aClass330_19, Static467.aClass96_3, Static540.aClass79_6, Static354.aClass142_4, Static577.aClass246_4, Static720.aClass363_4, Static34.aClass304_1);
		}
		if (Static198.aClass140_17 == Static473.aClass140_22) {
			...
			for (local12 = 0; local12 < Static691.aClass210_1.anInt5473; local12++) {
				if (Static691.aClass210_1.method3462(local12).anInt7174 == 0) {
					Static118.aBooleanArray4[local12] = true;
					Static319.anInt5078++;
				}
				Static511.anIntArray614[local12] = -1;
			}
			Static218.method2274();
			Static93.aClass330_16.method5339(false);
			Static398.aClass330_81.method5339(true);
			Static721.aClass330_128.method5339(true);
			Static697.aClass330_123.method5339(true);
			Static463.aClass330_93.method5339(true);
		...
		if (Static473.aClass140_22 == Static198.aClass140_18) {
			if (!Static571.method5330(Static65.aClass3_1.anInt88)) {
				return 0;
			}
			local184 = true;
			for (local74 = 0; local74 < Static453.aClass158ArrayArray2[Static65.aClass3_1.anInt88].length; local74++) {
				...
				if (local1315.anInt3820 == 5 && local1315.anInt3810 != -1 && !Static721.aClass330_128.method5350(0, local1315.anInt3810)) {
					local184 = false;
				}
			}
			if (!local184) {
		...
		if (Static198.aClass140_19 == Static473.aClass140_22) {
			Static456.method4332(true);
		}
		if (Static198.aClass140_20 == Static473.aClass140_22) {
			Static449.aClass364_1.method5936();
			try {
			...
			Static9.method71();
			Static3.aBoolean4 = Static400.aClass2_Sub34_28.aClass57_Sub10_1.method2547() == 1;
			Static400.aClass2_Sub34_28.method3576(1, Static400.aClass2_Sub34_28.aClass57_Sub10_1);
			...
			if (Static3.aBoolean4) {
				...
				Static32.method432(Static400.aClass2_Sub34_28.aClass57_Sub29_2.method5612(), false);
			}
			Static409.method4013(Static400.aClass2_Sub34_28.aClass57_Sub1_1.method934(), -1, false, -1);
			Static570.method5318(Static163.aClass19_17);
			Static469.method4447(Static163.aClass19_17);
			Static239.method2505(Static721.aClass330_128, Static163.aClass19_17);
			Static331.method3445(Static679.aClass23Array14);
		}
		return Static694.method6466();
	}

	@OriginalMember(owner = "client!qi", name = "a", descriptor = "(ZLclient!hda;)V")
	public static void method2487(@OriginalArg(1) Class158 arg0) {
		...
		arg0.anInt3738 = Static214.method2242(Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.aString9);
		...
		arg0.anInt3789 = local55.method6548();
		arg0.aClass152_6.method6530(local55);
	}
}
