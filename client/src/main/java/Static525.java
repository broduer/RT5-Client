...
public final class Static525 {
	...
	public static SecondaryNode_Sub16 aClass2_Sub2_Sub16_12;
	...
	public static void method7893(@OriginalArg(1) boolean arg0, @OriginalArg(2) int arg1) {
		...
		if (local17 == null || arg1 < 0 || local17.anInt8309 <= arg1) {
			return;
		}
		...
		@Pc(56) Class153 local56 = Static668.method8708();
		@Pc(62) Node_Sub19 local62 = Static293.method4342(Static457.aClass347_86, local56.aClass186_1);
		local62.aClass2_Sub21_Sub2_1.p1(Static231.method3379(local53) + 3);
		local62.aClass2_Sub21_Sub2_1.p1(arg0 ? 1 : 0);
		local62.aClass2_Sub21_Sub2_1.p2(arg1);
		local62.aClass2_Sub21_Sub2_1.pjstr(local53);
