...
public final class Static526 {
	...
	public static final Class225 aClass225_194 = new Class225(78, 8);

	@OriginalMember(owner = "client!qk", name = "e", descriptor = "I")
	public static int anInt8067 = 0;

	@OriginalMember(owner = "client!qk", name = "h", descriptor = "Lclient!lga;")
	public static final Class225 aClass225_195 = new Class225(80, -2);

	@OriginalMember(owner = "client!qk", name = "a", descriptor = "(IIB)Z")
	public static boolean method4948(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
