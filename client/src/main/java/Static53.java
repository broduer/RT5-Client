...
public final class Static53 {
	...
	public static int method688(@OriginalArg(1) String arg0) {
		if (!Static93.aClass390_1.aBoolean781) {
			return -1;
		} else if (Static154.aHashtable3.containsKey(arg0)) {
			return 100;
		} else {
			@Pc(22) String local22 = Static308.method3119(arg0);
			if (local22 == null) {
				return -1;
			}
			@Pc(36) String local36 = Static185.aString34 + local22;
			if (!Static442.aClass330_90.method5341(local36, "")) {
				return -1;
			} else if (Static442.aClass330_90.method5362(local36)) {
				@Pc(62) byte[] local62 = Static442.aClass330_90.method5364(local36, "");
				@Pc(68) File local68;
				try {
					local68 = Static649.method6044(local22);
				...
				@Pc(84) byte[] local84 = Static629.method5912(local68);
				...
				try {
					if (!local80) {
						Static93.aClass390_1.method6428(local68, local62);
					}
				} catch (@Pc(145) Throwable local145) {
					return -1;
				}
				Static196.method2052(local68, arg0);
				return 100;
			} else {
				return Static442.aClass330_90.method5357(local36);
			}
		}
	}
}
