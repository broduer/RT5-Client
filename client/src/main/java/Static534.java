...
public final class Static534 {
	...
	public static void method4995(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7) {
		@Pc(17) int local17;
		if (Static571.method5330(arg0)) {
			local17 = 0;
			@Pc(58) int local58 = 0;
			@Pc(60) int local60 = 0;
			@Pc(62) int local62 = 0;
			...
			if (Static148.aClass158ArrayArray1[arg0] == null) {
				Static71.method961(-1, arg6, Static453.aClass158ArrayArray2[arg0], arg1, arg3, arg7, arg5, arg5 < 0, arg2, arg4);
			} else {
				Static71.method961(-1, arg6, Static148.aClass158ArrayArray1[arg0], arg1, arg3, arg7, arg5, arg5 < 0, arg2, arg4);
			}
			if (Static137.aBoolean210) {
				if (arg5 >= 0 && Static691.anInt10368 == 2) {
					Static682.method6378(Static320.anInt5085, Static582.anInt8629, Static435.anInt6597, Static599.anInt8837);
				}
	...
	public static void method4996() {
		Static473.aClass82_157.method1381(50);
		Static312.aClass82_106.method1381(50);
		Static449.aClass82_146.method1381(50);
		Static444.aClass82_145.method1381(50);
	}

	@OriginalMember(owner = "client!qq", name = "a", descriptor = "(II)V")
	public static void method4997(@OriginalArg(1) int arg0) {
