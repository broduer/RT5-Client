...
public final class Static534 {
	...
	public static void method7127(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7) {
		@Pc(17) int local17;
		if (Static571.method7573(arg0)) {
			...
			if (Static137.aBoolean210) {
				local62 = Static582.anInt8653;
				local64 = Static691.anInt10396;
				local17 = Static435.anInt6617;
				local58 = Static320.anInt5102;
				local60 = Static599.anInt8861;
				Static691.anInt10396 = 1;
			}
			...
			if (Static137.aBoolean210) {
				if (arg5 >= 0 && Static691.anInt10396 == 2) {
					Static682.method8934(Static320.anInt5102, Static582.anInt8653, Static435.anInt6617, Static599.anInt8861);
				}
				Static320.anInt5102 = local58;
				Static582.anInt8653 = local62;
				Static435.anInt6617 = local17;
				Static691.anInt10396 = local64;
				Static599.anInt8861 = local60;
			}
		} else if (arg5 == -1) {
