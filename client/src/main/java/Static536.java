...
public final class Static536 {
	...
	public static int method5015(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(3) int arg2) {
		@Pc(8) Class2_Sub22 local8 = Static556.method5127(arg2, arg1);
		if (local8 == null) {
			return 0;
