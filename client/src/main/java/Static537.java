...
public final class Static537 {
	...
	public static Class2_Sub2_Sub10 method5030(@OriginalArg(0) Class242 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(10) int local10 = arg0.anInt6197 | arg1 << 10;
		@Pc(19) Class2_Sub2_Sub10 local19 = (Class2_Sub2_Sub10) Static480.aClass361_2.method5906((long) local10 << 16);
		if (local19 != null) {
			return local19;
		}
		@Pc(32) byte[] local32 = Static31.aClass330_6.method5353(Static31.aClass330_6.method5363(local10));
		if (local32 == null) {
			local10 = arg2 + 65536 << 10 | arg0.anInt6197;
			local19 = (Class2_Sub2_Sub10) Static480.aClass361_2.method5906((long) local10 << 16);
			if (local19 != null) {
				return local19;
			}
			local32 = Static31.aClass330_6.method5353(Static31.aClass330_6.method5363(local10));
			if (local32 == null) {
