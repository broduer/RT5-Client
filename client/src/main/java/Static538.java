...
public final class Static538 {
	...
	public static void method7200() {
		@Pc(15) Packet local15 = Static405.aClass153_2.aClass2_Sub21_Sub2_2;
		for (@Pc(17) int local17 = 0; local17 < Static86.anInt1806; local17++) {
			@Pc(23) int local23 = Static458.anIntArray553[local17];
			@Pc(31) Class8_Sub2_Sub1_Sub2_Sub2 local31 = ((Node_Sub45) Static18.aClass28_2.get(local23)).aClass8_Sub2_Sub1_Sub2_Sub2_2;
			...
			if ((local35 & 0x40) != 0) {
				...
				if (local73 > 0) {
					for (local77 = 0; local77 < local73; local77++) {
						local90 = -1;
						local96 = -1;
						local86 = local15.gsmarts();
						local240 = -1;
						if (local86 == 32767) {
							local86 = local15.gsmarts();
							local96 = local15.gsmarts();
							local90 = local15.gsmarts();
							local240 = local15.gsmarts();
						} else if (local86 == 32766) {
							local86 = -1;
						} else {
							local96 = local15.gsmarts();
						}
						local280 = local15.gsmarts();
						local284 = local15.g1();
						local31.method9308(local240, local280, local284, local96, client.cycle, local90, local86);
					}
				}
			}
			if ((local35 & 0x100) != 0) {
				...
				local31.anInt10747 = local31.anInt10765 + client.cycle + local31.anInt10766;
			}
			if ((local35 & 0x40000) != 0) {
				local31.aString128 = local15.gstr();
			...
			if ((local35 & 0x20) != 0) {
				...
				local31.method9335(client.npcTypeList.method7099(local15.method7379()));
			...
			if ((local35 & 0x2) != 0) {
				local31.method9334(local15.gstr());
			}
			if ((local35 & 0x8) != 0) {
			...
			if ((local35 & 0x400) != 0) {
				...
				local31.anInt10788 = local15.g2() + client.cycle;
				local31.anInt10784 = local15.method7413() + client.cycle;
			...
			if ((local35 & 0x200) != 0) {
				...
				local31.anInt10789 = client.cycle + local15.method7379();
				local31.anInt10781 = client.cycle + local15.g2();
			}
		}
	}
}
