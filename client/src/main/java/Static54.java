...
public final class Static54 {
	...
	public static void method694() {
		Static342.method3100(Static400.aClass2_Sub34_28.aClass57_Sub5_1.method1406());
		...
		Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.method873(8, 8);
		...
		for (@Pc(88) int local88 = (local19 - (Static720.anInt10859 >> 4)) / 8; local88 <= (local19 + (Static720.anInt10859 >> 4)) / 8; local88++) {
			for (local99 = (local28 - (Static501.anInt7568 >> 4)) / 8; local99 <= ((Static501.anInt7568 >> 4) + local28) / 8; local99++) {
				...
				Static267.anIntArray329[local79] = Static93.aClass330_16.method5354("m" + local88 + "_" + local99);
				Static266.anIntArray615[local79] = Static93.aClass330_16.method5354("l" + local88 + "_" + local99);
				Static376.anIntArray458[local79] = Static93.aClass330_16.method5354("n" + local88 + "_" + local99);
				Static68.anIntArray316[local79] = Static93.aClass330_16.method5354("um" + local88 + "_" + local99);
				Static298.anIntArray367[local79] = Static93.aClass330_16.method5354("ul" + local88 + "_" + local99);
		...
		Static684.method6382(false, local19, local309, local28);
	}

	@OriginalMember(owner = "client!bq", name = "a", descriptor = "(IBI)Z")
	public static boolean method698(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
