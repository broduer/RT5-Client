...
public final class Static540 {
	...
	public static boolean method6543(@OriginalArg(1) char arg0) {
		if (Character.isISOControl(arg0)) {
			return false;
		} else if (Static596.method7822(arg0)) {
			return true;
		} else {
	...
	public static void method6544(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		@Pc(16) Class2_Sub2_Sub2 local16 = Static440.method5970(1, (long) arg1);
		local16.method202();
		local16.anInt197 = arg0;
	}

	@OriginalMember(owner = "client!r", name = "a", descriptor = "(Ljava/lang/String;BILjava/lang/String;)I")
	public static int method6545(@OriginalArg(0) String arg0, @OriginalArg(2) int arg1, @OriginalArg(3) String arg2) {
		...
		while (local11 - local22 < local6 || local9 > local13 - local24) {
			...
			local22 = Static499.method6677(local62);
			local24 = Static499.method6677(local77);
			local62 = Static322.method9443(arg1, local62);
			local77 = Static322.method9443(arg1, local77);
			if (local62 != local77 && Character.toUpperCase(local62) != Character.toUpperCase(local77)) {
				...
				if (local77 != local62) {
					return Static511.method6777(arg1, local62) - Static511.method6777(arg1, local77);
				}
			}
		}
		...
		for (@Pc(151) int local151 = 0; local151 < local149; local151++) {
			...
			if (local180 != local184 && Character.toUpperCase(local180) != Character.toUpperCase(local184)) {
				...
				if (local180 != local184) {
					return Static511.method6777(arg1, local180) - Static511.method6777(arg1, local184);
				}
			}
		}
		...
		for (@Pc(246) int local246 = 0; local246 < local149; local246++) {
			...
			if (local251 != local255) {
				return Static511.method6777(arg1, local251) - Static511.method6777(arg1, local255);
			}
		}
		return 0;
	}
	...
	public static void method6546(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) String arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		@Pc(7) Class8_Sub3 local7 = new Class8_Sub3();
		local7.anInt962 = arg0;
		local7.anInt958 = arg6;
	...
	public static boolean method6547(@OriginalArg(0) int arg0) {
