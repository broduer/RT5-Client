...
public final class Static540 {
	...
	public static boolean method4588(@OriginalArg(1) char arg0) {
		if (Character.isISOControl(arg0)) {
			return false;
		} else if (Static596.method5549(arg0)) {
			return true;
		} else {
	...
	public static void method4589(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		@Pc(16) Class2_Sub2_Sub2 local16 = Static440.method4204(1, (long) arg1);
		local16.method130();
		local16.anInt197 = arg0;
	}

	@OriginalMember(owner = "client!r", name = "a", descriptor = "(Ljava/lang/String;BILjava/lang/String;)I")
	public static int method4590(@OriginalArg(0) String arg0, @OriginalArg(2) int arg1, @OriginalArg(3) String arg2) {
		...
		while (local11 - local22 < local6 || local9 > local13 - local24) {
			...
			local22 = Static499.method4687(local62);
			local24 = Static499.method4687(local77);
			local62 = Static322.method6815(arg1, local62);
			local77 = Static322.method6815(arg1, local77);
			if (local62 != local77 && Character.toUpperCase(local62) != Character.toUpperCase(local77)) {
				...
				if (local77 != local62) {
					return Static511.method4768(arg1, local62) - Static511.method4768(arg1, local77);
				}
			}
		}
		...
		for (@Pc(151) int local151 = 0; local151 < local149; local151++) {
			...
			if (local180 != local184 && Character.toUpperCase(local180) != Character.toUpperCase(local184)) {
				...
				if (local180 != local184) {
					return Static511.method4768(arg1, local180) - Static511.method4768(arg1, local184);
				}
			}
		}
		...
		for (@Pc(246) int local246 = 0; local246 < local149; local246++) {
			...
			if (local251 != local255) {
				return Static511.method4768(arg1, local251) - Static511.method4768(arg1, local255);
			}
		}
		return 0;
	}
	...
	public static void method4591(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) String arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		...
		Static422.aClass130_9.method1902(local7);
	}

	@OriginalMember(owner = "client!r", name = "b", descriptor = "(II)Z")
	public static boolean method4592(@OriginalArg(0) int arg0) {
