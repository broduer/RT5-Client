...
public final class Static542 {
	...
	public static void method5041(@OriginalArg(0) Object[] arg0, @OriginalArg(2) long[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		if (arg2 >= arg3) {
			return;
		}
		...
		method5041(arg0, arg1, arg2, local14 - 1);
		method5041(arg0, arg1, local14 + 1, arg3);
	}

	@OriginalMember(owner = "client!rb", name = "a", descriptor = "(ILclient!hda;)V")
	public static void method5043(@OriginalArg(1) Class158 arg0) {
		if (arg0.anInt3820 == 5 && arg0.anInt3760 != -1) {
			Static485.method6794(arg0, Static163.aClass19_17);
		}
	}
}
