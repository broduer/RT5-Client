...
public final class Static545 {
	...
	public static void method5077(@OriginalArg(0) int[] arg0, @OriginalArg(2) int[] arg1) {
	...
	public static void method5078(@OriginalArg(1) String arg0) {
		if (arg0 == null) {
			return;
		}
		@Pc(11) String local11 = Static390.method3889(arg0);
		if (local11 == null) {
			return;
		}
		for (@Pc(22) int local22 = 0; local22 < Static327.anInt5392; local22++) {
			@Pc(27) String local27 = Static330.aStringArray25[local22];
			@Pc(31) String local31 = Static390.method3889(local27);
			if (Static585.method5436(arg0, local31, local27, local11)) {
				Static327.anInt5392--;
				...
				@Pc(118) Class153 local118 = Static668.method6208();
				@Pc(124) Class2_Sub19 local124 = Static293.method3000(Static86.aClass345_16, local118.aClass186_1);
				local124.aClass2_Sub21_Sub2_1.method5198(Static231.method2417(arg0));
				local124.aClass2_Sub21_Sub2_1.method5200(arg0);
				local118.method2339(local124);
				return;
			}
		}
	}
