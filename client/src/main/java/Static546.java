...
public final class Static546 {
	...
	public static Class184[] method5080() {
	...
	public static boolean method5081(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		if (arg1 >= 1000 && arg0 < 1000) {
			return true;
		} else if (arg1 >= 1000 || arg0 >= 1000) {
			return arg1 >= 1000 && arg0 >= 1000;
		} else if (Static348.method3585(arg0)) {
			return true;
		} else {
			return !Static348.method3585(arg1);
		}
	}

	@OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lclient!ha;I)V")
	public static void method5082(@OriginalArg(0) Class19 arg0) {
		@Pc(7) int local7 = 0;
		@Pc(9) int local9 = 0;
		...
		Static682.method6378(local9, local9 + 350, local7, Static680.anInt10289 + local7);
		...
		if (Static512.anInt7664 > 0) {
			...
			for (@Pc(119) int local119 = Static213.anInt3471; Static213.anInt3471 + local54 > local119 && Static512.anInt7664 > local119; local119++) {
				@Pc(128) String[] local128 = Static189.method1971(Static393.aStringArray32[local119], '\b');
				...
				for (@Pc(139) int local139 = 0; local139 < local128.length; local139++) {
					...
					Static437.aClass14_9.a((int) (local7 + local147), local9 + 350 - Static694.aClass381_13.anInt10036 - Static644.anInt9608 - (local119 + -Static213.anInt3471) * Static161.anInt2797 - 2, Static386.method3851(local128[local139]), -16777216, 1, -1);
				}
			}
		}
		Static665.aClass14_12.a((byte) -117, Static680.anInt10289 + local7 - 25, "Build: 667", -1, -16777216, local9 + 350 - 20);
		arg0.KA(local7, local9, Static680.anInt10289 + local7, local9 + 350);
		arg0.a(local9 + 350 - Static644.anInt9608, -1, local7, false, Static680.anInt10289);
		Static180.aClass14_3.a((int) (local7 + 10), local9 + 350 - Static42.aClass381_4.anInt10036 - 1, "--> " + Static386.method3851(Static110.aString19), -16777216, 1, -1);
		if (-29 <= -49) {
			anInt8244 = -2;
		}
		...
		arg0.a(12, local9 + 350 - Static42.aClass381_4.anInt10036 - 11, local65, (int) (Static42.aClass381_4.method6241("--> " + Static386.method3851(Static110.aString19).substring(0, Static594.anInt8776)) + local7 + 10), 2);
	}
}
