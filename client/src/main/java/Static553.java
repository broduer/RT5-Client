...
public final class Static553 {
	...
	public static void method5113(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(7) Class2_Sub25 local7 = null;
		for (@Pc(12) Class2_Sub25 local12 = (Class2_Sub25) Static159.aClass339_15.method5453(65280); local12 != null; local12 = (Class2_Sub25) Static159.aClass339_15.method5460()) {
		...
		if (local7 == null) {
			...
			if (arg3 >= 0 && arg6 >= 0 && Static720.anInt10859 > arg3 && arg6 < Static501.anInt7568) {
				Static293.method2997(local7);
			}
			Static159.aClass339_15.method5465(local7);
		}
	...
	public static void method5114() {
		Static627.aClass82_200.method1385();
	}
}
