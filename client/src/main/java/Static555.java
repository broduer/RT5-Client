...
public final class Static555 {
	...
	public static boolean method5121(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		return (arg0 & 0x8000) != 0;
	}

	@OriginalMember(owner = "client!ria", name = "a", descriptor = "(IIII)V")
	public static void method5122(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		@Pc(14) Class2_Sub2_Sub2 local14 = Static440.method4204(11, (long) arg2);
		local14.method130();
