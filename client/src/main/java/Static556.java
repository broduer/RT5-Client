...
public final class Static556 {
	...
	public static Class158 method7306(@OriginalArg(1) Class158 arg0) {
		...
		for (@Pc(35) Node_Sub4 local35 = (Node_Sub4) local30.method7620(); local35 != null; local35 = (Node_Sub4) local30.method7617()) {
	...
	public static void method7308(@OriginalArg(0) Class19 arg0) {
		...
		if (Static156.aBoolean223 && Static594.anInt8801 < 2) {
			local63 = Static153.aString27 + Static32.aClass32_32.getLocalization(client.lang) + Static128.aString108 + " ->";
			...
			@Pc(55) SecondaryNode_Sub16 local55 = Static470.aClass2_Sub2_Sub16_10;
			if (local55 == null) {
				return;
			}
			...
			if (Static245.method8642(local55.anInt7335)) {
				local65 = client.objTypeList.get((int) local55.aLong233).anIntArray800;
			} else if (local55.anInt7338 != -1) {
				local65 = client.objTypeList.get(local55.anInt7338).anIntArray800;
			} else if (Static598.method7832(local55.anInt7335)) {
				@Pc(93) Node_Sub45 local93 = (Node_Sub45) Static18.aClass28_2.get((int) local55.aLong233);
				if (local93 != null) {
				...
				@Pc(131) LocType local131 = client.locTypeList.method3063((int) (local55.aLong233 >>> 32 & 0x7FFFFFFFL), 68);
		...
		if (Static594.anInt8801 > 2) {
			local63 = local63 + "<col=ffffff> / " + (Static594.anInt8801 - 2) + Static32.aClass32_25.getLocalization(client.lang);
		}
		...
		} else if (Static71.aClass158_2 != null && client.game == Static673.runescapeGame) {
	...
	public static Node_Sub22 method7310(@OriginalArg(0) int arg0, @OriginalArg(2) boolean arg1) {
		@Pc(19) long local19 = arg0 | (arg1 ? Integer.MIN_VALUE : 0);
		return (Node_Sub22) Static286.aClass28_23.get(local19);
	}
}
