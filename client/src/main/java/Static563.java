...
public final class Static563 {
	...
	public static final Class225 aClass225_207 = new Class225(127, 6);
				...
				for (local6 = 0; local6 < Static619.anInt1566; local6++) {
					for (local9 = 0; local9 < Static662.anInt9843; local9++) {
						if (Static478.aClass291ArrayArrayArray3[local3][local6][local9] != null) {
							Static478.aClass291ArrayArrayArray3[local3][local6][local9].method4602();
						}
				...
				for (local6 = 0; local6 < Static619.anInt1566; local6++) {
					for (local9 = 0; local9 < Static662.anInt9843; local9++) {
						if (Static420.aClass291ArrayArrayArray2[local3][local6][local9] != null) {
							Static420.aClass291ArrayArrayArray2[local3][local6][local9].method4602();
						}
