...
public final class Static57 {
	...
	public static void method740(@OriginalArg(1) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) Class330 arg2) {
	...
	public static short[] method745(@OriginalArg(0) short[] arg0) {
		if (arg0 == null) {
			return null;
		} else {
			@Pc(19) short[] local19 = new short[arg0.length];
			Static734.method5446(arg0, 0, local19, 0, arg0.length);
			return local19;
		}
	}

	@OriginalMember(owner = "client!bt", name = "a", descriptor = "(ILjava/lang/String;)V")
	public static void method746(@OriginalArg(1) String arg0) {
		...
		for (@Pc(28) int local28 = 0; local28 < local24; local28++) {
			...
			if (local35.aString9 != null && local35.aString9.equalsIgnoreCase(arg0) && (Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2 == local35 && (Static717.anInt10822 & 0x10) != 0 || (Static717.anInt10822 & 0x8) != 0)) {
				@Pc(75) Class2_Sub19 local75 = Static293.method3000(Static664.aClass345_115, Static405.aClass153_2.aClass186_1);
				local75.aClass2_Sub21_Sub2_1.method5171(local26[local28]);
				local75.aClass2_Sub21_Sub2_1.method5187(Static450.anInt6819);
				local75.aClass2_Sub21_Sub2_1.method5182(Static162.anInt2799);
				local75.aClass2_Sub21_Sub2_1.method5217(0);
				local75.aClass2_Sub21_Sub2_1.method5179(Static77.anInt1614);
				Static405.aClass153_2.method2339(local75);
				Static147.method1617(0, local35.anIntArray878[0], local35.method6693((byte) 65), true, local35.anIntArray879[0], 0, -2, local35.method6693((byte) 81));
				local22 = true;
				break;
			}
		}
		if (!local22) {
			Static67.method4240(Static32.aClass32_21.method429(Static51.anInt1052) + arg0);
		}
	...
	public static void method747(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2) {
		if (arg2.length() > 320 || !Static470.method4471()) {
			return;
		}
