...
public final class Static57 {
	...
	public static short[] method1230(@OriginalArg(0) short[] arg0) {
		if (arg0 == null) {
			...
			Static735.method7699(arg0, 0, local19, 0, arg0.length);
			return local19;
		}
	}
	...
	public static void method1231(@OriginalArg(1) String arg0) {
		if (!Static156.aBoolean223 || (Static717.anInt10851 & 0x18) == 0) {
			return;
		}
		@Pc(22) boolean local22 = false;
		@Pc(24) int local24 = Static338.anInt5584;
		...
		for (@Pc(28) int local28 = 0; local28 < local24; local28++) {
			...
			if (local35.aString9 != null && local35.aString9.equalsIgnoreCase(arg0) && (Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2 == local35 && (Static717.anInt10851 & 0x10) != 0 || (Static717.anInt10851 & 0x8) != 0)) {
				...
				Static147.method2419(0, local35.anIntArray878[0], local35.method9309((byte) 65), true, local35.anIntArray879[0], 0, -2, local35.method9309((byte) 81));
				local22 = true;
				break;
			}
		}
	...
	public static void method1232(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2) {
		if (arg2.length() > 320 || !Static470.method6394()) {
			return;
		}
		Static367.method5275();
