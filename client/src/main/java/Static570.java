...
public final class Static570 {
	...
	public static long method5317(@OriginalArg(0) long arg0, @OriginalArg(1) long arg1) {
		return arg0 & arg1;
	}

	@OriginalMember(owner = "client!rv", name = "a", descriptor = "(BLclient!ha;)V")
	public static void method5318(@OriginalArg(1) Class19 arg0) {
		...
		for (@Pc(14) int local14 = 0; local14 < Static552.anIntArray753.length; local14++) {
			...
			@Pc(24) Class381 local24 = Static238.method2501(local19, Static237.aClass330_87);
			@Pc(32) Class14 local32 = arg0.a(local24, Static735.method6776(Static555.aClass330_106, local19), true);
	...
	public static Class27 method5319() {
		try {
	...
	public static int method5320(@OriginalArg(0) int arg0) {
		return arg0 & 0xFF;
	}

	@OriginalMember(owner = "client!rv", name = "b", descriptor = "(I)Lclient!ge;")
	public static Class2_Sub21 method5321() {
		...
		local8.method5151(Static219.anIntArray287[0]);
		local8.method5151(Static219.anIntArray287[1]);
		local8.method5151(Static219.anIntArray287[2]);
		local8.method5151(Static219.anIntArray287[3]);
		return local8;
	}

	@OriginalMember(owner = "client!rv", name = "a", descriptor = "(I)V")
	public static void method5322() {
		Static473.aClass82_157.method1385();
		Static312.aClass82_106.method1385();
		Static449.aClass82_146.method1385();
		Static444.aClass82_145.method1385();
	}
}
