...
public final class Static571 {
	...
	public static boolean method5330(@OriginalArg(1) int arg0) {
		if (Static132.aBooleanArray5[arg0]) {
			return true;
		} else if (Static666.aClass330_118.method5371(arg0)) {
			@Pc(25) int local25 = Static666.aClass330_118.method5372(arg0);
			if (local25 == 0) {
			...
			for (@Pc(53) int local53 = 0; local53 < local25; local53++) {
				if (Static453.aClass158ArrayArray2[arg0][local53] == null) {
					@Pc(66) byte[] local66 = Static666.aClass330_118.method5359(local53, arg0);
					if (local66 != null) {
						...
						local78.method2428(new Class2_Sub21(local66));
					}
				}
			}
			Static132.aBooleanArray5[arg0] = true;
