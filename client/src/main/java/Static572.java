...
public final class Static572 {
	...
	public static int a(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
	...
	public static void b(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		@Pc(11) int local11 = Static42.aClass381_4.method6241(Static32.aClass32_24.method429(Static51.anInt1052));
		@Pc(68) int local68;
		@Pc(27) int local27;
		if (Static236.aBoolean304) {
			for (@Pc(18) Class2_Sub2_Sub4 local18 = (Class2_Sub2_Sub4) Static350.aClass192_8.method3017(); local18 != null; local18 = (Class2_Sub2_Sub4) Static350.aClass192_8.method3015()) {
				if (local18.anInt1534 == 1) {
					local27 = Static249.method2559((Class2_Sub2_Sub16) local18.aClass192_3.aClass2_Sub2_36.aClass2_Sub2_66);
				} else {
					local27 = Static192.method1980(local18);
				}
				if (local27 > local11) {
					local11 = local27;
				}
			...
			for (@Pc(74) Class2_Sub2_Sub16 local74 = (Class2_Sub2_Sub16) Static693.aClass339_79.method5453(65280); local74 != null; local74 = (Class2_Sub2_Sub16) Static693.aClass339_79.method5460()) {
				local27 = Static249.method2559(local74);
				if (local11 < local27) {
					local11 = local27;
				}
			}
