...
public final class Static576 {
	...
	public static boolean method7616(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		return Static69.method6342(arg1, arg0) & (Static526.method7080(arg0, arg1) | (arg1 & 0x2000) != 0 | Static220.method3197(arg1, arg0));
	}

	@OriginalMember(owner = "client!sba", name = "b", descriptor = "(Z)Z")
	public static boolean method7618() {
		try {
			if (Static96.anInt10199 == 2) {
				if (Static62.aClass2_Sub8_3 == null) {
					Static62.aClass2_Sub8_3 = Static728.method1153(Static676.aClass332_121, Static99.anInt2086, Static174.anInt2927);
					if (Static62.aClass2_Sub8_3 == null) {
						return false;
					}
				}
				...
				if (local36.method944(Static12.aClass123_4, Static86.aClass332_13, Static62.aClass2_Sub8_3)) {
					Static581.aClass2_Sub6_Sub1_3 = local36;
					Static581.aClass2_Sub6_Sub1_3.method933();
					@Pc(65) int local65;
					if (Static611.anInt9361 <= 0) {
						Static96.anInt10199 = 0;
						Static581.aClass2_Sub6_Sub1_3.method916(Static24.anInt597);
						...
						Static96.anInt10199 = 3;
						Static581.aClass2_Sub6_Sub1_3.method916(Static24.anInt597 < Static611.anInt9361 ? Static24.anInt597 : Static611.anInt9361);
						for (local65 = 0; local65 < Static286.anIntArray358.length; local65++) {
							Static581.aClass2_Sub6_Sub1_3.method926(Static286.anIntArray358[local65], local65);
							Static286.anIntArray358[local65] = 255;
						}
