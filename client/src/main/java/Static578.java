...
public final class Static578 {
	...
	public static Class8_Sub2_Sub1 method5387(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class arg3) {
	...
	public static void method5388(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		if (arg2 == 1003) {
			Static472.method4508(Static298.aClass242_8, arg1, arg0);
		} else if (arg2 == 1001) {
			Static472.method4508(Static39.aClass242_3, arg1, arg0);
			return;
		} else if (arg2 == 1006) {
			Static472.method4508(Static337.aClass242_9, arg1, arg0);
			return;
		} else if (arg2 == 1009) {
			Static472.method4508(Static515.aClass242_12, arg1, arg0);
			return;
		} else if (arg2 == 1004) {
			Static472.method4508(Static31.aClass242_2, arg1, arg0);
			return;
		}
	}
}
