...
public final class Static587 {
	...
	public static Class19 method5452(@OriginalArg(0) Interface4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) Canvas arg3) {
			...
			while (Static343.aClass297_Sub1Array2.length > Static419.anInt6434) {
				...
				if (local26 != null && local26.anInt7570 == -1) {
					if (Static522.aClass2_Sub12_4 == null) {
						Static522.aClass2_Sub12_4 = Static151.aClass226_20.method3702(local26.aString90);
					}
	...
	public static Class273[] method5464() {
		if (Static679.aClass273Array1 == null) {
			@Pc(20) Class273[] local20 = Static673.method6274(Static446.aClass390_6, true);
			@Pc(24) Class273[] local24 = new Class273[local20.length];
			@Pc(26) int local26 = 0;
			@Pc(31) int local31 = Static400.aClass2_Sub34_28.aClass57_Sub18_1.method4073();
			@Pc(112) int local112;
			...
			Static734.method5445(local24, 0, Static679.aClass273Array1, 0, local26);
			...
			Static510.method4761(Static679.aClass273Array1, local175);
		}
