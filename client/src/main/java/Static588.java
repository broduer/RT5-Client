...
public final class Static588 {
	...
	public static boolean method5466(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1) {
		return arg0 | arg1;
	}

	@OriginalMember(owner = "client!sj", name = "a", descriptor = "(I)V")
	public static void method5467() {
		Static425.aClass19_13.xa(((float) Static400.aClass2_Sub34_28.aClass57_Sub22_1.method4767() * 0.1F + 0.7F) * Static318.aFloat210);
		...
		Static425.aClass19_13.a(Static425.aClass67_6);
	}

	@OriginalMember(owner = "client!sj", name = "a", descriptor = "(ZIII)Z")
	public static boolean method5468(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		if (!Static18.aBoolean20 || !Static29.aBoolean60) {
			...
			if (-Static675.anInt10155 == local37) {
				...
				if (Static172.method1811(local64 + Static340.anInt5586 - 1, local68 + 1, Static246.aClass178Array1[arg1].a(arg0 + 1, arg2 + 1, (byte) -118), Static246.aClass178Array1[arg1].a(arg0 + 1, arg2, (byte) -118), Static246.aClass178Array1[arg1].a(arg0, arg2, (byte) -118), local68 + Static340.anInt5586 - 1, Static340.anInt5586 + local68 + -1, local64 + 1, local64 + 1) && Static172.method1811(Static340.anInt5586 + local64 - 1, local68 + 1, Static246.aClass178Array1[arg1].a(arg0, arg2 + 1, (byte) -118), Static246.aClass178Array1[arg1].a(arg0 + 1, arg2 + 1, (byte) -118), Static246.aClass178Array1[arg1].a(arg0, arg2, (byte) -118), local68 + 1, Static340.anInt5586 + local68 + -1, local64 + 1, Static340.anInt5586 + -1 + local64)) {
					Static298.anInt4811++;
	...
	public static synchronized long method5469() {
