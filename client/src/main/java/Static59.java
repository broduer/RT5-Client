...
public final class Static59 {
	...
	public static int method3776(@OriginalArg(0) Class2_Sub21_Sub2 arg0) {
		@Pc(10) int local10 = arg0.method5221(2);
		@Pc(22) int local22;
		if (local10 == 0) {
			local22 = 0;
		} else if (local10 == 1) {
			local22 = arg0.method5221(5);
		} else if (local10 == 2) {
			local22 = arg0.method5221(8);
		} else {
			local22 = arg0.method5221(11);
		}
		return local22;
	}
}
