...
public final class Static591 {
	...
	public static void method5501(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3) {
		if (Static180.anInt2995 <= arg0 && Static111.anInt2219 >= arg0) {
			@Pc(30) int local30 = Static670.method6229(Static724.anInt10930, Static273.anInt4395, arg2);
			@Pc(36) int local36 = Static670.method6229(Static724.anInt10930, Static273.anInt4395, arg3);
			Static87.method1107(local36, local30, arg1, arg0);
		}
	}

	@OriginalMember(owner = "client!sl", name = "a", descriptor = "(IZ[B)I")
	public static int method5502(@OriginalArg(0) int arg0, @OriginalArg(2) byte[] arg1) {
		return Static12.method3630(arg0, 0, arg1);
	}
}
