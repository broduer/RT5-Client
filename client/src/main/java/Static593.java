...
public final class Static593 {
	...
	public static String method5519(@OriginalArg(1) boolean arg0, @OriginalArg(2) int arg1) {
		return arg0 && arg1 >= 0 ? Static102.method1288(false, arg1, 10, arg0) : Integer.toString(arg1);
	}

	@OriginalMember(owner = "client!sm", name = "a", descriptor = "(II)I")
	public static int method5520(@OriginalArg(1) int arg0) {
		return arg0 >>> 8;
	}
}
