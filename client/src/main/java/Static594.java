...
public final class Static594 {
	...
	public static final SoftLruHashTable aClass82_193 = new SoftLruHashTable(128, 4);

	@OriginalMember(owner = "client!sn", name = "h", descriptor = "I")
	public static int anInt8800 = 0;

	@OriginalMember(owner = "client!sn", name = "j", descriptor = "I")
	public static int anInt8801 = 0;

	@OriginalMember(owner = "client!sn", name = "a", descriptor = "(II)Z")
	public static boolean method7789(@OriginalArg(0) int arg0) {
