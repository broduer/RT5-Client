...
public final class Static595 {
	...
	public static void method7814(@OriginalArg(1) String arg0, @OriginalArg(2) boolean arg1, @OriginalArg(3) int arg2) {
		...
		if (arg2 == 0) {
			...
			label216: {
				try {
					var14 = true;
					Static163.aClass19_17 = Static255.method3612(Static124.aClass332_20, Static56.anInterface4_3, arg2, Static434.aCanvas7, Static400.aClass2_Sub34_28.aClass57_Sub13_1.method4380() * 2);
					if (arg0 != null) {
						local57.GA(0);
					...
					if (Static163.aClass19_17.method7956()) {
						...
						try {
							local141 = Static292.aClass2_Sub43_2.anInt7633 > 256;
	...
	public static Class52 method7818(@OriginalArg(0) Class2_Sub21 arg0, @OriginalArg(1) Class384 arg1) {
		...
		if (local47) {
			...
			for (local213 = 0; local213 < 4; local213++) {
				if (local181[local213] != 15) {
					local10.aShortArray11[local181[local213]] = (short) arg0.method7389();
				}
			}
		}
		if (local57) {
			local178 = arg0.method7403();
			local181 = new int[] { local178 & 0xF, local178 >> 4 & 0xF };
			for (local213 = 0; local213 < 2; local213++) {
				if (local181[local213] != 15) {
					local10.aShortArray10[local181[local213]] = (short) arg0.method7389();
				}
			}
		}
		return local10;
