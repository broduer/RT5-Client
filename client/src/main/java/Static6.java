...
public final class Static6 {
	...
	public static void method107(@OriginalArg(1) int arg0, @OriginalArg(2) Class1 arg1, @OriginalArg(3) Class23 arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) Class158 arg5, @OriginalArg(7) int arg6) {
		...
		if (Static511.anInt7668 == 4) {
			...
			local15 = (int) Static171.aFloat64 + Static29.anInt726 & 0x3FFF;
		}
		@Pc(37) int local37 = Math.max(arg5.anInt3813 / 2, arg5.anInt3756 / 2) + 10;
		...
		arg2.method8202(local98 + arg5.anInt3813 / 2 + arg6 - arg2.method8210() / 2, arg5.anInt3756 / 2 + arg0 - local109 + -(arg2.method8199() / 2), arg1, arg6, arg0);
	}
}
