...
public final class Static60 {
	...
	public static byte[] method792(@OriginalArg(1) Object arg0, @OriginalArg(3) int arg1) {
		if (arg0 == null) {
			return null;
		} else if (arg0 instanceof byte[]) {
			@Pc(14) byte[] local14 = (byte[]) arg0;
			return Static585.method5428(arg1, local14);
		} else if (arg0 instanceof Class175) {
			@Pc(32) Class175 local32 = (Class175) arg0;
			return local32.method2706(arg1);
		} else {
	...
	public static void method793(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (Static400.aClass2_Sub34_28.aClass57_Sub29_1.method5612() == 0) {
			Static668.method6207(false);
		} else {
			Static114.anInt2256 = Static400.aClass2_Sub34_28.aClass57_Sub29_1.method5612();
			Static32.method432(0, true);
		}
		Static696.aBoolean784 = arg1;
		Static529.anInt8089 = arg2;
		Static227.anInt3694 = arg3;
		Static30.method3554(arg0);
		if (arg4 != -11493) {
			aBoolean86 = false;
		}
	}
