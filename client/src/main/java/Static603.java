...
public final class Static603 {
	...
	public static void method5596() {
		Static178.method1859(Static109.aClass158_3);
		Static181.anInt3003++;
		if (Static702.aBoolean797 && Static343.aBoolean428) {
			@Pc(30) int local30 = 0;
			@Pc(32) int local32 = 0;
			if (Static137.aBoolean210) {
				local30 = Static130.method1486();
				local32 = Static422.method4077();
			}
			@Pc(46) int local46 = local30 + Static189.aClass120_1.method6319();
			@Pc(52) int local52 = Static189.aClass120_1.method6320() + local32;
			...
			if (Static189.aClass120_1.method6310()) {
				...
				if (Static172.aBoolean246) {
					...
					if (Static327.aClass158_7 != null && Static84.method1077(Static109.aClass158_3) != null) {
						Static710.method4723(Static109.aClass158_3, Static327.aClass158_7);
					}
				} else if ((Static219.anInt3549 == 1 || Static204.method2174()) && Static594.anInt8777 > 2) {
					Static455.method4327(Static378.anInt5941 + Static655.anInt9763, Static115.anInt2258 + Static150.anInt2631);
				} else if (Static77.method998()) {
					Static455.method4327(Static655.anInt9763 + Static378.anInt5941, Static115.anInt2258 + Static150.anInt2631);
				}
	...
	public static void method5599(@OriginalArg(1) Class2_Sub20 arg0, @OriginalArg(2) Class19 arg1, @OriginalArg(3) Class105 arg2) {
		@Pc(8) Class23 local8 = arg2.method1626(arg1);
		if (local8 == null) {
			return;
		}
		@Pc(15) int local15 = local8.c();
		if (local8.d() > local15) {
			local15 = local8.d();
		}
		...
		if (arg2.aString25 != null) {
			local36 = Static154.aClass381_6.method6237(Static37.aStringArray5, (int[]) null, (Class23[]) null, arg2.aString25);
			for (local56 = 0; local56 < local36; local56++) {
				...
				local78 = Static142.aClass327_1.method5310(local61);
				if (local78 > local38) {
					local38 = local78;
				}
			}
			local40 = Static142.aClass327_1.method5307() * local36 + Static142.aClass327_1.method5309() / 2;
		}
		...
		local8.a((float) local31 + (float) local15 / 2.0F, (float) local34 + (float) local15 / 2.0F, 4096, local78);
		...
		if (arg2.aString25 != null) {
			...
			local259 = Static142.aClass327_1.method5307() * local36 + local163 + 3;
			if (arg2.anInt2605 != 0) {
				arg1.a(local257 - local246, local259 - local163, local163, (byte) 116, (int) local246, arg2.anInt2605);
			}
			if (arg2.anInt2608 != 0) {
				arg1.a(local163, arg2.anInt2608, local257 - local246, local259 - local163, (byte) -64, local246);
			}
			for (@Pc(333) int local333 = 0; local333 < local36; local333++) {
				...
				Static142.aClass327_1.method5311(arg1, local338, local56, local163, arg2.anInt2592);
				local163 += Static142.aClass327_1.method5307();
			}
		}
		...
		Static551.aClass339_54.method5465(local393);
	}
}
