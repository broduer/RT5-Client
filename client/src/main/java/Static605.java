...
public final class Static605 {
	...
	public static void method5609(@OriginalArg(1) Class287 arg0) {
		...
		if (arg0 == Static704.aClass287_17) {
			...
			local42 = local8.method5191();
			local46 = local8.method5191();
			local52 = local8.method5191();
			if (Static497.aClass28_35 != null) {
				@Pc(69) Class2_Sub17 local69 = (Class2_Sub17) Static497.aClass28_35.method373((long) (Static87.anInt1810 << 28 | local25 << 14 | local38));
				if (local69 != null) {
					for (@Pc(77) Class2_Sub15 local77 = (Class2_Sub15) local69.aClass339_12.method5453(65280); local77 != null; local77 = (Class2_Sub15) local69.aClass339_12.method5460()) {
						if ((local42 & 0x7FFF) == local77.anInt1958 && local77.anInt1959 == local46) {
							local77.a((byte) 39);
							local77.anInt1959 = local52;
							Static2.method30(Static87.anInt1810, local25, local38, local77);
							break;
						}
					}
					if (local34 >= 0 && local21 >= 0 && Static720.anInt10859 > local34 && Static501.anInt7568 > local21) {
						Static468.method5395(Static87.anInt1810, local21, local34);
					}
				}
			}
			return;
		...
		if (Static379.aClass287_12 == arg0) {
			local15 = local8.method5183();
			local21 = local15 >> 2;
			local25 = Static310.anIntArray379[local21];
			local34 = local8.method5205();
			local38 = local8.method5185();
			local42 = Static626.anInt9476 + (local38 >> 4 & 0x7);
			local46 = (local38 & 0x7) + Static270.anInt4354;
			local52 = local8.method5181();
			if (local21 == 11) {
				local21 = 10;
			}
			@Pc(210) Class54 local210 = Static354.aClass142_4.method2158(local52, 87);
			local212 = 0;
			...
			if ((local34 & 0x1) == 1) {
				Static296.method3026((Class150) null, Static87.anInt1810, local25, local42, local46);
			} else {
				@Pc(278) int[] local278 = null;
				if ((local34 & 0x2) == 2) {
					local278 = new int[local212];
					for (local290 = 0; local290 < local212; local290++) {
						local278[local290] = local8.method5191();
					}
				}
				...
				if ((local34 & 0x4) == 4) {
					...
					for (local322 = 0; local322 < local217; local322++) {
						local310[local322] = (short) local8.method5191();
					}
				}
				...
				if ((local34 & 0x8) == 8) {
					...
					for (local353 = 0; local353 < local219; local353++) {
						local343[local353] = (short) local8.method5191();
					}
				}
				Static296.method3026(new Class150((long) Static356.aLong177++, local278, local310, local343), Static87.anInt1810, local25, local42, local46);
			}
		} else if (arg0 == Static420.aClass287_13) {
			local15 = local8.method5215();
			if (local15 == 65535) {
				local15 = -1;
			}
			local21 = local8.method5183();
			local25 = Static626.anInt9476 + (local21 >> 4 & 0x7);
			local34 = (local21 & 0x7) + Static270.anInt4354;
			local38 = local8.method5205();
			local42 = local38 >> 2;
			local46 = local38 & 0x3;
			local52 = Static310.anIntArray379[local42];
			Static198.method2058(Static87.anInt1810, local34, local42, local15, local25, local46, local52);
		} else if (arg0 == Static328.aClass287_10) {
			local15 = local8.method5191();
			local21 = local8.method5205();
			Static354.aClass142_4.method2158(local15, 82).method804(local21);
		} else {
			@Pc(537) int local537;
			if (arg0 == Static481.aClass287_15) {
				...
				local46 = local38 & 0x7;
				local52 = local8.method5205();
				local537 = local8.method5205();
				local212 = local8.method5191();
				if (local21 >= 0 && local25 >= 0 && local21 < Static720.anInt10859 && Static501.anInt7568 > local25) {
					...
					if (local21 - local217 <= Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.anIntArray879[0] && local217 + local21 >= Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.anIntArray879[0] && Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.anIntArray878[0] >= local25 - local217 && local217 + local25 >= Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.anIntArray878[0]) {
						Static165.method1750(local537, local52, local34, local46, local212, local42 + (local25 << 8) + (Static87.anInt1810 << 24) + (local21 << 16));
					}
				}
				...
				local52 = local8.method5196();
				if (Static55.method733(Static117.anInt2282) || local21 >= 0 && local25 >= 0 && Static720.anInt10859 > local21 && Static501.anInt7568 > local25) {
					Static553.method5113(local42, local52, local46, local21, Static87.anInt1810, local38, local25);
				}
			} else {
				@Pc(812) int local812;
				if (arg0 == Static3.aClass287_1) {
					...
					local52 = local8.method5186() + local21;
					local537 = local25 + local8.method5186();
					local212 = local8.method5165();
					local217 = local8.method5165();
					local219 = local8.method5191();
					local812 = local8.method5205();
					if (local773) {
						local812 = (byte) local812;
					} else {
						local812 *= 4;
					}
					local290 = local8.method5205() * 4;
					local322 = local8.method5191();
					local353 = local8.method5191();
					@Pc(843) int local843 = local8.method5205();
					@Pc(847) int local847 = local8.method5191();
					if (local843 == 255) {
						local843 = -1;
					}
					if (local21 >= 0 && local25 >= 0 && local21 < Static720.anInt10859 * 2 && local25 < Static720.anInt10859 * 2 && local52 >= 0 && local537 >= 0 && Static501.anInt7568 * 2 > local52 && Static501.anInt7568 * 2 > local537 && local219 != 65535) {
						...
						if (local212 != 0 && local46 != -1) {
							...
							if (local212 >= 0) {
								local957 = local212 - 1;
								@Pc(964) Class2_Sub45 local964 = (Class2_Sub45) Static18.aClass28_2.method373((long) local957);
								if (local964 != null) {
							...
							if (local948 != null) {
								@Pc(991) Class289 local991 = local948.method6708();
						...
						local1053.a(Static102.method1286(Static87.anInt1810, -29754, local537, local52) - local290, local322 + Static333.anInt5455, local537, local52);
						Static505.aClass339_77.method5465(new Class2_Sub2_Sub15(local1053));
					}
				} else if (Static77.aClass287_5 == arg0) {
					local15 = local8.method5196();
					local21 = local8.method5183();
					...
					if (local15 != Static312.anInt5000) {
						...
						if (local1151 || Static55.method733(Static117.anInt2282)) {
							Static2.method30(Static87.anInt1810, local34, local42, new Class2_Sub15(local46, local52));
							if (local1151) {
								Static468.method5395(Static87.anInt1810, local25, local38);
							}
						}
					}
					...
					if (local21 >= 0 && local25 >= 0 && Static720.anInt10859 > local21 && Static501.anInt7568 > local25) {
						...
						if (Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.anIntArray879[0] >= local21 - local217 && local217 + local21 >= Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.anIntArray879[0] && Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.anIntArray878[0] >= local25 - local217 && Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.anIntArray878[0] <= local25 + local217) {
							Static179.method1885(local46, local52, local42 + (local25 << 8) + (Static87.anInt1810 << 24) + (local21 << 16), local212, local537, local34);
						}
					}
					...
					@Pc(1389) Class2_Sub17 local1389 = (Class2_Sub17) Static497.aClass28_35.method373((long) (local34 << 14 | Static87.anInt1810 << 28 | local42));
					if (local1389 != null) {
						for (@Pc(1399) Class2_Sub15 local1399 = (Class2_Sub15) local1389.aClass339_12.method5453(65280); local1399 != null; local1399 = (Class2_Sub15) local1389.aClass339_12.method5460()) {
							if (local1399.anInt1958 == (local15 & 0x7FFF)) {
								local1399.a((byte) 111);
								break;
							}
						}
						if (local1389.aClass339_12.method5456()) {
							local1389.a((byte) 127);
						}
					...
					local34 = local8.method5191();
					local38 = local8.method5205();
					local42 = local8.method5192();
					@Pc(1511) String local1511 = local8.method5167();
					Static540.method4591(Static87.anInt1810, local34, local1511, local42, local38, local21, local25);
					...
					local38 = local25 + local8.method5186();
					local42 = local34 + local8.method5186();
					local46 = local8.method5165();
					local52 = local8.method5191();
					local537 = local8.method5205() * 4;
					local212 = local8.method5205() * 4;
					local217 = local8.method5191();
					local219 = local8.method5191();
					local812 = local8.method5205();
					local290 = local8.method5191();
					if (local812 == 255) {
						local812 = -1;
					}
					if (local25 >= 0 && local34 >= 0 && Static720.anInt10859 > local25 && local34 < Static501.anInt7568 && local38 >= 0 && local42 >= 0 && Static720.anInt10859 > local38 && local42 < Static501.anInt7568 && local52 != 65535) {
						...
						local1728.a(Static102.method1286(Static87.anInt1810, -29754, local42, local38) - local212, Static333.anInt5455 + local217, local42, local38);
						Static505.aClass339_77.method5465(new Class2_Sub2_Sub15(local1728));
					}
				} else if (Static210.aClass287_9 == arg0) {
					local15 = local8.method5210();
					local21 = Static626.anInt9476 + (local15 >> 4 & 0x7);
					local25 = (local15 & 0x7) + Static270.anInt4354;
					local34 = local8.method5205();
					local38 = local34 >> 2;
					local42 = local34 & 0x3;
					local46 = Static310.anIntArray379[local38];
					if (Static55.method733(Static117.anInt2282) || local21 >= 0 && local25 >= 0 && Static720.anInt10859 > local21 && local25 < Static501.anInt7568) {
						Static553.method5113(local42, -1, local46, local21, Static87.anInt1810, local38, local25);
					}
					...
					local38 = Static691.anInt10367 + local34;
					local42 = local8.method5196();
					local46 = local8.method5191();
					@Pc(1886) boolean local1886 = local34 >= 0 && local21 >= 0 && local34 < Static720.anInt10859 && local21 < Static501.anInt7568;
					if (local1886 || Static55.method733(Static117.anInt2282)) {
						Static2.method30(Static87.anInt1810, local25, local38, new Class2_Sub15(local42, local46));
						if (local1886) {
							Static468.method5395(Static87.anInt1810, local21, local34);
						}
					}
					...
					local38 = local8.method5205();
					local42 = local8.method5191();
					local46 = local8.method5205();
					if (local21 >= 0 && local25 >= 0 && local21 < Static720.anInt10859 && Static501.anInt7568 > local25) {
						if (local34 == -1) {
							@Pc(2004) Class2_Sub2_Sub20 local2004 = (Class2_Sub2_Sub20) Static346.aClass28_29.method373((long) (local21 << 16 | local25));
							if (local2004 != null) {
								local2004.aClass8_Sub2_Sub1_Sub5_1.method4629();
								local2004.a((byte) 123);
								return;
							}
						} else {
							...
							if (local212 < 3 && Static441.method4209(local25, local21)) {
								local212++;
							}
							@Pc(2065) Class8_Sub2_Sub1_Sub5 local2065 = new Class8_Sub2_Sub1_Sub5(local34, local42, Static87.anInt1810, local212, local52, Static102.method1286(Static87.anInt1810, -29754, local537, local52) - local38, local537, local21, local21, local25, local25, local46, false);
							Static346.aClass28_29.method370((long) (local21 << 16 | local25), new Class2_Sub2_Sub20(local2065));
						}
					}
				} else {
					Static240.method2529((Throwable) null, "T3 - " + arg0);
