...
public final class Static607 {
	...
	public static Class332 aClass332_113;
	...
	public static byte[] method8168(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		@Pc(10) byte[] local10;
		if (arg2 > 0) {
	...
	public static boolean method8170() {
		return Static236.aBoolean305;
	}

	@OriginalMember(owner = "client!tca", name = "a", descriptor = "([BIIIIII[BI)V")
	public static void method8174(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) byte[] arg6, @OriginalArg(8) int arg7) {
