...
public final class Static607 {
	...
	public static byte[] method5770(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		@Pc(10) byte[] local10;
		if (arg2 > 0) {
		...
		local40.method6731();
		local40.method6732((long) (arg1 * 8), local10);
		@Pc(60) byte[] local60 = new byte[64];
		local40.method6733(local60);
		return local60;
	}

	@OriginalMember(owner = "client!tca", name = "bb", descriptor = "(I)Z")
	public static boolean method5772() {
		return Static236.aBoolean305;
	}

	@OriginalMember(owner = "client!tca", name = "a", descriptor = "([BIIIIII[BI)V")
	public static void method5776(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) byte[] arg6, @OriginalArg(8) int arg7) {
