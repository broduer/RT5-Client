...
public final class Static611 {
	...
	public static void method5811(@OriginalArg(1) int arg0) {
		@Pc(23) Class2_Sub2_Sub2 local23 = Static440.method4204(3, (long) arg0);
		local23.method133();
	}

	@OriginalMember(owner = "client!tfa", name = "c", descriptor = "(ZI)I")
	public static int method5812(@OriginalArg(1) int arg0) {
		@Pc(8) byte local8;
		if (arg0 > 12000) {
			local8 = 4;
	...
	public static void method5813(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) Class330 arg2) {
		Static184.method1912(0L, arg0, arg1, arg2);
	}
}
