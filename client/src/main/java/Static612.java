...
public final class Static612 {
	...
	public static int method5816(@OriginalArg(1) int arg0) {
		return arg0 & 0x7F;
	}

	@OriginalMember(owner = "client!tg", name = "a", descriptor = "(IIZII[FI)V")
	public static void method5817(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) float[] arg4, @OriginalArg(6) int arg5) {
		if (arg2 > 0 && !Static700.method6579(arg2)) {
			throw new IllegalArgumentException("");
		} else if (arg1 <= 0 || Static700.method6579(arg1)) {
			@Pc(41) int local41 = Static646.method6012(6408);
			@Pc(43) int local43 = 0;
