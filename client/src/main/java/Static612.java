...
public final class Static612 {
	...
	public static void method8245(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) float[] arg4, @OriginalArg(6) int arg5) {
		if (arg2 > 0 && !Static700.method9157(arg2)) {
			throw new IllegalArgumentException("");
		} else if (arg1 <= 0 || Static700.method9157(arg1)) {
			@Pc(41) int local41 = Static646.method8465(6408);
			@Pc(43) int local43 = 0;
