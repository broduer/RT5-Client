...
public final class Static616 {
	...
	public static void method5857(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1) {
		Static470.anInt7113 = -1;
		Static524.aClass153_3 = Static405.aClass153_1;
		Static299.anInt4825 = 1;
		Static238.method2504(false, arg1, false, arg0);
	}

	@OriginalMember(owner = "client!tia", name = "a", descriptor = "(BLclient!sb;)V")
	public static void method5858(@OriginalArg(1) Class330 arg0) {
		Static662.anInt9845 = arg0.method5354("p11_full");
		Static539.anInt8173 = arg0.method5354("p12_full");
		Static634.anInt9519 = arg0.method5354("b12_full");
	}
}
