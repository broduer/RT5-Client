...
public final class Static618 {
	...
	public static boolean method5885(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		return Static335.method3461(arg2, arg1) | (arg1 & 0x60000) != 0 || Static69.method4422(arg1, arg2);
	}

	@OriginalMember(owner = "client!tja", name = "a", descriptor = "(BLclient!ge;)V")
	public static void method5886(@OriginalArg(1) Class2_Sub21 arg0) {
		...
		@Pc(62) int local62 = arg0.method5191();
		if (local62 * 6 > arg0.aByteArray93.length - arg0.anInt8388) {
			return;
		}
		for (@Pc(80) int local80 = 0; local80 < local62; local80++) {
			@Pc(86) int local86 = arg0.method5191();
			@Pc(90) int local90 = arg0.method5158();
			if (local86 < Static511.anIntArray614.length && Static118.aBooleanArray4[local86] && (Static691.aClass210_1.method3462(local86).aChar5 != '1' || local90 >= -1 && local90 <= 1)) {
	...
	public static void method5887(@OriginalArg(0) Class330 arg0, @OriginalArg(1) int arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3) {
		if (arg3 <= 0) {
			Static611.method5813(arg2, arg1, arg0);
			return;
		}
		...
		Static190.anInt3112 = Static581.aClass2_Sub6_Sub1_3.method490() / arg3;
	...
	public static void method5888(@OriginalArg(0) Class2_Sub21_Sub2 arg0) {
	...
	public static Class114 method5889(@OriginalArg(0) int arg0, @OriginalArg(1) Class114 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) Class19 arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class152 arg8, @OriginalArg(10) int arg9, @OriginalArg(11) int arg10, @OriginalArg(12) int arg11) {
		...
		synchronized (Static354.aClass82_120) {
			local68 = (Class114) Static354.aClass82_120.method1390(local58);
		}
		if (local68 == null || arg6.b(local68.ua(), local12) != 0) {
			if (local68 != null) {
				local12 = arg6.c(local12, local68.ua());
			}
			...
			@Pc(169) int local169 = local162.method1450(0, 0, 0);
			...
			for (@Pc(175) int local175 = 0; local175 < 3; local175++) {
				...
				for (local187 = 0; local187 < local106; local187++) {
					...
					local173[local175][local187] = local162.method1450(local211, 0, local203);
				}
			}
			for (local181 = 0; local181 < 3; local181++) {
				...
				for (local211 = 0; local211 < local106; local211++) {
					if (local181 == 0) {
						local162.method1451(local169, local173[0][local211], local173[0][(local211 + 1) % local106], local310, (short) -1, local265, (byte) 1, (byte) -1);
					} else {
						local162.method1451(local173[local181 - 1][local211], local173[local181][(local211 + 1) % local106], local173[local181 - 1][(local211 + 1) % local106], local310, (short) -1, local265, (byte) 1, (byte) -1);
						local162.method1451(local173[local181 - 1][local211], local173[local181][local211], local173[local181][(local211 + 1) % local106], local310, (short) -1, local265, (byte) 1, (byte) -1);
					}
				}
			}
			local68 = arg6.a(local162, local12, Static722.anInt10905, 64, 768);
			@Pc(440) Class82 local440 = Static354.aClass82_120;
			synchronized (Static354.aClass82_120) {
				Static354.aClass82_120.method1384(local68, local58);
			}
		}
		...
		if (arg8 == null) {
			local68 = local68.a((byte) 3, local12, true);
