...
public final class Static619 {
	...
	public static void method952(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		@Pc(7) int local7 = 0;
		...
		if (arg0 >= Static724.anInt10930 && Static273.anInt4395 >= arg0) {
			local103 = Static670.method6229(Static180.anInt2995, Static111.anInt2219, arg1 + arg3);
			local112 = Static670.method6229(Static180.anInt2995, Static111.anInt2219, arg3 - arg1);
			Static696.method6473(local103, arg4, local112, Static723.anIntArrayArray266[arg0]);
		}
		while (local9 > 0) {
			if (local42 < 0) {
				while (local42 < 0) {
			...
			if (Static724.anInt10930 <= local112 && Static273.anInt4395 >= local103) {
				@Pc(224) int local224 = Static670.method6229(Static180.anInt2995, Static111.anInt2219, arg3 + local7);
				@Pc(233) int local233 = Static670.method6229(Static180.anInt2995, Static111.anInt2219, arg3 - local7);
				if (Static724.anInt10930 <= local103) {
					Static696.method6473(local224, arg4, local233, Static723.anIntArrayArray266[local103]);
				}
				if (Static273.anInt4395 >= local112) {
					Static696.method6473(local224, arg4, local233, Static723.anIntArrayArray266[local112]);
				}
			}
		}
	}
	...
	public static Class8_Sub2_Sub3 method954(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	public static void method956(@OriginalArg(0) int arg0) {
		...
		if (Static265.aByteArray44 != null) {
			...
			local18 = Static287.method2862(local25.method5207());
			Static430.aLong209 = local25.method5207();
		}
		if (local18 == null) {
			Static342.method3099(35);
		} else {
			Static238.method2504(false, local18, true, "");
		}
	}
}
