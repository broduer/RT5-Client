...
public final class Static619 {
	...
	public static final Class227 aClass227_34 = new Class227(68, 1);
	...
	public static void method1508(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		...
		@Pc(103) int local103;
		@Pc(112) int local112;
		if (arg0 >= Static724.anInt10959 && Static273.anInt4408 >= arg0) {
			local103 = Static670.method8739(Static180.anInt3004, Static111.anInt2228, arg1 + arg3);
			local112 = Static670.method8739(Static180.anInt3004, Static111.anInt2228, arg3 - arg1);
			Static696.method9044(local103, arg4, local112, Static723.anIntArrayArray266[arg0]);
		}
		while (local9 > 0) {
			if (local42 < 0) {
				while (local42 < 0) {
			...
			if (Static724.anInt10959 <= local112 && Static273.anInt4408 >= local103) {
				@Pc(224) int local224 = Static670.method8739(Static180.anInt3004, Static111.anInt2228, arg3 + local7);
				@Pc(233) int local233 = Static670.method8739(Static180.anInt3004, Static111.anInt2228, arg3 - local7);
				if (Static724.anInt10959 <= local103) {
					Static696.method9044(local224, arg4, local233, Static723.anIntArrayArray266[local103]);
				}
				if (Static273.anInt4408 >= local112) {
					Static696.method9044(local224, arg4, local233, Static723.anIntArrayArray266[local112]);
				}
			}
		}
	}
