...
public final class Static620 {
	...
	public static boolean method5890(@OriginalArg(1) int arg0) {
	...
	public static void method5891(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) Class1 arg2, @OriginalArg(4) Class19 arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class158 arg7) {
		@Pc(10) Class105 local10 = Static577.aClass246_4.method3966(arg4);
		if (local10 == null || !local10.aBoolean218 || !local10.method1623(Static34.aClass304_1)) {
			return;
		}
		@Pc(36) int local36;
		if (local10.anIntArray228 != null) {
			...
			@Pc(187) Class159 local187 = arg7.method2431(arg3);
			if (local187 != null) {
				Static141.method1575(arg3, local34, local10.anInt2610, local187.anIntArray303, local187.anIntArray302);
			}
			if (local10.anInt2603 > 0) {
				...
				for (local62 = 0; local62 < local34.length / 2 - 1; local62++) {
					...
					arg3.a(local66, local223, local231, local241, local10.anIntArray229[local10.aByteArray31[local62] & 0xFF], 1, arg2, arg1, arg5, local10.anInt2603, local10.anInt2587, local10.anInt2607);
				}
				...
				arg3.a(local66, local223, local231, local241, local10.anIntArray229[local10.aByteArray31[local10.aByteArray31.length - 1] & 0xFF], 1, arg2, arg1, arg5, local10.anInt2603, local10.anInt2587, local10.anInt2607);
			} else {
				for (local62 = 0; local62 < local34.length / 2 - 1; local62++) {
					arg3.a(local34[local62 * 2], local34[local62 * 2 + 1], local34[local62 * 2 + 2], local34[(local62 + 1) * 2 + 1], local10.anIntArray229[local10.aByteArray31[local62] & 0xFF], 1, arg2, arg1, arg5);
				}
				arg3.a(local34[local34.length - 2], local34[local34.length - 1], local34[0], local34[1], local10.anIntArray229[local10.aByteArray31[local10.aByteArray31.length - 1] & 0xFF], 1, arg2, arg1, arg5);
			}
		}
		@Pc(517) Class23 local517 = null;
		if (local10.anInt2596 != -1) {
			local517 = local10.method1629(false, arg3);
			if (local517 != null) {
				Static6.method64(arg5, arg2, local517, arg0, arg6, arg7, arg1);
			}
		}
		...
		Static256.method2637(local553, local10.aString25, local555, arg1, local10.anInt2592, local36, arg7, arg2, arg0, arg5, arg6);
	}

	@OriginalMember(owner = "client!tka", name = "a", descriptor = "([BZ)Ljava/lang/String;")
	public static String method5892(@OriginalArg(0) byte[] arg0) {
		return Static350.method3593(0, arg0, arg0.length);
	}

	@OriginalMember(owner = "client!tka", name = "a", descriptor = "(IIIIIII)V")
	public static void method5893(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
