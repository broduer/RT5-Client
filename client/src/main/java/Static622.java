...
public final class Static622 {
	...
	public static int method6860(@OriginalArg(0) int arg0) {
		return arg0 >> 11 & 0x7F;
	}

	@OriginalMember(owner = "client!tla", name = "a", descriptor = "(Ljava/lang/String;ILclient!qha;B)Lclient!cn;")
	public static Class71 method6861(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class19_Sub3 arg2, @OriginalArg(3) byte arg3) {
		if (arg3 <= 97) {
			return null;
		}
