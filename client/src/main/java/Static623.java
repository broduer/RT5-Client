...
public final class Static623 {
	...
	public static int method8333(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Random arg2) {
		if (arg1 <= 0) {
			...
			return Static719.method9125(local49, arg0 + 22147, arg1);
		}
	}
}
