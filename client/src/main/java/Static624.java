...
public final class Static624 {
	...
	public static Class162 method5898(@OriginalArg(1) int arg0) {
		@Pc(15) Class162[] local15 = Static660.method6141();
	...
	public static void method5899(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (Static180.anInt2995 <= arg1 && Static111.anInt2219 >= arg0 && arg4 >= Static724.anInt10930 && Static273.anInt4395 >= arg3) {
			Static561.method5241(arg4, arg2, arg1, arg3, arg0);
		} else {
			Static230.method2408(arg1, arg0, arg2, arg4, arg3);
		}
	}

	@OriginalMember(owner = "client!tn", name = "a", descriptor = "(ZIII)V")
	public static void method5900(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		@Pc(37) String local37 = "tele " + arg0 + "," + (arg2 >> 6) + "," + (arg1 >> 6) + "," + (arg2 & 0x3F) + "," + (arg1 & 0x3F);
		System.out.println(local37);
		Static231.method2419(true, false, local37);
	}
}
