...
public final class Static632 {
	...
	public static Class138 method5923(@OriginalArg(0) Class2_Sub21 arg0) {
		@Pc(10) Class403 local10 = Static33.method434()[arg0.method5205()];
		@Pc(17) Class103 local17 = Static313.method3174()[arg0.method5205()];
		@Pc(21) int local21 = arg0.method5165();
		@Pc(25) int local25 = arg0.method5165();
		@Pc(29) int local29 = arg0.method5191();
		@Pc(33) int local33 = arg0.method5191();
		@Pc(37) int local37 = arg0.method5165();
		@Pc(47) int local47 = arg0.method5158();
		@Pc(51) int local51 = arg0.method5158();
	...
	public static boolean method5928(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return (arg0 & 0x800) != 0 | Static558.method2000(arg0, arg1) || Static198.method2062(arg0, arg1);
	}

	@OriginalMember(owner = "client!u", name = "a", descriptor = "(ILclient!tg;IIBI)V")
	public static void method5930(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub51 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4) {
		if (arg1.anInt9353 == -1 && arg1.anIntArray718 == null) {
			return;
		}
		@Pc(23) int local23 = 0;
		@Pc(33) int local33 = arg1.anInt9358 * Static400.aClass2_Sub34_28.aClass57_Sub25_1.method5049() >> 8;
		...
		if (arg1.anInt9356 == 0 || arg1.anInt9356 < local23 - 256 || Static400.aClass2_Sub34_28.aClass57_Sub25_1.method5049() == 0 || arg2 != arg1.anInt9350) {
			if (arg1.aClass2_Sub6_Sub2_4 != null) {
				Static336.aClass2_Sub6_Sub3_1.method4174(arg1.aClass2_Sub6_Sub2_4);
				arg1.aClass2_Sub6_Sub2_4 = null;
				arg1.aClass2_Sub53_3 = null;
				arg1.aClass2_Sub49_Sub1_4 = null;
			}
			if (arg1.aClass2_Sub6_Sub2_3 != null) {
				Static336.aClass2_Sub6_Sub3_1.method4174(arg1.aClass2_Sub6_Sub2_3);
		...
		Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.method6693((byte) 71);
		...
		if (arg1.aClass2_Sub6_Sub2_4 != null) {
			arg1.aClass2_Sub6_Sub2_4.method2365(local182);
			arg1.aClass2_Sub6_Sub2_4.method2371(local214);
		} else if (arg1.anInt9353 >= 0) {
			local264 = arg1.anInt9360 == 256 && arg1.anInt9359 == 256 ? 256 : Static159.method1714(arg1.anInt9359, arg1.anInt9360);
			if (arg1.aBoolean714) {
				if (arg1.aClass2_Sub53_3 == null) {
					arg1.aClass2_Sub53_3 = Static650.method6047(Static147.aClass330_26, arg1.anInt9353);
				}
				if (arg1.aClass2_Sub53_3 != null) {
					if (arg1.aClass2_Sub49_Sub1_4 == null) {
						arg1.aClass2_Sub49_Sub1_4 = arg1.aClass2_Sub53_3.method6051(new int[] { 22050 });
					}
					if (arg1.aClass2_Sub49_Sub1_4 != null) {
						local391 = Static730.method2384(arg1.aClass2_Sub49_Sub1_4, local264, local182 << 6, local214);
						local391.method2356(-1);
						Static336.aClass2_Sub6_Sub3_1.method4173(local391);
						arg1.aClass2_Sub6_Sub2_4 = local391;
					}
				}
			} else {
				@Pc(408) Class89 local408 = Static729.method1465(Static281.aClass330_60, arg1.anInt9353, 0);
				if (local408 != null) {
					@Pc(415) Class2_Sub49_Sub1 local415 = local408.method1467().method5550(Static681.aClass224_2);
					@Pc(423) Class2_Sub6_Sub2 local423 = Static730.method2384(local415, local264, local182 << 6, local214);
					local423.method2356(-1);
					Static336.aClass2_Sub6_Sub3_1.method4173(local423);
					arg1.aClass2_Sub6_Sub2_4 = local423;
				}
			}
		}
		if (arg1.aClass2_Sub6_Sub2_3 != null) {
			arg1.aClass2_Sub6_Sub2_3.method2365(local182);
			arg1.aClass2_Sub6_Sub2_3.method2371(local214);
			if (!arg1.aClass2_Sub6_Sub2_3.e(-122)) {
				arg1.aClass2_Sub6_Sub2_3 = null;
				arg1.aClass2_Sub53_2 = null;
				arg1.aClass2_Sub49_Sub1_3 = null;
			}
			...
			if (!arg1.aBoolean715) {
				...
				@Pc(536) Class89 local536 = Static729.method1465(Static281.aClass330_60, arg1.anIntArray718[local275], 0);
				if (local536 != null) {
					@Pc(543) Class2_Sub49_Sub1 local543 = local536.method1467().method5550(Static681.aClass224_2);
					@Pc(551) Class2_Sub6_Sub2 local551 = Static730.method2384(local543, local264, local182 << 6, local214);
					local551.method2356(0);
					Static336.aClass2_Sub6_Sub3_1.method4173(local551);
			...
			if (arg1.aClass2_Sub53_2 == null) {
				...
				arg1.aClass2_Sub53_2 = Static650.method6047(Static147.aClass330_26, arg1.anIntArray718[local275]);
			}
			if (arg1.aClass2_Sub53_2 != null) {
				if (arg1.aClass2_Sub49_Sub1_3 == null) {
					arg1.aClass2_Sub49_Sub1_3 = arg1.aClass2_Sub53_2.method6051(new int[] { 22050 });
				}
				if (arg1.aClass2_Sub49_Sub1_3 != null) {
					local391 = Static730.method2384(arg1.aClass2_Sub49_Sub1_3, local264, local182 << 6, local214);
					local391.method2356(0);
					Static336.aClass2_Sub6_Sub3_1.method4173(local391);
	...
	public static void method5932(@OriginalArg(0) Class8_Sub2 arg0, @OriginalArg(2) boolean arg1) {
		arg0.aBoolean813 = arg1;
		if (Static661.aBoolean457) {
			Static684.aClass302Array1[Static684.aClass302Array1.length - 1].method4800(arg0);
		} else {
			Static658.method6123(arg0, Static501.aClass2_Sub7Array4);
		}
	}
}
