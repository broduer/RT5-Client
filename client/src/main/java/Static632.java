...
public final class Static632 {
	...
	public static final Class227 aClass227_229 = new Class227(89, -1);
	...
	public static boolean method8371(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public static void method8373(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub51 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4) {
		if (arg1.anInt9379 == -1 && arg1.anIntArray718 == null) {
			return;
		}
		@Pc(23) int local23 = 0;
		@Pc(33) int local33 = arg1.anInt9384 * Static400.aClass2_Sub34_28.aClass57_Sub25_1.method7215() >> 8;
		if (arg1.anInt9388 < arg3) {
			local23 = arg3 - arg1.anInt9388;
		} else if (arg1.anInt9383 > arg3) {
			local23 = arg1.anInt9383 - arg3;
		}
		if (arg1.anInt9375 < arg4) {
			local23 += arg4 - arg1.anInt9375;
		} else if (arg1.anInt9378 > arg4) {
			local23 += arg1.anInt9378 - arg4;
		}
		if (arg1.anInt9382 == 0 || arg1.anInt9382 < local23 - 256 || Static400.aClass2_Sub34_28.aClass57_Sub25_1.method7215() == 0 || arg2 != arg1.anInt9376) {
			if (arg1.aClass2_Sub6_Sub2_4 != null) {
				Static336.aClass2_Sub6_Sub3_1.method5890(arg1.aClass2_Sub6_Sub2_4);
				arg1.aClass2_Sub6_Sub2_4 = null;
				arg1.aClass2_Sub53_3 = null;
				arg1.aClass2_Sub49_Sub1_4 = null;
			}
			if (arg1.aClass2_Sub6_Sub2_3 != null) {
				Static336.aClass2_Sub6_Sub3_1.method5890(arg1.aClass2_Sub6_Sub2_3);
		...
		@Pc(172) int local172 = arg1.anInt9382 - arg1.anInt9381;
		if (local172 < 0) {
			local172 = arg1.anInt9382;
		}
		@Pc(182) int local182 = local33;
		@Pc(187) int local187 = local23 - arg1.anInt9381;
		if (local187 > 0 && local172 > 0) {
			local182 = (local172 - local187) * local33 / local172;
		}
		Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.method9309((byte) 71);
		@Pc(214) int local214 = 8192;
		@Pc(225) int local225 = (arg1.anInt9388 + arg1.anInt9383) / 2 - arg3;
		@Pc(236) int local236 = (arg1.anInt9375 + arg1.anInt9378) / 2 - arg4;
		@Pc(264) int local264;
		@Pc(275) int local275;
		if (local225 != 0 || local236 != 0) {
			local264 = -Static323.anInt5136 - (int) (Math.atan2((double) local225, (double) local236) * 2607.5945876176133D) - 4096 & 0x3FFF;
			if (local264 > 8192) {
		...
		if (arg1.aClass2_Sub6_Sub2_4 != null) {
			...
			if (arg1.aBoolean715) {
				if (arg1.aClass2_Sub53_3 == null) {
					arg1.aClass2_Sub53_3 = Static650.method8505(Static147.aClass332_26, arg1.anInt9379);
				}
				if (arg1.aClass2_Sub53_3 != null) {
					if (arg1.aClass2_Sub49_Sub1_4 == null) {
						arg1.aClass2_Sub49_Sub1_4 = arg1.aClass2_Sub53_3.method8509(new int[] { 22050 });
					}
					if (arg1.aClass2_Sub49_Sub1_4 != null) {
						local391 = Static730.method3346(arg1.aClass2_Sub49_Sub1_4, local264, local182 << 6, local214);
						local391.method3318(-1);
						Static336.aClass2_Sub6_Sub3_1.method5889(local391);
						arg1.aClass2_Sub6_Sub2_4 = local391;
					}
				}
			} else {
				@Pc(408) Class89 local408 = Static729.method2245(Static281.aClass332_60, arg1.anInt9379, 0);
				if (local408 != null) {
					@Pc(415) Class2_Sub49_Sub1 local415 = local408.method2247().method7828(Static681.aClass226_2);
					@Pc(423) Class2_Sub6_Sub2 local423 = Static730.method3346(local415, local264, local182 << 6, local214);
					local423.method3318(-1);
					Static336.aClass2_Sub6_Sub3_1.method5889(local423);
		...
		if (arg1.aClass2_Sub6_Sub2_3 != null) {
		...
		} else if (arg1.anIntArray718 != null && (arg1.anInt9377 -= arg0) <= 0) {
			local264 = arg1.anInt9386 == 256 && arg1.anInt9385 == 256 ? 256 : arg1.anInt9385 + (int) ((double) (arg1.anInt9386 - arg1.anInt9385) * Math.random());
			if (!arg1.aBoolean716) {
				local275 = (int) ((double) arg1.anIntArray718.length * Math.random());
				@Pc(536) Class89 local536 = Static729.method2245(Static281.aClass332_60, arg1.anIntArray718[local275], 0);
				if (local536 != null) {
					@Pc(543) Class2_Sub49_Sub1 local543 = local536.method2247().method7828(Static681.aClass226_2);
					@Pc(551) Class2_Sub6_Sub2 local551 = Static730.method3346(local543, local264, local182 << 6, local214);
					local551.method3318(0);
					Static336.aClass2_Sub6_Sub3_1.method5889(local551);
					arg1.anInt9377 = (int) (Math.random() * (double) (arg1.anInt9380 - arg1.anInt9391)) + arg1.anInt9391;
			...
			if (arg1.aClass2_Sub53_2 == null) {
				...
				arg1.aClass2_Sub53_2 = Static650.method8505(Static147.aClass332_26, arg1.anIntArray718[local275]);
			}
			if (arg1.aClass2_Sub53_2 != null) {
				if (arg1.aClass2_Sub49_Sub1_3 == null) {
					arg1.aClass2_Sub49_Sub1_3 = arg1.aClass2_Sub53_2.method8509(new int[] { 22050 });
				}
				if (arg1.aClass2_Sub49_Sub1_3 != null) {
					local391 = Static730.method3346(arg1.aClass2_Sub49_Sub1_3, local264, local182 << 6, local214);
					local391.method3318(0);
					Static336.aClass2_Sub6_Sub3_1.method5889(local391);
					arg1.anInt9377 = (int) ((double) (arg1.anInt9380 - arg1.anInt9391) * Math.random()) + arg1.anInt9391;
	...
	public static void method8375(@OriginalArg(0) Class8_Sub2 arg0, @OriginalArg(2) boolean arg1) {
		arg0.aBoolean814 = arg1;
		if (Static661.aBoolean457) {
			Static684.aClass304Array1[Static684.aClass304Array1.length - 1].method6819(arg0);
		} else {
			Static658.method8598(arg0, Static501.aClass2_Sub7Array4);
		}
	}
}
