...
public final class Static638 {
	...
	public static Class56 method5958(@OriginalArg(0) Class390 arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) Component arg3) {
		if (Static686.anInt8944 == 0) {
			...
			try {
				...
				if (Static156.anInt2679 > 0 && Static232.aClass119_1 == null) {
					...
					arg0.method6432(Static232.aClass119_1, Static156.anInt2679);
				}
				...
				try {
					...
					local141.method2596(arg3);
					local141.anInt4097 = 16384;
					local141.method2591(local141.anInt4097);
					if (Static156.anInt2679 > 0 && Static232.aClass119_1 == null) {
						Static232.aClass119_1 = new Class119();
						Static232.aClass119_1.aClass390_2 = arg0;
						arg0.method6432(Static232.aClass119_1, Static156.anInt2679);
	...
	public static void method5959(@OriginalArg(0) long arg0) {
		if (arg0 <= 0L) {
			return;
		}
		if (arg0 % 10L == 0L) {
			Static315.method3201(arg0 - 1L);
			Static315.method3201(1L);
		} else {
			Static315.method3201(arg0);
		}
	}

	@OriginalMember(owner = "client!uca", name = "b", descriptor = "(Z)Lclient!gh;")
	public static Class145 method5960() {
		try {
	...
	public static void method5961(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		...
		if (Static179.anInt2991 >= 100) {
			...
			@Pc(36) int local36 = Static102.method1286(Static394.anInt6176, -29754, local28, local22) - Static55.anInt1125;
	...
	public static Class8_Sub2_Sub5 method5962(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
