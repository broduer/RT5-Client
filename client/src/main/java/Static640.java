...
public final class Static640 {
	...
	public static void method5989(@OriginalArg(1) boolean arg0) {
		Static19.method151(arg0, Static377.anInt5930, Static380.anInt5979, Static680.anInt10289);
	}

	@OriginalMember(owner = "client!uda", name = "i", descriptor = "(I)Lclient!wca;")
	public static Class396 method5990() {
		return Static321.method3238();
	}

	@OriginalMember(owner = "client!uda", name = "a", descriptor = "(II)[[[B")
	public static byte[][][] method5991(@OriginalArg(1) int arg0) {
