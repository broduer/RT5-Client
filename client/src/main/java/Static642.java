...
public final class Static642 {
	...
	public static void method5994(@OriginalArg(0) Class330 arg0, @OriginalArg(3) Class330 arg1) {
		Static509.aClass330_96 = arg1;
		Static269.aClass330_58 = arg0;
	}

	@OriginalMember(owner = "client!uea", name = "a", descriptor = "(ZBI)Lclient!pea;")
	public static Class8_Sub7 method5995(@OriginalArg(0) boolean arg0, @OriginalArg(2) int arg1) {
		@Pc(7) Class130[] local7 = Class43.aClass130Array1;
		synchronized (Class43.aClass130Array1) {
			@Pc(37) Class8_Sub7 local37;
			if (Class43.aClass130Array1.length <= arg1 || Class43.aClass130Array1[arg1].method1897()) {
				...
				local37 = (Class8_Sub7) Class43.aClass130Array1[arg1].method1903();
				local37.a();
