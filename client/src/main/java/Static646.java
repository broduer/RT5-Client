...
public final class Static646 {
	...
	public static void method6007(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public static void method6008(@OriginalArg(0) Class158 arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2) {
		@Pc(8) Class159 local8 = arg0.method2431(Static163.aClass19_17);
		if (local8 == null) {
			return;
		}
		...
		if (Static578.anInt8595 >= 3) {
			...
			Static12.aClass23_27.a((float) arg0.anInt3802 / 2.0F + (float) arg1, (float) arg0.anInt3746 / 2.0F + (float) arg2, 4096, ((int) -Static171.aFloat64 & 0x3FFF) << 2, local8.aClass1_1, arg1, arg2);
		}
	}

	@OriginalMember(owner = "client!uga", name = "a", descriptor = "(BII)Z")
	public static boolean method6011(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		return (arg1 & 0x21) != 0;
	}

	@OriginalMember(owner = "client!uga", name = "a", descriptor = "(IB)I")
	public static int method6012(@OriginalArg(0) int arg0) {
		if (arg0 == 6406) {
			return 1;
		} else if (arg0 == 6409) {
			return 1;
