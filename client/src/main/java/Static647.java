...
public final class Static647 {
	...
	public static void method6021(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(20) Class2_Sub2_Sub2 local20 = Static440.method4204(14, (long) arg0);
		local20.method130();
	...
	public static int method6027(@OriginalArg(0) String arg0) {
		return Static269.method2737(arg0, 10);
	}

	@OriginalMember(owner = "client!uh", name = "a", descriptor = "(JZII)Ljava/lang/String;")
	public static String method6028(@OriginalArg(0) long arg0, @OriginalArg(2) int arg1) {
		...
		return arg1 == 3 ? Static120.method1427(arg0, arg1) : Integer.toString(local20 / 10) + local20 % 10 + "-" + Static19.aStringArrayArray1[arg1][local24] + "-" + local28 + " " + local32 / 10 + local32 % 10 + ":" + local36 / 10 + local36 % 10;
	}
}
