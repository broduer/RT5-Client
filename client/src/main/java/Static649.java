...
public final class Static649 {
	...
	public static File method6044(@OriginalArg(0) String arg0) {
		return method6045(aString113, anInt9672, arg0);
	}

	@OriginalMember(owner = "client!uia", name = "a", descriptor = "(BLjava/lang/String;ILjava/lang/String;)Ljava/io/File;")
	public static File method6045(@OriginalArg(1) String arg0, @OriginalArg(2) int arg1, @OriginalArg(3) String arg2) {
		if (!aBoolean743) {
	...
	public static void method6046(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1) {
		anInt9672 = arg0;
		aString113 = arg1;
		try {
