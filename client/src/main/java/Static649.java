...
public final class Static649 {
	...
	public static File method8497(@OriginalArg(0) String arg0) {
		return method8498(aString113, anInt9698, arg0);
	}

	@OriginalMember(owner = "client!uia", name = "a", descriptor = "(BLjava/lang/String;ILjava/lang/String;)Ljava/io/File;")
	public static File method8498(@OriginalArg(1) String arg0, @OriginalArg(2) int arg1, @OriginalArg(3) String arg2) {
		if (!aBoolean744) {
	...
	public static void method8499(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1) {
		anInt9698 = arg0;
		aString113 = arg1;
		try {
