...
public final class Static650 {
	...
	public static Class2_Sub53 method6047(@OriginalArg(0) Class330 arg0, @OriginalArg(1) int arg1) {
		if (method6054(arg0)) {
			@Pc(14) byte[] local14 = arg0.method5353(arg1);
			return local14 == null ? null : new Class2_Sub53(local14);
		} else {
			arg0.method5345(arg1);
			return null;
		}
	}

	@OriginalMember(owner = "client!uj", name = "c", descriptor = "(I)I")
	public static int method6049(@OriginalArg(0) int arg0) {
		@Pc(1) int local1 = 0;
		@Pc(3) int local3 = 0;
		@Pc(8) int local8;
	...
	private static void method6053(@OriginalArg(0) byte[] arg0) {
		method6057(arg0);
		anInt9681 = 0x1 << method6049(4);
		anInt9683 = 0x1 << method6049(4);
		...
		for (@Pc(17) int local17 = 0; local17 < 2; local17++) {
			...
			local191 = Static434.method4154(local36 - 1);
			for (@Pc(193) int local193 = 0; local193 < local36; local193++) {
				local185[local193] = Static179.method1882(local191, local193);
			}
			if (local17 == 0) {
	...
	public static Class2_Sub53 method6055(@OriginalArg(0) Class330 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (method6054(arg0)) {
			@Pc(16) byte[] local16 = arg0.method5359(arg2, arg1);
			return local16 == null ? null : new Class2_Sub53(local16);
		} else {
			arg0.method5350(arg2, arg1);
			return null;
		}
	}

	@OriginalMember(owner = "client!uj", name = "a", descriptor = "(I)F")
	public static float method6056(@OriginalArg(0) int arg0) {
	...
	public static void method6057(@OriginalArg(0) byte[] arg0) {
		aByteArray101 = arg0;
		anInt9682 = 0;
		anInt9677 = 0;
	}
