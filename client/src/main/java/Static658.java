...
public final class Static658 {
	...
	public static void method6123(@OriginalArg(0) Class8_Sub2 arg0, @OriginalArg(1) Class2_Sub7[] arg1) {
		@Pc(6) int local6;
		if (Static442.aBoolean500) {
			local6 = arg0.a(arg1);
			Static665.aClass19_15.a(local6, arg1);
		}
		if (Static693.aClass178Array2 == Static246.aClass178Array1) {
			...
			Static665.aClass19_15.EA(Static706.aClass178Array3[0].a(arg0.anInt10694, -123, (int) arg0.anInt10690), Static100.method1258(local6, local28), Static350.method3591(local6, local28), Static339.method3492(local6, local28));
		}
		@Pc(64) Class8_Sub7 local64 = arg0.a(Static665.aClass19_15);
		if (local64 == null) {
			return;
		}
		if (arg0.aBoolean813) {
			...
			for (@Pc(76) int local76 = 0; local76 < local74.length; local76++) {
				...
				if (local81.aBoolean352) {
					Static682.method6378(local81.anInt4505 - local81.anInt4502, local81.anInt4503 + local81.anInt4502, local81.anInt4504 - local81.anInt4502, local81.anInt4501 + local81.anInt4502);
				}
			}
		}
		if (local64.aBoolean548) {
			...
			if (Static661.aBoolean457) {
				...
				synchronized (Static514.aClass213_2) {
					Static514.aClass213_2.method3495(local64);
					return;
				}
			}
			Static514.aClass213_2.method3495(local64);
