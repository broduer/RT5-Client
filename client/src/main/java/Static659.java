...
public final class Static659 {
	...
	public static int method6131(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public static String method6132() {
	...
	public static Class2_Sub21 method6135() {
		@Pc(6) Class2_Sub21 local6 = Static570.method5321();
		local6.method5172(0L);
		local6.method5200(Static59.aString63);
		local6.method5172(Static430.aLong209);
		local6.method5172(Static571.aLong269);
		local6.method5194(Static374.aBigInteger2, Static262.aBigInteger1);
		return local6;
	}
}
