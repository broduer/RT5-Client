...
public final class Static661 {
	...
	public static void method3845(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		@Pc(7) int local7 = 0;
		...
		Static696.method6473(arg6 - local16, arg2, arg6 - arg1, local154);
		Static696.method6473(local16 + arg6, arg0, arg6 - local16, local154);
		Static696.method6473(arg6 + arg1, arg2, local16 + arg6, local154);
		while (local9 > 0) {
			...
			if (local198) {
				...
				Static696.method6473(local369, arg2, local358, Static723.anIntArrayArray266[local345]);
				Static696.method6473(local364, arg0, local369, Static723.anIntArrayArray266[local345]);
				Static696.method6473(local353, arg2, local364, Static723.anIntArrayArray266[local345]);
				Static696.method6473(local369, arg2, local358, Static723.anIntArrayArray266[local349]);
				Static696.method6473(local364, arg0, local369, Static723.anIntArrayArray266[local349]);
				Static696.method6473(local353, arg2, local364, Static723.anIntArrayArray266[local349]);
			} else {
				Static696.method6473(local353, arg2, local358, Static723.anIntArrayArray266[local345]);
				Static696.method6473(local353, arg2, local358, Static723.anIntArrayArray266[local349]);
			}
		}
	}
}
