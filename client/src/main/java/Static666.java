...
public final class Static666 {
	...
	public static void method6200(@OriginalArg(0) int arg0) {
		@Pc(5) Class83 local5 = null;
		try {
			if (arg0 != 1) {
				method6199(1);
			}
			@Pc(18) Class270 local18 = Static446.aClass390_6.method6422("");
			while (local18.anInt6789 == 0) {
				Static638.method5959(1L);
			}
			if (local18.anInt6789 == 1) {
				local5 = (Class83) local18.anObject13;
				@Pc(41) Class2_Sub21 local41 = Static400.aClass2_Sub34_28.method3582();
				local5.method1396(local41.aByteArray93, 0, local41.anInt8388);
			}
