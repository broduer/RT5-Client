...
public final class Static668 {
	...
	public static void method6207(@OriginalArg(0) boolean arg0) {
		...
		Static30.method3552();
		Static30.aClass339_31.method5454();
		...
		if (Static30.aClass246_3 != null) {
			Static30.aClass246_3.method3968();
			Static30.aClass246_3.method3965(128, 64);
		}
		if (Static30.aClass363_3 != null) {
			Static30.aClass363_3.method5929(64, 64);
		}
		if (Static30.aClass142_3 != null) {
			Static30.aClass142_3.method2157(64);
		}
		Static529.aClass161_1.method2458(64);
	}

	@OriginalMember(owner = "client!vca", name = "a", descriptor = "(B)Lclient!gw;")
	public static Class153 method6208() {
		return Static620.method5890(Static283.anInt4574) ? Static405.aClass153_1 : Static405.aClass153_2;
	}
	...
	public static void method6210() {
		...
		@Pc(26) int local26;
		if (Static523.anInt3885 != -1 && Static305.aLong157 < Static588.method5469()) {
			for (local26 = Static523.anInt3885; local26 < Static144.aStringArray7.length; local26++) {
				if (Static144.aStringArray7[local26].startsWith("pause")) {
					...
					Static79.method1013("Pausing for " + local40 + " seconds...");
					Static523.anInt3885 = local26 + 1;
					Static305.aLong157 = (long) (local40 * 1000) + Static588.method5469();
					return;
				}
		...
		for (local26 = 0; local26 < Static671.anInt10026; local26++) {
			...
			@Pc(151) int local151 = local147.method1801();
			@Pc(155) char local155 = local147.method1803();
			@Pc(159) int local159 = local147.method1804();
			if (local151 == 84) {
				Static270.method2742(false);
			}
			if (local151 == 80) {
				Static270.method2742(true);
				...
				if (Static175.aClipboard1 != null) {
					try {
						...
						if (local207 != null) {
							...
							if (local214 != null) {
								@Pc(221) String[] local221 = Static189.method1971(local214, '\n');
								Static363.method4338(local221);
							}
						}
				...
				Static625.anInt9472++;
				Static344.method3528();
				Static594.anInt8776 = Static110.aString19.length();
			} else if (local151 == 105 && Static625.anInt9472 > 0) {
				Static625.anInt9472--;
				Static344.method3528();
				Static594.anInt8776 = Static110.aString19.length();
			} else if (Static596.method5549(local155) || "\\/.:, _-+[]~@".indexOf(local155) != -1) {
				Static110.aString19 = Static110.aString19.substring(0, Static594.anInt8776) + Static194.anInterface27Array1[local26].method1803() + Static110.aString19.substring(Static594.anInt8776);
				Static594.anInt8776++;
			}
		}
