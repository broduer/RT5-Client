...
public final class Static669 {
	...
	public static int method8719(@OriginalArg(0) Class299_Sub1 arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) Class299_Sub1 arg2, @OriginalArg(3) int arg3) {
		...
		if (arg3 == 1) {
			...
			return Static540.method6545(arg0.method6724().aString13, Static51.anInt1056, arg2.method6724().aString13);
		} else if (arg3 == 3) {
			if (arg2.aString91.equals("-")) {
				...
				return Static540.method6545(arg0.aString91, Static51.anInt1056, arg2.aString91);
			}
		} else if (arg3 == 4) {
			if (arg2.method6719()) {
