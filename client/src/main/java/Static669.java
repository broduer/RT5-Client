...
public final class Static669 {
	...
	public static void method6213(@OriginalArg(0) int arg0) {
	...
	public static int method6214(@OriginalArg(0) Class297_Sub1 arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) Class297_Sub1 arg2, @OriginalArg(3) int arg3) {
		@Pc(11) int local11;
		@Pc(14) int local14;
		if (arg3 == 1) {
			...
			return Static540.method4590(arg0.method4730().aString13, Static51.anInt1052, arg2.method4730().aString13);
		} else if (arg3 == 3) {
			if (arg2.aString91.equals("-")) {
				...
				return Static540.method4590(arg0.aString91, Static51.anInt1052, arg2.aString91);
			}
		} else if (arg3 == 4) {
			if (arg2.method4725()) {
				return arg0.method4725() ? 0 : 1;
			} else if (arg0.method4725()) {
				return -1;
			} else {
				return 0;
			}
			...
			if (arg2.method4719()) {
				return arg0.method4719() ? 0 : 1;
			} else if (arg0.method4719()) {
				return -1;
			} else {
				return 0;
			}
			...
			if (arg2.method4721()) {
				return arg0.method4721() ? 0 : 1;
			} else if (arg0.method4721()) {
				return -1;
			} else {
				return 0;
			}
			...
			if (arg2.method4722()) {
				return arg0.method4722() ? 0 : 1;
			} else if (arg0.method4722()) {
				return -1;
			} else {
				return 0;
			}
