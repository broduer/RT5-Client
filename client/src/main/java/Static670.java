...
public final class Static670 {
	...
	public static int method6229(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2) {
		if (arg2 >= arg0) {
	...
	public static void method6232() {
		if (Static265.aByteArray44 != null) {
			Static619.method956(Static470.anInt7113);
		} else if (Static129.anInt2409 == -1) {
			Static192.method1982(Static59.aString63, Static470.anInt7113, Static449.aString75);
		} else {
			Static113.method1358(Static470.anInt7113);
		}
	}
}
