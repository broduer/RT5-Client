...
public final class Static678 {
	...
	public static void method6357(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub21 arg1) {
		for (@Pc(1) int local1 = 0; local1 < Static476.anInt7177; local1++) {
			@Pc(6) int local6 = arg1.method5199();
			@Pc(10) int local10 = arg1.method5191();
			if (local10 == 65535) {
				local10 = -1;
			}
		...
		if (arg0 != -1) {
			method6357(-83, (Class2_Sub21) null);
		}
	}
}
