...
public final class Static679 {
	...
	public static int method6360() {
		if (Static109.aClass158_3 == null) {
			...
			@Pc(28) int local28 = Static189.aClass120_1.method6319();
			@Pc(37) int local37 = Static189.aClass120_1.method6320();
			@Pc(53) int local53;
			@Pc(55) int local55;
			@Pc(71) int local71;
			...
			if (Static236.aBoolean304) {
				...
				if (Static71.anInt1576 < local28 && Static71.anInt1576 + Static682.anInt10295 > local28) {
					...
					if (local53 != -1) {
						...
						for (@Pc(368) Class2_Sub2_Sub4 local368 = (Class2_Sub2_Sub4) local262.method4737(); local368 != null; local368 = (Class2_Sub2_Sub4) local262.method4736()) {
							if (local71++ == local53) {
					...
					if (local53 != -1) {
						...
						for (local134 = (Class2_Sub2_Sub16) local262.method4737(); local134 != null; local134 = (Class2_Sub2_Sub16) local262.method4736()) {
							if (local71++ == local53) {
				...
				if (local53 != -1) {
					...
					for (local134 = (Class2_Sub2_Sub16) local129.method3008(); local134 != null; local134 = (Class2_Sub2_Sub16) local129.method3007()) {
						if (local53 == local71++) {
							return local134.anInt7318;
						}
					}
	...
	public static void method6362(@OriginalArg(1) Class2_Sub2_Sub16 arg0) {
		...
		if (!arg0.aBoolean551) {
			...
			for (local85 = (Class2_Sub2_Sub4) Static490.aClass28_34.method373(local79); local85 != null && !local85.aString10.equals(arg0.aString86); local85 = (Class2_Sub2_Sub4) Static490.aClass28_34.method379()) {
			}
			if (local85 != null && local85.method918(arg0)) {
				Static385.method3836(local85);
			}
			return;
		}
		for (@Pc(22) Class2_Sub2_Sub4 local22 = (Class2_Sub2_Sub4) Static350.aClass192_8.method3017(); local22 != null; local22 = (Class2_Sub2_Sub4) Static350.aClass192_8.method3015()) {
			if (local22.aString10.equals(arg0.aString86)) {
				@Pc(31) boolean local31 = false;
				for (@Pc(37) Class2_Sub2_Sub16 local37 = (Class2_Sub2_Sub16) local22.aClass192_3.method3017(); local37 != null; local37 = (Class2_Sub2_Sub16) local22.aClass192_3.method3015()) {
					if (local37 == arg0) {
						local31 = true;
						if (local22.method918(arg0)) {
							Static385.method3836(local22);
						}
						break;
					}
				}
