...
public final class Static682 {
	...
	public static String method6374(@OriginalArg(1) String arg0) {
		@Pc(17) String local17 = Static99.method1248(Static306.method3111(arg0, -120));
		if (local17 == null) {
			local17 = "";
		}
		return local17;
	...
	public static void method6377(@OriginalArg(1) int arg0) {
		@Pc(17) Class2_Sub2_Sub2 local17 = Static440.method4204(20, (long) arg0);
		local17.method133();
	}

	@OriginalMember(owner = "client!vka", name = "a", descriptor = "(IIIBI)V")
	public static void method6378(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3) {
		...
		for (@Pc(94) int local94 = local22; local94 <= local26; local94++) {
			@Pc(105) int local105 = Static719.method6552(local94 + Static482.anInt7265, 16939, Static617.anInt9434) * Static211.anInt5574;
			for (@Pc(107) int local107 = local14; local107 <= local18; local107++) {
				@Pc(117) int local117 = Static719.method6552(Static632.anInt9503 + local107, 16939, Static211.anInt5574) + local105;
