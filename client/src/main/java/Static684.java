...
public final class Static684 {
	...
	public static void method6382(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (Static1.anInt10798 == 4) {
			Static1.anInt10798 = 0;
			Static717.anInt10817 = -1;
		}
		if (!arg0 && Static62.anInt1465 == arg1 && Static525.anInt8907 == arg3 && (Static164.anInt2808 == Static394.anInt6176 || Static400.aClass2_Sub34_28.aClass57_Sub19_2.method4201() == 1)) {
			return;
		}
		...
		Static162.aClass2_Sub2_Sub13_2 = Static30.method3560(Static62.anInt1465 * 8, Static525.anInt8907 * 8);
		...
		if (arg2 == 12) {
				...
				if (local141 != null) {
					...
					if (local146.anInt10690 >= 0 && local128 >= local146.anInt10690 && local146.anInt10694 >= 0 && local134 >= local146.anInt10694) {
						...
						if (local191) {
							...
							local146.method6719((Class268) null);
							local120 = true;
							local141.a((byte) 29);
						}
					} else {
			...
			if (local120) {
				Static416.anInt6378 = Static18.aClass28_2.method374();
				Static18.aClass28_2.method378(Static592.aClass2_Sub45Array1);
			}
		}
		...
		for (local485 = (Class2_Sub25) Static159.aClass339_15.method5453(65280); local485 != null; local485 = (Class2_Sub25) Static159.aClass339_15.method5460()) {
		...
		for (local485 = (Class2_Sub25) Static227.aClass339_18.method5453(65280); local485 != null; local485 = (Class2_Sub25) Static227.aClass339_18.method5460()) {
			local485.anInt4006 -= local113;
			local485.anInt4016 -= local109;
			if (Static117.anInt2282 != 4 && (local485.anInt4016 < 0 || local485.anInt4006 < 0 || local485.anInt4016 >= Static720.anInt10859 || local485.anInt4006 >= Static501.anInt7568)) {
				local485.a((byte) 105);
		...
		if (Static117.anInt2282 != 4) {
			for (@Pc(608) Class2_Sub17 local608 = (Class2_Sub17) Static497.aClass28_35.method371(); local608 != null; local608 = (Class2_Sub17) Static497.aClass28_35.method375()) {
		...
		Static533.method4994();
		Static244.method2540();
		Static346.aClass28_29.method372();
		Static505.aClass339_77.method5454();
		Static422.aClass130_9.method1904();
		Static105.method1300();
	}
}
