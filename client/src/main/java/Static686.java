...
public final class Static686 {
	...
	public static void method5627(@OriginalArg(0) long arg0) {
		if (Static334.aClass291ArrayArrayArray1 != null) {
			if (Static511.anInt7645 == 1 || Static511.anInt7645 == 5) {
				Static604.method5600(arg0);
			} else if (Static511.anInt7645 == 4) {
				Static349.method3588(arg0);
			}
		}
		Static147.method1619((long) Static333.anInt5455, Static163.aClass19_17);
		if (Static377.anInt5930 != -1) {
			Static26.method351(Static377.anInt5930);
		}
		...
		if (Static377.anInt5930 != -1) {
			...
			Static261.method2691();
		}
		Static163.aClass19_17.la();
		Static676.method6325(Static163.aClass19_17);
		@Pc(116) int local116 = Static679.method6360();
		if (local116 == -1) {
		...
		Static115.method1370(local116);
		@Pc(136) int local136 = Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.method6693((byte) 70) << 8;
		Static220.method2283(Static35.anInt800, local136 + Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.anInt10694, Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.anInt10690 - -local136, Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.aByte144);
		Static35.anInt800 = 0;
	}
}
