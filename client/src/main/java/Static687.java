...
public final class Static687 {
	...
	public static int method6403(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2) {
		...
		for (@Pc(34) Class2_Sub20 local34 = (Class2_Sub20) Static30.aClass339_31.method5453(65280); local34 != null; local34 = (Class2_Sub20) Static30.aClass339_31.method5460()) {
	...
	public static void method6404(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		if (arg2 != 8 && arg2 != 16) {
		...
		for (@Pc(61) int local61 = 0; local61 < Static150.anInt2634; local61++) {
			...
			if (local67.aByte43 == arg2 && arg0 == local67.aShort26 && arg3 == local67.aShort23 || local67.aShort24 == arg0 && arg3 == local67.aShort23) {
				if (local61 != Static150.anInt2634) {
					Static734.method5445(Static285.aClass75Array1, local61 + 1, Static285.aClass75Array1, local61, Static285.aClass75Array1.length - local61 - 1);
				}
				Static150.anInt2634--;
				return;
			}
	...
	public static Class8_Sub2_Sub2 method6405(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
