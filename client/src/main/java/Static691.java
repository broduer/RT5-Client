...
public final class Static691 {
	...
	public static Class114 method6440(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) Class19 arg5) {
		@Pc(13) long local13 = (long) arg2;
		@Pc(19) Class114 local19 = (Class114) Static186.aClass82_67.method1390(local13);
		if (local19 == null) {
			@Pc(29) Class88 local29 = Static121.method1430(arg2, Static190.aClass330_38);
			if (local29 == null) {
				return null;
			}
			...
			local19 = arg5.a(local29, 2055, Static391.anInt6133, 64, 768);
			Static186.aClass82_67.method1384(local19, local13);
		}
		local19 = local19.a((byte) 6, 2055, true);
		if (arg4 != 0) {
			local19.a(arg4);
		}
		if (arg0 != 0) {
