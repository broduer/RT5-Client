...
public final class Static691 {
	...
	public static Class114 method9011(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) Class19 arg5) {
		...
		@Pc(19) Class114 local19 = (Class114) Static186.aClass82_67.get(local13);
		if (local19 == null) {
			@Pc(29) Class88 local29 = Static121.method2201(arg2, client.js5Archive7);
			if (local29 == null) {
				return null;
			}
			if (local29.anInt2388 < 13) {
				local29.method2232();
			}
			local19 = arg5.method7959(local29, 2055, Static391.anInt6153, 64, 768);
			Static186.aClass82_67.put(local19, local13);
		}
		local19 = local19.method7502((byte) 6, 2055, true);
		if (arg4 != 0) {
			local19.a(arg4);
		}
		if (arg0 != 0) {
