...
public final class Static693 {
	...
	public static String method6445(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
	...
	public static void method6446(@OriginalArg(0) byte[][] arg0, @OriginalArg(2) Class306_Sub1 arg1) {
		@Pc(10) int local10;
		@Pc(13) int local13;
		@Pc(22) int local22;
		@Pc(32) int local32;
						...
						if (!arg1.aBoolean673 || local32 == 0) {
							...
							for (@Pc(72) int local72 = 0; local72 < Static89.anIntArray169.length; local72++) {
								if (local70 == Static89.anIntArray169[local72] && arg0[local72] != null) {
									...
									arg1.method5588(local5, local32, local10 * 8, local60, local13 * 8, local91, local48, local54, Static577.aClass110Array1);
									arg1.method5592(local10 * 8, Static163.aClass19_17, local60, local91, local5, local54, local48, local32, local13 * 8);
									break;
								}
							}
						}
		...
		for (local10 = 0; local10 < arg1.anInt8913; local10++) {
			...
			for (local13 = 0; local13 < Static720.anInt10859 >> 3; local13++) {
				for (local22 = 0; local22 < Static501.anInt7568 >> 3; local22++) {
					...
					if (local32 == -1) {
						arg1.method5586(8, local22 * 8, local13 * 8, local10, 8);
					}
				}
			}
		}
	...
	public static void method6449(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(21) Class2_Sub2_Sub2 local21 = Static440.method4204(19, (long) arg0 | (long) arg1 << 32);
		local21.method133();
	}
}
