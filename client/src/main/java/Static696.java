...
public final class Static696 {
	...
	public static int method9041() {
		return Static470.anInt7134;
	}

	@OriginalMember(owner = "client!w", name = "a", descriptor = "(B)V")
	public static void method9042() {
		for (@Pc(1) int local1 = 0; local1 < Static33.anInt782; local1++) {
			@Pc(6) Class104 local6 = Static409.aClass104Array1[local1];
			if (local6.aByte49 == 3) {
				if (local6.aClass2_Sub6_Sub2_2 == null) {
					local6.anInt2580 = Integer.MIN_VALUE;
				} else {
					Static336.aClass2_Sub6_Sub3_1.method5890(local6.aClass2_Sub6_Sub2_2);
				}
			}
		}
	}
	...
	public static boolean method9043(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		if ((Static280.aByteArrayArrayArray3[0][arg2][arg0] & 0x2) != 0) {
			return true;
		} else if ((Static280.aByteArrayArrayArray3[arg3][arg2][arg0] & 0x10) == 0) {
			return Static705.method9205(arg0, arg2, arg3) == arg1;
		} else {
			return false;
		}
	}
	...
	public static void method9044(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3) {
		arg2--;
