...
public final class Static696 {
		...
		for (@Pc(1) int local1 = 0; local1 < Static33.anInt779; local1++) {
			...
			if (local6.aByte49 == 3) {
				if (local6.aClass2_Sub6_Sub2_2 == null) {
					...
					Static336.aClass2_Sub6_Sub3_1.method4174(local6.aClass2_Sub6_Sub2_2);
				}
			}
		}
	}
	...
	public static boolean method6472(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		if ((Static280.aByteArrayArrayArray3[0][arg2][arg0] & 0x2) != 0) {
			return true;
		} else if ((Static280.aByteArrayArrayArray3[arg3][arg2][arg0] & 0x10) == 0) {
			return Static705.method6627(arg0, arg2, arg3) == arg1;
		} else {
			return false;
		}
	}
	...
	public static void method6473(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3) {
		arg2--;
