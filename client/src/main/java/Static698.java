...
public final class Static698 {
	...
	public static void method6556(@OriginalArg(0) Class353 arg0) {
		...
		for (@Pc(39) int local39 = local22; local39 <= local30; local39++) {
			@Pc(42) int local42 = 0;
			@Pc(54) int local54 = local7.method5983() + Static247.anInt3993 - local7.method5986() >> Static52.anInt1066;
			if (local54 < 0) {
				local42 = -local54;
				local54 = 0;
			}
			@Pc(74) int local74 = local7.method5983() + local7.method5986() - Static247.anInt3993 >> Static52.anInt1066;
			...
			for (@Pc(83) int local83 = local54; local83 <= local74; local83++) {
				...
				@Pc(106) int local106 = (local7.method5980() + Static247.anInt3993 - local7.method5986() >> Static52.anInt1066) + (local90 >>> 8);
	...
	public static void method6557(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
		@Pc(12) Class2_Sub22 local12 = Static556.method5127(arg1, arg0);
		if (local12 != null) {
			local12.a((byte) 99);
		}
	}
	...
	public static void method6558(@OriginalArg(1) String arg0) {
		if (arg0.equals("")) {
			return;
		}
		@Pc(16) Class153 local16 = Static668.method6208();
		@Pc(29) Class2_Sub19 local29 = Static293.method3000(Static244.aClass345_53, local16.aClass186_1);
		local29.aClass2_Sub21_Sub2_1.method5198(Static231.method2417(arg0));
		local29.aClass2_Sub21_Sub2_1.method5200(arg0);
		local16.method2339(local29);
	}
}
