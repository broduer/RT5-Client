...
public final class Static707 {
	...
	public static void method9234() {
		...
		Static169.anInt2864 = -2;
		Static135.anInt8246 = 0;
	}

	@OriginalMember(owner = "client!wg", name = "a", descriptor = "(I[ILclient!qha;[III)Lclient!wl;")
	public static Class1_Sub3 method9235(@OriginalArg(1) int[] arg0, @OriginalArg(2) Class19_Sub3 arg1, @OriginalArg(3) int[] arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
