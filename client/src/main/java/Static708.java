...
public final class Static708 {
	...
	public static void method6654(@OriginalArg(1) String arg0) {
		...
		try {
			...
			if (arg0.length() == 0) {
				...
				local47 = local47 + "; Expires=" + Static163.method6312(Static588.method5469() + 94608000000L) + "; Max-Age=" + 94608000L;
			}
	...
	public static void method6655(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
