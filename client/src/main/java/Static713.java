...
public final class Static713 {
	...
	public static void method6722(@OriginalArg(1) boolean arg0) {
		Static712.aClass73_11.a(Static74.aClass19_4.n());
	...
	public static String method6724(@OriginalArg(1) String arg0) {
		...
		for (@Pc(14) int local14 = 0; local14 < local12; local14++) {
			...
			if (local29 == '%' && local12 > local14 + 2) {
				...
				local14 += 2;
				if (local84 != 0 && Static529.method4969((byte) local84)) {
					local9.append(Static346.method3566((byte) local84));
				}
			} else if (local29 == '+') {
				local9.append(' ');
			} else {
	...
	public static long method6725(@OriginalArg(0) long arg0, @OriginalArg(1) long arg1) {
		return arg0 | arg1;
	}

	@OriginalMember(owner = "client!wk", name = "a", descriptor = "(IB)I")
	public static int method6727(@OriginalArg(0) int arg0) {
		return arg0 >>> 7;
	}
}
