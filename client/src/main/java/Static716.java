...
public final class Static716 {
	...
	public static int anInt10844 = 0;

	@OriginalMember(owner = "client!wm", name = "a", descriptor = "(I)V")
	public static synchronized void method9356() {
		...
		try {
			...
			@Pc(75) Method local75 = local20.getMethod("newPlatformMXBeanProxy", Class.forName("javax.management.MBeanServerConnection"), aClass29 == null ? (aClass29 = Class407.a("java.lang.String")) : aClass29, aClass30 == null ? (aClass30 = Class407.a("java.lang.Class")) : aClass30);
	...
	public static void method9357(@OriginalArg(2) Class8_Sub2_Sub1_Sub2 arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3) {
		Static418.method7867(arg0.aByte144, arg0.anInt10722, arg2, arg0.anInt10718, 0);
	}
}
