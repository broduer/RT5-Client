...
public final class Static719 {
	...
	public static void method6551(@OriginalArg(0) Interface4 arg0, @OriginalArg(1) Class19 arg1) {
		if (Static30.aClass2_Sub2_Sub13_3 == null) {
			return;
		}
		if (Static273.anInt4403 < 10) {
			if (!Static30.aClass330_74.method5362(Static30.aClass2_Sub2_Sub13_3.aString48)) {
				Static273.anInt4403 = Static120.aClass330_19.method5357(Static30.aClass2_Sub2_Sub13_3.aString48) / 10;
				return;
			}
			Static700.method6581();
		...
		if (Static273.anInt4403 == 10) {
			...
			@Pc(79) int local79 = -1;
			@Pc(81) int local81 = -1;
			if (Static30.aClass2_Sub2_Sub13_3.method2838(local77, Static116.anInt2270 + (Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.anInt10694 >> 9), Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.aByte144, (Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.anInt10690 >> 9) + Static691.anInt10367)) {
			...
			if (!Static696.aBoolean784 && local79 >= 0 && Static30.anInt5650 > local79 && local81 >= 0 && local81 < Static30.anInt5644) {
				...
				Static30.aClass2_Sub2_Sub13_3.method2835(Static30.aClass2_Sub2_Sub13_3.anInt4556 >> 14 & 0x3FFF, Static30.aClass2_Sub2_Sub13_3.anInt4556 & 0x3FFF, local77);
				Static615.anInt9389 = local77[2] - Static30.anInt5648;
				Static164.anInt2809 = local77[1] - Static30.anInt5655;
			} else {
				Static30.aClass2_Sub2_Sub13_3.method2835(Static227.anInt3694, Static529.anInt8089, local77);
				if (local77 != null) {
					Static615.anInt9389 = local77[2] - Static30.anInt5648;
					Static164.anInt2809 = local77[1] - Static30.anInt5655;
				}
			...
			Static30.method3549(arg0, Static30.anInt5641 >> 2 << 10, Static30.anInt5642 >> 1);
			Static30.aClass246_3.method3965(1024, 256);
			Static30.aClass363_3.method5929(256, 256);
			Static30.aClass142_3.method2157(4096);
			Static529.aClass161_1.method2458(256);
			Static273.anInt4403 = 20;
		} else if (Static273.anInt4403 == 20) {
			Static314.method3191(true);
			Static30.method3562(arg1, Static30.anInt5641, Static30.anInt5642);
			Static273.anInt4403 = 60;
			Static314.method3191(true);
			Static199.method2077();
		} else if (Static273.anInt4403 == 60) {
			if (Static30.aClass330_74.method5351(Static30.aClass2_Sub2_Sub13_3.aString48 + "_staticelements")) {
				if (!Static30.aClass330_74.method5362(Static30.aClass2_Sub2_Sub13_3.aString48 + "_staticelements")) {
					return;
				}
				Static30.aClass255_3 = Static284.method2853(Static174.aBoolean249, Static30.aClass330_74, Static30.aClass2_Sub2_Sub13_3.aString48 + "_staticelements");
			} else {
	...
	public static int method6552(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg1 != 16939) {
			aClass56_5 = null;
		}
