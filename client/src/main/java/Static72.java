...
public final class Static72 {
	...
	public static String method966(@OriginalArg(1) int[] arg0) {
		@Pc(7) StringBuffer local7 = new StringBuffer();
		@Pc(9) int local9 = Static331.anInt5440;
		for (@Pc(11) int local11 = 0; local11 < arg0.length; local11++) {
			@Pc(19) Class218 local19 = Static272.aClass45_1.method629(arg0[local11]);
			if (local19.anInt5704 != -1) {
				@Pc(34) Class23 local34 = (Class23) Static452.aClass82_149.method1390((long) local19.anInt5704);
				if (local34 == null) {
					@Pc(42) Class407 local42 = Static735.method6771(Static721.aClass330_128, local19.anInt5704, 0);
					if (local42 != null) {
						local34 = Static163.aClass19_17.a(local42, true);
						Static452.aClass82_149.method1384(local34, (long) local19.anInt5704);
					}
				}
				if (local34 != null) {
