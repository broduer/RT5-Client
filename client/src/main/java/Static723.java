...
public final class Static723 {
	...
	public static void method6829() {
		Static268.aClass28_22.method372();
		Static232.aClass28_18.method372();
	}
	...
	public static void method6830() {
		...
		@Pc(77) int local77 = Static102.method1286(Static394.anInt6176, -29754, Static38.anInt920, Static494.anInt7409);
		@Pc(79) int local79 = 0;
		@Pc(109) int local109;
		if (local59 > 3 && local63 > 3 && Static720.anInt10859 - 4 > local59 && local63 < Static501.anInt7568 - 4) {
			for (local109 = local59 - 4; local109 <= local59 + 4; local109++) {
				for (@Pc(114) int local114 = local63 - 4; local114 <= local63 + 4; local114++) {
					...
					if (local117 < 3 && Static441.method4209(local114, local109)) {
						local117++;
					}
					...
					if (Static246.aClass178Array1 != null && Static246.aClass178Array1[local117] != null) {
						@Pc(177) int local177 = local132 + local77 - Static246.aClass178Array1[local117].a(local114, local109, (byte) -118);
						if (local79 < local177) {
							local79 = local177;
						}
					}
