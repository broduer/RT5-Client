...
public final class Static725 {
	...
	public static void method6833(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1) {
		if (!Static18.aBoolean20 || !Static29.aBoolean60) {
			Static469.anInt7072 = 0;
			return;
		}
		if (Static703.aBoolean798) {
			Static415.aLong205 = Static272.aClass13_1.method3628();
		}
		...
		arg0.a(Static118.anIntArray198);
		...
		Static107.aClass73_3 = arg0.n();
		Static469.anInt7072 = 0;
		for (@Pc(117) int local117 = 0; local117 < Static317.anInt5046; local117++) {
			Static494.method4630(arg1, Static384.aClass75Array2[local117], arg0);
		}
		if (-20 != -20) {
			anIntArray890 = null;
		}
		for (@Pc(149) int local149 = 0; local149 < Static444.anInt6751; local149++) {
			Static494.method4630(arg1, Static607.aClass75Array4[local149], arg0);
		}
		for (@Pc(170) int local170 = 0; local170 < Static150.anInt2634; local170++) {
			Static494.method4630(arg1, Static285.aClass75Array1[local170], arg0);
		}
		...
		if (Static469.anInt7072 > 0) {
			...
			for (@Pc(289) int local289 = 0; local289 < Static469.anInt7072; local289++) {
				...
				Static264.a(local295.aShortArray17[0], local295.aShortArray18[0], local295.aShortArray19[3], local295.aShortArray19[1], local295.aShortArray18[3], local295.aShortArray17[3], local295.aShortArray18[1], local295.aShortArray19[0], local295.aShortArray17[1]);
				Static264.a(local295.aShortArray17[1], local295.aShortArray18[1], local295.aShortArray19[3], local295.aShortArray19[2], local295.aShortArray18[3], local295.aShortArray17[3], local295.aShortArray18[2], local295.aShortArray19[1], local295.aShortArray17[2]);
			}
			Static254.anInt4115 = 2;
		}
		if (Static703.aBoolean798) {
			Static666.aLong301 = Static272.aClass13_1.method3628() - Static415.aLong205;
		}
	}

	@OriginalMember(owner = "client!ww", name = "a", descriptor = "(ZD)V")
	public static void method6834(@OriginalArg(1) double arg0) {
