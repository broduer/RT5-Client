...
public final class Static726 {
	...
	public static void a(@OriginalArg(0) String arg0) {
		if (arg0 == null) {
			return;
		}
		...
		for (@Pc(25) int local25 = 0; local25 < Static436.anInt3849; local25++) {
			...
			@Pc(34) String local34 = Static390.method3889(local30);
			if (Static585.method5436(arg0, local34, local30, local11)) {
				Static436.anInt3849--;
				...
				@Pc(101) Class153 local101 = Static668.method6208();
				@Pc(107) Class2_Sub19 local107 = Static293.method3000(Static8.aClass345_1, local101.aClass186_1);
				local107.aClass2_Sub21_Sub2_1.method5198(Static231.method2417(arg0));
				local107.aClass2_Sub21_Sub2_1.method5200(arg0);
				local101.method2339(local107);
				return;
			}
		}
	}
