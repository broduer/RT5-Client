	...
	public static void method9470(@OriginalArg(0) String arg0) {
		...
		for (@Pc(25) int local25 = 0; local25 < Static436.anInt3860; local25++) {
			...
			if (Static585.method7689(arg0, local34, local30, local11)) {
				...
				@Pc(107) Class2_Sub19 local107 = Static293.method4342(Static8.aClass347_1, local101.aClass186_1);
				local107.aClass2_Sub21_Sub2_1.method7396(Static231.method3379(arg0));
				local107.aClass2_Sub21_Sub2_1.method7398(arg0);
