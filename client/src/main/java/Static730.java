...
public final class Static730 {
	...
	public static int method3310(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub6_Sub2 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt3696 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!haa", name = "b", descriptor = "(II[B[IIIIIIIILclient!haa;II)I")
	public static int method3312(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub6_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	public static int method3313(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub6_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt3686 -= arg10.anInt3688 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt3686 += arg10.anInt3688 * local63;
		arg10.anInt3690 = arg4;
		arg10.anInt3687 = arg5;
		arg10.anInt3696 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!haa", name = "b", descriptor = "(II[B[IIIIIIILclient!haa;II)I")
	public static int method3316(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub6_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	public static int method3321(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub6_Sub2 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt3690 += arg8.anInt3693 * (local22 - arg3);
		arg8.anInt3687 += arg8.anInt3697 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt3686 = arg4 >> 2;
		arg8.anInt3696 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!haa", name = "c", descriptor = "(II[B[IIIIIIIILclient!haa;II)I")
	public static int method3324(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub6_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	public static int method3325(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub6_Sub2 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt3686 += arg10.anInt3688 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt3690 = arg4 >> 2;
		arg10.anInt3687 = arg5 >> 2;
		arg10.anInt3696 = arg2 << 8;
		return arg3 >> 1;
	}
	...
	public static int method3329(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub6_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	public static int method3331(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub6_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt3690 -= arg8.anInt3693 * arg3;
		arg8.anInt3687 -= arg8.anInt3697 * arg3;
		@Pc(32) int local32;
	...
	public static int method3332(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub6_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt3690 += arg8.anInt3693 * (local24 - arg3);
		arg8.anInt3687 += arg8.anInt3697 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	public static int method3334(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub6_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	public static int method3339(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub6_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	public static int method3342(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub6_Sub2 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt3686 += arg10.anInt3688 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	public static int method3343(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub6_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	public static Class2_Sub6_Sub2 method3346(@OriginalArg(0) Class2_Sub49_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray98 == null || arg0.aByteArray98.length == 0 ? null : new Class2_Sub6_Sub2(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!haa", name = "d", descriptor = "(II[B[IIIIIIIILclient!haa;II)I")
	public static int method3347(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub6_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt3690 -= arg8.anInt3693 * arg3;
		arg8.anInt3687 -= arg8.anInt3697 * arg3;
		@Pc(32) int local32;
