...
public final class Static735 {
	...
	public static Class409[] method9383(@OriginalArg(0) byte[] arg0) {
		...
		for (@Pc(58) int local58 = 0; local58 < local14; local58++) {
			local17[local58].anInt10881 = local4.g2();
		}
		for (@Pc(72) int local72 = 0; local72 < local14; local72++) {
			local17[local72].anInt10877 = local4.g2();
		}
		for (@Pc(86) int local86 = 0; local86 < local14; local86++) {
			local17[local86].anInt10876 = local4.g2();
		}
		for (@Pc(100) int local100 = 0; local100 < local14; local100++) {
			local17[local100].anInt10879 = local4.g2();
		}
			...
			if ((local217 & 0x2) == 0) {
				...
				if ((local217 & 0x1) == 0) {
					for (local227 = 0; local227 < local209; local227++) {
						local203.aByteArray114[local227] = local4.g1b();
					}
				} else {
					for (local227 = 0; local227 < local203.anInt10876; local227++) {
						for (local245 = 0; local245 < local203.anInt10879; local245++) {
							local203.aByteArray114[local227 + local245 * local203.anInt10876] = local4.g1b();
						}
					}
				}
			} else {
				...
				if ((local217 & 0x1) == 0) {
					for (local245 = 0; local245 < local209; local245++) {
						local203.aByteArray114[local245] = local4.g1b();
					}
					for (local295 = 0; local295 < local209; local295++) {
						@Pc(305) byte local305 = local203.aByteArray115[local295] = local4.g1b();
						local271 |= local305 != -1;
					}
				} else {
					for (local245 = 0; local245 < local203.anInt10876; local245++) {
						for (local295 = 0; local295 < local203.anInt10879; local295++) {
							local203.aByteArray114[local245 + local295 * local203.anInt10876] = local4.g1b();
						}
					}
					for (local295 = 0; local295 < local203.anInt10876; local295++) {
						for (@Pc(352) int local352 = 0; local352 < local203.anInt10879; local352++) {
							@Pc(367) byte local367 = local203.aByteArray115[local295 + local352 * local203.anInt10876] = local4.g1b();
							local271 |= local367 != -1;
						}
					}
				}
