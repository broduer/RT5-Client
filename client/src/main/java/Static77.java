...
public final class Static77 {
	...
	public static final Class289 aClass289_5 = new Class289(13, 7);

	@OriginalMember(owner = "client!ci", name = "d", descriptor = "Lclient!kda;")
	public static final Class206 aClass206_1 = new Class206(1, 2);
	...
	public static void method1557() {
		@Pc(13) Node_Sub19 local13 = Static293.method4342(Static317.aClass347_62, Static405.aClass153_2.aClass186_1);
		...
		for (@Pc(22) Node_Sub4 local22 = (Node_Sub4) Static548.aClass28_40.method736(); local22 != null; local22 = (Node_Sub4) Static548.aClass28_40.method740()) {
			...
			if (local22.anInt146 == 0) {
				Static449.method6122(true, true, local22);
			}
		}
	...
	public static void method1558(@OriginalArg(0) int arg0) {
		@Pc(9) SecondaryNode_Sub2 local9 = Static440.method5970(8, arg0);
		local9.method205();
	}

	@OriginalMember(owner = "client!ci", name = "a", descriptor = "(I)Z")
	public static boolean method1559() {
		return Static594.anInt8801 > 0;
	}
	...
	public static void method1561() {
		...
		if (local8 == 0) {
			...
			Static556.method7307(0);
		} else if (local8 == 1) {
			Static170.method2652((byte) 0);
			Static556.method7307(512);
			if (Static280.aByteArrayArrayArray3 != null) {
				Static361.method5247();
			}
		} else {
			Static170.method2652((byte) (Static198.anInt3285 - 4 & 0xFF));
			Static556.method7307(2);
		}
		Static514.anInt7703 = Static394.anInt6196;
	}
}
