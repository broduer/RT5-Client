...
public final class Static77 {
	...
	public static void method996() {
		@Pc(13) Class2_Sub19 local13 = Static293.method3000(Static317.aClass345_62, Static405.aClass153_2.aClass186_1);
		Static405.aClass153_2.method2339(local13);
		for (@Pc(22) Class2_Sub4 local22 = (Class2_Sub4) Static548.aClass28_40.method371(); local22 != null; local22 = (Class2_Sub4) Static548.aClass28_40.method375()) {
			if (!local22.e(-119)) {
				local22 = (Class2_Sub4) Static548.aClass28_40.method371();
				if (local22 == null) {
					break;
				}
			}
			if (local22.anInt146 == 0) {
				Static449.method4257(true, true, local22);
			}
		}
	...
	public static void method997(@OriginalArg(0) int arg0) {
		@Pc(9) Class2_Sub2_Sub2 local9 = Static440.method4204(8, (long) arg0);
		local9.method133();
	}

	@OriginalMember(owner = "client!ci", name = "a", descriptor = "(I)Z")
	public static boolean method998() {
		return Static594.anInt8777 > 0;
	}

	@OriginalMember(owner = "client!ci", name = "a", descriptor = "(III)Z")
	public static boolean method999(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		return (arg1 & 0x84080) != 0;
	}

	@OriginalMember(owner = "client!ci", name = "b", descriptor = "(I)V")
	public static void method1000() {
		@Pc(8) int local8 = Static400.aClass2_Sub34_28.aClass57_Sub4_2.method1377();
		if (local8 == 0) {
			Static328.aByteArrayArrayArray4 = null;
			Static556.method5124(0);
		} else if (local8 == 1) {
			Static170.method1794((byte) 0);
			Static556.method5124(512);
			if (Static280.aByteArrayArrayArray3 != null) {
				Static361.method3697();
			}
		} else {
			Static170.method1794((byte) (Static198.anInt3276 - 4 & 0xFF));
			Static556.method5124(2);
		}
