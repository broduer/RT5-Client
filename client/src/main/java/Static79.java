...
public final class Static79 {
	...
	public static void method1012() {
		for (@Pc(10) Class2_Sub2_Sub4 local10 = (Class2_Sub2_Sub4) Static350.aClass192_8.method3017(); local10 != null; local10 = (Class2_Sub2_Sub4) Static350.aClass192_8.method3015()) {
			if (local10.anInt1534 > 1) {
				local10.anInt1534 = 0;
				Static717.aClass82_232.method1384(local10, ((Class2_Sub2_Sub16) local10.aClass192_3.aClass2_Sub2_36.aClass2_Sub2_66).aLong234);
				local10.aClass192_3.method3016();
			}
		}
		...
		Static84.method1082(Static525.aClass2_Sub2_Sub16_12);
	}

	@OriginalMember(owner = "client!cja", name = "a", descriptor = "(BLjava/lang/String;)V")
	public static void method1013(@OriginalArg(1) String arg0) {
		if (Static393.aStringArray32 == null) {
			Static279.method2827();
		}
		Static459.aCalendar3.setTime(new Date(Static588.method5469()));
		...
		@Pc(74) String[] local74 = Static189.method1971(arg0, '\n');
		for (@Pc(76) int local76 = 0; local76 < local74.length; local76++) {
			...
			if (Static134.aFileOutputStream2 != null) {
				try {
					Static134.aFileOutputStream2.write(Static469.method4450(Static393.aStringArray32[0] + "\n"));
