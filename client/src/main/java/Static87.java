...
public final class Static87 {
	...
	public static void method1107(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(8) int local8;
		if (arg0 >= arg1) {
	...
	public static void method1108(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2, @OriginalArg(3) Class19 arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		if (Static459.aClass23_31 == null || Static1.aClass23_42 == null) {
			if (Static721.aClass330_128.method5345(Static63.anInt1474) && Static721.aClass330_128.method5345(Static282.anInt4417)) {
				Static459.aClass23_31 = arg3.a(Static735.method6771(Static721.aClass330_128, Static63.anInt1474, 0), true);
				@Pc(49) Class407 local49 = Static735.method6771(Static721.aClass330_128, Static282.anInt4417, 0);
				Static1.aClass23_42 = arg3.a(local49, true);
				local49.method6777();
				Static608.aClass23_41 = arg3.a(local49, true);
			} else {
				arg3.aa(arg5, arg4, arg0, 20, Static719.anInt10504 | 255 - Static514.anInt7677 << 24, 1);
			}
		}
		if (Static459.aClass23_31 != null && Static1.aClass23_42 != null) {
			@Pc(82) int local82 = (arg0 - Static1.aClass23_42.c() * 2) / Static459.aClass23_31.c();
			for (@Pc(84) int local84 = 0; local84 < local82; local84++) {
				Static459.aClass23_31.a(arg5 + Static1.aClass23_42.c() + local84 * Static459.aClass23_31.c(), arg4);
			}
			Static1.aClass23_42.a(arg5, arg4);
			Static608.aClass23_41.a(arg0 + arg5 - Static608.aClass23_41.c(), arg4);
		}
		Static180.aClass14_3.a((int) (arg5 + 3), arg4 + 14, arg2, -1, 1, Static563.anInt8455 | 0xFF000000);
	...
	public static void method1109(@OriginalArg(0) String arg0) {
