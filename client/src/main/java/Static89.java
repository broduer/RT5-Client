...
public final class Static89 {
	...
	public static void method1124(@OriginalArg(0) int arg0, @OriginalArg(1) Class8_Sub2_Sub1_Sub2_Sub1 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Class8_Sub2_Sub1_Sub2_Sub2 arg4, @OriginalArg(5) Class54 arg5, @OriginalArg(7) int arg6) {
		...
		if (arg5 != null) {
			...
			Static460.aClass339_40.method5465(local7);
			return;
		}
		if (arg4 != null) {
			...
			if (local37.anIntArray532 != null) {
				local7.aBoolean713 = true;
				local37 = local37.method4221(65535, Static34.aClass304_1);
			}
			if (local37 != null) {
				local7.anInt9362 = local37.anInt6713 + arg2 << 9;
				local7.anInt9349 = arg3 + local37.anInt6713 << 9;
				local7.anInt9353 = Static497.method4658(arg4);
			...
			Static717.aClass339_81.method5465(local7);
			return;
		}
		if (arg1 == null) {
			return;
		...
		local7.anInt9362 = arg2 + arg1.method6693((byte) 46) << 9;
		local7.anInt9349 = arg1.method6693((byte) 77) + arg3 << 9;
		local7.anInt9353 = Static326.method3400(arg1);
		...
		Static113.aClass28_12.method370((long) arg1.anInt10740, local7);
		return;
	}

	@OriginalMember(owner = "client!cp", name = "a", descriptor = "([FFIII[FFIIIII)V")
	public static void method1125(@OriginalArg(0) float[] arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) float[] arg5, @OriginalArg(6) float arg6, @OriginalArg(7) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9, @OriginalArg(11) int arg10) {
