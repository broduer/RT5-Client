...
public final class Static9 {
	...
	public static void method71() {
		Static594.aClass82_193.method1391();
	}

	@OriginalMember(owner = "client!af", name = "a", descriptor = "([BZ)V")
	public static void method72(@OriginalArg(0) byte[] arg0) {
		@Pc(15) Class2_Sub21 local15 = new Class2_Sub21(arg0);
		while (true) {
			@Pc(19) int local19 = local15.method5205();
			if (local19 == 0) {
				return;
			}
			if (local19 == 1) {
				@Pc(34) int local34 = local15.method5191();
