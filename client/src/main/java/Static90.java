...
public final class Static90 {
	...
	public static boolean method1132(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		return (arg1 & 0x400) != 0;
	}
	...
	public static void method1133() {
		...
		for (@Pc(40) int local40 = 0; local40 < Static390.anInt6126; local40++) {
			...
			@Pc(57) Class2_Sub45 local57 = (Class2_Sub45) Static18.aClass28_2.method373(local49);
			if (local57 != null) {
				local57.aClass8_Sub2_Sub1_Sub2_Sub2_2.method6687();
			}
		}
