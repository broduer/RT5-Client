...
public final class Static93 {
	...
	public static void method1187(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) Interface4 arg3, @OriginalArg(5) Class19 arg4, @OriginalArg(6) int arg5) {
		if (Static273.anInt4403 < 100) {
			Static719.method6551(arg3, arg4);
		}
		...
		if (Static273.anInt4403 < 100) {
			...
			arg4.d(local38 - 152, local57, 304, 34, Static337.aColorArray1[Static338.anInt5562].getRGB(), 0);
			arg4.aa(local38 - 150, local57 + 2, Static273.anInt4403 * 3, 30, Static718.aColorArray3[Static338.anInt5562].getRGB(), 0);
			Static180.aClass14_3.a(-1, (byte) 113, local38, Static32.aClass32_18.method429(Static51.anInt1052), local57 + 20, Static399.aColorArray2[Static338.anInt5562].getRGB());
			return;
		}
		...
		Static30.method3544(Static30.anInt5655 + local114, local38 - -Static30.anInt5648, local57 + Static30.anInt5655, local155 - -Static30.anInt5648, arg1, arg2, arg5 + arg1, arg0 + arg2 + 1);
		Static30.method3542(arg4);
		@Pc(203) Class339 local203 = Static30.method3563(arg4);
		Static368.method3729(local203, arg4);
		...
		Static437.aClass14_9.a((byte) 123, local250, "Fps:" + Static652.anInt9712, 16776960, -1, local256);
		...
		Static437.aClass14_9.a((byte) 108, local250, "Mem:" + local285 + "k", local287, -1, local273);
		local256 = local273 - 15;
	}

	@OriginalMember(owner = "client!cu", name = "a", descriptor = "(Ljava/lang/Class;ZLjava/lang/String;)Z")
	public static boolean method1188(@OriginalArg(0) Class arg0, @OriginalArg(2) String arg1) {
