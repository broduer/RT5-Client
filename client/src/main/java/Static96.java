...
public final class Static96 {
	...
	public static Class2_Sub2_Sub16 aClass2_Sub2_Sub16_13;

	@OriginalMember(owner = "client!da", name = "q", descriptor = "I")
	public static int anInt10171 = 0;

	@OriginalMember(owner = "client!da", name = "b", descriptor = "(II)V")
	public static void b(@OriginalArg(1) int arg0) {
		@Pc(18) Class2_Sub2_Sub2 local18 = Static440.method4204(4, (long) arg0);
		local18.method133();
	}

	@OriginalMember(owner = "client!da", name = "a", descriptor = "(II)Lclient!pf;")
	public static Class2_Sub1 a(@OriginalArg(0) int arg0) {
		if (arg0 == 0) {
	...
	public static void a(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
