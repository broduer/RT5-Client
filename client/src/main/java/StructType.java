...
public final class StructType extends SecondaryNode {
	...
	private HashTable aClass28_1;

	@OriginalMember(owner = "client!ab", name = "a", descriptor = "(ILclient!ge;I)V")
	private void method88(@OriginalArg(0) int arg0, @OriginalArg(1) Buffer arg1) {
		if (arg0 != 249) {
			return;
		}
		...
		if (this.aClass28_1 == null) {
			local13 = Static440.method5969(local6);
			this.aClass28_1 = new HashTable(local13);
		}
		for (local13 = 0; local13 < local6; local13++) {
			...
			@Pc(45) Node local45;
			if (local32) {
				local45 = new Node_Sub24(arg1.gstr());
			} else {
				local45 = new Node_Sub38(arg1.g4());
			}
			this.aClass28_1.put(local36, local45);
		}
	}
	...
	public int method89(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		if (this.aClass28_1 == null) {
			...
			@Pc(17) Node_Sub38 local17 = (Node_Sub38) this.aClass28_1.get(arg1);
			return local17 == null ? arg0 : local17.anInt6399;
		}
	}

	@OriginalMember(owner = "client!ab", name = "a", descriptor = "(BLclient!ge;)V")
	public void method90(@OriginalArg(1) Buffer arg0) {
		while (true) {
	...
	public String method91(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1) {
		if (this.aClass28_1 == null) {
			...
			@Pc(23) Node_Sub24 local23 = (Node_Sub24) this.aClass28_1.get(arg0);
