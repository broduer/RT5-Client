...
public final class Texture extends SecondaryNode {
	...
	private Texture() {
		...
		this.aClass2_Sub1_2.imageCacheCapacity = 1;
		this.aClass2_Sub1_3 = new TextureOpMonochromeFill();
		this.aClass2_Sub1_3.imageCacheCapacity = 1;
		this.aClass2_Sub1_1 = new TextureOpMonochromeFill();
		this.aClass2_Sub1_1.imageCacheCapacity = 1;
	...
	public Texture(@OriginalArg(0) Buffer arg0) {
		...
		for (@Pc(20) int local20 = 0; local20 < local7; local20++) {
			@Pc(28) TextureOp local28 = Static294.method4348(arg0);
			if (local28.method9419() >= 0) {
				local9++;
			}
			if (local28.method9426() >= 0) {
				local11++;
			}
			@Pc(49) int local49 = local28.childOps.length;
		...
		for (@Pc(105) int local105 = 0; local105 < local7; local105++) {
			...
			local56 = local114.childOps.length;
			for (@Pc(120) int local120 = 0; local120 < local56; local120++) {
				local114.childOps[local120] = this.aClass2_Sub1Array39[local14[local105][local120]];
			}
			@Pc(148) int local148 = local114.method9419();
			@Pc(152) int local152 = local114.method9426();
			if (local148 > 0) {
	...
	public float[] method8953(@OriginalArg(1) int arg0, @OriginalArg(2) TextureProvider arg1, @OriginalArg(3) Js5 arg2, @OriginalArg(4) boolean arg3, @OriginalArg(5) int arg4) {
		Static582.aClass332_108 = arg2;
		Static677.anInterface4_11 = arg1;
		for (@Pc(25) int local25 = 0; local25 < this.aClass2_Sub1Array39.length; local25++) {
			this.aClass2_Sub1Array39[local25].createImageCache(arg0, arg4);
		}
		...
		for (@Pc(58) int local58 = 0; local58 < arg0; local58++) {
			...
			if (this.aClass2_Sub1_3.monochrome) {
				@Pc(74) int[] local74 = this.aClass2_Sub1_3.getMonochromeOutput(local58);
				local76 = local74;
				local78 = local74;
				local80 = local74;
			} else {
				@Pc(88) int[][] local88 = this.aClass2_Sub1_3.getColorOutput(local58);
				local78 = local88[0];
				local76 = local88[2];
				local80 = local88[1];
			}
			...
			if (this.aClass2_Sub1_1.monochrome) {
				local110 = this.aClass2_Sub1_1.getMonochromeOutput(local58);
			} else {
				local110 = this.aClass2_Sub1_1.getColorOutput(local58)[0];
			}
			if (arg3) {
				local56 = local58 << 2;
			}
			...
			if (this.aClass2_Sub1_2.monochrome) {
				local136 = this.aClass2_Sub1_2.getMonochromeOutput(local58);
			} else {
				local136 = this.aClass2_Sub1_2.getColorOutput(local58)[0];
			}
		...
		for (@Pc(244) int local244 = 0; local244 < this.aClass2_Sub1Array39.length; local244++) {
			this.aClass2_Sub1Array39[local244].method9430();
		}
		return local54;
	}

	@OriginalMember(owner = "client!vm", name = "a", descriptor = "(Lclient!sb;Lclient!d;B)Z")
	public boolean method8954(@OriginalArg(0) Js5 arg0, @OriginalArg(1) TextureProvider arg1) {
		@Pc(12) int local12;
		if (Static426.anInt944 < 0) {
			for (local12 = 0; local12 < this.anIntArray824.length; local12++) {
				if (!arg0.method7588(this.anIntArray824[local12])) {
					return false;
				}
			}
		} else {
	...
	public int[] method8955(@OriginalArg(0) int arg0, @OriginalArg(1) double arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) int arg3, @OriginalArg(5) TextureProvider arg4, @OriginalArg(6) Js5 arg5) {
		Static582.aClass332_108 = arg5;
		Static677.anInterface4_11 = arg4;
		for (@Pc(11) int local11 = 0; local11 < this.aClass2_Sub1Array39.length; local11++) {
			this.aClass2_Sub1Array39[local11].createImageCache(arg3, arg0);
		}
		Static725.method9462(arg1);
		...
		for (@Pc(57) int local57 = 0; local57 < arg3; local57++) {
			...
			@Pc(93) int[] local93;
			if (this.aClass2_Sub1_3.monochrome) {
				local93 = this.aClass2_Sub1_3.getMonochromeOutput(local57);
				local81 = local93;
				local85 = local93;
				local77 = local93;
			} else {
				@Pc(73) int[][] local73 = this.aClass2_Sub1_3.getColorOutput(local57);
				local77 = local73[0];
				local81 = local73[2];
				local85 = local73[1];
			}
			if (this.aClass2_Sub1_1.monochrome) {
				local93 = this.aClass2_Sub1_1.getMonochromeOutput(local57);
			} else {
				local93 = this.aClass2_Sub1_1.getColorOutput(local57)[0];
			}
			if (arg2) {
				local55 = local57;
			}
		...
		for (@Pc(268) int local268 = 0; local268 < this.aClass2_Sub1Array39.length; local268++) {
			this.aClass2_Sub1Array39[local268].method9430();
		}
		return local53;
	}

	@OriginalMember(owner = "client!vm", name = "a", descriptor = "(Lclient!sb;DZLclient!d;ZIII)[I")
	public int[] method8958(@OriginalArg(0) Js5 arg0, @OriginalArg(1) double arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) TextureProvider arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		Static677.anInterface4_11 = arg3;
		Static582.aClass332_108 = arg0;
		for (@Pc(11) int local11 = 0; local11 < this.aClass2_Sub1Array39.length; local11++) {
			this.aClass2_Sub1Array39[local11].createImageCache(arg5, arg6);
		}
		Static725.method9462(arg1);
		...
		for (@Pc(65) int local65 = 0; local65 < arg5; local65++) {
			...
			@Pc(83) int[] local83;
			if (this.aClass2_Sub1_3.monochrome) {
				@Pc(79) int[] local79 = this.aClass2_Sub1_3.getMonochromeOutput(local65);
				local81 = local79;
				local83 = local79;
				local85 = local79;
			} else {
				@Pc(93) int[][] local93 = this.aClass2_Sub1_3.getColorOutput(local65);
				local83 = local93[2];
				local81 = local93[1];
				local85 = local93[0];
			}
		...
		for (@Pc(230) int local230 = 0; local230 < this.aClass2_Sub1Array39.length; local230++) {
			this.aClass2_Sub1Array39[local230].method9430();
		}
		return local41;
	}
}
