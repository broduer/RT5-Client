...
public final class TextureOpCombine extends TextureOp {
	...
	public int[] getMonochromeOutput(@OriginalArg(1) int y) {
		...
		if (super.monochromeImageCache.invalid) {
			@Pc(28) int[] local28 = this.method9429(y, 0);
			@Pc(34) int[] local34 = this.method9429(y, 1);
			@Pc(37) int local37 = this.anInt6121;
			if (local37 == 1) {
				for (local37 = 0; local37 < Static608.width; local37++) {
	...
	public int[][] getColorOutput(@OriginalArg(0) int y) {
		...
		if (super.colorImageCache.invalid) {
			@Pc(30) int[][] local30 = this.method9420(0, y);
			@Pc(36) int[][] local36 = this.method9420(1, y);
