...
public final class TextureOpInterpolate extends TextureOp {
	...
	public int[][] getColorOutput(@OriginalArg(0) int y) {
		...
		if (super.colorImageCache.invalid) {
			@Pc(27) int[] local27 = this.method9429(y, 2);
			@Pc(33) int[][] local33 = this.method9420(0, y);
			@Pc(39) int[][] local39 = this.method9420(1, y);
			...
			for (@Pc(77) int local77 = 0; local77 < Static608.width; local77++) {
	...
	public int[] getMonochromeOutput(@OriginalArg(1) int y) {
		...
		if (super.monochromeImageCache.invalid) {
			...
			@Pc(27) int[] local27 = this.method9429(y, 1);
			@Pc(33) int[] local33 = this.method9429(y, 2);
