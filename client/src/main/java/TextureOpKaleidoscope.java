...
public final class TextureOpKaleidoscope extends TextureOp {
	...
	private void method8698(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(9) int local9 = Static54.normalizedX[arg0];
		@Pc(13) int local13 = Static273.normalizedY[arg1];
		...
		if ((double) local24 >= -3.141592653589793D && (double) local24 <= -2.356194490192345D) {
			...
			Static37.anInt920 = Static608.width - arg1;
			Static187.anInt3102 = arg0;
			...
			Static187.anInt3102 = Static2.anInt53 - arg1;
			Static37.anInt920 = Static608.width - arg0;
		} else if ((double) local24 >= 0.7853981633974483D && (double) local24 <= 1.5707963267948966D) {
	...
	public int[][] getColorOutput(@OriginalArg(0) int y) {
		...
		if (super.colorImageCache.invalid) {
			...
			for (@Pc(39) int local39 = 0; local39 < Static608.width; local39++) {
				this.method8698(local39, y);
	...
	public int[] getMonochromeOutput(@OriginalArg(1) int y) {
		...
		if (super.monochromeImageCache.invalid) {
			for (@Pc(24) int local24 = 0; local24 < Static608.width; local24++) {
				this.method8698(local24, y);
