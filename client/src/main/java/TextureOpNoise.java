...
public final class TextureOpNoise extends TextureOp {
	...
	private int method8793(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
	...
	public int[] getMonochromeOutput(@OriginalArg(1) int y) {
		...
		if (super.monochromeImageCache.invalid) {
			@Pc(28) int local28 = Static273.normalizedY[y];
			for (@Pc(30) int local30 = 0; local30 < Static608.width; local30++) {
				local11[local30] = this.method8793(local28, Static54.normalizedX[local30]) % 4096;
			}
		}
		return local11;
	}
