...
public final class TextureOpPerlinNoise extends TextureOp {
	...
	public void method7816(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1) {
		@Pc(15) int local15 = this.anInt8829 * Static273.normalizedY[arg0];
		@Pc(103) int local103;
		@Pc(117) int local117;
		@Pc(31) int local31;
		@Pc(24) short local24;
		...
		if (this.anInt8827 == 1) {
			...
			local81 = MonochromeImageCache.PERLIN_FADE[local37];
			local90 = this.aByteArray97[local59 & 0xFF] & 0xFF;
			if (this.aBoolean668) {
				for (local95 = 0; local95 < Static608.width; local95++) {
					local103 = this.anInt8834 * Static54.normalizedX[local95];
				...
				for (local95 = 0; local95 < Static608.width; local95++) {
					local103 = Static54.normalizedX[local95] * this.anInt8834;
					local117 = this.method7819(local51, local77, local31 * local103 >> 12, local37, local81, local90);
	...
	public void method9428() {
		this.aByteArray97 = TextureOp.getPermutation(this.anInt8833);
		this.method7820();
	...
	public void decode(@OriginalArg(1) Buffer buf, @OriginalArg(2) int code) {
		if (code == 0) {
			this.aBoolean668 = buf.g1() == 1;
		} else if (code == 1) {
			this.anInt8827 = buf.g1();
		} else if (code == 2) {
			this.anInt8823 = buf.method7363();
			if (this.anInt8823 < 0) {
				this.aShortArray128 = new short[this.anInt8827];
				for (@Pc(103) int local103 = 0; local103 < this.anInt8827; local103++) {
					this.aShortArray128[local103] = (short) buf.method7363();
				}
				return;
			}
		} else if (code == 3) {
			this.anInt8834 = this.anInt8829 = buf.g1();
			return;
		} else if (code == 4) {
			this.anInt8833 = buf.g1();
			return;
		} else if (code == 5) {
			this.anInt8834 = buf.g1();
			return;
		} else if (code == 6) {
			this.anInt8829 = buf.g1();
			return;
		}
	}
	...
	private int method7819(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		...
		@Pc(44) int local44 = MonochromeImageCache.PERLIN_FADE[local15];
