...
public final class TextureOpRasterizer extends TextureOp {
	...
	public int[] getMonochromeOutput(@OriginalArg(1) int y) {
		...
		if (super.monochromeImageCache.invalid) {
			this.method6417(super.monochromeImageCache.method3932());
		}
		return local16;
	}

	@OriginalMember(owner = "client!ot", name = "a", descriptor = "(I[[I)V")
	private void method6417(@OriginalArg(1) int[][] arg0) {
		@Pc(7) int local7 = Static608.width;
		@Pc(9) int local9 = Static2.anInt53;
		Static430.method5822(arg0);
		Static96.method8842(Static489.anInt7364, Static576.anInt8604);
		...
		for (@Pc(23) int local23 = 0; local23 < this.aClass154Array1.length; local23++) {
			...
			@Pc(33) int local33 = local30.anInt7677;
			@Pc(36) int local36 = local30.anInt7678;
			if (local33 >= 0) {
				if (local36 < 0) {
					local30.method6779(local7, local9);
				} else {
					local30.method6783(local9, local7);
				}
			} else if (local36 >= 0) {
				local30.method6782(local9, local7);
			}
		}
	}
	...
	public int[][] getColorOutput(@OriginalArg(0) int y) {
		...
		if (super.colorImageCache.invalid) {
			@Pc(23) int local23 = Static608.width;
			@Pc(25) int local25 = Static2.anInt53;
			@Pc(29) int[][] local29 = new int[local25][local23];
			@Pc(34) int[][][] local34 = super.colorImageCache.method8458();
			this.method6417(local29);
			for (@Pc(40) int local40 = 0; local40 < Static2.anInt53; local40++) {
				...
				for (@Pc(64) int local64 = 0; local64 < Static608.width; local64++) {
	...
	public void decode(@OriginalArg(1) Buffer buf, @OriginalArg(2) int code) {
		if (code == 0) {
			this.aClass154Array1 = new Class154[buf.g1()];
			for (@Pc(33) int local33 = 0; local33 < this.aClass154Array1.length; local33++) {
				@Pc(39) int local39 = buf.g1();
				if (local39 == 0) {
					this.aClass154Array1[local33] = Static305.method4444(buf);
				} else if (local39 == 1) {
					this.aClass154Array1[local33] = Static396.method5559(buf);
				} else if (local39 == 2) {
					this.aClass154Array1[local33] = Static150.method2456(buf);
				} else if (local39 == 3) {
					this.aClass154Array1[local33] = Static75.method6247(buf);
				}
			}
		} else if (code == 1) {
