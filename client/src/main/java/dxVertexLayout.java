...
public final class dxVertexLayout extends Class246 {
	...
	public dxVertexLayout(@OriginalArg(0) Class19_Sub1_Sub1 arg0, @OriginalArg(1) Class239[] arg1) {
		@Pc(7) VertexElementCollection local7 = new VertexElementCollection(arg0.aClass189_1);
		@Pc(9) int local9 = 0;
		for (@Pc(11) int local11 = 0; local11 < arg1.length; local11++) {
			@Pc(17) int local17 = 0;
			@Pc(21) Class239 local21 = arg1[local11];
			for (@Pc(23) int local23 = 0; local23 < local21.method5450(); local23++) {
				@Pc(33) Class157 local33 = local21.method5452(local23);
