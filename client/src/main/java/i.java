...
public final class i extends Class114 implements Interface5 {
	...
	public Class330[] aClass330Array3;

	@OriginalMember(owner = "client!i", name = "p", descriptor = "[Lclient!mn;")
	public Class251[] aClass251Array3;
	...
	public i(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class88 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		this.anOa2 = arg0;
		this.aYa1 = arg1;
		this.aClass330Array3 = arg2.aClass330Array1;
		this.aClass251Array3 = arg2.aClass251Array1;
		@Pc(24) int local24 = arg2.aClass330Array1 == null ? 0 : arg2.aClass330Array1.length;
		@Pc(34) int local34 = arg2.aClass251Array1 == null ? 0 : arg2.aClass251Array1.length;
		@Pc(36) int local36 = 0;
		@Pc(43) int[] local43 = new int[local24 * 3 + local34];
		for (@Pc(45) int local45 = 0; local45 < local24; local45++) {
			local43[local36++] = this.aClass330Array3[local45].anInt8538;
			local43[local36++] = this.aClass330Array3[local45].anInt8532;
			local43[local36++] = this.aClass330Array3[local45].anInt8529;
		}
		for (@Pc(79) int local79 = 0; local79 < local34; local79++) {
			local43[local36++] = this.aClass251Array3[local79].anInt6267;
		}
		...
		for (@Pc(114) int local114 = 0; local114 < local105; local114++) {
			...
			@Pc(125) Class378 local125 = Static402.method5589(local120.anInt594);
			local110[local112++] = local120.anInt590;
			local110[local112++] = local125.anInt9722;
			local110[local112++] = local125.anInt9716;
			local110[local112++] = local125.anInt9719;
			local110[local112++] = local125.anInt9723;
			local110[local112++] = local125.anInt9715;
			local110[local112++] = local125.aBoolean748 ? -1 : 0;
		}
		for (@Pc(178) int local178 = 0; local178 < local105; local178++) {
			@Pc(184) Class24 local184 = arg2.aClass24Array1[local178];
			local110[local112++] = local184.anInt591;
		}
		this.R(this.anOa2, this.aYa1, arg2.anInt2381, arg2.anInt2372, arg2.anIntArray213, arg2.anIntArray205, arg2.anIntArray204, arg2.anIntArray209, arg2.aShortArray23, arg2.anInt2371, arg2.aShortArray27, arg2.aShortArray24, arg2.aShortArray26, arg2.aByteArray25, arg2.aByteArray26, arg2.aByteArray29, arg2.aByteArray28, arg2.aShortArray22, arg2.aShortArray25, arg2.anIntArray210, arg2.aByte45, arg2.aShortArray20, arg2.anInt2386, arg2.aByteArray24, arg2.aShortArray29, arg2.aShortArray21, arg2.aShortArray28, arg2.anIntArray211, arg2.anIntArray207, arg2.anIntArray208, arg2.aByteArray27, arg2.aByteArray23, arg2.anIntArray214, arg2.anIntArray212, arg2.anIntArray206, local43, local24, local34, arg3, arg4, arg5, arg6, local110);
	}
	...
	public boolean method7490(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class73 arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		return this.anOa2.method6094().method5(this, arg0, arg1, arg2, arg3, arg5);
	}
	...
	public boolean method7493(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class73 arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4) {
		return this.anOa2.method6094().method11(this, arg0, arg1, arg2, arg3);
	}
	...
	public void method7483(@OriginalArg(0) Class73 arg0) {
		...
		@Pc(5) int local5 = 0;
		@Pc(10) int local10;
		if (this.aClass330Array3 != null) {
			for (local10 = 0; local10 < this.aClass330Array3.length; local10++) {
				@Pc(16) Class330 local16 = this.aClass330Array3[local10];
				local16.anInt8542 = Static445.anIntArray537[local5++];
				local16.anInt8526 = Static445.anIntArray537[local5++];
				local16.anInt8528 = Static445.anIntArray537[local5++];
				local16.anInt8540 = Static445.anIntArray537[local5++];
				local16.anInt8531 = Static445.anIntArray537[local5++];
				local16.anInt8533 = Static445.anIntArray537[local5++];
				local16.anInt8536 = Static445.anIntArray537[local5++];
				local16.anInt8527 = Static445.anIntArray537[local5++];
				local16.anInt8544 = Static445.anIntArray537[local5++];
			}
		}
		if (this.aClass251Array3 == null) {
			return;
		}
		for (local10 = 0; local10 < this.aClass251Array3.length; local10++) {
			@Pc(89) Class251 local89 = this.aClass251Array3[local10];
			@Pc(91) Class251 local91 = local89;
			if (local89.aClass251_2 != null) {
				local91 = local89.aClass251_2;
			}
			if (local89.aClass73_6 == null) {
				local89.aClass73_6 = arg0.method7136();
			} else {
				local89.aClass73_6.method7135(arg0);
			}
			local91.anInt6272 = Static445.anIntArray537[local5++];
			local91.anInt6270 = Static445.anIntArray537[local5++];
			local91.anInt6269 = Static445.anIntArray537[local5++];
		}
	}
	...
	public native SecondaryNode_Sub9 ba(@OriginalArg(0) SecondaryNode_Sub9 arg0);
	...
	public void method7491(@OriginalArg(0) Class73 arg0, @OriginalArg(1) Class8_Sub6 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		this.anOa2.method6094().method9(this, arg0, Static445.anIntArray542, arg2, arg3);
		arg1.anInt4518 = Static445.anIntArray542[0];
		arg1.anInt4519 = Static445.anIntArray542[1];
		arg1.anInt4515 = Static445.anIntArray542[2];
		arg1.anInt4517 = Static445.anIntArray542[3];
		arg1.anInt4516 = Static445.anIntArray542[4];
	...
	private void method3688(@OriginalArg(0) int[] arg0, @OriginalArg(1) Class73 arg1) {
		this.anOa2.method6094().method15(this, arg0, arg1);
	}
	...
	public Class114 method7502(@OriginalArg(0) byte arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		return this.anOa2.method6094().method3(this, arg0, arg1, arg2);
	}
	...
	public void method7480(@OriginalArg(0) Class73 arg0, @OriginalArg(1) Class8_Sub6 arg1, @OriginalArg(2) int arg2) {
		...
		Static445.anIntArray542[5] = 0;
		this.anOa2.method6094().method8(this, arg0, Static445.anIntArray542, arg2);
		arg1.anInt4518 = Static445.anIntArray542[0];
		arg1.anInt4519 = Static445.anIntArray542[1];
		arg1.anInt4515 = Static445.anIntArray542[2];
		arg1.anInt4517 = Static445.anIntArray542[3];
	...
	public void method7488(@OriginalArg(0) Class114 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
		this.anOa2.method6094().method10(this, arg0, arg1, arg2, arg3, arg4);
	}

	@OriginalMember(owner = "client!i", name = "f", descriptor = "()[Lclient!rv;")
	@Override
	public Class330[] method7489() {
		return this.aClass330Array3;
	}
}
