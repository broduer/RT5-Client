...
public final class IDirect3D extends IUnknown {
	...
	public static native int _Direct3DCreate(@OriginalArg(0) int arg0, @OriginalArg(1) IDirect3D arg1);
	...
	public native int _GetAdapterDisplayMode(@OriginalArg(0) int arg0, @OriginalArg(1) D3DDISPLAYMODE arg1);
	...
	public native int _GetAdapterIdentifier(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) D3DADAPTER_IDENTIFIER arg2);
	...
	public native int _GetDeviceCaps(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) D3DCAPS arg2);
	...
	public native int _CreateDevice(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Canvas arg2, @OriginalArg(3) int arg3, @OriginalArg(4) D3DPRESENT_PARAMETERS arg4, @OriginalArg(5) IDirect3DDevice arg5);
