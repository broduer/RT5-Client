...
public final class IDirect3D extends IUnknown {
	...
	public static IDirect3D a(@OriginalArg(0) int arg0, @OriginalArg(1) Class189 arg1) {
		@Pc(4) IDirect3D local4 = new IDirect3D(arg1);
		@Pc(8) int local8 = _Direct3DCreate(arg0, local4);
		if (Class190.method4162(local8)) {
			throw new RuntimeException_Sub2(String.valueOf(local8));
		}
		return local4;
	}

	@OriginalMember(owner = "client!jagdx/IDirect3D", name = "<init>", descriptor = "(Lclient!jaclib/peer/ti;)V")
	private IDirect3D(@OriginalArg(0) Class189 arg0) {
		super(arg0);
		this.b = arg0;
	}
