...
public final class n extends Class14 implements Interface5 {
	...
	public n(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class383 arg2, @OriginalArg(3) Class409[] arg3, @OriginalArg(4) Class23[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			...
			local11[local25] = arg3[local25].anInt10876;
			local15[local25] = arg3[local25].anInt10879;
			local19[local25] = arg3[local25].anInt10881;
			local23[local25] = arg3[local25].anInt10877;
		}
	...
	public native void PA(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class1 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
