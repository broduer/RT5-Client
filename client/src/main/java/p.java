...
public final class p extends Class2 implements Interface5 {
	...
	private void a(@OriginalArg(0) Exception arg0) {
		if (!Static474.aBoolean542) {
			Static474.aLong229 = Static588.method5469();
			Static474.aBoolean542 = true;
		} else if (Static588.method5469() - Static474.aLong229 < 30000L) {
	...
	public void a(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
			synchronized (this.aCanvas9.getTreeLock()) {
