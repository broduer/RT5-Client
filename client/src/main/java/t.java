...
public final class t extends Class178 implements Interface5 {
		...
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt8918 && local59 >= 0 && local59 < super.anInt8916) {
						this.method7882(local53, local59);
					}
				}
			}
		}
	...
	public void method7882(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt8921 < 0) {
			this.anOa3.method6094().method2(this, arg0, arg1);
		} else {
			this.anOa3.method6094().method6(this, arg0, arg1, this.anInt8921);
		}
	}
	...
	public void method7880(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method6094().method13(this, arg0, arg1, arg2, arg3, arg4);
	}
