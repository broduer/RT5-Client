...
public final class Class413 {
	...
	public static File method6860(@OriginalArg(0) String arg0) {
		return method6862(aString145, anInt10951, arg0);
	}

	@OriginalMember(owner = "loader!uia", name = "a", descriptor = "(ILjava/lang/String;I)V")
	public static void method6861(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1) {
		aString145 = arg1;
		anInt10951 = arg0;
		try {
	...
	private static File method6862(@OriginalArg(1) String arg0, @OriginalArg(2) int arg1, @OriginalArg(3) String arg2) {
		if (!aBoolean835) {
