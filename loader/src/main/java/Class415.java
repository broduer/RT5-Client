...
public final class Class415 {
	...
	private static boolean aBoolean836 = false;
	...
	public static File method9495(@OriginalArg(0) String arg0) {
		return method9497(aString145, anInt10980, arg0);
	}

	@OriginalMember(owner = "loader!uia", name = "a", descriptor = "(ILjava/lang/String;I)V")
	public static void method9496(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1) {
		aString145 = arg1;
		anInt10980 = arg0;
		try {
