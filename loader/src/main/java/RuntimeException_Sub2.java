...
public final class RuntimeException_Sub2 extends RuntimeException {
	...
	private static String method6841(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2) {
	...
	private static String method6842(@OriginalArg(0) Throwable arg0) throws IOException {
	...
	private static void method6843(@OriginalArg(0) String arg0) {
		System.out.println("Error: " + method6841(arg0, "%0a", "\n"));
	}

	@OriginalMember(owner = "loader!f", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lloader!f;")
	private static RuntimeException_Sub2 method6844(@OriginalArg(0) Throwable arg0, @OriginalArg(1) String arg1) {
	...
	public static void method6845(@OriginalArg(0) String arg0, @OriginalArg(1) Applet arg1, @OriginalArg(2) Throwable arg2) {
		try {
			@Pc(1) String local1 = "";
			if (arg2 != null) {
				local1 = method6842(arg2);
			}
			if (arg0 != null) {
				if (arg2 != null) {
					local1 = local1 + " | ";
			...
			method6843(local1);
			local1 = method6841(local1, ":", "%3a");
			local1 = method6841(local1, "@", "%40");
			local1 = method6841(local1, "&", "%26");
			local1 = method6841(local1, "#", "%23");
