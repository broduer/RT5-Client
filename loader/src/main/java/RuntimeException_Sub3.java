...
public final class RuntimeException_Sub3 extends RuntimeException {
	...
	public static void method9480(@OriginalArg(0) String arg0, @OriginalArg(1) Applet arg1, @OriginalArg(2) Throwable arg2) {
		try {
			...
			method9478(local1);
			local1 = method9476(local1, ":", "%3a");
			local1 = method9476(local1, "@", "%40");
			local1 = method9476(local1, "&", "%26");
			local1 = method9476(local1, "#", "%23");
			@Pc(88) URL local88 = new URL(arg1.getCodeBase(), "loadererror.ws?c=" + anInt10973 + "&v1=" + System.getProperty("java.vendor") + "&v2=" + System.getProperty("java.version") + "&e=" + local1);
